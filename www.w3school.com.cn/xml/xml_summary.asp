...
<title>您已经学习了 XML，下一步学习什么内容呢？</title>
</head>
...
<li class="currentLink"><a href="/xml/xml_summary.asp" title="您已经学习了 XML，下一步学习什么内容呢？">XML 教程总结</a></li>
</ul>
<h2>XML 实例/测验</h2>
<ul>
...
<h1>您已经学习了 XML，下一步学习什么内容呢？</h1>

<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/xml/xml_editors.asp" title="XML 编辑器">XML 编辑器</a></li>
<li class="next"><a href="/example/xmle_examples.asp" title="XML 实例">XML 实例</a></li>
</ul>
</div>
...
<div>
<h2>XML 概要</h2>
<p>本教程已经向您讲解了如何使用 XML 来描述数据。</p>
<p>您已经理解，XML 应当用来从 HTML 那里分离数据。</p>
<p>同时您也学习到，XML 可被用来交换、共享以及存储数据。</p>
<p>如需更多关于 XML 的信息，请查看我们的 <a href="/example/xmle_examples.asp" title="XML实例">XML 实例</a>。</p>
</div>


<div>
<h2>您已经学习了 XML，下一步学习什么内容呢？</h2>
<p>下一步的学习内容是 XML DOM 和 XSLT。</p>
<p>如果您需要学习有关 XML 验证的知识，下一步的学习内容是 DTD 和 XML Schema。</p>

<h3>XML DOM</h3>
<p>XML DOM 定义了一种访问和操作 XML 文档的标准方法。</p>
<p>XML DOM 独立于语言和平台，可被任何编程语言使用，比如 Java、JavaScript 以及 VBScript。</p>
<p>如果您希望学习有关 DOM 的知识，请访问我们的 <a href="/xmldom/index.asp" title="XML DOM教程">XML DOM 教程</a>。</p>

<h3>XSLT</h3>
<p>XSLT 是一种针对 XML 文件的样式表语言。</p>
<p>通过 XSLT，您可以把 XML 文档转换为其他格式，比如 XHTML。</p>
<p>如果您需要学习有关 XSLT 的知识，请访问我们的 <a href="/xsl/index.asp" title="XSLT教程">XSLT 教程</a>。</p>

<h3>DTD 和 XML Schema</h3>
<p>DTD 的作用是定义在 XML 文档中什么元素、属性以及实体是合法的。</p>
<p>通过 DTD，您的每个 XML 文件均可携带有关其自身格式的描述。</p>
<p>DTD 可用于验证您接收到的以及您自己的数据的有效性。</p>
<p>如果需要学习有关 DTD 的知识，请访问我们的 <a href="/dtd/index.asp" title="DTD教程">DTD 教程</a>。</p>

<h3>XML Schema 将取代 DTD。</h3>
<p>XML Schema 是一种基于 XML 的 DTD 替代物。</p>
<p>与 DTD 不同，XML Schema 已经开始支持数据类型，同时 XML Schema 使用 XML 语法。</p>
<p>如果您希望学习有关 XML Schema 的知识，请访问我们的 <a href="/schema/index.asp" title="XML Schema教程">XML Schema 教程</a>。</p>
</div>
