...
<li class="currentLink"><a href="/xml/xml_dtd.asp" title="XML 验证">XML 验证</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/xml/xml_attributes.asp" title="XML 属性">XML 属性</a></li>
<li class="next"><a href="/xml/xml_validator.asp" title="XML 验证器">XML 验证器</a></li>
</ul>
</div>
...
<p>如果您希望学习 DTD，请访问我们的 <a href="/dtd/index.asp">DTD 教程</a>。</p>
</div>
...
<p>如果您需要学习 XML Schema，请访问我们的 <a href="/schema/index.asp">XML Schema 教程</a>。</p>
</div>
