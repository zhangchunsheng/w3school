...
<li class="currentLink"><a href="/xml/xml_elements.asp" title="XML 元素">XML 元素</a></li>
...
<div  id="tpn">
<ul class="prenext">
<li class="pre"><a href="/xml/xml_syntax.asp" title="XML 语法规则">XML 语法</a></li>
<li class="next"><a href="/xml/xml_attributes.asp" title="XML 属性">XML 属性</a></li>
</ul>
</div>


<div id="intro">
<p><strong>XML 文档包含 XML 元素。</strong></p>
</div>
...
<p>在上例中，&lt;bookstore&gt; 和 &lt;book&gt; 都拥有<em>元素内容</em>，因为它们包含了其他元素。&lt;author&gt; 只有<em>文本内容</em>，因为它仅包含文本。</p>

<p>在上例中，只有 &lt;book&gt; 元素拥有<em>属性</em> (category=&quot;CHILDREN&quot;)。</p>
</div>
...
<p>使名称具有描述性。使用下划线的名称也很不错。</p>

<p>名称应当比较简短，比如：&lt;book_title&gt;，而不是：&lt;the_title_of_the_book&gt;。</p>

<p>避免 &quot;-&quot; 字符。如果您按照这样的方式进行命名：&quot;first-name&quot;，一些软件会认为你需要提取第一个单词。</p>

<p>避免 &quot;.&quot; 字符。如果您按照这样的方式进行命名：&quot;first.name&quot;，一些软件会认为 &quot;name&quot; 是对象 &quot;first&quot; 的属性。</p>

<p>避免 &quot;:&quot; 字符。冒号会被转换为命名空间来使用（稍后介绍）。</p>

<p>XML 文档经常有一个对应的数据库，其中的字段会对应 XML 文档中的元素。有一个实用的经验，即使用数据库的名称规则来命名 XML 文档中的元素。</p>

<p>非英语的字母比如 éòá 也是合法的 XML 元素名，不过需要留意当软件开发商不支持这些字符时可能出现的问题。</p>
</div>
...
<p>让我们设想一下，我们创建了一个应用程序，可将 &lt;to&gt;、&lt;from&gt; 以及 &lt;body&gt; 元素提取出来，并产生以下的输出：</p>

<pre style="background-color:#e5eecc">
<span style="font-family:Verdana, Arial, Helvetica, sans-serif; font-weight:bold; color:#000000">MESSAGE</span>
To: George
From: John
...
<p>想象一下，之后这个 XML 文档作者又向这个文档添加了一些额外的信息：</p>
...
<p>XML 的优势之一，就是可以经常在不中断应用程序的情况进行扩展。</p>
</div>
