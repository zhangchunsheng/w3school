...
<li class="currentLink"><a href="/xml/xml_browsers.asp" title="XML 浏览器支持">XML 浏览器</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/xml/xml_validator.asp" title="XML 验证器">XML 验证器</a></li>
<li class="next"><a href="/xml/xml_view.asp" title="查看 XML 文件">XML 查看</a></li>
</ul>
</div>

<div id="intro">
<p><strong>几乎所有的主流浏览器均支持 XML 和 XSLT。</strong></p>
</div>

<div>
<h2>Mozilla Firefox</h2>
<p>从 1.0.2 版本开始，Firefox 就已开始支持 XML 和 XSLT（包括 CSS）。</p>
</div>

<div>
<h2>Mozilla</h2>
<p>Mozilla 含有用于 XML 解析的 Expat，并支持显示 XML + CSS。Mozilla 同时拥有对 Namespaces 的某些支持。</p>
<p>Mozilla 同样可做到对 XSLT 的执行（XSLT implementation）。</p>
</div>

<div>
<h2>Netscape</h2>
<p>自从版本 8 开始，Netscape 开始使用 Mozilla 的引擎，因此它对 XML / XSLT 的支持与 Mozilla 是相同的。</p>
</div>

<div>
<h2>Opera</h2>
<p>自从版本 9 开始，Opera 已经拥有对 XML / XSLT（以及 CSS）的支持。版本 8 仅支持 XML + CSS。</p>
</div>

<div>
<h2>Internet Explorer</h2>
<p>自从版本 6 开始，Internet Explorer 就开始支持 XML、Namespaces、CSS、XSLT 以及 XPath。</p>
<p class="note"><span>注释：</span>Internet Explorer 5 同样拥有对 XML 的支持，但是 XSL 部分与 W3C 的官方标准<em>不兼容</em>！</p>
</div>
