...
<li class="currentLink"><a href="/html/html_xhtml_attributes.asp" title="XHTML - 属性">XHTML 属性</a></li>
</ul>
<h2>实例/测验/总结</h2>
<ul>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/html/html_xhtml_elements.asp" title="XHTML - 元素">XHTML 元素</a></li>
...
<div>
<p><strong>XHTML 属性是以 XML 格式编写的 HTML 属性。</strong></p>
</div>
