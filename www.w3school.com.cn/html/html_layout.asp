...
<li class="currentLink"><a href="/html/html_layout.asp" title="HTML 布局">HTML 布局</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/html/html_blocks.asp" title="HTML &lt;div&gt; 和 &lt;span&gt;">HTML 块</a></li>
<li class="next"><a href="/html/html_forms.asp" title="HTML 表单和输入">HTML 表单</a></li>
</ul>
</div>

<div id="intro">
<p><strong>网页布局对改善网站的外观非常重要。</strong></p>
<p><strong>请慎重设计您的网页布局。</strong></p>
</div>
...
<dl>
<dt><a href="/tiy/t.asp?f=html_layout_divs">使用 &lt;div&gt; 元素的网页布局</a></dt>
<dd>如何使用 &lt;div&gt; 元素添加布局。</dd>

<dt><a href="/tiy/t.asp?f=html_layout_tables">使用 &lt;table&gt; 元素的网页布局</a></dt>
<dd>如何使用 &lt;table&gt; 元素添加布局。</dd>
</dl>
</div>
...
<p class="tip"><span>提示：</span>即使可以使用 HTML 表格来创建漂亮的布局，但设计表格的目的是呈现表格化数据 - 表格不是布局工具！</p>
</div>
...
<p><a href="/tiy/t.asp?f=html_layout_divs">亲自试一试</a></p>

<p>上面的 HTML 代码会产生如下结果：</p>

<img src="/i/html_layout_div.gif" alt="使用 div 和 CSS 进行布局" />
</div>
...
<p><a href="/tiy/t.asp?f=html_layout_tables">亲自试一试</a></p>

<p>上面的 HTML 代码会产生以下结果：</p>

<img src="/i/html_layout_table.gif" alt="使用表格进行布局" />
</div>
...
<p class="tip"><span>提示：</span>使用 CSS 最大的好处是，如果把 CSS 代码存放到外部样式表中，那么站点会更易于维护。通过编辑单一的文件，就可以改变所有页面的布局。如需学习更多有关 CSS 的知识，请访问我们的 <a href="/css/index.asp" title="CSS 教程">CSS 教程</a>。</p>

<p class="tip"><span>提示：</span>由于创建高级的布局非常耗时，使用模板是一个快速的选项。通过搜索引擎可以找到很多免费的网站模板（您可以使用这些预先构建好的网站布局，并优化它们）。</p>
</div>
