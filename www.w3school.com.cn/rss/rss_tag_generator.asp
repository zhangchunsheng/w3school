...
<p>&lt;generator&gt; 元素规定用于生成该 RSS feed 的程序名称。</p>
...
<p class="note"><span>注释：</span>在 feed 由自动生成器创建时，通常会使用该元素。</p>
</div>
...
&lt;channel&gt;
  ...
  <code>&lt;generator&gt;Notepad&lt;/generator&gt;</code>
    &lt;item&gt;
