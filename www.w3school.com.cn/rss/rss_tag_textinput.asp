...
<p>&lt;textInput&gt; 元素规定应当与 feed 一同显示的文本输入域。</p>
...
<p class="note"><span>注释：</span>大多数聚合器忽略 &lt;textInput&gt; 元素。</p>

</div>


<div>
<h2>&lt;textInput&gt; 的子元素</h2>
...
<tr>
<td>&lt;description&gt;</td>
<td>必需。定义对文本输入域的描述。</td>
</tr>
<tr>
<td>&lt;name&gt;</td>
<td>必需。定义在文本输入域中的文本对象的名称。</td>
</tr>
<tr>
<td>&lt;link&gt;</td>
<td>必需。定义处理文本输入的 CGI 脚本的 URL。</td>
</tr>
<tr>
<td>&lt;title&gt;</td>
<td>必需。定义文本输入域中的提交按钮的标注 (label)。</td>
</tr>
</table>
</div>
