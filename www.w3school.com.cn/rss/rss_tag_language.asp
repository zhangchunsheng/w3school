...
<p>&lt;language&gt; 元素用于指定编写 RSS 文档时所使用的语言。</p>
...
<p class="tip"><span>提示：</span>&lt;language&gt; 元素可以使聚合器根据语言对站点进行分组。</p>

<p class="note"><span>注释：</span><a href="http://www.rssboard.org/rss-language-codes" title="RSS Language Codes">标准的语言代码</a>。</p>
</div>
...
&lt;channel&gt;
  ...
  <code>&lt;language&gt;zh-cn&lt;/language&gt;</code>
  &lt;item&gt;
