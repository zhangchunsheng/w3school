...
<li class="currentLink"><a href="/rss/rss_syntax.asp" title="RSS 语法">RSS 语法</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/rss/rss_history.asp" title="RSS 的历史">RSS 历史</a></li>
<li class="next"><a href="/rss/rss_channel.asp" title="RSS &lt;channel&gt; 元素">RSS &lt;channel&gt;</a></li>
</ul>
</div>

<div id="intro">
<p><strong>RSS 2.0 的语法很简单，也很严格。这些规则很容易学习，也很容易使用。</strong></p>
</div>
...
<p class="tip"><span>提示：</span>请在 <a href="/rss/rss_publishing.asp" title="RSS 发布您的 feed">RSS 发布</a> 这一节浏览免费的 RSS 聚合器服务。</p>
</div>
