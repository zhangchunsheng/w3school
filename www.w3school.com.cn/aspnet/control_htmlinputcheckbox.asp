...
<title>ASP.NET HtmlInputCheckBox 控件</title>
</head>
...
<h1>ASP.NET HtmlInputCheckBox 控件</h1>
...
<div>
<h2>定义和用法</h2>
<p>HtmlInputCheckBox 控件用于控制 &lt;input type=&quot;checkbox&quot;&gt; 元素。在 HTML 中，该元素用于创建复选框。</p>
</div>
...
<tr>
<td>runat
<td>规定该控件是一个服务器控件。必须被设置为 &quot;server&quot;。
</tr>

<tr>
<td>Style
<td>设置或返回被应用到控件的 CSS 属性。
</tr>
...
<h2>实例</h2>
<dl>
<dl><a href="/tiy/s.asp?f=demo_aspnet_htmlinputcheckbox">HTMLInputCheckbox</a></dl>
<dd>在本例中，我们在 .aspx 文件中声明了两个 HtmlInputCheckBox 控件，一个 HtmlInputButton 控件，以及一个 HtmlGeneric 控件。当提交按钮被触发时，就会执行 submit 子例程。这个 submit 子例程有两种响应方式：如果 &quot;red&quot; 复选框被选中，则服务器会向 p 元素发送消息 &quot;You prefer red!&quot;。如果 &quot;blue&quot; 复选框被选中，则服务器会向 p 元素发送消息 &quot;You prefer blue!&quot;。</dd>
</dl>
</div>
