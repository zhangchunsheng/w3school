...
<title>ASP.NET IsWeekend 属性</title>
</head>
...
<p>IsWeekend 属性用于获取日期是否是星期六或星期日。</p>

<p>如果日期在周末，则返回 true，否则返回 false。</p>
</div>

<div>
<h2>实例</h2>

<p>下面的例子展示被选的日期是否在周末：</p>

<pre>&lt;script runat=&quot;server&quot;&gt;
Sub DaySelect(obj As Object, e As DayRenderEventArgs)
  If e.Day.IsSelected Then
    If <code>e.Day.IsWeekend</code> = &quot;TRUE&quot; Then
      Label1.Text = &quot;YES&quot;
    Else
      Label1.Text = &quot;NO&quot;
    End If
...
<h2>实例</h2>
<dl>
<dt>使用 IsWeekend 展示被选日期是否在周末</dt>
</dl>
</div>
