...
<title>ASP.NET Web Pages - 教程</title>
...
<h2>WP 教程</h2>
<ul>
<li class="currentLink"><a href="/aspnet/webpages_intro.asp" title="WebPages 简介">WebPages 简介</a></li>
...
<h1>ASP.NET Web Pages - 教程</h1>


<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/aspnet/aspnet.asp" title="ASP.NET 简介">ASP.NET 简介</a></li>
<li class="next"><a href="/aspnet/webpages_razor.asp" title="WebPages Razor">WebPages Razor</a></li>
</ul>
</div>


<div>
<p>ASP.NET 是一个开放框架，用于通过 HTML、CSS、JavaScript 以及服务器脚本来构建网页和网站。</p>

<p>ASP.NET 支持三种开放模式：</p>

<p>Web Pages、MVC (Model View Controller) 以及 Web Forms。</p>

<p>本教程为您讲解 WEB PAGES。</p>

<table class="dataintable" style="text-align:center; font-size:14px;">
<tr>
<td style="vertical-align:middle; background-color:#008000; color:#FFFFFF; width:33%; height:35px;">Web Pages</td>
<td style="vertical-align:middle; background-color:#dddddd; color:#FFFFFF; width:33%;">MVC</td>
<td style="vertical-align:middle; background-color:#dddddd; color:#FFFFFF;">Web Forms</td>
</tr>
</table>
</div>
...
<p>很多开发者喜欢通过阅读示例的方式来学习新技术。</p>

<p>如果您需要查看 Web Pages 实例，请访问这个 ASP.NET Web Pages 演示。</p>
</div>


<div>
<h2>使用“运行代码”来提高学习效率</h2>

<p>我们的“运行代码”功能可以降低 Web Pages 的学习难度。</p>

<p>该功能会显示并运行 ASP.NET 代码，同时输出 HTML。</p>

<p>请点击“运行代码”按钮，看看它是怎么工作的：</p>
...
<p>Web Pages 是三种 ASP.NET 编程模型中的一种，用于创建 ASP.NET 网站和 web 应用程序。</p>

<p>其他两种编程模型是 Web Forms 和 MVC (Model, View, Controller)。</p>

<p>Web Pages 是最简单的 ASP.NET 网页开发编程模型。它提供了一种简单的方法将 HTML、CSS、JavaScript 以及服务器代码结合起来：</p>

<ul>
<li>易于学习、阅读和使用</li>
<li>围绕单一网页进行构建</li>
<li>类似 PHP 和 ASP</li>
<li>服务器脚本使用 Visual Basic 或 C#</li>
<li>对 HTML、CSS、JavaScript 的完全控制</li>
</ul>

<p>Web Pages 通过可编程的 Web Helpers 进行扩展，包括数据库、视频、图像、社交网络等等。</p>
</div>
...
<p>如果您是 ASP.NET 新手，那么 Web Pages 是极好的入手之处。</p>

<p>在我们的 Web Pages 教程中，您将学习到如何通过使用 Visual Basic 和 C# 的最新 Razor 服务器标记语法，将 HTML、CSS、JavaScript 与服务器代码相结合。</p>

<p>您也会学到如何通过可编程的 Web Helpers 对网页进行扩展，包括数据库、视频、图像、社交网络等等。</p>
</div>
...
<p>因为 ASP.NET 代码在服务器上执行，所以您无法在浏览器中查看代码。您只能看到输出的纯 HTML。</p>

<p>在 W3School，每个实例都能显示出隐藏的 ASP.NET 代码。这有助于您更容易地理解其工作原理。</p>

<p><a href="/aspnet/webpages_examples.asp" title="ASP.NET Web Pages - C# 和 VB 中的例子">Web Pages 实例</a></p>
</div>
...
<p>本教程同时提供了完整的 ASP.NET 参考手册，包括对象、组件、属性和方法。</p>

<p><a href="/aspnet/webpages_ref_classes.asp" title="">Web Pages 参考手册</a></p>
</div>


<div>
<h2>我们使用 WebMatrix</h2>

<p>在本教程中，我们使用 WebMatrix。</p>

<p>WebMatrix 是简单但强大的免费 ASP.NET 开发工具，是微软专门为 Web Pages 开发的。</p>

<p>WebMatrix 包含：</p>

<ul>
<li>Web Pages 实例和模板</li>
<li>web 服务器语言（使用 VB 或 C# 的 Razor）</li>
<li>web 服务器（IIS Express）</li>
<li>数据库服务器（SQL Server Compact）</li>
<li>完整的 web 开发框架（ASP.NET）</li>
</ul>

<p>通过 WebMatrix，您能够从头开始建立空站点或空白网页，或者从 &quot;Web Application Gallery&quot; 构建开源应用程序。PHP 和 ASP.NET 应用程序都是可用的，比如 Umbraco, DotNetNuke, Drupal, Joomla, WordPress 等等。WebMatrix 还拥有用于安全、搜索引擎优化和 web 发布的内建工具。</p>

<p>您通过使用 WebMatrix 开发的技能和代码能够无缝地转换为专业的 ASP.NET 应用程序。</p>

<p>如果您需要使用 WebMatrix，请使用以下链接进行安装：</p>

<p><a href="http://www.microsoft.com/web/gallery/install.aspx?appid=WebMatrix">http://www.microsoft.com/web/gallery/install.aspx?appid=WebMatrix</a></p>
</div>
