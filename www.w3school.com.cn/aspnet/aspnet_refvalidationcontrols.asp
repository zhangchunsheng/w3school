...
<li class="currentLink"><a href="/aspnet/aspnet_refvalidationcontrols.asp" title="WebForms Validation">WebForms Validation</a></li>
</ul>
</div>
...
<h1>Validation 服务器控件</h1>

<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/aspnet/aspnet_refwebcontrols.asp" title="WebForms Controls">WebForms Controls</a></li>
<li class="next"><a href="/aspnet/index.asp" title="ASP.NET 教程">ASP.NET 教程</a></li>
</ul>
</div>

<div id="intro">
<p><strong>Validation 服务器控件用于用于验证用户输入。</strong></p>
</div>

<div>
<h2>Validation 服务器控件</h2>

<p>Validation 服务器控件用于验证输入控件的数据。如果数据未通过验证，则向用户显示错误消息。</p>

<h3>创建 Validation 服务器控件的语法是：</h3>

<pre>&lt;asp:control_name id=&quot;some_id&quot; runat=&quot;server&quot; /&gt;</pre>

<table class="dataintable">
<tr>
<th>Validation 服务器控件</th>
<th>描述</th>
</tr>

<tr>
<td><a href="/aspnet/control_comparevalidator.asp" title="ASP.NET CompareValidator 控件">CompareValidator</a></td>
<td>把一个输入控件的值与另一个输入控件或一个固定的值进行对比。</td>
</tr>

<tr>
<td><a href="/aspnet/control_customvalidator.asp" title="ASP.NET CustomValidator 控件">CustomValidator</a></td>
<td>允许您编写一个方法，来处理输入值的验证。</td>
</tr>

<tr>
<td><a href="/aspnet/control_rangevalidator.asp" title="ASP.NET RangeValidator 控件">RangeValidator</a></td>
<td>在两个值的范围内检查输入的值。</td>
</tr>

<tr>
<td><a href="/aspnet/control_regularexpvalidator.asp" title="ASP.NET RegularExpressionValidator 控件">RegularExpressionValidator</a></td>
<td>确保输入控件的值匹配指定的模式。</td>
</tr>

<tr>
<td><a href="/aspnet/control_reqfieldvalidator.asp" title="ASP.NET RequiredFieldValidator 控件">RequiredFieldValidator</a></td>
<td>是输入控件成为必需（必填）的字段。</td>
</tr>

<tr>
<td><a href="/aspnet/control_validationsummary.asp" title="ASP.NET ValidationSummary 控件">ValidationSummary</a></td>
<td>显示网页中所有验证错误的报告。</td>
</tr>
</table>
</div>
