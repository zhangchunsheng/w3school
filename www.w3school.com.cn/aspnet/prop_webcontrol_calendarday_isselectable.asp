...
<title>ASP.NET IsSelectable 属性</title>
</head>
...
<p>IsSelectable 属性用于获取或设置日期是否为可选。</p>

<p>如果日期可选，则返回 &quot;TRUE&quot;，否则为 false。</p>
</div>

<div>
<h2>实例</h2>

<p>下面的例子展示了周末不可选的日历：</p>

<pre>&lt;script runat=&quot;server&quot;&gt;
Sub DaySelect(obj As Object, e As DayRenderEventArgs)
  If e.Day.IsWeekend Then
    <code>e.Day.IsSelectable</code> = False
  End If
End Sub
&lt;/script&gt;
...
<h2>实例</h2>
<dl>
<dt>使用 IsSelectable 来设置日历中哪些为可选</dt>
</dl>
</div>
