...
<title>ASP.NET IsSelected 属性</title>
</head>
...
<h1>ASP.NET IsSelected 属性</h1>

<div class="backtoreference">
<p><a href="/aspnet/control_calendarday.asp" title="ASP.NET CalendarDay 控件">返回 ASP.NET CalendarDay 控件参考手册</a></p>
</div>

<div>
<h2>定义和用法</h2>

<p>IsSelected 属性用于设置日期在 calendar 控件中是否被选定。</p>

<p>如果日期在 Calendar 控件中被选定，则为 true；否则为 false。</p>
</div>

<div>
<h2>实例</h2>

<p>下面的例子显示了被选定的日期是否在当前的月份中：</p>

<pre>&lt;script runat=&quot;server&quot;&gt;
Sub DaySelect(obj As Object, e As DayRenderEventArgs)
  If <code>e.Day.IsSelected</code> Then
...
<h2>实例</h2>
<dl>
<dt>使用 IsOtherMonth 和 IsSelected 来展示日期是否在当前月份中</dt>
</dl>
</div>
