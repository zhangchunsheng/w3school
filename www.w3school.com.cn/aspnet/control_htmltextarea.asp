...
<title>ASP.NET HtmlTextArea 控件</title>
</head>
...
<div>
<h2>定义和用法</h2>
<p>HtmlTextArea 控件用于控制 &lt;textarea&gt; 元素。在 HTML 中，&lt;textarea&gt; 元素用于创建文本域。</p>
</div>
...
<h2>实例</h2>
<dl>
<dt><a href="/tiy/s.asp?f=demo_aspnet_htmltextarea">HTMLTextarea</a></dt>
<dd>在本例中，我们在 .aspx 文件中声明了一个 HtmlTextarea 控件，一个 HtmlInputButton 控件，以及一个 HtmlGeneric 控件。当触发提交按钮时，会执行 submit 子例程。这个 submit 子例程会向 p 元素发送消息 &quot;You wrote: &quot; 以及用户在文本框中输入的文本。</dd>
</dl>
</div>
