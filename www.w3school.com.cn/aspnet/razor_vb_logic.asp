...
<title>ASP.NET Razor - VB 逻辑条件</title>
...
<li class="currentLink"><a href="/aspnet/razor_vb_logic.asp" title="Razor VB 逻辑">Razor VB 逻辑</a></li>
</ul>
<h2>ASP.NET MVC</h2>
<ul>
...
<h1>ASP.NET Razor - VB 逻辑条件</h1>


<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/aspnet/razor_vb_loops.asp" title="Razor VB 循环">Razor VB 循环</a></li>
<li class="next"><a href="/aspnet/mvc_intro.asp" title="MVC 简介">MVC 简介</a></li>
</ul>
</div>
...
<ul>
<li>if 语句启动代码块</li>
<li>条件位于 if 和 then 之间</li>
<li>如果条件为真，则执行 if ... then 与 end if 之间的代码</li>
</ul>
...
<p><em>select 代码块</em>可用于测试一系列具体的条件：</p>
...
<p>&quot;Select Case&quot; 之后是测试值 (day)。每个具体的测试条件以 case 关键词开头，其后允许任意数量的代码行。如果测试值匹配 case 值，则执行代码行。</p>

<p>select 代码块可为其余的情况设置默认的 case (default:)，允许在所有 case 均不为 true 时执行代码。</p>
</div>
