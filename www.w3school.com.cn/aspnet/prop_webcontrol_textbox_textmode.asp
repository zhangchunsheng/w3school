...
<title>ASP.NET TextMode 属性</title>
</head>
...
<p>TextMode 属性用于设置或返回 TextBox 控件的行为模式。</p>

<h3>语法</h3>
<pre>&lt;asp:TextBox TextMode=&quot;mode&quot; runat=&quot;server&quot; /&gt;</pre>
...
<td>mode</td>
<td>
<p>TextBoxMode 枚举值之一。默认值为 SingleLine。</p>

<p>可能的值：</p>
<ul>
<li>SingleLine - 默认。表示单行输入模式。</li>
<li>MultiLine - 表示多行输入模式。</li>
<li>Password - 表示密码输入模式。</li>
</ul>
</td>
</tr>
</table>
...
<p>下面的例子设置把 TextBox 控件的文本模式设置为 &quot;Password&quot;：</p>

<pre>&lt;form runat=&quot;server&quot;&gt;
&lt;asp:TextBox id=&quot;tb1&quot; runat=&quot;server&quot; <code>TextMode=&quot;Password&quot;</code> /&gt;
&lt;/form&gt;</pre>
</div>
...
<h2>实例</h2>
<dl>
<dt>设置 TextBox 控件的 TextMode 属性</dt>
</dl>
</div>
