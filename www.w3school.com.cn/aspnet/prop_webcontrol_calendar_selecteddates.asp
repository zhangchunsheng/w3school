...
<title>ASP.NET SelectedDates 属性</title>
</head>
...
<h1>ASP.NET SelectedDates 属性</h1>
...
<div>
<h2>定义和用法</h2>
<p>SelectedDates 属性用于设置或返回日历中被选的日期。</p>
</div>

<div>
<h2>实例</h2>

<p>下面的例子在某日期被选择时输出该被选日期：</p>

<pre>&lt;script language=&quot;VB&quot; runat=&quot;server&quot;&gt;
Sub Change(obj As Object, e As EventArgs)
  Dim i As Integer
  For i = 0 To Cal1.SelectedDates.Count - 1
    Response.Write(<code>Cal1.SelectedDates(i).ToShortDateString()</code>)
    Response.Write(&quot;&lt;br /&gt;&quot;)
  Next i
End Sub
&lt;/script&gt;
...
<h2>实例</h2>
<dl>
<dt>设置 Calendar 控件的 SelectedDates</dt>
</dl>
</div>
