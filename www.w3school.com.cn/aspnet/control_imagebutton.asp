...
<title>ASP.NET ImageButton 控件</title>
</head>
...
<tr>
<td><a href="/aspnet/prop_webcontrol_imagebutton_causesvalidation.asp" title="ASP.NET CausesValidation 属性">CausesValidation</a></td>
<td>规定在 ImageButton 控件被点击时，是否验证页面。</td>
<td>1.0</td>
</tr>
...
<tr>
<td>CommandName</td>
<td>与 Command 事件相关的命令。</td>
<td>1.0</td>
</tr>

<tr>
<td>GenerateEmptyAlternateText</td>
<td>规定该控件是否创建空字符串作为替代文本。</td>
<td>2.0</td>
</tr>

<tr>
<td><a href="/aspnet/prop_webcontrol_imagebutton_onclientclick.asp" title="ASP.NET OnClientClick 属性">OnClientClick</a></td>
<td>当图像被点击时要执行的函数的名称。</td>
<td>2.0</td>
</tr>

<tr>
<td><a href="/aspnet/prop_webcontrol_imagebutton_postbackurl.asp" title="ASP.NET PostBackUrl 属性">PostBackUrl</a></td>
<td>当 ImageButton 被点击时，从当前页面进行回传的目标页面的 URL。</td>
<td>2.0</td>
</tr>
...
<tr>
<td><a href="/aspnet/prop_webcontrol_imagebutton_validationgroup.asp" title="ASP.NET ValidationGroup 属性">ValidationGroup</a></td>
<td>当 ImageButton 回传服务器时，该 ImageButton 控件引起验证所针对的控件组。</td>
<td>2.0</td>
</tr>
</table>

<p class="note"><span>注释：</span>Image 控件的属性也能够用在 ImageButton 控件上。</p>
</div>
...
<h2>实例</h2>
<dl>
<dt><a href="/tiy/s.asp?f=demo_aspnet_imagebutton">ImageButton</a></dt>
<dd>在本例中，我们在 .aspx 文件中声明了一个 ImageButton 控件和一个 Label 控件。在用户点击此图像时，会执行 subroutine 子例程。这个子例程会把消息 &quot;Coordinates: &quot; 以及单击的 x 和 y 坐标发送到 Label 控件。</dd>
</dl>
</div>
