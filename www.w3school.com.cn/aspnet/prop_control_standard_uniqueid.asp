...
<title>ASP.NET UniqueID 属性</title>
</head>
...
<p>UniqueID 属性获取服务器控件的唯一的、以分层形式限定的标识符。</p>

<p>此属性与 ID 属性不同，因为 UniqueID 属性包含服务器控件命名容器的标识符。处理页请求时自动生成此标识符。</p>
</div>

<div>
<h2>实例</h2>

<p>本例显示 button 控件的 UniqueID：</p>

<pre>&lt;script runat=&quot;server&quot;&gt;
Sub Button1_Click(sender As Object, e As EventArgs)
  Response.Write(&quot;UniqueID is: &quot; &amp; <code>button1.UniqueID</code>)
End Sub
&lt;/script&gt;
