...
<title>ASP.NET TableCell 控件</title>
</head>
...
<div>
<h2>定义和用法</h2>
<p>TableCell 控件与 Table 控件和 TableRow 控件结合，用于创建表格中的单元。</p>
<p class="tip"><span>提示：</span>每行的单元均存储在 <a href="/aspnet/control_tablerow.asp" title="ASP.NET TableRow 控件">TableRow 控件</a>的 Cells 集合中。</p>
</div>
...
<td>与 TableCell 控件关联的表标题单元格列表。</td>
<td>2.0</td>
</tr>

<tr>
<td><a href="/aspnet/prop_webcontrol_tablecell_columnspan.asp" title="ASP.NET ColumnSpan 属性">ColumnSpan</a></td>
<td>单元格跨越的列数。</td>
<td>1.0</td>
</tr>

<tr>
<td><a href="/aspnet/prop_webcontrol_tablecell_horizontalalign.asp" title="ASP.NET HorizontalAlign 属性">HorizontalAlign</a></td>
<td>单元格中内容的水平对齐方式。</td>
<td>1.0</td>
</tr>

<tr>
<td><a href="/aspnet/prop_webcontrol_tablecell_rowspan.asp" title="ASP.NET RowSpan 属性">RowSpan</a></td>
<td>单元格跨越的行数。</td>
<td>1.0</td>
</tr>
...
<tr>
<td><a href="/aspnet/prop_webcontrol_tablecell_text.asp" title="ASP.NET Text 属性">Text</a></td>
<td>规定单元格的文本内容。</td>
<td>1.0</td>
</tr>

<tr>
<td><a href="/aspnet/prop_webcontrol_tablecell_verticalalign.asp" title="ASP.NET VerticalAlign 属性">VerticalAlign</a></td>
<td>单元格中内容的垂直对齐方式。</td>
<td>1.0</td>
</tr>

<tr>
<td><a href="/aspnet/prop_webcontrol_tablecell_wrap.asp" title="ASP.NET Wrap 属性">Wrap</a></td>
<td>规定单元格内容是否换行。</td>
<td>1.0</td>
</tr>
</table>
...
<h2>实例</h2>
<dl>
<dt><a href="/tiy/s.asp?f=demo_aspnet_table_1">Table</a></dt>
<dd>在本例中，我们在 .aspx 文件中声明了两个 Table 控件。</dd>

<dt><a href="/tiy/s.asp?f=demo_aspnet_table_2">Table 2</a></dt>
<dd>在本例中，我们在 .aspx 文件中声明了一个 Table 控件，三个 TableRow 控件，以及两个 TableCell 控件。</dd>
</dl>
</div>
