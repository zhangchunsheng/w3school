...
<title>ASP.NET AccessKey 属性</title>
</head>
...
<p>AccessKey 属性用于设置或返回用于访问某个控件的键盘按键。</p>
<p class="note"><span>注释：</span>请使用 Alt + <i>AccessKey</i> 通过指定的快捷键为元素赋予焦点。</p>

<h3>语法</h3>
<pre>&lt;asp:<i>webcontrol</i> id=&quot;<i>id</i>&quot; <code>AccessKey=&quot;<i>accessKey</i>&quot;</code> runat=&quot;server&quot; /&gt;</pre>
...
&lt;asp:CheckBox id=&quot;check1&quot; <code>AccessKey=&quot;b&quot;</code> runat=&quot;server&quot; /&gt;
&lt;/form&gt;</pre>
</div>
...
<h2>实例</h2>
<dl>
<dt>向 checkbox 控件添加 AccessKey</dt>
</dl>
</div>
