...
<p><a href="/aspnet/control_listbox.asp" title="ASP.NET ListBox 控件">返回 ASP.NET ListBox 控件参考手册</a></p>
</div>

<div>
<h2>定义和用法</h2>

<p>SelectionMode 属性用于获取或设置用户选择 ListBox 项目的方式。</p>

<h3>语法</h3>
<pre>&lt;asp:ListBox SelectionMode=&quot;mode&quot; runat=&quot;server&quot;&gt;
some content
&lt;/asp:ListBox&gt;</pre>
...
<td>mode</td>
<td>
<p>规定用户选择 ListBox 项目的方式。</p>
<p>可能的值：</p>
<ul>
<li>Single - 默认。不能选择多个项目。</li>
<li>Multiple - 可选多个项目。</li>
</ul>
</td>
</tr>
</table>
...
<p>下面的例子设置了 ListBox 控件的 SelectionMode 属性：</p>
...
<h2>实例</h2>
<dl>
<dt>设置 ListBox 控件的 SelectionMode</dt>
</dl>
</div>
