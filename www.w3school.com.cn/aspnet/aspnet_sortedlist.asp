...
<title>ASP.NET - SortedList 对象</title>
</head>
...
<li class="currentLink"><a href="/aspnet/aspnet_sortedlist.asp" title="WebForms SortedList">WebForms SortedList</a></li>
...
<h1>ASP.NET - SortedList 对象</h1>

<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/aspnet/aspnet_hashtable.asp" title="WebForms Hashtable">WebForms Hashtable</a></li>
<li class="next"><a href="/aspnet/aspnet_xml.asp" title="WebForms XML 文件">WebForms XML 文件</a></li>
</ul>
</div>
...
<h2>实例</h2>
<dl>
<dt><a href="/tiy/s.asp?f=demo_aspnet_sortedlist_radio_1">SortedList RadiobuttonList 1</a></dt>
<dt><a href="/tiy/s.asp?f=demo_aspnet_sortedlist_radio_2">SortedList RadiobuttonList 2</a></dt>
<dt><a href="/tiy/s.asp?f=demo_aspnet_sortedlist_drop_1">SortedList DropDownList</a></dt>
</dl>
</div>
...
<p>SortedList 对象可自动地为下面的控件生成文本和值：
...
<p>如需把数据绑定到 RadioButtonList 控件，首先请在 aspx 文件中创建一个 RadioButtonList 控件（没有任何 asp:ListItem 元素）：

<pre>&lt;html&gt;
&lt;body&gt;

&lt;form runat=&quot;server&quot;&gt;
<code>&lt;asp:RadioButtonList id=&quot;rb&quot; runat=&quot;server&quot; AutoPostBack=&quot;True&quot; /&gt;</code>
&lt;/form&gt;
...
<code>sub displayMessage(s as Object,e As EventArgs)
...
&lt;p&gt;<span class="marked">&lt;asp:label id=&quot;lbl1&quot; runat=&quot;server&quot; /&gt;</span>&lt;/p&gt;
&lt;/form&gt;

&lt;/body&gt;
&lt;/html&gt;</pre>

<p><a href="/tiy/s.asp?f=demo_aspnet_sortedlist_radio_1">显示这个例子</a></p>
</div>
