...
<title>ASP.NET Web Pages - WebGrid 帮助器</title>
...
<li class="currentLink"><a href="/aspnet/webpages_webgrid.asp" title="WebPages WebGrid">WebPages WebGrid</a></li>
...
<h1>ASP.NET Web Pages - WebGrid 帮助器</h1>


<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/aspnet/webpages_helpers.asp" title="WebPages 帮助器">WebPages 帮助器</a></li>
<li class="next"><a href="/aspnet/webpages_chart.asp" title="WebPages 图表">WebPages 图表</a></li>
</ul>
</div>
...
<div id="intro">
<p>WebGrid - 众多有用的 ASP.NET Web 帮助器之一。</p>
</div>
...
<p>在前面的章节，我们通过使用 razor 代码来显示数据库中的数据，并且亲自编写所有 HTML 标记：</p>
...
<div>
<h2>使用 WebGrid 帮助器</h2>

<p>使用 WebGrid 帮助器来显示数据是更简单的方法。</p>
