...
<title>ASP.NET Razor - VB 循环和数组</title>
...
<li class="currentLink"><a href="/aspnet/razor_vb_loops.asp" title="Razor VB 循环">Razor VB 循环</a></li>
...
<h1>ASP.NET Razor - VB 循环和数组</h1>


<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/aspnet/razor_vb_variables.asp" title="Razor VB 变量">Razor VB 变量</a></li>
<li class="next"><a href="/aspnet/razor_vb_logic.asp" title="Razor VB 逻辑">Razor VB 逻辑</a></li>
</ul>
</div>
...
<p>while 循环以关键词 while 开始，后面定义循环持续的长度的表达式，然后是要循环的代码块。</p>
