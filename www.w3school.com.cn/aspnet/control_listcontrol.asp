...
<title>ASP.NET ListControl 控件</title>
</head>
...
<p>ListControl 控件为列表控件提供了所有基本的功能。继承自该控件的控件包括：CheckBoxList, DropDownList, ListBox 以及 RadioButtonList 类。</p>

<p>ListControl 类的属性允许您指定用来填充列表控件的数据源。</p>
</div>
...
<td>获取或设置一个布尔值，该值指示是否在绑定数据之前清除列表项。</td>
<td>2.0</td>
</tr>

<tr>
<td>AutoPostBack</td>
<td>获取或设置一个值，该值指示当用户更改列表中的选定内容时，是否自动向服务器进行回传。</td>
<td>1.0</td>
</tr>

<tr>
<td>CausesValidation</td>
<td>规定在列表控件中的项目被点击时，是否验证页面。</td>
<td>2.0</td>
</tr>

<tr>
<td>DataTextField</td>
<td>为列表项提供文本内容的数据源字段。</td>
<td>1.0</td>
</tr>

<tr>
<td>DataTextFormatString</td>
<td>用于规定如何显示列表数据的格式化字符串。</td>
<td>1.0</td>
</tr>

<tr>
<td>DataValueField</td>
<td>为各列表项提供值的数据源字段。</td>
<td>1.0</td>
</tr>
...
<td>当选定项的 index 被更改时，被执行的函数的名称。</td>
<td>1.0</td>
</tr>
</table>
</div>
