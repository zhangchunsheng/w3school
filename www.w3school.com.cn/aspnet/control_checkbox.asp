...
<title>ASP.NET CheckBox 控件</title>
</head>
...
<tr>
<td>AutoPostBack</td>
<td>规定在 Checked 属性已改变后，是否立即向服务器回传表单。默认是 false。</td>
<td>1.0</td>
</tr>

<tr>
<td>CausesValidation</td>
<td>规定点击 Button 控件时是否执行验证。</td>
<td>2.0</td>
</tr>

<tr>
<td><a href="/aspnet/prop_webcontrol_checkbox_checked.asp" title="ASP.NET Checked 属性">Checked</a></td>
<td>规定是否已选中该复选框。</td>
<td>1.0</td>
</tr>
...
<td>该 CheckBox 控件的 Input 元素所用的属性名和值的集合。</td>
<td>2.0</td>
</tr>

<tr>
<td>LabelAttributes</td>
<td>该 CheckBox 控件的 Label 元素所用的属性名和值的集合。</td>
<td>2.0</td>
</tr>

<tr>
<td>runat</td>
<td>规定该控件是服务器控件。必须被设置为 &quot;server&quot;。</td>
<td>1.0</td>
</tr>

<tr>
<td><a href="/aspnet/prop_webcontrol_checkbox_text.asp" title="ASP.NET Text 属性">Text</a></td>
<td>与 CheckBox 关联的文本标签。</td>
<td>1.0</td>
</tr>

<tr>
<td><a href="/aspnet/prop_webcontrol_checkbox_textalign.asp" title="ASP.NET TextAlign 属性">TextAlign</a></td>
<td>与 CheckBox 控件关联的文本标签的对齐方式。(right 或 left)</td>
<td>1.0</td>
</tr>

<tr>
<td>ValidationGroup</td>
<td>在 CheckBox 控件回发到服务器时要进行验证的控件组。</td>
<td>2.0</td>
</tr>

<tr>
<td>OnCheckedChanged</td>
<td>当 Checked 属性被改变时，被执行函数的名称。</td>
<td>&nbsp;</td>
</tr>
</table>
</div>
...
<h2>实例</h2>
<dl>
<dt><a href="/tiy/s.asp?f=demo_aspnet_checkbox">Checkbox</a></dt>
<dd>在本例中，我们在 .aspx 文件中声明了两个 TextBox 控件和一个 CheckBox 控件。然后，我们为 CheckedChanged 事件创建一个事件句柄，把包含 home phone 的文本框的内容复制到包含 work phone 的文本框中。</dd>
</dl>
</div>
