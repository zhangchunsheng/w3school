...
<div>
<h2>定义和用法</h2>
<p>Target 属性用于设置在何处打开广告的 URL。</p>

<h3>语法</h3>
<pre>&lt;asp:AdRotator Target=&quot;target&quot; runat=&quot;server&quot; /&gt;</pre>
...
<p>下面的例子为 AdRotator 设置了目标窗口（在 TIY 中查看此 XML 文件）：</p>
