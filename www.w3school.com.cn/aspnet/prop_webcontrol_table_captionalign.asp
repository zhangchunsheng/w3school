...
<title>ASP.NET CaptionAlign 属性</title>
</head>
...
<h1>ASP.NET CaptionAlign 属性</h1>

<div class="backtoreference">
<p><a href="/aspnet/control_table.asp" title="ASP.NET Table 控件">返回 ASP.NET Table 控件参考手册</a></p>
</div>

<div>
<h2>定义和用法</h2>

<p>CaptionAlign 属性用于为表格设置或返回标题文本的对齐方式。</p>

<h3>语法</h3>
<pre>&lt;asp:Table Caption=&quot;text&quot; <code>CaptionAlign=&quot;align&quot;</code> runat=&quot;server&quot;&gt;
...
<p>可能的值：</p>
<ul>
<li>NotSet - 默认。未设置标题的对齐方式。</li>
<li>Top - 标题显示在表格的顶端。文本居中。</li>
<li>Bottom - 标题显示在表格的底部。文本居中。</li>
<li>Left - 标题显示在表格的顶端。文本左对齐。</li>
<li>Right - 标题显示在表格的顶端。文本右对齐。</li>
</ul>
</td>
</tr>
</table>
...
<p>下面的例子设置了表格中的标题属性，并把排列在 Table 控件的底部：</p>

<pre>&lt;form runat=&quot;server&quot;&gt;
&lt;asp:Table id=&quot;tab1&quot; runat=&quot;server&quot; 
Caption=&quot;Table Example&quot; <code>CaptionAlign=&quot;bottom&quot;</code>&gt;
&lt;asp:TableRow&gt;
&lt;asp:TableCell&gt;
Hello!
&lt;/asp:TableCell&gt;
