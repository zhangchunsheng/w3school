...
<title>ASP.NET CheckBoxList 控件</title>
</head>
...
<div>
<h2>定义和用法</h2>
<p>CheckBoxList 控件用于创建多选的复选框组。</p>
<p>每个 CheckBoxList 控件中的可选项都是由 ListItem 元素定义的！</p>
...
<tr>
<td><a href="/aspnet/prop_webcontrol_checkboxlist_cellpadding.asp" title="ASP.NET CellPadding 属性">CellPadding</a></td>
<td>表格单元格的边框与内容之间的像素数。</td>
<td>1.0</td>
</tr>

<tr>
<td><a href="/aspnet/prop_webcontrol_checkboxlist_cellspacing.asp" title="ASP.NET CellSpacing 属性">CellSpacing</a></td>
<td>表格单元格之间的像素数。</td>
<td>1.0</td>
</tr>

<tr>
<td><a href="/aspnet/prop_webcontrol_checkboxlist_repeatcolumns.asp" title="ASP.NET RepeatColumns 属性">RepeatColumns</a></td>
<td>当显示复选框组时所用的列数。</td>
<td>1.0</td>
</tr>

<tr>
<td><a href="/aspnet/prop_webcontrol_checkboxlist_repeatdirection.asp" title="ASP.NET RepeatDirection 属性">RepeatDirection</a></td>
<td>规定复选框组水平重复还是垂直重复。</td>
<td>1.0</td>
</tr>

<tr>
<td><a href="/aspnet/prop_webcontrol_checkboxlist_repeatlayout.asp" title="ASP.NET RepeatLayout 属性">RepeatLayout</a></td>
<td>复选框组的布局。</td>
<td>1.0</td>
</tr>
...
<tr>
<td><a href="/aspnet/prop_webcontrol_checkboxlist_textalign.asp" title="ASP.NET TextAlign 属性">TextAlign</a></td>
<td>文本出现在复选框的那一侧。</td>
<td>1.0</td>
</tr>
</table>
...
<h2>实例</h2>
<dl>
<dt><a href="/tiy/s.asp?f=demo_aspnet_checkboxlist">CheckBoxList</a></dt>
<dd>在本例中，我们在 .aspx 文件中声明了一个 CheckBoxList 控件。然后我们为 SelectedIndexChanged 事件创建了一个事件句柄。这个可选列表包含六个复选框。当用户选中其中之一，页面会自动传回服务器，并执行 Check 子例程。该子例程会遍历控件的 Items 集合，并测试每个项目的 Selected 属性。被选的项目会显示在 Label 控件中。</dd>
</dl>
</div>
