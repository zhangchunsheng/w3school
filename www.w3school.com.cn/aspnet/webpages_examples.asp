...
<title>ASP.NET Web Pages - C# 和 VB 中的例子</title>
...
<li class="currentLink"><a href="/aspnet/webpages_examples.asp" title="WebPages 实例">WebPages 实例</a></li>
</ul>
<h2>WP 参考手册</h2>
<ul>
...
<h1>ASP.NET Web Pages - C# 和 VB 中的例子</h1>


<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/aspnet/webpages_publish.asp" title="WebPages 发布">WebPages 发布</a></li>
<li class="next"><a href="/aspnet/webpages_ref_classes.asp" title="WebPages 类">WebPages 类</a></li>
</ul>
</div>
...
<div id="intro">
<p>通过 C# 和 Visual Basic 实例来学习 ASP.NET Web Pages。</p>
</div>
...
<tr>
<td>
<h2 style="margin-bottom:15px; font-size:12px;">基本的 Web Pages</h2>
<ul>
<li>显示日期和事件</li>
<li>可重复使用的页面和页脚</li>
<li>基本的 HTML 表单</li>
</ul>
<p style="margin-top:15px; font-weight:bold;">例子解释</p>
</td>
...
<tr>
<td>
<h2 style="margin-bottom:15px; font-size:12px;">基础的 C#</h2>
<ul>
<li>For 循环</li>
<li>For Each 循环</li>
<li>While 循环</li>
...
<td>
<h2 style="margin-bottom:15px; font-size:12px;">基础的 VB</h2>
<ul>
<li>For 循环</li>
<li>For Each 循环</li>
<li>While 循环</li>
...
<tr>
<td>
<h2 style="margin-bottom:15px; font-size:12px;">与 Databases 打交道</h2>
<ul>
<li>显示数据库数据</li>
<li>通过 WebGrid 显示数据</li>
</ul>
<p style="margin-top:15px; font-weight:bold;">例子解释</p>
</td>
...
<tr>
<td>
<h2 style="margin-bottom:15px; font-size:12px;">使用图表助手</h2>
<ul>
<li>显示来自数组的条状图表</li>
<li>显示来自数据库的条状图表</li>
<li>显示来自数据库的饼图</li>
<li>显示来自 XML 文件的饼图</li>
</ul>
<p style="margin-top:15px; font-weight:bold;">例子解释</p>
</td>
