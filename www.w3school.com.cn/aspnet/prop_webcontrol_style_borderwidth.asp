...
<title>ASP.NET BorderWidth 属性</title>
</head>
...
<p>BorderWidth 属性用于设置或返回控件的边框宽度。</p>

<h3>语法</h3>
<pre>&lt;asp:webcontrol id=&quot;id&quot; <code>BorderWidth=&quot;length&quot;</code> runat=&quot;server&quot; /&gt;</pre>
...
<tr>
<td>length</td>
<td>边框的宽度。必须是合法的 .NET 长度单位。合法的单位是：cm、mm、in、pt、pc 或 px。</td>
</tr>
</table>
</div>
...
&lt;asp:Table runat=&quot;server&quot; <code>BorderWidth=&quot;5&quot;</code> GridLines=&quot;vertical&quot;&gt;
  &lt;asp:TableRow&gt;
...
<h2>实例</h2>
<dl>
<dt>设置表格控件的 BorderWidth</dt>

<dt>设置表格控件的 BorderWidth（带有声明和脚本）</dt>
</dl>
</div>
