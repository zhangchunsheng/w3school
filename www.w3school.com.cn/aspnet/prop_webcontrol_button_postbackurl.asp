...
<p>PostBackUrl 属性用于获得或设置在 Button 控件被点击时回传数据的页面的 URL。</p>

<h3>语法</h3>
<pre>&lt;asp:Button PostBackUrl=&quot;string&quot; runat=&quot;server&quot; /&gt;</pre>
...
<tr>
<td>string</td>
<td><p>字符串值，规定向其回传数据的页面的 URL。</p>
  <p>默认是空字符串，如果这么设置，页面会它自身进行回传。</p></td>
</tr>
</table>
</div>
...
<p>下面的例子设置了 Button 控件的 post URL：</p>
...
<h2>实例</h2>
<dl>
<dt>为 Button 控件设置 PostBackUrl</dt>
</dl>
</div>
