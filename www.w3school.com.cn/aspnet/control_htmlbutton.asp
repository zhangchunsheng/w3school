...
<title>ASP.NET HtmlButton 控件</title>
</head>
...
<div>
<h2>定义和用法</h2>
<p>HtmlButton 控件用于控制 &lt;button&gt; 元素。在 HTML 中，&lt;button&gt; 元素用于创建按钮。</p>
</div>
...
<h2>实例</h2>
<dl>
<dl><a href="/tiy/s.asp?f=demo_aspnet_htmlbutton">HTMLButton</a></dl>
<dd>在本例中，我们声明了两个 HtmlButton 控件（记得把这个控件嵌套在 HtmlForm 控件中）。然后，我们编写一个事件句柄，来规定在按钮被点击时执行的动作。</dd>
</dl>
</div>
