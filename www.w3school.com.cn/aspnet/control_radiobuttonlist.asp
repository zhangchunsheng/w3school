...
<title>ASP.NET RadioButtonList 控件</title>
</head>
...
<h1>ASP.NET RadioButtonList 控件</h1>
...
<div>
<h2>定义和用法</h2>
<p>RadioButtonList 控件用于创建单选按钮组。</p>
<p>RadioButtonList 控件中的每个可选项是通过 ListItem 元素来定义的！</p>
<p class="tip"><span>提示：</span>该控件支持数据绑定！</p>
</div>
...
<tr>
<td><a href="/aspnet/prop_webcontrol_radiobuttonlist_cellpadding.asp" title="ASP.NET CellPadding 属性">CellPadding</a></td>
<td>单元格边框与内容之间的像素数。</td>
<td>1.0</td>
</tr>

<tr>
<td><a href="/aspnet/prop_webcontrol_radiobuttonlist_cellspacing.asp" title="ASP.NET CellSpacing 属性">CellSpacing</a></td>
<td>表格单元格之间的像素数。</td>
<td>1.0</td>
</tr>

<tr>
<td><a href="/aspnet/prop_webcontrol_radiobuttonlist_repeatcolumns.asp" title="ASP.NET RepeatColumns 属性">RepeatColumns</a></td>
<td>当显示单选按钮组时要使用的列数。</td>
<td>1.0</td>
</tr>

<tr>
<td><a href="/aspnet/prop_webcontrol_radiobuttonlist_repeatdirection.asp" title="ASP.NET RepeatDirection 属性">RepeatDirection</a></td>
<td>规定单选按钮组应水平重复还是垂直重复。</td>
<td>1.0</td>
</tr>

<tr>
<td><a href="/aspnet/prop_webcontrol_radiobuttonlist_repeatlayout.asp" title="ASP.NET RepeatLayout 属性">RepeatLayout</a></td>
<td>单选按钮组的布局。</td>
<td>1.0</td>
</tr>
...
<tr>
<td><a href="/aspnet/prop_webcontrol_radiobuttonlist_textalign.asp" title="ASP.NET TextAlign 属性">TextAlign</a></td>
<td>文本应出现在单选按钮的哪一侧（左侧还是右侧）。</td>
<td>1.0</td>
</tr>
</table>
</div>
...
<h2>实例</h2>
<dl>
<dt><a href="/tiy/s.asp?f=demo_aspnet_radiobuttonlist">RadiobuttonList</a></dt>
<dd>在本例中，我们在 .aspx 文件中声明了一个 RadioButtonList 控件，一个 Button 控件，以及一个 Label 控件。然后，我们创建了一个事件句柄，当发生 Click 事件时，会把文本和被选项目显示在 Label 控件中。</dd>
</dl>
</div>
