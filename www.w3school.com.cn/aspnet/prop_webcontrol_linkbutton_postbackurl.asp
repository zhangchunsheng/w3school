...
<p>PostBackUrl 属性用于获取或设置当 LinkButton 控件被点击时要回传的目标页面的 URL。</p>

<h3>语法</h3>
<pre>&lt;asp:LinkButton PostBackUrl=&quot;string&quot; runat=&quot;server&quot; /&gt;</pre>
...
<tr>
<td>string</td>
<td>字符串值。规定要发送的目标页面的 URL。默认是空字符串，这会导致页面向自身回传。</td>
</tr>
</table>
</div>
...
<p>下面的例子设置了 LinkButton 控件的 post URL：</p>
...
<h2>实例</h2>
<dl>
<dt>设置 LinkButton 控件的 PostBackUrl 属性</dt>
</dl>
</div>
