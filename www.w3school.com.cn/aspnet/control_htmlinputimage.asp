...
<title>ASP.NET HtmlInputImage 控件</title>
</head>
...
<h1>ASP.NET HtmlInputImage 控件</h1>
...
<div>
<h2>定义和用法</h2>
<p>HtmlInputImage 控件用于控制 &lt;input type=&quot;image&quot;&gt; 元素。</p>
<p>在 HTML 中，该元素用于创建使用图像的按钮，可代替常规的按钮。</p>
</div>
...
<dl>
<dt><a href="/tiy/s.asp?f=demo_aspnet_htmlinputimage">HTMLInputImage</a></dt>
<dd>在本例中，我们在 .aspx 文件中声明了两个 HtmlInputImage 控件，一个 HtmlGeneric 控件。如果用户点击第一个图像，会执行 button1 子例程。该子例程会向 p 元素发送消息 &quot;You clicked the smiley button!&quot;。如果用户点击了第二个图像，则会执行 button2 子例程。这个子例程会向 p 元素发送消息 &quot;You clicked the angry button!&quot;。</dd>
</dl>
</div>
