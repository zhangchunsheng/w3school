...
<title>ASP.NET ShowNextPrevMonth 属性</title>
</head>
...
<h1>ASP.NET ShowNextPrevMonth 属性</h1>
...
<p>ShowNextPrevMonth 属性用于规定 Calendar 控件是否在标题部分显示下个月和上个月导航元素。</p>
<p>如果 Calendar 在标题部分显示下个月和上个月导航元素，则为 true；否则为 false。默认值为 true。</p>

<h3>语法</h3>
<pre>&lt;asp:Calendar ShowNextPrevMonth=&quot;TRUE|FALSE&quot; runat=&quot;server&quot; /&gt;
</pre>
</div>
...
<p>下面的例子把 ShowNextPrevMonth 设置为 FALSE：</p>

<pre>&lt;form runat=&quot;server&quot;&gt;
&lt;asp:Calendar id=&quot;cal1&quot; runat=&quot;server&quot;
<code>ShowNextPrevMonth=&quot;FALSE&quot;</code> /&gt;
&lt;/form&gt;</pre>
</div>
