...
<p>Text 属性用于设置或返回 ListItem 控件的文本。</p>

<h3>语法</h3>
<pre>&lt;asp:ListItem Text=&quot;string&quot; runat=&quot;server&quot; /&gt;</pre>
...
<p>下面的例子设置了 ListBox 控件中 ListItem 文本：</p>
...
<h2>实例</h2>
<dl>
<dt>在 BulletedList 控件中设置 ListItem 控件的文本</dt>
</dl>
</div>
