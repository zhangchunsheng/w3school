...
<title>ASP.NET Web Pages - 对象</title>
...
<li class="currentLink"><a href="/aspnet/webpages_objects.asp" title="WebPages 对象">WebPages 对象</a></li>
...
<h1>ASP.NET Web Pages - 对象</h1>


<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/aspnet/webpages_forms.asp" title="WebPages 窗体">WebPages 窗体</a></li>
<li class="next"><a href="/aspnet/webpages_files.asp" title="WebPages 文件">WebPages 文件</a></li>
</ul>
</div>
...
<p>在前一章，您已看到两个用过的 Page 对象属性（isPost 和 Request）：</p>
...
<div>
<h2>Page 属性（Page 对象的）</h2>

<p>Page 对象的 Page 属性，提供对页面、布局页和分页之间共享的页数据的类似属性的访问。</p>

<p>您能够像 Page 属性添加（使用）自己的属性：</p>

<ul>
<li>Page.Title</li>
<li>Page.Version</li>
<li>Page.anythingyoulike</li>
</ul>

<p>Page 属性很有用。举例，可以在内容文件中设置页面标题，然后在布局文件中使用它：</p>
