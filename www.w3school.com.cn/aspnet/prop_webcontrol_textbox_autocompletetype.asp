...
<title>ASP.NET AutoCompleteType 属性</title>
</head>
...
<h1>ASP.NET AutoCompleteType 属性</h1>

<div class="backtoreference">
<p><a href="/aspnet/control_textbox.asp" title="ASP.NET TextBox 控件">返回 ASP.NET TextBox 控件参考手册</a></p>
</div>

<div>
<h2>定义和用法</h2>

<p>AutoCompleteType 属性用于设置或返回 TextBox 控件的 AutoComplete 种类。</p>
<p>为了协助用户的数据输入，Microsoft Internet Explorer 5 及更高版本和 Netscape 都支持名为自动完成的功能。</p>
<p>AutoComplete 特性可创建在文本框中已输入的值列表。当再次使用该文本框时，已输入的值的列表或显示出来。用户可以直接选取值，而不需要重复键入之前已输入的值。</p>
<p>使用 AutoCompleteType 属性来控制 TextBox 控件的自动完成功能的行为。System.Web.UI.WebControls.AutoCompleteType 枚举用于表示可以应用到 AutoCompleteType 属性的值。</p>
<h3>语法</h3>
<pre>&lt;asp:TextBox <code>AutoCompleteType=&quot;cat&quot;</code> runat=&quot;server&quot;/&gt;</pre>
...
<td>cat</td>
<td>
<p>规定自动完成的种类。默认值为 None。</p>
<p>可能的值：<a href="#AutoCompleteType">System.Web.UI.WebControls.AutoCompleteType 枚举值</a>之一。</p></td>
</tr>
</table>
</div>
...
<p>下面的例子把 AutoCompleteType 模式设置为 &quot;HomePhone&quot;：</p>

<pre>&lt;form runat=&quot;server&quot;&gt;
&lt;asp:TextBox id=&quot;tb1&quot; runat=&quot;server&quot; <code>AutoCompleteType=&quot;HomePhone&quot;</code> /&gt;
&lt;/form&gt;</pre>
</div>
...
<h2>实例</h2>
<dl>
<dt>设置 TextBox 控件的 AutoCompleteType 属性</dt>
</dl>
</div>

<div>
<h2><a id="AutoCompleteType">AutoCompleteType 枚举</a></h2>
...
<tr>
<td>None</td>
<td>无任何类别与 TextBox 控件相关联。具有相同 ID 的所有 TextBox 控件都共享同一值列表。</td>
</tr>

<tr>
<td>Notes</td>
<td>要包含在窗体类别中的任何补充信息。</td>
</tr>
