...
<title>ASP.NET IsToday 属性</title>
</head>
...
<p>IsToday 属性用于获取日期是否是当前日期。</p>
<p>如果日期是当前日期，则返回 true，否则返回 false。</p>
...
<h2>实例</h2>
<dl>
<dt>使用 IsToday 来展示被选日期是否是当前日期</dt>
</dl>
</div>
