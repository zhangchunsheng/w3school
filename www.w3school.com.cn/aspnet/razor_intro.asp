...
<h2>ASP.NET Razor</h2>
<ul>
<li class="currentLink"><a href="/aspnet/razor_intro.asp" title="Razor 简介">Razor 简介</a></li>
...
<h1>ASP.NET Razor - 标记</h1>


<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/aspnet/webpages_ref_helpers.asp" title="WebPages 助手">WebPages 助手</a></li>
<li class="next"><a href="/aspnet/razor_syntax.asp" title="Razor 语法">Razor 语法</a></li>
</ul>
</div>


<div id="intro">
<p>Razor 不是编程语言。它是服务器端标记语言。</p>
</div>
...
<h3>Web Forms（以及 Classic ASP）：</h3>
...
<p>Razor 帮助器可通过简单的 Razor 代码进行访问。</p>

<p>您可以使用 Razor 语法构建自己的帮助器，或者使用内建的 ASP.NET 帮助器。</p>

<p>下面一些重要的 Razor 帮助器的简要描述：</p>
