...
<title>ASP.NET HtmlGeneric 控件</title>
</head>
...
<div>
<h2>定义和用法</h2>
<p>HtmlGeneric 控件用于控制未被具体的 HTML 服务器控件规定的其他 HTML 元素，比如 &lt;body&gt; 、&lt;div&gt; 、&lt;span&gt; 、&lt;font&gt; 、&lt;p&gt; 等等。</p>
</div>
...
<h2>实例</h2>
<dl>
<dl><a href="/tiy/s.asp?f=demo_aspnet_htmlinputbutton">HTMLGeneric</a></dl>
<dd>在本例中，我们在 .aspx 文件中声明了一个 HtmlInputText 控件，一个 HtmlInputButton 控件，以及一个 HtmlGeneric 控件（&lt;p&gt; 标签）（请记得把这个控件嵌套在 HtmlForm 控件中）当提交按钮被触发时，会执行 submit 子例程。submit 子例程会向 p 元素写一段欢迎消息。</dd>
</dl>
</div>
