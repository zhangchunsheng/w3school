...
<p><a href="/aspnet/control_literal.asp" title="ASP.NET Literal 控件">返回 ASP.NET Literal 控件参考手册</a></p>
</div>

<div>
<h2>定义和用法</h2>

<p>Text 属性用于设置或返回 Literal 控件的文本。</p>

<p>根据此属性的赋值方式，对标题进行 HTML 解码。如果通过 Literal 控件的 Text 属性赋值，则在显示之前对值进行 HTML 解码。例如，&lt;asp:Literal id=&quot;DisplayLiteral&quot; Text=&quot;A&amp;nbsp;B&quot;/&gt; 在浏览器中呈现为“A B”。然而，如果以编程方式，或者通过将文本放在控件的开始和结束标记之间设置此属性，则不对标题进行 HTML 解码。例如，&lt;asp:Literal id=&quot;DisplayLiteral&quot;&gt; A&amp;nbsp;B &lt;/asp:Literal&gt; 呈现为“A&amp;nbsp;B”。</p>

<h3>语法</h3>
<pre>&lt;asp:HyperLink Text=&quot;string&quot; runat=&quot;server&quot; /&gt;</pre>
...
<p>下面的例子为 Literal 控件设置了文本：</p>

<pre>&lt;form runat=&quot;server&quot;&gt;
&lt;asp:Literal runat=&quot;server&quot; <code>Text=&quot;W3School&quot;</code> /&gt;
&lt;/form&gt;</pre>
</div>
