...
<li class="currentLink"><a href="/aspnet/aspnet_button.asp" title="WebForms Button">WebForms Button</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/aspnet/aspnet_textbox.asp" title="WebForms TextBox">WebForms TextBox</a></li>
<li class="next"><a href="/aspnet/aspnet_databinding.asp" title="WebForms Data Binding">WebForms 数据绑定</a></li>
</ul>
</div>
...
<p>Button 控件的属性列在我们的 <a href="/aspnet/control_button.asp" title="ASP.NET Button 控件">Button 控件参考手册</a>中。</p>
