...
<title>ASP.NET DayStyle 属性</title>
</head>
...
<div>
<h2>定义和用法</h2>
<p>DayStyle 属性用于设置或返回日历中日期的样式。</p>
...
<pre>&lt;asp:Calendar runat=&quot;server&quot; DayStyle-style=&quot;value&quot; /&gt;</pre>
...
<tr>
<td>style</td>
<td>规定要设置的样式。请参阅 <a href="/aspnet/control_style.asp">Style 控件</a>，来查看可能的样式以及它们的值。</td>
</tr>
...
<p>下面的例子显示了在日历中设置 DayStyle 的一种方法：</p>

<pre>&lt;form runat=&quot;server&quot;&gt;
&lt;asp:Calendar id=&quot;cal1&quot; runat=&quot;server&quot;&gt;
<code>&lt;DayStyle ForeColor=&quot;#FF0000&quot; /&gt;</code>
&lt;/asp:Calendar&gt;
&lt;/form&gt;</pre>

<h3>例子 2</h3>

<p>下面的例子显示了在日历中设置 DayStyle 的另一种方法：</p>
...
<h2>实例</h2>
<dl>
<dt>设置日历控件的 DayStyle</dt>
<dt>设置日历控件的 DayStyle（带有声明和脚本）</dt>
</dl>
</div>
