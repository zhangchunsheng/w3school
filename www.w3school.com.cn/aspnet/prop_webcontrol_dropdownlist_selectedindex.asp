...
<title>ASP.NET SelectedIndex 属性</title>
</head>
...
<h1>ASP.NET SelectedIndex 属性</h1>

<div class="backtoreference">
<p><a href="/aspnet/control_dropdownlist.asp" title="ASP.NET DropDownList 控件">返回 ASP.NET DropDownList 控件参考手册</a></p>
</div>

<div>
<h2>定义和用法</h2>

<p>SelectedIndex 属性用于获取或设置 DropDownList 中被选项目的索引号。</p>
</div>
...
Sub GetName(obj As Object, e As EventArgs)
  lbl.Text = <code>ddList.SelectedItem.Text</code>
End Sub
&lt;/script&gt;
...
<h2>实例</h2>
<dl>
<dt>从 DropDownList 中的一个项目取得文本</dt>
</dl>
</div>
