...
<li class="currentLink"><a href="/aspnet/webpages_php.asp" title="WebPages PHP">WebPages PHP</a></li>
...
<h1>ASP.NET Web Pages - PHP</h1>


<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/aspnet/webpages_email.asp" title="WebPages 电邮">WebPages 电邮</a></li>
<li class="next"><a href="/aspnet/webpages_publish.asp" title="WebPages 发布">WebPages 发布</a></li>
</ul>
</div>
...
<div id="intro">
<p>PHP 开发者请注意。可以使用 PHP 来编写 Web Pages。</p>
</div>
...
<p>WebMatrix 给人的第一印象是仅支持微软的技术。这并不准确。在 WebMatrix 中，您能够编写搭配 MySQL 的完整 PHP 应用程序。</p>
</div>
...
<p>在 ASP.NET Web Pages - 创建网站这章中，我们创建了一个名为 &quot;Demo&quot; 的空网站，并在其中创建了类型 &quot;CSHTML&quot; 的新的空页面。</p>

<p>创建名为 &quot;Demo_PHP&quot; 的空站点，启用 PHP（见下图），创建 PHP 类型的新的空页面，名为 &quot;index.php&quot;，这样您就创建好了您的第一个 PHP 站点。</p>

<img src="/i/webmatrix_php.jpg" alt="WebMatrix 启用 PHP" />
</div>
