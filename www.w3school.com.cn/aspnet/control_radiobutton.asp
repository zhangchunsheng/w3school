...
<title>ASP.NET RadioButton 控件</title>
</head>
...
<div>
<h2>定义和用法</h2>
<p>RadioButton 控件用于显示单选按钮。</p>
<p class="tip"><span>提示：</span>如需创建一系列使用数据绑定的单选按钮，请使用 RadioButtonList 控件！</p>
</div>
...
<tr>
<td>AutoPostBack</td>
<td>布尔值，规定在 Checked 属性被改变后，是否立即回传表单。默认是 false。</td>
</tr>

<tr>
<td>Checked</td>
<td>布尔值，规定是否选定单选按钮。</td>
</tr>
...
<td>当 Checked 被改变时，被执行的函数的名称。</td>
</tr>
...
<h2>实例</h2>
<dl>
<dt><a href="/tiy/s.asp?f=demo_aspnet_radiobutton">Radiobutton</a></dt>
<dd>在本例中，我们在 .aspx 文件中声明了三个 RadioButton 控件，一个 Button 控件，以及一个 Label 控件。当提交按钮被触发时，会执行 submit 子例程。submit 子例程会以三种方式进行响应：假如带有 id=&quot;red&quot; 属性的 radiobutton 被选中，服务器向 Label 控件发送消息 &quot;You selected Red&quot;；假如带有 id=&quot;green&quot; 属性的 radiobutton 被选中，服务器向 Label 控件发送消息 &quot;You selected Green&quot;；假如带有 id=&quot;blue&quot; 属性的 radiobutton 被选中，服务器向 Label 控件发送消息 &quot;You selected Blue&quot;。</dd>
</dl>
</div>
