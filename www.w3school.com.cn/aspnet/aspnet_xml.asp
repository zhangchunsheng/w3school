...
<li class="currentLink"><a href="/aspnet/aspnet_xml.asp" title="WebForms XML 文件">WebForms XML 文件</a></li>
...
<h1>ASP .NET - XML 文件</h1>

<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/aspnet/aspnet_sortedlist.asp" title="WebForms SortedList">WebForms SortedList</a></li>
<li class="next"><a href="/aspnet/aspnet_repeater.asp" title="WebForms Repeater">WebForms Repeater</a></li>
</ul>
</div>
...
<h2>实例</h2>
<dl>
<dt><a href="/tiy/s.asp?f=demo_aspnet_xml_radio_1">XML RadiobuttonList</a></dt>
</dl>
</div>
...
<p>请查看该文件：<a href="/example/aspnet/countries.xml">countries.xml</a></p>
</div>
...
if Not Page.IsPostBack then
  <code>dim mycountries=New DataSet
  mycountries.ReadXml(MapPath(&quot;countries.xml&quot;))</code>
end if
end sub</pre>
...
<p><a href="/tiy/s.asp?f=demo_aspnet_xml_radio_1">显示这个例子</a></p>
</div>
