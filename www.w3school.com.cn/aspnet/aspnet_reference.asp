...
<div id="intro">
<p><strong>W3School 提供完整的 ASP.NET 服务器控件参考手册。</strong></p>
</div>
...
<p><a href="/aspnet/aspnet_refvalidationcontrols.asp" title="Validation 服务器控件">Validation 服务器控件参考手册</a></p>
</div>
