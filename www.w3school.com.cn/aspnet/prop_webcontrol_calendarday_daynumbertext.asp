...
<title>ASP.NET DayNumberText 属性</title>
</head>
...
<h1>ASP.NET DayNumberText 属性</h1>
...
<p>DayNumberText 属性用于获取表示日期的日期编号的一个字符串。</p>
...
<p>下面的例子展示了如何从日历中选定的日期获取 DayNumberText：</p>

<pre>&lt;script runat=&quot;server&quot;&gt;
Sub DaySelect(obj As Object, e As DayRenderEventArgs)
  If e.Day.IsSelected Then
  Label1.Text = <code>e.Day.DayNumberText</code>
  End If
End Sub
&lt;/script&gt;
...
<h2>实例</h2>
<dl>
<dt>从 Calendar 控件中选定的日期获取 DayNumberText</dt>
</dl>
</div>
