...
<p>ForeColor 属性用于设置或返回控件的前景色。</p>

<h3>语法</h3>
<pre>&lt;asp:<i>webcontrol</i> id=&quot;<i>id</i>&quot; <code>ForeColor=&quot;<i>color</i>&quot;</code> runat=&quot;server&quot; /&gt;</pre>
...
<table class="dataintable">
	...
	<tr>
		<td>color</td>
		<td>设置为控件的前景色。必须是合法的 HTML 颜色。</td>
	</tr>
</table>
</div>
