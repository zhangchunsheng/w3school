...
<title>ASP.NET HtmlInputButton 控件</title>
</head>
...
<h1>ASP.NET HtmlInputButton 控件</h1>
...
<p>HtmlInputButton 控件用于控制 &lt;input type=&quot;button&quot;&gt; 、&lt;input type=&quot;submit&quot;&gt; 以及 &lt;input type=&quot;reset&quot;&gt; 元素。</p>

<p>在 HTML 中，这个元素用于创建按钮、提交按钮以及重置按钮。</p>
</div>
...
<h2>实例</h2>
<dl>
<dl><a href="/tiy/s.asp?f=demo_aspnet_htmlinputbutton">HTMLInputbutton</a></dl>
<dd>在本例中，我们在 .aspx 文件中声明了一个 HtmlInputText 控件，一个 HtmlInputButton 控件，以及一个 HtmlGeneric 控件。当提交按钮被触发时，会执行 submit 子例程。这个 submit 子例程会向 p 元素写一条欢迎消息。</dd>
</dl>
</div>
