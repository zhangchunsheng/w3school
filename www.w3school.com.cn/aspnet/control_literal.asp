...
<title>ASP.NET Literal 控件</title>
</head>
...
<div>
<h2>定义和用法</h2>
<p>Literal 控件用于在页面上显示文本。此文本是可编程的。</p>
<p class="note"><span>注释：</span>该控件不允许您向其内容应用样式！</p>
</div>
...
<tr>
<td><a href="/aspnet/prop_webcontrol_literal_text.asp" title="ASP.NET Text 属性">Text</a></td>
<td>规定要显示的文本。</td>
<td>1.0</td>
</tr>
</table>
...
<h2>实例</h2>
<dl>
<dt><a href="/tiy/s.asp?f=demo_aspnet_literal_1">Literal</a></dt>
<dd>在本例中，我们在 .aspx 文件中声明了一个显示静态文本的 Literal 控件。</dd>

<dt><a href="/tiy/s.asp?f=demo_aspnet_literal_2">Literal 2</a></dt>
<dd>在本例中，我们在 .aspx 文件中声明了一个 Literal 控件和一个 Button 控件。当用户点击按钮时，会执行 submit 子例程。这个子例程会更改 Literal 控件的文本。</dd>
</dl>
</div>
