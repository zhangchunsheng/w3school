...
<title>ASP.NET DayHeaderStyle 属性</title>
</head>
...
<h1>ASP.NET DayHeaderStyle 属性</h1>
...
<div>
<h2>定义和用法</h2>
<p>DayHeaderStyle 属性用于设置或返回一周中某天的部分的样式属性。</p>
...
<p>或者：</p>
<pre>&lt;asp:Calendar runat=&quot;server&quot; DayHeaderStyle-style=&quot;value&quot; /&gt;</pre>
...
<tr>
<td>style</td>
<td>规定要设置的样式。查看 Style 控件，浏览可能的样式以及它们的值。</td>
</tr>
...
<p>下面的例子显示了设置日历中 DayHeaderStyle 的一种方法：</p>
...
<p>下面的例子显示设置日历中 DayHeaderStyle 的另一种方法：</p>
...
<h2>实例</h2>
<dl>
<dt>设置日历控件的 DayHeaderStyle 属性</dt>
<dt>设置日历控件的 DayHeaderStyle 属性（带有声明和脚本）</dt>
</dl>
</div>
