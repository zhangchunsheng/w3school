...
<title>ASP.NET VisibleDate 属性</title>
</head>
...
<div>
<h2>定义和用法</h2>
<p>VisibleDate 属性用于设置或获取要在 Calendar 控件上显示的月份的日期。</p>
</div>

<div>
<h2>实例</h2>

<p>下面的例子把 VisibleDate 设置为 01-Oct-07：</p>
<pre>&lt;script runat=&quot;server&quot;&gt;
Sub Page_Load
  <code>cal1.VisibleDate = DateValue(&quot;01-Oct-07&quot;)</code>
End Sub
&lt;/script&gt;
