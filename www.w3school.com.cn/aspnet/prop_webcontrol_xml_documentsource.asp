...
<title>ASP.NET DocumentSource 属性</title>
</head>
...
<h1>ASP.NET DocumentSource 属性</h1>

<div class="backtoreference">
<p><a href="/aspnet/control_xml.asp" title="ASP.NET XML 控件">返回 ASP.NET XML 控件参考手册</a></p>
</div>

<div>
<h2>定义和用法</h2>

<p>DocumentSource 属性用于设置或返回在 Xml 控件中显示的 XML 文档的路径。</p>

<h3>语法</h3>
<pre>&lt;asp:Xml <code>DocumentSource=&quot;path&quot;</code> runat=&quot;server&quot; /&gt;</pre>
...
<td>path</td>
<td>
<p>字符串值，规定 XML 文件的位置。</p>
<p>该属性可以是相对或绝对路径：</p>
<ul>
<li>相对路径：文件路径相对于当前页面（比如：&quot;~/note.xml&quot;）</li>
<li>绝对路径：比如：&quot;C:\xml\note.xml&quot;</li>
</ul>
</td>
</tr>
...
<p>下面的例子设置了 Xml 控件的 DocumentSource：</p>

<pre>&lt;form runat=&quot;server&quot;&gt;
&lt;asp:Xml id=&quot;xml1&quot; runat=&quot;server&quot; <code>DocumentSource=&quot;note.xml&quot;</code> /&gt;
&lt;/form&gt;</pre>

<p>在例子中以及 TIY 中使用的 XML 文件是 &quot;<a href="/aspnet/note.xml">note.xml</a>&quot;。</p>
</div>

<div class="example">
<h2>实例</h2>
<dl>
<dt>为 XML 控件设置 XML 文档源</dt>
</dl>
</div>
