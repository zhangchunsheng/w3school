...
<title>ASP.NET HtmlSelect 控件</title>
</head>
...
<div>
<h2>定义和用法</h2>
<p>HtmlSelect 控件用于控制 &lt;select&gt; 元素。在 HTML 中，&lt;select&gt; 元素用于创建下拉列表。</p>
</div>
...
<tr>
<td>DataTextField</td>
<td>要显示在此下拉列表中的数据源中的字段。</td>
</tr>

<tr>
<td>DataValueField</td>
<td>规定此下拉列表中每个可选项的值的数据源中的字段。</td>
</tr>
...
<h2>实例</h2>
<dl>
<dt><a href="/tiy/s.asp?f=demo_aspnet_htmlimage2">HTMLSelect</a></dt>
<dd>在本例中，我们在 .aspx 文件中声明一个 HtmlImage 控件以及一个 HTMLSelect 控件。然后我们会根据用户的选择来修改 HtmlImage 控件的 src 属性。在 HtmlSelect 控件中选择的值决定了显示哪幅图像。</dd>
</dl>
</div>
