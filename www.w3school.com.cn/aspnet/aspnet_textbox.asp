...
<li class="currentLink"><a href="/aspnet/aspnet_textbox.asp" title="WebForms TextBox">WebForms TextBox</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/aspnet/aspnet_viewstate.asp" title="WebForms ViewState">WebForms ViewState</a></li>
<li class="next"><a href="/aspnet/aspnet_button.asp" title="WebForms Button">WebForms Button</a></li>
</ul>
</div>
...
<p>TextBox 控件的属性列在我们的 <a href="/aspnet/control_textbox.asp" title="ASP.NET TextBox 控件">TextBox 控件参考手册</a>中。</p>
...
<p><a href="/tiy/s.asp?f=demo_aspnet_textbox_1">显示这个例子</a></p>
</div>
...
<p><a href="/tiy/s.asp?f=demo_aspnet_textbox_2">显示这个例子</a></p>
...
<p><a href="/tiy/s.asp?f=demo_aspnet_textbox_3">显示这个例子</a></p>
</div>
