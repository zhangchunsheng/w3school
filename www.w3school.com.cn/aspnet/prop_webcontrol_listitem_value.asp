...
<h1>ASP.NET Value 属性</h1>

<div class="backtoreference">
<p><a href="/aspnet/control_listitem.asp" title="ASP.NET ListItem 控件">返回 ASP.NET ListItem 控件参考手册</a></p>
</div>

<div>
<h2>定义和用法</h2>

<p>Value 属性用于设置或返回 ListItem 控件的值。</p>

<h3>语法</h3>
<pre>&lt;asp:ListItem Value=&quot;string&quot; runat=&quot;server&quot; /&gt;</pre>
...
<p>下面的例子设置了 ListBox 控件中 ListItem 的值：</p>
...
<h2>实例</h2>
<dl>
<dt>设置 BulletedList 控件中 ListItem 控件的值</dt>
</dl>
</div>
