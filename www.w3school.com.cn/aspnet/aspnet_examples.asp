...
<title>ASP.NET Web Forms - 实例</title>
...
<li class="currentLink"><a href="/aspnet/aspnet_examples.asp" title="WebForms 实例">WebForms 实例</a></li>
</ul>
<h2>WF 参考手册</h2>
<ul>
...
<h1>ASP.NET Web Forms - 实例</h1>


<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/aspnet/aspnet_navigation.asp" title="WebForms 导航">WebForms 导航</a></li>
<li class="next"><a href="/aspnet/aspnet_refhtmlcontrols.asp" title="WebForms HTML">WebForms HTML</a></li>
</ul>
</div>
