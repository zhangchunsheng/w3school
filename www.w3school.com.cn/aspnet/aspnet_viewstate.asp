...
<li class="currentLink"><a href="/aspnet/aspnet_viewstate.asp" title="WebForms ViewState">WebForms ViewState</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/aspnet/aspnet_forms.asp" title="WebForms 窗体">WebForms 窗体</a></li>
<li class="next"><a href="/aspnet/aspnet_textbox.asp" title="WebForms TextBox">WebForms TextBox</a></li>
</ul>
</div>
...
<p><a href="/tiy/s.asp?f=demo_aspnet_viewstate_classicasp">显示这个例子</a></p>
...
<p><a href="/tiy/s.asp?f=demo_aspnet_button">显示这个例子</a> （请在右边的框架中点击“查看原文档”，您可以看到 ASP .NET 已经向表单中添加了一个隐藏域，这样就可以维持 ViewState。）</p>
</div>
