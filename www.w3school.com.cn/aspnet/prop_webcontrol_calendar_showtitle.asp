...
<title>ASP.NET ShowTitle 属性</title>
</head>
...
<p>ShowTitle 属性用于规定是否显示日历中的标题。</p>
<p>如果 Calendar 显示标题部分，则为 true；否则为 false。默认值为 true。</p>
<p class="note"><span>注释：</span>隐藏标题部分还会隐藏下个月和上个月导航控件，以及月份名称。</p>

<h3>语法</h3>
<pre>&lt;asp:Calendar ShowTitle=&quot;TRUE|FALSE&quot; runat=&quot;server&quot; /&gt;
</pre>
</div>
...
<p>下面的例子把 ShowTitle 设置为 FALSE：</p>

<pre>&lt;form runat=&quot;server&quot;&gt;
&lt;asp:Calendar id=&quot;cal1&quot; runat=&quot;server&quot;
<code>ShowTitle=&quot;FALSE&quot;</code> /&gt;
&lt;/form&gt;</pre>
</div>
