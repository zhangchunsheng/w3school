...
<title>ASP.NET BindingContainer 属性</title>
</head>
...
<h1>ASP.NET BindingContainer 属性</h1>

<div class="backtoreference">
<p><a href="/aspnet/prop_control_standard.asp" title="ASP.NET 控件标准属性">ASP.NET 控件标准属性</a></p>
</div>

<div>
<h2>定义和用法</h2>

<p>BindingContainer 属性获取包含该控件的数据绑定的控件。</p>
<p>BindingContainer 属性包含对 Control 对象的引用，该对象包含当前控件的数据绑定信息。</p>

</div>

<div>
<h2>提示和注释</h2>
<p class="note"><span>注释：</span>此属性支持 .NET 基础结构，但不适合在代码中直接使用。</p>
<p class="note"><span>注释：</span>BindingContainer 属性与 NamingContainer 属性相同，在控件是模板的一部分时除外。在这种情况下，BindingContainer 属性设置为定义模板的 Control。</p>
</div>

<div>
<h2>实例</h2>

<p>本例展示 button 控件的 BindingContainer：</p>

<pre>&lt;script runat=&quot;server&quot;&gt;
Sub Button1_Click(sender As Object, e As EventArgs)
  Response.Write(&quot;The binding container is: &quot;)
  Response.Write(<code>button1.BindingContainer</code>)
End Sub
&lt;/script&gt;
...
<h2>实例</h2>
<dl>
<dt>展示 Button 控件的 BindingContainer</dt>
</dl>
</div>
