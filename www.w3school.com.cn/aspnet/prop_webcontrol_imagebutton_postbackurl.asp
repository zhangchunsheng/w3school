...
<title>ASP.NET PostBackUrl 属性</title>
</head>
...
<p>PostBackUrl 属性用于获取或设置当 ImageButton 控件被点击时要回传的目标页面的 URL。</p>

<h3>语法</h3>
<pre>&lt;asp:ImageButton PostBackUrl=&quot;string&quot; runat=&quot;server&quot; /&gt;</pre>
...
<tr>
<td>string</td>
<td>字符串值。规定要回传的目标页面的 URL。默认是空字符串，这会使页面向自身回传。</td>
</tr>
</table>
</div>
...
<p>下面的例子设置了 ImageButton 控件的 post URL：</p>

<pre>&lt;form runat=&quot;server&quot;&gt;
  Name:&lt;asp:textbox id=&quot;TextBox1&quot; runat=Server /&gt;
  &lt;asp:ImageButton id=&quot;Button1&quot; ImageUrl=&quot;img.gif&quot;
  <code>PostBackUrl=&quot;demo_postbackurl.aspx&quot;</code> runat=&quot;Server&quot; /&gt;
&lt;/form&gt;</pre>
</div>
...
<h2>实例</h2>
<dl>
<dt>为 ImageButton 控件设置 PostBackUrl 属性</dt>
</dl>
</div>
