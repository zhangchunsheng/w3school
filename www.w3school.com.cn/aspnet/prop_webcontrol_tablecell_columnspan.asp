...
<title>ASP.NET ColumnSpan 属性</title>
</head>
...
<h1>ASP.NET ColumnSpan 属性</h1>

<div class="backtoreference">
<p><a href="/aspnet/control_tablecell.asp" title="ASP.NET TableCell 控件">返回 ASP.NET TableCell 控件参考手册</a></p>
</div>

<div>
<h2>定义和用法</h2>

<p>ColumnSpan 属性用于设置或返回在 Table 控件中 TableCell 横跨的列数。</p>

<h3>语法</h3>
<pre>&lt;asp:TableCell <code>ColumnSpan=&quot;num&quot;</code> runat=&quot;server&quot;&gt;
...
<p>下面的例子把 ColumnSpan 设置为 &quot;2&quot;：</p>

<pre>&lt;form runat=&quot;server&quot;&gt;
&lt;asp:Table id=&quot;tab1&quot; runat=&quot;server&quot;&gt;

&lt;asp:TableRow&gt;
&lt;asp:TableCell <code>ColumnSpan=&quot;2&quot;</code>&gt;<span>Some Content</span>&lt;/asp:TableCell&gt;
&lt;/asp:TableRow&gt;

&lt;asp:TableRow&gt;
&lt;asp:TableCell&gt;<span>Some Content</span>&lt;/asp:TableCell&gt;
&lt;asp:TableCell&gt;<span>Some Content</span>&lt;/asp:TableCell&gt;
&lt;/asp:TableRow&gt;
...
<h2>实例</h2>
<dl>
<dt>为 TableCell 控件设置 ColumnSpan 属性</dt>
</dl>
</div>
