...
<title>ASP.NET ForeColor 属性</title>
</head>
...
<p>ForeColor 属性用于设置或返回控件的前景色（通常是文本的颜色）。</p>

<h3>语法</h3>
<pre>&lt;asp:webcontrol id=&quot;id&quot; <code>ForeColor=&quot;color&quot;</code> runat=&quot;server&quot; /&gt;</pre>
...
<tr>
<td>color</td>
<td>设置为控件前景色的颜色。必须是合法的 <a href="/tags/html_ref_colornames.asp" title="HTML 颜色名">HTML 颜色</a>。</td>
</tr>
</table>
</div>
...
<code>ForeColor=&quot;#FF0000&quot;</code> runat=&quot;server&quot; /&gt;
&lt;/form&gt;</pre>
</div>
...
<h2>实例</h2>
<dl>
<dt>设置 Button 控件的 ForeColor</dt>
<dt>设置 Button 控件的 ForeColor（带有声明和脚本）</dt>
</dl>
</div>
