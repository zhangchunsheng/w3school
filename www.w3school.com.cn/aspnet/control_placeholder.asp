...
<title>ASP.NET PlaceHolder 控件</title>
</head>
...
<div>
<h2>定义和用法</h2>
<p>PlaceHolder 控件用于为代码添加的控件预留空间。</p>
<p class="note"><span>注释：</span>PlaceHolder 不会产生任何可见的输出（仅仅是网页上其它控件的容器）。</p>
</div>
