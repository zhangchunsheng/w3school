...
<title>ASP.NET AdvertisementFile 属性</title>
</head>
...
<h1>ASP.NET AdvertisementFile 属性</h1>

<div class="backtoreference">
<p><a href="/aspnet/control_adrotator.asp" title="ASP.NET AdRotator 控件">ASP.NET AdRotator 控件参考手册</a></p>
</div>

<div>
<h2>定义和用法</h2>
<p>AdvertisementFile 属性用于设置或返回包含广告信息的 XML 文件的路径。</p>

<h3>语法</h3>
<pre>&lt;asp:AdRotator AdvertisementFile=&quot;path&quot; runat=&quot;server&quot; /&gt;</pre>
...
<td>path</td>
<td>
<p>字符串值，规定包含广告数据的 XML 文件的位置。</p>

<p>可能的值：</p>

<ul>
<li>绝对路径： (比如 http://www.w3school.com.cn/ads/bigad.xml) </li>
<li>虚拟根路径： (比如 ~/ads/bigad.xml)</li>
<li>相对路径：(比如 ../ads/bigad.xml).</li>
</ul>
</td>
</tr>
</table>
...
<p>下面的例子声明了一个 AdRotator（在 TIY 中查看此 XML 文件）：</p>
...
<h2>实例</h2>
<dl>
<dt>设置 AdRotator 控件中的 AdvertismentFile 属性</dt>
</dl>
</div>
