...
<title>ASP.NET ListItem 控件</title>
</head>
...
<div>
<h2>定义和用法</h2>
<p>ListItem 控件可创建列表中的一个项目。</p>
<p>此控件与这些列表控件一同使用：<a href="/aspnet/control_listbox.asp" title="ASP.NET ListBox 控件">&lt;asp:ListBox&gt;</a> 、<a href="/aspnet/control_radiobuttonlist.asp" title="ASP.NET RadioButtonList 控件">&lt;asp:RadioButtonList&gt;</a> 以及 <a href="/aspnet/control_bulletedlist.asp" title="ASP.NET BulletedList 控件">&lt;asp:BulletedList&gt;</a>。</p>
...
<tr>
<td>Attributes</td>
<td>可选的。此类不直接支持的 ListItem 的属性名和值对的集合。</td>
<td>1.0</td>
</tr>

<tr>
<td><a href="/aspnet/prop_webcontrol_listitem_enabled.asp" title="ASP.NET Enabled 属性">Enabled</a></td>
<td>可选的。规定是否禁用或启用项目。</td>
<td>2.0</td>
</tr>

<tr>
<td><a href="/aspnet/prop_webcontrol_listitem_selected.asp" title="ASP.NET Selected 属性">Selected</a></td>
<td>可选的。规定是否选定该项。</td>
<td>1.0</td>
</tr>

<tr>
<td><a href="/aspnet/prop_webcontrol_listitem_text.asp" title="ASP.NET Text 属性">Text</a></td>
<td>可选的。在 ListItem 中显示的文本。</td>
<td>1.0</td>
</tr>

<tr>
<td><a href="/aspnet/prop_webcontrol_listitem_value.asp" title="ASP.NET Value 属性">Value</a></td>
<td>可选的。ListItem 的值。</td>
<td>1.0</td>
</tr>
</table>
</div>
...
<div>
<h2>ListControl 标准属性</h2>
<pre>AppendDataBoundItems, AutoPostBack, CausesValidation, DataTextField,
DataTextFormatString, DataValueField, Items, runat, SelectedIndex, SelectedItem,
SelectedValue, TagKey, Text, ValidationGroup, OnSelectedIndexChanged</pre>
<p>ListControl 控件包括列表控件的所有基本功能。继承自此控件的控件包括：CheckBoxList, DropDownList, ListBox 以及 RadioButtonList 控件。</p>
<p>如需完整描述，请访问 <a href="/aspnet/control_listcontrol.asp" title="ASP.NET ListControl 控件">ListControl 标准属性</a>。</p>
</div>
...
<div>
<p>有可能使用 Text 或 Value 属性以及 inner HTML 文本来设置显示列表项的文本。</p>

<h3>例子</h3>
<pre>&lt;asp:ListItem Value=&quot;Text1&quot; Text=&quot;Text2&quot;&gt;Text3&lt;/asp:ListItem&gt;</pre>

<p>根据 Text 或 Value 属性以及 inner HTML 文本的组合，可显示不同的文本，并可使用不同的值。下面的表格列出了所有可能的组合以及它们的值：</p>
...
<p class="note"><span>注释：</span>由于 Text 和 Value 属性都具有空字符串默认值，所以列表控件中可能有空列表项。</p>
</div>

<div class="example">
<h2>实例</h2>
<dl>
<dt><a href="/tiy/s.asp?f=demo_aspnet_listitem">在 BulletedList 中的基本 ListItem</a></dt>
<dd>本例展示了 .aspx 文件中带有两个 ListItems 的 BulletedList 控件。</dd>

<dt><a href="/tiy/s.asp?f=demo_aspnet_listitem_text">ListBox 中带有不同属性的 ListItem</a></dt>
<dd>本例展示了 .aspx 文件中带有几个 ListItem 的 ListBox 控件。列表中的文本使用了不同的属性来显示列表项的文本。</dd>

<dt><a href="/tiy/s.asp?f=demo_aspnet_listitem_disabled">ListItem disabled in ListBox</a></dt>
<dd>本例展示了一个带有被禁用的列表项的 ListBox 控件。</dd>

<dt><a href="/tiy/s.asp?f=demo_aspnet_listitem_selected">ListItem selected in RadioButtonList</a></dt>
<dd>本例展示了一个带有已选列表项的 RadioButtonList 控件。</dd>
</dl>
</div>
