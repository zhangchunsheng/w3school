...
<title>ASP.NET LinkButton 控件</title>
</head>
...
<div>
<h2>定义和用法</h2>
<p>LinkButton 控件用于创建超链接样式的按钮。</p>
<p class="note"><span>注释：</span>该控件的外观与 HyperLink 控件相同，但其功能与 Button 控件一样。</p>
</div>
...
<td>规定当 LinkButton 控件被点击时是否验证页面。</td>
<td>1.0</td>
</tr>
...
<tr>
<td><a href="/aspnet/prop_webcontrol_linkbutton_onclientclick.asp" title="ASP.NET OnClientClick 属性">OnClientClick</a></td>
<td>当 LinkButton 控件被点击时被执行的函数的名称。</td>
<td>2.0</td>
</tr>

<tr>
<td><a href="/aspnet/prop_webcontrol_linkbutton_postbackurl.asp" title="ASP.NET PostBackUrl 属性">PostBackUrl</a></td>
<td>当 LinkButton 控件被点击时从当前页面进行回传的目标页面的 URL。</td>
<td>2.0</td>
</tr>
...
<tr>
<td><a href="/aspnet/prop_webcontrol_linkbutton_text.asp" title="ASP.NET Text 属性">Text</a></td>
<td>LinkButton 上的文本。</td>
<td>1.0</td>
</tr>

<tr>
<td><a href="/aspnet/prop_webcontrol_linkbutton_validationgroup.asp" title="ASP.NET ValidationGroup 属性">ValidationGroup</a></td>
<td>当其回传服务器时，该 LinkButton 控件引起的验证所针对的控件组。</td>
<td>2.0</td>
</tr>
</table>
</div>
...
<h2>实例</h2>
<dl>
<dt><a href="/tiy/s.asp?f=demo_aspnet_linkbutton">LinkButton</a></dt>
<dd>在本例中，我们在 .aspx 文件中声明了一个 LinkButton 控件，以及一个 Label 控件。当用户点击这个链接时，会执行 lbClick 子例程。这个子例程会像 Label 控件发送文本 &quot;You clicked the LinkButton control&quot;。</dd>
</dl>
</div>
