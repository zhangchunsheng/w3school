...
<title>ASP.NET DefaultButton 属性</title>
</head>
...
<h1>ASP.NET DefaultButton 属性</h1>
...
<p>DefaultButton 属性用于设置或返回 Panel 控件的默认按钮的 ID。</p>

<p>使用 DefaultButton 属性指示当 Panel 控件具有焦点并且用户按 Enter 键时，哪个按钮会被单击。</p>

<h3>语法</h3>
<pre>&lt;asp:Panel DefaultButton=&quot;button_id&quot; runat=&quot;server&quot;&gt;
Some Content
&lt;/asp:Panel&gt;</pre>
...
<p>下面的例子为 Panel 控件设置了 DefaultButton：</p>

<pre>&lt;form runat=&quot;server&quot;&gt;
&lt;asp:Panel runat=&quot;server&quot; <code>DefaultButton=&quot;bt1&quot;</code>&gt;
...
<h2>实例</h2>
<dl>
<dt>为 Panel 控件设置 DefaultButton 属性</dt>
</dl>
</div>
