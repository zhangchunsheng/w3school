...
<div>
<h2>定义和用法</h2>
<p>Panel 控件用作其它控件的容器。</p>
<p class="tip"><span>提示：</span>此控件常用于以编程方式生成控件，或显示或隐藏控件组。</p>
<p class="note"><span>注释：</span>在 IE 中，此控件呈现为 HTML 的 &lt;div&gt; 元素，在 Mozilla 中呈现为 &lt;table&gt; 标签。</p>
</div>
...
<tr>
<td><a href="/aspnet/prop_webcontrol_panel_backimageurl.asp" title="ASP.NET BackImageUrl 属性">BackImageUrl</a></td>
<td>规定显示控件背景的图像文件的 URL。</td>
<td>1.0</td>
</tr>

<tr>
<td><a href="/aspnet/prop_webcontrol_panel_defaultbutton.asp" title="ASP.NET DefaultButton 属性">DefaultButton</a></td>
<td>规定 Panel 中默认按钮的 ID。</td>
<td>2.0</td>
</tr>

<tr>
<td><a href="/aspnet/prop_webcontrol_panel_direction.asp" title="ASP.NET Direction 属性">Direction</a></td>
<td>规定 Panel 的内容显示方向。</td>
<td>2.0</td>
</tr>

<tr>
<td><a href="/aspnet/prop_webcontrol_panel_groupingtext.asp" title="ASP.NET GroupingText 属性">GroupingText</a></td>
<td>规定 Panel 中控件组的标题。</td>
<td>2.0</td>
</tr>

<tr>
<td><a href="/aspnet/prop_webcontrol_panel_horizontalalign.asp" title="ASP.NET HorizontalAlign 属性">HorizontalAlign</a></td>
<td>规定内容的水平对齐方式。</td>
<td>1.0</td>
</tr>
...
<tr>
<td>runat</td>
<td>规定控件是服务器。必须设置为 &quot;server&quot;。</td>
<td>1.0</td>
</tr>

<tr>
<td><a href="/aspnet/prop_webcontrol_panel_scrollbars.asp" title="ASP.NET ScrollBars 属性">ScrollBars</a></td>
<td>规定 Panel 中滚动栏的位置和可见性。</td>
<td>2.0</td>
</tr>

<tr>
<td><a href="/aspnet/prop_webcontrol_panel_wrap.asp" title="ASP.NET Wrap 属性">Wrap</a></td>
<td>规定内容是否折行。</td>
<td>1.0</td>
</tr>
</table>
...
<h2>实例</h2>
<dl>
<dt><a href="/tiy/s.asp?f=demo_aspnet_panel">Panel</a></dt>
<dd>在本例中，我们在 .aspx 文件中声明了一个 Panel 控件，一个 CheckBox 控件，以及一个 Button 控件。当用户选中 CheckBox 控件并点击刷新按钮时，Panel 控件将隐藏起来。</dd>
</dl>
</div>
