...
<title>ASP.NET DropDownList 控件</title>
</head>
...
<div>
<h2>定义和用法</h2>
<p>DropDownList 控件用于创建下拉列表。</p>
<p>DropDownList 控件中的每个可选项都是由 ListItem 元素定义的！</p>
...
<tr>
<td><a href="/aspnet/prop_webcontrol_dropdownlist_selectedindex.asp" title="ASP.NET SelectedIndex 属性">SelectedIndex</a></td>
<td>可选项的索引号</td>
<td>1.0</td>
</tr>
...
<td>当被选项目的 index 被更改时被执行的函数的名称。</td>
<td>1.0</td>
</tr>
...
<h2>实例</h2>
<dl>
<dt><a href="/tiy/s.asp?f=demo_aspnet_dropdownlist">DropdownList</a></dt>
<dd>在本例中，我们在 .aspx 文件中声明了一个 DropDownList 控件。然后创建了一个事件句柄，在 Click 事件发生时在 Label 控件中显示文本和被选项目。</dd>
</dl>
</div>
