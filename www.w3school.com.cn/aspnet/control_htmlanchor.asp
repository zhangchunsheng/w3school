...
<title>ASP.NET HtmlAnchor 控件</title>
</head>
...
<div>
<h2>定义和用法</h2>
<p>HtmlAnchor 控件用于控制 &lt;a&gt; 元素。</p>
<p>在 HTML 中，&lt;a&gt; 元素用于创建超链接。超链接可链接到书签或其他页面。</p>
</div>
...
<tr>
<td>Title</td>
<td>由浏览器显示的标题（比如 img 元素的 alt 属性）。</td>
</tr>
...
<dl>
<dl><a href="/tiy/s.asp?f=demo_aspnet_htmlanchor">HTMLAnchor</a></dl>
<dd>在本例中，我们在 .aspx 文件中声明了两个 HtmlAnchor 控件（记得把这个控件嵌套在 HtmlForm 控件中）。然后我们在事件句柄中修改这个 HtmlAnchor 控件的 URL、target 以及 title。Page_Load 事件是 ASP.NET 可理解的众多事件之一。</dd>
</dl>
</div>
