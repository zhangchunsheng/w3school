...
<title>ASP.NET NamingContainer 属性</title>
</head>
...
<h1>ASP.NET NamingContainer 属性</h1>
...
<p>NamingContainer 属性获取对服务器控件的命名容器的引用，此引用创建唯一的命名空间，以区分具有相同 Control.ID 属性值的服务器控件。</p>
...
<p>本例展示 button 控件的 NamingContainer：</p>

<pre>&lt;script runat=&quot;server&quot;&gt;
Sub Button1_Click(sender As Object, e As EventArgs)
  Response.Write(&quot;The naming container is: &quot;)
  Response.Write(<code>button1.NamingContainer</code>)
End Sub
&lt;/script&gt;
...
<h2>实例</h2>
<dl>
<dt>展示 Button 控件的 NamingContainer</dt>
</dl>
</div>
