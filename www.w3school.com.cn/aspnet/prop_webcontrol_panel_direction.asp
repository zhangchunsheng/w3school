...
<title>ASP.NET Direction 属性</title>
</head>
...
<h1>ASP.NET Direction 属性</h1>

<div class="backtoreference">
<p><a href="/aspnet/control_panel.asp" title="ASP.NET Panel 控件">返回 ASP.NET Panel 控件参考手册</a></p>
</div>

<div>
<h2>定义和用法</h2>

<p>Direction 属性用于设置或返回 Panel 的内容显示方向。</p>

<p>该属性用于规定 Panel 中包含文本的控件的显示方向。</p>

<h3>语法</h3>
<pre>&lt;asp:Panel Direction=&quot;direction&quot; runat=&quot;server&quot;&gt;
Some Content
&lt;/asp:Panel&gt;</pre>
...
<td>direction</td>
<td>
<p>规定 panel 的内容显示方向。</p>
<p>可能的值：</p>
<ul>
<li>NotSet - 默认。不设置内容方向</li>
<li>LeftToRight - 内容方向为从左到右</li>
<li>RightToLeft - 内容方向为从右到左</li>
</ul>
</td>
</tr>
</table>
...
<p>下面的例子更改了 Panel 控件的 Direction 属性：</p>

<pre>&lt;form runat=&quot;server&quot;&gt;
&lt;asp:Panel id=&quot;pan1&quot; runat=&quot;server&quot; <code>Direction=&quot;RightToLeft&quot;</code>&gt;
...
<h2>实例</h2>
<dl>
<dt>为 Panel 控件设置 Direction 属性</dt>
</dl>
</div>
