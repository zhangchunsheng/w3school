...
<title>ASP.NET GroupingText 控件</title>
</head>
...
<p>GroupingText 属性用于设置或返回 Panel 控件中的控件组的标题文本。</p>

<p>该属性用于为 Panel 控件显示一个框架和标题。</p>
<h3>语法</h3>
<pre>&lt;asp:Panel GroupingText=&quot;string&quot; runat=&quot;server&quot;&gt;
Some Content
&lt;/asp:Panel&gt;</pre>
...
<p>下面的例子为 Panel 控件设置了 GroupingText：</p>

<pre>&lt;form runat=&quot;server&quot;&gt;
&lt;asp:Panel id=&quot;pan1&quot; runat=&quot;server&quot; <code>GroupingText=&quot;Panel&quot;</code> &gt;
Hello!
&lt;/asp:Panel&gt;
&lt;/form&gt;</pre>
</div>
...
<h2>实例</h2>
<dl>
<dt>为 Panel 控件设置 GroupingText 属性</dt>
</dl>
</div>
