...
<li class="currentLink"><a href="/aspnet/aspnet_dbconnection.asp" title="WebForms DbConnection">WebForms 数据库连接</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/aspnet/aspnet_datalist.asp" title="WebForms DataList">WebForms DataList</a></li>
<li class="next"><a href="/aspnet/aspnet_masterpages.asp" title="WebForms Master Pages">WebForms 母版页</a></li>
</ul>
</div>
...
<p><strong>ADO.NET 的职能是处理数据访问。通过 ADO.NET，您就可以操作数据库了。</strong></p>
</div>
...
<h2>实例</h2>
<dl>
<dt><a href="/tiy/s.asp?f=demo_aspnet_dbconn_repeater">数据库连接 - 绑定到 Repeater 控件</a></dt>
<dt><a href="/tiy/s.asp?f=demo_aspnet_dbconn_datalist">数据库连接 - 绑定到 DataList 控件</a></dt>
</dl>
</div>
...
<p><a href="/tiy/s.asp?f=demo_aspnet_dbconn_repeater">显示这个例子</a></p>
</div>
