...
<title>ASP.NET ValidationSummary 控件</title>
</head>
...
<h1>ASP.NET ValidationSummary 控件</h1>
...
<div>
<h2>定义和用法</h2>
<p>ValidationSummary 控件用于在网页、消息框或在这两者中内联显示所有验证错误的摘要。</p>
<p>在该控件中显示的错误消息是由每个验证控件的 ErrorMessage 属性规定的。如果未设置验证控件的 ErrorMessage 属性，就不会为那个验证控件显示错误消息。</p>
</div>
...
<tr>
<td>HeaderText</td>
<td>ValidationSummary 控件中的标题文本。</td>
</tr>
...
<td>布尔值，指示是否在消息框中显示验证摘要。</td>
</tr>

<tr>
<td>ShowSummary</td>
<td>布尔值，规定是否显示验证摘要。</td>
</tr>
</table>
</div>
...
<h2>实例</h2>
<dl>
<dt><a href="/tiy/s.asp?f=demo_aspnet_validationsum_1">Validationsummary</a></dt>
<dd>在本例中，我们使用 ValidationSummary 控件生成了一个用户未填的必选字段的列表。</dd>

<dt><a href="/tiy/s.asp?f=demo_aspnet_validationsum_2">Validationsummary 2</a></dt>
<dd>在本例中，我们使用 ValidationSummary 控件显示了一个提示用户未填的必选字段的消息框。</dd>
</dl>
</div>
