...
<title>ASP.NET OtherMonthDayStyle 属性</title>
</head>
...
<h1>ASP.NET OtherMonthDayStyle 属性</h1>

<div class="backtoreference">
<p><a href="/aspnet/control_calendar.asp" title="ASP.NET Calendar 控件">返回 ASP.NET Calendar 控件参考手册</a></p>
</div>

<div>
<h2>定义和用法</h2>
<p>OtherMonthDayStyle 属性用于设置或返回日历中不属于当前月的日的样式。</p>
...
<pre>&lt;asp:Calendar runat=&quot;server&quot; NextPrevStyle-style=&quot;value&quot; /&gt;</pre>
...
<tr>
<td>style</td>
<td>规定要设置的样式。请参阅 <a href="/aspnet/control_style.asp" title="ASP.NET Style 控件">Style 控件</a>，来查看可能的样式和它们的值。</td>
</tr>
...
<h3>例子 1</h3>
<p>下面的例子显示了设置日历中 OtherMonthDayStyle 属性的一种方法：</p>

<pre>&lt;form runat=&quot;server&quot;&gt;
&lt;asp:Calendar id=&quot;cal1&quot; runat=&quot;server&quot;&gt;
<code>&lt;OtherMonthDayStyle ForeColor=&quot;#FF0000&quot; /&gt;</code>
&lt;/asp:Calendar&gt;
&lt;/form&gt;</pre>

<h3>例子 2</h3>
<p>下面的例子显示了设置日历中 OtherMonthDayStyle 属性的另一种方法：</p>
...
<h2>实例</h2>
<dl>
<dt>设置 Calendar 控件的 OtherMonthDayStyle</dt>
<dt>设置 Calendar 控件的 OtherMonthDayStyle（带有声明和脚本）</dt>
</dl>
</div>
