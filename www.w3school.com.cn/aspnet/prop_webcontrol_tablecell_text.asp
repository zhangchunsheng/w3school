...
<p>Text 属性用于设置或返回 TableCell 控件的文本内容。</p>

<h3>语法</h3>
<pre>&lt;asp:TableCell <code>Text=&quot;string&quot;</code> runat=&quot;server&quot; /&gt;</pre>
...
<p>下面的例子设置了 TableCell 控件的文本：</p>

<pre>&lt;form runat=&quot;server&quot;&gt;
&lt;asp:Table id=&quot;tab1&quot; runat=&quot;server&quot;&gt;
&lt;asp:TableRow&gt;
&lt;asp:TableCell <code>Text=&quot;Hello&quot;</code> /&gt;
&lt;/asp:TableRow&gt;
&lt;/asp:Table&gt;
&lt;/form&gt;</pre>
</div>
...
<h2>实例</h2>
<dl>
<dt>设置 TableCell 控件的 Text 属性</dt>
</dl>
</div>
