...
<title>ASP.NET BackImageUrl 控件</title>
</head>
...
<p>BackImageUrl 属性用于设置或返回 Panel 控件的背景图像的 URL。</p>

<h3>语法</h3>
<pre>&lt;asp:Panel BackImageUrl=&quot;URL&quot; runat=&quot;server&quot;&gt;
Some Content
&lt;/asp:Panel&gt;</pre>
...
<p>下面的例子为 Panel 控件设置了 BackImageUrl：</p>

<pre>&lt;form runat=&quot;server&quot;&gt;
&lt;asp:Panel id=&quot;Pan1&quot; runat=&quot;server&quot; <code>BackImageUrl=&quot;img.gif&quot;</code>&gt;
Hello!
&lt;/asp:Panel&gt;
&lt;/form&gt;</pre>
</div>
...
<h2>实例</h2>
<dl>
<dt>为 Panel 控件设置 BackImageUrl 属性</dt>
</dl>
</div>
