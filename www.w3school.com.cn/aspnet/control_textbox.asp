...
<tr>
<td><a href="/aspnet/prop_webcontrol_textbox_autocompletetype.asp" title="ASP.NET AutoCompleteType 属性">AutoCompleteType</a></td>
<td>规定 TextBox 控件的 AutoComplete 行为。</td>
<td>2.0</td>
</tr>

<tr>
<td><a href="/aspnet/prop_webcontrol_textbox_autopostback.asp" title="ASP.NET AutoPostBack 属性">AutoPostBack</a></td>
...
<td>规定当 Postback 发生时，是否验证页面。</td>
<td>2.0</td>
</tr>

<tr>
<td><a href="/aspnet/prop_webcontrol_textbox_columns.asp" title="ASP.NET Columns 属性">Columns</a></td>
<td>textbox 的宽度。</td>
<td>1.0</td>
</tr>

<tr>
<td><a href="/aspnet/prop_webcontrol_textbox_maxlength.asp" title="ASP.NET MaxLength 属性">MaxLength</a></td>
<td>在 textbox 中所允许的最大字符数。</td>
<td>1.0</td>
</tr>

<tr>
<td><a href="/aspnet/prop_webcontrol_textbox_readonly.asp" title="ASP.NET ReadOnly 属性">ReadOnly</a></td>
<td>规定能否改变文本框中的文本。</td>
<td>1.0</td>
</tr>

<tr>
<td><a href="/aspnet/prop_webcontrol_textbox_rows.asp" title="ASP.NET Rows 属性">Rows</a></td>
<td>textbox 的高度（仅在 TextMode=&quot;Multiline&quot; 时使用）。</td>
<td>1.0</td>
</tr>

<tr>
<td>runat</td>
<td>规定该控件是否是服务器控件。必须设置为 &quot;server&quot;。</td>
<td>&nbsp;</td>
</tr>
...
<tr>
<td><a href="/aspnet/prop_webcontrol_textbox_text.asp" title="ASP.NET Text 属性">Text</a></td>
<td>textbox 的内容。</td>
<td>1.0</td>
</tr>

<tr>
<td><a href="/aspnet/prop_webcontrol_textbox_textmode.asp" title="ASP.NET TextMode 属性">TextMode</a></td>
<td>规定 TextBox 的行为模式（单行、多行或密码）。</td>
<td>1.0</td>
</tr>

<tr>
<td>ValidationGroup</td>
<td>当 Postback 发生时，被验证的控件组。</td>
<td>&nbsp;</td>
</tr>

<tr>
<td><a href="/aspnet/prop_webcontrol_textbox_wrap.asp" title="ASP.NET Wrap 属性">Wrap</a></td>
<td>布尔值，指示 textbox 的内容是否换行。</td>
<td>1.0</td>
</tr>

<tr>
<td>OnTextChanged</td>
<td>当 textbox 中的文本被更改时，被执行的函数的名称。</td>
<td>&nbsp;</td>
</tr>
</table>
</div>
...
<h2>实例</h2>
<dl>
<dt><a href="/tiy/s.asp?f=demo_aspnet_textbox_2">Textbox</a></dt>
<dd>在本例中，我们在 .aspx 文件中声明了一个 TextBox 控件，一个 Button 控件，以及一个 Label 控件。当提交按钮被触发时，会执行 submit 子例程。这个 submit 子例程会向 Label 控件输出文本。</dd>

<dt><a href="/tiy/s.asp?f=demo_aspnet_textbox_4">Textbox 2</a></dt>
<dd>在本例中，我们在 .aspx 文件中声明了一个 TextBox 控件，一个 Button 控件，以及一个 Label 控件。当提交按钮被触发时，会执行 submit 子例程。这个 submit 子例程会把文本框的内容拷贝到 Label 控件。</dd>
</dl>
</div>
