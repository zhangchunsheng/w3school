...
<title>ASP.NET TodaysDate 属性</title>
</head>
...
<div>
<h2>定义和用法</h2>
<p>TodaysDate 属性用于设置或返回日历的当前日期。</p>

<p>如果未显式设置此属性，则此日期将为服务器上的日期。</p>
</div>
...
Sub Page_Load
  ...
  Response.Write(<code>cal1.TodaysDate.ToShortDateString()</code>)
End Sub
&lt;/script&gt;
