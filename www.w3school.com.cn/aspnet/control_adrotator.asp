...
<title>ASP.NET AdRotator 控件</title>
</head>
...
<p>AdRotator 控件用于显示图像序列。</p>
<p>该控件使用 XML 文件来存储 ad 信息。XML 文件使用 &lt;Advertisements&gt; 开始和结束。在 &lt;Advertisements&gt; 标签内部，应该有若干个定义每条 ad 的 &lt;Ad&gt; 标签。</p>
<p>&lt;Ad&gt; 标签中预定义的元素被列在下面：</p>
...
<tr>
<td><a href="/aspnet/prop_webcontrol_adrotator_advertisementfile.asp" title="ASP.NET AdvertisementFile 属性">AdvertisementFile</a></td>
<td>包含 ad 信息的 XML 文件的路径。</td>
<td>1.0</td>
</tr>

<tr>
<td>AlternateTextField</td>
<td>代替广告的 Alt 文本而使用的数据字段。</td>
<td>2.0</td>
</tr>

<tr>
<td>ImageUrlField</td>
<td>代替广告的 ImageURL 属性而使用的数据字段。</td>
<td>2.0</td>
</tr>
...
<td>代替广告的 NavigateUrl 属性而使用的数据字段。</td>
<td>2.0</td>
</tr>
...
<tr>
<td><a href="/aspnet/prop_webcontrol_adrotator_target.asp" title="ASP.NET Target 属性">Target</a></td>
<td>在何处打开 URL。</td>
<td>1.0</td>
</tr>
</table>
...
<h2>实例</h2>
<dl>
<dt><a href="/tiy/s.asp?f=demo_aspnet_adrotator">AdRotator</a></dt>
<dd>在本例中，我们在 .aspx 文件中声明了一个 AdRotator 控件。然后我们再 .aspx 文件中为 AdCreated 事件创建了一个事件句柄，来覆盖 XML 文件中 NavigateUrl 元素的值。</dd>
</dl>
</div>
