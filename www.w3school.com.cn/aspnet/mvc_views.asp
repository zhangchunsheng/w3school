...
<li class="currentLink"><a href="/aspnet/mvc_views.asp" title="MVC 视图">MVC 视图</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/aspnet/mvc_controllers.asp" title="MVC 控制器">MVC 控制器</a></li>
<li class="next"><a href="/aspnet/mvc_database.asp" title="MVC 数据库">MVC 数据库</a></li>
</ul>
</div>
