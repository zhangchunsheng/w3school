...
<title>ASP.NET HtmlForm 控件</title>
</head>
...
<h1>ASP.NET HtmlForm 控件</h1>

<div class="backtoreference">
<p><a href="/aspnet/aspnet_refhtmlcontrols.asp" title="HTML 服务器控件">HTML 服务器控件参考手册</a></p>
</div>
...
<p>HtmlForm 控件用于控制 &lt;form&gt; 元素。在 HTML 中，&lt;form&gt; 元素用于创建表单。</p>

<p class="note"><span>注释：</span>所有 HTML 服务器控件必须位于 HtmlForm 控件内部！</p>

<p class="note"><span>注释：</span>在一张页面内，您只能使用一个 HtmlForm 控件！</p>
</div>
...
<td>Action</td>
<td>
<p>URL，定义当提交表单时把数据送往何处。</p>
<p>注释：该属性总是设置为页面自身的 URL！</p>
</td>
</tr>
...
<tr>
<td>InnerHtml</td>
<td><p>设置或返回该 HTML 元素的开始标签和结束标签之间的内容。</p><p>特殊字符不会被自动转换为 HTML 实体。</p></td>
</tr>

<tr>
<td>InnerText</td>
<td><p>设置或返回该 HTML 元素的开始标签和结束标签之间的所有文本。</p><p>特殊字符会被自动转换为 HTML 实体。</p></td>
</tr>

<tr>
<td>Method</td>
<td>表单向服务器传送数据的方式。合法的值是 &quot;post&quot; 和 &quot;get&quot;。默认是 &quot;post&quot;。</td>
</tr>
...
<h2>实例</h2>
<dl>
<dl><a href="/tiy/s.asp?f=demo_aspnet_htmlinputbutton">HTMLForm</a></dl>
<dd>在本例中，我们在 .aspx 文件中声明了一个 HtmlInputText 控件，一个 HtmlInputButton 控件，以及一个 HtmlGeneric 控件（记得把这个控件嵌套在 HtmlForm 控件中）。当 submit 按钮被触发时，就会执行 submit 子例程。这个 submit 子例程会向 p 元素写一条欢迎消息。</dd>
</dl>
</div>
