...
<title>ASP.NET ListBox 控件</title>
</head>
...
<div>
<h2>定义和用法</h2>
<p>ListBox 控件用于创建但选货多选的下拉列表。</p>
<p>ListBox 控件中的可选项目是通过 ListItem 元素定义的！</p>
...
<tr>
<td><a href="/aspnet/prop_webcontrol_listbox_rows.asp" title="ASP.NET Rows 属性">Rows</a></td>
<td>在列表中显示的行数。</td>
<td>1.0</td>
</tr>

<tr>
<td><a href="/aspnet/prop_webcontrol_listbox_selectionmode.asp" title="ASP.NET SelectionMode 属性">SelectionMode</a></td>
<td>允许单选还是多选。</td>
<td>1.0</td>
</tr>
</table>
...
<h2>实例</h2>
<dl>
<dt><a href="/tiy/s.asp?f=demo_aspnet_listbox">Listbox</a></dt>
<dd>在本例中，我们在 .aspx 文件中声明一个 ListBox 控件。然后我们创建了一个事件句柄，当发生 Click 事件时，该句柄会在 Label 控件中显示文本和被选项目。</dd>
</dl>
</div>
