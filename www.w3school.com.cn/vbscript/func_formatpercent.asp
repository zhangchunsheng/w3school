...
<title>VBScript FormatPercent 函数</title>
</head>
...
<div id="maincontent">
<h1>VBScript FormatPercent 函数</h1>
...
<div>
<h2>定义和用法</h2>
<p>FormatPercent  函数可返回作为百分数被格式化的表达式（尾随有 % 符号的百分比（乘以 100 ））。</p>

<h3>语法</h3>
<pre>FormatPercent(Expression[,NumDigAfterDec[,
...
<h3>例子 1</h3>
<pre>' 6 是 345 的百分之几?
document.write(FormatPercent(6/345))</pre>
<p>输出：</p>
<pre>1.74%</pre>

<h3>例子 2</h3>
<pre>' 6 是 345 的百分之几?
document.write(FormatPercent(6/345,1))</pre>
<p>输出：</p>
<pre>1.7%</pre>
</div>
