...
<title>VBScript GetLocale 函数</title>
</head>
...
<div>
<h2>定义和用法</h2>
<p>GetLocale 函数可返回当前的 locale ID 。</p>
<p>locale 是用户参考信息集合，比如用户的语言、国家和文化传统。locale 决定键盘布局、字母排序顺序和日期、时间、数字与货币格式等等。</p>
<p>返回值可以是任意一个 32-位 的值，如 <a href="#localeid">区域设置 ID</a> 所示。</p>
