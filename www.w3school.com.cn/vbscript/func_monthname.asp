...
<title>VBScript MonthName 函数</title>
</head>
...
<div>
<h2>定义和用法</h2>
<p>MonthName 函数可返回指定的月份的名称。</p>

<h3>语法</h3>
<pre>MonthName(month[,abbreviate])</pre>
...
<table class="dataintable"> 
  ...
  <tr>
    <td>month</td>
    <td>必需的。规定月的数字。（比如一月是1，二月是2，依此类推。）</td>
  </tr>
  <tr>
    <td>abbreviate</td>
    <td>可选的。一个布尔值，指示是否缩写月份名称。默认是 False。</td>
  </tr>
</table>
</div>
...
<h2>实例</h2>
<h3>例子 1</h3>
<pre>document.write(MonthName(8))</pre>
<p>输出：</p>
<pre>八月</pre>

<h3>例子 2</h3>
<pre>document.write(MonthName(8,true))</pre>
<p>输出：</p>
<pre>Aug</pre>
<p class="note"><span>注释：</span>在中文系统中，仍然输出为“八月”。</p>
</div>
