...
<div>
<h2>定义和用法</h2>
<p>CSng 函数可把表达式转换为单精度（Single）类型。</p>
<p class="note"><span>注释：</span>如果表达式在 Single 子类型允许的范围之外，则发生错误。</p>
