...
<title>VBScript IsArray 函数</title>
</head>
...
<div>
<h2>定义和用法</h2>
<p>IsArray 函数可返回一个指示指定的变量是否为数组的布尔值。如果变量为数组，则返回 True，否则返回 False。</p>

<h3>语法</h3>
<pre>IsArray(variable)</pre>
