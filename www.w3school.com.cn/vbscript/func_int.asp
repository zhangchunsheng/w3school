...
<div>
<h2>定义和用法</h2>
<p>Int 函数可返回指定数字的整数部分。</p>
<p class="note"><span>注释：</span>若 number 参数包含 Null ，则返回 Null 。</p>
<p class="tip"><span>提示：</span>请参阅 Fix 函数。Int 和 Fix 函数都删除 number 参数的小数部分并返回以整数表示的结果。</p>
<p>Int 和 Fix 函数的区别在于如果 number 参数为负数时，Int 函数返回小于或等于 number 的第一个负整数，而 Fix 函数返回大于或等于 number 参数的第一个负整数。例如，Int 将 -8.4 转换为 -9，而 Fix 函数将 -8.4 转换为 -8。</p>
...
<h2>实例</h2>
<h3>例子 1</h3>
<pre>document.write(Int(6.83227))</pre>
<p>输出：</p>
<pre>6</pre>

<h3>例子 2</h3>
<pre>document.write(Int(6.23443))</pre>
<p>输出：</p>
<pre>6</pre>

<h3>例子 3</h3>
<pre>document.write(Int(-6.13443))</pre>
<p>输出：</p>
<pre>-7</pre>

<h3>例子 4</h3>
<pre>document.write(Int(-6.93443))</pre>
<p>输出：</p>
<pre>-7</pre>
</div>
