...
<title>VBScript TimeValue 函数</title>
</head>
...
<div>
<h2>定义和用法</h2>
<p>TimeValue 函数可返回包含时间的日期子类型的变量。</p>
<p><strong>TimeValue 函数可用来取出参数的时间部分。</strong></p>
<p class="note"><span>注释：</span>若参数不含时间，则 TimeValue 将返回0，若输出结果则是 12:00:00 AM。</p>

<h3>语法</h3>
<pre>TimeValue(time)</pre>
...
<table class="dataintable"> 
  ...
  <tr>
    <td>time</td>
    <td>必需的。介于 0:00:00 (12:00:00 A.M.) - 23:59:59 (11:59:59 P.M.) 的时间，或任何可表示此范围内时间的表达式。</td>
  </tr>
  </table>
</div>
...
<pre>
D = #7/1/96 13:30:00#
document.write(TimeValue(D))</pre>
<p>输出：</p>
<pre>13:30:00 或 1:30:00 PM</pre>

<h3>例子 2</h3>
<pre>D = &quot;7/1/96 13:30:00&quot;
document.write(TimeValue(D)) '只要能够判断，字符串也能接受。</pre>
<p>输出：</p>
<pre>13:30:00 或 1:30:00 PM</pre>

<h3>例子 3</h3>
<pre>D = &quot;7/1/96&quot;
document.write(TimeValue(D)) '只有日期</pre>
<p>输出：</p>
<pre>12:00:00 AM '相当于0</pre>
</div>
