...
<title>VBScript FormatCurrency 函数</title>
</head>
...
<div id="maincontent">
<h1>VBScript FormatCurrency 函数</h1>
...
<div>
<h2>定义和用法</h2>
<p>FormatCurrency 函数可返回作为货币值被格式化的表达式，使用系统控制面板中定义的货币符号。</p>

<h3>语法</h3>
<pre>FormatCurrency(Expression[,NumDigAfterDec[,
IncLeadingDig[,UseParForNegNum[,GroupDig]]]])</pre>
...
<table class="dataintable"> 
  ...
  <tr>
    ...
    <td>指示小数点右侧显示位数的数值。默认值为 -1（使用的是计算机的区域设置）。</td>
  </tr>
  <tr>
    <td>IncLeadingDig</td>
    <td>可选的。指示是否显示小数值的前导零（leading zero）：<ul>
      <li>-2 = TristateUseDefault - 使用计算机区域设置中的设置。</li>
  ...
  <tr>
    <td>GroupDig</td>
    <td>可选的。指示是否使用计算机区域设置中指定的数字分组符号将数字分组。
	<ul>
      <li>-2 = TristateUseDefault - 使用计算机区域设置中的设置。</li>
      <li>-1 = TristateTrue - True </li>
      <li>0 = TristateFalse - False</li>
...
<h2>实例</h2>
<h3>例子 1</h3>
<pre>document.write(FormatCurrency(20000))</pre>
<p>输出：</p>
<pre>￥20,000.00 </pre>

<h3>例子 2</h3>
<pre>document.write(FormatCurrency(20000.578,2))</pre>
<p>输出：</p>
<pre>￥20,000.58 </pre>

<h3>例子 3</h3>
<pre>document.write(FormatCurrency(20000.578,2,,,0))</pre>
<p>输出：</p>
<pre>￥20000.58</pre>
</div>
