...
<title>VBScript IsEmpty 函数</title>
</head>
...
<div>
<h2>定义和用法</h2>
<p>IsEmpty 函数可返回指定的变量是否被初始化的布尔值。如果未被初始化，则返回 true ，否则返回 False 。</p>
