...
<p class="tip"><span>提示：</span>请参阅 <a href="/vbscript/func_instrrev.asp" title="VBScript InStrRev 函数">InStrRev 函数</a>。</p>
...
pos=<code>InStr(4,txt,&quot;is&quot;,1)</code>
document.write(pos)</pre>
<p>输出：</p>
<pre>6</pre>
