...
<title>VBScript LBound 函数</title>
</head>
...
<div>
<h2>定义和用法</h2>
<p>LBound 函数可返回指示数组维数的最小下标。</p>
<p class="note"><span>注释：</span>任何维数的 LBound 总是 0。</p>
<p class="tip"><span>提示：</span>LBound 函数与 UBound 函数共同使用，可以确定数组的大小。使用 UBound 函数可以找到数组某一维的上界。</p>
...
<table class="dataintable"> 
  ...
  <tr>
    <td>dimension</td>
    <td>可选的。要返回哪一维的下界。 1 = 第一维， 2 =  第二维，以此类推。默认是 1 。</td>
  </tr>
</table>
</div>
