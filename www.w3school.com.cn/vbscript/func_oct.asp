...
<p>Oct 函数可返回表示指定数字八进制值的字符串。</p>

<p class="note"><span>注释：</span>如果 <i>number</i> 参数不是整数，则在进行运算前将其四舍五入为最接近的整数。</p>

<h3>语法</h3>

<pre>Oct(<i>number</i>)</pre>
...
<table class="dataintable"> 
  ...
  <tr>
	...
	<p>如果 <i>number</i> 是：</p>
    <ul>
      <li>Null - 那么 Oct 函数会返回 Null。</li>
      <li>Empty - 那么 Oct 函数会返回零 (0)。</li>
      <li>其他数 - 那么 Oct 函数会返回最多 11 个十六进制字符。</li>
    </ul>
	</td>
  </tr>
</table>
...
<p><a href="/tiy/t.asp?f=vbst_oct_func">亲自试一试</a></p>
</div>
