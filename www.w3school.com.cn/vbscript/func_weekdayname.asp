...
<title>VBScript WeekdayName 函数</title>
</head>
...
<div>
<h2>定义和用法</h2>
<p>WeekdayName 函数可返回一周中指定一天的星期名。</p>
<p class="note"><span>注释：</span>在英文 Windows 环境下，返回值是 &quot;Sunday&quot;、&quot;Monday&quot; 、... ...</p>

<h3>语法</h3>
<pre>WeekdayName(weekday[,abbreviate[,firstdayofweek]])</pre>
...
<h3>例子 1</h3>
<pre>
document.write(WeekdayName(3))</pre>
<p>输出：</p>
<pre>星期二</pre>
...
<pre>
D = #2007/10/1#
document.write(WeekdayName(Weekday(D)))</pre>
<p>输出：</p>
<pre>星期一</pre>
...
<pre>
D = #2007/10/1#
document.write(WeekdayName(Weekday(Date),true))</pre>
<p>输出：</p>
<pre>星期一 或 Mon</pre>
</div>
