...
<div>
<h2>定义和用法</h2>
<p>Right 函数可从字符串右侧返回指定数目的字符。</p>
<p class="tip"><span>提示：</span>请使用Len 函数来确定字符串中的字符数目。</p>
<p class="tip"><span>提示：</span>请参阅 Left 函数。</p>
...
<table class="dataintable"> 
  ...
  <tr>
    <td>string</td>
    <td>必需的。从其中返回字符的字符串。</td>
  </tr>
  <tr>
    <td>length</td>
    <td>必需的。规定返回多少字符。如果设置为 0，则返回空字符串 (&quot;&quot;)。如果设置为大于或等于字符串的长度，则返回整个的字符串。</td>
  </tr>
</table>
</div>
...
document.write(Right(txt,11))</pre>
<p>输出：</p>
<pre>utiful day!</pre>
...
<pre>dim txt
txt=&quot;This is a beautiful day!&quot;
document.write(Right(txt,100))</pre>
<p>输出：</p>
...
txt=&quot;This is a beautiful day!&quot;
x=Len(txt)
document.write(Right(txt,x))</pre>
<p>输出：</p>
<pre>This is a beautiful day!</pre>
</div>
