...
<div>
<h2>定义和用法</h2>
<p>Exp 函数可e（自然对数的底）的幂次方。</p>
<p class="note"><span>注释：</span>值不能超过 709.782712893 。常数 e 的值约为 2.718282。</p>
<p class="tip"><span>提示：</span>请参阅 Log 函数。Exp 函数完成 Log 函数的反运算，并且有时引用为反对数形式。</p>
...
<h2>实例</h2>
<h3>例子 1</h3>
<pre>document.write(Exp(6.7))</pre>
<p>输出：</p>
<pre>812.405825167543</pre>

<h3>例子 2</h3>
<pre>document.write(Exp(-6.7))</pre>
<p>输出：</p>
<pre>1.23091190267348E-03</pre>
</div>
