...
<table class="dataintable"> 
  ...
  <tr>
    <td>red</td>
    <td>必需的。介于 0 - 255 之间（且包括）的数字，代表颜色红色部分。</td>
  </tr>
  <tr>
    <td>green</td>
    <td>必需的。介于 0 - 255 之间（且包括）的数字，代表颜色绿色部分。</td>
  </tr>
  <tr>
    <td>blue</td>
    <td>必需的。介于 0 - 255 之间（且包括）的数字，代表颜色蓝色部分。</td>
  </tr>
</table>
</div>
...
<h2>实例</h2>
<h3>例子 1</h3>
<pre>document.write(rgb(255,0,0))</pre>
<p>输出：</p>
<pre>255</pre>

<h3>例子 2</h3>
<pre>document.write(rgb(255,30,30))</pre>
<p>输出：</p>
<pre>1974015</pre>
</div>
