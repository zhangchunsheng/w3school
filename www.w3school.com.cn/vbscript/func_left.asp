...
<div>
<h2>定义和用法</h2>
<p>Left 函数可从字符串的左侧返回指定数目的字符。</p>
<p class="tip"><span>提示：</span>请使用 Len 函数来确定字符串中的字符数目。</p>
<p class="tip"><span>提示：</span>请参阅 Right 函数。</p>
...
<table class="dataintable"> 
  ...
  <tr>
    <td>length</td>
    <td>必需的。规定需返回多少字符。如果设置为 0，则返回空字符串(&quot;&quot;)。如果设置为大于或等于字符串的长度，则返回整个字符串。</td>
  </tr>
</table>
</div>
...
document.write(Left(txt,11))</pre>
<p>输出：</p>
<pre>This is a b</pre>
...
<pre>dim txt
txt=&quot;This is a beautiful day!&quot;
document.write(Left(txt,100))</pre>
<p>输出：</p>
