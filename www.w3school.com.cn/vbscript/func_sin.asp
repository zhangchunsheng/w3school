...
<div>
<h2>定义和用法</h2>
<p>Sin 函数可返回指定数字（角度）的正弦。</p>
<p>Sin 函数取某个角并返回直角三角形两边的比值。此比值是直角三角形中该角的对边长度与斜边长度之比。结果的范围在 -1 到 1 之间。</p>
<p class="note"><span>注释：</span>将角度乘以 pi/180 即可转换为弧度，将弧度乘以 180/pi 即可转换为角度。</p>
...
<h2>实例</h2>
<h3>例子 1</h3>
<pre>document.write(Sin(47))</pre>
<p>输出：</p>
<pre>0.123573122745224</pre>
