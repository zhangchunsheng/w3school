...
<title>VBScript GetRef 函数</title>
</head>
...
<div>
<h2>定义和用法</h2>
<p>GetRef 函数可把一段 VBScript 过程（子程序）连接到页面的一个 DHTML 事件上。</p>

<h3>语法</h3>
<pre>Set object.event=GetRef(procname)</pre>
...
<table class="dataintable"> 
  ...
  <tr>
    <td>object</td>
    <td>必需的。事件所关联的对象的名称。</td>
  </tr>
  <tr>
    <td>event</td>
    <td>Required. 要与函数绑定的事件的名称。</td>
  </tr>
  <tr>
    <td>procname</td>
    <td>Required. 与事件关联的 Sub 或 Function 过程的名称。</td>
  </tr>
</table>
</div>
