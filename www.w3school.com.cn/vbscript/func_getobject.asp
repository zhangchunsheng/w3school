...
<title>VBScript GetObject 函数</title>
</head>
...
<div>
<h2>定义和用法</h2>
<p>GetObject 函数可返回对文件中 Automation 对象的引用。</p>
...
<table class="dataintable"> 
  ...
  <tr>
    <td>pathname</td>
    <td>可选的。包含 automation 对象的文件的完整路径和名称。如果此参数被忽略，就必须有 class 参数。</td>
  </tr>
  <tr>
    <td>class</td>
    <td>可选的。automation 对象的类。此参数使用此语法：appname.objectype。</td>
  </tr>
</table>
</div>
