...
<title>VBScript IsObject 函数</title>
</head>
...
<div>
<h2>定义和用法</h2>
<p>IsObject 函数可返回指示是否指定的表达式是一个 automation 对象的布尔值。如果表达式是对象，则返回 True 。否则返回 False。</p>

<h3>语法</h3>
<pre>IsObject(expression)</pre>
