...
<title>VBScript InStrRev 函数</title>
</head>
...
<p class="tip"><span>提示：</span>请参阅 <a href="/vbscript/func_instr.asp" title="VBScript InStr 函数">InStr 函数</a>。</p>

<h3>语法</h3>
<pre>InStrRev(string1,string2[,start[,compare]])</pre>
...
pos=<code>InStrRev(txt,&quot;his&quot;)</code>
document.write(pos)</pre>
<p>输出：</p>
<pre>2</pre>
...
txt=&quot;This is a beautiful day!&quot;
'textual comparison
pos=<code>InStrRev(txt,&quot;B&quot;,-1,1)</code>
document.write(pos)</pre>
<p>输出：</p>
<pre>11</pre>
