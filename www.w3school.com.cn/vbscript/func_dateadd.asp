...
<title>VBScript DateAdd 函数</title>
</head>
...
<table class="dataintable"> 
  ...
  <tr>
    ...
    <td valign="top">必需的。需要添加的时间间隔的数目。可对未来的日期使用正值，对过去的日期使用负值。</td>
  </tr>
  <tr>
    <td valign="top">date</td>
    <td valign="top">必需的。代表被添加的时间间隔的日期的变量或文字。</td>
  </tr>
</table>
</div>
...
<h2>实例</h2>
<h3>例子 1</h3>
<p>给 January 31, 2000 增加一个月：</p>
<pre>document.write(DateAdd(&quot;m&quot;,1,&quot;31-Jan-00&quot;))</pre>
<p>输出：</p>
<pre>2/29/2000</pre>

<h3>例子 1</h3>
<p>给 January 31, 2001 增加一个月：</p>
<pre>document.write(DateAdd(&quot;m&quot;,1,&quot;31-Jan-01&quot;))</pre>
<p>输出：</p>
<pre>2/28/2001</pre>

<h3>例子 1</h3>
<p>从 January 31, 2001 减去一个月：</p>
<pre>document.write(DateAdd(&quot;m&quot;,-1,&quot;31-Jan-01&quot;))</pre>
<p>输出：</p>
<pre>12/31/2000</pre>
</div>
...
<h3>TIY</h3>
<dl>
<dt><a href="/tiy/t.asp?f=vbst_dateadd_func">DateAdd</a></dt>
<dd>如何使用 DateAdd 函数为日期增加一个月。</dd>

<dt><a href="/tiy/t.asp?f=vbst_dateadd_func2">DateAdd</a></dt>
<dd>如何使用 DateAdd 函数从日期减去一个月。</dd>
</dl>
</div>
