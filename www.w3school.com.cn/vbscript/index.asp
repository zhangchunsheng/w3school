...
<ul>
<li class="currentLink"><a href="/vbscript/index.asp" title="VBScript 教程">VB 教程</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/vbscript/index.asp" title="VBScript 教程">VB 教程</a></li>
<li class="next"><a href="/vbscript/vbscript_intro.asp" title="VBScript 简介">VB 简介</a></li>
</ul>
</div>

<div>
<p><strong>VBScript 是微软公司出品的脚本语言。</strong></p>
<p><strong>在我们的 VBScript 教程中，你可以学习如何写 VBScript，以及如何在你的HTML文件中插入这些代码，以使得这些 WEB 页面动态性和交互性更强。</strong></p>
<p><a href="/vbscript/vbscript_intro.asp" title="VBScript 简介">开始学习 VBScript</a>！</p>
</div>

<div>
<h2>VBScript 实例</h2>
<p>通过实例进行学习。使用我们的编辑器，你可以编辑源代码，然后单击 test 按钮来查看结果。</p>
<p><a href="/example/vbst_examples.asp" title="VBScript实例">VBScript 实例</a></p>
</div>

<div>
<h2>VBScript 参考手册</h2>
<p>在 W3School，我们提供完整的 VBScript 参考手册。</p>
<p><a href="/vbscript/vbscript_ref_functions.asp" title="VBScript Reference">VBScript 参考手册</a></p>
</div>
