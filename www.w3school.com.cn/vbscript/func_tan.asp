...
<div>
<h2>定义和用法</h2>
<p>Tan 函数可返回指定数字（角度）的正切。</p>
<p>Tan 取某个角并返回直角三角形两个直角边的比值。此比值是直角三角形中该角的对边长度与邻边长度之比。</p>
...
<h2>实例</h2>
<h3>例子 1</h3>
<pre>document.write(Tan(40))</pre>
<p>输出：</p>
<pre>-1.1172149309239</pre>
</div>
