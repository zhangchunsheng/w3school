...
<title>VBScript IsDate 函数</title>
</head>
...
<div>
<h2>定义和用法</h2>
<p>IsDate 函数可一个布尔值，指示经计算的表达式是否可被转换为日期。如果表达式是日期，或可被转换为日期，则返回 True 。否则，返回 False 。</p>

<p><strong>注释：</strong>IsDate 函数使用本地设置来检测字符串是否可以转换为日期。</p>
<h3>语法</h3>
