...
<div>
<h2>定义和用法</h2>
<p>Sqr 函数可返回一个数的平方根。</p>
<p class="note"><span>注释：</span>number 参数不能是负值。</p>
...
<h2>实例</h2>
<h3>例子 1</h3>
<pre>document.write(Sqr(9))</pre>
<p>输出：</p>
<pre>3</pre>

<h3>例子 2</h3>
<pre>document.write(Sqr(0))</pre>
<p>输出：</p>
<pre>0</pre>

<h3>例子 3</h3>
<pre>document.write(Sqr(47))</pre>
<p>输出：</p>
<pre>6.85565460040104</pre>
</div>
