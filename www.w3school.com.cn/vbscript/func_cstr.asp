...
<div>
<h2>定义和用法</h2>
<p>CStr 函数可把表达式转换为字符串（String）类型。</p>
<p class="note"><span>注释：</span>若表达式的类型不同，那么 CStr <a href="#result">输出的结果</a>也会有所不同。</p>
...
<h3><a id="result">当表达式为不同的值时，CStr 返回的结果：</a></h3>
<table class="dataintable">
<tr>
<th>表达式可能的值</th>
<th>CStr 相应的返回结果</th>
...
<tr>
<td>Boolean</td>
<td>字符串，包含 True 或 False。</td>
</tr>

<tr>
<td>Date</td>
<td>字符串，包含系统的短日期格式日期。</td>
</tr>

<tr>
<td>Null</td>
<td>会发生 run-time 错误。</td>
</tr>
