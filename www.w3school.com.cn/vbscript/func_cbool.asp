...
<table class="dataintable"> 
  ...
  <tr>
    <td>expression</td>
    <td>必需的。任何合法的表达式。非零的值返回 True，零返回 False。如果表达式不能解释为数值，则将发生 run-time  错误。</td>
  </tr>
</table>
</div>
