...
<div>
<h2>定义和用法</h2>
<p>CInt 函数可把表达式转换为整数（Integer）类型。</p>
<p class="note"><span>注释：</span>值必须是介于 -32768 与 32767 之间的数字。</p>
<p class="note"><span>注释：</span>CInt 不同于 Fix 和 Int 函数删除数值的小数部分，而是采用四舍五入的方式。 当小数部分正好等于 0.5 时, CInt 总是将其四舍五入成最接近该数的偶数。例如， 0.5 四舍五入为 0, 以及 1.5 四舍五入为 2.</p>
