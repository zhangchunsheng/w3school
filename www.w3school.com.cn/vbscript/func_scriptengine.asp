...
<title>VBScript ScriptEngine, ScriptEngineBuildVersion, ScriptEngineMajorVersion, 以及 ScriptEngineMinorVersion 函数</title>
</head>
...
<div id="maincontent">
<h1>VBScript ScriptEngine, ScriptEngineBuildVersion, ScriptEngineMajorVersion, 以及 ScriptEngineMinorVersion 函数</h1>
...
<div>
<h2>ScriptEngine 函数</h2>
<p>ScriptEngine 函数可返回当前使用的脚本语言。</p>
<p>此函数可返回下面的字符串：</p>
<ul>
    <li>VBScript - 指示当前使用的脚本引擎是 Microsoft(R) Visual Basic(R) Scripting Edition</li>
    <li>JScript - 指示当前使用的编写脚本引擎是 Microsoft Visual Basic Scripting Edition(R)。</li>
    <li>VBA - 指示当前使用的脚本引擎是 Microsoft Visual Basic for Applications。</li>
</ul>
</div>

<div>
<h2>ScriptEngineBuildVersion 函数</h2>
<p>ScriptEngineBuildVersion 函数可返回当前在用的脚本引擎的版本号。</p>
</div>

<div>
<h2>ScriptEngineMajorVersion 函数</h2>
<p>ScriptEngineMajorVersion 函数可返回当前在用的脚本引擎的主版本号。</p>
</div>

<div>
<h2>ScriptEngineMinorVersion 函数</h2>
<p>ScriptEngineMinorVersion 函数可返回当前在用的脚本引擎的副版本。</p>
</div>
