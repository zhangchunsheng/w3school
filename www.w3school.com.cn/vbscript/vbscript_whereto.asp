...
<li class="currentLink"><a href="/vbscript/vbscript_whereto.asp" title="VBScript Where to">VB Where to</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/vbscript/vbscript_howto.asp" title="VBScript How to">VB How to</a></li>
<li class="next"><a href="/vbscript/vbscript_variables.asp" title="VBScript 变量">VB 变量</a></li>
</ul>
</div>
...
<h2>实例</h2>
<dl>
<dt><a href="/tiy/t.asp?f=vbst_headsection">head 部分中的函数</a></dt>
<dd>可以把脚本放置在 head 部分。经常，我们会把所有的函数放置于 head 部分。这么做的目的是为了确保函数在调用前已经被载入。</dd>

<dt><a href="/tiy/t.asp?f=vbst_bodysection">body 部分中的脚本</a></dt>
