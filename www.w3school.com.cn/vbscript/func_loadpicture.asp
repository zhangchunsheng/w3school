...
<title>VBScript LoadPicture 函数</title>
</head>
...
<div>
<h2>定义和用法</h2>
<p>LoadPicture 函数可返回一个图片对象。</p>
<p>可被 LoadPicture 函数识别的图形格式有：</p>
<ul>
  <li>bitmap 文件 (.bmp)</li>
  <li>icon 文件 (.ico)</li>
  <li>run-length encoded 文件 (.rle)</li>
  <li>metafile 文件 (.wmf)</li>
  <li>enhanced meta文件 (.emf)</li>
  <li>GIF 文件 (.gif)</li>
  <li>JPEG 文件 (.jpg)</li>
</ul>
<p class="note"><span>注释：</span>此函数仅供 32-位 平台。</p>

<h3>语法</h3>
<pre>LoadPicture(picturename)</pre>
