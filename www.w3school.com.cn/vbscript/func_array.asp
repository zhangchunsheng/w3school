...
<div>
<h2>定义和用法</h2>
<p>Array 可返回一个包含数组的变量。</p>
<p class="note"><span>注释：</span>数组中的第一个元素是零。</p>

<h3>语法</h3>
<pre>Array(arglist)</pre>
