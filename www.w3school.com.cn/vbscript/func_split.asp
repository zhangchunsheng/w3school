...
<div>
<h2>定义和用法</h2>
<p>Split 函数可返回基于 0 的一维数组，此数组包含指定数目的子字符串。</p>

<h3>语法</h3>
<pre>Split(expression[,delimiter[,count[,compare]]])</pre>
...
<table class="dataintable"> 
  ...
  <tr>
    <td>expression</td>
    <td>必需的。包含子字符串和分隔符的字符串表达式。</td>
  </tr>
  <tr>
    <td>delimiter</td>
    <td>可选的。用于识别子字符串界限的字符。默认是空格字符。</td>
  </tr>
  <tr>
    <td>count</td>
    <td>可选的。需被返回的子字符串的数目。-1 指示返回所有的子字符串。</td>
  </tr>
  <tr>
    <td>compare</td>
    <td>
	<p>可选的。规定要使用的字符串比较类型。</p>
	<p>可采用下列的值：</p>
    <ul>
