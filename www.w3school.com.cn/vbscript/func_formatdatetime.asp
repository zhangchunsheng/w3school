...
<title>VBScript FormatDateTime 函数</title>
</head>
...
<div id="maincontent">
<h1>VBScript FormatDateTime 函数</h1>
...
<div>
<h2>定义和用法</h2>
<p>FormatDateTime 函数可格式化并返回一个合法的日期或时间表达式。</p>

<h3>语法</h3>
<pre>FormatDateTime(date,format)</pre>
...
<table class="dataintable"> 
  ...
  <tr>
    <td>date</td>
    <td>必需的。任何合法的日期表达式。(比如 Date() 或 Now())</td>
  </tr>
  <tr>
    <td>format</td>
    <td>可选的。规定所使用的日期/时间格式的格式值。</td>
  </tr>
</table>
...
<table class="dataintable">
    ...
    <tr>
      <td>vbGeneralDate</td>
      <td>0</td>
      <td>显示日期和/或时间。如果有日期部分，则将该部分显示为短日期格式。如果有时间部分，则将该部分显示为长时间格式。如果都存在，则显示所有部分。 </td>
    </tr>
    <tr>
      <td>vbLongDate</td>
      <td>1</td>
      <td>使用计算机区域设置中指定的长日期格式显示日期。</td>
    </tr>
    <tr>
      <td>vbShortDate</td>
      <td>2</td>
      <td>使用计算机区域设置中指定的短日期格式显示日期。</td>
    </tr>
    <tr>
      <td>vbLongTime</td>
      <td>3</td>
      <td>使用此格式显示时间：hh:mm:ss PM/AM</td>
    </tr>
    <tr>
      <td>vbShortTime</td>
      <td>4</td>
      <td>使用 24 小时格式 (hh:mm) 显示时间。</td>
    </tr>
  </table>
</div>
