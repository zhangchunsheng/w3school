...
<div>
<h2>定义和用法</h2>
<p>Now 函数可根据计算机系统的日期和时间设置返回当前的日期和时间。</p>
...
<h2>实例</h2>
<h3>例子 1</h3>
<pre>document.write(Now)</pre>
<p>输出：</p>
<pre>2007-10-1 14:10:06</pre>
<p class="note"><span>注释：</span>输出的结果可能由于不同的计算机设置而略有差异。</p>
</div>
