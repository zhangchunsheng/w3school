...
<title>VBScript CreateObject 函数</title>
</head>
...
<div>
<h2>定义和用法</h2>
<p>CreateObject 函数可创建一个指定类型的对象。</p>

<h3>语法</h3>
<pre>CreateObject(servername.typename[,location])</pre>
...
<table class="dataintable"> 
  ...
  <tr>
    <td>servername</td>
    <td>必需的。提供此对象的应用程序名称。</td>
  </tr>
  <tr>
    <td>typename</td>
    <td>必需的。对象的类型或类（type/class）。</td>
  </tr>
  <tr>
    <td>location</td>
    <td>可选的。在何处创建对象。</td>
