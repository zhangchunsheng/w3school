...
<div>
<h2>定义和用法</h2>
<p>Join 函数可返回一个由某个数组中一系列子字符串组成的字符串。</p>
...
<table class="dataintable"> 
  ...
  <tr>
    <td>list</td>
    <td>必需的。一维数组，其中包含需被连接的子字符串。</td>
  </tr>
  <tr>
    <td>delimiter</td>
    <td>可选的。用于在返回的字符串中分割子字符串的字符。默认是空格字符。</td>
  </tr>
</table>
</div>
...
a(4)=&quot;Wednesday&quot;
b=Filter(a,&quot;n&quot;)
document.write(join(b))</pre>
<p>输出：</p>
<pre>Sunday Monday Wednesday</pre>
