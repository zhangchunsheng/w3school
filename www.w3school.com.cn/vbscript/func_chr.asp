...
<div>
<h2>定义和用法</h2>
<p>Chr 函数可把指定的 ANSI 字符代码转换为字符。</p>
<p class="note"><span>注释：</span>从0到31的数字代表不可打印的 ASCII 代码，举例，Chr(10) 会返回一个换行符。</p>
...
<h2>实例</h2>
<h3>例子 1</h3>
<pre>document.write(Chr(65))
document.write(Chr(97))</pre>
<p>输出分别是：</p>
<pre>A
a</pre>

<h3>例子 2</h3>
<pre>document.write(Chr(37))
document.write(Chr(45))</pre>
<p>输出分别是：</p>
<pre>%
-</pre>

<h3>例子 2</h3>
<pre>document.write(Chr(50))
document.write(Chr(35))</pre>
<p>输出分别是：</p>
<pre>2
#</pre>
</div>
