...
<title>VBScript Second 函数</title>
</head>
...
<div>
<h2>定义和用法</h2>
<p>Second 函数可返回表示分钟的秒数的数字，介于 0 到59 之间。</p>
...
<h2>实例</h2>
<h3>例子 1</h3>
<pre>D = #1/15/2002 10:55:51 AM#
document.write(Second(D))</pre>
<p>输出：</p>
<pre>51</pre>

<h3>例子 2</h3>
<pre>T = #10:55:51 AM#
document.write(Second(T))</pre>
<p>输出：</p>
<pre>51</pre>

<h3>例子 3</h3>
<p>下面这个例子是一个可输出中文格式时间的 ASP 函数，其中使用到了 VBScript 的 Hour、Minute 以及 Second 函数。</p>
<pre>&lt;%
Sub HHMMSS(T)
H = Hour(T)
If H&lt;12 then
