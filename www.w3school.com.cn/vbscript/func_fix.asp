...
<div>
<h2>定义和用法</h2>
<p>Fix 函数可返回指定数字的整数部分。</p>
<p class="note"><span>注释：</span>若 number 参数包含 Null ，则返回 Null 。</p>
<p class="tip"><span>提示：</span>请参阅 Int 函数。Int 和 Fix 函数都删除 number 参数的小数部分并返回以整数表示的结果。</p>
...
<h2>实例</h2>
<h3>例子 1</h3>
<pre>document.write(Fix(6.83227))</pre>
<p>输出：</p>
<pre>6</pre>

<h3>例子 2</h3>
<pre>document.write(Fix(6.23443))</pre>
<p>输出：</p>
<pre>6</pre>

<h3>例子 3</h3>
<pre>document.write(Fix(-6.13443))</pre>
<p>输出：</p>
<pre>-6</pre>

<h3>例子 4</h3>
<pre>document.write(Fix(-6.93443))</pre>
<p>输出：</p>
<pre>-6</pre>
</div>
