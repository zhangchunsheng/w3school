...
<title>VBScript IsNumeric 函数</title>
</head>
...
<div>
<h2>定义和用法</h2>
<p>IsNumeric 函数可返回指示指定的表达式是否可作为数字来计算的布尔值。如果作为数字来计算，则返回 True ，否则返回 False。</p>
<p class="note"><span>注释：</span>如果表达式是日期表达式，则 IsNumeric 返回 False。</p>

<h3>语法</h3>
<pre>IsNumeric(expression)</pre>
...
document.write(IsNumeric(x))
x=&quot;911 Help&quot;
document.write(IsNumeric(x))</pre>
<p>分别输出：</p>
<pre>True
True
False
