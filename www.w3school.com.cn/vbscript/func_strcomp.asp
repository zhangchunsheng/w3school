...
<title>VBScript StrComp 函数</title>
</head>
...
<div>
<h2>定义和用法</h2>
<p>StrComp 函数可比较两个字符串，并返回表示比较结果的一个值。</p>
<p>StrComp 函数可返回下面的值：</p>
<ul>
  <li>-1 (如果 string1 &lt; string2)</li>
  <li>0 (如果 string1 = string2)</li>
  <li>1 (如果 string1 &gt; string2)</li>
  <li>Null (如果 string1 或 string2 为 Null)</li>
</ul>

<h3>语法</h3>
<pre>StrComp(string1,string2[,compare])</pre>
...
<tr>
  ...
  <tr>
    <td>compare</td>
    <td>
	<p>可选的。规定要使用的字符串比较类型。默认是 0。Optional. Specifies the string comparison to use. Default is 0</p>
	<p>可采用的值：</p>
    <ul>
...
<h2>实例</h2>
<h3>例子 1</h3>
<pre>document.write(StrComp(&quot;VBScript&quot;,&quot;VBScript&quot;))</pre>
<p>输出：</p>
<pre>0</pre>
...
<h3>例子 3</h3>
<pre>document.write(StrComp(&quot;VBScript&quot;,&quot;vbscript&quot;,1))</pre>
<p>输出：</p>
<pre>0</pre>
</div>
