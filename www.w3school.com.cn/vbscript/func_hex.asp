...
<div>
<h2>定义和用法</h2>
<p>Hex 函数可返回一个表示指定数字的十六进制值的字符串。</p>
<p class="note"><span>注释：</span>如果 number 参数不是整数，则在进行运算前将其四舍五入为最接近的整数。</p>
<h3>语法</h3>
<pre>Hex(number)</pre>
...
<table class="dataintable"> 
  ...
  <tr>
	...
	<p>如果 number 是：</p>
    <ul>
      <li>Null - 那么 Hex 函数会返回 Null。</li>
      <li>Empty - 那么 Hex 函数会返回零 (0)。</li>
      <li>其他数 - 那么 Hex 函数会返回最多 8 个十六进制字符。</li>
    </ul>
	</td>
  </tr>
</table>
