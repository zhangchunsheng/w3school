...
<title>jQuery Mobile Touch 事件</title>
...
<li class="currentLink"><a href="/jquerymobile/jquerymobile_events_touch.asp" title="jQuery Mobile 触控">jQuery Mobile 触控</a></li>
...
<h1>jQuery Mobile Touch 事件</h1>

<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/jquerymobile/jquerymobile_events_intro.asp" title="jQuery Mobile 事件">jQuery Mobile 事件</a></li>
<li class="next"><a href="/jquerymobile/jquerymobile_events_scroll.asp" title="jQuery Mobile 滚动">jQuery Mobile 滚动</a></li>
</ul>
</div>


<div>
<p>Touch 事件在用户触摸屏幕（页面）时触发。</p>

<iframe src="/jquerymobile/tjm_touch.html" scrolling="no" frameborder="0" width="100%" height="150px" style="margin-top:15px;"></iframe>

<p class="tip"><span>提示：</span>Touch 事件同样适用于桌面电脑：点击鼠标！</p>
</div>
...
<p>tap 事件在用户敲击某个元素时触发。</p>

<p>下面的例子当 &lt;p&gt; 元素上触发 tap 事件时，隐藏当前 &lt;p&gt; 元素：</p>

<h3>实例</h3>

<pre>
$(&quot;p&quot;).on(<span class="marked">&quot;tap&quot;</span>,function(){
  $(this).hide();
});
</pre>

<p><a target="_blank" href="/tiy/t.asp?f=jquerymobile_events_tap">亲自试一试</a></p>
</div>
...
<p>taphold 事件在用户敲击某个元素并保持一秒时被触发：</p>

<h3>实例</h3>

<pre>
$(&quot;p&quot;).on(<span class="marked">&quot;taphold&quot;</span>,function(){
  $(this).hide();
});
</pre>

<p><a target="_blank" href="/tiy/t.asp?f=jquerymobile_events_taphold">亲自试一试</a></p>
</div>
...
<p>swipe 事件在用户在某个元素上水平滑动超过 30px 时被触发：</p>

<h3>实例</h3>

<pre>
$(&quot;p&quot;).on(<span class="marked">&quot;swipe&quot;</span>,function(){
  $(&quot;span&quot;).text(&quot;Swipe detected!&quot;);
});
</pre>

<p><a target="_blank" href="/tiy/t.asp?f=jquerymobile_events_swipe">亲自试一试</a></p>
</div>
...
<p>swipeleft 事件在用户在某个元素上从左滑动超过 30px 时被触发：</p>

<h3>实例</h3>

<pre>
$(&quot;p&quot;).on(<span class="marked">&quot;swipeleft&quot;</span>,function(){
  alert(&quot;You swiped left!&quot;);
});
</pre>

<p><a target="_blank" href="/tiy/t.asp?f=jquerymobile_events_swipeleft">亲自试一试</a></p>
</div>
...
<p>swiperight 事件在用户在某个元素上从右滑动超过 30px 时被触发：</p>

<h3>实例</h3>

<pre>
$(&quot;p&quot;).on(<span class="marked">&quot;swiperight&quot;</span>,function(){
  alert(&quot;You swiped right!&quot;);
});
</pre>

<p><a target="_blank" href="/tiy/t.asp?f=jquerymobile_events_swiperight">亲自试一试</a></p>
</div>
