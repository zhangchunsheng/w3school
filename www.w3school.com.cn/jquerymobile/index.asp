...
<ul>
<li class="currentLink"><a href="/jquerymobile/index.asp" title="jQuery Mobile 教程">jQuery Mobile 教程</a></li>
...
<h1>jQuery Mobile 教程</h1>

<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/jquerymobile/index.asp" title="jQuery Mobile 教程">jQuery Mobile 教程</a></li>
<li class="next"><a href="/jquerymobile/jquerymobile_intro.asp" title="jQuery Mobile 简介">jQuery Mobile 简介</a></li>
</ul>
</div>
...
<p>jQuery Mobile 是创建移动 web 应用程序的框架。</p>

<p>jQuery Mobile 适用于所有流行的智能手机和平板电脑。</p>

<p>jQuery Mobile 使用 HTML5 和 CSS3 通过尽可能少的脚本对页面进行布局。</p>

<iframe src="/jquerymobile/tjm_index.html" scrolling="no" frameborder="0" width="100%" height="470px" style="margin-top:15px;"></iframe>
</div>
...
<p>通过我们的在线编辑器，您能够编辑代码，然后点击提交按钮来查看结果。</p>
...
<p><a target="_blank" href="/tiy/t.asp?f=jquerymobile_example">亲自试一试</a></p>

<p>请点击“亲自试一试”按钮来查看结果。</p>
</div>
...
<p>通过实例来学习！在 W3School，您可以找到大量 jQuery Mobile 实例，并亲自进行测试。</p>

<p><a href="/jquerymobile/jquerymobile_examples.asp" title="jQuery Mobile 实例">jQuery Mobile 实例</a></p>
</div>
...
<p>在 W3School，您将找到包含所有 jQuery Mobile 属性的完整参考手册。</p>

<p><a href="/jquerymobile/jquerymobile_ref_data.asp" title="jQuery Mobile Data 属性">jQuery Mobile 数据参考手册</a></p>
</div>
