...
<title>jQuery Mobile 滚动事件</title>
...
<li class="currentLink"><a href="/jquerymobile/jquerymobile_events_scroll.asp" title="jQuery Mobile 滚动">jQuery Mobile 滚动</a></li>
...
<h1>jQuery Mobile 滚动事件</h1>

<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/jquerymobile/jquerymobile_events_touch.asp" title="jQuery Mobile 触控">jQuery Mobile 触控</a></li>
<li class="next"><a href="/jquerymobile/jquerymobile_events_orientation.asp" title="jQuery Mobile 方向">jQuery Mobile 方向</a></li>
</ul>
</div>


<div>
<p>jQuery Mobile 提供两种滚动事件：在滚动开始和当滚动结束。</p>
</div>
...
<p>scrollstart 事件在用户开始滚动页面时被触发：</p>

<h3>实例</h3>
<pre>
$(document).on(<span class="marked">&quot;scrollstart&quot;</span>,function(){
  alert(&quot;开始滚动！&quot;);
});
</pre>

<p><a target="_blank" href="/tiy/t.asp?f=jquerymobile_events_scrollstart">亲自试一试</a></p>

<p class="note"><span>注释：</span>iOS 设备会在滚动事件发生时冻结 DOM 操作，这意味着当用户滚动时无法改变任何事物。不过 jQuery 团队正致力于解决该问题。</p>
</div>
...
<p>scrollstop 事件在用户停止滚动页面时被处罚：</p>

<h3>实例</h3>
<pre>
$(document).on(<span class="marked">&quot;scrollstop&quot;</span>,function(){
  alert(&quot;结束滚动！&quot;);
});
</pre>

<p><a target="_blank" href="/tiy/t.asp?f=jquerymobile_events_scrollstop">亲自试一试</a></p>
</div>
