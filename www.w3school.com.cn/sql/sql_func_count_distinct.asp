...
<title>SQL COUNT DISTINCT 函数</title>
</head>
...
<h1>SQL COUNT DISTINCT 函数</h1>

<div class="backtoreference">
<p><a href="/sql/sql_functions.asp" title="SQL 函数">SQL 函数</a></p>
</div>
...
<p>可以一同使用 DISTINCT 和 COUNT 关键词，来计算非重复结果的数目。</p>
...
<p class="important"><span>注意：</span>下面的例子仅适用于 ORACLE 和 Microsoft SQL server，不能用于 Microsoft Access。</p>
