...
<li class="currentLink"><a href="/sql/sql_func_now.asp" title="SQL NOW() 函数">SQL now()</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/sql/sql_func_round.asp" title="SQL ROUND() 函数">SQL round()</a></li>
<li class="next"><a href="/sql/sql_func_format.asp" title="SQL FORMAT() 函数">SQL format()</a></li>
</ul>
</div>
...
<p class="tip"><span>提示：</span>如果您在使用 Sql Server 数据库，请使用 getdate() 函数来获得当前的日期时间。</p>

<h3>SQL NOW() 语法</h3>
<pre>SELECT NOW() FROM table_name</pre>
</div>
...
<p>现在，我们希望显示当天的日期所对应的名称和价格。</p>

<p>我们使用如下 SQL 语句：</p>

<pre>SELECT ProductName, UnitPrice, Now() as PerDate FROM Products</pre>
