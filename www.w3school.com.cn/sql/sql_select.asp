...
<li class="currentLink"><a href="/sql/sql_select.asp" title="SQL SELECT 语句">SQL select</a></li>
...
<div  id="tpn">
<ul class="prenext">
<li class="pre"><a href="/sql/sql_syntax.asp" title="SQL 语法">SQL 语法</a></li>
<li class="next"><a href="/sql/sql_distinct.asp" title="SQL SELECT DISTINCT 语句">SQL distinct</a></li>
</ul>
</div>


<div>
<p><strong>本章讲解 SELECT 和 SELECT * 语句。</strong></p>
</div>
...
<p class="note"><span>注释：</span>SQL 语句对大小写不敏感。SELECT 等效于 select。</p>
</div>
...
<pre>SELECT <code>*</code> FROM Persons</pre>

<p class="tip"><span>提示：</span>星号（*）是选取所有列的快捷方式。</p>
...
<p>类似这些编程函数不在本教程讲解之列。如需学习通过函数调用访问数据的知识，请访问我们的 <a href="/ado/index.asp" title="ADO 教程">ADO 教程</a> 和 <a href="/php/index.asp" title="PHP 教程">PHP 教程</a>。</p>
</div>
