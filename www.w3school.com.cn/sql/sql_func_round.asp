...
<li class="currentLink"><a href="/sql/sql_func_round.asp" title="SQL ROUND() 函数">SQL round()</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/sql/sql_func_len.asp" title="SQL LEN() 函数">SQL len()</a></li>
<li class="next"><a href="/sql/sql_func_now.asp" title="SQL NOW() 函数">SQL now()</a></li>
</ul>
</div>
...
<h3>SQL ROUND() 语法</h3>
<pre>SELECT ROUND(column_name,decimals) FROM table_name</pre>
...
<p>现在，我们希望把名称和价格舍入为最接近的整数。</p>

<p>我们使用如下 SQL 语句：</p>

<pre>SELECT ProductName, ROUND(UnitPrice,0) as UnitPrice FROM Products</pre>
