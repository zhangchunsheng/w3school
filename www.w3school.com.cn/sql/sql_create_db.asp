...
<title>SQL CREATE DATABASE 语句</title>
</head>
...
<li class="currentLink"><a href="/sql/sql_create_db.asp" title="SQL CREATE DATABASE 语句">SQL Create DB</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/sql/sql_select_into.asp" title="SQL SELECT INTO 语句">SQL Select Into</a></li>
<li class="next"><a href="/sql/sql_create_table.asp" title="SQL CREATE TABLE 语句">SQL Create Table</a></li>
</ul>
</div>


<div>
<h2>CREATE DATABASE 语句</h2>

<p>CREATE DATABASE 用于创建数据库。</p>


<h3>SQL CREATE DATABASE 语法</h3>
...
<div>
<h2>SQL CREATE DATABASE 实例</h2>

<p>现在我们希望创建一个名为 &quot;my_db&quot; 的数据库。</p>

<p>我们使用下面的 CREATE DATABASE 语句：</p>

<pre>CREATE DATABASE my_db</pre>
