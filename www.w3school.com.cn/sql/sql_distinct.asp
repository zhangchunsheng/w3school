...
<title>SQL SELECT DISTINCT 语句</title>
</head>
...
<li class="currentLink"><a href="/sql/sql_distinct.asp" title="SQL SELECT DISTINCT 语句">SQL distinct</a></li>
...
<div  id="tpn">
<ul class="prenext">
<li class="pre"><a href="/sql/sql_select.asp" title="SQL SELECT 语句">SQL select</a></li>
<li class="next"><a href="/sql/sql_where.asp" title="SQL WHERE 子句">SQL where</a></li>
</ul>
</div>


<div>
<p><strong>本章讲解 SELECT DISTINCT 语句。</strong></p>
</div>

<div>
<h2>SQL SELECT DISTINCT 语句</h2>
...
<h3>语法：</h3>
<pre>SELECT DISTINCT 列名称 FROM 表名称</pre>
</div>

<div>
<h2>使用 DISTINCT 关键词</h2>
<p>如果要从 &quot;Company&quot; 列中选取所有的值，我们需要使用 SELECT 语句：</p>
<pre>SELECT Company FROM Orders</pre>
...
<pre>SELECT <code>DISTINCT</code> Company FROM Orders </pre>
