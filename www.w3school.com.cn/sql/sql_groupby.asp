...
<li class="currentLink"><a href="/sql/sql_groupby.asp" title="SQL GROUP BY 语句">SQL Group By</a></li>
...
<div  id="tpn">
<ul class="prenext">
<li class="pre"><a href="/sql/sql_func_sum.asp" title="SQL SUM() 函数">SQL sum()</a></li>
<li class="next"><a href="/sql/sql_having.asp" title="SQL HAVING 子句">SQL Having</a></li>
</ul>
</div>
