...
<li class="currentLink"><a href="/sql/sql_alias.asp" title="SQL Alias（别名）">SQL Aliases</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/sql/sql_between.asp" title="SQL BETWEEN">SQL Between</a></li>
<li class="next"><a href="/sql/sql_join.asp" title="SQL JOIN">SQL Join</a></li>
</ul>
</div>
...
FROM Persons <code>AS p</code>, Product_Orders <code>AS po</code>
...
<pre>SELECT LastName <code>AS Family</code>, FirstName <code>AS Name</code>
FROM Persons</pre>
