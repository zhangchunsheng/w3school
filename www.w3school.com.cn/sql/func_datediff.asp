...
<title>SQL Server DATEDIFF() 函数</title>
</head>
...
<h3>语法</h3>
<pre>DATEDIFF(<i>datepart</i>,<i>startdate</i>,<i>enddate</i>)</pre>

<p><i>startdate</i> 和 <i>enddate</i> 参数是合法的日期表达式。</p>
...
<pre>SELECT DATEDIFF(day,'2008-12-29','2008-12-30') AS DiffDate</pre>
...
<pre>SELECT DATEDIFF(day,'2008-12-30','2008-12-29') AS DiffDate</pre>
