...
<li class="currentLink"><a href="/sql/sql_func_first.asp" title="SQL FIRST() 函数">SQL first()</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/sql/sql_func_count.asp" title="SQL COUNT() 函数">SQL count()</a></li>
<li class="next"><a href="/sql/sql_func_last.asp" title="SQL LAST() 函数">SQL last()</a></li>
</ul>
</div>
