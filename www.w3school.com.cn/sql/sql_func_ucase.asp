...
<li class="currentLink"><a href="/sql/sql_func_ucase.asp" title="SQL UCASE() 函数">SQL ucase()</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/sql/sql_having.asp" title="SQL HAVING 子句">SQL Having</a></li>
<li class="next"><a href="/sql/sql_func_lcase.asp" title="SQL LCASE() 函数">SQL lcase()</a></li>
</ul>
</div>
...
<h3>SQL UCASE() 语法</h3>
<pre>SELECT UCASE(column_name) FROM table_name</pre>
</div>
...
<pre>SELECT UCASE(LastName) as LastName,FirstName FROM Persons</pre>
