...
<h3>语法</h3>
<pre>DATE_SUB(date,INTERVAL expr type)</pre>
...
<p>现在，我们希望从 &quot;OrderDate&quot; 减去 2 天。</p>

<p>我们使用下面的 SELECT 语句：</p>

<pre>
SELECT OrderId,<code>DATE_SUB(OrderDate,INTERVAL 2 DAY)</code> AS OrderPayDate
FROM Orders
</pre>
