...
<li class="currentLink"><a href="/sql/sql_summary.asp" title="我们已经学习了 SQL，下一步学习什么呢？">SQL 教程总结</a></li>
</ul>
<h2>SQL 测验</h2>
<ul>
...
<h1>我们已经学习了 SQL，下一步学习什么呢？</h1>

<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/sql/sql_quickref.asp" title="SQL 快速参考">SQL 快速参考</a></li>
<li class="next"><a href="/sql/sql_quiz.asp" title="SQL 测验">SQL 测验</a></li>
</ul>
</div>
...
<div>
<h2>我们已经学习了 SQL，下一步学习什么呢？</h2>
<p>下一步应该学习 ADO。</p>
<p>ADO 是一种从网站访问数据库中数据的编程接口。</p>
<p>ADO 使用 SQL 来查询数据库中的数据。</p>
<p>如果您需要学习更多关于 ADO 的知识，请访问我们的《<a href="/ado/index.asp" title="ADO 教程">ADO 教程</a>》。</p>
</div>
