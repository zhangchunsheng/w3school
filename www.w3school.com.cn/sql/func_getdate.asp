...
<title>SQL Server GETDATE() 函数</title>
</head>
...
<p>GETDATE() 函数从 SQL Server 返回当前的时间和日期。</p>
...
<pre>SELECT GETDATE() AS CurrentDateTime</pre>

<p>结果：</p>

<table class="dataintable">
<tr><th>CurrentDateTime</th></tr>
<tr><td>2008-12-29 16:25:46.635</td></tr>
</table>

<p class="note"><span>注释：</span>上面的时间部分精确到毫秒。</p>
...
<p>请注意，OrderDate 把 GETDATE() 规定为默认值。结果是，当您在表中插入新行时，当前日期和时间自动插入列中。</p>

<p>现在，我们希望在 &quot;Orders&quot; 表中插入一条记录：</p>

<pre>INSERT INTO Orders (ProductName) VALUES ('Computer')</pre>
