...
<li class="currentLink"><a href="/sql/sql_func_format.asp" title="SQL FORMAT() 函数">SQL format()</a></li>
</ul>
<h2>SQL 总结</h2>
<ul>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/sql/sql_func_now.asp" title="SQL NOW() 函数">SQL now()</a></li>
<li class="next"><a href="/sql/sql_quickref.asp" title="SQL 快速参考">SQL 快速参考</a></li>
</ul>
</div>
...
<h3>SQL FORMAT() 语法</h3>
<pre>SELECT FORMAT(column_name,format) FROM table_name</pre>
...
<p>现在，我们希望显示每天日期所对应的名称和价格（日期的显示格式是 &quot;YYYY-MM-DD&quot;）。</p>

<p>我们使用如下 SQL 语句：</p>

<pre>SELECT ProductName, UnitPrice, FORMAT(Now(),'YYYY-MM-DD') as PerDate
FROM Products</pre>
