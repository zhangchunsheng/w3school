...
<li class="currentLink"><a href="/sql/sql_having.asp" title="SQL HAVING 子句">SQL Having</a></li>
...
<div  id="tpn">
<ul class="prenext">
<li class="pre"><a href="/sql/sql_groupby.asp" title="SQL GROUP BY 语句">SQL Group By</a></li>
<li class="next"><a href="/sql/sql_func_ucase.asp" title="SQL UCASE() 函数">SQL ucase()</a></li>
</ul>
</div>
