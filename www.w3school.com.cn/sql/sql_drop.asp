...
<li class="currentLink"><a href="/sql/sql_drop.asp" title="SQL 撤销索引、表以及数据库">SQL Drop</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/sql/sql_create_index.asp" title="SQL CREATE INDEX 语句">SQL Create Index</a></li>
<li class="next"><a href="/sql/sql_alter.asp" title="SQL ALTER TABLE">SQL Alter</a></li>
</ul>
</div>
