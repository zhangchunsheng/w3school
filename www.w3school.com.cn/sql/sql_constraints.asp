...
<li class="currentLink"><a href="/sql/sql_constraints.asp" title="SQL 约束">SQL Constraints</a></li>
...
<h1>SQL 约束 (Constraints)</h1>

<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/sql/sql_create_table.asp" title="SQL CREATE TABLE 语句">SQL Create Table</a></li>
<li class="next"><a href="/sql/sql_notnull.asp" title="SQL NOT NULL 约束">SQL Not Null</a></li>
</ul>
</div>
...
<p class="note"><span>注释：</span>在下面的章节，我们会详细讲解每一种约束。</p>
