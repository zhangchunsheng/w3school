...
<li class="currentLink"><a href="/sql/sql_datatypes.asp" title="SQL 数据类型">SQL 数据类型</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/sql/sql_isnull.asp" title="SQL NULL 函数">SQL isnull()</a></li>
<li class="next"><a href="/sql/sql_server.asp" title="SQL 服务器 - RDBMS">SQL 服务器</a></li>
</ul>
</div>
