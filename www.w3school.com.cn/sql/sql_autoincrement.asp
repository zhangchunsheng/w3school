...
<li class="currentLink"><a href="/sql/sql_autoincrement.asp" title="SQL AUTO INCREMENT 字段">SQL Increment</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/sql/sql_alter.asp" title="SQL ALTER TABLE">SQL Alter</a></li>
<li class="next"><a href="/sql/sql_view.asp" title="SQL VIEW（视图）">SQL View</a></li>
</ul>
</div>


<div>
<p><strong>Auto-increment 会在新记录插入表中时生成一个唯一的数字。</strong></p>
</div>


<div>
<h2>AUTO INCREMENT 字段</h2>
...
(
<code>P_Id int NOT NULL AUTO_INCREMENT,</code>
LastName varchar(255) NOT NULL,
FirstName varchar(255),
Address varchar(255),
City varchar(255),
<code>PRIMARY KEY (P_Id)</code>
)
</pre>
...
CREATE TABLE Persons
(
<code>P_Id int PRIMARY KEY IDENTITY,</code>
LastName varchar(255) NOT NULL,
FirstName varchar(255),
Address varchar(255),
City varchar(255)
...
CREATE TABLE Persons
(
<code>P_Id int PRIMARY KEY AUTOINCREMENT,</code>
LastName varchar(255) NOT NULL,
FirstName varchar(255),
Address varchar(255),
City varchar(255)
...
<p>要规定 &quot;P_Id&quot; 列以 20 起始且递增 10，请把 autoincrement 改为 AUTOINCREMENT(20,10)</p>
...
<p>上面的代码创建名为 seq_person 的序列对象，它以 1 起始且以 1 递增。该对象缓存 10 个值以提高性能。CACHE 选项规定了为了提高访问速度要存储多少个序列值。</p>
...
<p>上面的 SQL 语句会在 &quot;Persons&quot; 表中插入一条新记录。&quot;P_Id&quot; 的赋值是来自 seq_person 序列的下一个数字。&quot;FirstName&quot; 会被设置为 &quot;Bill&quot;，&quot;LastName&quot; 列会被设置为 &quot;Gates&quot;。</p>
</div>
