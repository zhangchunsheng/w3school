...
<li class="currentLink"><a href="/sql/sql_default.asp" title="SQL DEFAULT 约束">SQL Default</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/sql/sql_check.asp" title="SQL CHECK 约束">SQL Check</a></li>
<li class="next"><a href="/sql/sql_create_index.asp" title="SQL CREATE INDEX 语句">SQL Create Index</a></li>
</ul>
</div>
