...
<li class="currentLink"><a href="/sql/sql_wildcards.asp" title="SQL 通配符">SQL 通配符</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/sql/sql_like.asp" title="SQL LIKE 运算符">SQL Like</a></li>
<li class="next"><a href="/sql/sql_in.asp" title="SQL IN">SQL In</a></li>
</ul>
</div>
...
<pre>SELECT * FROM Persons
WHERE City LIKE 'Ne%'</pre>
...
<pre>SELECT * FROM Persons
WHERE FirstName LIKE '_eorge'</pre>
...
<p>接下来，我们希望从 &quot;Persons&quot; 表中选取的这条记录的姓氏以 &quot;C&quot; 开头，然后是一个任意字符，然后是 &quot;r&quot;，然后是任意字符，然后是 &quot;er&quot;：</p>

<p>我们可以使用下面的 SELECT 语句：</p>

<pre>SELECT * FROM Persons
WHERE LastName LIKE 'C_r_er'</pre>
...
<div>
<h2>使用 [charlist] 通配符</h2>

<h3>例子 1</h3>

<p>现在，我们希望从上面的 &quot;Persons&quot; 表中选取居住的城市以 &quot;A&quot; 或 &quot;L&quot; 或 &quot;N&quot; 开头的人：</p>

<p>我们可以使用下面的 SELECT 语句：</p>

<pre>SELECT * FROM Persons
WHERE City LIKE '[ALN]%'</pre>
...
<p>现在，我们希望从上面的 &quot;Persons&quot; 表中选取居住的城市<em>不以</em> &quot;A&quot; 或 &quot;L&quot; 或 &quot;N&quot; 开头的人：</p>
