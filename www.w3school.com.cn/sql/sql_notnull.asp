...
<li class="currentLink"><a href="/sql/sql_notnull.asp" title="SQL NOT NULL 约束">SQL Not Null</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/sql/sql_constraints.asp" title="SQL 约束">SQL Constraints</a></li>
<li class="next"><a href="/sql/sql_unique.asp" title="SQL UNIQUE 约束">SQL Unique</a></li>
</ul>
</div>


<div>
<h2>SQL NOT NULL 约束</h2>
...
(
Id_P int <code>NOT NULL</code>,
LastName varchar(255) <code>NOT NULL</code>,
