...
<li class="currentLink"><a href="/sql/sql_null_values.asp" title="SQL NULL 值">SQL Nulls</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/sql/sql_dates.asp" title="SQL Date 函数">SQL Date</a></li>
<li class="next"><a href="/sql/sql_isnull.asp" title="SQL NULL 函数">SQL isnull()</a></li>
</ul>
</div>


<div>
<p><strong>NULL 值是遗漏的未知数据。</strong></p>
...
<p class="note"><span>注释：</span>无法比较 NULL 和 0；它们是不等价的。</p>
</div>

<div>
<h2>SQL 的 NULL 值处理</h2>
...
<p class="tip"><span>提示：</span>请始终使用 IS NULL 来查找 NULL 值。</p>
</div>
