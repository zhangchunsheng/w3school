...
<title>SQL INSERT INTO 语句</title>
</head>
...
<li class="currentLink"><a href="/sql/sql_insert.asp" title="SQL INSERT INTO 语句">SQL insert</a></li>
...
<div  id="tpn">
<ul class="prenext">
<li class="pre"><a href="/sql/sql_orderby.asp" title="SQL ORDER BY 语句">SQL Order By</a></li>
<li class="next"><a href="/sql/sql_update.asp" title="SQL UPDATE 语句">SQL update</a></li>
</ul>
</div>
...
<h3>语法</h3>
<pre>INSERT INTO 表名称 VALUES (值1, 值2,....)</pre>
<p>我们也可以指定所要插入数据的列：</p>
<pre>INSERT INTO table_name (列1, 列2,...) VALUES (值1, 值2,....)</pre>
</div>
...
<h3>SQL 语句：</h3>
<pre>INSERT INTO Persons VALUES ('Gates', 'Bill', 'Xuanwumen 10', 'Beijing')</pre>
<h3>结果：</h3>
<table class="dataintable">
    <tr>
      <th>LastName</th>
...
<h3>SQL 语句：</h3>
<pre>INSERT INTO Persons (LastName, Address) VALUES ('Wilson', 'Champs-Elysees')</pre>
<h3>结果：</h3>
