...
<li class="currentLink"><a href="/sql/sql_func_len.asp" title="SQL LEN() 函数">SQL len()</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/sql/sql_func_mid.asp" title="SQL MID() 函数">SQL mid()</a></li>
<li class="next"><a href="/sql/sql_func_round.asp" title="SQL ROUND() 函数">SQL round()</a></li>
</ul>
</div>
...
<h3>SQL LEN() 语法</h3>
<pre>SELECT LEN(column_name) FROM table_name</pre>
</div>
...
<p>现在，我们希望取得 &quot;City&quot; 列中值的长度。</p>

<p>我们使用如下 SQL 语句：</p>

<pre>SELECT LEN(City) as LengthOfCity FROM Persons</pre>
