...
<li class="currentLink"><a href="/sql/sql_in.asp" title="SQL IN">SQL In</a></li>
...
<div  id="tpn">
<ul class="prenext">
<li class="pre"><a href="/sql/sql_wildcards.asp" title="SQL 通配符">SQL 通配符</a></li>
<li class="next"><a href="/sql/sql_between.asp" title="SQL BETWEEN">SQL Between</a></li>
</ul>
</div>
...
WHERE LastName IN ('Adams','Carter')</pre>
