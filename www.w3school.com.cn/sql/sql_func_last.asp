...
<li class="currentLink"><a href="/sql/sql_func_last.asp" title="SQL LAST() 函数">SQL last()</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/sql/sql_func_first.asp" title="SQL FIRST() 函数">SQL first()</a></li>
<li class="next"><a href="/sql/sql_func_max.asp" title="SQL MAX() 函数">SQL max()</a></li>
</ul>
</div>
...
<p>LAST() 函数返回指定的字段中最后一个记录的值。</p>

<p class="tip"><span>提示：</span>可使用 ORDER BY 语句对记录进行排序。</p>


<h3>SQL LAST() 语法</h3>
<pre>SELECT LAST(column_name) FROM table_name</pre>
</div>
...
<p>现在，我们希望查找 &quot;OrderPrice&quot; 列的最后一个值。</p>

<p>我们使用如下 SQL 语句：</p>

<pre>SELECT LAST(OrderPrice) AS LastOrderPrice FROM Orders</pre>

<p>结果集类似这样：</p>

<table class="dataintable" style="width:30%">
  <tr>
    <th>LastOrderPrice</th>
  </tr>
  <tr>
    <td>100</td>
  </tr>
