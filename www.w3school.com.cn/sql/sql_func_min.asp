...
<li class="currentLink"><a href="/sql/sql_func_min.asp" title="SQL MIN() 函数">SQL min()</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/sql/sql_func_max.asp" title="SQL MAX() 函数">SQL max()</a></li>
<li class="next"><a href="/sql/sql_func_sum.asp" title="SQL SUM() 函数">SQL sum()</a></li>
</ul>
</div>
...
<p>MIN 函数返回一列中的最小值。NULL 值不包括在计算中。</p>


<h3>SQL MIN() 语法</h3>
<pre>SELECT MIN(column_name) FROM table_name</pre>
...
<p>现在，我们希望查找 &quot;OrderPrice&quot; 列的最小值。</p>

<p>我们使用如下 SQL 语句：</p>

<pre>SELECT MIN(OrderPrice) AS SmallestOrderPrice FROM Orders</pre>

<p>结果集类似这样：</p>

<table class="dataintable" style="width:30%">
  <tr>
    <th>SmallestOrderPrice</th>
  </tr>
  <tr>
    <td>100</td>
  </tr>
