...
<title>SQL INNER JOIN 关键字</title>
</head>
...
<li class="currentLink"><a href="/sql/sql_join_inner.asp" title="SQL INNER JOIN 关键字">SQL Inner Join</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/sql/sql_join.asp" title="SQL JOIN">SQL Join</a></li>
<li class="next"><a href="/sql/sql_join_left.asp" title="SQL LEFT JOIN 关键字">SQL Left Join</a></li>
</ul>
</div>


<div>
<h2>SQL INNER JOIN 关键字</h2>

<p>在表中存在至少一个匹配时，INNER JOIN 关键字返回行。</p>


<h3>INNER JOIN 关键字语法</h3>
...
<p class="note"><span>注释：</span>INNER JOIN 与 JOIN 是相同的。</p>
</div>
