...
<li class="currentLink"><a href="/sql/sql_server.asp" title="SQL 服务器 - RDBMS">SQL 服务器</a></li>
</ul>
<h2>SQL 函数</h2>
<ul>
...
<div  id="tpn">
<ul class="prenext">
<li class="pre"><a href="/sql/sql_datatypes.asp" title="SQL 数据类型">SQL 数据类型</a></li>
<li class="next"><a href="/sql/sql_functions.asp" title="SQL 函数">SQL functions</a></li>
</ul>
</div>

<div id="intro">
<p><strong>现代的 SQL 服务器构建在 RDBMS 之上。</strong></p>
</div>

<div>
<h2>DBMS - 数据库管理系统（Database Management System）</h2>
<p>数据库管理系统是一种可以访问数据库中数据的计算机程序。</p>
<p>DBMS 使我们有能力在数据库中提取、修改或者存贮信息。</p>
<p>不同的 DBMS 提供不同的函数供查询、提交以及修改数据。</p>
</div>

<div>
<h2>RDBMS - 关系数据库管理系统（Relational Database Management System）</h2>
<p>关系数据库管理系统 (RDBMS) 也是一种数据库管理系统，其数据库是根据数据间的关系来组织和访问数据的。</p>
