...
<li class="currentLink"><a href="/sql/sql_func_max.asp" title="SQL MAX() 函数">SQL max()</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/sql/sql_func_last.asp" title="SQL LAST() 函数">SQL last()</a></li>
<li class="next"><a href="/sql/sql_func_min.asp" title="SQL MIN() 函数">SQL min()</a></li>
</ul>
</div>
...
<p>MAX 函数返回一列中的最大值。NULL 值不包括在计算中。</p>


<h3>SQL MAX() 语法</h3>
<pre>SELECT MAX(column_name) FROM table_name</pre>

<p class="note"><span>注释：</span>MIN 和 MAX 也可用于文本列，以获得按字母顺序排列的最高或最低值。</p>
</div>
...
<p>现在，我们希望查找 &quot;OrderPrice&quot; 列的最大值。</p>

<p>我们使用如下 SQL 语句：</p>

<pre>SELECT MAX(OrderPrice) AS LargestOrderPrice FROM Orders</pre>

<p>结果集类似这样：</p>

<table class="dataintable" style="width:30%">
  <tr>
    <th>LargestOrderPrice</th>
  </tr>
  <tr>
    <td>2000</td>
  </tr>
