...
<title>SQL RIGHT JOIN 关键字</title>
</head>
...
<li class="currentLink"><a href="/sql/sql_join_right.asp" title="SQL RIGHT JOIN 关键字">SQL Right Join</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/sql/sql_join_left.asp" title="SQL LEFT JOIN 关键字">SQL Left Join</a></li>
<li class="next"><a href="/sql/sql_join_full.asp" title="SQL FULL JOIN 关键字">SQL Full Join</a></li>
</ul>
</div>


<div>
<h2>SQL RIGHT JOIN 关键字</h2>

<p>RIGHT JOIN 关键字会右表 (table_name2) 那里返回所有的行，即使在左表 (table_name1) 中没有匹配的行。</p>


<h3>RIGHT JOIN 关键字语法</h3>
...
<p class="note"><span>注释：</span>在某些数据库中， RIGHT JOIN 称为 RIGHT OUTER JOIN。</p>
</div>
