...
<title>SQL SELECT INTO 语句</title>
</head>
...
<li class="currentLink"><a href="/sql/sql_select_into.asp" title="SQL SELECT INTO 语句">SQL Select Into</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/sql/sql_union.asp" title="SQL UNION 和 UNION ALL">SQL Union</a></li>
<li class="next"><a href="/sql/sql_create_db.asp" title="SQL CREATE DATABASE 语句">SQL Create DB</a></li>
</ul>
</div>
...
<div>
<h2>SQL SELECT INTO 实例 - 制作备份复件</h2>
...
<div>
<h2>SQL SELECT INTO 实例 - 带有 WHERE 子句</h2>
...
<div>
<h2>SQL SELECT INTO 实例 - 被连接的表</h2>
