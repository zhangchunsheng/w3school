...
<h3>语法</h3>
<pre>DATEDIFF(date1,date2)</pre>

<p><i>date1</i> 和 <i>date2</i> 参数是合法的日期或日期/时间表达式。</p>

<p class="note"><span>注释：</span>只有值的日期部分参与计算。</p>
</div>
...
<pre>SELECT DATEDIFF('2008-12-30','2008-12-29') AS DiffDate</pre>
...
<pre>SELECT DATEDIFF('2008-12-29','2008-12-30') AS DiffDate</pre>
