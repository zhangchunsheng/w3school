...
<li class="currentLink"><a href="/sql/sql_where.asp" title="SQL WHERE 子句">SQL where</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/sql/sql_distinct.asp" title="SQL SELECT DISTINCT 语句">SQL distinct</a></li>
<li class="next"><a href="/sql/sql_and_or.asp" title="SQL AND &amp; OR">SQL AND &amp; OR</a></li>
</ul>
</div>

<div id="intro">
<p><strong>WHERE 子句用于规定选择的标准。</strong></p>
</div>
...
<h3>语法</h3>
<pre>SELECT 列名称 FROM 表名称 WHERE 列 运算符 值</pre>
...
<p class="note"><span>注释：</span>在某些版本的 SQL 中，操作符 &lt;&gt; 可以写为 !=。</p>
</div>
...
<pre>SELECT * FROM Persons <code>WHERE City='Beijing'</code></pre>
...
这是错误的：
SELECT * FROM Persons WHERE <code style="color:red;">FirstName=Bush</code>
</pre>
...
<pre>
这是正确的：
SELECT * FROM Persons WHERE <code>Year&gt;1965</code>

这是错误的：
SELECT * FROM Persons WHERE <code style="color:red;">Year&gt;'1965'</code>
</pre>
</div>
