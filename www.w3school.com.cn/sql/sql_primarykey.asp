...
<title>SQL PRIMARY KEY 约束</title>
</head>
...
<li class="currentLink"><a href="/sql/sql_primarykey.asp" title="SQL PRIMARY KEY 约束">SQL Primary Key</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/sql/sql_unique.asp" title="SQL UNIQUE 约束">SQL Unique</a></li>
<li class="next"><a href="/sql/sql_foreignkey.asp" title="SQL FOREIGN KEY 约束">SQL Foreign Key</a></li>
</ul>
</div>


<div>
<h2>SQL PRIMARY KEY 约束</h2>
...
CREATE TABLE Persons
(
Id_P int NOT NULL <code>PRIMARY KEY</code>,
LastName varchar(255) NOT NULL,
FirstName varchar(255),
Address varchar(255),
City varchar(255)
...
Address varchar(255),
City varchar(255),
<code>CONSTRAINT pk_PersonID PRIMARY KEY (Id_P,LastName)</code>
)
</pre>
</div>
...
<pre>
ALTER TABLE Persons
<code>ADD PRIMARY KEY (Id_P)</code>
</pre>
...
<pre>
ALTER TABLE Persons
<code>ADD CONSTRAINT pk_PersonID PRIMARY KEY (Id_P,LastName)</code>
</pre>

<p class="note"><span>注释：</span>如果您使用 ALTER TABLE 语句添加主键，必须把主键列声明为不包含 NULL 值（在表首次创建时）。
</div>
...
<pre>
ALTER TABLE Persons
<code>DROP CONSTRAINT pk_PersonID</code>
</pre>
</div>
