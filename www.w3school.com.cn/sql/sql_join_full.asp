...
<li class="currentLink"><a href="/sql/sql_join_full.asp" title="SQL FULL JOIN 关键字">SQL Full Join</a></li>
...
<h1>SQL FULL JOIN 关键字</h1>

<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/sql/sql_join_right.asp" title="SQL RIGHT JOIN 关键字">SQL Right Join</a></li>
<li class="next"><a href="/sql/sql_union.asp" title="SQL UNION 和 UNION ALL">SQL Union</a></li>
</ul>
</div>


<div>
<h2>SQL FULL JOIN 关键字</h2>

<p>只要其中某个表存在匹配，FULL JOIN 关键字就会返回行。</p>


<h3>FULL JOIN 关键字语法</h3>
...
<p class="note"><span>注释：</span>在某些数据库中， FULL JOIN 称为 FULL OUTER JOIN。</p>
</div>
