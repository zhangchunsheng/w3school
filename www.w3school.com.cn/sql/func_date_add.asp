...
<h3>语法</h3>
<pre>DATE_ADD(date,INTERVAL expr type)</pre>

<p><i>date</i> 参数是合法的日期表达式。<i>expr</i> 参数是您希望添加的时间间隔。</p>
...
<p>现在，我们希望向 &quot;OrderDate&quot; 添加 2 天，这样就可以找到付款日期。</p>

<p>我们使用下面的 SELECT 语句：</p>

<pre>
SELECT OrderId,<code>DATE_ADD(OrderDate,INTERVAL 2 DAY)</code> AS OrderPayDate
FROM Orders
</pre>
