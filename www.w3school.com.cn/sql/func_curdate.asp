...
<pre>SELECT NOW(),CURDATE(),CURTIME()</pre>
...
<p>请注意，OrderDate 列规定 CURDATE() 作为默认值。作为结果，当您向表中插入行时，当前日期和时间自动插入列中。</p>

<p>现在，我们希望在 &quot;Orders&quot; 表中插入一条新记录：</p>
