...
<h2>SQL 高级教程</h2>
<ul>
<li class="currentLink"><a href="/sql/sql_top.asp" title="SQL TOP 子句">SQL Top</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/sql/sql_delete.asp" title="SQL DELETE 语句">SQL delete</a></li>
<li class="next"><a href="/sql/sql_like.asp" title="SQL LIKE 运算符">SQL Like</a></li>
</ul>
</div>
...
<p class="note"><span>注释：</span>并非所有的数据库系统都支持 TOP 子句。</p>


<h3>SQL Server 的语法：</h3>

<pre>SELECT TOP number|percent column_name(s)
FROM table_name</pre>
</div>


<div>
<h2>MySQL 和 Oracle 中的 SQL SELECT TOP 是等价的</h2>
...
<pre>SELECT <code>TOP 2</code> * FROM Persons</pre>
...
<div>
<h2>SQL TOP PERCENT 实例</h2>

<p>现在，我们希望从上面的 &quot;Persons&quot; 表中选取 50% 的记录。</p>

<p>我们可以使用下面的 SELECT 语句：</p>

<pre>SELECT <code>TOP 50 PERCENT</code> * FROM Persons</pre>
