...
<ul>
<li class="currentLink"><a href="/sql/index.asp" title="SQL 教程">SQL 教程</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/sql/index.asp" title="SQL 教程">SQL 教程</a></li>
<li class="next"><a href="/sql/sql_intro.asp" title="SQL 简介">SQL 简介</a></li>
</ul>
</div>

<div id="intro">
<p><strong>SQL 是用于访问和处理数据库的标准的计算机语言。</strong></p>
<p><strong>在本教程中，您将学到如何使用 SQL 访问和处理数据系统中的数据，这类数据库包括：Oracle, Sybase, SQL Server, DB2, Access 等等。</strong></p>
<p><a href="/sql/sql_intro.asp" title="SQL 简介">开始学习 SQL</a> ！</p>

<p class="note"><span>注：</span>本教程中出现的姓名、地址等信息仅供教学，与实际情况无关。</p>
</div>

<div>
<h2>SQL 测验</h2>

<p>在 W3School 测试你的 SQL 技能!</p>
<p><a href="/sql/sql_quiz.asp" title="SQL 测验">开始 SQL 测验</a> ！</p>
</div>
