...
<li class="currentLink"><a href="/sql/sql_update.asp" title="SQL UPDATE 语句">SQL update</a></li>
...
<div  id="tpn">
<ul class="prenext">
<li class="pre"><a href="/sql/sql_insert.asp" title="SQL INSERT INTO 语句">SQL insert</a></li>
<li class="next"><a href="/sql/sql_delete.asp" title="SQL DELETE 语句">SQL delete</a></li>
</ul>
</div>
...
<pre>UPDATE Person SET FirstName = 'Fred' WHERE LastName = 'Wilson' </pre>
...
<pre>UPDATE Person SET Address = 'Zhongshan 23', City = 'Nanjing'
