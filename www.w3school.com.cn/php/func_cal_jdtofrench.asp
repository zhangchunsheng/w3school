...
<p>JDToFrench() 函数把儒略日计数转换为法国共和国历法。</p>

<h3>语法</h3>
<pre>jdtofrench(jd)</pre>
...
<p class="note"><span>注释：</span>该函数以 &quot;month/day/year&quot; 的格式返回一个字符串。</p>

<p class="tip"><span>提示：</span>法国共和历法是法国革命期间提出的一种历法，从 1793 年晚期开始，法国政府使用了大约 12 年。</p>
