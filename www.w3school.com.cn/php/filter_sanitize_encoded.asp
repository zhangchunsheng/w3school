...
<title>PHP FILTER_SANITIZE_ENCODED 过滤器</title>
</head>
...
<h1>PHP FILTER_SANITIZE_ENCODED 过滤器</h1>
...
<p>FILTER_SANITIZE_ENCODED 过滤器去除或 URL 编码不需要的字符。</p>

<p>该函数与 urlencode() 函数很类似。</p>
...
var_dump(filter_var($url,<code>FILTER_SANITIZE_ENCODED</code>));
?&gt;</pre>

<p>输出：</p>

<pre>string(32) &quot;http%3A%2F%2Fwww.w3school.com.cn&quot;</pre>
