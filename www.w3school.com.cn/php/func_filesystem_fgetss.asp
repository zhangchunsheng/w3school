...
<p>fgetss() 函数从打开的文件中读取一行并过滤掉 HTML 和 PHP 标记。</p>

<p>与 <a href="/php/func_filesystem_fgets.asp" title="PHP fgets() 函数">fgets()</a> 相同，不同的是 fgetss 尝试从读取的文本中去掉任何 HTML 和 PHP 标记。</p>

<h3>语法</h3>
<pre>fgetss(<i>file</i>,<i>length</i>,<i>tags</i>)</pre>
...
<table class="dataintable">
  ...
  <tr>
    <td><i>length</i></td>
    <td>可选。规定要读取的字节数。默认是 1024 字节。该参数在 PHP 5 之前是必需的。
	</td>
  </tr>
  <tr>
    <td><i>tags</i></td>
...
<p>可以用可选的第三个参数 <i>tags</i> 指定哪些标记不被去掉。</p>
...
<pre><b>This is a paragraph.</b></pre>

<p>输出的源代码是：</p>

<pre>&lt;p&gt;&lt;b&gt;This is a paragraph.&lt;/b&gt;&lt;/p&gt;</pre>
