...
<title>PHP zip_entry_read() 函数</title>
</head>
...
<p>zip_entry_read() 函数从打开的 zip 档案项目中获取内容。</p>

<p>如果成功，则返回项目的内容。如果失败，则返回 false。</p>


<h3>语法</h3>
<pre>zip_entry_read(zip_entry,length)</pre>
...
if ($zip)
  ...
  while ($zip_entry = zip_read($zip))
    ...
    if (zip_entry_open($zip, $zip_entry))
      ...
      $contents = <code>zip_entry_read($zip_entry)</code>;
      echo &quot;$contents&lt;br /&gt;&quot;;
