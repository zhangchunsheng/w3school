...
<title>PHP array_diff_key() 函数</title>
</head>
...
<p>array_diff_key() 函数返回一个数组，该数组包括了所有在被比较的数组中，但是不在任何其他参数数组中的键。</p>


<h3>语法</h3>
<pre>array_diff_key(array1,array2,array3...)</pre>
...
<p class="note"><span>注释：</span>仅仅键名用于比较。</p>
</div>
