...
<title>PHP mysql_client_encoding() 函数</title>
</head>
...
<h1>PHP mysql_client_encoding() 函数</h1>
...
<p>mysql_client_encoding() 函数返回当前连接的字符集的名称。</p>


<h3>语法</h3>
<pre>mysql_client_encoding(link_identifier)</pre>
...
<p>从 MySQL 中取得 character_set 变量的值。</p>
...
$charset = <code>mysql_client_encoding($con)</code>;
...
<pre>The current character set is: latin1</pre>
