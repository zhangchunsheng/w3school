...
<p>fprintf() 函数把格式化的字符串写到指定的输出流（例如：文件或数据库）。</p>

<p>该函数返回被写字符串的长度。</p>


<h3>语法</h3>
<pre>fprintf(stream,format,arg1,arg2,arg++)</pre>
...
<table class="dataintable">
  ...
  <tr>
    <td>arg1</td>
    <td>必需。规定插到 format 字符串中第一个 % 符号处的参数。</td>
  </tr>
  <tr>
    <td>arg2</td>
    <td>可选。规定插到 format 字符串中第二个 % 符号处的参数。</td>
  </tr>
  <tr>
    <td>arg++</td>
    <td>可选。规定插到 format 字符串中第三、四等等 % 符号处的参数。</td>
  </tr>
</table>
...
<p class="note"><span>注释：</span>如果 % 符号多于 arg 参数，则您必须使用占位符。占位符被插入 % 符号之后，由数字和 &quot;\$&quot; 组成。请参见例子 3。</p>
