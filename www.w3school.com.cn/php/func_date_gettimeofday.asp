...
<title>PHP gettimeofday() 函数</title>
</head>
...
<p>gettimeofday() 函数返回一个包含当前时间信息的数组。</p>

<p>自 PHP 5.1.0 起有个可选参数 <i>return_float</i>，当其设置为 TRUE 时，gettimeofday() 会返回一个浮点数。</p>

<p>所返回的数组键的含义是： </p>

<ul>
<li>&quot;sec&quot; - 自 Unix 纪元起的秒数</li>
<li>&quot;usec&quot; - 微秒数</li>
<li>&quot;minuteswest&quot; - 格林威治向西的分钟数</li>
<li>&quot;dsttime&quot; - 夏令时修正的类型</li>
</ul>
...
<table class="dataintable"> 
  ...
  <tr>
    <td>return_float</td>
    <td>可选。当其设置为 TRUE 时，gettimeofday() 会返回一个浮点数。</td>
  </tr>
</table>
