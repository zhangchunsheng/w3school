...
<title>PHP xml_set_unparsed_entity_decl_handler() 函数</title>
</head>
...
<h1>PHP xml_set_unparsed_entity_decl_handler() 函数</h1>
...
<p>xml_set_unparsed_entity_decl_handler() 函数规定在遇到无法解析的实体名称（NDATA）声明时被调用的函数。</p>

<p>如果处理器被成功的建立，该函数将返回 true；否则返回 false。</p>


<h3>语法</h3>
<pre>xml_set_unparsed_entity_decl_handler(parser,handler)</pre>
...
<code>xml_set_unparsed_entity_decl_handler($parser,
&quot;unparsed_ent_handler&quot;);</code>
