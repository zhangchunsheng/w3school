...
<h3>语法</h3>
<pre>mkdir(path,mode,recursive,context)</pre>
...
<table class="dataintable">
  ...
  <tr>
    <td>context</td>
    <td>必需。规定文件句柄的环境。Context 是可修改流的行为的一套选项。</td>
  </tr>
</table>

<h3>说明</h3>

<p>mkdir() 尝试新建一个由 <i>path</i> 指定的目录。</p>

<p>默认的 <i>mode</i> 是 0777，意味着最大可能的访问权。</p>
...
<p class="note"><span>注释：</span><i>mode</i> 在 Windows 下被忽略。自 PHP 4.2.0 起成为可选项。</p>

<p class="note"><span>注释：</span>对 <i>context</i> 的支持是 PHP 5.0.0 添加的。</p>

<p class="note"><span>注释：</span><i>recursive</i> 参数是 PHP 5.0.0 添加的。</p>
