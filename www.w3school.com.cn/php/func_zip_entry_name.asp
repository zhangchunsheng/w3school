...
<title>PHP zip_entry_name() 函数</title>
</head>
...
<p>zip_entry_name() 函数返回 zip 档案项目的名称。</p>


<h3>语法</h3>
<pre>zip_entry_name(zip_entry)</pre>
...
if ($zip)
  ...
  while ($zip_entry = zip_read($zip))
    {
    echo &quot;Name: &quot; . <code>zip_entry_name($zip_entry)</code> . &quot;&lt;br /&gt;&quot;;
    }
  zip_close($zip);
  }
?&gt;</pre>
