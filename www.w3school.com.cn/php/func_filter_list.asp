...
<title>PHP filter_list() 函数</title>
</head>
...
<p class="note"><span>注释：</span>该函数的结果不是过滤器的 ID，而是过滤器名称。请使用 <a href="/php/func_filter_id.asp" title="PHP filter_id() 函数">filter_id()</a> 函数来获取过滤器 ID。</p>
</div>
