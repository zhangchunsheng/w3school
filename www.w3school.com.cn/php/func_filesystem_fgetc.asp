...
<p>返回一个包含有一个字符的字符串，该字符从 <i>file</i> 指向的文件中得到。碰到 EOF 则返回 false。</p>
...
<div>
<h2>提示和注释</h2>
<p class="important"><span>注意：</span>该函数可能返回布尔值 false，但也可能返回一个与 false 等值的非布尔值，例如 0 或者 &quot;&quot;。</p>
<p class="note"><span>注释：</span>该函数可安全用于二进制对象。</p>
</div>
