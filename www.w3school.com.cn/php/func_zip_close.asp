...
<p>zip_close() 函数关闭由 zip_open() 函数打开的 zip 档案文件。</p>


<h3>语法</h3>
<pre>zip_close(zip)</pre>
...
<table class="dataintable">
  ...
  <tr>
    <td>zip</td>
    <td>必需。规定要关闭的 zip 资源（由 zip_open() 打开的 zip 文件）。</td>
  </tr>
</table>
