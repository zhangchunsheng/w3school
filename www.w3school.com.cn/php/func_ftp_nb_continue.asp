...
<title>PHP ftp_nb_continue() 函数</title>
</head>
...
<p>ftp_nb_continue() 函数连续获取 / 发送文件。</p>
...
<p>该函数异步地发送/获取文件。这意味着您的程序可以在文件下载时执行其他操作。</p>


<h3>语法</h3>
<pre>ftp_nb_continue(ftp_connection)</pre>
