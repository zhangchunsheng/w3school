...
<li class="currentLink"><a href="/php/php_ref_mail.asp" title="PHP Mail 函数">PHP Mail</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/php/php_ref_libxml.asp" title="PHP LibXML 函数">PHP LibXML</a></li>
<li class="next"><a href="/php/php_ref_math.asp" title="PHP Math 函数">PHP Math</a></li>
</ul>
</div>
...
<p>邮件函数是 PHP 核心的组成部分。无需安装即可使用这些函数。</p>
</div>
...
<table class="dataintable">
  ...
  <tr>
    <td>SMTP</td>
    <td>&quot;localhost&quot;</td>
    <td>Windows 专用：SMTP 服务器的 DNS 名称或 IP 地址。</td>
    <td>PHP_INI_ALL</td>
  </tr>
  <tr>
    <td>smtp_port</td>
    <td>&quot;25&quot;</td>
    <td>Windows 专用：SMTP 端口号。自 PHP 4.3 起可用。</td>
    <td>PHP_INI_ALL</td>
  </tr>
  <tr>
    <td>sendmail_from</td>
    <td>NULL</td>
    <td>Windows 专用：规定从 PHP 发送的邮件中使用的 &quot;from&quot; 地址。</td>
    <td>PHP_INI_ALL</td>
  </tr>
  <tr>
    <td>sendmail_path</td>
    <td>NULL</td>
    <td>Unix 系统专用：规定sendmail 程序的路径（通常 /usr/sbin/sendmail 或 /usr/lib/sendmail）</td>
...
<table class="dataintable">
  ...
  <tr>
    <td>ezmlm_hash()</td>
    <td>计算 EZMLM 邮件列表系统所需的散列值。</td>
    <td>3</td>
  </tr>
  <tr>
    <td><a href="func_mail_mail.asp">mail()</a></td>
    <td>允许您从脚本中直接发送电子邮件。</td>
    <td>3</td>
  </tr>
</table>
</div>
