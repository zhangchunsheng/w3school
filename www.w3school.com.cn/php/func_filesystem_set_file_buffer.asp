...
<title>PHP set_file_buffer() 函数</title>
</head>
...
<p>set_file_buffer() 函数设置打开文件的缓冲大小。</p>

<p>若成功，则该函数返回 0。若失败，则返回 EOF。</p>


<h3>语法</h3>
<pre>set_file_buffer(file,buffer)</pre>
...
<p class="note"><span>注释：</span>该函数是 stream_set_write_buffer() 的别名。</p>
