...
<p>wordwrap() 函数按照指定长度对字符串进行折行处理。</p>

<p>如果成功，则返回折行后的字符串。如果失败，则返回 false。</p>


<h3>语法</h3>
<pre>wordwrap(string,width,break,cut)</pre>
...
<table class="dataintable">
  ...
  <tr>
    <td>string</td>
    <td>必需。规定要进行折行的字符串。</td>
  </tr>
  <tr>
    <td>width</td>
    <td>可选。规定最大行宽度。默认是 75。</td>
  </tr>
  <tr>
    <td>break</td>
    <td>可选。规定作为分隔符使用的字符（字串断开字符）。默认是 &quot;\n&quot;。</td>
  </tr>
  <tr>
    <td>cut</td>
    <td>可选。规定是否对大约指定宽度的单词进行折行。默认是 FALSE (no-wrap)。</td>
  </tr>
</table>
...
echo <code>wordwrap($str,15)</code>;
?&gt;</pre>

<p>浏览器输出：</p>

<pre>An example on a long word is: Supercalifragulistic </pre>
