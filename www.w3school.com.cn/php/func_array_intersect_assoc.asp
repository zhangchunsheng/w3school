...
<title>PHP array_intersect_assoc() 函数</title>
</head>
...
<h1>PHP array_intersect_assoc() 函数</h1>
...
<p>array_intersect_assoc() 函数返回两个或多个数组的交集数组。</p>

<p>与 <a href="/php/func_array_intersect.asp" title="PHP array_intersect() 函数">array_intersect() 函数</a> 不同的是，本函数除了比较键值，还比较键名。返回的数组中元素的键名保持不变。</p>

<h3>语法</h3>
<pre>array_intersect_assoc(array1,array2,array3...)</pre>
