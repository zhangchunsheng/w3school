...
<li class="currentLink"><a href="/php/php_mysql_connect.asp" title="PHP MySQL 连接数据库">MySQL Connect</a></li>
...
<h1>PHP MySQL 连接数据库</h1>

<div  id="tpn">
<ul class="prenext">
<li class="pre"><a href="/php/php_mysql_intro.asp" title="MySQL 简介">MySQL 简介</a></li>
<li class="next"><a href="/php/php_mysql_create.asp" title="PHP MySQL 创建数据库和表">MySQL Create</a></li>
</ul>
</div>

<div id="intro">
<p><strong>免费的 MySQL 数据库通常是通过 PHP 来使用的。</strong></p>
</div>
