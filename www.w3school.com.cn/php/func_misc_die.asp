...
<p>该函数是 <a href="/php/func_misc_exit.asp" title="PHP exit() 函数">exit()</a> 函数的别名。</p>
...
<table class="dataintable"> 
  ...
  <tr>
    <td>status</td>
    <td>必需。规定在退出脚本之前写入的消息或状态号。状态号不会被写入输出。</td>
  </tr>
</table>

<h3>说明</h3>

<p>如果 <i>status</i> 是字符串，则该函数会在退出前输出字符串。</p>

<p>如果 <i>status</i> 是整数，这个值会被用作退出状态。退出状态的值在 0 至 254 之间。退出状态 255 由 PHP 保留，不会被使用。状态 0 用于成功地终止程序。</p>
...
<p class="note"><span>注释：</span>如果 PHP 的版本号大于等于 4.2.0，那么在 <i>status</i> 是整数的情况下，不会输出该参数。</p>
</div>
...
fopen($site,&quot;r&quot;)
or <code>die(&quot;Unable to connect to $site&quot;)</code>;
?&gt;</pre>
