...
<title>PHP FILTER_VALIDATE_EMAIL 过滤器</title>
</head>
...
<h1>PHP FILTER_VALIDATE_EMAIL 过滤器</h1>
...
<p>FILTER_VALIDATE_EMAIL 过滤器把值作为电子邮件地址来验证。</p>
...
if(!filter_var($email, <code>FILTER_VALIDATE_EMAIL</code>))
 {
