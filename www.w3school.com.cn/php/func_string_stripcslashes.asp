...
<title>PHP stripcslashes() 函数</title>
</head>
...
<p>stripcslashes() 函数删除由 <a href="/php/func_string_addcslashes.asp" title="PHP addcslashes() 函数">addcslashes()</a> 函数添加的反斜杠。</p>


<h3>语法</h3>
<pre>stripcslashes(string)</pre>
...
<p class="note"><span>注释：</span>该函数用于清理从数据库中取回的数据。</p>
</div>
...
<pre>&lt;?php
echo <code>stripcslashes(&quot;Hello, \my na\me is Kai Ji\m.&quot;)</code>;
?&gt;</pre>

<p>输出：</p>

<pre>Hello, my name is Kai Jim.</pre>
