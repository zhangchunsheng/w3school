...
<table class="dataintable">
  ...
  <tr>
    <td>length</td>
    <td>可选。一个数字，定义字符串块的长度。</td>
  </tr>
  <tr>
    <td>end</td>
    <td>可选。字符串值，定义在每个字符串块之后放置的内容。</td>
  </tr>
</table>
...
<p class="note"><span>注释：</span>本函数不改变原始字符串。</p>
</div>
...
<pre>&lt;?php
$str = &quot;Hello world!&quot;;
echo <code>chunk_split($str,1,&quot;.&quot;)</code>;
?&gt;</pre>
...
<p>本例将在六个字符之后分割一次字符串，并添加 &quot;...&quot;：</p>

<pre>&lt;?php
$str = &quot;Hello world!&quot;;
echo <code>chunk_split($str,6,&quot;...&quot;)</code>;
?&gt;</pre>
