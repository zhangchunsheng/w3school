...
<p>decbin() 函数把十进制转换为二进制。</p>


<h3>语法</h3>
<pre>decbin(dec_number)</pre>
...
<p>返回一个字符串，包含有给定 <i>dec_number</i> 参数的二进制表示。所能转换的最大数值为十进制的 4294967295，其结果为 32 个 1 的字符串。</p>
