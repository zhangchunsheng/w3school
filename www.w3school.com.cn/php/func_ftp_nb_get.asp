...
<p>ftp_nb_get() 函数从 FTP 服务器上获取文件并写入本地文件 (non-blocking)。</p>
...
<p>与 <a href="/php/func_ftp_get.asp" title="PHP ftp_get() 函数">ftp_get()</a> 不同，该函数异步地获取文件。这意味着您的程序可以在文件传输时执行其他操作。</p>


<h3>语法</h3>
<pre>ftp_nb_get(ftp_connection,local,remote,mode,resume)</pre>
...
<table class="dataintable">
  ...
  <tr>
    <td>local</td>
    <td>必需。规定要写入的本地文件。若该文件已存在，则将被覆盖。</td>
  </tr>
  <tr>
    <td>remote</td>
    <td>必需。规定从中进行拷贝的文件的路径。</td>
  </tr>
  <tr>
    <td>mode</td>
    <td>
  ...
  <tr>
    <td>resume</td>
    <td>必需。规定在远程文件中的何处开始拷贝。默认是 0。</td>
  </tr>
</table>
...
<p>本例把文本从 &quot;source.txt&quot; 拷贝到 &quot;target.txt&quot; 中：</p>

<pre>&lt;?php
$conn = ftp_connect(&quot;ftp.testftp.com&quot;) or die(&quot;Could not connect&quot;);
ftp_login($conn,&quot;admin&quot;,&quot;ert456&quot;);

<code>ftp_nb_get($conn,&quot;target.txt&quot;,&quot;source.txt&quot;,FTP_ASCII);</code>
