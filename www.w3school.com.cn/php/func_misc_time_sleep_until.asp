...
<title>PHP time_sleep_until() 函数</title>
</head>
...
<p>time_sleep_until() 函数延迟代码执行直到指定的时间。</p>


<h3>语法</h3>
<pre>time_sleep_until(timestamp)</pre>
...
<p>使脚本暂停执行，直到指定的 <i>timestamp</i>。</p>
...
<p>如果指定的时间戳位于过去，则该函数将生成一个 E_WARNING。</p>
...
<p class="note"><span>注释：</span>所有信号都将在脚本唤醒后递送。</p>
