...
<p>返回自从 Unix 纪元（格林威治时间 1970 年 1 月 1 日 00:00:00）到当前时间的秒数。</p>

</div>

<div>
<h2>提示和注释</h2>
<p class="tip"><span>提示：</span>自 PHP 5.1 起在 <i>$_SERVER['REQUEST_TIME']</i> 中保存了发起该请求时刻的时间戳。</p>
</div>
...
<pre>1138618081
Mon January 30 2006</pre>

<h3>例子 2</h3>

<pre>&lt;?php
$nextWeek = time() + (7 * 24 * 60 * 60); <span>// 7 days; 24 hours; 60 mins; 60secs</span>
echo 'Now:       '. date('Y-m-d') .&quot;\n&quot;;
