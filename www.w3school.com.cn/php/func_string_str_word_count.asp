...
<title>PHP str_word_count() 函数</title>
</head>
...
<p>str_word_count() 函数计算字符串中的单词数。</p>


<h3>语法</h3>
<pre>str_word_count(string,return,char)</pre>
...
<table class="dataintable">
  ...
  <tr>
    <td>return</td>
    <td>
	<p>可选。规定 str_word_count() 函数的返回值。</p>
	<p>可能的值：</p>
	<ul class="listintable">
		<li>0 - 默认。返回找到的单词的数目。</li>
		<li>1 - 返回包含字符串中的单词的数组。</li>
		<li>2 - 返回一个数组，其中的键是单词在字符串中的位置，值是实际的单词。</li>
	</ul>
	</td>
  </tr>
  <tr>
    <td>return</td>
    <td>可选。规定被认定为单词的特殊字符。该参数是 PHP 5.1 中新加的。</td>
  </tr>
</table>
...
<pre>&lt;?php
echo <code>str_word_count(&quot;Hello world!&quot;)</code>;
?&gt;</pre>
...
<pre>&lt;?php
print_r(<code>str_word_count(&quot;Hello world!&quot;,1)</code>);
?&gt;</pre>
...
<pre>&lt;?php
print_r(<code>str_word_count(&quot;Hello world!&quot;,2)</code>);
?&gt;</pre>
...
<pre>&lt;?php
print_r(<code>str_word_count(&quot;Hello world &amp; good morning!&quot;,1)</code>);
print_r(<code>str_word_count(&quot;Hello world &amp; good morning!&quot;,1,&quot;&amp;&quot;)</code>);
?&gt;</pre>
