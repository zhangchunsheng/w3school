...
<p>mktime() 函数返回一个日期的 Unix 时间戳。</p>

<p>参数总是表示 GMT 日期，因此 <i>is_dst</i> 对结果没有影响。</p>

<p>参数可以从右到左依次空着，空着的参数会被设为相应的当前 GMT 值。</p>
...
<div>
<h2>提示和注释</h2>
<p class="note"><span>注释：</span>在 PHP 5.1 之前，如果该函数的参数非法，则会返回 false。</p>
</div>

<div>
<h2>例子</h2>

<p>mktime() 函数对于日期运算和验证非常有用。它可以自动校正越界的输入：</p>
