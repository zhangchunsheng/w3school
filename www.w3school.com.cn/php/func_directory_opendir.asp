...
<h1>PHP opendir() 函数</h1>

<div class="backtoreference">
<p><a href="/php/php_ref_directory.asp" title="PHP Directory 函数">PHP Directory 函数</a></p>
</div>

<div>
<h2>定义和用法</h2>

<p>opendir() 函数打开一个目录句柄，可由 closedir()，readdir() 和 rewinddir() 使用。</p>

<p>若成功，则该函数返回一个目录流，否则返回 false 以及一个 error。可以通过在函数名前加上 &quot;@&quot; 来隐藏 error 的输出。</p>

<h3>语法</h3>
<pre>opendir(path,context)</pre>
...
<div>
<h2>提示和注释</h2>
<p class="note"><span>注释：</span>从 PHP 5.0.0 开始，<i>path</i> 参数支持 ftp:// URL wrapper。</p>
<p class="note"><span>注释：</span>在 PHP 4.3.0 中， <i>path</i> 参数可以是任何支持目录列表的 URL，不过在 PHP 4 中只有 file:// URL wrapper 支持此功能。 </p>
</div>
...
<pre>&lt;?php
<span>//打开 images 目录</span>
$dir = opendir(&quot;images&quot;);

<span>//列出 images 目录中的文件</span>
...
filename: dog.gif
filename: food
filename: horse.gif</pre>

<h3>例子 2</h3>

<p>如果 opendir() 的输出失败，本例会隐藏错误：</p>

<pre>&lt;?php
<span>//打开 images 目录</span>
$dir = <code>@ opendir(&quot;images&quot;)</code>;
