...
<title>PHP restore_exception_handler() 函数</title>
</head>
...
<h1>PHP restore_exception_handler() 函数</h1>
...
<p>restore_exception_handler() 函数恢复之前的异常处理程序，该程序是由 set_exception_handler() 函数改变的。</p>

<p>该函数永远返回 true。</p>

<h3>语法</h3>
<pre>restore_exception_handler()</pre>

</div>

<div>
<h2>提示和注释</h2>
<p class="tip"><span>提示：</span>之前的异常处理程序可能是在异常处理程序或用户自定义函数中构建的。</p>
</div>
...
<pre><b>Fatal error</b>: Uncaught exception 'Exception' with message 
'Uncaught Exception occured' in C:\webfolder\test.php:4 
Stack trace: #0 {main} thrown in <b>C:\webfolder\test.php</b> on line <b>4</b></pre>
</div>
