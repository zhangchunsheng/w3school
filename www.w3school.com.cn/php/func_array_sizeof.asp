...
<p>sizeof() 函数计算数组中的单元数目或对象中的属性个数。</p>

<p>该函数是 <a href="/php/func_array_count.asp" title="PHP count() 函数">count()</a> 的别名。</p>

<h3>语法</h3>
<pre>sizeof(array,mode)</pre>
...
<li>0 - 默认。不检测多维数组（数组中的数组）。</li>
<li>1 - 检测多维数组。</li>
</ul>

<p>注释：该参数是 PHP 4.2 中加入的。</p>
</tr>
</table>
...
<div>
<h2>提示和注释</h2>
<p class="note"><span>注释：</span>当变量未被设置，或是变量包含一个空的数组，该函数会返回 0。可使用 isset() 变量来测试变量是否被设置。</p>
</div>
