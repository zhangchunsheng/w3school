...
<p>ltrim() 函数从字符串左侧删除空格或其他预定义字符。</p>


<h3>语法</h3>
<pre>ltrim(string,charlist)</pre>
...
echo &quot;&lt;br /&gt;&quot;;
echo &quot;With ltrim: &quot; . <code>ltrim($str)</code>;
?&gt;
&lt;body&gt;
&lt;html&gt;</pre>
...
<pre>Without ltrim: Hello World!
With ltrim: Hello World!</pre>

<p>如果在浏览器中查看源代码，会看到以下 HTML：</p>
