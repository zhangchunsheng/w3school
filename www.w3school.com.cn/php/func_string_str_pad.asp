...
<p>str_pad() 函数把字符串填充为指定的长度。</p>


<h3>语法</h3>
<pre>str_pad(string,length,pad_string,pad_type)</pre>
...
<table class="dataintable">
  ...
  <tr>
    <td>length</td>
    <td>必需。规定新字符串的长度。如果该值小于原始字符串的长度，则不进行任何操作。</td>
  </tr>
  <tr>
    <td>pad_string</td>
  ...
  <tr>
	...
	<ul class="listintable">
		<li>STR_PAD_BOTH - 填充到字符串的两头。如果不是偶数，则右侧获得额外的填充。</li>
		<li>STR_PAD_LEFT - 填充到字符串的左侧。</li>
		<li>STR_PAD_RIGHT - 填充到字符串的右侧。这是默认的。</li>
	</ul>
	</td>
  </tr>
</table>
...
<pre>&lt;?php
$str = &quot;Hello World&quot;;
echo <code>str_pad($str,20,&quot;.&quot;,STR_PAD_LEFT)</code>;
?&gt;</pre>
...
<pre>&lt;?php
$str = &quot;Hello World&quot;;
echo <code>str_pad($str,20,&quot;.:&quot;,STR_PAD_BOTH)</code>;
?&gt;</pre>
