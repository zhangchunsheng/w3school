...
<table class="dataintable">
  ...
  <tr>
    <td>array</td>
    <td>必需（除非使用 <i>from</i> 和 <i>to</i>）。一个数组，其中的键是原始字符，值是目标字符。</td>
  </tr>
</table>

<h3>说明</h3>

<p>如果 <i>from</i> 和 <i>to</i> 的长度不同，则格式化为最短的长度。</p>
...
<pre>&lt;?php
echo <code>strtr(&quot;Hilla Warld&quot;,&quot;ia&quot;,&quot;eo&quot;)</code>;
?&gt;</pre>
...
echo <code>strtr(&quot;Hello world&quot;,$arr)</code>;
?&gt;</pre>
