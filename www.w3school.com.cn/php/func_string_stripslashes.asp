...
<title>PHP stripslashes() 函数</title>
</head>
...
<p>stripslashes() 函数删除由 <a href="/php/func_string_addslashes.asp" title="PHP addslashes() 函数">addslashes()</a> 函数添加的反斜杠。</p>


<h3>语法</h3>
<pre>stripslashes(string)</pre>
...
<p class="note"><span>注释：</span>该函数用于清理从数据库或 HTML 表单中取回的数据。</p>
</div>
...
<pre>&lt;?php
echo <code>stripslashes(&quot;Who\'s John Adams?&quot;)</code>;
?&gt;</pre>

<p>输出：</p>

<pre>Who's John Adams?</pre>
