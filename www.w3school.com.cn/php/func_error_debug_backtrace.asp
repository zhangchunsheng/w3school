...
<title>PHP debug_backtrace() 函数</title>
</head>
...
<p>PHP debug_backtrace() 函数生成一个 backtrace。</p>

<p>该函数返回一个关联数组。下面是可能返回的元素：</p>
