...
<p>stristr() 函数查找字符串在另一个字符串中第一次出现的位置。</p>

<p>如果成功，则返回字符串的其余部分（从匹配点）。如果没有找到该字符串，则返回 false。</p>


<h3>语法</h3>
<pre>stristr(string,search)</pre>
...
<table class="dataintable">
  ...
  <tr>
    <td>find</td>
    <td>必需。规定要查找的字符。如果该参数是数字，则搜索匹配该数字对应的 ASCII 值的字符。</td>
  </tr>
</table>
...
<p class="note"><span>注释：</span>该函数对大小写不敏感。如需对大小写敏感的搜索，请使用 <a href="/php/func_string_strstr.asp" title="PHP strstr() 函数">strstr()</a>。</p>
...
<pre>&lt;?php
echo <code>stristr(&quot;Hello world!&quot;,&quot;WORLD&quot;)</code>;
?&gt;</pre>
...
<pre>&lt;?php
echo <code>stristr(&quot;Hello world!&quot;,111)</code>;
?&gt;</pre>
