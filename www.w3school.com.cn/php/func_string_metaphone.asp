...
<p>metaphone() 函数计算字符串的 metaphone 键。</p>

<p> metaphone 键字符串的英语发音。</p>

<p>metaphone() 函数可用于拼写检查应用程序。</p>

<p>如果成功，则返回字符串的 metaphone 键，如果失败，则返回 false。</p>

<h3>语法</h3>
<pre>metaphone(string,length)</pre>
...
<p class="note"><span>注释：</span>metaphone() 为发音相似的单词创建相同的键。</p>

<p class="note"><span>注释：</span>所生成的 metaphone 键长度可变。</p>

<p class="tip"><span>提示：</span>metaphone() 比 <a href="/php/func_string_soundex.asp" title="PHP soundex() 函数">soundex()</a> 函数更精确，因为 metaphone() 了解基本的英语发音规则。</p>
</div>
...
<pre>&lt;?php
echo <code>metaphone(&quot;world&quot;)</code>;
?&gt;</pre>
...
<p>在本例中，我们对两个发音相似的单词应用 metaphone() 函数：</p>

<pre>&lt;?php
$str = &quot;Sun&quot;;
$str2 = &quot;Son&quot;;

echo <code>metaphone($str)</code>;
echo <code>metaphone($str2)</code>;
?&gt;</pre>
