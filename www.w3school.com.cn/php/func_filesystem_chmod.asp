...
<table class="dataintable"> 
  ...
  <tr>
    ...
    <td>
	<p>可选。规定新的权限。</p>
	<p>mode 参数由 4 个数字组成：</p>
	<ul class="listintable">
	<li>第一个数字永远是 0</li>
	<li>第二个数字规定所有者的权限</li>
	<li>第二个数字规定所有者所属的用户组的权限</li>
	<li>第四个数字规定其他所有人的权限</li>
	</ul>
	<p>可能的值（如需设置多个权限，请对下面的数字进行总计）：</p>
	<ul class="listintable">
	<li>1 - 执行权限</li>
	<li>2 - 写权限</li>
	<li>4 - 读权限</li>
...
<span>// 所有者有所有权限，其他所有人可读和执行</span>
chmod(&quot;test.txt&quot;,0755);

<span>// 所有者有所有权限，所有者所在的组可读</span>
chmod(&quot;test.txt&quot;,0740);
?&gt; </pre>
