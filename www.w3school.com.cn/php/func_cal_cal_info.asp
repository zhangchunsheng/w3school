...
<p>cal_info() 函数返回一个数组，其中包含了关于给定历法的信息。</p>

<p>所返回的数组包含这些元素：calname, calsymbol, month, abbrevmonth 以及 maxdaysinmonth。</p>

<h3>语法</h3>
<pre>cal_from_jd(jd,calendar)</pre>
...
<div>
<h2>提示和注释</h2>
<p class="tip"><span>提示：</span>在 PHP 5 中，如果没有指定 calendar 参数，则返回所有被支持的历法的信息。</p>
</div>
