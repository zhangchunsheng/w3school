...
<title>PHP mt_getrandmax() 函数</title>
</head>
...
<p>mt_getrandmax() 显示随机数的最大可能值。</p>


<h3>语法</h3>
<pre>mt_getrandmax()</pre>


<h3>说明</h3>

<p>返回调用 <a href="/php/func_math_mt_rand.asp" title="PHP mt_rand() 函数">mt_rand()</a> 所能返回的最大的随机数。</p>
