...
<p>ftp_exec() 函数请求在 FTP 服务器上执行一个程序或命令。</p>

<p>若成功（服务器发送响应代码 200），则返回 true，否则返回 false。</p>


<h3>语法</h3>
<pre>ftp_exec(ftp_connection,command)</pre>
...
<table class="dataintable">
  ...
  <tr>
    <td>command</td>
    <td>必需。规定发送到服务器的命名请求。</td>
  </tr>
</table>

<h3>说明</h3>

<p>该函数发送一个 SITE EXEC command 请求到 FTP 服务器。</p>
...
<p>与 <a href="/php/func_ftp_raw.asp" title="PHP ftp_raw() 函数">ftp_raw() 函数</a> 不同，ftp_exec() 只有在登录到 FTP 服务器后才能发送命令。</p>
</div>
...
if (<code>ftp_exec($conn,$command)</code>)
  {
