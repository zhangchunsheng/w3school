...
<p>idate() 函数将本地时间/日期格式化为整数。</p>

<h3>语法</h3>
<pre>strftime(format,timestamp)</pre>
...
<p>根据给定的格式字符对 <i>timestamp</i> 进行格式化，并返回数字结果。</p>

<p><i>timestamp</i> 为可选项，默认值为本地当前时间，即 time() 的值。</p>
...
<div>
<h2>提示和注释</h2>
<p class="note"><span>注释：</span>与 <a href="/php/func_date_date.asp" title="PHP date() 函数">date()</a> 不同，idate() 只接受一个字符作为 <i>format</i> 参数。</p>

<h3>format 参数可识别以下字符</h3>
...
<tr>
<td>I</td>
<td>如果启用夏时制则返回 1，否则返回 0</td>
</tr>

<tr>
<td>L</td>
<td>如果是闰年则返回 1，否则返回 0</td>
</tr>
...
<tr>
<td>U</td>
<td>自 Unix 纪元（January 1 1970 00:00:00 GMT）起的秒数――这和 time() 作用相同</td>
</tr>

<tr>
<td>w</td>
<td>星期中的第几天（星期天是 0）</td>
</tr>
