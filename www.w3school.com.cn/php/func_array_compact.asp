...
<p>compact() 函数创建一个由参数所带变量组成的数组。如果参数中存在数组，该数组中变量的值也会被获取。</p>

<p>本函数返回的数组是一个关联数组，键名为函数的参数，键值为参数中变量的值。</p>

<p>本函数执行的行为与 <a href="/php/func_array_extract.asp" title="PHP extract() 函数">extract()</a> 正好相反。</p>

<h3>语法</h3>
<pre>compact(var1,var2...)</pre>
...
<tr>
<td>var1</td>
<td>必需。可以是带有变量名的字符串，或者是一个变量数组。</td>
</tr>

<tr>
<td>var2</td>
<td>可选。可以是带有变量名的字符串，或者是一个变量数组。允许多个参数。</td>
</tr>
...
<p class="note"><span>注释：</span>任何没有变量名与之对应的字符串都被略过。</p>
</div>
