...
<title>PHP highlight_string() 函数</title>
</head>
...
<p>highlight_string() 函数对字符串进行语法高亮显示。</p>


<h3>语法</h3>
<pre>highlight_string(string,return)</pre>
...
<p>本函数通过使用 PHP 语法高亮程序中定义的颜色，输出或返回给定的 PHP 代码的语法高亮版本。</p>

<h3>返回值</h3>

<p>如果 <i>return</i> 参数被设置为 true，那么该函数会以字符串返回被高亮处理的代码，而不是输出它们。否则，若成功，则返回 true，失败则返回 false。</p>
...
<pre>Hello&nbsp;world!&nbsp;<span style="color:#0000bb">&lt;?php&nbsp;phpinfo</span><span style="color:#007700">();</span><span style="color:#0000bb">?&gt;</span></pre>
