...
<p>ftp_get() 函数从 FTP 服务器上下载一个文件。</p>

<p>若成功则返回 true，失败则返回 false。</p>


<h3>语法</h3>
<pre>ftp_get(ftp_connection,local,remote,mode,resume)</pre>
...
echo <code>ftp_get($conn,&quot;target.txt&quot;,&quot;source.txt&quot;,FTP_ASCII)</code>;
