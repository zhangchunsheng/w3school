...
<title>PHP FILTER_SANITIZE_NUMBER_FLOAT 过滤器</title>
</head>
...
<h1>PHP FILTER_SANITIZE_NUMBER_FLOAT 过滤器</h1>
...
<p>FILTER_SANITIZE_NUMBER_FLOAT 过滤器删除浮点数中所有非法的字符。</p>
...
<ul>
	<li>FILTER_FLAG_ALLOW_FRACTION - 允许小数分隔符 （比如 .）</li>
	<li>FILTER_FLAG_ALLOW_THOUSAND - 允许千分隔符 （比如 ,）</li>
	<li>FILTER_FLAG_ALLOW_SCIENTIFIC - 允许科学技术法 （比如 e 和 E）</li>
</ul>
...
var_dump(filter_var($number, <code>FILTER_SANITIZE_NUMBER_FLOAT</code>,
FILTER_FLAG_ALLOW_FRACTION));
?&gt;</pre>

<p>输出：</p>

<pre>string(7) &quot;5-2+3.3&quot;</pre>
