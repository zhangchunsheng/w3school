...
<p>filesize() 函数返回指定文件的大小。</p>

<p>若成功，则返回文件大小的字节数。若失败，则返回 false 并生成一条 E_WARNING 级的错误。</p>


<h3>语法</h3>
<pre>filesize(filename)</pre>
