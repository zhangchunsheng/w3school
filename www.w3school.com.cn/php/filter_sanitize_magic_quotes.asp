...
<title>PHP FILTER_SANITIZE_MAGIC_QUOTES 过滤器</title>
</head>
...
<h1>PHP FILTER_SANITIZE_MAGIC_QUOTES 过滤器</h1>
...
<p>FILTER_SANITIZE_MAGIC_QUOTES 过滤器对字符串执行 addslashes() 函数。</p>

<p>该过滤器在预定义的字符串前面设置反斜杠。</p>
...
<p>FILTER_SANITIZE_MAGIC_QUOTES 信息：</p>
...
var_dump(filter_var($var, <code>FILTER_SANITIZE_MAGIC_QUOTES</code>));
?&gt;</pre>

<p>输出：</p>

<pre>string(14) &quot;Peter\'s here!&quot;</pre>
