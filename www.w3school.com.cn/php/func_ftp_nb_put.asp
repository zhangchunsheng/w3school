...
<p>ftp_nb_put() 函数把文件上传到服务器 (non-blocking)。</p>
...
<p>与 <a href="/php/func_ftp_put.asp" title="PHP ftp_put() 函数">ftp_put()</a> 不同，该函数异步地获取文件。这意味着您的程序可以在文件传输时执行其他操作。</p>
...
<code>ftp_nb_put($conn,&quot;target.txt&quot;,&quot;source.txt&quot;,FTP_ASCII);</code>
