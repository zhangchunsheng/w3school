...
<li class="currentLink"><a href="/php/php_operators.asp" title="PHP 运算符">PHP 运算符</a></li>
...
<div  id="tpn">
<ul class="prenext">
<li class="pre"><a href="/php/php_string.asp" title="PHP 字符串">PHP 字符串</a></li>
<li class="next"><a href="/php/php_if_else.asp" title="PHP If...Else 语句">PHP If...Else</a></li>
</ul>
</div>

<div id="intro">
<p><strong>运算符用于对值进行运算.</strong></p>
</div>

<div>
<h2>PHP 运算符</h2>
<p>本部分列出了在 PHP 中使用的各种运算符：</p>
...
<td>and</td>
<td> x=6<br />y=3
<p>(x &lt; 10 &amp;&amp; y &gt; 1) returns true</p></td>
</tr>
<tr>
<td>||</td>
<td>or</td>
<td> x=6<br />y=3
<p>(x==5 || y==5) returns false</p></td>
</tr>
<tr>
<td>!</td>
<td>not</td>
<td> x=6<br />y=3
<p>!(x==y) returns true</p></td>
</tr>
</table>
</div>
