...
<li class="currentLink"><a href="/php/php_includes.asp" title="PHP Include 文件">PHP Include</a></li>
...
<h1>PHP Include 文件</h1>

<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/php/php_date.asp" title="PHP Date()">PHP 日期</a></li>
<li class="next"><a href="/php/php_file.asp" title="PHP 文件处理">PHP 文件</a></li>
</ul>
</div>


<div id="intro">
<p><strong>服务器端包含 (SSI) 用于创建可在多个页面重复使用的函数、页眉、页脚或元素。</strong></p>
</div>
...
<p>在 PHP 中，您能够在服务器执行 PHP 文件之前把该文件插入另一个 PHP 文件中。</p>

<p>include 和 require 语句用于在执行流中向其他文件插入有用的的代码。</p>

<p>include 和 require 很相似，除了在错误处理方面的差异：</p>

<ul>
<li>require 会产生致命错误 (E_COMPILE_ERROR)，并停止脚本</li>
<li>include 只会产生警告 (E_WARNING)，脚本将继续</li>
</ul>
