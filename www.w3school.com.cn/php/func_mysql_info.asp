...
<p>mysql_info() 函数返回最近一条查询的信息。</p>

<p>如果成功，则返回有关该语句的信息，如果失败，则返回 false。</p>


<h3>语法</h3>
<pre>mysql_info(connection)</pre>
...
<p>mysql_info() 返回通过给定的 <i>connection</i> 所进行的最新一条查询的详细信息。如果没有指定 <i>connection</i>，则假定为上一个打开的连接。</p>

<p>mysql_info() 对以下列出的所有语句返回一个字符串：</p>
...
<p>对于其它任何语句返回 false。字符串的格式取决于给出的语句。</p>
...
<pre>String format: Records: 15 Duplicates: 0 Warnings: 0</pre>
