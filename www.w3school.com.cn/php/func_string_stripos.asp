...
<h3>语法</h3>
<pre>stripos(string,find,start)</pre>
...
<p class="note"><span>注释：</span>该函数对大小写不敏感。如需进行对大小写敏感的搜索，请使用 <a href="/php/func_string_strpos.asp" title="PHP strpos() 函数">strpos()</a> 函数。</p>
...
<pre>&lt;?php
echo <code>stripos(&quot;Hello world!&quot;,&quot;WO&quot;)</code>;
?&gt;</pre>
