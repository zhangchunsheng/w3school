...
<p>chgrp() 函数改变文件所属的组。</p>

<p>如果成功则返回 TRUE，否则返回 FALSE。</p>

<h3>语法</h3>
<pre>chgrp(file,group)</pre>
...
<table class="dataintable"> 
  ...
  <tr>
    <td>group</td>
    <td>可选。规定新的组。可以是组名或组的 ID。</td>
  </tr>
</table>

<h3>说明</h3>

<p>尝试将文件 <i>file</i> 所属的组改成 <i>group</i> （通过组名或组 ID 指定）。</p>

<p>只有超级用户可以任意修改文件的组，其它用户可能只能将文件的组改成该用户自己所在的组。</p>
</div>
