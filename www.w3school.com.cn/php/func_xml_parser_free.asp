...
<title>PHP xml_parser_free() 函数</title>
</head>
...
<p>xml_parser_free() 函数释放 XML 解析器。</p>

<p>如果成功，则返回 true。否则返回 false。</p>


<h3>语法</h3>
<pre>xml_parser_free(parser)</pre>
...
<p class="tip"><span>提示：</span>要创建 XML 解析器，请使用 <a href="/php/func_xml_parser_create.asp" title="PHP xml_parser_create() 函数">xml_parser_create()</a> 函数。</p>
</div>
...
<code>xml_parser_free($xmlparser);</code>
?&gt;</pre>
</div>
