...
<li class="currentLink"><a href="/php/php_ref_simplexml.asp" title="PHP SimpleXML 函数">PHP SimpleXML</a></li>
...
<div  id="tpn">
<ul class="prenext">
<li class="pre"><a href="/php/php_ref_mysql.asp" title="PHP MySQL 函数">PHP MySQL</a></li>
<li class="next"><a href="/php/php_ref_string.asp" title="PHP String 函数">PHP String</a></li>
</ul>
</div>
