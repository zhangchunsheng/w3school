...
<title>PHP show_source() 函数</title>
</head>
...
<p>show_source() 函数对文件进行语法高亮显示。</p>

<p>本函数是 <a href="/php/func_misc_highlight_file.asp" title="PHP highlight_file() 函数">highlight_file()</a> 的别名。</p>


<h3>语法</h3>
<pre>show_source(filename,return)</pre>
...
<p class="important"><span>警告：</span>需要注意的是，在使用 show_source() 函数时，请不要因为疏忽而泄露诸如密码或其他类型的敏感信息，否则会出现潜在的安全风险。</p>
</div>
...
show_source</span><span style="COLOR: #007700">(</span><span style="COLOR: #dd0000">&quot;test.php&quot;</span><span style="COLOR: #007700">); </span>
