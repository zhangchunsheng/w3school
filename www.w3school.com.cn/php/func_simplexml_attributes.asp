...
<p>attributes() 函数获取 SimpleXML 元素的属性。</p>

<p>该函数提供在一个 XML 标签中定义的属性和值。</p>


<h3>语法</h3>
<pre>class SimpleXMLElement
{
string attributes(<i>ns</i>,<i>is_prefix</i>)
}</pre>
...
&lt;body <span class="marked">type=&quot;small&quot; important=&quot;low&quot;</span>&gt;Don't forget the meeting!&lt;/body&gt;
&lt;/note&gt;</pre>
...
<pre>type=&quot;small&quot; important=&quot;low&quot;</pre>
</div>
