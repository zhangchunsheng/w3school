...
<p>decoct() 函数把十进制转换为八进制。</p>


<h3>语法</h3>
<pre>decoct(dec_number)</pre>
...
<p>返回一个字符串，包含有给定 <i>dec_number</i> 参数的八进制表示。所能转换的最大数值为十进制的 4294967295，其结果为 &quot;37777777777&quot;。</p>
