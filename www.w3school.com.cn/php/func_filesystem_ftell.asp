...
<p>ftell() 函数在打开文件中的当前位置。</p>

<p>该函数返回文件指针的当前位置。若失败，则返回 false。</p>
...
<table class="dataintable">
  ...
  <tr>
    <td>file</td>
    <td>必需。规定要检查的已打开文件。</td>
  </tr>
</table>

<h3>说明</h3>

<p>文件指针 <i>file</i> 必须是有效的，且必须指向一个通过 <a href="/php/func_filesystem_fopen.asp" title="PHP fopen() 函数">fopen()</a> 或 <a href="/php/func_filesystem_popen.asp" title="PHP popen() 函数">popen()</a> 成功打开的文件。</p>

<p>在附加模式（加参数 &quot;a&quot; 打开文件）中 ftell() 会返回未定义错误。</p>
