...
<title>PHP MySQL Order By 关键词</title>
</head>
...
<li class="currentLink"><a href="/php/php_mysql_order_by.asp" title="PHP MySQL Order By 关键词">MySQL Order By</a></li>
...
<h1>PHP MySQL Order By 关键词</h1>

<div  id="tpn">
<ul class="prenext">
<li class="pre"><a href="/php/php_mysql_where.asp" title="PHP MySQL Where 子句">MySQL Where</a></li>
<li class="next"><a href="/php/php_mysql_update.asp" title="PHP MySQL Update">MySQL Update</a></li>
</ul>
</div>

<div id="intro">
<p><strong>ORDER BY 关键词用于对记录集中的数据进行排序。</strong></p>
</div>
...
<p>注释：SQL 对大小写不敏感。ORDER BY 与 order by 等效。</p>

<h3>例子</h3>

<p>下面的例子选取 &quot;Persons&quot; 表中的存储的所有数据，并根据 &quot;Age&quot; 列对结果进行排序：</p>
...
<p>如果您使用 ORDER BY 关键词，记录集的排序顺序默认是升序（1 在 9 之前，&quot;a&quot; 在 &quot;p&quot; 之前）。</p>

<p>请使用 DESC 关键词来设定降序排序（9 在 1 之前，&quot;p&quot; 在 &quot;a&quot; 之前）：</p>
...
<p>可以根据多个列进行排序。当按照多个列进行排序时，只有第一列相同时才使用第二列：</p>
