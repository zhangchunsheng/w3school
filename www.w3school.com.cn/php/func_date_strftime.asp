...
<p>strftime() 函数根据区域设置格式化本地时间／日期。</p>
...
<div>
<h2>提示和注释</h2>
<p class="tip"><span>提示：</span>与 <a href="/php/func_date_gmstrftime.asp" title="PHP gmstrftime() 函数">gmstrftime()</a> 的行为相同，不同的是返回时间是本地时间。</p>
</div>
