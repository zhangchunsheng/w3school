...
<title>PHP FILTER_CALLBACK 过滤器</title>
</head>
...
<p>FILTER_CALLBACK 过滤器使用用户自定义函数对值进行过滤。</p>

<p>这个过滤器为我们提供了对数据过滤的完全控制。</p>

<p>指定的函数必须存入名为 &quot;options&quot; 的关联数组中。请参见下面的例子。</p>
...
<p class="tip"><span>提示：</span>您可以创建自己的函数，或者使用已有的 PHP 函数。</p>
</div>
...
echo filter_var($string, <code>FILTER_CALLBACK</code>,
array(&quot;options&quot;=&gt;&quot;convertSpace&quot;));
?&gt;</pre>

<p>输出：</p>

<pre>Peter_is_a_great_guy!</pre>
