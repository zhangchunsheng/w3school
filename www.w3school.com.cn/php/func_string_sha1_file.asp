...
<p>sha1_file() 函数计算文件的 SHA-1 散列。</p>

<p>sha1() 函数使用美国 Secure Hash 算法 1。</p>

<p>如果成功，则返回所计算的 SHA-1 散列，如果失败，则返回 false。</p>

<h3>语法</h3>

<pre>sha1_file(<i>string</i>,<i>raw</i>)</pre>
...
<table class="dataintable">
  ...
  <tr>
    <td><i>raw</i></td>
    <td>
	<p>可选。规定十六进制或二进制输出格式：</p>
	<ul class="listintable">
		<li>TRUE - 原始 20 字符二进制格式</li>
		<li>FALSE - 默认。40 字符十六进制数</li>
	</ul>
	<p>注释：该参数是 PHP 5.0 中添加的。</p>
	</td>
  </tr>
</table>
...
<pre>&lt;?php
$filename = &quot;test.txt&quot;;
$sha1file = <code>sha1_file($filename)</code>;
echo $sha1file;
?&gt;</pre>

<p>输出：</p>

<pre>aaf4c61ddcc5e8a2dabede0f3b482cd9aea9434d</pre>


<h3>例子 2</h3>

<p>在一个文件中存储 &quot;test.txt&quot; 的 SHA-1 散列：</p>

<pre>&lt;?php
$sha1file = <code>sha1_file(&quot;test.txt&quot;)</code>;
file_put_contents(&quot;sha1file.txt&quot;,$sha1file);
?&gt;</pre>

<p>在本例中，我们将测试 &quot;test.txt&quot; 是否已更改（即 SHA-1 hash 是否已更改）：</p>

<pre>&lt;?php
$sha1file = file_get_contents(&quot;sha1file.txt&quot;);
if (<code>sha1_file(&quot;test.txt&quot;)</code> == $sha1file)
  {
  echo &quot;The file is ok.&quot;;
  }
else
