...
<title>PHP xml_get_error_code() 函数</title>
</head>
...
<h1>PHP xml_get_error_code() 函数</h1>
...
<p>xml_get_error_code() 函数获取 XML 解析器错误代码。</p>

<p>如果成功，则返回错误代码。否则，返回 false。</p>


<h3>语法</h3>
<pre>xml_get_error_code(parser)</pre>
