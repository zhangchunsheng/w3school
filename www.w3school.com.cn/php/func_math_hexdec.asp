...
<p>hexdec() 函数把十六进制转换为十进制。</p>


<h3>语法</h3>
<pre>hexdec(hex_string)</pre>
...
<table class="dataintable">
  ...
  <tr>
    <td>hex_string</td>
    <td>必需。规定要转换的十六进制数。</td>
  </tr>
</table>

<h3>说明</h3>

<p>返回与 <i>hex_string</i> 参数所表示的十六进制数等值的的十进制数。hexdec() 将一个十六进制字符串转换为十进制数。所能转换的最大数值为 7fffffff，即十进制的 2147483647。PHP 4.1.0 开始，该函数可以处理大数字，这种情况下，它会返回 float 类型。</p>

<p>hexdec() 将遇到的所有非十六进制字符替换成 0。这样，所有左边的零都被忽略，但右边的零会计入值中。</p>
