...
<p>vprintf() 函数输出格式化的字符串。</p>

<p>与 <a href="/php/func_string_printf.asp" title="PHP printf() 函数">printf()</a> 不同，vprintf() 中的 <i>arg</i> 参数位于数组中。数组的元素会被插入主字符串的百分比 (%) 符号处。该函数是逐步执行的。在第一个 % 符号中，插入 arg1，在第二个 % 符号处，插入 arg2，依此类推。</p>


<h3>语法</h3>
<pre>vprintf(format,argarray)</pre>
...
<a href="/php/func_string_vsprintf.asp" title="PHP vsprintf() 函数">vsprintf()</a>。
</p>
...
$str = &quot;Hello&quot;;
$number = 123;
<code>vprintf(&quot;%s world. Day number %u&quot;,array($str,$number));</code>
?&gt;</pre>
...
$num1 = 123;
$num2 = 456;
<code>vprintf(&quot;%f%f&quot;,array($num1,$num2));</code>
?&gt;</pre>
...
<pre>&lt;?php
$number = 123;
<code>vprintf(&quot;With 2 decimals: %1\$.2f&lt;br /&gt;With no decimals: %1\$u&quot;,array($number));</code>
?&gt;</pre>
