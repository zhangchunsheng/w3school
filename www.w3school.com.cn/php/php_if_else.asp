...
<li class="currentLink"><a href="/php/php_if_else.asp" title="PHP If...Else 语句">PHP If...Else</a></li>
...
<h1>PHP If...Else 语句</h1>

<div  id="tpn">
<ul class="prenext">
<li class="pre"><a href="/php/php_operators.asp" title="PHP 运算符">PHP 运算符</a></li>
<li class="next"><a href="/php/php_switch.asp" title="PHP Switch 语句">PHP Switch</a></li>
</ul>
</div>

<div id="intro">
<p><strong>if、elseif 以及 else 语句用于执行基于不同条件的不同动作。</strong></p>
</div>

<div>
<h2>条件语句</h2>

<p>当您编写代码时，您常常需要为不同的判断执行不同的动作。</p>

<p>您可以在代码中使用条件语句来完成此任务。</p>

<dl class="define">
<dt>if...else 语句</dt>
<dd>在条件成立时执行一块代码，条件不成立时执行另一块代码</dd>

<dt>elseif 语句</dt>
<dd>与 if...else 配合使用，在若干条件之一成立时执行一个代码块</dd>
</dl>
</div>
...
<p>如果您希望在某个条件成立时执行一些代码，在条件不成立时执行另一些代码，请使用 if....else 语句。</p>
...
<p>如果当前日期是周五，下面的代码将输出 &quot;Have a nice weekend!&quot;，否则会输出 &quot;Have a nice day!&quot;：</p>
...
<p>如果需要在条件成立或不成立时执行多行代码，应该把这些代码行包括在花括号中：</p>
...
<p>如果希望在多个条件之一成立时执行代码，请使用 elseif 语句：</p>
...
<p>如果当前日期是周五，下面的例子会输出 &quot;Have a nice weekend!&quot;，如果是周日，则输出 &quot;Have a nice Sunday!&quot;，否则输出 &quot;Have a nice day!&quot;：</p>
