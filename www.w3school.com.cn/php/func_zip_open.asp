...
<h1>PHP zip_open() 函数</h1>

<div class="backtoreference">
<p><a href="/php/php_ref_zip.asp" title="PHP Zip File 函数">PHP Zip File 函数</a></p>
</div>

<div>
<h2>定义和用法</h2>

<p>zip_open() 函数打开 ZIP 文件以供读取。</p>

<p>如果成功，则返回 zip 文件档案资源。如果失败，则返回 false。</p>


<h3>语法</h3>
<pre>zip_open(filename)</pre>
...
<p class="tip"><span>提示：</span>新打开的 zip 文件资源之后可被 <a href="/php/func_zip_read.asp" title="PHP zip_read() 函数">zip_read()</a> 和 <a href="/php/func_zip_close.asp" title="PHP zip_close() 函数">zip_close()</a> 函数使用。</p>
</div>
...
<pre>&lt;?php
$zip = <code>zip_open(&quot;test.zip&quot;)</code>;
