...
<title>PHP convert_cyr_string() 函数</title>
</head>
...
<h1>PHP convert_cyr_string() 函数</h1>
...
<p>convert_cyr_string() 函数把字符由一种 Cyrillic 字符转换成另一种。</p>

<p>被支持的 Cyrillic 字符集是：</p>
<ul>
	<li>k - koi8-r</li>
...
<h3>语法</h3>
<pre>convert_cyr_string(string,from,to)</pre>
...
<table class="dataintable">
  ...
  <tr>
    <td>from</td>
    <td>必需。源 Cyrillic 字符集。</td>
  </tr>
  <tr>
    <td>to</td>
    <td>必需。目标 Cyrillic 字符集。</td>
  </tr>
</table>
