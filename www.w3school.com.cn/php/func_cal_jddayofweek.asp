...
<title>PHP JDDayOfWeek() 函数</title>
</head>
...
<p>JDDayOfWeek() 函数返回日期在周几。</p>

<h3>语法</h3>
<pre>jddayofweek(jd,mode)</pre>
...
<table class="dataintable"> 
  ...
  <tr>
    <td>mode</td>
    <td>
	<p>可选。定义返回的内容（数字还是字符串）。模式值：</p>
	<ul>
		<li>0 - 默认。以整数返回周的天。（0 为周日, 1 为周一... 余类推）</li>
		<li>1 - 返回包含周的天的字符串。（英文-格里高里历）</li>
		<li>2 - 返回包含周的天的简写的字符串。（英文-格里高里历）</li>
	</ul>
	</td>
  </tr>
</table>
