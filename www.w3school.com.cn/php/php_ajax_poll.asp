...
<li class="currentLink"><a href="/php/php_ajax_poll.asp" title="PHP 和 AJAX 投票">AJAX Poll</a></li>
</ul>
<h2>PHP 参考手册</h2>
<ul>
...
<div  id="tpn">
<ul class="prenext">
<li class="pre"><a href="/php/php_ajax_rss_reader.asp" title="PHP 和 AJAX RSS 阅读器">AJAX RSS Reader</a></li>
<li class="next"><a href="/php/php_ref_array.asp" title="PHP Array 函数">PHP Array</a></li>
</ul>
</div>
...
<p class="note"><span>注释：</span>记得只允许您的 web 服务器来编辑该文本文件。不要让其他人获得访问权，除了 web 服务器 (PHP)。</p>
</div>
...
<p>stateChanged() 和 GetXmlHttpObject 函数与 <a href="/php/php_ajax_suggest.asp" title="PHP 和 AJAX 请求">PHP 和 AJAX 请求</a> 这一节中的例子相同。</p>
...
<li>向 url 添加参数 (vote)，参数中带有输入字段的内容</li>
<li>添加一个随机数，以防止服务器使用缓存的文件</li>
<li>调用 GetXmlHttpObject 函数来创建 XMLHTTP 对象，并告知该对象当触发一个变化时执行 stateChanged 函数</li>
<li>用给定的 url 来打开 XMLHTTP 对象</li>
