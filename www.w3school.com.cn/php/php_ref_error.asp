...
<li class="currentLink"><a href="/php/php_ref_error.asp" title="PHP Error 和 Logging 函数">PHP Error</a></li>
...
<h1>PHP Error 和 Logging 函数</h1>

<div  id="tpn">
<ul class="prenext">
<li class="pre"><a href="/php/php_ref_directory.asp" title="PHP Directory 函数">PHP Directory</a></li>
<li class="next"><a href="/php/php_ref_filesystem.asp" title="PHP Filesystem 函数">PHP Filesystem</a></li>
</ul>
</div>
...
<p>error 和 logging 函数允许你对错误进行处理和记录。</p>
...
<table class="dataintable">
  ...
  <tr>
    <td>1</td>
    <td>E_ERROR</td>
    <td>致命的运行时错误。错误无法恢复。脚本的执行被中断。</td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td>2</td>
    <td>E_WARNING</td>
    <td>非致命的运行时错误。脚本的执行不会中断。</td>
    <td>&nbsp;</td>
  </tr>
	<tr>
    <td>4</td>
    <td>E_PARSE</td>
    <td>编译时语法解析错误。解析错误只应该由解析器生成。</td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td>8</td>
    <td>E_NOTICE</td>
    <td>运行时提示。可能是错误，也可能在正常运行脚本时发生。</td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td>16</td>
  ...
  <tr>
    ...
    <td>由 Zend 脚本引擎内部生成的错误。</td>
    <td>4</td>
  </tr>
  <tr>
    <td>128</td>
    <td>E_COMPILE_WARNING</td>
    <td>由 Zend 脚本引擎内部生成的警告。</td>
    <td>4</td>
  </tr>
  <tr>
    <td>256</td>
    <td>E_USER_ERROR</td>
    <td>由于调用 trigger_error() 函数生成的运行时错误。</td>
    <td>4</td>
  </tr>
  <tr>
    <td>512</td>
    <td>E_USER_WARNING</td>
    <td>由于调用 trigger_error() 函数生成的运行时警告。</td>
    <td>4</td>
  </tr>
  <tr>
    <td>1024</td>
    <td>E_USER_NOTICE</td>
    <td>由于调用 trigger_error() 函数生成的运行时提示。</td>
    <td>4</td>
  </tr>
  <tr>
    <td>2048</td>
    <td>E_STRICT</td>
    <td>运行时提示。对增强代码的互用性和兼容性有益。</td>
    <td>5</td>
  </tr>
  <tr>
    <td>4096</td>
    <td>E_RECOVERABLE_ERROR</td>
    <td>可捕获的致命错误。（参阅 set_error_handler()）</td>
    <td>5</td>
  </tr>
  <tr>
    <td>8191</td>
    <td>E_ALL</td>
    <td>所有的错误和警告，除了 E_STRICT。</td>
    <td>5</td>
  </tr>
</table>
</div>
