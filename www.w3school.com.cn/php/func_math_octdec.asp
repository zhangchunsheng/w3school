...
<p>octdec() 函数把八进制转换为十进制。</p>


<h3>语法</h3>
<pre>octdec(octal_string)</pre>
...
<p>返回 <i>octal_string</i> 参数所表示的八进制数的十进制等值。可转换的最大的数值为 17777777777 或十进制的 2147483647。从 PHP 4.1.0 开始，该函数可以处理大数字，这种情况下，它会返回 float 类型。</p> 
</div>
