...
<p>array_fill() 函数用给定的值填充数组，返回的数组有 number 个元素，值为 value。返回的数组使用数字索引，从 start 位置开始并递增。如果 number 为 0 或小于 0，就会出错。</p>


<h3>语法</h3>
<pre>array_fill(start,number,value)</pre>
...
<tr>
<td>start</td>
<td>必需。数值，规定键的起始索引。</td>
</tr>

<tr>
<td>number</td>
<td>必需。数值，规定填充的数量，其值必须大于 0。</td>
</tr>
...
<pre>Array ( [2] =&gt; Dog [3] =&gt; Dog [4] =&gt; Dog )</pre>
</div>
