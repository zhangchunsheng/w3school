...
<title>PHP convert_uudecode() 函数</title>
</head>
...
<p>convert_uudecode() 函数对 uuencode 编码的字符串进行解码。</p>


<h3>语法</h3>
<pre>convert_uudecode(string)</pre>
...
<p>在本例中，我们将通过使用 convert_uudecode() 对 uuencode 编码的字符串进行解码：</p>
