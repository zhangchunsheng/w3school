...
<title>PHP array_intersect() 函数</title>
</head>
...
<p>array_intersect() 函数返回两个或多个数组的交集数组。</p>

<p>结果数组包含了所有在被比较数组中，也同时出现在所有其他参数数组中的值，键名保留不变。</p>

<p class="note"><span>注释：</span>仅有值用于比较。</p>

<h3>语法</h3>
<pre>array_intersect(array1,array2,array3...)</pre>
