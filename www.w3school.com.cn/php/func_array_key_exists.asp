...
<title>PHP array_key_exists() 函数</title>
</head>
...
<p>array_key_exists() 函数判断某个数组中是否存在指定的 key，如果该 key 存在，则返回 true，否则返回 false。</p>
