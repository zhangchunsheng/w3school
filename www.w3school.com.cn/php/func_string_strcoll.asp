...
<p>字符串的比较会根据本地设置而变化。（A&lt;a 或 A&gt;a）。</p>


<h3>语法</h3>
<pre>strcoll(string1,string2)</pre>
...
<p class="note"><span>注释：</span>该函数对大小写敏感，但不是二进制安全的。</p>

<p class="note"><span>注释：</span>如果本地设置是 C 或 POSIX，则该函数的工作方式与 <a href="/php/func_string_strcmp.asp" title="PHP strcmp() 函数">strcmp()</a> 相同。</p>
...
echo <code>strcoll(&quot;Hello World!&quot;,&quot;Hello WORLD!&quot;)</code>;
echo &quot;&lt;br /&gt;&quot;;
