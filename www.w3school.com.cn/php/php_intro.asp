...
<li class="currentLink"><a href="/php/php_intro.asp" title="PHP 简介">PHP 简介</a></li>
...
<li class="next"><a href="/php/php_install.asp" title="PHP 安装">PHP 安装</a></li>
</ul>
</div>

<div id="intro">
<p><strong>PHP 文件可包含文本、HTML 标签以及脚本。PHP 文件中的脚本可在服务器上执行。</strong></p>
</div>
...
<h2>什么是 PHP？</h2>
<ul>
<li>PHP 指 PHP:超文本预处理器（译者注：PHP: Hypertext Preprocessor，递归命名）</li>
<li>PHP 是一种服务器端的脚本语言，类似 ASP</li>
<li>PHP 脚本在服务器上执行</li>
<li>PHP 支持很多数据库（MySQL、Informix、Oracle、Sybase、Solid、PostgreSQL、Generic ODBC 等等）</li>
<li>PHP 是一个开源的软件（open source software，OSS）</li>
<li>PHP 可免费下载使用</li>
</ul>
</div>
...
<h2>什么是 PHP 文件？</h2>
<ul>
<li>PHP 文件可包含文本、HTML 标签以及脚本</li>
<li>PHP 文件向浏览器返回纯粹的 HTML</li>
<li>PHP 文件的文件后缀是 &quot;.php&quot;、&quot;.php3&quot; 或 &quot;.phtml&quot;</li>
</ul>
</div>
...
<h2>什么是 MySQL？</h2>
<ul>
<li>MySQL 是一种数据库服务器</li>
<li>MySQL 支持标准的 SQL</li>
<li>MySQL 可在许多平台上编译</li>
<li>MySQL 可免费下载使用</li>
</ul>
</div>
...
<div>
<h2>PHP + MySQL</h2>
<p>PHP 与 MySQL 的组合是跨平台的（意思是您可以在 Windows 环境进行开发，而在 Unix 平台上提供服务）</p>
</div>

<div>
<h2>为什么要使用 PHP？</h2>
<ul>
<li>PHP 可在不同的平台上运行（Windows、Linux、Unix）</li>
<li>PHP 与目前几乎所有的正在被使用的服务器相兼容（Apache、IIS 等）</li>
<li>PHP 可从官方的 PHP 资源免费下载：www.php.net</li>
...
<h2>从何处开始？</h2>
<ul>
<li>在 Windows 或者 Linux 机器上安装 Apache 服务器</li>
<li>在 Windows 或者 Linux 机器上安装 PHP</li>
<li>在 Windows 或者 Linux 机器上安装 MySQL</li>
</ul>
</div>
