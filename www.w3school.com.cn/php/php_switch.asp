...
<li class="currentLink"><a href="/php/php_switch.asp" title="PHP Switch 语句">PHP Switch</a></li>
...
<div  id="tpn">
<ul class="prenext">
<li class="pre"><a href="/php/php_if_else.asp" title="PHP If...Else 语句">PHP If...Else</a></li>
<li class="next"><a href="/php/php_arrays.asp" title="PHP 数组">PHP 数组</a></li>
</ul>
</div>

<div id="intro">
<p><strong>PHP 中的 Switch 语句用于执行基于多个不同条件的不同动作。</strong></p>
</div>
...
<p>使用 Switch 语句可以避免冗长的 if..elseif..else 代码块。</p>
...
<p>工作原理：</p>
<ol>
<li>对表达式（通常是变量）进行一次计算</li>
<li>把表达式的值与结构中 case 的值进行比较</li>
<li>如果存在匹配，则执行与 case 关联的代码</li>
<li>代码执行后，<em>break 语句</em>阻止代码跳入下一个 case 中继续执行</li>
<li>如果没有 case 为真，则使用 default 语句</li>
</ol>
