...
<p>返回 <i>x</i> 的反余弦值，单位是弧度。acos() 是 <a href="/php/func_math_cos.asp" title="PHP cos() 函数">cos()</a> 的反函数，它的意思是在 acos() 范围里的每个值都是 a==cos(acos(a)) 。</p>

<p>如果 <i>x</i> 的值在 -1 到 1 之外，则返回 -1.#IND。如果为 -1，则返回 PI 的值。</p>
