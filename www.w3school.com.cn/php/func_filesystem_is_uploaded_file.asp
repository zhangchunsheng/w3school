...
<title>PHP is_uploaded_file() 函数</title>
</head>
...
<p>如果 <i>file</i> 所给出的文件是通过 HTTP POST 上传的则返回 TRUE。</p>
...
<pre>test.txt is not uploaded via HTTP POST</pre>
