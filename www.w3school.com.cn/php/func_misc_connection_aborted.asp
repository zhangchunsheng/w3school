...
<title>PHP connection_aborted() 函数</title>
</head>
...
<h1>PHP connection_aborted() 函数</h1>
...
<p>connection_aborted() 函数检查是否断开客户机。</p>

<p>如果已终止连接，则该函返回 1，否则返回 0。</p>


<h3>语法</h3>
<pre>connection_aborted()</pre>
...
<p>创建一个函数，在客户机终止脚本时写入一条日志消息：</p>

<pre>&lt;?php
function check_abort()
  {
  if (<code>connection_aborted()</code>)
...
<span>// 在脚本结束时调用 check_abort 函数</span>
