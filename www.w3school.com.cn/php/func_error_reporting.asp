...
<title>PHP error_reporting() 函数</title>
</head>
...
<p>error_reporting() 设置 PHP 的报错级别并返回当前级别。</p>

<h3>语法</h3>
<pre>error_reporting(report_level)</pre>
...
<table class="dataintable">
  ...
  <tr>
    <td>1</td>
    <td>E_ERROR</td>
    <td>Fatal run-time errors. Errors that can not be recovered from. Execution of the script is halted</td>
  </tr>
  <tr>
    <td>2</td>
    <td>E_WARNING</td>
...
<p>任意数目的以上选项都可以用“或”来连接（用 OR 或 |），这样可以报告所有需要的各级别错误。例如，下面的代码关闭了用户自定义的错误和警告，执行了某些操作，然后恢复到原始的报错级别：</p>
