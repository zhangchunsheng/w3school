...
<h3>语法</h3>
<pre>substr(<i>string</i>,<i>start</i>,<i>length</i>)</pre>
...
<table class="dataintable">
  ...
  <tr>
    <td><i>length</i></td>
    <td>
	<p>可选。规定要返回的字符串长度。默认是直到字符串的结尾。</p>
	<ul class="listintable">
		<li>正数 - 从 start 参数所在的位置返回</li>
		<li>负数 - 从字符串末端返回</li>
	</ul>	
	</td>
  </tr>
...
<pre>&lt;?php
echo <code>substr(&quot;Hello world!&quot;,6)</code>;
?&gt;</pre>
...
<pre>&lt;?php
echo <code>substr(&quot;Hello world!&quot;,6,5)</code>;
?&gt;</pre>
