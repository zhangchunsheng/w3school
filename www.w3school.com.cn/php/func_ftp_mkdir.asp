...
<p>ftp_mkdir() 函数在 FTP 服务器上建立新目录。</p>


<h3>语法</h3>
<pre>ftp_mkdir(ftp_connection,dir)</pre>
...
<table class="dataintable">
  ...
  <tr>
    <td>dir</td>
    <td>必需。规定要创建的目录的名称。</td>
  </tr>
</table>

<h3>说明</h3>

<p>在 FTP 服务器上建立一个目录名为参数 <i>dir</i> 的新目录。</p>

<p>如果成功，则返回新建的目录名，否则返回 false。</p>
...
echo <code>ftp_mkdir($conn,&quot;testdir&quot;)</code>;
