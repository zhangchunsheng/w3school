...
<p>获取由 <i>file</i> 参数指定的文件或符号连接的统计信息。</p>
...
<p class="tip"><span>提示：</span>本函数与 <a href="/php/func_filesystem_stat.asp" title="PHP stat() 函数">stat()</a> 函数相同，不同之处只有一点：如果 <i>file</i> 参数是符号连接的话，则该符号连接的状态被返回，而不是该符号连接所指向的文件的状态。</p>
