...
<title>PHP levenshtein() 函数</title>
</head>
...
<h3>语法</h3>
<pre>levenshtein(string1,string2,insert,replace,delete)</pre>
...
<table class="dataintable">
  ...
  <tr>
    <td>insert</td>
    <td>可选。插入一个字符的代价。默认是 1。</td>
  </tr>
  <tr>
    <td>replace</td>
    <td>可选。替换一个字符的代价。默认是 1。</td>
  </tr>
  <tr>
    <td>delete</td>
    <td>可选。删除一个字符的代价。默认是 1。</td>
  </tr>
</table>
...
<p class="note"><span>注释：</span>如果其中一个字符串超过 255 个字符，levenshtein() 函数返回 -1。</p>

<p class="note"><span>注释：</span>levenshtein() 函数对大小写不敏感。</p>

<p class="note"><span>注释：</span>levenshtein() 函数比 similar_text() 函数更快。不过，similar_text() 函数提供需要更少修改的更精确的结果。</p>
