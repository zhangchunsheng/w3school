...
<p>hebrev() 函数把希伯来文本从右至左的流转换为左至右的流。</p>
...
<p class="tip"><span>提示：</span>hebrev() 和 <a href="/php/func_string_hebrevc.asp" title="PHP hebrevc() 函数">hebrevc()</a> 可以把希伯来逻辑文本转换为希伯来可见文本。希伯来可见文本不需要特殊的右至左字符支持，这使它对于在 web 上显示希伯来文本很有用处。</p>
</div>
