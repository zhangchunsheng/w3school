...
<title>PHP base_convert() 函数</title>
</head>
...
<h3>语法</h3>
<pre>base_convert(number,frombase,tobase)</pre>
...
<p>返回一个字符串，包含 <i>number</i> 以 <i>tobase</i> 进制的表示。<i>number</i> 本身的进制由 <i>frombase</i> 指定。<i>frombase</i> 和 <i>tobase</i> 都只能在 2 和 36 之间（包括 2 和 36）。高于十进制的数字用字母 a-z 表示，例如 a 表示 10，b 表示 11 以及 z 表示 35。</p>
