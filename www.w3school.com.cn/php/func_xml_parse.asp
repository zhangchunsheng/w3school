...
<p>xml_parse() 函数解析 XML 文档。</p>

<p>如果成功，则返回 true。否则，返回 false。</p>


<h3>语法</h3>
<pre>xml_parse(parser,xml,end)</pre>
...
<table class="dataintable">
  ...
  <tr>
    <td>end</td>
    <td>可选。如果该参数是 true，则 xml 参数中的数据为当前解析中最后一段数据。</td>
  </tr>
</table>
...
<p class="tip"><span>提示：</span>要创建 XML 解析器，请使用 <a href="" title="">xml_parser_create()</a> 函数。</p>
</div>
...
while ($xmldata = fread($fp, 4096)) 
  ...
  if (!xml_parse($xmlparser,$xmldata,feof($fp))) 
    {
    die( print &quot;ERROR: &quot;
    . <code>xml_get_error_code($xmlparser)</code>
    . &quot;&lt;br /&gt;&quot;
    . &quot;Line: &quot;
