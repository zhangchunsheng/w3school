...
<title>PHP strncasecmp() 函数</title>
</head>
...
<h3>语法</h3>
<pre>strncasecmp(string1,string2,length)</pre>
...
<p class="note"><span>注释：</span>该函数是二进制安全的，且对大小写不敏感。</p>
...
<pre>&lt;?php
echo <code>strncasecmp(&quot;Hello world!&quot;,&quot;Hello earth!&quot;,6)</code>;
?&gt;</pre>
