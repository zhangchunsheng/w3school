...
<title>PHP xml_parser_create() 函数</title>
</head>
...
<h1>PHP xml_parser_create() 函数</h1>
...
<p>xml_parser_create() 函数创建 XML 解析器。</p>

<p>该函数建立一个新的 XML 解析器并返回可被其它 XML 函数使用的资源句柄。</p>


<h3>语法</h3>
<pre>xml_parser_create(encoding)</pre>
...
<p class="tip"><span>提示：</span>要创建带有命名空间支持的 XML 解析器，请使用 <a href="/php/func_xml_parser_create_ns.asp" title="PHP xml_parser_create_ns() 函数">xml_parser_create_ns()</a> 函数。</p>
</div>
...
<pre>&lt;?php
$xmlparser = <code>xml_parser_create()</code>;
