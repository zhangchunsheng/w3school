...
<title>PHP FILTER_VALIDATE_FLOAT 过滤器</title>
</head>
...
<h1>PHP FILTER_VALIDATE_FLOAT 过滤器</h1>
...
<p>FILTER_VALIDATE_FLOAT 过滤器把值作为浮点数来验证。</p>
...
var_dump(filter_var($var, <code>FILTER_VALIDATE_FLOAT</code>));
?&gt;</pre>
