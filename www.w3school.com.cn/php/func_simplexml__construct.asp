...
<title>PHP __construct() 函数</title>
</head>
...
<p>__construct() 函数创建一个新的 SimpleXMLElement 对象。</p>

<p>如果成功，则该函数返回一个对象。如果失败，则返回 false。</p>


<h3>语法</h3>
<pre>__construct(data,options,is_url,ns,is_prefix)</pre>
...
<table class="dataintable"> 
  ...
  <tr>
    <td>data</td>
    <td>必需。形式良好的 XML 字符串或 XML 文档的路径或 URL。</td>
  </tr>
  <tr>
    <td>options</td>
  ...
  <tr>
    <td>is_url</td>
    <td>可选。规定 data 参数是否是 URL。默认是 false。</td>
  </tr>
  <tr>
    <td>ns</td>
    <td>可选。</td>
...
<p>返回一个表示数据的 SimpleXMLElement 对象。</p>
...
<pre>Don't forget the meeting!</pre>
</div>
