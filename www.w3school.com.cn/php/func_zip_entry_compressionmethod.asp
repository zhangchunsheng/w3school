...
<title>PHP zip_entry_compressionmethod() 函数</title>
</head>
...
<h1>PHP zip_entry_compressionmethod() 函数</h1>
...
<p>zip_entry_compressionmethod() 函数返回 zip 档案项目的压缩方法。</p>


<h3>语法</h3>
<pre>zip_entry_compressionmethod(zip_entry)</pre>
...
<table class="dataintable">
  ...
  <tr>
    <td>zip_entry</td>
    <td>必需。规定要读取的 zip 项目资源（由 zip_read() 打开的 zip 项目）。</td>
  </tr>
</table>
...
if ($zip)
  ...
  while ($zip_entry = zip_read($zip))
    ...
    . <code>zip_entry_compressionmethod($zip_entry)</code>;
    echo &quot;&lt;/p&gt;&quot;;
    }
  zip_close($zip);
  }
...
<pre>Name: ziptest.txt
Compression Method: deflated

Name: htmlziptest.html
Compression Method: deflated</pre>
</div>
