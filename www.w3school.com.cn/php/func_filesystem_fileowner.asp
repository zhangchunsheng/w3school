...
<p>fileowner() 函数返回文件的所有者。</p>

<p>若成功，则返回文件所有的用户 ID。若失败，则返回 false。用户 ID 以数字格式返回。</p>


<h3>语法</h3>
<pre>fileowner(filename)</pre>
...
<p class="tip"><span>提示：</span>用户 ID 以数字格式返回，请使用 posix_getpwuid() 来把用户 ID 转换为用户名。</p>
