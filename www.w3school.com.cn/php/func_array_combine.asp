...
<title>PHP array_combine() 函数</title>
</head>
...
<p>array_combine() 函数通过合并两个数组来创建一个新数组，其中的一个数组是键名，另一个数组的值为键值。</p>

<p>如果其中一个数组为空，或者两个数组的元素个数不同，则该函数返回 false。</p>


<h3>语法</h3>
<pre>array_combine(array1,array2)</pre>
...
<div>
<h2>提示和注释</h2>
<p class="note"><span>注释：</span>两个参数必须有相同数目的元素。</p>
</div>
...
<pre>Array ( [a] =&gt; Cat [b] =&gt; Dog [c] =&gt; Horse [d] =&gt; Cow )</pre>
</div>
