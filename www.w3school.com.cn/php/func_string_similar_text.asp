...
<title>PHP similar_text() 函数</title>
</head>
...
<p>similar_text() 函数计算两个字符串的匹配字符的数目。</p>

<p>该函数也可以计算两个字符串的相似度（以百分比计）。</p>

<h3>语法</h3>
<pre>similar_text(string1,string2,percent)</pre>
...
<p class="note"><span>注释：</span><a href="/php/func_string_levenshtein.asp" title="PHP levenshtein() 函数">levenshtein()</a> 函数比 similar_text() 函数更快。不过，similar_text() 函数通过更少的必需修改次数提供更精确的结果。</p>
</div>
...
<pre>&lt;?php
similar_text(&quot;Hello World&quot;,&quot;Hello Peter&quot;,<code>$percent</code>);
echo $percent;
?&gt;</pre>

<p>输出：</p>

<pre>63.6363636364</pre>
