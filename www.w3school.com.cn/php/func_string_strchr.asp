...
<p>strchr() 函数搜索一个字符串在另一个字符串中的第一次出现。</p>

<p>该函数返回字符串的其余部分（从匹配点）。如果未找到所搜索的字符串，则返回 false。</p>

<p>该函数是 <a href="/php/func_string_strstr.asp" title="PHP strstr() 函数">strstr()</a> 函数的别名。</p>


<h3>语法</h3>
<pre>strchr(string,search)</pre>
...
<table class="dataintable">
  ...
  <tr>
    <td>search</td>
    <td>必需。规定所搜索的字符串。如果该参数是数字，则搜索匹配数字 ASCII 值的字符。</td>
  </tr>
</table>
...
<p class="note"><span>注释：</span>该函数对大小写敏感。如需进行大小写不敏感的搜索，请使用 <a href="/php/func_string_stristr.asp" title="PHP stristr() 函数">stristr()</a>。</p>
</div>
...
<pre>&lt;?php
echo <code>strchr(&quot;Hello world!&quot;,&quot;world&quot;)</code>;
?&gt;</pre>
...
<p>在本例中，我们将搜索 &quot;o&quot; 的 ASCII 值所代表的字符：</p>

<pre>&lt;?php
echo <code>strchr(&quot;Hello world!&quot;,111)</code>;
?&gt;</pre>
