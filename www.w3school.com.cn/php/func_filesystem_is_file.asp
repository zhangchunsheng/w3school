...
<p>is_file() 函数检查指定的文件名是否是正常的文件。</p>


<h3>语法</h3>
<pre>is_file(file)</pre>
...
<pre>test.txt is a regular file</pre>
