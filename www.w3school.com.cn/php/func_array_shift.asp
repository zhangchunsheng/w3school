...
<title>PHP array_shift() 函数</title>
</head>
...
<p>array_shift() 函数删除数组中的第一个元素，并返回被删除元素的值。</p>
<p class="note"><span>注释：</span>如果键是数字的，所有元素都将获得新的键，从 0 开始，并以 1 递增。（参见例子 2）。</p>

<h3>语法</h3>
<pre>array_shift(array)</pre>
