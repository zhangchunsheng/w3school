...
<p>tmpfile() 函数以读写（w+）模式建立一个具有唯一文件名的临时文件。</p>

<p>文件会在关闭后（用 fclose()）自动被删除，或当脚本结束后。</p>
...
<p class="tip"><span>提示：</span>参见 <a href="/php/func_filesystem_tempnam.asp" title="PHP tempnam() 函数">tempnam()</a>。</p>
