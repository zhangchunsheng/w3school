...
<title>PHP filter_var_array() 函数</title>
</head>
...
<p>由于无需重复调用 filter_input()，因此本函数对过滤多个变量很有用。</p>

<p>如果成功，则返回包含被过滤的变量值的数组，如果失败，则返回 false。</p>


<h3>语法</h3>
<pre>filter_var_array(array, args)</pre>
...
print_r(<code>filter_var_array($arr, $filters)</code>);
?&gt;</pre>
