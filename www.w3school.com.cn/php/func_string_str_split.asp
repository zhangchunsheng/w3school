...
<table class="dataintable">
  ...
  <tr>
    <td>length</td>
    <td>可选。规定每个数组元素的长度。默认是 1。</td>
  </tr>
</table>

<h3>说明</h3>

<p>如果 <i>length</i> 小于 1，str_split() 函数将返回 false。</p>

<p>如果 <i>length</i> 大于字符串的长度，整个字符串将作为数组的唯一元素返回。</p>
...
<pre>&lt;?php
print_r(<code>str_split(&quot;Hello&quot;)</code>);
?&gt;</pre>
...
<pre>&lt;?php
print_r(<code>str_split(&quot;Hello&quot;,3)</code>);
?&gt;</pre>
