...
<p>vsprintf() 函数把格式化字符串写入变量中。</p>

<p>与 <a href="/php/func_string_sprintf.asp" title="PHP sprintf() 函数">sprintf()</a> 不同，vsprintf() 中的 <i>arg</i> 参数位于数组中。数组的元素会被插入主字符串的百分比 (%) 符号处。该函数是逐步执行的。在第一个 % 符号中，插入 arg1，在第二个 % 符号处，插入 arg2，依此类推。</p>


<h3>语法</h3>
<pre>vsprintf(format,argarray)</pre>
...
<table class="dataintable">
  ...
  <tr>
    <td>argarray</td>
    <td>必需。带有参数的一个数组，这些参数会被插到 format 字符串中的 % 符号处。</td>
  </tr>
</table>
...
<p class="note"><span>注释：</span>如果 % 符号多于 <i>arg</i> 参数，则您必须使用占位符。占位符插到 % 符号后面，由数字和 &quot;\$&quot; 组成。请参见例子 3。</p>

<p class="tip"><span>提示：</span>
相关函数：
<a href="/php/func_string_fprintf.asp" title="PHP fprintf() 函数">fprintf()</a>、
<a href="/php/func_string_printf.asp" title="PHP printf() 函数">printf()</a>、
<a href="/php/func_string_sprintf.asp" title="PHP sprintf() 函数">sprintf()</a>、
<a href="/php/func_string_vfprintf.asp" title="PHP vfprintf() 函数">vfprintf()</a> 以及 
<a href="/php/func_string_vprintf.asp" title="PHP vprintf() 函数">vprintf()</a>。
</p>
...
$str = &quot;Hello&quot;;
$number = 123;
$txt = <code>vsprintf(&quot;%s world. Day number %u&quot;,array($str,$number))</code>;
echo $txt;
?&gt;</pre>

<p>输出：</p>

<pre>Hello world. Day number 123</pre>
...
$num1 = 123;
$num2 = 456;
$txt = <code>vsprintf(&quot;%f%f&quot;,array($num1,$num2))</code>;
echo $txt;
?&gt;</pre>

<p>输出：</p>

<pre>123.000000456.000000</pre>
...
<pre>&lt;?php
$number = 123;
$txt = <code>vsprintf(&quot;With 2 decimals: %1\$.2f
&lt;br /&gt;With no decimals: %1\$u&quot;,array($number))</code>;
echo $txt;
?&gt;</pre>

<p>输出：</p>

<pre>With 2 decimals: 123.00 
With no decimals: 123</pre>
