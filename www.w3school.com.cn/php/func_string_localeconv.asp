...
<p>localeconv() 函数返回包含本地数字及货币信息格式的数组。</p>
...
<p class="tip"><span>提示：</span>如需定义本地设置，请使用 setlocale() 函数。</p>
...
<p>在本例中，我们将获得美国本地的数字格式化信息：</p>

<pre>&lt;?php
setlocale(LC_ALL, 'US');
$locale_info = <code>localeconv()</code>;
print_r($locale_info);
?&gt;</pre>
