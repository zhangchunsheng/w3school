...
<li class="currentLink"><a href="/php/php_ref_libxml.asp" title="PHP LibXML 函数">PHP LibXML</a></li>
...
<div  id="tpn">
<ul class="prenext">
<li class="pre"><a href="/php/php_ref_http.asp" title="PHP HTTP 函数">PHP HTTP</a></li>
<li class="next"><a href="/php/php_ref_mail.asp" title="PHP Mail 函数">PHP Mail</a></li>
</ul>
</div>

<div>
<h2>PHP libxml 简介</h2>
<p>libxml 函数和常量与 SimpleXML, XSLT 以及 DOM 一起使用。</p>
</div>

<div>
<h2>安装</h2>
<p>这些函数需要 libxml 程序包。<a href="http://www.xmlsoft.org/downloads.html" title="Downloads">在 xmlsoft.org 下载</a>。</p>
</div>
...
<table class="dataintable">
  ...
  <tr>
    ...
    <td>把 CDATA 设置为文本节点。</td>
    <td>5</td>
  </tr>
	<tr>
    <td>LIBXML_NOEMPTYTAG</td>
    <td>
	<p>更改空标签（比如 &lt;br/&gt; 改为 &lt;br&gt;&lt;/br&gt;）。</p>
	<p>仅在 DOMDocument-&gt;save() 和 DOMDocument-&gt;saveXML() 函数中可用。</p>
	</td>
    <td>5</td>
  </tr>
	<tr>
  ...
  <tr>
    ...
    <td>获得 libxml 版本（例如：20605 或 20617）。</td>
    <td>5</td>
  </tr>
  <tr>
    <td>LIBXML_DOTTED_VERSION</td>
    <td>获得有点号的 libxml 版本（例如：2.6.5 或 2.6.17）。</td>
    <td>5</td>
  </tr>
</table>
</div>
