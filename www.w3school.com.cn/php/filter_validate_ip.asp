...
<title>PHP FILTER_VALIDATE_IP 过滤器</title>
</head>
...
<h1>PHP FILTER_VALIDATE_IP 过滤器</h1>
...
<p>FILTER_VALIDATE_IP 过滤器把值作为 IP 进行验证。</p>
...
if(!filter_var($ip, <code>FILTER_VALIDATE_IP</code>))
 {
...
if(!filter_var($ip, <code>FILTER_VALIDATE_IP</code>, FILTER_FLAG_IPV6))
 {
 echo &quot;IP is not valid&quot;;
 }
else
