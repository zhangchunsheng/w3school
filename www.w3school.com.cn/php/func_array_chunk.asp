...
<title>PHP array_chunk() 函数</title>
</head>
...
<p>array_chunk() 函数把一个数组分割为新的数组块。</p>
...
<h3>语法</h3>
<pre>array_chunk(array,size,preserve_key)</pre>
...
<li>true - 保留原始数组中的键名。</li>
<li>false - 默认。每个结果数组使用从零开始的新数组索引。</li>
</ul>
</td>
</tr>
</table>
