...
<p class="note"><span>注释：</span>implode() 可以接收两种参数顺序。但是由于历史原因，explode() 是不行的。你必须保证 <i>separator</i> 参数在 <i>string</i> 参数之前才行。</p>
