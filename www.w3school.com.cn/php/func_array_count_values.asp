...
<title>PHP array_count_values() 函数</title>
</head>
...
<h1>PHP array_count_values() 函数</h1>
...
<p>array_count_values() 函数用于统计数组中所有值出现的次数。</p>

<p>本函数返回一个数组，其元素的键名是原数组的值，键值是该值在原数组中出现的次数。</p>


<h3>语法</h3>
<pre>array_count_values(array)</pre>
...
<pre>Array ( [Cat] =&gt; 1 [Dog] =&gt; 2 [Horse] =&gt; 1 )</pre>
</div>
