...
<title>PHP date_sunset() 函数</title>
</head>
...
<p>date_sunset() 函数返回指定的日期与地点的日落时间。</p>

<h3>语法</h3>
<pre>date_sunset(timestamp,format,latitude,longitude,zenith,gmt_offset)</pre>
