...
<p class="note"><span>注释：</span>自 PHP 4.2.0 起，不再需要用 srand() 或 <a href="/php/func_math_mt_srand.asp" title="PHP mt_srand() 函数">mt_srand()</a> 函数给随机数发生器播种，现在已自动完成。</p>
</div>
