...
<title>PHP getDocNamespaces() 函数</title>
</head>
...
<p>getDocNamespaces() 函数从 SimpleXMLElement 对象返回在 XML 文档中声明的命名空间。</p>

<p>如果成功，该函数返回包含命名空间名称（带有关联的 URL）的数组。如果失败，则返回 false。</p>
...
<table class="dataintable"> 
  ...
  <tr>
    <td>recursive</td>
    <td>可选。规定是否返回父子节点中的所有命名空间。默认是 false。</td>
  </tr>
</table>
...
print_r(<code>$xml-&gt;getDocNamespaces()</code>);
?&gt;</pre>
