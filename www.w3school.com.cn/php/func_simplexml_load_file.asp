...
<title>PHP simplexml_load_file() 函数</title>
</head>
...
<h1>PHP simplexml_load_file() 函数</h1>

<div class="backtoreference">
<p><a href="/php/php_ref_simplexml.asp" title="PHP SimpleXML 函数">PHP SimpleXML 函数</a></p>
</div>

<div>
<h2>定义和用法</h2>

<p>simplexml_load_file() 函数把 XML 文档载入对象中。</p>

<p>如果失败，则返回 false。</p>


<h3>语法</h3>
<pre>simplexml_load_file(file,class,options,ns,is_prefix)</pre>
...
<p>返回类 SimpleXMLElement 的一个对象，该对象的属性包含 XML 文档中的数据。如果失败，则返回 false。</p>
...
if (file_exists('test.xml'))
  {
  $xml = <code>simplexml_load_file('test.xml')</code>;
  var_dump($xml);
  }
...
<pre>object(SimpleXMLElement)#1 (4)
{
[&quot;to&quot;]=&gt; string(4) &quot;George&quot;
[&quot;from&quot;]=&gt; string(4) &quot;John&quot;
