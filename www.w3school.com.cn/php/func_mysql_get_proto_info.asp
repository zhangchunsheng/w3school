...
<title>PHP mysql_get_proto_info() 函数</title>
</head>
...
<h1>PHP mysql_get_proto_info() 函数</h1>
...
<p>mysql_get_proto_info() 函数返回 MySQL 协议的信息。</p>

<p>如果成功，则返回 MySQL 协议的版本，如果失败，则返回 false。</p>


<h3>语法</h3>
<pre>mysql_get_proto_info(connection)</pre>
...
echo &quot;MySQL protocol info: &quot; . <code>mysql_get_proto_info($con)</code>;
?&gt;</pre>

<p>输出：</p>

<pre>MySQL protocol info: 10</pre>
