...
<p>JDToUnix() 函数把儒略日计数转换为 Unix 时间戳。</p>
...
<p class="note"><span>注释：</span>如果参数 jd 不在 Unix 新纪元之中（意味着格利高里年必须介于 1970 和 2037 之间，或者 jd &gt;= 2440588 且 jd &lt;= 2465342），则该函数将返回 false。所返回的时间是本地时间。</p>
