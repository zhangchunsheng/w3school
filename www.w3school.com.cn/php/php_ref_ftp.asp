...
<li class="currentLink"><a href="/php/php_ref_ftp.asp" title="PHP FTP 函数">PHP FTP</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/php/php_ref_filter.asp" title="PHP Filter 函数">PHP Filter</a></li>
<li class="next"><a href="/php/php_ref_http.asp" title="PHP HTTP 函数">PHP HTTP</a></li>
</ul>
</div>
...
<p>FTP 函数用于打开、登录以及关闭连接，同时用于上传、下载、重名命、删除及获取文件服务器上的文件信息。不是所有 FTP 函数对每个服务器都起作用或返回相同的结果。自 PHP 3 起，FTP 函数可用。</p>
...
<div>
<h2>安装</h2>
<p>PHP 的 Windows 版本已经内置该 FTP 扩展模块的支持。无需加载任何附加扩展库即可使用这些函数。</p>

<p>不过，如果您运行的是 PHP 的 Linux 版本，在编译的时候请添加 --enable-ftp 选项 (PHP4 或以上版本) 或者 --with-ftp (PHP3 版本)。</p>
</div>
...
<table class="dataintable">
  ...
  <tr>
    ...
    <td>打开一个安全的 SSL-FTP 连接。</td>
    <td>4</td>
  </tr>
  <tr>
    <td><a href="func_ftp_systype.asp">ftp_systype()</a></td>
    <td>返回远程 FTP 服务器的系统类型标识符。</td>
    <td>3</td>
  </tr>
</table>
</div>
...
<table class="dataintable">
  ...
  <tr>
    ...
    <td>
	<p>为 GET 和 PUT 请求自动决定恢复和开始的位置</p>
	<p>只能工作在 FTP_AUTOSEEK 打开的情况下</p>
	</td>
    <td>4</td>
  </tr>
  <tr>
