...
<title>PHP substr_count() 函数</title>
</head>
...
<p>substr_count() 函数计算子串在字符串中出现的次数。</p>


<h3>语法</h3>
<pre>substr_count(<i>string</i>,<i>substring</i>,<i>start</i>,<i>length</i>)</pre>
...
<pre>&lt;?php
echo <code>substr_count(&quot;Hello world. The world is nice&quot;,&quot;world&quot;)</code>;
?&gt;</pre>
