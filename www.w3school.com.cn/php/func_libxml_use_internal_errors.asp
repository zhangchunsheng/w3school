...
<title>PHP libxml_use_internal_errors() 函数</title>
</head>
...
<h1>PHP libxml_use_internal_errors() 函数</h1>

<div class="backtoreference">
<p><a href="/php/php_ref_libxml.asp" title="PHP libxml 函数">PHP libxml 函数</a></p>
</div>

<div>
<h2>定义和用法</h2>

<p>libxml_use_internal_errors() 函数禁用标准的 libxml 错误，并启用用户错误处理。</p>


<h3>语法</h3>
<pre>libxml_use_internal_errors(user_errors)</pre>
...
<table class="dataintable">
  ...
  <tr>
    <td>user_errors</td>
    <td>可选。规定是否应该启用用户错误处理。默认是 false。</td>
  </tr>
</table>

<h3>说明</h3>

<p>该函数返回 <i>user_errors</i> 参数之前的值。</p>
