...
<p>strrpos() 函数查找字符串在另一个字符串中最后一次出现的位置。</p>

<p>如果成功，则返回位置，否则返回 false。</p>


<h3>语法</h3>
<pre>strrpos(string,find,start)</pre>
...
<p class="note"><span>注释：</span>该函数对大小写敏感。如需进行大小写不敏感的查找，请使用 <a href="/php/func_string_strripos.asp" title="PHP strripos() 函数">strripos()</a>。</p>
...
<pre>&lt;?php
echo <code>strrpos(&quot;Hello world!&quot;,&quot;wo&quot;)</code>;
?&gt;</pre>
