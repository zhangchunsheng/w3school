...
<p>ftp_chdir() 函数改变 FTP 服务器上的当前目录。</p>

<p>若成功，则返回 true。否则返回 false。如果切换目录失败，PHP 还会发出一条警告。</p>


<h3>语法</h3>
<pre>ftp_chdir(ftp_connection,directory)</pre>
...
<span>//切换为 images 目录</span>
<code>ftp_chdir($conn,&quot;images&quot;);</code>
echo &quot;Dir: &quot;.ftp_pwd($conn);
