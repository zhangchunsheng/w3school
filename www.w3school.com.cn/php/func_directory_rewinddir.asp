...
<p>rewinddir() 函数重置由 opendir() 打开的目录句柄。</p>

<p>本函数什么都不会返回。</p>

<h3>语法</h3>
<pre>rewinddir(dir_stream)</pre>
...
<div>
<h2>提示和注释</h2>
<p class="tip"><span>提示：</span>本函数重读目录，并可用于检查目录中的变化。</p>
</div>
