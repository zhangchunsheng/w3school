...
<p>strripos() 函数查找字符串在另一个字符串中最后一次出现的位置。</p>
...
<p class="note"><span>注释：</span>该函数对大小写不敏感。如需进行大小写敏感的查找，请使用 <a href="/php/func_string_strrpos.asp" title="PHP strrpos() 函数">strrpos()</a>。</p>
...
<pre>&lt;?php
echo <code>strripos(&quot;Hello world!&quot;,&quot;WO&quot;)</code>;
?&gt;</pre>
