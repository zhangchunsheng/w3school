...
<p>gmdate() 函数格式化 GMT/UTC 日期/时间。</p>

<p>同 <a href="/php/func_date_date.asp" title="PHP date() 函数">date() 函数</a> 类似，不同的是返回的时间是格林威治标准时（GMT）。</p>


<h3>语法</h3>
<pre>gmdate(format,timestamp) 
</pre>
...
<div>
<h2>提示和注释</h2>
<p class="note"><span>注释：</span>在 PHP 5.1.0 之前，负的时间戳（1970 年之前的日期）在某些系统下（例如 Windows）不能工作。</p>
</div>
...
<h3>例子 1</h3>
<p>当在中国（GMT +0800）运行以下程序时，第一行显示“Jan 01 2000 00:00:00”，而第二行显示“Dec 31 1999 16:00:00”。 </p>
