...
<p>scandir() 函数返回一个数组，其中包含指定路径中的文件和目录。</p>

<p>若成功，则返回一个数组，若失败，则返回 false。如果 <i>directory</i> 不是目录，则返回布尔值 false 并生成一条 E_WARNING 级的错误。</p>

<h3>语法</h3>
<pre>scandir(directory,sort,context)</pre>
...
<table class="dataintable"> 
  ...
  <tr>
    <td>sort</td>
    <td>可选。规定排列顺序。默认是 0 （升序）。如果是 1，则为降序。</td>
  </tr>
  <tr>
    <td>context</td>
