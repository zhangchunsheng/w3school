...
<title>PHP libxml_get_errors() 函数</title>
</head>
...
<h1>PHP libxml_get_errors() 函数</h1>
...
<p>libxml_get_errors() 函数从 libxml 错误缓冲中获取错误。</p>

<p>该函数返回错误对象的一个数组，如果 libxml 错误缓冲中没有错误，则返回一个空数组。</p>


<h3>语法</h3>
<pre>libxml_get_errors()</pre>
