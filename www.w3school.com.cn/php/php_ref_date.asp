...
<li class="currentLink"><a href="/php/php_ref_date.asp" title="PHP Date / Time 函数">PHP Date</a></li>
...
<h1>PHP Date / Time 函数</h1>

<div  id="tpn">
<ul class="prenext">
<li class="pre"><a href="/php/php_ref_calendar.asp" title="PHP Calendar 函数">PHP Calendar</a></li>
<li class="next"><a href="/php/php_ref_directory.asp" title="PHP Directory 函数">PHP Directory</a></li>
</ul>
</div>

<div>
<h2>PHP Date / Time 简介</h2>

<p>date/time 函数允许您提取并格式化服务器上的日期和时间。</p>
<p class="note"><span>注释：</span>这些函数依赖于服务器的本地设置。</p>
</div>

<div>
<h2>安装</h2>
<p>date/time 函数是 PHP 核心的组成部分。无需安装即可使用这些函数。</p>
</div>

<div>
<h2>Runtime 配置</h2>

<p>日期/时间函数的行为受到 php.ini 中设置的影响。</p>
...
<table class="dataintable">
  ...
  <tr>
    ...
    <td>&nbsp;&quot;31.7667&quot;</td>
    <td>规定默认纬度（从 PHP 5 开始可用）。date_sunrise() 和 date_sunset() 使用该选项。</td>
    <td>PHP_INI_ALL</td>
  </tr>
  <tr>
    <td>date.default_longitude</td>
    <td>&quot;35.2333&quot;</td>
    <td>规定默认经度（从 PHP 5 开始可用）。date_sunrise() 和 date_sunset() 使用该选项。</td>
    <td>PHP_INI_ALL</td>
  </tr>
  <tr>
...
<table class="dataintable">
  ...
  <tr>
    ...
    <td>根据本地区域设置格式化 GMT/UTC 时间／日期。</td>
    <td>3</td>
  </tr>
  <tr>
    <td><a href="func_date_idate.asp">idate()</a></td>
    <td>将本地时间/日期格式化为整数</td>
    <td>5</td>
  </tr>
  <tr>
...
<table class="dataintable">
  ...
  <tr>
    <td>DATE_ATOM</td>
    <td>原子钟格式 (如: 2005-08-15T16:13:03+0000)</td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td>DATE_COOKIE</td>
    <td>HTTP Cookies 格式 (如: Sun, 14 Aug 2005 16:13:03 UTC)</td>
    <td>&nbsp;</td>
  </tr>
	<tr>
    <td>DATE_ISO8601</td>
    <td>ISO-8601 (如: 2005-08-14T16:13:03+0000)</td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td>DATE_RFC822</td>
    <td>RFC 822 (如: Sun, 14 Aug 2005 16:13:03 UTC)</td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td>DATE_RFC850</td>
    <td>RFC 850 (如: Sunday, 14-Aug-05 16:13:03 UTC)</td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td>DATE_RFC1036</td>
    <td>RFC 1036 (如: Sunday, 14-Aug-05 16:13:03 UTC)</td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td>DATE_RFC1123</td>
    <td>RFC 1123 (如: Sun, 14 Aug 2005 16:13:03 UTC)</td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td>DATE_RFC2822</td>
    <td>RFC 2822 (如: Sun, 14 Aug 2005 16:13:03 +0000)</td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td>DATE_RSS</td>
    <td>RSS (如: Sun, 14 Aug 2005 16:13:03 UTC)</td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td>DATE_W3C</td>
    <td>World Wide Web Consortium (如: 2005-08-14T16:13:03+0000)</td>
    <td>&nbsp;</td>
  </tr>
</table>
</div>
