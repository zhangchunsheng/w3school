...
<li class="currentLink"><a href="/php/php_mysql_delete.asp" title="PHP MySQL Delete From">MySQL Delete</a></li>
...
<h1>PHP MySQL Delete From</h1>

<div  id="tpn">
<ul class="prenext">
<li class="pre"><a href="/php/php_mysql_update.asp" title="PHP MySQL Update">MySQL Update</a></li>
<li class="next"><a href="/php/php_db_odbc.asp" title="PHP Database ODBC">PHP ODBC</a></li>
</ul>
</div>

<div id="intro">
<p><strong>DELETE FROM 语句用于从数据库表中删除行。</strong></p>
</div>
...
<p class="note"><span>注释：</span>SQL 对大小写不敏感。DELETE FROM 与 delete from 等效。</p>

<p>为了让 PHP 执行上面的语句，我们必须使用 mysql_query( 函数。该函数用于向 SQL 连接发送查询和命令。</p>

<h3>例子</h3>
<p>稍早时，我们在本教程中创建了一个名为 &quot;Persons&quot; 的表。它看起来类似这样：</p>
...
<p>下面的例子删除 &quot;Persons&quot; 表中所有 LastName='Griffin' 的记录：</p>
