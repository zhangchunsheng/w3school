...
<p>deg2rad() 函数将角度转换为弧度。</p>


<h3>语法</h3>
<pre>deg2rad(degree_number)</pre>
...
<p>本函数把 <i>degree_number</i> 从角度转换成弧度。</p>
...
<pre>角度 180 等于弧度 3.14159265359</pre>
</div>
