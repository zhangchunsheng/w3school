...
<p>ftp_quit() 函数关闭 FTP 连接。</p>

<p>该函数关闭给出的连接标识符并释放资源。</p>


<h3>语法</h3>
<pre>ftp_quit(ftp_connection)</pre>
...
<p class="tip"><span>提示：</span>该函数是 <a href="/php/func_ftp_close.asp" title="PHP ftp_close() 函数">ftp_close()</a> 函数的别名。</p>
</div>
