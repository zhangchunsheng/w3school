...
<p>ftp_nlist() 函数返回指定目录的文件列表。</p>

<p>如果成功，则返回给定目录下的文件名组成的数组，否则返回 false。</p>


<h3>语法</h3>
<pre>ftp_nlist(ftp_connection,dir)</pre>
...
<p class="note"><span>注释：</span>该函数不适用于 IIS (Internet Information Server)。它返回 nothing。</p>
...
print_r(<code>ftp_nlist($conn,&quot;images&quot;)</code>);
