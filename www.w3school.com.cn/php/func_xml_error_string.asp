...
<title>PHP xml_error_string() 函数</title>
</head>
...
<p>xml_error_string() 函数获取 XML 解析器的错误描述。</p>



<h3>语法</h3>
<pre>xml_error_string(errorcode)</pre>
...
<table class="dataintable"> 
  ...
  <tr>
    <td>errorcode</td>
    <td>必需。规定要使用的错误代码。该错误码是 xml_get_error_code() 函数的返回值。</td>
  </tr>
</table>

<h3>说明</h3>

<p>返回与 <i>errorcode</i> 描述的错误代码参数对应的文本描述字符串，若没有与之对应的描述，则返回 false。</p>
...
while ($xmldata = fread($fp, 4096)) 
  ...
  if (!xml_parse($xmlparser,$xmldata,feof($fp))) 
    {
    die( print &quot;ERROR: &quot;
    . <code>xml_error_string(xml_get_error_code($xmlparser))</code>
    . &quot;&lt;br /&gt;&quot;
    . &quot;Line: &quot;
