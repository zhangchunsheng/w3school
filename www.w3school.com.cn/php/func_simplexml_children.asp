...
foreach (<code>$xml-&gt;children()</code> as $child)
  {
...
<pre>Child node: George
Child node: John
Child node: Reminder
Child node: Don't forget the meeting!</pre>
</div>
