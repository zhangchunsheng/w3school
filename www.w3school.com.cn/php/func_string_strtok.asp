...
<p>strtok() 函数把字符串分割为更小的字符串。</p>


<h3>语法</h3>
<pre>strtok(string,split)</pre>
...
<p>在下面的例子中，请注意，我们仅在第一次调用 strtok() 函数时使用了 <i>string</i> 参数。在首次调用后，该函数仅需要 <i>split</i> 参数，这是因为它清楚自己在当前函数中所在的位置：</p>

<pre>&lt;?php
$string = &quot;Hello world. Beautiful day today.&quot;;
$token = <code>strtok($string, &quot; &quot;)</code>;

while ($token !== false)
  {
  echo &quot;$token&lt;br /&gt;&quot;;
  $token = <code>strtok(&quot; &quot;)</code>;
  }
?&gt;</pre>
