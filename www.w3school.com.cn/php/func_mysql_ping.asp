...
<p>mysql_ping() 函数 Ping 一个服务器连接，如果没有连接则重新连接。</p>

<p>如果存在连接，则返回 true。如果失败，则返回 false。</p>


<h3>语法</h3>
<pre>mysql_ping(connection)</pre>
...
<p class="note"><span>注释：</span>本函数可用于空闲很久的脚本来检查服务器是否关闭了连接。</p>
</div>
