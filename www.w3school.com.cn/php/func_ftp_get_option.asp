...
<title>PHP ftp_get_option() 函数</title>
</head>
...
<p>ftp_get_option() 函数返回当前 FTP 连接的各种不同的选项设置。</p>


<h3>语法</h3>
<pre>ftp_get_option(ftp_connection,option)</pre>
...
<table class="dataintable">
  ...
  <tr>
    <td>option</td>
    <td>
	<p>必需。规定要返回的选项。可能的值有：</p>
	<ul class="listintable">
		<li>FTP_TIMEOUT_SEC - 返回网络操作的时间限制</li>
		<li>FTP_AUTOSEEK - 如果设置该选项，则返回 true，否则返回 false</li>
	</ul>
	</td>
  </tr>
</table>
...
<p>如果成功，则返回选项的值，否则，如果给定的参数 <i>option</i> 选项若不被支持，则返回 false 同时会提示一条错误信息。</p> 

<p>此函数会返回连接句柄为 <i>ftp_connection</i>，指定键值 <i>option</i> 的值。</p>
...
echo <code>ftp_get_option($conn,FTP_TIMEOUT_SEC)</code>;
