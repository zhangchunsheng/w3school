...
<title>PHP restore_error_handler() 函数</title>
</head>
...
<h1>PHP restore_error_handler() 函数</h1>
...
<p>restore_error_handler() 函数恢复之前的错误处理程序，该程序是由 set_error_handler() 函数改变的。</p>

<p>该函数永远返回 true。</p>

<h3>语法</h3>
<pre>restore_error_handler()</pre>

</div>

<div>
<h2>提示和注释</h2>
<p class="tip"><span>提示：</span>之前的错误处理程序可能是在错误处理程序或用户自定义函数中构建的。</p>
</div>
...
<pre>
<b>Custom error:</b> [1024] A custom error has been triggered
Error on line 14 in C:\webfolder\test.php

<b>Notice</b>: A custom error has been triggered in <b>
C:\webfolder\test.php</b> on line <b>21</b></pre>
</div>
