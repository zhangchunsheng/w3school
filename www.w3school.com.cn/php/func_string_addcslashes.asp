...
<title>PHP addcslashes() 函数</title>
</head>
...
<h3>语法</h3>
<pre>addcslashes(<i>string</i>,<i>characters</i>)</pre>
...
<p class="note"><span>注释：</span>在对 0，r，n 和 t 应用 addcslashes() 时要小心。在 PHP 中，\0，\r，\n 和 \t 是预定义的转义序列。</p>
</div>
...
<p>在本例中，我们要向字符串中的特定字符添加反斜杠：</p>

<pre>&lt;?php
$str = &quot;Hello, my name is John Adams.&quot;;
echo $str;
echo <code>addcslashes($str,'m');</code>
echo <code>addcslashes($str,'J');</code>
?&gt;</pre>

<p>输出：</p>

<pre>Hello, my name is John Adams.
Hello, \my na\me is John Ada\ms.
Hello, my name is \John Adams.</pre>



<h3>例子 2</h3>

<p>在本例中，我们要向字符串中的一个范围内的字符添加反斜杠：</p>

<pre>&lt;?php
$str = &quot;Hello, my name is John Adams.&quot;;
echo $str;
echo <code>addcslashes($str,'A..Z')</code>;
echo <code>addcslashes($str,'a..z')</code>;
echo <code>addcslashes($str,'a..h')</code>;
?&gt;</pre>
...
H\e\l\l\o, \m\y \n\a\m\e \i\s J\o\h\n A\d\a\m\s.
H\ello, my n\am\e is Jo\hn A\d\ams.</pre>
