...
<p>list() 函数用数组中的元素为一组变量赋值。</p>

<p>注意，与 <a href="/php/func_array.asp" title="PHP array()">array()</a> 类似，list() 实际上是一种语言结构，不是函数。</p>

<h3>语法</h3>
<pre>list(var1,var2...)</pre>
...
<div>
<h2>提示和注释</h2>
<p class="note"><span>注释：</span>该函数只用于数字索引的数组，且假定数字索引从 0 开始。</p>
</div>
...
<pre>I have several animals, a Dog, a Cat and a Horse.</pre>
</div>
...
<pre>Here I only use the Dog and Horse variables.</pre>
</div>
