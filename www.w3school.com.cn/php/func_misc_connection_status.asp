...
<title>PHP connection_status() 函数</title>
</head>
...
<h1>PHP connection_status() 函数</h1>
...
<p>connection_status() 函数返回当前的连接状态。</p>

<p>可返回的可能值：</p>

<ul>
	<li>0 - CONNECTION_NORMAL - 连接运行正常</li>
	<li>1 - CONNECTION_ABORTED - 连接由用户或网络错误终止</li>
	<li>2 - CONNECTION_TIMEOUT - 连接超时</li>
	<li>3 - CONNECTION_ABORTED &amp; CONNECTION_TIMEOUT</li>
</ul>


<h3>语法</h3>
<pre>connection_status()</pre>
...
switch (<code>connection_status()</code>)
{
