...
<title>PHP mysql_get_server_info() 函数</title>
</head>
...
<h1>PHP mysql_get_server_info() 函数</h1>
...
<p>mysql_get_server_info() 函数返回 MySQL 服务器的信息。</p>

<p>如果成功，则返回 MySQL 服务器的版本号，如果失败，则返回 false。</p>


<h3>语法</h3>
<pre>mysql_get_server_info(connection)</pre>
...
echo &quot;MySQL server info: &quot; . <code>mysql_get_server_info($con)</code>;
?&gt;</pre>

<p>输出：</p>

<pre>MySQL server info: 5.0.18-nt</pre>
