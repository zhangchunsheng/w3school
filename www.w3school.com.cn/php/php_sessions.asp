...
<li class="currentLink"><a href="/php/php_sessions.asp" title="PHP Sessions">PHP Sessions</a></li>
...
<div  id="tpn">
<ul class="prenext">
<li class="pre"><a href="/php/php_cookies.asp" title="PHP Cookies">PHP Cookies</a></li>
<li class="next"><a href="/php/php_mail.asp" title="PHP 发送电子邮件">PHP E-mail</a></li>
</ul>
</div>

<div id="intro">
<p><strong>PHP session 变量用于存储有关用户会话的信息，或更改用户会话的设置。Session 变量保存的信息是单一用户的，并且可供应用程序中的所有页面使用。</strong></p>
</div>
...
<p class="note"><span>注释：</span>session_start() 函数必须位于 &lt;html&gt; 标签之前：</p>
...
<p class="note"><span>注释：</span>session_destroy() 将重置 session，您将失去所有已存储的 session 数据。</p>
</div>
