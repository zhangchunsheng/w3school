...
<li class="currentLink"><a href="/php/php_ref_misc.asp" title="PHP 杂项函数">PHP 杂项</a></li>
</ul>
<h2>PHP 测验</h2>
<ul>
...
<div  id="tpn">
<ul class="prenext">
<li class="pre"><a href="/php/php_ref_zip.asp" title="PHP Zip File 函数">PHP Zip</a></li>
<li class="next"><a href="/php/php_quiz.asp" title="PHP 测验">PHP 测验</a></li>
</ul>
</div>
...
<p>杂项函数函数的行为受到 php.ini 中设置的影响。</p>
...
<table class="dataintable">
  ...
  <tr>
    ...
    <td>&quot;0&quot;</td>
    <td>FALSE 指示只要脚本在客户机终止连接后尝试进行输出，脚本将被终止。</td>
    <td>PHP_INI_ALL</td>
  </tr>
  <tr>
    <td>highlight.string</td>
    <td>&quot;#DD0000&quot;</td>
    <td>供突出显示符合 PHP 语法的字符串而使用的颜色。</td>
    <td>PHP_INI_ALL</td>
  </tr>
  <tr>
    <td>highlight.comment</td>
    <td>&quot;#FF8000&quot;</td>
    <td>供突出显示 PHP 注释而使用的颜色。</td>
    <td>PHP_INI_ALL</td>
  </tr>
  <tr>
    <td>highlight.keyword</td>
    <td>&quot;#007700&quot;</td>
    <td>供突出显示 PHP 关键词而使用的颜色（比如圆括号和分号）。</td>
    <td>PHP_INI_ALL</td>
  </tr>
  <tr>
    <td>highlight.bg</td>
  ...
  <tr>
    <td>browscap</td>
    <td>NULL</td>
    <td>浏览器性能文件的名称和位置（例如：browscap.ini）。</td>
...
<table class="dataintable">
  ...
  <tr>
    <td><a href="func_misc_ignore_user_abort.asp">ignore_user_abort()</a></td>
    <td>设置与客户机断开是否会终止脚本的执行。</td>
    <td>3</td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td>在 PHP 5.0.5 中不赞成使用。</td>
    <td>5</td>
  </tr>
  <tr>
    <td><a href="func_misc_strip_whitespace.asp">php_strip_whitespace()</a></td>
    <td>返回已删除 PHP 注释以及空白字符的源代码文件。</td>
    <td>5</td>
  </tr>
  <tr>
    <td><a href="func_misc_show_source.asp">show_source()</a></td>
    <td>highlight_file() 的别名。</td>
    <td>4</td>
  </tr>
  <tr>
