...
<li class="currentLink"><a href="/php/php_ref_http.asp" title="PHP HTTP 函数">PHP HTTP</a></li>
...
<div  id="tpn">
<ul class="prenext">
<li class="pre"><a href="/php/php_ref_ftp.asp" title="PHP FTP 函数">PHP FTP</a></li>
<li class="next"><a href="/php/php_ref_libxml.asp" title="PHP LibXML 函数">PHP LibXML</a></li>
</ul>
</div>

<div>
<h2>PHP HTTP 简介</h2>
<p>HTTP 函数允许您在其他输出被发送之前，对由 web 服务器发送到浏览器的信息进行操作。</p>
</div>

<div>
<h2>安装</h2>
<p>HTTP 函数是 PHP 核心的组成部分。无需安装即可使用这些函数。</p>
</div>
