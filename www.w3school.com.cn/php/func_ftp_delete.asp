...
<p>ftp_delete() 函数删除 FTP 服务器上的一个文件。</p>

<p>若成功，则返回 true，否则返回 false。</p>


<h3>语法</h3>
<pre>ftp_delete(ftp_connection,path)</pre>
...
<table class="dataintable">
  ...
  <tr>
    <td>path</td>
    <td>必需。规定要删除的文件的路径。</td>
  </tr>
</table>

<h3>说明</h3>

<p>ftp_delete() 函数用来删除 FTP 服务器上的一个由参数 <i>path</i> 指定的的文件。</p>
...
echo <code>ftp_delete($conn,&quot;test.txt&quot;)</code>;
