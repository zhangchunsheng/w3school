...
<title>PHP ftp_ssl_connect() 函数</title>
</head>
...
<p>ftp_ssl_connect() 函数打开一个安全的 SSL-FTP 连接。</p>

<p>当连接打开，您就可以在服务器运行 FTP 函数。</p>


<h3>语法</h3>
<pre>ftp_ssl_connect(host,port,timeout)</pre>
...
<table class="dataintable">
  ...
  <tr>
    <td>host</td>
    <td>
	<p>必需。规定要使用的 FTP 连接（FTP 连接的标识符）。</p>
	<p>可以是域名或 IP 地址。该参数不能包含 &quot;ftp://&quot; 或 斜杠。</p>
	</td>
  </tr>
  <tr>
    <td>port</td>
    <td>可选。规定 FTP 服务器的端口。默认是 21。</td>
  </tr>
  <tr>
    <td>timeout</td>
    <td>可选。规定 FTP 连接的超时时间。默认是 90 秒。</td>
  </tr>
</table>
...
<p>本例尝试连接一个 FTP 服务器。如果连接失败，die() 函数会终止脚本的执行，并输出一条消息：</p>

<pre>&lt;?php
$conn = <code>ftp_ssl_connect(&quot;ftp.testftp.com&quot;)</code> or die(&quot;Could not connect&quot;);
?&gt;</pre>
