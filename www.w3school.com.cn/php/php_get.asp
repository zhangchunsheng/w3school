...
<li class="currentLink"><a href="/php/php_get.asp" title="PHP $_GET">PHP $_GET</a></li>
...
<div  id="tpn">
<ul class="prenext">
<li class="pre"><a href="/php/php_forms.asp" title="PHP 表单和用户输入">PHP 表单</a></li>
<li class="next"><a href="/php/php_post.asp" title="PHP $_POST">PHP $_POST</a></li>
</ul>
</div>

<div id="intro">
<p><strong>$_GET 变量用于收集来自 method=&quot;get&quot; 的表单中的值。</strong></p>
</div>
...
<pre>&lt;form action=&quot;welcome.php&quot; <code>method=&quot;get&quot;</code>&gt;
Name: &lt;input type=&quot;text&quot; name=&quot;name&quot; /&gt;
Age: &lt;input type=&quot;text&quot; name=&quot;age&quot; /&gt;
&lt;input type=&quot;submit&quot; /&gt;
&lt;/form&gt;</pre>

<p>当用户点击提交按钮时，发送的 URL 会类似这样：</p>

<pre>http://www.w3school.com.cn/welcome.php?name=Peter&amp;age=37</pre>

<p>&quot;welcome.php&quot; 文件现在可以通过 $_GET 变量来获取表单数据了（请注意，表单域的名称会自动成为 $_GET 数组中的 ID 键）：</p>

<pre>Welcome &lt;?php echo <code>$_GET[&quot;name&quot;]</code>; ?&gt;.&lt;br /&gt;
You are &lt;?php echo <code>$_GET[&quot;age&quot;]</code>; ?&gt; years old!</pre>
</div>

<div>
<h2>为什么使用 $_GET？</h2>

<p class="note"><span>注释：</span>在使用 $_GET 变量时，所有的变量名和值都会显示在 URL 中。所以在发送密码或其他敏感信息时，不应该使用这个方法。不过，正因为变量显示在 URL 中，因此可以在收藏夹中收藏该页面。在某些情况下，这是很有用的。</p>

<p class="note"><span>注释：</span>HTTP GET 方法不适合大型的变量值；值是不能超过 100 个字符的。</p>
</div>
