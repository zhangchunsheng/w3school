...
<title>PHP mysql_field_seek() 函数</title>
</head>
...
<p>mysql_field_seek() 函数将结果集中的指针设定为指定的字段偏移量。</p>

<p>如果成功，则返回 true，如果失败，则返回 false。</p>


<h3>语法</h3>
<pre>mysql_field_seek(data,field_offset)</pre>
...
<span>// 跳到第四个字段</span>
<code>mysql_field_seek($result,3);</code>
