...
<title>PHP xml_set_processing_instruction_handler() 函数</title>
</head>
...
<h1>PHP xml_set_processing_instruction_handler() 函数</h1>
...
<p>xml_set_processing_instruction_handler() 函数规定当解析器在 XML 文档中找到处理指令时所调用的函数。</p>

<p>处理指令包含在 &lt;? 和 ?&gt; 分隔符中。</p>

<p>如果处理器被成功的建立，该函数将返回 true；否则返回 false。</p>

<p>例子：在本例中，处理指令把一个样式表与 XML 文档关联起来：</p>

<pre>&lt;?xml version=&quot;1.0&quot; encoding=&quot;ISO-8859-1&quot;?&gt;
<code>&lt;?xml-stylesheet href=&quot;default.xsl&quot; type=&quot;text/xml&quot;?&gt;</code>
&lt;note&gt;
&lt;to&gt;Tove&lt;/to&gt;
&lt;from&gt;Jani&lt;/from&gt;
...
<h3>语法</h3>
<pre>xml_set_processing_instruction_handler(parser,handler)</pre>
...
<p>由 <i>handler</i> 参数规定的函数必须有三个参数：</p>
...
<table class="dataintable"> 
  ...
  <tr>
	...
	<tr>
    <td>target</td>
    <td>必需。规定包含处理指令目标的变量。</td>
  </tr>
  </tr>
	<tr>
    <td>data</td>
    <td>必需。规定包含处理指令数据的变量。</td>
  </tr>
</table>
...
<code>xml_set_processing_instruction_handler($parser, &quot;pi_handler&quot;);</code>
$fp=fopen(&quot;test.xml&quot;,&quot;r&quot;);
