...
<title>PHP mysql_fetch_lengths() 函数</title>
</head>
...
<h1>PHP mysql_fetch_lengths() 函数</h1>
...
<p>mysql_fetch_lengths() 函数取得一行中每个字段的内容的长度。</p>

<p>行是由这些函数返回的：<a href="/php/func_mysql_fetch_array.asp" title="PHP mysql_fetch_array() 函数">mysql_fetch_array()</a>、<a href="/php/func_mysql_fetch_assoc.asp" title="PHP mysql_fetch_assoc() 函数">mysql_fetch_assoc()</a>、<a href="/php/func_mysql_fetch_object.asp" title="PHP mysql_fetch_object() 函数">mysql_fetch_object()</a> 或 <a href="/php/func_mysql_fetch_row.asp" title="PHP mysql_fetch_row() 函数">mysql_fetch_row()</a>。</p>

<p>若成功，则该函数返回一个数字数组，若出错或没有其他的行，则返回 false。</p>


<h3>语法</h3>
<pre>mysql_fetch_lengths(data)</pre>
...
<table class="dataintable">
  ...
  <tr>
    <td>data</td>
    <td>必需。要使用的数据指针。该数据指针是从 <a href="/php/func_mysql_query.asp" title="PHP mysql_query() 函数">mysql_query()</a> 返回的结果。</td>
  </tr>
</table>
...
print_r(<code>mysql_fetch_lengths($result)</code>);
