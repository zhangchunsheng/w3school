...
<title>PHP date_default_timezone_set() 函数</title>
</head>
...
<h1>PHP date_default_timezone_set() 函数</h1>
...
<p>date_default_timezone_set() 函数设置用在脚本中所有日期/时间函数的默认时区。</p>

<h3>语法</h3>
<pre>date_default_timezone_set(timezone)</pre>
...
<table class="dataintable"> 
  ...
  <tr>
    <td>timezone</td>
    <td>
	<p>必需。时区标识符，比如 &quot;UTC&quot; 或 &quot;Europe/Paris&quot;。</p>
	<p>合法时区的列表：<a href="http://www.php.net/manual/en/timezones.php" title="PHP List of Supported Timezones - Manual">http://www.php.net/manual/en/timezones.php</a></p>
	</td>
  </tr>
</table>
...
<p class="note"><span>注释：</span>自 PHP 5.1.0 起（此版本日期时间函数被重写了），如果时区不合法则每个对日期时间函数的调用都会产生一条 E_NOTICE 级别的错误信息，如果使用系统设定或 TZ 环境变量则还会产生 E_STRICT 级别的信息。</p>
