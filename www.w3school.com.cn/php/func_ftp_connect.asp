...
<title>PHP ftp_connect() 函数</title>
</head>
...
<h1>PHP ftp_connect() 函数</h1>

<div class="backtoreference">
<p><a href="/php/php_ref_ftp.asp" title="PHP FTP 函数">PHP FTP 函数</a></p>
</div>

<div>
<h2>定义和用法</h2>

<p>ftp_connect() 函数建立一个新的 FTP 连接。</p>

<p>若成功，则返回一个连接标识，否则返回 false。</p>


<h3>语法</h3>
<pre>ftp_connect(host,port,timeout)</pre>
...
<table class="dataintable">
  ...
  <tr>
    <td>host</td>
    <td>
	<p>必需。规定要连接的 FTP 服务器。可以是域名或 IP 地址。</p>
	<p>后面不应以斜线结尾，前面也不需要用 ftp:// 开头。</p>
	</td>
  </tr>
  <tr>
    <td>port</td>
    <td>可选。规定 FTP 服务器的端口。</td>
  </tr>
  <tr>
    <td>timeout</td>
    <td>可选。规定该 FTP 服务器的超时时间。默认是 90 秒。</td>
  </tr>
</table>

<h3>说明</h3>

<p class="tip"><span>提示：</span>超时时间可以在任何时候通过函数 <a href="/php/func_ftp_set_option.asp" title="PHP ftp_set_option() 函数">ftp_set_option()</a> 及 <a href="/php/func_ftp_get_option.asp" title="PHP ftp_get_option() 函数">ftp_get_option()</a> 来改变和获取。</p>

<p>参数 <i>timeout</i> 仅适用于 PHP 4.2.0 及以上版本。</p>
...
<p>本例尝试连接一个 FTP 服务器。如果连接失败，则 die() 函数将终止脚本，并输出一条消息：</p>
