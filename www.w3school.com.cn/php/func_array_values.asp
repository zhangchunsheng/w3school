...
<title>PHP array_values() 函数</title>
</head>
...
<p>array_values() 函数返回一个包含给定数组中所有键值的数组，但不保留键名。</p>

<h3>语法</h3>
<pre>array_values(array)</pre>
...
<p class="tip"><span>提示：</span>被返回的数组将使用数值键，从 0 开始且以 1 递增。</p>
</div>
...
<pre>Array ( [0] =&gt; Cat [1] =&gt; Dog [2] =&gt; Horse )</pre>
</div>
