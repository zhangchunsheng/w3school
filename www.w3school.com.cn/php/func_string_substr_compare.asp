...
<title>PHP substr_compare() 函数</title>
</head>
...
<p>substr_compare() 函数从指定的开始长度比较两个字符串。</p>

<p>该函数返回：</p>

<ul>
	<li>0 - 如果两字符串相等</li>
	<li>&lt;0 - 如果 string1 （从开始位置）小于 string2</li>
	<li>&gt;0 - 如果 string1 （从开始位置）大于 string2</li>
</ul>



<h3>语法</h3>
<pre>substr_compare(string1,string2,startpos,length,case)</pre>
...
<table class="dataintable">
  ...
  <tr>
    <td>startpos</td>
    <td>可选。规定在 <i>string1</i> 中的何处开始比较。</td>
  </tr>
  <tr>
    <td>length</td>
    <td>可选。规定在 <i>string1</i> 中参与比较的字符数。</td>
  </tr>
  <tr>
    <td>case</td>
    <td>可选。规定是否指定大小写比较。默认是 FALSE （对大小写敏感）。</td>
  </tr>
</table>

<h3>说明</h3>

<p>如果 <i>length</i> 大于或等于 <i>string1</i> 的长度，则函数返回 false。</p>
...
<pre>&lt;?php
echo <code>substr_compare(&quot;Hello world&quot;,&quot;Hello world&quot;,0)</code>;
?&gt;</pre>
...
<pre>&lt;?php
echo <code>substr_compare(&quot;Hello world&quot;,&quot;world&quot;,6)</code>;
?&gt;</pre>
...
<pre>&lt;?php
echo <code>substr_compare(&quot;Hello world&quot;,&quot;WORLD&quot;,6,TRUE)</code>;
?&gt;</pre>
