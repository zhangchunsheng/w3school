...
<p>ftp_alloc() 函数为要上传到 FTP 服务器的文件分配空间。</p>

<p>若成功，则返回 true。否则返回 false。</p>


<h3>语法</h3>
<pre>ftp_alloc(ftp_connection,size,return)</pre>
...
<p class="note"><span>注释：</span>很多服务器不支持该命令。</p>
...
<code>ftp_alloc($conn,&quot;160&quot;,$response);</code>
echo $response;
...
if (<code>ftp_alloc($conn, filesize($file), $response)</code>)
  {
