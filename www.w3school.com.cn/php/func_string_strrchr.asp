...
<p>strrchr() 函数查找字符串在另一个字符串中最后一次出现的位置，并返回从该位置到字符串结尾的所有字符。</p>

<p>如果成失败，否则返回 false。</p>


<h3>语法</h3>
<pre>strrchr(string,char)</pre>
...
<pre>&lt;?php
echo <code>strrchr(&quot;Hello world!&quot;,&quot;world&quot;)</code>;
?&gt;</pre>
...
<pre>&lt;?php
echo <code>strrchr(&quot;Hello world!&quot;,111)</code>;
?&gt;</pre>
