...
<title>PHP array_reduce() 函数</title>
</head>
...
<p>array_reduce() 函数用回调函数迭代地将数组简化为单一的值。如果指定第三个参数，则该参数将被当成是数组中的第一个值来处理，或者如果数组为空的话就作为最终返回值。</p>

<h3>语法</h3>
<pre>array_reduce(array,function,initial)</pre>
...
<tr>
<td>function</td>
<td>必需。规定自定义回调函数的名称。</td>
</tr>

<tr>
<td>initial</td>
<td>可选。如果规定了该参数，该参数将作为数组中的第一个值来处理。</td>
</tr>
</table>
</div>
