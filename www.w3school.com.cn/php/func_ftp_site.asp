...
<p>ftp_site() 函数向服务器发送 SITE 命令。</p>

<p>SITE 命令没有标准化。不同的服务器不尽相同。对于处理文件权限或组关系方面的事情，SITE 命令很有用。</p>


<h3>语法</h3>
<pre>ftp_site(ftp_connection,command)</pre>
...
<table class="dataintable">
  ...
  <tr>
    <td>command</td>
    <td>必需。规定向 FTP 发送的 SITE 命令。</td>
  </tr>
</table>

<h3>说明</h3>

<p>ftp_site() 函数向 FTP 服务器发送由参数 <i>command</i> 指定的命令。</p>
...
<p class="tip"><span>提示：</span>如需查看哪些命令可用，请通过 <a href="/php/func_ftp_raw.asp" title="PHP ftp_raw() 函数">ftp_raw()</a> 函数发送 REMOTEHELP 命令。</p>
</div>
...
<code>ftp_site($conn,&quot;CHMOD 0600 sitetest.txt&quot;);</code>
