...
<title>PHP mysql_field_len() 函数</title>
</head>
...
<p>mysql_field_len() 函数返回指定字段的长度。</p>

<p>如果成功，则返回字段的长度，如果失败，则返回 false。</p>


<h3>语法</h3>
<pre>mysql_field_len(data,field_offset)</pre>
...
$length = <code>mysql_field_len($result, 0)</code>;
