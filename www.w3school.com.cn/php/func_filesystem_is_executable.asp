...
<title>PHP is_executable() 函数</title>
</head>
...
<p>is_executable() 函数检查指定的文件是否可执行。</p>


<h3>语法</h3>
<pre>is_executable(file)</pre>
...
<p class="note"><span>注释：</span>is_executable() 自 PHP 5.0.0 版起可用于 Windows。</p>
</div>
...
<pre>setup.exe is executable</pre>
