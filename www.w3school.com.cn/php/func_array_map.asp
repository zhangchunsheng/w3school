...
<p>array_map() 函数返回用户自定义函数作用后的数组。回调函数接受的参数数目应该和传递给 array_map() 函数的数组数目一致。</p>

<h3>语法</h3>
<pre>array_map(function,array1,array2,array3...)</pre>
...
<pre>Array ( [0] =&gt; Horse [1] =&gt; Fido [2] =&gt; Cat )</pre>
</div>
...
<pre>Array ( [0] =&gt; different [1] =&gt; same [2] =&gt; different )</pre>
</div>

<div>
<h2>例子 3</h2>

<p>请看当自定义函数名设置为 null 时的情况：</p>
