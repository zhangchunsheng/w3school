...
<p>strip_tags() 函数剥去 HTML、XML 以及 PHP 的标签。</p>


<h3>语法</h3>
<pre>strip_tags(string,allow)</pre>
...
<p class="note"><span>注释：</span>该函数始终会剥离 HTML 注释。这点无法通过 <i>allow</i> 参数改变。</p>
</div>
...
<pre>&lt;?php
echo <code>strip_tags(&quot;Hello &lt;b&gt;world!&lt;/b&gt;&quot;)</code>;
?&gt;</pre>
...
<pre>&lt;?php
echo strip_tags(&quot;Hello &lt;b&gt;&lt;i&gt;world!&lt;/i&gt;&lt;/b&gt;&quot;,<code>&quot;&lt;b&gt;&quot;</code>);
?&gt;</pre>
