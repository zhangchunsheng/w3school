...
<p>ROT-13 编码是一种每一个字母被另一个字母代替的方法。这个代替字母是由原来的字母向前移动 13 个字母而得到的。数字和非字母字符保持不变。</p>


<h3>语法</h3>
<pre>str_rot13(string)</pre>
...
<p class="tip"><span>提示：</span>编码和解码都是由相同的函数完成的。如果您把一个已编码的字符串作为参数，那么将返回原始字符串。</p>
</div>
...
<p>在本例中，我们将通过使用 str_rot13() 函数对字符串进行编码和解码：</p>

<pre>&lt;?php
echo <code>str_rot13(&quot;Hello World&quot;)</code>;
echo &quot;&lt;br /&gt;&quot;;
echo <code>str_rot13(&quot;Uryyb Jbeyq&quot;)</code>;
?&gt;</pre>
