...
<p>range() 函数创建并返回一个包含指定范围的元素的数组。</p>

<h3>语法</h3>
<pre>range(first,second,step)</pre>
...
<td>step</td>
<td>
	<p>可选。规定元素之间的步进制。默认是 1。</p>
	<p>注释：该参数是 PHP 5 中加入的。</p>
</td>
</tr>
</table>
...
<p>该函数创建一个数组，包含从 first 到 second （包含 first 和 second）之间的整数或字符。如果 second 比 first 小，则返回反序的数组。</p>
