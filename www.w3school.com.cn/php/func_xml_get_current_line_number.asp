...
<title>PHP xml_get_current_line_number() 函数</title>
</head>
...
<h1>PHP xml_get_current_line_number() 函数</h1>
...
<p>xml_get_current_line_number() 函数获取 XML 解析器的当前行号。</p>


<h3>语法</h3>
<pre>xml_get_current_line_number(parser)</pre>
...
<p>如果 <i>parser</i> 参数没有指向一个合法的解析器，该函数将返回 FALSE，否则将返回指定解析器在其缓存中的当前行号。</p>
...
while ($xmldata = fread($fp, 4096)) 
  ...
  if (!xml_parse($xmlparser,$xmldata,feof($fp))) 
    ...
    . &quot;&lt;br /&gt;&quot;
    . &quot;Line: &quot;
    . <code>xml_get_current_line_number($xmlparser)</code>
    . &quot;&lt;br /&gt;&quot;
    . &quot;Column: &quot;
