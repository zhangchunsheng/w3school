...
<li class="currentLink"><a href="/php/php_ajax_xmlhttprequest.asp" title="AJAX XMLHttpRequest">XMLHttpRequest</a></li>
...
<div  id="tpn">
<ul class="prenext">
<li class="pre"><a href="/php/php_ajax_intro.asp" title="AJAX XMLHttpRequest">AJAX 简介</a></li>
<li class="next"><a href="/php/php_ajax_suggest.asp" title="PHP 和 AJAX 请求">AJAX Suggest</a></li>
</ul>
</div>

<div>
<p><strong>XMLHttpRequest 对象使 AJAX 成为可能。</strong></p>
</div>
...
<p>不同的浏览器使用不同的方法来创建 <em>XMLHttpRequest</em> 对象。</p>

<p>Internet Explorer 使用 <em>ActiveXObject</em>。</p>

<p>其他浏览器使用名为 <em>XMLHttpRequest</em> 的 JavaScript 内建对象。</p>
...
<ol>
<li>首先创建一个作为 XMLHttpRequest 对象使用的 <em>XMLHttp</em> 变量。把它的值设置为 null。</li>
<li>然后测试 <em>window.XMLHttpRequest</em> 对象是否可用。在新版本的 Firefox, Mozilla, Opera 以及 Safari 浏览器中，该对象是可用的。</li>
<li>如果可用，则用它创建一个新对象：<em>XMLHttp=new XMLHttpRequest()</em></li>
<li>如果不可用，则检测 <em>window.ActiveXObject</em> 是否可用。在 Internet Explorer version 5.5 及更高的版本中，该对象是可用的。</li>
<li>如果可用，使用它来创建一个新对象：<em>XMLHttp=new ActiveXObject()</em></li>
</ol>
</div>
...
<h3>代码解释：</h3>
<ol>
<li>首先创建用作 XMLHttpRequest 对象的 <em>XMLHttp</em> 变量。把它的值设置为 null。</li>
<li>按照 web 标准创建对象 (Mozilla, Opera 以及 Safari)：<em>XMLHttp=new XMLHttpRequest()</em></li>
<li>按照微软的方式创建对象，在 Internet Explorer 6 及更高的版本可用：<em>XMLHttp=new ActiveXObject(&quot;Msxml2.XMLHTTP&quot;)</em></li>
<li>如果捕获错误，则尝试更老的方法 (Internet Explorer 5.5) ：<em>XMLHttp=new ActiveXObject(&quot;Microsoft.XMLHTTP&quot;)</em></li>
</ol>
</div>

<div>
<h2>更多有关 XMLHttpRequest 对象的信息</h2>

<p>如果您希望阅读更多有关 XMLHttpRequest 的内容，请访问我们的 <a href="/ajax/index.asp" title="AJAX 教程">AJAX 教程</a>。</p>
</div>
