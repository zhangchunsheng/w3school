...
<p>mt_srand() 播种 Mersenne Twister 随机数生成器。</p>


<h3>语法</h3>
<pre>mt_srand(seed)</pre>
...
<p>从 PHP 4.2.0 版开始，<i>seed</i> 参数变为可选项，当该项为空时，会被设为随时数。</p> 
</div>
...
<p class="note"><span>注释：</span>自 PHP 4.2.0 起，不再需要用 <a href="/php/func_math_srand.asp" title="PHP srand() 函数">srand()</a> 或 mt_srand() 函数给随机数发生器播种，现已自动完成。</p>
