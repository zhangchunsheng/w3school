...
<p>sprintf() 函数把格式化的字符串写入一个变量中。</p>


<h3>语法</h3>
<pre>sprintf(<i>format</i>,<i>arg1</i>,<i>arg2</i>,<i>arg++</i>)</pre>
...
<table class="dataintable">
  ...
  <tr>
    <td><i>arg1</i></td>
    <td>必需。规定插到 <i>format</i> 字符串中第一个 % 符号处的参数。</td>
  </tr>
  <tr>
    <td><i>arg2</i></td>
    <td>可选。规定插到 <i>format</i> 字符串中第二个 % 符号处的参数。</td>
  </tr>
  <tr>
    <td><i>arg++</i></td>
    <td>可选。规定插到 <i>format</i> 字符串中第三、四等等 % 符号处的参数。</td>
  </tr>
</table>
...
<p><i>arg1</i>, <i>arg2</i>, <i>++</i> 等参数将插入到主字符串中的百分号 (%) 符号处。该函数是逐步执行的。在第一个 % 符号中，插入 <i>arg1</i>，在第二个 % 符号处，插入 <i>arg2</i>，依此类推。</p>
...
<a href="/php/func_string_vfprintf.asp" title="PHP vfprintf() 函数">vfprintf()</a>、
<a href="/php/func_string_vprintf.asp" title="PHP vprintf() 函数">vprintf()</a> 以及 
...
$str = &quot;Hello&quot;;
$number = 123;
$txt = <code>sprintf(&quot;%s world. Day number %u&quot;,$str,$number)</code>;
echo $txt;
?&gt;</pre>
...
<pre>&lt;?php
$number = 123;
$txt = <code>sprintf(&quot;%f&quot;,$number)</code>;
echo $txt;
?&gt;</pre>
