...
<p>printf() 函数输出格式化的字符串。</p>


<h3>语法</h3>
<pre>printf(format,arg1,arg2,arg++)</pre>
...
<table class="dataintable">
  ...
  <tr>
    <td>arg1</td>
    <td>必需。规定插到格式化字符串中第一个 % 符号处的参数。</td>
  </tr>
  <tr>
    <td>arg2</td>
    <td>可选。规定插到格式化字符串中第二个 % 符号处的参数。</td>
  </tr>
  <tr>
    <td>arg++</td>
    <td>可选。规定插到格式化字符串中第三、四等等 % 符号处的参数。</td>
  </tr>
</table>
