...
<title>PHP filter_has_var() 函数</title>
</head>
...
<p>filter_has_var() 函数检查是否存在指定输入类型的变量。</p>

<p>若成功，则返回 true，否则返回 false。</p>


<h3>语法</h3>
<pre>filter_has_var(type, variable)</pre>
...
<p>在本例中，输入变量 &quot;name&quot; 被发送到 PHP 页面：</p>

<pre>&lt;?php
if(!<code>filter_has_var(INPUT_GET, &quot;name&quot;)</code>)
&nbsp;{
