...
<p>chop() 函数从字符串的末端开始删除空白字符或其他预定义字符。</p>

<p>该函数的 <a href="/php/func_string_rtrim.asp" title="PHP rtrim() 函数">rtrim()</a> 函数的别名。</p>


<h3>语法</h3>
<pre>chop(string,charlist)</pre>
...
<table class="dataintable">
  ...
  <tr>
    <td>charlist</td>
    <td>
	<p>可选。规定从字符串中删除哪些字符。</p>
	<p>如果未设置该参数，则全部删除以下字符：</p>
	<ul class="listintable">
		<li>&quot;\0&quot; - ASCII 0, NULL</li>
		<li>&quot;\t&quot; - ASCII 9, 制表符</li>
		<li>&quot;\n&quot; - ASCII 10, 新行</li>
		<li>&quot;\x0B&quot; - ASCII 11, 垂直制表符</li>
		<li>&quot;\r&quot; - ASCII 13, 回车</li>
		<li>&quot; &quot; - ASCII 32, 空格</li>
	</ul>
	</td>
...
<p>在本例中，我们将使用 chop() 函数从字符串右端删除字符：</p>

<pre>&lt;?php
$str = &quot;Hello World!\n\n&quot;;
echo $str;
echo <code>chop($str)</code>;
?&gt;</pre>
