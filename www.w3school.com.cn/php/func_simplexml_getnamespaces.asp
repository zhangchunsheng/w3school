...
<title>PHP getNamespace() 函数</title>
</head>
...
<p>getNamespace() 函数获取在 XML 文档中使用的命名空间。</p>

<p>如果成功，该函数返回命名空间（带有关联的 URL）的一个数组。如果失败，则返回 false。</p>
...
<table class="dataintable"> 
  ...
  <tr>
    <td>recursive</td>
    <td>可选。规定是否返回父子节点中使用的所有命名空间。默认是 false。</td>
  </tr>
</table>
...
print_r(<code>$xml-&gt;getNamespaces()</code>);
?&gt;</pre>
