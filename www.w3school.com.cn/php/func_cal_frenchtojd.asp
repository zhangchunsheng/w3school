...
<p>FrenchToJD() 函数将法国共和历法转换成为儒略日计数。</p>

<h3>语法</h3>
<pre>frenchtojd(month,day,year)</pre>
...
<div>
<h2>提示和注释</h2>
<p>法国共和历法是法国革命期间提出的一种历法，从 1793 年晚期开始，法国政府使用了大约 12 年。该函数只转换 1 到 14 年内的日期 （格利高里历 1792 年 9 月 22 日 - 1806 年 9 月 22 日）。</p>
</div>
