...
<p>ftp_fget() 函数从 FTP 服务器上下载一个文件并保存到本地一个已经打开的文件中。</p>

<p>若成功则返回 true，失败则返回 false。</p>


<h3>语法</h3>
<pre>ftp_fget(ftp_connection,local,remote,mode,resume)</pre>
...
<p>参数 <i>resume</i> 仅适用于 PHP 4.3.0 以上版本</p>
...
<code>ftp_fget($conn,$target,$source,FTP_ASCII);</code>
