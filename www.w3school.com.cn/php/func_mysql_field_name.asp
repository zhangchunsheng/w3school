...
<title>PHP mysql_field_name() 函数</title>
</head>
...
<p>mysql_field_name() 函数取得结果中指定字段的字段名。</p>

<p>如果成功，则返回字段的名称，如果失败，则返回 false。</p>


<h3>语法</h3>
<pre>mysql_field_name(data,field_offset)</pre>
...
$name = <code>mysql_field_name($result, 0)</code>;
