...
<p>array_diff() 函数返回两个数组的差集数组。该数组包括了所有在被比较的数组中，但是不在任何其他参数数组中的键值。</p>

<p>在返回的数组中，键名保持不变。</p>


<h3>语法</h3>
<pre>array_diff(array1,array2,array3...)</pre>
