...
<li class="currentLink"><a href="/php/php_ref_math.asp" title="PHP Math 函数">PHP Math</a></li>
...
<div  id="tpn">
<ul class="prenext">
<li class="pre"><a href="/php/php_ref_mail.asp" title="PHP Mail 函数">PHP Mail</a></li>
<li class="next"><a href="/php/php_ref_mysql.asp" title="PHP MySQL 函数">PHP MySQL</a></li>
</ul>
</div>

<div>
<h2>PHP Math 简介</h2>
<p>数学 (Math) 函数能处理 integer 和 float 范围内的值。</p>
</div>

<div>
<h2>安装</h2>
<p>数学 (Math) 函数是 PHP 核心的组成部分。无需安装即可使用这些函数。</p>
</div>
...
<table class="dataintable">
  ...
  <tr>
    <td><a href="func_math_atan.asp">atan2()</a></td>
    <td>两个参数的反正切。</td>
    <td>3</td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td>返回 E<sup>x</sup> 的值。</td>
    <td>3</td>
  </tr>
  <tr>
    <td><a href="func_math_expm1.asp">expm1()</a></td>
    <td>返回 E<sup>x</sup> - 1 的值。</td>
    <td>4</td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td>使用 Mersenne Twister 算法返回随机整数。</td>
    <td>3</td>
  </tr>
  <tr>
    <td><a href="func_math_mt_srand.asp">mt_srand()</a></td>
    <td>播种 Mersenne Twister 随机数生成器。</td>
    <td>3</td>
  </tr>
  <tr>
