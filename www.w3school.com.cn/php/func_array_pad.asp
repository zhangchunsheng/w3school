...
<p>array_pad() 函数向一个数组插入带有指定值的指定数量的元素。</p>

<h3>语法</h3>
<pre>array_pad(array,size,value)</pre>
...
<tr>
<td>size</td>
<td>必需。指定的长度。整数则填补到右侧，负数则填补到左侧。</td>
</tr>
...
<p class="tip"><span>提示：</span>如何设置了负的长度值，该函数会在原始数组之前插入新的元素。（参见例子 2）</p>

<p class="note"><span>注释：</span>如果 size 参数小于原始数组的长度，该函数不会删除任何元素。</p>
</div>
...
<pre>Array ( [0] =&gt; Dog [1] =&gt; Cat [2] =&gt; 0 [3] =&gt; 0 [4] =&gt; 0 )</pre>
</div>
...
<pre>Array ( [0] =&gt; 0 [1] =&gt; 0 [2] =&gt; 0 [3] =&gt; Dog [4] =&gt; Cat )</pre>
</div>
