...
<p>asXML() 函数以字符串的形式从 SimpleXMLElement 对象返回 XML 文档。</p>
...
<table class="dataintable"> 
  ...
  <tr>
    <td>file</td>
    <td>可选。如果规定了此参数，则该函数会把 XML 写入一个文件，而不是返回它。</td>
  </tr>
</table>
...
<p>如果在浏览器窗口中选择“查看源文件”，会看到这些 HTML：</p>
