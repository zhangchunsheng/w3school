...
<li class="currentLink"><a href="/php/php_xml_dom.asp" title="PHP XML DOM">XML DOM</a></li>
...
<div  id="tpn">
<ul class="prenext">
<li class="pre"><a href="/php/php_xml_parser_expat.asp" title="PHP XML Expat 解析器">XML Expat Parser</a></li>
<li class="next"><a href="/php/php_xml_simplexml.asp" title="PHP SimpleXML">XML SimpleXML</a></li>
</ul>
</div>

<div id="intro">
<p><strong>内建的 DOM 解析器使在 PHP 中处理 XML 文档成为可能。</strong></p>
</div>
...
<p>如果您希望学习更多有关 XML DOM 的知识，请访问我们的 <a href="/xmldom/index.asp" title="XML DOM 教程">XML DOM 教程</a>。</p>
</div>
