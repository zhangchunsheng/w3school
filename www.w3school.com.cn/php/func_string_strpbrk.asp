...
<p>strpbrk() 函数在字符串中搜索指定字符中的任意一个。</p>

<p>该函数返回指定字符第一次出现的位置开始的剩余部分。如果没有找到，则返回 false。</p>


<h3>语法</h3>
<pre>strpbrk(string,charlist)</pre>
...
<pre>&lt;?php
echo <code>strpbrk(&quot;Hello world!&quot;,&quot;oe&quot;)</code>;
?&gt;</pre>
