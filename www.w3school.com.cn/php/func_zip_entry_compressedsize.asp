...
<title>PHP zip_entry_compressedsize() 函数</title>
</head>
...
<h1>PHP zip_entry_compressedsize() 函数</h1>
...
<p>zip_entry_compressedsize() 函数返回 zip 档案项目的压缩文件尺寸。</p>


<h3>语法</h3>
<pre>zip_entry_compressedsize(zip_entry)</pre>
...
if ($zip)
  ...
  while ($zip_entry = zip_read($zip))
    ...
    . <code>zip_entry_compressedsize($zip_entry)</code>;
    echo &quot;&lt;/p&gt;&quot;;
    }
  zip_close($zip);
  }
