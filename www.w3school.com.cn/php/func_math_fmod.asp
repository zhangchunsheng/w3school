...
<p>返回被除数（<i>x</i>）除以除数（<i>y</i>）所得的浮点数余数。余数（r）的定义是：x = i * y + r，其中 <i>i</i> 是整数。如果 <i>y</i> 是非零值，则 <i>r</i> 和 <i>x</i> 的符号相同并且其数量值小于 <i>y</i> 。</p>
...
<p>在本例中，我们将使用 fmod() 函数来返回 5/2 的余数：</p>
