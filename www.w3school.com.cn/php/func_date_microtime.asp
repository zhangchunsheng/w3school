...
<p>microtime() 函数返回当前 Unix 时间戳和微秒数。</p>

<h3>语法</h3>
<pre>microtime(get_as_float)</pre>
...
<table class="dataintable"> 
  ...
  <tr>
    <td>get_as_float</td>
    <td>如果给出了 get_as_float 参数并且其值等价于 TRUE，该函数将返回一个浮点数。</td>
  </tr>
</table>

<h3>说明</h3>

<p>本函数仅在支持 <a href="/php/func_date_gettimeofday.asp" title="PHP gettimeofday() 函数">gettimeofday()</a> 系统调用的操作系统下可用。 </p>
