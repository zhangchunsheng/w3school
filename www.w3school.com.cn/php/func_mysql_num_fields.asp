...
<title>PHP mysql_num_fields() 函数</title>
</head>
...
<p>mysql_num_fields() 函数返回结果集中字段的数。</p>

<p>如果失败，则返回 false。</p>


<h3>语法</h3>
<pre>mysql_num_fields(data)</pre>
...
<table class="dataintable"> 
  ...
  <tr>
    <td>data</td>
    <td>必需。规定规定要使用的数据指针。该数据指针是 mysql_query() 函数产生的结果。</td>
  </tr>
</table>
