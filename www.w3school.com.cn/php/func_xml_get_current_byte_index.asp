...
<title>PHP xml_get_current_byte_index() 函数</title>
</head>
...
<h1>PHP xml_get_current_byte_index() 函数</h1>
...
<p>xml_get_current_byte_index() 函数获取 XML 解析器的当前字节索引。</p>
...
<p>如果 <i>parser</i> 没有指向一个合法的解析器，该函数将返回 false，否则将返回解析器当前在其数据缓冲区中的字节索引（起始值为 0）。</p>
...
while ($xmldata = fread($fp, 4096)) 
  ...
  if (!xml_parse($xmlparser,$xmldata,feof($fp))) 
    ...
    . &quot;&lt;br /&gt;&quot;
    . &quot;Byte Index: &quot;
    . <code>xml_get_current_byte_index($xmlparser)</code>
    . &quot;&lt;br /&gt;&quot;);
    }
  }
