...
<title>PHP money_format() 函数</title>
</head>
...
<p>money_format() 函数把字符串格式化为货币字符串。</p>


<h3>语法</h3>
<pre>money_format(string,number)</pre>
...
echo <code>money_format(&quot;The price is %i&quot;, $number)</code>;
?&gt;</pre>

<p>输出：</p>

<pre>The price is USD 1,234.56</pre>


<h3>例子 2</h3>

<p>负数，带有 () 指示负数的 US 国际格式，右侧精度为 2，&quot;*&quot; 为填充字符：</p>

<pre>&lt;?php
$number = -1234.5672;

echo <code>money_format(&quot;%=*(#10.2n&quot;, $number)</code>;
?&gt;</pre>
