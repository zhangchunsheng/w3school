...
<p>soundex() 函数计算字符串的 soundex 键。</p>

<p>soundex 键是 4 字符长的字母数字字符串，表示一个单词的英文发音。</p>

<p>soundex() 函数可用于拼写检查程序。</p>

<p>如果成功，则返回字符串的 soundex 键，如果失败，则返回 false。</p>
...
<p class="note"><span>注释：</span>soundex() 为发音相似的单词创建相同的键。</p>

<p class="tip"><span>提示：</span><a href="/php/func_string_metaphone.asp" title="PHP metaphone() 函数">metaphone()</a> 比 soundex() 函数更精确，因为 metaphone() 了解基本的英语发音规则。</p>
</div>
...
<p>在本例中，我们对两个发音相似的单词应用 soundex() 函数：</p>
