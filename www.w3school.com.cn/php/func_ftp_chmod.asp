...
<p>ftp_chmod() 函数设置 FTP 服务器上指定文件的权限。</p>

<p>若成功，则该函数返回新的权限。否则返回 false。</p>


<h3>语法</h3>
<pre>ftp_chmod(ftp_connection,mode,file)</pre>
...
<span>// 所有者可读写，其他人没有任何权限</span>
ftp_chmod($conn,&quot;0600&quot;,&quot;test.txt&quot;);

<span>// 所有者可读写，其他人可读</span>
ftp_chmod($conn,&quot;0644&quot;,&quot;test.txt&quot;);

<span>// 所有者拥有所有权限，其他人可读可执行</span>
ftp_chmod($conn,&quot;0755&quot;,&quot;test.txt&quot;);

<span>// 所有者拥有所有权限，所有者所属的组可读</span>
