...
<p>ftp_put() 函数把文件上传到服务器。</p>

<p>若成功则返回 true，失败则返回 false。</p>


<h3>语法</h3>
<pre>ftp_put(ftp_connection,remote,local,mode,resume)</pre>
...
echo <code>ftp_put($conn,&quot;target.txt&quot;,&quot;source.txt&quot;,FTP_ASCII)</code>;
