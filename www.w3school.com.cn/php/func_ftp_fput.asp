...
<p>ftp_fput() 函数上传一个已经打开的文件到 FTP 服务器。</p>

<p>若成功则返回 true，失败则返回 false。</p>


<h3>语法</h3>
<pre>ftp_fput(ftp_connection,remote,local,mode,resume)</pre>
...
echo <code>ftp_fput($conn,&quot;target.txt&quot;,$source,FTP_ASCII)</code>;
