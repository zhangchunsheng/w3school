...
<li class="currentLink"><a href="/php/php_mysql_update.asp" title="PHP MySQL Update">MySQL Update</a></li>
...
<div  id="tpn">
<ul class="prenext">
<li class="pre"><a href="/php/php_mysql_order_by.asp" title="PHP MySQL Order By 关键词">MySQL Order By</a></li>
<li class="next"><a href="/php/php_mysql_delete.asp" title="PHP MySQL Delete From">MySQL Delete</a></li>
</ul>
</div>

<div id="intro">
<p><strong>UPDATE 语句用于中修改数据库表中的数据。</strong></p>
</div>

<div>
<h2>更新数据库中的数据</h2>

<p>UPDATE 语句用于在数据库表中修改数据。</p>
...
<p class="note"><span>注释：</span>SQL 对大小写不敏感。UPDATE 与 update 等效。</p>
