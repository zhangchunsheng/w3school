...
<li class="currentLink"><a href="/php/php_ref_xml.asp" title="PHP XML Parser 函数">PHP XML</a></li>
...
<div  id="tpn">
<ul class="prenext">
<li class="pre"><a href="/php/php_ref_string.asp" title="PHP String 函数">PHP String</a></li>
<li class="next"><a href="/php/php_ref_zip.asp" title="PHP Zip File 函数">PHP Zip</a></li>
</ul>
</div>
...
<p>XML 是一种用于标准结构化文档交换的数据格式。您可以在我们的 <a href="/xml/index.asp" title="XML 教程">XML 教程</a> 中找到更多有关 XML 的信息。</p>
