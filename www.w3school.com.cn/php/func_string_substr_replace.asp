...
<title>PHP substr_replace() 函数</title>
</head>
...
<p>substr_replace() 函数把字符串的一部分替换为另一个字符串。</p>
...
<table class="dataintable">
  ...
  <tr>
    <td>start</td>
    <td>
	<p>必需。规定在字符串的何处开始替换。</p>
	<ul class="listintable">
		<li>正数 - 在第 <i>start</i> 个偏移量开始替换</li>
		<li>负数 - 在从字符串结尾的第 <i>start</i> 个偏移量开始替换</li>
		<li>0 - 在字符串中的第一个字符处开始替换</li>
	</ul>
	</td>
  </tr>
  <tr>
...
<p class="note"><span>注释：</span>如果 <i>start</i> 是负数且 <i>length</i> 小于等于 <i>start</i>，则 <i>length</i> 为 0。</p>
</div>
...
<pre>&lt;?php
echo <code>substr_replace(&quot;Hello world&quot;,&quot;earth&quot;,6)</code>;
?&gt;</pre>
