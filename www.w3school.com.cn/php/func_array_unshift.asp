...
<title>PHP array_unshift() 函数</title>
</head>
...
<p>array_unshift() 函数在数组开头插入一个或多个元素。</p>

<p>被加上的元素作为一个整体添加，这些元素在数组中的顺序和在参数中的顺序一样。</p>

<p>该函数会返回数组中元素的个数。</p>

<h3>语法</h3>
<pre>array_unshift(array,value1,value2,value3...)</pre>
...
<p class="note"><span>注释：</span>所有的数值键名将修改为从零开始重新计数，所有的字符串键名保持不变。</p>
</div>
...
<pre>Array ( [0] =&gt; Horse [a] =&gt; Cat [b] =&gt; Dog )</pre>
</div>
...
<pre>Array ( [0] =&gt; Horse [1] =&gt; Cat [2] =&gt; Dog )</pre>
</div>
