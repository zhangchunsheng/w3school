...
<p>ftp_mdtm() 函数返回指定文件的最后修改时间。</p>


<h3>语法</h3>
<pre>ftp_login(ftp_connection,file)</pre>
...
<p class="note"><span>注释：</span>并非所有 FTP 服务器都支持该函数。</p>

<p class="note"><span>注释：</span>该函数不适用于检查目录。
</div>
...
$mod = <code>ftp_mdtm($conn,&quot;test.txt&quot;)</code>;

<span>//以 Unix 时间戳返回结果</span>
echo $mod;
echo &quot;&lt;br /&gt;&quot;;

<span>//把 Unix 时间戳格式化为日期</span>
...
<pre>1140082571
Thu, 16 Feb 2006 10:36:11 CET</pre>
</div>
