...
<p>chown() 函数改变指定文件的所有者。</p>

<p>如果成功则返回 TRUE，否则返回 FALSE。</p>

<h3>语法</h3>
<pre>chown(file,owner)</pre>
...
<table class="dataintable"> 
  ...
  <tr>
    <td>owner</td>
    <td>规定新的所有者。可以是用户名或用户的 ID。</td>
  </tr>
</table>

<h3>说明</h3>

<p>尝试将文件 <i>file</i> 的所有者改成用户 <i>owner</i> （由用户名或用户 ID 指定）。只有超级用户可以改变文件的所有者。</p>
