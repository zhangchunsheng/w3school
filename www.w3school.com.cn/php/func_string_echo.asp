...
<p>echo() 函数输出一个或多个字符串。</p>


<h3>语法</h3>
<pre>echo(strings)</pre>
...
<p class="note"><span>注释：</span>echo() 实际上不是一个函数，因此您无需对其使用括号。不过，如果您希望向 echo() 传递一个或多个参数，那么使用括号会发生解析错误。</p>

<p class="tip"><span>提示：</span>echo() 函数比 print() 函数快一点点。</p>

<p class="tip"><span>提示：</span>echo() 函数可以使用简化语法。参见例子 5。</p>
...
<pre>This text spans multiple lines.</pre>
...
<pre>This string was made with multiple parameters</pre>


<h3>例子 4</h3>

<p>单引号和双引号的不同之处。单引号仅输出变量名，而不是值：</p>

<pre>&lt;?php
$color = &quot;red&quot;;
<code>echo &quot;Roses are $color&quot;;</code>
echo &quot;&lt;br /&gt;&quot;;
<code>echo 'Roses are $color';</code>
?&gt;</pre>
