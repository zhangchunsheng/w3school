...
<title>PHP FILTER_VALIDATE_BOOLEAN 过滤器</title>
</head>
...
<h1>PHP FILTER_VALIDATE_BOOLEAN 过滤器</h1>
...
<p>FILTER_VALIDATE_BOOLEAN 过滤器把值作为布尔选项来验证。</p>
...
var_dump(filter_var($var, <code>FILTER_VALIDATE_BOOLEAN</code>));
?&gt;</pre>
