...
<title>PHP FILTER_SANITIZE_NUMBER_INT 过滤器</title>
</head>
...
<h1>PHP FILTER_SANITIZE_NUMBER_INT 过滤器</h1>
...
<p>FILTER_SANITIZE_NUMBER_INT 过滤器删除数字中所有非法的字符。</p>
...
var_dump(filter_var($number, <code>FILTER_SANITIZE_NUMBER_INT</code>));
?&gt;</pre>

<p>输出：</p>

<pre>string(5) &quot;5-2+3&quot;</pre>
