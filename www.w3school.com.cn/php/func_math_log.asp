...
<table class="dataintable">
  ...
  <tr>
    <td>base</td>
    <td>可选。如果规定了该参数，则返回 log<sub>base</sub>x。</td>
  </tr>
</table>
...
<p>如果指定了可选的参数 <i>base</i>，log() 返回 log<sub>base</sub>x ，否则 log() 返回参数 <i>x</i> 的自然对数。</p>

<p class="note"><span>注释：</span>参数 base 自 PHP 4.3.0 开始可用。你可以计算任意以 b 为底 n 的对数，但其实使用的是数学等式：logb(n) = log(n)/log(b)，其中 log 是自然对数。</p>
