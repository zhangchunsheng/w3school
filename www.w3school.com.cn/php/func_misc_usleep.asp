...
<p>usleep() 函数延迟代码执行若干微秒。</p>


<h3>语法</h3>
<pre>usleep(microseconds)</pre>
...
<p class="note"><span>注释：</span>在 PHP 5 之前，该函数无法工作于 Windows 系统上。</p>

<p class="note"><span>注释：</span>一微秒等于百万分之一秒。</p>
</div>
