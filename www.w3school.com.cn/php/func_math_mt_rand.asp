...
<p>mt_rand() 使用 Mersenne Twister 算法返回随机整数。</p>


<h3>语法</h3>
<pre>mt_rand(min,max)</pre>


<h3>说明</h3>

<p>如果没有提供可选参数 <i>min</i> 和 <i>max</i>，mt_rand() 返回 0 到 RAND_MAX 之间的伪随机数。例如想要 5 到 15（包括 5 和 15）之间的随机数，用 mt_rand(5, 15)。</p>
...
<p class="note"><span>注释：</span>在 3.0.7 之前的版本中，max 的含义是 range 。要在这些版本中得到和上例相同 5 到 15 的随机数，简短的例子是 mt_rand (5, 11)。
</div>
