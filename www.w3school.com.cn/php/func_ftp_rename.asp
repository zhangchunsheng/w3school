...
<p>ftp_rename() 函数更改 FTP 服务器上的文件或目录名。</p>

<p>如果成功，则返回 true，否则返回 false。</p>


<h3>语法</h3>
<pre>ftp_rename(ftp_connection,from,to)</pre>
...
<code>ftp_rename($conn,&quot;oldname.txt&quot;,&quot;newname.txt&quot;);</code>
