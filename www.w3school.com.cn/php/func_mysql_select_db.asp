...
<title>PHP mysql_select_db() 函数</title>
</head>
...
<p>mysql_select_db() 函数设置活动的 MySQL 数据库。</p>

<p>如果成功，则该函数返回 true。如果失败，则返回 false。</p>


<h3>语法</h3>
<pre>mysql_select_db(database,connection)</pre>
...
$db_selected = <code>mysql_select_db(&quot;test_db&quot;, $con)</code>;
