...
<title>PHP array_reverse() 函数</title>
</head>
...
<p>array_reverse() 函数将原数组中的元素顺序翻转，创建新的数组并返回。如果第二个参数指定为 true，则元素的键名保持不变，否则键名将丢失。</p>

<h3>语法</h3>
<pre>array_reverse(array,preserve)</pre>
...
<td>preserve</td>
<td>
	<p>可选。规定是否保留原始数组的键名。可能的值：true 和 false。</p>
	<p>这个参数是 PHP 4.0.3 中新加的。</p>
</td>
</tr>
</table>
</div>
...
<pre>Array ( [c] =&gt; Horse [b] =&gt; Cat [a] =&gt; Dog )</pre>
</div>
