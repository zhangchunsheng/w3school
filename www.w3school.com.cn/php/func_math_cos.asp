...
<p>cos() 返回参数 <i>x</i> 的余弦值。参数 <i>x</i> 的单位为弧度。</p>
...
<p class="note"><span>注释：</span>cos() 返回的数值在 -1 和 1 之间。</p>
</div>
