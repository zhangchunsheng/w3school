...
<li class="currentLink"><a href="/php/php_syntax.asp" title="PHP 语法">PHP 语法</a></li>
...
<div  id="tpn">
<ul class="prenext">
<li class="pre"><a href="/php/php_install.asp" title="PHP 安装">PHP 安装</a></li>
<li class="next"><a href="/php/php_variables.asp" title="PHP 变量">PHP 变量</a></li>
</ul>
</div>

<div id="intro">
<p><strong>您无法在浏览器中通过查看源文档的方式来查看 PHP 的源代码 - 您只能看到 PHP 文件的输出，即纯粹的 HTML。这是因为在结果返回浏览器之前，脚本就已经在服务器执行了。</strong></p>
</div>

<div>
<h2>基本的 PHP 语法</h2>

<p>PHP 的脚本块以 <em>&lt;?php</em> 开始，以 <em>?&gt;</em> 结束。您可以把 PHP 的脚本块放置在文档中的任何位置。</p>

<p>当然，在支持简写的服务器上，您可以使用 &lt;? 和 ?&gt; 来开始和结束脚本块。</p>

<p>不过，为了达到最好的兼容性，我们推荐您使用标准形式 (&lt;?php)，而不是简写形式。</p>

<pre>&lt;?php

?&gt;</pre>

<p>PHP 文件通常会包含 HTML 标签，就像一个 HTML 文件，以及一些 PHP 脚本代码。</p>

<p>在下面，我们提供了一段简单的 PHP 脚本，它可以向浏览器输出文本 &quot;Hello World&quot;：</p>
...
<p>有两种通过 PHP 来输出文本的基础指令：<em>echo</em> 和 <em>print</em>。在上面的例子中，我们使用了 echo 语句来输出文本 &quot;Hello World&quot;。</p>
</div>

<div>
<h2>PHP 中的注释</h2>

<p>在 PHP 中，我们使用 // 来编写单行注释，或者使用 /* 和 */ 来编写大的注释块。</p>
