...
<title>PHP str_replace() 函数</title>
</head>
...
<p>str_replace() 函数使用一个字符串替换字符串中的另一些字符。</p>
...
<p class="note"><span>注释：</span>该函数对大小写敏感。请使用 <a href="/php/func_string_str_ireplace.asp" title="PHP str_ireplace() 函数">str_ireplace()</a> 执行对大小写不敏感的搜索。</p>
...
<pre>&lt;?php
echo <code>str_replace(&quot;world&quot;,&quot;John&quot;,&quot;Hello world!&quot;)</code>;
?&gt;</pre>
...
<p>在本例中，我们将演示带有数组和 count 变量的 str_replace() 函数：</p>

<pre>&lt;?php
$arr = array(&quot;blue&quot;,&quot;red&quot;,&quot;green&quot;,&quot;yellow&quot;);
print_r(<code>str_replace(&quot;red&quot;,&quot;pink&quot;,$arr,$i)</code>);
echo &quot;Replacements: $i&quot;;
?&gt;</pre>
...
print_r(<code>str_replace($find,$replace,$arr)</code>);
?&gt;</pre>
