...
<p>strpos() 函数返回字符串在另一个字符串中第一次出现的位置。</p>

<p>如果没有找到该字符串，则返回 false。</p>


<h3>语法</h3>
<pre>strpos(string,find,start)</pre>
...
<p class="note"><span>注释：</span>该函数对大小写敏感。如需进行对大小写不敏感的搜索，请使用 <a href="/php/func_string_stripos.asp" title="PHP stripos() 函数">stripos()</a> 函数。</p>
