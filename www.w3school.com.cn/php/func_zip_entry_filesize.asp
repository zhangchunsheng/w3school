...
<title>PHP zip_entry_filesize() 函数</title>
</head>
...
<h1>PHP zip_entry_filesize() 函数</h1>
...
<p>zip_entry_filesize() 函数返回 zip 档案项目的原始大小（在压缩之前）。</p>


<h3>语法</h3>
<pre>zip_entry_filesize(zip_entry)</pre>
...
if ($zip)
  ...
  while ($zip_entry = zip_read($zip))
    ...
    echo &quot;Original size: &quot; . <code>zip_entry_filesize($zip_entry)</code>;
    echo &quot;&lt;/p&gt;&quot;;
    }
  zip_close($zip);
  }
