...
<p>strcspn() 函数返回在找到任何指定的字符之前，在字符串查找的字符数。</p>


<h3>语法</h3>
<pre>strcspn(string,char,start,length)</pre>
...
<table class="dataintable">
  ...
  <tr>
    <td>start</td>
    <td>可选。规定开始查找的位置。该参数是 PHP 4.3 中新加的。</td>
  </tr>
  <tr>
    <td>length</td>
    <td>可选。规定字符串的长度（搜索多少字符）。该参数是 PHP 4.3 中新加的。</td>
  </tr>
</table>
...
<pre>&lt;?php
echo <code>strcspn(&quot;Hello world!&quot;,&quot;w&quot;)</code>;
?&gt;</pre>
