...
<p>在本例中，我们将把一个字符串值从二进制转换为十六进制，再转换回去：</p>

<pre>&lt;?php
$str = &quot;Hello world!&quot;;
echo <code>bin2hex($str)</code>;
echo pack(&quot;H*&quot;,<code>bin2hex($str)</code>);
?&gt;</pre>

<p>输出：</p>

<pre>48656c6c6f20776f726c6421
Hello world!</pre>
