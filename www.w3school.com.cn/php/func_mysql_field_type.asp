...
<title>PHP mysql_field_type() 函数</title>
</head>
...
<p>mysql_field_type() 函数返回结果集中指定字段的类型。</p>

<p>如果成功，则返回指定字段的类型，如果失败，则返回 false。</p>


<h3>语法</h3>
<pre>mysql_field_type(data,field_offset)</pre>
...
$type = <code>mysql_field_type($result, 0)</code>;
