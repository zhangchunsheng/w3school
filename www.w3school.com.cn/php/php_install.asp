...
<li class="currentLink"><a href="/php/php_install.asp" title="PHP 安装">PHP 安装</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/php/php_intro.asp" title="PHP 简介">PHP 简介</a></li>
<li class="next"><a href="/php/php_syntax.asp" title="PHP 语法">PHP 语法</a></li>
</ul>
</div>
...
<p>本教程不会为您讲解如何安装 PHP 、MySQL 或 Apache 服务器。</p>

<p>如果您的服务器支持 PHP - 那么您不需要做任何事情！您不需要编译任何软件，或安装额外的工具 - 只要在您的 web 目录中创建 .php 文件即可 - 然后您的服务器会为您解析这些文件。大多数主机都提供对 PHP 的支持。</p>

<p>不过，如果您的服务器不支持 PHP，那么您必须安装 PHP。下面的链接提供了来自 PHP.net 的优秀教程，您可以从中学习到如何安装 PHP5：</p>

<p><a href="http://www.php.net/manual/en/install.php" title="PHP Installation and Configuration - Manual">http://www.php.net/manual/en/install.php</a></p>

<h3>下载 PHP</h3>

<p>从此处下载免费的 PHP：<a href="http://www.php.net/downloads.php" title="PHP Downloads">http://www.php.net/downloads.php</a></p>

<h3>下载 MySQL Database</h3>

<p>从此处下载免费的 MySQL：<a href="http://www.mysql.com/downloads/" title="MySQL ::  MySQL Downloads (Generally Available)">http://www.mysql.com/downloads/</a></p>

<h3>下载 Apache Server</h3>

<p>从此处下载免费的 Apache：<a href="http://httpd.apache.org/download.cgi" title="Download - The Apache HTTP Server Project">http://httpd.apache.org/download.cgi</a></p>
</div>
