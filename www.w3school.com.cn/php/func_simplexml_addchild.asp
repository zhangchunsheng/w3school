...
<p>addChild() 函数向指定的 XML 节点添加一个子节点。</p>

<p>该函数返回一个 SimpleXMLElement 对象，这个对象表示添加到 XML 节点的子元素。</p>
