...
<title>PHP simplexml_load_string() 函数</title>
</head>
...
<h1>PHP simplexml_load_string() 函数</h1>
...
<h3>语法</h3>
<pre>simplexml_load_file(string,class,options,ns,is_prefix)</pre>
...
$xml = <code>simplexml_load_string($xmlstring)</code>;
