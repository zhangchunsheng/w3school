...
<p>ftp_rmdir() 函数删除一个目录。</p>

<p>如果成功，则返回 true，否则返回 false。</p>


<h3>语法</h3>
<pre>ftp_rmdir(ftp_connection,dir)</pre>
...
<p>删除由参数 <i>dir</i> 指定的目录。<i>dir</i> 必须是一个空目录的绝对或相对路径。</p>
...
<code>ftp_rmdir($conn,&quot;testdir&quot;);</code>
