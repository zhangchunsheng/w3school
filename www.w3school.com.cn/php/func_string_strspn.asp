...
<p>strspn() 函数返回在字符串中包含的特定字符的数目。</p>


<h3>语法</h3>
<pre>strspn(string,charlist,start,length)</pre>
...
<pre>&lt;?php
echo <code>strspn(&quot;Hello world!&quot;,&quot;kHlleo&quot;)</code>;
?&gt;</pre>
...
<pre>&lt;?php
echo <code>strspn(&quot;abcdefand&quot;,&quot;abc&quot;)</code>;
?&gt;</pre>
