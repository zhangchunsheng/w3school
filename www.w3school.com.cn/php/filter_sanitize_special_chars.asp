...
<title>PHP FILTER_SANITIZE_SPECIAL_CHARS 过滤器</title>
</head>
...
<h1>PHP FILTER_SANITIZE_SPECIAL_CHARS 过滤器</h1>
...
<p>FILTER_SANITIZE_SPECIAL_CHARS 过滤器对特殊字符进行 HTML 转义。</p>

<p>该过滤器用于对 &quot;&lt;&gt;&amp; 以及 ASCII 值在 32 值以下的字符进行转义。</p>
...
var_dump(filter_var($url,<code>FILTER_SANITIZE_SPECIAL_CHARS</code>));
?&gt;</pre>

<p>输出：</p>

<pre>string(37) &quot;Is Peter &lt;smart&gt; &amp; funny?&quot;</pre>

<p>如果您在浏览器中查看源代码，会看到以下 HTML：</p>
