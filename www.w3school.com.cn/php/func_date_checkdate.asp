...
<p>checkdate() 函数验证一个格里高里日期。</p>

<p>如果指定的值合法，则该函数返回 true，否则返回 false。</p>

<p>日期在下列情况下为合法：</p>

<ul>
	<li>month 介于且包括 1 - 12</li>
	<li>Day 的值在给定的 month 所应该具有的天数范围之内，闰年已经考虑进去了。</li>
	<li>year 介于且包括 1 到 32767</li>
</ul>
