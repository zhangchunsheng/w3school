...
<title>PHP ftp_set_option() 函数</title>
</head>
...
<p>ftp_set_option() 函数设置各种 FTP 运行时选项。</p>


<h3>语法</h3>
<pre>ftp_set_option(ftp_connection,option,value)</pre>
...
<table class="dataintable">
  ...
  <tr>
    <td>value</td>
    <td>必需。设置 option 参数的值。</td>
  </tr>
</table>

<h3>说明</h3>

<p>FTP_TIMEOUT_SEC 选项改变网络传输的超时时间。参数 value 必须为整数且大于 0。默认的超时时间为 90 秒。</p>

<p>当 FTP_AUTOSEEK 选项打开时，带 resumepos 或 startpos 参数的 GET 或 PUT 请求将先检索到文件中指定的位置。此选项默认是打开的。</p>
...
<code>ftp_set_option($conn,FTP_TIMEOUT_SEC,120);</code>
