...
<table class="dataintable"> 
  ...
  <tr>
    <td>timestamp</td>
    <td>可选。规定 Unix 时间格式中的时间。</td>
  </tr>
</table>

<h3>说明</h3>

<p>返回一个根据 <i>timestamp</i> 得出的包含有日期信息的结合数组。如果没有给出时间戳，则认为是当前本地时间。</p>
...
<tr>
<td>0</td>
<td>自从 Unix 纪元开始至今的秒数，和 time() 的返回值以及用于 date() 的值类似。</td>
<td>系统相关，典型值为从 -2147483648 到 2147483647。</td>
</tr>
</table>
</div>
...
<pre>Wednesday, January 25, 2006</pre>
</div>
