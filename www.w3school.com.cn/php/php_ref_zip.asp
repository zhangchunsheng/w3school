...
<li class="currentLink"><a href="/php/php_ref_zip.asp" title="PHP Zip File 函数">PHP Zip</a></li>
...
<h1>PHP Zip File 函数</h1>

<div  id="tpn">
<ul class="prenext">
<li class="pre"><a href="/php/php_ref_xml.asp" title="PHP XML Parser 函数">PHP XML</a></li>
<li class="next"><a href="/php/php_ref_misc.asp" title="PHP 杂项函数">PHP 杂项</a></li>
</ul>
</div>

<div>
<h2>PHP Zip File 简介</h2>

<p>压缩文件函数允许我们读取压缩文件。</p>

</div>

<div>
<h2>安装</h2>
<p>如需在服务器上运行 Zip File 函数，必须安装这些库：</p>

<ul>
	<li>Guido Draheim 的 ZZIPlib 库：<a href="http://zziplib.sourceforge.net/download.html">下载 ZZIPlib 库</a></li>
	<li>Zip PELC 扩展：<a href="http://snaps.php.net/">下载 Zip PELC 扩展</a></li>
</ul>

<h3>在 Linux 系统上安装</h3>
<p><em>PHP 5+：</em>Zip 函数和 Zip 库默认不会启用，必须从上面的链接下载。请使用 <i>--with-zip=DIR</i> 配置选项来包含 Zip 支持。</p>

<h3>在 Windows 系统上安装</h3>
<p><em>PHP 5+：</em>Zip 函数默认不会启用，必须从上面的链接下载 php_zip.dll 和 ZZIPlib 库。必须在php.ini 之内启用 php_zip.dll。</p>
<p>如需启用任何 PHP 扩展，PHP extension_dir 设置（在 php.ini 文件中）应该设置为该 PHP 扩展所在的目录。举例 extension_dir 的值可能是 c:\php\ext。</p>

</div>


<div>
<h2>PHP Zip File 函数</h2>
