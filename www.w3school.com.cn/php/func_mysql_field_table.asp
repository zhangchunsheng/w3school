...
<title>PHP mysql_field_table() 函数</title>
</head>
...
<h1>PHP mysql_field_table() 函数</h1>
...
<p>mysql_field_table() 函数返回指定字段所在的表名。</p>

<p>如果成功，则返回指定字段的表名，如果失败，则返回 false。</p>


<h3>语法</h3>
<pre>mysql_field_table(data,field_offset)</pre>
...
$table = <code>mysql_field_table($result, 0)</code>;
