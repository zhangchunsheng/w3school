...
<title>PHP natcasesort() 函数</title>
</head>
...
<p>natcasesort() 函数用不区分大小写的自然顺序算法对给定数组中的元素排序。</p>

<p>natcasesort() 函数实现了“自然排序”，即数字从 1 到 9 的排序方法，字母从 a 到 z 的排序方法，短者优先，该函数不区分大小写。数组的索引与单元值保持关联。</p>

<p>如果成功，则该函数返回 TRUE，否则返回 FALSE。</p>

<h3>语法</h3>
<pre>natcasesort(array)</pre>
...
<div>
<h2>提示和注释</h2>
<p class="tip"><span>提示：</span>natcasesort() 是 <a href="/php/func_array_natsort.asp" title="PHP natsort() 函数">natsort() 函数</a> 的不区分大小写字母的版本。</p>
</div>
