...
<p>md5_file() 函数计算文件的 MD5 散列。</p>

<p>md5() 函数使用 RSA 数据安全，包括 MD5 报文摘译算法。</p>

<p>如果成功，则返回所计算的 MD5 散列，如果失败，则返回 false。</p>

<h3>语法</h3>

<pre>md5(<i>string</i>,<i>raw</i>)</pre>
...
<pre>&lt;?php
$filename = &quot;test.txt&quot;;
$md5file = <code>md5_file($filename)</code>;
echo $md5file;
?&gt;</pre>
...
<p>存储 &quot;test.txt&quot; 文件的 MD5 散列：</p>

<pre>&lt;?php
$md5file = <code>md5_file(&quot;test.txt&quot;)</code>;
file_put_contents(&quot;md5file.txt&quot;,$md5file);
?&gt;</pre>

<p>在本例中，我们将检测 &quot;test.txt&quot; 是否已被更改（即是否 MD5 散列已被更改）：</p>

<pre>&lt;?php
$md5file = file_get_contents(&quot;md5file.txt&quot;);
if (<code>md5_file(&quot;test.txt&quot;)</code> == $md5file)
  {
  echo &quot;The file is ok.&quot;;
  }
else
