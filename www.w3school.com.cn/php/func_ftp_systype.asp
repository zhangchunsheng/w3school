...
<title>PHP ftp_systype() 函数</title>
</head>
...
<p>ftp_systype() 函数返回远程 FTP 服务器的系统类型标识符。</p>

<p>该函数返回远程服务器的系统类型。若发生错误，则返回 false。</p>


<h3>语法</h3>
<pre>ftp_systype(ftp_connection)</pre>
...
echo <code>ftp_systype($conn)</code>;
