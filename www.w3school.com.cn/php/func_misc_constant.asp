...
<p>constant() 函数返回常量的值。</p>


<h3>语法</h3>
<pre>constant(constant)</pre>
...
<p class="note"><span>注释：</span>该函数仅适用于 class 常量。</p>
</div>
...
echo <code>constant(&quot;GREETING&quot;)</code>;
?&gt;</pre>
