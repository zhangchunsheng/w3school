...
<pre>sha1(<i>string</i>,<i>raw</i>)</pre>
...
<pre>&lt;?php
$str = 'Hello';
echo <code>sha1($str)</code>;
?&gt;</pre>

<p>输出：</p>

<pre>f7ff9e8b7bb2e09b70935a5d785e0cc5d9d0abf0</pre>


<h3>例子 2</h3>

<p>在本例中，我们将输出 sha1() 的结果，然后对其测试：</p>

<pre>&lt;?php
$str = 'Hello';
echo <code>sha1($str)</code>;

if (<code>sha1($str) == 'f7ff9e8b7bb2e09b70935a5d785e0cc5d9d0abf0'</code>)
  {
  echo &quot;&lt;br /&gt;Hello world!&quot;;
  exit;
  }
...
<pre>f7ff9e8b7bb2e09b70935a5d785e0cc5d9d0abf0
Hello world!</pre>
