...
<title>PHP setrawcookie() 函数</title>
</head>
...
<h1>PHP setrawcookie() 函数</h1>

<div class="backtoreference">
<p><a href="/php/php_ref_http.asp" title="PHP HTTP 函数">PHP HTTP 函数</a></p>
</div>

<div>
<h2>定义和用法</h2>

<p>setrawcookie() 函数不对 cookie 值进行 URL 编码，发送一个 HTTP cookie。</p>

<p>cookie 是由服务器发送到浏览器的变量。cookie 通常是服务器嵌入到用户计算机中的小文本文件。每当计算机通过浏览器请求一个页面，就会发送这个 cookie。</p>

<p>cookie 的名称指定为相同名称的变量。例如，如果被发送的 cookie 名为 &quot;name&quot;，会自动创建名为 $user 的变量，包含 cookie 的值。</p>

<p>必须在任何其他输出发送前对 cookie 进行赋值。</p>
...
<p class="note"><span>注释：</span>setrawcookie() 与 <a href="/php/func_http_setcookie.asp" title="PHP setcookie() 函数">setcookie()</a> 几乎完全相同，不同的是不会在发往客户机时，对 cookie 值进行自动 URL 编码。</p>
...
<span>// 发送一个简单的 cookie</span>
<code>setrawcookie(&quot;TestCookie&quot;,$value);</code>
?&gt;
...
<span>// 发送一个 24 小时候过期的 cookie</span>
<code>setrawcookie(&quot;TestCookie&quot;,$value, time()+3600*24);</code>
?&gt;
...
<span>// 输出个别的 cookie</span>
echo $_COOKIE[&quot;TestCookie&quot;];
echo &quot;&lt;br /&gt;&quot;;
echo $HTTP_COOKIE_VARS[&quot;TestCookie&quot;];
echo &quot;&lt;br /&gt;&quot;;

<span>// 输出所有 cookie</span>
print_r($_COOKIE);
?&gt;
...
<pre>my cookie value
my cookie value
Array ([TestCookie] =&gt; my cookie value)</pre>
...
<pre>&lt;?php
<span>// 把失效日期设置为一小时前</span>
<code>setrawcookie (&quot;TestCookie&quot;, &quot;&quot;, time() - 3600);</code>
?&gt;
...
<pre>&lt;?php
<code>setrawcookie(&quot;cookie[three]&quot;,&quot;cookiethree&quot;);
setrawcookie(&quot;cookie[two]&quot;,&quot;cookietwo&quot;);
setrawcookie(&quot;cookie[one]&quot;,&quot;cookieone&quot;);</code>

<span>// 输出 cookie （在重载页面后）</span>
