...
<title>PHP utf8_decode() 函数</title>
</head>
...
<p>utf8_decode() 函数把 UTF-8 字符串解码为 ISO-8859-1。</p>

<p>该函数把用 UTF-8 方式编码的 ISO-8859-1 字符串转换成单字节的 ISO-8859-1 字符串。</p>

<p>如果成功，该函数将返回解码字符串；否则返回 false。</p>


<h3>语法</h3>
<pre>utf8_decode(string)</pre>
