...
<title>PHP strip_whitespace() 函数</title>
</head>
...
<p>strip_whitespace() 函数返回已删除 PHP 注释以及空白字符的源代码文件。</p>

<p>该函数对于检测脚本中的实际代码量很有用。</p>


<h3>语法</h3>
<pre>strip_whitespace(filename)</pre>
...
<p>若成功，则返回被剥离的源代码，若失败，则返回空字符串。</p>

<p class="note"><span>注释：</span>在 PHP 5.0.1，该函数的行为与上面的描述一致。在这之前，它仅返回空字符串。</p>
...
<pre>&lt;?php
echo php_strip_whitespace (&quot;test.php&quot;); ?&gt;</pre>
