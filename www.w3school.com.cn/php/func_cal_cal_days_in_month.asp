...
<title>PHP cal_days_in_month() 函数</title>
</head>
...
<h1>PHP cal_days_in_month() 函数</h1>
...
<p>cal_days_in_month() 函数针对指定的年份和日历，返回一个月中的天数。</p>

<h3>语法</h3>
<pre>cal_days_in_month(calendar,month,year)</pre>
...
<pre>There was 31 days in October 2005</pre>
</div>
