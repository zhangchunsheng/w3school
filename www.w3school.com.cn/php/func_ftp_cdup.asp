...
<p>ftp_cdup() 函数把当前目录改变为 FTP 服务器上的父目录。</p>

<p>若成功，则返回 true。否则返回 false。</p>


<h3>语法</h3>
<pre>ftp_cdup(ftp_connection)</pre>
...
<span>//更改为 images 目录</span>
ftp_chdir($conn,&quot;images&quot;);
echo &quot;Dir: &quot;.ftp_pwd($conn);
echo &quot;&lt;br /&gt;&quot;;

<span>//把当前目录切换为父目录</span>
<code>ftp_cdup($conn);</code>
echo &quot;Dir: &quot;.ftp_pwd($conn);
