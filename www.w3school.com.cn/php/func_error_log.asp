...
<p>error_log() 函数向服务器错误记录、文件或远程目标发送一个错误。</p>

<p>若成功，返回 true，否则返回 false。</p>

<h3>语法</h3>
<pre>error_log(error,type,destination,headers)</pre>
...
<table class="dataintable"> 
  ...
  <tr>
    <td>destination</td>
    <td>可选。规定向何处发送错误消息。该参数的值依赖于 &quot;type&quot; 参数的值。</td>
  </tr>
  <tr>
    <td>headers</td>
    <td>
	<p>可选。只在 &quot;type&quot; 为 1 时使用。</p>
	<p>规定附加的头部，比如 From, Cc 以及 Bcc。由 CRLF (\r\n) 分隔。</p>
	<p>注释：在发送电子邮件时，必须包含 From 头部。可以在 php.ini 文件中或者通过此参数设置。</p>
	</td>
  </tr>
</table>
</div>
...
<pre>A custom error has been triggered</pre>
</div>
