...
<p>UnixToJD() 函数把 Unix 时间戳转换为儒略日计数。</p>

<h3>语法</h3>
<pre>unixtojd(timestamp)</pre>
...
<p class="note"><span>注释：</span>Unix 时间戳指示的是从格利高里历（不是罗马儒略历）的 1970 年 1 月 1 日至今的秒数。</p>
