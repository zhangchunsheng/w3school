...
<title>PHP array_intersect_ukey() 函数</title>
</head>
...
<h1>PHP array_intersect_ukey() 函数</h1>
...
<p>array_intersect_ukey() 函数用回调函数比较键名来计算数组的交集。</p>

<p>array_intersect_ukey() 返回一个数组，该数组包含了所有出现在 array1 中并同时出现在所有其它参数数组中的键名的值。 </p>
