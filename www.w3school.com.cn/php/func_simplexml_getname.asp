...
<p>getName() 函数从 SimpleXMLElement 对象获取 XML 元素的名称。</p>

<p>如果成功，该函数返回当前的 XML 元素的名称。如果失败，则返回 false。</p>
