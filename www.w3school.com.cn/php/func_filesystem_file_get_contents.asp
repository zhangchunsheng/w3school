...
<title>PHP file_get_contents() 函数</title>
</head>
...
<h1>PHP file_get_contents() 函数</h1>
...
<p>和 <a href="/php/func_filesystem_file.asp" title="PHP file() 函数">file()</a> 一样，不同的是 file_get_contents() 把文件读入一个字符串。</p>

<p>file_get_contents() 函数是用于将文件的内容读入到一个字符串中的首选方法。如果操作系统支持，还会使用内存映射技术来增强性能。</p>

<h3>语法</h3>
<pre>file_get_contents(<i>path</i>,<i>include_path</i>,<i>context</i>,<i>start</i>,<i>max_length</i>)</pre>
...
<pre>This is a test file with test text.</pre>
