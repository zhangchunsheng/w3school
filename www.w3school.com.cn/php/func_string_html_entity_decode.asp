...
<title>PHP html_entity_decode() 函数</title>
</head>
...
<h1>PHP html_entity_decode() 函数</h1>
...
<p>html_entity_decode() 函数把 HTML 实体转换为字符。</p>

<p>html_entity_decode() 是 <a href="/php/func_string_htmlentities.asp" title="PHP htmlentities() 函数">htmlentities()</a> 的反函数。</p>


<h3>语法</h3>
<pre>html_entity_decode(string,quotestyle,character-set)</pre>
