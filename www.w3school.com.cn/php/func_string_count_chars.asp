...
<title>PHP count_chars() 函数</title>
</head>
...
<p>count_chars() 函数返回字符串所用字符的信息。</p>


<h3>语法</h3>
<pre>count_chars(<i>string</i>,<i>mode</i>)</pre>
...
<table class="dataintable">
  ...
  <tr>
    <td>mode</td>
    <td>
	<p>可选。规定返回模式。默认是 0。有以下不同的返回模式：</p>
	<ul class="listintable">
		<li>0 - 数组，ASCII 值为键名，出现的次数为键值</li>
		<li>1 - 数组，ASCII 值为键名，出现的次数为键值，只列出出现次数大于 0 的值</li>
		<li>2 - 数组，ASCII 值为键名，出现的次数为键值，只列出出现次数等于 0 的值</li>
		<li>3 - 字符串，带有所有使用过的不同的字符</li>
		<li>4 - 字符串，带有所有未使用过的不同的字符</li>
    </ul>
	</td>
  </tr>
</table>
...
<p>在本例中，我们将使用 count_chars() 来检查字符串，返回模式设置为 1：</p>

<pre>&lt;?php
$str = &quot;Hello World!&quot;;
print_r(<code>count_chars($str,1)</code>);
?&gt;</pre>
...
<p>在本例中，我们将使用 count_chars() 来检查字符串，返回模式设置为 3：</p>

<pre>&lt;?php
$str = &quot;Hello World!&quot;;
echo <code>count_chars($str,3)</code>;
?&gt;</pre>
