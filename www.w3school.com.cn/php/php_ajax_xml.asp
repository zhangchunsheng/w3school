...
<li class="currentLink"><a href="/php/php_ajax_xml.asp" title="PHP 和 AJAX XML 实例">AJAX XML</a></li>
...
<h1>PHP 和 AJAX XML 实例</h1>

<div  id="tpn">
<ul class="prenext">
<li class="pre"><a href="/php/php_ajax_suggest.asp" title="PHP 和 AJAX 请求">AJAX Suggest</a></li>
<li class="next"><a href="/php/php_ajax_database.asp" title="PHP 和 AJAX MySQL 数据库实例">AJAX Database</a></li>
</ul>
</div>

<div>
<p><strong>AJAX 可与 XML 文件进行交互式通信。</strong></p>
</div>
...
<div id="txtHint" style="margin:15px 0 0 0;padding:0;border:0;"><em>在此列出 CD 信息。</em></div>
...
<p>XML 文件是 &quot;<a href="/php/cd_catalog.xml">cd_catalog.xml</a>&quot;。该文件中包含了有关 CD 收藏的数据。</p>
</div>
...
<p>这张页面是用 PHP 编写的，使用 XML DOM 来加载 XML 文档 &quot;<a href="/php/cd_catalog.xml">cd_catalog.xml</a>&quot;。</p>
...
<ol>
<li>PHP 创建 &quot;cd_catalog.xml&quot; 文件的 XML DOM 对象</li>
<li>循环所有 &quot;artist&quot; 元素 (nodetypes = 1)，查找与 JavaScript 所传数据向匹配的名字</li>
<li>找到 CD 包含的正确 artist</li>
<li>输出 album 的信息，并发送到 &quot;txtHint&quot; 占位符</li>
</ol>
</div>
