...
<p>quotemeta() 函数在字符串中某些预定义的字符前添加反斜杠。</p>
...
<p class="tip"><span>提示：</span>该函数可用于转义拥有特殊意义的字符，比如 SQL 中的 ( )、[ ] 以及 *。</p>
</div>
...
<pre>Hello world\. \(can you hear me\?\)</pre>
