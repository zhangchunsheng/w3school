...
<li class="currentLink"><a href="/php/php_filter.asp" title="PHP 过滤器（Filter）">PHP Filter</a></li>
</ul>
<h2>PHP 数据库</h2>
<ul>
...
<div  id="tpn">
<ul class="prenext">
<li class="pre"><a href="/php/php_exception.asp" title="PHP 异常处理">PHP Exception</a></li>
<li class="next"><a href="/php/php_mysql_intro.asp" title="MySQL 简介">MySQL 简介</a></li>
</ul>
</div>
...
<p>如需完整的函数和过滤器列表，请访问我们的 <a href="/php/php_ref_filter.asp" title="PHP Filter 函数">PHP Filter 参考手册</a>。</p>
</div>
...
<p>如需完整的函数及过滤器列表，请访问 W3School 提供的 <a href="/php/php_ref_filter.asp" title="PHP Filter 函数">PHP Filter 参考手册</a>。您可以看到每个过滤器的可用选项和标志。</p>
</div>
