...
<title>PHP mysql_get_client_info() 函数</title>
</head>
...
<h1>PHP mysql_get_client_info() 函数</h1>
...
<p>mysql_get_client_info() 函数返回 MySQL 客户端信息。</p>

<p>如果成功，则返回 MySQL 客户端的版本号，如果失败，则返回 false。</p>


<h3>语法</h3>
<pre>mysql_get_client_info()</pre>
...
<pre>&lt;?php
echo &quot;MySQL client info: &quot; . <code>mysql_get_client_info()</code>;
?&gt;</pre>

<p>输出：</p>

<pre>MySQL client info: 5.0.18</pre>
