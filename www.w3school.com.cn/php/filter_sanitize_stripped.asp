...
<title>PHP FILTER_SANITIZE_STRIPPED 过滤器</title>
</head>
...
<h1>PHP FILTER_SANITIZE_STRIPPED 过滤器</h1>
...
<p>FILTER_SANITIZE_STRIPPED 过滤器去除或编码不需要的字符。</p>

<p>该过滤去是 <a href="/php/filter_sanitize_string.asp" title="PHP FILTER_SANITIZE_STRING 过滤器">FILTER_SANITIZE_STRING</a> 过滤器的别名。</p>

<p>这个过滤器删除那些对应用程序有潜在危害的数据。它用于去除标签或删除或编码不需要的字符。</p>
...
<ul>
	...
	<li>FILTER_FLAG_STRIP_HIGH - 去除 ASCII 值在 32 以上的字符</li>
	<li>FILTER_FLAG_ENCODE_LOW - 编码 ASCII 值在 32 以下的字符</li>
	<li>FILTER_FLAG_ENCODE_HIGH - 编码 ASCII 值在 32 以上的字符</li>
	<li>FILTER_FLAG_ENCODE_AMP - 把 &amp; 字符编码为 &amp;amp;</li>
</ul>
...
var_dump(filter_var($var, <code>FILTER_SANITIZE_STRIPPED</code>));
?&gt;</pre>

<p>输出：</p>

<pre>string(13) &quot;Bill Gates&quot;</pre>
