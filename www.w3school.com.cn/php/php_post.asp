...
<li class="currentLink"><a href="/php/php_post.asp" title="PHP $_POST">PHP $_POST</a></li>
</ul>
<h2>PHP 高级教程</h2>
<ul>
...
<div  id="tpn">
<ul class="prenext">
<li class="pre"><a href="/php/php_get.asp" title="PHP $_GET">PHP $_GET</a></li>
<li class="next"><a href="/php/php_date.asp" title="PHP Date()">PHP 日期</a></li>
</ul>
</div>


<div id="intro">
<p><strong>$_POST 变量用于收集来自 method=&quot;post&quot; 的表单中的值。</strong></p>
</div>
...
<p>$_POST 变量是一个数组，内容是由 HTTP POST 方法发送的变量名称和值。</p>

<p>$_POST 变量用于收集来自 method=&quot;post&quot; 的表单中的值。从带有 POST 方法的表单发送的信息，对任何人都是不可见的（不会显示在浏览器的地址栏），并且对发送信息的量也没有限制。</p>

<h3>例子</h3>
<pre>&lt;form action=&quot;welcome.php&quot; <code>method=&quot;post&quot;</code>&gt;
Enter your name: &lt;input type=&quot;text&quot; name=&quot;name&quot; /&gt;
Enter your age: &lt;input type=&quot;text&quot; name=&quot;age&quot; /&gt;
&lt;input type=&quot;submit&quot; /&gt;
&lt;/form&gt;</pre>

<p>当用户点击提交按钮，URL 不会含有任何表单数据，看上去类似这样：</p>

<pre>http://www.w3school.com.cn/welcome.php</pre>

<p>&quot;welcome.php&quot; 文件现在可以通过 $_POST 变量来获取表单数据了（请注意，表单域的名称会自动成为 $_POST 数组中的 ID 键）：</p>

<pre>Welcome &lt;?php echo <code>$_POST[&quot;name&quot;]</code>; ?&gt;.&lt;br /&gt;
You are &lt;?php echo <code>$_POST[&quot;age&quot;]</code>; ?&gt; years old!</pre>
</div>

<div>
<h2>为什么使用 $_POST？</h2>
<ul>
<li>通过 HTTP POST 发送的变量不会显示在 URL 中。</li>
<li>变量没有长度限制。</li>
</ul>
<p>不过，由于变量不显示在 URL 中，所以无法把页面加入书签。</p>
</div>
...
<p>PHP 的 $_REQUEST 变量包含了 $_GET, $_POST 以及 $_COOKIE 的内容。</p>

<p>PHP 的 $_REQUEST 变量可用来取得通过 GET 和 POST 方法发送的表单数据的结果。</p>
