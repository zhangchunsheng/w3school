...
<li class="currentLink"><a href="/php/php_ref_filesystem.asp" title="PHP Filesystem 函数">PHP Filesystem</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/php/php_ref_error.asp" title="PHP Error 和 Logging 函数">PHP Error</a></li>
<li class="next"><a href="/php/php_ref_filter.asp" title="PHP Filter 函数">PHP Filter</a></li>
</ul>
</div>
...
<table class="dataintable">
  ...
  <tr>
    <td>delete()</td>
    <td>参见 <a href="/php/func_filesystem_unlink.asp" title="PHP unlink() 函数">unlink()</a> 或 unset()。</td>
    <td>&nbsp;</td>
  </tr>
  <tr>
