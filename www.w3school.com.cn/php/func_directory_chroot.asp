...
<p>chroot() 函数把当前进程的根目录改变为指定的目录。</p>

<p>若成功，则该函数返回 true，否则返回 false。</p>

<h3>语法</h3>
<pre>chroot(directory)</pre>
...
<div>
<h2>提示和注释</h2>
<p class="tip"><span>提示：</span>该函数没有在 Windows 平台上实现。</p>
</div>
