...
<p>print() 函数输出一个或多个字符串。</p>


<h3>语法</h3>
<pre>print(strings)</pre>
...
<p class="note"><span>注释：</span>print() 函数实际上不是函数，所以您不必对它使用括号。</p>

<p class="note"><span>注释：</span>print() 函数稍慢于 <a href="/php/func_string_echo.asp" title="PHP echo() 函数">echo()</a>。</p>
</div>
