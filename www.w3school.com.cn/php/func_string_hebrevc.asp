...
<p>hebrevc() 函数把希伯来文本从右至左的流转换为左至右的流。它也会把新行 (\n) 转换为 &lt;br /&gt;。</p>

<p>只有 224 至 251 之间的 ASCII 字符，以及标点符号受到影响。</p>


<h3>语法</h3>
<pre>hebrev(string,maxcharline)</pre>
...
<table class="dataintable">
  ...
  <tr>
    <td>salt</td>
    <td>规定每行的最大字符数。如果可能，hebrev() 将避免把单词断开。</td>
  </tr>
</table>
...
<p class="tip"><span>提示：</span><a href="/php/func_string_hebrev.asp" title="PHP hebrev() 函数">hebrev()</a> 和 hebrevc() 可以把希伯来逻辑文本转换为希伯来可见文本。希伯来可见文本不需要特殊的右至左字符支持，这使它对于在 web 上显示希伯来文本很有用处。</p>
</div>
