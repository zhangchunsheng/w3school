...
<title>PHP mysql_error() 函数</title>
</head>
...
<p>mysql_error() 函数返回上一个 MySQL 操作产生的文本错误信息。</p>

<p>本函数返回上一个 MySQL 函数的错误文本，如果没有出错则返回 ''（空字符串）。</p>


<h3>语法</h3>
<pre>mysql_error(connection)</pre>
...
<pre>Access denied for user 'wrong_user'@'localhost'
