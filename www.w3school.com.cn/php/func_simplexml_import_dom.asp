...
<title>PHP simplexml_import_dom() 函数</title>
</head>
...
<h1>PHP simplexml_import_dom() 函数</h1>
...
<p>如果失败，则该函数返回 false。</p>


<h3>语法</h3>
<pre>simplexml_import_dom(data,class)</pre>
...
<table class="dataintable"> 
  ...
  <tr>
    <td>data</td>
    <td>必需。规定要使用的 DOM 节点。</td>
  </tr>
  <tr>
    <td>class</td>
    <td>必需。规定新对象的 class。</td>
  </tr>
</table>
...
$xml = <code>simplexml_import_dom($dom)</code>;
