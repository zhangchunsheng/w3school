...
<title>XML Schema complexContent 元素</title>
</head>
...
<h1>XML Schema complexContent 元素</h1>
...
<p>complexContent 元素定义对复杂类型（包含混合内容或仅包含元素）的扩展或限制。</p>
...
<td>
<p>可选项。annotation</p>
<p>必选项。 有并且只有一个下列元素： restriction (complexContent) 或 extension (complexContent)。</p>
</td>
</tr>
</table>
...
<p>（? 符号声明元素可在 complexContent 元素内出现零次或一次。）</p>
...
<tr>
<td>mixed</td>
<td>可选。规定是否允许字符数据出现在该 complexType 元素的子元素之间。 默认值为 false。</td>
</tr>
...
<div>
<h2>实例</h2>
<p>下面的例子中有一个复杂类型 &quot;fullpersoninfo&quot;，这个复杂类型是通过用三个补充的元素扩展继承的类型，从另一个复杂类型 &quot;personinfo&quot; 衍生而来的：</p>
...
<p>在上例中，&quot;employee&quot; 元素必须按顺序包含下面的元素：&quot;firstname&quot;、&quot;lastname&quot;、&quot;address&quot;、&quot;city&quot; 以及 &quot;country&quot;。</p>
</div>
