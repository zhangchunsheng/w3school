...
<li class="currentLink"><a href="/schema/schema_facets.asp" title="XSD 限定/Facets">XSD 限定</a></li>
</ul>
<h2>复杂的类型</h2>
<ul>
...
<div  id="tpn">
<ul class="prenext">
<li class="pre"><a href="/schema/schema_simple_attributes.asp" title="XSD 属性">XSD 属性</a></li>
<li class="next"><a href="/schema/schema_complex.asp" title="XSD 复合元素">XSD 元素</a></li>
</ul>
</div>

<div id="intro">
<p><strong>限定（restriction）用于为 XML 元素或者属性定义可接受的值。对 XML 元素的限定被称为 facet。</strong></p>
</div>
...
<p class="note"><span>注释：</span>在这种情况下，类型 &quot;carType&quot; 可被其他元素使用，因为它不是 &quot;car&quot; 元素的组成部分。</p>
</div>
...
<p>下面的例子定义了带有一个限定的名为 &quot;letter&quot; 的元素。可接受的值是 a - z 中零个或多个字母：</p>
<pre>&lt;xs:element name=&quot;letter&quot;&gt;
...
<div>
<h2>对空白字符的限定</h2>
<p>如需规定对空白字符（whitespace characters）的处理方式，我们需要使用 whiteSpace 限定。</p>
...
<p>如需限制元素中值的长度，我们需要使用 length、maxLength 以及 minLength 限定。</p>
