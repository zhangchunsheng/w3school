...
<li class="currentLink"><a href="/schema/schema_dtypes_date.asp" title="XSD 日期及时间数据类型">XSD 日期</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/schema/schema_dtypes_string.asp" title="XSD 字符串数据类型">XSD 字符串</a></li>
<li class="next"><a href="/schema/schema_dtypes_numeric.asp" title="XSD 数值数据类型">XSD 数值</a></li>
</ul>
</div>
