...
<li class="currentLink"><a href="/schema/schema_howto.asp" title="如何使用 XSD？">XSD 如何使用</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/schema/schema_why.asp" title="为什么要使用 XML Schemas？">XSD 为何使用</a></li>
<li class="next"><a href="/schema/schema_schema.asp" title="XSD - &lt;schema&gt; 元素">XSD &lt;schema&gt;</a></li>
</ul>
</div>

<div id="intro">
<p><strong>XML 文档可对 DTD 或 XML Schema 进行引用。</strong></p>
</div>

<div>
<h2>一个简单的 XML 文档：</h2>
<p>请看这个名为 &quot;note.xml&quot; 的 XML 文档：</p>
<pre>&lt;?xml version=&quot;1.0&quot;?&gt;
&lt;note&gt;
&lt;to&gt;George&lt;/to&gt;
&lt;from&gt;John&lt;/from&gt;
...
<div>
<h2>DTD 文件</h2>
<p>下面这个例子是名为 &quot;note.dtd&quot; 的 DTD 文件，它对上面那个 XML 文档的元素进行了定义：</p>
...
<div>
<h2>XML Schema</h2>
<p>下面这个例子是一个名为 &quot;note.xsd&quot; 的 XML Schema 文件，它定义了上面那个 XML 文档的元素：</p>
<pre>&lt;?xml version=&quot;1.0&quot;?&gt;
...
<p>此文件包含对 DTD 的引用：</p>
<pre>&lt;?xml version=&quot;1.0&quot;?&gt;
<code>&lt;!DOCTYPE note SYSTEM &quot;http://www.w3school.com.cn/dtd/note.dtd&quot;&gt;</code>
&lt;note&gt;
&lt;to&gt;George&lt;/to&gt;
&lt;from&gt;John&lt;/from&gt;
&lt;heading&gt;Reminder&lt;/heading&gt;
...
<div>
<h2>对 XML Schema 的引用</h2>
<p>此文件包含对 XML Schema 的引用：</p>
<pre>&lt;?xml version=&quot;1.0&quot;?&gt;
&lt;note
xmlns=&quot;http://www.w3school.com.cn&quot;
xmlns:xsi=&quot;http://www.w3.org/2001/XMLSchema-instance&quot;
<code>xsi:schemaLocation=&quot;http://www.w3school.com.cn note.xsd&quot;</code>&gt;
