...
<li class="currentLink"><a href="/schema/schema_complex_empty.asp" title="XSD 复合空元素">XSD 空元素</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/schema/schema_complex.asp" title="XSD 复合元素">XSD 元素</a></li>
<li class="next"><a href="/schema/schema_complex_elements.asp" title="XSD 复合类型 - 仅含元素">XSD 仅含元素</a></li>
</ul>
</div>

<div id="intro">
<p><strong>空的复合元素不能包含内容，只能含有属性。</strong></p>
</div>

<div>
<h2>复合空元素：</h2>
<p>一个空的 XML 元素：</p>
<pre>&lt;product prodid=&quot;1345&quot; /&gt;</pre>
<p>上面的 &quot;product&quot; 元素根本没有内容。为了定义无内容的类型，我们就必须声明一个在其内容中只能包含元素的类型，但是实际上我们并不会声明任何元素，比如这样：</p>
<pre>&lt;xs:element name=&quot;product&quot;&gt;
  &lt;xs:complexType&gt;
    &lt;xs:complexContent&gt;
...
<pre>&lt;xs:element name=&quot;product&quot; type=&quot;prodtype&quot;/&gt;
