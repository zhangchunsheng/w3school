...
<li class="currentLink"><a href="/schema/schema_complex_mixed.asp" title="XSD 带有混合内容的复合类型">XSD 混合内容</a></li>
...
<h1>XSD 带有混合内容的复合类型</h1>

<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/schema/schema_complex_text.asp" title="XSD 仅含文本复合元素">XSD 仅含文本</a></li>
<li class="next"><a href="/schema/schema_complex_indicators.asp" title="XSD 复合类型指示器">XSD 指示器</a></li>
</ul>
</div>

<div id="intro">
<p><strong>混合的复合类型可包含属性、元素以及文本。</strong></p>
</div>

<div>
<h2>带有混合内容的复合类型</h2>

<p>XML 元素，&quot;letter&quot;，含有文本以及其他元素：</p>
<pre>&lt;letter&gt;
...
<pre>&lt;xs:element name=&quot;letter&quot;&gt;
  &lt;xs:complexType <code>mixed=&quot;true&quot;</code>&gt;
    &lt;xs:sequence&gt;
  ...
  &lt;/xs:complexType&gt;
&lt;/xs:element&gt;</pre>
<p class="note"><span>注释：</span>为了使字符数据可以出现在 &quot;letter&quot; 的子元素之间，mixed 属性必须被设置为 &quot;true&quot;。&lt;xs:sequence&gt; 标签 (name、orderid 以及 shipdate ) 意味着被定义的元素必须依次出现在 &quot;letter&quot; 元素内部。</p>

<p>我们也可以为 complexType 元素起一个名字，并让 &quot;letter&quot; 元素的 type 属性引用 complexType 的这个名称（通过这个方法，若干元素均可引用同一个复合类型）：</p>
<pre>&lt;xs:element name=&quot;letter&quot; type=&quot;lettertype&quot;/&gt;
