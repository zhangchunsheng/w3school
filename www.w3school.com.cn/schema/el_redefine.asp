...
<title>XML Schema redefine 元素</title>
</head>
...
<p>redefine 元素允许在当前 Schema 中重新定义从外部架构文件中获取的简单和复杂类型、组和属性组。</p>
...
<tr>
<td>内容</td>
<td>annotation、attributeGroup、complexType、group、simpleType</td>
</tr>
</table>
...
<td>必需。对 schema 文档位置的 URI 引用。</td>
</tr>
...
<p>下面的例子展示了一个 schema，Myschama2.xsd，其中存在由 Myschama1.xsd 规定的元素。pname 类型被重新定义。根据此 schema，被 pname 约束的元素必须以 &quot;country&quot; 元素结束：</p>
