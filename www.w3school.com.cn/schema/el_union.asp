...
<title>XML Schema union 元素</title>
</head>
...
<p>union 元素定义多个 simpleType 定义的集合。</p>
...
<p>（? 符号声明在 union 元素中该元素可出现零次或一次。）</p>
...
<tr>
<td>memberTypes</td>
<td>可选。规定在 schema 中定义的内置数据类型或 simpleType 元素的名称列表。</td>
</tr>
