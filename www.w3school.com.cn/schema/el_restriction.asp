...
<title>XML Schema restriction 元素</title>
</head>
...
<h1>XML Schema restriction 元素</h1>
...
<p>restriction 元素定义对 simpleType、simpleContent 或 complexContent 定义的约束。</p>
...
<tr>
<td>内容</td>
<td>group、all、choice、sequence、attribute、attributeGroup、anyAttribute</td>
</tr>
</table>
...
<p>（? 符号声明在 restriction 元素中该元素可出现零次或一次。）</p>
...
<tr>
<td>base</td>
<td>必需。规定在该 schema（或由指定的命名空间指示的其他 schema）中定义的内建数据类型、simpleType 或 complexType 元素的名称。</td>
</tr>
...
<p>下面的例子定义了一个带有约束且名为 &quot;age&quot; 的元素。age 的值不能小于 0 或大于 100：</p>
...
<p>本例定义了一个名为 &quot;initials&quot; 的元素。&quot;initials&quot; 元素是带有约束的简单类型。可接受的值是三个从 a 到 z 的大写或小写字母：</p>
...
<p>本例定义了一个名为 &quot;password&quot; 元素。&quot;password&quot; 元素是带有约束的简单类型。值必须为最少 5 个字符且最多 8 个字符：</p>
...
<p>本例展示了一个使用约束的复杂类型定义。复杂类型 &quot;Chinese_customer&quot; 从一个普通的 customer 复杂类型派生而来，其 country 元素的固定值是 &quot;China&quot;：</p>

<pre>&lt;xs:complexType name=&quot;customer&quot;&gt;
  &lt;xs:sequence&gt;
