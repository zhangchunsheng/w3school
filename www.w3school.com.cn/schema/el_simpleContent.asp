...
<title>XML Schema simpleContent 元素</title>
</head>
...
<h1>XML Schema simpleContent 元素</h1>
...
<p>simpleContent 元素包含对 complexType 元素（它以字符数据或 simpleType 元素为内容）的扩展或限制并且不包含任何元素。</p>
...
<td>
<p>可选项 — annotation</p>
<p>必选项 — 有并且只有一个下列元素： restriction (simpleContent) 或 extension (simpleContent)。</p>
</td>
</tr>
</table>
...
<p>（? 符号声明在 simpleContent 元素中该元素可出现零次或一次。）</p>
...
<p>这是一个仅包含文本的 XML 元素 (&lt;shoesize&gt;)：</p>

<pre>&lt;shoesize country=&quot;france&quot;&gt;35&lt;/shoesize&gt;</pre>

<p>下面的例子声明了一个复杂类型 &quot;shoesize&quot;，其内容被定义为整数数据类型，并带有一个 country 属性：</p>
