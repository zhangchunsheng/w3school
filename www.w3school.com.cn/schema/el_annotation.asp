...
<title>XML Schema annotation 元素</title>
</head>
...
<h1>XML Schema annotation 元素</h1>
...
<p>annotation 元素是一个顶层元素，规定 schema 的注释。</p>
<p class="note"><span>注释：</span>可以包含 appinfo 元素（由应用程序使用的信息）和 documentation 元素（由用户读取或使用的注释或文本）。</p>
...
<p>（* 符号声明该元素可在 annotation 元素中出现零次或多次。）</p>
