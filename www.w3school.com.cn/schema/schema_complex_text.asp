...
<li class="currentLink"><a href="/schema/schema_complex_text.asp" title="XSD 仅含文本复合元素">XSD 仅含文本</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/schema/schema_complex_elements.asp" title="XSD 复合类型 - 仅含元素">XSD 仅含元素</a></li>
<li class="next"><a href="/schema/schema_complex_mixed.asp" title="XSD 带有混合内容的复合类型">XSD 混合内容</a></li>
</ul>
</div>

<div id="intro">
<p><strong>仅含文本的复合元素可包含文本和属性。</strong></p>
</div>

<div>
<h2>仅含文本的复合元素</h2>

<p>此类型仅包含简易的内容（文本和属性），因此我们要向此内容添加 simpleContent 元素。当使用简易内容时，我们就必须在 simpleContent 元素内定义扩展或限定，就像这样：</p>
<pre>&lt;xs:element name=&quot;某个名称&quot;&gt;
  &lt;xs:complexType&gt;
    &lt;xs:simpleContent&gt;
...
<p class="tip"><span>提示：</span>请使用 extension 或 restriction 元素来扩展或限制元素的基本简易类型。</p>

<p>这里有一个 XML 元素的例子，&quot;shoesize&quot;，其中仅包含文本：</p>
<pre>&lt;shoesize country=&quot;france&quot;&gt;35&lt;/shoesize&gt;</pre>

<p>下面这个例子声明了一个复合类型，其内容被定义为整数值，并且 &quot;shoesize&quot; 元素含有名为 &quot;country&quot; 的属性：</p>
<pre>&lt;xs:element name=&quot;shoesize&quot;&gt;
  &lt;xs:complexType&gt;
    &lt;xs:simpleContent&gt;
...
<pre>&lt;xs:element name=&quot;shoesize&quot; type=&quot;shoetype&quot;/&gt;
