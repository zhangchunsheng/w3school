...
<title>XML Schema attributeGroup 元素</title>
</head>
...
<h1>XML Schema attributeGroup 元素</h1>
...
<p>attributeGroup 元素用于对属性声明进行组合，这样这些声明就能够以组合的形式合并到复杂类型中。</p>
...
<p>（? 符号声明在 attributeGroup 元素中，元素可出现零次或一次，* 符号声明元素可出现零次或多次。）</p>
...
<tr>
<td>name</td>
<td>可选。规定属性组的名称。name 和 ref 属性不能同时出现。</td>
</tr>

<tr>
<td>ref</td>
<td>可选。规定对指定的属性组的引用。name 和 ref 属性不能同时出现。</td>
</tr>
...
<p>上面的例子定义了一个名为 &quot;personattr&quot; 的属性组，在名为 &quot;person&quot; 的复杂类型中使用。</p>
</div>
