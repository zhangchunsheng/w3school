...
<li class="currentLink"><a href="/schema/schema_complex_elements.asp" title="XSD 复合类型 - 仅含元素">XSD 仅含元素</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/schema/schema_complex_empty.asp" title="XSD 复合空元素">XSD 空元素</a></li>
<li class="next"><a href="/schema/schema_complex_text.asp" title="XSD 仅含文本复合元素">XSD 仅含文本</a></li>
</ul>
</div>


<div id="intro">
<p><strong>“仅含元素”的复合类型元素是只能包含其他元素的元素。</strong></p>
</div>
...
<p>您可在 schema 中这样定义 &quot;person&quot; 元素：</p>
...
<p>请留意这个 &lt;xs:sequence&gt;。它意味着被定义的元素必须按上面的次序出现在 &quot;person&quot; 元素中。</p>

<p>或者您可以为 complexType 元素设定一个名称，并让 &quot;person&quot; 元素的 type 属性来引用此名称（如使用此方法，若干元素均可引用相同的复合类型）：</p>

<pre>&lt;xs:element name=&quot;person&quot; type=&quot;persontype&quot;/&gt;
