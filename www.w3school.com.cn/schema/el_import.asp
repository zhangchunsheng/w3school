...
<title>XML Schema import 元素</title>
</head>
...
<p>import 元素用于向一个文档添加带有不同目标命名空间的多个 schema。</p>
...
<tr>
<td>namespace</td>
<td>必需。规定要导入的命名空间的 URI。</td>
</tr>

<tr>
<td>schemaLocation</td>
<td>可选。规定被导入的命名空间的 URI。</td>
</tr>
...
<p>（? 符号声明在 import 元素中，该元素可出现零次或一次。）</p>
</div>
