...
<p>all 元素规定子元素能够以任意顺序出现，每个子元素可出现零次或一次。</p>
...
<tr>
<td>父元素</td>
<td>group、restriction (simpleContent)、extension (simpleContent)、restriction (complexContent)、extension (complexContent)、complexType</td>
</tr>

<tr>
<td>内容</td>
<td>annotation、element</td>
</tr>
</table>
...
<p>（? 符号声明该元素可出现零次或一次，而 * 符号声明该元素可在所有元素中出现零次或多次。）</p>
...
<tr>
<td>maxOccurs</td>
<td>可选。元素可出现的最大次数。 该值必须是 1。</td>
</tr>

<tr>
<td>minOccurs</td>
<td>可选。元素可出现的最小次数。 该值可以是整数 0 或 1。若要指定该元素是可选的，请将该属性设置为 0。 默认值为 1。</td>
</tr>
...
<p>上面的例子指示 &quot;firstname&quot; 和 &quot;lastname&quot; 元素能够以任何顺序出现，两个元素都必须且只能出现一次！</p>
...
<p>上面的例子指示 &quot;firstname&quot; 和 &quot;lastname&quot; 元素能够以任何顺序出现，每个元素都能出现零次或一次！</p>
</div>
