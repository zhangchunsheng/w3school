...
<title>XML Schema extension 元素</title>
</head>
...
<p>extension 元素对 simpleType 或 complexType 的元素进行扩展。</p>
...
<tr>
<td>内容</td>
<td>annotation、attribute、attributeGroup、anyAttribute、choice、all、sequence、group</td>
</tr>
</table>
...
<tr>
<td>base</td>
<td>必需。规定内建数据类型、simpleType 或 complexType 元素的名称。</td>
</tr>
...
<p>（? 符号声明在 extension 元素内，该元素只能出现零次或一次，* 符号声明该元素可出现零次或多次。）</p>
</div>
...
<p>下面的例子通过添加属性，对一个已有的 simpleType 进行扩展：</p>
...
<p>下面的例子通过添加三个元素，对一个已有的 complexType 元素进行扩展：</p>
