...
<li class="currentLink"><a href="/schema/schema_intro.asp" title="XSD 简介">XSD 简介</a></li>
...
<li class="next"><a href="/schema/schema_why.asp" title="为什么要使用 XML Schemas？">XSD 为何使用</a></li>
</ul>
</div>

<div id="intro">
<p><strong>XML Schema 是基于 XML 的 DTD 替代者。</strong></p>
<p><strong>XML Schema 可描述 XML 文档的结构。</strong></p>
<p><strong>XML Schema 语言也可作为 XSD（XML Schema Definition）来引用。</strong></p>
</div>
...
<ul>
<li>HTML / XHTML</li>
<li>XML 以及 XML 命名空间</li>
<li>对 DTD 的基本了解</li>
</ul>
<p>如果您希望首先学习这些项目，请在 <a href="/index.html" title="W3School在线教程">首页</a> 访问这些教程。</p>
</div>

<div>
<h2>什么是 XML Schema？</h2>
...
<div>
<h2>XML Schema 是 W3C 标准</h2>
<p>XML Schema 在 2001 年 5 月 2 日成为 W3C 标准。</p>
<p>您可以在我们的《<a href="/w3c/w3c_schema.asp" title="W3C XML Schema 活动">W3C 教程</a>》中获得更多有关 XML Schema 标准的信息。</p>
</div>
