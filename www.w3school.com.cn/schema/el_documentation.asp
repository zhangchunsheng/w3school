...
<title>XML Schema documentation 元素</title>
</head>
...
<h1>XML Schema documentation 元素</h1>
...
<p>documentation 元素在 schema 中输入文本注释。该元素必须位于 annotation 元素内。</p>
