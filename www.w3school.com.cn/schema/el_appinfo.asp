...
<title>XML Schema appInfo 元素</title>
</head>
...
<p>appInfo 元素规定 annotation 元素中应用程序要使用的信息。该元素必须位于 annotation 中。</p>
<p class="note"><span>注释：</span>应用程序使用在 appinfo 元素内提供的信息处理指令。</p>
...
<tr>
<td>source</td>
<td>可选。一个 URI 引用，规定应用程序信息的来源。</td>
</tr>
</table>
