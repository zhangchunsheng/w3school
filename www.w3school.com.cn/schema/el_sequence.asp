...
<title>XML Schema sequence 元素</title>
</head>
...
<p>sequence 元素要求组中的元素以指定的顺序出现在包含元素中。每个子元素可出现 0 次到任意次数。</p>
...
<tr>
<td>父元素</td>
<td>group、choice、sequence、complexType、restriction (simpleContent)、extension (simpleContent)、restriction (complexContent)、extension (complexContent)</td>
</tr>

<tr>
<td>内容</td>
<td>annotation、any、choice、element、group、sequence</td>
</tr>
</table>
...
<p>（? 声明在 sequence 元素中该元素可出现零次或一次。）</p>
...
<tr>
<td>maxOccurs</td>
<td>可选。规定 any 元素在父元素中可出现的最大次数。该值可以是大于或等于零的整数。若不想对最大次数设置任何限制，请使用字符串 &quot;unbounded&quot;。 默认值为 1。</td>
</tr>

<tr>
<td>minOccurs</td>
<td>可选。规定 any 元素在父元素中可出现的最小次数。该值可以是大于或等于零的整数。若要指定该 any 组是可选的，请将此属性设置为零。 默认值为 1。</td>
</tr>
...
<p>本例是一个针对 &quot;personinfo&quot; 元素的声明，该元素必需按顺序包含下列 5 个元素：&quot;firstname&quot;, &quot;lastname&quot;, &quot;address&quot;, &quot;city&quot;, and &quot;country&quot;。</p>

<pre>&lt;xs:element name=&quot;personinfo&quot;&gt;
  &lt;xs:complexType&gt;
    &lt;xs:sequence&gt;
...
<p>本例是一个针对 &quot;pets&quot; 元素的声明，可包含零个或多个 dog 和 cat 元素：</p>

<pre>&lt;xs:element name=&quot;pets&quot;&gt;
  &lt;xs:complexType&gt;
