...
<li class="currentLink"><a href="/schema/schema_simple_attributes.asp" title="XSD 属性">XSD 属性</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/schema/schema_simple.asp" title="XSD 简易元素">XSD 元素</a></li>
<li class="next"><a href="/schema/schema_facets.asp" title="XSD 限定/Facets">XSD 限定</a></li>
</ul>
</div>

<div id="intro">
<p><strong>所有的属性均作为简易类型来声明。</strong></p>
</div>

<div>
<h2>什么是属性？</h2>
<p>简易元素无法拥有属性。假如某个元素拥有属性，它就会被当作某种复合类型。但是属性本身总是作为简易类型被声明的。</p>
</div>
...
<h3>定义属性的语法是：</h3>
<pre>&lt;xs:attribute name=&quot;xxx&quot; type=&quot;yyy&quot;/&gt;</pre>

<p>在此处，xxx 指属性名称，yyy 则规定属性的数据类型。XML Schema 拥有很多内建的数据类型。</p>
...
<h3>实例</h3>
<p>这是带有属性的 XML 元素：</p>
<pre>&lt;lastname lang=&quot;EN&quot;&gt;Smith&lt;/lastname&gt;</pre>

<p>这是对应的属性定义：</p>
<pre>&lt;xs:attribute name=&quot;lang&quot; type=&quot;xs:string&quot;/&gt;</pre>
</div>
...
<div>
<h2>可选的和必需的属性</h2>
<p>在缺省的情况下，属性是可选的。如需规定属性为必选，请使用 &quot;use&quot; 属性：</p>
<pre>&lt;xs:attribute name=&quot;lang&quot; type=&quot;xs:string&quot; use=&quot;required&quot;/&gt;</pre>
</div>

<div>
<h2>对内容的限定</h2>
<p>当 XML 元素或属性拥有被定义的数据类型时，就会向元素或属性的内容添加限定。</p>
<p>假如 XML 元素的类型是 &quot;xs:date&quot;，而其包含的内容是类似 &quot;Hello World&quot; 的字符串，元素将不会（通过）验证。</p>
<p>通过 XML schema，您也可向您的 XML 元素及属性添加自己的限定。这些限定被称为 facet（编者注：意为(多面体的)面，可译为限定面）。您会在下一节了解到更多有关 facet 的知识。</p>
</div>
