...
<li class="currentLink"><a href="/schema/schema_complex_indicators.asp" title="XSD 复合类型指示器">XSD 指示器</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/schema/schema_complex_mixed.asp" title="XSD 带有混合内容的复合类型">XSD 混合内容</a></li>
<li class="next"><a href="/schema/schema_complex_any.asp" title="XSD &lt;any&gt; 元素">XSD &lt;any&gt;</a></li>
</ul>
</div>


<div id="intro">
<p><strong>通过指示器，我们可以控制在文档中使用元素的方式。</strong></p>
</div>
...
<p class="note"><span>注释：</span>当使用 &lt;all&gt; 指示器时，你可以把 &lt;minOccurs&gt; 设置为 0 或者 1，而只能把 &lt;maxOccurs&gt; 指示器设置为 1（稍后将讲解 &lt;minOccurs&gt; 以及 &lt;maxOccurs&gt;）。</p>
...
<p class="tip"><span>提示：</span>如需设置子元素出现任意次数，可将 &lt;maxOccurs&gt; （稍后会讲解）设置为 unbounded（无限次）。</p>
...
<p class="note"><span>注释：</span>对于所有的 &quot;Order&quot; 和 &quot;Group&quot; 指示器（any、all、choice、sequence、group name 以及 group reference），其中的 maxOccurs 以及 minOccurs 的默认值均为 1。</p>
...
<pre>&lt;xs:element name=&quot;person&quot;&gt;
  &lt;xs:complexType&gt;
    &lt;xs:sequence&gt;
      ...
      &lt;xs:element name=&quot;child_name&quot; type=&quot;xs:string&quot; <code>maxOccurs=&quot;10&quot;</code>/&gt;
    &lt;/xs:sequence&gt;
  &lt;/xs:complexType&gt;
&lt;/xs:element&gt;</pre>
...
<pre>&lt;xs:element name=&quot;person&quot;&gt;
  &lt;xs:complexType&gt;
    &lt;xs:sequence&gt;
      ...
      maxOccurs=&quot;10&quot; <code>minOccurs=&quot;0&quot;</code>/&gt;
    &lt;/xs:sequence&gt;
  &lt;/xs:complexType&gt;
&lt;/xs:element&gt;</pre>
<p>上面的例子表明，子元素 &quot;child_name&quot; 可在 &quot;person&quot; 元素中出现最少 0 次，最多出现 10 次。</p>
<p class="tip"><span>提示：</span>如需使某个元素的出现次数不受限制，请使用 maxOccurs=&quot;unbounded&quot; 这个声明：</p>
      ...
      &lt;xs:element name=&quot;person&quot; maxOccurs=&quot;unbounded&quot;&gt;
        &lt;xs:complexType&gt;
          &lt;xs:sequence&gt;
            &lt;xs:element name=&quot;full_name&quot; type=&quot;xs:string&quot;/&gt;
            &lt;xs:element name=&quot;child_name&quot; type=&quot;xs:string&quot;
            <code>minOccurs=&quot;0&quot; maxOccurs=&quot;5&quot;</code>/&gt;
          &lt;/xs:sequence&gt;
        &lt;/xs:complexType&gt;
      &lt;/xs:element&gt;
    &lt;/xs:sequence&gt;
...
<pre>&lt;xs:group <code>name=&quot;persongroup&quot;</code>&gt;
  &lt;xs:sequence&gt;
    &lt;xs:element name=&quot;firstname&quot; type=&quot;xs:string&quot;/&gt;
    &lt;xs:element name=&quot;lastname&quot; type=&quot;xs:string&quot;/&gt;
    &lt;xs:element name=&quot;birthday&quot; type=&quot;xs:date&quot;/&gt;
...
&lt;xs:complexType name=&quot;personinfo&quot;&gt;
  &lt;xs:sequence&gt;
    <code>&lt;xs:group ref=&quot;persongroup&quot;/&gt;</code>
...
<pre>&lt;xs:attributeGroup name=&quot;组名称&quot;&gt;
  ...
&lt;/xs:attributeGroup&gt;</pre>

<p>下面这个例子定义了名为 &quot;personattrgroup&quot; 的一个属性组：</p>
<pre>&lt;xs:attributeGroup name=&quot;personattrgroup&quot;&gt;
...
<pre>&lt;xs:attributeGroup <code>name=&quot;personattrgroup&quot;</code>&gt;
  &lt;xs:attribute name=&quot;firstname&quot; type=&quot;xs:string&quot;/&gt;
  &lt;xs:attribute name=&quot;lastname&quot; type=&quot;xs:string&quot;/&gt;
  &lt;xs:attribute name=&quot;birthday&quot; type=&quot;xs:date&quot;/&gt;
&lt;/xs:attributeGroup&gt;
...
&lt;xs:element name=&quot;person&quot;&gt;
  &lt;xs:complexType&gt;
    <code>&lt;xs:attributeGroup ref=&quot;personattrgroup&quot;/&gt;</code>
  &lt;/xs:complexType&gt;
&lt;/xs:element&gt;</pre>
</div>
