...
<title>XML Schema choice 元素</title>
</head>
...
<p>XML Schema 的 choice 元素仅允许包含在 &lt;choice&gt; 声明中的元素之一出现在包含元素中。</p>
...
<td>在 group 和 complexType 元素中为一次；其他为无限制。</td>
</tr>
...
<p>（? 符号声明在 choice 元素中，元素可出现零次或一次，* 符号声明元素可出现零次或多次。）</p>
...
<tr>
<td>maxOccurs</td>
<td>可选。规定 choice 元素在父元素中可出现的最大次数。该值可以是大于或等于零的整数。若不想对最大次数设置任何限制，请使用字符串 &quot;unbounded&quot;。 默认值为 1。</td>
</tr>

<tr>
<td>minOccurs</td>
<td>可选。规定 choice 元素在父元素中可出现的最小次数。该值可以是大于或等于零的整数。若要指定该 any 组是可选的，请将此属性设置为零。 默认值为 1。</td>
</tr>
...
<p>上面的例子定义 &quot;person&quot; 元素必须包含一个 &quot;employee&quot; 元素或一个 &quot;member&quot; 元素。</p>
</div>
