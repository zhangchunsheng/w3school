...
<title>XML Schema selector 元素</title>
</head>
...
<p>selector 元素指定 XML 路径语言 (XPath) 表达式，该表达式为标识约束选择一组元素（unique、key 和 keyref 元素）。</p>
...
<tr>
<td>xpath</td>
<td>必需。规定相对于所声明的元素的 XPath 表达式。该表达式标识应用标识约束（所声明的元素）的子元素。</td>
</tr>
