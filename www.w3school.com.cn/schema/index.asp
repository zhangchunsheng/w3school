...
<ul>
<li class="currentLink"><a href="/schema/index.asp" title="XSD 教程">XSD 教程</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/schema/index.asp" title="XSD 教程">XSD 教程</a></li>
<li class="next"><a href="/schema/schema_intro.asp" title="XSD 简介">XSD 简介</a></li>
</ul>
</div>

<div id="intro">
<p><strong>XML Schema 是基于 XML 的 DTD 替代者。</strong></p>
<p><strong>XML Schema 描述 XML 文档的结构。</strong></p>
<p><strong>XML Schema 语言也称作 XML Schema 定义（XML Schema Definition，XSD）。</strong></p>
<p><strong>在此教程中，你将学习如何在应用程序中读取和创建 XML Schema 语言，XML Schema 为何比 DTD 更加强大，以及如何在您的应用程序中使用 XML Schema。</strong></p>
<p><a href="/schema/schema_intro.asp" title="Schema 简介">开始学习 XML Schema</a> ！</p>
</div>

<div>
<h2>XML Schema 参考手册</h2>
<p>在 W3School，我们提供完整的有效的 XML Schema 元素。</p>
<p><a href="/schema/schema_elements_ref.asp" title="XML Schema 参考手册">XML Schema 参考手册</a></p>
</div>
