...
<title>您已经学习了 XML Schema，下一步学习什么呢？</title>
</head>
...
<li class="currentLink"><a href="/schema/schema_summary.asp" title="您已经学习了 XML Schema，下一步学习什么呢？">XSD 总结</a></li>
</ul>
<h2>参考手册</h2>
<ul>
...
<h1>您已经学习了 XML Schema，下一步学习什么呢？</h1>

<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/schema/schema_dtypes_misc.asp" title="XSD 杂项数据类型">XSD 杂项</a></li>
<li class="next"><a href="/schema/schema_elements_ref.asp" title="XSD 参考手册">XSD 参考手册</a></li>
</ul>
</div>

<div>
<h2>XML Schema 概要</h2>
<p>本教程已经向您讲解了如何描述 XML 文档的结构。</p>
<p>您已经学习了如何使用 XML Schema 来定义 XML 文档的合法元素，就像 DTD。我们认为，XML Schema 作为 DTD 的替代者，会很快被应用于大多数 Web 应用程序中。</p>
<p>您还学习到，XML Schema 是很完善的。与 DTD 不同，XML Schema 支持数据类型（data type）和命名空间（namespace）。</p>
<p>请参阅我们的 <a href="/schema/schema_elements_ref.asp">XML Schema 参考手册</a>，获得更多有关 XML Schema 的信息。</p>
</div>

<div>
<h2>您已经学习了 XML Schema，下一步学习什么呢？</h2>
<p>下一步应该学习 WSDL。</p>
<p>WSDL 是一种基于 schema 的语言，用来描述 Web service 以及如何如何访问它们。</p>
<p>WSDL 可描述 Web service，连同用于 Web service 的消息格式和协议细节。</p>
<p>如果您希望学习更多有关 WSDL 的知识，请访问我们的 <a href="/wsdl/index.asp">WSDL 教程</a>。</p>
</div>
