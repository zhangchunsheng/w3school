...
<li class="currentLink"><a href="/css/css_dont.asp" title="CSS 注意事项">CSS 注意事项</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/css/css_mediatypes.asp" title="CSS 媒介类型">CSS 媒介类型</a></li>
<li class="next"><a href="/css/css_summary.asp" title="CSS 总结">CSS 总结</a></li>
</ul>
</div>

<div id="intro">
<p><strong>本节列出了在使用 CSS 时尽量避免使用的技术。</strong></p>
</div>

<div>
<h2>Internet Explorer Behaviors</h2>

<p><em>它是什么？</em>Internet Explorer 5 引入了行为 (behaviors)。behaviors 是一种通过使用 CSS 向 HTML 元素添加行为的方法。</p>

<p><em>为什么要避免它？</em>只有 Internet Explorer 支持 behavior 属性。</p>

<p><em>用什么代替？</em>请使用 <a href="/js/index.asp" title="JavaScript 教程">JavaScript</a> 和 <a href="/jsref/dom_obj_style.asp" title="HTML DOM Style 对象">HTML DOM</a> 取而代之。</p>
</div>

<div>
<h2>例子 1 - Mouseover Highlight</h2>

<p>下面的 HTML 文件中有一个 &lt;style&gt; 元素，它为 &lt;h1&gt; 元素定义了一个行为：</p>
...
<p>behavior 文件包含了针对元素的 JavaScript 和 事件句柄。</p>

<p>如果您使用 Internet Explorer，可以<a href="/tiy/t.asp?f=csse_behave">亲自试一下</a>（把鼠标放在例子中的文本上）。</p>
</div>

<div>
<h2>例子 2 - Typewriter Simulation</h2>

<p>下面的 HTML 文件中有一个 &lt;style&gt; 元素，它为 id 为 &quot;typing&quot; 的元素定义了一个行为：</p>
...
<p>如果您使用 Internet Explorer，可以<a href="/tiy/t.asp?f=csse_behave_typing">亲自试一下</a>。</p>
</div>
