...
<li class="currentLink"><a href="/css/css_syntax_pro.asp" title="CSS 高级语法">CSS 高级语法</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/css/css_syntax.asp" title="CSS 基础语法">CSS 基础语法</a></li>
<li class="next"><a href="/css/css_syntax_descendant_selector.asp" title="CSS 派生选择器">CSS 派生选择器</a></li>
</ul>
</div>
...
<div>
<h2>友善地对待Netscape 4</h2>
<p>幸运地是，你可以通过使用我们称为 &quot;Be Kind to Netscape 4&quot; 的冗余法则来处理旧式浏览器无法理解继承的问题。</p>
<pre>body  {
     font-family: Verdana, sans-serif;
     }
...
<div>
<h2>继承是一个诅咒吗？</h2>
<p>如果你不希望 &quot;Verdana, sans-serif&quot; 字体被所有的子元素继承，又该怎么做呢？比方说，你希望段落的字体是 Times。没问题。创建一个针对 p 的特殊规则，这样它就会摆脱父元素的规则：</p>
<pre>body  {
     font-family: Verdana, sans-serif;
     }
