...
<li class="currentLink"><a href="/css/css_positioning_floating.asp" title="CSS 浮动">CSS 浮动</a></li>
</ul>
<h2>CSS 选择器</h2>
<ul>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/css/css_positioning_absolute.asp" title="CSS 绝对定位">CSS 绝对定位</a></li>
<li class="next"><a href="/css/css_selector_type.asp" title="CSS 元素选择器">CSS 元素选择器</a></li>
</ul>
</div>
...
<p>如需更多有关 float 属性的知识，请访问参考手册：<a href="/cssref/pr_class_float.asp" title="CSS float 属性">CSS float 属性</a>。</p>
</div>
...
<p>要想阻止行框围绕浮动框，需要对该框应用 <a href="/cssref/pr_class_clear.asp" title="CSS clear 属性">clear 属性</a>。clear 属性的值可以是 left、right、both 或 none，它表示框的哪些边不应该挨着浮动框。</p>
...
<p>我们刚才详细讨论了 CSS 清理的工作原理和 clear 属性应用方法。如果您希望学习更多有关 clear 属性的知识，请访问参考手册：<a href="/cssref/pr_class_clear.asp" title="CSS clear 属性">CSS clear 属性</a>。</p>
</div>
...
<dl>
<dt><a href="/tiy/t.asp?f=csse_float">float 属性的简单应用</a></dt>
<dd>使图像浮动于一个段落的右侧。</dd>

<dt><a href="/tiy/t.asp?f=csse_float2">将带有边框和边界的图像浮动于段落的右侧</a></dt>
<dd>使图像浮动于段落的右侧。向图像添加边框和边界。</dd>

<dt><a href="/tiy/t.asp?f=csse_float3">带标题的图像浮动于右侧</a></dt>
<dd>使带有标题的图像浮动于右侧</dd>

<dt><a href="/tiy/t.asp?f=csse_float4">使段落的首字母浮动于左侧</a></dt>
<dd>使段落的首字母浮动于左侧，并向这个字母添加样式。</dd>

<dt><a href="/tiy/t.asp?f=csse_float5">创建水平菜单</a></dt>
<dd>使用具有一栏超链接的浮动来创建水平菜单。</dd>

<dt><a href="/tiy/t.asp?f=csse_float6">创建无表格的首页</a></dt>
