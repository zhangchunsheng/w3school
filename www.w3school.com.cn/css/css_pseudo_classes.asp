...
<li class="currentLink"><a href="/css/css_pseudo_classes.asp" title="CSS 伪类">CSS 伪类</a></li>
...
<h1>CSS 伪类 (Pseudo-classes)</h1>

<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/css/css_selector_adjacent_sibling.asp" title="CSS 相邻兄弟选择器">CSS 相邻兄弟选择器</a></li>
<li class="next"><a href="/css/css_pseudo_elements.asp" title="CSS 伪元素">CSS 伪元素</a></li>
</ul>
</div>


<div id="intro">
<p><strong>CSS 伪类用于向某些选择器添加特殊的效果。</strong></p>
</div>
...
<dd>本例演示如何对超链接应用 :focus 伪类（无法在 IE 中工作）。</dd>
...
<pre>
<code>a:link</code> {color: #FF0000}		<span>/* 未访问的链接 */</span>
<code>a:visited</code> {color: #00FF00}	<span>/* 已访问的链接 */</span>
<code>a:hover</code> {color: #FF00FF}	<span>/* 鼠标移动到链接上 */</span>
<code>a:active</code> {color: #0000FF}	<span>/* 选定的链接 */</span>
</pre>

<p><a href="/tiy/t.asp?f=csse_link">亲自试一试</a></p>

<p class="tip"><span>提示：</span>在 CSS 定义中，a:hover 必须被置于 a:link 和 a:visited 之后，才是有效的。</p>
<p class="tip"><span>提示：</span>在 CSS 定义中，a:active 必须被置于 a:hover 之后，才是有效的。</p>
<p class="tip"><span>提示：</span>伪类名称对大小写不敏感。</p>
</div>
...
<pre>a<code>.red</code> : visited {color: #FF0000}

&lt;a class=&quot;<code>red</code>&quot; href=&quot;css_syntax.asp&quot;&gt;CSS Syntax&lt;/a&gt;</pre>
...
<div>
<h2>CSS2 - :first-child 伪类</h2>

<p>您可以使用 :first-child 伪类来选择元素的第一个子元素。这个特定伪类很容易遭到误解，所以有必要举例来说明。考虑以下标记：</p>
...
<p>在上面的例子中，作为第一个元素的元素包括第一个 p、第一个 li 和 strong 和 em 元素。</p>
...
<p>请访问该链接，来查看这个 <a href="/tiy/t.asp?f=csse_first-child">:first-child 实例</a>的效果。</p>

<p class="tip"><span>提示：</span>最常见的错误是认为 p:first-child 之类的选择器会选择 p 元素的第一个子元素。</p>
<p class="note"><span>注释：</span>必须声明 <a href="/tags/tag_doctype.asp">&lt;!DOCTYPE&gt;</a>，这样 :first-child 才能在 IE 中生效。</p>

<p>为了使您更透彻地理解 :first-child 伪类，我们另外提供了 3 个例子：</p>
...
<p><a href="/tiy/t.asp?f=csse_first-child_1">TIY</a></p>
...
<p><a href="/tiy/t.asp?f=csse_first-child_2">TIY</a></p>
...
<p><a href="/tiy/t.asp?f=csse_first-child_3">TIY</a></p>
</div>
...
<p><em>W3C</em>：&quot;W3C&quot; 列指示出该属性在哪个 CSS 版本中定义（CSS1 还是 CSS2）。</p>
