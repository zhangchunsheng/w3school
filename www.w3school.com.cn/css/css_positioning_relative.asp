...
<li class="currentLink"><a href="/css/css_positioning_relative.asp" title="CSS 相对定位">CSS 相对定位</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/css/css_positioning.asp" title="CSS 定位概述">CSS 定位概述</a></li>
<li class="next"><a href="/css/css_positioning_absolute.asp" title="CSS 绝对定位">CSS 绝对定位</a></li>
</ul>
</div>


<div id="intro">
<p><strong>设置为相对定位的元素框会偏移某个距离。元素仍然保持其未定位前的形状，它原本所占的空间仍保留。</strong></p>
</div>
...
<img src="/i/ct_css_positioning_relative_example.gif" alt="CSS 相对定位实例" />
