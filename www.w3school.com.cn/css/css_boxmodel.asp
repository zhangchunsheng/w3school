...
<h2>CSS 框模型</h2>
<ul>
<li class="currentLink"><a href="/css/css_boxmodel.asp" title="CSS 框模型概述">CSS 框模型概述</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/css/css_outline.asp" title="CSS 轮廓">CSS 轮廓</a></li>
<li class="next"><a href="/css/css_padding.asp" title="CSS 内边距">CSS 内边距</a></li>
</ul>
</div>

<div id="intro">
<p><strong>CSS 框模型 (Box Model) 规定了元素框处理元素内容、<a href="/css/css_padding.asp" title="CSS 内边距">内边距</a>、<a href="/css/css_border.asp" title="CSS 边框">边框</a> 和 <a href="/css/css_margin.asp" title="CSS 外边距">外边距</a> 的方式。</strong></p>
</div>

<div class="example">
<h2>CSS 框模型概述</h2>

<img src="/i/ct_boxmodel.gif" alt="CSS 框模型" />

<p>元素框的最内部分是实际的内容，直接包围内容的是内边距。内边距呈现了元素的背景。内边距的边缘是边框。边框以外是外边距，外边距默认是透明的，因此不会遮挡其后的任何元素。</p>

<p class="tip"><span>提示：</span>背景应用于由内容和内边距、边框组成的区域。</p>
...
<img src="/i/ct_css_boxmodel_example.gif" alt="CSS 框模型实例" />
...
<p class="tip"><span>提示：</span>内边距、边框和外边距可以应用于一个元素的所有边，也可以应用于单独的边。</p>
<p class="tip"><span>提示：</span>外边距可以是负值，而且在很多情况下都要使用负值的外边距。</p>
</div>
...
<p>在 w3school，我们把 padding 和 margin 统一地称为内边距和外边距。边框内的空白是内边距，边框外的空白是外边距，很容易记吧：）</p>
</div>
