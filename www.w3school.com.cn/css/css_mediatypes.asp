...
<li class="currentLink"><a href="/css/css_mediatypes.asp" title="CSS 媒介类型">CSS 媒介类型</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/css/css_image_transparency.asp" title="CSS 图片透明度">CSS 图片透明</a></li>
<li class="next"><a href="/css/css_dont.asp" title="CSS 注意事项">CSS 注意事项</a></li>
</ul>
</div>


<div id="intro">
<p><strong>媒介类型(Media Types)允许你定义以何种媒介来提交文档。文档可以被显示在显示器、纸媒介或者听觉浏览器等等。</strong></p>
</div>


<div>
<h2>媒介类型</h2>
<p>某些 CSS 属性仅仅被设计为针对某些媒介。比方说 &quot;voice-family&quot; 属性被设计为针对听觉用户终端。其他的属性可被用于不同的媒介。例如，&quot;font-size&quot; 属性可被用于显示器以及印刷媒介，但是也许会带有不同的值。显示器上面的显示的文档通常会需要比纸媒介文档更大的字号，同时，在显示器上，sans-serif 字体更易阅读，而在纸媒介上，serif 字体更易阅读。</p>
</div>
...
<p>下面这个例子中的样式告知浏览器在显示器上显示 14 像素的 Verdana 字体。但是假如页面需要被打印，将使用 10 个像素的 Times 字体。注意：font-weight 被设置为粗体，不论显示器还是纸媒介：</p>
<pre>&lt;html&gt;
&lt;head&gt;
...
<div>
<h2>不同的媒介类型</h2>
<p class="tip"><span>注释：</span>媒介类型名称对大小写不敏感。</p>
...
<table class="dataintable">
  ...
  <tr>
    <td>tty</td>
    <td>用于使用固定密度字母栅格的媒介，比如电传打字机和终端。</td>
  </tr>
  <tr>
    <td>tv</td>
    <td>用于电视机类型的设备。</td>
