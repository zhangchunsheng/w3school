...
<li class="currentLink"><a href="/css/css_syntax_descendant_selector.asp" title="CSS 派生选择器">CSS 派生选择器</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/css/css_syntax_pro.asp" title="CSS 高级语法">CSS 高级语法</a></li>
<li class="next"><a href="/css/css_syntax_id_selector.asp" title="CSS id 选择器">CSS id 选择器</a></li>
</ul>
</div>
...
<p><strong>通过依据元素在其位置的上下文关系来定义样式，你可以使标记更加简洁。</strong></p>
...
<p>请注意标记为 &lt;strong&gt; 的蓝色代码的上下文关系：</p>

<pre>
&lt;p&gt;&lt;strong&gt;我是粗体字，不是斜体字，因为我不在列表当中，所以这个规则对我不起作用&lt;/strong&gt;&lt;/p&gt;

&lt;ol&gt;
<code>&lt;li&gt;&lt;strong&gt;</code>我是斜体字。这是因为 strong 元素位于 li 元素内。<code>&lt;/strong&gt;&lt;/li&gt;</code>
&lt;li&gt;我是正常的字体。&lt;/li&gt;
&lt;/ol&gt;
</pre>
...
<p>如果您需要更深入地学习关于派生选择器的知识，请阅读 W3School 的高级教程中的以下内容：</p>

<ul>
<li><a href="/css/css_selector_descendant.asp">CSS 后代选择器</a></li>
<li><a href="/css/css_selector_child.asp">CSS 子元素选择器</a></li>
<li><a href="/css/css_selector_adjacent_sibling.asp">CSS 相邻兄弟选择器</a></li>
</ul>
</div>
