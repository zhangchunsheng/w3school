...
<li class="currentLink"><a href="/css/css_margin_collapsing.asp" title="CSS 外边距合并">CSS 外边距合并</a></li>
</ul>
<h2>CSS 定位</h2>
<ul>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/css/css_margin.asp" title="CSS 外边距">CSS 外边距</a></li>
<li class="next"><a href="/css/css_positioning.asp" title="CSS 定位概述">CSS 定位概述</a></li>
</ul>
</div>
...
<img src="/i/ct_css_margin_collapsing_example_1.gif" alt="CSS 外边距合并实例 1" />

<p><a href="/tiy/t.asp?f=csse_margin_collapsing1">亲自试一试</a></p>


<p>当一个元素包含在另一个元素中时（假设没有内边距或边框把外边距分隔开），它们的上和/或下外边距也会发生合并。请看下图：</p>

<img src="/i/ct_css_margin_collapsing_example_2.gif" alt="CSS 外边距合并实例 2" />

<p><a href="/tiy/t.asp?f=csse_margin_collapsing2">亲自试一试</a></p>
...
<img src="/i/ct_css_margin_collapsing_example_3.gif" alt="CSS 外边距合并实例 3" />

<p>如果这个外边距遇到另一个元素的外边距，它还会发生合并：</p>

<img src="/i/ct_css_margin_collapsing_example_4.gif" alt="CSS 外边距合并实例 4" />

<p>这就是一系列的段落元素占用空间非常小的原因，因为它们的所有外边距都合并到一起，形成了一个小的外边距。</p>
...
<img src="/i/ct_css_margin_collapsing.gif" alt="CSS 外边距合并的实际意义" />

<p class="note"><span>注释：</span>只有普通文档流中块框的垂直外边距才会发生外边距合并。行内框、浮动框或绝对定位之间的外边距不会合并。</p>
</div>
