...
<li class="currentLink"><a href="/css/css_table.asp" title="CSS 表格">CSS 表格</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/css/css_list.asp" title="CSS 列表">CSS 列表</a></li>
<li class="next"><a href="/css/css_outline.asp" title="CSS 轮廓">CSS 轮廓</a></li>
</ul>
</div>

<div id="intro">
<p><strong>CSS 表格属性可以帮助您极大地改善表格的外观。</strong></p>
</div>
...
<p>如需在 CSS 中设置表格边框，请使用 border 属性。</p>

<p>下面的例子为 table、th 以及 td 设置了蓝色边框：</p>
...
<p><a href="/tiy/t.asp?f=csse_table_border">亲自试一试</a></p>

<p>请注意，上例中的表格具有双线条边框。这是由于 table、th 以及 td 元素都有独立的边框。</p>

<p>如果需要把表格显示为单线条边框，请使用 border-collapse 属性。</p>
</div>
...
<p>border-collapse 属性设置是否将表格边框折叠为单一边框：</p>
...
<p><a href="/tiy/t.asp?f=csse_table_border-collapse">亲自试一试</a></p>
</div>
...
<p>通过 width 和 height 属性定义表格的宽度和高度。</p>
...
<p><a href="/tiy/t.asp?f=csse_table_width">亲自试一试</a></p>
</div>
...
<p>text-align 和 vertical-align 属性设置表格中文本的对齐方式。</p>

<p>text-align 属性设置水平对齐方式，比如左对齐、右对齐或者居中：</p>
...
<p><a href="/tiy/t.asp?f=csse_table_align">亲自试一试</a></p>

<p>vertical-align 属性设置垂直对齐方式，比如顶部对齐、底部对齐或居中对齐：</p>
...
<p><a href="/tiy/t.asp?f=csse_table_vertical-align">亲自试一试</a></p>
</div>
...
<p>如需控制表格中内容与边框的距离，请为 td 和 th 元素设置 padding 属性：</p>
...
<p><a href="/tiy/t.asp?f=csse_table_padding">亲自试一试</a></p>
</div>
...
<p>下面的例子设置边框的颜色，以及 th 元素的文本和背景颜色：</p>
...
<p><a href="/tiy/t.asp?f=csse_table_color">亲自试一试</a></p>
</div>
...
<h2>亲自试一试 - 更多实例</h2>
<dl>
<dt><a href="/tiy/t.asp?f=csse_table_fancy">制作一个漂亮的表格</a></dt>
<dd>本例演示如何创造一个漂亮的表格。</dd>

<dt><a href="/tiy/t.asp?f=csse_table_empty-cells">显示表格中的空单元</a></dt>
<dd>本例演示是否显示表格中的空单元。</dd>
