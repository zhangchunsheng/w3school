...
<li class="currentLink"><a href="/css/css_pseudo_elements.asp" title="CSS 伪元素">CSS 伪元素</a></li>
</ul>
<h2>CSS 高级</h2>
<ul>
...
<h1>CSS 伪元素 (Pseudo-elements)</h1>

<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/css/css_pseudo_classes.asp" title="CSS 伪类">CSS 伪类</a></li>
<li class="next"><a href="/css/css_align.asp" title="CSS 水平对齐">CSS 对齐</a></li>
</ul>
</div>
...
<pre>selector:pseudo-element {property:value;}</pre>

<p>CSS 类也可以与伪元素配合使用：</p>

<pre>selector.class:pseudo-element {property:value;}</pre>
</div>
...
<p><a href="/tiy/t.asp?f=csse_firstline">亲自试一试</a></p>

<p class="note"><span>注释：</span>&quot;first-line&quot; 伪元素只能用于块级元素。</p>

<p class="note"><span>注释：</span>下面的属性可应用于 &quot;first-line&quot; 伪元素：</p>
...
<p><a href="/tiy/t.asp?f=csse_firstletter">亲自试一试</a></p>

<p class="note"><span>注释：</span>&quot;first-letter&quot; 伪元素只能用于块级元素。</p>

<p class="note"><span>注释：</span>下面的属性可应用于 &quot;first-letter&quot; 伪元素：</p>
...
<p>在下面的例子中，段落的第一个字母将显示为红色，其字体大小为 xx-large。第一行中的其余文本将为蓝色，并以小型大写字母显示。段落中的其余文本将以默认字体大小和颜色来显示：</p>
...
<p><a href="/tiy/t.asp?f=csse_firstletter_firstline">亲自试一试</a></p>
</div>


<div>
<h2>CSS2 - :before 伪元素</h2>
...
<p><a href="/tiy/t.asp?f=csse_before">亲自试一试</a></p>
</div>


<div>
<h2>CSS2 - :after 伪元素</h2>
...
<p><a href="/tiy/t.asp?f=csse_after">亲自试一试</a></p>
</div>
