...
<li class="currentLink"><a href="/css/css_link.asp" title="CSS 链接">CSS 链接</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/css/css_font.asp" title="CSS 字体">CSS 字体</a></li>
<li class="next"><a href="/css/css_list.asp" title="CSS 列表">CSS 列表</a></li>
</ul>
</div>

<div id="intro">
<p><strong>我们能够以不同的方法为链接设置样式。</strong></p>
</div>
...
<p>能够设置链接样式的 CSS 属性有很多种（例如 color, font-family, background 等等）。</p>
...
<pre>
a:link {color:#FF0000;}		<span class="code_comment">/* 未被访问的链接 */</span>
a:visited {color:#00FF00;}	<span class="code_comment">/* 已被访问的链接 */</span>
a:hover {color:#FF00FF;}	<span class="code_comment">/* 鼠标指针移动到链接上 */</span>
a:active {color:#0000FF;}	<span class="code_comment">/* 正在被点击的链接 */</span>
</pre>

<p><a target="_blank" href="/tiy/t.asp?f=css_link">亲自试一试</a></p>
...
<p>在上面的例子中，链接根据其状态改变颜色。</p>

<p>让我们看看其他几种常见的设置链接样式的方法：</p>

<h3>文本修饰</h3>

<p>text-decoration 属性大多用于去掉链接中的下划线：</p>
...
<p><a target="_blank" href="/tiy/t.asp?f=css_link_decoration">亲自试一试</a></p>

<h3>背景色</h3>

<p>background-color 属性规定链接的背景色：</p>
...
<p><a target="_blank" href="/tiy/t.asp?f=css_link_background">亲自试一试</a></p>
</div>
...
<dl>
<dt><a target="_blank" href="/tiy/t.asp?f=css_link2">向链接添加不同的样式</a></dt>
<dd>本例演示如何向链接添加其他样式。</dd>

<dt><a target="_blank" href="/tiy/t.asp?f=css_link_advanced">高级 - 创建链接框</a></dt>
<dd>本例演示了更高级的示例，我们结合了若干种 CSS 属性，来把链接显示为方框。</dd>
</dl>
</div>
