...
<li class="currentLink"><a href="/css/css_syntax_class_selector.asp" title="CSS 类选择器">CSS 类选择器</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/css/css_syntax_id_selector.asp" title="CSS id 选择器">CSS id 选择器</a></li>
<li class="next"><a href="/css/css_syntax_attribute_selector.asp" title="CSS 属性选择器">CSS 属性选择器</a></li>
</ul>
</div>
...
<pre>
&lt;h1 <code>class=&quot;center&quot;</code>&gt;
This heading will be center-aligned
&lt;/h1&gt;

&lt;p <code>class=&quot;center&quot;</code>&gt;
This paragraph will also be center-aligned.
&lt;/p&gt;
</pre>

<p class="important"><span>注意：</span>类名的第一个字符不能使用数字！它无法在 Mozilla 或 Firefox 中起作用。</p>
...
<pre>&lt;td <code>class=&quot;fancy&quot;</code>&gt;</pre>
...
<p>如果您需要更深入地学习关于类选择器的知识，请阅读 W3School 的高级教程：<a href="/css/css_selector_class.asp">CSS 类选择器详解</a>。</p>
</div>
