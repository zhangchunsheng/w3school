...
<li class="currentLink"><a href="/css/css_selector_child.asp" title="CSS 子元素选择器">CSS 子元素选择器</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/css/css_selector_descendant.asp" title="CSS 后代选择器">CSS 后代选择器</a></li>
<li class="next"><a href="/css/css_selector_adjacent_sibling.asp" title="CSS 相邻兄弟选择器">CSS 相邻兄弟选择器</a></li>
</ul>
</div>


<div id="intro">
<p><strong>与后代选择器相比，子元素选择器（Child selectors）只能选择作为某元素子元素的元素。</strong></p>
</div>
...
<p>如果您不希望选择任意的后代元素，而是希望缩小范围，只选择某个元素的子元素，请使用子元素选择器（Child selector）。</p>

<p>例如，如果您希望选择只作为 h1 元素子元素的 strong 元素，可以这样写：</p>

<pre>h1 <span class="marked">&gt;</span> strong {color:red;}</pre>
...
<p><a href="/tiy/t.asp?f=csse_selector_child">亲自试一试</a></p>
</div>
...
<p>您应该已经注意到了，子选择器使用了大于号（子结合符）。</p>

<p>子结合符两边可以有空白符，这是可选的。因此，以下写法都没有问题：</p>
...
<p>如果从右向左读，选择器 h1 &gt; strong 可以解释为“选择作为 h1 元素子元素的所有 strong 元素”。</p>
</div>
