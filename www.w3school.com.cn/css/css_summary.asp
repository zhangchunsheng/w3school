...
<li class="currentLink"><a href="/css/css_summary.asp" title="CSS 总结">CSS 总结</a></li>
</ul>
<h2>CSS 实例</h2>
<ul>
...
<h1>你已经学习了 CSS，下一步学习什么呢？</h1>

<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/css/css_dont.asp" title="CSS 注意事项">CSS 注意事项</a></li>
<li class="next"><a href="/example/csse_examples.asp" title="CSS 实例">CSS 实例</a></li>
</ul>
</div>
...
<p>如果需要更多关于 CSS 的信息，请参阅我们对 <a href="/example/csse_examples.asp" title="CSS 实例">CSS 实例</a>、<a href="/cssref/index.asp" title="CSS 参考手册">CSS 参考手册</a> 以及 <a href="/css3/index.asp">CSS3 教程</a>。</p>
</div>


<div>
<h2>你已经学习了 CSS，下一步学习什么呢？</h2>

<p>下一步应该学习 CSS3、HTML5 和 JavaScript 。</p>
...
<p>我们的 HTML5 教程向您讲解 HTML5 中的诸多新特性。</p>

<p><a href="/html5/index.asp" title="HTML5 教程">现在就开始学习 HTML5</a> ！</p>
