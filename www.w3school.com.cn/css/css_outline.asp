...
<li class="currentLink"><a href="/css/css_outline.asp" title="CSS 轮廓">CSS 轮廓</a></li>
</ul>
<h2>CSS 框模型</h2>
<ul>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/css/css_table.asp" title="CSS 表格">CSS 表格</a></li>
<li class="next"><a href="/css/css_boxmodel.asp" title="CSS 框模型概述">CSS 框模型概述</a></li>
</ul>
</div>

<div id="intro">
<p><strong>轮廓（outline）是绘制于元素周围的一条线，位于边框边缘的外围，可起到突出元素的作用。</strong></p>
...
<p>&quot;CSS&quot; 列中的数字指示哪个 CSS 版本定义了该属性。</p>
