...
<h2>CSS 选择器</h2>
<ul>
<li class="currentLink"><a href="/css/css_selector_type.asp" title="CSS 元素选择器">CSS 元素选择器</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/css/css_positioning_floating.asp" title="CSS 浮动">CSS 浮动</a></li>
<li class="next"><a href="/css/css_selector_grouping.asp" title="CSS 选择器分组">CSS 选择器分组</a></li>
</ul>
</div>
...
<p><a href="/tiy/t.asp?f=csse_selector_type_1">亲自试一试</a></p>

<p>可以将某个样式从一个元素切换到另一个元素。</p>

<p>假设您决定将上面的段落文本（而不是 h1 元素）设置为灰色。只需要把 h1 选择器改为 p：</p>

<pre>
html {color:black;}
<code>p {color:gray;}</code>
h2 {color:silver;}
</pre>

<p><a href="/tiy/t.asp?f=csse_selector_type_2">亲自试一试</a></p>
</div>
...
<p>在 W3C 标准中，元素选择器又称为类型选择器（type selector）。</p>

<p>“类型选择器匹配文档语言元素类型的名称。类型选择器匹配文档树中该元素类型的每一个实例。”</p>

<p>下面的规则匹配文档树中所有 h1 元素：</p>

<pre>h1 {font-family: sans-serif;}</pre>

<p>因此，我们也可以为 XML 文档中的元素设置样式：</p>

<h3>XML 文档：</h3>

<pre>
&lt;?xml version=&quot;1.0&quot; encoding=&quot;ISO-8859-1&quot;?&gt;
<code>&lt;?xml-stylesheet type=&quot;text/css&quot; href=&quot;note.css&quot;?&gt;</code>
&lt;note&gt;
&lt;to&gt;George&lt;/to&gt;
&lt;from&gt;John&lt;/from&gt;
...
<p><a href="/example/csse/note_css.xml">查看效果</a></p>

<p>通过上面的例子，您可以看到，CSS 元素选择器（类型选择器）可以设置 XML 文档中元素的样式。</p>

<p>如果您需要更多关于为 XML 文档添加样式的知识，请访问 w3school 的 <a href="/xml/index.asp">XML 教程</a>。</p>
</div>
