...
<li class="currentLink"><a href="/css/css_font.asp" title="CSS 字体">CSS 字体</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/css/css_text.asp" title="CSS 文本">CSS 文本</a></li>
<li class="next"><a href="/css/css_link.asp" title="CSS 链接">CSS 链接</a></li>
</ul>
</div>

<div id="intro">
<p><strong>CSS 字体属性定义文本的字体系列、大小、加粗、风格（如斜体）和变形（如小型大写字母）。</strong></p>
</div>
...
<p style="font-family:Arial, Helvetica, sans-serif">如果需要了解更多有关字体系列的知识，请阅读 <a href="/css/css_font-family.asp" title="CSS 字体系列">CSS 字体系列</a>。</p>
</div>
...
<p>使用 <a href="../cssref/pr_font_font-family.asp" title="CSS font-family 属性">font-family 属性</a> 定义文本的字体系列。</p>
...
<p><a href="/tiy/t.asp?f=csse_font_family_generic">亲自试一试</a></p>

<p>这样用户代理就会从 sans-serif 字体系列中选择一个字体（如 Helvetica），并将其应用到 body 元素。因为有继承，这种字体选择还将应用到 body 元素中包含的所有元素，除非有一种更特定的选择器将其覆盖。</p>
...
<p><a href="/tiy/t.asp?f=csse_font_family_specific">亲自试一试</a></p>

<p>这样的规则同时会产生另外一个问题，如果用户代理上没有安装 Georgia 字体，就只能使用用户代理的默认字体来显示 h1 元素。</p>

<p>我们可以通过结合特定字体名和通用字体系列来解决这个问题：</p>

<pre>h1 {font-family: Georgia, <code>serif</code>;}</pre>

<p><a href="/tiy/t.asp?f=csse_font_family_fallback_1">亲自试一试</a></p>

<p>如果读者没有安装 Georgia，但安装了 Times 字体（serif 字体系列中的一种字体），用户代理就可能对 h1 元素使用 Times。尽管 Times 与 Georgia 并不完全匹配，但至少足够接近。</p>

<p>因此，我们建议在所有 font-family 规则中都提供一个通用字体系列。这样就提供了一条后路，在用户代理无法提供与规则匹配的特定字体时，就可以选择一个候选字体。</p>
...
<p><a href="/tiy/t.asp?f=csse_font_family_fallback_2">亲自试一试</a></p>

<p>根据这个列表，用户代理会按所列的顺序查找这些字体。如果列出的所有字体都不可用，就会简单地选择一种可用的 serif 字体。</p>
...
<p><a href="/tiy/t.asp?f=csse_font_family_quote">亲自试一试</a></p>
</div>
...
<p><a href="/cssref/pr_font_font-style.asp" title="CSS font-style 属性">font-style 属性</a>最常用于规定斜体文本。</p>
...
<p><a href="/tiy/t.asp?f=csse_font-style">亲自试一试</a></p>
...
<p><a href="/cssref/pr_font_font-variant.asp" title="CSS font-variant 属性">font-variant 属性</a>可以设定小型大写字母。</p>

<p>小型大写字母不是一般的大写字母，也不是小写字母，这种字母采用不同大小的大写字母。</p>

<h3>实例</h3>

<pre>p {font-variant:small-caps;}</pre>

<p><a href="/tiy/t.asp?f=csse_font-variant">亲自试一试</a></p>
</div>
...
<p><a href="/cssref/pr_font_weight.asp" title="CSS font-weight 属性">font-weight 属性</a>设置文本的粗细。</p>
...
<p><a href="/tiy/t.asp?f=csse_font-weight">亲自试一试</a></p>
</div>
...
<p><a href="/cssref/pr_font_font-size.asp" title="CSS font-size 属性">font-size 属性</a>设置文本的大小。</p>
...
<p class="important"><span>注意：</span>如果您没有规定字体大小，普通文本（比如段落）的默认大小是 16 像素 (16px=1em)。</p>

<h3>使用像素来设置字体大小</h3>

<p>通过像素设置文本大小，可以对文本大小进行完全控制：</p>
...
<p><a href="/tiy/t.asp?f=csse_font_size_pixel">亲自试一试</a></p>

<p>在 Firefox, Chrome, and Safari 中，可以重新调整以上例子的文本大小，但是在 Internet Explorer 中不行。</p>

<p>虽然可以通过浏览器的缩放工具调整文本大小，但是这实际上是对整个页面的调整，而不仅限于文本。</p>

<h3>使用 em 来设置字体大小</h3>

<p>如果要避免在 Internet Explorer 中无法调整文本的问题，许多开发者使用 em 单位代替 pixels。</p>

<p>W3C 推荐使用 em 尺寸单位。</p>

<p>1em 等于当前的字体尺寸。如果一个元素的 font-size 为 16 像素，那么对于该元素，1em 就等于 16 像素。在设置字体大小时，em 的值会相对于父元素的字体大小改变。</p>

<p>浏览器中默认的文本大小是 16 像素。因此 1em 的默认尺寸是 16 像素。</p>

<p>可以使用下面这个公式将像素转换为 em：<i>pixels</i>/16=<i>em</i></p>

<p>（注：16 等于父元素的默认字体大小，假设父元素的 font-size 为 20px，那么公式需改为：<i>pixels</i>/20=<i>em</i>）</p>

<h4>实例</h4>

<pre>
h1 {font-size:3.75em;} <span>/* 60px/16=3.75em */</span>
h2 {font-size:2.5em;}  <span>/* 40px/16=2.5em */</span>
p {font-size:0.875em;} <span>/* 14px/16=0.875em */</span>
</pre>

<p><a href="/tiy/t.asp?f=csse_font_size_em">亲自试一试</a></p>

<p>在上面的例子中，以 em 为单位的文本大小与前一个例子中以像素计的文本是相同的。不过，如果使用 em 单位，则可以在所有浏览器中调整文本大小。</p>

<p>不幸的是，在 IE 中仍存在问题。在重设文本大小时，会比正常的尺寸更大或更小。</p>

<h3>结合使用百分比和 EM</h3>

<p>在所有浏览器中均有效的方案是为 body 元素（父元素）以百分比设置默认的 font-size 值：</p>
...
<p><a href="/tiy/t.asp?f=csse_font_size_em_percent">亲自试一试</a></p>
...
<table class="dataintable">
  ...
  <tr>
    <td><a href="../cssref/pr_font_font.asp" title="CSS font 属性">font</a></td>
    <td>简写属性。作用是把所有针对字体的属性设置在一个声明中。</td>
  </tr>
  <tr>
    <td><a href="../cssref/pr_font_font-family.asp" title="CSS font-family 属性">font-family</a></td>
    <td>设置字体系列。</td>
  </tr>
  <tr>
    <td><a href="../cssref/pr_font_font-size.asp" title="CSS font-size 属性">font-size</a></td>
    <td>设置字体的尺寸。</td>
  </tr>
  <tr>
    <td><a href="../cssref/pr_font_font-size-adjust.asp" title="CSS font-size-adjust 属性">font-size-adjust</a></td>
    <td>当首选字体不可用时，对替换字体进行智能缩放。（CSS2.1 已删除该属性。）</td>
  </tr>
  <tr>
    <td><a href="../cssref/pr_font_font-stretch.asp" title="CSS font-stretch 属性">font-stretch</a></td>
    <td>对字体进行水平拉伸。（CSS2.1 已删除该属性。）</td>
  </tr>
  <tr>
    <td><a href="../cssref/pr_font_font-style.asp" title="CSS font-style 属性">font-style</a></td>
    <td>设置字体风格。</td>
  </tr>
  <tr>
    <td><a href="../cssref/pr_font_font-variant.asp" title="CSS font-variant 属性">font-variant</a></td>
    <td>以小型大写字体或者正常字体显示文本。</td>
  </tr>
  <tr>
    <td><a href="../cssref/pr_font_weight.asp" title="CSS font-weight 属性">font-weight</a></td>
    <td>设置字体的粗细。</td>
  </tr>
</table>
</div>
