...
<li class="currentLink"><a href="/xsl/xsl_functions.asp" title="XSLT 函数参考手册">XSLT 函数</a></li>
</ul>
</div><div id="selected">
<h2>建站手册</h2>
<ul>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/xsl/xsl_w3celementref.asp" title="XSLT 元素参考手册">XSLT 元素</a></li>
<li class="next"><a href="/xsl/index.asp" title="XSLT 教程">XSLT 教程</a></li>
</ul>
</div>
...
<tr>
<td><a href="/xsl/func_current.asp" title="XSLT current() 函数">current()</a></td>
<td>返回当前节点作为唯一成员的节点集。</td>
</tr>

<tr>
<td><a href="/xsl/func_document.asp" title="XSLT document() 函数">document()</a></td>
<td>用于访问外部 XML 文档中的节点。</td>
</tr>

<tr>
<td><a href="/xsl/func_elementavailable.asp" title="XSLT element-available() 函数">element-available()</a></td>
<td>检测 XSLT 处理器是否支持指定的元素。</td>
</tr>

<tr>
<td><a href="/xsl/func_formatnumber.asp" title="XSLT format-number() 函数">format-number()</a></td>
<td>把数字转换为字符串。</td>
</tr>

<tr>
<td><a href="/xsl/func_functionavailable.asp" title="XSLT function-available() 函数">function-available()</a></td>
<td>检测 XSLT 处理器是否支持指定的函数。</td>
</tr>

<tr>
<td><a href="/xsl/func_generateid.asp" title="XSLT generate-id() 函数">generate-id()</a></td>
<td>返回唯一标识指定节点的字符串值。</td>
</tr>

<tr>
<td><a href="/xsl/func_key.asp" title="XSLT key() 函数">key()</a></td>
<td>检索以前使用 &lt;xsl:key&gt; 语句标记的元素。</td>
</tr>

<tr>
<td><a href="/xsl/func_nodeset.asp" title="XSLT node-set() 函数">node-set </a></td>
<td>将树转换为节点集。产生的节点集总是包含单个节点并且是树的根节点。</td>
</tr>

<tr>
<td><a href="/xsl/func_systemproperty.asp" title="XSLT system-property() 函数">system-property()</a></td>
<td>返回系统属性的值。</td>
</tr>

<tr>
<td><a href="/xsl/func_unparsedentityuri.asp" title="XSLT unparsed-entity-uri() 函数">unparsed-entity-uri()</a></td>
<td>返回未解析实体的 URI。</td>
</tr>
</table>
</div>
