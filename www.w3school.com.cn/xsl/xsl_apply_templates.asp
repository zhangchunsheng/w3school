...
<title>XSLT &lt;xsl:apply-templates&gt; 元素</title>
</head>
...
<li class="currentLink"><a href="/xsl/xsl_apply_templates.asp" title="XSLT &lt;xsl:apply-templates&gt; 元素">XSLT apply</a></li>
</ul>
<h2>XSLT 高级</h2>
<ul>
...
<h1>XSLT &lt;xsl:apply-templates&gt; 元素</h1>

<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/xsl/xsl_choose.asp" title="XSLT &lt;xsl:choose&gt; 元素">XSLT &lt;choose&gt;</a></li>
<li class="next"><a href="/xsl/xsl_client.asp" title="XSLT - 客户端">XSLT 在客户端</a></li>
</ul>
</div>

<div id="intro">
<p><strong>&lt;xsl:apply-templates&gt; 元素可把一个模板应用于当前的元素或者当前元素的子节点。</strong></p>
</div>

<div>
<h2>&lt;xsl:apply-templates&gt; 元素</h2>
<p>&lt;xsl:apply-templates&gt; 元素可把一个模板应用于当前的元素或者当前元素的子节点。</p>
<p>假如我们向 &lt;xsl:apply-templates&gt; 元素添加一个 select 属性，此元素就会仅仅处理与属性值匹配的子元素。我们可以使用 select 属性来规定子节点被处理的顺序。</p>
<p>请看下面的 XSL 样式表：</p>
...
<p><a href="/xsl/cdcatalog.xml">查看此XML文件</a>，<a href="/xsl/cdcatalog_apply.xsl">查看此XSL文件</a>，<a href="/xsl/cdcatalog_apply.xml">查看结果</a>。</p>
</div>
