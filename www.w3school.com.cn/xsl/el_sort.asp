...
<p>&lt;xsl:sort&gt; 元素用于对结果进行排序。</p>
<p class="note"><span>注释：</span>&lt;xsl:sort&gt; 总是位于 &lt;xsl:for-each&gt; 或 &lt;xsl:apply-templates&gt; 内部。</p>
</div>
...
<td>可选。规定节点的排序关键字，即根据哪个节点或节点集来排序。</td>
</tr>
...
<td>可选。规定被排序的数据的数据类型。默认是 &quot;text&quot;。</td>
</tr>
