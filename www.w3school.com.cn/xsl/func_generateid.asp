...
<title>XSLT generate-id() 函数</title>
</head>
...
<p>generate-id() 函数返回唯一标识指定节点的字符串值。</p>

<p>如果指定的节点集是空的，则返回空字符串。如果省略了 node-set 参数，则默认设置为当前节点。</p>
</div>

<div>
<h2>语法</h2>

<pre>string generate-id(node-set?)</pre>
...
&lt;li&gt;
&lt;a href=&quot;#{<code>generate-id(artist)</code>}&quot;&gt;
...
&lt;hr /&gt;
&lt;xsl:for-each select=&quot;catalog/cd&quot;&gt;
Artist: &lt;a name=&quot;{<code>generate-id(artist)</code>}&quot;&gt;
&lt;xsl:value-of select=&quot;artist&quot; /&gt;&lt;/a&gt;
&lt;br /&gt;
...
<p><a href="/xsl/cdcatalog.xml">查看 XSL 文件</a>，<a href="/xsl/cdcatalog_generateid.xsl">查看 XSL 文件</a>，<a href="/xsl/cdcatalog_generateid.xml">查看结果</a>。</p>
</div>
