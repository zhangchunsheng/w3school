...
<title>XSLT &lt;xsl:apply-imports&gt; 元素</title>
</head>
...
<h1>XSLT &lt;xsl:apply-imports&gt; 元素</h1>
...
<p>&lt;xsl:apply-imports&gt; 元素可应用来自导入样式表中的模版规则。</p>

<p>导入样式表中的模版规则的优先级要比主样式表中的模版规则要低。如果您希望使用导入样式表中的某条模版规则，而不是主样式表中的某条等价规则，就会用到 &lt;xsl:apply-imports&gt; 元素。</p>
</div>
...
<p>假设我们有一个名为 &quot;standard.xsl&quot; 的样式表，其中包含用于 message 元素的模版规则：</p>
...
<p>另一个样式表能够导入 &quot;standard.xsl&quot;，并修改 message，就像这样：</p>
