...
<h2>XSLT 高级</h2>
<ul>
<li class="currentLink"><a href="/xsl/xsl_client.asp" title="XSLT - 客户端">XSLT 在客户端</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/xsl/xsl_apply_templates.asp" title="XSLT &lt;xsl:apply-templates&gt; 元素">XSLT apply</a></li>
<li class="next"><a href="/xsl/xsl_server.asp" title="XSLT - 在服务器上">XSLT 在服务器端</a></li>
</ul>
</div>
...
<p><a href="/xsl/cdcatalog.xml">查看此 XML 文件</a>。</p>
<p>以及附随的 XSL 样式表：</p>
<pre>&lt;?xml version=&quot;1.0&quot; encoding=&quot;ISO-8859-1&quot;?&gt;
...
<p><a href="/xsl/cdcatalog.xsl">查看此 XSL 文件</a>。</p>
<p><strong>请注意，这个 XML 文件没有包含对 XSL 文件的引用。</strong></p>
<p class="important"><span>重要事项：</span>上面这句话意味着，XML 文件可使用多个不同的 XSL 样式表来进行转换。</p>
</div>
...
<p class="tip"><span>提示：</span>假如您不了解如何编写 JavaScript，请学习我们的《<a href="/js/index.asp" title="JavaScript教程">JavaScript 教程</a>》。</p>
...
<p><a href="/tiy/t.asp?f=xmle_cdcatalog">请看它在 IE 中如何工作</a>。</p>
</div>
