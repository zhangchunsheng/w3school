...
<title>XSLT &lt;xsl:decimal-format&gt; 元素</title>
</head>
...
<h1>XSLT &lt;xsl:decimal-format&gt; 元素</h1>
...
<p>&lt;xsl:decimal-format&gt; 元素定义了当通过 format-number() 函数把数字转换为字符串时，所要使用的字符和符号。</p>

<p>不是所有国家都使用相同的字符来分隔小数与整数的部分，或者对数字进行分组。通过 &lt;xsl:decimal-format&gt; 元素，您可以把具体到字符更改为其他的符号。</p>
<p>该元素是顶层的元素（top level）。</p>
<p>format-number() 函数可通过名称（name）来引用 &lt;xsl:decimal-format&gt; 元素。</p>
</div>
...
<td>char</td>
<td>可选。规定小数点字符。默认是 &quot;.&quot;。</td>
</tr>

<tr>
<td class="no_wrap">grouping-separator</td>
<td>char</td>
<td>可选。规定千的分隔字符。默认是 &quot;,&quot;。</td>
</tr>

<tr>
<td>infinity</td>
<td>string</td>
<td>可选。规定用来表示无穷大的字符串。默认是 &quot;Infinity&quot;。</td>
</tr>

<tr>
<td>minus-sign</td>
<td>char</td>
<td>可选。规定表示负数的字符。默认是 &quot;-&quot;。</td>
</tr>

<tr>
<td>NaN</td>
<td>string</td>
<td>可选。规定当值不是数字时使用的字符串。默认是 &quot;NaN&quot;。</td>
</tr>

<tr>
<td>percent</td>
<td>char</td>
<td>可选。规定百分比符号的字符。默认是 &quot;%&quot;。</td>
</tr>

<tr>
<td>per-mille</td>
<td>char</td>
<td>可选。规定千分号的字符。默认是 &quot;‰&quot;。</td>
</tr>

<tr>
<td>zero-digit</td>
<td>char</td>
<td>可选。规定数字 0 的字符。默认是 &quot;0&quot;。</td>
</tr>

<tr>
<td>digit</td>
<td>char</td>
<td>可选。规定字符，该字符用于指示需要使用数字的地方。默认是 #。</td>
</tr>

<tr>
<td>pattern-separator</td>
<td>char.</td>
<td>可选。规定字符，该字符用于分隔格式模式中的正负次模式。默认是 &quot;;&quot;。</td>
</tr>
</table>
</div>
...
<h3>例子 1</h3>
<p>下面的例子展示了，如何格式化为欧洲货币（请注意，format-number() 函数中的第三个参数引用了 &lt;xsl:decimal-format&gt; 元素的名称）：</p>

<pre>&lt;?xml version=&quot;1.0&quot; encoding=&quot;ISO-8859-1&quot;?&gt;
&lt;xsl:stylesheet version=&quot;1.0&quot;
xmlns:xsl=&quot;http://www.w3.org/1999/XSL/Transform&quot;&gt;

<code>&lt;xsl:decimal-format name=&quot;euro&quot; decimal-separator=&quot;,&quot; grouping-separator=&quot;.&quot;/&gt;</code>
 
&lt;xsl:template match=&quot;/&quot;&gt;
&lt;xsl:value-of select=&quot;<code>format-number(26825.8, '#.###,00', 'euro')</code>&quot;/&gt;
&lt;/xsl:template&gt;
