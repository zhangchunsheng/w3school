...
<p>&lt;xsl:text&gt; 元素用于向输出写文本，即通过样式表生成文本节点。</p>
<p class="tip"><span>提示：</span>该元素可包含文本、实体引用，以及 #PCDATA。</p>
</div>
...
<td>可选。
默认值为 &quot;no&quot;。如果值为 &quot;yes&quot;，通过实例化 &lt;xsl:text&gt; 元素生成的文本节点在输出时将不进行任何转义。
比如如果设置为 &quot;yes&quot;，则 &quot;&lt;&quot; 将不进行转换。如果设置为 &quot;no&quot;，则被输出为 &quot;&amp;lt;&quot;。
Netscape 6 不支持该属性。</td>
</td>
</tr>
</table>
</div>
...
<p>显示每个 CD 的 title。如果不是最后一个或倒数第二个 CD，则在每个 cd-title 之间插入 &quot;, &quot;。如果是最后的 CD，则在 title 后添加 &quot;!&quot;。如果是倒数第二个 CD，则在 title 后添加 &quot;, and &quot;：</p>
