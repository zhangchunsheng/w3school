...
<title>XSLT &lt;xsl:for-each&gt; 元素</title>
</head>
...
<li class="currentLink"><a href="/xsl/xsl_for_each.asp" title="XSLT &lt;xsl:for-each&gt; 元素">XSLT &lt;for-each&gt;</a></li>
...
<h1>XSLT &lt;xsl:for-each&gt; 元素</h1>

<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/xsl/xsl_value_of.asp" title="XSLT &lt;xsl:value-of&gt; 元素">XSLT &lt;value-of&gt;</a></li>
<li class="next"><a href="/xsl/xsl_sort.asp" title="XSLT &lt;xsl:sort&gt; 元素">XSLT &lt;xsl:sort&gt;</a></li>
</ul>
</div>

<div id="intro">
<p><strong>&lt;xsl:for-each&gt; 元素允许您在 XSLT 中进行循环。</strong></p>
</div>

<div>
<h2>&lt;xsl:for-each&gt; 元素</h2>
<p>&lt;xsl:for-each&gt; 元素可用于选取指定的节点集中的每个 XML 元素。</p>
  ...
  &lt;body&gt;
    ...
    &lt;table border=&quot;1&quot;&gt;
      &lt;tr bgcolor=&quot;#9acd32&quot;&gt;
        ...
        &lt;th&gt;Artist&lt;/th&gt;
      &lt;/tr&gt;
      <code>&lt;xsl:for-each select=&quot;catalog/cd&quot;&gt;</code>
      &lt;tr&gt;
...
<h3>上面的转换结果类似这样：</h3>
<img class="illustration" src="i/xsl_for_each_01.gif" />
<p><a href="/xsl/cdcatalog.xml">查看此 XML 文件</a>，<a href="/xsl/cdcatalog_ex3.xsl">查看此 XSL 文件</a>，并<a href="/xsl/cdcatalog_with_ex3.xml">查看结果</a>。</p>
</div>

<div>
<h2>结果过滤</h2>
<p>通过在 &lt;xsl:for-each&gt; 元素中添加一个选择属性的判别式，我们也可以过滤从 XML 文件输出的结果。</p>
<pre>&lt;xsl:for-each select=&quot;catalog/cd<code>[artist='Bob Dylan']</code>&quot;&gt;</pre>
 ...
 &lt;html&gt;
  ...
  &lt;table border=&quot;1&quot;&gt;
   &lt;tr bgcolor=&quot;#9acd32&quot;&gt;
      ...
      &lt;th&gt;Artist&lt;/th&gt;
   &lt;/tr&gt;
   <code>&lt;xsl:for-each select=&quot;catalog/cd[artist='Bob Dylan']&quot;&gt;</code>
   &lt;tr&gt;
      &lt;td&gt;&lt;xsl:value-of select=&quot;title&quot;/&gt;&lt;/td&gt;
      &lt;td&gt;&lt;xsl:value-of select=&quot;artist&quot;/&gt;&lt;/td&gt;
   &lt;/tr&gt;
...
<h3>上面的转换结果类似这样：</h3>
<img class="illustration" src="i/xsl_for_each_02.gif" />
<p><a href="/xsl/cdcatalog.xml">查看此 XML 文件</a>，<a href="/xsl/cdcatalog_filter.xsl">查看此 XSL 文件</a>，<a href="/xsl/cdcatalog_filter.xml">并查看结果</a>。</p>
</div>
