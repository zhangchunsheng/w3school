...
<title>XSLT &lt;xsl:attribute-set&gt; 元素</title>
</head>
...
<h1>XSLT &lt;xsl:attribute-set&gt; 元素</h1>
...
<p>&lt;xsl:attribute-set&gt; 元素可创建命名的属性集。该属性集（attribute-set）可作为整体应用到输出文档。</p>

<p class="note"><span>注释：</span>必须是 &lt;xsl:stylesheet&gt; 或 &lt;xsl:transform&gt; 的子节点。</p>
</div>
...
<td>name-list</td>
<td>可选。在该属性集中使用的其它属性集的列表，由空格分隔。</td>
</tr>
</table>
</div>
...
<h3>例子 1</h3>
<p>创建可应用到任何输出元素的属性集（attribute-set ）：</p>
