...
<p>&lt;xsl:param&gt; 元素用于声明局部或全局参数。</p>

<p class="note"><span>注释：</span>如果在模板内声明参数，就是局部参数，如果作为顶层元素来声明，就是全局参数。</p>
</div>
...
<td>select</td>
<td>expression</td>
<td>可选。规定 XPath 表达式，该表达式是参数的默认值。</td>
</tr>
</table>
</div>
...
&lt;xsl:template name=&quot;show_title&quot; match=&quot;/&quot;&gt;
  <code>&lt;xsl:param name=&quot;title&quot; /&gt;</code>
