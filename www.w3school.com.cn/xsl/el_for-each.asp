...
<p>&lt;xsl:for-each&gt; 元素可遍历指定的节点集中的每个节点。</p>
...
<h3>例子 1</h3>
<p>循环遍历每个 &quot;cd&quot; 元素，并使用 &lt;xsl:value-of&gt; 把每个 title 和 artist 写到输出中：</p>
...
<h3>例子 2</h3>
<p>循环遍历每个 &quot;cd&quot; 元素，并使用 &lt;xsl:value-of&gt; 把每个 title 和 artist 写到输出中（以 artist 排序）：</p>
...
<p><a href="/xsl/cdcatalog.xml">查看 XML 文件</a>，<a href="/xsl/cdcatalog_sort.xsl">查看 XSL 文件</a>，<a href="/xsl/cdcatalog_sort.xml">查看结果</a>。</p>
</div>
