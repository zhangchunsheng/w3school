...
<title>XSLT &lt;xsl:message&gt; 元素</title>
</head>
...
<p>&lt;xsl:message&gt; 元素可向输出写一条消息。该元素主要用于报告错误。</p>

<p>该元素能够包含几乎任何其他的 XSL 元素（&lt;xsl:text&gt; 、&lt;xsl:value-of&gt; 等等）。</p>
<p>terminate 属性允许您选择在错误发生时，是否应终止转换。</p>
</div>
...
<td>可选。&quot;yes&quot;：在消息写入输出后，终止处理。&quot;no&quot;：在消息写入输出后，继续进行处理。默认是 &quot;no&quot;。</td>
</tr>
</table>
</div>
...
<p>检测 artist 是否是空字符串。如果是，则退出 XSL 处理器，并显示一条消息：</p>
