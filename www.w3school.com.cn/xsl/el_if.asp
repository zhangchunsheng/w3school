...
<p>&lt;xsl:if&gt; 包含了一个模板，只有指定的条件成立时，才应用此模板。</p>

<p>提示：请使用 &lt;xsl:choose&gt; 与 &lt;xsl:when&gt; 和 &lt;xsl:otherwise&gt; 结合，来表达多重条件测试！</p>
</div>
...
<h3>例子 1</h3>
<p>当 CD 的价格高于 10 时，选取 title 和 artist 的值：</p>
...
<p><a href="/xsl/cdcatalog.xml">查看 XML 文件</a>，<a href="/xsl/cdcatalog_if.xsl">查看 XSL 文件</a>，<a href="/xsl/cdcatalog_if.xml">查看结果</a>。</p>

<h3>例子 2</h3>
<p>显示每个 CD 的标题。如果不是最后一个或倒数第二个 CD，则在每个 CD-title 间插入 &quot;, &quot;。如果是最后一个 CD，则在标题后添加 &quot;!&quot;。如果是倒数第二个 CD，则在其后添加 &quot;, and &quot;：</p>
