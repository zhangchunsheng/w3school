...
<title>XSLT &lt;xsl:element&gt; 元素</title>
</head>
...
<p>&lt;xsl:element&gt; 元素用于在输出文档中创建元素节点。</p>
...
<td>name</td>
<td>name</td>
<td>必需。规定要创建的元素的名称（可以使用表达式为 name 属性赋值，这个表达式是在运行时进行计算的，比如：&lt;xsl:element name=&quot;{$country}&quot; /&gt;）</td>
</tr>

<tr>
<td>namespace</td>
<td>URI</td>
<td>可选。规定元素的命名空间 URI。（可以使用表达式为 namespace 属性赋值，这个表达式是在运行时进行计算的，比如：&lt;xsl:element name=&quot;{$country}&quot; namespace=&quot;{$someuri}&quot;/&gt;）</td>
</tr>

<tr>
<td class="no_wrap">use-attribute-sets</td>
<td>namelist</td>
<td>可选。空格分隔的属性集，该属性集包含了需要向元素添加的属性。</td>
</tr>
</table>
</div>
...
<h3>例子 1</h3>
<p>创建一个名为 &quot;singer&quot; 的元素，该元素包含每个 artist 元素的值：</p>
...
<p><a href="/xsl/cdcatalog.xml">查看 XML 文件</a>，<a href="/xsl/cdcatalog_element.xsl">查看 XSL 文件</a>，<a href="/xsl/cdcatalog_element.xml">查看结果</a>。</p>
</div>
