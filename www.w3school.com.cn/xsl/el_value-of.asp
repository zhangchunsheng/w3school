...
<p>&lt;xsl:value-of&gt; 元素可提取选定节点的值。</p>
<p>&lt;xsl:value-of&gt; 元素可用于选取某个 XML 元素的值，并把它输出。</p>
<p class="note"><span>注释：</span>select 属性（必选）的值是一个 XPath 表达式。它的工作原理类似对文件系统的定位，比如用一个斜杠来选择子目录。</p>
</div>
...
<td>select</td>
<td>expression</td>
<td>必需。XPath 表达式，规定了从哪个节点/属性来提取值。</td>
</tr>

<tr>
<td class="no_wrap">disable-output-escaping</td>
<td>
<ul>
<li>yes</li>
<li>no</li>
...
<td>默认值为 &quot;no&quot;。如果值为 &quot;yes&quot;，通过实例化 &lt;xsl:text&gt; 元素生成的文本节点在输出时将不进行任何转义。
比如如果设置为 &quot;yes&quot;，则 &quot;&lt;&quot; 将不进行转换。如果设置为 &quot;no&quot;，则被输出为 &quot;&amp;lt;&quot;。</td>
</tr>
</table>
</div>
...
<p><a href="/xsl/cdcatalog.xml">查看 XML 文件</a>，<a href="/xsl/cdcatalog_ex2.xsl">查看 XSL 文件</a>，<a href="/xsl/cdcatalog_with_ex2.xml">查看结果</a>。</p>
...
<p><a href="/xsl/cdcatalog.xml">查看 XML 文件</a>，<a href="/xsl/cdcatalog_ex3.xsl">查看 XSL 文件</a>，<a href="/xsl/cdcatalog_with_ex3.xml">查看结果</a>。</p>
</div>
