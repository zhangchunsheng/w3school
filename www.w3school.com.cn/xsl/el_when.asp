...
<p>&lt;xsl:when&gt; 元素用于为 &lt;xsl:choose&gt; 元素规定相关动作。</p>
<p>&lt;xsl:when&gt; 元素会计算一个表达式，如果返回 true，则执行规定的动作。</p>
<p class="note"><span>注释：</span>&lt;xsl:when&gt; 元素提供多个与 &lt;xsl:choose&gt; 元素和 &lt;xsl:otherwise&gt; 元素有关的条件测试。</p>
</div>

<div>
<h2>语法</h2>

<pre>&lt;xsl:when test=&quot;boolean-expression&quot;&gt;
...
<h3>例子 1</h3>
<p>下面的代码会在 cd 的 price 高于 10 时向 artist 列添加粉色的背景色：</p>
    ...
    &lt;table border=&quot;1&quot;&gt;
      ...
      &lt;tr&gt;
        &lt;td&gt;&lt;xsl:value-of select=&quot;title&quot;/&gt;&lt;/td&gt;
      	&lt;xsl:choose&gt;
          <code>&lt;xsl:when test=&quot;price&amp;gt;'10'&quot;&gt;</code>
            &lt;td bgcolor=&quot;#ff00ff&quot;&gt;
...
<p><a href="/xsl/cdcatalog.xml">查看 XML 文件</a>，<a href="/xsl/cdcatalog_choose.xsl">查看 XSL 文件</a>，<a href="/xsl/cdcatalog_choose.xml">查看结果</a>。</p>

<h3>例子 2</h3>
<p>声明了一个名为 &quot;color&quot; 的变量。把它的值赋给当前元素的 color 属性。如果当前元素没有 color 属性，则 &quot;color&quot; 的值将是 &quot;green&quot;：</p>

<pre>&lt;xsl:variable name=&quot;color&quot;&gt;
  &lt;xsl:choose&gt;
    <code>&lt;xsl:when test=&quot;@color&quot;&gt;</code>
