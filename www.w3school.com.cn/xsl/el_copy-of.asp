...
<title>XSLT &lt;xsl:copy-of&gt; 元素</title>
</head>
...
<p>&lt;xsl:copy-of&gt; 元素可创建当前节点的一个副本。</p>

<p class="note"><span>注释：</span>当前节点的 Namespace 节点、子节点以及属性都会被自动复制！</p>
<p class="tip"><span>提示：</span>该元素可用于把相同节点的多个副本插入到输出的不同位置。</p>
</div>
