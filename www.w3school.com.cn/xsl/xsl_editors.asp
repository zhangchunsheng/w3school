...
<li class="currentLink"><a href="/xsl/xsl_editors.asp" title="XSLT 编辑器">XSLT 编辑器</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/xsl/xsl_editxml.asp" title="XSLT - 编辑 XML">XSLT 编辑 XML</a></li>
<li class="next"><a href="/xsl/xsl_summary.asp" title="您已经学习了 XSLT，下一步呢？">XSLT 教程总结</a></li>
</ul>
</div>
...
<p>但是，如果您使用记事本对 XML 进行编辑，可能很快会发现不少问题。</p>
...
<li>为开始标签自动添加结束标签</li>
<li>强制您编写合法的 XML</li>
<li>根据 DTD 来验证 XML</li>
<li>根据 Schema 来验证 XML</li>
<li>对您的 XML 语法进行代码的颜色化显示</li>
</ul>
</div>
