...
<title>XSLT &lt;xsl:processing-instruction&gt; 元素</title>
</head>
...
<h1>XSLT &lt;xsl:processing-instruction&gt; 元素</h1>
...
<p>&lt;xsl:processing-instruction&gt; 元素可向输出写一条处理指令，即生成处理指令节点。</p>
</div>
