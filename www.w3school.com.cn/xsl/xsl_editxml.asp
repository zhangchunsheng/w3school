...
<li class="currentLink"><a href="/xsl/xsl_editxml.asp" title="XSLT - 编辑 XML">XSLT 编辑 XML</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/xsl/xsl_server.asp" title="XSLT - 在服务器上">XSLT 在服务器端</a></li>
<li class="next"><a href="/xsl/xsl_editors.asp" title="XSLT 编辑器">XSLT 编辑器</a></li>
</ul>
</div>
...
<p><a href="/xsl/tool.xml">查看 XML 文件</a>。</p>
...
<p><a href="/xsl/tool.xsl">查看 XSL 文件</a>。</p>
...
<p><a href="/xsl/tool_updated.xsl">查看 XSL 文件</a>。</p>
</div>
...
<p class="tip"><span>提示：</span>假如您不了解如何编写 ASP，请学习我们的《<a href="/asp/index.asp">ASP 教程</a>》。</p>
