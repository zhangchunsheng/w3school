...
<p>&lt;xsl:key&gt; 元素是顶层元素，它可声明一个命名的键（即为 XML 文档中指定的元素分配的名称和值对）。</p>

<p>此键通过 key() 函数在样式表中使用，帮助您有效地在复杂的 XML 文档中访问分配的元素。。</p>
<p class="note"><span>注释：</span>键不必是唯一的！</p>
</div>
...
<td>match</td>
<td>pattern</td>
<td>必需。定义该键被应用到哪个节点。</td>
</tr>

<tr>
<td>use
<td>expression</td>
<td><p>必需。指定要作为该键的值使用的表达式。</p>
<p>键值可以是下列任一值：属性、子元素或匹配元素的内容。</p></td>
</tr>
</table>
</div>
...
<p>假设您拥有名为 &quot;persons.xml&quot; 的 XML 文件：</p>
...
<p>您可以在 XSL 文件中定义一个键，就像这样：</p>

<pre>&lt;xsl:key name=&quot;preg&quot; match=&quot;person&quot; use=&quot;@id&quot;/&gt;</pre>

<p>如需找到 id=&quot;050676&quot; 的 person，请使用这些代码（在 XSL 文件中）：</p>
...
&lt;xsl:template match=&quot;/&quot;&gt;
  &lt;html&gt;
  &lt;body&gt;
  &lt;xsl:for-each select=&quot;<code>key('preg','050676')</code>&quot;&gt;
    &lt;p&gt;
