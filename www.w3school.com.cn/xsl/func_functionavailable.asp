...
<title>XSLT function-available() 函数</title>
</head>
...
<h1>XSLT function-available() 函数</h1>
...
<p>function-available() 函数返回一个布尔值，该值指示 XSLT 处理器是否支持指定的函数。</p>

<p>你可以测试 XSLT 函数和被继承的 XPath 函数。</p>
</div>

<div>
<h2>语法</h2>

<pre>boolean function-available(string)</pre>
...
<p><a href="/xsl/functionavailable.xsl">查看 XSL 文件</a>，<a href="/xsl/functionavailable.xml">查看结果</a>。</p>
</div>
