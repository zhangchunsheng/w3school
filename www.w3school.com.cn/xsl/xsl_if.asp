...
<li class="currentLink"><a href="/xsl/xsl_if.asp" title="XSLT &lt;xsl:if&gt; 元素">XSLT &lt;if&gt;</a></li>
...
<h1>XSLT &lt;xsl:if&gt; 元素</h1>

<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/xsl/xsl_sort.asp" title="XSLT &lt;xsl:sort&gt; 元素">XSLT &lt;xsl:sort&gt;</a></li>
<li class="next"><a href="/xsl/xsl_choose.asp" title="XSLT &lt;xsl:choose&gt; 元素">XSLT &lt;choose&gt;</a></li>
</ul>
</div>

<div id="intro">
<p><strong>&lt;xsl:if&gt; 元素用于放置针对 XML 文件内容的条件测试。</strong></p>
</div>

<div>
<h2>&lt;xsl:if&gt; 元素</h2>

<p>如需放置针对 XML 文件内容的条件测试，请向 XSL 文档添加 &lt;xsl:if&gt; 元素。</p>

<h3>语法</h3>
<pre>&lt;xsl:if test=&quot;<i>expression</i>&quot;&gt;
  ...
  ...如果条件成立则输出...
  ...
&lt;/xsl:if&gt;</pre>
...
<div>
<h2>在何处放置 &lt;xsl:if&gt; 元素</h2>

<p>如需添加有条件的测试，请在 XSL 文件中的 &lt;xsl:for-each&gt; 元素内部添加 &lt;xsl:if&gt; 元素：</p>
...
&lt;xsl:template match=&quot;/&quot;&gt;
  ...
  &lt;body&gt;
    ...
    &lt;table border=&quot;1&quot;&gt;
      ...
      <code>&lt;xsl:if test=&quot;price &amp;gt; 10&quot;&gt;</code>
        &lt;tr&gt;
...
<p class="note"><span>注释：</span>必选的 <em>test</em> 属性的值包含了需要求值的表达式。</p>
<p>上面的代码仅仅会输出价格高于 10 的 CD 的 title 和 artist 元素。</p>

<h3>上面的转换结果类似这样：</h3>
<img class="illustration" src="i/xsl_if_01.gif" />
<p><a href="/xsl/cdcatalog.xml">查看此 XML 文件</a>，<a href="/xsl/cdcatalog_if.xsl">查看此 XSL 文件</a>，<a href="/xsl/cdcatalog_if.xml">查看结果</a>。</p>
</div>
