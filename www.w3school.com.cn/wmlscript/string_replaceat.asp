...
<title>WMLScript replaceAt() 函数</title>
</head>
...
<div>
<p>replaceAt() 函数把字符串划分为元素，并替换一个指定的元素。</p>

<h3>语法</h3>
<pre>n = String.replaceAt(string, substring, index, separator)</pre>
...
<table class="dataintable">
  ...
  <tr>
    <td>substring</td>
    <td>替换在字符串中指定元素的字符串。 </td>
  </tr>
  <tr>
    <td>index</td>
    <td>一个整数，规定在何处替换子字符串。</td>
  </tr>
  <tr>
    <td>separator</td>
    <td>分隔符。</td>
...
<h3>例子</h3>
<pre>var a = String.replaceAt(&quot;Visit W3School!&quot;,&quot;I love&quot;,0,&quot; &quot;);
var b = String.replaceAt(&quot;Visit W3School!&quot;,&quot;us!&quot;,2,&quot; &quot;);</pre>

<h3>结果</h3>
<pre>a = &quot;I love W3School!&quot;
b = &quot;Visit us!&quot;</pre>
</div>
