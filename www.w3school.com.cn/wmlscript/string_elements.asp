...
<title>WMLScript elements() 函数</title>
</head>
...
<div>
<p>elements() 函数返回指定的值在字符串中出现的次数。</p>

<h3>语法</h3>
<pre>n = String.elements(string, separator)</pre>
...
<table class="dataintable">
  ...
  <tr>
    <td>n</td>
    <td>在 separator 中规定的字符串在字符串 string 中出现的次数。 </td>
  </tr>
  <tr>
    <td>string</td>
    <td>被检索的字符串。</td>
...
<h3>例子</h3>
<pre>var a = String.elements(&quot;Visit W3School!&quot;,&quot;i&quot;);
var b = String.elements(&quot;Visit W3School!&quot;,&quot;V&quot;);
var c = String.elements(&quot;Visit W3School!&quot;,&quot; &quot;);</pre>
