...
<title>WMLScript minFloat() 函数</title>
</head>
...
<div>
<p>minFloat() 函数返回最小的可能的浮点数。</p>

<h3>语法</h3>
<pre>n = Float.minFloat()</pre>
...
<table class="dataintable">
  ...
  <tr>
    <td>n</td>
    <td>该函数返回的最小的可能的浮点数 (1.17549435-38)。</td>
  </tr>
</table>

<h3>例子</h3>
<pre>var a = Float.minFloat();</pre>

<h3>结果</h3>
<pre>a = 1.17549435-38</pre>
</div>
