...
<title>WMLScript maxFloat() 函数</title>
</head>
...
<h1>WMLScript maxFloat() 函数</h1>

<div class="backtoreference">
<p><a href="/wmlscript/wmlscript_lib_float.asp" title="WMLScript Float 库">返回 WMLScript Float 库参考手册</a></p>
</div>

<div>
<p>maxFloat() 函数返回最大的可能的浮点数。</p>

<h3>语法</h3>
<pre>n = Float.maxFloat()</pre>
...
<table class="dataintable">
  ...
  <tr>
    <td>n</td>
    <td>该函数返回的最大的可能的浮点数(3.40282347E+38)。</td>
  </tr>
</table>

<h3>例子</h3>
<pre>var a = Float.maxFloat();</pre>

<h3>结果</h3>
<pre>a = 3.40282347E+38</pre>
</div>
