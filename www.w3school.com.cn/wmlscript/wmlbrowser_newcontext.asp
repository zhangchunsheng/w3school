...
<title>WMLScript newContext() 函数</title>
</head>
...
<div>
<p>newContext() 函数清空 WML 环境中的所有变量，并返回一个空字符串。</p>

<h3>语法</h3>
<pre>n = WMLBrowser.go(url)</pre>
...
<h3>例子</h3>
<pre>var a = WMLBrowser.newContext();</pre>
