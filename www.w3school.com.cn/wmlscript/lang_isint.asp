...
<title>WMLScript isInt() 函数</title>
</head>
...
<div>
<p>isInt() 函数返回一个布尔值，指示是否能够通过 parseInt() 函数把一个值转换为整数。如果可以，则返回 true，否则返回 false。</p>

<h3>语法</h3>
<pre>n = Lang.isInt(value)</pre>
...
<h3>例子</h3>
<pre>var a = Lang.isInt(&quot;576&quot;);
var b = Lang.isInt(&quot;-576&quot;);
var c = Lang.isInt(&quot;6.5&quot;);
var d = Lang.isInt(&quot;@13&quot;);
var e = Lang.isInt(&quot;hello&quot;);</pre>
