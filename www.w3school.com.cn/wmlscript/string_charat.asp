...
<title>WMLScript charAt() 函数</title>
</head>
...
<div>
<p>charAt() 函数返回位于指定位置的字符。</p>

<h3>语法</h3>
<pre>n = String.charAt(string, index)</pre>
...
<table class="dataintable">
  ...
  <tr>
    <td>index</td>
    <td>规定在字符串中的下标位置的一个数。</td>
  </tr>
</table>

<h3>例子</h3>
<pre>var a = String.charAt(&quot;world&quot;,2);
var b = String.charAt(&quot;world&quot;,0);
var c = String.charAt(&quot;world&quot;,10);</pre>
