...
<title>WMLScript abort() 函数</title>
</head>
...
<h1>WMLScript abort() 函数</h1>

<div class="backtoreference">
<p><a href="/wmlscript/wmlscript_lib_lang.asp" title="WMLScript Lang 库">返回 WMLScript Lang 库参考手册</a></p>
</div>

<div>
<p>abort() 函数中止 WMLScript，并向该脚本的调用者返回一条消息。</p>

<h3>语法</h3>
<pre>Lang.abort(text)</pre>
...
<h3>例子</h3>
<pre>var errtxt = &quot;Illegal value&quot;;
Lang.abort(&quot;Error in function: &quot; + errtxt);</pre>

<h3>结果</h3>
<pre>The script is aborted, and the string &quot;Error in function: Illegal value&quot; 
is returned to the caller of the script.</pre>
</div>
