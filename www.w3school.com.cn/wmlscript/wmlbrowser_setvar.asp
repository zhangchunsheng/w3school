...
<title>WMLScript setVar() 函数</title>
</head>
...
<div>
<p>setVar() 函数设置浏览器环境中指定变量的值。</p>

<h3>语法</h3>
<pre>n = WMLBrowser.setVar(variable, value)</pre>
...
<h3>例子</h3>
<pre>var a = WMLBrowser.setVar(&quot;weeks&quot;, 34);</pre>
