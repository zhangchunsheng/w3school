...
<title>WMLScript round() 函数</title>
</head>
...
<div>
<p>round() 函数把一个数字舍入为最接近的整数。</p>

<h3>语法</h3>
<pre>n = Float.round(x)</pre>
...
<h3>例子</h3>
<pre>var a = Float.round(3.5);
var b = Float.round(3.4);</pre>
