...
<title>WMLScript random() 函数</title>
</head>
...
<div>
<p>random() 函数返回介于 0 和 x 之间的随机整数。</p>

<h3>语法</h3>
<pre>n = Lang.random(x)</pre>
...
<h3>例子</h3>
<pre>var a = Lang.random(6.5);</pre>

<h3>结果</h3>
<pre>a = 介于 0 与 6 之间的随机整数</pre>
</div>
