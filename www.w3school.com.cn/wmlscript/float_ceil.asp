...
<div>
<p>ceil() 函数返回不小于 x 参数值的最接近的整数。</p>

<h3>语法</h3>
<pre>n = Float.ceil(x)</pre>
...
<h3>例子</h3>
<pre>var a = Float.ceil(5.32);
var b = Float.ceil(5.55);
var c = Float.ceil(-5.32);</pre>
