...
<title>WMLScript subString() 函数</title>
</head>
...
<div>
<p>subString() 函数返回字符串的指定部分。</p>

<h3>语法</h3>
<pre>n = String.subString(string, start, length)</pre>
