...
<title>WMLScript format() 函数</title>
</head>
...
<h3>语法</h3>
<pre>n = String.format(format, value)</pre>
...
<p><strong>format 由三个部分组成：%width.precision type</strong></p>

<p>width - 可选。规定所输出字符的最小数目。</p>

<p>precision - 可选。设置输出值的精度。可采用下列值：</p>

<ul>
<li>d - 输出的最小位数。默认是 1。</li>
<li>f - 小数点后的位数。默认是 6。</li>
<li>s - 输出的最大字符数。默认输出所有字符。</li>
</ul>

<p>type - 必需。确定如何解释被格式化的值。可采用下列的值：</p>
...
<h3>例子</h3>
<pre>var b = String.format(&quot;%4.3d&quot;, 32);
var d = String.format(&quot;%3f&quot;, 10.1234);
var e = String.format(&quot;%2.2f&quot;, 2.3)</pre>
