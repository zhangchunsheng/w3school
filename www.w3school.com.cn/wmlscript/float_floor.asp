...
<title>WMLScript floor() 函数</title>
</head>
...
<div>
<p>floor() 函数返回不大于 x 参数值的最接近的整数。</p>

<h3>语法</h3>
<pre>n = Float.floor(x)</pre>
...
<h3>例子</h3>
<pre>var a = Float.floor(5.32);
var b = Float.floor(-5.32);</pre>
