...
<div>
<p>exit() 函数退出 WMLScript，并向该脚本的调用者返回一条消息。</p>

<h3>语法</h3>
<pre>Lang.exit(value)</pre>
...
<h3>例子</h3>
<pre>Lang.exit(&quot;Value is 500&quot;);</pre>

<h3>结果</h3>
<pre>脚本结束，值 &quot;Value is: 500&quot; 返回脚本的调用者。</pre>
</div>
