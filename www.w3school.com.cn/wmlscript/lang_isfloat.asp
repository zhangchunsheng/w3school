...
<title>WMLScript isFloat() 函数</title>
</head>
...
<div>
<p>isFloat() 函数返回一个布尔值，指示是否能够通过 parseFloat() 函数把一个值转换为浮点数。如果可以，则返回 true，否则返回 false。</p>

<h3>语法</h3>
<pre>n = Lang.isFloat(value)</pre>
