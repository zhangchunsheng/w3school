...
<title>WMLScript toString() 函数</title>
</head>
...
<div>
<p>toString() 函数把一个值转换为字符串。</p>

<h3>语法</h3>
<pre>n = String.toString(value)</pre>
...
<h3>例子</h3>
<pre>var a = String.toString(66);
var b = String.toString(world);</pre>
