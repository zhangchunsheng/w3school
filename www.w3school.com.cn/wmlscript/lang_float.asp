...
<title>WMLScript float() 函数</title>
</head>
...
<div>
<p>float() 函数返回一个布尔值，该值指示是否支持浮点数。</p>

<h3>语法</h3>
<pre>n = Lang.float()</pre>
...
<table class="dataintable">
  ...
  <tr>
    <td>n</td>
    <td>从函数返回的布尔值。指示是否支持浮点数。</td>
  </tr>
</table>

<h3>例子</h3>
<pre>var a = Lang.float();</pre>
