...
<title>WMLScript compare() 函数</title>
</head>
...
<div>
<p>compare() 函数比较两个字符串，并返回一个表示比较结果的值。</p>
<p>compare() 函数可返回下列值：</p>
<ul>
...
<h3>语法</h3>
<pre>n = String.compare(string1, string2)</pre>
...
<h3>例子</h3>
<pre>var a = String.compare(&quot;world&quot;,&quot;world&quot;);
var b = String.compare(&quot;I&quot;,&quot;world&quot;);
var c = String.compare(&quot;world&quot;,&quot;I&quot;);</pre>
