...
<title>WMLScript Dialogs 库</title>
</head>
...
<h2>WMLScript 库</h2>
<ul>
<li class="currentLink"><a href="/wmlscript/wmlscript_lib_dialogs.asp" title="WMLScript Dialogs 库">WML Dialogs</a></li>
...
<h1>WMLScript Dialogs 库</h1>

<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/wmlscript/wmlscript_howto.asp" title="WMLScript 调用">WMLScript 调用</a></li>
<li class="next"><a href="/wmlscript/wmlscript_lib_float.asp" title="WMLScript Float 库">WML Float</a></li>
</ul>
</div>


<div><strong>Dialogs 库中包含了显示警告信息的函数，该函数库包含典型的用户界面程序。</strong></div>

<div>
<h2>WMLScript Dialogs 库的函数</h2>
...
<table class="dataintable">
  ...
  <tr>
    <td><a href="dialog_alert.asp">alert()</a></td>
    <td>显示一条消息，并等待确认。</td>
  </tr>
  <tr>
    <td><a href="dialog_confirm.asp">confirm()</a></td>
    <td>显示一条消息，并等待回答。</td>
  </tr>
  <tr>
    <td><a href="dialog_prompt.asp">prompt()</a></td>
    <td>显示一个问题，并等待输入。</td>
  </tr>
</table>
</div>
