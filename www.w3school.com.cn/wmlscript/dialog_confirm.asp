...
<title>WMLScript confirm() 函数</title>
</head>
...
<h1>WMLScript confirm() 函数</h1>

<div class="backtoreference">
<p><a href="/wmlscript/wmlscript_lib_dialogs.asp" title="WMLScript Dialogs 库">返回 WMLScript Dialogs 库参考手册</a></p>
</div>

<div>
<p>confirm() 函数显示一条消息，等待回答 ，然后根据用户所选的回答返回一个布尔值。如果用户选择 ok，则返回 true，如果用户选择 cancel，则选择 false。</p>

<h3>语法</h3>
<pre>n = Dialogs.confirm(message, ok, cancel)</pre>
...
<table class="dataintable">
  ...
  <tr>
    <td>cancel</td>
    <td>包含 cancel 文本的字符串。</td>
  </tr>
</table>

<h3>例子</h3>
<pre>var a = Dialogs.confirm(&quot;Exit?&quot;,&quot;Yes&quot;,&quot;No&quot;);</pre>

<h3>结果</h3>
<pre>a = true (if &quot;Yes&quot; is selected)
a = false (if &quot;No&quot; is selected)</pre>
</div>
