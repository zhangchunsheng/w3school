...
<title>WMLScript refresh() 函数</title>
</head>
...
<div>
<p>refresh() 函数刷新当前卡片，如果刷新成功，则返回一个空字符串。如果失败，则返回一个非空字符串。</p>

<h3>语法</h3>
<pre>n = WMLBrowser.refresh()</pre>
...
<h3>例子</h3>
<pre>var a = WMLBrowser.setVar(&quot;day&quot;,11);
var b = WMLBrowser.refresh();</pre>
