...
<title>WMLScript parseFloat() 函数</title>
</head>
...
<div>
<p>parseFloat() 函数返回由一个字符串定义的浮点数。</p>
<p>解析会在第一个不能作为浮点值解析的字符上结束。</p>

<h3>语法</h3>
<pre>n = Lang.parseFloat(string)</pre>
