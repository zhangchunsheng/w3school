...
<title>WMLScript length() 函数</title>
</head>
...
<div>
<p>length() 函数返回字符串的长度。</p>

<h3>语法</h3>
<pre>n = String.length(string)</pre>
...
<h3>例子</h3>
<pre>var a = String.length(&quot;&quot;);
var b = String.length(&quot;Hello world&quot;);
var c = String.length(23.4);</pre>
