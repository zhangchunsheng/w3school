...
<title>WMLScript getCurrentCard() 函数</title>
</head>
...
<h1>WMLScript getCurrentCard() 函数</h1>

<div class="backtoreference">
<p><a href="/wmlscript/wmlscript_lib_wmlbrowser.asp" title="WMLScript WMLBrowser 库">返回 WMLScript WMLBrowser 库参考手册</a></p>
</div>

<div>
<p>getCurrentCard() 函数返回当前卡片的（相对）URL。</p>

<h3>语法</h3>
<pre>n = WMLBrowser.getCurrentCard()</pre>
...
<h3>例子</h3>
<pre>var a = WMLBrowser.getCurrentCard();</pre>

<h3>结果</h3>
<pre>a = &quot;card1#note&quot;</pre>
</div>
