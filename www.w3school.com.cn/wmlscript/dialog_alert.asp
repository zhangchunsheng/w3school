...
<title>WMLScript alert() 函数</title>
</head>
...
<div>
<p>alert() 函数显示一条消息，等待确认，然后返回一个空字符串。</p>

<h3>语法</h3>
<pre>n = Dialogs.alert(message)</pre>
...
<h3>例子</h3>
<pre>var a = Dialogs.alert(&quot;The value must be numeric!&quot;);</pre>
