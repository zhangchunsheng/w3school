...
<title>WMLScript isEmpty() 函数</title>
</head>
...
<div>
<p>isEmpty() 函数检查字符串是否是空的。</p>

<h3>语法</h3>
<pre>n = String.isEmpty(string)</pre>
...
<h3>例子</h3>
<pre>var a = String.isEmpty(&quot;&quot;);
var b = String.isEmpty(&quot;Hello world&quot;);
var c = String.isEmpty(23.4);</pre>
