...
<title>WMLScript WMLBrowser 库</title>
</head>
...
<li class="currentLink"><a href="/wmlscript/wmlscript_lib_wmlbrowser.asp" title="WMLScript WMLBrowser 库">WML Browser</a></li>
</ul>
</div><div id="selected">
<h2>建站手册</h2>
<ul>
...
<h1>WMLScript WMLBrowser 库</h1>

<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/wmlscript/wmlscript_lib_url.asp" title="WMLScript URL 库">WML URL</a></li>
<li class="next"><a href="/wmlscript/index.asp" title="WMLScript 教程">WMLScript 教程</a></li>
</ul>
</div>


<div id="intro">
<p><strong>WMLBrowser 函数库。</strong></p>
</div>

<div>
<h2>WMLScript WMLBrowser 库的函数</h2>
...
<table class="dataintable">
  ...
  <tr>
    <td><a href="wmlbrowser_getcurrentcard.asp">getCurrentCard()</a></td>
    <td>返回当前卡片的（相对）URL。</td>
  </tr>
  <tr>
    <td><a href="wmlbrowser_getvar.asp">getVar()</a></td>
    <td>返回变量的值。</td>
  </tr>
  <tr>
    <td><a href="wmlbrowser_go.asp">go()</a></td>
    <td>前往新的卡片。</td>
  </tr>
  <tr>
    <td><a href="wmlbrowser_newcontext.asp">newContext()</a></td>
    <td>清空所有变量。</td>
  </tr>
  <tr>
    <td><a href="wmlbrowser_prev.asp">prev()</a></td>
    <td>前往之前的卡片。</td>
  </tr>
  <tr>
    <td><a href="wmlbrowser_refresh.asp">refresh()</a></td>
    <td>刷新当前卡片。</td>
  </tr>
  <tr>
    <td><a href="wmlbrowser_setvar.asp">setvar()</a></td>
    <td>设置变量的值。</td>
  </tr>
</table>
