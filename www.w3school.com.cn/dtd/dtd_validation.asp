...
<li class="currentLink"><a href="/dtd/dtd_validation.asp" title="DTD - 验证">DTD 验证</a></li>
...
<div  id="tpn">
<ul class="prenext">
<li class="pre"><a href="/dtd/dtd_entities.asp" title="DTD - 实体">DTD 实体</a></li>
<li class="next"><a href="/dtd/dtd_examples.asp" title="DTD - 来自网络的实例">DTD 实例</a></li>
</ul>
</div>
