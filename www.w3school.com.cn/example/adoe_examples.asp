...
<h2>ADO 实例</h2>
<ul>
<li class="currentLink"><a href="/example/adoe_examples.asp" title="ADO 实例">ADO 实例</a></li>
</ul>
</div><div id="selected">
<h2>建站手册</h2>
<ul>
...
<div  id="tpn">
<ul class="prenext">
<li class="pre"><a href="/ado/ado_summary.asp" title="您已经学习了 ADO，下一步呢？">ADO 总结</a></li>
<li class="next"><a href="/ado/index.asp" title="ADO 教程">ADO 教程</a></li>
</ul>
</div>
...
<h2>显示</h2>
<dl>
<dt><a href="/tiy/s.asp?f=demo_adoe_display_1">显示记录</a></dt>
<dt><a href="/tiy/s.asp?f=demo_adoe_display_2">在 HTML 表格中显示记录</a></dt>
<dt><a href="/tiy/s.asp?f=demo_adoe_display_3">向 HTML 表添添加标题</a></dt>
<dt><a href="/tiy/s.asp?f=demo_adoe_display_4">向 HTML 表格添加颜色</a></dt>
</dl>
</div>
...
<h2>查询</h2>
<dl>
<dt><a href="/tiy/s.asp?f=demo_adoe_query_1">显示 "Companyname" 以 A 开头的记录</a></dt>
<dt><a href="/tiy/s.asp?f=demo_adoe_query_2">显示 "Companyname" 大于 E 的记录</a></dt>
<dt><a href="/tiy/s.asp?f=demo_adoe_query_3">仅显示中国的客户</a></dt>
<dt><a href="/tiy/s.asp?f=demo_adoe_query_4">让用户来选择过滤条件</a></dt>
</dl>
</div>
...
<h2>排序</h2>
<dl>
<dt><a href="/tiy/s.asp?f=demo_adoe_sort_1">根据指定的字段名称进行升序排序</a></dt>
<dt><a href="/tiy/s.asp?f=demo_adoe_sort_2">根据指定的字段名称进行降序排序</a></dt>
<dt><a href="/tiy/s.asp?f=demo_adoe_sort_3">让用户来选择根据那一列来进行排序</a></dt>
</dl>
</div>
...
<h2>Recordset 对象</h2>
<dl>
<dt><a href="/tiy/s.asp?f=demo_adoe_getrows">GetRows</a></dt>
<dt><a href="/tiy/s.asp?f=demo_adoe_display_5">GetString</a></dt>
</dl>
</div>
