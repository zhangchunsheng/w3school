...
<pre>
&lt;img src=&quot;img_logo.gif&quot; <code>alt=&quot;W3School.com.cn&quot;</code> /&gt;
</pre>

<p><a href="/tiy/t.asp?f=html5_img_alt">亲自试一试</a></p>
</div>
...
<p>必需的 alt 属性规定图像的替代文本，如果该图像无法显示。</p>

<p>当用户无法查看图像时（可能由于网速太慢、错误的 src 属性、或者用户使用的是屏幕阅读器），alt 属性为图像提供了替代的文本。</p>

<p class="note"><span>注释：</span>当鼠标在图像上悬停时，Internet Explorer （版本 9 之前) 会把 alt 属性的值显示为工具提示。根据 HTML 规范，这不是正确的做法。</p>

<p class="tip"><span>提示：</span>如需创建图像的工具提示，请使用 title 属性！</p>
</div>
...
<td>
  ...
  <li>如果图像中包含信息，则 alt 文本应该对图像进行描述</li>
  <li>如果图像位于 &lt;a&gt; 元素中，则 alt 文本应该解释链接指向哪里</li>
  <li>如果图像是纯装饰性的，请使用 alt=&quot;&quot;</li>
  </ul>
</td>
</tr>
</table>
