...
<title>HTML5 canvas shadowOffsetY 属性</title>
...
<h1>HTML 5 canvas shadowOffsetY 属性</h1>
...
<p>绘制一个矩形，带有向下偏移 20 像素的阴影（从矩形的 top 位置）：</p>
...
var ctx=c.getContext(&quot;2d&quot;);
ctx.shadowBlur=10;
<code>ctx.shadowOffsetY=20;</code>
ctx.shadowColor=&quot;black&quot;;
ctx.fillStyle=&quot;blue&quot;;
ctx.fillRect(20,20,100,80);
</pre>

<p><a href="/tiy/t.asp?f=html5_canvas_shadowoffsety">亲自试一试</a></p>
</div>
...
<p>Internet Explorer 9、Firefox、Opera、Chrome 以及 Safari 支持 shadowOffsetY 属性。</p>
...
<p>shadowOffsetY 属性设置或返回形状与阴影的垂直距离。</p>
...
<p class="tip"><span>提示：</span>如需调整距离形状的水平位置，请使用 <a href="/html5/canvas_shadowoffsetx.asp" title="HTML5 canvas shadowOffsetX 属性">shadowOffsetX</a> 属性。</p>
...
<tr>
<th>JavaScript 语法：</th>
<td>context.shadowOffsetY=<i>number</i>;</td>
</tr>
</table>
