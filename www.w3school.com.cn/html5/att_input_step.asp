...
<title>HTML 5 &lt;input&gt; step 属性</title>
</head>
...
&lt;form action=&quot;demo_form.asp&quot; method=&quot;get&quot;&gt;
  &lt;input type=&quot;number&quot; name=&quot;points&quot; <code>step=&quot;3&quot;</code> /&gt;
  &lt;input type=&quot;submit&quot; /&gt;
&lt;/form&gt;
</pre>

<p><a href="/tiy/t.asp?f=html5_input_step">亲自试一试</a></p>
</div>
...
<p>step 属性规定输入字段的合法数字间隔（假如 step=&quot;3&quot;，则合法数字应该是 -3、0、3、6，以此类推）。</p>

<p class="tip"><span>提示：</span>step 属性可以与 max 以及 min 属性配合使用，以创建合法值的范围。</p>

<p class="note"><span>注释：</span>step、max 以及 min 属性适用于以下 &lt;input&gt; 类型：number, range, date, datetime, datetime-local, month, time 以及 week。</p>
</div>
