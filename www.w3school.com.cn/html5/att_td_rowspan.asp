...
<title>HTML 5 &lt;td&gt; rowspan 属性</title>
</head>
...
<h1>HTML 5 &lt;td&gt; rowspan 属性</h1>


<div class="backtoreference">
<p><a href="/html5/tag_td.asp">HTML 5 &lt;td&gt; 标签</a></p>
</div>
...
<p><a href="/tiy/t.asp?f=html5_td_rowspan">亲自试一试</a></p>
</div>
...
<p>所有主流浏览器均支持 rowspan 属性。</p>

<p class="note"><span>注释：</span>只有 Opera 浏览器支持 rowspan=&quot;0&quot;，该值有特殊的含义（请看下面的属性值表格）。</p>
</div>
...
<td>
  <p>设置单元格应该横跨的行数。</p>
  <p>注释：rowspan=&quot;0&quot; 告知浏览器使单元格横跨到表格组件中的最后一个行（thead、tbody 或 tfoot）。</p>
</td>
</tr>
</table>
</div>
