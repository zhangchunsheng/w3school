...
<title>HTML 5 &lt;script&gt; charset 属性</title>
</head>
...
<h1>HTML 5 &lt;script&gt; charset 属性</h1>


<div class="backtoreference">
<p><a href="/html5/tag_script.asp">HTML 5 &lt;script&gt; 标签</a></p>
</div>
...
<p>设置了指定字符集的外部 JavaScript：</p>

<pre>
&lt;script type=&quot;text/javascript&quot; src=&quot;demo_time.js&quot; <code>charset=&quot;UTF-8&quot;</code>&gt;
&lt;/script&gt;
</pre>

<p><a href="/tiy/t.asp?f=html5_script_charset">亲自试一试</a></p>
</div>
...
<p>当外部脚本文件中的字符编码与主文件中的编码不同时，会用到 charset 属性。</p>

<p class="note"><span>注释：</span>charset 属性仅适用于外部脚本（当使用 src 属性时）。</p>
</div>
...
<pre>&lt;script charset=&quot;<i>character_set</i>&quot;&gt;</pre>
...
<table class="dataintable">
  ...
  <tr>
    ...
    <li>&quot;ISO-8859-1&quot; - 拉丁字母表的标准编码</li>
    <li>&quot;UTF-8&quot; - Unicode 字符编码。与 ASCII 兼容</li>
    </ul>
    <p>请参阅我们的<a href="/tags/html_ref_charactersets.asp" title="HTML 字符集">字符集参考手册</a>，获得完整的字符集列表。</p>
	</td>
  </tr>
</table>
</div>
