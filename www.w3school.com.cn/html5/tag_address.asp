...
<li class="currentLink"><a href="/html5/tag_address.asp" title="HTML5 &lt;address&gt; 标签">&lt;address&gt;</a></li>
...
<h1>HTML 5 &lt;address&gt; 标签</h1>

<div>
<h2>定义和用法</h2>

<p>&lt;address&gt; 标签定义文档作者或拥有者的联系信息。</p>

<p>如果 &lt;address&gt; 元素位于 &lt;article&gt; 元素内部，则它表示该文章作者或拥有者的联系信息。</p>

<p>通常的做法是将 address 元素添加到网页的头部或底部。</p>
</div>
...
<p><a href="/tiy/t.asp?f=html5_address">亲自试一试</a></p>
</div>


<div>
<h2>HTML 4.01 与 HTML 5 之间的差异</h2>
<p>HTML 4.01 不支持 &lt;article&gt; 标签，因此在 HTML 4.01 中 &lt;address&gt; 标签永远定义文档作者或拥有者的联系信息。</p>
</div>


<div>
<h2>提示和注释：</h2>
<p class="note"><span>注释：</span>不应该使用 &lt;address&gt; 标签来描述邮政地址，除非这些信息是联系信息的组成部分。</p>

<p class="note"><span>注释：</span>&lt;address&gt; 元素通常呈现为斜体。大多数浏览器会在该元素的前后添加换行。</p>
</div>


<div>
<h2>全局属性</h2>
<p>&lt;address&gt; 标签支持 <a href="html5_ref_globalattributes.asp">HTML 5 中的全局属性</a>。</p>
</div>


<div>
<h2>事件属性</h2>
<p>&lt;address&gt; 标签支持 <a href="html5_ref_eventattributes.asp">HTML 5 中的事件属性</a>。</p>
</div>
