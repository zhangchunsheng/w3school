...
<li class="currentLink"><a href="/html5/tag_i.asp" title="HTML5 &lt;i&gt; 标签">&lt;i&gt;</a></li>
...
<h2>定义和用法</h2>
<p>&lt;i&gt; 标签呈现斜体的文本。</p>
<p>&lt;i&gt; 标签定义与文本中其余部分不同的部分，并把这部分文本呈现为斜体文本。在没有其他元素可以使用时，比如 &lt;b&gt;, &lt;cite&gt;, &lt;dfn&gt;, &lt;em&gt;, &lt;q&gt;, &lt;small&gt;, &lt;strong&gt;，请使用 &lt;i&gt; 标签。</p>
</div>
...
<p>没有区别。</p>
<p>但是在 HTML 4.01 中，存在着一种理解，即应该使用 CSS 来制作斜体文本。在 HTML 5 中，情况没有改变，但是你应该使用 &lt;i&gt; 标签把部分文本定义为某种类型，而不只是利用它在布局中所呈现的样式。</p>
</div>
...
<div>
<h2>全局属性</h2>
<p>&lt;i&gt; 标签支持 <a href="html5_ref_globalattributes.asp">HTML 5 中的全局属性</a>。</p>
</div>
 
 
<div>
<h2>事件属性</h2>
<p>&lt;i&gt; 标签支持 <a href="html5_ref_eventattributes.asp">HTML 5 中的事件属性</a>。</p>
</div>
