...
<title>HTML 5 &lt;th&gt; headers 属性</title>
</head>
...
&lt;table&gt;
  ...
  &lt;/tr&gt;
  &lt;tr&gt;
    &lt;th <code>headers=&quot;name&quot;</code>&gt;Firsname&lt;/th&gt;
    &lt;th <code>headers=&quot;name&quot;</code>&gt;Lastname&lt;/th&gt;
  &lt;/tr&gt;
&lt;/table&gt;
</pre>

<p><a href="/tiy/t.asp?f=html5_th_headers">亲自试一试</a></p>
</div>
...
<p>headers 属性在普通的 web 浏览器中没有可见效果，但可被屏幕阅读器使用。</p>
</div>
...
<p>headers 属性规定与表头单元格相关联的一个或多个表头单元格。</p>
</div>
...
<pre>&lt;th headers=&quot;<i>header_id</i>&quot;&gt;</pre>
...
<tr>
<td><i>header_id</i></td>
<td>规定空格分隔的 id 列表，定义表头单元格关联的一个或多个表头单元格。</td>
</tr>
</table>
</div>
