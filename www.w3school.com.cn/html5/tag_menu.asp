...
<li class="currentLink"><a href="/html5/tag_menu.asp" title="HTML5 &lt;menu&gt; 标签">&lt;menu&gt;</a></li>
...
<h1>HTML 5 &lt;menu&gt; 标签</h1>


<div>
<h2>定义和用法</h2>
<p>&lt;menu&gt; 标签定义菜单列表。当希望列出表单控件时使用该标签。</p>
</div>


<div>
<h2>HTML 4.01 与 HTML 5 之间的差异</h2>
<p>在 HTML 4.01 中，不赞成使用 menu 元素。</p>
<p>在 HTML 5 中，重新定义了 menu 元素，且使用用于排列表单控件。</p>
</div>
...
<table class="dataintable">
  ...
  <tr>
    ...
    <td>true
	false</td>
    <td>如果为 true，那么当表单控件改变时会自动提交。</td>
    <td>&nbsp;</td>
    <td>5</td>
  </tr>
	<tr>
    <td>compact</td>
    <td>compact_rendering</td>
...
<div>
<h2>全局属性</h2>
<p>&lt;menu&gt; 标签支持 <a href="html5_ref_globalattributes.asp">HTML 5 中的全局属性</a>。</p>
</div>
 
 
<div>
<h2>事件属性</h2>
<p>&lt;menu&gt; 标签支持 <a href="html5_ref_eventattributes.asp">HTML 5 中的事件属性</a>。</p>
</div>
