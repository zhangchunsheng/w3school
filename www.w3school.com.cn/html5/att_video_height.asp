...
<title>HTML 5 &lt;video&gt; height 属性</title>
</head>
...
<h1>HTML 5 &lt;video&gt; height 属性</h1>


<div class="backtoreference">
<p><a href="/html5/tag_video.asp">HTML 5 &lt;video&gt; 标签</a></p>
</div>
...
<pre>
&lt;video <code>width=&quot;320&quot;</code> <code>height=&quot;240&quot;</code> controls=&quot;controls&quot;&gt;
...
<p><a href="/tiy/t.asp?f=html5_video_width_height">亲自试一试</a></p>
</div>
...
<p>height 属性指定视频播放器的高度。</p>

<p class="tip"><span>提示：</span>规定视频的高度和宽度是一个好习惯。如果设置这些属性，在页面加载时会为视频预留出空间。如果没有设置这些属性，那么浏览器就无法预先确定视频的尺寸，这样就无法为视频保留合适的空间。结果是，在页面加载的过程中，其布局也会产生变化。</p>

<p class="tip"><span>提示：</span>请勿通过 height 和 width 属性来缩放视频！通过 height 和 width 属性来缩小视频，只会迫使用户下载原始的视频（即使在页面上它看起来较小）。正确的方法是在网页上使用该视频前，使用软件对视频进行压缩。</p>
...
<p>height 属性是 HTML 5 中的新属性。</p>
</div>

<div>
<h2>语法</h2>

<pre>&lt;video height=&quot;<i>value</i>&quot; /&gt;</pre>
