...
<li class="currentLink"><a href="/html5/html_5_app_cache.asp" title="HTML 5 应用程序缓存">HTML5 应用缓存</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/html5/html_5_webstorage.asp" title="HTML5 Web 存储">HTML5 Web 存储</a></li>
<li class="next"><a href="/html5/html_5_webworkers.asp" title="HTML5 Web Workers">HTML5 Web Workers</a></li>
</ul>
</div>
...
<p><a href="/tiy/t.asp?f=html5_html_manifest">亲自试一试</a></p>
</div>
