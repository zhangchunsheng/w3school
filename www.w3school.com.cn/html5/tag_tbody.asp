...
<li class="currentLink"><a href="/html5/tag_tbody.asp" title="HTML5 &lt;tbody&gt; 标签">&lt;tbody&gt;</a></li>
...
<h1>HTML 5 &lt;tbody&gt; 标签</h1>


<div>
<h2>定义和用法</h2>
<p>定义一段表格主体（正文）。</p>
<p>使用 &lt;tbody&gt; 标签，可以将表格分为一个单独的部分。&lt;tbody&gt; 标签可将表格中的一行或几行合成一组。</p>
<p>虽然您可能想包括一个，甚至会在表格中包括两个或更多个 &lt;tbody&gt; 标签，但是我们建议最好在表格中没有 &lt;tbody&gt; 标签。</p>
<p>在 &lt;tbody&gt; 标签中，只有 &lt;tr&gt; 标签可以定义表格行。并且一旦定义，一个 &lt;tbody&gt; 标签就是表格中的一个独立的部分。例如不能从一个 &lt;tbody&gt; 跨越到另一个 &lt;tbody&gt; 中。</p>
...
<p>在 HTML 5 中，不支持 &lt;tbody&gt; 标签的任何属性。</p>
</div>
...
<div>
<h2>全局属性</h2>
<p>&lt;tbody&gt; 标签支持 <a href="html5_ref_globalattributes.asp">HTML 5 中的全局属性</a>。</p>
</div>
 
 
<div>
<h2>事件属性</h2>
<p>&lt;tbody&gt; 标签支持 <a href="html5_ref_eventattributes.asp">HTML 5 中的事件属性</a>。</p>
</div>
