...
<li class="currentLink"><a href="/html5/tag_s.asp" title="HTML5 &lt;s&gt; 标签">&lt;s&gt;</a></li>
...
<div>
<h2>定义和用法</h2>
<p>&lt;s&gt; 标签定义加删除线的文本。HTML 5 中不再支持这个标签。请使用 CSS 代替。</p>
</div>
...
<p>在 HTML 4.01 中不赞成使用 &lt;s&gt; 标签。</p>
<p>在 HTML 5 中不支持 &lt;s&gt; 标签。</p>
</div>


<div>
<h2>提示和注释</h2>
<p class="tip"><span>提示：</span>请使用 &lt;del&gt; 标签代替。</p>
</div>


<div>
<h2>全局属性</h2>
<p>&lt;s&gt; 标签支持 <a href="html5_ref_globalattributes.asp">HTML 5 中的全局属性</a>。</p>
</div>
 
 
<div>
<h2>事件属性</h2>
<p>&lt;s&gt; 标签支持 <a href="html5_ref_eventattributes.asp">HTML 5 中的事件属性</a>。</p>
</div>
