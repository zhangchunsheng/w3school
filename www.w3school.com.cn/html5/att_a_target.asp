...
<title>HTML 5 &lt;a&gt; 标签的 target 属性</title>
</head>
...
<p>不再允许把框架名称设定为目标，因为不再支持 frame 和 frameset。</p>

<p>self, parent 以及 top 这三个值大多数时候与 iframe 一起使用。</p>
</div>
