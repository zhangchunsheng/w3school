...
<li class="currentLink"><a href="/html5/tag_col.asp" title="HTML5 &lt;col&gt; 标签">&lt;col&gt;</a></li>
...
<p>&lt;col&gt; 标签为表格中的一个或多个列定义属性值。</p>

<p>通过使用 &lt;col&gt; 标签，可以向整个列应用样式，而不需要重复为每个单元格或每一行设置样式。</p>

<p>只能在 table 或 colgroup 元素内使用 &lt;col&gt; 标签。</p>
</div>
...
<pre>
&lt;table&gt;
<code>&lt;col span=&quot;2&quot; style=&quot;background-color:red&quot; /&gt;</code>
  &lt;tr&gt;
    &lt;th&gt;ISBN&lt;/th&gt;
    &lt;th&gt;Title&lt;/th&gt;
    &lt;th&gt;Price&lt;/th&gt;
...
<p class="note"><span>注释：</span>col 元素是空元素。如需创建列，则必须在 tr 元素中规定 td 元素。</p>
...
<table class="dataintable">
  ...
  <tr>
    <td><a href="/html5/att_col_span.asp" title="HTML5 &lt;col&gt; span 属性">span</a></td>
    <td><i>number</i></td>
...
<div>
<h2>全局属性</h2>
<p>&lt;col&gt; 标签支持 <a href="html5_ref_globalattributes.asp">HTML 5 中的全局属性</a>。</p>
</div>
 
 
<div>
<h2>事件属性</h2>
<p>&lt;col&gt; 标签支持 <a href="html5_ref_eventattributes.asp">HTML 5 中的事件属性</a>。</p>
</div>
