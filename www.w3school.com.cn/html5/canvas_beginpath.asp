...
<title>HTML5 canvas beginPath() 方法</title>
...
<h1>HTML5 canvas beginPath() 方法</h1>
...
ctx.lineWidth=&quot;5&quot;;
ctx.strokeStyle=&quot;red&quot;; <span>// 红色路径</span>
ctx.moveTo(0,75);
ctx.lineTo(250,75);
ctx.stroke(); <span>// 进行绘制</span>

<code>ctx.beginPath();</code>
ctx.strokeStyle=&quot;blue&quot;; <span>// 蓝色路径</span>
ctx.moveTo(50,0);
ctx.lineTo(150,130);
ctx.stroke(); <span>// 进行绘制</span>
</pre>

<p><a target="_blank" href="/tiy/t.asp?f=html5_canvas_beginpath">亲自试一试</a></p>
</div>
...
<p>Internet Explorer 9、Firefox、Opera、Chrome 以及 Safari 支持 beginPath() 方法。</p>
...
<p class="tip"><span>提示：</span>请使用这些方法来创建路径：moveTo()、lineTo()、quadricCurveTo()、bezierCurveTo()、arcTo() 以及 arc()。</p>

<p class="tip"><span>提示：</span>请使用 <a href="/html5/canvas_stroke.asp" title="HTML5 canvas stroke() 方法">stroke()</a> 方法在画布上绘制确切的路径。</p>

<h3>JavaScript 语法：</h3>

<pre>context.fillRect(<i>x</i>,<i>y</i>,<i>width</i>,<i>height</i>);</pre>
</div>
