...
<title>HTML 5 &lt;input&gt; max 属性</title>
</head>
...
<pre>
Points: &lt;input type=&quot;number&quot; name=&quot;points&quot; min=&quot;0&quot; <code>max=&quot;10&quot;</code> /&gt;
</pre>

<p><a href="/tiy/t.asp?f=html5_input_max_min">亲自试一试</a></p>
</div>
...
<p>max 属性规定输入字段所允许的最大值。</p>

<p class="tip"><span>提示：</span>max 属性与 <a href="/html5/att_input_min.asp" title="HTML 5 &lt;input&gt; min 属性">min</a> 属性配合使用，可创建合法值范围。</p>

<p class="note"><span>注释：</span>max 和 min 属性适用于以下 &lt;input&gt; 类型：number, range, date, datetime, datetime-local, month, time 以及 week。</p>
</div>
...
<p>max 属性是 &lt;input&gt; 标签在 HTML5 中的新属性。</p>
</div>
...
<pre>&lt;input max=&quot;<i>number|date</i>&quot;&gt;</pre>
...
<tr>
<td><i>number</i></td>
<td>数字值。规定输入字段允许的最大值。</td>
</tr>

<tr>
<td><i>date</i></td>
<td>日期。规定输入字段允许的最大值。</td>
</tr>
</table>
</div>
