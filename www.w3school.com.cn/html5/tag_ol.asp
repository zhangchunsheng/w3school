...
<li class="currentLink"><a href="/html5/tag_ol.asp" title="HTML5 &lt;ol&gt; 标签">&lt;ol&gt;</a></li>
...
<p><a target="_blank" href="/tiy/t.asp?f=html_list_ordered">亲自试一试</a></p>
</div>
...
<p>&lt;ol&gt; 标签定义有序列表。有序列表可以是数字或字母顺序。</p>
...
<p class="tip"><span>提示：</span>对于无序列表，请使用 &lt;ul&gt; 标签。</p>

<p class="tip"><span>提示：</span>请使用 CSS 来设置列表的样式。</p>
</div>
...
<p>在 HTML 4.01 中不赞成使用 &quot;start&quot; 和 &quot;type&quot; 属性，但是在 HTML5 中支持。</p>

<p>&quot;reversed&quot; 属性是 HTML5 中的新属性。</p>

<p>在 HTML 4.01 中不赞成使用 &quot;compact&quot; 属性，在 HTML5 中不支持。</p>
</div>
...
<tr>
<td><a href="/html5/att_ol_compact.asp">compact</a></td>
<td>compact</td>
<td><p>HTML5 中不支持。HTML 4.01 中不赞成使用。</p><p>规定列表呈现的效果比正常情况更小巧。</p></td>
</tr>

<tr>
<td class="html5_new"><a href="/html5/att_ol_reversed.asp">reversed</a></td>
<td>reversed</td>
<td>规定列表顺序为降序。(9,8,7...)</td>
</tr>

<tr>
<td><a href="/html5/att_ol_start.asp">start</a></td>
<td><i>number</i></td>
<td>规定有序列表的起始值。</td>
</tr>

<tr>
<td><a href="/html5/att_ol_type.asp">type</a></td>
<td>
    <ul>
    <li>1</li>
    <li>A</li>
...
<p>&lt;ol&gt; 标签支持 <a href="html5_ref_globalattributes.asp">HTML 5 中的全局属性</a>。</p>
</div>
...
<p>&lt;ol&gt; 标签支持 <a href="html5_ref_eventattributes.asp">HTML 5 中的事件属性</a>。</p>
</div>
...
<p>HTML 教程：<a href="/html/html_lists.asp" title="HTML 列表">HTML 列表</a></p>
</div>
