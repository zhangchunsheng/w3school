...
<li class="currentLink"><a href="/html5/tag_pre.asp" title="HTML5 &lt;pre&gt; 标签">&lt;pre&gt;</a></li>
...
<p>在 HTML 4.01 中，不赞成使用 width 属性，在 HTML 5 中不再支持该属性。</p>
</div>


<div>
<h2>提示和注释</h2>
<p class="tip"><span>提示：</span>请使用 &lt;pre&gt; 标签来显示非常规的格式化内容，或者某类计算机代码。</p>
</div>


<div>
<h2>全局属性</h2>
<p>&lt;pre&gt; 标签支持 <a href="html5_ref_globalattributes.asp">HTML 5 中的全局属性</a>。</p>
</div>
 
 
<div>
<h2>事件属性</h2>
<p>&lt;pre&gt; 标签支持 <a href="html5_ref_eventattributes.asp">HTML 5 中的事件属性</a>。</p>
</div>
