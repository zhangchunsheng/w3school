...
<title>HTML 5 &lt;textarea&gt; 标签</title>
</head>
...
<li class="currentLink"><a href="/html5/tag_textarea.asp" title="HTML5 &lt;textarea&gt; 标签">&lt;textarea&gt;</a></li>
...
<h1>HTML 5 &lt;textarea&gt; 标签</h1>


<div>
<h2>定义和用法</h2>
<p>定义一个文本区域 (text-area) （一个多行的文本输入区域）。用户可在此文本区域中写文本。在一个文本区中，您可输入无限数量的文本。文本区中的默认字体是等宽字体 (fixed pitch)。</p>
</div>


<div>
<h2>HTML 4.01 与 HTML 5 之间的差异</h2>
<p>在 HTML 5 中有一些新属性，同时不再支持 HTML 4.01 中的一些属性。</p>
</div>
...
<table class="dataintable">
  ...
  <tr>
    ...
    <td>在页面加载时，使这个 textarea 获得焦点。</td>
    <td>&nbsp;</td>
    <td>5</td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td>定义为了提交该表单，该 textarea 的值是否是必需的。</td>
    <td>&nbsp;</td>
    <td>5</td>
  </tr>
  <tr>
...
<div>
<h2>全局属性</h2>
<p>&lt;textarea&gt; 标签支持 <a href="html5_ref_globalattributes.asp">HTML 5 中的全局属性</a>。</p>
</div>
 
 
<div>
<h2>事件属性</h2>
<p>&lt;textarea&gt; 标签支持 <a href="html5_ref_eventattributes.asp">HTML 5 中的事件属性</a>。</p>
</div>
