...
<li class="currentLink"><a href="/html5/tag_dl.asp" title="HTML5 &lt;dl&gt; 标签">&lt;dl&gt;</a></li>
...
<p>&lt;dl&gt; 标签定义一个定义列表（definition list）。</p>

<p>&lt;dl&gt; 标签用于结合 <a href="/html5/tag_dt.asp" title="HTML 5 &lt;dt&gt; 标签">&lt;dt&gt;</a> （定义列表中的项目）和 <a href="/html5/tag_dd.asp" title="HTML 5 &lt;dd&gt; 标签">&lt;dd&gt;</a> （描述列表中的项目）。</p>
</div>
...
<p><a href="/tiy/t.asp?f=html5_dl">亲自试一试</a></p>
</div>
...
<div>
<h2>全局属性</h2>
<p>&lt;dl&gt; 标签支持 <a href="html5_ref_globalattributes.asp">HTML 5 中的全局属性</a>。</p>
</div>
 
 
<div>
<h2>事件属性</h2>
<p>&lt;dl&gt; 标签支持 <a href="html5_ref_eventattributes.asp">HTML 5 中的事件属性</a>。</p>
</div>
