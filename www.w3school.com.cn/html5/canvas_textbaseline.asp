...
<title>HTML5 canvas textBaseline 属性</title>
...
<h1>HTML 5 canvas textBaseline 属性</h1>
...
<canvas id="myCanvas" width="400" height="200" style="border:1px solid #d3d3d3;background:#ffffff; margin-top:20px;">
...
<span class="code_comment">//在位置 y=100 绘制蓝色线条</span>
ctx.strokeStyle=&quot;blue&quot;;
ctx.moveTo(5,100);
ctx.lineTo(395,100);
ctx.stroke();
...
<span class="code_comment">//在 y=200 以不同的 textBaseline 值放置每个单词</span>
ctx.textBaseline=&quot;top&quot;;
ctx.fillText(&quot;Top&quot;,5,100);
ctx.textBaseline=&quot;bottom&quot;;
ctx.fillText(&quot;Bottom&quot;,50,100);
...
<p><a target="_blank" href="/tiy/t.asp?f=html5_canvas_textbaseline">亲自试一试</a></p>
</div>
...
<p>Internet Explorer 9、Firefox、Opera、Chrome 以及 Safari 支持 textBaseline 属性。</p>
...
<img src="/i/textBaseline.gif" alt="文本基线图示" style="margin-left:0; margin-bottom:20px;" />

<p class="note"><span>注释：</span><a href="/html5/canvas_filltext.asp" title="HTML5 canvas fillRect() 方法">fillText()</a> 或 <a href="/html5/canvas_stroketext.asp" title="HTML5 canvas strokeText() 方法">strokeText()</a> 方法在画布上定位文本时，将使用指定的 textBaseline 值。</p>
