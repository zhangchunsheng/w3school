...
<title>HTML 5 &lt;button&gt; name 属性</title>
</head>
...
<p>拥有相同名称的两个按钮，当被点击时提交不同的值：</p>

<pre>
&lt;form action=&quot;demo_form.asp&quot; method=&quot;get&quot;&gt;
请选择您喜欢的课程：
&lt;button <code>name=&quot;subject&quot;</code> type=&quot;submit&quot; value=&quot;HTML&quot;&gt;HTML&lt;/button&gt;
&lt;button <code>name=&quot;subject&quot;</code> type=&quot;submit&quot; value=&quot;CSS&quot;&gt;CSS&lt;/button&gt;
&lt;/form&gt;
</pre>
...
<p>button 元素的 name 属性用于在表单提交后引用表单数据，或在 JavaScript 中引用该元素。</p>

<p class="tip"><span>提示：</span>多个 button 元素可分享相同的名称。这样就可以为多个按钮设置相同的名称，在表单中使用时可以提交不同的值。</p>
</div>
