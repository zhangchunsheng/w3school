...
<title>HTML 5 &lt;ol&gt; reversed 属性</title>
...
<p><a target="_blank" href="/tiy/t.asp?f=html5_ol_reversed">亲自试一试</a></p>
</div>
...
<p>目前只有 Chrome 和 Safari 6 支持 reversed 属性。</p>
</div>
...
<p>reversed 属性是逻辑属性。</p>

<p>当使用该属性时，它规定列表属性为降序 (9, 8, 7...)，而不是升序 (1, 2, 3...)。</p>
</div>
...
<p>在 XHTML 中，禁止属性最小化，reversed 属性必须被定义为 &lt;ol reversed=&quot;reversed&quot;&gt;。</p>
</div>
