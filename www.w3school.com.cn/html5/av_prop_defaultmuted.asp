...
<title>HTML 5 Audio/Video DOM defaultMuted 属性</title>
...
<h1>HTML 5 Audio/Video DOM defaultMuted 属性</h1>
...
<code>myVid.defaultMuted=true</code>;
</pre>

<p><a href="/tiy/t.asp?f=html5_av_prop_defaultmuted">亲自试一试</a></p>
</div>
...
<p>defaultMuted 属性设置或返回音频/视频是否默认静音。</p>

<p>设置该属性仅会改变默认的静音状态，而不是当前的。要改变当前的静音状态，请使用 <a href="/html5/av_prop_muted.asp" title="HTML5 Audio/Video DOM muted 属性">muted 属性</a>。</p>
</div>
...
<p>只有 Google Chrome 支持 defaultMuted 属性。</p>
</div>
...
<p>设置 defaultMuted 属性：</p>
<pre>audio|video.defaultMuted=true|false</pre>

<p>返回 defaultMuted 属性：</p>
<pre>audio|video.defaultMuted</pre>
