...
<li class="currentLink"><a href="/html5/tag_select.asp" title="HTML5 &lt;select&gt; 标签">&lt;select&gt;</a></li>
...
<div>
<h2>提示和注释：</h2>
<p class="tip"><span>提示：</span>请在 form 元素中使用此标签来接受用户的输入。</p>
</div>
...
<table class="dataintable">
  ...
  <tr>
    ...
    <td>当该属性为 true 时，规定可一次选定多个项目。</td>
    <td>4</td>
    <td>5</td>
  </tr>
  <tr>
...
<div>
<h2>全局属性</h2>
<p>&lt;select&gt; 标签支持 <a href="html5_ref_globalattributes.asp">HTML 5 中的全局属性</a>。</p>
</div>
 
 
<div>
<h2>事件属性</h2>
<p>&lt;select&gt; 标签支持 <a href="html5_ref_eventattributes.asp">HTML 5 中的事件属性</a>。</p>
</div>
