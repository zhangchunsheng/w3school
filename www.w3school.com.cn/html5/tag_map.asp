...
<li class="currentLink"><a href="/html5/tag_map.asp" title="HTML5 &lt;map&gt; 标签">&lt;map&gt;</a></li>
...
<p>&lt;map&gt; 标签用于定义客户端图像映射。图像映射指的是带有可点击区域的图像。</p>

<p>name 属性在 map 元素中是必需的。该属性与 &lt;img&gt; 标签的 usemap 属性相关联，以创建图像与映射之间的关系。</p>

<p>map 元素包含若干 <a href="/html5/tag_area.asp" title="HTML 5 &lt;area&gt; 标签">area</a> 元素，定义图像映射中的可点击区域。</p>
</div>
...
<p><a href="/tiy/t.asp?f=html5_map">亲自试一试</a></p>
</div>
...
<p class="note"><span>注释：</span>在 HTML5 中，如果同时规定了 &lt;map&gt; 标签的 id 属性，则必须为 name 属性规定相同的值。</p>
</div>
...
<table class="dataintable">
  ...
  <tr>
    <td><a href="/html5/att_map_name.asp" title="HTML5 &lt;map&gt; name 属性">name</a></td>
    <td><i>mapname</i></td>
    <td>规定图像映射的名称。</td>
  </tr>
</table>
...
<div>
<h2>全局属性</h2>
<p>&lt;map&gt; 标签支持 <a href="html5_ref_globalattributes.asp">HTML 5 中的全局属性</a>。</p>
</div>
 
 
<div>
<h2>事件属性</h2>
<p>&lt;map&gt; 标签支持 <a href="html5_ref_eventattributes.asp">HTML 5 中的事件属性</a>。</p>
</div>
