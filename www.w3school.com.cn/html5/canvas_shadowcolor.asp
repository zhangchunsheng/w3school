...
<title>HTML5 canvas shadowColor 属性</title>
...
<h1>HTML 5 canvas shadowColor 属性</h1>
...
var ctx=c.getContext("2d");
ctx.shadowBlur=20;
<code>ctx.shadowColor="black";</code>
ctx.fillStyle="blue";
ctx.fillRect(20,20,100,80);
</pre>

<p><a href="/tiy/t.asp?f=html5_canvas_shadowcolor">亲自试一试</a></p>
</div>
...
<p>Internet Explorer 9、Firefox、Opera、Chrome 以及 Safari 支持 shadowColor 属性。</p>
...
<p class="note"><span>注释：</span>请将 shadowColor 属性与 <a href="/html5/canvas_shadowblur.asp" title="HTML5 canvas shadowBlur 属性">shadowBlur</a> 属性一起使用，来创建阴影。</p>

<p class="tip"><span>提示：</span>请通过使用 <a href="/html5/canvas_shadowoffsetx.asp" title="HTML5 canvas shadowOffsetX 属性">shadowOffsetX</a> 和 <a href="/html5/canvas_shadowoffsety.asp" title="HTML5 canvas shadowOffsetY 属性">shadowOffsetY</a> 属性来调节阴影效果。</p>
...
<tr>
<th>JavaScript 语法：</th>
<td>context.shadowColor=<i>color</i>;</td>
</tr>
</table>
...
<tr>
<td><i>color</i></td>
<td>用于阴影的 <a href="/css/css_colors_legal.asp" title="CSS 合法颜色值">CSS 颜色值</a>。默认值是 #000000。</td>
</tr>
</table>
</div>
