...
<li class="currentLink"><a href="/html5/tag_th.asp" title="HTML5 &lt;th&gt; 标签">&lt;th&gt;</a></li>
...
<p>&lt;th&gt; 标签定义 HTML 表格中的表头单元格。</p>

<p>HTML 表格有两种单元格类型：</p>

<ul>
<li>表头单元格 - 包含头部信息（由 th 元素创建）</li>
<li>标准单元格 - 包含数据（由 <a href="/html5/tag_td.asp" title="HTML 5 &lt;td&gt; 标签">td</a> 元素创建）</li>
</ul>

<p>th 元素中的文本呈现为粗体并且居中。</p>

<p>td 元素中的文本是普通的左对齐文本。</p>
</div>
...
<p>一个简单的 HTML 表格，带有两个表头单元格和两个数据单元格：</p>
...
<p><a href="/tiy/t.asp?f=html5_th">亲自试一试</a></p>
</div>
...
<table class="dataintable">
  ...
  <tr>
    <td><a href="/html5/att_th_colspan.asp" title="HTML5 &lt;th&gt; colspan 属性">colspan</a></td>
    <td><i>number</i></td>
    <td>规定此表头单元格可横跨的列数。</td>
  </tr>

  <tr>
    <td><a href="/html5/att_th_headers.asp" title="HTML5 &lt;th&gt; headers 属性">headers</a></td>
    <td><i>header_id</i></td>
    <td>规定与表头单元格相关联的一个或多个表头单元格。</td>
  </tr>
  ...
  <tr>
    <td><a href="/html5/att_th_rowspan.asp" title="HTML5 &lt;th&gt; rowspan 属性">rowspan</a></td>
    <td><i>number</i></td>
    <td>规定此单元格可横跨的行数。</td>
  </tr>

  <tr>
    <td><a href="/html5/att_th_scope.asp" title="HTML5 &lt;th&gt; scope 属性">scope</a></td>
    <td>
	<ul>
	<li>col</li>
    <li>colgroup</li>
...
<div>
<h2>全局属性</h2>
<p>&lt;th&gt; 标签支持 <a href="html5_ref_globalattributes.asp">HTML 5 中的全局属性</a>。</p>
</div>
 
 
<div>
<h2>事件属性</h2>
<p>&lt;th&gt; 标签支持 <a href="html5_ref_eventattributes.asp">HTML 5 中的事件属性</a>。</p>
</div>
