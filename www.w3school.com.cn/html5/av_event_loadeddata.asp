...
<title>HTML 5 Audio/Video DOM loadeddata 事件</title>
...
<h1>HTML 5 Audio/Video DOM loadeddata 事件</h1>
...
<code>myVid.onloadeddata=alert(&quot;Browser has loaded the current frame&quot;)</code>;
</pre>

<p><a href="/tiy/t.asp?f=html5_av_event_loadeddata">亲自试一试</a></p>
</div>
...
<p>当当前帧的数据已加载，但没有足够的数据来播放指定音频/视频的下一帧时，会发生 loadeddata 事件。</p>
...
<p>在 HTML 中：</p>
<pre>&lt;audio|video onloadeddata=&quot;<i>SomeJavaScriptCode</i>&quot;&gt;</pre>
...
<p><a href="/tiy/t.asp?f=html5_av_event_loadeddata_html">在 HTML 元素上使用 loadeddata 属性</a></p>

<p><a href="/tiy/t.asp?f=html5_av_event_loadeddata_addeventlistener">使用 addEventListener() 来监听 loadeddata 事件</a></p>
</div>
