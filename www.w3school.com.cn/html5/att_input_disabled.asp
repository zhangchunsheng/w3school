...
<title>HTML 5 &lt;input&gt; disabled 属性</title>
</head>
...
<h1>HTML 5 &lt;input&gt; disabled 属性</h1>
...
&lt;form action=&quot;demo_form.asp&quot;&gt;
  ...
  Last name: &lt;input type=&quot;text&quot; name=&quot;lname&quot; <code>disabled=&quot;disabled&quot;</code> /&gt;&lt;br /&gt;
  &lt;input type=&quot;submit&quot; value=&quot;Submit&quot; /&gt;
&lt;/form&gt;
</pre>

<p><a href="/tiy/t.asp?f=html5_input_disabled">亲自试一试</a></p>
</div>
...
<p>disabled 属性规定应该禁用输入字段。</p>

<p>被禁用的输入字段是无法使用和无法点击的。</p>

<p>如果使用该属性，则会禁用输入字段。</p>

<p>可以对 disabled 属性进行设置，使用户在满足某些条件时（比如选中复选框，等等）才能使用输入字段。然后，可使用 JavaScript 来删除 disabled 属性，使该输入字段变为可用的状态。</p>

<p class="note"><span>注释：</span>disabled 属性不适用于 &lt;input type=&quot;hidden&quot;&gt;。</p>

<p class="tip"><span>提示：</span>被禁用的表单元素不会被提交。</p>
</div>
