...
<title>HTML5 canvas addColorStop() 方法</title>
...
<h1>HTML5 canvas addColorStop() 方法</h1>
...
var grd=ctx.createLinearGradient(0,0,170,0);
<code>grd.addColorStop(0,&quot;black&quot;);</code>
<code>grd.addColorStop(1,&quot;white&quot;);</code>
...
<p>Internet Explorer 9、Firefox、Opera、Chrome 以及 Safari 支持 addColorStop() 方法。</p>
...
<p>addColorStop() 方法规定 gradient 对象中的颜色和位置。</p>

<p>
addColorStop() 方法与 
<a href="/html5/canvas_createlineargradient.asp" title="HTML5 canvas createLinearGradient() 方法">createLinearGradient()</a>
 或 
<a href="/html5/canvas_createradialgradient.asp" title="HTML5 canvas createRadialGradient() 方法">createRadialGradient()</a> 一起使用。
</p>

<p class="note"><span>注释：</span>您可以多次调用 addColorStop() 方法来改变渐变。如果您不对 gradient 对象使用该方法，那么渐变将不可见。为了获得可见的渐变，您需要创建至少一个色标。</p>

<h3>JavaScript 语法：</h3>

<pre>gradient.addColorStop(<i>stop</i>,<i>color</i>);</pre>
...
var grd=ctx.createLinearGradient(0,0,170,0);
<code>grd.addColorStop(0,&quot;black&quot;);
grd.addColorStop(&quot;0.3&quot;,&quot;magenta&quot;);
grd.addColorStop(&quot;0.5&quot;,&quot;blue&quot;);
grd.addColorStop(&quot;0.6&quot;,&quot;green&quot;);
grd.addColorStop(&quot;0.8&quot;,&quot;yellow&quot;);
grd.addColorStop(1,&quot;red&quot;);</code>

ctx.fillStyle=grd;
ctx.fillRect(20,20,150,100);
</pre>

<p><a target="_blank" href="/tiy/t.asp?f=html5_canvas_addcolorstop_multiple">亲自试一试</a></p>
</div>
