...
<title>HTML5 canvas lineTo() 方法</title>
...
<p><a target="_blank" href="/tiy/t.asp?f=html5_canvas_lineto">亲自试一试</a></p>
</div>
...
<p>Internet Explorer 9、Firefox、Opera、Chrome 以及 Safari 支持 lineTo() 方法。</p>
...
<pre>context.lineTo(<i>x</i>,<i>y</i>);</pre>
...
ctx.beginPath();
ctx.moveTo(20,20);
<code>ctx.lineTo(20,100);</code>
<code>ctx.lineTo(70,100);</code>
ctx.stroke();
</pre>

<p><a target="_blank" href="/tiy/t.asp?f=html5_canvas_lineto2">亲自试一试</a></p>
</div>
