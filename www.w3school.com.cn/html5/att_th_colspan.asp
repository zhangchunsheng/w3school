...
<title>HTML 5 &lt;th&gt; colspan 属性</title>
</head>
...
<p>下面的表格中包含一个横跨两列的表头：</p>

<pre>
&lt;table&gt;
  &lt;tr&gt;
    &lt;th <code>colspan=&quot;2&quot;</code>&gt;月份&lt;/th&gt;
  &lt;/tr&gt;
  &lt;tr&gt;
    &lt;td&gt;一月&lt;/td&gt;
    &lt;td&gt;二月&lt;/td&gt;
...
<p><a href="/tiy/t.asp?f=html5_th_colspan">亲自试一试</a></p>
</div>
...
<p>所有主流浏览器均支持 colspan 属性。</p>

<p class="note"><span>注释：</span>没有浏览器支持 colspan=&quot;0&quot;，该值有特殊的含义（请看下面的属性值表格）。</p>
</div>
