...
<li class="currentLink"><a href="/html5/tag_footer.asp" title="HTML5 &lt;footer&gt; 标签">&lt;footer&gt;</a></li>
...
<h1>HTML 5 &lt;footer&gt; 标签</h1>


<div>
<h2>定义和用法</h2>
<p>&lt;footer&gt; 标签定义 section 或 document 的页脚。</p>
<p>在典型情况下，该元素会包含创作者的姓名、文档的创作日期以及/或者联系信息。</p>
</div>
...
<p><a href="/tiy/t.asp?f=html5_footer">亲自试一试</a></p>
</div>
...
<div>
<h2>提示和注释</h2>
<p class="tip"><span>提示：</span>假如您使用 footer 来插入联系信息，应该在 footer 元素内使用 &lt;address&gt; 元素。</p>
</div>


<div>
<h2>全局属性</h2>
<p>&lt;footer&gt; 标签支持 <a href="html5_ref_globalattributes.asp">HTML 5 中的全局属性</a>。</p>
</div>


<div>
<h2>事件属性</h2>
<p>&lt;footer&gt; 标签支持 <a href="html5_ref_eventattributes.asp">HTML 5 中的事件属性</a>。</p>
</div>
