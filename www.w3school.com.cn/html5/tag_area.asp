...
<li class="currentLink"><a href="/html5/tag_area.asp" title="HTML5 &lt;area&gt; 标签">&lt;area&gt;</a></li>
...
<h1>HTML 5 &lt;area&gt; 标签</h1>


<div>
<h2>定义和用法</h2>

<p>&lt;area&gt; 标签定义图像映射内部的区域（图像映射指的是带有可点击区域的图像）。</p>

<p>area 元素始终嵌套在 &lt;map&gt; 标签内部。</p>

<p class="note"><span>注释：</span><a href="/html5/tag_img.asp" title="HTML 5 &lt;img&gt; 标签">&lt;img&gt;</a> 标签中的 usemap 属性与 <a href="/html5/tag_map.asp" title="HTML 5 &lt;map&gt; 标签">map</a> 元素中的 name 相关联，以创建图像与映射之间的关系。</p>
</div>
...
<p><a href="/tiy/t.asp?f=html5_area">亲自试一试</a></p>
</div>
...
<p>HTML5 提供了一些新属性，同时不再支持 HTML 4.01 中的某些属性。</p>
</div>
...
<td>alt</td>
<td><i>text</i></td>
<td>规定区域的替代文本。如果使用 href 属性，则该属性是必需的。</td>
</tr>
...
<tr>
<td class="html5_new">hreflang</td>
<td><i>language_code</i></td>
<td>规定目标 URL 的语言。</td>
</tr>

<tr>
<td class="html5_new">media</td>
<td><i>media query</i></td>
<td>规定目标 URL 是为何种媒介/设备优化的。默认：all。</td>
</tr>
...
<tr>
<td class="html5_new">type</td>
<td><i>mime_type</i></td>
<td>规定目标 URL 的 MIME 类型。</td>
</tr>
</table>
</div>
...
<div>
<h2>全局属性</h2>
<p>&lt;area&gt; 标签支持 <a href="html5_ref_globalattributes.asp">HTML 5 中的全局属性</a>。</p>
</div>


<div>
<h2>事件属性</h2>
<p>&lt;area&gt; 标签支持 <a href="html5_ref_eventattributes.asp">HTML 5 中的事件属性</a>。</p>
</div>
