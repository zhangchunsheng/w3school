...
<title>HTML5 canvas createLinearGradient() 方法</title>
...
<h1>HTML5 canvas createLinearGradient() 方法</h1>
...
var grd=ctx.<code>createLinearGradient(0,0,170,0)</code>;
grd.addColorStop(0,&quot;black&quot;);
grd.addColorStop(1,&quot;white&quot;);

ctx.fillStyle=grd;
ctx.fillRect(20,20,150,100);</pre>


<p><a target="_blank" href="/tiy/t.asp?f=html5_canvas_createlineargradient">亲自试一试</a></p>
</div>
...
<p>Internet Explorer 9、Firefox、Opera、Chrome 以及 Safari 支持 createLinearGradient() 方法。</p>
...
<p class="tip"><span>提示：</span>请使用该对象作为 <a href="/html5/canvas_strokestyle.asp" title="HTML 5 canvas strokeStyle 属性">strokeStyle</a> 或 <a href="/html5/canvas_fillstyle.asp" title="HTML 5 canvas fillStyle 属性">fillStyle</a> 属性的值。</p>

<p class="tip"><span>提示：</span>请使用 <a href="/html5/canvas_addcolorstop.asp" title="HTML5 canvas addColorStop() 方法">addColorStop()</a> 方法规定不同的颜色，以及在 gradient 对象中的何处定位颜色。</p>

<h3>JavaScript 语法：</h3>

<pre>context.createLinearGradient(<i>x0</i>,<i>y0</i>,<i>x1</i>,<i>y1</i>);</pre>
...
var c=document.getElementById("myCanvas");
var ctx=c.getContext("2d");
var my_gradient=<code>ctx.createLinearGradient(0,0,0,170)</code>;
my_gradient.addColorStop(0,"black");
my_gradient.addColorStop(1,"white");
ctx.fillStyle=my_gradient;
ctx.fillRect(20,20,150,100);
...
<p><a target="_blank" href="/tiy/t.asp?f=html5_canvas_fillstyle_gradient">亲自试一试</a></p>

<h3>实例 2</h3>

<p>定义一个从黑到红再到白的渐变，作为矩形的填充样式：</p>

<canvas id="myCanvas4" class="canvas_example">
Your browser does not support the canvas tag.
</canvas>
...
var c=document.getElementById("myCanvas");
var ctx=c.getContext("2d");
var my_gradient=<code>ctx.createLinearGradient(0,0,170,0)</code>;
my_gradient.addColorStop(0,"black");
my_gradient.addColorStop(0.5,"red");
my_gradient.addColorStop(1,"white");
ctx.fillStyle=my_gradient;
...
<p><a target="_blank" href="/tiy/t.asp?f=html5_canvas_fillstyle_gradient3">亲自试一试</a></p>
</div>
