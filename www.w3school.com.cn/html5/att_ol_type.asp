...
<h1>HTML 5 &lt;ol&gt; type 属性</h1>

<div class="backtoreference">
<p><a href="/html5/tag_ol.asp">HTML 5 &lt;ol&gt; 标签</a></p>
</div>
...
<p><a target="_blank" href="/tiy/t.asp?f=html_ol_start">亲自试一试</a></p>
</div>
...
<p>在 HTML5 中，不再反对使用 &lt;ol&gt; 元素的 type 属性。</p>
</div>
...
<p>在 HTML 4.01 中，不赞成使用 ol 元素的 type 属性；在 XHTML 1.0 Strict DTD 中，不支持 ol 元素的 type 属性。</p>

<p>请使用 CSS 代替。</p>

<p>CSS 语法：&lt;ol style=&quot;list-style-type:upper-roman&quot;&gt;</p>

<p><a href="/tiy/t.asp?f=html_ol_type_css">CSS 实例：列表样式类型</a></p>
...
<tr>
<td>i</td>
<td>罗马字母，小写 (i, ii, iii, iv)。</td>
</tr>

<tr>
<td>I</td>
<td>罗马字母，大写 (I, II, III, IV)。</td>
</tr>
