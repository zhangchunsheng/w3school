...
<title>HTML5 canvas strokeRect() 方法</title>
...
<h1>HTML5 canvas strokeRect() 方法</h1>
...
<p><a target="_blank" href="/tiy/t.asp?f=html5_canvas_strokerect">亲自试一试</a></p>
</div>
...
<p>Internet Explorer 9、Firefox、Opera、Chrome 以及 Safari 支持 strokeRect() 方法。</p>
...
<p>strokeRect() 方法绘制矩形（不填色）。笔触的默认颜色是黑色。</p>

<p class="tip"><span>提示：</span>请使用 <a href="/html5/canvas_strokestyle.asp" title="HTML 5 canvas strokeStyle 属性">strokeStyle</a> 属性来设置笔触的颜色、渐变或模式。</p>

<h3>JavaScript 语法：</h3>

<pre>context.strokeRect(<i>x</i>,<i>y</i>,<i>width</i>,<i>height</i>);</pre>
