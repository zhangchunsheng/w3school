...
<li class="currentLink"><a href="/html5/tag_a.asp" title="HTML5 &lt;a&gt; 标签">&lt;a&gt;</a></li>
...
<p><a href="/tiy/t.asp?f=html5_a">亲自试一试</a></p>
</div>


<div>
<h2>HTML 4.01 与 HTML 5 之间的差异</h2>
<p>在 HTML 4.01 中，&lt;a&gt; 标签既可以是超链接，也可以是锚。这取决于是否描述了 href 属性。</p>
<p>在 HTML 5 中，&lt;a&gt; 是超链接，但是假如没有 href 属性，它仅仅是超链接的一个占位符。</p>
<p>HTML 5 有一些新的属性，同时不再支持一些 HTML 4.01 的属性。</p>
</div>
...
<p class="tip"><span>提示：</span>如果没有使用 href 属性，则不能使用 hreflang, media, ping, rel, target 以及 type 属性。</p>

<p class="tip"><span>提示：</span>通常在当前浏览器窗口中显示被链接页面，除非规定了其他 target。</p>

<p class="tip"><span>提示：</span>请使用 CSS 来改变链接的样式。</p>
</div>
...
<table class="dataintable"> 
  ...
  <tr>
    <td><a href="/html5/att_a_href.asp" title="HTML5 &lt;a&gt; href 属性">href</a></td>
	<td><i>URL</i></td>
    <td>链接的目标 URL。</td>
  </tr>
  <tr>
    <td><a href="/html5/att_a_hreflang.asp" title="HTML5 &lt;a&gt; hreflang 属性">hreflang</a></td>
	<td><i>language_code</i></td>
    <td>规定目标 URL 的基准语言。仅在 href 属性存在时使用。</td>
  </tr>
  <tr>
    <td class="html5_new"><a href="/html5/att_a_media.asp" title="HTML5 &lt;a&gt; media 属性">media</a></td>
	<td><i>media query</i></td>
    <td>
	<p>规定目标 URL 的媒介类型。</p>
	<p>默认值：all。仅在 href 属性存在时使用。</p>
	</td>
  </tr>
  <tr>
    <td>name</td>
  ...
  <tr>
    <td><a href="/html5/att_a_rel.asp" title="HTML5 &lt;a&gt; rel 属性">rel</a></td>
	<td>
		<ul>
		<li>alternate</li>
		<li>archives</li>
  ...
  <tr>
    <td><a href="/html5/att_a_target.asp" title="HTML5 &lt;a&gt; target 属性">target</a></td>
	<td>
		<ul>
		<li>_blank</li>
		<li>_parent</li>
    ...
    <td>在何处打开目标 URL。仅在 href 属性存在时使用。</td>
  </tr>
  <tr>
    <td class="html5_new"><a href="/html5/att_a_type.asp" title="HTML5 &lt;a&gt; type 属性">type</a></td>
	<td><i>mime_type</i></td>
    <td>
	<p>规定目标 URL 的 MIME 类型。仅在 href 属性存在时使用。</p>
	<p>注：MIME = Multipurpose Internet Mail Extensions。</p>
	</td>
  </tr>
</table>
...
<div>
<h2>全局属性</h2>
<p>&lt;a&gt; 标签支持 <a href="html5_ref_globalattributes.asp">HTML 5 中的全局属性</a>。</p>
</div>


<div>
<h2>事件属性</h2>
<p>&lt;a&gt; 标签支持 <a href="html5_ref_eventattributes.asp">HTML 5 中的事件属性</a>。</p>
</div>
