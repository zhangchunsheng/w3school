...
<p>dropzone 属性规定当被拖动的数据在拖放到元素上时，是否被复制、移动或链接。</p>
</div>
...
<pre>
&lt;<i>element</i> draggable=&quot;copy|move|link&quot;&gt;
</pre>
...
<tr>
<td>copy</td>
<td>拖动数据会导致被拖数据产生副本。</td>
</tr>

<tr>
<td>move</td>
<td>拖动数据会导致被拖数据移动到新位置。</td>
</tr>

<tr>
<td>link</td>
<td>拖动数据会生成指向原始数据的链接。</td>
</tr>
</table>
</div>
