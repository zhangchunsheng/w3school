...
<title>HTML5 canvas stroke() 方法</title>
...
<p><a target="_blank" href="/tiy/t.asp?f=html5_canvas_stroke">亲自试一试</a></p>
</div>
...
<p>Internet Explorer 9、Firefox、Opera、Chrome 以及 Safari 支持 stroke() 方法。</p>
...
<p class="tip"><span>提示：</span>请使用 <a href="/html5/canvas_strokestyle.asp" title="HTML5 canvas strokeStyle 属性">strokeStyle</a> 属性来绘制另一种颜色/渐变。</p>
