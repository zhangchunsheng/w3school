...
<title>HTML 5 &lt;audio&gt; preload 属性</title>
</head>
...
<p><a href="/tiy/t.asp?f=html5_audio_preload">亲自试一试</a></p>
</div>
...
<p>preload 属性是 HTML 5 中的新属性。</p>
</div>

<div>
<h2>语法</h2>

<pre>&lt;audio preload=&quot;load&quot; /&gt;</pre>
...
<td>
	...
	<li>auto - 当页面加载后载入整个音频</li>
	<li>meta - 当页面加载后只载入元数据</li>
	<li>none - 当页面加载后不载入音频</li>
	</ul>
</td>
</table>
</div>
