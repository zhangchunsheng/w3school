...
<title>HTML 5 全局 spellcheck 属性</title>
</head>
...
<pre>
&lt;p contenteditable=&quot;true&quot; <code>spellcheck=&quot;true&quot;</code>&gt;这是可编辑的段落。请试着编辑文本。&lt;/p&gt;
</pre>

<p><a href="/tiy/t.asp?f=html5_global_spellcheck">亲自试一试</a></p>
</div>
...
<p>spellcheck 属性规定是否对元素内容进行拼写检查。</p>

<p>可对以下文本进行拼写检查：</p>

<ul>
<li>类型为 text 的 input 元素中的值（非密码）</li>
<li>textarea 元素中的值</li>
<li>可编辑元素中的值</li>
</ul>
</div>
...
<p>spellcheck 属性是 HTML5 中的新属性。</p>
</div>
...
<tr>
<td>true</td>
<td>规定应当对元素的文本进行拼写检查。</td>
</tr>

<tr>
<td>false</td>
<td>规定不应对元素的文本进行拼写检查。</td>
</tr>
</table>
