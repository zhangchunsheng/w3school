...
<title>HTML 5 &lt;link&gt; rel 属性</title>
</head>
...
<pre>
&lt;link <code>rel=&quot;stylesheet&quot;</code> type=&quot;text/css&quot; href=&quot;demo_link.css&quot; /&gt;
</pre>

<p><a href="/tiy/t.asp?f=html5_link_rel">亲自试一试</a></p>
</div>
...
<p>rel 属性规定当前文档与被链接文档/资源之间的关系。</p>

<p>只有当使用 href 属性时，才能使用 rel 属性。</p>
</div>
...
<p>已删除的值：appendix, chapter, contents, copyright, glossary, index, section, start, subsection</p>

<p>新值：archives, author, bookmark, external, first, index, last, license, nofollow, noreferrer, pingback, search, sidebar, tag, up</p>
</div>
...
<tr>
<td>sidebar</td>
<td>链接到应该显示在浏览器侧栏的文档。</td>
</tr>

<tr>
<td>stylesheet</td>
<td>指向要导入的样式表的 URL。</td>
</tr>
