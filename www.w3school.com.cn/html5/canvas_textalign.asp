...
<title>HTML5 canvas textAlign 属性</title>
...
<h1>HTML 5 canvas textAlign 属性</h1>
...
<p>在位置 150 创建一条红线。位置 150 是下面例子中定义的所有文本的锚点。请研究每种 textAlign 属性值的效果：</p>

<canvas id="myCanvas" width="300" height="200" style="border:1px solid #d3d3d3;background:#ffffff; margin-top:20px;">
...
<span class="code_comment">// 在位置 150 创建蓝线</span>
ctx.strokeStyle=&quot;blue&quot;;
ctx.moveTo(150,20);
ctx.lineTo(150,170);
ctx.stroke();
...
<span class="code_comment">// 显示不同的 textAlign 值</span>
ctx.textAlign=&quot;start&quot;;
ctx.fillText(&quot;textAlign=start&quot;,150,60);
ctx.textAlign=&quot;end&quot;;
ctx.fillText(&quot;textAlign=end&quot;,150,80);
...
<p><a target="_blank" href="/tiy/t.asp?f=html5_canvas_textalign">亲自试一试</a></p>
</div>
...
<p>Internet Explorer 9、Firefox、Opera、Chrome 以及 Safari 支持 textAlign 属性。</p>
...
<p>通常，文本会从指定位置开始，不过，如果您设置为 textAlign=&quot;right&quot; 并将文本放置到位置 150，那么会在位置 150 结束。</p>

<p class="tip"><span>提示：</span>使用 <a href="/html5/canvas_filltext.asp" title="HTML5 canvas fillRect() 方法">fillText()</a> 或 <a href="/html5/canvas_stroketext.asp" title="HTML5 canvas strokeText() 方法">strokeText()</a> 方法在实际地在画布上绘制并定位文本。</p>
