...
<title>HTML5 canvas moveTo() 方法</title>
...
<p><a target="_blank" href="/tiy/t.asp?f=html5_canvas_moveto">亲自试一试</a></p>
</div>
...
<p>Internet Explorer 9、Firefox、Opera、Chrome 以及 Safari 支持 moveTo() 方法。</p>
...
<pre>context.moveTo(<i>x</i>,<i>y</i>);</pre>
