...
<title>HTML 5 &lt;th&gt; scope 属性</title>
</head>
...
<p>规定两个表头单元格是两个列的头部：</p>

<pre>
&lt;table&gt;
  &lt;tr&gt;
    &lt;th&gt;&lt;/th&gt;
    &lt;th <code>scope=&quot;col&quot;</code>&gt;月份&lt;/th&gt;
    &lt;th <code>scope=&quot;col&quot;</code>&gt;存款&lt;/th&gt;
  &lt;/tr&gt;
  &lt;tr&gt;
    &lt;td&gt;1&lt;/td&gt;
    &lt;td&gt;一月&lt;/td&gt;
...
<p><a href="/tiy/t.asp?f=html5_th_scope">亲自试一试</a></p>
</div>
...
<p>scope 属性在普通的 web 浏览器中没有可见效果，但可被屏幕阅读器使用。</p>
</div>
...
<p>scope 属性规定此表头单元格是否是行、列、行组或列组的头部。</p>
</div>
...
<pre>&lt;th scope=&quot;col|row|colgroup|rowgroup&quot;&gt;</pre>
