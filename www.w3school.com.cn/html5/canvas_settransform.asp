...
<title>HTML5 canvas setTransform() 方法</title>
...
<h1>HTML5 canvas setTransform() 方法</h1>
...
<code>ctx.setTransform(1,0.5,-0.5,1,30,10);</code>
ctx.fillStyle=&quot;red&quot;;
ctx.fillRect(0,0,250,100);
...
<p><a target="_blank" href="/tiy/t.asp?f=html5_canvas_setTransform">亲自试一试</a></p>
</div>
...
<p>Internet Explorer 9、Firefox、Opera、Chrome 以及 Safari 支持 setTransform() 方法。</p>
...
<p>setTransform() 方法把当前的变换矩阵重置为单位矩阵，然后以相同的参数运行 <a href="/html5/canvas_transform.asp" title="HTML5 canvas transform() 方法">transform()</a>。</p>

<p>换句话说，setTransform() 允许您缩放、旋转、移动并倾斜当前的环境。</p>

<p class="note"><span>注释：</span>该变换只会影响 setTransform() 方法调用之后的绘图。</p>

<h3>JavaScript 语法：</h3>

<pre>context.setTransform(<i>a</i>,<i>b</i>,<i>c</i>,<i>d</i>,<i>e</i>,<i>f</i>);</pre>
