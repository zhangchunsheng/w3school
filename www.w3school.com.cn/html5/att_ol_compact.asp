...
<title>HTML 5 &lt;ol&gt; compact 属性</title>
...
<p><a target="_blank" href="/tiy/t.asp?f=html_ol_compact">亲自试一试</a></p>
</div>
...
<p>在 HTML5 中不支持 &lt;ol&gt; compact 属性，请使用 CSS 代替。</p>

<p>在 HTML 4.01 中不赞成使用 &lt;ol&gt; 的 compact 属性。</p>

<p>compact 属性是逻辑属性。</p>

<p>当使用该属性时，它规定了列表的显示效果应该比正常情况更小巧，通过缩小行间距和列表的缩进。</p>
</div>
...
<p>HTML 4.01 中不赞成使用 &lt;ol&gt; 的 compact 属性。请使用 CSS 代替。</p>

<p>CSS 语法：&lt;ol style=&quot;line-height: 80%&quot;&gt;</p>

<p><a target="_blank" href="/tiy/t.asp?f=html_ol_compact_css">CSS 实例：缩小列表中的行高</a></p>

<p>在我们的 CSS 教程中，您能够找到关于 line-height 属性的更多信息。</p>
</div>
...
<p>在 XHTML 中，禁止属性最小化，compact 属性必须被定义为 &lt;ol compact=&quot;compact&quot;&gt;。</p>
</div>
