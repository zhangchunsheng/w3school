...
<li class="currentLink"><a href="/html5/tag_p.asp" title="HTML5 &lt;p&gt; 标签">&lt;p&gt;</a></li>
...
<p>在 HTML 4.01 中，不赞成使用 align 属性，在 HTML 5 中不再支持该属性。</p>
</div>


<div>
<h2>全局属性</h2>
<p>&lt;p&gt; 标签支持 <a href="html5_ref_globalattributes.asp">HTML 5 中的全局属性</a>。</p>
</div>
 
 
<div>
<h2>事件属性</h2>
<p>&lt;p&gt; 标签支持 <a href="html5_ref_eventattributes.asp">HTML 5 中的事件属性</a>。</p>
</div>
