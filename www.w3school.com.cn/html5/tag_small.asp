...
<li class="currentLink"><a href="/html5/tag_small.asp" title="HTML5 &lt;small&gt; 标签">&lt;small&gt;</a></li>
...
<h1>HTML 5 &lt;small&gt; 标签</h1>


<div>
<h2>定义和用法</h2>

<p>&lt;small&gt; 标签将旁注 (side comments) 呈现为小型文本。</p>

<p>免责声明、注意事项、法律限制或版权声明的特征通常都是小型文本。小型文本有时也用于新闻来源、许可要求。</p>

<p>对于由 em 元素强调过的或由 strong 元素标记为重要的文本，small 元素不会取消对文本的强调，也不会降低这些文本的重要性。</p>
</div>
...
&lt;dl&gt;
 &lt;dt&gt;单人间&lt;/dt&gt;
 &lt;dd&gt;399 元 <code>&lt;small&gt;含早餐，不含税&lt;/small&gt;</code>&lt;/dd&gt;
 &lt;dt&gt;双人间&lt;/dt&gt;
 &lt;dd&gt;599 元 <code>&lt;small&gt;含早餐，不含税&lt;/small&gt;</code>&lt;/dd&gt;
&lt;/dl&gt;
</pre>

<p><a href="/tiy/t.asp?f=html5_small">亲自试一试</a></p>
</div>
...
<p>实际运用时没有区别。在 HTML 4.01 中，small 元素显示为更小的文本。在 HTML5 中，small 元素定义旁注信息，并显示为更小的文本。</p>
</div>


<div>
<h2>全局属性</h2>
<p>&lt;small&gt; 标签支持 <a href="html5_ref_globalattributes.asp">HTML 5 中的全局属性</a>。</p>
</div>
 
 
<div>
<h2>事件属性</h2>
<p>&lt;small&gt; 标签支持 <a href="html5_ref_eventattributes.asp">HTML 5 中的事件属性</a>。</p>
</div>
