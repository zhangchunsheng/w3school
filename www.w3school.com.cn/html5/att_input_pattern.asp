...
<title>HTML 5 &lt;input&gt; pattern 属性</title>
</head>
...
<p>只能包含三个字母的文本字段（数字或特殊字符）：</p>

<pre>
  Country code: &lt;input type=&quot;text&quot; name=&quot;country_code&quot; <code>pattern=&quot;[A-z]{3}</code>&quot;
  title=&quot;Three letter country code&quot; /&gt;
</pre>

<p><a href="/tiy/t.asp?f=html5_input_pattern">亲自试一试</a></p>
</div>
...
<p>pattern 属性规定用于验证输入字段的模式。</p>

<p>模式指的是<a href="/js/js_obj_regexp.asp" title="JavaScript RegExp 对象">正则表达式</a>。您可以在我们的 JavaScript 教程中阅读到这方面的内容。</p>

<p class="note"><span>注释：</span>pattern 属性适用于以下 &lt;input&gt; 类型：text, search, url, telephone, email 以及 password 。</p>

<p class="tip"><span>提示：</span>请使用标准的 &quot;title&quot; 属性来描述模式。</p>
</div>
...
<pre>&lt;input pattern=&quot;<i>regexp</i>&quot;&gt;</pre>
