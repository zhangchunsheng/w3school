...
<title>HTML5 canvas fill() 方法</title>
...
<p><a target="_blank" href="/tiy/t.asp?f=html5_canvas_fill">亲自试一试</a></p>
</div>
...
<p>Internet Explorer 9、Firefox、Opera、Chrome 以及 Safari 支持 fill() 方法。</p>
...
<p class="tip"><span>提示：</span>请使用 fillStyle 属性来填充另一种颜色/渐变。</p>

<p class="note"><span>注释：</span>如果路径未关闭，那么 fill() 方法会从路径结束点到开始点之间添加一条线，以关闭该路径，然后填充该路径。</p>
