...
<li class="currentLink"><a href="/html5/tag_abbr.asp" title="HTML5 &lt;abbr&gt; 标签">&lt;abbr&gt;</a></li>
...
<p>浏览器可能会根据这个信息改变对这些文本的显示方式，或者用其他文本代替。也许当前流行的浏览器对 &lt;abbr&gt; 标签中包含的文本还没有任何处理方式，但是我们无法预测将来的版本将会如何实现该标签。</p>
</div>
...
<p><a href="/tiy/t.asp?f=html5_abbr">亲自试一试</a></p>
</div>
...
<div>
<h2>提示和注释：</h2>
<p class="note"><span>注释：</span>在某些浏览器中，当您把鼠标移至缩略词语上时，<em>title</em> 可用于展示表达的完整版本。</p>
</div>


<div>
<h2>全局属性</h2>
<p>&lt;abbr&gt; 标签支持 <a href="html5_ref_globalattributes.asp">HTML 5 中的全局属性</a>。</p>
</div>


<div>
<h2>事件属性</h2>
<p>&lt;abbr&gt; 标签支持 <a href="html5_ref_eventattributes.asp">HTML 5 中的事件属性</a>。</p>
</div>
