...
<title>HTML 5 &lt;del&gt; datetime 属性</title>
</head>
...
<pre>a dozen is &lt;del datetime="2011-02-21T19:55:09Z"&gt;21&lt;/del&gt; 12 pieces</pre>

<p><a href="/tiy/t.asp?f=html5_del_datetime">亲自试一试</a></p>
</div>
...
<td>
	...
	<li>YYYY - 年（比如 2011）</li>
	<li>MM - 月（比如 02）</li>
	<li>DD - 日（比如 21）</li>
	<li>T - 必需的分隔符</li>
	<li>hh - 小时（比如 19:00pm）</li>
	<li>mm - 分钟（比如 55）</li>
	<li>ss - 秒(比如 09)</li>
	<li>TZD - 时区指示符</li>
	</ul>
