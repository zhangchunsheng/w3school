...
<title>HTML5 canvas createImageData() 方法</title>
...
<p><a target="_blank" href="/tiy/t.asp?f=html5_canvas_createimagedata">亲自试一试</a></p>
</div>
...
<p>Internet Explorer 9、Firefox、Opera、Chrome 以及 Safari 支持 createImageData() 方法。</p>
...
<p>包含 color/alpha 信息的数组存储于 ImageData 对象的 <a href="/html5/canvas_imagedata_data.asp" title="HTML canvas data 属性">data</a> 属性中。</p>
