...
<title>HTML5 canvas bezierCurveTo() 方法</title>
...
<h1>HTML5 canvas bezierCurveTo() 方法</h1>
...
ctx.beginPath();
ctx.moveTo(20,20);
<code>ctx.bezierCurveTo(20,100,200,100,200,20);</code>
ctx.stroke();
</pre>

<p><a target="_blank" href="/tiy/t.asp?f=html5_canvas_beziercurveto">亲自试一试</a></p>
</div>
...
<p>Internet Explorer 9、Firefox、Opera、Chrome 以及 Safari 支持 bezierCurveTo() 方法。</p>
...
<p class="tip"><span>提示：</span>三次贝塞尔曲线需要三个点。前两个点是用于三次贝塞尔计算中的控制点，第三个点是曲线的结束点。曲线的开始点是当前路径中最后一个点。如果路径不存在，那么请使用 <a href="/html5/canvas_beginpath.asp" title="HTML5 canvas beginPath() 方法">beginPath()</a> 和 <a href="/html5/canvas_moveto.asp" title="HTML5 canvas moveTo() 方法">moveTo()</a> 方法来定义开始点。</p>

<img src="/i/beziercurve.gif" alt="三次贝塞尔曲线" />

<ul>
<li>开始点：moveTo(<span class="marked">20</span>,<span class="marked">20</span>)</li>
<li>控制点 1：bezierCurveTo(<span class="marked">20</span>,<span class="marked">100</span>,200,100,200,20)</li>
<li>控制点 2：bezierCurveTo(20,100,<span class="marked">200</span>,<span class="marked">100</span>,200,20)</li>
<li>结束点：bezierCurveTo(20,100,200,100,<span class="marked">200</span>,<span class="marked">20</span>)</li>
</ul>

<p class="tip"><span>提示：</span>请查看 
<a href="/html5/canvas_quadraticcurveto.asp" title="HTML5 canvas quadraticCurveTo() 方法">quadraticCurveTo() 方法</a>。它有一个控制点，而不是两个。</p>

<h3>JavaScript 语法：</h3>

<pre>context.bezierCurveTo(<i>cp1x</i>,<i>cp1y</i>,<i>cp2x</i>,<i>cp2y</i>,<i>x</i>,<i>y</i>);</pre>
