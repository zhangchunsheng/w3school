...
<li class="currentLink"><a href="/html5/tag_base.asp" title="HTML5 &lt;base&gt; 标签">&lt;base&gt;</a></li>
...
<p>假设图像的绝对地址是：</p>
<pre>&lt;img src=&quot;http://www.w3school.com.cn/i/pic.gif&quot; /&gt;</pre>

<p>现在我们在页面中的 head 部分插入 &lt;base&gt; 标签，规定页面中所有链接的基准 url：</p>
<pre>
&lt;head&gt;
...
<p>在上例中的页面上插入图像时，我们必须规定相对的地址，浏览器会寻找文件所使用的完整 URL：</p>
<pre>&lt;img src=&quot;pic.gif&quot; /&gt;</pre>

<h3>例子 2</h3>

<p>规定页面上所有链接的默认 URL 和默认目标：</p>

<pre>
&lt;head&gt;
<code>&lt;base href=&quot;http://www.w3school.com.cn/css/&quot; target=&quot;_blank&quot; /&gt;</code>
&lt;/head&gt;
...
<p><a href="/tiy/t.asp?f=html5_base">亲自试一试</a></p>
</div>
...
<p class="tip"><span>提示：</span>请把 &lt;base&gt; 标签排在 head 元素中第一个元素的位置，这样 head 中其他元素就可以利用 &lt;base&gt; 元素中的信息了。</p>

<p class="note"><span>注释：</span>在一个文档中，最多能使用一个 &lt;base&gt; 元素。</p>
</div>
...
<table class="dataintable">
  ...
  <tr>
    <td><a href="/html5/att_base_href.asp" title="HTML5 &lt;base&gt; href 属性">href</a></td>
    <td><i>URL</i></td>
    <td>规定作为基准 URL 在页面中使用的 URL。</td>
  </tr>
	<tr>
    <td><a href="/html5/att_base_target.asp" title="HTML5 &lt;base&gt; target 属性">target</a></td>
    <td>
		<ul>
		<li>_blank</li>
		<li>_parent</li>
    ...
    <td>在何处打开页面上的链接。该属性会被每个链接中的 target 属性覆盖。</td>
  </tr>
</table>
</div>
