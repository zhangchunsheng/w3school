...
<title>HTML5 canvas translate() 方法</title>
...
<h1>HTML5 canvas translate() 方法</h1>
...
var ctx=c.getContext(&quot;2d&quot;);
ctx.fillRect(10,10,100,50);
<code>ctx.translate(70,70);</code>
ctx.fillRect(10,10,100,50);
</pre>

<p><a target="_blank" href="/tiy/t.asp?f=html5_canvas_translate">亲自试一试</a></p>
</div>
...
<p>Internet Explorer 9、Firefox、Opera、Chrome 以及 Safari 支持 translate() 方法。</p>
...
<p class="note"><span>注释：</span>当您在 translate() 之后调用诸如 fillRect() 之类的方法时，值会添加到 x 和 y 坐标值上。</p>

<img src="/i/translate.gif" alt="translate() 方法的图示" />

<h3>JavaScript 语法：</h3>

<pre>context.translate(<i>x</i>,<i>y</i>);</pre>
