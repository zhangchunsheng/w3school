...
<title>HTML 5 &lt;form&gt; enctype 属性</title>
</head>
...
<p>发送以 multipart/form-data 编码的表单数据：</p>

<pre>
&lt;form action=&quot;demo_post_enctype.asp&quot;
method=&quot;post&quot; <code>enctype=&quot;multipart/form-data&quot;</code>&gt;
...
<p><a href="/tiy/t.asp?f=html5_form_enctype">亲自试一试</a></p>
</div>
...
<p>enctype 属性规定在将表单数据发送到服务器之前如何对其进行编码。</p>

<p>默认是对表单数据以 &quot;application/x-www-form-urlencoded&quot; 进行编码。这意味着在发送前对所有字符进行编码（把 &quot;+&quot; 转换为空格，把特殊字符转换为 ASCII 十六进制值）。</p>
</div>
...
<pre>&lt;form enctype=&quot;<i>value</i>&quot;&gt;</pre>
