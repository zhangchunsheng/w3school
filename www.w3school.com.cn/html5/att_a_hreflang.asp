...
<title>HTML 5 &lt;a&gt; 标签的 hreflang 属性</title>
</head>
...
<h1>HTML 5 &lt;a&gt; 标签的 hreflang 属性</h1>
...
<p>hreflang 属性在链接中规定文档的语言：</p>

<pre>&lt;a href=&quot;http://www.w3school.com.cn&quot; <code>hreflang=&quot;zh&quot;</code>&gt;w3school&lt;/a&gt;</pre>

<p><a href="/tiy/t.asp?f=html5_a_hreflang">亲自试一试</a></p>
</div>
...
<p>hreflang 属性规定被链接文档的语言。</p>

<p>仅在使用 href 属性时才可以指定 hreflang 属性。和 lang 属性类似，hreflang 属性的值也是 ISO 标准的双字符语言代码。和 lang 属性不同的是，hreflang 属性不会指定标签中的内容所使用的语言，而是指定被 href 属性调用的文档所使用的语言。</p>
</div>
...
<table class="dataintable">
  ...
  <tr>
    ...
    <td>
		<p>双字符的语言代码，指定被链接文档的语言。</p>
		<p>如需查看所有可用的语言代码，请访问我们的 <a href="/tags/html_ref_language_codes.asp" title="HTML 语言代码参考手册">语言代码集参考手册</a>。</p>
    </td>
  </tr>
</table>
</div>
