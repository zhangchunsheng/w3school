...
<title>HTML 5 &lt;script&gt; defer 属性</title>
</head>
...
<pre>
&lt;script type=&quot;text/javascript&quot; src=&quot;demo_defer.js&quot; <code>defer=&quot;defer&quot;</code>&gt;&lt;/script&gt;
</pre>

<p><a href="/tiy/t.asp?f=html5_script_defer">亲自试一试</a></p>
</div>
...
<p>defer 属性规定当页面已完成加载后，才会执行脚本。</p>

<p class="note"><span>注释：</span>defer 属性仅适用于外部脚本（只有在使用 src 属性时）。</p>
