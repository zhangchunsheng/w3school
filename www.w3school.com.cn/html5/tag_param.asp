...
<li class="currentLink"><a href="/html5/tag_param.asp" title="HTML5 &lt;param&gt; 标签">&lt;param&gt;</a></li>
...
<h1>HTML 5 &lt;param&gt; 标签</h1>


<div>
<h2>定义和用法</h2>
<p>param 元素允许您为插入 XHTML 文档的对象规定 run-time 设置，也就是说，此标签可为包含它的 &lt;object&gt; 标签提供参数。</p>
</div>
...
<table class="dataintable">
  ...
  <tr>
    <td>type</td>
    <td>MIME type</td>
    <td>规定参数的 MIME 类型（internet media type）。不支持。</td>
    <td>4</td>
    <td>&nbsp;</td>
  </tr>
  <tr>
...
<div>
<h2>全局属性</h2>
<p>&lt;param&gt; 标签支持 <a href="html5_ref_globalattributes.asp">HTML 5 中的全局属性</a>。</p>
</div>
 
 
<div>
<h2>事件属性</h2>
<p>&lt;param&gt; 标签支持 <a href="html5_ref_eventattributes.asp">HTML 5 中的事件属性</a>。</p>
</div>
