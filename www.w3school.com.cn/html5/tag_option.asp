...
<li class="currentLink"><a href="/html5/tag_option.asp" title="HTML5 &lt;option&gt; 标签">&lt;option&gt;</a></li>
...
<h1>HTML 5 &lt;option&gt; 标签</h1>


<div>
<h2>定义和用法</h2>
<p>&lt;option&gt; 标签定义下拉列表中的一个选项。</p>
</div>


<div>
<h2>HTML 4.01 与 HTML 5 之间的差异</h2>
<p>在 HTML 5 中，&lt;option&gt; 标签也用于新元素 &lt;datalist&gt; 中。</p>
</div>


<div>
<h2>提示和注释</h2>
<p class="note"><span>注释：</span>&lt;option&gt; 标签能够在不带任何属性的情况下使用，但是通常需要 value 属性，该属性定义了发送到服务器的数据。</p>
<p class="note"><span>注释：</span>请与 &lt;select&gt; 或 &lt;datalist&gt; 标签结合使用。在其他地方，&lt;option&gt; 标签是无意义的。</p>
</div>
...
<div>
<h2>全局属性</h2>
<p>&lt;option&gt; 标签支持 <a href="html5_ref_globalattributes.asp">HTML 5 中的全局属性</a>。</p>
</div>
 
 
<div>
<h2>事件属性</h2>
<p>&lt;option&gt; 标签支持 <a href="html5_ref_eventattributes.asp">HTML 5 中的事件属性</a>。</p>
</div>
