...
<title>HTML 5 全局 contextmenu 属性</title>
</head>
...
<h1>HTML 5 全局 contextmenu 属性</h1>
...
<p>为 &lt;p&gt; 元素规定一个上下文菜单。该菜单会在用户右键点击该元素时出现：</p>

<pre>
&lt;p <code>contextmenu=&quot;supermenu&quot;</code>&gt;这个段落附加了一个名为 &quot;supermenu&quot; 的上下文菜单。&lt;/p&gt;
...
<p><a href="/tiy/t.asp?f=html5_global_contextmenu">亲自试一试</a></p>
</div>
...
<p>目前没有任何主流浏览器支持 contextmenu 属性。</p>
</div>
...
<p>contextmenu 属性为元素规定上下文菜单。这个菜单会在用户右键点击元素时出现。</p>

<p>contextmenu 属性的值是需要打开的 &lt;menu&gt; 元素的 id。</p>
</div>
...
<p>contextmenu 属性是 HTML5 中的新属性。</p>
</div>
