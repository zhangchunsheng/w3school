...
<title>HTML 5 &lt;blockquote&gt; 标签</title>
</head>
...
<li class="currentLink"><a href="/html5/tag_blockquote.asp" title="HTML5 &lt;blockquote&gt; 标签">&lt;blockquote&gt;</a></li>
...
<h1>HTML 5 &lt;blockquote&gt; 标签</h1>


<div>
<h2>定义和用法</h2>

<p>&lt;blockquote&gt; 标签定义摘自另一个源的块引用。</p>

<p>&lt;blockquote&gt; 与 &lt;/blockquote&gt; 之间的所有文本都会从常规文本中分离出来，经常会在左、右两边进行缩进，而且有时会使用斜体。也就是说，块引用拥有它们自己的空间。</p>
</div>
...
<p><a href="/tiy/t.asp?f=html5_blockquote">亲自试一试</a></p>
</div>
...
<p class="tip"><span>提示：</span>如果标记是不需要段落分隔的短引用，请使用 <a href="/html5/tag_q.asp" title="HTML 5 &lt;q&gt; 标签">&lt;q&gt; 元素</a>。</p>

<p class="note"><span>注释：</span>blockquote 只应该应用于来自另一个源的引用。</p>
</div>
...
<table class="dataintable">
  ...
  <tr>
    <td><a href="/html5/att_blockquote_cite.asp" title="HTML5 &lt;blockquote&gt; cite 属性">cite</a></td>
    <td>URL</td>
    <td>引用的 URL，如果引用来自网络的话。</td>
  </tr>
</table>
</div>
...
<div>
<h2>全局属性</h2>
<p>&lt;blockquote&gt; 标签支持 <a href="html5_ref_globalattributes.asp">HTML 5 中的全局属性</a>。</p>
</div>
 
 
<div>
<h2>事件属性</h2>
<p>&lt;blockquote&gt; 标签支持 <a href="html5_ref_eventattributes.asp">HTML 5 中的事件属性</a>。</p>
</div>
