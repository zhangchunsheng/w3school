...
<li class="currentLink"><a href="/html5/tag_div.asp" title="HTML5 &lt;div&gt; 标签">&lt;div&gt;</a></li>
...
<p>&lt;div&gt; 标签定义 HTML 文档中的分隔（division）或部分（section）。</p>

<p>&lt;div&gt; 标签常用于组合块级元素，以便通过样式表来对这些元素进行格式化。</p>
</div>
...
<p><a href="/tiy/t.asp?f=html5_div">亲自试一试</a></p>
</div>
...
<p>HTML 4.01 中是不赞成使用 &quot;align&quot; 属性，在 HTML 5 中不支持该属性。</p>
</div>


<div>
<h2>提示和注释</h2>
<p class="note"><span>注释：</span>浏览器通常会在 div 元素之前和之后插入换行符。</p>
<p class="tip"><span>提示：</span>&lt;div&gt; 标签常用于对块级元素进行组合，这样就可以使用样式对它们进行格式化。</p>
</div>


<div>
<h2>全局属性</h2>
<p>&lt;div&gt; 标签支持 <a href="html5_ref_globalattributes.asp">HTML 5 中的全局属性</a>。</p>
</div>
 
 
<div>
<h2>事件属性</h2>
<p>&lt;div&gt; 标签支持 <a href="html5_ref_eventattributes.asp">HTML 5 中的事件属性</a>。</p>
</div>
