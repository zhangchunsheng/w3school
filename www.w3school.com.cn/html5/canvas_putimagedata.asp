...
<title>HTML5 canvas putImageData() 方法</title>
...
<h1>HTML5 canvas putImageData() 方法</h1>
...
<code>ctx.putImageData(imgData,10,70);</code>
}
</pre>

<p><a target="_blank" href="/tiy/t.asp?f=html5_canvas_getimagedata">亲自试一试</a></p>
</div>
...
<p>Internet Explorer 9、Firefox、Opera、Chrome 以及 Safari 支持 putImageData() 方法。</p>
...
<p class="tip"><span>提示：</span>请参阅 <a href="/html5/canvas_getimagedata.asp" title="HTML canvas getImageData() 方法">getImageData()</a> 方法，它可复制画布上指定的矩形的像素数据。</p>

<p class="tip"><span>提示：</span>请参阅 <a href="/html5/canvas_createimagedata.asp" title="HTML canvas createImageData() 方法">createImageData()</a> 方法，它可创建新的空白 ImageData 对象。</p>

<h3>JavaScript 语法：</h3>

<pre><i>context</i>.putImageData(<i>imgData</i>,<i>x</i>,<i>y</i>,<i>dirtyX</i>,<i>dirtyY</i>,<i>dirtyWidth</i>,<i>dirtyHeight</i>);</pre>
