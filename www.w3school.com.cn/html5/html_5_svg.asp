...
<li class="currentLink"><a href="/html5/html_5_svg.asp" title="HTML5 内联 SVG">HTML5 SVG</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/html5/html_5_canvas.asp" title="HTML5 Canvas">HTML5 画布</a></li>
<li class="next"><a href="/html5/html_5_canvas_vs_svg.asp" title="HTML5 Canvas vs. SVG">HTML5 画布 vs SVG</a></li>
</ul>
</div>


<div id="intro">
<p><strong>HTML5 支持内联 SVG。</strong></p>
</div>
...
<p>Internet Explorer 9、Firefox、Opera、Chrome 以及 Safari 支持内联 SVG。</p>
</div>
...
<p><a href="/tiy/t.asp?f=html5_svg_ex">亲自试一试</a></p>
...
<p>如需学习更多有关 SVG 的知识，请阅读我们的 <a href="/svg/index.asp" title="SVG 教程">SVG 教程</a>。</p>
</div>
