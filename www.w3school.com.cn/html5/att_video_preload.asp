...
<title>HTML 5 &lt;video&gt; preload 属性</title>
</head>
...
<p><a href="/tiy/t.asp?f=html5_video_preload">亲自试一试</a></p>
</div>
...
<td>
	...
	<li>auto - 当页面加载后载入整个视频</li>
	<li>meta - 当页面加载后只载入元数据</li>
	<li>none - 当页面加载后不载入视频</li>
	</ul>
</td>
</tr>
</table>
