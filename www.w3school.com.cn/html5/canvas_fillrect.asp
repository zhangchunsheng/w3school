...
<title>HTML5 canvas fillRect() 方法</title>
...
<h1>HTML5 canvas fillRect() 方法</h1>
...
var c=document.getElementById(&quot;myCanvas&quot;);
var ctx=c.getContext(&quot;2d&quot;);
<code>ctx.fillRect(20,20,150,100);</code>
</pre>

<p><a target="_blank" href="/tiy/t.asp?f=html5_canvas_fillrect">亲自试一试</a></p>
</div>
...
<p>Internet Explorer 9、Firefox、Opera、Chrome 以及 Safari 支持 fillRect() 方法。</p>
...
<p>fillRect() 方法绘制“已填色”的矩形。默认的填充颜色是黑色。</p>

<p class="tip"><span>提示：</span>请使用 <a href="/html5/canvas_fillstyle.asp" title="HTML5 canvas fillStyle 属性">fillStyle</a> 属性来设置用于填充绘图的颜色、渐变或模式。</p>
