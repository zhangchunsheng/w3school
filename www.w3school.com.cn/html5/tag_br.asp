...
<li class="currentLink"><a href="/html5/tag_br.asp" title="HTML5 &lt;br&gt; 标签">&lt;br&gt;</a></li>
...
<p>&lt;br /&gt; 标签是一个空标签，意味着它没有结束标签。所以这样是错误的：&lt;br&gt;&lt;/br&gt;</p>
</div>
...
<pre>This text contains<code>&lt;br /&gt;</code>a line break</pre>
...
<p><a href="/tiy/t.asp?f=html5_br">亲自试一试</a></p>
</div>
...
<p class="tip"><span>提示：</span>请使用 &lt;br /&gt; 标签来输入空行，而不是分隔段落。</p>
</div>


<div>
<h2>全局属性</h2>
<p>&lt;br /&gt; 标签支持 <a href="html5_ref_globalattributes.asp">HTML 5 中的全局属性</a>。</p>
</div>
 
 
<div>
<h2>事件属性</h2>
<p>&lt;br /&gt; 标签支持 <a href="html5_ref_eventattributes.asp">HTML 5 中的事件属性</a>。</p>
</div>
