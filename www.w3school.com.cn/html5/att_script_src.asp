...
<title>HTML 5 &lt;script&gt; src 属性</title>
</head>
...
<p>执行一个外部 JavaScript 文件：</p>

<pre>
&lt;script type=&quot;text/javascript&quot; <code>src=&quot;demo_time.js&quot;</code>&gt;&lt;/script&gt;
</pre>

<p><a href="/tiy/t.asp?f=html5_script_src">亲自试一试</a></p>
</div>
...
<p>如果您希望在网站中的多个页面上运行相同的 JavaScript，就应该创建外部 JavaScript 文件，而不是重复编写脚本。把脚本文件以 .js 扩展名进行保存，然后在 &lt;script&gt; 标签中使用 src 属性引用它。</p>

<p class="note"><span>注释：</span>外部脚本文件不能包含 &lt;script&gt; 标签。</p>
</div>
...
<table class="dataintable">
  ...
  <tr>
    ...
    <li>绝对 URL - 指向另一个网站（比如 src=&quot;http://www.example.com/example.js&quot;）</li>
    <li>相对 URL - 指向网站内的文件（比如 src=&quot;/scripts/example.js&quot;）</li>
    </ul>
	</td>
  </tr>
</table>
