...
<li class="currentLink"><a href="/html5/tag_ins.asp" title="HTML5 &lt;ins&gt; 标签">&lt;ins&gt;</a></li>
...
<div>
<h2>例子</h2>
<p class="tip"><span>提示：</span>请与 &lt;del&gt; 标签一起使用，来描述对文档的更新和修正。</p>
</div>
...
<table class="dataintable">
  ...
  <tr>
    <td>cite</td>
    <td>URL</td>
    <td>指向另一个文档的 URL，该文档解释文本插入的原因。</td>
    <td>4</td>
    <td>5</td>
  </tr>
  <tr>
...
<div>
<h2>全局属性</h2>
<p>&lt;ins&gt; 标签支持 <a href="html5_ref_globalattributes.asp">HTML 5 中的全局属性</a>。</p>
</div>
 
 
<div>
<h2>事件属性</h2>
<p>&lt;ins&gt; 标签支持 <a href="html5_ref_eventattributes.asp">HTML 5 中的事件属性</a>。</p>
</div>
