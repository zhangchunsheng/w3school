...
<title>HTML 5 &lt;form&gt; method 属性</title>
</head>
...
<h1>HTML 5 &lt;form&gt; method 属性</h1>


<div class="backtoreference">
<p><a href="/html5/tag_form.asp">HTML 5 &lt;form&gt; 标签</a></p>
</div>
...
<pre>
&lt;form action=&quot;demo_post_enctype.asp&quot; <code>method=&quot;post&quot;</code>&gt;
...
<p><a href="/tiy/t.asp?f=html5_form_method">亲自试一试</a></p>
</div>
...
<p>method 方法规定如何发送表单数据（form-data）（表单数据会被发送到在 action 属性中规定的页面中）。</p>

<p>可以通过以下方式发送 form-data ：</p>

<ul>
<li>以 URL 变量 (使用 method=&quot;get&quot;) 的形式来发送</li>
<li>以 HTTP post (使用 method=&quot;post&quot;) 的形式来发送</li>
</ul>

<p>关于 &quot;get&quot; 方法的注释：</p>

<ul>
<li>该方法将表单数据以名称/值对的形式附加到 URL 中</li>
<li>该方法对于用户希望加入书签的表单提交很有用</li>
<li>在 URL 中放置的数据量是有限制的（不同的浏览器有差别），所以无法确保所有表单数据得到正确地传输</li>
<li>绝不要使用 &quot;get&quot; 方法来传输敏感信息！（密码或其他敏感信息在浏览器地址栏中是可见的）</li>
</ul>

<p>关于 &quot;post&quot; 方法的注释：</p>

<ul>
<li>该方法以 HTTP post 事务的方式来传递表单数据</li>
<li>无法将通过 &quot;post&quot; 方法提交的表单加入书签</li>
<li>与 &quot;get&quot; 相比，&quot;post&quot; 方法更健壮更安全，而且 &quot;post&quot; 没有容量限制</li>
</ul>
</div>
...
<tr>
<td>get</td>
<td>向 URL 追加表单数据（form-data）：<i>URL</i>?<i>name</i>=<i>value</i>&amp;<i>name</i>=<i>value</i></td>
</tr>
 
<tr>
<td>post</td>
<td>以 HTTP post 事务的形式发送表单数据（form-data）</td>
</tr>
</table>
</div>
