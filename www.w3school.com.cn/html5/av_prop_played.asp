...
<title>HTML 5 Audio/Video DOM played 属性</title>
...
<h1>HTML 5 Audio/Video DOM played 属性</h1>
...
<p>获得视频中以秒计的首段已播放的范围（部分）：</p>

<pre>
myVid=document.getElementById(&quot;video1&quot;);
alert(&quot;Start: &quot; + <code>myVid.played.start(0)</code> + &quot; End: &quot; + <code>myVid.played.end(0))</code>;
</pre>

<p><a href="/tiy/t.asp?f=html5_av_prop_played">亲自试一试</a></p>
</div>
...
<p>played 属性返回 TimeRanges 对象。</p>

<p>TimeRanges 对象表示用户已经播放或看到的音频/视频范围。</p>

<p>已播范围指的是被播放音频/视频的时间范围。如果用户在音频/视频中跳跃，则会获得多个播放范围。</p>
</div>
...
<p>Chrome、Safari 以及 Internet Explorer 支持 played 属性。</p>
...
<td>
	<p>表示音频/视频的已播范围。</p>	
	<p>TimeRanges 对象的属性：</p>
	<ul class="listintable">
	<li>length - 获得音频/视频中已播范围的数量</li>
	<li>start(<i>index</i>) - 获得某个已播范围的开始位置</li>
	<li>end(<i>index</i>) - 获得某个已播范围的结束位置</li>
	</ul>
	<p class="note"><span>注释：</span>首段已播范围的下标是 0。</p>
</td>
</tr>
</table>
