...
<title>HTML 5 Audio/Video DOM autoplay 属性</title>
...
<h1>HTML 5 Audio/Video DOM autoplay 属性</h1>
...
<code>myVid.autoplay=true</code>;
myVid.load();
</pre>

<p><a href="/tiy/t.asp?f=html5_av_prop_autoplay">亲自试一试</a></p>
</div>
...
<p>autoplay 属性设置或返回音视频是否在加载后即开始播放。</p>
</div>
...
<p>设置 autoplay 属性：</p>
<pre>audio|video.autoplay=true|false</pre>

<p>返回 autoplay 属性：</p>
<pre>audio|video.autoplay</pre>
...
<tr>
<td>true</td>
<td>指示音视频在加载完成后随即播放。</td>
</tr>

<tr>
<td>false</td>
<td>默认。指示音视频不应在加载后立即播放。</td>
</tr>
</table>
</div>
