...
<title>HTML 5 Audio/Video DOM networkState 属性</title>
...
<h1>HTML 5 Audio/Video DOM networkState 属性</h1>
...
alert(<code>myVid.networkState</code>);
</pre>

<p><a href="/tiy/t.asp?f=html5_av_prop_networkstate">亲自试一试</a></p>
</div>
...
<p>networkState 属性返回音频/视频的当前网络状态（activity）。</p>
</div>
...
<p>所有主流浏览器都支持 networkState 属性。</p>
...
<pre>audio|video.networkState</pre>
