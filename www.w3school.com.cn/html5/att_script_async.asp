...
<title>HTML 5 &lt;script&gt; async 属性</title>
</head>
...
<pre>
&lt;script type=&quot;text/javascript&quot; src=&quot;demo_async.js&quot; <code>async=&quot;async&quot;</code>&gt;&lt;/script&gt;
</pre>

<p><a href="/tiy/t.asp?f=html5_script_async">亲自试一试</a></p>
</div>
...
<p class="note"><span>注释：</span>async 属性仅适用于外部脚本（只有在使用 src 属性时）。</p>
