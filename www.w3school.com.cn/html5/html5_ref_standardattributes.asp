...
<li class="currentLink"><a href="/html5/html5_ref_standardattributes.asp" title="HTML5 标准属性">HTML5 属性</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/html5/html5_reference.asp" title="HTML5 参考手册">HTML5 标签</a></li>
<li class="next"><a href="/html5/html5_ref_eventattributes.asp" title="HTML5 事件属性">HTML5 事件</a></li>
</ul>
</div>


<div id="intro">
<p><strong>所有 HTML 5 标签均支持下面列出的属性，仅有少数例外。</strong></p>
</div>
...
<p class="important"><span>NEW：</span>HTML 5 中新的标准属性。</p>
<p class="note"><span>注释：</span>HTML 4.01 不再支持 accesskey 属性：</p>
...
<tr>
<td class="html5_new">contenteditable</td>
<td>
	<ul>
	<li>true</li>
	<li>false</li>
...
<tr>
<td class="html5_new">contextmenu</td>
<td><i>menu_id</i></td>
<td>规定元素的上下文菜单。</td>
</tr>

<tr>
<td class="html5_new">data-yourvalue</td>
<td><i>value</i></td>
<td>
	<p>创作者定义的属性。</p>
	<p>HTML 文档的创作者可以定义他们自己的属性。</p>
	<p>必须以 &quot;data-&quot; 开头。</p>
</td>
</tr>
...
<tr>
<td class="html5_new">draggable</td>
<td>
	<ul>
	<li>true</li>
	<li>false</li>
...
<tr>
<td class="html5_new">itemprop</td>
<td>
	<ul>
	<li><i>url</i></li>
	<li><i>group value</i></li>
	</ul>
</td>
<td>用于组合项目。</td>
</tr>
...
<td>规定元素中内容的语言代码。<a href="/tags/html_ref_language_codes.asp" title="HTML 语言代码参考手册">语言代码参考手册</a>。</td>
</tr>

<tr>
<td class="html5_new">spellcheck</td>
<td>
	<ul>
	<li>true</li>
	<li>false</li>
