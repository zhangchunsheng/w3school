...
<title>HTML 5 &lt;td&gt; headers 属性</title>
</head>
...
<p><a href="/tiy/t.asp?f=html5_td_headers">亲自试一试</a></p>
</div>
...
<p>headers 属性规定与单元格相关联的一个或多个表头单元格。</p>
</div>
...
<pre>&lt;td headers=&quot;<i>header_id</i>&quot;&gt;</pre>
...
<tr>
<td><i>header_id</i></td>
<td>规定空格分隔的 id 列表，定义单元格关联的一个或多个表头单元格。</td>
</tr>
</table>
</div>
