...
<title>HTML 5 &lt;input&gt; required 属性</title>
</head>
...
<h1>HTML 5 &lt;input&gt; required 属性</h1>
...
<p><a href="/tiy/t.asp?f=html5_input_required">亲自试一试</a></p>
</div>
...
<p>required 属性规定必需在提交之前填写输入字段。</p>

<p>如果使用该属性，则字段是必填（或必选）的。</p>

<p class="note"><span>注释：</span>required 属性适用于以下 &lt;input&gt; 类型：text, search, url, telephone, email, password, date pickers, number, checkbox, radio 以及 file。</p>
</div>
