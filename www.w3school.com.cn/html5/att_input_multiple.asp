...
<title>HTML 5 &lt;input&gt; multiple 属性</title>
</head>
...
<h1>HTML 5 &lt;input&gt; multiple 属性</h1>
...
<p><a href="/tiy/t.asp?f=html5_input_multiple">亲自试一试</a></p>
</div>
...
<p>multiple 属性规定输入字段可选择多个值。</p>

<p>如果使用该属性，则字段可接受多个值。</p>

<p class="note"><span>注释：</span>multiple 属性使用欧冠与以下 &lt;input&gt; 类型：email 和 file。</p>
</div>
...
<pre>&lt;input multiple=&quot;multiple&quot;&gt;</pre>
</div>
