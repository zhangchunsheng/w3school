...
<title>HTML 5 全局 hidden 属性</title>
</head>
...
<pre>
&lt;p <code>hidden=&quot;hidden&quot;</code>&gt;这是一个段落。&lt;/p&gt;
</pre>

<p><a href="/tiy/t.asp?f=html5_global_hidden">亲自试一试</a></p>
</div>
...
<p>hidden 属性规定对元素进行隐藏。</p>

<p>隐藏的元素不会被显示。</p>

<p>如果使用该属性，则会隐藏元素。</p>

<p>可以对 hidden 属性进行设置，使用户在满足某些条件时才能看到某个元素（比如选中复选框，等等）。然后，可使用 JavaScript 来删除 hidden 属性，使该元素变得可见。</p>
</div>
