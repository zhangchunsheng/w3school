...
<title>HTML 5 &lt;input&gt; accept 属性</title>
</head>
...
<p>在文件上传控件中使用 accept 属性（允许上传两种文件类型：gif 和 jpeg）：</p>

<pre>
&lt;form action=&quot;demo_form.asp&quot;&gt;
  &lt;input type=&quot;file&quot; name=&quot;pic&quot; <code>accept=&quot;image/gif,image.jpg&quot;</code> /&gt;
  &lt;input type=&quot;submit&quot; /&gt;
&lt;/form&gt;
</pre>

<p><a href="/tiy/t.asp?f=html5_input_accept">亲自试一试</a></p>
</div>
...
<p>accept 属性仅适用于 &lt;input type=&quot;file&quot;&gt;，它规定了可通过文件上传提交的文件类型。</p>

<p class="tip"><span>提示：</span>请不要将该属性作为您唯一的验证工具。应该在服务器上对文件上传进行验证。</p>
</div>
...
<table class="dataintable">
  ...
  <tr>
    <td><i>MIME_type</i></td>
    <td>
	<p>能够被提交或上传的一个或多个 MIME 类型。</p>
	<p>如需规定多个 MIME 类型，请使用逗号分隔这些类型。</p>
	<p>参阅：<a href="http://www.iana.org/assignments/media-types/">IANA MIME 类型</a>（标准 MIME 类型的完整列表）。</p>
	</td>
  </tr>
</table>
</div>
