...
<title>HTML 5 全局 draggable 属性</title>
</head>
...
<pre>
&lt;p <code>draggable=&quot;true&quot;</code>&gt;This is a draggable paragraph.&lt;/p&gt;
</pre>

<p><a href="/tiy/t.asp?f=html5_global_draggable">亲自试一试</a></p>
</div>
...
<p>目前只有 Firefox、Chrome 以及 Safari 支持 draggable 属性。</p>
</div>
...
<p class="tip"><span>提示：</span>链接和图像默认是可拖动的。</p>

<p class="tip"><span>提示：</span>draggable 属性经常用于拖放操作。请阅读我们的 <a href="/html5/html_5_draganddrop.asp" title="HTML5 拖放">HTML5 拖放教程</a>，以学习更多知识。</p>
</div>
