...
<li class="currentLink"><a href="/html5/tag_b.asp" title="HTML5 &lt;b&gt; 标签">&lt;b&gt;</a></li>
...
<p><a href="/tiy/t.asp?f=html5_b">亲自试一试</a></p>
</div>
...
<p>没有区别。</p>
<p>但是在 HTML 4.01 中，我们的理解是使用 CSS 来制作粗体的文本。在 HTML 5 中，我们仍然可以这么理解，不过我们应该使用 &lt;b&gt; 标签定义文本中需要强调的部分。</p>
</div>
...
<p>如果您希望把文本标记为相比其他文本更为重要，应该使用 <a href="/html5/tag_phrase_elements.asp">&lt;strong&gt;</a> 标签。</p>
</div>


<div>
<h2>全局属性</h2>
<p>&lt;b&gt; 标签支持 <a href="html5_ref_globalattributes.asp">HTML 5 中的全局属性</a>。</p>
</div>
 
 
<div>
<h2>事件属性</h2>
<p>&lt;b&gt; 标签支持 <a href="html5_ref_eventattributes.asp">HTML 5 中的事件属性</a>。</p>
</div>
