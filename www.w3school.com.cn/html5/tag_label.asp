...
<li class="currentLink"><a href="/html5/tag_label.asp" title="HTML5 &lt;label&gt; 标签">&lt;label&gt;</a></li>
...
<h1>HTML 5 &lt;label&gt; 标签</h1>


<div>
<h2>定义和用法</h2>

<p>&lt;label&gt; 标签为 input 元素定义标签（label）。</p>

<p>label 元素不会向用户呈现任何特殊的样式。不过，它为鼠标用户改善了可用性，因为如果用户点击 label 元素内的文本，则会切换到控件本身。</p>

<p>&lt;label&gt; 标签的 for 属性应该等于相关元素的 id 元素，以便将它们捆绑起来。</p>
</div>
...
<p>带有两个输入字段和相关标签的简单 HTML 表单：</p>

<pre>
&lt;form&gt;
<code>&lt;label <span class="marked">for=&quot;male&quot;</span>&gt;Male&lt;/label&gt;</code>
&lt;input type=&quot;radio&quot; name=&quot;sex&quot; <span class="marked">id=&quot;male&quot;</span> /&gt;
&lt;br /&gt;
<code>&lt;label <span class="marked">for=&quot;female&quot;</span>&gt;Female&lt;/label&gt;</code>
&lt;input type=&quot;radio&quot; name=&quot;sex&quot; <span class="marked">id=&quot;female&quot;</span> /&gt;
&lt;/form&gt;
</pre>

<p><a href="/tiy/t.asp?f=html5_label">亲自试一试</a></p>
</div>
...
<p>&quot;form&quot; 属性是 HTML5 中的新属性。</p>
</div>


<div>
<h2>提示和注释</h2>
<p class="note"><span>注释：</span>可以通过使用 &quot;for&quot; 属性将 label 绑定到另一个元素，或者直接在 label 元素内部放置元素。</p>
</div>
...
<tr>
<td><a href="/html5/att_label_for.asp" title="HTML5 &lt;label&gt; for 属性">for</a></td>
<td><i>id</i></td>
<td>规定 label 绑定到哪个表单元素。</td>
</tr>

<tr>
<td class="html5_new"><a href="/html5/att_label_form.asp" title="HTML5 &lt;label&gt; form 属性">form</a></td>
<td><i>formid</i></td>
<td>规定 label 字段所属的一个或多个表单。</td>
</tr>
</table>
</div>
...
<div>
<h2>全局属性</h2>
<p>&lt;label&gt; 标签支持 <a href="html5_ref_globalattributes.asp">HTML 5 中的全局属性</a>。</p>
</div>
 
 
<div>
<h2>事件属性</h2>
<p>&lt;label&gt; 标签支持 <a href="html5_ref_eventattributes.asp">HTML 5 中的事件属性</a>。</p>
</div>
