...
<li class="currentLink"><a href="/html5/tag_body.asp" title="HTML5 &lt;body&gt; 标签">&lt;body&gt;</a></li>
...
<h1>HTML 5 &lt;body&gt; 标签</h1>


<div>
<h2>定义和用法</h2>
<p>&lt;body&gt; 元素定义文档的主体。</p>
<p>&lt;body&gt; 元素包含文档的所有内容，比如文本、超链接、图像、表格、列表等等。</p>
</div>
...
<p>一个简单的 HTML 文档，拥有尽可能少的必需的标签：</p>
...
<p><a href="/tiy/t.asp?f=html5_body">亲自试一试</a></p>
</div>


<div>
<h2>HTML 4.01 与 HTML 5 之间的差异</h2>
<p>在 HTML 5 中，删除了所有 &lt;body&gt; 的特殊属性。而那些属性在 HTML 4.01 中是不被赞成使用的。</p>
</div>


<div>
<h2>全局属性</h2>
<p>&lt;body&gt; 标签支持 <a href="html5_ref_globalattributes.asp">HTML 5 中的全局属性</a>。</p>
</div>
 
 
<div>
<h2>事件属性</h2>
<p>&lt;body&gt; 标签支持 <a href="html5_ref_eventattributes.asp">HTML 5 中的事件属性</a>。</p>
</div>
