...
<title>HTML 5 Audio/Video DOM audioTracks 属性</title>
...
<h1>HTML 5 Audio/Video DOM audioTracks 属性</h1>
...
alert(<code>myVid.audioTracks</code>.length);
</pre>

<p><a href="/tiy/t.asp?f=html5_av_prop_audiotracks">亲自试一试</a></p>
</div>
...
<p>audioTracks 属性返回 AudioTrackList 对象。</p>

<p>AudioTrackList 对象表示音视频的可用音轨。</p>

<p>每个可用的音轨由一个 AudioTrack 对象表示。</p>
</div>
...
<p>任何主流浏览器都不支持 audioTracks 属性。</p>
</div>
...
<tr>
<td>AudioTrackList 对象</td>
<td>
	<p>表示音视频的可用音轨。</p>
	<p>AudioTrackList 对象：</p>
	<ul class="listintable">	
	<li>audioTracks.length - 或者可用音轨的数量</li>
	<li>audioTracks.getTrackById(id) - 通过 id 来获得 AudioTrack 对象</li>
	<li>audioTracks[index] - 通过 index 来获得 AudioTrack 对象</li>
	</ul>
	<p class="note"><span>注释：</span>首个可用的 AudioTrack 对象的下标是 0。</p>
</td>
</tr>
...
<td>
	<p>表示音轨。</p>	
	<p>AudioTrack 对象的属性：</p>
	<ul class="listintable">	
	<li>id - 获得音轨的 id</li>
	<li>kind - 获得音轨的类型（可以是 &quot;alternative&quot;, &quot;description&quot;, &quot;main&quot;, &quot;translation&quot;, &quot;commentary&quot;, 或者 &quot;&quot; （空字符串））</li>
	<li>label - 获得音轨的标签</li>
	<li>language - 获得音轨的语言</li>
	<li>enabled - 获得或设置音轨是否是活动的 (true|false)</li>
	</ul>
</td>
</tr>
</table>
