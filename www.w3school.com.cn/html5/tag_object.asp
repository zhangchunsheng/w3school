...
<li class="currentLink"><a href="/html5/tag_object.asp" title="HTML5 &lt;object&gt; 标签">&lt;object&gt;</a></li>
...
<h1>HTML 5 &lt;object&gt; 标签</h1>


<div>
<h2>定义和用法</h2>
<p>定义一个嵌入的对象。请使用此元素向您的 XHTML 页面添加多媒体。此元素运行您规定插入 HTML 文档中的对象的数据和参数，以及可用来显示和操作数据的代码。</p>
</div>


<div>
<h2>HTML 4.01 与 HTML 5 之间的差异</h2>
<p>不再支持 HTML 4.01 中的一些属性。</p>
</div>


<div>
<h2>提示和注释</h2>
<p class="note"><span>注释：</span>object 元素可位于在 head 元素或 body 元素内部。&lt;object&gt; 与 &lt;/object&gt; 之间的文本是替换文本，针对不支持此标签的浏览器。&lt;param&gt; 标签可定义用于对象的 run-time 设置。</p>
<p class="tip"><span>提示：</span>至于图像，请使用 &lt;img&gt; 标签代替 &lt;object&gt; 标签。</p>
<p class="tip"><span>提示：</span>至少必须定义 &quot;data&quot; 和 &quot;type&quot; 属性之一。</p>
</div>
...
<table class="dataintable">
  ...
  <tr>
    <td><a href="/html5/att_object_data.asp" title="HTML5 &lt;object&gt; data 属性">data</a></td>
    <td><i>URL</i></td>
    <td>规定对象使用的资源的 URL。</td>
  </tr>
  ...
  <tr>
    <td class="html5_new"><a href="/html5/att_object_form.asp" title="HTML5 &lt;object&gt; form 属性">form</a></td>
    <td><i>form_id</i></td>
    <td>规定对象所属的一个或多个表单。</td>
  </tr>

  <tr>
    <td><a href="/html5/att_object_height.asp" title="HTML5 &lt;object&gt; height 属性">height</a></td>
    <td><i>pixels</i></td>
    <td>规定对象的高度。</td>
  </tr>
  ...
  <tr>
    <td><a href="/html5/att_object_name.asp" title="HTML5 &lt;object&gt; name 属性">name</a></td>
    <td><i>name</i></td>
    <td>为对象定义名称。</td>
  </tr>
  ...
  <tr>
    <td><a href="/html5/att_object_type.asp" title="HTML5 &lt;object&gt; type 属性">type</a></td>
    <td><i>MIME_type</i></td>
    <td>定义 data 属性中规定的数据的 MIME 类型。</td>
  </tr>

  <tr>
    <td><a href="/html5/att_object_usemap.asp" title="HTML5 &lt;object&gt; usemap 属性">usemap</a></td>
    <td><i>#mapname</i></td>
  ...
  <tr>
    <td><a href="/html5/att_object_width.asp" title="HTML5 &lt;object&gt; width 属性">width</a></td>
    <td><i>pixels</i></td>
    <td>规定对象的宽度。</td>
  </tr>
</table>
...
<div>
<h2>全局属性</h2>
<p>&lt;object&gt; 标签支持 <a href="html5_ref_globalattributes.asp">HTML 5 中的全局属性</a>。</p>
</div>
 
 
<div>
<h2>事件属性</h2>
<p>&lt;object&gt; 标签支持 <a href="html5_ref_eventattributes.asp">HTML 5 中的事件属性</a>。</p>
</div>
