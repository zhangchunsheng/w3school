...
<title>HTML 5 &lt;img&gt; height 属性</title>
</head>
...
<h1>HTML 5 &lt;img&gt; height 属性</h1>


<div class="backtoreference">
<p><a href="/html5/tag_img.asp">HTML 5 &lt;img&gt; 标签</a></p>
</div>
...
<pre>
&lt;img src=&quot;tulip.gif&quot; width=&quot;400&quot; <code>height=&quot;266&quot;</code> alt=&quot;上海鲜花港 - 郁金香&quot; /&gt;
</pre>

<p><a href="/tiy/t.asp?f=html5_img_height_width">亲自试一试</a></p>
</div>
...
<p>height 属性规定图像的高度。</p>

<p class="tip"><span>提示：</span>为图像指定 height 和 width 属性是一个好习惯。如果设置了这些属性，就可以在页面加载时为图像留出空间。如果没有设置这些属性，那么浏览器就无法了解图像的尺寸，也就无法为图像预留出适当的空间。因此当图像加载时，页面的布局就会发生变化。</p>

<p class="tip"><span>提示：</span>请不要通过 height 和 width 属性来缩放图像。如果通过 height 和 width 属性来缩小图像，那么用户就必须下载大容量的图像（即使图像在页面上看上去很小）。正确的做法是，在网页上使用图像之前，应该通过软件把图像处理为合适的尺寸。</p>
</div>
...
<pre>&lt;img height=&quot;<i>pixels</i>|<i>%</i>&quot; /&gt;</pre>
...
<tr>
<td><i>pixels</i></td>
<td>以像素为单位的高度。（比如 &quot;100px&quot; 或仅仅是 &quot;100&quot;）</td>
</tr>

<tr>
<td><i>%</i></td>
<td>以包含元素的百分比计的高度。（比如 &quot;50%&quot;）</td>
</tr>
</table>
</div>
