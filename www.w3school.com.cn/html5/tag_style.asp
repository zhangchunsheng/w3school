...
<li class="currentLink"><a href="/html5/tag_style.asp" title="HTML5 &lt;style&gt; 标签">&lt;style&gt;</a></li>
...
<h1>HTML 5 &lt;style&gt; 标签</h1>


<div>
<h2>定义和用法</h2>
<p>&lt;style&gt; 标签定义 HTML 文档的样式信息。</p>
<p>在 style 元素中，您规定的是 HTML 元素如何在浏览器中呈现。</p>
</div>


<div>
<h2>实例</h2>
<p>在 HTML 文档中使用 style 元素：</p>
<pre>
&lt;html&gt;
&lt;head&gt;
...
<p><a href="/tiy/t.asp?f=html5_style">亲自试一试</a></p>
</div>


<div>
<h2>HTML 4.01 与 HTML 5 之间的差异</h2>
<p>scoped 属性是 HTML 5 中的新属性，它允许我们为文档的指定部分定义样式，而不是整个文档。</p>
<p>如果使用 &quot;scoped&quot; 属性，那么所规定的样式只能应用到 style 元素的父元素及其子元素。</p>
</div>


<div>
<h2>提示和注释：</h2>
<p class="tip"><span>提示：</span>如需链接外部样式表，请使用 &lt;link&gt; 标签。</p>
<p class="tip"><span>提示：</span>如需学习更多有关样式表的知识，请访问我们的 <a href="/css/index.asp">CSS 教程</a>。</p>
<p class="note"><span>注释：</span>如果未定义 scoped 属性，那么 &lt;style&gt; 元素必须位于 &lt;head&gt; 部分中。</p>
</div>
...
<table class="dataintable">
  ...
  <tr>
    <td class="html5_new">scoped</td>
    <td>scoped</td>
    <td>如果使用该属性，则样式仅仅应用到 style 元素的父元素及其子元素。</td>
  </tr>
</table>
</div>
...
<div>
<h2>全局属性</h2>
<p>&lt;style&gt; 标签支持 <a href="html5_ref_globalattributes.asp">HTML 5 中的全局属性</a>。</p>
</div>
 
 
<div>
<h2>事件属性</h2>
<p>&lt;style&gt; 标签支持 <a href="html5_ref_eventattributes.asp">HTML 5 中的事件属性</a>。</p>
</div>
