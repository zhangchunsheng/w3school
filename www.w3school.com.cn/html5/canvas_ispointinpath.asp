...
<title>HTML5 canvas isPointInPath() 方法</title>
...
<h1>HTML5 canvas isPointInPath() 方法</h1>
...
var ctx=c.getContext(&quot;2d&quot;);
ctx.rect(20,20,150,100);
if (<code>ctx.isPointInPath(20,50)</code>)
   {
   ctx.stroke();
   };
</pre>

<p><a target="_blank" href="/tiy/t.asp?f=html5_canvas_ispointinpath">亲自试一试</a></p>
</div>
...
<p>Internet Explorer 9、Firefox、Opera、Chrome 以及 Safari 支持 isPointInPath() 方法。</p>
...
<p>isPointInPath() 方法返回 true，如果指定的点位于当前路径中；否则返回 false。</p>

<h3>JavaScript 语法：</h3>

<pre>context.isPointInPath(<i>x</i>,<i>y</i>);</pre>
