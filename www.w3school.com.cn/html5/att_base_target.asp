...
<title>HTML 5 &lt;base&gt; target 属性</title>
</head>
...
<p>target 属性设置基准 URL：</p>

<pre>
&lt;base <code>target=&quot;_blank&quot;</code> /&gt;
</pre>

<p><a href="/tiy/t.asp?f=html5_base_target">亲自试一试</a></p>
</div>
...
<p>target 属性规定在何处打开页面上的所有链接。</p>

<p>可以在每个链接中使用 target 属性来覆盖该属性。</p>

<p>如果没有为 base 元素规定 href 属性，则 target 属性是必需的。</p>
</div>
...
<p>已无法再将框架名定义为 target，因为已经不再支持 frame 和 frameset 。</p>

<p>self, parent 以及 top 值目前大多应用于 iframe。</p>
</div>
