...
<h1>HTML 5 全局 id 属性</h1>


<div class="backtoreference">
<p><a href="/html5/html5_ref_globalattributes.asp">HTML 5 全局属性</a></p>
</div>
...
<p>通过 JavaScript 利用 id 属性来改变一段文本：</p>
...
{
document<span class="marked">.getElementById(&quot;myHeader&quot;)</span>.innerHTML=&quot;Nice day!&quot;;
}
&lt;/script&gt;
&lt;/head&gt;

&lt;body&gt;
&lt;h1 <code>id=&quot;myHeader&quot;</code>&gt;Hello World!&lt;/h1&gt;
...
<p><a href="/tiy/t.asp?f=html5_global_id_js">亲自试一试</a></p>
</div>
...
<p>id 属性规定 HTML 元素的唯一的 id。</p>

<p>id 在 HTML 文档中必须是唯一的。</p>

<p>id 属性可用作链接锚（link anchor），通过 JavaScript（HTML DOM）或通过 CSS 为带有指定 id 的元素改变或添加样式。</p>
</div>
...
<pre>&lt;<i>element</i> <code>id=&quot;<i>value</i>&quot;</code>&gt;</pre>
...
<td>
  ...
  <li>必须以字母 A-Z 或 a-z 开头</li>
  <li>其后的字符：字母(A-Za-z)、数字(0-9)、连字符("-")、下划线("_")、冒号(":") 以及点号(".")</li>
  <li>值对大小写敏感</li>
  </ul>
</td>
</tr>
...
<dl>
<dt><a href="/tiy/t.asp?f=html5_global_id">向 HTML 元素添加唯一的 id</a></dt>
<dd>如何向 HTML 元素添加 id 属性。</dd>

<dt><a href="/tiy/t.asp?f=html5_global_id_css">在 CSS 中使用 id 属性</a></dt>
<dd>如何在 CSS 中使用 id 属性为元素添加样式 </dd>

<dt><a href="/tiy/t.asp?f=html5_global_id_anchor">使用 id 属性来创建链接锚</a></dt>
<dd>如何使用 id 属性来创建链接锚。</dd>
</dl>
</div>
