...
<title>HTML 5 &lt;form&gt; accept-charset 属性</title>
</head>
...
<h1>HTML 5 &lt;form&gt; accept-charset 属性</h1>
...
<pre>
&lt;form action=&quot;demo_form.asp&quot; <code>accept-charset=&quot;ISO-8859-1&quot;</code>&gt;
...
<p><a href="/tiy/t.asp?f=html5_form_accept-charset">亲自试一试</a></p>
</div>
...
<pre>&lt;form accept-charset=&quot;value&quot;&gt;</pre>
...
<table class="dataintable">
  ...
  <tr>
    ...
    <td>
		<p>服务器可处理的一个或多个字符集。如需规定一个以上的字符集，请使用逗号来分隔各字符集。</p>
		<p>常用值：</p>
		<ul class="listintable">
			<li>UTF-8 - Unicode 字符编码</li>
			<li>ISO-8859-1 - 拉丁字母表的字符编码</li>
			<li>gb2312 - 简体中文字符集</li>
		</ul>
		<p>理论上讲，可使用任何字符编码，但没有浏览器可以理解所有的编码。字符编码使用得越广泛，浏览器对其支持越好。</p>
		<p>如需查看所有可用的字符集，请访问我们的 <a href="/tags/html_ref_charactersets.asp">字符编码参考</a>。</p>
	</td>
  </tr>
</table>
