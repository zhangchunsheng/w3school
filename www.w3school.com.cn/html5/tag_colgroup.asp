...
<title>HTML 5 &lt;colgroup&gt; 标签</title>
</head>
...
<li class="currentLink"><a href="/html5/tag_colgroup.asp" title="HTML5 &lt;colgroup&gt; 标签">&lt;colgroup&gt;</a></li>
...
<p>只能在 table 元素内使用 &lt;colgroup&gt; 标签。</p>
</div>
...
<pre>
&lt;table&gt;
<code>&lt;colgroup span=&quot;2&quot; style=&quot;background-color:red&quot; /&gt;</code>
  &lt;tr&gt;
    &lt;th&gt;ISBN&lt;/th&gt;
    &lt;th&gt;Title&lt;/th&gt;
    &lt;th&gt;Price&lt;/th&gt;
...
<p><a href="/tiy/t.asp?f=html5_col">亲自试一试</a></p>
</div>
...
<p>HTML5 中不再支持 HTML 4.01 中的大部分属性。</p>
</div>
...
<p class="note"><span>注释：</span>colgroup 元素只能包含 col 元素。</p>

<p class="note"><span>注释：</span>colgroup 元素无法创建表格列。如需创建列，必须在 tr 元素内规定 td 元素。</p>

<p class="tip"><span>提示：</span>如果您希望为一组表格列规定相同的属性值，请使用 &lt;colgroup&gt; 元素。</p>

<p class="tip"><span>提示：</span>如果您希望为多个表格列规定不同的属性值，请使用 &lt;col&gt; 元素。</p>
</div>
...
<table class="dataintable">
  ...
  <tr>
    <td><a href="/html5/att_colgroup_span.asp" title="HTML5 &lt;colgroup&gt; span 属性">span</a></td>
    <td><i>number</i></td>
    <td>定义 &lt;colgroup&gt; 应当横跨的列数。</td>
  </tr>
  <tr>
    <td>valign</td>
    <td>
...
<div>
<h2>全局属性</h2>
<p>&lt;colgroup&gt; 标签支持 <a href="html5_ref_globalattributes.asp">HTML 5 中的全局属性</a>。</p>
</div>
 
 
<div>
<h2>事件属性</h2>
<p>&lt;colgroup&gt; 标签支持 <a href="html5_ref_eventattributes.asp">HTML 5 中的事件属性</a>。</p>
</div>
