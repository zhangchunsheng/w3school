...
<title>HTML 5 &lt;script&gt; type 属性</title>
</head>
...
<p><a href="/tiy/t.asp?f=html5_script_type">亲自试一试</a></p>
</div>
...
<p>type 属性规定脚本的 MIME 类型。</p>

<p>type 属性标示 &lt;script&gt; 与 &lt;/script&gt; 标签之间的内容。</p>

<p>MIME 类型包括两部分：media type 和 subtype。对于 JavaScript，MIME 类型是 &quot;text/javascript&quot;。</p>
</div>
...
<p>在 HTML5 中，type 属性不再是必需的。默认值是 &quot;text/javascript&quot;。</p>
</div>
...
<pre>&lt;script type=&quot;<i>MIME_type</i>&quot;&gt;</pre>
...
<table class="dataintable">
  ...
  <tr>
    ...
    <p>请参阅 <a href="http://www.iana.org/assignments/media-types/">IANA MIME 类型</a>，获得完整的标准 MIME 类型列表。</p>
	</td>
  </tr>
</table>
</div>
