...
<title>HTML5 canvas rotate() 方法</title>
...
var c=document.getElementById(&quot;myCanvas&quot;);
var ctx=c.getContext(&quot;2d&quot;);
<code>ctx.rotate(20*Math.PI/180);</code>
ctx.fillRect(50,20,100,50);
</pre>

<p><a target="_blank" href="/tiy/t.asp?f=html5_canvas_rotate">亲自试一试</a></p>
</div>
...
<p>Internet Explorer 9、Firefox、Opera、Chrome 以及 Safari 支持 rotate() 方法。</p>
