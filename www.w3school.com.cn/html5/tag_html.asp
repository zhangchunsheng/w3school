...
<li class="currentLink"><a href="/html5/tag_html.asp" title="HTML5 &lt;html&gt; 标签">&lt;html&gt;</a></li>
...
<h1>HTML 5 &lt;html&gt; 标签</h1>


<div>
<h2>定义和用法</h2>

<p>&lt;html&gt; 标签告知浏览器这是一个 HTML 文档。</p>

<p>html 元素是 HTML 文档中最外层的元素。</p>
...
<p><a href="/tiy/t.asp?f=html5_html">亲自试一试</a></p>
</div>


<div>
<h2>HTML 4.01 与 HTML 5 之间的差异</h2>
<p>在 HTML 4.01 中的 xmlns 属性，在 XHTML 中是必须的。实际上它没有任何效果，但是出于验证的原因，在把 HTML 转换为 XHTML 的过程中，是很有帮助的。在 HTML 5 中，没有理由这么做，但是你仍然可以把 xmlns 属性定义为 &quot;http://www.w3.org/1999/xhtml&quot;。</p>
<p>在 HTML 5 中，有一个新属性：manifest。</p>
</div>


<div>
<h2>提示和注释</h2>
<p class="note"><span>注释：</span>如果您出于某种原因，希望定义 xmlns 属性，唯一合法的值是 &quot;http://www.w3.org/1999/xhtml&quot;。</p>
</div>
...
<table class="dataintable">
  ...
  <tr>
    <td class="html5_new">manifest</td>
    <td><i>url</i></td>
    <td>定义一个 URL，在这个 URL 上描述了文档的缓存信息。</td>
    </tr>
  <tr>
    <td>xmlns</td>
...
<div>
<h2>全局属性</h2>
<p>&lt;html&gt; 标签支持 <a href="html5_ref_globalattributes.asp">HTML 5 中的全局属性</a>。</p>
</div>
