...
<title>HTML 5 Audio/Video DOM currentSrc 属性</title>
...
<h1>HTML 5 Audio/Video DOM currentSrc 属性</h1>
...
alert(<code>myVid.currentSrc</code>);
</pre>

<p><a href="/tiy/t.asp?f=html5_av_prop_currentsrc">亲自试一试</a></p>
</div>
...
<p>currentSrc 熟悉返回当前音频/视频的 URL。</p>

<p>如果未设置音频/视频，则返回空字符串。</p>
</div>
...
<pre>audio|video.currentSrc</pre>
</div>
