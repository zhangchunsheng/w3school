...
<ul>
<li class="currentLink"><a href="/jquery/index.asp" title="jQuery 教程">jQuery 教程</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/jquery/index.asp" title="jQuery 教程">jQuery 教程</a></li>
<li class="next"><a href="/jquery/jquery_intro.asp" title="jQuery 简介">jQuery 简介</a></li>
</ul>
</div>
...
<p><a href="/tiy/t.asp?f=jquery_hide">亲自试一试</a></p>

<p>通过点击 &quot;TIY&quot; 按钮来看看它是如何运行的。</p>
</div>
...
<p>基本上，您将学习到如何选取 HTML 元素，以及如何对它们执行类似隐藏、移动以及操作其内容等任务。</p>
</div>
...
<p>如果您需要首先学习这些科目，请在我们的 <a href="/index.html" title="w3school 在线教程">首页</a> 查找这些教程。</p>
</div>
...
<p>通过实例来学习！在 W3School，您将找到许多可以在线编辑并测试的 jQuery 实例。</p>

<p><a href="/jquery/jquery_examples.asp" title="jQuery 实例">jQuery 实例</a></p>
</div>
...
<p><a href="/jquery/jquery_reference.asp">jQuery 参考手册</a></p>
</div>
