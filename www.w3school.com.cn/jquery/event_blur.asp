...
<p>当输入域失去焦点 (blur) 时改变其颜色：</p>

<pre>$(&quot;input&quot;).blur(function(){
  $(&quot;input&quot;).css(&quot;background-color&quot;,&quot;#D6D6FF&quot;);
});</pre>

<p><a href="/tiy/t.asp?f=jquery_event_blur">亲自试一试</a></p>
</div>
...
<p>当元素失去焦点时发生 blur 事件。</p>

<p>blur() 函数触发 blur 事件，或者如果设置了 <i>function</i> 参数，该函数也可规定当发生 blur 事件时执行的代码。</p>

<p class="tip"><span>提示：</span>早前，blur 事件仅发生于表单元素上。在新浏览器中，该事件可用于任何元素。</p>
</div>
...
<pre>$(<i>selector</i>).blur()</pre>

<p><a href="/tiy/t.asp?f=jquery_event_focus_blur_trigger">亲自试一试</a></p>
</div>


<div>
<h2>将函数绑定到 blur 事件</h2>

<p>规定当被选元素的 blur 事件发生时运行的函数。</p>

<h3>语法</h3>

<pre>$(<i>selector</i>).blur(<i>function</i>)</pre>
