...
<h2>jQuery HTML</h2>
<ul>
<li class="currentLink"><a href="/jquery/jquery_dom_get.asp" title="jQuery - 获取内容和属性">jQuery 获取</a></li>
...
<h1>jQuery - 获得内容和属性</h1>

<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/jquery/jquery_chaining.asp" title="jQuery - Chaining">jQuery Chaining</a></li>
<li class="next"><a href="/jquery/jquery_dom_set.asp" title="jQuery - 设置内容和属性">jQuery 设置</a></li>
</ul>
</div>

<div id="intro">
<p><strong>jQuery 拥有可操作 HTML 元素和属性的强大方法。</strong></p>
</div>
...
<p class="tip"><span>提示：</span>DOM = Document Object Model（文档对象模型）</p>

<p>DOM 定义访问 HTML 和 XML 文档的标准：</p>

<p>“W3C 文档对象模型独立于平台和语言的界面，允许程序和脚本动态访问和更新文档的内容、结构以及样式。”</p>
</div>
...
<p><a href="/tiy/t.asp?f=jquery_dom_html_get">亲自试一试</a></p>
...
<p><a href="/tiy/t.asp?f=jquery_dom_val_get">亲自试一试</a></p>
</div>
...
<p><a href="/tiy/t.asp?f=jquery_dom_attr_get">亲自试一试</a></p>

<p>下一章会讲解如何设置（改变）内容和属性值。</p>
</div>
...
<p>如需有关 jQuery HTML 方法的完整内容，请访问以下参考手册：</p>
