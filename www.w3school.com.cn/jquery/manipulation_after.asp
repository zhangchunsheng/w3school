...
<title>jQuery 文档操作 - after() 方法</title>
</head>
...
$(&quot;button&quot;).click(function(){
  $(&quot;p&quot;).<code>after(&quot;&lt;p&gt;Hello world!&lt;/p&gt;&quot;)</code>;
});
</pre>

<p><a href="/tiy/t.asp?f=jquery_manipulation_after">亲自试一试</a></p>
</div>
...
<p>after() 方法在被选元素后插入指定的内容。</p>

<h3>语法</h3>

<pre>$(selector).after(<i>content</i>)</pre>
...
<p>使用函数在被选元素之后插入指定的内容。</p>

<h3>语法</h3>

<pre>$(selector).after(<i>function</i>(<i>index</i>))</pre>

<p><a href="/tiy/t.asp?f=jquery_manipulation_after_func">亲自试一试</a></p>
