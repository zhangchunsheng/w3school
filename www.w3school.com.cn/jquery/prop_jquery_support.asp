...
<title>jQuery jQuery.support 属性</title>
...
<h1>jQuery jQuery.support 属性</h1>
...
<p>测试浏览器是否能创建 XMLHttpRequest 对象：</p>

<pre>
$(document).ready(function(){
  $(&quot;p&quot;).html(&quot;This browser can create XMLHttpRequest object: &quot; + <code>jQuery.support.ajax</code>);
});
</pre>

<p class="tiy"><a target="_blank" href="/tiy/t.asp?f=jquery_prop_jquery_support">亲自试一试</a></p>
</div>
...
<p>jQuery.support 属性包含表示不同浏览器特性或漏洞的属性集。</p>

<p>此属性主要用于 jQuery 的内部使用。</p>

<h3>语法</h3>

<pre>jQuery.support.<i>propvalue</i></pre>
