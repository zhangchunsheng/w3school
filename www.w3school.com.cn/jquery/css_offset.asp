...
<title>jQuery CSS 操作 - offset() 方法</title>
</head>
...
<pre>
$(&quot;.btn1&quot;).click(function(){
  x=<code>$(&quot;p&quot;).offset()</code>;
  $(&quot;#span1&quot;).text(x.left);
  $(&quot;#span2&quot;).text(x.top);
});
</pre>

<p><a href="/tiy/t.asp?f=jquery_css_offset">亲自试一试</a></p>
</div>
...
<p>offset() 方法返回或设置匹配元素相对于文档的偏移（位置）。</p>
</div>
...
<p>该方法返回的对象包含两个整型属性：top 和 left，以像素计。此方法只对可见元素有效。</p>

<h3>语法</h3>

<pre>$(<i>selector</i>).offset()</pre>
...
<pre>$(<i>selector</i>).offset(<i>value</i>)</pre>
...
<td><i>value</i></td>
<td>
	<p>必需。规定以像素计的 top 和 left 坐标。</p>
	<p>可能的值：</p>
	<ul class="listintable">
	<li>值对，比如 {top:100,left:0}</li>
	<li>带有 top 和 left 属性的对象</li>
	</ul>
</td>
</tr>
</table>

<p><a href="/tiy/t.asp?f=jquery_css_offset_set">亲自试一试</a></p>
</div>
...
<p>使用函数来设置所有匹配元素的偏移坐标。</p>

<h3>语法</h3>

<pre>$(<i>selector</i>).offset(<i>function(index,oldoffset)</i>)</pre>
...
<tr>
<td><i>function(index,oldoffset)</i></td>
<td>
	<p>规定返回被选元素新偏移坐标的函数。</p>
	<ul class="listintable">
	<li>index - 可选。接受选择器的 index 位置</li>
	<li>oldvalue - 可选。接受选择器的当前坐标。</li>
	</ul>
</td>
</tr>
</table>

<p><a href="/tiy/t.asp?f=jquery_css_offset_set_function">亲自试一试</a></p>
</div>
...
<dl>
<dt><a href="/tiy/t.asp?f=jquery_css_offset_object">使用对象来为对象设置新的 offset 值</a></dt>
<dd>使用新对象中的坐标来定位元素。</dd>

<dt><a href="/tiy/t.asp?f=jquery_css_offset_object_copy">使用另一个元素的位置来为元素设置新的 offset 值</a></dt>
<dd>使用已有对象的位置来定位元素。</dd>
</dl>
</div>
