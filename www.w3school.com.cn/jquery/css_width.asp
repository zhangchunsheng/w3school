...
<title>jQuery CSS 操作 - width() 方法</title>
</head>
...
<pre>
$(&quot;.btn1&quot;).click(function(){
  <code>$(&quot;p&quot;).width(200);</code>
});
</pre>

<p><a href="/tiy/t.asp?f=jquery_css_width_set">亲自试一试</a></p>
</div>
...
<p>如果不为该方法设置参数，则返回以像素计的匹配元素的宽度。</p>

<h3>语法</h3>

<pre>$(<i>selector</i>).width()</pre>

<p><a href="/tiy/t.asp?f=jquery_css_width_get">亲自试一试</a></p>
</div>
...
<pre>$(<i>selector</i>).width(<i>length</i>)</pre>
...
<p>使用函数来设置所有匹配元素的宽度。</p>

<h3>语法</h3>

<pre>$(<i>selector</i>).width(<i>function(index,oldwidth)</i>)</pre>
...
<tr>
<td><i>function(index,oldwidth)</i></td>
<td>
	<p>规定返回被选元素新宽度的函数。</p>
...
<p><a href="/tiy/t.asp?f=jquery_css_width_set_function">亲自试一试</a></p>
</div>
...
<dl>
<dt><a href="/tiy/t.asp?f=jquery_css_width_doc_win">获得文档和窗口元素的宽度</a></dt>
<dd>使用 width() 方法来获得 document 和 window 元素的当前宽度。</dd>

<dt><a href="/tiy/t.asp?f=jquery_css_width_set_unit">使用 em 和 % 值来设置宽度</a></dt>
<dd>使用指定的长度单位来设置元素的宽度。</dd>
</dl>
</div>
