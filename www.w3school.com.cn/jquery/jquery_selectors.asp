...
<li class="currentLink"><a href="/jquery/jquery_selectors.asp" title="jQuery 选择器">jQuery 选择器</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/jquery/jquery_syntax.asp" title="jQuery 语法">jQuery 语法</a></li>
<li class="next"><a href="/jquery/jquery_events.asp" title="jQuery 事件">jQuery 事件</a></li>
</ul>
</div>

<div id="intro">
<p><strong>选择器允许您对元素组或单个元素进行操作。</strong></p>
</div>
...
<p>在前面的章节中，我们展示了一些有关如何选取 HTML 元素的实例。</p>
...
<pre>$(&quot;p&quot;).css(&quot;background-color&quot;,&quot;red&quot;);</pre>

<p><a href="/tiy/t.asp?f=jquery_css_change_p">亲自试一试</a></p>
</div>
...
<p>如需完整的参考手册，请访问我们的 <a href="/jquery/jquery_ref_selectors.asp" title="jQuery 参考手册 - 选择器">jQuery 选择器参考手册</a>。</p>
</div>
