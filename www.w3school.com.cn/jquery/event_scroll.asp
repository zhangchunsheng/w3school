...
<title>jQuery 事件 - scroll() 方法</title>
</head>
...
<p><a href="/tiy/t.asp?f=jquery_event_scroll">亲自试一试</a></p>
</div>
...
<p>当用户滚动指定的元素时，会发生 scroll 事件。</p>

<p>scroll 事件适用于所有可滚动的元素和 window 对象（浏览器窗口）。</p>

<p>scroll() 方法触发 scroll 事件，或规定当发生 scroll 事件时运行的函数。</p>
</div>
...
<pre>$(<i>selector</i>).scroll()</pre>

<p><a href="/tiy/t.asp?f=jquery_event_scroll_trigger">亲自试一试</a></p>
</div>


<div>
<h2>将函数绑定到 scroll 事件</h2>

<h3>语法</h3>

<pre>$(<i>selector</i>).scroll(<i>function</i>)</pre>
...
<tr>
<td><i>function</i></td>
<td>可选。规定当发生 scroll 事件时运行的函数。</td>
</tr>
</table>
