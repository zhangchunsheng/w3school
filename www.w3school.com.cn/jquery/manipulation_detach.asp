...
<p><a href="/tiy/t.asp?f=jquery_manipulation_detach">亲自试一试</a></p>
</div>
...
<dl>
<dt><a href="/tiy/t.asp?f=jquery_manipulation_detach_move">移动元素</a></dt>
<dd>使用 detach() 方法来移动元素。</dd>

<dt><a href="/tiy/t.asp?f=jquery_manipulation_detach_remove_restore">删除并恢复一个元素</a></dt>
<dd>使用 detach() 方法来删除并恢复一个元素。</dd>

<dt><a href="/tiy/t.asp?f=jquery_manipulation_detach_restore">移动元素并保留其 click 事件</a></dt>
