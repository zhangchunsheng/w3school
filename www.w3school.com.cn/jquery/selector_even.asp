...
<h1>jQuery :even 选择器</h1>

<div class="backtoreference">
<p><a href="/jquery/jquery_ref_selectors.asp" title="jQuery 参考手册 - 选择器">jQuery 选择器参考手册</a></p>
</div>
...
<p>选择每个相隔的（偶数） &lt;tr&gt; 元素：</p>

<pre>$(&quot;tr:even&quot;)</pre>

<p><a href="/tiy/t.asp?f=jquery_selector_even">亲自试一试</a></p>
</div>
...
<p>:even 选择器选取每个带有偶数 index 值的元素（比如 2、4、6）。</p>

<p>index 值从 0 开始，所有第一个元素是偶数 (0)。</p>

<p>最常见的用法：与其他元素/选择器一起使用，来选择指定的组中偶数序号的元素（如上面的例子）。</p>
...
<p class="tip"><span>提示：</span>请使用 <a href="/jquery/selector_odd.asp" title="jQuery :odd 选择器">:odd 选择器</a>来选取奇数序号的元素。</p>
</div>
