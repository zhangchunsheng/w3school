...
<p>选择前 3 个之后的所有 &lt;tr&gt; 元素：</p>

<pre>$(&quot;tr:gt(2)&quot;)</pre>

<p><a href="/tiy/t.asp?f=jquery_selector_gt">亲自试一试</a></p>
</div>
...
<p>:gt 选择器选取 index 值高于指定数的元素。</p>

<p>index 值从 0 开始。</p>

<p>经常与其他元素/选择器一起使用，来选择指定的组中特定序号之后的元素（如上面的例子）。</p>

<h3>语法</h3>

<pre>$(&quot;:gt(<i>index</i>)&quot;)</pre>
...
<p class="tip"><span>提示：</span>请使用 <a href="/jquery/selector_lt.asp" title="jQuery :lt 选择器">:lt 选择器</a>来选取 index 值小于指定数的元素。</p>
</div>
