...
<title>jQuery 属性操作 - val() 方法</title>
</head>
...
$(&quot;button&quot;).click(function(){
  $(&quot;:text&quot;).<code>val(&quot;Hello World&quot;)</code>;
});
</pre>

<p><a href="/tiy/t.asp?f=jquery_attributes_val">亲自试一试</a></p>
</div>
...
<p>val() 方法返回或设置被选元素的值。</p>

<p>元素的值是通过 value 属性设置的。该方法大多用于 input 元素。</p>

<p>如果该方法未设置参数，则返回被选元素的当前值。</p>

<h3>语法</h3>

<pre>$(<i>selector</i>).val(<i>value</i>)</pre>
...
<p>返回第一个匹配元素的 value 属性的值。</p>

<h3>语法</h3>

<pre>$(<i>selector</i>).val()</pre>

<p><a href="/tiy/t.asp?f=jquery_attributes_val_get">亲自试一试</a></p>
</div>
...
<p><a href="/tiy/t.asp?f=jquery_attributes_val_set">亲自试一试</a></p>
</div>


<div>
<h2>使用函数设置 Value 属性的值</h2>

<pre>$(<i>selector</i>).val(<i>function(index,oldvalue)</i>)</pre>

<p><a href="/tiy/t.asp?f=jquery_attributes_val_func">亲自试一试</a></p>
...
<td>
	...
	<li><i>index</i> - 可选。接受选择器的 index 位置。</li>
	<li><i>oldvalue</i> - 可选。接受选择器的当前 Value 属性。</li>
	</ul>
</td>
</tr>
</table>
