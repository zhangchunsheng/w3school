...
<title>jQuery 遍历 - andSelf() 方法</title>
</head>
...
<p>找到所有 div，以及其中的所有段落，并为它们添加两个类名。请注意，由于未使用 .andSelf()，div 没有黄色背景色。</p>

<pre>
$(&quot;div&quot;).find(&quot;p&quot;)<code>.andSelf()</code>.addClass(&quot;border&quot;);
$(&quot;div&quot;).find(&quot;p&quot;).addClass(&quot;background&quot;);
</pre>

<p><a href="/tiy/t.asp?f=jquery_traversing_andself">亲自试一试</a></p>
</div>
...
<p><a href="/tiy/t.asp?f=jquery_traversing_andself_2">亲自试一试</a></p>

<p>首先，初始的选择器会定位项目 3，初始化的堆栈存有仅包含该项目的集合。调用 .nextAll() 会将项目 4, 5 的集合推入堆栈。最后，调用 .andSelf() 会合并这两个集合，所创建的 jQuery 对象指向按照文档顺序的所有三个项目：{[&lt;li.third-item&gt;,&lt;li&gt;,&lt;li&gt; ]}。</p>
