...
<title>jQuery 事件 - undelegate() 方法</title>
</head>
...
<p>从所有元素删除由 delegate() 方法添加的所有事件处理器：</p>

<pre>
$(&quot;body&quot;).undelegate();
</pre>

<p><a href="/tiy/t.asp?f=jquery_event_undelegate">亲自试一试</a></p>
</div>
...
<p>undelegate() 方法删除由 delegate() 方法添加的一个或多个事件处理程序。</p>

<h3>语法</h3>

<pre>$(<i>selector</i>).undelegate(<i>selector</i>,<i>event</i>,<i>function</i>)</pre>

<p><a href="/tiy/t.asp?f=jquery_event_unbind">亲自试一试</a></p>
...
<tr>
<td><i>selector</i></td>
<td>可选。规定需要删除事件处理程序的选择器。</td>
</tr>

<tr>
<td><i>event</i></td>
<td>可选。规定需要删除处理函数的一个或多个事件类型。</td>
</tr>

<tr>
<td><i>function</i></td>
<td>可选。规定要删除的具体事件处理函数。</td>
</tr>
</table>
</div>
...
<dl>
<dt><a href="/tiy/t.asp?f=jquery_event_undelegate_selector">删除事件处理程序，由 delegate() 添加，来自具体选择器</a></dt>
<dd>如何使用 undelegate() 方法从指定元素删除所有事件处理程序。</dd>

<dt><a href="/tiy/t.asp?f=jquery_event_undelegate_event">删除指定事件类型的事件处理程序，由 delegate() 添加，来自指定元素</a></dt>
<dd>如何使用 undelegate() 方法从指定元素删除具体事件类型的所有事件处理程序。</dd>

<dt><a href="/tiy/t.asp?f=jquery_event_undelegate_function">删除由 delegate() 添加的具体函数</a></dt>
<dd>如何使用 undelegate() 方法为事件处理程序删除来自特定事件类型的特定函数。</dd>
</dl>
</div>
