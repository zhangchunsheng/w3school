...
<li class="currentLink"><a href="/jquery/jquery_ref_data.asp" title="jQuery 参考手册 - 数据">jQuery 数据</a></li>
...
<h1>jQuery 参考手册 - 数据</h1>

<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/jquery/jquery_ref_traversing.asp" title="jQuery 参考手册 - 遍历">jQuery 遍历</a></li>
<li class="next"><a href="/jquery/jquery_ref_dom_element_methods.asp" title="jQuery 参考手册 - DOM 元素方法">jQuery DOM 元素</a></li>
</ul>
</div>
...
<p>这些方法允许我们将指定的 DOM 元素与任意数据相关联。</p>
...
<tr>
<td><a href="/jquery/data_clearqueue.asp" title="jQuery 数据 - clearQueue() 方法">.clearQueue()</a></td>
<td>从队列中删除所有未运行的项目。</td>
</tr>

<tr>
<td><a href="/jquery/data_data.asp" title="jQuery 数据 - data() 方法">.data()</a></td>
<td>存储与匹配元素相关的任意数据。</td>
</tr>

<tr>
<td><a href="/jquery/data_jquery_data.asp" title="jQuery 数据 - jQuery.data() 方法">jQuery.data()</a></td>
<td>存储与指定元素相关的任意数据。</td>
</tr>

<tr>
<td><a href="/jquery/data_dequeue.asp" title="jQuery 数据 - dequeue() 方法">.dequeue()</a></td>
<td>从队列最前端移除一个队列函数，并执行它。</td>
</tr>

<tr>
<td><a href="/jquery/data_jquery_dequeue.asp" title="jQuery 数据 - jQuery.dequeue() 方法">jQuery.dequeue()</a></td>
<td>从队列最前端移除一个队列函数，并执行它。</td>
</tr>

<tr>
<td><a href="/jquery/data_hasdata.asp" title="jQuery 数据 - jQuery.hasData() 方法">jQuery.hasData()</a></td>
<td>存储与匹配元素相关的任意数据。</td>
</tr>

<tr>
<td><a href="/jquery/data_queue.asp" title="jQuery 数据 - queue() 方法">.queue()</a></td>
<td>显示或操作匹配元素所执行函数的队列。</td>
</tr>

<tr>
<td><a href="/jquery/data_jquery_queue.asp" title="jQuery 数据 - jQuery.queue() 方法">jQuery.queue()</a></td>
<td>显示或操作匹配元素所执行函数的队列。</td>
</tr>

<tr>
<td><a href="/jquery/data_removedata.asp" title="jQuery 数据 - removeData() 方法">.removeData()</a></td>
<td>移除之前存放的数据。</td>
</tr>

<tr>
<td><a href="/jquery/data_jquery_removedata.asp" title="jQuery 数据 - jQuery.removeData() 方法">jQuery.removeData()</a></td>
<td>移除之前存放的数据。</td>
</tr>
...
<p>参考手册：<a href="/jquery/jquery_ref_queue.asp" title="jQuery 参考手册 - 队列控制">jQuery 队列控制</a></p>
</div>
