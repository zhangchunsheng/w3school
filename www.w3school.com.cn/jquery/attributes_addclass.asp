...
<title>jQuery 属性操作 - addClass() 方法</title>
</head>
...
<h1>jQuery 属性操作 - addClass() 方法</h1>

<div class="backtoreference">
<p><a href="/jquery/jquery_ref_attributes.asp" title="jQuery 参考手册 - 属性操作">jQuery 属性操作参考手册</a></p>
</div>
...
$(&quot;button&quot;).click(function(){
  $(&quot;p:first&quot;).<code>addClass(&quot;intro&quot;)</code>;
});
</pre>

<p><a href="/tiy/t.asp?f=jquery_attributes_addclass">亲自试一试</a></p>
</div>
...
<p>addClass() 方法向被选元素添加一个或多个类。</p>

<p>该方法不会移除已存在的 class 属性，仅仅添加一个或多个 class 属性。</p>

<p class="tip"><span>提示：</span>如需添加多个类，请使用空格分隔类名。</p>

<h3>语法</h3>

<pre>$(selector).addClass(<i>class</i>)</pre>
...
<pre>$(selector).addClass(<i>function</i>(<i>index</i>,<i>oldclass)</i>)</pre>

<p><a href="/tiy/t.asp?f=jquery_attributes_addclass_func">亲自试一试</a></p>
...
<tr>
<td><i>function</i>(<i>index</i>,<i>oldclass)</i></td>
<td>
	<p>必需。规定返回一个或多个待添加类名的函数。</p>
	<ul class="listintable">
	<li><i>index</i> - 可选。选择器的 index 位置。</li>
	<li><i>class</i> - 可选。选择器的旧的类名。</li>
	</ul>
</td>
</tr>
</table>
...
<dl>
<dt><a href="/tiy/t.asp?f=jquery_attributes_addclass_two">向元素添加两个类</a></dt>
<dd>如何向被选元素添加两个 class。</dd>

<dt><a href="/tiy/t.asp?f=jquery_attributes_addremoveclass">改变元素的类</a></dt>
<dd>如任何使用 addClass() 和 removeClass() 来移除 class，并添加新的 class。</dd>
</dl>
</div>
