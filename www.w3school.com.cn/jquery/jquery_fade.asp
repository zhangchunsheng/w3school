...
<li class="currentLink"><a href="/jquery/jquery_fade.asp" title="jQuery jQuery 效果 - 淡入淡出">jQuery 淡入淡出</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/jquery/jquery_hide_show.asp" title="jQuery jQuery 效果 - 隐藏和显示">jQuery 隐藏/显示</a></li>
<li class="next"><a href="/jquery/jquery_slide.asp" title="jQuery 效果 - 滑动">jQuery 滑动</a></li>
</ul>
</div>

<div id="intro">
<p><strong>通过 jQuery，您可以实现元素的淡入淡出效果。</strong></p>
</div>
...
<dl>
<dt><a href="/tiy/t.asp?f=jquery_fadein">jQuery fadeIn()</a></dt>
<dd>演示 jQuery fadeIn() 方法。</dd>

<dt><a href="/tiy/t.asp?f=jquery_fadeout">jQuery fadeOut()</a></dt>
<dd>演示 jQuery fadeOut() 方法。</dd>

<dt><a href="/tiy/t.asp?f=jquery_fadetoggle">jQuery fadeToggle()</a></dt>
<dd>演示 jQuery fadeToggle() 方法。</dd>

<dt><a href="/tiy/t.asp?f=jquery_fadeto">jQuery fadeTo()</a></dt>
<dd>演示 jQuery fadeTo() 方法。</dd>
</dl>
</div>
...
<pre>$(selector).fadeIn(speed,callback);</pre>
...
<p><a href="/tiy/t.asp?f=jquery_fadein">亲自试一试</a></p>
</div>
...
<pre>$(selector).fadeOut(speed,callback);</pre>
...
<p><a href="/tiy/t.asp?f=jquery_fadeout">亲自试一试</a></p>
</div>
...
<pre>$(selector).fadeToggle(speed,callback);</pre>
...
<p><a href="/tiy/t.asp?f=jquery_fadetoggle">亲自试一试</a></p>
</div>
...
<pre>$(selector).fadeTo(speed,opacity,callback);</pre>
...
<p>如需全面查阅 jQuery 效果，请访问我们的 <a href="/jquery/jquery_ref_effects.asp" title="jQuery 参考手册 - 效果">jQuery 效果参考手册</a>。</p>
</div>
