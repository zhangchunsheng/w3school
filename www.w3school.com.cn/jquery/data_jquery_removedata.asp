...
<title>jQuery 数据 - jQuery.removeData() 方法</title>
</head>
...
<h1>jQuery 数据 - jQuery.removeData() 方法</h1>
...
<pre>
$(&quot;#btn2&quot;).click(function(){
  <code>$(&quot;div&quot;).removeData(&quot;greeting&quot;);</code>
  alert(&quot;Greeting is: &quot; + $(&quot;div&quot;).data(&quot;greeting&quot;));
});
</pre>

<p><a href="/tiy/t.asp?f=jquery_data_removedata">亲自试一试</a></p>
</div>
...
<p>removeData() 方法删除之前通过 data() 方法设置的数据。</p>

<p class="note"><span>注释：</span>这是底层级的方法；使用 <a href="/jquery/data_removedata.asp">.removeData()</a> 更加方便。</p>

<h3>语法</h3>

<pre>$(<i>selector</i>).removeData(<i>name</i>)</pre>
...
<td>
	<p>可选。规定要删除的数据的名称。</p>
	<p>如果没有规定名称，该方法将从被选元素中删除所有已存储的数据。</p>
</td>
</tr>
</table>
</div>
