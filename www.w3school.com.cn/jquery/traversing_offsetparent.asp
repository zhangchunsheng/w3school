...
<title>jQuery 遍历 - offsetParent() 方法</title>
</head>
...
<h1>jQuery 遍历 - offsetParent() 方法</h1>
...
<p>设置类名为 item-a 的 li 元素的最近定位父元素的背景色：</p>

<pre>
$('li.item-a').offsetParent().css('background-color', 'red');
</pre>

<p><a href="/tiy/t.asp?f=jquery_traversing_offsetparent">亲自试一试</a></p>
</div>
...
<p>如果给定一个表示 DOM 元素集合的 jQuery 对象，.offsetParent() 方法允许我们搜索 DOM 树中元素的祖先，并构造一个由最近的定位祖先元素包围的 jQuery 对象。定位元素指的是，元素的 CSS position 属性设置为 relative、absolute 或 fixed。在为表演动画计算偏移或在页面上放置对象时，该信息会很有用处。</p>

<p>请思考带有基本嵌套列表的页面，其中带有定位元素：</p>

<pre>
&lt;ul class=&quot;level-1&quot;&gt;
  &lt;li class=&quot;item-i&quot;&gt;I&lt;/li&gt;
  &lt;li class=&quot;item-ii&quot; <span class="marked">style=&quot;position: relative;&quot;</span>&gt;II
    &lt;ul class=&quot;level-2&quot;&gt;
...
<p>如果我们从项目 A 开始，我们可以找到其定位祖先元素：</p>

<pre>$('li.item-a')<code>.offsetParent()</code>.css('background-color', 'red');</pre>

<p><a href="/tiy/t.asp?f=jquery_traversing_offsetparent_2">亲自试一试</a></p>

<p>这会改变被定位的项目 II 的背景色。</p>
</div>
