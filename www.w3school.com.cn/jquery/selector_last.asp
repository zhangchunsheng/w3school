...
<p><a href="/tiy/t.asp?f=jquery_selector_last">亲自试一试</a></p>
</div>
...
<p>:last 选择器选取最后一个元素。</p>

<p>最常见的用法：与其他元素一起使用，选取指定组合中的最后一个元素（就像上面的例子）。</p>
