...
<li class="currentLink"><a href="/jquery/jquery_stop.asp" title="jQuery 停止动画">jQuery stop()</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/jquery/jquery_animate.asp" title="jQuery 效果 - 动画">jQuery 动画</a></li>
<li class="next"><a href="/jquery/jquery_callback.asp" title="jQuery 回调函数">jQuery Callback</a></li>
</ul>
</div>

<div id="intro">
<p><strong>jQuery stop() 方法用于在动画或效果完成前对它们进行停止。</strong></p>
</div>
...
<dl>
<dt><a href="/tiy/t.asp?f=jquery_stop_slide">jQuery stop() 滑动</a></dt>
<dd>演示 jQuery stop() 方法。</dd>

<dt><a href="/tiy/t.asp?f=jquery_stop_params">jQuery stop() 动画（带有参数）</a></dt>
<dd>演示 jQuery stop() 方法。</dd>
</dl>
</div>
...
<pre>$(selector).stop(stopAll,goToEnd);</pre>
...
<p><a href="/tiy/t.asp?f=jquery_stop_slide">亲自试一试</a></p>
</div>
