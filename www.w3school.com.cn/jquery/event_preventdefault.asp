...
<title>jQuery 事件 - preventDefault() 方法</title>
</head>
...
<h1>jQuery 事件 - preventDefault() 方法</h1>
...
<p><a href="/tiy/t.asp?f=jquery_event_preventdefault">亲自试一试</a></p>
</div>
...
<p>preventDefault() 方法阻止元素发生默认的行为（例如，当点击提交按钮时阻止对表单的提交）。</p>

<h3>语法</h3>

<pre><i>event</i>.preventDefault()</pre>
...
<tr>
<td><i>event</i></td>
<td>必需。规定阻止哪个事件的默认动作。这个 <i>event</i> 参数来自事件绑定函数。</td>
</tr>
</table>
</div>
