...
<h2>jQuery 参考手册</h2>
<ul>
<li class="currentLink"><a href="/jquery/jquery_reference.asp" title="jQuery 参考手册">jQuery 参考手册</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/jquery/jquery_quiz.asp" title="jQuery 测验">jQuery 测验</a></li>
<li class="next"><a href="/jquery/jquery_ref_selectors.asp" title="jQuery 参考手册 - 选择器">jQuery 选择器</a></li>
</ul>
</div>

<div id="intro">
<p><strong>W3school 提供完整的 jQuery 参考手册以及大量的在线实例。</strong></p>
</div>
...
<p>在 W3School，您将找到包含所有 jQuery 对象和函数的完整参考手册：</p>

<ul>
<li><a href="/jquery/jquery_ref_selectors.asp">选择器</a></li>
<li><a href="/jquery/jquery_ref_events.asp">事件</a></li>
<li><a href="/jquery/jquery_ref_effects.asp">效果</a></li>
<li><a href="/jquery/jquery_ref_manipulation.asp">文档操作</a></li>
<li><a href="/jquery/jquery_ref_attributes.asp">属性</a></li>
<li><a href="/jquery/jquery_ref_css.asp">CSS</a></li>
<li><a href="/jquery/jquery_ref_ajax.asp">AJAX</a></li>
<li><a href="/jquery/jquery_ref_traversing.asp">遍历</a></li>
<li><a href="/jquery/jquery_ref_data.asp">数据</a></li>
<li><a href="/jquery/jquery_ref_dom_element_methods.asp">DOM 元素</a></li>
<li><a href="/jquery/jquery_ref_core.asp">核心</a></li>
</ul>
</div>
...
<p><a href="/jsref/index.asp">JavaScript 参考手册</a></p>
<p><a href="/xmldom/xmldom_reference.asp">XML DOM 参考手册</a></p>
</div>
