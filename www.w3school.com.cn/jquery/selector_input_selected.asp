...
<title>jQuery :selected 选择器</title>
</head>
...
<p><a href="/tiy/t.asp?f=jquery_selector_input_selected">亲自试一试</a></p>
</div>
...
<p>:selected 选择器选取被选择的 &lt;option&gt; 元素。</p>
...
<p class="note"><span>注释：</span>该选择器不适用于单选按钮或复选框。请使用 :checked 代替。</p>
</div>
