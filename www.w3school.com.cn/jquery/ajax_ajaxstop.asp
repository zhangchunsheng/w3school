...
<title>jQuery ajax - ajaxStop() 方法</title>
</head>
...
<p><a href="/tiy/t.asp?f=jquery_ajax_ajaxstop">亲自试一试</a></p>
</div>
...
<p>ajaxStop() 方法在 AJAX 请求结束时执行函数。它是一个 Ajax 事件。</p>

<h3>详细说明</h3>

<p>无论 Ajax 请求在何时完成 ，jQuery 都会检查是否存在其他 Ajax 请求。如果不存在，则 jQuery 会触发该 ajaxStop 事件。在此时，由 .ajaxStop() 方法注册的任何函数都会被执行。</p>

<h3>语法</h3>

<pre>.ajaxStop(<i>function()</i>)</pre>
...
<pre>
$(&quot;#loading&quot;)<code>.ajaxStop</code>(function(){
  $(this).hide();
});
</pre>
