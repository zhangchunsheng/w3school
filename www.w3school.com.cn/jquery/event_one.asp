...
<p><a href="/tiy/t.asp?f=jquery_event_one">亲自试一试</a></p>
</div>
...
<p>one() 方法为被选元素附加一个或多个事件处理程序，并规定当事件发生时运行的函数。</p>

<p>当使用 one() 方法时，每个元素只能运行一次事件处理器函数。</p>

<h3>语法</h3>

<pre>$(<i>selector</i>).one(<i>event</i>,<i>data</i>,<i>function</i>)</pre>
