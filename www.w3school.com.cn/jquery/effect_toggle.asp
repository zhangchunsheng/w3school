...
<title>jQuery 效果 - toggle() 方法</title>
</head>
...
<p><a href="/tiy/t.asp?f=jquery_effect_toggle">亲自试一试</a></p>
</div>
...
<p>toggle() 方法切换元素的可见状态。</p>

<p>如果被选元素可见，则隐藏这些元素，如果被选元素隐藏，则显示这些元素。</p>

<h3>语法</h3>

<pre>$(<i>selector</i>).toggle(<i>speed</i>,<i>callback</i>,<i>switch</i>)</pre>
...
<td><i>speed</i></td>
<td>
	<p>可选。规定元素从可见到隐藏的速度（或者相反）。默认为 &quot;0&quot;。</p>
	...
	<p>在设置速度的情况下，元素从可见到隐藏的过程中，会逐渐地改变其高度、宽度、外边距、内边距和透明度。</p>
	
	<p>如果设置此参数，则无法使用 switch 参数。</p>
</td>
</tr>
...
<td><i>switch</i></td>
<td>
	<p>可选。布尔值。规定 toggle 是否隐藏或显示所有被选元素。</p>
	...
	<p>如果设置此参数，则无法使用 speed 和 callback 参数。</p>
</td>
</tr>
</table>
</div>
...
<p class="note"><span>注释：</span>该效果适用于通过 jQuery 隐藏的元素，或在 CSS 中声明 display:none 的元素（但不适用于 visibility:hidden 的元素）。</p>
...
<dl>
<dt><a href="/tiy/t.asp?f=jquery_effect_toggle_speed">使用 speed 参数</a></dt>
<dd>使用 speed 参数来隐藏和显示元素。</dd>

<dt><a href="/tiy/t.asp?f=jquery_effect_toggle_switch">使用 switch 参数</a></dt>
<dd>使用 switch 参数来显示所有隐藏的段落。</dd>
</dl>
</div>
