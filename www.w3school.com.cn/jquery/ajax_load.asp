...
<p class="note"><span>注释：</span>还存在一个名为 <a href="/jquery/event_load.asp" title="jQuery 事件 - load() 方法">load</a> 的 jQuery <a href="jquery_ref_events.asp" title="jQuery 参考手册 - 事件">事件</a>方法。调用哪个，取决于参数。</p>
