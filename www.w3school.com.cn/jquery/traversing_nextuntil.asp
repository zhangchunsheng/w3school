...
<title>jQuery 遍历 - nextUntil() 方法</title>
</head>
...
<p>查找跟随 &lt;dt id=&quot;term-2&quot;&gt; 的同胞元素，直到下一个 &lt;dt&gt;，然后将它们设置为红色背景色。同时，找到跟随 &lt;dt id=&quot;term-1&quot;&gt; 的 &lt;dd&gt; 同胞元素，直到 &lt;dt id=&quot;term-3&quot;&gt;，并为它们设置蓝色文本颜色。</p>

<pre>
$(&quot;#term-2&quot;)<code>.nextUntil(&quot;dt&quot;)</code>.css(&quot;background-color&quot;, &quot;red&quot;);
var term3 = document.getElementById(&quot;term-3&quot;);
$(&quot;#term-1&quot;)<code>.nextUntil(term3, &quot;dd&quot;)</code>.css(&quot;color&quot;, &quot;blue&quot;);
</pre>

<p><a href="/tiy/t.asp?f=jquery_traversing_nextuntil">亲自试一试</a></p>
</div>
...
<p>nextUntil() 获得每个元素所有跟随的同胞元素，但不包括被选择器、DOM 节点或已传递的 jQuery 对象匹配的元素。</p>


<h3>语法 1</h3>

<pre>.nextUntil(<i>selector</i>,<i>filter</i>)</pre>
...
<tr>
<td><i>selector</i></td>
<td>字符串值，包含指示在何处停止匹配跟随的同胞元素的选择器表达式。</td>
</tr>
...
<pre>.nextUntil(<i>element</i>,<i>filter</i>)</pre>
...
<tr>
<td><i>element</i></td>
<td>指示在何处停止匹配跟随的同胞元素的 DOM 节点或 jQuery 对象。</td>
</tr>
...
<p>如果给定一个表示 DOM 元素集合的 jQuery 对象，.nextUntil() 方法允许我们搜索 DOM 树中的元素跟随的同胞元素，当遇到被该方法的参数所匹配的元素时会停止搜索。返回的新 jQuery 对象包含所有跟随的同胞元素，但不包含被参数匹配的元素。</p>

<p>如果选择器不匹配或未规定选择器，则会选取所有跟随的同胞；如果不提供供筛选的选择器，则该方法选取的元素与 .nextAll() 方法相同。</p>

<p>对于 jQuery 1.6，DOM 节点或 jQuery 对象，而不是选择器，可传递到 .nextUntil() 方法。</p>

<p>该方法接受可选的选择器表达式作为其第二参数。如果指定该参数，则将通过检测元素是否匹配该选择器来筛选它们。</p>
</div>
