...
<title>jQuery 事件 - mouseover() 方法</title>
</head>
...
<p><a href="/tiy/t.asp?f=jquery_event_mouseover_mouseout">亲自试一试</a></p>
</div>
...
<p>当鼠标指针位于元素上方时，会发生 mouseover 事件。</p>

<p>该事件大多数时候会与 <a href="/jquery/event_mouseout.asp" title="jQuery mouseout() 事件函数">mouseout</a> 事件一起使用。</p>

<p>mouseover() 方法触发 mouseover 事件，或规定当发生 mouseover 事件时运行的函数。</p>

<p class="note"><span>注释：</span>与 mouseenter 事件不同，不论鼠标指针穿过被选元素或其子元素，都会触发 mouseover 事件。只有在鼠标指针穿过被选元素时，才会触发 mouseenter 事件。请看下面例子的演示。</p>

<p>亲自试一试：<a href="/tiy/t.asp?f=jquery_event_mouseenter_mouseover">mouseenter 与 mouseover 的不同</a></p>
</div>


<div>
<h2>触发 mouseover 事件</h2>

<h3>语法</h3>

<pre>$(<i>selector</i>).mouseover()</pre>

<p><a href="/tiy/t.asp?f=jquery_event_over_out_trigger">亲自试一试</a></p>
</div>


<div>
<h2>将函数绑定到 mouseover 事件</h2>

<h3>语法</h3>

<pre>$(<i>selector</i>).mouseover(<i>function</i>)</pre>
...
<tr>
<td><i>function</i></td>
<td>可选。规定当发生 mouseover 事件时运行的函数。</td>
</tr>
</table>
