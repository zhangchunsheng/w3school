...
<title>jQuery 事件 - mouseleave() 方法</title>
</head>
...
<p>该事件大多数时候会与 <a href="/jquery/event_mouseenter.asp" title="jQuery mouseenter() 事件函数">mouseenter</a> 事件一起使用。</p>

<p>mouseleave() 方法触发 mouseleave 事件，或规定当发生 mouseleave 事件时运行的函数。</p>

<p class="note"><span>注释：</span>与 mouseout 事件不同，只有在鼠标指针离开被选元素时，才会触发 mouseleave 事件。如果鼠标指针离开任何子元素，同样会触发 mouseout 事件。请看下面例子的演示。</p>
...
<div>
<h2>触发 mouseleave 事件</h2>

<h3>语法</h3>

<pre>$(<i>selector</i>).mouseleave()</pre>
...
<div>
<h2>将函数绑定到 mouseleave 事件</h2>

<h3>语法</h3>

<pre>$(<i>selector</i>).mouseleave(<i>function</i>)</pre>
...
<tr>
<td><i>function</i></td>
<td>可选。规定当发生 mouseleave 事件时运行的函数。</td>
</tr>
</table>
