...
<title>jQuery 事件 - keydown() 方法</title>
</head>
...
<p>完整的 key press 过程分为两个部分：1. 按键被按下；2. 按键被松开。</p>

<p>当按钮被按下时，发生 keydown 事件。</p>
...
<div>
<h2>将函数绑定到 keydown 事件</h2>

<h3>语法</h3>

<pre>$(<i>selector</i>).keydown(<i>function</i>)</pre>
...
<tr>
<td><i>function</i></td>
<td>可选。规定当发生 keydown 事件时运行的函数。</td>
</tr>
</table>
