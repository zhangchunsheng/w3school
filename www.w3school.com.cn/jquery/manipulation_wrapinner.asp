...
<title>jQuery 文档操作 - wrapInner() 方法</title>
</head>
...
<h1>jQuery 文档操作 - wrapInner() 方法</h1>
...
<p>在每个 p 元素的内容上包围 b 元素：</p>

<pre>
$(&quot;.btn1&quot;).click(function(){
   $(&quot;p&quot;).<code>wrapInner(&quot;&lt;b&gt;&lt;/b&gt;&quot;)</code>;
});
</pre>

<p><a href="/tiy/t.asp?f=jquery_manipulation_wrapinner">亲自试一试</a></p>
</div>
...
<p>wrapInner() 方法使用指定的 HTML 内容或元素，来包裹每个被选元素中的所有内容 (inner HTML)。</p>

<h3>语法</h3>

<pre>$(<i>selector</i>).wrapInner(<i>wrapper</i>)</pre>
...
<td><i>wrapper</i></td>
<td>
	<p>必需。规定包围在被选元素的内容周围的内容。</p>

	<p>可能的值:</p>
	<ul class="listintable">
	<li>HTML 代码 - 比如 (&quot;&lt;div&gt;&lt;/div&gt;&quot;)</li>
	<li>新的 DOM 元素 - 比如 (document.createElement(&quot;div&quot;))</li>
...
<p>使用函数来规定包围在每个被选元素周围的内容。</p>

<h3>语法</h3>

<pre>$(<i>selector</i>).wrapInner(<i>function()</i>)</pre>

<p><a href="/tiy/t.asp?f=jquery_manipulation_wrapinner_function">亲自试一试</a></p>
...
<dl>
<dt><a href="/tiy/t.asp?f=jquery_manipulation_wrapinner_element">使用新元素来包裹</a></dt>
<dd>创建一个新的 DOM 元素来包裹每个被选元素。</dd>
</dl>
</div>
