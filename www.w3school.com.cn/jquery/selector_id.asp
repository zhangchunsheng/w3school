...
<p>选取 id=&quot;choose&quot; 的 元素：</p>

<pre>$(#choose)</pre>

<p><a href="/tiy/t.asp?f=jquery_selector_id">亲自试一试</a></p>
</div>
...
<p># 选取带有唯一的指定 id 的元素。</p>

<p>id 引用 HTML 元素的 id 属性。</p>

<p>相同的 id 值只能在文档中使用一次。</p>
...
<p class="note"><span>注释：</span>不要使用数字开头的 ID 名称！在某些浏览器中可能出问题。</p>
</div>
