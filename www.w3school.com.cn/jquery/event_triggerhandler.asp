...
<title>jQuery 事件 - triggerHandler() 方法</title>
</head>
...
<h1>jQuery 事件 - triggerHandler() 方法</h1>
...
<p><a href="/tiy/t.asp?f=jquery_event_triggerhandler">亲自试一试</a></p>
</div>
...
<pre>$(<i>selector</i>).triggerHandler(<i>event</i>,[<i>param1</i>,<i>param2</i>,...])</pre>
...
<tr>
<td><i>event</i></td>
<td>必需。规定指定元素要触发的事件。</td>
</tr>

<tr>
<td>[<i>param1</i>,<i>param2</i>,...]</td>
<td>可选。传递到事件处理程序的额外参数。</td>
</tr>
</table>
</div>
