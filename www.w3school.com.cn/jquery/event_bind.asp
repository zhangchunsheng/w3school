...
<p><a href="/tiy/t.asp?f=jquery_event_bind">亲自试一试</a></p>
</div>
...
<p>bind() 方法为被选元素添加一个或多个事件处理程序，并规定事件发生时运行的函数。</p>
</div>
...
<pre>$(<i>selector</i>).bind(<i>event</i>,<i>data</i>,<i>function</i>)</pre>
...
<pre>$(<i>selector</i>).bind({<i>event</i>:<i>function</i>, <i>event</i>:<i>function</i>, ...})</pre>

<p><a href="/tiy/t.asp?f=jquery_event_bind_map">亲自试一试</a></p>
...
<tr>
<td>{<i>event</i>:<i>function</i>, <i>event</i>:<i>function</i>, ...}</td>
<td>必需。规定事件映射，其中包含一个或多个添加到元素的事件，以及当事件发生时运行的函数。</td>
</tr>
</table>
</div>
