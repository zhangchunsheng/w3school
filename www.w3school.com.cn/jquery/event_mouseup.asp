...
<title>jQuery 事件 - mouseup() 方法</title>
</head>
...
<p><a href="/tiy/t.asp?f=jquery_event_mouseup">亲自试一试</a></p>
</div>
...
<p>当在元素上放松鼠标按钮时，会发生 mouseup 事件。</p>

<p>与 click 事件不同，mouseup 事件仅需要放松按钮。当鼠标指针位于元素上方时，放松鼠标按钮就会触发该事件。</p>
...
<pre>$(<i>selector</i>).mouseup()</pre>

<p><a href="/tiy/t.asp?f=jquery_event_mouseup_trigger">亲自试一试</a></p>
</div>


<div>
<h2>将函数绑定到 mouseup 事件</h2>

<h3>语法</h3>

<pre>$(<i>selector</i>).mouseup(<i>function</i>)</pre>
...
<tr>
<td><i>function</i></td>
<td>可选。规定当发生 mouseup 事件时运行的函数。</td>
</tr>
</table>
