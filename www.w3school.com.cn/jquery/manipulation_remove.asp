...
<title>jQuery 文档操作 - remove() 方法</title>
</head>
...
<p><a href="/tiy/t.asp?f=jquery_manipulation_remove">亲自试一试</a></p>
</div>
...
<p>remove() 方法移除被选元素，包括所有文本和子节点。</p>

<p>该方法不会把匹配的元素从 jQuery 对象中删除，因而可以在将来再使用这些匹配的元素。</p>

<p>但除了这个元素本身得以保留之外，remove() 不会保留元素的 jQuery 数据。其他的比如绑定的事件、附加的数据等都会被移除。这一点与 detach() 不同。</p>

<h3>语法</h3>

<pre>$(<i>selector</i>).remove()</pre>
</div>
...
<dl>
<dt><a href="/tiy/t.asp?f=jquery_manipulation_remove_move">移动元素</a></dt>
<dd>使用 remove() 方法来移动元素。</dd>
</dl>
</div>
