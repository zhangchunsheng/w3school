...
<title>jQuery 事件 - pageX 属性</title>
</head>
...
<p><a href="/tiy/t.asp?f=jquery_event_pagex_pagey">亲自试一试</a></p>
</div>
...
<p>pageX() 属性是鼠标指针的位置，相对于文档的左边缘。</p>

<h3>语法</h3>

<pre><i>event</i>.pageX</pre>
...
<tr>
<td><i>event</i></td>
<td>必需。规定要使用的事件。这个 <i>event</i> 参数来自事件绑定函数。</td>
</tr>
</table>
</div>
