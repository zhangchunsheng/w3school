...
<li class="currentLink"><a href="/jquery/jquery_chaining.asp" title="jQuery - Chaining">jQuery Chaining</a></li>
</ul>
<h2>jQuery HTML</h2>
<ul>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/jquery/jquery_callback.asp" title="jQuery 回调函数">jQuery Callback</a></li>
<li class="next"><a href="/jquery/jquery_dom_get.asp" title="jQuery - 获取内容和属性">jQuery 获取</a></li>
</ul>
</div>


<div id="intro">
<p><strong>通过 jQuery，您可以把动作/方法链接起来。</strong></p>

<p><strong>Chaining 允许我们在一条语句中允许多个 jQuery 方法（在相同的元素上）。</strong></p>
</div>
...
<p>下面的例子把 css(), slideUp(), and slideDown() 链接在一起。&quot;p1&quot; 元素首先会变为红色，然后向上滑动，然后向下滑动：</p>

<pre>$(&quot;#p1&quot;).css(&quot;color&quot;,&quot;red&quot;).slideUp(2000).slideDown(2000);</pre>

<p><a href="/tiy/t.asp?f=jquery_chaining">亲自试一试</a></p>

<p>如果需要，我们也可以添加多个方法调用。</p>

<p class="tip"><span>提示：</span>当进行链接时，代码行会变得很差。不过，jQuery 在语法上不是很严格；您可以按照希望的格式来写，包含折行和缩进。</p>
...
<p><a href="/tiy/t.asp?f=jquery_chaining2">亲自试一试</a></p>

<p>jQuery 会抛掉多余的空格，并按照一行长代码来执行上面的代码行。</p>
</div>
