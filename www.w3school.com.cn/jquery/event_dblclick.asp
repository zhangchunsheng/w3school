...
<title>jQuery 事件 - dblclick() 方法</title>
</head>
...
<p><a href="/tiy/t.asp?f=jquery_event_dblclick">亲自试一试</a></p>
</div>
...
<p class="tip"><span>提示：</span>如果把 dblclick 和 click 事件应用于同一元素，可能会产生问题。</p>
</div>


<div>
<h2>触发 dblclick 事件</h2>

<h3>语法</h3>

<pre>$(<i>selector</i>).dblclick()</pre>

<p><a href="/tiy/t.asp?f=jquery_event_dblclick_trigger">亲自试一试</a></p>
</div>


<div>
<h2>将函数绑定到 dblclick 事件</h2>

<h3>语法</h3>

<pre>$(<i>selector</i>).dblclick(<i>function</i>)</pre>
...
<tr>
<td><i>function</i></td>
<td>可选。规定当发生 dblclick 事件时运行的函数。</td>
</tr>
</table>
