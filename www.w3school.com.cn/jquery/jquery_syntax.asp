...
<li class="currentLink"><a href="/jquery/jquery_syntax.asp" title="jQuery 语法">jQuery 语法</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/jquery/jquery_install.asp" title="jQuery 安装">jQuery 安装</a></li>
<li class="next"><a href="/jquery/jquery_selectors.asp" title="jQuery 选择器">jQuery 选择器</a></li>
</ul>
</div>

<div id="intro">
<p><strong>通过 jQuery，您可以选取（查询，query） HTML 元素，并对它们执行“操作”（actions）。</strong></p>
</div>
...
<p class="tip"><span>提示：</span>jQuery 使用的语法是 XPath 与 CSS 选择器语法的组合。在本教程接下来的章节，您将学习到更多有关选择器的语法。</p>
</div>
