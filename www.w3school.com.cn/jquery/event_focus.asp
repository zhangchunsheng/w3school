...
<title>jQuery 事件 - focus() 方法</title>
</head>
...
<p><a href="/tiy/t.asp?f=jquery_event_focus">亲自试一试</a></p>
</div>
...
<div>
<h2>将函数绑定到 focus 事件</h2>

<h3>语法</h3>

<pre>$(<i>selector</i>).focus(<i>function</i>)</pre>
