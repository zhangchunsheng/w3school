...
<title>jQuery 事件 - result 属性</title>
</head>
...
$(&quot;button&quot;).click(function(e) {
  $(&quot;p&quot;).html(<code>e.result</code>);
});
</pre>

<p><a href="/tiy/t.asp?f=jquery_event_result">亲自试一试</a></p>
</div>
...
<p>result 属性包含由被指定事件触发的事件处理器返回的最后一个值，除非这个值未定义。</p>

<h3>语法</h3>

<pre><i>event</i>.result</pre>
...
<tr>
<td><i>event</i></td>
<td>必需。规定返回的最后一个值来自哪个事件。这个 <i>event</i> 参数来自事件绑定函数。</td>
</tr>
</table>
</div>
