...
<p><a href="/tiy/t.asp?f=jquery_effect_animate">亲自试一试</a></p>
</div>
...
<p class="note"><span>注释：</span>使用 &quot;+=&quot; 或 &quot;-=&quot; 来创建相对动画（relative animations）。</p>

<h3>语法 1</h3>

<pre>$(<i>selector</i>).animate(<i>styles</i>,<i>speed</i>,<i>easing</i>,<i>callback</i>)</pre>
...
<td>styles</td>
<td>
<p>必需。规定产生动画效果的 CSS 样式和值。</p>

<p>可能的 CSS 样式值（提供实例）：</p>

<ul class="listintable">
		<li><a href="/tiy/t.asp?f=jquery_eff_ani_backgroundposition">backgroundPosition</a></li>
		<li><a href="/tiy/t.asp?f=jquery_eff_ani_borderwidth">borderWidth</a></li>
		<li><a href="/tiy/t.asp?f=jquery_eff_ani_borderbottomwidth">borderBottomWidth</a></li>
		<li><a href="/tiy/t.asp?f=jquery_eff_ani_borderleftwidth">borderLeftWidth</a></li>
		<li><a href="/tiy/t.asp?f=jquery_eff_ani_borderrightwidth">borderRightWidth</a></li>
		<li><a href="/tiy/t.asp?f=jquery_eff_ani_bordertopwidth">borderTopWidth</a></li>
		<li><a href="/tiy/t.asp?f=jquery_eff_ani_borderspacing">borderSpacing</a></li>
		<li><a href="/tiy/t.asp?f=jquery_eff_ani_margin">margin</a></li>
		<li><a href="/tiy/t.asp?f=jquery_eff_ani_marginbottom">marginBottom</a></li>
		<li><a href="/tiy/t.asp?f=jquery_eff_ani_marginleft">marginLeft</a></li>
		<li><a href="/tiy/t.asp?f=jquery_eff_ani_marginright">marginRight</a></li>
		<li><a href="/tiy/t.asp?f=jquery_eff_ani_margintop">marginTop</a></li>
		<li><a href="/tiy/t.asp?f=jquery_eff_ani_outlinewidth">outlineWidth</a></li>
		<li><a href="/tiy/t.asp?f=jquery_eff_ani_padding">padding</a></li>
		<li><a href="/tiy/t.asp?f=jquery_eff_ani_paddingbottom">paddingBottom</a></li>
		<li><a href="/tiy/t.asp?f=jquery_eff_ani_paddingleft">paddingLeft</a></li>
		<li><a href="/tiy/t.asp?f=jquery_eff_ani_paddingright">paddingRight</a></li>
		<li><a href="/tiy/t.asp?f=jquery_eff_ani_paddingtop">paddingTop</a></li>
		<li><a href="/tiy/t.asp?f=jquery_eff_ani_height">height</a></li>
		<li><a href="/tiy/t.asp?f=jquery_eff_ani_width">width</a></li>				
		<li><a href="/tiy/t.asp?f=jquery_eff_ani_maxheight">maxHeight</a></li>
		<li><a href="/tiy/t.asp?f=jquery_eff_ani_maxwidth">maxWidth</a></li>				
		<li><a href="/tiy/t.asp?f=jquery_eff_ani_minheight">minHeight</a></li>
		<li><a href="/tiy/t.asp?f=jquery_eff_ani_minwidth">minWidth</a></li>				
    	<li><a href="/tiy/t.asp?f=jquery_eff_ani_font">font</a></li>				
    	<li><a href="/tiy/t.asp?f=jquery_eff_ani_fontsize">fontSize</a></li>				
    	<li><a href="/tiy/t.asp?f=jquery_eff_ani_bottom">bottom</a></li>				
    	<li><a href="/tiy/t.asp?f=jquery_eff_ani_left">left</a></li>				
    	<li><a href="/tiy/t.asp?f=jquery_eff_ani_right">right</a></li>				
    	<li><a href="/tiy/t.asp?f=jquery_eff_ani_top">top</a></li>				
    	<li><a href="/tiy/t.asp?f=jquery_eff_ani_letterspacing">letterSpacing</a></li>
    	<li><a href="/tiy/t.asp?f=jquery_eff_ani_wordspacing">wordSpacing</a></li>
    	<li><a href="/tiy/t.asp?f=jquery_eff_ani_lineheight">lineHeight</a></li>    	
    	<li><a href="/tiy/t.asp?f=jquery_eff_ani_textindent">textIndent</a></li>
    </ul>

<p class="note"><span>注释：</span>CSS 样式使用 DOM 名称（比如 &quot;fontSize&quot;）来设置，而非 CSS 名称（比如 &quot;font-size&quot;）。</p>
</td>
</tr>
...
<td>easing</td>
<td>
	<p>可选。规定在不同的动画点中设置动画速度的 easing 函数。</p>
...
<td>callback</td>
<td>
	<p>可选。animate 函数执行完之后，要执行的函数。</p>
	
	<p>如需学习更多有关 callback 的内容，请访问我们的 <a href="/jquery/jquery_callback.asp" title="jQuery Callback 函数">jQuery Callback</a> 这一章。</p>
</td>
</tr>
</table>
...
<pre>$(<i>selector</i>).animate(<i>styles</i>,<i>options</i>)</pre>
...
<td>
	...
	<li>specialEasing - 来自 <i>styles</i> 参数的一个或多个 CSS 属性的映射，以及它们的对应 easing 函数</li>
	</ul>
</td>
</tr>
</table>
