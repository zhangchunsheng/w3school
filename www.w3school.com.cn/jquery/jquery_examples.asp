...
<h2>jQuery 实例</h2>
<ul>
<li class="currentLink"><a href="/jquery/jquery_examples.asp" title="jQuery 实例">jQuery 实例</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/jquery/jquery_noconflict.asp" title="jQuery - noConflict() 方法">jQuery noConflict()</a></li>
<li class="next"><a href="/jquery/jquery_quiz.asp" title="jQuery 测验">jQuery 测验</a></li>
</ul>
</div>

<div id="intro">
<p><strong>通过实例增进 jQuery 技能！</strong></p>
</div>
...
<dl>
<dt><a href="/tiy/t.asp?f=jquery_hide_this">$(this).hide()</a></dt>
<dd>演示 jQuery 的 hide() 函数，隐藏当前的 HTML 元素。</dd>

<dt><a href="/tiy/t.asp?f=jquery_hide_p">$(&quot;p&quot;).hide()</a></dt>
<dd>演示 jQuery 的 hide() 函数，隐藏所有 &lt;p&gt; 元素。</dd>

<dt><a href="/tiy/t.asp?f=jquery_hide_class">$(&quot;.test&quot;).hide()</a></dt>
<dd>演示 jQuery 的 hide() 函数，隐藏所有 class=&quot;test&quot; 的元素。</dd>

<dt><a href="/tiy/t.asp?f=jquery_hide_id">$(&quot;#test&quot;).hide()</a></dt>
<dd>演示 jQuery 的 hide() 函数，隐藏 id=&quot;test&quot; 的元素。</dd>
</dl>

<p><em><a href="/jquery/jquery_syntax.asp" title="jQuery 语法">例子解释</a></em></p>
</div>


<div class="example">
<h2>Hiding - Sliding- Fading</h2>

<dl>
<dt><a href="/tiy/t.asp?f=jquery_fadeout">jQuery fadeOut()</a></dt>
<dd>演示简单的 jQuery fadeout() 函数。</dd>

<dt><a href="/tiy/t.asp?f=jquery_hide">jQuery hide()</a></dt>
<dd>演示简单的 jQuery hide() 函数。</dd>

<dt><a href="/tiy/t.asp?f=jquery_hide_explanations">Hide explanations</a></dt>
<dd>演示如何隐藏部分文本。</dd>

<dt><a href="/tiy/t.asp?f=jquery_slide_toggle">Slide panel</a></dt>
...
<p><em><a href="/jquery/jquery_effects.asp" title="jQuery 效果">例子解释</a></em></p>
</div>
...
<p><a href="/tiy/t.asp?f=jquery_html_change_p">改变 HTML 元素的内容</a>。</p>

<p><a href="/tiy/t.asp?f=jquery_html_append">向 HTML 元素追加内容</a>。</p>

<p><a href="/tiy/t.asp?f=jquery_html_after">在 HTML 元素之后追加内容</a>。</p>

<p><em><a href="/jquery/jquery_html.asp" title="jQuery HTML 操作">例子解释</a></em></p>
</div>
...
<p><a href="/tiy/t.asp?f=jquery_css_change_p">改变 HTML 元素的 CSS 属性</a>。</p>

<p><a href="/tiy/t.asp?f=jquery_css_change_p_and_font">改变多个 CSS 属性</a>。</p>

<p><a href="/tiy/t.asp?f=jquery_css_getcolor">获得元素的 CSS 属性</a>。</p>

<p><em><a href="/jquery/jquery_css.asp" title="jQuery CSS 函数">例子解释</a></em></p>
</div>
...
<p><a href="/tiy/t.asp?f=jquery_ajax1">使用 $(selector).load(url) 来改变 HTML 内容</a>。</p>

<p><a href="/tiy/t.asp?f=jquery_ajax2">使用 $.ajax(options) 来改变 HTML 内容</a>。</p>

<p><em><a href="/jquery/jquery_ajax.asp" title="jQuery AJAX 函数">例子解释</a></em></p>
</div>
