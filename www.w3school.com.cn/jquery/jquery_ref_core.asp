...
<li class="currentLink"><a href="/jquery/jquery_ref_core.asp" title="jQuery 参考手册 - 核心">jQuery 核心</a></li>
...
<h1>jQuery 参考手册 - 核心</h1>

<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/jquery/jquery_ref_dom_element_methods.asp" title="jQuery 参考手册 - DOM 元素方法">jQuery DOM 元素</a></li>
<li class="next"><a href="/jquery/jquery_ref_prop.asp" title="jQuery 属性">jQuery 属性</a></li>
</ul>
</div>
...
<tr>
<td><a href="core_jquery.asp" title="jQuery jQuery() 方法">jQuery()</a></td>
<td>接受一个字符串，其中包含了用于匹配元素集合的 CSS 选择器。</td>
</tr>

<tr>
<td><a href="core_noconflict.asp" title="jQuery noConflict() 方法">jQuery.noConflict()</a></td>
