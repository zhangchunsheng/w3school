...
<p><a href="/tiy/t.asp?f=jquery_effect_show_hide">亲自试一试</a></p>
</div>
...
<p>如果被选元素已被隐藏，则显示这些元素：</p>

<h3>语法</h3>

<pre>$(<i>selector</i>).show(<i>speed</i>,<i>callback</i>)</pre>
...
<td>
	...
	<p>在设置速度的情况下，元素从隐藏到完全可见的过程中，会逐渐地改变其高度、宽度、外边距、内边距和透明度。</p>
</td>
</tr>
...
<p class="tip"><span>提示：</span>如果元素已经是完全可见，则该效果不产生任何变化，除非规定了 callback 函数。</p>
...
<dl>
<dt><a href="/tiy/t.asp?f=jquery_effect_show_hide_speed">使用 speed 参数</a></dt>
<dd>使用 speed 参数来隐藏和显示元素。</dd>

<dt><a href="/tiy/t.asp?f=jquery_effect_show_hide_callback">使用 speed 和 callback 参数</a></dt>
<dd>使用 speed 和 callback 参数来隐藏和显示元素。</dd>
</dl>
</div>
