...
<title>jQuery 文档操作 - text() 方法</title>
</head>
...
<pre>
$(&quot;.btn1&quot;).click(function(){
  $(&quot;p&quot;).<code>text(&quot;Hello &lt;b&gt;world&lt;/b&gt;!&quot;);</code>
});
</pre>

<p><a href="/tiy/t.asp?f=jquery_manipulation_text_set">亲自试一试</a></p>
</div>
...
<p>当该方法用于返回一个值时，它会返回所有匹配元素的组合的文本内容（会删除 HTML 标记）。</p>

<h3>语法</h3>

<pre>$(<i>selector</i>).text()</pre>

<p><a href="/tiy/t.asp?f=jquery_manipulation_text_get">亲自试一试</a></p>
</div>
...
<p>当该方法用于设置值时，它会覆盖被选元素的所有内容。</p>

<pre>$(<i>selector</i>).text(<i>content</i>)</pre>
...
<tr>
<td><i>content</i></td>
<td>规定被选元素的新文本内容。注释：特殊字符会被编码。</td>
<tr>
</table>
</div>
...
<p>使用函数设置所有被选元素的文本内容。</p>

<h3>语法</h3>

<pre>$(<i>selector</i>).text(<i>function(index,oldcontent)</i>)</pre>

<p><a href="/tiy/t.asp?f=jquery_manipulation_text_set_function">亲自试一试</a></p>
...
<td>
	<p>必需。规定返回被选元素的新文本内容的函数。</p>
	<ul class="listintable">
	<li>index - 可选。接受选择器的 index 位置。</li>
	<li>html - 可选。接受选择器的当前内容。</li>
	</ul>
</td>
<tr>
</table>
