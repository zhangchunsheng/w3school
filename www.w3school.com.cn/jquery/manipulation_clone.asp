...
<title>jQuery 文档操作 - clone() 方法</title>
</head>
...
$(&quot;button&quot;).click(function(){
  $(&quot;body&quot;).<code>append($(&quot;p&quot;).clone())</code>;
});
</pre>

<p><a href="/tiy/t.asp?f=jquery_manipulation_clone">亲自试一试</a></p>
</div>
...
<pre>$(<i>selector</i>).clone(<i>includeEvents</i>)</pre>
...
<tr>
<td><i>includeEvents</i></td>
<td>
	<p>可选。布尔值。规定是否复制元素的所有事件处理。</p>
	<p>默认地，副本中不包含事件处理器。</p>
</td>
</tr>
</table>
...
<dl>
<dt><a href="/tiy/t.asp?f=jquery_manipulation_clone_eventhandler">复制一个元素，包括事件处理器</a></dt>
<dd>使用 clone() 方法来复制元素，包括其事件处理器。</dd>
</dl>
</div>
