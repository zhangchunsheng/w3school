...
<title>jQuery 文档操作 - prependTo() 方法</title>
</head>
...
<h1>jQuery 文档操作 - prependTo() 方法</h1>
...
<pre>
$(&quot;.btn1&quot;).click(function(){
  $(&quot;&lt;b&gt;Hello World!&lt;/b&gt;&quot;).<code>prependTo(&quot;p&quot;)</code>;
});
</pre>

<p><a href="/tiy/t.asp?f=jquery_manipulation_prependto">亲自试一试</a></p>
</div>
...
<p>prependTo() 方法在被选元素的开头（仍位于内部）插入指定内容。</p>

<p class="tip"><span>提示：</span><a href="/jquery/manipulation_prepend.asp" title="jQuery 文档操作 - prepend() 方法">prepend()</a> 和 prependTo() 方法作用相同。差异在于语法：内容和选择器的位置，以及 prepend() 能够使用函数来插入内容。</p>

<h3>语法</h3>

<pre>$(<i>content</i>).prependTo(<i>selector</i>)</pre>
