...
<title>jQuery DOM 元素方法 - size() 方法</title>
</head>
...
<p>输出被 jQuery 选择器匹配的元素的数量：</p>

<pre>
$(&quot;button&quot;).click(function(){
  alert(<code>$(&quot;li&quot;).size()</code>);
});
</pre>

<p><a href="/tiy/t.asp?f=jquery_dom_element_methods_size">亲自试一试</a></p>
</div>
...
<p>size() 方法返回被 jQuery 选择器匹配的元素的数量。</p>

<h3>语法</h3>

<pre>$(<i>selector</i>).size()</pre>
