...
<title>jQuery 遍历 - first() 方法</title>
</head>
...
<p>高亮显示段落中的第一个 span ：</p>

<pre>
$(&quot;p span&quot;)<code>.first()</code>.addClass('highlight');
</pre>

<p><a href="/tiy/t.asp?f=jquery_traversing_first">亲自试一试</a></p>
</div>
...
<p>如果给定一个表示 DOM 元素集合的 jQuery 对象，.first() 方法会用第一个匹配元素构造一个新的 jQuery 对象。</p>
...
<p>我们可以对这个列表项集合应用该方法：</p>

<pre>$('li')<code>.first()</code>.css('background-color', 'red');</pre>

<p><a href="/tiy/t.asp?f=jquery_traversing_first_2">亲自试一试</a></p>

<p>这次调用的结果是，第一个项目被设置为红色背景。</p>
</div>
