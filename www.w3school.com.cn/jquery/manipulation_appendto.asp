...
<title>jQuery 文档操作 - appendTo() 方法</title>
</head>
...
<p><a href="/tiy/t.asp?f=jquery_manipulation_appendto">亲自试一试</a></p>
</div>
...
<p>appendTo() 方法在被选元素的结尾（仍然在内部）插入指定内容。</p>

<p class="tip"><span>提示：</span><a href="/jquery/manipulation_append.asp">append()</a> 和 appendTo() 方法执行的任务相同。不同之处在于：内容和选择器的位置，以及 append() 能够使用函数来附加内容。</p>

<h3>语法</h3>

<pre>$(<i>content</i>).appendTo(<i>selector</i>)</pre>
