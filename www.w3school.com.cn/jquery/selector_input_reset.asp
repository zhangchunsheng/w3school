...
<p>选择 type=&quot;reset&quot; 的 &lt;input&gt; 和 &lt;button&gt; 元素：</p>

<pre>$(&quot;:reset&quot;)</pre>

<p><a href="/tiy/t.asp?f=jquery_selector_input_reset">亲自试一试</a></p>
</div>
...
<p>:reset 选择器选取类型为 reset 的 &lt;button&gt; 和 &lt;input&gt; 元素。</p>
...
<p class="tip"><span>提示：</span>通过该选择器使用 input:reset 不会选择 &lt;button&gt; 元素。</p>
</div>
