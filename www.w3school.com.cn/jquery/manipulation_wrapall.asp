...
<title>jQuery 文档操作 - wrapAll() 方法</title>
</head>
...
<pre>
$(&quot;.btn1&quot;).click(function(){
   $(&quot;p&quot;).<code>wrapAll(&quot;&lt;div&gt;&lt;/div&gt;&quot;)</code>;
});
</pre>

<p><a href="/tiy/t.asp?f=jquery_manipulation_wrapall">亲自试一试</a></p>
</div>
...
<p>wrapAll() 在指定的 HTML 内容或元素中放置所有被选的元素。</p>

<h3>语法</h3>

<pre>$(<i>selector</i>).wrapAll(<i>wrapper</i>)</pre>
...
<dl>
<dt><a href="/tiy/t.asp?f=jquery_manipulation_wrapall_element">使用新元素来包裹</a></dt>
