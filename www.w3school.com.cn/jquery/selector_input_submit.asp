...
<p>选择 type=&quot;submit&quot; 的 &lt;input&gt; 和 &lt;button&gt; 元素：</p>

<pre>$(&quot;:submit&quot;)</pre>

<p><a href="/tiy/t.asp?f=jquery_selector_input_submit">亲自试一试</a></p>
</div>
...
<p>:submit 选择器选取类型为 submit 的 &lt;button&gt; 和 &lt;input&gt; 元素。</p>

<p>如果 &lt;button&gt; 元素没有定义类型，大多数浏览器会把该元素当作类型为 submit 的按钮。</p>
...
<p class="tip"><span>提示：</span>通过该选择器使用 input:submit 不会选择 &lt;button&gt; 元素。</p>
</div>
