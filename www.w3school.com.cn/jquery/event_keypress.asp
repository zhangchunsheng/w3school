...
<title>jQuery 事件 - keypress() 方法</title>
</head>
...
<p><a href="/tiy/t.asp?f=jquery_event_keypress">亲自试一试</a></p>
</div>
...
<p>keypress 事件与 keydown 事件类似。当按钮被按下时，会发生该事件。它发生在当前获得焦点的元素上。</p>

<p>不过，与 keydown 事件不同，每插入一个字符，就会发生 keypress 事件。</p>

<p>keypress() 方法触发 keypress 事件，或规定当发生 keypress 事件时运行的函数。</p>
...
<div>
<h2>触发 keypress 事件</h2>

<h3>语法</h3>

<pre>$(<i>selector</i>).keypress()</pre>

<p><a href="/tiy/t.asp?f=jquery_event_keypress_trigger">亲自试一试</a></p>
</div>


<div>
<h2>将函数绑定到 keypress 事件</h2>

<h3>语法</h3>

<pre>$(<i>selector</i>).keypress(<i>function</i>)</pre>
...
<tr>
<td><i>function</i></td>
<td>可选。规定当发生 keypress 事件时运行的函数。</td>
</tr>
</table>
