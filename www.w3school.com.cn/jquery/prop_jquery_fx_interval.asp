...
<title>jQuery jQuery.fx.interval 属性</title>
...
<h1>jQuery jQuery.fx.interval 属性</h1>

<div class="backtoreference">
<p><a href="/jquery/jquery_ref_prop.asp" title="jQuery 属性">jQuery 属性参考手册</a></p>
</div>
...
$(&quot;#interval&quot;).on(&quot;click&quot;,function(){
  <code>jQuery.fx.interval = 500</code>;
});
</pre>

<p class="tiy"><a target="_blank" href="/tiy/t.asp?f=jquery_prop_jquery_fx_interval">亲自试一试</a></p>
</div>
...
<p>jQuery.fx.interval 属性用于改变以毫秒计的动画运行速率。可操作该属性来调整动画运行的每秒帧数。</p>

<p>默认值是 13 毫秒。该属性常用于修改动画运行的每秒帧数。</p>

<p>降低这个值能够使动画在更快的浏览器中运行得更流畅，但这么做也行会影响性能。</p>

<p class="tip"><span>提示：</span>由于 jQuery 使用一个全局的间隔时间，为了使该属性生效，动画应该不在运行或者首先停止所有动画。</p>

<p class="note"><span>注释：</span>该属性在支持 requestAnimationFrame 属性的浏览器中无效，比如 Google Chrome 11。</p>

<h3>语法</h3>

<pre>jQuery.fx.interval = <i>milliseconds</i>;</pre>
...
<tr>
<td><i>milliseconds</i></td>
<td>必需。规定以毫秒计的动画运行速率。默认是 13 毫秒。</td>
</tr>
</table>
</div>
