...
$(&quot;p&quot;).bind('click dblclick mouseover mouseout',function(event){
  $(&quot;div&quot;).html(&quot;Event: &quot; + <code>event.type</code>);
});
</pre>

<p><a href="/tiy/t.asp?f=jquery_event_type">亲自试一试</a></p>
</div>
...
<p>type 属性描述触发哪种事件类型。</p>

<h3>语法</h3>

<pre><i>event</i>.type</pre>
