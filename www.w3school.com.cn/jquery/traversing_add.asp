...
<p>找到所有 div 并添加边框。然后将所有段落添加到该 jQuery 对象，并把它们的背景设置为黄色：</p>
...
<p>add() 方法将元素添加到匹配元素的集合中。</p>

<h3>语法 1</h3>

<pre>.add(<i>selector</i>)</pre>
...
<tr>
<td><i>selector</i></td>
<td>字符串值，表示查找供添加到匹配元素集合的元素的选择器表达式。</td>
</tr>
</table>

<h3>语法 2</h3>

<pre>.add(<i>elements</i>)</pre>
...
<tr>
<td><i>elements</i></td>
<td>添加到匹配元素集合的一个或多个元素。</td>
</tr>
</table>

<h3>语法 3</h3>

<pre>.add(<i>html</i>)</pre>
...
<tr>
<td><i>jQueryObject</i></td>
<td>添加到匹配元素集合的已有 jQuery 对象。</td>
</tr>
</table>
...
<pre>.add(<i>selector</i>, <i>context</i>)</pre>
