...
<p>选择（&lt;body&gt; 标签中）不包含 id=&quot;main_header&quot; 的元素：</p>

<pre>$(&quot;body [id!=main_header]&quot;)</pre>

<p><a href="/tiy/t.asp?f=jquery_selector_attribute_notequal_value">亲自试一试</a></p>
</div>
...
<p>[attribute!=value] 选择器选取每个不带有指定属性及值的元素。</p>

<p>带有指定的属性，但不带有指定的值的元素，也会被选择。</p>

<h3>语法</h3>

<pre>$(&quot;[<i>attribute</i>!=<i>value</i>]&quot;)</pre>
