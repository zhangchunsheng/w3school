...
<title>jQuery DOM 元素方法 - toArray() 方法</title>
</head>
...
<h1>jQuery DOM 元素方法 - toArray() 方法</h1>
...
<p>将 li 元素转换为数组，然后输出该数组元素的 innerHTML ：</p>

<pre>
$(&quot;button&quot;).click(function(){
  x=<code>$(&quot;li&quot;).toArray()</code>
...
<p><a href="/tiy/t.asp?f=jquery_dom_element_methods_toarray">亲自试一试</a></p>
</div>
...
<p>toArray() 方法以数组的形式返回 jQuery 选择器匹配的元素。</p>

<h3>语法</h3>

<pre>$(<i>selector</i>).toArray()</pre>
