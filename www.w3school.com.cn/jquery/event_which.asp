...
<title>jQuery 事件 - which 属性</title>
</head>
...
$(&quot;input&quot;).keydown(function(event){
  $(&quot;div&quot;).html(&quot;Key: &quot; + <code>event.which</code>);
});
</pre>

<p><a href="/tiy/t.asp?f=jquery_event_which">亲自试一试</a></p>
</div>
...
<p>which 属性指示按了哪个键或按钮。</p>

<h3>语法</h3>

<pre><i>event</i>.which</pre>
...
<tr>
<td><i>event</i></td>
<td>必需。规定要检查的事件。这个 <i>event</i> 参数来自事件绑定函数。</td>
</tr>
</table>
</div>
