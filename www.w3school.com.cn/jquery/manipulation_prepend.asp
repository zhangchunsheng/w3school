...
<p><a href="/tiy/t.asp?f=jquery_manipulation_prepend">亲自试一试</a></p>
</div>
...
<p class="tip"><span>提示：</span>prepend() 和 <a href="/jquery/manipulation_perpendto.asp" title="jQuery 文档操作 - prependTo() 方法">prependTo()</a> 方法作用相同。差异在于语法：内容和选择器的位置，以及 prependTo() 无法使用函数来插入内容。</p>
...
<p><a href="/tiy/t.asp?f=jquery_manipulation_prepend_function">亲自试一试</a></p>
