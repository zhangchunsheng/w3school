...
<p>移除所有通过 live() 方法向 p 元素添加的事件处理程序：</p>

<pre>
$(&quot;p&quot;).die();
</pre>

<p><a href="/tiy/t.asp?f=jquery_event_die">亲自试一试</a></p>
</div>
...
<p>die() 方法移除所有通过 live() 方法向指定元素添加的一个或多个事件处理程序。</p>

<h3>语法</h3>

<pre>$(<i>selector</i>).die(<i>event</i>,<i>function</i>)</pre>
...
<dl>
<dt><a href="/tiy/t.asp?f=jquery_event_die_function">移除通过 live() 添加的特定函数</a></dt>
<dd>如何使用 live() 方法移除事件处理程序的特定函数。</dd>
</dl>
</div>
