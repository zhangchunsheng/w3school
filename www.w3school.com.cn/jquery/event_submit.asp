...
<title>jQuery 事件 - submit() 方法</title>
</head>
...
<p><a href="/tiy/t.asp?f=jquery_event_submit">亲自试一试</a></p>
</div>
...
<p>submit() 方法触发 submit 事件，或规定当发生 submit 事件时运行的函数。</p>
</div>
...
<pre>$(<i>selector</i>).submit()</pre>

<p><a href="/tiy/t.asp?f=jquery_event_submit_trigger">亲自试一试</a></p>
</div>


<div>
<h2>将函数绑定到 submit 事件</h2>

<h3>语法</h3>

<pre>$(<i>selector</i>).submit(<i>function</i>)</pre>
...
<tr>
<td><i>function</i></td>
<td>可选。规定当发生 submit 事件时运行的函数。</td>
</tr>
</table>
...
<dl>
<dt><a href="/tiy/t.asp?f=jquery_event_submit_prevent">阻止提交按钮的默认 action</a></dt>
<dd>使用 preventDefault() 函数来阻止对表单的提交。</dd>
</dl>
</div>
