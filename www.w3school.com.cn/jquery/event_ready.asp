...
<title>jQuery 事件 - ready() 方法</title>
</head>
...
<p><a href="/tiy/t.asp?f=jquery_event_ready">亲自试一试</a></p>
</div>
...
<pre>$(document).ready(<i>function</i>)</pre>

<h3>语法 2</h3>

<pre>$().ready(<i>function</i>)</pre>

<h3>语法 3</h3>

<pre>$(<i>function</i>)</pre>
...
<p class="tip"><span>提示：</span>ready() 函数不应与 &lt;body onload=&quot;&quot;&gt; 一起使用。</p>
</div>
