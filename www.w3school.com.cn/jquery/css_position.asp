...
<title>jQuery CSS 操作 - position() 方法</title>
</head>
...
<h1>jQuery CSS 操作 - position() 方法</h1>
...
<pre>
$(&quot;.btn1&quot;).click(function(){
  x=<code>$(&quot;p&quot;).position()</code>;
  $(&quot;#span1&quot;).text(x.left);
  $(&quot;#span2&quot;).text(x.top);
});
</pre>

<p><a href="/tiy/t.asp?f=jquery_css_position">亲自试一试</a></p>
</div>
...
<p>position() 方法返回匹配元素相对于父元素的位置（偏移）。</p>

<p>该方法返回的对象包含两个整型属性：top 和 left，以像素计。</p>
