...
<h2>jQuery AJAX</h2>
<ul>
<li class="currentLink"><a href="/jquery/jquery_ajax_intro.asp" title="jQuery - AJAX 简介">jQuery AJAX 简介</a></li>
...
<h1>jQuery - AJAX 简介</h1>

<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/jquery/jquery_traversing_filtering.asp" title="jQuery 遍历 - 过滤">jQuery 过滤</a></li>
<li class="next"><a href="/jquery/jquery_ajax_load.asp" title="jQuery - AJAX load() 方法">jQuery 加载</a></li>
</ul>
</div>

<div id="intro">
<p><strong>AJAX 是与服务器交换数据的艺术，它在不重载全部页面的情况下，实现了对部分网页的更新。</strong></p>
</div>
...
<p><a href="/tiy/t.asp?f=jquery_ajax_load">亲自试一试</a></p>
</div>
...
<p>您可以在我们的 <a href="/ajax/index.asp">AJAX 教程</a>中学到更多有关 AJAX 的知识。</p>
</div>
...
<p class="tip"><span>提示：</span>如果没有 jQuery，AJAX 编程还是有些难度的。</p>
...
<p>在下面的章节，我们将学习到最重要的 jQuery AJAX 方法。</p>
</div>
