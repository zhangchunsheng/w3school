...
<title>jQuery 文档操作 - html() 方法</title>
</head>
...
<pre>
$(".btn1").click(function(){
  $("p").<code>html("Hello &lt;b&gt;world&lt;/b&gt;!")</code>;
});
</pre>

<p><a href="/tiy/t.asp?f=jquery_manipulation_html_set">亲自试一试</a></p>
</div>
...
<p>html() 方法返回或设置被选元素的内容 (inner HTML)。</p>
...
<p>当使用该方法返回一个值时，它会返回第一个匹配元素的内容。</p>

<h3>语法</h3>

<pre>$(selector).html()</pre>

<p><a href="/tiy/t.asp?f=jquery_manipulation_html_get">亲自试一试</a></p>
</div>
...
<p>当使用该方法设置一个值时，它会覆盖所有匹配元素的内容。</p>

<h3>语法</h3>

<pre>$(<i>selector</i>).html(<i>content</i>)</pre>
...
<tr>
<td><i>content</i></td>
<td>可选。规定被选元素的新内容。该参数可包含 HTML 标签。</td>
</tr>
</table>
</div>
...
<p>使用函数来设置所有匹配元素的内容。</p>

<h3>语法</h3>

<pre>$(<i>selector</i>).html(<i>function(index,oldcontent)</i>)</pre>

<p><a href="/tiy/t.asp?f=jquery_manipulation_html_set_function">亲自试一试</a></p>
...
<tr>
<td><i>function(index,oldcontent)</i></td>
<td>
	<p>规定一个返回被选元素的新内容的函数。</p>
	<ul class="listintable">
	<li><i>index</i> - 可选。接收选择器的 index 位置。</li>
	<li><i>oldcontent</i> - 可选。接收选择器的当前内容。</li>
	</ul>
</td>
</tr>
</table>
