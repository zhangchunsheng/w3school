...
<title>jQuery jQuery.fx.off 属性</title>
...
<pre>
$(&quot;#true&quot;).click(function(){
  <code>jQuery.fx.off = true</code>;
});
$(&quot;#false&quot;).click(function(){
  <code>jQuery.fx.off = false</code>;
});
...
<p class="tiy"><a target="_blank" href="/tiy/t.asp?f=jquery_prop_jquery_fx_off">亲自试一试</a></p>
</div>
...
<p>jQuery.fx.off 属性用于对所有动画进行全局禁用或启用。</p>

<p>默认值是 false，它允许动画正常运行。当设置为 true 时，将禁用所有动画方法，这样会把元素设置为其最后的状态，而不是显示效果。</p>

<p class="tip"><span>提示：</span>如需简化代码，可以使用 $.fx.off 来代替 jQuery.fx.off。</p>

<h3>语法</h3>

<pre>jQuery.fx.off = true|false;</pre>
