...
<p>输出当前正在运行的 jQuery 版本：</p>

<pre>
$(&quot;button&quot;).on(&quot;click&quot;,function(){ 
  var version = <code>$().jquery</code>;
  alert(&quot;You are running jQuery version: &quot; + version);
});
</pre>

<p class="tiy"><a target="_blank" href="/tiy/t.asp?f=jquery_prop_jquery">亲自试一试</a></p>
</div>
...
<p>jquery 属性返回的字符串包含 jquery 的版本号。</p>
