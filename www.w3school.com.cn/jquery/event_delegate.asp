...
<title>jQuery 事件 - delegate() 方法</title>
</head>
...
<p><a href="/tiy/t.asp?f=jquery_event_delegate">亲自试一试</a></p>
</div>
...
<pre>$(<i>selector</i>).delegate(<i>childSelector</i>,<i>event</i>,<i>data</i>,<i>function</i>)</pre>
...
<dl>
<dt><a href="/tiy/t.asp?f=jquery_event_delegate_newelement">向未来的元素添加事件处理程序</a></dt>
<dd>如何使用 delegate() 方法向尚未创建的元素添加事件处理程序。</dd>
</dl>
</div>
