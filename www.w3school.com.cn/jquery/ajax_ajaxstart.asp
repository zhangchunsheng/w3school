...
<title>jQuery ajax - ajaxStart() 方法</title>
</head>
...
<h1>jQuery ajax - ajaxStart() 方法</h1>
...
<p><a href="/tiy/t.asp?f=jquery_ajax_ajaxstart">亲自试一试</a></p>
</div>
...
<p>ajaxStart() 方法在 AJAX 请求发送前执行函数。它是一个 Ajax 事件。</p>

<h3>详细说明</h3>

<p>无论在何时发送 Ajax 请求，jQuery 都会检查是否存在其他 Ajax 请求。如果不存在，则 jQuery 会触发该 ajaxStart 事件。在此时，由 .ajaxStart() 方法注册的任何函数都会被执行。</p>

<h3>语法</h3>

<pre>.ajaxStart(<i>function()</i>)</pre>
...
<pre>
$(&quot;#loading&quot;)<code>.ajaxStart</code>(function(){
  $(this).show();
});
</pre>
