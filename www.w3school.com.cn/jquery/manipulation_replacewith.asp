...
<title>jQuery 文档操作 - replaceWith() 方法</title>
</head>
...
<h1>jQuery 文档操作 - replaceWith() 方法</h1>

<div class="backtoreference">
<p><a href="/jquery/jquery_ref_manipulation.asp" title="jQuery 参考手册 - 文档操作">jQuery 文档操作参考手册</a></p>
</div>
...
<p><a href="/tiy/t.asp?f=jquery_manipulation_replacewith">亲自试一试</a></p>
</div>
...
<p>replaceWith() 方法用指定的 HTML 内容或元素替换被选元素。</p>

<p class="tip"><span>提示：</span>replaceWith() 与 <a href="/jquery/manipulation_replaceall.asp" title="jQuery 文档操作 - replaceAll() 方法">replaceAll()</a> 作用相同。差异在于语法：内容和选择器的位置，以及 replaceAll() 无法使用函数进行替换。</p>

<h3>语法</h3>

<pre>$(<i>selector</i>).replaceWith(<i>content</i>)</pre>
...
<td>
	...
	<li>HTML 代码 - 比如 (&quot;&lt;div&gt;&lt;/div&gt;&quot;)</li>
	<li>新元素 - 比如 (document.createElement(&quot;div&quot;))</li>
	<li>已存在的元素  - 比如 ($(&quot;.div1&quot;))</li>
	</ul>

	<p>已存在的元素不会被移动，只会被复制，并包裹被选元素。</p>
</td>
</tr>
...
<pre>$(<i>selector</i>).replaceWith(<i>function()</i>)</pre>

<p><a href="/tiy/t.asp?f=jquery_manipulation_replacewith_function">亲自试一试</a></p>
...
<dl>
<dt><a href="/tiy/t.asp?f=jquery_manipulation_replacewith_element">使用新元素来替换元素</a></dt>
<dd>使用 document.createElement() 来创建一个新的 DOM 元素，然后用它替换被选元素。</dd>
</dl>
</div>
