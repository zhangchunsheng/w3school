...
<title>jQuery DOM 元素方法 - index() 方法</title>
</head>
...
<h1>jQuery DOM 元素方法 - index() 方法</h1>

<div class="backtoreference">
<p><a href="/jquery/jquery_ref_dom_element_methods.asp" title="jQuery 参考手册 - DOM 元素方法">jQuery DOM 元素方法参考手册</a></p>
</div>
...
<pre>
$(&quot;li&quot;).click(function(){
  alert(<code>$(this).index()</code>);
});
</pre>

<p><a href="/tiy/t.asp?f=jquery_dom_element_methods_index">亲自试一试</a></p>
</div>
...
<p>index() 方法返回指定元素相对于其他指定元素的 index 位置。</p>

<p>这些元素可通过 jQuery 选择器或 DOM 元素来指定。</p>

<p class="note"><span>注释：</span>如果未找到元素，index() 将返回 -1。</p>
</div>


<div>
<h2>第一个匹配元素的 index，相对于同胞元素</h2>

<p>获得第一个匹配元素相对于其同胞元素的 index 位置。</p>

<h3>语法</h3>

<pre>$(<i>selector</i>).index()</pre>
...
<div>
<h2>元素的 index，相对于选择器</h2>

<p>获得元素相对于选择器的 index 位置。</p>

<p>该元素可以通过 DOM 元素或 jQuery 选择器来指定。</p>

<h3>语法</h3>

<pre>$(<i>selector</i>).index(<i>element</i>)</pre>

<p><a href="/tiy/t.asp?f=jquery_dom_element_methods_index_selector">亲自试一试</a></p>
...
<tr>
<td><i>element</i></td>
<td>可选。规定要获得 index 位置的元素。可以是 DOM 元素或 jQuery 选择器。</td>
</tr>
</table>
</div>
