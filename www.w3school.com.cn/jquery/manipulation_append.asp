...
<title>jQuery 文档操作 - append() 方法</title>
</head>
...
$(&quot;button&quot;).click(function(){
  $(&quot;p&quot;).<code>append(&quot; &lt;b&gt;Hello world!&lt;/b&gt;&quot;)</code>;
});
</pre>

<p><a href="/tiy/t.asp?f=jquery_manipulation_append">亲自试一试</a></p>
</div>
...
<p>append() 方法在被选元素的结尾（仍然在内部）插入指定内容。</p>

<p class="tip"><span>提示：</span>append() 和 <a href="/jquery/manipulation_appendto.asp">appendTo()</a> 方法执行的任务相同。不同之处在于：内容的位置和选择器。</p>

<h3>语法</h3>

<pre>$(selector).append(<i>content</i>)</pre>
...
<p>使用函数在指定元素的结尾插入内容。</p>

<h3>语法</h3>

<pre>$(selector).append(<i>function(index,html)</i>)</pre>

<p><a href="/tiy/t.asp?f=jquery_manipulation_append_func">亲自试一试</a></p>
...
<td>
	...
	<li><i>html</i> - 可选。接收选择器的当前 HTML。</li>
	</ul>
</td>
</tr>
</table>
