...
<li class="currentLink"><a href="/jquery/jquery_quiz.asp" title="jQuery 测验">jQuery 测验</a></li>
</ul>
<h2>jQuery 参考手册</h2>
<ul>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/jquery/jquery_examples.asp" title="jQuery 实例">jQuery 实例</a></li>
<li class="next"><a href="/jquery/jquery_reference.asp" title="jQuery 参考手册">jQuery 参考手册</a></li>
</ul>
</div>

<div id="intro">
<p><strong>您可以通过 W3SCHOOL 的测验程序来测试您的 jQuery 技能。</strong></p>
</div>
...
<p>本测验是非官方的测试，它仅仅提供了一个了解您对 jQuery 的掌握程度的工具。</p>
</div>
...
<p><a href="/quiz/quiz.asp?quiz=jquery" title="jQuery 测验">现在就开始测验</a>！祝您好运。</p>
</div>
