...
<h2>jQuery 遍历</h2>
<ul>
<li class="currentLink"><a href="/jquery/jquery_traversing.asp" title="jQuery 遍历">jQuery 遍历</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/jquery/jquery_dimensions.asp" title="jQuery - 尺寸">jQuery 尺寸</a></li>
<li class="next"><a href="/jquery/jquery_traversing_ancestors.asp" title="jQuery 遍历 - 祖先">jQuery 祖先</a></li>
</ul>
</div>
...
<img src="/i/dom_tree.gif" alt="遍历 DOM 树" />
...
<p class="tip"><span>提示：</span>祖先是父、祖父、曾祖父等等。后代是子、孙、曾孙等等。同胞拥有相同的父。</p>
</div>
...
<p>下一章会讲解如何在 DOM 树中向上、下以及同级移动。</p>
</div>
