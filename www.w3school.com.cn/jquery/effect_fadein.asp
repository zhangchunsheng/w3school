...
<title>jQuery 效果 - fadeIn() 方法</title>
</head>
...
<p><a href="/tiy/t.asp?f=jquery_effect_fadeout_fadein">亲自试一试</a></p>
</div>
...
<p>fadeIn() 方法使用淡入效果来显示被选元素，假如该元素是隐藏的。</p>
...
<td><i>speed</i></td>
<td>
	<p>可选。规定元素从隐藏到可见的速度。默认为 &quot;normal&quot;。</p>
	...
	<p>在设置速度的情况下，元素从隐藏到可见的过程中，会逐渐地改变其透明度（这样会创造淡入效果）。</p>
</td>
</tr>
...
<p class="tip"><span>提示：</span>如果元素已经显示，则该效果不产生任何变化，除非规定了 callback 函数。</p>
...
<dl>
<dt><a href="/tiy/t.asp?f=jquery_effect_fadeout_fadein_speed">使用 speed 参数</a></dt>
<dd>使用 speed 参数来对淡入或淡出元素。</dd>
</dl>
</div>
