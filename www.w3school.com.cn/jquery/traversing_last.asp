...
<p>高亮显示段落中的最后一个 span ：</p>

<pre>
$(&quot;p span&quot;)<code>.last()</code>.addClass('highlight');
</pre>

<p><a href="/tiy/t.asp?f=jquery_traversing_last">亲自试一试</a></p>
</div>
...
<p>如果给定一个表示 DOM 元素集合的 jQuery 对象，.last() 方法会用最后一个匹配元素构造一个新的 jQuery 对象。</p>
...
<pre>$('li')<code>.last()</code>.css('background-color', 'red');</pre>

<p><a href="/tiy/t.asp?f=jquery_traversing_last_2">亲自试一试</a></p>

<p>这次调用的结果是，最后一个项目被设置为红色背景。</p>
</div>
