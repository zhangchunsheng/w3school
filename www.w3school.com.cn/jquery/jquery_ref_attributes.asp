...
<li class="currentLink"><a href="/jquery/jquery_ref_attributes.asp" title="jQuery 参考手册 - 属性操作">jQuery 属性操作</a></li>
...
<h1>jQuery 参考手册 - 属性操作</h1>

<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/jquery/jquery_ref_manipulation.asp" title="jQuery 参考手册 - 文档操作">jQuery 文档操作</a></li>
<li class="next"><a href="/jquery/jquery_ref_css.asp" title="jQuery 参考手册 - CSS 操作">jQuery CSS 操作</a></li>
</ul>
</div>
...
<p class="note"><span>注释：</span><a href="/jquery/jquery_ref_manipulation.asp">jQuery 文档操作参考手册</a>中也列出了以上方法。本参考页的作用是方便用户单独查阅有关属性操作方面的方法。</p>
</div>
