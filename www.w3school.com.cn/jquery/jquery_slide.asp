...
<li class="currentLink"><a href="/jquery/jquery_slide.asp" title="jQuery 效果 - 滑动">jQuery 滑动</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/jquery/jquery_fade.asp" title="jQuery jQuery 效果 - 淡入淡出">jQuery 淡入淡出</a></li>
<li class="next"><a href="/jquery/jquery_animate.asp" title="jQuery 效果 - 动画">jQuery 动画</a></li>
</ul>
</div>

<div id="intro">
<p><strong>jQuery 滑动方法可使元素上下滑动。</strong></p>
</div>
...
<dl>
<dt><a href="/tiy/t.asp?f=jquery_slide_down">jQuery slideDown()</a></dt>
<dd>演示 jQuery slideDown() 方法。</dd>

<dt><a href="/tiy/t.asp?f=jquery_slide_up">jQuery slideUp()</a></dt>
<dd>演示 jQuery slideUp() 方法。</dd>

<dt><a href="/tiy/t.asp?f=jquery_slide_toggle">jQuery slideToggle()</a></dt>
<dd>演示 jQuery slideToggle() 方法。</dd>
</dl>
</div>
...
<pre>$(selector).slideDown(speed,callback);</pre>
...
<pre>$(selector).slideUp(speed,callback);</pre>
