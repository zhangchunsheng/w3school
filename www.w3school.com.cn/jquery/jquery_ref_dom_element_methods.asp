...
<title>jQuery 参考手册 - DOM 元素方法</title>
</head>
...
<li class="currentLink"><a href="/jquery/jquery_ref_dom_element_methods.asp" title="jQuery 参考手册 - DOM 元素方法">jQuery DOM 元素</a></li>
...
<h1>jQuery 参考手册 - DOM 元素方法</h1>

<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/jquery/jquery_ref_data.asp" title="jQuery 参考手册 - 数据">jQuery 数据</a></li>
<li class="next"><a href="/jquery/jquery_ref_core.asp" title="jQuery 参考手册 - 核心">jQuery 核心</a></li>
</ul>
</div>


<div>
<h2>jQuery DOM 元素方法</h2>
