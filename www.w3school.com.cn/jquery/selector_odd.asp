...
<p>选择每个相隔的（奇数） &lt;tr&gt; 元素：</p>

<pre>$(&quot;tr:odd&quot;)</pre>

<p><a href="/tiy/t.asp?f=jquery_selector_odd">亲自试一试</a></p>
</div>
...
<p>:odd 选择器选取每个带有奇数 index 值的元素（比如 1、3、5）。</p>

<p>index 值从 0 开始，所有第一个元素是偶数 (0)。</p>

<p>最常见的用法：与其他元素/选择器一起使用，来选择指定的组中奇数序号的元素（如上面的例子）。</p>
...
<p class="tip"><span>提示：</span>请使用 <a href="/jquery/selector_even.asp" title="jQuery :even 选择器">:even 选择器</a>来选取偶数序号的元素。</p>
</div>
