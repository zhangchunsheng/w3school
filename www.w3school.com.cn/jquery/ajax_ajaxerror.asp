...
<title>jQuery ajax - ajaxError() 方法</title>
</head>
...
<h1>jQuery ajax - ajaxError() 方法</h1>
...
<p><a href="/tiy/t.asp?f=jquery_ajax_ajaxerror">亲自试一试</a></p>
</div>
...
<p>ajaxError() 方法在 AJAX 请求发生错误时执行函数。它是一个 Ajax 事件。</p>

<h3>语法</h3>

<pre>.ajaxError(<i>function(event,xhr,options,exc)</i>)</pre>
...
<tr>
<td><i>function(event,xhr,options,exc)</i></td>
<td>
	<p>必需。规定当请求失败时运行的函数。</p>
	<p>额外的参数：</p>
	<ul class="listintable">
	<li><i>event</i> - 包含 event 对象</li>
	<li><i>xhr</i> - 包含 XMLHttpRequest 对象</li>
	<li><i>options</i> - 包含 AJAX 请求中使用的选项</li>
	<li><i>exc</i> - 包含 JavaScript exception</li>
	</ul>
</td>
</tr>
</table>
...
<h2>亲自试一试 - 实例</h2>
<dt>
<dt><a href="/tiy/t.asp?f=jquery_ajax_ajaxerror_options">使用 <i>xhr</i> 和 <i>options</i> 参数</a></dt>
<dd>如何使用 <i>options</i> 参数来获得更有用的错误消息。</dd>
</dt>
</div>
