...
<title>jQuery Callback 函数</title>
</head>
...
<li class="currentLink"><a href="/jquery/jquery_callback.asp" title="jQuery 回调函数">jQuery Callback</a></li>
...
<h1>jQuery Callback 函数</h1>

<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/jquery/jquery_stop.asp" title="jQuery 停止动画">jQuery stop()</a></li>
<li class="next"><a href="/jquery/jquery_chaining.asp" title="jQuery - Chaining">jQuery Chaining</a></li>
</ul>
</div>


<div>
<p><strong>Callback 函数在当前动画 100% 完成之后执行。</strong></p>
</div>
...
<p>由于 JavaScript 语句（指令）是逐一执行的 - 按照次序，动画之后的语句可能会产生错误或页面冲突，因为动画还没有完成。</p>

<p>为了避免这个情况，您可以以参数的形式添加 Callback 函数。</p>
</div>
...
<p>当动画 100% 完成后，即调用 Callback 函数。</p>

<h3>典型的语法：</h3>

<pre>$(selector).hide(speed,callback)</pre>

<p><i>callback</i> 参数是一个在 hide 操作完成后被执行的函数。</p>

<h3>错误（没有 callback）</h3>
...
<p><a href="/tiy/t.asp?f=jquery_hide_slow_wrong">亲自试一试</a></p>
...
<p><a href="/tiy/t.asp?f=jquery_hide_slow_right">亲自试一试</a></p>
