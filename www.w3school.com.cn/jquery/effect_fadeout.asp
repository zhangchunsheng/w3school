...
<title>jQuery 效果 - fadeOut() 方法</title>
</head>
...
<p>fadeOut() 方法使用淡出效果来隐藏被选元素，假如该元素是隐藏的。</p>
...
<td><i>speed</i></td>
<td>
	<p>可选。规定元素从可见到隐藏的速度。默认为 &quot;normal&quot;。</p>
	...
	<p>在设置速度的情况下，元素从可见到隐藏的过程中，会逐渐地改变其透明度（这样会创造淡出效果）。</p>
</td>
</tr>
