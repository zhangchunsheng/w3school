...
<title>jQuery :contains 选择器</title>
</head>
...
<p>选择所有包含 &quot;is&quot; 的 &lt;p&gt; 元素：</p>

<pre>$(&quot;p:contains(is)&quot;)</pre>

<p><a href="/tiy/t.asp?f=jquery_selector_contains">亲自试一试</a></p>
</div>
...
<p>:contains 选择器选取包含指定字符串的元素。</p>

<p>该字符串可以是直接包含在元素中的文本，或者被包含于子元素中。</p>

<p>经常与其他元素/选择器一起使用，来选择指定的组中包含指定文本的元素（如上面的例子）。</p>
