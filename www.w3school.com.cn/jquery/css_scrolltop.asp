...
<title>jQuery CSS 操作 - scrollTop() 方法</title>
</head>
...
<h1>jQuery CSS 操作 - scrollTop() 方法</h1>
...
<p>设置 &lt;div&gt; 元素中滚动条的垂直偏移：</p>

<pre>
$(&quot;.btn1&quot;).click(function(){
  <code>$(&quot;div&quot;).scrollLeft(100);</code>
});
</pre>

<p><a href="/tiy/t.asp?f=jquery_css_scrolltop_set">亲自试一试</a></p>
</div>
...
<p>如果该方法未设置参数，则返回以像素计的相对滚动条顶部的偏移。</p>


<h3>语法</h3>

<pre>$(<i>selector</i>).scrollTop(<i>offset</i>)</pre>
...
<p class="note"><span>注释：</span>该方法对于可见元素和不可见元素均有效。</p>
<p class="note"><span>注释：</span>当用于获取值时，该方法只返回第一个匹配元素的 scroll top offset。</p>
<p class="note"><span>注释：</span>当用于设置值时，该方法设置所有匹配元素的 scroll top offset。</p>
</div>
...
<dl>
<dt><a href="/tiy/t.asp?f=jquery_css_scrolltop_get">获得当前的 scroll top offset</a></dt>
<dd>使用 scrollTop() 方法获得 scroll top offset。</dd>
</dl>
</div>
