...
<title>jQuery CSS 操作 - scrollLeft() 方法</title>
</head>
...
<h1>jQuery CSS 操作 - scrollLeft() 方法</h1>
...
<p><a href="/tiy/t.asp?f=jquery_css_scrollleft_set">亲自试一试</a></p>
</div>
...
<p>scrollLeft() 方法返回或设置匹配元素的滚动条的水平位置。</p>

<p>滚动条的水平位置指的是从其左侧滚动过的像素数。当滚动条位于最左侧时，位置是 0。</p>
</div>
...
<p>返回第一个匹配元素的水平滚动条位置。</p>

<h3>语法</h3>

<pre>$(<i>selector</i>).scrollLeft()</pre>

<p><a href="/tiy/t.asp?f=jquery_css_scrollleft_get">亲自试一试</a></p>
</div>
...
<p>设置所有匹配元素的水平滚动条位置。</p>

<h3>语法</h3>

<pre>$(<i>selector</i>).scrollLeft(<i>position</i>)</pre>
