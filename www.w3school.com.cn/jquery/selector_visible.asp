...
<title>jQuery :visible 选择器</title>
</head>
...
<p>选择 &lt;body&gt; 元素中每个可见的元素：</p>

<pre>$(&quot;body :visible&quot;)</pre>

<p><a href="/tiy/t.asp?f=jquery_selector_visible">亲自试一试</a></p>
</div>
...
<p>:visible 选择器选取每个当前是可见的元素。</p>

<p>除以下几种情况之外的元素即是可见元素：</p>

<ul>
<li>设置为 display:none</li>
<li>type=&quot;hidden&quot; 的表单元素</li>
<li>Width 和 height 设置为 0</li>
<li>隐藏的父元素（同时隐藏所有子元素）</li>
</ul>
