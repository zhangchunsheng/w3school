...
<li class="currentLink"><a href="/jquery/jquery_animate.asp" title="jQuery 效果 - 动画">jQuery 动画</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/jquery/jquery_slide.asp" title="jQuery 效果 - 滑动">jQuery 滑动</a></li>
<li class="next"><a href="/jquery/jquery_stop.asp" title="jQuery 停止动画">jQuery stop()</a></li>
</ul>
</div>

<div id="intro">
<p><strong>jQuery animate() 方法允许您创建自定义的动画。</strong></p>
</div>
...
<p>下面的例子演示 animate() 方法的简单应用；它把 &lt;div&gt; 元素移动到左边，直到 left 属性等于 250 像素为止：</p>
...
<p><a href="/tiy/t.asp?f=jquery_animation1">亲自试一试</a></p>
...
<p><a href="/tiy/t.asp?f=jquery_animation1_multicss">亲自试一试</a></p>

<p class="tip"><span>提示：</span>可以用 animate() 方法来操作所有 CSS 属性吗？</p>

<p>是的，几乎可以！不过，需要记住一件重要的事情：当使用 animate() 时，必须使用 Camel 标记法书写所有的属性名，比如，必须使用 paddingLeft 而不是 padding-left，使用 marginRight 而不是 margin-right，等等。</p>

<p>同时，色彩动画并不包含在核心 jQuery 库中。</p>

<p>如果需要生成颜色动画，您需要从 jQuery.com 下载 Color Animations 插件。</p>
</div>
...
<p><a href="/tiy/t.asp?f=jquery_animation1_relative">亲自试一试</a></p>
</div>
...
<p><a href="/tiy/t.asp?f=jquery_animation1_toggle">亲自试一试</a></p>
</div>
...
<p>隐藏，如果您希望在彼此之后执行不同的动画，那么我们要利用队列功能：</p>
...
<p>下面的例子把 &lt;div&gt; 元素移动到右边，然后增加文本的字号：</p>
