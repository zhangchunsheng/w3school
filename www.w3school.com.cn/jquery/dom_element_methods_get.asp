...
<title>jQuery DOM 元素方法 - get() 方法</title>
</head>
...
<p><a href="/tiy/t.asp?f=jquery_dom_element_methods_get">亲自试一试</a></p>
</div>
...
<p>get() 方法获得由选择器指定的 DOM 元素。</p>

<h3>语法</h3>

<pre>$(<i>selector</i>).get(<i>index</i>)</pre>
...
<tr>
<td><i>index</i></td>
<td>可选。规定获取哪个匹配元素（通过 index 编号）。</td>
</tr>
</table>
</div>
