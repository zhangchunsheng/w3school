...
<title>jQuery 事件 - select() 方法</title>
</head>
...
<p><a href="/tiy/t.asp?f=jquery_event_select">亲自试一试</a></p>
</div>
...
<pre>$(<i>selector</i>).select()</pre>

<p><a href="/tiy/t.asp?f=jquery_event_select_trigger">亲自试一试</a></p>
</div>


<div>
<h2>将函数绑定到 select 事件</h2>

<h3>语法</h3>

<pre>$(<i>selector</i>).select(<i>function</i>)</pre>
...
<tr>
<td><i>function</i></td>
<td>可选。规定当发生 select 事件时运行的函数。</td>
</tr>
</table>
