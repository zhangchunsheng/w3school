...
<title>jQuery ajax - ajaxSuccess() 方法</title>
</head>
...
<h1>jQuery ajax - ajaxSuccess() 方法</h1>
...
<p><a href="/tiy/t.asp?f=jquery_ajax_ajaxsuccess">亲自试一试</a></p>
</div>
...
<p>ajaxSuccess() 方法在 AJAX 请求成功时执行函数。它是一个 Ajax 事件。</p>

<h3>详细说明</h3>

<p>XMLHttpRequest 对象和设置作为参数传递给回调函数。</p>

<p>无论 Ajax 请求在何时成功完成 ，jQuery 都会触发该 ajaxSuccess 事件。在此时，由 .ajaxSuccess() 方法注册的任何函数都会被执行。</p>

<h3>语法</h3>

<pre>.ajaxSuccess(<i>function(event,xhr,options)</i>)</pre>
...
<tr>
<td><i>function(event,xhr,options)</i></td>
<td>
	<p>必需。规定当请求成功时运行的函数。</p>
	<p>额外的参数：</p>
...
<pre>
$(&quot;#msg&quot;)<code>.ajaxSuccess</code>(function(evt, request, settings){
