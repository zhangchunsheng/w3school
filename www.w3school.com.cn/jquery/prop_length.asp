...
$(&quot;button&quot;).click(function(){
  alert($(<code>&quot;li&quot;).length</code>);
});
</pre>

<p class="tiy"><a target="_blank" href="/tiy/t.asp?f=jquery_prop_length">亲自试一试</a></p>
</div>
...
<p>length 属性包含 jQuery 对象中元素的数目。</p>

<h3>语法</h3>

<pre>$(selector).length</pre>
