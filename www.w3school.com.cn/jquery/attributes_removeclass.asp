...
<title>jQuery 属性操作 - removeClass() 方法</title>
</head>
...
<h1>jQuery 属性操作 - removeClass() 方法</h1>
...
<p>移除所有 &lt;p&gt; 的 &quot;intro&quot; 类：</p>

<pre>
$(&quot;button&quot;).click(function(){
  $(&quot;p:first&quot;).<code>removeClass(&quot;intro&quot;)</code>;
});
</pre>

<p><a href="/tiy/t.asp?f=jquery_attributes_removeClass">亲自试一试</a></p>
</div>
...
<p>removeClass() 方法从被选元素移除一个或多个类。</p>

<p class="note"><span>注释：</span>如果没有规定参数，则该方法将从被选元素中删除所有类。</p>

<h3>语法</h3>

<pre>$(<i>selector</i>).removeClass(<i>class</i>)</pre>
...
<td><i>class</i></td>
<td>
	<p>可选。规定要移除的 class 的名称。</p>
	<p>如需移除若干类，请使用空格来分隔类名。</p>
	<p>如果不设置该参数，则会移除所有类。</p>
</td>
</tr>
</table>
</div>
...
<pre>$(<i>selector</i>).removeClass(<i>function(index,oldclass)</i>)</pre>

<p><a href="/tiy/t.asp?f=jquery_attributes_removeclass_func">亲自试一试</a></p>
...
<tr>
<td><i>function(index,oldclass)</i></td>
<td>
	<p>必需。通过运行函数来移除指定的类。</p>
	<ul class="listintable">
	<li>index - 可选。接受选择器的 index 位置。</li>
	<li>html - 可选。接受选择器的旧的类值。</li>
	</ul>
</td>
</tr>
</table>
...
<dd>如何使用 addClass() 和 removeClass() 来移除一个类，并添加一个新的类。</dd>
</dl>
</div>
