...
<pre>
$(&quot;ul&quot;).append(&quot;&lt;li&gt;&quot; + ($(&quot;ul&quot;)<code>.has(&quot;li&quot;)</code>.length ? &quot;Yes&quot; : &quot;No&quot;) + &quot;&lt;/li&gt;&quot;);
$(&quot;ul&quot;)<code>.has(&quot;li&quot;)</code>.addClass(&quot;full&quot;);
</pre>

<p><a href="/tiy/t.asp?f=jquery_traversing_has">亲自试一试</a></p>
</div>
...
<p>has() 将匹配元素集合缩减为拥有匹配指定选择器或 DOM 元素的后代的子集。</p>

<h3>语法</h3>

<pre>.has(<i>selector</i>)</pre>
...
<p>如果给定一个表示 DOM 元素集合的 jQuery 对象，.has() 方法用匹配元素的子集来构造一个新的 jQuery 对象。所使用的选择器用于检测匹配元素的后代；如果任何后代元素匹配该选择器，该元素将被包含在结果中。</p>

<p>请思考下面这个带有嵌套列表的页面：</p>
...
<p>我们可以对列表项集合应用该方法，就像这样：</p>

<pre>$('li')<code>.has('ul')</code>.css('background-color', 'red');</pre>

<p><a href="/tiy/t.asp?f=jquery_traversing_has_2">亲自试一试</a></p>

<p>该调用的结果是，项目 2 的背景被设置为红色，这是因为该项目是后代中唯一拥有 &lt;ul&gt; 的 &lt;li&gt;。</p>
</div>
