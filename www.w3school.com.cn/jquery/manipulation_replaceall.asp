...
<title>jQuery 文档操作 - replaceAll() 方法</title>
</head>
...
<h1>jQuery 文档操作 - replaceAll() 方法</h1>
...
<pre>
$(&quot;.btn1&quot;).click(function(){
   $(&quot;p&quot;).<code>replaceAll(&quot;&lt;b&gt;Hello world!&lt;/b&gt;&quot;)</code>;
});
</pre>
...
<p>replaceAll() 方法用指定的 HTML 内容或元素替换被选元素。</p>

<p class="tip"><span>提示：</span>replaceAll() 与 <a href="/jquery/manipulation_replacewith.asp" title="jQuery 文档操作 - replaceWith() 方法">replaceWith()</a> 作用相同。差异在于语法：内容和选择器的位置，以及 replaceWith() 能够使用函数进行替换。</p>

<h3>语法</h3>

<pre>$(<i>content</i>).replaceAll(<i>selector</i>)</pre>
...
<dl>
<dt><a href="/tiy/t.asp?f=jquery_manipulation_replaceall_element">使用新元素来替换元素</a></dt>
