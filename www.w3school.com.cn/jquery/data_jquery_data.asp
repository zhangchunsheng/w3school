...
<title>jQuery 数据 - jQuery.data() 方法</title>
</head>
...
<h1>jQuery 数据 - jQuery.data() 方法</h1>
...
<p><a href="/tiy/t.asp?f=jquery_data_data_set_get">亲自试一试</a></p>
</div>
...
<p class="note"><span>注释：</span>这是底层级的方法；使用 <a href="/jquery/data_data.asp">.data()</a> 更加方便。</p>
</div>
...
<pre>$(<i>selector</i>).data(<i>name</i>)</pre>
...
<td>
	<p>可选。规定要取回的数据的名称。</p>
	<p>如果没有规定名称，则该方法将以对象的形式从元素中返回所有存储的数据。</p>
</td>
</tr>
</table>
</div>
...
<pre>$(<i>selector</i>).data(<i>name</i>,<i>value</i>)</pre>
...
<p>使用带有名称/值对的对象向被选元素添加数据。</p>

<h3>语法</h3>

<pre>$(<i>selector</i>).data(<i>object</i>)</pre>

<p><a href="/tiy/t.asp?f=jquery_data_data_set_object">亲自试一试</a></p>
