...
<title>jQuery 事件 - isDefaultPrevented() 方法</title>
</head>
...
<h1>jQuery 事件 - isDefaultPrevented() 方法</h1>
...
<p>防止链接打开 URL，并声明来自 isDefaultPrevented() 的结果：</p>

<pre>
$(&quot;a&quot;).click(function(event){
   <span class="marked">event.preventDefault();</span>
  alert(&quot;Default prevented: &quot; + <code>event.isDefaultPrevented()</code>);
});
</pre>

<p><a href="/tiy/t.asp?f=jquery_event_isdefaultprevented">亲自试一试</a></p>
</div>
...
<p>isDefaultPrevented() 方法返回指定的 event 对象上是否调用了 <a href="/jquery/event_preventdefault.asp" title="jQuery 事件 - preventDefault() 方法">preventDefault() 方法</a>。</p>

<h3>语法</h3>

<pre><i>event</i>.isDefaultPrevented()</pre>
...
<tr>
<td><i>event</i></td>
<td>必需。规定需要检查的事件。这个 <i>event</i> 参数来自事件绑定函数。</td>
</tr>
</table>
</div>
