...
<p><a href="/tiy/t.asp?f=jquery_selector_all">亲自试一试</a></p>
</div>
...
<p>* 选择器选取文档中的每个单独的元素，包括 html、head 和 body。</p>

<p>如果与其他元素（嵌套选择器，正如上面的例子）一起使用，该选择器选取指定元素中的所有子元素。</p>
...
<p class="tip"><span>提示：</span>根据实践，某些浏览器使用 * 的处理速度缓慢。</p>
</div>
