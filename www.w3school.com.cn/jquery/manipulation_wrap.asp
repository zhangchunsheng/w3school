...
<title>jQuery 文档操作 - wrap() 方法</title>
</head>
...
<pre>
$(&quot;.btn1&quot;).click(function(){
   $(&quot;p&quot;).<code>wrap(&quot;&lt;div&gt;&lt;/div&gt;&quot;)</code>;
});
</pre>

<p><a href="/tiy/t.asp?f=jquery_manipulation_wrap">亲自试一试</a></p>
</div>
...
<p>wrap() 方法把每个被选元素放置在指定的 HTML 内容或元素中。</p>

<h3>语法</h3>

<pre>$(<i>selector</i>).wrap(<i>wrapper</i>)</pre>
...
<p>使用函数来规定在每个被选元素周围包裹的内容。</p>

<h3>语法</h3>

<pre>$(<i>selector</i>).wrap(<i>function()</i>)</pre>

<p><a href="/tiy/t.asp?f=jquery_manipulation_wrap_function">亲自试一试</a></p>
...
<dl>
<dt><a href="/tiy/t.asp?f=jquery_manipulation_wrap_element">使用新元素来包裹</a></dt>
<dd>创建一个新的 DOM 元素来包裹每个被选元素。</dd>

<dt><a href="/tiy/t.asp?f=jquery_manipulation_wrap_unwrap">包裹或解开元素</a></dt>
<dd>对包裹和解开元素的任务进行切换。</dd>
</dl>
</div>
