...
<title>jQuery 事件 - target 属性</title>
</head>
...
<p>显示哪个 DOM 元素触发了事件：</p>

<pre>
$(&quot;p, button, h1, h2&quot;).click(function(event){
  $(&quot;div&quot;).html(&quot;Triggered by a &quot; + <code>event.target.nodeName</code> + &quot; element.&quot;);
});
</pre>

<p><a href="/tiy/t.asp?f=jquery_event_target">亲自试一试</a></p>
</div>
...
<p>target 属性规定哪个 DOM 元素触发了该事件。</p>

<h3>语法</h3>

<pre><i>event</i>.target</pre>
