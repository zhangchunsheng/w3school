...
<p><a href="/tiy/t.asp?f=jquery_effect_stop">亲自试一试</a></p>
</div>
...
<tr>
<td><i>stopAll</i></td>
<td>可选。规定是否停止被选元素的所有加入队列的动画。</td>
</tr>

<tr>
<td><i>goToEnd</i></td>
<td>
	<p>可选。规定是否允许完成当前的动画。</p>
	
	<p>该参数只能在设置了 stopAll 参数时使用。</p>
</td>
</tr>
</table>
</div>
...
<dl>
<dt><a href="/tiy/t.asp?f=jquery_effect_stop_queue">停止动画队列</a></dt>
<dd>停止被选元素的所有加入队列的动画。</dd>

<dt><a href="/tiy/t.asp?f=jquery_effect_stop_queue_end">在当前动画完成后停止动画队列</a></dt>
<dd>停止被选元素的所有加入队列的动画，但允许完成当前动画。</dd>
</dl>
</div>
