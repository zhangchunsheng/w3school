...
<title>jQuery element 选择器</title>
</head>
...
<p><a href="/tiy/t.asp?f=jquery_selector_element">亲自试一试</a></p>
</div>
...
<p>element 选择器选取带有指定标签名的元素。</p>

<p>标签名引用 HTML 标签的 &lt; 与 &gt; 之间的文本。</p>
