...
<title>jQuery ajax - ajaxSetup() 方法</title>
</head>
...
<h1>jQuery ajax - ajaxSetup() 方法</h1>
...
<p>为所有 AJAX 请求设置默认 URL 和 success 函数：</p>
...
<p><a href="/tiy/t.asp?f=jquery_ajax_ajaxsetup">亲自试一试</a></p>
</div>
...
<p>jQuery.ajaxSetup() 方法设置全局 AJAX 默认选项。</p>

<h3>语法</h3>

<pre>jQuery.ajaxSetup(<i>name:value</i>, <i>name:value</i>, ...)</pre>
...
<tr>
<td><i>name:value</i></td>
<td>可选。使用名称/值对来规定 AJAX 请求的设置。</td>
</tr>
</table>

<p class="note"><span>注释：</span>参数见 <a href="/jquery/ajax_ajax.asp" title="jQuery ajax - ajax() 方法">'$.ajax'</a> 说明。</p>
