...
<title>jQuery 属性操作 - removeAttr() 方法</title>
</head>
...
<h1>jQuery 属性操作 - removeAttr() 方法</h1>
...
<p>从任何 p 元素中移除 id 属性：</p>

<pre>
$(&quot;button&quot;).click(function(){
  $(&quot;p&quot;).<code>removeAttr(&quot;id&quot;)</code>;
});
</pre>

<p><a href="/tiy/t.asp?f=jquery_attributes_removeAttr">亲自试一试</a></p>
</div>
...
<p>removeAttr() 方法从被选元素中移除属性。</p>

<h3>语法</h3>

<pre>$(<i>selector</i>).removeAttr(<i>attribute</i>)</pre>
