...
<p>选取 class=&quot;intro&quot; 的元素：</p>

<pre>$(.intro)</pre>

<p><a href="/tiy/t.asp?f=jquery_selector_class">亲自试一试</a></p>
</div>
...
<p>. 选择器选取带有指定 class 的元素。</p>

<p>class 引用 HTML 元素的 class 属性。</p>

<p>与 id 选择器不同，class 选择器常用于多个元素。</p>

<p>这样就可以为带有相同 class 的任何 HTML 元素设置特定的样式。</p>
...
<td>class</td>
<td>
	<p>必需。规定要选取的元素的 class。</p>
	<p>class 选择器使用 HTML 元素的 class 属性。</p>
</td>
</tr>
</table>
</div>
...
<p class="note"><span>注释：</span>不要使用数字开头的类名！在某些浏览器中可能出问题。</p>
</div>
