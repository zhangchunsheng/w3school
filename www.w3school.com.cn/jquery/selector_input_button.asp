...
<p>选择 type=&quot;button&quot; 的 &lt;button&gt; 元素和 &lt;input&gt; 元素：</p>

<pre>$(&quot;:button&quot;)</pre>

<p><a href="/tiy/t.asp?f=jquery_selector_input_button">亲自试一试</a></p>
</div>
...
<p>:button 选择器选取类型为 button 的 &lt;button&gt; 元素和 &lt;input&gt; 元素。</p>
...
<p class="tip"><span>提示：</span>通过该选择器使用 input:button 不会选择 &lt;button&gt; 元素。</p>
</div>
