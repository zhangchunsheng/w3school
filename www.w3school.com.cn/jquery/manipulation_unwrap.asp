...
<title>jQuery 文档操作 - unwrap() 方法</title>
</head>
...
<p><a href="/tiy/t.asp?f=jquery_manipulation_unwrap">亲自试一试</a></p>
</div>
...
<p>unwrap() 方法删除被选元素的父元素。</p>

<h3>语法</h3>

<pre>$(<i>selector</i>).unwrap()</pre>
</div>
