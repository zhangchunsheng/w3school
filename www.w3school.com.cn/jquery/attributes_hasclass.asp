...
<title>jQuery 属性操作 - hasClass() 方法</title>
</head>
...
<p>检查第一个 &lt;p&gt; 元素是否包含 &quot;intro&quot; 类：</p>

<pre>
$(&quot;button&quot;).click(function(){
  alert($(&quot;p:first&quot;).<code>hasClass(&quot;intro&quot;)</code>);
});
</pre>

<p><a href="/tiy/t.asp?f=jquery_attributes_hasclass">亲自试一试</a></p>
</div>
...
<p>hasClass() 方法检查被选元素是否包含指定的 class。</p>

<h3>语法</h3>

<pre>$(<i>selector</i>).hasClass(<i>class</i>)</pre>
