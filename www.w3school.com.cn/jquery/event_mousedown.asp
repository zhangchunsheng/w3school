...
<title>jQuery 事件 - mousedown() 方法</title>
</head>
...
<p><a href="/tiy/t.asp?f=jquery_event_mousedown">亲自试一试</a></p>
</div>
...
<p>与 click 事件不同，mousedown 事件仅需要按键被按下，而不需要松开即可发生。</p>
...
<div>
<h2>触发 mousedown 事件</h2>

<h3>语法</h3>

<pre>$(<i>selector</i>).mousedown()</pre>

<p><a href="/tiy/t.asp?f=jquery_event_mousedown_trigger">亲自试一试</a></p>
</div>


<div>
<h2>将函数绑定到 mousedown 事件</h2>

<h3>语法</h3>

<pre>$(<i>selector</i>).mousedown(<i>function</i>)</pre>
...
<tr>
<td><i>function</i></td>
<td>可选。规定当发生 mousedown 事件时运行的函数。</td>
</tr>
</table>
