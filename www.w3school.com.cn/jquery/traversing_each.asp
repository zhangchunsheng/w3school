...
<p><a href="/tiy/t.asp?f=jquery_traversing_each">亲自试一试</a></p>
</div>
...
<p>each() 方法规定为每个匹配元素规定运行的函数。</p>

<p class="tip"><span>提示：</span>返回 false 可用于及早停止循环。</p>

<h3>语法</h3>

<pre>$(<i>selector</i>).each(<i>function(index,element)</i>)</pre>
...
<tr>
<td><i>function(index,element)</i></td>
<td>
