...
<title>jQuery 事件 - unload 属性</title>
</head>
...
<p><a href="/tiy/t.asp?f=jquery_event_unload">亲自试一试</a></p>
</div>
...
<p>当用户离开页面时，会发生 unload 事件。</p>

<p>具体来说，当发生以下情况时，会发出 unload 事件：</p>
...
<p>unload() 方法将事件处理程序绑定到 unload 事件。</p>
<p>unload() 方法只应用于 window 对象。</p>

<h3>语法</h3>

<pre><i>event</i>.unload(<i>function</i>)</pre>
...
<tr>
<td><i>function</i></td>
<td>必需。规定当触发 unload 事件时运行的函数。</td>
</tr>
</table>
</div>
