...
<title>jQuery [attribute] 选择器</title>
</head>
...
<p><a href="/tiy/t.asp?f=jquery_selector_attribute">亲自试一试</a></p>
</div>
...
<p>[attribute] 选择每个带有指定属性的元素。</p>

<p>可以选取带有任何属性的元素（对于指定的属性没有限制）。</p>

<h3>语法</h3>

<pre>$(&quot;[<i>attribute</i>]&quot;)</pre>
