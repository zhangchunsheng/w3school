...
<title>jQuery 效果 - slideDown() 方法</title>
</head>
...
<pre>
$(&quot;.btn2&quot;).click(function(){
  <code>$(&quot;p&quot;).slideDown();</code>
});
</pre>

<p><a href="/tiy/t.asp?f=jquery_effect_slideup_slidedown">亲自试一试</a></p>
</div>
...
<p>slideDown() 方法通过使用滑动效果，显示隐藏的被选元素。</p>
...
<td><i>speed</i></td>
<td>
	<p>可选。规定元素从隐藏到可见的速度（或者相反）。默认为 &quot;normal&quot;。</p>
	...
	<p>在设置速度的情况下，元素从隐藏到可见的过程中，会逐渐地改变其高度。</p>
</td>
</tr>
...
<td><i>callback</i></td>
<td>
	<p>可选。slideDown 函数执行完之后，要执行的函数。</p>
...
<dl>
<dt><a href="/tiy/t.asp?f=jquery_effect_slideup_slidedown_speed">使用 speed 参数</a></dt>
