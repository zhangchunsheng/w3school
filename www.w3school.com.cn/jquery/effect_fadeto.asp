...
<title>jQuery 效果 - fadeTo() 方法</title>
</head>
...
<pre>
$(&quot;.btn1&quot;).click(function(){
  <code>$(&quot;p&quot;).fadeTo(1000,0.4);</code>
});
</pre>

<p><a href="/tiy/t.asp?f=jquery_effect_fadeto">亲自试一试</a></p>
</div>
...
<p>fadeTo() 方法将被选元素的不透明度逐渐地改变为指定的值。</p>

<h3>语法</h3>

<pre>$(<i>selector</i>).fadeTo(<i>speed</i>,<i>opacity</i>,<i>callback</i>)</pre>
...
<tr>
<td><i>opacity</i></td>
<td>必需。规定要淡入或淡出的透明度。必须是介于 0.00 与 1.00 之间的数字。</td>
</tr>

<tr>
<td><i>callback</i></td>
<td>
	<p>可选。fadeTo 函数执行完之后，要执行的函数。</p>
