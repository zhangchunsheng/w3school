...
<p><a href="/tiy/t.asp?f=jquery_selector_lt">亲自试一试</a></p>
</div>
...
<p class="tip"><span>提示：</span>请使用 <a href="/jquery/selector_gt.asp" title="jQuery :gt 选择器">:gt 选择器</a>来选取 index 值大于指定数的元素。</p>
</div>
