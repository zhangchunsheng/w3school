...
<title>jQuery 事件 - timeStamp 属性</title>
</head>
...
<p><a href="/tiy/t.asp?f=jquery_event_timestamp">亲自试一试</a></p>
</div>
...
<p>timeStamp 属性包含从 1970 年 1 月 1 日到事件被触发时的毫秒数。</p>

<h3>语法</h3>

<pre><i>event</i>.timeStamp</pre>
...
<tr>
<td><i>event</i></td>
<td>必需。规定返回该时间戳的事件。这个 <i>event</i> 参数来自事件绑定函数。</td>
</tr>
</table>
</div>
