...
<title>jQuery CSS 操作 - height() 方法</title>
</head>
...
<pre>
$(&quot;.btn1&quot;).click(function(){
  <code>$(&quot;p&quot;).height(50);</code>
});
</pre>

<p><a href="/tiy/t.asp?f=jquery_css_height_set">亲自试一试</a></p>
</div>
...
<p>如果不为该方法设置参数，则返回以像素计的匹配元素的高度。</p>

<h3>语法</h3>

<pre>$(<i>selector</i>).height()</pre>

<p><a href="/tiy/t.asp?f=jquery_css_height_get">亲自试一试</a></p>
</div>
...
<pre>$(<i>selector</i>).height(<i>length</i>)</pre>
...
<p>使用函数来设置所有匹配元素的高度。</p>

<h3>语法</h3>

<pre>$(<i>selector</i>).height(<i>function(index,oldheight)</i>)</pre>
...
<tr>
<td><i>function(index,oldheight)</i></td>
<td>
	<p>规定返回被选元素新高度的函数。</p>
	<ul class="listintable">
	<li>index - 可选。接受选择器的 index 位置</li>
	<li>oldvalue - 可选。接受选择器的当前值。</li>
	</ul>
</td>
</tr>
</table>

<p><a href="/tiy/t.asp?f=jquery_css_height_set_function">亲自试一试</a></p>
</div>
...
<dl>
<dt><a href="/tiy/t.asp?f=jquery_css_height_doc_win">获得文档和窗口元素的高度</a></dt>
<dd>使用 height() 方法来获得 document 和 window 元素的当前高度。</dd>

<dt><a href="/tiy/t.asp?f=jquery_css_height_set_unit">使用 em 和 % 值来设置高度</a></dt>
<dd>使用指定的长度单位来设置元素的高度。</dd>
</dl>
</div>
