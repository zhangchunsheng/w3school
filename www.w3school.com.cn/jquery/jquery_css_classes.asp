...
<title>jQuery - 获取并设置 CSS 类</title>
...
<li class="currentLink"><a href="/jquery/jquery_css_classes.asp" title="jQuery - 获取和设置 CSS 类">jQuery CSS 类</a></li>
...
<h1>jQuery - 获取并设置 CSS 类</h1>

<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/jquery/jquery_dom_remove.asp" title="jQuery - 删除元素">jQuery 删除</a></li>
<li class="next"><a href="/jquery/jquery_css.asp" title="jQuery - css() 方法">jQuery css()</a></li>
</ul>
</div>

<div id="intro">
<p id="test"><strong>通过 jQuery，可以很容易地对 CSS 元素进行操作。</strong></p>
<button id="btnEx">切换类</button>
...
<p><a href="/tiy/t.asp?f=jquery_dom_addclass">亲自试一试</a></p>
...
<p><a href="/tiy/t.asp?f=jquery_dom_addclass2">亲自试一试</a></p>
</div>
...
<p>下面的例子演示如何不同的元素中删除指定的 class 属性：</p>
...
<p><a href="/tiy/t.asp?f=jquery_dom_removeclass">亲自试一试</a></p>
</div>
...
<p><a href="/tiy/t.asp?f=jquery_dom_toggleclass">亲自试一试</a></p>
</div>
...
<p>我们将在下一章讲解 jQuery css() 方法。</p>
</div>


<div>
<h2>jQuery HTML 参考手册</h2>

<p>如需有关 jQuery CSS 方法的完整内容，请访问我们的 <a href="/jquery/jquery_ref_css.asp" title="jQuery 参考手册 - CSS 操作">jQuery CSS 操作参考手册</a></p>
</div>
