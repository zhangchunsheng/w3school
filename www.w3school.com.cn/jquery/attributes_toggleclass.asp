...
<title>jQuery 属性操作 - toggleClass() 方法</title>
</head>
...
<h1>jQuery 属性操作 - toggleClass() 方法</h1>
...
<p><a href="/tiy/t.asp?f=jquery_attributes_toggleclass">亲自试一试</a></p>
</div>
...
<p>toggleClass() 对设置或移除被选元素的一个或多个类进行切换。</p>

<p>该方法检查每个元素中指定的类。如果不存在则添加类，如果已设置则删除之。这就是所谓的切换效果。</p>

<p>不过，通过使用 &quot;switch&quot; 参数，您能够规定只删除或只添加类。</p>
...
<td><i>class</i></td>
<td>
	<p>必需。规定添加或移除 class 的指定元素。</p>
	<p>如需规定若干 class，请使用空格来分隔类名。</p>
</td>
</tr>

<tr>
<td><i>switch</i></td>
<td>可选。布尔值。规定是否添加或移除 class。</td>
</tr>
</table>
</div>
...
<p><a href="/tiy/t.asp?f=jquery_attributes_toggleclass_func">亲自试一试</a></p>
...
<td>
	<p>必需。规定返回需要添加或删除的一个或多个类名的函数。</p>
	<ul class="listintable">
	<li>index - 可选。接受选择器的 index 位置。</li>
	<li>class - 可选。接受选择器的当前的类。</li>
	</ul>
</td>
</tr>
...
<tr>
<td><i>switch</i></td>
<td>可选。布尔值。规定是否添加(true)或移除(false)类。</td>
</tr>
</table>
</div>
