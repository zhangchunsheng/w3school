...
<title>jQuery :password 选择器</title>
</head>
...
<p>选择 type=&quot;password&quot; 的 &lt;input&gt; 元素：</p>

<pre>$(&quot;:password&quot;)</pre>

<p><a href="/tiy/t.asp?f=jquery_selector_input_password">亲自试一试</a></p>
</div>
...
<p>:password 选择器选取类型为 password 的 &lt;input&gt; 元素。</p>
