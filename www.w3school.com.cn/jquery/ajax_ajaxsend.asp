...
<title>jQuery ajax - ajaxSend() 方法</title>
</head>
...
<p>当 AJAX 请求即将发送时，改变 div 元素的内容：</p>
...
<p><a href="/tiy/t.asp?f=jquery_ajax_ajaxsend">亲自试一试</a></p>
</div>
...
<p>ajaxSend() 方法在 AJAX 请求开始时执行函数。它是一个 Ajax 事件。</p>

<h3>语法</h3>

<pre>.ajaxSend([<i>function(event,xhr,options)</i>])</pre>
