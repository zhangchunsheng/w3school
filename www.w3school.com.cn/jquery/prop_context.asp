...
<pre>
$(&quot;div&quot;).append(&quot;&lt;p&gt;&quot; + <code>$(&quot;div&quot;).context</code> + &quot;&lt;/p&gt;&quot;)
.append(&quot;&lt;p&gt;&quot; + $(&quot;div&quot;,document.body).context.nodeName + &quot;&lt;/p&gt;&quot;);
</pre>

<p class="tiy"><a target="_blank" href="/tiy/t.asp?f=jquery_prop_context">亲自试一试</a></p>
</div>
...
<p>context 属性在 jQuery version 1.10 中被弃用。</p>

<p>context 属性含有被传递到 jQuery 的原始上下文，可能是 DOM 节点上下文，如果未传递节点，则是 document 上下文。</p>
