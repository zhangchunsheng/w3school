...
<title>jQuery 事件 - mouseenter() 方法</title>
</head>
...
<p><a href="/tiy/t.asp?f=jquery_event_mouseenter_mouseleave">亲自试一试</a></p>
</div>
...
<p>该事件大多数时候会与 <a href="/jquery/event_mouseleave.asp" title="jQuery mouseleave() 事件函数">mouseleave</a> 事件一起使用。</p>

<p>mouseenter() 方法触发 mouseenter 事件，或规定当发生 mouseenter 事件时运行的函数。</p>

<p class="note"><span>注释：</span>与 mouseover 事件不同，只有在鼠标指针穿过被选元素时，才会触发 mouseenter 事件。如果鼠标指针穿过任何子元素，同样会触发 mouseover 事件。请看下面例子的演示。</p>
...
<div>
<h2>触发 mouseenter 事件</h2>

<h3>语法</h3>

<pre>$(<i>selector</i>).mouseenter()</pre>

<p><a href="/tiy/t.asp?f=jquery_event_enter_leave_trigger">亲自试一试</a></p>
</div>


<div>
<h2>将函数绑定到 mouseenter 事件</h2>

<h3>语法</h3>

<pre>$(<i>selector</i>).mouseenter(<i>function</i>)</pre>
...
<tr>
<td><i>function</i></td>
<td>可选。规定当发生 mouseenter 事件时运行的函数。</td>
</tr>
</table>
