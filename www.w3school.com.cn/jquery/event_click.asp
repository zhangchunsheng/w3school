...
<title>jQuery 事件 - click() 方法</title>
</head>
...
<p><a href="/tiy/t.asp?f=jquery_event_click">亲自试一试</a></p>
</div>
...
<p>当点击元素时，会发生 click 事件。</p>

<p>当鼠标指针停留在元素上方，然后按下并松开鼠标左键时，就会发生一次 click。</p>

<p>click() 方法触发 click 事件，或规定当发生 click 事件时运行的函数。</p>
</div>
...
<pre>$(<i>selector</i>).click()</pre>

<p><a href="/tiy/t.asp?f=jquery_event_click_trigger">亲自试一试</a></p>
</div>


<div>
<h2>将函数绑定到 click 事件</h2>

<h3>语法</h3>

<pre>$(<i>selector</i>).click(<i>function</i>)</pre>
