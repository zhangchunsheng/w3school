...
<li class="currentLink"><a href="/rdf/rdf_dublin.asp" title="RDF 都柏林核心">RDF 都柏林核心</a></li>
...
<h1>RDF 都柏林核心元数据倡议</h1>

<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/rdf/rdf_schema.asp" title="RDF Schema">RDF Schema</a></li>
<li class="next"><a href="/rdf/rdf_owl.asp" title="RDF OWL">RDF OWL</a></li>
</ul>
</div>

<div id="intro">
<p><strong>都柏林核心元数据倡议 (DCMI) 已创建了一些供描述文档的预定义属性。</strong></p>
</div>

<div>
<h2>Dublin 核心</h2>
<p>RDF 是元数据（关于数据的数据）。RDF 被用于描述信息资源。</p>
<p>都柏林核心是一套供描述文档的预定义属性。</p>
<p>第一份都柏林核心属性是于1995年 在俄亥俄州的都柏林的元数据工作组被定义的，目前由都柏林元数据倡议来维护。</p>
...
<tr>
<td>Rights</td>
<td>有关保留在资源之内和之上的权利的信息</td>
</tr>

<tr>
<td>Source</td>
<td>一个对作为目前资源的来源的资源引用。</td>
</tr>
...
<p>通过浏览上面这个表格，我们可以发现 RDF 是非常适合表示都柏林核心信息的。</p>
</div>

<div>
<h2>RDF 实例</h2>
<p>下面的例子演示了都柏林核心属性在一个 RDF 文档中的使用：</p>
<pre>&lt;?xml version=&quot;1.0&quot;?&gt;
