...
<li class="currentLink"><a href="/rdf/rdf_collections.asp" title="RDF 集合">RDF 集合</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/rdf/rdf_containers.asp" title="RDF 容器">RDF 容器</a></li>
<li class="next"><a href="/rdf/rdf_schema.asp" title="RDF Schema">RDF Schema</a></li>
</ul>
</div>

<div id="intro">
<p><strong>RDF 集合用于描述仅包含指定成员的组。</strong></p>
</div>


<div>
<h2>rdf:parseType=&quot;Collection&quot; 属性</h2>

<p>正如在前面的章节所看到的，我们无法关闭一个容器。容器规定了所包含的资源为成员 - 它没有规定其他的成员是不被允许的。</p>

<p>RDF 集合用于描述仅包含指定成员的组。</p>
