...
<h2>AJAX XHR</h2>
<ul>
<li class="currentLink"><a href="/ajax/ajax_xmlhttprequest_create.asp" title="AJAX - 创建 XMLHttpRequest 对象">XHR 创建对象</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/ajax/ajax_example.asp" title="AJAX 实例">AJAX 实例</a></li>
<li class="next"><a href="/ajax/ajax_xmlhttprequest_send.asp" title="AJAX - 向服务器发送请求">XHR 请求</a></li>
</ul>
</div>
