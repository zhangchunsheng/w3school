...
<li class="currentLink"><a href="/ajax/ajax_xmlfile.asp" title="AJAX XML 实例">AJAX XML 文件</a></li>
</ul>
<h2>AJAX 实例</h2>
<ul>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/ajax/ajax_database.asp" title="AJAX 数据库实例">AJAX 数据库</a></li>
<li class="next"><a href="/example/ajax_examples.asp" title="AJAX 实例">AJAX 实例</a></li>
</ul>
</div>

<div id="intro">
<p><strong>AJAX 可用来与 XML 文件进行交互式通信。</strong></p>
</div>
...
<p><a href="/tiy/t.asp?f=ajax_xml">亲自试一下源代码</a></p>
</div>
