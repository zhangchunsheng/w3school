...
<div>
<h2>定义和用法</h2>
<p>Path 属性用于返回指定的驱动器、文件或者文件的路径。</p>
<p class="note"><span>注释：</span>对于驱动器，路径不包含根目录。例如，C 驱动器的路径是 C:，而不是 C:\。</p>

<h3>语法：</h3>
<pre>DriveObject.Path 
FileObject.Path
FolderObject.Path</pre>
</div>

<div>
<h2>实例</h2>

<h3>针对 Drive 对象的例子</h3>
<pre>&lt;%
dim fs,d
set fs=Server.CreateObject(&quot;Scripting.FileSystemObject&quot;)
set d=fs.GetDrive(&quot;c:&quot;)
Response.Write(&quot;The path is &quot; &amp; <code>d.Path</code>)
set d=nothing
set fs=nothing
%&gt;</pre>

<p>输出：</p>
<pre>The path is C:</pre>
...
Response.Write(&quot;The path is: &quot; &amp; <code>f.Path</code>)
set f=nothing
set fs=nothing
%&gt;</pre>

<p>输出：</p>
<pre>The path is: D:\asp\test\test.asp</pre>
...
Response.Write(&quot;The path is: &quot; &amp; <code>fo.Path</code>)
set fo=nothing
set fs=nothing
%&gt;</pre>

<p>输出：</p>
<pre>The path is: D:\asp\test</pre>
</div>
