...
<div>
<h2>定义和用法</h2>
<p>FileSystem 属性返回指定的驱动器所使用的文件系统。</p>
<p>此属性可返回下列的值：</p>

<ul>
  <li>FAT - 可移动驱动器</li>
  <li>CDFS - CD-ROM 驱动器</li>
  <li>FAT, FAT32 或 NTFS - 在 Windows 2000 或 Windows NT 上的硬盘驱动器</li>
  <li>FAT 或 FAT32 - 在 Windows 9x 上的硬盘驱动器</li>
</ul>

<h3>语法：</h3>
<pre>DriveObject.FileSystem</pre>
</div>
...
set d=fs.GetDrive(&quot;c:&quot;)
Response.Write(&quot;The file system in use is: &quot; &amp; <code>d.FileSystem</code>)
set d=nothing
set fs=nothing
%&gt;</pre>

<p>输出：</p>
<pre>The file system in use is: FAT</pre>
</div>
