...
<title>ASP GetLastError() 方法 (ASP 3.0)</title>
</head>
...
<h1>ASP GetLastError() 方法 (ASP 3.0)</h1>

<div>
<p><a href="asp_ref_server.asp" title="ASP Server 对象">Server 对象参考手册</a></p>
</div>

<div>
<h2>定义和用法</h2>
<p>GetLastError 方法返回 ASPError 对象，描述发生错误的原因。</p>

<p>默认地，网站会使用文件 \iishelp\common\500-100.asp 来处理 ASP 错误。您即可以使用此文件，也可以创建自己的文件。如果您希望改变处理 500;100 custom errors 的 ASP 文件，请使用 IIS snap-in 。</p>

<p class="note"><span>注释：</span>如果在 IIS 处理 ASP 文件或应用程序的 Global.asa 时碰到错误，就会生成500;100 custom error。</p>
<p class="note"><span>注释：</span>此方法仅在 ASP 文件发送任何内容到浏览器之前可用。</p>
</div>

<div>
<h2>语法</h2>
<pre>Server.GetLastError()</pre>
</div>
...
<h3>例子 1</h3>
<p>在本例中，在 IIS 试图引用文件，而 include 语句没有使用 file 参数时，错误就会发生：</p>
<pre>&lt;!--#include f=&quot;header.inc&quot; --&gt;
&lt;%
response.write(&quot;sometext&quot;)
%&gt;</pre>

<h3>例子 2</h3>
<p>在本例中，当编译脚本时，由于关键词 &quot;next&quot; 被遗漏，就会发生错误：</p>
<pre>&lt;%
dim i
for i=1 to 10
  ........
...
<h3>例子 3</h3>
<p>在本例中，由于脚本试图用 0 来除一个数，就会发生错误：</p>
<pre>&lt;%
dim i,tot,j
i=0
tot=0
