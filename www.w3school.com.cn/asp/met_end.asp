...
<p>End 方法停止对脚本的处理，并返回当前的结果。</p>

<p class="note"><span>注释：</span>如果 Response.Buffer 被设置为 true ，此方法会输出缓存的内容。如果您不希望向用户返回任何任何输出，应该首先调用 Response.Clear 。</p>
...
<pre>I am writing some text. This text will never be </pre>
</div>
