...
<title>ASP FolderExists 方法</title>
</head>
...
<div>
<h2>定义和用法</h2>
<p>FolderExists 方法可返回指示指定的文件夹是否存在的布尔值。如果存在则返回 Ture，否则返回 Fasle。</p>

<h3>语法：</h3>
<pre>FileSystemObject.FolderExists(foldername)</pre>
...
if <code>fs.FolderExists(&quot;c:\asp&quot;)</code>=true then
