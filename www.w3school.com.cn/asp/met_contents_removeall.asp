...
<title>ASP Contents.RemoveAll 方法</title>
</head>
...
<h1>ASP Contents.RemoveAll 方法</h1>
...
<div>
<h2>定义和用法</h2>
<p>Contents.RemoveAll 方法可从 Contents 集合删除所有的项目。</p>
</div>

<div>
<h2>语法</h2>
<pre>Application.Contents.RemoveAll()

Session.Contents.RemoveAll()</pre>
</div>

<div>
<h2>针对 Application 对象的例子</h2>
<pre>&lt;%
