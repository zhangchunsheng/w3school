...
<div>
<h2>定义和用法</h2>
<p>FreeSpace 属性返回在指定驱动器或网络共享上对于用户的剩余空间量。</p>
<p class="note"><span>注释：</span>返回的值通常等于由 AvailableSpace 属性返回的值。对于支持限额的计算机系统来说，这两个属性返回的值有所差异。</p>

<h3>语法：</h3>
<pre>DriveObject.FreeSpace</pre>
</div>
...
Response.Write(&quot; Free space in bytes: &quot; &amp; <code>d.FreeSpace</code>)
set d=nothing
set fs=nothing
%&gt;</pre>

<p>输出：</p>
<pre>Drive c: Free space in bytes: 669965663</pre>
</div>
