...
<div>
<h2>定义和用法</h2>
<p>WriteLine 方法向 TextStream 文件写入一段指定的文本以及一个新行字符。</p>

<h3>语法：</h3>
<pre>TextStreamObject.WriteLine(text)</pre>
...
<table class="dataintable"> 
  ...
  <tr>
    <td>text</td>
    <td>可选的。需要写入文件的文本。如果您不规定此参数，那么一个新行字符会被写入文件。</td>
  </tr>
</table>
</div>
...
<code>f.WriteLine(&quot;Hello World!&quot;)
f.WriteLine(&quot;How are you today?&quot;)
f.WriteLine(&quot;Goodbye!&quot;)</code>
f.close
set f=nothing
set fs=nothing
%&gt;</pre>
