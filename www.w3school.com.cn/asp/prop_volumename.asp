...
<div>
<h2>定义和用法</h2>
<p>VolumeName 属性设置或返回指定驱动器的卷标。可读写。</p>

<h3>语法：</h3>
<pre>DriveObject.VolumeName[=newname]</pre>
...
set d=fs.GetDrive(&quot;c:&quot;)
Response.Write(&quot;The volume name is: &quot; &amp; <code>d.VolumeName</code>)
set d=nothing
set fs=nothing
%&gt;</pre>
</div>
