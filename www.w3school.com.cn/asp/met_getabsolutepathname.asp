...
<title>ASP GetAbsolutePathName 方法</title>
</head>
...
<h1>ASP GetAbsolutePathName 方法</h1>
...
<div>
<h2>定义和用法</h2>
<p>GetAbsolutePathName 方法为指定路径返回从根驱动器开始的完整路径。</p>

<h3>语法：</h3>
<pre>FileSystemObject.GetAbsolutePathName(path)</pre>
...
path=<code>fs.GetAbsolutePathName(&quot;c:&quot;)</code>
response.write(path)
%&gt;</pre>
...
dim fs,path
set fs=Server.CreateObject(&quot;Scripting.FileSystemObject&quot;)
path=<code>fs.GetAbsolutePathName(&quot;mydoc.txt&quot;)</code>
response.write(path)
%&gt;</pre>

<p>输出：</p>
<pre>c:\temp\test\mydoc.txt</pre>
...
dim fs,path
set fs=Server.CreateObject(&quot;Scripting.FileSystemObject&quot;)
path=<code>fs.GetAbsolutePathName(&quot;private\mydoc.txt&quot;)</code>
response.write(path)
%&gt;</pre>

<p>输出：</p>
<pre>c:\temp\test\private\mydoc.txt</pre>
</div>
