...
<div>
<h2>定义和用法</h2>
<p>TotalSize 属性返回指定驱动器或网络共享的总字节数。</p>

<h3>语法：</h3>
<pre>DriveObject.TotalSize</pre>
</div>
...
set d=fs.GetDrive(&quot;c:&quot;)
Response.Write(&quot;The total size in bytes is: &quot; &amp; <code>d.TotalSize</code>)
set d=nothing
set fs=nothing
%&gt;</pre>

<p>输出：</p>
<pre>The total size in bytes is: 9693563395</pre>
</div>
