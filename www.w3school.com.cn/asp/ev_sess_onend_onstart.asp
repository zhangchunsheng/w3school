...
<title>ASP Session_OnStart 和 Session_OnEnd 事件</title>
</head>
...
<h1>ASP Session_OnStart 和 Session_OnEnd 事件</h1>
...
<h3>Session_OnStart Event</h3>
<p>Session_OnStart 事件在服务器创建新会话时发生。</p>
<p>此事件放置在 Global.asa 文件中。</p>

<h3>Session_OnEnd Event</h3>
<p>Session_OnEnd 事件在会话结束时发生。 (会话被放弃或超时的时候).</p>
<p>此事件放置在 Global.asa 文件中。</p>
<p class="note"><span>注释：</span>MapPath 方法不能用在 Session_OnEnd 代码中。</p>
</div>
