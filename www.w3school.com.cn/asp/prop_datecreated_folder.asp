...
<title>ASP DateCreated 属性</title>
</head>
...
<div>
<h2>定义和用法</h2>
<p>DateCreated 属性用于返回指定的文件或文件夹被创建的日期和时间。</p>

<h3>语法：</h3>
<pre>FileObject.DateCreated
FolderObject.DateCreated</pre>
</div>
...
Response.Write(<code>f.DateCreated</code>)
set f=nothing
set fs=nothing
%&gt;</pre>

<p>输出：</p>
<pre>File created: 8/8/2008 8:8:00 PM</pre>
...
Response.Write(<code>fo.DateCreated</code>)
set fo=nothing
set fs=nothing
%&gt;</pre>

<p>输出：</p>
<pre>Folder created: 8/8/2008 8:8:00 PM</pre>
</div>
