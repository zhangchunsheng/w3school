...
<div>
<h2>定义和用法</h2>
<p>Attributes 属性可用来设置或返回指定的文件或文件夹的属性。</p>

<h3>语法：</h3>
<pre>FileObject.Attributes[=newattributes] 
FolderObject.Attributes[=newattributes]</pre>
...
<table class="dataintable"> 
  ...
  <tr>
    <td valign="top">newattributes</td>
    <td valign="top">
	<p>可选的。规定文件或文件夹的属性值。</p>
	<p>才采用下列的值之一或下列值的组合：</p>
