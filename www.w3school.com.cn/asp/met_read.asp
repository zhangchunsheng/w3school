...
<div>
<h2>定义和用法</h2>
<p>Read 方法从 TextStream 文件中读取指定数量的字符，并以字符串返回结果。</p>

<h3>语法：</h3>
<pre>TextStreamObject.Read(numchar)</pre>
...
x=<code>t.Read(5)</code>
t.close 
Response.Write(&quot;The first five characters are: &quot; &amp; x)
%&gt;</pre>

<p>输出：</p>
<pre>The first five characters are: Hello</pre>
</div>
