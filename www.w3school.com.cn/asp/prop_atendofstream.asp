...
<title>ASP AtEndOfStream 属性</title>
</head>
...
<h1>ASP AtEndOfStream 属性</h1>

<div class="backtoreference">
<p><a href="asp_ref_textstream.asp" title="ASP Textstream 对象">Textstream 对象参考手册</a></p>
</div>

<div>
<h2>定义和用法</h2>
<p>如果文件指针位于 TextStream 文件的末尾，AtEndOfStream 属性返回 True ，否则返回 False 。</p>
<p class="note"><span>注释：</span>此属性仅工作于以只读方式打开的 TextStream 对象。</p>

<h3>语法：</h3>
<pre>TextStreamObject.AtEndOfStream</pre>
</div>
...
do while <code>t.AtEndOfStream</code>&lt;&gt;true
  x=t.Read(1)
loop
t.close 
...
<p>输出：</p>
<p>The last character in the text file is: !</p>
</div>
