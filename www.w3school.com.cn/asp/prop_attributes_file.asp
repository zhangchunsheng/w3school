...
<p>Attributes 属性用于设置或返回指定文件或文件夹的属性。</p>

<h3>语法：</h3>
<pre>FileObject.Attributes[=newattributes]
...
<table class="dataintable"> 
  ...
  <tr>
    <td>newattributes</td>
    <td>
	<p>可选的。规定文件或文件夹的属性值。</p>
	<p>可采用下列值之一或者下列值的组合：</p>
    <ul class="listintable">
	<li>0 = 普通文件。没有设置任何属性。</li>
    <li>1 = 只读文件。可读写。</li>
    <li>2 = 隐藏文件。可读写。</li>
    <li>4 = 系统文件。可读写。</li>
    <li>16 = 文件夹或目录。只读。</li>
    <li>32 = 上次备份后已更改的文件。可读写。</li>
    <li>1024 = 链接或快捷方式。只读。</li>
    <li>2048 = 压缩文件。只读。</li>
	</ul>
	</td>
  </tr>
...
Response.Write(<code>f.Attributes</code>)
set f=nothing
set fs=nothing
%&gt;</pre>
<p>输出：</p>
<pre>The attributes of the file are: 32</pre>
</div>
...
Response.Write(<code>fo.Attributes</code>)
set fo=nothing
set fs=nothing
%&gt;</pre>
<p>输出：</p>
<pre>The attributes of the folder are: 16</pre>
</div>
