...
<title>ASP ContentType 属性</title>
</head>
...
<div>
<p>ContentType 属性为 response 对象设置 HTTP 内容类型。</p>
...
<table class="dataintable"> 
  ...
  <tr>
    ...
    <td>
	<p>描述内容类型的字符串。</p>
    <p>如需完整的内容类型列表，请参阅您的浏览器文档或 HTTP 规范。</p>
	</td>
  </tr>
</table>
</div>
...
<p>如果 ASP 页面没有设置 ContentType 属性，那么默认的 content-type 头部是这样的：</p>
<pre>content-type:text/html</pre>

<p>其他一些常用的 ContentType 值：</p>
<pre>&lt;%response.ContentType=&quot;text/HTML&quot;%&gt;
&lt;%response.ContentType=&quot;image/GIF&quot;%&gt;
&lt;%response.ContentType=&quot;image/JPEG&quot;%&gt;
&lt;%response.ContentType=&quot;text/plain&quot;%&gt;
&lt;%response.ContentType=&quot;image/JPEG&quot;%&gt;</pre>

<p>此例会在浏览器中打开一个 Excel 电子表格（如果用户已经安装了 Excel ）：</p>
<pre>&lt;%response.ContentType=&quot;application/vnd.ms-excel&quot;%&gt;
&lt;html&gt;
&lt;body&gt;
&lt;table&gt;
&lt;tr&gt;
