...
<div>
<h2>定义和用法</h2>
<p>ShortName 属性用于返回指定的文件或文件夹的短名称 (8.3 命名约定)。</p>

<h3>语法：</h3>
<pre>FileObject.ShortName
FolderObject.ShortName</pre>
</div>
...
Response.Write(&quot;&lt;br /&gt;ShortName: &quot; &amp; <code>f.ShortName</code>)
set f=nothing
set fs=nothing
%&gt;</pre>

<p>输出：</p>
<pre>Name: hitcounterfile.txt
ShortName: HITCOU~1.TXT</pre>
</div>
...
Response.Write(&quot;&lt;br /&gt;ShortName: &quot; &amp; <code>fo.ShortName</code>)
set fo=nothing
set fs=nothing
%&gt;</pre>

<p>输出：</p>
<pre>Name: asp_test_web
ShortName: ASP_TE~1</pre>
</div>
