...
<div>
<h2>定义和用法</h2>
<p>ReadAll 方法可读取整个 TextStream 文件，并以字符串返回结果。</p>
<p class="note"><span>注释：</span>此方法不适合大型文件（会浪费内存资源）。</p>

<h3>语法：</h3>
<pre>TextStreamObject.ReadAll</pre>
</div>
...
x=<code>t.ReadAll</code>
t.close 
Response.Write(&quot;The text in the file is: &quot; &amp; x)
%&gt;</pre>

<p>输出：</p>
<pre>The text in the file is: Hello World!</pre>
</div>
