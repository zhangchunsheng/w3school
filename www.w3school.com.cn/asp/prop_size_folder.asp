...
<p>Size 属性用于返回指定的文件或文件夹的字节数。</p>

<h3>语法：</h3>
<pre>FileObject.Size
FolderObject.Size</pre>
</div>
...
Response.Write(<code>f.Size</code> &amp; &quot; bytes.&quot;)
set f=nothing
set fs=nothing
%&gt;</pre>

<p>输出：</p>
<pre>The size of test.asp is: 18665 bytes.</pre>
</div>
...
Response.Write(<code>fo.Size</code> &amp; &quot; bytes.&quot;)
set fo=nothing
set fs=nothing
%&gt;</pre>

<p>输出：</p>
<pre>The size of the folder test is: 652398 bytes.</pre>
</div>
