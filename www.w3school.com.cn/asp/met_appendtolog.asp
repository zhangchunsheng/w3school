...
<title>ASP AppendToLog 方法</title>
</head>
...
<p>AppendToLog 方法向服务器日志文件的末端添加字符串。</p>

<p>您可在脚本文件中多次调用此方法。当它每次被调用，就会向日志追加指定的字符串。</p>

<h3>语法</h3>

<pre>response.AppendToLog <i>string</i></pre>
...
<tr>
<td><i>string</i></td>
<td>必需的。向日志文件追加的文本。 (不能包含任何逗号字符)</td>
</tr>
</table>
</div>
...
<div>
<h2>实例</h2>
<pre>&lt;%Response.AppendToLog &quot;My log message&quot;%&gt;</pre>
</div>
