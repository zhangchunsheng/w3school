...
<div>
<h2>定义和用法</h2>
<p>Drive 属性用于返回指定的文件或文件夹所处的驱动器的驱动器字母（驱动器号）。</p>

<h3>语法：</h3>
<pre>FileObject.Drive
FolderObject.Drive</pre>
</div>
...
Response.Write(<code>f.Drive</code>)
set f=nothing
set fs=nothing
%&gt;</pre>

<p>输出：</p>
<pre>File resides on drive: d:</pre>
</div>
...
Response.Write(<code>fo.Drive</code>)
set fo=nothing
set fs=nothing
%&gt;</pre>

<p>输出：</p>
<pre>Folder resides on drive: d:</pre>
</div>
