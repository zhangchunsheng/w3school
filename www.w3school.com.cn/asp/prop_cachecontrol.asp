...
<title>ASP CacheControl 属性</title>
</head>
...
<div>
<p>CacheControl 属性设置是否可缓存由 ASP 生成的输出。默认地，代理服务器不会保持缓存副本。</p>

<h3>语法：</h3>
<pre>response.CacheControl[=control_header]</pre>
...
<table class="dataintable"> 
  ...
  <tr>
    ...
    <td>
	<p>缓存的 control header ，可被设置为 &quot;Public&quot; 或 &quot;Private&quot;。</p>
    <p>Private 是默认的，仅有私人缓存可以缓存此页。如果为此设置，代理服务器就不会缓存页面。</p>
    <p>Public 指示公共缓存。如果为此设置，代理服务器会缓存页面。</p>
	</td>
  </tr>
</table>
</div>
...
<p>或者：</p>
<pre>&lt;%response.CacheControl=&quot;Private&quot;%&gt;</pre>
</div>
