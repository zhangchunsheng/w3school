...
<title>ASP GetBaseName 方法</title>
</head>
...
<div>
<h2>定义和用法</h2>
<p>GetBaseName 方法返回指定路径中的文件或文件夹的基准名称。</p>

<h3>语法：</h3>
<pre>FileSystemObject.GetBaseName(path)</pre>
...
Response.Write(<code>fs.GetBaseName(&quot;c:\winnt\cursors\3dgarro.cur&quot;)</code>)
set fs=nothing
%&gt;</pre>
