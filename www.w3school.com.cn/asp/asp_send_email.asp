...
<meta name="keywords" content="ASP电子邮件,CDOSYS组件" />
<meta name="description" content="本节向您讲解如何使用ASP的CDOSYS组件来发送电子邮件。" />
...
<title>ASP 使用 CDOSYS 发送电子邮件</title>
</head>
...
<li class="currentLink"><a href="/asp/asp_send_email.asp" title="ASP 使用 CDOSYS 发送电子邮件">ASP 邮件</a></li>
</ul>
<h2>ASP 高级</h2>
<ul>
...
<h1>ASP 使用 CDOSYS 发送电子邮件</h1>


<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/asp/asp_globalasa.asp" title="ASP Global.asa 文件">ASP Global.asa</a></li>
<li class="next"><a href="/asp/asp_ref_response.asp" title="ASP Response 对象">ASP Response</a></li>
</ul>
</div>


<div id="intro">
<p><strong>CDOSYS 是 ASP 中的内置组件。此组建用于通过 ASP 来发送电子邮件。</strong></p>
</div>
...
<p>CDO (Collaboration Data Objects) 是一项微软的技术，设计目的是用来简化通信程序的创建。</p>

<p>CDOSYS 是 ASP 中的内置组件。我们会向您展示如何使用该组件来发送电子邮件。</p>

<h3>CDONTs 怎么样？</h3>

<p>微软已经在 Windows 2000、Windows XP 以及 Windows 2003 中淘汰了 CDONTs。如果您还在应用程序中使用 CDONTs，就需要更新代码，并使用新的 CDO 技术。</p>
