...
<div>
<h2>定义和用法</h2>
<p>Add 方法向 Dictionary 对象添加一个新的 key/item 对。</p>
<p class="note"><span>注释：</span>如果 key 已经存在，则会出现错误。</p>

<h3>语法：</h3>
<pre>DictionaryObject.Add(key,item)</pre>
...
<table class="dataintable"> 
  ...
  <tr>
    <td>key</td>
    <td>必需的。与 item 相关联的 key 值。</td>
  </tr>
  <tr>
    <td>item</td>
    <td>必需的。与 key 相关联的 item 值。</td>
  </tr>
</table>
</div>
