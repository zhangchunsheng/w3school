...
<div>
<h2>定义和用法</h2>
<p>BuildPath 方法向已有的路径添加名称。</p>

<h3>语法：</h3>
<pre>[newpath=]FileSystemObject.BuildPath(path,name)</pre>
...
path=<code>fs.BuildPath(&quot;c:\mydocuments&quot;,&quot;test&quot;)</code>
response.write(path)
set fs=nothing
%&gt;
</pre>
