...
<div>
<h2>定义和用法</h2>
<p>Skip 方法在读取 TextStream 文件时跳过指定的字符数目。</p>

<h3>语法：</h3>
<pre>TextStreamObject.Skip(numchar)</pre>
...
<p>输出：</p>
<pre>The output after skipping some characters: orld!</pre>
</div>
