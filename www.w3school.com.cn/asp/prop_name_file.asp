...
<div>
<h2>定义和用法</h2>
<p>Name 属性用来设置或返回指定的文件或文件夹的名称。</p>

<h3>语法：</h3>
<pre>FileObject.Name[=newname]
FolderObject.Name[=newname]</pre>
...
Response.Write(<code>f.Name</code>)
set f=nothing
set fs=nothing
%&gt;</pre>
<p>输出：</p>
<pre>The file's name: help.txt</pre>
</div>
...
Response.Write(<code>fo.Name</code>)
set fo=nothing
set fs=nothing
%&gt;</pre>
<p>输出：</p>
<pre>The folder's name: help</pre>
</div>
