...
<h2>ASP 教程总结</h2>
<ul>
<li class="currentLink"><a href="/asp/asp_quickref.asp" title="ASP 快速参考">ASP 快速参考</a></li>
...
<div  id="tpn">
<ul class="prenext">
<li class="pre"><a href="/asp/asp_ajax_database.asp" title="AJAX 数据库实例">AJAX 数据库</a></li>
<li class="next"><a href="/asp/asp_summary.asp" title="ASP 课程总结">ASP 课程总结</a></li>
</ul>
</div>
