...
<title>ASP GetExtensionName 方法</title>
</head>
...
<div>
<h2>定义和用法</h2>
<p>GetExtensionName 方法返回包含指定路径中最后成分的文件扩展名的字符串。</p>

<h3>语法：</h3>
<pre>FileSystemObject.GetExtensionName(path)</pre>
...
Response.Write(<code>fs.GetExtensionName(&quot;c:\test\test.htm&quot;)</code>)
set fs=nothing
%&gt;</pre>
