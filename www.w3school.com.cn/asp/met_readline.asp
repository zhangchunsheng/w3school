...
<div>
<h2>定义和用法</h2>
<p>ReadLine 方法可从 TextStream 文件中读取一整行字符，并以字符串返回结果。</p>

<h3>语法：</h3>
<pre>TextStreamObject.ReadLine</pre>
</div>
...
<p>输出：</p>
<pre>The first line in the file contains this text: Line 1</pre>
</div>
