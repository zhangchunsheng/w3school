...
<div>
<h2>定义和用法</h2>
<p>Remove 方法从 Dictionary 对象中删除指定的 key/item 对。</p>

<h3>语法：</h3>
<pre>DictionaryObject.Remove(key)</pre>
...
<table class="dataintable"> 
  ...
  <tr>
    <td>key</td>
    <td>必需的。与需要删除的 key/item 对相关联的 key。</td>
  </tr>
</table>
</div>
