...
<div>
<h2>定义和用法</h2>
<p>URLEncode 方法把 URL 编码规则应用到指定的字符串。</p>
</div>

<div>
<h2>Syntax
</h2>
<pre>Server.URLEncode(string) </pre>
...
<p>输出</p>
<pre>http%3A%2F%2Fwww%2Ew3school%2Ecom%2Ecn</pre>
</div>
