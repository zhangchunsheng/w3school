...
<div>
<h2>定义和用法</h2>
<p>Exists 方法返回在 Dictionary 对象中是否存在指定的 key 的布尔值。如果存在，返回 true，否则返回 false。</p>

<h3>语法：</h3>
<pre>DictionaryObject.Exists(key)</pre>
...
if <code>d.Exists(&quot;c&quot;)</code>=true then
