...
<title>ASP SerialNumber 属性</title>
</head>
...
<div>
<h2>定义和用法</h2>
<p>SerialNumber 属性返回指定驱动器的序列号。</p>
<p class="note"><span>注释：</span>可以使用 SerialNumber 属性以确保在可移动媒介驱动器中插入正确的磁盘。</p>

<h3>语法：</h3>
<pre>DriveObject.SerialNumber</pre>
</div>
...
set d=fs.GetDrive(&quot;c:&quot;)
Response.Write(&quot;The serial number is: &quot; &amp; <code>d.SerialNumber</code>)
set d=nothing
set fs=nothing
%&gt;</pre>

<p>输出：</p>
<pre>The serial number is: 578680518</pre>
</div>
