...
<title>ASP ScriptTimeout 属性</title>
</head>
...
<div>
<h2>定义和用法</h2>
<p>ScriptTimeout 属性设置或返回脚本在被终止前可运行的最大秒数。</p>
</div>

<div>
<h2>语法</h2>
<pre>Server.ScriptTimeout[=NumSeconds]</pre>
...
<table class="dataintable"> 
  ...
  <tr>
    <td>NumSeconds</td>
    <td>脚本在被终止前可运行的最大秒数。默认是 90 秒。</td>
  </tr>
</table>
</div>
