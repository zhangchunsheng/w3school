...
<div>
<h2>定义和用法</h2>
<p>MapPath 方法可把指定的路径影射到服务器上相应的物理路径上。</p>

<p class="note"><span>注释：</span>此方法不能用于 Session.OnEnd 和 Application.OnEnd 中。</p>
</div>

<div>
<h2>Syntax</h2>
<pre>Server.MapPath(path)</pre>
...
<table class="dataintable"> 
  ...
  <tr>
    ...
    <td valign="top">必需。映射为物理路径的相对路径或绝对路径。如果该参数以 / 或 \ 开头，则返回完整的虚拟路径。如果该参数不以 / 或 \ 开头，则返回相对于正在被处理的 .asp 文件的路径。</td>
  </tr>
</table>
</div>
...
<h3>实例 1</h3>
<p>举例，文件 test.asp 位于 C:\Inetpub\wwwroot\Script。</p>
<p>文件 Test.asp (位于 C:\Inetpub\wwwroot\Script) 包含下列代码：</p>
<pre>&lt;%
...
<p>输出：</p>
<pre>c:\inetpub\wwwroot\script\test.asp
c:\inetpub\wwwroot\script\script\test.asp
c:\inetpub\wwwroot\script\test.asp
c:\inetpub\wwwroot\script
c:\inetpub\wwwroot
c:\inetpub\wwwroot</pre>

<h3>例子 2</h3>
<p>如何使用一个相对路径来返回到达正在浏览器中查看的页面的相对物理路径：</p>
<pre>&lt;%
