...
<title>ASP GetDriveName 方法</title>
</head>
...
<div>
<h2>定义和用法</h2>
<p>GetDriveName 方法返回一个字符串，该值是指定路径的驱动器名称。</p>

<h3>语法：</h3>
<pre>FileSystemObject.GetDriveName(path)</pre>
...
dname=<code>fs.GetDriveName(&quot;c:\test\test.htm&quot;)</code>
