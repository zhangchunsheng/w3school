...
<title>ASP GetTempName 方法</title>
</head>
...
<div>
<h2>定义和用法</h2>
<p>GetTempName 方法返回一个随机产生的临时文件或文件夹。</p>

<h3>语法：</h3>
<pre>FileSystemObject.GetTempName</pre>
</div>
...
tname=<code>fs.GetTempName</code>
