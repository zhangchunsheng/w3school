...
<li class="currentLink"><a href="/asp/asp_ref_application.asp" title="ASP Application 对象">ASP Application</a></li>
...
<div  id="tpn">
<ul class="prenext">
<li class="pre"><a href="/asp/asp_ref_request.asp" title="ASP Request 对象">ASP Request</a></li>
<li class="next"><a href="/asp/asp_ref_session.asp" title="ASP Session 对象">ASP Session</a></li>
</ul>
</div>
...
<tr>
<td><a href="/asp/met_lock_unlock.asp">Lock</a></td>
<td>防止其余的用户修改 Application 对象中的变量。</td>
</tr>

<tr>
<td><a href="/asp/met_lock_unlock.asp">Unlock</a></td>
...
<tr>
<td><a href="/asp/ev_app_onend_onstart.asp">Application_OnEnd</a></td>
<td>当所有用户的 session 都结束，并且应用程序结束时，此事件发生。</td>
</tr>

<tr>
<td><a href="/asp/ev_app_onend_onstart.asp">Application_OnStart</a></td>
