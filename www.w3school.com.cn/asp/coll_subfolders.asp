...
<div>
<h2>定义和用法</h2>
<p>SubFolders 集合可返回指定的文件夹中所有子文件夹组成的的一个集合。</p>

<h3>语法：</h3>
<pre>FolderObject.SubFolders</pre>
</div>
...
for each x in <code>fo.SubFolders</code>
