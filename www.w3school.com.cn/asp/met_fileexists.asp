...
<div>
<h2>定义和用法</h2>
<p>FileExists 方法可返回指示指定的文件是否存在的布尔值。如果存在，则返回 Ture，否则返回 False。</p>

<h3>语法：</h3>
<pre>FileSystemObject.FileExists(filename)</pre>
...
if <code>fs.FileExists(&quot;c:\asp\introduction.asp&quot;)</code>=true then
