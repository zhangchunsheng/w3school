...
<p>AddHeader 方法向 HTTP 响应添加一个新的 HTTP 头部和值。</p>

<p class="note"><span>注释：</span>一旦头部被添加，就无法删除。</p>

<p class="note"><span>注释：</span>在 IIS 4.0 中，您调用此方法需要在任何的输出送往浏览器之前。在 IIS 5.0 中，您可以在脚本中的任何点调用 AddHeader 方法，只要它先于对 response.Flush 方法的调用。</p>

<h3>语法</h3>

<pre>response.AddHeader <i>name</i>,<i>value</i></pre>
...
<div>
<h2>实例</h2>
<pre>&lt;%Response.AddHeader &quot;WARNING&quot;,&quot;Error message text&quot;%&gt;</pre>
</div>
