...
<title>ASP DateLastModified 属性</title>
</head>
...
<div>
<h2>定义和用法</h2>
<p>DateLastModified 属性用于返回指定的文件或文件夹最后被修改的日期和时间。</p>

<h3>语法：</h3>
<pre>FileObject.DateLastModified
FolderObject.DateLastModified</pre>
</div>
...
Response.Write(<code>f.DateLastModified</code>)
set f=nothing
set fs=nothing
%&gt;</pre>

<p>输出：</p>
<pre>File last modified on: 8/8/2008 8:8:00 PM</pre>
...
Response.Write(<code>fo.DateLastModified</code>)
set fo=nothing
set fs=nothing
%&gt;</pre>

<p>输出：</p>
<pre>Folder last modified on: 8/8/2008 8:8:00 PM</pre>
</div>
