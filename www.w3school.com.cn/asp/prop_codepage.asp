...
<div>
<h2>定义和用法</h2>
<p>CodePage 属性规定在显示动态内容时所使用的字符集。</p>

<p>例子：</p>
<ul>
  <li>1252 - 美国英语和大多数欧洲语言</li>
  <li>932 - 日本汉字</li>
</ul>
</div>
...
<div>
<h2>语法</h2>
<pre>Session.CodePage(=Codepage)</pre>
