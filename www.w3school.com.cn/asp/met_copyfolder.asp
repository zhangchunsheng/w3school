...
<div>
<h2>定义和用法</h2>
<p>CopyFolder 方法从一个位置向另外一个位置复制一个或多个文件夹。</p>

<h3>语法：</h3>
<pre>FileSystemObject.CopyFolder source,destination[,overwrite]</pre>
...
<table class="dataintable"> 
  ...
  <tr>
    <td>source</td>
    <td>可选的。需拷贝的文件夹（可使用通配符）。</td>
  </tr>
  <tr>
    <td>destination</td>
    <td>必需的。拷贝文件夹的目的地（不可使用通配符）。</td>
  </tr>
  <tr>
    <td>overwrite</td>
    <td>可选的。规定是否可覆盖已有的文件夹。True 允许覆盖已有文件夹，False 可防止已有文件夹被覆盖。默认为 True 。</td>
  </tr>
</table>
</div>
...
<p>把 c:\mydocuments\web 中的所有文件夹拷贝到文件夹 c:\webpages 中：</p>
<pre>&lt;%
dim fs
set fs=Server.CreateObject(&quot;Scripting.FileSystemObject&quot;)
<code>fs.CopyFolder &quot;c:\mydocuments\web\*&quot;,&quot;c:\webpages\&quot;</code>
set fs=nothing
%&gt;</pre>

<p>仅把文件夹 test 从 c:\mydocuments\web 拷贝到文件夹 c:\webpages 中：</p>
<pre>
&lt;%
dim fs
set fs=Server.CreateObject(&quot;Scripting.FileSystemObject&quot;)
<code>fs.CopyFolder &quot;c:\mydocuments\web\test&quot;,&quot;c:\webpages\&quot;</code>
set fs=nothing
%&gt;</pre>
</div>
