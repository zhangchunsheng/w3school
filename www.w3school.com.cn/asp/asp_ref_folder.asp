...
<li class="currentLink"><a href="/asp/asp_ref_folder.asp" title="ASP Folder 对象">ASP Folder</a></li>
...
<div  id="tpn">
<ul class="prenext">
<li class="pre"><a href="/asp/asp_ref_file.asp" title="ASP File 对象">ASP File</a></li>
<li class="next"><a href="/asp/asp_ref_dictionary.asp" title="ASP Dictionary 对象">ASP Dictionary</a></li>
</ul>
</div>
...
<tr>
<td><a href="/asp/coll_files.asp">Files</a></td>
<td>返回指定文件夹中所有文件夹的集合。</td>
</tr>

<tr>
<td><a href="/asp/coll_subfolders.asp">SubFolders</a></td>
...
<tr>
<td><a href="/asp/prop_attributes_folder.asp">Attributes</a></td>
<td>设置或返回指定文件夹的属性。</td>
</tr>

<tr>
<td><a href="/asp/prop_datecreated_folder.asp">DateCreated</a></td>
<td>返回指定文件夹被创建的日期和时间。</td>
</tr>

<tr>
<td><a href="/asp/prop_datelastaccessed_folder.asp">DateLastAccessed</a></td>
<td>返回指定文件夹最后被访问的日期和时间。</td>
</tr>

<tr>
<td><a href="/asp/prop_datelastmodified_folder.asp">DateLastModified</a></td>
<td>返回指定文件夹最后被修改的日期和时间。</td>
</tr>

<tr>
<td><a href="/asp/prop_drive_folder.asp">Drive</a></td>
<td>返回指定文件夹所在的驱动器的驱动器字母。</td>
</tr>

<tr>
<td><a href="/asp/prop_isrootfolder.asp">IsRootFolder</a></td>
<td>假如文件夹是根文件夹，则返回 ture，否则返回 false。</td>
</tr>

<tr>
<td><a href="/asp/prop_name_folder.asp">Name</a></td>
<td>设置或返回指定文件夹的名称。</td>
</tr>

<tr>
<td><a href="/asp/prop_parentfolder_folder.asp">ParentFolder</a></td>
<td>返回指定文件夹的父文件夹。</td>
</tr>

<tr>
<td><a href="/asp/prop_path_folder.asp">Path</a></td>
<td>返回指定文件的路径。</td>
</tr>

<tr>
<td><a href="/asp/prop_shortname_folder.asp">ShortName</a></td>
<td>返回指定文件夹的短名称。（8.3 命名约定）</td>
</tr>

<tr>
<td><a href="/asp/prop_shortpath_folder.asp">ShortPath</a></td>
<td>返回指定文件夹的短路径。（8.3 命名约定）</td>
</tr>

<tr>
<td><a href="/asp/prop_size_folder.asp">Size</a></td>
<td>返回指定文件夹的大小。</td>
</tr>

<tr>
<td><a href="/asp/prop_type_folder.asp">Type</a></td>
<td>返回指定文件夹的类型。</td>
</tr>
</table>
...
<tr>
<td><a href="/asp/met_copy_folder.asp">Copy</a></td>
<td>把指定的文件夹从一个位置拷贝到另一个位置。</td>
</tr>

<tr>
<td><a href="/asp/met_delete_folder.asp">Delete</a></td>
<td>删除指定文件夹。</td>
</tr>

<tr>
<td><a href="/asp/met_move_folder.asp">Move</a></td>
<td>把指定的文件夹从一个位置移动到另一个位置。</td>
</tr>

<tr>
<td><a href="/asp/met_createtextfile_folder.asp">CreateTextFile</a></td>
