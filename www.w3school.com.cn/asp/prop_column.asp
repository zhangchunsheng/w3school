...
<div>
<h2>定义和用法</h2>
<p>Column 属性返回输入流中当前字符位置的列号。</p>
<p class="note"><span>注释：</span>此属性在新行字符 (new line character ) 被写入之后为 1 （在其他字符被写入前）。</p>
...
<p>输出：</p>
<pre>The last character in the text file is: !
at character position: 12</pre>
</div>
