...
<div>
<h2>定义和用法</h2>
<p>ShortPath 属性用于返回指定的文件或文件夹的短路径 (8.3 命名约定)。</p>

<h3>语法：</h3>
<pre>FileObject.ShortPath
FolderObject.ShortPath</pre>
</div>
...
Response.Write(&quot;&lt;br /&gt;ShortPath: &quot; &amp; <code>f.ShortPath</code>)
set f=nothing
set fs=nothing
%&gt;</pre>

<p>输出：</p>
<pre>Path: C:\asp_test_web\hitcounterfile.txt
ShortPath: C:\ASP_TE~1\HITCOU~1.TXT</pre>
</div>
...
Response.Write(&quot;&lt;br /&gt;ShortPath: &quot; &amp; <code>fo.ShortPath</code>)
set fo=nothing
set fs=nothing
%&gt;</pre>

<p>输出：</p>
<pre>Path: C:\asp_test_web
ShortPath: C:\ASP_TE~1</pre>
</div>
