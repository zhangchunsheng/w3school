...
<p>Clear 方法清空任何已缓冲的 HTML 输出。</p>

<p class="note"><span>注释：</span>此方法无法清除响应的头部，只能清空响应的正文。</p>

<p class="note"><span>注释：</span>假如 response.Buffer 为 false，那么此方法会引起一个 run-time 错误。</p>
