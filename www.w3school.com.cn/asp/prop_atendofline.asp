...
<title>ASP AtEndOfLine 属性</title>
</head>
...
<div>
<h2>定义和用法</h2>
<p>AtEndOfLine 属性返回一个布尔值。True 指示文件指针紧靠行末标记之前，否则返回 False 。</p>
<p><span>Note:</span>此属性仅工作于以只读方式打开的 TextStream 对象。</p>

<h3>语法：</h3>
<pre>TextStreamObject.AtEndOfLine</pre>
</div>
...
do while <code>t.AtEndOfLine</code>&lt;&gt;true
  x=t.Read(1)
loop
t.close 
...
<p>输出：</p>
<pre>The last character of the first line in the text file is: !</pre>
</div>
