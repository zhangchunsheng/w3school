...
<div>
<h2>定义和用法</h2>
<p>RemoveAll 方法从一个 Dictionary 对象中删除所有的 key/item 对。</p>

<h3>语法：</h3>
<pre>DictionaryObject.RemoveAll</pre>
</div>
