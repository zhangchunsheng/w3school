...
set d=fs.GetDrive(&quot;a:&quot;)
Response.Write(&quot;The drive type is: &quot; &amp; <code>d.DriveType</code>)
set d=nothing
set fs=nothing
%&gt;</pre>

<p>输出：</p>
<pre>The drive type is: 1</pre>
</div>
