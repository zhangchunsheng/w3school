...
<div>
<h2>定义和用法</h2>
<p>SkipLine 方法在读取 TextStream 文件时跳过一行。</p>

<h3>语法：</h3>
<pre>TextStreamObject.SkipLine</pre>
</div>
...
<p>输出：</p>
<pre>Output after skipping the first line in the file: Line 2
Line 3</pre>
</div>
