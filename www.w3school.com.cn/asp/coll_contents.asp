...
<div>
<p>Contents 集合包含着通过脚本命令添加到 application/session 的所有项目。</p>
<p class="tip"><span>提示：</span>要从 Contents 集合中删除项目，请使用 Remove 和 RemoveAll 方法。</p>
</div>

<div>
<h2>语法</h2>
<pre>Application.Contents(Key)

Session.Contents(Key)</pre>
...
<h3>例子 1</h3>
<p>请注意，name 和 objtest 都会被追加到 Contents 集合中：</p>
<pre>&lt;% 
