...
<title>ASP BinaryWrite 方法</title>
</head>
...
<p>BinaryWrite 方法在不进行字符转换的情况下直接向输出写数据。</p>

<p class="note"><span>注释：</span>此方法可用于从数据库向浏览器写属性数据 (BLOB) 。</p>

<h3>语法</h3>

<pre>response.BinaryWrite <i>data</i></pre>
