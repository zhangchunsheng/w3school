...
<div>
<h2>定义和用法</h2>
<p>OpenTextFile 方法打开指定的文件，并返回可用来访问此文件的 TextStream 对象。</p>

<h3>语法：</h3>
<pre>FileSystemObject.OpenTextFile(fname,mode,create,format)</pre>
...
<table class="dataintable"> 
  ...
  <tr>
	...
	<li>1=ForReading - 打开文件用于读取数据。您无法向此文件写数据。</li>
	<li>2=ForWriting - 打开文件用于写数据。</li>
	<li>8=ForAppending - 打开文件，并向文件的末尾写数据。</li>
	</ul>
</td>
  </tr>
  <tr>
    <td>create</td>
    <td>可选的。设置如果文件名不存在，是否创建新文件。True 指示可创建新文件，而 False 指示新文件不会被创建。False 是默认的。</td>
  </tr>
  <tr>
    <td>format</td>
    <td>可选的。文件的格式。
	<ul class="listintable">
	<li>0=TristateFalse - 以 ASCII 打开文件。默认。</li>
	<li>-1=TristateTrue - 以 Unicode 打开文件。</li>
...
set f=<code>fs.OpenTextFile(Server.MapPath(&quot;testread.txt&quot;),8,true)</code>
