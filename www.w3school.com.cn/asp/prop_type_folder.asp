...
<div>
<h2>定义和用法</h2>
<p>Type 属性用于返回指定的文件或文件夹的类型。</p>

<h3>语法：</h3>
<pre>FileObject.Type
FolderObject.Type</pre>
</div>
...
Response.Write(<code>f.Type</code>)
set f=nothing
set fs=nothing
%&gt;</pre>

<p>输出：</p>
<pre>The file test.txt is of type: Text Document</pre>
...
<p>输出：</p>
<pre>The file test.asp is of type: Active Server Document</pre>
</div>
...
Response.Write(<code>fo.Type</code>)
set fo=nothing
set fs=nothing
%&gt;</pre>

<p>输出：</p>
<pre>The folder test is of type: File Folder</pre>
</div>
