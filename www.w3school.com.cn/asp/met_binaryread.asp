...
<div>
<p>BinaryRead 方法用于获取作为 POST 请求的部分从客户机发送到服务器的数据。 </p>
<p class="note"><span>注释：</span>请在调用 BinaryRead 之后调用 Request.Form ，否则会引起错误。</p>
</div>

<div>
<h2>语法</h2>
<pre>Request.BinaryRead(count)</pre>
...
<div>
<h2>实例</h2>
<p>下面的例子使用 BinaryRead 方法把一个请求的内容放入了一个安全的数组：</p>
<pre>&lt;%
dim a,b
