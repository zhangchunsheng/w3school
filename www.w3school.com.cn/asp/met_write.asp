...
<p>Write 方法向 TextStream 文件写入指定的文本。</p>

<p class="note"><span>注释：</span>此方法向 TextStream 文件写入的文本在每个字符串之间不带有空格或折行。</p>

<h3>语法</h3>

<pre>TextStreamObject.Write(<i>text</i>)</pre>
...
<code>f.write(&quot;Hello World!&quot;)</code>
<code>f.write(&quot;How are you today?&quot;)</code>
f.close
set f=nothing
set fs=nothing
%&gt;</pre>
...
<pre>Hello World!How are you today?</pre>
</div>
