...
<meta name="description" content="W3school的ASP教程首页" />
...
<ul>
<li class="currentLink"><a href="/asp/index.asp" title="ASP 教程">ASP 教程</a></li>
...
<li class="next"><a href="/asp/asp_intro.asp" title="ASP 简介">ASP 简介</a></li>
</ul>
</div>


<div>
<p><strong>在我们的 ASP 教程中，您将学到 ASP 的相关知识，以及如何在服务器端执行脚本。</strong></p>
<p><strong>您会发现，ASP 是一种生成动态交互性网页的强有力工具。</strong></p>
<p><a href="/asp/asp_intro.asp" title="ASP 简介">开始学习 ASP</a> ！</p>
</div>
...
<p>在 W3School，我们为您提供完整的 ASP 参考手册，其中包括内建对象和组件，以及它们的属性和方法。</p>
<p><a href="/asp/asp_ref.asp">ASP 参考手册</a></p>
</div>
...
<p>通过实例来学习！</p>
<p>ASP 脚本只能在服务器端执行，所以无法在浏览器中查看 ASP 代码，只能看到由 ASP 输出的纯粹 HTML 代码。</p>
<p>在 W3School，每个实例均可显示出以往被隐藏的 ASP 代码。这样，您就可以更容易地理解它们的工作原理。</p>
<p><a href="/example/aspe_examples.asp" title="ASP 实例">ASP 实例</a></p>
</div>
...
<p>在 W3School 测试你的 ASP 技能!</p>
<p><a href="/asp/asp_quiz.asp" title="ASP 测验">开始 ASP 测验</a>！</p>
</div>
