...
<div>
<h2>定义和用法</h2>
<p>ParentFolder 属性用于为指定的文件或文件夹的父文件夹返回 folder 对象。</p>

<h3>语法：</h3>
<pre>FileObject.ParentFolder
FolderObject.ParentFolder</pre>
</div>
...
<p>输出：</p>
<pre>The file test.asp is in the folder: D:\asp\test</pre>
</div>
...
<p>输出：</p>
<pre>The folder test is in the folder: D:\asp</pre>
</div>
