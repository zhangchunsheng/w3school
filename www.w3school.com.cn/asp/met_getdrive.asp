...
<div>
<h2>定义和用法</h2>
<p>GetDrive 方法可返回由 drivespec 参数规定的 Drive 对象。</p>

<h3>语法：</h3>
<pre>FileSystemObject.GetDrive(drivespec)</pre>
...
<table class="dataintable"> 
  ...
  <tr>
    <td>drivespec</td>
    <td>必需的。可以是驱动器字母 (c)，或者带有冒号的驱动器字母，或者带有冒号和路径分隔符的驱动器字母，或者任何网络共享规范 (\\computer2\share1)。</td>
  </tr>
</table>
</div>
