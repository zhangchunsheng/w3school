...
<div>
<h2>定义和用法</h2>
<p>IsReady 属性返回指定驱动器是否就绪。就绪为 true，未就绪为 false。</p>
<p class="note"><span>注释：</span>对于可移动媒体驱动器和 CD-ROM 驱动器，仅当插入相应的媒体并准备接受访问时，IsReady 返回 True。</p>

<h3>语法：</h3>
<pre>DriveObject.IsReady</pre>
</div>
...
set d=fs.GetDrive(&quot;a:&quot;)
n = &quot;The &quot; &amp; d.DriveLetter
if <code>d.IsReady</code>=true then
  n=n &amp; &quot; drive is ready!&quot;
else
...
<p>输出：</p>
<pre>The A drive is not ready!</pre>
</div>
