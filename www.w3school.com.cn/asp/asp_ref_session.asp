...
<li class="currentLink"><a href="/asp/asp_ref_session.asp" title="ASP Session 对象">ASP Session</a></li>
...
<div  id="tpn">
<ul class="prenext">
<li class="pre"><a href="/asp/asp_ref_application.asp" title="ASP Application 对象">ASP Application</a></li>
<li class="next"><a href="/asp/asp_ref_server.asp" title="ASP Server 对象">ASP Server</a></li>
</ul>
</div>
...
<tr>
<td><a href="/asp/coll_contents.asp">Contents</a></td>
<td>包含所有通过脚本命令追加到 session 的条目。</td>
</tr>

<tr>
<td><a href="/asp/coll_staticobjects.asp">StaticObjects</a></td>
...
<tr>
<td><a href="/asp/prop_codepage.asp">CodePage</a></td>
<td>规定显示动态内容时使用的字符集</td>
</tr>

<tr>
<td><a href="/asp/prop_lcid.asp">LCID</a></td>
<td>设置或返回指定位置或者地区的一个整数。诸如日期、时间以及货币的内容会根据位置或者地区来显示。</td>
</tr>

<tr>
<td><a href="/asp/prop_sessionid.asp">SessionID</a></td>
<td>为每个用户返回一个唯一的 id。此 id 由服务器生成。</td>
</tr>

<tr>
<td><a href="/asp/prop_timeout.asp">Timeout</a></td>
...
<tr>
<td><a href="/asp/met_abandon.asp">Abandon</a></td>
<td>撤销一个用户的 session。</td>
</tr>

<tr>
<td><a href="/asp/met_contents_remove.asp">Contents.Remove</a></td>
<td>从 Contents 集合删除一个项目。</td>
</tr>

<tr>
<td><a href="/asp/met_contents_removeall.asp">Contents.RemoveAll()</a></td>
...
<tr>
<td><a href="/asp/ev_sess_onend_onstart.asp">Session_OnEnd</a></td>
<td>当一个会话结束时此事件发生。</td>
</tr>

<tr>
<td><a href="/asp/ev_sess_onend_onstart.asp">Session_OnStart</a></td>
<td>当一个会话开始时此事件发生。</td>
</tr>
</table>
</div>
