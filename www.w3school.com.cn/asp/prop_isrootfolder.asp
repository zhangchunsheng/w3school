...
<title>ASP IsRootFolder 属性</title>
</head>
...
<div>
<h2>定义和用法</h2>
<p>IsRootFolder 属性返回指定的文件夹是否为根文件夹。如果是，返回 True；否则返回 False。</p>

<h3>语法：</h3>
<pre>FolderObject.IsRootFolder</pre>
</div>
...
if <code>fo.IsRootFolder</code>=true then
...
<p>输出：</p>
<pre>The folder is not the root folder!</pre>
</div>
