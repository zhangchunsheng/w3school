...
<meta name="keywords" content="ASP ASPError Object" />
<meta name="description" content="ASPError对象的作用，以及相关的属性" />
...
<li class="currentLink"><a href="/asp/asp_ref_error.asp" title="ASP ASPError 对象">ASP Error</a></li>
...
<h1>ASP ASPError 对象</h1>

<div  id="tpn">
<ul class="prenext">
<li class="pre"><a href="/asp/asp_ref_server.asp" title="ASP Server 对象">ASP Server</a></li>
<li class="next"><a href="/asp/asp_ref_filesystem.asp" title="ASP FileSystemObject 对象">ASP FileSystem</a></li>
</ul>
</div>

<div id="intro">
<p><strong>ASPError 对象用于显示在 ASP 文件的脚本中发生的任何错误的详细信息。</strong></p>
</div>

<div>
<h2>ASP ASPError 对象</h2>
<p>ASP 3.0 提供这个对象，且在 IIS5 及更高版本中可用。</p>
<p>ASPError 对象用于显示在 ASP 文件的脚本中发生的任何错误的详细信息。当 Server.GetLastError 被调用时，ASPError 对象就会被创建，因此只能通过使用 Server.GetLastError 方法来访问错误信息。</p>
<p>ASPError 对象的属性描述如下（所有属性都是可读的）：</p>
<p class="note"><span>注释：</span>下面的属性只能 <a href="/asp/met_getlasterror.asp" title="ASP GetLastError() 方法 (ASP 3.0)">Server.GetLastError()</a> 方法来访问。</p>
...
<tr>
<td><a href="/asp/prop_asperrorobject.asp">ASPCode</a></td>
<td>返回由 IIS 生成的错误代码。</td>
</tr>

<tr>
<td><a href="/asp/prop_asperrorobject.asp">ASPDescription</a></td>
<td>返回有关错误的详细信息。（假如错误和 ASP 相关。）</td>
</tr>

<tr>
<td><a href="/asp/prop_asperrorobject.asp">Category</a></td>
<td>返回错误来源。(是由 ASP、脚本语言还是对象引起的？）</td>
</tr>

<tr>
<td><a href="/asp/prop_asperrorobject.asp">Column</a></td>
<td>返回在出错文件中的列位置。</td>
</tr>

<tr>
<td><a href="/asp/prop_asperrorobject.asp">Description</a></td>
<td>返回关于错误的简短描述。</td>
</tr>

<tr>
<td><a href="/asp/prop_asperrorobject.asp">File</a></td>
<td>返回出错 ASP 文件的文件名。</td>
</tr>

<tr>
<td><a href="/asp/prop_asperrorobject.asp">Line</a></td>
<td>返回错误所在的行数。</td>
</tr>

<tr>
<td><a href="/asp/prop_asperrorobject.asp">Number</a></td>
<td>返回关于错误的标准 COM 错误代码。</td>
</tr>

<tr>
<td><a href="/asp/prop_asperrorobject.asp">Source</a></td>
<td>返回错误所在行的实际的源代码</td>
</tr>
</table>
</div>
