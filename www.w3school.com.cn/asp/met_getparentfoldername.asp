...
<title>ASP GetParentFolderName 方法</title>
</head>
...
<h1>ASP GetParentFolderName 方法</h1>
...
<div>
<h2>定义和用法</h2>
<p>GetParentFolderName 方法返回指定的路径中最后成分的父文件夹的名称。</p>

<h3>语法：</h3>
<pre>FileSystemObject.GetParentFolderName(path)</pre>
...
p=<code>fs.GetParentFolderName(&quot;c:\winnt\cursors\3dgarro.cur&quot;)</code>
Response.Write(p)
set fs=nothing
%&gt;</pre>

<p>输出：</p>
<pre>c:\winnt\cursors</pre>
</div>
