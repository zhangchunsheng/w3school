...
<div>
<h2>定义和用法</h2>
<p>Item 属性设置或返回 Dictionary 对象中某个项目的值。</p>

<h3>语法：</h3>
<pre>DictionaryObject.Item(key)[=newitem]</pre>
...
<table class="dataintable"> 
  ...
  <tr>
    <td>key</td>
    <td>必需的。与 item 相关联的 key。</td>
  </tr>
  <tr>
    <td>newitem</td>
    <td>可选的。规定与 key 相关联的值。</td>
  </tr>
</table>
</div>
...
d.Add &quot;bl&quot;,&quot;Blue&quot;
d.Add &quot;pi&quot;,&quot;Pink&quot;
Response.Write(&quot;The value of key bl is: &quot; &amp; <code>d.Item(&quot;bl&quot;)</code>)
%&gt;</pre>
