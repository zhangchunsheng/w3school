...
<div>
<p>Charset 属性向 Response 对象中 content-type 头部追加字符集名称。</p>

<p class="note"><span>注释：</span>此属性可接受任何字符串，不论是否为合法的字符集名称。</p>

<h3>语法：</h3>
      <pre>response.Charset(charsetname)</pre>
...
<div>
<h2>实例</h2>
<p>如果 ASP 页面没有设置 Charset 属性，那么 content-type 头部会是这样的：</p>
<pre>content-type:text/html</pre>

<p>如果我们使用了 Charset 属性：</p>
<pre>&lt;%response.Charset=&quot;ISO-8859-1&quot;%&gt;</pre>

<p>content-type 头部会是这样的：</p>
