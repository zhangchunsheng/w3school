...
<div>
<h2>定义和用法</h2>
<p>ShareName 属性返回指定驱动器的网络共享名称。</p>
<p class="note"><span>注释：</span>如果对象不是一个网络驱动器，则 ShareName 属性返回零长度字符串 (&quot;&quot;)。</p>

<h3>语法：</h3>
<pre>DriveObject.ShareName</pre>
</div>
...
set d=fs.GetDrive(&quot;c:&quot;)
Response.Write(&quot;The sharename is: &quot; &amp; <code>d.ShareName</code>)
set d=nothing
set fs=nothing
%&gt;</pre>
</div>
