...
<div>
<h2>定义和用法</h2>
<p>TotalBytes 属性是一个只读的属性，可返回在客户端发送的请求正文中的字节总数。</p>
</div>

<div>
<h2>语法</h2>
<pre>varbytes=Request.Totalbytes</pre>
</div>

<div>
<h2>Example</h2>
<p>下面的代码把一个变量设置为请求正文发送的字节总数：</p>
<pre>
&lt;%
dim a
