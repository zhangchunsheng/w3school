...
<div>
<h2>定义和用法</h2>
<p>Execute 方法从另外一个 ASP 文件中执行 ASP 文件。在被调用的 .asp 文件执行完毕后，控制权会返回原始的 .asp 文件。</p>
</div>

<div>
<h2>语法</h2>
<pre>Server.Execute(path) </pre>
...
<code>Server.Execute(&quot;file2.asp&quot;)</code>
...
<pre>I am in File 1!
I am in File 2!
I am back in File 1!</pre>

<p>请参阅 <a href="/asp/met_transfer.asp" title="ASP Transfer 方法">Server.Transfer</a> 方法，了解一下 Server.Execute 与 Server.Transfer 方法的区别。</p>
</div>
