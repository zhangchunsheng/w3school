...
<p><a href="asp_ref_drive.asp" title="ASP Drive 对象">Drive 对象参考手册</a></p>
</div>

<div>
<h2>定义和用法</h2>
<p>Path 属性用于返回指定驱动器、文件或文件夹的路径。</p>
...
%&gt;</pre>
<p>输出：</p>
<pre>The path is: C:\asp\test\test.asp</pre>
</div>
