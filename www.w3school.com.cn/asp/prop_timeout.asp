...
<div>
<h2>定义和用法</h2>
<p>Timeout 属性按分钟设置或返回应用程序的 Session 对象的超时周期。如果用户在此超时周期内没有刷新或请求页面，会话就会被终止。</p>
</div>

<div>
<h2>语法</h2>
<pre>Session.Timeout[=nMinutes]</pre>
...
<table class="dataintable"> 
  ...
  <tr>
    <td>nMinutes </td>
    <td>session 在服务器终止它之前可保持空闲的分钟值。默认是 20 分钟。</td>
  </tr>
</table>
</div>
...
<p>输出：</p>
<pre>Default Timeout is: 20
Timeout is now: 30</pre>
</div>
