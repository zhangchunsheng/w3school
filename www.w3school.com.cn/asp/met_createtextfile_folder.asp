...
<p><a href="asp_ref_folder.asp" title="ASP Folder 对象">Folder 对象参考手册</a></p>
</div>

<div>
<h2>定义和用法</h2>
<p>CreateTextFile 方法在当前文件夹创建一个新的文本文件，并返回供读写此文件的一个 TextStream 对象。</p>
...
<table class="dataintable"> 
  ...
  <tr>
    <td>filename</td>
    <td>必需的。需要创建的文件的名称。</td>
  </tr>
  <tr>
    <td>overwrite </td>
    <td>可选的。指示是否可覆盖已有文件的布尔值。True 表示可覆盖此文件，而 False 表示不可覆盖此文件。默认是 True。</td>
  </tr>
  <tr>
    <td>unicode </td>
...
set tfile=<code>fs.CreateTextFile(&quot;d:\somefile.txt&quot;)</code>
...
<div>
<h3>针对 Folder 对象的例子</h3>
<pre>&lt;%
dim fs,fo,tfile
Set fs=Server.CreateObject(&quot;Scripting.FileSystemObject&quot;) 
Set fo=fs.GetFolder(&quot;d:\test&quot;) 
Set tfile=<code>fo.CreateTextFile(&quot;somefile.txt&quot;,false)</code>
tfile.WriteLine(&quot;Hello World!&quot;)
tfile.Close
set tfile=nothing
set fo=nothing
