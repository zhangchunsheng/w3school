...
<title>ASP DriveExists 方法</title>
</head>
...
<div>
<h2>定义和用法</h2>
<p>DriveExists 方法返回指示指定的驱动器是否存在的布尔值。如果驱动器存在则返回 True ，否则，返回 False。</p>

<h3>语法：</h3>
<pre>FileSystemObject.DriveExists(drive)</pre>
...
if <code>fs.DriveExists(&quot;c:&quot;)</code>=true then
