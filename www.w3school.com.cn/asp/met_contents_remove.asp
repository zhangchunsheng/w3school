...
<title>ASP Contents.Remove 方法</title>
</head>
...
<div>
<p>Contents.Remove 方法从 Contents 集合中删除一个项目。 </p>
</div>

<div>
<h2>语法</h2>
<pre>Application.Contents.Remove(name|index)

Session.Contents.Remove(name|index)</pre>
...
<p>输出：</p>
<pre>test1=First test
test3=Third test</pre>
