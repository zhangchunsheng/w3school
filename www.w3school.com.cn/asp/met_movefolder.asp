...
<div>
<h2>定义和用法</h2>
<p>MoveFolder 方法从一个位置向另一个位置移动一个或多个文件夹。</p>

<h3>语法：</h3>
<pre>FileSystemObject.MoveFolder source,destination</pre>
...
<table class="dataintable"> 
  ...
  <tr>
    <td>source</td>
    <td>必需的。指向需被移动的文件夹的路径。可在最后的成分中包含通配符。</td>
  </tr>
  <tr>
    <td>destination</td>
    <td>必需的。移动文件夹的目的地。不能包含通配符。</td>
  </tr>
</table>
</div>
...
<code>fs.MoveFolder &quot;c:\test\web\&quot;,&quot;c:\windows\&quot;</code>
set fs=nothing
%&gt;</pre>
</div>
