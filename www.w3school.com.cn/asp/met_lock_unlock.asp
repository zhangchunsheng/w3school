...
<title>ASP Lock 和 Unlock 方法</title>
</head>
...
<h3>Lock 方法</h3>
<p>Lock 方法阻止其他用户修改 Application 对象中的变量 (用来确保同一时间只有一位用户可修改 Application 变量)。</p>

<h3>Unlock 方法</h3>
<p>Unlock 方法使其他用户能够修改存储在 Application 对象中的变量 (在它被使用 Lock 方法锁定之后)。</p>
</div>
...
<div>
<h2>实例</h2>
<p>下面的例子用 Lock 方法来防止一个以上的用户在同一时间访问变量 visits，用 Unlock 方法来对已锁定的对象进行解锁，这样下一个用户就可以增加变量 visits 的值：</p>

<pre>&lt;%
<code>Application.Lock</code>
Application(&quot;visits&quot;)=Application(&quot;visits&quot;)+1
<code>Application.Unlock</code>
%&gt;

This page has been visited
&lt;%=Application(&quot;visits&quot;)%&gt; times!</pre>
</div>
