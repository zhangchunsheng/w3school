...
<title>ASP ExpiresAbsolute 属性</title>
</head>
...
<div>
<p>ExpiresAbsolute 属性设置缓存页面在浏览器上的失效日期和时间。如果用户在此日期 / 时间之前返回同一张页面，那么会显示出缓存的版本。</p>

<h3>语法：</h3>
<pre>response.ExpiresAbsolute[=[date][time]]</pre>
...
<table class="dataintable"> 
  ...
  <tr>
    ...
    <td>
	<p>规定页面的失效日期。</p>
    <p>如果不规定此参数，那么页面会在脚本运行当日的指定时间失效。</p>
    </td>
  </tr>
  <tr>
    <td>time </td>
...
<div>
<h2>实例</h2>
<p>下面的代码指示，页面会在 2003 年 10 月 11 月 4:00 PM 失效：</p>
<pre>&lt;%response.ExpiresAbsolute=#October 11,2003 16:00:00#%&gt;</pre>
</div>
