...
<title>ASP CreateFolder 方法</title>
</head>
...
<div>
<h2>定义和用法</h2>
<p>CreateFolder 方法创建一个新文件夹。</p>

<h3>语法：</h3>
<pre>FileSystemObject.CreateFolder(name)</pre>
...
<code>set f=fs.CreateFolder(&quot;c:\asp&quot;)</code>
set f=nothing
set fs=nothing
%&gt;</pre>
</div>
