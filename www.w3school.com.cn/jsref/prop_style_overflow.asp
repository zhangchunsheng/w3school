...
<title>HTML DOM overflow 属性</title>
...
<div>
<h2>定义和用法</h2>
<p>overflow 属性规定如何处理如何处理不符合元素框的内容。</p>

<h3>语法：</h3>
<pre>Object.style.overflow=visible|hidden|scroll|auto</pre>
...
<table class="dataintable">
	...
	<tr>
		<td>visible</td>
		<td>内容不会被修剪，会呈现在元素框之外。</td>
	</tr>
	<tr>
		<td>hidden</td>
		<td>内容会被修剪，但是浏览器不会显示供查看内容的滚动条。</td>
	</tr>
	<tr>
		<td>scroll</td>
...
{
<code>document.getElementById(&quot;div1&quot;).style.overflow=&quot;hidden&quot;;</code>
}
&lt;/script&gt;
&lt;/head&gt;
&lt;body&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_style_overflow">overflow - 隐藏内容溢出</a></dt>
</dl>
</div>
