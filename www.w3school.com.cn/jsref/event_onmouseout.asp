...
<div>
<h2>定义和用法</h2>
<p>onmouseout 事件会在鼠标指针移出指定的对象时发生。</p>

<h3>语法</h3>
<pre>onmouseout=&quot;SomeJavaScriptCode&quot;</pre>
...
<div>
<h2>实例 1</h2>
<p>在下面的例子中，我们将在鼠标指针移出图像时显示一个对话框：</p>
<pre>&lt;img src=&quot;/i/example_mouse2.jpg&quot; alt=&quot;mouse&quot;
<code>onmousemove=&quot;alert('您的鼠标刚才离开了图片！')&quot;</code> /&gt;</pre>

<h3>输出：(请把鼠标从图片上移开):</h3>
<img alt="Visit W3School!" src="/i/eg_mouse2.jpg" onmouseout="alert('您的鼠标刚才离开了图片！')" />
</div>

<div>
<h2>实例 2</h2>
<p>下面的例子中，我们将在网页上添加一个用作连接按钮的图像，然后我们会添加 onMouseOver 和 onMouseOut 事件，这样就可以在运行两个 JavaScript 函数来切换两幅图像：</p>
<pre>&lt;html&gt;
&lt;head&gt;
&lt;script type=&quot;text/javascript&quot;&gt;
function mouseOver()
...
<code>onmouseover=&quot;mouseOver()&quot; onmouseout=&quot;mouseOut()&quot;</code>&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_onmouseout">onmouseout</a></dt>
<dd>如何使用 onmouseout。</dd>
</dl>
</div>
