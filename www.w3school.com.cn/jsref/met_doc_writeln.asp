...
<title>HTML DOM writeln() 方法</title>
...
<div>
<h2>定义和用法</h2>
<p>writeln() 方法与 write() 方法作用相同，外加可在每个表达式后写一个换行符。</p>
...
<div>
<h2>提示和注释</h2>
<p class="tip"><span>提示：</span>在编写 &lt;pre&gt; 标记的内容时，该方法很有用。</p>
</div>
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_text">使用 document.write() 向输出流写文本</a></dt>
<dt><a href="/tiy/t.asp?f=hdom_formattext">使用 document.write() 向输出流写 HTML</a></dt>
<dt><a href="/tiy/t.asp?f=hdom_text2">使用多参数的 document.write()</a></dt>
</dl>
</div>
