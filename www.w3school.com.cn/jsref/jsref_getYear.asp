...
<title>JavaScript getYear() 方法</title>
...
<p>getYear() 方法可返回表示年份的两位或四位的数字。</p>

<h3>语法</h3>

<pre>dateObject.getYear()</pre>
...
<p class="note"><span>注释：</span>由 getYear() 返回的值不总是 4 位的数字！对于介于 1900 与 1999 之间的年份，getYear() 方法仅返回两位数字。对于 1900 之前或 1999 之后的年份，则返回 4 位数字！</p>

<p class="note"><span>注释：</span>该方法总是结合一个 Date 对象来使用。</p>

<p class="important"><span>重要事项：</span>从 ECMAScript v3 开始，JavaScript 的实现就不再使用该方法，而使用 getFullYear() 方法取而代之！</p>
</div>
...
<dl>
<dt><a href="/tiy/t.asp?f=jseg_getyear">getYear()</a></dt>
<dd>如何使用 getYear() 来取得当前的年份。</dd>
</dl>
</div>
