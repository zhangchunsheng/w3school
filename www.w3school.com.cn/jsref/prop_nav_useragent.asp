...
<title>HTML DOM userAgent 属性</title>
...
<p class="note"><span>注：</span>用户代理头：user-agent header。</p>
...
document.write(<code>navigator.userAgent</code> + &quot;&lt;/p&gt;&quot;)
&lt;/script&gt;
&lt;/body&gt;
