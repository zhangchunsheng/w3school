...
<title>JavaScript decodeURIComponent() 函数</title>
...
<h1>JavaScript decodeURIComponent() 函数</h1>
...
<pre>decodeURIComponent(URIstring)</pre>
...
<table class="dataintable"> 
  ...
  <tr>
    <td>URIstring</td>
    <td>必需。一个字符串，含有编码 URI 组件或其他要解码的文本。</td>
  </tr>
</table>

<h3>返回值</h3>

<p>URIstring 的副本，其中的十六进制转义序列将被它们表示的字符替换。</p>
</div>
...
<p>在本例中，我们将使用 decodeURIComponent() 对编码后的 URI 进行解码：</p>

<pre>&lt;script type=&quot;text/javascript&quot;&gt;

var test1=&quot;http://www.w3school.com.cn/My first/&quot;

document.write(<code>encodeURIComponent(test1)</code>+ &quot;&lt;br /&gt;&quot;)
document.write(<code>decodeURIComponent(test1)</code>)
...
<dl>
<dt><a href="/tiy/t.asp?f=jseg_decodeURIComponent">decodeURIComponent()</a></dt>
<dd>如何使用 decodeURIComponent() 对编码后的 URI 进行解码。</dd>
</dl>
</div>
