...
<title>HTML DOM marginHeight 属性</title>
...
<h1>HTML DOM marginHeight 属性</h1>
...
<div>
<h2>定义和用法</h2>
<p>marginHeight 属性可设置或返回框架的顶部和底部页空白（以像素为单位）。</p>

<h3>语法</h3>
<pre>frameObject.marginHeight=pixels</pre>
</div>
...
<p>HTML 文档 &quot;frame_marginheight.htm&quot; 被放入第一列，而 HTML 文档 &quot;frame_a.htm&quot; 被放入第二列。</p>
<p>下面是 &quot;frame_marginheight.htm&quot; 的源代码：</p>
...
document.write(<code>x.marginHeight</code>);
document.write(&quot;&lt;br /&gt;Top/Bottom margins for rightFrame: &quot;);
document.write(<code>y.marginHeight</code>);
&lt;/script&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_frame_marginheight">返回框架的顶部和底部页空白</a></dt>
</dl>
</div>
