...
<title>HTML DOM bottom 属性</title>
...
<div>
<h2>定义和用法</h2>
<p>bottom 属性设置定位元素下外边距边界与其包含块下边界之间的偏移。</p>

<h3>语法：</h3>
<pre>Object.style.bottom=auto|%|length</pre>
...
<tr>
<td>auto</td>
<td>默认。通过浏览器计算底部的位置。</td>
</tr>

<tr>
<td>%</td>
<td>设置元素的底边到最近一个具有定位设置父元素的底部边缘的百分比位置。</td>
</tr>

<tr>
<td>length</td>
<td>使用 px、cm 等单位设置元素的底边到最近一个具有定位设置父元素的底部边缘的位置。可使用负值。</td>
</tr>
</table>
</div>
...
<div>
<h2>提示和注释</h2>
<p class="note"><span>Note:</span>如果 &quot;position&quot; 属性的值为 &quot;static&quot;，那么设置 &quot;bottom&quot; 属性不会产生任何效果。</p>
</div>
...
{
<code>document.getElementById(&quot;b1&quot;).style.bottom=&quot;100px&quot;;</code>
}
&lt;/script&gt;
&lt;/head&gt;
&lt;body&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_style_bottom">bottom - 对元素的下边进行设置</a></dt>
</dl>
</div>
