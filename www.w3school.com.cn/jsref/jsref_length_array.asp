...
<title>JavaScript length 属性</title>
...
<p>数组的 length 属性在用构造函数 Array() 创建数组时被初始化。给数组添加新元素时，如果必要，将更新 length 的值。</p>
...
<p>在本例中，我们将展示如何使用 length 属性返回并设置数组的长度：</p>
...
document.write(&quot;Original length: &quot; + <code>arr.length</code>)
document.write(&quot;&lt;br /&gt;&quot;)

arr.length=5
document.write(&quot;New length: &quot; + <code>arr.length</code>)
...
<dl>
<dt><a href="/tiy/t.asp?f=jseg_length_array">length</a></dt>
<dd>在本例中，我们将展示如何使用 length 属性。</dd>
</dl>
</div>
