...
<title>HTML DOM Hidden 对象</title>
...
<li class="currentLink"><a href="/jsref/dom_obj_hidden.asp" title="HTML DOM Hidden 对象">&lt;input&gt; hidden</a></li>
...
<h1>HTML DOM Hidden 对象</h1>


<div>
<h2>Hidden 对象</h2>

<p>Hidden 对象代表一个 HTML 表单中的某个隐藏输入域。</p>

<p>这种类型的输入元素实际上是隐藏的。这个不可见的表单元素的 value 属性保存了一个要提交给 Web 服务器的任意字符串。如果想要提交并非用户直接输入的数据的话，就是用这种类型的元素。</p>

<p>在 HTML 表单中 &lt;input type=&quot;hidden&quot;&gt; 标签每出现一次，一个 Hidden 对象就会被创建。</p>

<p>您可通过遍历表单的 elements[] 数组来访问某个隐藏输入域，或者通过使用document.getElementById()。</p>
</div>
...
<table class="dataintable">
  ...
  <tr>
    <td><a href="/jsref/prop_hidden_alt.asp">alt</a></td>
    <td>设置或返回当不支持隐藏输入域时显示的替代文本。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_hidden_form.asp">form</a></td>
    <td>返回一个对包含隐藏域的表单的引用。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_hidden_id.asp">id</a></td>
    <td>设置或返回隐藏域的 id。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_hidden_name.asp">name</a></td>
    <td>设置或返回隐藏域的名称。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_hidden_type.asp">type</a></td>
    <td>返回隐藏输入域的表单类型。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_hidden_value.asp">value</a></td>
    <td>设置或返回隐藏域的 value 属性的值。</td>
  </tr>
</table>
</div>
