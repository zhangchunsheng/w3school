...
<title>HTML DOM systemLanguage 属性</title>
...
<h1>HTML DOM systemLanguage 属性</h1>
...
<div>
<h2>定义和用法</h2>
<p>systemLanguage 属性可返回操作系统使用的默认语言。</p>

<h3>语法</h3>
<pre>navigator.systemLanguage</pre>
</div>
...
document.write(<code>navigator.systemLanguage</code> + &quot;&lt;/p&gt;&quot;)
&lt;/script&gt;
&lt;/body&gt;
