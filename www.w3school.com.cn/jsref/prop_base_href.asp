...
<p><a href="/jsref/dom_obj_base.asp">HTML DOM Base 对象</a></p>
</div>

<div>
<h2>定义和用法</h2>
<p>href 属性可设置或返回页面中所有链接的基准 URL。</p>

<h3>语法</h3>
<pre>baseObject.href=URL</pre>
</div>
...
document.write(<code>x.href</code>);
&lt;/script&gt;
&lt;/p&gt;
...
<p>输出：</p>
<pre>Base URL: http://www.w3school.com.cn/htmldom/ </pre>
</div>

<div class="example">
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_base_href">取得 HTML 文档的基准 URL</a></dt>
</dl>
</div>
