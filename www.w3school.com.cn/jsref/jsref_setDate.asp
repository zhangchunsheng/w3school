...
<title>JavaScript setDate() 方法</title>
...
<pre>dateObject.setDate(day)</pre>
...
<p>在本例中，我们将通过 setDate() 方法把当前月的天设置为 15：</p>
...
<dl>
<dt><a href="/tiy/t.asp?f=jseg_setdate">setDate()</a></dt>
<dd>如何使用 setDate() 来设置当前月的某一天。</dd>
</dl>
</div>
