...
<div>
<h2>定义和用法</h2>
<p>name 属性可设置或返回存放窗口的名称的一个字符串。</p>
<p>该名称是在 open() 方法创建窗口时指定的或者使用一个 &lt;frame&gt; 标记的 name 属性指定的。</p>
<p>窗口的名称可以用作一个 &lt;a&gt; 或者 &lt;form&gt; 标记的 target 属性的值。以这种方式使用 target 属性声明了超链接文档或表单提交结果应该显示于指定的窗口或框架中。</p>
	
<h3>语法</h3>
<pre>window.name=<span>name</span></pre>
</div>
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_win_name">返回新窗口的名称</a></dt>
</dl>
</div>
