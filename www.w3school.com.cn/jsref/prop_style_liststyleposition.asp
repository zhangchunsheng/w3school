...
<title>HTML DOM listStylePosition 属性</title>
...
<h1>HTML DOM listStylePosition 属性</h1>
...
<div>
<h2>定义和用法</h2>
<p>listStylePosition 属性对列表中的列表项标记进行定位。</p>

<h3>语法：</h3>
<pre>Object.style.listStylePosition=inside|outside</pre>
...
<table class="dataintable">
	...
	<tr>
		<td>outside</td>
		<td>默认。保持标记位于文本的左侧。列表项目标记放置在文本以外，且环绕文本不根据标记对齐。</td>
	</tr>
</table>
</div>
...
function changeList()
{
<code>document.getElementById(&quot;ul1&quot;).style.listStylePosition=&quot;inside&quot;;</code>
}
&lt;/script&gt;
&lt;/head&gt;
&lt;body&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_style_liststyleposition">listStylePosition - 改变列表项标志的位置</a></dt>
</dl>
</div>
