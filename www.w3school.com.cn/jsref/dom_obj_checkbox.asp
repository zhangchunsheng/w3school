...
<title>HTML DOM Checkbox 对象</title>
...
<li class="currentLink"><a href="/jsref/dom_obj_checkbox.asp" title="HTML DOM Checkbox 对象">&lt;input&gt; checkbox</a></li>
...
<h1>HTML DOM Checkbox 对象</h1>


<div>
<h2>Checkbox 对象</h2>

<p>Checkbox 对象代表一个 HTML 表单中的 一个选择框。</p>

<p>在 HTML 文档中 &lt;input type=&quot;checkbox&quot;&gt; 每出现一次，Checkbox 对象就会被创建。</p>

<p>您可以通过遍历表单的 elements[] 数组来访问某个选择框，或者通过使用 document.getElementById() 。</p>
</div>


<div>
<h2>Checkbox 对象的属性</h2>
...
<table class="dataintable">
  ...
  <tr>
    <td><a href="/jsref/prop_checkbox_accesskey.asp">accessKey</a></td>
    <td>设置或返回访问 checkbox 的快捷键。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_checkbox_alt.asp">alt</a></td>
    <td>设置或返回不支持 checkbox 时显示的替代文本。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_checkbox_checked.asp">checked</a></td>
    <td>设置或返回 checkbox 是否应被选中。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_checkbox_defaultchecked.asp">defaultChecked</a></td>
    <td>返回 checked 属性的默认值。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_checkbox_disabled.asp">disabled</a></td>
    <td>设置或返回 checkbox 是否应被禁用。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_checkbox_form.asp">form</a></td>
    <td>返回对包含 checkbox 的表单的引用。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_checkbox_id.asp">id</a></td>
    <td>设置或返回 checkbox 的 id。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_checkbox_name.asp">name</a></td>
    <td>设置或返回 checkbox 的名称。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_checkbox_tabindex.asp">tabIndex</a></td>
    <td>设置或返回 checkbox 的 tab 键控制次序。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_checkbox_type.asp">type</a></td>
    <td>返回 checkbox 的表单元素类型。</td>
  </tr>
  <tr>
    <td>value</td>
    <td>设置或返回 checkbox 的 value 属性的值</td>
  </tr>
</table>
</div>
...
<table class="dataintable">
  ...
  <tr>
    <td><a href="/jsref/met_checkbox_blur.asp">blur()</a></td>
    <td>从 checkbox 上移开焦点。</td>
  </tr>
  <tr>
    <td><a href="/jsref/met_checkbox_click.asp">click()</a></td>
    <td>模拟在 checkbox 中的一次鼠标点击。</td>
  </tr>
  <tr>
    <td><a href="/jsref/met_checkbox_focus.asp">focus()</a></td>
    <td>为 checkbox 赋予焦点。</td>
  </tr>
</table>
</div>
