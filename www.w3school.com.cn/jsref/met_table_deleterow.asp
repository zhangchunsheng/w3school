...
<title>HTML DOM deleteRow() 方法</title>
...
<div>
<h2>定义和用法</h2>
<p>deleteRow() 方法用于从表格删除指定位置的行。</p>

<h3>语法</h3>
<pre>tableObject.deleteRow(index)</pre>

<h3>说明</h3>
<p>参数 index 指定了要删除的行在表中的位置。行的编码顺序就是他们在文档源代码中出现的顺序。&lt;thead&gt; 和 &lt;tfoot&gt; 中的行与表中其它行一起编码。</p>
</div>

<div>
<h2>实例</h2>
<p>The following example deletes the first row of the table:</p>
<pre>&lt;html&gt;
&lt;head&gt;
&lt;script type=&quot;text/javascript&quot;&gt;
function delRow()
  {
  <code>document.getElementById('myTable').deleteRow(0)</code>
  }
&lt;/script&gt;
&lt;/head&gt;
&lt;body&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_table_deleterow">从表格删除行</a></dt>
</dl>
</div>
