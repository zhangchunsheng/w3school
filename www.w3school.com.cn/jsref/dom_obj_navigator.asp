...
<li class="currentLink"><a href="/jsref/dom_obj_navigator.asp" title="HTML DOM Navigator 对象">Navigator</a></li>
...
<table class="dataintable">
  ...
  <tr>
    <td><a href="/jsref/prop_nav_appcodename.asp">appCodeName</a></td>
    <td>返回浏览器的代码名。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_nav_appminorversion.asp">appMinorVersion</a></td>
    <td>返回浏览器的次级版本。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_nav_appname.asp">appName</a></td>
    <td>返回浏览器的名称。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_nav_appversion.asp">appVersion</a></td>
    <td>返回浏览器的平台和版本信息。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_nav_browserlanguage.asp">browserLanguage</a></td>
    <td>返回当前浏览器的语言。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_nav_cookieenabled.asp">cookieEnabled</a></td>
    <td>返回指明浏览器中是否启用 cookie 的布尔值。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_nav_cpuclass.asp">cpuClass</a></td>
    <td>返回浏览器系统的 CPU 等级。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_nav_online.asp">onLine</a></td>
    <td>返回指明系统是否处于脱机模式的布尔值。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_nav_platform.asp">platform</a></td>
...
<table class="dataintable">
  ...
  <tr>
    <td><a href="/jsref/met_nav_javaenabled.asp">javaEnabled()</a></td>
    <td>规定浏览器是否启用 Java。</td>
  </tr>
  <tr>
    <td><a href="/jsref/met_nav_taintenabled.asp">taintEnabled()</a></td>
