...
<title>HTML DOM whiteSpace 属性</title>
...
<div>
<h2>定义和用法</h2>
<p>whiteSpace 属性设置如何处理文本中的空白符（比如空格和换行符）。</p>

<h3>语法：</h3>
<pre>Object.style.whiteSpace=normal|nowrap|pre</pre>
...
{
<code>document.getElementById(&quot;div1&quot;).style.whiteSpace=&quot;nowrap&quot;;</code>
}
&lt;/script&gt;
&lt;/head&gt;
&lt;body&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_style_whitespace">whiteSpace - 不允许在文本内换行</a></dt>
</dl>
</div>
