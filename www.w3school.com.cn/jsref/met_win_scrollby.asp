...
<title>HTML DOM  scrollBy() 方法</title>
...
<div>
<h2>定义和用法</h2>
<p>scrollBy() 方法可把内容滚动指定的像素数。</p>

<h3>语法</h3>
<pre>scrollBy(xnum,ynum)</pre>
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_window_scrollby">通过 scrollBy() 滚动文档</a></dt>
</dl>
</div>
