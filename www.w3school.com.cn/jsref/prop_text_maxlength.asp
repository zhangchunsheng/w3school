...
<title>HTML DOM maxLength 属性</title>
...
<div>
<h2>定义和用法</h2>
<p>maxLength 属性可设置或返回文本域中的最大字符数。</p>

<h3>语法</h3>
<pre>textObject.maxLength=number_of_char</pre>
</div>

<div>
<h2>实例</h2>
<p>下面的例子显示出该文本域的最大字符数：</p>
<pre>&lt;html&gt;
&lt;head&gt;
&lt;script type=&quot;text/javascript&quot;&gt;
function maxLen()
  {
  alert(<code>document.getElementById(&quot;name&quot;).maxLength</code>)
  }
&lt;/script&gt;
&lt;/head&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_text_size">提示出文本域的尺寸和最大字符数</a></dt>
<dt><a href="/tiy/t.asp?f=hdom_autonext">当达到文本域的最大字符数时跳至下一个域</a></dt>
</dl>
</div>
