...
<div>
<h2>定义和用法</h2>
<p>sub() 方法用于把字符串显示为下标。</p>

<h3>语法</h3>
<pre>stringObject.sub()</pre>
</div>
	
<div>
<h2>实例</h2>
<p>在本例中，&quot;Hello world!&quot; 将被显示为下标：</p>
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=jseg_str_style">sub()</a></dt>
<dd>如何使用 sub() 把字符串显示为下标。</dd>
</dl>
</div>
