...
<title>HTML DOM frameBorder 属性</title>
...
<div>
<h2>定义和用法</h2>
<p>frameBorder 属性设置或返回是否显示框架周围的边框。</p>
<p>如果不希望出现框架的边框，请把该属性设置为 0。</p>

<h3>语法</h3>
<pre>frameObject.frameBorder=1|0</pre>
</div>
...
<p>HTML 文档 &quot;frame_frameborder.htm&quot; 被放入第一列，而 HTML 文档 &quot;frame_a.htm&quot; 被放入第二列。</p>
<p>下面是 &quot;frame_frameborder.htm&quot; 的源代码：</p>
...
document.write(<code>x.frameBorder</code>);

document.write(&quot;&lt;br /&gt;Frame border for rightFrame is: &quot;);
document.write(<code>y.frameBorder</code>);
&lt;/script&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_frame_frameborder">返回框架的 frameBorder 属性</a></dt>
</dl>
</div>
