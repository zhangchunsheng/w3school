...
<title>JavaScript search() 方法</title>
...
<pre>stringObject.search(regexp)</pre>
...
<table class="dataintable"> 
  ...
  <tr>
    <td>regexp</td>
    <td>
	<p>该参数可以是需要在 stringObject 中检索的子串，也可以是需要检索的 RegExp 对象。</p>
	<p>注释：要执行忽略大小写的检索，请追加标志 i。</p></td>
  </tr>
</table>
...
<p class="note"><span>注释：</span>如果没有找到任何匹配的子串，则返回 -1。</p>
...
<dl>
<dt><a href="/tiy/t.asp?f=jseg_search_1">search()</a></dt>
<dd>如何使用 search() 来检索字符串中指定的子串。</dd>

<dt><a href="/tiy/t.asp?f=jseg_search_2">search() 忽略大小写的检索</a></dt>
<dd>如何使用 search() 来检索字符串中指定的子串。</dd>
</dl>
</div>
