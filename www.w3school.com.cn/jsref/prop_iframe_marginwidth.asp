...
<div>
<h2>定义和用法</h2>
<p>marginWidth 属性可设置或返回框架的左侧和右侧边缘的页面空白（以像素为单位）。</p>

<h3>语法</h3>
<pre>iframeObject.marginWidth=pixels</pre>
</div>

<div>
<h2>实例</h2>
<p>下面的例子将返回 iframe 的左边缘和右边缘的页空白：</p>
<pre>&lt;html&gt;
&lt;body&gt;
...
document.write(<code>x.marginWidth</code>);
&lt;/script&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_iframe_marginwidth">返回 iframe 的左边缘和右边缘的页空白</a></dt>
</dl>
</div>
