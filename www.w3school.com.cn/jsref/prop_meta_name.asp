...
<p>name 属性把 content 属性连接到 name。</p>

<h3>语法</h3>
<pre>metaObject.name=author|description|keywords|generator|revised|others</pre>
</div>
...
document.write(&quot;Meta name: &quot; + <code>x.name</code>);
&lt;/script&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_meta_name">获得 &lt;meta&gt; 元素的 content 属性的名称</a></dt>
</dl>
</div>
