...
<div>
<h2>定义和用法</h2>
<p>accessKey 属性可设置或返回访问一个链接的键盘按键。</p>
<p class="note"><span>注释：</span>请使用 Alt + accessKey 为拥有指定快捷键的元素赋予焦点。</p>

<h3>语法</h3>
<pre>anchorObject.accessKey=accessKey</pre>
</div>
...
function accesskey()
  {
  <code>document.getElementById('w3').accessKey=&quot;w&quot;</code>
  }
&lt;/script&gt;
&lt;/head&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_accesskey_anchor">向超链接添加快捷键</a></dt>
</dl>
</div>
