...
<div>
<h2>定义和用法</h2>
<p>text 属性可设置或返回选项的文本值。</p>
<p>该属性设置或返回的是包含在 &lt;option&gt; 元素中的纯文本。这个文本会作为选项的标签出现。</p>

<h3>语法</h3>
<pre>optionObject.text=sometext</pre>
</div>
