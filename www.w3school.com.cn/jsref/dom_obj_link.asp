...
<li class="currentLink"><a href="/jsref/dom_obj_link.asp" title="HTML DOM Link 对象">&lt;link&gt;</a></li>
...
<h1>HTML DOM Link 对象</h1>


<div>
<h2>Link 对象</h2>

<p>Link 对象代表某个 HTML 的 &lt;link&gt; 元素。&lt;link&gt; 元素可定义两个链接文档之间的关系。</p>

<p>&lt;link&gt; 元素被定义于 HTML 文档的 head 部分。</p>
</div>
...
<table class="dataintable">
  ...
  <tr>
    <td><a href="/jsref/prop_link_charset.asp">charset</a></td>
    <td>设置或返回目标 URL 的字符编码。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_link_disabled.asp">disabled</a></td>
    <td>设置或返回目标 URL 是否当被禁用。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_link_href.asp">href</a></td>
    <td>设置或返回被链接资源的 URL。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_link_hreflang.asp">hreflang</a></td>
    <td>设置或返回目标 URL 的基准语言。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_link_id.asp">id</a></td>
    <td>设置或返回某个 &lt;link&gt; 元素的 id。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_link_media.asp">media</a></td>
    <td>设置或返回文档显示的设备类型。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_link_name.asp">name</a></td>
    <td>设置或返回 &lt;link&gt; 元素的名称。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_link_rel.asp">rel</a></td>
    <td>设置或返回当前文档与目标 URL之间的关系。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_link_rev.asp">rev</a></td>
    <td>设置或返回目标 URL 与当前文档之间的关系。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_link_type.asp">type</a></td>
    <td>设置或返回目标 URL 的 MIME 类型。</td>
  </tr>
</table>
</div>
