...
<title>HTML DOM resizeBy() 方法</title>
...
<div>
<h2>定义和用法</h2>
<p>resizeBy() 方法用于根据指定的像素来调整窗口的大小。</p>

<h3>语法</h3>
<pre>resizeBy(width,height)</pre>
...
<table class="dataintable"> 
  ...
  <tr>
    <td>width</td>
    <td>必需。要使窗口宽度增加的像素数。可以是正、负数值。</td>
  </tr>
  <tr>
    <td>height</td>
    <td>可选。要使窗口高度增加的像素数。可以是正、负数值。</td>
  </tr>
</table>
</div>
...
function resizeWindow()
  {
  <code>window.resizeBy(-100,-100)</code>
  }
&lt;/script&gt;
&lt;/head&gt;
&lt;body&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_window_resizeby">调整窗口的大小</a></dt>
</dl>
</div>
