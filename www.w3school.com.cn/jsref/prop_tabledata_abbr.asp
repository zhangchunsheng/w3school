...
<div>
<h2>定义和用法</h2>
<p>abbr 属性可设置或返回表元中内容的缩写版本（针对非可视的媒介，比如语音和盲文）。</p>

<h3>语法</h3>
<pre>tabledataObject.abbr=text</pre>
</div>

<div>
<h2>实例</h2>
<p>下面的例子可提示某个单元格的 abbr：</p>
<pre>&lt;html&gt;
&lt;head&gt;
&lt;script type=&quot;text/javascript&quot;&gt;
function alertAbbr()
  {
  alert(<code>document.getElementById('td1').abbr</code>);
  }
&lt;/script&gt;
&lt;/head&gt;
&lt;body&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_tablecell_abbr">返回某个单元格的 abbr</a></dt>
</dl>
</div>
