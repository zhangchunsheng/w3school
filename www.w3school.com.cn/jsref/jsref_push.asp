...
<title>JavaScript push() 方法</title>
...
<p class="tip"><span>提示：</span>要想数组的开头添加一个或多个元素，请使用 unshift() 方法。</p>
</div>
...
document.write(<code>arr.push(&quot;James&quot;)</code> + &quot;&lt;br /&gt;&quot;)
document.write(arr)
...
<dl>
<dt><a href="/tiy/t.asp?f=jseg_push">push()</a></dt>
<dd>如何使用 push() 来改变数组的长度。</dd>
</dl>
</div>
