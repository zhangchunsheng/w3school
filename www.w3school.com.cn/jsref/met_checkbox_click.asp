...
<div>
<h2>定义和用法</h2>
<p>click() 方法用于在 checkbox 上模拟一次鼠标单击。</p>

<h3>语法</h3>
<pre>checkboxObject.click()</pre>
</div>

<div>
<h2>实例</h2>
<p>下面的例子可在 checkbox 上模拟一次鼠标点击：</p>
<pre>&lt;html&gt;
&lt;head&gt;
&lt;script type=&quot;text/javascript&quot;&gt;
function clickCheckbox()
  {
  <code>document.getElementById('check1').click()</code>
  }
&lt;/script&gt;
&lt;/head&gt;
&lt;body&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_checkbox_click">在 checkbox 上模拟一次鼠标点击</a></dt>
</dl>
</div>
