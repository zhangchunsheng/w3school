...
<title>HTML DOM pageBreakAfter 属性</title>
...
<h1>HTML DOM pageBreakAfter 属性</h1>
...
<div>
<h2>定义和用法</h2>
<p>pageBreakAfter 属性设置元素后否应当放置分页符。</p>

<h3>语法：</h3>
<pre>Object.style.pageBreakAfter=auto|always|avoid|left|right</pre>
...
<div>
<h2>实例</h2>
<p>本例在 id 为 p1 的段落之后设置了一个 page-break：</p>
...
{
<code>document.getElementById(&quot;p1&quot;).style.pageBreakAfter=&quot;always&quot;;</code>
}
&lt;/script&gt;
&lt;/head&gt;
&lt;body&gt;
