...
<title>HTML DOM lowsrc 属性</title>
...
<div>
<h2>定义和用法</h2>
<p>lowsrc 属性可设置或返回图像的低分辨率版本的 URL。</p>

<h3>语法</h3>
<pre>imageObject.lowsrc=URL</pre>
</div>

<div>
<h2>实例</h2>
<p>下面的例子可创建一个指向图像的低分辨率版本的链接：</p>
<pre>&lt;html&gt;
&lt;body&gt;
...
document.write('&lt;a href=&quot;' + <code>x.lowsrc</code> + '&quot;&gt;Low resolution&lt;/a&gt;');
&lt;/script&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_image_lowsrc">创建一个指向图像的低分辨率版本的链接</a></dt>
</dl>
</div>
