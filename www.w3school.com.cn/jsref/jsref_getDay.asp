...
<title>JavaScript getDay() 方法</title>
...
<p>getDay() 方法可返回表示星期的某一天的数字。</p>

<h3>语法</h3>

<pre>dateObject.getDay()</pre>

<h3>返回值</h3>

<p>dateObject 所指的星期中的某一天，使用本地时间。返回值是 0（周日） 到 6（周六） 之间的一个整数。</p>
</div>
...
<p>在本例中，我们将以数字取得星期的当前一天：</p>

<pre>
&lt;script type=&quot;text/javascript&quot;&gt;

var d=new Date()
document.write(<code>d.getDay()</code>)
...
<p>现在，我们将创建一个数组，这样就可以使上面的例子输出星期的名称，而不是数字：</p>
...
document.write(&quot;Today it is &quot; + weekday[<code>d.getDay()</code>])
...
<dl>
<dt><a href="/tiy/t.asp?f=jseg_date_weekday">getDay()</a></dt>
<dd>使用 getDay() 和一个数组来输出星期的名称，而不是数字。</dd>
</dl>
</div>
