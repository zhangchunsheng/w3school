...
<div>
<h2>定义和用法</h2>
<p>tabIndex 属性设置或返回文本域的 tab 键控制次序。</p>

<h3>语法</h3>
<pre>textObject.tabIndex=number</pre>
</div>

<div>
<h2>实例</h2>
<p>下面的例子显示出不同文本域的 tab 键控制次序：</p>
<pre>&lt;html&gt;
&lt;head&gt;
&lt;script type=&quot;text/javascript&quot;&gt;
function checkTab(x)
{
alert(<code>x.tabIndex</code>)
}
&lt;/script&gt;
&lt;/head&gt;
&lt;body&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_text_tabindex">显示出不同文本域的 tab 键控制次序</a></dt>
</dl>
</div>
