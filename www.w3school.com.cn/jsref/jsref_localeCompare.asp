...
<title>JavaScript localeCompare() 方法</title>
...
<h1>JavaScript localeCompare() 方法</h1>
...
<pre>stringObject.localeCompare(target)</pre>
...
<table class="dataintable"> 
  ...
  <tr>
    <td>target</td>
    <td>要以本地特定的顺序与 stringObject 进行比较的字符串。</td>
  </tr>
</table>

<h3>返回值</h3>

<p>说明比较结果的数字。如果 stringObject 小于 target，则 localeCompare() 返回小于 0 的数。如果 stringObject 大于 target，则该方法返回大于 0 的数。如果两个字符串相等，或根据本地排序规则没有区别，该方法返回 0。</p>

<h3>说明</h3>

<p>把 &lt; 和 &gt; 运算符应用到字符串时，它们只用字符的 Unicode 编码比较字符串，而不考虑当地的排序规则。以这种方法生成的顺序不一定是正确的。例如，在西班牙语中，其中字符 “ch” 通常作为出现在字母 “c” 和 “d” 之间的字符来排序。</p>
