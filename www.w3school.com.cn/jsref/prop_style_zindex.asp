...
<title>HTML DOM zIndex 属性</title>
...
<div>
<h2>定义和用法</h2>
<p>zIndex 属性设置元素的堆叠顺序。</p>
<p>该属性设置一个定位元素沿 z 轴的位置，z 轴定义为垂直延伸到显示区的轴。如果为正数，则离用户更近，为负数则表示离用户更远。</p>

<h3>语法：</h3>
<pre>Object.style.zIndex=auto|<i>number</i></pre>
...
{
<code>document.getElementById(&quot;img1&quot;).style.zIndex=&quot;1&quot;;</code>
}
&lt;/script&gt;
&lt;/head&gt;
&lt;body&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_style_zindex">zIndex - 改变元素的堆叠顺序</a></dt>
</dl>
</div>
