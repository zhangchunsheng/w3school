...
<title>JavaScript strike() 方法</title>
...
<div>
<h2>定义和用法</h2>
<p>strike() 方法用于显示加删除线的字符串。</p>

<h3>语法</h3>
<pre>stringObject.strike()</pre>
</div>
	
<div>
<h2>实例</h2>
<p>在本例中，&quot;Hello world!&quot; 将被加上一条删除线：</p>
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=jseg_str_style">strike()</a></dt>
<dd>如何使用 strike() 来显示加了删除线的字符串。</dd>
</dl>
</div>
