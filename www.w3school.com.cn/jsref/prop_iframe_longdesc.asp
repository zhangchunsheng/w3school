...
<div>
<h2>定义和用法</h2>
<p>longDesc 属性可设置或返回包含 iframe 内容描述的文档的 URL。</p>
<p class="tip"><span>提示：</span>请把该属性用于不支持框架的浏览器。</p>

<h3>语法</h3>
<pre>iframeObject.longDesc=URL</pre>
</div>

<div>
<h2>实例</h2>
<p>下面的例子创建了一个指向一个描述页面的链接：</p>
<pre>&lt;html&gt;
&lt;body&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_iframe_longdesc">使用 &lt;iframe&gt; 元素中的 longdesc 属性</a></dt>
</dl>
</div>
