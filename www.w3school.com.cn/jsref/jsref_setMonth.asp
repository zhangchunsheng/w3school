...
<title>JavaScript setMonth() 方法</title>
...
<pre>dateObject.setMonth(month,day)</pre>
...
<table class="dataintable"> 
  ...
  <tr>
    <td>month</td>
    <td>必需。一个表示月份的数值，该值介于 0（一月） ~ 11（十二月） 之间。</td>
  </tr>
    <tr>
    <td>day</td>
    <td>
	<p>可选。一个表示月的某一天的数值，该值介于 1 ~ 31 之间（以本地时间计）。</p>
	<p>在 EMCAScript 标准化之前，不支持该参数。</p>
	</td>
  </tr>
</table>
...
<p>在本例中，我们将通过 setMonth() 方法把对象 d 的月字段设置为 0 （一月）：</p>
...
<p>在本例中，我们将通过 setMonth() 方法把对象 d 的月字段设置为 0 （一月），把天字段设置为 20：</p>
...
<dl>
<dt><a href="/tiy/t.asp?f=jseg_setmonth">setMonth()</a></dt>
<dd>如何使用 setMonth() 来设置月份。</dd>
</dl>
</div>
