...
<div>
<h2>定义和用法</h2>
<p>form 属性可返回对包含该密码域的表单的引用。</p>
<p>若成功，该属性将返回一个表单对象。</p>

<h3>语法</h3>
<pre>passwordObject.form</pre>
</div>

<div>
<h2>实例</h2>
<p>下面的例子取得了该密码域所属的表单的 id：</p>
<pre>&lt;html&gt;
&lt;body&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_password_form">取得密码域所属的表单的 id</a></dt>
</dl>
</div>
