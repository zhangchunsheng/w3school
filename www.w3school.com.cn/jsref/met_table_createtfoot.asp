...
<title>HTML DOM createTFoot() 方法</title>
...
<div>
<h2>定义和用法</h2>
<p>createTFoot() 方法用于在表格中获取或创建 &lt;tfoot&gt; 元素。</p>

<h3>语法</h3>
<pre>tableObject.createTFoot()</pre>

<h3>返回值</h3>
<p>返回一个 TableSection，表示该表的 &lt;tfoot&gt; 元素。如果该表格已经有了脚注，则返回它。如果该表没有脚注，则创建一个新的空 &lt;tfoot&gt; 元素，把它插入表格，并返回它。</p>
</div>
...
{
var x=<code>document.getElementById('myTable').createTFoot()</code>
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_table_createtfoot">为表格创建了一个脚注</a></dt>
</dl>
</div>
