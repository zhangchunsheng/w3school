...
<title>JavaScript setTime() 方法</title>
...
<pre>dateObject.setTime(<i>millisec</i>)</pre>
...
<table class="dataintable"> 
  ...
  <tr>
    <td><i>millisec</i></td>
    <td>必需。要设置的日期和时间据 GMT 时间 1970 年 1 月 1 日午夜之间的毫秒数。这种类型的毫秒值可以传递给 Date() 构造函数，可以通过调用 Date.UTC() 和 Date.parse() 方法获得该值。以毫秒形式表示日期可以使它独立于时区。</td>
  </tr>
</table>

<h3>返回值</h3>

<p>返回参数 <i>millisec</i>。在 ECMAScript 标准化之前，该方法不返回值。</p>
</div>
...
<p>在本例中，我们将向 1970/01/01 添加 77771564221 毫秒，并显示新的日期和时间：</p>
...
<p>在本例中，我们将从 1970/01/01 减去 77771564221 毫秒，并显示新的日期和时间：</p>
...
<dl>
<dt><a href="/tiy/t.asp?f=jseg_settime">setTime()</a></dt>
<dd>使用 setTime() 向 1970/01/01 添加毫秒，并显示新的日期和时间。</dd>
</dl>
</div>
