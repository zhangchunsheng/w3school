...
<title>HTML DOM selected 属性</title>
...
<div>
<h2>定义和用法</h2>
<p>selected 属性可设置或返回选项的 selected 属性的值。</p>
<p>该属性设置选项的当前状态，如果为 true，则该选项被选中。该属性的初始值来自 &lt;option&gt; 的 selected 属性。</p>

<h3>语法</h3>
<pre>optionObject.selected=true|false</pre>
</div>
...
{
<code>document.getElementById(&quot;orange&quot;).selected=true;</code>
}
&lt;/script&gt;
&lt;/head&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_option_selected">更改被选选项</a></dt>
</dl>
</div>
