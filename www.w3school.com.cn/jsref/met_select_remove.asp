...
<title>HTML DOM remove() 方法</title>
...
<div>
<h2>定义和用法</h2>
<p>remove() 方法用于从下拉列表删除选项。</p>

<h3>语法</h3>
<pre>selectObject.remove(index)</pre>
<table class="dataintable">
	...
	<tr>
		<td>index</td>
		<td>必需。规定要删除的选项的索引号。</td>
	</tr>
</table>

<h3>说明</h3>
<p>该方法从选项数组的指定位置移除 &lt;option&gt; 元素。如果指定的下标比 0 小，或者大于或等于选项的数目，remove() 方法会忽略它并什么也不做。</p>
</div>

<div>
<h2>实例</h2>
<p>下面的例子可从列表中删除被选的选项：</p>
<pre>&lt;html&gt;
&lt;head&gt;
&lt;script type=&quot;text/javascript&quot;&gt;
function removeOption()
  ...
  <code>x.remove(x.selectedIndex)</code>
  }
&lt;/script&gt;
&lt;/head&gt;
&lt;body&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_select_remove">从下拉列表中删除被选的选项</a></dt>
<dt><a href="/tiy/t.asp?f=hdom_select_remove2">从下拉列表中删除最后的选项</a></dt>
</dl>
</div>
