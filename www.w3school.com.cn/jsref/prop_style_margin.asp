...
<title>HTML DOM margin 属性</title>
...
<p>margin 属性设置元素的外边距。</p>

<p>该属性可使用 1 到 4 个值：</p>
<ul>
	<li>如果规定一个值，比如 div {margin: 50px} - 所有的外边距都是 50 px</li>
	<li>如果规定两个值，比如 div {margin: 50px 10px} - 上下外边距是 50px，左右外边距是 10 px。</li>
	<li>如果规定三个值，比如 div {margin: 50px 10px 20px}- 上外边距是 50 px，而左右外边距是 10 px，下外边距是 20 px。</li>
	<li>如果规定四个值，比如 div {margin: 50px 10px 20px 30px} - 上外边距是 50 px，右外边距是 10 px，下外边距是 20 px，左外边距是 30 px。</li>
</ul>

<h3>语法：</h3>
<pre>Object.style.margin=margin</pre>
...
{
<code>document.getElementById(&quot;p1&quot;).style.margin=&quot;100px&quot;;</code>
}
&lt;/script&gt;
&lt;/head&gt;
&lt;body&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_style_margin">margin - 改变段落的外边距</a></dt>
</dl>
</div>
