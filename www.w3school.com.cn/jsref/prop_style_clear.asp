...
<div>
<h2>定义和用法</h2>
<p>clear 属性设置一个元素的侧面是否允许其他的浮动元素。</p>

<h3>语法：</h3>
<pre>Object.style.clear=left|right|both|none</pre>
...
function clearLeft()
{
<code>document.getElementById(&quot;p1&quot;).style.clear=&quot;left&quot;;</code>
}
&lt;/script&gt;
&lt;/head&gt;
&lt;body&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_style_clear">清除文本左边的浮动元素</a></dt>
</dl>
</div>
