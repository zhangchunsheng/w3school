...
<li class="currentLink"><a href="/jsref/dom_obj_area.asp" title="HTML DOM Area 对象">&lt;area&gt;</a></li>
...
<h1>HTML DOM Area 对象</h1>


<div>
<h2>Area 对象</h2>

<p>Area 对象代表图像映射的一个区域（图像映射指的是带有可点击区域的图像）</p>

<p>在 HTML 文档中 &lt;area&gt; 标签每出现一次，就会创建一个 Area 对象。</p>
</div>
...
<table class="dataintable">
  ...
  <tr>
    <td><a href="/jsref/prop_area_accesskey.asp">accessKey</a></td>
    <td>设置或返回访问某个区域的快捷键。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_area_alt.asp">alt</a></td>
    <td>设置或返回当浏览器无法显示某个区域时的替换文字。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_area_coords.asp">coords</a></td>
    <td>设置或返回图像映射中可点击区域的坐标。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_area_hash.asp">hash</a></td>
    <td>设置或返回某个区域中 URL 的锚部分。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_area_host.asp">host</a></td>
    <td>设置或返回某个区域中 URL 的主机名和端口。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_area_href.asp">href</a></td>
    <td>设置或返回图像映射中链接的 URL。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_area_id.asp">id</a></td>
    <td>设置或返回某个区域的 id。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_area_nohref.asp">noHref</a></td>
    <td>设置或返回某个区域是否应是活动的还是非活动的。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_area_pathname.asp">pathname</a></td>
    <td>设置或返回某个区域中的 URL 的路径名。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_area_protocol.asp">protocol</a></td>
    <td>设置或返回某个区域中的 URL 的协议。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_area_search.asp">search</a></td>
    <td>设置或返回某个区域中 URL 的查询字符串部分。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_area_shape.asp">shape</a></td>
    <td>设置或返回图像映射中某个区域的形状。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_area_tabindex.asp">tabIndex</a></td>
    <td>设置或返回某个区域的 tab 键控制次序。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_area_target.asp">target</a></td>
    <td>设置或返回在何处打开区域中的 link-URL。</td>
  </tr>
</table>
</div>
...
<table class="dataintable">
  ...
  <tr>
    <td><a href="/jsref/prop_area_title.asp">title</a></td>
