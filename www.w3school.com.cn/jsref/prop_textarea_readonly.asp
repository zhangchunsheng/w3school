...
<p>readOnly 属性设置或返回 textarea 是否为只读。</p>

<h3>语法</h3>
<pre>textareaObject.readOnly=true|false</pre>
</div>

<div>
<h2>实例</h2>

<p>本例把 textarea 设置为只读：</p>
...
function setReadOnly()
  {
  <code>document.getElementById('txt1').readOnly=true;</code>
  }
&lt;/script&gt;
&lt;/head&gt;
&lt;body&gt;
