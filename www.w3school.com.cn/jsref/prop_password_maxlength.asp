...
<div>
<h2>定义和用法</h2>
<p>maxLength 属性可设置或返回密码域中所允许的最大字符数。</p>

<h3>语法</h3>
<pre>passwordObject.maxLength=number_of_chars</pre>
</div>

<div>
<h2>实例</h2>
<p>下面的例子可显示指定的密码域中所允许的最大字符数：</p>
<pre>&lt;html&gt;
&lt;head&gt;
&lt;script type=&quot;text/javascript&quot;&gt;
function alertLength()
  {
  alert(<code>document.getElementById(&quot;password1&quot;).maxLength</code>)
  }
&lt;/script&gt;
&lt;/head&gt;
&lt;body&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_password_maxlength">获得密码域中所允许的最大字符数</a></dt>
</dl>
</div>
