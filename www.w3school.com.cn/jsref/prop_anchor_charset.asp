...
<title>HTML DOM charset 属性</title>
...
<div>
<h2>定义和用法</h2>
<p>charset 属性可设置或返回被链接资源的字符集。</p>

<h3>语法</h3>
<pre>anchorObject.charset=charset</pre>
</div>

<div>
<h2>实例</h2>
<p>下面的例子可设置被链资源的字符串：</p>
<pre>&lt;html&gt;
&lt;body&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_anchor_charset">设置被链资源的字符串</a></dt>
</dl>
</div>
