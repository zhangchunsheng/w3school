...
<h1>Button type 属性</h1>

<div class="backtoreference">
<p><a href="/jsref/dom_obj_pushbutton.asp">HTML DOM Button 对象</a></p>
</div>
...
<p>type 属性设置或返回按钮的类型。</p>

<p class="tip"><span>提示：</span>请始终为按钮规定 type 属性。IE 浏览器的默认类型是 &quot;button&quot;，而在其他浏览器中（以及在 W3C 规范中）是 &quot;submit&quot;。</p>

<h3>语法</h3>
<pre>buttonObject.type=<i>value</i></pre>
...
<tr>
<td>submit</td>
<td>button 是提交按钮（是 IE 之外的所有浏览器的默认值）</td>
</tr>

<tr>
<td>button</td>
<td>button 是可点击的按钮（IE 的默认值）</td>
</tr>

<tr>
<td>reset</td>
<td>button 是重置按钮（清除表单数据）</td>
</tr>
</table>
</div>
...
function alertType()
{
alert(<code>document.getElementById(&quot;myButton&quot;).type</code>)
}
&lt;/script&gt;
&lt;/head&gt;
...
<p><a href="/tiy/t.asp?f=hdom_button_type">亲自试一试</a></p>
</div>
