...
<title>HTML DOM cookie 集合</title>
...
<div>
<h2>定义和用法</h2>
<p>cookie 属性可设置或查询与当前文档相关的所有 cookie。</p>

<h3>语法</h3>
<pre>document.cookie</pre>

<h3>说明</h3>
<p>该属性是一个可读可写的字符串，可使用该属性对当前文档的 cookie 进行读取、创建、修改和删除操作。</p>
</div>

<div>
<h2>提示和注释</h2>
<p class="tip"><span>提示：</span>该属性的行为与普通的读/写属性是不同的。</p>
</div>
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_document_cookie">返回与当前文档相关的 cookie</a></dt>
</dl>
</div>
