...
<title>JavaScript acos() 方法</title>
...
<table class="dataintable"> 
  ...
  <tr>
    <td>x</td>
    <td>必需。必须是 -1.0 ~ 1.0 之间的数。</td>
  </tr>
</table>

<h3>返回值</h3>

<p>x 的反余弦值。返回的值是 0 到 PI 之间的弧度值。</p>
</div>
...
<p class="note"><span>注释：</span>如果参数 x 取值 -1，那么将返回 PI。</p>
</div>
...
<dl>
<dt><a href="/tiy/t.asp?f=jseg_acos">acos()</a></dt>
<dd>如何使用 acos() 来取得不同数的反余弦值。</dd>
</dl>
</div>
