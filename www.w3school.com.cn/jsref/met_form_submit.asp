...
<title>HTML DOM submit() 方法</title>
...
<div>
<h2>定义和用法</h2>
<p>submit() 方法把表单数据提交到 Web 服务器。</p>

<h3>语法</h3>
<pre>formObject.submit()</pre>

<h3>说明</h3>
<p>该方法提交表单的方式与用户单击 Submit 按钮一样，但是表单的 onsubmit 事件句柄不会被调用。</p>
</div>
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_form_submit">提交表单</a></dt>
</dl>
</div>
