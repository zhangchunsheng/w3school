...
<title>HTML DOM replace() 方法</title>
...
<h3>语法</h3>
<pre>location.replace(newURL)</pre>

<h3>说明</h3>
<p>replace() 方法不会在 History 对象中生成一个新的记录。当使用该方法时，新的 URL 将覆盖 History 对象中的当前记录。</p>
</div>

<div>
<h2>实例</h2>

<p>下面的例子将使用 replace() 方法来替换当前文档：</p>
...
function replaceDoc()
  {
  <code>window.location.replace(&quot;http://www.w3school.com.cn&quot;)</code>
  }
&lt;/script&gt;
&lt;/head&gt;
&lt;body&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_loc_replace">使用 location 对象的 replace() 方法</a></dt>
</dl>
</div>
