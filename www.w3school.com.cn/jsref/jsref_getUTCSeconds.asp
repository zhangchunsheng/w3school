...
<title>JavaScript getUTCSeconds() 方法</title>
...
<h1>JavaScript getUTCSeconds() 方法</h1>
...
<p>getUTCSeconds() 方法可根据世界时返回时间的秒。</p>

<h3>语法</h3>

<pre>dateObject.getUTCSeconds()</pre>

<h3>返回值</h3>

<p>当 dateObject 用世界时表示时，返回它的秒字段，该值是一个 0 ~ 59 之间的整数。</p>
</div>
...
<p class="note"><span>注释：</span>由 getUTCSeconds() 返回的值是一个两位的数字。不过返回值不总是两位的，如果该值小于 10，则仅返回一位数字。</p>
