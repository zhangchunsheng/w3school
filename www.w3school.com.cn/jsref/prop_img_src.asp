...
<div>
<h2>定义和用法</h2>
<p>src 属性可设置或返回图像的 URL。</p>
<p class="note"><span>注释：</span>该属性可在任意时间被更改。不过新图像会继承原始图像的 height 和 width 属性。</p>
<p>该属性的初始值由标记 &lt;img&gt; 的 src 属性来设置。当把该属性设置为新图像的 URL 时，浏览器就会把那幅新图像装载并显示出来。这对于更新网页的图像外观以响应用户的动作非常有用。</p>

<h3>语法</h3>
<pre>imageObject.src=URL</pre>
</div>
...
function changeSrc()
  {
  <code>document.getElementById(&quot;myImage&quot;).src=&quot;hackanm.gif&quot;</code>
  }
&lt;/script&gt;
&lt;/head&gt;
&lt;body&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_image_src">更改图像的 src</a></dt>
</dl>
</div>
