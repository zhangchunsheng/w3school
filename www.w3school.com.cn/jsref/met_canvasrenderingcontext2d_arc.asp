...
<h3>语法</h3>
<pre>arc(<i>x</i>, <i>y</i>, <i>radius</i>, <i>startAngle</i>, <i>endAngle</i>, <i>counterclockwise</i>)</pre>
...
<td><p>沿着圆指定弧的开始点和结束点的一个角度。这个角度用弧度来衡量。</p>
<p>沿着 X 轴正半轴的三点钟方向的角度为 0，角度沿着逆时针方向而增加。</p></td>
</tr>
...
<p>最后一个 <i>counterclockwise</i> 参数指定了圆应该沿着哪个方向遍历来连接起始点和结束点。这个方法将当前位置设置为弧的终点。</p>
</div>

<div>
<h2>参阅</h2>

<p><a href="/jsref/met_canvasrenderingcontext2d_arcto.asp" title="HTML DOM arcTo() 方法">CanvasRenderingContext2D.arcTo()</a></p>
<p><a href="/jsref/met_canvasrenderingcontext2d_beginpath.asp" title="HTML DOM beginPath() 方法">CanvasRenderingContext2D.beginPath()</a></p>
<p><a href="/jsref/met_canvasrenderingcontext2d_closepath.asp" title="HTML DOM closePath() 方法">CanvasRenderingContext2D.closePath()</a></p>
</div>
