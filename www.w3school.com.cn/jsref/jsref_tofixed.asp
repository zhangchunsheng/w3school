...
<title>JavaScript toFixed() 方法</title>
...
<h3>语法</h3>
<pre>NumberObject.toFixed(num)</pre>
...
<table class="dataintable"> 
  ...
  <tr>
    <td>num</td>
    <td>必需。规定小数的位数，是 0 ~ 20 之间的值，包括 0 和 20，有些实现可以支持更大的数值范围。如果省略了该参数，将用 0 代替。</td>
  </tr>
</table>
...
<div>
<h2>实例</h2>
<p>在本例中，我们将把数字舍入为仅有一位小数的数字：</p>
<pre>Show the number 13.37 with one decimal:
&lt;script type=&quot;text/javascript&quot;&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=jseg_tofixed">toFixed()</a></dt>
<dd>如何使用 toFixed() 来舍入一个数字。</dd>
</dl>
</div>
