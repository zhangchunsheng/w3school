...
<title>HTML DOM TableCell 对象</title>
...
<li class="currentLink"><a href="/jsref/dom_obj_tabledata.asp" title="HTML DOM TableCell 对象">&lt;td&gt;</a></li>
<li class="currentLink"><a href="/jsref/dom_obj_tabledata.asp" title="HTML DOM TableCell 对象">&lt;th&gt;</a></li>
...
<h1>HTML DOM TableCell 对象</h1>


<div>
<h2>TableCell 对象</h2>

<p>TableCell 对象代表一个 HTML 表格单元格。</p>

<p>在一个 HTML 文档中 &lt;td&gt; 标签每出现一次，一个 TableCell 对象就会被创建。</p>
</div>


<div>
<h2>TableCell 对象属性</h2>
...
<table class="dataintable">
  ...
  <tr>
    <td><a href="/jsref/prop_tabledata_abbr.asp">abbr</a></td>
    <td>设置或返回单元格中内容的缩写版本。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_tabledata_align.asp">align</a></td>
    <td>设置或返回单元格内部数据的水平排列方式。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_tabledata_axis.asp">axis</a></td>
    <td>设置或返回相关单元格的一个逗号分隔的列表。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_tabledata_cellindex.asp">cellIndex</a></td>
    <td>返回单元格在某行的单元格集合中的位置。</td>
  </tr>
  <tr>
    <td>ch</td>
    <td>设置或返回单元格的对齐字符。</td>
  ...
  <tr>
    <td>chOff</td>
    <td>设置或返回单元格的对齐字符的偏移量。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_tabledata_colspan.asp">colSpan</a></td>
    <td>单元格横跨的列数。</td>
  </tr>
  <tr>
    <td>headers</td>
    <td>设置或返回 header-cell 的 id 值。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_tabledata_id.asp">id</a></td>
    <td>设置或返回单元格的 id。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_tabledata_innerhtml.asp">innerHTML</a></td>
    <td>设置或返回单元格的开始标签和结束标签之间的 HTML。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_tabledata_rowspan.asp">rowSpan</a></td>
    <td>设置或返回单元格可横跨的行数。</td>
  </tr>
  <tr>
    <td>scope</td>
    <td>设置或返回此单元格是否可提供标签信息。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_tabledata_valign.asp">vAlign</a></td>
    <td>设置或返回表格单元格内数据的垂直排列方式。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_tabledata_width.asp">width</a></td>
    <td>设置或返回单元格的宽度。</td>
  </tr>
</table>
</div>
