...
<title>HTML DOM appName 属性</title>
...
<h1>HTML DOM appName 属性</h1>

<div class="backtoreference">
<p><a href="/jsref/dom_obj_navigator.asp">HTML DOM Navigator 对象</a></p>
</div>

<div>
<h2>定义和用法</h2>
<p>appName 属性可返回浏览器的名称。</p>
<p>appName 属性是一个只读到字符串，声明了浏览器的名称。在基于 Netscape 的浏览器中，这个属性的值是 &quot;Netscape&quot;。在 IE 中，这个属性的值是 &quot;Microsoft Internet Explorer&quot;。其他浏览器可以正确地表示自己或者伪装成其他的浏览器以达到兼容性。</p>

<h3>语法</h3>
<pre>navigator.appMinorVersion</pre>
</div>
...
document.write(<code>navigator.appName</code> + &quot;&lt;/p&gt;&quot;)
&lt;/script&gt;
&lt;/body&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_browser">检测访问者的浏览器和版本号</a></dt>
<dt><a href="/tiy/t.asp?f=hdom_browserdetails">有关访问者的浏览器的更多信息</a></dt>
<dt><a href="/tiy/t.asp?f=hdom_navigator">有关访问者的浏览器的全部细节</a></dt>
<dt><a href="/tiy/t.asp?f=hdom_browser2">根据浏览器来提醒用户</a></dt>
</dl>
</div>
