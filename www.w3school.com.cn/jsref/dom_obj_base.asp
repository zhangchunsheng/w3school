...
<li class="currentLink"><a href="/jsref/dom_obj_base.asp" title="HTML DOM Base 对象">&lt;base&gt;</a></li>
...
<h1>HTML DOM Base 对象</h1>


<div>
<h2>Base 对象</h2>

<p>Base 对象代表 HTML 的 base 元素。</p>

<p>在 HTML 文档中 &lt;base&gt; 每出现一次，Base 对象就会被创建。</p>
</div>
...
<table class="dataintable">
  ...
  <tr>
    <td><a href="/jsref/prop_base_href.asp">href</a></td>
    <td>设置或返回针对页面中所有链接的基准 URL。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_base_id.asp">id</a></td>
    <td>设置或返回 &lt;base&gt; 元素的 id。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_base_target.asp">target</a></td>
    <td>设置或返回针对页面中所有链接的默认目标框架。</td>
  </tr>
</table>
</div>
