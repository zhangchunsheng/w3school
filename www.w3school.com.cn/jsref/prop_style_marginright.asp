...
<title>HTML DOM marginRight 属性</title>
...
<div>
<h2>定义和用法</h2>
<p>marginRight 属性设置元素的右外边距。</p>

<h3>语法：</h3>
<pre>Object.style.marginRight=auto|length|%</pre>
...
<tr>
<td>length</td>
<td>定义固定的外右边距。默认值是 0。</td>
</tr>

<tr>
<td>%</td>
<td>定义基于父对象总高度的百分比外右边距。</td>
</tr>
</table>
</div>
...
{
<code>document.getElementById(&quot;p1&quot;).style.marginRight=&quot;32px&quot;;</code>
}
&lt;/script&gt;
&lt;/head&gt;
&lt;body&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_style_marginright">marginRight - 改变段落的右外边距</a></dt>
</dl>
</div>
