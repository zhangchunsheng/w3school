...
<title>HTML DOM borderWidth 属性</title>
...
<p>borderWidth 属性设置所有四个边框的宽度。</p>

<p>该属性可使用 1 到 4 个值：</p>

<ul>
<li>如果规定一个值，比如 div {border-width: thick} - 所有四个边框都是粗线。</li>
<li>如果规定两个值，比如 div {border-width: thick thin} - 上下边框是粗线，而左右边框是细线。</li>
<li>如果规定三个值，比如 div {border-width: thick thin medium}- 上边框是粗线，左右边框是细线，下边框是中等 (medium) 的宽度。</li>
<li>如果规定四个值，比如 div {border-width: thick thin medium 10px} - 上边框是粗线，右边框是细线，下边框是中等的宽度，而左边框是 10px 的宽度。</li>
</ul>

<h3>语法：</h3>
<pre>Object.style.borderWidth=thin|medium|thick|length</pre>
...
{
<code>document.getElementById(&quot;p1&quot;).style.borderWidth=&quot;thick thin&quot;;</code>
}
&lt;/script&gt;
&lt;/head&gt;
&lt;body&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_style_borderwidth">borderWidth - 改变所有四个边框的宽度</a></dt>
</dl>
</div>
