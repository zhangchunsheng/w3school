...
<title>JavaScript setUTCFullYear() 方法</title>
...
<h1>JavaScript setUTCFullYear() 方法</h1>
...
<p>setUTCFullYear() 方法用于根据世界时 (UTC) 设置年份。</p>

<h3>语法</h3>

<pre>dateObject.setUTCFullYear(year,month,day)</pre>
...
<table class="dataintable"> 
  ...
  <tr>
    <td>year</td>
    <td>
	<p>必需。要给 dateObject 设置的年份字段的值。</p>
	<p>该参数应该是含有世纪值的完整年份，如 1999，而不只是缩写的年份值，比如 99。</p>
	</td>
  </tr>
  <tr>
    <td>month</td>
    <td>
	<p>可选。要给 dateObject 设置的月份字段的值。使用世界时表示。</p>
	<p>该参数是 0 ~ 11 之间的整数。</p>
	</td>
  </tr>
  <tr>
    <td>day</td>
    <td>
	<p>可选。要给 dateObject 设置的天字段的值。使用世界时表示。</p>
	<p>该参数是 1 ~ 31 之间的整数。</p>
	</td>
  </tr>
</table>
...
<p>在本例中，我们将通过 setUTCFullYear() 方法把年份设置为 1992：</p>
...
<p>在本例中，我将通过 setUTCFullYear() 方法把日期设置为 November 3, 1992：</p>
...
<dl>
<dt><a href="/tiy/t.asp?f=jseg_setutcfullyear">setUTCFullYear()</a></dt>
<dd>如何使用 setUTCFullYear() 来设置年份。</dd>
</dl>
</div>
