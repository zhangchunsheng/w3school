...
<div>
<h2>定义和用法</h2>
<p>focus() 方法用于给予链接焦点。</p>

<h3>语法</h3>
<pre>anchorObject.focus()</pre>

<h3>说明</h3>
<p>该方法可滚动文档以使 Anchor 对象的位置变为可见。</p>
</div>
...
&lt;script type=&quot;text/javascript&quot;&gt;
function getfocus()
{<code>document.getElementById('myAnchor').focus()</code>}

function losefocus()
{<code>document.getElementById('myAnchor').blur()</code>}
&lt;/script&gt;
&lt;/head&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_anchor_focus_blur">使用 focus() 和 blur()</a></dt>
</dl>
</div>
