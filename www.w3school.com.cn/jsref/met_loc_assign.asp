...
<title>HTML DOM assign() 方法</title>
...
<h3>语法</h3>
<pre>location.assign(URL)</pre>
</div>

<div>
<h2>实例</h2>

<p>下面的例子将使用 assign() 来加载一个新的文档：</p>
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_loc_assign">使用 location 对象的 assign() 方法</a></dt>
</dl>
</div>
