...
<p class="tip"><span>提示：</span>可以使用 <a href="/jsref/jsref_unescape.asp" title="JavaScript unescape() 函数">unescape()</a> 对 escape() 编码的字符串进行解码。</p>
...
<dl>
<dt><a href="/tiy/t.asp?f=jseg_escape">escape()</a></dt>
