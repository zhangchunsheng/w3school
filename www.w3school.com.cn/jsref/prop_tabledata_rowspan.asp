...
<title>HTML DOM rowSpan 属性</title>
...
<div>
<h2>定义和用法</h2>
<p>rowSpan 属性可设置或返回表元横跨的行数。</p>

<h3>语法</h3>
<pre>tabledataObject.rowSpan=number_of_rows</pre>
</div>
...
function changeRowSpan()
  {
  <code>document.getElementById(&quot;td2&quot;).rowSpan=&quot;2&quot;;</code>
  }
&lt;/script&gt;
&lt;/head&gt;
&lt;body&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_tablecell_rowspan">更改表元横跨的行数</a></dt>
</dl>
</div>
