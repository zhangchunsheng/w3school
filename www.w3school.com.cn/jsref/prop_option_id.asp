...
<div>
<h2>定义和用法</h2>
<p>id 属性可设置或返回下拉列表中选项的 id。</p>

<h3>语法</h3>
<pre>optionObject.id=id</pre>
</div>

<div>
<h2>实例</h2>
<p>下面的例子可返回下拉列表中所选选项的 id：</p>
<pre>&lt;html&gt;
&lt;head&gt;
&lt;script type=&quot;text/javascript&quot;&gt;
...
alert(<code>document.getElementsByTagName(&quot;option&quot;)[x].id</code>);
}
&lt;/script&gt;
&lt;/head&gt;
&lt;body&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_option_id">取得下拉列表中所选选项的 id</a></dt>
</dl>
</div>
