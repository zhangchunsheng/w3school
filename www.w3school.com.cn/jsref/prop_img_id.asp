...
<div>
<h2>定义和用法</h2>
<p>id 属性可设置或返回图像的 id。</p>

<h3>语法</h3>
<pre>imageObject.id=id</pre>
</div>

<div>
<h2>实例</h2>
<p>下面的例子将通过两种方法来返回图像的 id：</p>
<pre>&lt;html&gt;
&lt;body&gt;
...
document.write(&quot;Image id: &quot; + <code>x.id</code>);
document.write(&quot;&lt;br /&gt;&quot;);
document.write(&quot;An alternate way: &quot;);
document.write(<code>document.getElementById('compman').id</code>);
&lt;/script&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_image_id">取得图像的 id</a></dt>
</dl>
</div>
