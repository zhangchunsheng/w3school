...
<title>JavaScript split() 方法</title>
...
<h3>语法</h3>
<pre>stringObject.split(<i>separator</i>,<i>howmany</i>)</pre>
...
<table class="dataintable"> 
  ...
  <tr>
    <td>separator</td>
    <td>必需。字符串或正则表达式，从该参数指定的地方分割 stringObject。</td>
  </tr>
  <tr>
    <td>howmany</td>
...
<h3>返回值</h3>
<p>一个字符串数组。该数组是通过在 <i>separator</i> 指定的边界处将字符串 stringObject 分割成子串创建的。返回的数组中的字串不包括 <i>separator</i> 自身。</p>
<p>但是，如果 <i>separator</i> 是包含子表达式的正则表达式，那么返回的数组中包括与这些子表达式匹配的字串（但不包括与整个正则表达式匹配的文本）。</p>
</div>


<div>
<h2>提示和注释</h2>
<p class="note"><span>注释：</span>如果把空字符串 (&quot;&quot;) 用作 <i>separator</i>，那么 stringObject 中的每个字符之间都会被分割。</p>
<p class="note"><span>注释：</span>String.split() 执行的操作与 <a href="/jsref/jsref_join.asp" title="JavaScript join() 方法">Array.join</a> 执行的操作是相反的。</p>
</div>
...
<pre>var words = sentence.split(' ')</pre>

<p>或者使用正则表达式作为 separator：</p>
<pre>var words = sentence.split(/\s+/)</pre>

<h3>例子 4</h3>
<p>如果您希望把单词分割为字母，或者把字符串分割为字符，可使用下面的代码：</p>
<pre>&quot;hello&quot;.split(&quot;&quot;)	//可返回 [&quot;h&quot;, &quot;e&quot;, &quot;l&quot;, &quot;l&quot;, &quot;o&quot;]</pre>

<p>若只需要返回一部分字符，请使用 howmany 参数：</p>
<pre>&quot;hello&quot;.split(&quot;&quot;, 3)	//可返回 [&quot;h&quot;, &quot;e&quot;, &quot;l&quot;]</pre>
</div>
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=jseg_split_1">split()</a></dt>
<dd>如何使用 split() 来分割字符串。</dd>
</dl>
</div>
