...
<title>HTML DOM noHref 属性</title>
...
<div>
<h2>定义和用法</h2>
<p>noHref 属性可设置或返回某个区域是活动的还是非活动的。</p>

<h3>语法</h3>
<pre>areaObject.noHref=true|false</pre>

<h3>说明</h3>
<p>&lt;area&gt; 标签的 nohref 属性在客户端图像映射中定义了一个对鼠标敏感的区域，而该区域不会在用户选取它时采取任何操作。你必须为每个 &lt;area&gt; 标签都包含一个 href 或 nohref 属性。</p>
</div>

<div>
<h2>实例</h2>
<p>下面的例子可返回图像映射中 &quot;Venus&quot; 区域的 &quot;noHref&quot; 状态：</p>
<pre>&lt;html&gt;
&lt;body&gt;
...
document.write(<code>x.noHref</code>);
&lt;/script&gt;
&lt;/p&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_area_nohref">返回图像映射中某个区域的 noHref 状态</a></dt>
</dl>
</div>
