...
<div>
<h2>定义和用法</h2>
<p>metaKey 事件属性可返回一个布尔值，指示当事件发生时，&quot;meta&quot; 键是否被按下并保持住。</p>

<h3>语法</h3>
<pre>event.metaKey</pre>
</div>

<div>
<h2>实例</h2>
<p>下面的例子可提示当鼠标按键被点击时 &quot;meta&quot; 键是否被按住：</p>
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_event_metakey">metakey</a></dt>
<dd>检测 meta 键是否被按住（不支持 IE）。</dd>
</dl>
</div>
