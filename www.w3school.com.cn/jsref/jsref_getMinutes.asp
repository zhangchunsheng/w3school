...
<title>JavaScript getMinutes() 方法</title>
...
<h1>JavaScript getMinutes() 方法</h1>
...
<p>getMinutes() 方法可返回时间的分钟字段。</p>

<h3>语法</h3>

<pre>dateObject.getMinutes()</pre>

<h3>返回值</h3>

<p>dateObject 的分钟字段，以本地时间显示。返回值是 0 ~ 59 之间的一个整数。</p>
</div>

<div>
<h2>提示和注释：</h2>

<p class="note"><span>注释：</span>由 getMinutes() 返回的值是一个两位的数字。不过返回值不总是两位的，如果该值小于 10，则仅返回一位数字。</p>
