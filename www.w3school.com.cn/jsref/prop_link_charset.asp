...
<title>HTML DOM charset 方法</title>
...
<div>
<h2>定义和用法</h2>
<p>The charset property sets or returns the character encoding of the target URL.</p>

<h3>语法</h3>
<pre>linkObject.charset=character-encoding</pre>
</div>

<div>
<h2>实例</h2>
<p>The following example sets the character encoding of the target URL:</p>
<pre>&lt;html&gt;
&lt;head&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_link_charset">Set the character encoding of a &lt;link&gt; element</a></dt>
</dl>
</div>
