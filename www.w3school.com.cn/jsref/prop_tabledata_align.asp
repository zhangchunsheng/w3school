...
<div>
<h2>定义和用法</h2>
<p>align 属性可设置或返回表格单元内数据的水平排列方式。</p>

<h3>语法</h3>
<pre>tabledataObject.align=left|right|center</pre>
</div>

<div>
<h2>实例</h2>
<p>下面的例子把单元格的内容排列到了右边：</p>
<pre>&lt;html&gt;
&lt;head&gt;
&lt;script type=&quot;text/javascript&quot;&gt;
function alignCell()
  {
  <code>document.getElementById('td1').align=&quot;right&quot;</code>
  }
&lt;/script&gt;
&lt;/head&gt;
&lt;body&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_tablecell_align">更改 &lt;td&gt; 元素的排列方式</a></dt>
</dl>
</div>
