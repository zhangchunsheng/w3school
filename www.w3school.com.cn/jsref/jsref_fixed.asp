...
<title>JavaScript fixed() 方法</title>
...
<p>fixed() 方法用于把字符串显示为打字机字体。</p>

<h3>语法</h3>

<pre>stringObject.fixed()</pre>
</div>
...
<p>在本例中，&quot;Hello world!&quot; 将被显示为打字机文本：</p>
...
<dl>
<dt><a href="/tiy/t.asp?f=jseg_str_style">fixed()</a></dt>
<dd>如何使用 fixed() 把字符串显示为打字机字体。</dd>
</dl>
</div>
