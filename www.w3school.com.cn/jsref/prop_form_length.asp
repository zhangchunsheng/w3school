...
<div>
<h2>定义和用法</h2>
<p>length 属性可返回表单中元素的数目。</p>

<h3>语法</h3>
<pre>formObject.length</pre>
</div>

<div>
<h2>实例</h2>
<p>下面的例子可返回表单中元素的数目：</p>
<pre>&lt;html&gt;
&lt;body&gt;
...
document.write(<code>document.getElementById('myForm').length</code>);
&lt;/script&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_form_length">取得表单中元素的数目</a></dt>
</dl>
</div>
