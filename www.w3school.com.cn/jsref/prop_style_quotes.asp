...
<title>HTML DOM quotes 属性</title>
...
<div>
<h2>定义和用法</h2>
<p>quotes 属性设置嵌入引用的引号类型。</p>
<h3>语法：</h3>
<pre>Object.style.quotes=none|string string string string</pre>
...
<tr>
<td class="no_wrap">string string string string</td>
<td>定义要使用的引号。前两个值规定第一级引用嵌套，后两个值规定下一级引号嵌套。</td>
</tr>
</table>
</div>
