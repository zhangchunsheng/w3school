...
<div>
<h2>定义和用法</h2>
<p>dir 属性可设置或返回元素的文本方向。</p>

<h3>语法</h3>
<pre>bodyObject.dir=text-direction</pre>
</div>

<div>
<h2>实例</h2>
<p>下面的例子可展示两种设置 &lt;body&gt; 元素的文本方向的方法：</p>
<pre>&lt;html&gt;
&lt;body id=&quot;myid&quot; dir=&quot;rtl&quot;&gt;

&lt;script type=&quot;text/javascript&quot;&gt;
<code>x=document.getElementsByTagName('body')[0];</code>
document.write(&quot;Text direction: &quot; + <code>x.dir</code>);
document.write(&quot;&lt;br /&gt;&quot;);
document.write(&quot;An alternate way: &quot;);
document.write(<code>document.getElementById('myid').dir</code>);
&lt;/script&gt;
...
<p>输出：</p>
<pre>Text direction: rtl
An alternate way: rtl </pre>
</div>

<div class="example">
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_body_dir">返回 &lt;body&gt; 元素的文本方向</a></dt>
</dl>
</div>
