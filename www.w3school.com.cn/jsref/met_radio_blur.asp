...
<div>
<h2>定义和用法</h2>
<p>blur() 方法用于从单选按钮上移开焦点。</p>

<h3>语法</h3>
<pre>radioObject.blur()</pre>
</div>

<div>
<h2>实例</h2>
<p>下面的例子可设置或移开单选按钮上的焦点：</p>
<pre>&lt;html&gt;
&lt;head&gt;
&lt;script type=&quot;text/javascript&quot;&gt;
function setFocus()
  {
  <code>document.getElementById('male').focus()</code>
  }
function loseFocus()
  {
  <code>document.getElementById('male').blur()</code>
  }
&lt;/script&gt;
&lt;/head&gt;
&lt;body&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_radio_focus_blur">设置或移开单选按钮上的焦点</a></dt>
</dl>
</div>
