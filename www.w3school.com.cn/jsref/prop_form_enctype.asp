...
<title>HTML DOM enctype 属性</title>
...
<div>
<h2>定义和用法</h2>
<p>enctype 属性可设置或返回用于编码表单内容的 MIME 类型。</p>
<p>如果表单没有 enctype 属性，那么当提交文本时的默认值是 &quot;application/x-www-form-urlencoded&quot;。</p>
<p>当 input type 是 &quot;file&quot; 时，值是 &quot;multipart/form-data&quot;。</p>

<h3>语法</h3>
<pre>formObject.encoding=encoding</pre>
</div>
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_form_enctype">取得表单的编码类型。</a></dt>
</dl>
</div>
