...
<ul>
<li class="currentLink"><a href="/jsref/index.asp" title="JavaScript 参考手册">参考手册目录</a></li>
</ul>
<h2>JavaScript 对象</h2>
<ul>
...
<h1>JavaScript 参考手册</h1>


<div id="intro">
<p>本部分提供完整的 JavaScript 参考手册：</p>

<ul>
<li>JavaScript 本地对象和内置对象</li>
<li>Browser 对象（BOM）</li>
<li>HTML DOM 对象</li>
</ul>
</div>
...
<div>
<h2>JavaScript 对象参考手册</h2>
<p>本参考手册描述每个对象的属性和方法，并提供实例。</p>
<ul>
<li><a href="/jsref/jsref_obj_array.asp">Array</a></li>
<li><a href="/jsref/jsref_obj_boolean.asp">Boolean</a></li>
<li><a href="/jsref/jsref_obj_date.asp">Date</a></li>
<li><a href="/jsref/jsref_obj_math.asp">Math</a></li>
<li><a href="/jsref/jsref_obj_number.asp">Number</a></li>
<li><a href="/jsref/jsref_obj_string.asp">String</a></li>
<li><a href="/jsref/jsref_obj_regexp.asp">RegExp</a></li>
<li><a href="/jsref/jsref_obj_global.asp">Global</a></li>
</ul>
</div>


<div>
<h2>Browser 对象参考手册</h2>
<p>本参考手册描述每个对象的属性和方法，并提供实例。</p>
<ul>
<li><a href="/jsref/dom_obj_window.asp" title="HTML DOM Window 对象">Window</a></li>
<li><a href="/jsref/dom_obj_navigator.asp" title="HTML DOM Navigator 对象">Navigator</a></li>
...
<div>
<h2>HTML DOM 对象参考手册</h2>
<p>本参考手册描述每个对象的属性和方法，并提供实例。</p>
<ul>
<li><a href="/jsref/dom_obj_document.asp" title="HTML DOM Document 对象">Document</a></li>
<li><a href="/jsref/dom_obj_anchor.asp" title="HTML DOM Anchor 对象">Anchor</a></li>
<li><a href="/jsref/dom_obj_area.asp" title="HTML DOM Area 对象">Area</a></li>
<li><a href="/jsref/dom_obj_base.asp" title="HTML DOM Base 对象">Base</a></li>
<li><a href="/jsref/dom_obj_body.asp" title="HTML DOM Body 对象">Body</a></li>
<li><a href="/jsref/dom_obj_pushbutton.asp" title="HTML DOM Button 对象">Button</a></li>
<li><a href="/jsref/dom_obj_canvas.asp" title="HTML DOM Canvas 对象">Canvas</a></li>
<li><a href="/jsref/dom_obj_event.asp" title="HTML DOM Event 对象">Event</a></li>
<li><a href="/jsref/dom_obj_form.asp" title="HTML DOM Form 对象">Form</a></li>
<li><a href="/jsref/dom_obj_frame.asp" title="HTML DOM Frame 对象">Frame</a></li>
<li><a href="/jsref/dom_obj_frameset.asp" title="HTML DOM Frameset 对象">Frameset</a></li>
<li><a href="/jsref/dom_obj_iframe.asp" title="HTML DOM IFrame 对象">IFrame</a></li>
...
<li><a href="/jsref/dom_obj_style.asp" title="HTML DOM Style 对象">Style</a></li>
<li><a href="/jsref/dom_obj_table.asp" title="HTML DOM Table 对象">Table</a></li>
<li><a href="/jsref/dom_obj_tabledata.asp" title="HTML DOM TableCell 对象">TableCell</a></li>
<li><a href="/jsref/dom_obj_tablerow.asp" title="HTML DOM TableRow 对象">TableRow</a></li>
<li><a href="/jsref/dom_obj_textarea.asp" title="HTML DOM Textarea 对象">Textarea</a></li>
</ul>
</div>
...
<p>如需更多有关 JavaScript 对象的知识，请阅读 JavaScript 高级教程中的相关内容：</p>
<ul>
<li><a href="/js/pro_js_object_oriented.asp" title="ECMAScript 面向对象技术">面向对象技术</a></li>
...
<p>如需更多有关 DOM 的知识，请访问 W3School 提供的 XML DOM 教程：</p>
<ul>
<li><a href="/xmldom/index.asp" title="XML DOM 教程">XML DOM 教程</a></li>
<li><a href="/xmldom/xmldom_reference.asp" title="XML DOM 参考手册">XML DOM 参考手册</a></li>
</ul>

<p>如需更多有关 jQuery 的知识，请访问 W3School 提供的 jQuery 教程：</p>
<ul>
<li><a href="/jquery/index.asp">jQuery 教程</a></li>
<li><a href="/jquery/jquery_reference.asp">jQuery 参考手册</a></li>
</ul>

<p class="note"><span>注释：</span>jQuery 是一个 JavaScript 库，它极大地简化了 JavaScript 编程。</p>
