...
<title>HTML DOM scrollbarShadowColor 属性</title>
...
<h1>HTML DOM scrollbarShadowColor 属性</h1>
...
<div>
<h2>定义和用法</h2>
<p>scrollbarShadowColor 属性设置箭头和滚动条的右边和下边的颜色。</p>
<p class="tip"><span>提示：</span>该属性可与 scrollbarDarkShadowColor 一同使用，在滚动条上设置阴影效果。</p>

<h3>语法：</h3>
<pre>Object.style.scrollbarShadowColor=color</pre>
...
{
<code>document.body.style.scrollbarShadowColor=&quot;pink&quot;;</code>
}
&lt;/script&gt;
&lt;/head&gt; 
&lt;body&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_style_scrollbarshadowcolor">scrollbarShadowColor</a></dt>
</dl>
</div>
