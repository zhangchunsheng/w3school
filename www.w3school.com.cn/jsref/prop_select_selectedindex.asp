...
<title>HTML DOM selectedIndex 属性</title>
...
<h1>HTML DOM selectedIndex 属性</h1>
...
<div>
<h2>定义和用法</h2>
<p>selectedIndex 属性可设置或返回下拉列表中被选选项的索引号。</p>
<p class="note"><span>注释：</span>若允许多重选择，则仅会返回第一个被选选项的索引号。</p>

<h3>语法</h3>
<pre>selectObject.selectedIndex=number</pre>
</div>

<div>
<h2>实例</h2>
<p>下面的例子可提示出被选选项的索引号：</p>
<pre>&lt;html&gt;
&lt;head&gt;
&lt;script type=&quot;text/javascript&quot;&gt;
function getIndex()
  ...
  alert(<code>x.selectedIndex</code>)
  }
&lt;/script&gt;
&lt;/head&gt;
&lt;body&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_option_index">显示被选选项的索引号</a></dt>
<dt><a href="/tiy/t.asp?f=hdom_option_settext">设置下拉列表中被选选项的文本</a></dt>
<dt><a href="/tiy/t.asp?f=hdom_select_remove">从下拉列表中删除选项</a></dt>
</dl>
</div>
