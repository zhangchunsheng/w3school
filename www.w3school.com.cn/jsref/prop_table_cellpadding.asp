...
<title>HTML DOM cellPadding 属性</title>
...
<div>
<h2>定义和用法</h2>
<p>cellPadding 属性可设置或返回单元格边框与单元格内容之间的空白量（以像素为单位）。</p>

<h3>语法</h3>
<pre>tableObject.cellPadding=pixels</pre>
</div>

<div>
<h2>实例</h2>
<p>The following example changes the cell padding of a table:</p>
<pre>&lt;html&gt;
&lt;head&gt;
&lt;script type=&quot;text/javascript&quot;&gt;
function padding()
  {
  <code>document.getElementById('myTable').cellPadding=&quot;15&quot;</code>
  }
&lt;/script&gt;
&lt;/head&gt;
&lt;body&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_table_paddspac">更改表格的 cellPadding 和 cellSpacing</a></dt>
</dl>
</div>
