...
<title>HTML DOM TableRow 对象</title>
...
<li class="currentLink"><a href="/jsref/dom_obj_tablerow.asp" title="HTML DOM TableRow 对象">&lt;tr&gt;</a></li>
...
<h1>HTML DOM TableRow 对象</h1>


<div>
<h2>TableRow 对象</h2>

<p>TableRow 对象代表一个 HTML 表格行。</p>

<p>在 HTML 文档中 &lt;tr&gt; 标签每出现一次，一个 TableRow 对象就会被创建。</p>
</div>
...
<table class="dataintable">
  ...
  <tr>
    <td><a href="/jsref/prop_tablerow_align.asp">align</a></td>
    <td>设置或返回在行中数据的水平排列。</td>
  </tr>
  <tr>
    <td>ch</td>
    <td>设置或返回在行中单元格的对齐字符。</td>
  </tr>
  <tr>
    <td>chOff</td>
    <td>设置或返回在行中单元格的对齐字符的偏移量。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_tablerow_id.asp">id</a></td>
    <td>设置或返回行的 id。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_tablerow_innerhtml.asp">innerHTML</a></td>
    <td>设置或返回行的开始标签和结束标签之间的 HTML。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_tablerow_rowindex.asp">rowIndex</a></td>
    <td>返回该行在表中的位置。</td>
  </tr>
  <tr>
    <td>sectionRowIndex</td>
    <td>返回在 tBody 、tHead 或 tFoot 中，行的位置。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_tablerow_valign.asp">vAlign</a></td>
    <td>设置或返回在行中的数据的垂直排列方式。</td>
  </tr>
</table>
</div>
...
<table class="dataintable">
  ...
  <tr>
    <td><a href="/jsref/met_tablerow_deletecell.asp">deleteCell()</a></td>
    <td>删除行中的指定的单元格。</td>
  </tr>
  <tr>
    <td><a href="/jsref/met_tablerow_insertcell.asp">insertCell()</a></td>
    <td>在一行中的指定位置插入一个空的 &lt;td&gt; 元素。</td>
  </tr>
</table>
</div>
