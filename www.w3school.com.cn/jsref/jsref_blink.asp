...
<title>JavaScript blink() 方法</title>
...
<p>blink() 方法用于显示闪动的字符串。</p>

<h3>语法</h3>

<pre>stringObject.blink()</pre>
</div>
...
<p class="note"><span>注释：</span>此方法无法工作于 Internet Explorer 中。</p>
</div>
...
<p>在本例中，&quot;Hello world!&quot; 将被显示为闪动的文本：</p>
...
<dl>
<dt><a href="/tiy/t.asp?f=jseg_str_style">blink()</a></dt>
<dd>如何使用 blink() 来显示闪动的文本。</dd>
</dl>
</div>
