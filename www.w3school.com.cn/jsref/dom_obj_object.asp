...
<title>HTML DOM Object 对象</title>
...
<li class="currentLink"><a href="/jsref/dom_obj_object.asp" title="HTML DOM Object 对象">&lt;object&gt;</a></li>
...
<h1>HTML DOM Object 对象</h1>


<div>
<h2>Object 对象</h2>

<p>Object 对象代表 HTML 的 &lt;object&gt; 元素。</p>

<p>&lt;object&gt; 元素用于在网页中包含对象，比如：图像、音频、视频、Java applet、ActiveX、PDF、Flash 等。</p>
</div>
...
<table class="dataintable">
  ...
  <tr>
    <td>align</td>
    <td>设置或返回对象相对于周围文本的对齐方式。</td>
  </tr>
  <tr>
    <td>archive</td>
    <td>设置或返回一个字符串，用于实现对象的存档功能。</td>
  </tr>
  <tr>
    <td>border</td>
    <td>设置或返回围绕对象的边框。</td>
  ...
  <tr>
    <td>code</td>
    <td>设置或返回文件的 URL，该文件包含已编译的 Java 类。</td>
  </tr>
  <tr>
    <td>codeBase</td>
    <td>设置或返回组件的 URL。</td>
  ...
  <tr>
    <td>standby</td>
    <td>设置或返回在加载对象时返回的消息。</td>
  </tr>
  <tr>
    <td>type</td>
    <td>设置或返回通过 data 属性下载的数据的内容类型。</td>
  </tr>
  <tr>
    <td>useMap</td>
    <td>&nbsp;</td>
