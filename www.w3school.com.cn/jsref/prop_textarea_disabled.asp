...
<div>
<h2>定义和用法</h2>
<p>disabled 属性可设置或返回是否应禁用文本框。</p>

<h3>语法</h3>
<pre>textareaObject.disabled=true|false</pre>
</div>
...
function disable()
  {
  <code>document.getElementById('txt1').disabled=true;</code>
  }
function enable()
  {
  <code>document.getElementById('txt1').disabled=false;</code>
  }
&lt;/script&gt;
&lt;/head&gt;
&lt;body&gt;
