...
<li class="currentLink"><a href="/jsref/dom_obj_pushbutton.asp" title="HTML DOM Button 对象">&lt;button&gt;</a></li>
...
<p>在 HTML 文档中 &lt;button&gt; 标签每出现一次，Button 对象就会被创建。</p>
</div>
...
<table class="dataintable">
  ...
  <tr>
    <td><a href="/jsref/prop_pushbutton_accesskey.asp">accessKey</a></td>
    <td>设置或返回访问某个按钮的快捷键。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_pushbutton_disabled.asp">disabled</a></td>
    <td>设置或返回是否禁用按钮。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_pushbutton_form.asp">form</a></td>
    <td>返回对包含按钮的表单的引用。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_pushbutton_id.asp">id</a></td>
    <td>设置或返回按钮的 id。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_pushbutton_name.asp">name</a></td>
    <td>设置或返回按钮的名称。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_pushbutton_tabindex.asp">tabIndex</a></td>
    <td>设置或返回按钮的 Tab 键控制次序。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_pushbutton_type.asp">type</a></td>
    <td>返回按钮的表单类型。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_pushbutton_value.asp">value</a></td>
    <td>设置或返回显示在按钮上的文本。</td>
  </tr>
</table>
</div>
