...
<title>HTML DOM borderColor 属性</title>
...
<div>
<h2>定义和用法</h2>
<p>borderColor 属性设置元素周围边框的颜色。</p>

<p>本属性可使用 1 到 4 种颜色：</p>

<ul>
	<li>如果规定一种颜色，比如 table {border-color: red} - 所有的边框都是红色。</li>
	<li>如果规定了两种颜色，比如 table {border-color: red green} - 上边框和下边框是红色，而左边框和右边框是绿色。</li>
	<li>如果规定了三种颜色，比如 table {border-color: red green blue}- 上边框是红色，左边框和右边框是绿色，下边框是蓝色。</li>
	<li>如果规定了四种颜色，比如 table {border-color: red green blue yellow} - 上边框是红色，右边框是绿色，下边框是蓝色，左边框是黄色。</li>
</ul>

<h3>语法：</h3>
<pre>Object.style.borderColor=color-name|color-rgb|color-hex|transparent</pre>
</div>
...
{
<code>document.getElementById(&quot;p1&quot;).style.borderColor=&quot;#0000FF #00FF00&quot;;</code>
}
&lt;/script&gt;
&lt;/head&gt;
&lt;body&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_style_bordercolor">borderColor - 改变边框的颜色</a></dt>
</dl>
</div>
