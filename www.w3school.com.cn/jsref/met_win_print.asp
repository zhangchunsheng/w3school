...
<div>
<h2>定义和用法</h2>
<p>print() 方法用于打印当前窗口的内容。</p>
<p>调用 print() 方法所引发的行为就像用户单击浏览器的打印按钮。通常，这会产生一个对话框，让用户可以取消或定制打印请求。</p>
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_print">打印页面</a></dt>
</dl>
</div>
