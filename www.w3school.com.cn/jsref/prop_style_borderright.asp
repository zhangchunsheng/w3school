...
<title>HTML DOM borderRight 属性</title>
...
<div>
<h2>定义和用法</h2>
<p>borderRight 属性在一个声明中为右边框设置所有属性。</p>

<h3>语法：</h3>
<pre>Object.style.borderRight=borderWidth borderStyle borderColor</pre>
...
{
<code>document.getElementById(&quot;p1&quot;).style.borderRight=&quot;thick solid #0000FF&quot;;</code>
}
&lt;/script&gt;
&lt;/head&gt;
&lt;body&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_style_borderright">borderRight - 改变右边框的宽度、样式和颜色</a></dt>
</dl>
</div>
