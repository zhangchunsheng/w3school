...
<title>HTML DOM hspace 属性</title>
...
<h1>HTML DOM hspace 属性</h1>

<div class="backtoreference">
<p><a href="/jsref/dom_obj_image.asp">HTML DOM Image 对象</a></p>
</div>

<div>
<h2>定义和用法</h2>

<p>hspace 属性可设置或返回图像的左边缘和右边缘的空白。</p>
<p>hspace 和 vspace 属性可与 align 一同使用，来设置图像与周围文本的距离。</p>

<h3>语法</h3>
<pre>imageObject.hspace=pixels</pre>
</div>

<div>
<h2>实例</h2>
<p>下面的例子将设置图像的 hspace 和 vspace 属性：</p>
<pre>&lt;html&gt;
&lt;head&gt;
&lt;script type=&quot;text/javascript&quot;&gt;
function setSpace()
{
<code>document.getElementById(&quot;compman&quot;).hspace=&quot;50&quot;
document.getElementById(&quot;compman&quot;).vspace=&quot;50&quot;</code>
}
&lt;/script&gt;
&lt;/head&gt;
&lt;body&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_image_hspace_vspace">设置图像的水平和垂直定位</a></dt>
</dl>
</div>
