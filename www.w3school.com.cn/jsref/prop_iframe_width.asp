...
<div>
<h2>定义和用法</h2>
<p>width 属性可设置或返回 iframe 的宽度（以像素或百分比为单位）。</p>

<h3>语法</h3>
<pre>iframeObject.width=pixels</pre>
</div>

<div>
<h2>实例</h2>
<p>下面的例子可更改 iframe 的宽度：</p>
<pre>&lt;html&gt;
&lt;head&gt;
&lt;script type=&quot;text/javascript&quot;&gt;
function changeWidth()
{
<code>document.getElementById(&quot;frame1&quot;).width=&quot;100&quot;;</code>
}
&lt;/script&gt;
&lt;/head&gt;
&lt;body&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_iframe_height_width">更改 iframe 的高度和宽度</a></dt>
</dl>
</div>
