...
<div>
<h2>定义和用法</h2>
<p>border 属性可设置或返回表格边框的宽度（以像素为单位）。</p>

<h3>语法</h3>
<pre>tableObject.border=pixels</pre>
</div>
...
function changeBorder()
  {
  <code>document.getElementById('myTable').border=&quot;10&quot;</code>
  }
&lt;/script&gt;
&lt;/head&gt;
&lt;body&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_table_border">更改表格边线的宽度</a></dt>
</dl>
</div>
