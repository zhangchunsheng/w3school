...
<title>HTML DOM referrer 属性</title>
...
<div>
<h2>定义和用法</h2>
<p>referrer 属性可返回载入当前文档的文档的 URL。</p>

<h3>语法</h3>
<pre>document.referrer</pre>

<h3>说明</h3>
<p>如果当前文档不是通过超级链接访问的，则为 null。这个属性允许客户端 JavaScript 访问 HTTP 引用头部。</p>
</div>
...
&lt;script type=&quot;text/javascript&quot;&gt;
document.write(<code>document.referrer</code>)
&lt;/script&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_document_referrer">返回当前文档的 referrer</a></dt>
</dl>
</div>
