...
<div>
<h2>定义和用法</h2>
<p>blur() 方法用于从 checkbox 上移开焦点。</p>

<h3>语法</h3>
<pre>checkboxObject.blur()</pre>
</div>

<div>
<h2>实例</h2>
<p>下面的例子可设置并移开 checkbox 上的焦点：</p>
<pre>&lt;html&gt;
&lt;head&gt;
&lt;script type=&quot;text/javascript&quot;&gt;
function setFocus()
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_checkbox_focus_blur">设置并移开 checkbox 上的焦点</a></dt>
</dl>
</div>
