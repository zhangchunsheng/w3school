...
<title>HTML DOM Anchor 对象</title>
...
<h2>HTML 对象</h2>
<ul>
<li class="currentLink"><a href="/jsref/dom_obj_anchor.asp" title="HTML DOM Anchor 对象">&lt;a&gt;</a></li>
...
<h1>HTML DOM Anchor 对象</h1>


<div>
<h2>Anchor 对象</h2>

<p>Anchor 对象表示 HTML 超链接。</p>
...
<table class="dataintable">
  ...
  <tr>
    <td><a href="/jsref/prop_anchor_accesskey.asp">accessKey</a></td>
    <td>设置或返回访问一个链接的快捷键。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_anchor_charset.asp">charset</a></td>
    <td>设置或返回被链接资源的字符集。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_anchor_coords.asp">coords</a></td>
    <td>设置或返回逗号分隔列表，包含了图像映射中链接的坐标。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_anchor_href.asp">href</a></td>
    <td>设置或返回被链接资源的 URL。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_anchor_hreflang.asp">hreflang</a></td>
    <td>设置或返回被链接资源的语言代码。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_anchor_id.asp">id</a></td>
    <td>设置或返回一个链接的 id。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_anchor_innerhtml.asp">innerHTML</a></td>
    <td>设置或返回一个链接的内容。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_anchor_name.asp">name</a></td>
    <td>设置或返回一个链接的名称。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_anchor_rel.asp">rel</a></td>
    <td>设置或返回当前文档与目标 URL 之间的关系。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_anchor_rev.asp">rev</a></td>
    <td>设置或返回目标 URL 与之间当前文档的关系。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_anchor_shape.asp">shape</a></td>
    <td>设置或返回图像映射中某个链接的形状。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_anchor_tabindex.asp">tabIndex</a></td>
    <td>设置或返回某个链接的 Tab 键控制次序。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_anchor_target.asp">target</a></td>
    <td>设置或返回在何处打开链接。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_anchor_type.asp">type</a></td>
...
<table class="dataintable">
  ...
  <tr>
    <td><a href="/jsref/met_anchor_blur.asp">blur()</a></td>
    <td>把焦点从链接上移开。</td>
  </tr>
  <tr>
    <td><a href="/jsref/met_anchor_focus.asp">focus()</a></td>
    <td>给链接应用焦点。</td>
  </tr>
</table>
</div>
