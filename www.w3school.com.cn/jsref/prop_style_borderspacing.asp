...
<title>HTML DOM borderSpacing 属性</title>
...
<h1>HTML DOM borderSpacing 属性</h1>
...
<div>
<h2>定义和用法</h2>
<p>borderSpacing 属性相邻单元格的边框之间的距离（仅用于“边框分离”模式）。</p>

<h3>语法：</h3>
<pre>Object.style.borderSpacing=length,length</pre>
...
<tr>
<td class="no_wrap">length length</td>
<td>使用 px、cm 等单位定义距离。如果定义一个 length 参数，那么定义的是水平和垂直间距。如果定义了两个 length 参数，那么第一个设置水平间距，而第二个设置垂直间距。length 不能为负值。</td>
</tr>
...
{
<code>document.getElementById('myTable').style.borderSpacing=&quot;10px&quot;</code>
}
&lt;/script&gt;
&lt;/head&gt;
&lt;body&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_style_borderspacing">borderSpacing - 改变相邻单元格的边框之间的距离</a>（请在非 IE 浏览器中查看）</dt>
</dl>
</div>
