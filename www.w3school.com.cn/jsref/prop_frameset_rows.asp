...
<div>
<h2>定义和用法</h2>
<p>rows 属性可设置或返回框架中行的数目和尺寸。</p>
<p>由逗号分割的像素或百分比列表定义了列的数目和高度：</p>

<h3>语法</h3>
<pre>framesetObject.rows=row1,row2,row3....</pre>
</div>
...
<p>HTML 文档 &quot;frame_rows.htm&quot; 被放入第一列，而 HTML 文档 &quot;frame_a.htm&quot; 被放入第二列。</p>
<p>下面是 &quot;frame_rows.htm&quot; 的源代码：</p>
...
function changeRows()
  {
  <code>parent.document.getElementById(&quot;main&quot;).rows=&quot;30%,70%&quot;</code>
  }

function restoreRows()
  {
  <code>parent.document.getElementById(&quot;main&quot;).rows=&quot;50%,50%&quot;</code>
  }
&lt;/script&gt;
&lt;/head&gt;
&lt;body&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_frameset_rows">更改框架集的行尺寸</a></dt>
</dl>
</div>
