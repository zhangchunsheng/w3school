...
<p><a href="/jsref/dom_obj_reset.asp" title="HTML DOM Reset 对象">HTML DOM Reset 对象</a></p>
</div>

<div>
<h2>定义和用法</h2>
<p>accessKey 属性可设置或返回访问重置按钮的快捷键。</p>
<p class="note"><span>注释：</span>请使用 <em>Alt + accessKey</em> 为拥有指定快捷键的元素赋予焦点。</p>
<h3>语法</h3>
<pre>resetObject.accessKey=accessKey</pre>
</div>

<div>
<h2>实例</h2>
<p>下面的例子可返回重置按钮的快捷键：</p>
<pre>&lt;html&gt;
&lt;body&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_reset_accesskey">返回重置按钮的快捷键</a></dt>
</dl>
</div>
