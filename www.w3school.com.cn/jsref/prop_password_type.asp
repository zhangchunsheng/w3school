...
<div>
<h2>定义和用法</h2>
<p>type 属性可设置表单元素的类型。对于密码域，该属性总是 &quot;password&quot;。</p>

<h3>语法</h3>
<pre>passwordObject.type</pre>
</div>

<div>
<h2>实例</h2>
<p>下面的例子返回了该密码域的表单元素类型：</p>
<pre>&lt;html&gt;
&lt;body&gt;
...
document.write(<code>x.type</code>);
&lt;/script&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_password_type">取得密码域的表单元素类型</a></dt>
</dl>
</div>
