...
<title>HTML DOM getContext() 方法</title>
...
<h1>HTML DOM getContext() 方法</h1>

<div class="backtoreference">
<p><a href="/jsref/dom_obj_canvas.asp">HTML DOM Canvas 对象</a></p>
</div>

<div>
<h2>定义和用法</h2>
<p>getContext() 方法返回一个用于在画布上绘图的环境。</p>

<h3>语法</h3>
<pre>Canvas.getContext(<i>contextID</i>)</pre>

<h3>参数</h3>
<p>参数 <i>contextID</i> 指定了您想要在画布上绘制的类型。当前唯一的合法值是 &quot;2d&quot;，它指定了二维绘图，并且导致这个方法返回一个环境对象，该对象导出一个二维绘图 API。</p>

<p class="tip"><span>提示：</span>在未来，如果 &lt;canvas&gt; 标签扩展到支持 3D 绘图，getContext() 方法可能允许传递一个 &quot;3d&quot; 字符串参数。</p>

<h3>返回值</h3>
<p>一个 CanvasRenderingContext2D 对象，使用它可以绘制到 Canvas 元素中。</p>

<h3>描述</h3>
<p>返回一个表示用来绘制的环境类型的环境。其本意是要为不同的绘制类型（2 维、3 维）提供不同的环境。当前，唯一支持的是 &quot;2d&quot;，它返回一个 CanvasRenderingContext2D 对象，该对象实现了一个画布所使用的大多数方法。</p>
</div>
