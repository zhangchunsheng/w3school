...
<h3>语法</h3>
<pre>onkeypress=&quot;SomeJavaScriptCode&quot;</pre>
...
<pre>document, image, link, textarea</pre>
</div>


<div>
<h2>提示和注释</h2>
<p class="note"><span>浏览器差异：</span>Internet Explorer 使用 event.keyCode 取回被按下的字符，而 Netscape/Firefox/Opera 使用 event.which。</p>
</div>
...
if(window.event) <span>// IE</span>
  {
  <code>keynum = e.keyCode</code>
  }
else if(e.which) <span>// Netscape/Firefox/Opera</span>
  {
  <code>keynum = e.which</code>
  }
...
&lt;form&gt;
&lt;input type=&quot;text&quot; <code>onkeypress=&quot;return noNumbers(event)&quot;</code> /&gt;
&lt;/form&gt;
...
<form>
<p><input type="text" onkeypress="return noNumbers(event)" /></p>
</form>
</div>
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_onkeypress">onkeypress</a></dt>
<dd>如何使用 onkeypress</dd>
</dl>
</div>
