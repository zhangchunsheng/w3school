...
<title>HTML DOM pageBreakInside 属性</title>
...
<h1>HTML DOM pageBreakInside 属性</h1>
...
<div>
<h2>定义和用法</h2>
<p>pageBreakInside 声明一个元素内部是否应当放置分页符。</p>

<h3>语法：</h3>
<pre>Object.style.pageBreakInside=auto|avoid</pre>
...
<div>
<h2>实例</h2>
<p>本例避免在 id 为 p2 的段落中的 page-break：</p>
...
{
<code>document.getElementById(&quot;p2&quot;).style.pageBreakInside=&quot;avoid&quot;;</code>
}
&lt;/script&gt;
&lt;/head&gt;
&lt;body&gt;
