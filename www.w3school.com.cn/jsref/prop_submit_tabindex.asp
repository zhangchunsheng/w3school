...
<p><a href="/jsref/dom_obj_submit.asp" title="HTML DOM Submit 对象">HTML DOM Submit 对象</a></p>
</div>

<div>
<h2>定义和用法</h2>
<p>tabIndex 属性可设置或返回确认按钮的 tab 键控制次序。</p>

<h3>语法</h3>
<pre>submitObject.tabIndex=tabIndex</pre>
</div>
...
function showTabIndex()
  ...
  var r1=<code>document.getElementById('submit1').tabIndex;</code>
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_submit_tabindex">显示表单元素的 tab 键控制次序</a></dt>
</dl>
</div>
