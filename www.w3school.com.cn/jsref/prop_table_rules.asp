...
<div>
<h2>定义和用法</h2>
<p>rules 属性可设置或返回表格的内部边线。</p>

<h3>语法</h3>
<pre>tableObject.rules=none|groups|rows|cols|all</pre>
</div>

<div>
<h2>实例</h2>
<p>下面的例子设置了表格的两种不同的内部边线：</p>
<pre>&lt;html&gt;
&lt;head&gt;
&lt;script type=&quot;text/javascript&quot;&gt;
function rowRules()
  {
  <code>document.getElementById('myTable').rules=&quot;rows&quot;</code>
  }
function colRules()
  {
  <code>document.getElementById('myTable').rules=&quot;cols&quot;</code>
  }
&lt;/script&gt;
&lt;/head&gt;
&lt;body&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_table_rules">规定表格的内部边线</a></dt>
</dl>
</div>
