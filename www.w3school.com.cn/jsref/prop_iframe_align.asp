...
<div>
<h2>定义和用法</h2>
<p>align 属性可设置或返回如何根据周围的文本来排列 iframe。</p>

<h3>语法</h3>
<pre>iframeObject.align=left|right|top|middle|bottom</pre>
</div>

<div>
<h2>实例</h2>
<p>下面的例子将把 iframe 根据环绕文本排列到右侧：</p>
<pre>&lt;html&gt;
&lt;body&gt;
...
&lt;script type=&quot;text/javascript&quot;&gt;
<code>document.getElementById(&quot;frame1&quot;).align=&quot;right&quot;;</code>
&lt;/script&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_iframe_align">设置 &lt;iframe&gt; 的排列方式</a></dt>
</dl>
</div>
