...
<div>
<h2>定义和用法</h2>
<p>search 属性可设置或返回某个区域中 link-URL 的查询字符串部分。</p>

<h3>语法</h3>
<pre>areaObject.search=querystring</pre>
</div>

<div>
<h2>实例</h2>
<p>下面的例子可返回 &quot;Venus&quot; 中的 link-URL 的查询字符串部分：</p>
<pre>&lt;html&gt;
&lt;body&gt;
...
document.write(<code>x.search</code>)
&lt;/script&gt;
&lt;/p&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_area_search">返回图像映射中某个区域的链接的查询字符串部分</a></dt>
</dl>
</div>
