...
<title>JavaScript charCodeAt() 方法</title>
...
<h1>JavaScript charCodeAt() 方法</h1>
...
<p>charCodeAt() 方法可返回指定位置的字符的 Unicode 编码。这个返回值是 0 - 65535 之间的整数。</p>

<p>方法 charCodeAt() 与 charAt() 方法执行的操作相似，只不过前者返回的是位于指定位置的字符的编码，而后者返回的是字符子串。</p>

<h3>语法</h3>

<pre>stringObject.charCodeAt(index)</pre>
...
<p class="note"><span>注释：</span>字符串中第一个字符的下标是 0。如果 index 是负数，或大于等于字符串的长度，则 charCodeAt() 返回 NaN。</p>
</div>
...
<p>在字符串 &quot;Hello world!&quot; 中，我们将返回位置 1 的字符的 Unicode 编码：</p>
...
<dl>
<dt><a href="/tiy/t.asp?f=jseg_charcodeat">charCodeAt()</a></dt>
<dd>如何使用 charCodeAt() 来获得字符串中某个具体字符的 Unicode 编码。</dd>
</dl>
</div>
