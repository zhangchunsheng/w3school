...
<title>JavaScript toLocaleUpperCase() 方法</title>
...
<h1>JavaScript toLocaleUpperCase() 方法</h1>
...
<h3>语法</h3>
<pre>stringObject.toLocaleUpperCase()</pre>

<h3>返回值</h3>
<p>一个新的字符串，在其中 stringObject 的所有小写字符全部被转换为了大写字符。</p>

<h3>说明</h3>
<p>与 toUpperCase() 不同的是，toLocaleUpperCase() 方法按照本地方式把字符串转换为大写。只有几种语言（如土耳其语）具有地方特有的大小写映射，所有该方法的返回值通常与 toUpperCase() 一样。</p>
</div>
