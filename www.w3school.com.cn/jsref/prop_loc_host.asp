...
<div>
<h2>定义和用法</h2>
<p>host 属性是一个可读可写的字符串，可设置或返回当前 URL 的主机名称和端口号。</p>
...
&lt;script type=&quot;text/javascript&quot;&gt;
document.write(<code>location.host</code>);
&lt;/script&gt;
...
<p>输出：</p>
<pre>example.com:1234</pre>
</div>

<div class="example">
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_loc_host">使用 location 对象的 host 属性</a></dt>
</dl>
</div>
