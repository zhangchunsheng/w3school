...
<title>JavaScript setMinutes() 方法</title>
...
<h1>JavaScript setMinutes() 方法</h1>
...
<p>setMinutes() 方法用于设置指定时间的分钟字段。</p>

<h3>语法</h3>

<pre>dateObject.setMinutes(min,sec,millisec)</pre>
...
<table class="dataintable"> 
  ...
  <tr>
    <td>min</td>
    <td>必需。表示分钟的数值，介于 0 ~ 59 之间，以本地时间计（下同）。</td>
  </tr>
  <tr>
    <td>sec</td>
    ...
    <tr>
    <td>millisec</td>
    <td>可选。表示毫秒的数值，介于 0 ~ 999 之间。在 EMCAScript 标准化之前，不支持该参数。</td>
  </tr>
</table>
...
<p>在本例中，我们将通过 setMinutes() 方法把当前时间的分钟字段设置为 01：</p>
...
<dl>
<dt><a href="/tiy/t.asp?f=jseg_setminutes">setMinutes()</a></dt>
<dd>如何使用 setMinutes() 来设置当前时间的分钟。</dd>
</dl>
</div>
