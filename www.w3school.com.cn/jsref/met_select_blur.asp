...
<div>
<h2>定义和用法</h2>
<p>focus() 方法用于从下拉列表中移开焦点。</p>

<h3>语法</h3>
<pre>selectObject.blur()</pre>
</div>

<div>
<h2>实例</h2>
<p>下面的例子可设置或从下拉列表移开焦点：</p>
<pre>&lt;html&gt;
&lt;head&gt;
&lt;script type=&quot;text/javascript&quot;&gt;
function setFocus()
  {
  <code>document.getElementById('select1').focus()</code>
  }
function loseFocus()
  {
  <code>document.getElementById('select1').blur()</code>
  }
&lt;/script&gt;
&lt;/head&gt;
&lt;body&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_select_focus_blur">设置并从下拉列表移开焦点</a></dt>
</dl>
</div>
