...
<h3>语法</h3>
<pre>onkeydown=&quot;SomeJavaScriptCode&quot;</pre>
...
if(window.event) <span>// IE</span>
  {
  keynum = <code>e.keyCode</code>
  }
else if(e.which) <span>// Netscape/Firefox/Opera</span>
  {
  keynum = <code>e.which</code>
  }
...
&lt;form&gt;
&lt;input type=&quot;text&quot; <code>onkeydown=&quot;return noNumbers(event)&quot;</code> /&gt;
&lt;/form&gt;
...
<form>
<p><input type="text" onkeydown="return noNumbers(event)" /></p>
</form>
</div>
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_onkeydown">onkeydown</a></dt>
<dd>如何使用 onkeydown。</dd>
</dl>
</div>
