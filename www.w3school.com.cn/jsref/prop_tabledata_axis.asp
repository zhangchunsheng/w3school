...
<div>
<h2>定义和用法</h2>
<p>axis 属性可设置或返回一个由逗号分隔的列表，其中包含了一组类型（有关联的单元格）的名称。</p>
<p>axis 属性可为某个单元格定义类型名称。</p>

<h3>语法</h3>
<pre>tabledataObject.axis=text</pre>
</div>

<div>
<h2>实例</h2>
<p>下面的例子可返回单元格的 axis：</p>
<pre>&lt;&lt;html&gt;
&lt;head&gt;
&lt;script type=&quot;text/javascript&quot;&gt;
function alertAxis()
  {
  alert(<code>document.getElementById('td3').axis</code>);
  }
&lt;/script&gt;
&lt;/head&gt;
&lt;body&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_tablecell_axis">显示表元的 axis</a></dt>
</dl>
</div>
