...
<div>
<h2>定义和用法</h2>
<p>disabled 属性可设置或返回是否禁用单选按钮。</p>

<h3>语法</h3>
<pre>radioObject.disabled=true|false</pre>
</div>
...
function disable()
  {
  <code>document.getElementById(&quot;gnome&quot;).disabled=true</code>
  }
&lt;/script&gt;
&lt;/head&gt;
&lt;body&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_radio_disabled">禁用某个单选按钮</a></dt>
</dl>
</div>
