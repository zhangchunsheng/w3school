...
<title>JavaScript multiline 属性</title>
...
<p>multiline 属性用于返回正则表达式是否具有标志 m。</p>

<p>它声明了给定的正则表达式是否以多行模式执行模式匹配。</p>

<p>在这种模式中，如果要检索的字符串中含有换行符，^ 和 $ 锚除了匹配字符串的开头和结尾外还匹配每行的开头和结尾。</p>

<p>例如，模式 /W3School$/im 匹配 &quot;w3school&quot; 和 &quot;W3School\nisgreat&quot;。（\n 是换行符\u000A）。</p>

<p>如果 m 标志被设置，则该属性为 true，否则为 false。</p>

<h3>语法</h3>

<pre>RegExpObject.multiline</pre>
</div>
...
<p>在下面的例子中，我们将查看正则表达式是否具有标志 m：</p>
...
<dl>
<dt><a href="/tiy/t.asp?f=jseg_multiline_regexp">multiline</a></dt>
<dd>如何使用 multiline 属性来检测正则表达式是否具有标志 m。</dd>
</dl>
</div>
