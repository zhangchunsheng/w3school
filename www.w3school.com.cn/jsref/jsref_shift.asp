...
<title>JavaScript shift() 方法</title>
...
<p class="tip"><span>提示：</span>要删除并返回数组的最后一个元素，请使用 pop() 方法。</p>
</div>
	
<div>
<h2>实例</h2>

<p>在本例中，我们将创建一个数组，并删除数组的第一个元素。请注意，这也将改变数组的长度：</p>
...
document.write(<code>arr.shift()</code> + &quot;&lt;br /&gt;&quot;)
document.write(arr)
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=jseg_shift">shift()</a></dt>
<dd>如何使用 shift() 删除并返回数组的第一个元素。</dd>
</dl>
</div>
