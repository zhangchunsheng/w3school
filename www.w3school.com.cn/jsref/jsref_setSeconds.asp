...
<title>JavaScript setSeconds() 方法</title>
...
<h1>JavaScript setSeconds() 方法</h1>
...
<p>The setSeconds() method is used to set the seconds of a specified time.</p>

<h3>语法</h3>

<pre>dateObject.setSeconds(sec,millisec)</pre>
...
<table class="dataintable"> 
  ...
  <tr>
    <td>sec</td>
    <td>必需。表示秒的数值，该值是介于 0 ~ 59 之间的整数。</td>
  </tr>
    <tr>
    <td>millisec</td>
...
<p>在本例中，我们将通过 setSeconds() 方法把当前时间的秒字段设置为 01：</p>
...
<dl>
<dt><a href="/tiy/t.asp?f=jseg_setseconds">setSeconds()</a></dt>
<dd>如何使用 setSeconds() 来设置当前时间的秒。</dd>
</dl>
</div>
