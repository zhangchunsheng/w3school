...
<title>JavaScript setUTCDate() 方法</title>
...
<h1>JavaScript setUTCDate() 方法</h1>
...
<p>setUTCDate() 方法用于根据世界时 (UTC) 设置一个月中的某一天。</p>

<h3>语法</h3>

<pre>dateObject.setUTCDate(day)</pre>
...
<table class="dataintable"> 
  ...
  <tr>
    <td>day</td>
    <td>必需。要给 dateObject 设置的一个月中的某一天，用世界时表示。该参数是 1 ~ 31 之间的整数。</td>
  </tr>
</table>
...
<p>在本例中，我们将通过 setUTCDate() 方法把当前月的天字段设置为 15：</p>
...
<dl>
<dt><a href="/tiy/t.asp?f=jseg_setutcdate">setUTCDate()</a></dt>
<dd>如何使用 setUTCDate() 来设置此月的天。</dd>
</dl>
</div>
