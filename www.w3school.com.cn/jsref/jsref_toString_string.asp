...
<div>
<h2>定义和用法</h2>
<p>toString() 方法返回字符串。</p>

<h3>语法</h3>
<pre>stringObject.toString()</pre>

<h3>返回值</h3>
<p>stringObject 的原始字符串值。一般不会调用该方法。</p>

<h3>抛出</h3>
<p>当调用该方法的对象不是 String 时抛出 TypeError 异常。</p>

<h3>参阅</h3>
<p>
<a href="/jsref/jsref_toString_array.asp">array.toString()</a>
、
<a href="/jsref/jsref_toString_boolean.asp">boolean.toString()</a>
、
<a href="/jsref/jsref_toString_date.asp">date.toString()</a>
、
<a href="/jsref/jsref_tostring_number.asp">Number.toString()</a>
</p>

<p>
<a href="/jsref/jsref_toLocaleString_array.asp">array.toLocaleString()</a>
、
<a href="/jsref/jsref_toLocaleString.asp">date.toLocaleString()</a>
、
<a href="/jsref/jsref_tolocalestring_number.asp">Number.toLocaleString()</a>
</p>

<p><a href="/jsref/jsref_valueOf_string.asp">stringObject.valueOf()</a></p>
</div>
