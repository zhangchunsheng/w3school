...
<p><a href="/jsref/dom_obj_anchor.asp">HTML DOM Anchor 对象</a></p>
</div>

<div>
<h2>定义和用法</h2>
<p>target 属性可设置或返回在何处打开链接。</p>

<h3>语法</h3>
<pre>anchorObject.target=_blank|_parent|_self|_top </pre>
<p>四个保留的目标名称：</p>
<ul>
...
<div>
<h2>实例</h2>
<p>下面的例子将更改一个链接的文本、URL 以及 target：</p>
<pre>&lt;html&gt;
&lt;head&gt;
&lt;script type=&quot;text/javascript&quot;&gt;
function changeLink()
...
<code>document.getElementById('myAnchor').target=&quot;_blank&quot;</code>;
}
&lt;/script&gt;
&lt;/head&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_anchor_href">更改一个链接的文本、URL 以及 target</a></dt>
</dl>
</div>
