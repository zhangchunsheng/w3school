...
<title>JavaScript NEGATIVE_INFINITY 属性</title>
...
<h1>JavaScript NEGATIVE_INFINITY 属性</h1>

<div class="backtoreference">
<p><a href="/jsref/jsref_obj_number.asp" title="JavaScript Number 对象">JavaScript Number 对象</a></p>
</div>
...
<p>NEGATIVE_INFINITY 属性表示小于 Number.MIN_VALUE 的值。</p>
...
<p>Number.NEGATIVE_INFINITY 是一个特殊值，它在算术运算或函数生成一个比 JavaScript 能表示的最小负数还小的数（也就是比 -Number.MAX_VALUE 还小的数）时返回。</p>

<p>JavaScript 显示 NEGATIVE_INFINITY 时使用的是 -Infinity。这个值的算术行为和无穷大非常相似。例如，任何数乘无穷大结果仍为无穷大，任何数被无穷大除的结果为 0。</p>

<p>在 ECMAScript v1 和其后的版本中，还可以用 -Infinity 代替 Number.NEGATIVE_INFINITY。</p>
</div>
...
<p>在本例中，我们将使用 NEGATIVE_INFINITY：</p>

<pre>&lt;script type=&quot;text/javascript&quot;&gt;

var x=(-Number.MAX_VALUE)*2
if (x==<code>Number.NEGATIVE_INFINITY</code>)
  {
...
<pre>Value of x: -Infinity</pre>

<p><a href="/tiy/t.asp?f=jseg_negative_infinity">TIY</a></p>
</div>
...
<dl>
<dt><a href="/tiy/t.asp?f=jseg_negative_infinity">NEGATIVE_INFINITY</a></dt>
<dd>如何通过 NEGATIVE_INFINITY 来判断一个值是否是负无穷大。</dd>
</dl>
</div>
...
<p>JavaScript 全局对象参考手册：<a href="/jsref/jsref_infinity.asp" title="JavaScript Infinity 属性">Infinity 属性</a></p>

<p>JavaScript 全局对象参考手册：<a href="/jsref/jsref_isFinite.asp" title="JavaScript isFinite() 函数">isFinite() 函数</a></p>
</div>
