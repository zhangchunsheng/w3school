...
<title>HTML DOM moveTo() 方法</title>
...
<div>
<h2>定义和用法</h2>
<p>moveTo() 方法可把窗口的左上角移动到一个指定的坐标。</p>

<h3>语法</h3>
<pre>window.moveTo(x,y)</pre>
...
<div>
<h2>提示和注释</h2>
<p class="note"><span>注释：</span>出于安全方面的原因，浏览器限制此方法使其不能把窗口移出屏幕。</p>
</div>

<div>
<h2>实例</h2>
<p>下面的例子讲把新窗口移动到指定的坐标：</p>
<pre>&lt;html&gt;
&lt;head&gt;
&lt;script type=&quot;text/javascript&quot;&gt;
function moveWin()
  {
  <code>myWindow.moveTo(50,50)</code>
  }
&lt;/script&gt;
&lt;/head&gt;
&lt;body&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_win_moveto">通过 moveTo() 移动窗口</a></dt>
</dl>
</div>
