...
<p>如果单选按钮的默认状态是选中，则返回 true，否则返回 fasle。</p>

<h3>语法</h3>
<pre>radioObject.defaultChecked</pre>
</div>

<div>
<h2>实例</h2>
<p>下面的例子返回了 checked 属性的默认值：</p>
<pre>&lt;html&gt;
&lt;body&gt;
...
&lt;script type=&quot;text/javascript&quot;&gt;
alert(<code>document.getElementById(&quot;radio1&quot;).defaultChecked</code>);
&lt;/script&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_radio_defaultchecked">返回单选按钮的默认状态</a></dt>
</dl>
</div>
