...
<title>HTML DOM deleteCell() 方法</title>
...
<div>
<h2>定义和用法</h2>
<p>deleteCell() 方法用于删除表格行中的单元格（&lt;td&gt; 元素）。</p>

<h3>语法</h3>
<pre>tablerowObject.deleteCell(index)</pre>

<h3>说明</h3>
<p>参数 index 是要删除的表元在行中的位置。</p>
<p>该方法将删除表行中指定位置的表元。</p>
...
<div>
<h2>实例</h2>
<p>下面的例子从行中删除了一个单元格：</p>
<pre>&lt;html&gt;
&lt;head&gt;
&lt;script type=&quot;text/javascript&quot;&gt;
function delCell()
  {
  <code>document.getElementById('tr2').deleteCell(0)</code>
  }
&lt;/script&gt;
&lt;/head&gt;
&lt;body&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_tablerow_deletecell">删除行中的一个单元格</a></dt>
</dl>
</div>
