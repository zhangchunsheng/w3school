...
<div>
<h2>定义和用法</h2>
<p>height 属性可设置或返回 iframe 的高度（以像素或百分比为单位）。</p>

<h3>语法</h3>
<pre>iframeObject.height=pixels</pre>
</div>

<div>
<h2>实例</h2>
<p>下面的例子可更改 iframe 的高度：</p>
<pre>&lt;html&gt;
&lt;head&gt;
&lt;script type=&quot;text/javascript&quot;&gt;
function changeHeight()
  {
  <code>document.getElementById(&quot;frame1&quot;).height=&quot;200&quot;;</code>
  }
&lt;/script&gt;
&lt;/head&gt;
&lt;body&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_height_width">更改 iframe 的高度和宽度</a></dt>
</dl>
</div>
