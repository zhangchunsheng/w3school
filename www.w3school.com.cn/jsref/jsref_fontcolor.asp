...
<title>JavaScript fontcolor() 方法</title>
...
<p>fontcolor() 方法用于按照指定的颜色来显示字符串。</p>

<h3>语法</h3>

<pre>stringObject.fontcolor(color)</pre>
...
<table class="dataintable"> 
  ...
  <tr>
    <td>color</td>
    <td>必需。为字符串规定 font-color。该值必须是颜色名(red)、RGB 值(rgb(255,0,0))或者十六进制数(#FF0000)。</td>
  </tr>
</table>
</div>
...
<dl>
<dt><a href="/tiy/t.asp?f=jseg_str_style">fontcolor()</a></dt>
<dd>如何使用 fontcolor() 来把字符串显示为红色。</dd>
</dl>
</div>
