...
<title>HTML DOM AccessKey 属性</title>
...
<h1>HTML DOM AccessKey 属性</h1>

<div class="backtoreference">
<p><a href="/jsref/dom_obj_radio.asp" title="HTML DOM Radio 对象">HTML DOM Radio 对象</a></p>
</div>

<div>
<h2>定义和用法</h2>
<p>accessKey 属性可设置或返回访问单选按钮的快捷键。</p>
<p class="note"><span>注释：</span>请使用 <em>Alt + accessKey</em> 为拥有指定快捷键的元素赋予焦点。</p>

<h3>语法</h3>
<pre>radioObject.accessKey=accesskey</pre>
</div>

<div>
<h2>实例</h2>
<p>下面的例子可返回单选按钮的快捷键：</p>
<pre>&lt;html&gt;
&lt;body&gt;
...
&lt;script type=&quot;text/javascript&quot;&gt;
document.write(<code>document.getElementById('male').accessKey</code>);
document.write(&quot; and &quot;);
document.write(<code>document.getElementById('female').accessKey</code>);
&lt;/script&gt;&lt;/p&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_radio_accesskey">返回单选按钮的快捷键</a></dt>
</dl>
</div>
