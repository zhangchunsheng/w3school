...
<li class="currentLink"><a href="/jsref/dom_obj_meta.asp" title="HTML DOM Meta 对象">&lt;meta&gt;</a></li>
...
<h1>HTML DOM Meta 对象</h1>


<div>
<h2>Meta 对象</h2>

<p>Meta 对象代表 HTML 的 一个 &lt;meta&gt; 元素。</p>

<p>&lt;meta&gt; 元素可提供有关某个 HTML 元素的元信息 (meta-information)，比如描述、针对搜索引擎的关键词以及刷新频率。</p>
</div>
...
<table class="dataintable">
  ...
  <tr>
    <td><a href="/jsref/prop_meta_content.asp">content</a></td>
    <td>设置或返回 &lt;meta&gt; 元素的 content 属性的值。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_meta_httpequiv.asp">httpEquiv</a></td>
    <td>把 content 属性连接到一个 HTTP 头部。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_meta_name.asp">name</a></td>
    <td>把 content 属性连接到某个名称。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_meta_scheme.asp">scheme</a></td>
