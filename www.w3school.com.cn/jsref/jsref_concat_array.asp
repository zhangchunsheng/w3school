...
<title>JavaScript concat() 方法</title>
...
<pre>arrayObject.concat(arrayX,arrayX,......,arrayX)</pre>
...
<table class="dataintable"> 
  ...
  <tr>
    <td>arrayX</td>
    <td>必需。该参数可以是具体的值，也可以是数组对象。可以是任意多个。</td>
  </tr>
</table>
...
<p>在本例中，我们将把 concat() 中的参数连接到数组 a 中：</p>

<pre>
&lt;script type=&quot;text/javascript&quot;&gt;

var a = [1,2,3];
document.write(<code>a.concat(4,5)</code>);
...
<p>在本例中，我们创建了两个数组，然后使用 concat() 把它们连接起来：</p>
...
document.write(<code>arr.concat(arr2)</code>)
...
<pre>George,John,Thomas,James,Adrew,Martin</pre>
...
document.write(<code>arr.concat(arr2,arr3)</code>)
...
<pre>George,John,Thomas,James,Adrew,Martin,William,Franklin</pre>
</div>
...
<dl>
<dt><a href="/tiy/t.asp?f=jseg_concat_1">如何使用 concat() 连接数组中的值</a></dt>
<dt><a href="/tiy/t.asp?f=jseg_concat_2">如何使用 concat() 连接两个数组</a></dt>
<dt><a href="/tiy/t.asp?f=jseg_concat_3">如何使用 concat() 连接三个数组</a></dt>
</dl>
</div>
