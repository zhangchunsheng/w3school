...
<title>HTML DOM httpEquiv 属性</title>
...
<h1>HTML DOM httpEquiv 属性</h1>

<div class="backtoreference">
<p><a href="/jsref/dom_obj_meta.asp">HTML DOM Meta 对象</a></p>
</div>

<div>
<h2>定义和用法</h2>

<p>httpEquiv 属性把 content 属性连接到 HTTP 头部。</p>

<h3>语法</h3>
<pre>metaObject.httpEquiv=content-type|expires|refresh|set-cookie</pre>
</div>
...
document.write(&quot;Http equiv: &quot; + <code>x.httpEquiv</code>);
&lt;/script&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_httpequiv1">每 5 秒刷新页面</a></dt>
<dt><a href="/tiy/t.asp?f=hdom_httpequiv2">5 秒后重定向页面</a></dt>
</dl>
</div>
