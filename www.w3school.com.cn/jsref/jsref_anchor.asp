...
<title>JavaScript anchor() 方法</title>
...
<p>anchor() 方法用于创建 HTML 锚。</p>

<pre>stringObject.anchor(anchorname)</pre>
...
<p>上面的代码将输出为纯粹的 HTML：</p>

<pre>&lt;a name=&quot;myanchor&quot;&gt;Hello world!&lt;/a&gt;</pre>
</div>
