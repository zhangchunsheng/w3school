...
<title>HTML DOM search 属性</title>
...
<h3>语法</h3>
<pre>location.search=path_from_questionmark</pre>
</div>

<div>
<h2>实例</h2>
<p>假设当前的 URL 是: http://www.w3school.com.cn/tiy/t.asp?f=hdom_loc_search</p>
<pre>&lt;html&gt;
&lt;body&gt;

&lt;script type=&quot;text/javascript&quot;&gt;
document.write(<code>location.search</code>);
&lt;/script&gt;
...
<p>输出：</p>
<pre>?f=hdom_loc_search</pre>
</div>

<div class="example">
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_loc_search">使用 location 的 search 属性</a></dt>
</dl>
</div>
