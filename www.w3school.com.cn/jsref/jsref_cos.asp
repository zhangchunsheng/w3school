...
<p>x 的余弦值。返回的是 -1.0 到 1.0 之间的数。</p>
</div>
...
<dl>
<dt><a href="/tiy/t.asp?f=jseg_cos">cos()</a></dt>
<dd>如何使用 cos() 来取得一些数字的余弦值。</dd>
</dl>
</div>
