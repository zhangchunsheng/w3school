...
<div>
<h2>定义和用法</h2>
<p>URL 属性可返回当前文档的 URL。</p>

<h3>语法</h3>
<pre>document.URL</pre>

<h3>说明</h3>
<p>一般情况下，该属性的值与包含文档的 Window 的 location.href 属性相同。不过，在 URL 重定向发生的时候，这个 URL 属性保存了文档的实际 URL，而 location.href 保存了请求的 URL。</p>
</div>
...
&lt;script type=&quot;text/javascript&quot;&gt;
document.write(<code>document.URL</code>)
&lt;/script&gt;
&lt;/body&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_document_url">返回当前文档的 URL</a></dt>
</dl>
</div>
