...
<h3>语法</h3>
<pre>NumberObject.toString(radix)</pre>
...
<table class="dataintable"> 
  ...
  <tr>
    <td>radix</td>
    <td>可选。规定表示数字的基数，使 2 ~ 36 之间的整数。若省略该参数，则使用基数 10。但是要注意，如果该参数是 10 以外的其他值，则 ECMAScript 标准允许实现返回任意值。</td>
  </tr>
</table>

<h3>返回值</h3>
<p>数字的字符串表示。例如，当 radix 为 2 时，NumberObject 会被转换为二进制值表示的字符串。</p>
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=jseg_tostring_number">toString()</a></dt>
<dd>如何使用 toString() 来把数字转换为字符串。</dd>
</dl>
</div>
