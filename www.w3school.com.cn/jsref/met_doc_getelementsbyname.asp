...
<title>HTML DOM getElementsByName() 方法</title>
...
<h1>HTML DOM getElementsByName() 方法</h1>
...
<div>
<h2>定义和用法</h2>
<p>getElementsByName() 方法可返回带有指定名称的对象的集合。</p>

<h3>语法</h3>
<pre>document.getElementsByName(name)</pre>

<p>该方法与 getElementById() 方法相似，但是它查询元素的 name 属性，而不是 id 属性。</p>
<p>另外，因为一个文档中的 name 属性可能不唯一（如 HTML 表单中的单选按钮通常具有相同的 name 属性），所有 getElementsByName() 方法返回的是元素的数组，而不是一个元素。</p>
</div>
...
function getElements()
  {
  var x=<code>document.getElementsByName(&quot;myInput&quot;)</code>;
  alert(x.length);
  }
&lt;/script&gt;
&lt;/head&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_document_getbyname">使用 getElementsByName()</a></dt>
</dl>
</div>
