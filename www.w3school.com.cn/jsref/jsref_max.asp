...
<p>max() 方法可返回两个指定的数中带有较大的值的那个数。</p>
...
<table class="dataintable"> 
  ...
  <tr>
    <td>x</td>
    <td>0 或多个值。在 ECMASCript v3 之前，该方法只有两个参数。</td>
  </tr>
</table>

<h3>返回值</h3>

<p>参数中最大的值。如果没有参数，则返回 -Infinity。如果有某个参数为 NaN，或是不能转换成数字的非数字值，则返回 NaN。</p>
</div>
...
<p>在本例中，我们将展示如何使用 max() 来返回指定数字中带有最高值的数字：</p>
...
<dl>
<dt><a href="/tiy/t.asp?f=jseg_max">max()</a></dt>
<dd>如何使用 max() 来返回指定数字中带有最高值的数字。</dd>
</dl>
</div>
