...
<p>参数中最小的值。如果没有参数，则返回 Infinity。如果有某个参数为 NaN，或是不能转换成数字的非数字值，则返回 NaN。</p>
</div>
...
<p>在本例中，我们将展示如何使用 min() 来返回指定数字中带有最低值的数字：</p>
...
<dl>
<dt><a href="/tiy/t.asp?f=jseg_min">min()</a></dt>
<dd>如何使用 min() 来取得指定数字中带有最低值的数字。</dd>
</dl>
</div>
