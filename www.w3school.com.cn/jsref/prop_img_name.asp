...
<div>
<h2>定义和用法</h2>
<p>name 属性可设置或返回图像的名称。</p>
<p>如果一个 &lt;img&gt; 有一个 name 属性，就可以把相应的 Image 对象作为 Document 对象的命名属性来访问。</p>

<h3>语法</h3>
<pre>imageObject.name=name</pre>
</div>
...
document.write(<code>document.getElementById('compman').name</code>);
&lt;/script&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_image_name">取得图像的名称</a></dt>
</dl>
</div>
