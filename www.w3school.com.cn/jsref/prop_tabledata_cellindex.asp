...
<title>HTML DOM cellIndex 属性</title>
...
<h1>HTML DOM cellIndex 属性</h1>

<div class="backtoreference">
<p><a href="/jsref/dom_obj_tabledata.asp">HTML DOM TableCell 对象</a></p>
</div>

<div>
<h2>定义和用法</h2>
<p>cellIndex 属性可返回一行的单元格集合中单元格的位置。</p>

<h3>语法</h3>
<pre>tabledataObject.cellIndex</pre>
</div>

<div>
<h2>实例</h2>
<p>下面的例子可返回两个单元格的位置（cell index）：</p>
<pre>&lt;html&gt;
&lt;head&gt;
&lt;script type=&quot;text/javascript&quot;&gt;
function alertTd1()
  {
  alert(<code>document.getElementById('td1').cellIndex</code>);
  }
function alertTd2()
  {
  alert(<code>document.getElementById('td2').cellIndex</code>);
  }
&lt;/script&gt;
&lt;/head&gt;
&lt;body&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_tablecell_cellindex">取得单元格的 cell index</a></dt>
</dl>
</div>
