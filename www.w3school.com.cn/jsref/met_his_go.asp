...
<div>
<h2>定义和用法</h2>
<p>go() 方法可加载历史列表中的某个具体的页面。</p>

<h3>语法</h3>
<pre>history.go(number|URL)</pre>

<h3>说明</h3>
<p>URL 参数使用的是要访问的 URL，或 URL 的子串。而 number 参数使用的是要访问的 URL 在 History 的 URL 列表中的相对位置。</p>
</div>

<div>
<h2>实例</h2>
<p>下面例子会加载历史列表中的前一个页面：</p>
<pre>&lt;html&gt;
&lt;head&gt;
&lt;script type=&quot;text/javascript&quot;&gt;
function goBack()
