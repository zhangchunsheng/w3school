...
<h3>语法</h3>
<pre>dateObject.toLocaleString()</pre>

<h3>返回值</h3>
<p>dateObject 的字符串表示，以本地时间区表示，并根据本地规则格式化。</p>
</div>
...
<h3>例子 1</h3>
<p>在本例中，我们将根据本地时间把今天的日期转换为字符串：</p>
...
<h3>例子 2</h3>
<p>在本例中，我们将根据本地时间把具体的日期转换为字符串：</p>
<pre>&lt;script type=&quot;text/javascript&quot;&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=jseg_tolocalestring">toLocaleString()</a></dt>
<dd>如何使用 toLocaleString() 来根据本地时间把今天的日期转换为字符串。</dd>
</dl>
</div>
