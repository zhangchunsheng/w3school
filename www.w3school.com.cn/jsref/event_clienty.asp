...
<div>
<h2>定义和用法</h2>
<p>clientY 事件属性返回当事件被触发时鼠标指针向对于浏览器页面（客户区）的垂直坐标。</p>
<p>客户区指的是当前窗口。</p>

<h3>语法</h3>
<pre>event.clientY</pre>
</div>

<div>
<h2>提示和注释</h2>
<p class="note"><span>注释：</span>注意，该坐标不考虑文档的滚动。如果事件发生在窗口的顶部，无论文档滚了多远，clientY 的值都是 0。但是，2 级 DOM 没有提供把窗口坐标转换为文档坐标的标准方法。在 IE 以外的浏览器，使用 window.pageXOffset 和 window.pageYOffset 即可。</p>
</div>
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_event_clienty">clientY</a></dt>
<dd>显示鼠标指针的坐标。</dd>
</dl>
</div>
