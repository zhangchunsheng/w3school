...
<div>
<h2>定义和用法</h2>
<p>ctrlKey 事件属性可返回一个布尔值，指示当事件发生时，Ctrl 键是否被按下并保持住。</p>

<h3>语法</h3>
<pre>event.ctrlKey=true|false|1|0</pre>
</div>

<div>
<h2>实例</h2>
<p>下面的例子可提示当鼠标按键被点击时 &quot;CTRL&quot; 键是否被按住：</p>
<pre>&lt;html&gt;
&lt;head&gt;
&lt;script type=&quot;text/javascript&quot;&gt;
function isKeyPressed(event)
{
  if (<code>event.ctrlKey==1</code>)
    {
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_event_ctrlkey">ctrlKey</a></dt>
<dd>检测 CTRL 键是否被按下了。</dd>
</dl>
</div>
