...
<title>JavaScript atan2() 方法</title>
...
<p>atan2() 方法可返回从 x 轴到点 (x,y) 之间的角度。</p>
...
<p>-PI 到 PI 之间的值，是从 X 轴正向逆时针旋转到点 (x,y) 时经过的角度。</p>
</div>
...
<p class="note"><span>注释：</span>请注意这个函数的参数顺序，Y 坐标在 X 坐标之前传递。</p>
</div>
...
<p>下面这个例子可通过 atan2() 方法返回不同 (x,y) 点的角度：</p>
...
<dl>
<dt><a href="/tiy/t.asp?f=jseg_atan2">atan2()</a></dt>
<dd>如何使用 atan2() 来返回不同 (x,y) 点的角度。</dd>
</dl>
</div>
