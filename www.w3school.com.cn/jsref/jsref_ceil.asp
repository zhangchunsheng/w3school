...
<title>JavaScript ceil() 方法</title>
...
<p>ceil() 方法执行的是向上取整计算，它返回的是大于或等于函数参数，并且与之最接近的整数。</p>
</div>
...
<p>在本例中，我们将把 ceil() 方法运用到不同的数字上：</p>
