...
<p>big() 方法用于把字符串显示为大号字体。</p>

<pre>stringObject.big()</pre>
</div>
...
<p>在本例中，&quot;Hello world!&quot; 将被显示为大号字体：</p>
...
<dl>
<dt><a href="/tiy/t.asp?f=jseg_str_style">big()</a></dt>
<dd>如何使用 big() 把字符串显示为大号字体。</dd>
</dl>
</div>
