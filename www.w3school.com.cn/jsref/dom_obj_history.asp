...
<li class="currentLink"><a href="/jsref/dom_obj_history.asp" title="HTML DOM History 对象">History</a></li>
...
<table class="dataintable">
  ...
  <tr>
    <td><a href="/jsref/prop_his_length.asp">length</a></td>
...
<table class="dataintable">
  ...
  <tr>
    <td><a href="/jsref/met_his_back.asp">back()</a></td>
    <td>加载 history 列表中的前一个 URL。</td>
  </tr>
  <tr>
    <td><a href="/jsref/met_his_forward.asp">forward()</a></td>
    <td>加载 history 列表中的下一个 URL。</td>
  </tr>
  <tr>
    <td><a href="/jsref/met_his_go.asp">go()</a></td>
...
<p>History 对象最初设计来表示窗口的浏览历史。但出于隐私方面的原因，History 对象不再允许脚本访问已经访问过的实际 URL。唯一保持使用的功能只有 <a href="/jsref/met_his_back.asp">back()</a>、<a href="/jsref/met_his_forward.asp">forward()</a> 和 <a href="/jsref/met_his_go.asp">go()</a> 方法。</p>
