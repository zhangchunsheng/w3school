...
<li class="currentLink"><a href="/jsref/dom_obj_table.asp" title="HTML DOM Table 对象">&lt;table&gt;</a></li>
...
<h1>HTML DOM Table 对象</h1>


<div>
<h2>Table 对象</h2>

<p>Table 对象代表一个 HTML 表格。</p>

<p>在 HTML 文档中 &lt;table&gt; 标签每出现一次，一个 Table 对象就会被创建。</p>
</div>
...
<table class="dataintable">
  ...
  <tr>
    <td><a href="/jsref/coll_table_cells.asp">cells[]</a></td>
    <td>返回包含表格中所有单元格的一个数组。</td>
  </tr>
  <tr>
    <td><a href="/jsref/coll_table_rows.asp">rows[]</a></td>
    <td>返回包含表格中所有行的一个数组。</td>
  </tr>
  <tr>
    <td>tBodies[]</td>
    <td>返回包含表格中所有 tbody 的一个数组。</td>
  </tr>
</table>
</div>
...
<table class="dataintable">
  ...
  <tr>
    <td><a href="/jsref/prop_table_border.asp">border</a></td>
    <td>设置或返回表格边框的宽度。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_table_caption.asp">caption</a></td>
    <td>对表格的 &lt;caption&gt; 元素的引用。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_table_cellpadding.asp">cellPadding</a></td>
    <td>设置或返回单元格内容和单元格边框之间的空白量。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_table_cellspacing.asp">cellSpacing</a></td>
    <td>设置或返回在表格中的单元格之间的空白量。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_table_frame.asp">frame</a></td>
    <td>设置或返回表格的外部边框。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_table_id.asp">id</a></td>
    <td>设置或返回表格的 id。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_table_rules.asp">rules</a></td>
    <td>设置或返回表格的内部边框（行线）。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_table_summary.asp">summary</a></td>
    <td>设置或返回对表格的描述（概述）。</td>
  </tr>
  <tr>
    <td>tFoot</td>
    <td>返回表格的 TFoot 对象。如果不存在该元素，则为 null。</td>
  </tr>
  <tr>
    <td>tHead</td>
    <td>返回表格的 THead 对象。如果不存在该元素，则为 null。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_table_width.asp">width</a></td>
    <td>设置或返回表格的宽度。</td>
  </tr>
  </table>
</div>
...
<table class="dataintable">
  ...
  <tr>
    <td><a href="/jsref/prop_classname.asp">className</a></td>
    <td>设置或返回元素的 class 属性。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_dir.asp">dir</a></td>
    <td>设置或返回文本的方向。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_lang.asp">lang</a></td>
    <td>设置或返回元素的语言代码。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_title.asp">title</a></td>
...
<table class="dataintable">
  ...
  <tr>
    <td><a href="/jsref/met_table_createcaption.asp">createCaption()</a></td>
    <td>为表格创建一个 caption 元素。</td>
  </tr>
  <tr>
    <td><a href="/jsref/met_table_createtfoot.asp">createTFoot()</a></td>
    <td>在表格中创建一个空的 tFoot 元素。</td>
  </tr>
  <tr>
    <td><a href="/jsref/met_table_createthead.asp">createTHead()</a></td>
    <td>在表格中创建一个空的 tHead 元素。</td>
  </tr>
  <tr>
    <td><a href="/jsref/met_table_deletecaption.asp">deleteCaption()</a></td>
    <td>从表格删除 caption 元素以及其内容。</td>
  </tr>
  <tr>
    <td><a href="/jsref/met_table_deleterow.asp">deleteRow()</a></td>
    <td>从表格删除一行。</td>
  </tr>
  <tr>
    <td><a href="/jsref/met_table_deletetfoot.asp">deleteTFoot()</a></td>
    <td>从表格删除 tFoot 元素及其内容。</td>
  </tr>
  <tr>
    <td><a href="/jsref/met_table_deletethead.asp">deleteTHead()</a></td>
    <td>从表格删除 tHead 元素及其内容。</td>
  </tr>
  <tr>
    <td><a href="/jsref/met_table_insertrow.asp">insertRow()</a></td>
    <td>在表格中插入一个新行。</td>
  </tr>
  </table>
</div>
