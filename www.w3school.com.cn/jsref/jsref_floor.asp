...
<title>JavaScript floor() 方法</title>
...
<p>在本例中，我们将在不同的数字上使用 floor() 方法：</p>
...
<dl>
<dt><a href="/tiy/t.asp?f=jseg_floor">floor()</a></dt>
<dd>如何使用 floor() 方法。</dd>
</dl>
</div>
