...
<title>HTML DOM paddingLeft 属性</title>
...
<div>
<h2>定义和用法</h2>
<p>paddingLeft 属性设置元素的左内边距。</p>
<p>padding 属性定义元素边框与元素内容之间的空间。</p>

<h3>语法：</h3>
<pre>Object.style.paddingLeft=length|%</pre>
...
{
<code>document.getElementById(&quot;p1&quot;).style.paddingLeft=&quot;2cm&quot;;</code>
}
&lt;/script&gt;
&lt;/head&gt;
&lt;body&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_style_paddingleft">paddingLeft - 改变元素的左内边距</a></dt>
</dl>
</div>
