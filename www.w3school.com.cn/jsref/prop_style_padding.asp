...
<title>HTML DOM padding 属性</title>
...
<p>padding 属性设置元素的内边距。</p>
<p>padding 属性定义元素边框与元素内容之间的空间。</p>

<p>该属性可采取 4 个值：</p>
<ul>
	<li>如果规定一个值，比如 div {padding: 50px} - 所有四个边的 padding 都是 50 px。</li>
	<li>如果规定两个值，比如 div {padding: 50px 10px} - 上下内边距是 50 px，左右内边距是 10 px。</li>
	<li>如果规定三个值，比如 div {padding: 50px 10px 20px} - 上内边距是 50 px，左右内边距是 10 px，下内边距是 20 px。</li>
	<li>如果规定四个值，比如 div {padding: 50px 10px 20px 30px} - 上内边距是 50 px，右内边距是 10 px，下内边距是 20 px，左内边距是 30 px。</li>
</ul>

<h3>语法：</h3>
<pre>Object.style.padding=padding</pre>
...
{
<code>document.getElementById(&quot;p1&quot;).style.padding=&quot;2cm&quot;;</code>
}
&lt;/script&gt;
&lt;/head&gt;
&lt;body&gt;
...
<h3>TIY</h3>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_style_padding">padding - 改变元素的内边距</a></dt>
</dl>
</div>
