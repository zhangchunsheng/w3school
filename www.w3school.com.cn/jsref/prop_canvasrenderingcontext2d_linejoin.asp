...
<title>HTML DOM lineJoin 属性</title>
...
<div>
<h2>提示和注释</h2>
<p class="note"><span>注释：</span>FireFox 1.5 没有正确地实现斜切连接，而是把它们当作圆连接来绘制。另外，当采用一种部分透明的颜色来勾勒的时候，斜角连接也不能正确地显示。</p>
</div>
...
<p><a href="/jsref/prop_canvasrenderingcontext2d_miterlimit.asp" title="HTML DOM miterLimit 属性">CanvasRenderingContext2D.miterLimit</a></p>
</div>
