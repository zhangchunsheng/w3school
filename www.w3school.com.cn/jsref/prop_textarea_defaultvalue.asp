...
<p><a href="/jsref/dom_obj_textarea.asp">HTML DOM Textarea 对象</a></p>
</div>

<div>
<h2>定义和用法</h2>
<p>defaultValue 属性设置或返回文本框的初始内容。</p>
<p class="note"><span>注释：</span>文本框的初始值是位于 &lt;textarea&gt; 和 &lt;/textarea&gt; 标签之间的文本。在表单被重置时，文本框将被恢复为整个值。改变这个属性的值会改变文本框中当前显示的文本。</p>

<h3>语法</h3>
<pre>textareaObject.defaultValue=text</pre>
</div>

<div>
<h2>实例</h2>
<p>下面的例子提示出了文本框的默认值：</p>
<pre>&lt;html&gt;
&lt;head&gt;
&lt;script type=&quot;text/javascript&quot;&gt;
function alertDefaultValue()
  {
  alert(<code>document.getElementById('txt1').defaultValue</code>);
  }
&lt;/script&gt;
&lt;/head&gt;
&lt;body&gt;
