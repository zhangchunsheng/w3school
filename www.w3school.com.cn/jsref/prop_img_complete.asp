...
<title>HTML DOM complete 属性</title>
...
<div>
<h2>定义和用法</h2>
<p>complete 属性可返回浏览器是否已完成对图像的加载。</p>
<p>如果加载完成，则返回 true，否则返回 fasle。</p>

<h3>语法</h3>
<pre>imageObject.complete</pre>
</div>

<div>
<h2>实例</h2>
<p>下面的例子可检测图形是否已完成加载：</p>
<pre>&lt;html&gt;
&lt;head&gt;
&lt;script type=&quot;text/javascript&quot;&gt;
function alertComplete()
{
alert(<code>document.getElementById(&quot;compman&quot;).complete</code>)
}
&lt;/script&gt;
&lt;/head&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_image_complete">检测图形是否已完成加载</a></dt>
</dl>
</div>
