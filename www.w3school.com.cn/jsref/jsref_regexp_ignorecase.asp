...
<title>JavaScript ignoreCase 属性</title>
...
<h1>JavaScript ignoreCase 属性</h1>
...
<p>ignoreCase 属性规定是否设置 <a href="/jsref/jsref_regexp_i.asp" title="JavaScript RegExp i 修饰符">&quot;i&quot; 标志</a>。</p>

<p>如果设置了 &quot;i&quot; 标志，则返回 true，否则返回 false。</p>

<h3>语法</h3>

<pre>RegExpObject.ignoreCase</pre>
</div>
...
<p>在下面的例子中，我们将查看正则表达式是否具有标志 i：</p>
...
<dl>
<dt><a href="/tiy/t.asp?f=jseg_ignorecase_regexp">ignoreCase</a></dt>
<dd>如何使用 ignoreCase 属性来检测正则表达式是否具有标志 i。</dd>
</dl>
</div>
