...
<title>HTML DOM Textarea 对象</title>
...
<li class="currentLink"><a href="/jsref/dom_obj_textarea.asp" title="HTML DOM Textarea 对象">&lt;textarea&gt;</a></li>
</ul>
</div><div id="selected">
<h2>建站手册</h2>
<ul>
...
<h1>HTML DOM Textarea 对象</h1>


<div>
<h2>Textarea 对象</h2>

<p>Textarea 对象代表 HTML 表单中的一个文本区 (text-area)。在表单中 &lt;textarea&gt; 标签每出现一次，一个 Textarea 对象就会被创建。</p>

<p>您可以通过索引相应表单的元素数组来访问某个 Textarea 对象，或者使用 getElementById()。</p>
</div>
...
<table class="dataintable">
  ...
  <tr>
    <td><a href="/jsref/prop_textarea_accesskey.asp">accessKey</a></td>
    <td>设置或返回访问 textarea 的键盘快捷键。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_textarea_cols.asp">cols</a></td>
    <td>设置或返回 textarea 的宽度。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_textarea_defaultvalue.asp">defaultValue</a></td>
    <td>设置或返回文本框中的初始内容。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_textarea_disabled.asp">disabled</a></td>
    <td>设置或返回 textarea 是否应当被禁用。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_textarea_form.asp">form</a></td>
    <td>返回对包含该 textarea 的表单对象的引用。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_textarea_id.asp">id</a></td>
    <td>设置或返回某个 textarea 的 id。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_textarea_name.asp">name</a></td>
    <td>设置或返回 textarea 的名称。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_textarea_readonly.asp">readOnly</a></td>
    <td>设置或返回 textarea 是否应当是只读的。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_textarea_rows.asp">rows</a></td>
    <td>设置或返回 textarea 的高度。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_textarea_tabindex.asp">tabIndex</a></td>
    <td>设置或返回 textarea 的 tab 键控制次序。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_textarea_type.asp">type</a></td>
    <td>返回该文本框的表单类型。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_textarea_value.asp">value</a></td>
    <td>设置或返回在 textarea 中的文本。</td>
  </tr>
  </table>
</div>
...
<table class="dataintable">
  ...
  <tr>
    <td><a href="/jsref/met_textarea_blur.asp">blur()</a></td>
    <td>从 textarea 移开焦点。</td>
  </tr>
  <tr>
    <td><a href="/jsref/met_textarea_focus.asp">focus()</a></td>
    <td>在 textarea 上设置焦点。</td>
  </tr>
  <tr>
    <td><a href="/jsref/met_textarea_select.asp">select()</a></td>
    <td>选择 textarea 中的文本。</td>
  </tr>
</table>
</div>
...
<div>
<h2>Textarea 对象事件句柄</h2>

<table class="dataintable">
  <tr>
    <th style="width:25%">事件句柄</th>
    <th>描述</th>
  </tr>
  <tr>
    <td><a href="/jsref/prop_textarea_onchange.asp">onchange</a></td>
    <td>当输入值改变时调用的事件句柄</td>
  </tr>
</table>
</div>
