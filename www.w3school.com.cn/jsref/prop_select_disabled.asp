...
<title>Select disabled 属性</title>
...
<p><a target="_blank" target="_blank" href="/tiy/t.asp?f=hdom_select_disabled">亲自试一试</a></p>
</div>
...
<p>disabled 属性设置或返回是否禁用下拉列表。</p>

<p>被禁用的元素不可用且不可点击。被禁用元素在浏览器中通常显示为灰色。</p>
</div>
...
<pre>element.disabled=true|false</pre>

<p>返回 disabled 属性：</p>

<pre>element.disabled</pre>
</div>
