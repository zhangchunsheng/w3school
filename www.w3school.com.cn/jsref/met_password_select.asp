...
<div>
<h2>定义和用法</h2>
<p>select() 方法用于选取密码域中的文本。</p>

<h3>语法</h3>
<pre>passwordObject.select()</pre>
</div>
...
function selText()
  {
  <code>document.getElementById('password1').select()</code>
  }
&lt;/script&gt;
&lt;/head&gt;
&lt;body&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_password_select">选取密码域中的文本</a></dt>
</dl>
</div>
