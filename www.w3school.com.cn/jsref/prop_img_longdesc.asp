...
<div>
<h2>定义和用法</h2>
<p>longDesc　属性可设置或返回包含图像描述的文档的 URL。</p>
<p>该描述是对 &quot;alt&quot; 属性的补充，可对非可视的用户代理很有用。</p>

<h3>语法</h3>
<pre>imageObject.longDesc=URL</pre>
</div>

<div>
<h2>实例</h2>
<p>下面的例子将创建一个指向图像描述的链接：</p>
<pre>&lt;html&gt;
&lt;body&gt;
...
document.write('&lt;a href=&quot;' + <code>x.longDesc</code> + '&quot;&gt;Description&lt;/a&gt;');
&lt;/script&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_image_longdesc">创建一个较长的图像描述的链接</a></dt>
</dl>
</div>
