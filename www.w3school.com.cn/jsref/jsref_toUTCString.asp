...
<title>JavaScript toUTCString() 方法</title>
...
<h1>JavaScript toUTCString() 方法</h1>
...
<div>
<h2>定义和用法</h2>
<p>toUTCString() 方法可根据世界时 (UTC) 把 Date 对象转换为字符串，并返回结果。</p>

<h3>语法</h3>
<pre>dateObject.toUTCString()</pre>

<h3>返回值</h3>
<p>dateObject 的字符串表示，用世界时表示。</p>
</div>
...
<h3>例子 1</h3>
<p>在下面的例子中，我们将使用 toUTCString() 来把今天的日期转换为（根据 UTC）字符串：</p>
...
<h3>例子 2</h3>
<p>在下面的例子中，我们将把具体的日期转换为（根据 UTC）字符串：</p>
<pre>&lt;script type=&quot;text/javascript&quot;&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=jseg_toutcstring">toUTCString()</a></dt>
<dd>如何使用 toUTCString() 来把今天的日期转换为（根据 UTC）字符串。</dd>
</dl>
</div>
