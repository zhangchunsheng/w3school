...
<title>JavaScript fromCharCode() 方法</title>
...
<h1>JavaScript fromCharCode() 方法</h1>
...
<pre>String.fromCharCode(numX,numX,...,numX)</pre>
...
<table class="dataintable"> 
  ...
  <tr>
    <td>numX</td>
    <td>必需。一个或多个 Unicode 值，即要创建的字符串中的字符的 Unicode 编码。</td>
  </tr>
</table>
</div>
...
<p class="note"><span>注释：</span>该方法是 String 的静态方法，字符串中的每个字符都由单独的数字 Unicode 编码指定。</p>

<p>它不能作为您已创建的 String 对象的方法来使用。因此它的语法应该是 String.fromCharCode()，而不是 myStringObject.fromCharCode()。</p>
</div>
...
<dl>
<dt><a href="/tiy/t.asp?f=jseg_fromcharcode">fromCharCode()</a></dt>
<dd>如何使用 fromCharCode() 来根据 Unicode 值显示字符串。</dd>
</dl>
</div>
...
<p><a href="/jsref/jsref_charCodeAt.asp">charCodeAt() 方法</a></p>
</div>
