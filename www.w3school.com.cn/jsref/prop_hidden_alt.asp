...
<div>
<h2>定义和用法</h2>
<p>alt 属性可设置或返回浏览器不支持隐藏域时显示的文本。</p>

<h3>语法</h3>
<pre>hiddenObject.alt=alternate_text</pre>
</div>

<div>
<h2>实例</h2>
<p>下面的例子返回了隐藏输入域的 alt 文本：</p>
<pre>&lt;html&gt;
&lt;body&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_hidden_alt">返回隐藏域的 alt 文本</a></dt>
</dl>
</div>
