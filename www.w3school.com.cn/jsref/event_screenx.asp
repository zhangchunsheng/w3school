...
<div>
<h2>定义和用法</h2>
<p>screenX 事件属性可返回事件发生时鼠标指针相对于屏幕的水平坐标。</p>

<h3>语法</h3>
<pre>event.screenX</pre>
</div>
...
function show_coords(event)
  {
  x=<code>event.screenX</code>
  y=<code>event.screenY</code>
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_event_screenxy">screenX</a></dt>
<dd>提示鼠标指针的坐标。</dd>
</dl>
</div>
