...
<div>
<h2>定义和用法</h2>
<p>value 属性可设置或返回单选按钮的 value 属性的值。</p>

<h3>语法</h3>
<pre>radioObject.value=sometext</pre>
</div>
...
function check(browser)
  {
  <code>document.getElementById(&quot;answer&quot;).value=browser</code>
  }
&lt;/script&gt;
&lt;/head&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_form_radio">使用单选按钮中的 value 属性</a></dt>
</dl>
</div>
