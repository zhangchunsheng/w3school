...
<div>
<h2>定义和用法</h2>
<p>index 属性可返回下拉列表中选项的索引位置。</p>

<h3>语法</h3>
<pre>optionObject.index</pre>
</div>

<div>
<h2>实例</h2>
<p>本例可返回下拉列表中所选的选项的索引位置：</p>
<pre>&lt;&lt;html&gt;
&lt;head&gt;
&lt;script type=&quot;text/javascript&quot;&gt;
function alertIndex()
...
alert(y[x].text + &quot; has the index of: &quot; + <code>y[x].index</code>);
}
&lt;/script&gt;
&lt;/head&gt;
&lt;body&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_option_index1">取得下拉列表中所选的选项的索引位置</a></dt>
</dl>
</div>
