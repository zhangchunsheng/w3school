...
<title>HTML DOM bezierCurveTo() 方法</title>
...
<h1>HTML DOM bezierCurveTo() 方法</h1>
...
<p>bezierCurveTo() 方法在一个画布中开始子路径的一个新的集合。</p>

<h3>语法</h3>
<pre>bezierCurveTo(<i>cpX1</i>, <i>cpY1</i>, <i>cpX2</i>, <i>cpY2</i>, <i>x</i>, <i>y</i>)</pre>
...
<p>bezierCurveTo() 为一个画布的当前子路径添加一条三次贝塞尔曲线。这条曲线的开始点是画布的当前点，而结束点是 (<i>x</i>, <i>y</i>)。两条贝塞尔曲线控制点 (<i>cpX1</i>, <i>cpY1</i>) 和 (<i>cpX2</i>, <i>cpY2</i>) 定义了曲线的形状。当这个方法返回的时候，当前的位置为 (<i>x</i>, <i>y</i>)。</p>
</div>
...
<p><a href="/jsref/met_canvasrenderingcontext2d_quadraticcurveto.asp" title="HTML DOM quadraticCurveTo() 方法">CanvasRenderingContext2D.quadraticCurveTo()</a></p>
</div>
