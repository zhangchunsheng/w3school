...
<div>
<h2>定义和用法</h2>
<p>right 属性设置定位元素右外边距边界与其包含块右边界之间的偏移。</p>

<h3>语法：</h3>
<pre>Object.style.right=auto|%|length</pre>
...
<tr>
<td>auto</td>
<td>默认。通过浏览器来计算右侧的位置。</td>
</tr>

<tr>
<td>%</td>
<td>设置元素的右边到最近一个具有定位设置父元素的右边缘的百分比位置。</td>
</tr>

<tr>
<td>length</td>
<td>使用 px、cm 等单位设置元素的右边到最近一个具有定位设置父元素的右边缘的位置。可使用负值。</td>
</tr>
</table>
</div>
...
{
<code>document.getElementById(&quot;b1&quot;).style.right=&quot;100px&quot;;</code>
}
&lt;/script&gt;
&lt;/head&gt;
&lt;body&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_style_right">right - 设置元素的右边界</a></dt>
</dl>
</div>
