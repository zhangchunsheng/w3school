...
<div>
<h2>定义和用法</h2>
<p>size 属性可设置或返回下拉列表中一次显示显示的选项数。</p>
<p class="note"><span>注释：</span>Opera 9 无法在脚本中设置该属性，仅能返回它。</p>

<h3>语法</h3>
<pre>selectObject.size=number</pre>
</div>
...
function changeSize()
  {
  <code>document.getElementById(&quot;mySelect&quot;).size=4</code>
  }
&lt;/script&gt;
&lt;/head&gt;
&lt;body&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_select_size">更改下拉列表中的可见行数</a></dt>
</dl>
</div>
