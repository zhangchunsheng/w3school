...
<title>HTML DOM outlineColor 属性</title>
...
<h1>HTML DOM outlineColor 属性</h1>
...
<div>
<h2>定义和用法</h2>
<p>outlineColor 属性设置元素周围的轮廓的颜色。</p>

<h3>语法：</h3>
<pre>Object.style.outlineColor=color-name|color-rgb|color-hex</pre>
</div>
...
{
<code>document.getElementById(&quot;p1&quot;).style.outlineColor=&quot;#00FF00&quot;;</code>
}
&lt;/script&gt;
&lt;/head&gt;
&lt;body&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_style_outlinecolor">outlineColor - 改变围绕元素的轮廓的颜色</a>（请在非 IE 浏览器中浏览）</dt>
</dl>
</div>
