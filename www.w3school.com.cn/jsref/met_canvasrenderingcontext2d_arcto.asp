...
<h3>语法</h3>
<pre>arcTo(<i>x1</i>, <i>y1</i>, <i>x2</i>, <i>y2</i>, <i>radius</i>)</pre>
...
<p>这个方法为当前的子路径添加了一条圆弧，但是，它所描述的这条圆弧和 arc() 方法所描述的圆弧大不相同。添加给路径的圆弧是具有指定 <i>radius</i> 的圆的一部分。该圆弧有一个点与当前位置到 P1 的线段相切，还有一个点和从 P1 到 P2 的线段相切。这两个切点就是圆弧的起点和终点，圆弧绘制的方向就是连接这两个点的最短圆弧的方向。</p>
...
<p class="note"><span>注释：</span>这个方法在 Firefox 1.5 中未实现。</p>
</div>

<div>
<h2>参阅</h2>

<p><a href="/jsref/met_canvasrenderingcontext2d_arc.asp" title="HTML DOM arc() 方法">CanvasRenderingContext2D.arc()</a></p>
</div>
