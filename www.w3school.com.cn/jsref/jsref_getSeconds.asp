...
<h1>JavaScript getSeconds() 方法</h1>
...
<p>getSeconds() 方法可返回时间的秒。</p>

<h3>语法</h3>

<pre>dateObject.getSeconds()</pre>
...
<p class="note"><span>注释：</span>由 getSeconds() 返回的值是一个两位的数字。不过返回值不总是两位的，如果该值小于 10，则仅返回一位数字。</p>
