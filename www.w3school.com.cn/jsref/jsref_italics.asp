...
<title>JavaScript italics() 方法</title>
...
<p>italics() 方法用于把字符串显示为斜体。</p>

<h3>语法</h3>

<pre>stringObject.italics()</pre>
</div>
...
<dl>
<dt><a href="/tiy/t.asp?f=jseg_str_style">italics()</a></dt>
<dd>如何使用 italics() 把字符串显示为斜体。</dd>
</dl>
</div>
