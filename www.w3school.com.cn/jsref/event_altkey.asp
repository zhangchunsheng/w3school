...
<div>
<h2>定义和用法</h2>
<p>altKey 事件属性返回一个布尔值。指示在指定的事件发生时，Alt 键是否被按下并保持住了。</p>

<h3>语法</h3>
<pre>event.altKey=true|false|1|0</pre>
</div>

<div>
<h2>实例</h2>
<p>下面的例子可提示当鼠标按键被点击时 &quot;ALT&quot; 键是否已被按住：</p>
<pre>&lt;html&gt;
&lt;head&gt;
&lt;script type=&quot;text/javascript&quot;&gt;
function isKeyPressed(event)
{
  if (<code>event.altKey==1</code>)
    {
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_event_altkey">altKey</a></dt>
<dd>检测 ALT 键是否已被按住。</dd>
</dl>
</div>
