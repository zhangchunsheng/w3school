...
<title>HTML DOM background 属性</title>
...
<div>
<h2>定义和用法</h2>
<p>background 属性在一个声明中设置所有的背景属性。</p>

<h3>语法：</h3>
<pre>Object.style.background=background-color background-image
background-repeat background-attachment background-position</pre>
...
function setStyle()
{
<code>document.body.style.background=&quot;#FFCC80 url(bgdesert.jpg) repeat-y&quot;;</code>
}
&lt;/script&gt;
&lt;/head&gt;
&lt;body&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_style_background">改变文档背景的样式</a></dt>
</dl>
</div>
