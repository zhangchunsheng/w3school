...
<div>
<h2>定义和用法</h2>
<p>tabIndex 属性可设置或返回某个区域的 tab 键控制次序。</p>

<h3>语法</h3>
<pre>areaObject.tabIndex=tabIndex</pre>
</div>

<div>
<h2>实例</h2>
<p>下面的例子可展示图像映射中区域的 tab 键控制次序：</p>
<pre>&lt;html&gt;
&lt;head&gt;
&lt;script type=&quot;text/javascript&quot;&gt;
function showTabIndex()
{
<code>var sun=document.getElementById('sun').tabIndex;
var mercury=document.getElementById('mercury').tabIndex;
var venus=document.getElementById('venus').tabIndex;</code>
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_area_tabindex">返回图像映射中区域的 tab 键控制次序</a></dt>
</dl>
</div>
