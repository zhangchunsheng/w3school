...
<title>JavaScript setUTCHours() 方法</title>
...
<h1>JavaScript setUTCHours() 方法</h1>
...
<p>setUTCHours() 方法用于根据世界时 (UTC) 设置小时（0 - 23）。</p>

<h3>语法</h3>

<pre>dateObject.setUTCHours(<i>hour</i>,<i>min</i>,<i>sec</i>,<i>millisec</i>)</pre>
...
<table class="dataintable"> 
  ...
  <tr>
    <td>hour</td>
    <td>
	<p>必需。要给 dateObject 设置的小时字段的值。</p>
	<p>该参数是 0 ~ 23 之间的整数。</p>
	</td>
  </tr>
  <tr>
    <td>min</td>
    <td>
	<p>可选。要给 dateObject 设置的分钟字段的值。</p>
	<p>该参数是 0 ~ 59 之间的整数。</p>
	</td>
  </tr>
  <tr>
  ...
  <tr>
    <td>millisec</td>
    <td>
	<p>可选。要给 dateObject 设置的毫秒字段的值。</p>
	<p>该参数是 1 ~ 999 之间的整数。</p>
	</td>
  </tr>
</table>
...
<p>如果没有规定 <i>min</i>, <i>sec</i> 以及 <i>millisec</i> 参数，则使用从 getUTCMinutes, getUTCSeconds 以及 getUTCMilliseconds 方法返回的值。</p>

<p>如果您规定的参数在指定范围之外，则 setUTCHours 尝试据此来更新 Date 对象中的日期信息。例如，如果 <i>sec</i> 参数的值是 100，则增加 1 分钟 (<i>min</i> + 1)，而秒数为 40。</p>
...
<p>在本例中，我们将通过 setUTCHours() 方法将 UTC 小时设置为 23：</p>

<pre>
&lt;script type=&quot;text/javascript&quot;&gt;

var d = new Date();
<code>d.setUTCHours(23);</code>
document.write(d);
...
<p><a href="/tiy/t.asp?f=jseg_setutchours">亲自试一试</a></p>

<h3>例子 2</h3>

<p>在本例中，我们将通过 setUTCHours() 方法将 UTC 小时设置为 23:15:06 ：</p>

<pre>
&lt;script type=&quot;text/javascript&quot;&gt;

var d = new Date();
<code>d.setUTCHours(23,15,6);</code>
document.write(d);
...
<p><a href="/tiy/t.asp?f=jseg_setutchours2">亲自试一试</a></p>
</div>
...
<dl>
<dt><a href="/tiy/t.asp?f=jseg_setutchours">setUTCHours()</a></dt>
<dd>如何使用 setUTCHours() 来设置小时。</dd>
</dl>
</div>
