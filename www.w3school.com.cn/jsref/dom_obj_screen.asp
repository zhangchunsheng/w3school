...
<li class="currentLink"><a href="/jsref/dom_obj_screen.asp" title="HTML DOM Screen 对象">Screen</a></li>
...
<p class="note"><span>注释：</span>没有应用于 screen 对象的公开标准，不过所有浏览器都支持该对象。</p>
</div>
...
<table class="dataintable">
  ...
  <tr>
    <td><a href="/jsref/prop_screen_availheight.asp">availHeight</a></td>
    <td>返回显示屏幕的高度 (除 Windows 任务栏之外)。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_screen_availwidth.asp">availWidth</a></td>
    <td>返回显示屏幕的宽度 (除 Windows 任务栏之外)。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_screen_bufferdepth.asp">bufferDepth</a></td>
    <td>设置或返回调色板的比特深度。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_screen_colordepth.asp">colorDepth</a></td>
    <td>返回目标设备或缓冲器上的调色板的比特深度。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_screen_devicexdpi.asp">deviceXDPI</a></td>
    <td>返回显示屏幕的每英寸水平点数。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_screen_deviceydpi.asp">deviceYDPI</a></td>
    <td>返回显示屏幕的每英寸垂直点数。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_screen_fontsmoothingenabled.asp">fontSmoothingEnabled</a></td>
    <td>返回用户是否在显示控制面板中启用了字体平滑。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_screen_height.asp">height</a></td>
    <td>返回显示屏幕的高度。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_screen_logicalxdpi.asp">logicalXDPI</a></td>
    <td>返回显示屏幕每英寸的水平方向的常规点数。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_screen_logicalydpi.asp">logicalYDPI</a></td>
    <td>返回显示屏幕每英寸的垂直方向的常规点数。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_screen_pixeldepth.asp">pixelDepth</a></td>
    <td>返回显示屏幕的颜色分辨率（比特每像素）。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_screen_updateinterval.asp">updateInterval</a></td>
    <td>设置或返回屏幕的刷新率。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_screen_width.asp">width</a></td>
    <td>返回显示器屏幕的宽度。</td>
  </tr>
</table>
</div>
