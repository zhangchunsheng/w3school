...
<title>HTML DOM javaEnabled() 方法</title>
...
<div>
<h2>定义和用法</h2>
<p>javaEnabled() 方法可返回一个布尔值，该值指示浏览器是否支持并启用了 Java。如果是，则返回 true，否则返回 false。</p>
<p></p>
...
<div>
<h2>提示和注释</h2>
<p class="tip"><span>提示：</span>可以使用 navigator.javaEnabled() 来检测当前浏览器是否支持 Java，从而知道浏览器是否能显示 Java 小程序。</p>
</div>

<div>
<h2>实例</h2>
<p>下面的例子讲返回当前浏览器是否已启用 Java 的布尔值：</p>
<pre>&lt;html&gt;
&lt;body&gt;

&lt;script type=&quot;text/javascript&quot;&gt;
alert(<code>navigator.javaEnabled()</code>)
&lt;/script&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_nav_javaenabled">使用 navigator 对象的 javaEnabled() 方法</a></dt>
</dl>
</div>
