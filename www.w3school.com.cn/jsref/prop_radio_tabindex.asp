...
<div>
<h2>定义和用法</h2>
<p>tabIndex 属性可设置或返回单选按钮的 tab 键控制次序。</p>

<h3>语法</h3>
<pre>radioObject.tabIndex=number</pre>
</div>

<div>
<h2>实例</h2>
<p>下面的例子可显示出单选按钮的 tab index：</p>
<pre>&lt;html&gt;
&lt;head&gt;
&lt;script type=&quot;text/javascript&quot;&gt;
function showTabIndex()
  {
  var r1=<code>document.getElementById('radio1').tabIndex</code>;
  var r2=<code>document.getElementById('radio2').tabIndex</code>;
  var r3=<code>document.getElementById('radio3').tabIndex</code>;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_radio_tabindex">显示单选按钮的 tab 键控制次序</a></dt>
</dl>
</div>
