...
<p><a href="/jsref/dom_obj_option.asp">HTML DOM Option 对象</a></p>
</div>

<div>
<h2>定义和用法</h2>
<p>disabled 属性可设置或返回是否默认地禁用某个 &lt;option&gt; 元素。</p>
<p class="note"><span>注释：</span>该 disabled 属性在 IE 中不起作用。</p>
<p>如果该属性为 true，则该 &lt;option&gt; 元素将被禁用，用户就无法选择它了。</p>
<p>该属性映射 HTML 属性 disabled。</p>

<h3>语法</h3>
<pre>optionObject.disabled=true|false</pre>
</div>

<div>
<h2>实例</h2>
<p>下面的例子可提示所选的水果是否被默认地禁用：</p>
<pre>&lt;html&gt;
&lt;head&gt;
&lt;script type=&quot;text/javascript&quot;&gt;
function alertDefaultDisabled()
  ...
  alert(&quot;Is &quot; + y[x].text + &quot; disabled by default? &quot; + <code>y[x].disabled</code>);
  }
&lt;/script&gt;
&lt;/head&gt;
&lt;body&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_option_disabled_selected">检测某个选项是否被默认地禁用</a></dt>
<dt><a href="/tiy/t.asp?f=hdom_option_disabled_id">通过 id 禁用某个选项</a></dt>
</dl>
</div>
