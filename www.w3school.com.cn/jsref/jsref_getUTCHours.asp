...
<title>JavaScript getUTCHours() 方法</title>
...
<h1>JavaScript getUTCHours() 方法</h1>
...
<p>getUTCHours() 方法可根据世界时 (UTC) 返回时间的小时。</p>

<h3>语法</h3>

<pre>dateObject.getUTCHours()</pre>

<h3>返回值</h3>

<p>返回 dateObject 用世界时表示时的小时字段，该值是一个 0（午夜） ~ 23（晚上 11 点） 之间的整数。</p>
</div>
...
<p class="note"><span>注释：</span>由 getUTCHours() 返回的值是一个两位的数字。不过返回值不总是两位的，如果该值小于 10，则仅返回一位数字。</p>
...
<p>在这里，我们将从具体的日期和时间中提取 UTC 小时：</p>
