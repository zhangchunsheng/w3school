...
<div>
<h2>定义和用法</h2>
<p>add() 方法用于向 &lt;select&gt; 添加一个 &lt;option&gt; 元素。</p>

<h3>语法</h3>
<pre>selectObject.add(option,before)</pre>
...
<table class="dataintable">
	...
	<tr>
		<td>option</td>
		<td>必需。要添加选项元素。必需是 option 或 optgroup 元素。</td>
	</tr>
	<tr>
		<td>before</td>
		<td>必需。在选项数组的该元素之前增加新的元素。如果该参数是null，元素添加到选项数组的末尾。</td>
	</tr>
</table>
</div>
...
<div>
<h2>实例</h2>
<p>下面的例子可向下拉列表的末尾添加一个 &quot;kiwi&quot; 选项：</p>
<pre>&lt;html&gt;
&lt;head&gt;
&lt;script type=&quot;text/javascript&quot;&gt;
function insertOption()
  ...
  try
    {
    <code>x.add(y,null);</code> <span>// standards compliant</span>
    }
  catch(ex)
    {
    <code>x.add(y);</code> <span>// IE only</span>
    }
  }
&lt;/script&gt;
&lt;/head&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_select_add">把一个选项添加到下拉列表的末尾</a></dt>
<dt><a href="/tiy/t.asp?f=hdom_select_add2">在下拉列表的被选选项之前添加选项</a></dt>
</dl>
</div>
