...
<div>
<h2>定义和用法</h2>
<p>id 属性可设置或返回框架集的 id。</p>

<h3>语法</h3>
<pre>framesetObject.id=id</pre>
</div>
...
<p>HTML 文档 &quot;frame_frameset_id.htm&quot; 被放入第一列，而 HTML 文档 &quot;frame_a.htm&quot; 被放入第二列。</p>
<p>下面是 &quot;frame_frameset_id.htm&quot; 的源代码：</p>
...
function showFrameId()
  {
  var txt=&quot;Frameset Id: &quot;
  txt=txt + <code>parent.document.getElementById(&quot;main&quot;).id</code>
  alert(txt)
  }
&lt;/script&gt;
&lt;/head&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_frameset_id">取得 &lt;frameset&gt; 元素的 id</a></dt>
</dl>
</div>
