...
<title>HTML DOM cellSpacing 属性</title>
...
<div>
<h2>定义和用法</h2>
<p>cellSpacing 属性可设置或返回在表格中的单元格之间的空白量（以像素为单位）。</p>

<h3>语法</h3>
<pre>tableObject.cellSpacing=pixels</pre>
</div>

<div>
<h2>实例</h2>
<p>下面的例子更改了表格的 cellSpacing：</p>
<pre>&lt;html&gt;
&lt;head&gt;
&lt;script type=&quot;text/javascript&quot;&gt;
function spacing()
  {
  <code>document.getElementById('myTable').cellSpacing=&quot;15&quot;</code>
  }
&lt;/script&gt;
&lt;/head&gt;
&lt;body&gt;
