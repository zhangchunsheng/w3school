...
<div>
<h2>定义和用法</h2>
<p>focus() 方法用于向按钮赋予焦点。</p>

<h3>语法</h3>
<pre>buttonObject.focus()</pre>
</div>
...
function setFocus()
  {
  <code>document.getElementById('button1').focus()</code>
  }
&lt;/script&gt;
&lt;/head&gt;
&lt;body&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_button_focus_blur">设置并从按钮上移开焦点</a></dt>
</dl>
</div>
