...
<div>
<h2>定义和用法</h2>
<p>button 事件属性可返回一个整数，指示当事件被触发时哪个鼠标按键被点击。</p>

<h3>语法</h3>
<pre>event.button=0|1|2</pre>
...
<div>
<h2>提示和注释</h2>
<p class="note"><span>注释：</span>对于惯用左手的鼠标配置，上面的参数是颠倒的。</p>
<p class="tip"><span>提示：</span>Mozilla 的 Ctrl–Click 参数是 2 （等价于右击）。</p>
</div>

<div>
<h2>实例</h2>
<p>The following example alerts which mouse button was clicked:</p>
<pre>&lt;html&gt;
&lt;head&gt;
&lt;script type=&quot;text/javascript&quot;&gt;
function whichButton(event)
  {
    if (<code>event.button==2</code>)
      {
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_event_button">button</a></dt>
<dd>检测哪个鼠标键被点击了。</dd>
</dl>
</div>
