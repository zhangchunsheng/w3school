...
<div>
<h2>定义和用法</h2>
<p>tabIndex 属性可为链接设置或返回 tab 键控制次序。</p>

<h3>语法</h3>
<pre>anchorObject.tabIndex=tabIndex</pre>
</div>

<div>
<h2>实例</h2>
<p>下面的例子可更改三个链接的 tab 键控制次序：</p>
<pre>&lt;html&gt;
&lt;head&gt;
&lt;script type=&quot;text/javascript&quot;&gt;
function changeTabIndex()
  {
  <code>document.getElementById('1').tabIndex=&quot;3&quot;
  document.getElementById('2').tabIndex=&quot;2&quot;
  document.getElementById('3').tabIndex=&quot;1&quot;</code>
  }
&lt;/script&gt;
&lt;/head&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_anchor_tabindex">为链接设置 tab 键控制次序</a></dt>
</dl>
</div>
