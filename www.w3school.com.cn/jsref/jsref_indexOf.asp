...
<title>JavaScript indexOf() 方法</title>
...
<pre>stringObject.indexOf(searchvalue,fromindex)</pre>
...
<p>该方法将从头到尾地检索字符串 stringObject，看它是否含有子串 searchvalue。开始检索的位置在字符串的 fromindex 处或字符串的开头（没有指定 fromindex 时）。如果找到一个 searchvalue，则返回 searchvalue 的第一次出现的位置。stringObject 中的字符位置是从 0 开始的。</p>
</div>
...
<p class="note"><span>注释：</span>indexOf() 方法对大小写敏感！</p>
...
<dl>
<dt><a href="/tiy/t.asp?f=jseg_indexof">indexOf()</a></dt>
<dd>如何使用 indexOf() 在字符串内进行检索。</dd>
</dl>
</div>
...
<p><a href="/jsref/jsref_charCodeAt.asp">charCodeAt() 方法</a>、<a href="/jsref/jsref_lastIndexOf.asp">lastIndexOf() 方法</a>、<a href="/jsref/jsref_substring.asp">substring() 方法</a></p>
</div>
