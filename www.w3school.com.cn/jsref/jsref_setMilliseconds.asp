...
<title>JavaScript setMilliseconds() 方法</title>
...
<h1>JavaScript setMilliseconds() 方法</h1>
...
<p>setMilliseconds() 方法用于设置指定时间的毫秒字段。</p>

<h3>语法</h3>

<pre>dateObject.setMilliseconds(millisec)</pre>
...
<table class="dataintable"> 
  ...
  <tr>
    <td>millisec</td>
    <td>必需。用于设置 dateObject 毫秒字段，该参数是介于 0 ~ 999 之间的整数。</td>
  </tr>
</table>
...
<p>在本例中，我们将通过 setMilliseconds() 方法把当前时间的毫秒字段设置为 001：</p>
...
<dl>
<dt><a href="/tiy/t.asp?f=jseg_setmilliseconds">setMilliseconds()</a></dt>
<dd>如何使用 setMilliseconds() 来更改当前的毫秒。</dd>
</dl>
</div>
