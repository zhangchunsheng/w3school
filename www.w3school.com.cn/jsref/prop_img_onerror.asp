...
<title>HTML DOM onerror 事件句柄</title>
...
<div>
<h2>定义和用法</h2>
<p>在装载图像的过程中发生错误时调用的事件句柄。</p>

<h3>语法</h3>
<pre>imageObject.onerror</pre>

<h3>说明</h3>
<p>Image 对象的属性 onerror 声明了一个事件句柄函数，当装载图像的过程中发生了错误时就会调用这个句柄。</p>
</div>
