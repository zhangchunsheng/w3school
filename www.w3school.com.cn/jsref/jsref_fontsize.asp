...
<title>JavaScript fontsize() 方法</title>
...
<p>fontsize() 方法用于按照指定的尺寸来显示字符串。</p>

<h3>语法</h3>

<pre>stringObject.fontsize(size)</pre>
</div>
...
<p class="note"><span>注释：</span>size 参数必须是从 1 至 7 的数字。</p>
</div>
...
<dl>
<dt><a href="/tiy/t.asp?f=jseg_str_style">fontsize()</a></dt>
<dd>如何使用 fontsize() 把字符串显示为大号字。</dd>
</dl>
</div>
