...
<title>HTML DOM defaultChecked 属性</title>
...
<h1>HTML DOM defaultChecked 属性</h1>
...
<div>
<h2>定义和用法</h2>
<p>defaultChecked 属性可返回 checked 属性的默认值。</p>
<p>该属性在 checkbox 默认被选定时返回 true，否则返回 false。</p>

<h3>语法</h3>
<pre>checkboxObject.defaultChecked</pre>
</div>

<div>
<h2>实例</h2>
<p>下面的例子可返回 checked 属性的值：</p>
<pre>&lt;html&gt;
&lt;body&gt;
...
&lt;script type=&quot;text/javascript&quot;&gt;
alert(<code>document.getElementById(&quot;myCheck&quot;).defaultChecked</code>)
&lt;/script&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_checkbox_defaultchecked">返回 checkbox 是否默认被选中</a></dt>
