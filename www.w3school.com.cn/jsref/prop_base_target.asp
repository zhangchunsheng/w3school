...
<div>
<h2>定义和用法</h2>
<p>target 属性可设置或返回页面中所有链接的默认 target。</p>

<h3>语法</h3>
<pre>baseObject.target=target</pre>
</div>

<div>
<h2>实例</h2>
<p>下面的例子可返回默认的链接 target：</p>
<pre>&lt;html&gt;
&lt;head&gt;
...
document.write(<code>x.target</code>);
&lt;/script&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_base_target">取得 HTML 文档的基本 target</a></dt>
</dl>
</div>
