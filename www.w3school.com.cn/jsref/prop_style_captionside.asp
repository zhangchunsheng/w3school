...
<title>HTML DOM captionSide 属性</title>
...
<div>
<h2>定义和用法</h2>
<p>captionSide 属性设置表格标题的位置。</p>

<h3>语法：</h3>
<pre>Object.style.captionSide=top|bottom|left|right</pre>
...
{
<code>document.getElementById('myTable').style.captionSide=&quot;right&quot;</code>
}
&lt;/script&gt;
&lt;/head&gt;
&lt;body&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_style_captionside">captionSide - 对表格标题进行定位</a>（请在非 IE 浏览器中查看） </dt>
</dl>
</div>
