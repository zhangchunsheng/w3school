...
<title>HTML DOM FileUpload 对象</title>
...
<li class="currentLink"><a href="/jsref/dom_obj_fileupload.asp" title="HTML DOM FileUpload 对象">&lt;input&gt; file</a></li>
...
<p>您可以通过遍历表单的 elements[] 数组，或者通过使用 document.getElementById()来访问 FileUpload 对象。</p>
</div>


<div>
<h2>FileUpload 对象的属性</h2>
...
<table class="dataintable">
  ...
  <tr>
    <td>accept</td>
    <td>设置或返回指示文件传输的 MIME 类型的列表（逗号分隔）。</td>
  </tr>
  <tr>
    <td>accessKey</td>
...
<table class="dataintable">
  ...
  <tr>
    <td>blur()</td>
    <td>从 FileUpload 对象上移开焦点。</td>
  </tr>
  <tr>
    <td>focus()</td>
    <td>为 FileUpload 对象赋予焦点。</td>
  </tr>
  <tr>
    <td>select()</td>
    <td>选取 FileUpload 对象。</td>
  </tr>
</table>
</div>
