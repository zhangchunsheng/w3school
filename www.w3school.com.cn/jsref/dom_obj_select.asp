...
<title>HTML DOM Select 对象</title>
...
<li class="currentLink"><a href="/jsref/dom_obj_select.asp" title="HTML DOM Select 对象">&lt;select&gt;</a></li>
...
<h1>HTML DOM Select 对象</h1>


<div>
<h2>Select 对象</h2>

<p>Select 对象代表 HTML 表单中的一个下拉列表。</p>

<p>在 HTML 表单中，&lt;select&gt; 标签每出现一次，一个 Select 对象就会被创建。</p>

<p>您可通过遍历表单的 elements[] 数组来访问某个 Select 对象，或者使用 document.getElementById()。</p>
</div>
...
<table class="dataintable">
  ...
  <tr>
    <td><a href="/jsref/coll_select_options.asp">options[]</a></td>
    <td>返回包含下拉列表中的所有选项的一个数组。</td>
  </tr>
</table>
</div>
...
<table class="dataintable">
  ...
  <tr>
    <td><a href="/jsref/prop_select_disabled.asp">disabled</a></td>
    <td>设置或返回是否应禁用下拉列表。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_select_form.asp">form</a></td>
    <td>返回对包含下拉列表的表单的引用。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_select_id.asp">id</a></td>
    <td>设置或返回下拉列表的 id。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_select_length.asp">length</a></td>
    <td>返回下拉列表中的选项数目。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_select_multiple.asp">multiple</a></td>
    <td>设置或返回是否选择多个项目。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_select_name.asp">name</a></td>
    <td>设置或返回下拉列表的名称。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_select_selectedindex.asp">selectedIndex</a></td>
    <td>设置或返回下拉列表中被选项目的索引号。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_select_size.asp">size</a></td>
    <td>设置或返回下拉列表中的可见行数。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_select_tabindex.asp">tabIndex</a></td>
    <td>设置或返回下拉列表的 tab 键控制次序。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_select_type.asp">type</a></td>
    <td>返回下拉列表的表单类型。</td>
  </tr>
</table>
</div>
...
<table class="dataintable">
  ...
  <tr>
    <td><a href="/jsref/met_select_add.asp">add()</a></td>
    <td>向下拉列表添加一个选项。</td>
  </tr>
  <tr>
    <td><a href="/jsref/met_select_blur.asp">blur()</a></td>
    <td>从下拉列表移开焦点。</td>
  </tr>
  <tr>
    <td><a href="/jsref/met_select_focus.asp">focus()</a></td>
    <td>在下拉列表上设置焦点。</td>
  </tr>
  <tr>
    <td><a href="/jsref/met_select_remove.asp">remove()</a></td>
    <td>从下拉列表中删除一个选项。</td>
  </tr>
</table>
</div>
...
<table class="dataintable">
  ...
  <tr>
    <td><a href="/jsref/prop_select_onchange.asp">onchange</a></td>
    <td>当改变选择时调用的事件句柄。</td>
  </tr>
</table>
</div>
