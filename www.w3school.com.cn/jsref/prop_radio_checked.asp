...
<div>
<h2>定义和用法</h2>
<p>checked 属性可设置或返回某个单选按钮是否被选中。</p>

<h3>语法</h3>
<pre>radioObject.checked=true|false</pre>
</div>

<div>
<h2>实例</h2>
<p>下面的例子可对一个单选按钮进行选定和不选定：</p>
<pre>&lt;html&gt;
&lt;head&gt;
&lt;script type=&quot;text/javascript&quot;&gt;
function check()
  {
  <code>document.getElementById(&quot;radio1&quot;).checked=true</code>
  }
function uncheck()
  {
  <code>document.getElementById(&quot;radio1&quot;).checked=false</code>
  }
&lt;/script&gt;
&lt;/head&gt;
&lt;body&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_radio_checked">选定及不选定单选按钮</a></dt>
</dl>
</div>
