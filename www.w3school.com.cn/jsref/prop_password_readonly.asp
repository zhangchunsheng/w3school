...
<title>HTML DOM readOnly 属性</title>
...
<div>
<h2>定义和用法</h2>
<p>readOnly 属性可设置或返回密码域是否为只读。</p>

<h3>语法</h3>
<pre>passwordObject.readOnly=true|false</pre>
</div>
...
function makeReadOnly()
  {
  <code>document.getElementById(&quot;password1&quot;).readOnly=true</code>
  }
&lt;/script&gt;
&lt;/head&gt;
&lt;body&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_password_readonly">把密码域设置为只读</a></dt>
</dl>
</div>
