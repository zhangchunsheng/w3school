...
<div>
<h2>定义和用法</h2>
<p>rev 属性可设置或返回一个链接的反向关系。</p>
<p>rel 和 rev 属性可以同时在 &lt;a&gt; 标签中使用。</p>
<p>rel (relationship) 属性规定了从源文档到目标文档的关系。rev (reverse) 属性规定了从目标文档到当前文档的反向关系。</p>
<p>浏览器可以使用它们改变锚内容的外观，或者自动构建文档浏览菜单。其他工具也可以使用这些属性构建特殊的链接集合、目录和索引等。</p>

<h3>语法</h3>
<pre>anchorObject.rev=relationship</pre>
...
<table class="dataintable">
  ...
  <tr>
	...
	<tr>
    <td>bookmark</td>
    <td>链接到一个书签。在 web blogs 中常用于 &quot;permalink&quot;。</td>
  </tr>
	<tr>
    <td>chapter</td>
    <td>从当前文档链接到一个章节。</td>
...
document.write(<code>x.rev</code>);
&lt;/script&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_anchor_rev">取得链接的反向关系</a></dt>
</dl>
</div>
