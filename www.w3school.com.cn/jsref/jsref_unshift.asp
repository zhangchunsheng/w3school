...
<title>JavaScript unshift() 方法</title>
...
<h3>返回值</h3>
<p>arrayObject 的新长度。</p>

<h3>说明</h3>
<p>unshift() 方法将把它的参数插入 arrayObject 的头部，并将已经存在的元素顺次地移到较高的下标处，以便留出空间。该方法的第一个参数将成为数组的新元素 0，如果还有第二个参数，它将成为新的元素 1，以此类推。</p>

<p>请注意，unshift() 方法不创建新的创建，而是直接修改原有的数组。</p>
</div>


<div>
<h2>提示和注释</h2>
<p class="note"><span>注释：</span>该方法会改变数组的长度。</p>
<p class="note"><span>注释：</span>unshift() 方法无法在 Internet Explorer 中正确地工作！</p>
<p class="tip"><span>提示：</span>要把一个或多个元素添加到数组的尾部，请使用 push() 方法。</p>
</div>
	
<div>
<h2>实例</h2>
<p>在本例中，我们将创建一个数组，并把一个元素添加到数组的开头，并返回数组的新长度：</p>
...
document.write(<code>arr.unshift(&quot;William&quot;)</code> + &quot;&lt;br /&gt;&quot;)
document.write(arr)

&lt;/script&gt;</pre>
<p>输出：</p>
<pre>George,John,Thomas<br />4<br />William,George,John,Thomas</pre>
</div>

<div class="example">
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=jseg_unshift">unshift()</a></dt>
<dd>如何使用 unshift() 把一个元素添加到数组的开头，并返回数组的新长度。</dd>
</dl>
</div>
