...
<div>
<h2>定义和用法</h2>
<p>cells 集合返回表格中所有单元格的一个数组。</p>

<h3>语法</h3>
<pre>tableObject.cells[]</pre>
</div>

<div>
<h2>实例</h2>
<p>下面的例子使用 cells 来显示出第一个单元格的内容：</p>
<pre>&lt;html&gt;
&lt;head&gt;
&lt;script type=&quot;text/javascript&quot;&gt;
function cell()
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_table_cells">使用 cells[] 集合</a></dt>
</dl>
</div>
