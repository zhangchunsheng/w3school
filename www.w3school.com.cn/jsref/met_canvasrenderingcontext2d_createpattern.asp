...
<title>HTML DOM createPattern() 方法</title>
...
<h1>HTML DOM createPattern() 方法</h1>
...
<p>createPattern() 方法为贴图图像创建一个模式。</p>

<h3>语法</h3>
<pre>createPattern(<i>image</i>, <i>repetitionStyle</i>)</pre>
...
<td>image</td>
<td><p>需要贴图的图像。</p>
<p>这个参数通常是一个 Image 对象，但是也可以使用一个 Canvas 元素。</p></td>
</tr>
...
<p>表示模式的一个 <a href="dom_obj_createpattern.asp" title="HTML DOM CanvasPattern 对象">CanvasPattern 对象</a>。</p>
...
<p class="note"><span>注释：</span>Firefox 1.5 只支持 &quot;repeat&quot; 方式，其他的都被忽略。</p>
</div>
...
<p><a href="/jsref/dom_obj_createpattern.asp" title="HTML DOM CanvasPattern 对象">CanvasPattern</a></p>
</div>
