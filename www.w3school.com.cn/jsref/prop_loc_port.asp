...
<div>
<h2>定义和用法</h2>
<p>port 属性是一个可读可写的字符串，可设置或返回当前 URL 的端口部分。</p>

<h3>语法</h3>
<pre>location.port=portnumber</pre>
</div>
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_loc_port">使用 location 对象的 port 属性</a></dt>
</dl>
</div>
