...
<li class="currentLink"><a href="/jsref/dom_obj_text.asp" title="HTML DOM Text 对象">&lt;input&gt; text</a></li>
...
<p>您可以使用 HTML &lt;textarea&gt; 标记来创建多行文本输入。参阅 <a href="/jsref/dom_obj_textarea.asp">Textarea 对象</a>。</p>

<p>对于掩码文本输入，把 &lt;input type=&quot;text&quot;&gt; 中的 type 设置为 &quot;password&quot;。参阅 <a href="/jsref/dom_obj_password.asp">Input Password</a>。</p>
...
<table class="dataintable">
  ...
  <tr>
    <td><a href="/jsref/prop_text_accesskey.asp">accessKey</a></td>
    <td>设置或返回访问文本域的快捷键。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_text_alt.asp">alt</a></td>
    <td>设置或返回当浏览器不支持文本域时供显示的替代文本。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_text_defaultvalue.asp">defaultValue</a></td>
    <td>设置或返回文本域的默认值。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_text_disabled.asp">disabled</a></td>
    <td>设置或返回文本域是否应被禁用。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_text_form.asp">form</a></td>
    <td>返回一个对包含文本域的表单对象的引用。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_text_id.asp">id</a></td>
    <td>设置或返回文本域的 id。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_text_maxlength.asp">maxLength</a></td>
    <td>设置或返回文本域中的最大字符数。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_text_name.asp">name</a></td>
    <td>设置或返回文本域的名称。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_text_readonly.asp">readOnly</a></td>
    <td>设置或返回文本域是否应是只读的。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_text_size.asp">size</a></td>
    <td>设置或返回文本域的尺寸。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_text_tabindex.asp">tabIndex</a></td>
    <td>设置或返回文本域的 tab 键控制次序。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_text_type.asp">type</a></td>
    <td>返回文本域的表单元素类型。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_text_value.asp">value</a></td>
...
<table class="dataintable">
  ...
  <tr>
    <td><a href="/jsref/met_text_blur.asp">blur()</a></td>
    <td>从文本域上移开焦点。</td>
  </tr>
  <tr>
    <td><a href="/jsref/met_text_focus.asp">focus()</a></td>
    <td>在文本域上设置焦点。</td>
  </tr>
  <tr>
    <td><a href="/jsref/met_text_select.asp">select()</a></td>
    <td>选取文本域中的内容。</td>
  </tr>
</table>
</div>
