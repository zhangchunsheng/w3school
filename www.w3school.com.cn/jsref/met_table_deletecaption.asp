...
<title>HTML DOM deleteCaption() 方法</title>
...
<h1>HTML DOM deleteCaption() 方法</h1>
...
<div>
<h2>定义和用法</h2>
<p>deleteCaption() 方法用于删除表格的 caption 元素及其内容。</p>

<h3>语法</h3>
<pre>tableObject.deleteCaption()</pre>

<h3>说明</h3>
<p>如果该表有 &lt;caption&gt; 元素，则从文档树种删除它。否则，什么也不做。</p>
</div>
...
function deleteCaption()
  {
  <code>document.getElementById('myTable').deleteCaption()</code>
  }
&lt;/script&gt;
&lt;/head&gt;
&lt;body&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_table_deletecaption">删除表格的标题</a></dt>
</dl>
</div>
