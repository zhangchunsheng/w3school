...
<title>HTML DOM hostname 属性</title>
...
<div>
<h2>定义和用法</h2>
<p>hostname 属性是一个可读可写的字符串，可设置或返回当前 URL 的主机名。</p>
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_loc_hostname">使用 location 对象的 hostname 属性</a></dt>
</dl>
</div>
