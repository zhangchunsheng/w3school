...
<title>HTML DOM vAlign 属性</title>
...
<div>
<h2>定义和用法</h2>
<p>vAlign 属性设置或返回单元格内数据的垂直排列方式。</p>

<h3>语法</h3>
<pre>tabledataObject.vAlign=top|middle|bottom|baseline</pre>
</div>

<div>
<h2>实例</h2>
<p>下面的例子更改了单元格内数据的垂直排列方式：</p>
<pre>&lt;html&gt;
&lt;head&gt;
&lt;script type=&quot;text/javascript&quot;&gt;
function topAlign()
  {
  <code>document.getElementById('td1').vAlign=&quot;top&quot;;
  document.getElementById('td2').vAlign=&quot;top&quot;;
  document.getElementById('td3').vAlign=&quot;top&quot;;</code>
  }
&lt;/script&gt;
&lt;/head&gt;
&lt;body&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_tablecell_valign">更改单元格内数据的垂直排列方式</a></dt>
</dl>
</div>
