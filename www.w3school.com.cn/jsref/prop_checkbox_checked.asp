...
<title>HTML DOM checked 属性</title>
...
<h1>HTML DOM checked 属性</h1>

<div class="backtoreference">
<p><a href="/jsref/dom_obj_checkbox.asp">HTML DOM Checkbox 对象</a></p>
</div>

<div>
<h2>定义和用法</h2>
<p>checked 属性设置或返回 checkbox 是否应被选中。</p>

<h3>语法</h3>
<pre>checkboxObject.checked=true|false</pre>

<h3>说明</h3>
<p>该属性保存了 checkbox 的当前状态，不管何时，这个值发生变化的时候，onclick 事件句柄就会触发（也可能触发 onchange 事件句柄）。</p>
</div>

<div>
<h2>实例</h2>
<p>下面的例子可设置该 checkbox 的状态：</p>
<pre>&lt;html&gt;
&lt;head&gt;
&lt;script type=&quot;text/javascript&quot;&gt;
function check()
  {
  <code>document.getElementById(&quot;check1&quot;).checked=true</code>
  }
function uncheck()
  {
  <code>document.getElementById(&quot;check1&quot;).checked=false</code>
  }
&lt;/script&gt;
&lt;/head&gt;
&lt;body&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_input_checked">选定以及不选定 checkbox</a></dt>
<dt><a href="/tiy/t.asp?f=hdom_form_checkbox">一个表单中的若干个 checkbox</a></dt>
<dt><a href="/tiy/t.asp?f=hdom_checkbox">Checkbox - 把文本转换为大写</a></dt>
</dl>
</div>
