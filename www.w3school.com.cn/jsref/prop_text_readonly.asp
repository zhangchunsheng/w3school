...
<div>
<h2>定义和用法</h2>
<p>readOnly 属性设置或返回文本域是否为只读。</p>

<h3>语法</h3>
<pre>textObject.readOnly=true|false</pre>
</div>
...
function makeReadOnly()
  {
  <code>document.getElementById(&quot;text1&quot;).readOnly=true</code>
  }
&lt;/script&gt;
&lt;/head&gt;
&lt;body&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_text_readonly">将文本域设置为只读</a></dt>
</dl>
</div>
