...
<p><i>n</i>+ 量词匹配包含至少一个 <i>n</i> 的任何字符串。</p>
...
var patt1=<code>/o+/g</code>;
</pre>

<p>下面被标记的文本显示了表达式获得匹配的位置：</p>

<pre>Hell<span class="marked">ooo</span> W<span class="marked">o</span>rld! Hell<span class="marked">o</span> W3Sch<span class="marked">oo</span>l!</pre>

<p><a href="/tiy/t.asp?f=jseg_regexp_onemore">TIY</a></p>
...
var patt1=<code>/\w+/g</code>;
</pre>

<p>下面被标记的文本显示了表达式获得匹配的位置：</p>

<pre><span class="marked">Hello World</span>! <span class="marked">Hello W3School</span>!</pre>

<p><a href="/tiy/t.asp?f=jseg_regexp_onemore2">TIY</a></p>
</div>
