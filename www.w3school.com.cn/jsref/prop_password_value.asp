...
<div>
<h2>定义和用法</h2>
<p>value 属性可设置或返回密码域的默认值。</p>
<p>出于安全考虑，一些浏览器可能阻止 JavaScript 代码读取 value 属性。</p>

<h3>语法</h3>
<pre>passwordObject.value=text</pre>
</div>
...
function alertValue()
  {
  alert(<code>document.getElementById(&quot;password1&quot;).value</code>)
  }
&lt;/script&gt;
&lt;/head&gt;
&lt;body&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_password_value">获得密码域的默认值</a></dt>
</dl>
</div>
