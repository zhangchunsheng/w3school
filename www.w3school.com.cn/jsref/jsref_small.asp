...
<title>JavaScript small() 方法</title>
...
<div>
<h2>定义和用法</h2>
<p>small() 方法用于把字符串显示为小号字。</p>

<h3>语法</h3>
<pre>stringObject.small()</pre>
</div>

<div>
<h2>实例</h2>
<p>在本例中，&quot;Hello world!&quot; 将显示为小号字：</p>
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=jseg_str_style">small()</a></dt>
<dd>如何使用 small() 把字符串显示为小号字。</dd>
</dl>
</div>
