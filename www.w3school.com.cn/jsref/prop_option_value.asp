...
<div>
<h2>定义和用法</h2>
<p>value 属性可设置或返回选项的值。</p>
<p>当表单提交发生的时候，如果这个选项被选中，value 会和表单一起提交。映射 &lt;option&gt; 的 value 属性。</p>

<h3>语法</h3>
<pre>optionObject.value=somevalue</pre>
</div>
...
function alertValue()
  ...
  alert(<code>document.getElementsByTagName(&quot;option&quot;)[x].value</code>);
  }
&lt;/script&gt;
&lt;/head&gt;
&lt;body&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_option_value">返回被选选项的文本</a></dt>
</dl>
</div>
