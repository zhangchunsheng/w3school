...
<title>HTML DOM coords 属性</title>
...
<div>
<h2>定义和用法</h2>
<p>coords 属性可设置或返回图像映射中某个可点击区域的坐标。</p>

<h3>语法</h3>
<pre>areaObject.coords=coordinates</pre>
</div>

<div>
<h2>实例</h2>
<p>下面的例子可返回图像映射中某个可点击区域的坐标：</p>
<pre>&lt;html&gt;
&lt;body&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_anchor_coords">返回图像映射中某个可点击区域的坐标</a></dt>
</dl>
</div>
