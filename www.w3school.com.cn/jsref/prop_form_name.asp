...
<div>
<h2>定义和用法</h2>
<p>length 属性可设置或返回表单的名称。</p>

<h3>语法</h3>
<pre>formObject.name=formname</pre>
</div>
...
document.write(<code>document.getElementById('myForm').name</code>);
&lt;/script&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_form_name">取得 &lt;form&gt; 元素的名称</a></dt>
</dl>
</div>
