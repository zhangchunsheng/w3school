...
<p>如果结果是虚数或负数，则该方法将返回 NaN。如果由于指数过大而引起浮点溢出，则该方法将返回 Infinity。</p>
</div>
...
<p>在下面的例子中，我们将把 pow() 运用到不同的数字组合上：</p>
...
<dl>
<dt><a href="/tiy/t.asp?f=jseg_pow">pow()</a></dt>
<dd>如何使用 pow() 方法。</dd>
</dl>
</div>
