...
<title>HTML DOM borderCollapse 属性</title>
...
<h1>HTML DOM borderCollapse 属性</h1>
...
<div>
<h2>定义和用法</h2>
<p>borderCollapse 属性设置表格的边框是否被合并为一个单一的边框，还是象在标准的 HTML 中那样分开显示。</p>

<h3>语法：</h3>
<pre>Object.style.borderCollapse=collapse|separate</pre>
...
{
<code>document.getElementById('myTable').style.borderCollapse=&quot;collapse&quot;</code>
}
&lt;/script&gt;
&lt;/head&gt;
&lt;body&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_style_bordercollapse">borderCollapse - 把表格边框合并为单一边框</a></dt>
</dl>
</div>
