...
<p>?=<i>n</i> 量词匹配任何其后紧接指定字符串 <i>n</i> 的字符串。</p>
...
<p>对其后紧跟 &quot;all&quot; 的 &quot;is&quot; 进行全局搜索：</p>

<pre>
var str=&quot;Is this all there is&quot;;
var patt1=<code>/is(?= all)/g</code>;
</pre>

<p>下面被标记的文本显示了表达式获得匹配的位置：</p>

<pre>Is th<span class="marked">is</span> all there is</pre>

<p><a href="/tiy/t.asp?f=jseg_regexp_ahead">TIY</a></p>
</div>
