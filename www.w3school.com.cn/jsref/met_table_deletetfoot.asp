...
<title>HTML DOM deleteTFoot() 方法</title>
...
<div>
<h2>定义和用法</h2>
<p>deleteTFoot() 方法用于从表格删除 &lt;tfoot&gt; 元素。</p>

<h3>语法</h3>
<pre>tableObject.deleteTFoot()</pre>

<h3>说明</h3>
<p>如果该表有 &lt;tfoot&gt; 元素，则将它从文档树种删除，否则什么也不做。</p>
</div>
...
function delRow()
  {
  <code>document.getElementById('myTable').deleteTFoot()</code>
  }
&lt;/script&gt;
&lt;/head&gt;
&lt;body&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_table_deletetfoot">从表格删除脚注</a></dt>
</dl>
</div>
