...
<title>JavaScript toSource() 方法</title>
...
<p>toSource() 方法表示对象的源代码。</p>
<p>该原始值由 Array 对象派生的所有对象继承。</p>
<p>toSource() 方法通常由 JavaScript 在后台自动调用，并不显式地出现在代码中。</p>

<h3>语法</h3>
<pre>object.toSource()</pre>
</div>


<div>
<h2>浏览器支持</h2>
<p>只有 Gecko 核心的浏览器（比如 Firefox）支持该方法，也就是说 IE、Safari、Chrome、Opera 等浏览器均不支持该方法。</p>
</div>
...
document.write(<code>bill.toSource()</code>);

&lt;/script&gt;</pre>

<p>输出：</p>

<pre>({name:"Bill Gates", job:"Engineer", born:1985}) </pre>

<p><a href="/tiy/t.asp?f=jseg_tosource">TIY</a></p>
</div>
