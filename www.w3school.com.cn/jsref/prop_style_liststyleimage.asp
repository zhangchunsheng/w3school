...
<title>HTML DOM listStyleImage 属性</title>
...
<h1>HTML DOM listStyleImage 属性</h1>
...
<div>
<h2>定义和用法</h2>
<p>listStyleImage 属性把图像设置为列表项标志。</p>

<h3>语法：</h3>
<pre>Object.style.listStyleImage=url|none</pre>
...
function changeList()
{
<code>document.getElementById(&quot;ul1&quot;).style.listStyleImage=&quot;url('blueb.gif')&quot;;</code>
}
&lt;/script&gt;
&lt;/head&gt;
&lt;body&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_style_liststyleimage">listStyleImage - 改变列表的列表项标志</a></dt>
</dl>
</div>
