...
<title>JavaScript getDate() 方法</title>
...
<p>getDate() 方法可返回月份的某一天。</p>

<h3>语法</h3>

<pre>dateObject.getDate()</pre>

<h3>返回值</h3>

<p>dateObject 所指的月份中的某一天，使用本地时间。返回值是 1 ~ 31 之间的一个整数。</p>
</div>
...
<p>在本例中，我们定义了一个带有具体日期的变量，并输出变量中月份的天：</p>
...
<dl>
<dt><a href="/tiy/t.asp?f=jseg_getDate">getDate()</a></dt>
<dd>如何使用 getDate() 来取得当前月份的日期。</dd>
<dt><a href="/tiy/t.asp?f=jseg_datedate">以不同的格式显示当前日期</a></dt>
<dd>如何使用 getDate(), getMonth() 以及 getFullYear() 以不同的格式来显示当前日期。</dd>
</dl>
</div>
