...
<div>
<h2>定义和用法</h2>
<p>type 属性可返回表单元素的类型。对于 hidden 对象，该属性总是 &quot;hidden&quot;。</p>

<h3>语法</h3>
<pre>hiddenObject.type</pre>
</div>

<div>
<h2>实例</h2>
<p>下面的例子返回了该隐藏域的表单元素类型：</p>
<pre>&lt;html&gt;
&lt;body&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_hidden_type">取得隐藏域的表单元素类型</a></dt>
</dl>
</div>
