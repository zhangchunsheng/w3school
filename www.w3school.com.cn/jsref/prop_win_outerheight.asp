...
<title>HTML DOM outerheight 属性</title>
...
<div>
<h2>定义和用法</h2>
<p>outerheight 属性是一个只读的整数，声明了整个窗口的高度。</p>
	
<h3>语法</h3>
<pre>window.outerheight=pixels</pre>
</div>

<div>
<h2>提示和注释</h2>
<p class="tip"><span>提示：</span>IE 不支持此属性，且没有提供替代的属性。</p>
</div>

<div>
<h2>实例</h2>
<p>下面的例子可把新窗口设置为 100x100 像素：</p>
...
<h3>TIY</h3>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_win_outerheight">设置窗口的高度和宽度</a></dt>
</dl>
</div>
