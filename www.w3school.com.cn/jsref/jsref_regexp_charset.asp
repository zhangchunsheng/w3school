...
<p>[abc] 表达式用于查找方括号之间的任何字符。</p>

<p>方括号内的字符可以是任何字符或字符范围。</p>

<h3>语法</h3>

<pre>new RegExp(&quot;[abc]&quot;)</pre>
...
<pre>Is t<span class="marked">h</span>is <span class="marked">a</span>ll t<span class="marked">he</span>r<span class="marked">e</span> is?</pre>

<p><a href="/tiy/t.asp?f=jseg_regexp_charset">TIY</a></p>
</div>
