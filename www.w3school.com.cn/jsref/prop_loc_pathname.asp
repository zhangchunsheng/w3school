...
<title>HTML DOM pathname 属性</title>
...
<div>
<h2>定义和用法</h2>
<p>pathname 属性是一个可读可写的字符串，可设置或返回当前 URL 的路径部分。</p>

<h3>语法</h3>
<pre>location.pathname=path</pre>
</div>


<div>
<h2>实例</h2>
<p>假设当前的 URL 是: http://example.com:1234/test/test.htm#part2：</p>
<pre>&lt;html&gt;
&lt;body&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_loc_pathname">使用 location 对象的 pathname 属性</a></dt>
</dl>
</div>
