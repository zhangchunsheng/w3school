...
<div>
<h2>定义和用法</h2>
<p>marginHeight 属性可设置或返回框架顶部和底部的页面空白（以像素计）。</p>

<h3>语法</h3>
<pre>iframeObject.marginHeight=pixels</pre>
</div>

<div>
<h2>实例</h2>
<p>下面的例子可返回 iframe 顶部和底部的页面空白：</p>
<pre>&lt;html&gt;
&lt;body&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_iframe_marginheight">返回 iframe 的顶部和底部页空白</a></dt>
</dl>
</div>
