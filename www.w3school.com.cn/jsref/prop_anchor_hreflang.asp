...
<div>
<h2>定义和用法</h2>
<p>hreflang 属性可设置或返回被链资源的语言代码。</p>

<h3>语法</h3>
<pre>anchorObject.hreflang=languagecode</pre>
</div>

<div>
<h2>实例</h2>
<p>下面的例子将返回被链资源的语言代码：</p>
<pre>&lt;html&gt;
&lt;body&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_anchor_hreflang">取得被链资源的语言代码</a></dt>
</dl>
</div>
