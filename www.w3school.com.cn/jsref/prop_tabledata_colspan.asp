...
<title>HTML DOM colSpan 属性</title>
...
<div>
<h2>定义和用法</h2>
<p>colSpan 属性可设置或返回表元横跨的列数。</p>

<h3>语法</h3>
<pre>tabledataObject.colSpan=number_of_columns</pre>
</div>
...
function changeColSpan()
  {
  <code>document.getElementById(&quot;td1&quot;).colSpan=&quot;2&quot;;</code>
  }
&lt;/script&gt;
&lt;/head&gt;
&lt;body&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_tablecell_colspan">更改表元横跨的列数</a></dt>
</dl>
</div>
