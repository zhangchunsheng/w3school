...
<h1>onmousedown 事件</h1>

<div class="backtoreference">
<p><a href="/jsref/dom_obj_event.asp">Event 对象</a></p>
</div>

<div>
<h2>定义和用法</h2>
<p>onmousedown 事件会在鼠标按键被按下时发生。</p>

<h3>语法</h3>
<pre>onmousedown=&quot;SomeJavaScriptCode&quot;</pre>
...
<pre>button, document, link</pre>
</div>

<div>
<h2>实例</h2>
<p>在本例中，当您点击下面的图片时会弹出一个对话框：</p>
<pre>&lt;img src=&quot;/i/example_mouse2.jpg&quot; 
<code>onmousedown=&quot;alert('You clicked the picture!')&quot;</code> /&gt;</pre>

<h3>输出：（请点击图片）</h3>
<img src="/i/eg_mouse2.jpg" onMouseDown="alert('You clicked the picture!')" />
</div>

<div>
<h2>实例 2</h2>
<p>在本例中，对话框将显示出您所点击的元素的标签名：</p>
<pre>&lt;html&gt;
&lt;head&gt;
&lt;script type=&quot;text/javascript&quot;&gt;
...
if (targ.nodeType == 3) <span>// defeat Safari bug</span>
...
&lt;body <code>onmousedown=&quot;whichElement(event)&quot;</code>&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_onmousedown">onmousedown</a></dt>
<dd>如何使用 onmousedown 在图像被点击时显示一个对话框。</dd>
<dt><a href="/tiy/t.asp?f=hdom_event_srcelement">onmousedown 2</a></dt>
<dd>如何使用 onmousedown 来显示您所点击的元素的标签名。</dd>
</dl>
</div>
