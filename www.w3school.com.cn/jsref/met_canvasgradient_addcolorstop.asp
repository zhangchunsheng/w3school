...
<title>HTML DOM addColorStop() 方法</title>
...
<h1>HTML DOM addColorStop() 方法</h1>

<div class="backtoreference">
<p><a href="/jsref/dom_obj_canvasgradient.asp" title="HTML DOM CanvasGradient 对象">HTML DOM CanvasGradient 对象</a></p>
</div>

<div>
<h2>定义和用法</h2>

<p>addColorStop() 方法在渐变中的某一点添加一个颜色变化。</p>

<h3>语法</h3>
<pre>addColorStop(<i>offset</i>, <i>color</i>)</pre>
...
<tr>
<td>offset</td>
<td>这是一个范围在 0.0 到 1.0 之间的浮点值，表示渐变的开始点和结束点之间的一部分。offset 为 0 对应开始点，offset 为 1 对应结束点。</td>
</tr>

<tr>
<td>color</td>
<td>以一个 CSS 颜色字符串的方式，表示在指定 offset 显示的颜色。沿着渐变某一点的颜色是根据这个值以及任何其他的颜色色标来插值的。</td>
</tr>
</table>
...
<p>addColorStop() 提供了一种描述渐变中颜色变化的方法。该方法可以调用一次或多次来改变渐变的开始点和结束点之间的特定百分段的颜色。</p>

<p>如果这个方法无法在一个渐变上调用，那么这个渐变是透明的。至少必须指定一个颜色色标来产生一个可见的颜色渐变。</p>
</div>
