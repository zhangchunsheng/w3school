...
<title>HTML DOM Submit 对象</title>
...
<li class="currentLink"><a href="/jsref/dom_obj_submit.asp" title="HTML DOM Submit 对象">&lt;input&gt; submit</a></li>
...
<h1>HTML DOM Submit 对象</h1>


<div>
<h2>Submit 对象</h2>

<p>Submit 对象代表 HTML 表单中的一个提交按钮 (submit button)。</p>

<p>在 HTML 表单中 &lt;input type=&quot;submit&quot;&gt; 标签每出现一次，一个 Submit 对象就会被创建。</p>

<p>在表单提交之前，触发 onclick 事件句柄，并且一个句柄可以通过返回 fasle 来取消表单提交。</p>

<p>参阅 <a href="/jsref/met_form_submit.asp">Form.submit() 方法</a> 和 <a href="/jsref/prop_form_onsubmit.asp">Form.onsubmit</a> 事件句柄。</p>

<p>实例：<a target="_blank" href="/tiy/t.asp?f=hdom_formvalidate">表单验证</a></p>

<p>您可以通过遍历表单的 elements[] 数组来访问某个提交按钮，或者通过使用document.getElementById()。</p>
</div>
...
<table class="dataintable">
  ...
  <tr>
    <td><a href="/jsref/prop_submit_accesskey.asp">accessKey</a></td>
    <td>设置或返回访问提交按钮的快捷键。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_submit_alt.asp">alt</a></td>
    <td>设置或返回当浏览器不支持提交按钮时供显示的替代文本。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_submit_disabled.asp">disabled</a></td>
    <td>设置或返回提交按钮是否应被禁用。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_submit_form.asp">form</a></td>
    <td>返回一个对包含此提交按钮的表单的引用。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_submit_id.asp">id</a></td>
    <td>设置或返回提交按钮的 id。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_submit_name.asp">name</a></td>
    <td>设置或返回提交按钮的名称。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_submit_tabindex.asp">tabIndex</a></td>
    <td>设置或返回提交按钮的 tab 键控制次序。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_submit_type.asp">type</a></td>
    <td>返回提交按钮的表单元素类型。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_submit_value.asp">value</a></td>
    <td>设置或返回在提交按钮上显示的文本。</td>
  </tr>
</table>
</div>
