...
<title>HTML DOM Canvas 对象</title>
...
<li class="currentLink"><a href="/jsref/dom_obj_canvas.asp" title="HTML DOM Canvas 对象">&lt;canvas&gt;</a></li>
...
<h1>HTML DOM Canvas 对象</h1>


<div>
<h2>Canvas 对象</h2>

<p>Canvas 对象表示一个 HTML 画布元素 - <a href="/html5/tag_canvas.asp" title="HTML 5 &lt;canvas&gt; 标签">&lt;canvas&gt;</a>。它没有自己的行为，但是定义了一个 API 支持脚本化客户端绘图操作。</p>

<p>你可以直接在该对象上指定宽度和高度，但是，其大多数功能都可以通过 <a href="/jsref/dom_obj_canvasrenderingcontext2d.asp" title="HTML DOM CanvasRenderingContext2D 对象">CanvasRenderingContext2D 对象</a>获得。
这是通过 Canvas 对象的 <a href="/jsref/met_canvas_getcontext.asp" title="HTML DOM getContext() 方法">getContext() 方法</a>并且把直接量字符串 &quot;2d&quot; 作为唯一的参数传递给它而获得的。</p>

<p>&lt;canvas&gt; 标记在 Safari 1.3 中引入，在制作此参考页时，它在 Firefox 1.5 和 Opera 9 中也得到了支持。在 IE 中，&lt;canvas&gt; 标记及其 API 可以使用位于 <a href="http://excanvas.sourceforge.net/" title="ExplorerCanvas">excanvas.sourceforge.net</a> 的 ExplorerCanvas 开源项目来模拟。</p>

<p class="tip"><span>提示：</span>如果希望学习如何使用 &lt;canvas&gt; 来绘制图形，可以访问 Mozilla 提供的 <a href="https://developer.mozilla.org/En/Canvas_tutorial" title="Canvas tutorial - MDC">Canvas 教程</a>（英文）以及相应的 <a href="https://developer.mozilla.org/cn/Canvas_tutorial" title="Canvas tutorial - MDC">中文 Canvas 教程</a>。</p>
</div>
...
<tr>
<td><a href="met_canvas_getcontext.asp" title="HTML DOM getContext() 方法">getContext()</a></td>
<td>返回一个用于在画布上绘图的环境。</td>
</tr>
</table>
</div>
