...
<div>
<h2>定义和用法</h2>
<p>type 属性可返回重置按钮的表单元素类型。对于确认按钮，该属性总是 &quot;reset&quot;。</p>

<h3>语法</h3>
<pre>resetObject.type</pre>
</div>

<div>
<h2>实例</h2>
<p>下面的例子可返回重置按钮的表单元素类型：</p>
<pre>&lt;html&gt;
&lt;head&gt;
&lt;script type=&quot;text/javascript&quot;&gt;
function alertType()
{
alert(<code>document.getElementById(&quot;reset1&quot;).type</code>)
}
&lt;/script&gt;
&lt;/head&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_resetbutton">提示重置按钮的 id、类型和值 + 禁用按钮</a></dt>
</dl>
</div>
