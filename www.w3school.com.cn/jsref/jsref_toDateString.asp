...
<title>JavaScript toDateString() 方法</title>
...
<h1>JavaScript toDateString() 方法</h1>
...
<div>
<h2>定义和用法</h2>
<p>toDateString() 方法可把 Date 对象的日期部分转换为字符串，并返回结果。</p>

<h3>语法</h3>
<pre>dateObject.toDateString()</pre>

<h3>返回值</h3>
<p>dateObject 的日期部分的字符串表示，由实现决定，使用本地时间表示。</p>
</div>
