...
<li class="currentLink"><a href="/jsref/dom_obj_iframe.asp" title="HTML DOM IFrame 对象">&lt;iframe&gt;</a></li>
...
<table class="dataintable">
  ...
  <tr>
    <td><a href="/jsref/prop_iframe_align.asp">align</a></td>
    <td>根据周围的文字排列 iframe。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_iframe_contentDocument.asp">contentDocument</a></td>
    <td>容纳框架的内容的文档。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_iframe_frameborder.asp">frameBorder</a></td>
    <td>设置或返回是否显示 iframe 周围的边框。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_iframe_height.asp">height</a></td>
    <td>设置或返回 iframe 的高度。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_iframe_id.asp">id</a></td>
    <td>设置或返回 iframe 的 id。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_iframe_longdesc.asp">longDesc</a></td>
    <td>设置或返回描述  iframe 内容的文档的 URL。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_iframe_marginheight.asp">marginHeight</a></td>
    <td>设置或返回 iframe 的顶部和底部的页空白。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_iframe_marginwidth.asp">marginWidth</a></td>
    <td>设置或返回 iframe 的左侧和右侧的页空白。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_iframe_name.asp">name</a></td>
    <td>设置或返回 iframe 的名称。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_iframe_scrolling.asp">scrolling</a></td>
    <td>设置或返回 iframe 是否可拥有滚动条。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_iframe_src.asp">src</a></td>
    <td>设置或返回应载入 iframe 中的文档的 URL。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_iframe_width.asp">width</a></td>
