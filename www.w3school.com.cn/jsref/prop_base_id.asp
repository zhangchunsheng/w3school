...
<div>
<h2>定义和用法</h2>
<p>id 属性可设置或返回 &lt;base&gt; 元素的 id。</p>

<h3>语法</h3>
<pre>baseObject.id=id</pre>
</div>

<div>
<h2>实例</h2>
<p>下面的例子可返回 &lt;base&gt; 元素的 id：</p>
<pre>&lt;html&gt;
&lt;head&gt;
...
<p>输出：</p>
<pre>Base id: myBaseId</pre>
</div>

<div class="example">
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_base_id">取得 HTML 文档的 base id</a></dt>
</dl>
</div>
