...
<title>HTML DOM Password 对象</title>
...
<li class="currentLink"><a href="/jsref/dom_obj_password.asp" title="HTML DOM Password 对象">&lt;input&gt; password</a></li>
...
<h1>HTML DOM Password 对象</h1>


<div>
<h2>Password 对象</h2>

<p>Password 对象代表 HTML 表单中的密码字段。</p>

<p>HTML 的 &lt;input type=&quot;password&quot;&gt; 标签在表单上每出现一次，一个 Password 对象就会被创建。</p>

<p>该文本输入字段供用户输入某些敏感的数据，比如密码等。当用户输入的时候，他的输入是被掩盖的（例如使用星号*），以防止旁边的人从他背后看到输入的内容。不过需要注意的是，当表单提交时，输入是用明文发送的。</p>

<p>与类型为 &quot;text&quot; 的元素类似，当用户改变显示值时，它会触发 onchange 事件句柄。</p>

<p>您可以通过遍历表单的 elements[] array 来访问密码字段，或者通过使用 document.getElementById() 。</p>
</div>
...
<table class="dataintable">
  ...
  <tr>
    <td><a href="/jsref/prop_password_accesskey.asp">accessKey</a></td>
    <td>设置或返回访问密码字段的快捷键。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_password_alt.asp">alt</a></td>
    <td>设置或返回当不支持密码字段时显示的替代文字。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_password_defaultvalue.asp">defaultValue</a></td>
    <td>设置或返回密码字段的默认值。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_password_disabled.asp">disabled</a></td>
    <td>设置或返回是否应被禁用密码字段。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_password_form.asp">form</a></td>
    <td>返回对包含此密码字段的表单的引用。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_password_id.asp">id</a></td>
    <td>设置或返回密码字段的 id。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_password_maxlength.asp">maxLength</a></td>
    <td>设置或返回密码字段中字符的最大数目。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_password_name.asp">name</a></td>
    <td>设置或返回密码字段的名称。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_password_readonly.asp">readOnly</a></td>
    <td>设置或返回密码字段是否应当是只读的。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_password_size.asp">size</a></td>
    <td>设置或返回密码字段的长度。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_password_tabindex.asp">tabIndex</a></td>
    <td>设置或返回密码字段的 tab 键控制次序。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_password_type.asp">type</a></td>
    <td>返回密码字段的表单元素类型。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_password_value.asp">value</a></td>
    <td>设置或返回密码字段的 value 属性的值。</td>
  </tr>
</table>
</div>
...
<table class="dataintable">
  ...
  <tr>
    <td><a href="/jsref/met_password_blur.asp">blur()</a></td>
    <td>从密码字段移开焦点。</td>
  </tr>
  <tr>
    <td><a href="/jsref/met_password_focus.asp">focus()</a></td>
    <td>为密码字段赋予焦点。</td>
  </tr>
  <tr>
    <td><a href="/jsref/met_password_select.asp">select()</a></td>
    <td>选取密码字段中的文本。</td>
  </tr>
</table>
</div>
