...
<title>HTML DOM innerHTML 属性</title>
...
<div>
<h2>定义和用法</h2>
<p>innerHTML 属性可设置或返回单元格的开始标签和结束标签之间的 HTML。</p>

<h3>语法</h3>
<pre>tabledataObject.innerHTML=text</pre>
</div>

<div>
<h2>实例</h2>
<p>下面的例子返回了表元的 inner HTML：</p>
<pre>&lt;html&gt;
&lt;head&gt;
&lt;script type=&quot;text/javascript&quot;&gt;
function alertInnerHTML()
  {
  alert(<code>document.getElementById(&quot;td1&quot;).innerHTML</code>);
  }
&lt;/script&gt;
&lt;/head&gt;
&lt;body&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_tablecell_innerhtml">取得表元的 inner HTML</a></dt>
</dl>
</div>
