...
<div>
<h2>定义和用法</h2>
<p>open() 方法可打开一个新文档，并擦除当前文档的内容。</p>

<h3>语法</h3>
<pre>document.open(mimetype,replace)</pre>
<table class="dataintable">
    ...
    <tr>
    <td>mimetype</td>
    <td>可选。规定正在写的文档的类型。默认值是 &quot;text/html&quot;。</td>
    </tr>
    <tr>
    <td>replace</td>
    <td>可选。当此参数设置后，可引起新文档从父文档继承历史条目。</td>
    </tr>
</table>

<h3>说明</h3>
<p>该方法将擦除当前 HTML 文档的内容，开始一个新的文档，新文档用 write() 方法或 writeln() 方法编写。</p>
</div>

<div>
<h2>提示和注释</h2>
<p class="important"><span>重要事项：</span>调用 open() 方法打开一个新文档并且用 write() 方法设置文档内容后，必须记住用 close 方法关闭文档，并迫使其内容显示出来。</p>
<p class="tip"><span>注释：</span>属于被覆盖的文档的一部分的脚本或事件句柄不能调用该方法，因为脚本或事件句柄自身也会被覆盖。</p>
</div>
...
function createNewDoc()
  {
  var newDoc=<code>document.open(&quot;text/html&quot;,&quot;replace&quot;)</code>;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_document_open">打开一个新的文档，添加一些文本，然后关闭它。</a></dt>
<dt><a href="/tiy/t.asp?f=hdom_window_open">在新窗口打开新的文档，并添加一些文本。</a></dt>
</dl>
</div>
