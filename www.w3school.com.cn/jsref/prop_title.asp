...
<div>
<h2>定义和用法</h2>
<p>title 属性设置或返回元素的（咨询性质的）标题。</p>

<h3>语法：</h3>
<pre>object.title=title</pre>
</div>

<div>
<h2>实例 1</h2>

<p>本例展示了两种获取 &lt;body&gt; 元素的 title 属性的方法：</p>
...
document.write(&quot;Body title: &quot; + <code>x.title</code>);
document.write(&quot;&lt;br /&gt;&quot;);
document.write(&quot;An alternate way: &quot;);
document.write(<code>document.getElementById('myid').title</code>);
&lt;/script&gt;
...
document.write(<code>x.title</code>)
&lt;/script&gt;
&lt;/p&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_body_title">返回 &lt;body&gt; 元素的 title 属性</a></dt>
<dt><a href="/tiy/t.asp?f=hdom_area_title">返回图像映射中某个区域的 title</a></dt>
</dl>
</div>
