...
<title>JavaScript sqrt() 方法</title>
...
<p>sqrt() 方法可返回一个数的平方根。</p>

<h3>语法</h3>

<pre>Math.sqrt(<i>x</i>)</pre>
...
<table class="dataintable"> 
  ...
  <tr>
    <td><i>x</i></td>
    <td>必需。必须是大于等于 0 的数。</td>
  </tr>
</table>

<h3>返回值</h3>

<p>参数 <i>x</i> 的平方根。如果 <i>x</i> 小于 0，则返回 NaN。</p>
</div>


<div>
<h2>提示和注释</h2>
<p class="tip"><span>提示：</span><a href="/jsref/jsref_pow.asp" title="JavaScript pow() 方法">Math.pow()</a> 方法可以计算一个数的任意次根。</p>
</div>
...
<p><a href="/tiy/t.asp?f=jseg_sqrt">亲自试一试</a></p>
</div>
