...
<title>HTML DOM anchors 集合</title>
...
<div>
<h2>定义和用法</h2>
<p>anchors 集合可返回对文档中所有 Anchor 对象的引用。</p>

<h3>语法</h3>
<pre>document.anchors[]</pre>
</div>
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_document_anchors">返回文档中锚的数目</a></dt>
<dt><a href="/tiy/t.asp?f=hdom_document_anchors2">返回文档中第一个锚的 innerHTML</a></dt>
</dl>
</div>
