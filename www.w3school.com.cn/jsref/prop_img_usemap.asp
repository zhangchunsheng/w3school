...
<title>HTML DOM useMap 属性</title>
...
<div>
<h2>定义和用法</h2>
<p>useMap 属性可设置或返回图像的 usemap 属性的值。</p>

<h3>语法</h3>
<pre>imageObject.useMap=URL</pre>
</div>

<div>
<h2>实例</h2>
<p>下面的例子可输出客户端图像映射的 usemap 属性的值：</p>
<pre>&lt;html&gt;
&lt;body&gt;
...
document.write(<code>x.useMap</code>);
&lt;/script&gt;
&lt;/p&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_image_usemap">返回客户端图像映射的 usemap 属性的值</a></dt>
</dl>
</div>
