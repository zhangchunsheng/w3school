...
<title>HTML DOM rowIndex 属性</title>
...
<div>
<h2>定义和用法</h2>
<p>rowIndex 属性返回某一行在表格的行集合中的位置（row index）。</p>

<h3>语法</h3>
<pre>tablerowObject.rowIndex</pre>
</div>

<div>
<h2>实例</h2>
<p>下面的例子返回了某一行在表格中的位置：</p>
<pre>&lt;html&gt;
&lt;head&gt;
&lt;script type=&quot;text/javascript&quot;&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_tablerow_rowindex">返回某一行在表格的行集合中的位置</a></dt>
</dl>
</div>
