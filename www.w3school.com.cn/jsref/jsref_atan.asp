...
<title>JavaScript atan() 方法</title>
...
<p>x 的反正切值。返回的值是 -PI/2 到 PI/2 之间的弧度值。</p>
</div>
...
<p>下面这个例子可通过 atan() 方法返回不同数字的反正切值：</p>
...
<dl>
<dt><a href="/tiy/t.asp?f=jseg_atan">atan()</a></dt>
<dd>如何使用 atan() 来返回不同数值的反正切值。</dd>
</dl>
</div>
