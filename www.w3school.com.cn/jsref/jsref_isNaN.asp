...
<p class="tip"><span>提示：</span>isNaN() 函数通常用于检测 parseFloat() 和 parseInt() 的结果，以判断它们表示的是否是合法的数字。当然也可以用 isNaN() 函数来检测算数错误，比如用 0 作除数的情况。</p>
</div>
...
document.write(<code>isNaN(123)</code>);
document.write(<code>isNaN(-1.23)</code>);
document.write(<code>isNaN(5-2)</code>);
document.write(<code>isNaN(0)</code>);
document.write(<code>isNaN(&quot;Hello&quot;)</code>);
document.write(<code>isNaN(&quot;2005/12/12&quot;)</code>);
...
<p><a href="/tiy/t.asp?f=jseg_isNaN">亲自试一试</a></p>
</div>
