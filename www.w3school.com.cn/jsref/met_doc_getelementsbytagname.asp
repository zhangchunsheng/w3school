...
<title>HTML DOM getElementsByTagName() 方法</title>
...
<h1>HTML DOM getElementsByTagName() 方法</h1>

<div class="backtoreference">
<p><a href="/jsref/dom_obj_document.asp">HTML DOM Document 对象</a></p>
</div>
...
<p>如果把特殊字符串 &quot;*&quot; 传递给 getElementsByTagName() 方法，它将返回文档中所有元素的列表，元素排列的顺序就是它们在文档中的顺序。</p>
</div>

<div>
<h2>提示和注释</h2>
<p class="note"><span>注释：</span>传递给 getElementsByTagName() 方法的字符串可以不区分大小写。</p>
</div>
...
function getElements()
  {
  var x=<code>document.getElementsByTagName(&quot;input&quot;)</code>;
  alert(x.length);
  }
&lt;/script&gt;
&lt;/head&gt;
...
<h3>例子 2</h3>
<p>可以用 getElementsByTagName() 方法获取任何类型的 HTML 元素的列表。例如，下面的代码可获取文档中所有的表：</p>
<pre>
var tables = <code>document.getElementsByTagName(&quot;table&quot;)</code>;
alert (&quot;This document contains &quot; + tables.length + &quot; tables&quot;);
</pre>

<h3>例子 3</h3>
<p>如果您非常了解文档的结构，也可以使用 getElementsByTagName() 方法获取文档中的一个特定的元素。例如，下面的代码可以获得文档中的第四个段落：</p>
<pre>
var myParagragh = <code>document.getElementsByTagName(&quot;p&quot;)[3]</code>;
</pre>

<p>不过，我们还是认为，如果您需要操作某个特定的元素，使用 getElementById() 方法将更为有效。</p>
</div>

<div class="example">
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_document_getbytagname">使用 getElementsByTagName()</a></dt>
</dl>
</div>
