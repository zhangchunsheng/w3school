...
<title>JavaScript RegExp g 修饰符</title>
...
<p>g 修饰符用于执行全局匹配（查找所有匹配而非在找到第一个匹配后停止）。</p>

<h3>语法</h3>

<pre>new RegExp(&quot;<i>regexp</i>&quot;,&quot;g&quot;)</pre>

<p>直接量语法：</p>

<pre>/<i>regexp</i>/g</pre>
</div>
...
var patt1=<code>/is/g</code>;
</pre>

<p>下面被标记的文本显示了表达式获得匹配的位置：</p>

<pre>Is th<span class="marked">is</span> all there <span class="marked">is</span>?</pre>

<p><a href="/tiy/t.asp?f=jseg_regexp_g">TIY</a></p>

<h3>例子 2</h3>

<p>对 &quot;is&quot; 进行全局且大小写不敏感的搜索：</p>

<pre>var str=&quot;Is this all there is?&quot;;
var patt1=<code>/is/gi</code>;</pre>

<p>下面被标记的文本显示了表达式获得匹配的位置：</p>

<pre><span class="marked">Is</span> th<span class="marked">is</span> all there <span class="marked">is</span>?</pre>

<p><a href="/tiy/t.asp?f=jseg_regexp_g_2">TIY</a></p>
</div>
