...
<table class="dataintable"> 
  ...
  <tr>
    <td>x</td>
    <td>必需。一个以弧度表示的角。将角度乘以 0.017453293 （2PI/360）即可转换为弧度。</td>
  </tr>
</table>

<h3>返回值</h3>
<p>参数 x 的正弦值。返回值在 -1.0 到 1.0 之间。</p>
</div>

<div>
<h2>实例</h2>
<p>在本例中，我们将返回不同数字的正弦：</p>
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=jseg_sin">sin()</a></dt>
<dd>如何使用 sin() 来取得一些数字的正弦。</dd>
</dl>
</div>
