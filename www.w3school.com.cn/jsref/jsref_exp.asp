...
<table class="dataintable"> 
  ...
  <tr>
    <td>x</td>
    <td>必需。任意数值或表达式。被用作指数。</td>
  </tr>
</table>

<h3>返回值</h3>

<p>返回 e 的 x 次幂。e 代表自然对数的底数，其值近似为 2.71828。</p>
</div>
...
<p>在下面的例子中，我们将把 exp() 运用到不同的数值上：</p>
...
<dl>
<dt><a href="/tiy/t.asp?f=jseg_exp">exp()</a></dt>
<dd>如何使用 exp() 方法。</dd>
</dl>
</div>
