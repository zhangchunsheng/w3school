...
<title>HTML DOM caption 属性</title>
...
<div>
<h2>定义和用法</h2>
<p>caption 属性设置或返回表格的 caption 元素。</p>
<p>&lt;caption&gt; 元素定义了一个表格标题。&lt;caption&gt; 标签必须紧跟在 &lt;table&gt; 标签之后，每个表格仅能规定一个 caption。通常，caption 会位于表格之上居中的位置。</p>

<h3>语法</h3>
<pre>tableObject.caption=captionObject</pre>
</div>

<div>
<h2>实例</h2>
<p>下面的例子可返回表格的 &lt;caption&gt; 元素的文本：</p>
<pre>&lt;html&gt;
&lt;head&gt;
&lt;script type=&quot;text/javascript&quot;&gt;
function alertCaption()
  {
  alert(<code>document.getElementById(&quot;table1&quot;).caption.innerHTML</code>);
  }
&lt;/script&gt;
&lt;/head&gt;
&lt;body&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_table_caption">取得表格的 &lt;caption&gt; 元素的文本</a></dt>
</dl>
</div>
