...
<title>HTML DOM images 集合</title>
...
<div>
<h2>定义和用法</h2>
<p>images 集合可返回对文档中所有 Image 对象的引用。</p>

<h3>语法</h3>
<pre>document.images[]</pre>
</div>

<div>
<h2>提示和注释</h2>
<p class="note"><span>注释：</span>为了与 0 级 DOM 兼容，该集合不包括由 &lt;object&gt; 标记定义的图像。</p>
</div>
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_collection_imglength">计算文档中的图像数目</a></dt>
</dl>
</div>
