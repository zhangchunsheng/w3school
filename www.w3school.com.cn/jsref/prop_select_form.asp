...
<div>
<h2>定义和用法</h2>
<p>form 属性可返回对包含该下拉列表的表单元素的引用。</p>

<h3>语法</h3>
<pre>selectObject.form</pre>
</div>
...
&lt;script type=&quot;text/javascript&quot;&gt;
document.write(<code>document.getElementById(&quot;mySelect&quot;).form.id</code>)
&lt;/script&gt;
&lt;/p&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_select_form">取得包含该下拉列表的表单的 id</a></dt>
</dl>
</div>
