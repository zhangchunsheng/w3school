...
<title>JavaScript toLowerCase() 方法</title>
...
<h1>JavaScript toLowerCase() 方法</h1>
...
<h3>语法</h3>
<pre>stringObject.toLowerCase()</pre>
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=jseg_str_style">toLowerCase()</a></dt>
<dd>如何使用 toLowerCase() 来把字符串转换成小写。</dd>
</dl>
</div>
