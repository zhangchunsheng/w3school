...
<div>
<h2>定义和用法</h2>
<p>alt 属性可设置或返回在浏览器不支持单选按钮时显示的替代文本。</p>

<h3>语法</h3>
<pre>radioObject.alt=alternate_text</pre>
</div>

<div>
<h2>实例</h2>
<p>下面的例子可返回单选按钮的 alt 文本：</p>
<pre>&lt;html&gt;
&lt;body&gt;
...
&lt;script type=&quot;text/javascript&quot;&gt;
document.write(<code>document.getElementById('male').alt</code>);
document.write(&quot; and &quot;);
document.write(<code>document.getElementById('female').alt</code>);
&lt;/script&gt;&lt;/p&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_radio_alt">返回单选按钮的 alt 文本</a></dt>
</dl>
</div>
