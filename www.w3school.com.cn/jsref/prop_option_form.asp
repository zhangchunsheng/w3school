...
<div>
<h2>定义和用法</h2>
<p>form 属性可返回对包含选项的表单的引用。</p>

<h3>语法</h3>
<pre>optionObject.form</pre>
</div>
...
&lt;script type=&quot;text/javascript&quot;&gt;
document.write(<code>document.getElementById(&quot;apple&quot;).form.id</code>)
&lt;/script&gt;
&lt;/p&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_option_form">取得包含列表中选项的表单的 id</a></dt>
</dl>
</div>
