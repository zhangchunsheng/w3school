...
<title>HTML DOM action 属性</title>
...
<div>
<h2>定义和用法</h2>
<p>action 属性可设置或返回表单的 action 属性。</p>
<p>action 属性定义了当表单被提交时数据被送往何处。</p>

<h3>语法</h3>
<pre>formObject.action=<em>URL</em></pre>
</div>

<div>
<h2>实例</h2>
<p>下面的例子可更改表单的 action URL：</p>
<pre>&lt;html&gt;
&lt;head&gt;
&lt;script type=&quot;text/javascript&quot;&gt;
function changeAction()
  ...
  alert(&quot;Original action: &quot; + <code>x.action</code>)
  <code>x.action=&quot;index.asp&quot;</code>
  alert(&quot;New action: &quot; + <code>x.action</code>)
  x.submit()
  }
&lt;/script&gt;
&lt;/head&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_form_action">更改表单的 action 属性</a></dt>
</dl>
</div>
