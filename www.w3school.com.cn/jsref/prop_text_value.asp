...
<h1>HTML DOM value 属性</h1>

<div class="backtoreference">
<p><a href="/jsref/dom_obj_text.asp" title="HTML DOM Text 对象">HTML DOM Text 对象</a></p>
</div>

<div>
<h2>定义和用法</h2>
<p>value 属性设置或返回文本域的值。</p>

<h3>语法</h3>
<pre>textObject.value=text</pre>
</div>
...
function alertValue()
  {
  alert(<code>document.getElementById(&quot;text1&quot;).value</code>)
  }
&lt;/script&gt;
&lt;/head&gt;
&lt;body&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_text_value">获得文本域的值</a></dt>
<dt><a href="/tiy/t.asp?f=hdom_formvalidate">表单验证</a></dt>
<dt><a href="/tiy/t.asp?f=hdom_form_radio">表单中的单选按钮</a></dt>
<dt><a href="/tiy/t.asp?f=hdom_form_checkbox">表单中的复选按钮</a></dt>
<dt><a href="/tiy/t.asp?f=hdom_putdropdown">表单中的下拉列表</a></dt>
<dt><a href="/tiy/t.asp?f=hdom_putmore">另一个下拉列表</a></dt>
</dl>
</div>
