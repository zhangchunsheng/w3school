...
<title>HTML DOM taintEnabled() 方法</title>
...
<h1>HTML DOM taintEnabled() 方法</h1>
...
<div>
<h2>定义和用法</h2>
<p>taintEnabled() 方法可返回一个布尔值，该值声明了当前浏览器是否启用了 data tainting。</p>
...
<div>
<h2>实例</h2>
<p>下面的例子讲返回当前浏览器是否已启用 data tainting 的布尔值：</p>
<pre>&lt;html&gt;
&lt;body&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_nav_taintenabled">使用 navigator 对象的 taintEnabled() 方法</a></dt>
</dl>
</div>
