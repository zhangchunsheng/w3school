...
<title>JavaScript compile() 方法</title>
...
<p>compile() 方法用于在脚本执行过程中编译正则表达式。</p>

<p>compile() 方法也可用于改变和重新编译正则表达式。</p>

<h3>语法</h3>

<pre>RegExpObject.compile(<i>regexp</i>,<i>modifier</i>)</pre>
...
<table class="dataintable"> 
  ...
  <tr>
    <td>modifier</td>
    <td>规定匹配的类型。&quot;g&quot; 用于全局匹配，&quot;i&quot; 用于区分大小写，&quot;gi&quot; 用于全局区分大小写的匹配。</td>
  </tr>
</table>
</div>
...
<span style="color:red;">patt=/(wo)?man/g;</span>
<code>patt.compile(patt);</code>
str2=str.replace(patt,&quot;person&quot;);
document.write(str2);
...
<p><a href="/tiy/t.asp?f=jseg_regexp_compile_ref">TIY</a></p>
</div>
...
<dl>
<dt><a href="/tiy/t.asp?f=jseg_regexp_compile_ref">compile()</a></dt>
<dd>如何使用 compile() 来改变正则表达式。</dd>
</dl>
</div>
