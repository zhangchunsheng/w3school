...
<div>
<h2>定义和用法</h2>
<p>width 属性设置或返回表元的宽度。</p>
<p class="note"><span>注释：</span>整个列都会受到影响。</p>

<h3>语法</h3>
<pre>tabledataObject.width=percent|pixels</pre>
</div>
...
function changeWidth()
  {
  <code>document.getElementById(&quot;td1&quot;).width=&quot;200px&quot;;</code>
  }
&lt;/script&gt;
&lt;/head&gt;
&lt;body&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_tablecell_width">更改表元的宽度</a></dt>
</dl>
</div>
