...
<title>HTML DOM hreflang 属性</title>
...
<div>
<h2>定义和用法</h2>
<p>The hreflang property sets or returns the base language of the target URL.</p>

<h3>语法</h3>
<pre>linkObject.hreflang=languagecode</pre>
</div>

<div>
<h2>实例</h2>
<p>The following example returns the language code of the link element:</p>
<pre>&lt;html&gt;
&lt;head&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_link_hreflang">Get the language code of a &lt;link&gt; element</a></dt>
</dl>
</div>
