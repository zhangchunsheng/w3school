...
<p>请注意， onclick 与 onmousedown 不同。单击事件是在同一元素上发生了鼠标按下事件之后又发生了鼠标放开事件时才发生的。</p>

<h3>语法</h3>
<pre>onclick=&quot;SomeJavaScriptCode&quot;</pre>
...
<pre>&lt;a&gt;, &lt;address&gt;, &lt;area&gt;, &lt;b&gt;, &lt;bdo&gt;, &lt;big&gt;, &lt;blockquote&gt;, &lt;body&gt;, &lt;button&gt;, 
...
<div>
<h2>实例 1</h2>
<p>在本例中，当按钮被单击时，第一个输入框中的文本会被拷贝到第二个输入框中：</p>
<pre>&lt;html&gt;
&lt;body&gt;
...
&lt;br /&gt;
&lt;button <code>onclick=&quot;document.getElementById('field2').value=
...
<p>点击下面的按钮，把 Field1 的内容拷贝到 Field2 中：</p>
<p><button onclick="document.getElementById('field2').value=document.getElementById('field1').value">Copy Text</button></p>
</div>

<div class="example">
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_onclick">onclick</a></dt>
<dd>如何使用 onclick</dd>
</dl>
</div>
