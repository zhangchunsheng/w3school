...
<title>JavaScript POSITIVE_INFINITY 属性</title>
...
<h1>JavaScript POSITIVE_INFINITY 属性</h1>
...
<p>POSITIVE_INFINITY 属性表示大于 Number.MAX_VALUE 的值。</p>
...
<p>Number.POSITIVE_INFINITY 是一个特殊值，它在算术运算或函数生成一个比 JavaScript 能表示的最大的数还大的数（也就是比 Number.MAX_VALUE 还大的数）时返回。</p>

<p>JavaScript 显示 POSITIVE_INFINITY 时使用的是 Infinity。这个值的算术行为和无穷大非常相似。例如，任何数乘无穷大结果仍为无穷大，任何数被无穷大除的结果为 0。</p>

<p>在 ECMAScript v1 和其后的版本中，还可以用 Infinity 代替 Number.POSITIVE_INFINITY。</p>
</div>
...
<p>在本例中，我们将使用 POSITIVE_INFINITY：</p>

<pre>
&lt;script type=&quot;text/javascript&quot;&gt;

var x=(Number.MAX_VALUE)*2
if (x==<code>Number.POSITIVE_INFINITY</code>)
  {
...
<p><a href="/tiy/t.asp?f=jseg_positive_infinity">TIY</a></p>
</div>
...
<dl>
<dt><a href="/tiy/t.asp?f=jseg_positive_infinity">POSITIVE_INFINITY</a></dt>
<dd>如何通过 POSITIVE_INFINITY 来判断一个值是否是正无穷大。</dd>
</dl>
</div>
