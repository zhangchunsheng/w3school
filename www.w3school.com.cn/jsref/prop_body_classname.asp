...
<title>HTML DOM className 属性</title>
...
<h1>HTML DOM className 属性</h1>

<div class="backtoreference">
<p><a href="/jsref/dom_obj_body.asp">返回 HTML DOM Body 对象</a></p>
</div>

<div>
<h2>定义和用法</h2>
<p>className 属性可设置或返回元素的 class 属性。</p>

<h3>语法</h3>
<pre>bodyObject.className=classname</pre>
</div>

<div>
<h2>实例</h2>
<p>下面的例子将展示两种获取 &lt;body&gt; 元素的 class 属性的方法：</p>
<pre>&lt;html&gt;
&lt;body id=&quot;myid&quot; class=&quot;mystyle&quot;&gt;

&lt;script type=&quot;text/javascript&quot;&gt;
<code>x=document.getElementsByTagName('body')[0]</code>;
document.write(&quot;Body CSS class: &quot; + <code>x.className</code>);
document.write(&quot;&lt;br /&gt;&quot;);
document.write(&quot;An alternate way: &quot;);
document.write(<code>document.getElementById('myid').className</code>);
&lt;/script&gt;
...
<p>输出：</p>
<pre>Body CSS class: mystyle
An alternate way: mystyle</pre>
</div>

<div class="example">
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_body_classname">返回 &lt;body&gt; 元素的 class 属性</a></dt>
</dl>
</div>
