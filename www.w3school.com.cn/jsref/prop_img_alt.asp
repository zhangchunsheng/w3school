...
<div>
<h2>定义和用法</h2>
<p>alt 属性可设置或返回图像无法显示时的替代文本。</p>

<h3>语法</h3>
<pre>imageObject.alt=alternate_text</pre>
</div>
...
function changeAlt()
  {
  <code>document.getElementById(&quot;compman&quot;).alt=&quot;Man using computer&quot;</code>
  }
function alertAlt()
  {
  alert(<code>document.getElementById(&quot;compman&quot;).alt</code>)
  }
&lt;/script&gt;
&lt;/head&gt;
&lt;body&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_image_alt">更改图像的替代文本</a></dt>
</dl>
</div>
