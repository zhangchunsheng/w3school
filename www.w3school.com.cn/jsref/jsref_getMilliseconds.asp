...
<title>JavaScript getMilliseconds() 方法</title>
...
<h1>JavaScript getMilliseconds() 方法</h1>
...
<p>getMilliseconds() 方法可返回时间的毫秒。</p>

<h3>语法</h3>

<pre>dateObject.getMilliseconds()</pre>

<h3>返回值</h3>

<p>dateObject 的毫秒字段，以本地时间显示。返回值是 0 ~ 999 之间的一个整数。</p>
</div>
...
<p class="note"><span>注释：</span>由 getMilliseconds() 返回的值是一个三位的数字。不过返回值不总是三位的，如果该值小于 100，则仅返回两位数字，如果该值小于 10，则仅返回一位数字。</p>
...
<dl>
<dt><a href="/tiy/t.asp?f=jseg_getmilliseconds">getMilliseconds()</a></dt>
<dd>如何使用 getMilliseconds() 来取得当前的毫秒。</dd>
<dt><a href="/tiy/t.asp?f=jseg_datetime">显示当前时间</a></dt>
<dd>如何使用 getHours(), getMinutes() 以及 getSeconds() 来显示当前的时间。</dd>
<dt><a href="/tiy/t.asp?f=jseg_datetime2">显示当前时间（带有一个判断数值是否小于 10 的函数）</a></dt>
<dd>如何使用 getHours(), getMinutes() 以及 getSeconds() 来显示当前的时间。</dd>
</dl>
</div>
