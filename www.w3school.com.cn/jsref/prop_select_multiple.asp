...
<title>HTML DOM multiple 属性</title>
...
<div>
<h2>定义和用法</h2>
<p>multiple 属性可设置或返回是否可有多个选项被选中。</p>
<p class="note"><span>注释：</span>Opera 9 无法在脚本中设置该属性，仅能返回它。</p>

<h3>语法</h3>
<pre>selectObject.multiple=true|false</pre>
</div>

<div>
<h2>实例</h2>
<p>The following example returns the id of the dropdown list:</p>
<pre>&lt;html&gt;
&lt;head&gt;
&lt;script type=&quot;text/javascript&quot;&gt;
function selectMultiple()
  {
  <code>document.getElementById(&quot;mySelect&quot;).multiple=true</code>
  }
&lt;/script&gt;
&lt;/head&gt;
&lt;body&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_select_multiple">选择下拉列表中的多个选项</a></dt>
</dl>
</div>
