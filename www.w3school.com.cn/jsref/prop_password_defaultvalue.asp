...
<title>HTML DOM defaultValue 属性</title>
...
<h1>HTML DOM defaultValue 属性</h1>

<div class="backtoreference">
<p><a href="/jsref/dom_obj_password.asp" title="HTML DOM Password 对象">HTML DOM Password 对象</a></p>
</div>

<div>
<h2>定义和用法</h2>
<p>defaultValue 属性可设置或返回密码域的默认值。</p>
<p class="note"><span>注释：</span>该默认值是在 HTML &quot;value&quot; 属性中规定的默认值。</p>

<h3>语法</h3>
<pre>passwordObject.defaultValue=somevalue</pre>
</div>
...
function alertValue()
  {
  alert(<code>document.getElementById(&quot;password1&quot;).defaultValue</code>)
  }
&lt;/script&gt;
&lt;/head&gt;
&lt;body&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_password_defaultvalue">获得密码域的默认值</a></dt>
</dl>
</div>
