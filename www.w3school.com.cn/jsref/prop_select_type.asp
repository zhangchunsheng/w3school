...
<div>
<h2>定义和用法</h2>
<p>type 属性可返回下拉列表的表单类型。对于下拉列表，类型总是 &quot;select-one&quot; 或 &quot;select-multiple&quot;。</p>

<h3>语法</h3>
<pre>selectObject.type</pre>
</div>

<div>
<h2>实例</h2>
<p>下面的例子返回下拉列表的表单类型：</p>
<pre>&lt;html&gt;
&lt;head&gt;
&lt;script type=&quot;text/javascript&quot;&gt;
function getType()
  {
  alert(<code>document.getElementById(&quot;mySelect&quot;).type</code>)
  }
&lt;/script&gt;
&lt;/head&gt;
&lt;body&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_select_type">取得下拉列表的类型</a></dt>
</dl>
</div>
