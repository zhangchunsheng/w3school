...
<title>JavaScript RegExp {X,Y} 量词</title>
...
<h1>JavaScript RegExp {X,Y} 量词</h1>
...
<p><i>n</i>{<i>X</i>,<i>Y</i>} 量词匹配包含 X 或 Y 个 <i>n</i> 的序列的字符串。</p>

<p><i>X</i> 和 <i>Y</i> 必须是数字。</p>

<h3>语法</h3>

<pre>new RegExp(&quot;<i>n</i>{<i>X,Y</i>}&quot;)</pre>

<p>直接量语法：</p>

<pre>/<i>n</i>{<i>X,Y</i>}/</pre>
</div>
...
<p>对包含三位或四位数字序列的子串进行全局搜索：</p>

<pre>
var str=&quot;100, 1000 or 10000?&quot;;
var patt1=<code>/\d{3,4}/g</code>;
</pre>

<p>下面被标记的文本显示了表达式获得匹配的位置：</p>

<pre><span class="marked">100</span>, <span class="marked">1000</span> or <span class="marked">1000</span>0?</pre>

<p><a href="/tiy/t.asp?f=jseg_regexp_nxy">TIY</a></p>
</div>
