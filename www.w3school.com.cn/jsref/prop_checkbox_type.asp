...
<div>
<h2>定义和用法</h2>
<p>type 属性可返回元素的表单类型。对于一个 checkbox 对象，该属性总是返回 &quot;checkbox&quot;。</p>

<h3>语法</h3>
<pre>checkboxObject.type</pre>
</div>

<div>
<h2>实例</h2>
<p>下面的例子返回了 checkbox 的表单元素类型：</p>
<pre>&lt;html&gt;
&lt;body&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_checkbox_type">获得 checkbox 的表单元素类型</a></dt>
</dl>
</div>
