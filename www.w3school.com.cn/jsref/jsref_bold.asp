...
<title>JavaScript bold() 方法</title>
...
<p>bold() 方法用于把字符串显示为粗体。</p>

<h3>语法</h3>

<pre>stringObject.bold()</pre>
</div>
...
<dl>
<dt><a href="/tiy/t.asp?f=jseg_str_style">bold()</a></dt>
<dd>如何使用 bold() 把字符串显示为粗体。</dd>
</dl>
</div>
