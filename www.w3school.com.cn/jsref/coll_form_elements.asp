...
<title>HTML DOM elements 集合</title>
...
<h1>HTML DOM elements 集合</h1>

<div class="backtoreference">
<p><a href="/jsref/dom_obj_form.asp">HTML DOM Form 对象</a></p>
</div>

<div>
<h2>定义和用法</h2>
<p>elements 集合可返回包含表单中所有元素的数组。</p>
<p>元素在数组中出现的顺序和它们在表单的HTML 源代码中出现的顺序相同。</p>
<p>每个元素都有一个 type 属性，其字符串值说明了元素的类型。</p>

<h3>语法</h3>
<pre>formObject.elements[].property</pre>
</div>

<div>
<h2>提示和注释</h2>
<p class="tip"><span>提示：</span>如果 elements[] 数组具有名称（input 标签的 id 或 name 属性），那么该元素的名称就是 formObject 的一个属性，因此可以使用名称而不是数字来引用 input 对象。</p>
<p>举例，假设 x 是一个 form 对象，其中的一个 input 对象的名称是 fname，则可以使用 x.fname 来引用该对象。</p>
</div>

<div>
<h2>实例</h2>
<p>下面的例子输出了所有表单元素的值和类型：</p>
<pre>&lt;html&gt;
&lt;body&gt;
...
for (var i=0;i&lt;x.length;i++)
  {
  document.write(<code>x.elements[i].value</code>);
  document.write(&quot;&lt;br /&gt;&quot;);
  document.write(<code>x.elements[i].type</code>);
  document.write(&quot;&lt;br /&gt;&quot;);
  }
&lt;/script&gt;
&lt;/p&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_form_elements">取得所有表单元素的值和类型</a></dt>
</dl>
</div>
