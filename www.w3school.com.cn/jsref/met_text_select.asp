...
<title>HTML DOM select() 方法</title>
...
<div>
<h2>定义和用法</h2>
<p>select() 方法用于选取文本域中的内容。</p>

<h3>语法</h3>
<pre>textObject.select()</pre>
</div>
...
function selText()
  {
  <code>document.getElementById(&quot;myText&quot;).select()</code>
  }
&lt;/script&gt;
&lt;/head&gt;
&lt;body&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_select2">选取文本域中的内容</a></dt>
</dl>
</div>
