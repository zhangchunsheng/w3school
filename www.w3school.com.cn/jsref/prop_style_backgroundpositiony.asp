...
<title>HTML DOM backgroundPositionY 属性</title>
...
<h1>HTML DOM backgroundPositionY 属性</h1>
...
<div>
<h2>定义和用法</h2>
<p>backgroundPositionY 属性设置 background-image 的垂直位置。</p>

<h3>语法：</h3>
<pre>Object.style.backgroundPositionY=position</pre>
<table class="dataintable">
	...
	<tr>
		<td>y%</td>
		<td>垂直位置。Top 是 0%。Bottom 是 100%</td>
	</tr>
	<tr>
		<td>ypos</td>
		<td>垂直位置。Top 是 0。单位是像素 (0px) 或其他 CSS 单位。</td>
	</tr>
</table>
</div>
...
<div>
<h2>实例</h2>
<p>下面的例子改变 background-image 的垂直位置：</p>
...
{
<code>document.body.style.backgroundPositionY=&quot;bottom&quot;;</code>
}
&lt;/script&gt;
&lt;/head&gt;
&lt;body&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_style_backgroundpositiony">改变 background-image 的垂直位置</a></dt>
</dl>
</div>
