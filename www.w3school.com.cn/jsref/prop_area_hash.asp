...
<div>
<h2>定义和用法</h2>
<p>hash 属性可设置或返回一个区域中 URL 的锚部分。</p>

<h3>语法</h3>
<pre>areaObject.hash=anchorname</pre>
</div>

<div>
<h2>实例</h2>
<p>下面的例子可把 URL 的锚部分 #top 更改为 #bottom：</p>
<pre>&lt;html&gt;
&lt;head&gt;
&lt;script type=&quot;text/javascript&quot;&gt;
function changeLink()
  {
  <code>document.getElementById('venus').hash=&quot;bottom&quot;</code>
  }
&lt;/script&gt;
&lt;/head&gt;
&lt;body&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_area_hash">更改一个区域中 URL 的锚部分</a></dt>
</dl>
</div>
