...
<title>JavaScript charAt() 方法</title>
...
<p class="note"><span>注释：</span>字符串中第一个字符的下标是 0。如果参数 index 不在 0 与 string.length 之间，该方法将返回一个空字符串。</p>
</div>
...
<dl>
<dt><a href="/tiy/t.asp?f=jseg_charat">charAt()</a></dt>
<dd>如何使用 charAt() 从某个字符串取得具体的字符。</dd>
</dl>
</div>
