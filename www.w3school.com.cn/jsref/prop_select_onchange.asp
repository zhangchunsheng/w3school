...
<h3>语法</h3>
<pre>selectObject.onchange</pre>

<h3>说明</h3>
<p>Select 对象的 onchange 属性引用了一个事件句柄函数。当用户选中一个选项，或者取消了对一个选项的选定时，就会调用该句柄。这个事件不会指定新的选项是什么，必须通过 Select 对象的 selectedIndex 属性，或者各个 Option 对象的 selected 属性来确定这一点。</p>
</div>
