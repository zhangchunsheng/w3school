...
<title>HTML DOM fontSizeAdjust 属性</title>
...
<h1>HTML DOM fontSizeAdjust 属性</h1>

<div>
<p><a href="/jsref/dom_obj_style.asp">HTML DOM Style 对象</a></p>
</div>

<div>
<h2>定义和用法</h2>
<p>fontSizeAdjust 属性设置文本的尺寸。</p>
<p>字体的小写字母 &quot;x&quot; 的高度与 &quot;font-size&quot; 高度之间的比率被称为一个字体的 <em>aspect 值</em>。当字体拥有高的 <em>aspect 值</em>时，那么当此字体被设置为很小的尺寸时会更易阅读。举例：Verdana 的 <em>aspect 值</em>是 0.58（意味着当字体尺寸为 100px 时，它的 x-height 是 58px ）。Times New Roman 的 <em>aspect 值</em>是 0.46。这就意味着 Verdana 在小尺寸时比 Times New Roman 更易阅读。</p>
<p>该可为某个元素规定一个 <em>aspect 值</em>，这样就可以保持首选字体的 x-height。</p>

<h3>语法：</h3>
<pre>Object.style.fontSizeAdjust=none|number</pre>
...
{
<code>document.getElementById(&quot;p1&quot;).style.fontSizeAdjust=&quot;0.70&quot;;</code>
}
&lt;/script&gt;
&lt;/head&gt;
&lt;body&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_style_fontsizeadjust">fontSizeAdjust - 调节字体的大小</a></dt>
</dl>
</div>
