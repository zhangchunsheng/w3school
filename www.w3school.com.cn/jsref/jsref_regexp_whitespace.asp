...
<title>JavaScript RegExp \s 元字符</title>
...
<p>对字符串中的空白字符进行全局搜索：</p>

<pre>
var str=&quot;Is this all there is?&quot;;
var patt1=<code>/\s/g</code>;
</pre>

<p>下面被标记的文本显示了表达式获得匹配的位置：</p>

<pre>Is<span style="background-color: rgb(232, 0, 0);"> </span>this<span style="background-color: rgb(232, 0, 0);"> </span>all<span style="background-color: rgb(232, 0, 0);"> </span>there<span style="background-color: rgb(232, 0, 0);"> </span>is?</pre>

<p><a href="/tiy/t.asp?f=jseg_regexp_space">TIY</a></p>
</div>
