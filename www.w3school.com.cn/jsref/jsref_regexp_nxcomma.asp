...
<title>JavaScript RegExp {X,} 量词</title>
...
<p><i>n</i>{<i>X</i>,} 量词匹配包含至少 X 个 <i>n</i> 的序列的字符串。</p>

<p><i>X</i> 必须是数字。</p>

<h3>语法</h3>

<pre>new RegExp("<i>n</i>{<i>X,</i>}")</pre>
...
<p>对包含至少三位数字序列的子串进行全局搜索：</p>

<pre>
var str=&quot;100, 1000 or 10000?&quot;;
var patt1=<code>/\d{3,}/g</code>;
</pre>

<p>下面被标记的文本显示了表达式获得匹配的位置：</p>

<pre><span class="marked">100</span>, <span class="marked">1000</span> or <span class="marked">10000</span>?</pre>

<p><a href="/tiy/t.asp?f=jseg_regexp_nxx">TIY</a></p>
</div>
