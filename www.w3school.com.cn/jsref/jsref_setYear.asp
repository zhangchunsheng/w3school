...
<title>JavaScript setYear() 方法</title>
...
<p>setYear() 方法用于设置年份。</p>

<h3>语法</h3>

<pre>dateObject.setYear(year)</pre>
...
<p class="note"><span>注释：</span>如果 year 参数是两位的数字，比如 setYear(91)，则该方法会理解为 1991。如果要规定 1990 年之前或 1999 年之后的年份，请使用四位数字。</p>

<p class="note"><span>注释：</span>该方法总是结合一个 Date 对象来使用。</p>

<p class="important"><span>重要事项：</span>从 ECMAScript v3 起，JavaScript 实现不再要求使用该函数，而使用 setFullYear() 函数代替它。</p>
</div>
...
<p>在本例中，我们将通过 setYear() 方法把年份设置为 1891：</p>
...
<dl>
<dt><a href="/tiy/t.asp?f=jseg_setyear">setYear()</a></dt>
<dd>如何使用 setYear() 来设置年份。</dd>
</dl>
</div>
