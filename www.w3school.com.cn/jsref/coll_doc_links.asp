...
<div>
<h2>定义和用法</h2>
<p>links 集合可返回对文档中所有 Area 和 Link 对象的引用。</p>
...
&lt;script type=&quot;text/javascript&quot;&gt;
document.write(<code>document.links.length</code>)
&lt;/script&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_document_links">返回文档中链接的数目</a></dt>
<dt><a href="/tiy/t.asp?f=hdom_document_links2">返回文档中第一个链接的 id</a></dt>
</dl>
</div>
