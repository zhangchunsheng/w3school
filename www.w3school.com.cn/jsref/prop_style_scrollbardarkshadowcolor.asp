...
<title>HTML DOM scrollbarDarkShadowColor 属性</title>
...
<h1>HTML DOM scrollbarDarkShadowColor 属性</h1>
...
<div>
<h2>定义和用法</h2>
<p>scrollbarDarkShadowColor 属性设置箭头和滚动条的右边和下边的颜色。</p>
<p class="tip"><span>提示：</span>可以与 scrollbarShadowColor 一同使用，设置滚动条的阴影效果。</p>

<h3>语法：</h3>
<pre>Object.style.scrollbarDarkShadowColor=color</pre>
...
<table class="dataintable">
	...
	<tr>
		<td>color</td>
		<td>颜色值可以是颜色名 (red)，rgb 值 (rgb(255,0,0))，或十六进制 (#ff0000)。</td>
	</tr>
</table>
</div>
...
{
<code>document.body.style.scrollbarDarkShadowColor=&quot;darkred&quot;;</code>
}
&lt;/script&gt;
&lt;/head&gt; 
&lt;body&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_style_scrollbardarkshadowcolor">scrollbarDarkShadowColor</a></dt>
</dl>
</div>
