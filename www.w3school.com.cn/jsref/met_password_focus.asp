...
<div>
<h2>定义和用法</h2>
<p>focus() 方法用于在密码域上设置焦点。</p>

<h3>语法</h3>
<pre>passwordObject.focus()</pre>
</div>

<div>
<h2>实例</h2>
<p>下面的例子可设置或移开密码域上的焦点：</p>
<pre>&lt;html&gt;
&lt;head&gt;
&lt;script type=&quot;text/javascript&quot;&gt;
function setFocus()
  {
  <code>document.getElementById('password1').focus()</code>
  }
function loseFocus()
  {
  <code>document.getElementById('password1').blur()</code>
  }
&lt;/script&gt;
&lt;/head&gt;
&lt;body&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_password_blur_focus">设置或移开密码域上的焦点</a></dt>
</dl>
</div>
