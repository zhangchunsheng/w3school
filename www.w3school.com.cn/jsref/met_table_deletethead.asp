...
<title>HTML DOM deleteTHead() 方法</title>
...
<div>
<h2>定义和用法</h2>
<p>deleteTHead() 方法用于从表格删除 &lt;thead&gt; 元素。</p>

<h3>语法</h3>
<pre>tableObject.deleteTHead()</pre>

<h3>说明</h3>
<p>如果该表有 &lt;thead&gt; 元素，则将它从文档树种删除，否则什么也不做。</p>
</div>
...
function delRow()
  {
  <code>document.getElementById('myTable').deleteTHead()</code>
  }
&lt;/script&gt;
&lt;/head&gt;
&lt;body&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_table_deletethead">从表格删除表头</a></dt>
</dl>
</div>
