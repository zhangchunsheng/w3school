...
<div>
<h2>定义和用法</h2>
<p>form 属性返回对包含该元素的表单对象的引用。</p>

<h3>语法</h3>
<pre>checkboxObject.form</pre>
</div>

<div>
<h2>实例</h2>
<p>下面的例子返回了该 checkbox 所属的表单的 id：</p>
<pre>&lt;html&gt;
&lt;body&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_checkbox_form">取得 checkbox 所属的表单的 id</a></dt>
</dl>
</div>
