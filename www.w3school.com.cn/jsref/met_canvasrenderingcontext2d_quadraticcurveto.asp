...
<title>HTML DOM quadraticCurveTo() 方法</title>
...
<h1>HTML DOM quadraticCurveTo() 方法</h1>
...
<h3>语法</h3>
<pre>quadraticCurveTo(<i>cpX</i>, <i>cpY</i>, <i>x</i>, <i>y</i>)</pre>
...
<p>quadraticCurveTo() 方法为当前的子路径添加一条贝塞尔曲线。这条曲线从当前点开始，到 (<i>x</i>,<i>y</i>) 结束。控制点 (<i>cpX</i>,<i>cpY</i>) 说明了这两个点之间的曲线的形状（贝塞尔曲线的数学原理超过了本参考页的范围）。</p>

<p>当 quadraticCurveTo() 方法返回时，当前位置是 (<i>x</i>,<i>y</i>)。</p>
</div>
...
<p><a href="/jsref/met_canvasrenderingcontext2d_beziercurveto.asp" title="HTML DOM bezierCurveTo() 方法">CanvasRenderingContext2D.bezierCurveTo()</a></p>
</div>
