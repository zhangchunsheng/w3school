...
<div>
<h2>定义和用法</h2>
<p>shape 属性可设置或返回图像映射中某个区域的形状。</p>

<h3>语法</h3>
<pre>areaObject.shape=RECT|CIRCLE|POLY|DEFAULT</pre>
</div>

<div>
<h2>实例</h2>
<p>下面的例子可返回图像映射中 &quot;Venus&quot; 区域的形状：</p>
<pre>&lt;html&gt;
&lt;body&gt;
...
document.write(<code>x.shape</code>);
&lt;/script&gt;
&lt;/p&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_anchor_shape">返回图像映射中某个区域的形状</a></dt>
</dl>
</div>
