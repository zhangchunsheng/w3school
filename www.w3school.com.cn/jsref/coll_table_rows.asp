...
<div>
<h2>定义和用法</h2>
<p>rows 集合返回表格中所有行（TableRow 对象）的一个数组，即一个 HTMLCollection。</p>
<p>该集合包括 &lt;thead&gt;、&lt;tfoot&gt; 和 &lt;tbody&gt; 中定义的所有行。</p>

<h3>语法</h3>
<pre>tableObject.rows[]</pre>
</div>

<div>
<h2>实例</h2>
<p>下面的例子使用了 rows 集合来显示第一行中的内容：</p>
<pre>&lt;html&gt;
&lt;head&gt;
&lt;script type=&quot;text/javascript&quot;&gt;
function showRow()
  {
  alert(<code>document.getElementById('myTable').rows[0].innerHTML</code>)
  }
&lt;/script&gt;
&lt;/head&gt;
&lt;body&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_table_rows">某一个行的 InnerHTML</a></dt>
<dt><a href="/tiy/t.asp?f=hdom_tablerow_insertcell">通过 rows 集合向表格行添加一个单元格</a></dt>
<dt><a href="/tiy/t.asp?f=hdom_tablerow_align">排列表格行中的单元格内容</a></dt>
<dt><a href="/tiy/t.asp?f=hdom_tablerow_valign">垂直排列表格行中的单元格内容</a></dt>
<dt><a href="/tiy/t.asp?f=hdom_tablecell_align">排列一个单独的单元格中的内容</a></dt>
<dt><a href="/tiy/t.asp?f=hdom_tablecell_valign">垂直排列一个单独的单元格中的内容</a></dt>
<dt><a href="/tiy/t.asp?f=hdom_tablerow_cells">更改表格单元格中的内容</a></dt>
<dt><a href="/tiy/t.asp?f=hdom_tablecell_colspan">更改一个表格行的 colspan</a></dt>
</dl>
</div>
