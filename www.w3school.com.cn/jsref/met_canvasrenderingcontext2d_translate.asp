...
<title>HTML DOM translate() 方法</title>
...
<h3>语法</h3>
<pre>translate(<i>dx</i>, <i>dy</i>)</pre>
...
<p>translate() 方法为画布的变换矩阵添加水平的和垂直的偏移。参数 <i>dx</i> 和 <i>dy</i> 添加给后续定义路径中的所有点。</p>
</div>
...
<p><a href="/jsref/met_canvasrenderingcontext2d_scale.asp" title="HTML DOM scale() 方法">CanvasRenderingContext2D.scale()</a></p>
</div>
