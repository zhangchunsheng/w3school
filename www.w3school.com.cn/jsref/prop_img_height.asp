...
<title>HTML DOM height 属性</title>
...
<div>
<h2>定义和用法</h2>
<p>height 属性可设置或返回图像的高度。</p>

<h3>语法</h3>
<pre>imageObject.height=pixels</pre>
</div>

<div>
<h2>实例</h2>
<p>下面的例子可设置图像的高度和宽度：</p>
<pre>&lt;html&gt;
&lt;head&gt;
&lt;script type=&quot;text/javascript&quot;&gt;
function changeSize()
{
<code>document.getElementById(&quot;compman&quot;).height=&quot;250&quot;
document.getElementById(&quot;compman&quot;).width=&quot;300&quot;</code>
}
&lt;/script&gt;
&lt;/head&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_image_height">更改图像的高度和宽度</a></dt>
</dl>
</div>
