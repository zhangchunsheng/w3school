...
<div>
<h2>定义和用法</h2>
<p>title 属性可设置或返回对元素的描述性短语。</p>

<h3>语法</h3>
<pre>bodyObject.title=title</pre>
</div>

<div>
<h2>实例</h2>
<p>下面的例子将展示设置 &lt;body&gt; 元素的 title 属性的两种方法：</p>
<pre>&lt;html&gt;
...
<p>输出：</p>
<pre>Body title: mytitle
An alternate way: mytitle</pre>
</div>

<div class="example">
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_body_title">返回 &lt;body&gt; 元素的标题</a></dt>
</dl>
</div>
