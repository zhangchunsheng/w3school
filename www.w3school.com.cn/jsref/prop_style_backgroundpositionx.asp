...
<title>HTML DOM backgroundPositionX 属性</title>
...
<h1>HTML DOM backgroundPositionX 属性</h1>
...
<div>
<h2>定义和用法</h2>
<p>backgroundPositionX 属性设置背景图像的水平位置。</p>

<h3>语法：</h3>
<pre>Object.style.backgroundPositionX=position</pre>
...
<table class="dataintable">
	...
	<tr>
		<td>x%</td>
		<td>水平位置。左是 0%。右是 100%。</td>
	</tr>
	<tr>
		<td>xpos</td>
		<td>水平位置。左是 0。单位是像素 (0px) 或其他 CSS 单位。</td>
	</tr>
</table>
</div>
...
{
<code>document.body.style.backgroundPositionX=&quot;right&quot;;</code>
}
&lt;/script&gt;
&lt;/head&gt;
&lt;body&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_style_backgroundpositionx">改变背景图像的水平位置</a></dt>
</dl>
</div>
