...
<title>HTML DOM contentDocument 属性</title>
...
<h1>HTML DOM contentDocument 属性</h1>
...
<div>
<h2>定义和用法</h2>
<p>contentDocument 属性以 HTML 对象返回框架容纳的文档。</p>
<p>可以通过所有标准的 DOM 方法来处理被返回的对象。</p>

<h3>语法</h3>
<pre>frameObject.contentDocument</pre>
</div>
...
<p>HTML 文档 &quot;frame_cdoc.htm&quot; 被放入第一列，而 HTML 文档 &quot;frame_a.htm&quot; 被放入第二列。</p>
<p>下面是 &quot;frame_cdoc.htm&quot; 的源代码：</p>
<pre>&lt;html&gt;
&lt;head&gt;
&lt;script type=&quot;text/javascript&quot;&gt;
function showCDoc()
  ...
  alert(<code>x.contentDocument.documentElement.tagName</code>)
  }
&lt;/script&gt;
&lt;/head&gt;
&lt;body&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_frame_contentdocument">返回作为 HTML 对象的框架文档。</a></dt>
</dl>
</div>
