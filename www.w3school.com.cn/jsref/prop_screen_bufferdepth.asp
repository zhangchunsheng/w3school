...
<title>HTML DOM bufferDepth 属性</title>
...
<div>
<h2>定义和用法</h2>
<p>bufferDepth 属性设置或返回在 off-screen bitmap buffer 中调色板的比特深度。</p>

<h3>语法</h3>
<pre>screen.bufferDepth=number</pre>
</div>
