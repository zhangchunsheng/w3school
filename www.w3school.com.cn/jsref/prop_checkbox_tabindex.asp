...
<div>
<h2>定义和用法</h2>
<p>tabIndex 属性可设置或返回 checkbox 的 tab 键控制次序。</p>

<h3>语法</h3>
<pre>checkboxObject.tabIndex=number</pre>
</div>

<div>
<h2>实例</h2>
<p>下面的例子可更改 checkbox 的 tab index：</p>
<pre>&lt;html&gt;
&lt;head&gt;
&lt;script type=&quot;text/javascript&quot;&gt;
function changeTabIndex()
{
<code>document.getElementById('check3').tabIndex=&quot;1&quot;
document.getElementById('check1').tabIndex=&quot;3&quot;</code>
}
&lt;/script&gt;
&lt;/head&gt;
&lt;body&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_checkbox_tabindex">更改 checkbox 的 tab 键次序</a></dt>
</dl>
</div>
