...
<h1>HTML DOM cols 属性</h1>

<div class="backtoreference">
<p><a href="/jsref/dom_obj_frameset.asp">HTML DOM Frameset 对象</a></p>
</div>

<div>
<h2>定义和用法</h2>
<p>cols 属性可设置或返回框架集中列的数目和尺寸。</p>
<p>由逗号分割的像素或百分比列表定义了列的数目和宽度：</p>

<h3>语法</h3>
<pre>framesetObject.cols=col1,col2,col3....</pre>
</div>
...
<p>HTML 文档 &quot;frame_cols.htm&quot; 被放入第一列，而 HTML 文档 &quot;frame_a.htm&quot; 被放入第二列。</p>
<p>下面是 &quot;frame_cols.htm&quot; 的源代码：</p>
...
function changeCols()
  {
  <code>parent.document.getElementById(&quot;main&quot;).cols=&quot;30%,70%&quot;</code>
  }
  
function restoreCols()
  {
  <code>parent.document.getElementById(&quot;main&quot;).cols=&quot;50%,50%&quot;</code>
  }
&lt;/script&gt;
&lt;/head&gt;
&lt;body&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_frameset_cols">更改框架集的列尺寸</a></dt>
</dl>
</div>
