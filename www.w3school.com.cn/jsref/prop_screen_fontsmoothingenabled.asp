...
<title>HTML DOM fontSmoothingEnabled 属性</title>
...
<h1>HTML DOM fontSmoothingEnabled 属性</h1>
...
<div>
<h2>定义和用法</h2>
<p>fontSmoothingEnabled 属性返回用户是否在显示控制面板中启用了字体平滑。</p>

<h3>语法</h3>
<pre>sscreen.fontSmoothingEnabled</pre>
</div>
