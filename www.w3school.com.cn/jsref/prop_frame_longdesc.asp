...
<title>HTML DOM longDesc 属性</title>
...
<div>
<h2>定义和用法</h2>
<p>longDesc 属性可设置或返回一个框架内容描述的 URL。</p>
<p class="tip"><span>提示：</span>对那么不支持框架的浏览器使用该属性。</p>

<h3>语法</h3>
<pre>frameObject.longDesc=URL</pre>
</div>
...
<p>HTML 文档 &quot;frame_longdesc.htm&quot; 被放入第一列，而 HTML 文档 &quot;frame_a.htm&quot; 被放入第二列。</p>
<p>下面是 &quot;frame_longdesc.htm&quot; 的源代码：</p>
...
document.write('&lt;a href=&quot;' + <code>x.longDesc</code>
+ '&quot;&gt;Description&lt;/a&gt;');
&lt;/script&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_frame_longdesc">使用 &lt;frame&gt; 元素中的 longdesc 属性</a></dt>
</dl>
</div>
