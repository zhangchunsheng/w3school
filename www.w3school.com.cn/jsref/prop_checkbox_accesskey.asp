...
<div>
<h2>定义和用法</h2>
<p>accessKey 属性设置或返回 checkbox 的快捷键。</p>
<p class="note"><span>注释：</span>请使用 <em>Alt + accessKey</em> 为拥有指定快捷键的元素赋予焦点。</p>

<h3>语法</h3>
<pre>checkboxObject.accessKey=accessKey</pre>
</div>

<div>
<h2>实例</h2>
<p>下面的例子返回了 checkbox 的快捷键：</p>
<pre>&lt;html&gt;
&lt;body&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_checkbox_accesskey">返回 checkbox 的快捷键</a></dt>
</dl>
</div>
