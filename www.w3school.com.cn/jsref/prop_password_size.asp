...
<div>
<h2>定义和用法</h2>
<p>size 属性可设置或返回密码域的大小（以字符数计）。</p>

<h3>语法</h3>
<pre>passwordObject.size=number_of_chars</pre>
</div>
...
function changeSize()
  {
  <code>document.getElementById(&quot;password1&quot;).size=40</code>
  }
&lt;/script&gt;
&lt;/head&gt;
&lt;body&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_password_size">更改密码域的尺寸</a></dt>
</dl>
</div>
