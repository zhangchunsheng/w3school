...
<div>
<h2>定义和用法</h2>
<p>lang 属性可设置或返回元素的预言代码。</p>

<h3>语法</h3>
<pre>bodyObject.lang=language-code</pre>
</div>

<div>
<h2>实例</h2>
<p>下面的例子将展示获取 &lt;body&gt; 元素的语言代码的两种方法：</p>
<pre>&lt;html&gt;
&lt;body id=&quot;myid&quot; lang=&quot;en-us&quot;&gt;

&lt;script type=&quot;text/javascript&quot;&gt;
<code>x=document.getElementsByTagName('body')[0];</code>
document.write(&quot;Body language: &quot; + <code>x.lang</code>);
document.write(&quot;&lt;br /&gt;&quot;);
document.write(&quot;An alternate way: &quot;);
document.write(<code>document.getElementById('myid').lang</code>);
&lt;/script&gt;
...
<p>输出：</p>
<pre>Body language: en-us
An alternate way: en-us</pre>
</div>

<div class="example">
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_body_lang">返回 &lt;body&gt; 元素的语言代码</a></dt>
</dl>
</div>
