...
<title>JavaScript setHours() 方法</title>
...
<p>setHours() 方法用于设置指定的时间的小时字段。</p>

<h3>语法</h3>

<pre>dateObject.setHours(hour,min,sec,millisec)</pre>
...
<table class="dataintable"> 
  ...
  <tr>
    <td>hour</td>
    <td>必需。表示小时的数值，介于 0（午夜） ~ 23（晚上11点） 之间，以本地时间计（下同）。</td>
  </tr>
    <tr>
    <td>min</td>
    <td>可选。表示分钟的数值，介于 0 ~ 59 之间。在 EMCAScript 标准化之前，不支持该参数。</td>
  </tr>
    <tr>
    <td>sec</td>
    <td>可选。表示秒的数值，介于 0 ~ 59 之间。在 EMCAScript 标准化之前，不支持该参数。</td>
  </tr>
    <tr>
    <td>millisec</td>
    <td>可选。表示毫秒的数值，介于 0 ~ 999之间。在 EMCAScript 标准化之前，不支持该参数。</td>
  </tr>
</table>

<h3>返回值</h3>

<p>调整过的日期的毫秒表示。在 ECMAScript 标准化之前，该方法什么都不返回。</p>
</div>
...
<p>在本例中，我们将通过 setHours() 方法把当前时间的小时字段设置为 15：</p>
...
<p>在本例中，我们将通过 setHours() 方法把时间设置为 15:35:01：</p>
...
<dl>
<dt><a href="/tiy/t.asp?f=jseg_sethours">setHours()</a></dt>
<dd>如何使用 setHours() 来设置时间。</dd>
</dl>
</div>
