...
<title>HTML DOM pageBreakBefore 属性</title>
...
<h1>HTML DOM pageBreakBefore 属性</h1>
...
<div>
<h2>定义和用法</h2>
<p>pageBreakBefore 属性声明一个元素前是否应当放置分页符。</p>

<h3>语法：</h3>
<pre>Object.style.pageBreakBefore=auto|always|avoid|left|right</pre>
...
<div>
<h2>实例</h2>
<p>本例在 id 为 p2 的段落之前设置一个 page-break：</p>
...
{
<code>document.getElementById(&quot;p2&quot;).style.pageBreakBefore=&quot;always&quot;;</code>
}
&lt;/script&gt;
&lt;/head&gt;
&lt;body&gt;
