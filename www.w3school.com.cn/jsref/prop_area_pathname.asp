...
<div>
<h2>定义和用法</h2>
<p>pathname 属性可设置或返回某个区域中 link-URL 的路径名。</p>

<h3>语法</h3>
<pre>areaObject.pathname=pathnamee</pre>
</div>

<div>
<h2>实例</h2>
<p>下面的例子可返回 &quot;Venus&quot; 区域中 link-URL 的路径名：</p>
<pre>&lt;html&gt;
&lt;body&gt;
...
document.write(<code>x.pathname</code>);
&lt;/script&gt;
&lt;/p&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_area_pathname">取得图像映射中某个区域的 link-URL 的路径名</a></dt>
</dl>
</div>
