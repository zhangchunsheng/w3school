...
<title>JavaScript parse() 方法</title>
...
<table class="dataintable"> 
  ...
  <tr>
    <td>datestring</td>
    <td>必需。表示日期和时间的字符串。</td>
  </tr>
</table>

<h3>返回值</h3>

<p>指定的日期和时间据 1970/1/1 午夜（GMT 时间）之间的毫秒数。</p>

<h3>说明</h3>

<p>该方法是 Date 对象的静态方法。一般采用 Date.parse() 的形式来调用，而不是通过 dateobject.parse() 调用该方法。</p>
</div>
...
<p class="note"><span>注释：</span>Date.parse() 是 Date 对象的静态方法。</p>
</div>
...
<p>在本例中，我们将取得从 1970/01/01 到 2005/07/08 的毫秒数：</p>
...
<dl>
<dt><a href="/tiy/t.asp?f=jseg_parse">parse()</a></dt>
<dd>使用 parse() 来输出从 1970/01/01 到一个具体日期的毫秒数。</dd>
</dl>
</div>
