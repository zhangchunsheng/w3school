...
<title>HTML DOM acceptCharset 属性</title>
...
<h1>HTML DOM acceptCharset 属性</h1>
...
<div>
<h2>定义和用法</h2>
<p>acceptCharset 属性可设置或返回一个逗号分隔的列表，内容是服务器可接受的字符集。</p>

<h3>语法</h3>
<pre>formObject.acceptCharset=charset</pre>
</div>

<div>
<h2>实例</h2>
<p>下面的例子提示出表单数据可能的字符集：</p>
<pre>&lt;html&gt;
&lt;head&gt;
&lt;script type=&quot;text/javascript&quot;&gt;
function showCharset()
  ...
  alert(<code>x.acceptCharset</code>)
  }
&lt;/script&gt;
&lt;/head&gt;
&lt;body&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_form_acceptcharset">取得表单数据可能的字符集</a></dt>
</dl>
</div>
