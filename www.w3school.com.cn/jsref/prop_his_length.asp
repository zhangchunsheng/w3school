...
<p><a href="/jsref/dom_obj_history.asp">HTML DOM History 对象</a></p>
</div>

<div>
<h2>定义和用法</h2>

<p>length 属性声明了浏览器历史列表中的元素数量。</p>

<p class="note"><span>注释：</span>IE 6 和 Opera 9 以 0 开始，而  Firefox 1.5 以 1 开始。</p>


<h3>语法</h3>

<pre>history.length</pre>
</div>
...
&lt;script type=&quot;text/javascript&quot;&gt;
document.write(<code>history.length</code>);
&lt;/script&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_his_length">使用 history 对象的 length 属性</a></dt>
</dl>
</div>
