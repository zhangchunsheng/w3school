...
<li class="currentLink"><a href="/jsref/dom_obj_frame.asp" title="HTML DOM Frame 对象">&lt;frame&gt;</a></li>
...
<h1>HTML DOM Frame 对象</h1>


<div>
<h2>Frame 对象</h2>

<p>Frame 对象代表一个 HTML 框架。</p>

<p>在 HTML 文档中 &lt;frame&gt; 每出现一次，就会创建一个 Frame对象。</p>
</div>
...
<table class="dataintable">
  ...
  <tr>
    <td><a href="/jsref/prop_frame_contentdocument.asp">contentDocument</a></td>
    <td>容纳框架的内容的文档。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_frame_frameborder.asp">frameBorder</a></td>
    <td>设置或返回是否显示框架周围的边框。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_frame_id.asp">id</a></td>
    <td>设置或返回框架的 id。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_frame_longdesc.asp">longDesc</a></td>
    <td>设置或返回指向包含框架内容描述文档的 URL。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_frame_marginheight.asp">marginHeight</a></td>
    <td>设置或返回框架的顶部和底部页空白。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_frame_marginwidth.asp">marginWidth</a></td>
    <td>设置或返回框架的左边缘和右边缘的空白。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_frame_name.asp">name</a></td>
    <td>设置或返回框架的名称。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_frame_noresize.asp">noResize</a></td>
    <td>设置或返回框架是否可调整大小。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_frame_scrolling.asp">scrolling</a></td>
    <td>设置或返回框架是否可拥有滚动条。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_frame_src.asp">src</a></td>
    <td>设置或返回应被加载到框架中的文档的 URL。</td>
  </tr>
</table>
</div>
