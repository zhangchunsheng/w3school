...
<p><a href="/jsref/dom_obj_link.asp" title="HTML DOM Link 对象">HTML DOM Link 对象</a></p>
</div>

<div>
<h2>定义和用法</h2>
<p>The rev property sets or returns the relationship between the target URL and   the current document.</p>
...
<h3>语法</h3>
<pre>linkObject.rev=relationship</pre>
...
<div>
<h2>实例</h2>
<p>The following example returns the relationship between the target URL and the current document:</p>
<pre>&lt;html&gt;
&lt;head&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_link_rev">Return the reverse relationship of a &lt;link&gt; element</a></dt>
</dl>
</div>
