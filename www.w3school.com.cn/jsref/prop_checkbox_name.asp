...
<div>
<h2>定义和用法</h2>
<p>name 属性可设置或返回 checkbox 的名称。</p>

<h3>语法</h3>
<pre>checkboxObject.name=name</pre>
</div>

<div>
<h2>实例</h2>
<p>下面的例子可输出 checkbox 的名称：</p>
<pre>&lt;html&gt;
&lt;body&gt;
...
&lt;script type=&quot;text/javascript&quot;&gt;
document.write(<code>document.getElementById(&quot;check1&quot;).name</code>)
&lt;/script&gt;
&lt;/p&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_checkbox_name">取得 checkbox 的名称</a></dt>
</dl>
</div>
