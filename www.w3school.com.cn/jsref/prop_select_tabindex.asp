...
<div>
<h2>定义和用法</h2>
<p>tabIndex 属性可设桌返回下拉列表中的 tab 键控制次序。</p>

<h3>语法</h3>
<pre>selectObject.tabIndex=number</pre>
</div>

<div>
<h2>实例</h2>
<p>下面的例子将显示出一个文本框和一个下拉列表的 tab 键控制次序：</p>
<pre>&lt;html&gt;
&lt;head&gt;
&lt;script type=&quot;text/javascript&quot;&gt;
function showTabIndex()
  ...
  var sex=<code>document.getElementById('sex').tabIndex</code>;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_select_tabindex">显示表单域的 tab 键控制次序</a></dt>
</dl>
</div>
