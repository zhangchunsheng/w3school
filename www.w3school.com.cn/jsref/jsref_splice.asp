...
<title>JavaScript splice() 方法</title>
...
<h1>JavaScript splice() 方法</h1>

<div class="backtoreference">
<p><a href="/jsref/jsref_obj_array.asp" title="JavaScript Array 对象">JavaScript Array 对象</a></p>
</div>
...
<p class="note"><span>注释：</span>该方法会改变原始数组。</p>
...
<table class="dataintable">
<tr>
<th style="width:25%;">JavaScript 版本：</th>
<td>1.2</td>
</tr>
</table>
</div>
...
<p>所有主流浏览器都支持 splice() 方法。</p>
</div>


<div>
<h2>提示和注释</h2>
<p class="tip"><span>注释：</span>请注意，splice() 方法与 slice() 方法的作用是不同的，splice() 方法会直接对数组进行修改。</p>
</div>
...
<code>arr.splice(2,0,&quot;William&quot;)</code>
document.write(arr + &quot;&lt;br /&gt;&quot;)

&lt;/script&gt;</pre>
<p>输出：</p>
<pre>George,John,Thomas,James,Adrew,Martin
George,John,William,Thomas,James,Adrew,Martin</pre>

<h3>例子 2</h3>
<p>在本例中我们将删除位于 index 2 的元素，并添加一个新元素来替代被删除的元素：</p>
<pre>&lt;script type=&quot;text/javascript&quot;&gt;
...
document.write(arr + &quot;&lt;br /&gt;&quot;)
<code>arr.splice(2,1,&quot;William&quot;)</code>
document.write(arr)

&lt;/script&gt;</pre>
<p>输出：</p>
<pre>George,John,Thomas,James,Adrew,Martin<br />George,John,William,James,Adrew,Martin</pre>

<h3>例子 3</h3>
<p>在本例中我们将删除从 index 2 (&quot;Thomas&quot;) 开始的三个元素，并添加一个新元素 (&quot;William&quot;) 来替代被删除的元素：</p>
<pre>&lt;script type=&quot;text/javascript&quot;&gt;
...
document.write(arr + &quot;&lt;br /&gt;&quot;)
<code>arr.splice(2,3,&quot;William&quot;)</code>
document.write(arr)

&lt;/script&gt;</pre>
<p>输出：</p>
<pre>George,John,Thomas,James,Adrew,Martin<br />George,John,William,Martin</pre>
</div>

<div class="example">
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=jseg_splice">splice()</a></dt>
<dd>如何使用 splice() 来更改数组。</dd>
</dl>
</div>
