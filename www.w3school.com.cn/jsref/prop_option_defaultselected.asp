...
<title>HTML DOM defaultSelected 属性</title>
...
<h1>HTML DOM defaultSelected 属性</h1>
...
<div>
<h2>定义和用法</h2>
<p>defaultSelected 属性可返回 selected 属性的初始值。</p>
<p>如果选择了默认的选项，则返回 true，否则返回 fasle。</p>
<p>如果表单被重置，则 selected 属性重置为该属性的值。这个该属性也会设置 selected 属性的值。</p>
<p class="note"><span>注释：</span>默认的选项将显示在第一位。</p>

<h3>语法</h3>
<pre>optionObject.defaultSelected</pre>
</div>

<div>
<h2>实例</h2>
<p>下面的例子可检测所选项是否是默认选项：</p>
<pre>&lt;html&gt;
&lt;head&gt;
&lt;script type=&quot;text/javascript&quot;&gt;
function alertDefaultSelected()
  ...
  txt=txt + <code>y[x].defaultSelected</code>;
  alert(txt);
  }
&lt;/script&gt;
&lt;/head&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_option_defaultselected">检测所选项是否是默认选项</a></dt>
</dl>
</div>
