...
<title>HTML DOM target 属性</title>
...
<h1>HTML DOM target 属性</h1>

<div class="backtoreference">
<p><a href="/jsref/dom_obj_area.asp">HTML DOM Area 对象</a></p>
</div>

<div>
<h2>定义和用法</h2>
<p>target 属性可设置或返回在何处打开区域中的 link-URL。</p>

<h3>语法</h3>
<pre>areaObject.target=_blank|_parent|_self|_top</pre>

<p>四个保留的目标名称：</p>
<ul>
	<li>_blank - 在一个新的未命名的窗口载入文档</li>
	<li>_self - 在相同的框架或窗口中载入目标文档</li>
	<li>_parent - 把文档载入父窗口或包含了超链接引用的框架的框架集</li>
	<li>_top - 把文档载入包含该超链接的窗口,取代任何当前正在窗口中显示的框架</li>
</ul>
</div>

<div>
<h2>实例</h2>
<p>The following example changes the target of the link in the image-map:</p>
<pre>&lt;html&gt;
&lt;head&gt;
&lt;script type=&quot;text/javascript&quot;&gt;
function changeTarget()
  {
  <code>document.getElementById('venus').target=&quot;_blank&quot;</code>
  }
&lt;/script&gt;
&lt;/head&gt;
&lt;body&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_area_target">更改图像映射中某个链接的 target</a></dt>
</dl>
</div>
