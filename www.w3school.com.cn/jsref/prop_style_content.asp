...
<h3>语法：</h3>
<pre>Object.style.content=value</pre>
...
<table class="dataintable">
	...
	<tr>
		<td>
		<ul>
		<li>counter(<i>name</i>)</li>
		<li>counter(<i>name, list-style-type</i>)</li>
		<li>counters(<i>name, string</i>)</li>
		<li>counters(<i>name, string, list-style-type</i>)</li>
		</ul>
		</td>
		<td>&nbsp;</td>
	</tr>
...
<div>
<h2>提示和注释</h2>
<p class="note"><span>注释：</span>如果在一行中对于浮动元素而言空间太少，则这个元素会跳到下一行，这个过程会持续到有足够空间的一行为止。</p>
<p class="note"><span>注释：</span>行内元素的内容、背景和边框应该出现在浮动元素之前。块级元素的背景和边框应当出现在浮动元素之后，但是块级元素的内容应当在浮动元素的前面。</p>
</div>
...
{
<code>document.getElementById(&quot;img1&quot;).style.cssFloat=&quot;left&quot;;</code>
}
&lt;/script&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_style_cssfloat">设置图像浮动于文字的左边</a></dt>
</dl>
</div>
