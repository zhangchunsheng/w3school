...
<p>value 属性设置或返回显示在按钮上的文本。</p>

<h3>语法</h3>
<pre>buttonObject.value=value</pre>
</div>

<div>
<h2>实例</h2>

<p>下面的例子可返回显示在按钮上的文本：</p>
...
document.write(<code>x.value</code>);
&lt;/script&gt;&lt;/p&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_pushbutton_value">获取按钮上的文本</a></dt>
</dl>
</div>
