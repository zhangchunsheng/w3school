...
<title>HTML DOM outlineStyle 属性</title>
...
<h1>HTML DOM outlineStyle 属性</h1>
...
<div>
<h2>定义和用法</h2>
<p>outlineStyle 属性设置围绕元素的轮廓的样式。</p>

<h3>语法：</h3>
<pre>Object.style.outlineStyle=style</pre>
...
<tr>
<td>double</td>
<td>定义一个双线轮廓。双线的宽度等同于 outline-width 的值。</td>
</tr>

<tr>
<td>groove</td>
<td>定义一个 3D 凹槽轮廓。此效果取决于 outline-color 值。</td>
</tr>

<tr>
<td>ridge</td>
<td>定义一个 3D 凸槽轮廓。此效果取决于 outline-color 值。</td>
</tr>

<tr>
<td>inset</td>
<td>定义一个 3D 凹边轮廓。此效果取决于 outline-color 值。</td>
</tr>

<tr>
<td>outset</td>
<td>定义一个 3D 凸边轮廓。此效果取决于 outline-color 值。</td>
</tr>
</table>
</div>
...
{
<code>document.getElementById(&quot;p1&quot;).style.outlineStyle=&quot;dotted&quot;;</code>
}
&lt;/script&gt;
&lt;/head&gt;
&lt;body&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_style_outlinestyle">outlineStyle - 改变围绕元素的轮廓的样式</a>（请在非 IE 浏览器中浏览）</dt>
</dl>
</div>
