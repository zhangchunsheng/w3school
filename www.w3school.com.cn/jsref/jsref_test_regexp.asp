...
<title>JavaScript test() 方法</title>
...
<h3>语法</h3>
<pre>RegExpObject.test(string)</pre>
...
<h3>返回值</h3>
<p>如果字符串 string 中含有与 RegExpObject 匹配的文本，则返回 true，否则返回 false。</p>

<h3>说明</h3>
<p>调用 RegExp 对象 r 的 test() 方法，并为它传递字符串 s，与这个表示式是等价的：(r.exec(s) != null)。</p>
</div>

<div>
<h2>实例</h2>
<p>在下面的例子中，我们将检索 &quot;W3School&quot;：</p>
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=jseg_test_regexp">test()</a></dt>
<dd>如何使用 test() 来检索字符串。</dd>
</dl>
</div>
