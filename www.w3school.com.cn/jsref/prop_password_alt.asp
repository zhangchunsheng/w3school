...
<div>
<h2>定义和用法</h2>
<p>alt 属性设置或返回在浏览器不支持密码域时显示的替代文本。</p>

<h3>语法</h3>
<pre>passwordObject.alt=alternate_text</pre>
</div>

<div>
<h2>实例</h2>
<p>下面的例子可返回密码域的替代文本：</p>
<pre>&lt;html&gt;
&lt;body&gt;
...
document.write(<code>x.alt</code>);
&lt;/script&gt;&lt;/p&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_password_alt">返回密码域的 alt 文本</a></dt>
</dl>
</div>
