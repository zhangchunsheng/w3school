...
<p>id 属性设置或返回 body 元素的 id。</p>

<h3>语法</h3>
<pre>bodyObject.id=id</pre>
</div>

<div>
<h2>实例</h2>

<p>下面的例子将展示设置 &lt;body&gt; 元素的 id 的两种方法：</p>
...
document.write(&quot;Body id: &quot; + <code>x.id</code>);
document.write(&quot;&lt;br /&gt;&quot;);
document.write(&quot;An alternate way: &quot;);
document.write(<code>document.getElementById('myid').id</code>);
&lt;/script&gt;
...
<pre>Body id: myid
An alternate way: myid</pre>
</div>

<div class="example">
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_body_id">返回 &lt;body&gt; 元素的 id</a></dt>
</dl>
</div>
