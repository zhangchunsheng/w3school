...
<title>HTML DOM domain 属性</title>
...
<div>
<h2>定义和用法</h2>
<p>domain 属性可返回下载当前文档的服务器域名。</p>

<h3>语法</h3>
<pre>document.domain</pre>

<h3>说明</h3>
<p>该属性是一个只读的字符串，包含了载入当前文档的 web 服务器的主机名。</p>
</div>


<div>
<h2>提示和注释</h2>
<p class="tip"><span>提示：</span>domain 属性可以解决因同源安全策略带来的不同文档的属性共享问题。</p>
<p><a href="https://developer.mozilla.org/Cn/JavaScript%E7%9A%84%E5%90%8C%E6%BA%90%E7%AD%96%E7%95%A5">点击这里，了解同源安全策略的详细信息</a>。</p>
</div>
...
&lt;script type=&quot;text/javascript&quot;&gt;
document.write(<code>document.domain</code>)
&lt;/script&gt;

&lt;/body&gt;
&lt;/html&gt;</pre>

<p><a href="/tiy/t.asp?f=hdom_document_domain">亲自试一试</a></p>
</div>
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_document_domain">返回下载当前文档的服务器域名</a></dt>
</dl>
</div>
