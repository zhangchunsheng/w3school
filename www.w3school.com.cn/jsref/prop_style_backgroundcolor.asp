...
<title>HTML DOM backgroundColor 属性</title>
...
<h1>HTML DOM backgroundColor 属性</h1>
...
<div>
<h2>定义和用法</h2>
<p>backgroundColor 属性设置元素的背景颜色。</p>

<h3>语法：</h3>
<pre>Object.style.backgroundColor=color-name|color-rgb
|color-hex|transparent</pre>
</div>
...
{
<code>document.body.style.backgroundColor=&quot;#FFCC80&quot;;</code>
}
&lt;/script&gt;
&lt;/head&gt;
&lt;body&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_style_backgroundcolor">改变背景色（十六进制）</a></dt>
<dt><a href="/tiy/t.asp?f=hdom_style_backgroundcolor2">改变背景色（颜色名）</a></dt>
</dl>
</div>
