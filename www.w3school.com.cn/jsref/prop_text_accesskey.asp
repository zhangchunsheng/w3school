...
<div>
<h2>定义和用法</h2>
<p>accessKey 属性可设置或返回访问文本域的快捷键。</p>
<p class="note"><span>注释：</span>请使用 <em>Alt + accessKey</em> 为拥有指定快捷键的元素赋予焦点。</p>
<h3>语法</h3>
<pre>textObject.accessKey=accessKey</pre>
</div>
...
function setAccessKeys()
  {
  <code>document.getElementById('fname').accessKey=&quot;n&quot;
  document.getElementById('pwd').accessKey=&quot;p&quot;</code>
  }
&lt;/script&gt;
&lt;/head&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_text_accesskey">为文本域添加快捷键</a></dt>
<dt><a href="/tiy/t.asp?f=hdom_accesskey_form">为若干表单域添加快捷键</a></dt>
</dl>
</div>
