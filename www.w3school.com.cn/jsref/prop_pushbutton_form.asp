...
<div>
<h2>定义和用法</h2>
<p>form 属性可返回对包含该按钮的表单的引用。</p>
<p>如果包含该按钮，则返回一个 form 对象，如果未包含该按钮，则返回 null。</p>

<h3>语法</h3>
<pre>buttonObject.form</pre>
</div>

<div>
<h2>实例</h2>
<p>下面的例子可返回该按钮所属的表单的 id：</p>
<pre>&lt;html&gt;
&lt;body&gt;
...
document.write(<code>x.form.id</code>);
&lt;/script&gt;&lt;/p&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_pushbutton_form">返回按钮所属的表单的 id</a></dt>
</dl>
</div>
