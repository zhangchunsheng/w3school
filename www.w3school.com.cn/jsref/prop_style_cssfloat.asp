...
<title>HTML DOM cssFloat 属性</title>
...
<div>
<h2>定义和用法</h2>
<p>设置文本或图像出现（浮动）在另一个元素中的什么地方。</p>

<h3>语法：</h3>
<pre>Object.style.cssFloat=left|right|none</pre>
...
<table class="dataintable">
	...
	<tr>
		<td>left</td>
		<td>图像或文本浮动在父元素的左边。</td>
	</tr>
	<tr>
		<td>right</td>
		<td>图像或文本浮动在父元素的右边。</td>
	</tr>
	<tr>
		<td>none</td>
		<td>图像或文本浮动显示在它在父元素中出现的位置。</td>
	</tr>
</table>
</div>
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_style_cssfloat">cssFloat - 设置图像浮动于文字的左边</a>（请在非 IE 浏览器中查看）</dt>
</dl>
</div>
