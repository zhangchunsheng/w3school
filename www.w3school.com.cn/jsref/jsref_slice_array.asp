...
<title>JavaScript slice() 方法</title>
...
<h3>语法</h3>
<pre>arrayObject.slice(start,end)</pre>
...
<div>
<h2>提示和注释</h2>
<p class="note"><span>注释：</span>您可使用负值从数组的尾部选取元素。</p>
<p class="note"><span>注释：</span>如果 end 未被规定，那么 slice() 方法会选取从 start 到数组结尾的所有元素。</p>
</div>
...
document.write(<code>arr.slice(1)</code> + &quot;&lt;br /&gt;&quot;)
document.write(arr)

&lt;/script&gt;</pre>
<p>输出：</p>
<pre>George,John,Thomas
John,Thomas
George,John,Thomas</pre>
...
document.write(arr + &quot;&lt;br /&gt;&quot;)
document.write(<code>arr.slice(2,4)</code> + &quot;&lt;br /&gt;&quot;)
document.write(arr)
...
Thomas,James
George,John,Thomas,James,Adrew,Martin</pre>
</div>

<div class="example">
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=jseg_slice_array">slice()</a></dt>
<dd>如何使用 slice() 从已有的数组显示选取的元素。</dd>
</dl>
</div>
