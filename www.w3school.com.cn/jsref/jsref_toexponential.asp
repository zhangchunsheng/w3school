...
<title>JavaScript toExponential() 方法</title>
...
<h1>JavaScript toExponential() 方法</h1>
...
<div>
<h2>定义和用法</h2>
<p>toExponential() 方法可把对象的值转换成指数计数法。</p>

<h3>语法</h3>
<pre>NumberObject.toExponential(num)</pre>
...
<table class="dataintable"> 
  ...
  <tr>
    <td>num</td>
    <td>必需。规定指数计数法中的小数位数，是 0 ~ 20 之间的值，包括 0 和 20，有些实现可以支持更大的数值范围。如果省略了该参数，将使用尽可能多的数字。</td>
  </tr>
</table>
...
<h3>抛出</h3>
<p>当 num 太小或太大时抛出异常 RangeError。0 ~ 20 之间的值不会引发该异常。有些实现支持更大范围或更小范围内的值。</p>
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=jseg_toexponential">toExponential()</a></dt>
<dd>如何使用 toExponential() 来把数字转换为指数计数法。</dd>
</dl>
</div>
