...
<div>
<h2>定义和用法</h2>
<p>defaultValue 属性可设置或返回文本域的默认值。</p>
<p class="note"><span>注释：</span>该默认值是规定于 HTML &quot;value&quot; 属性的值。</p>

<h3>语法</h3>
<pre>textObject.defaultValue=somevalue</pre>
</div>

<div>
<h2>实例</h2>
<p>下面的例子可获得该文本域的默认文本：</p>
<pre>&lt;html&gt;
&lt;head&gt;
&lt;script type=&quot;text/javascript&quot;&gt;
function alertValue()
{
alert(<code>document.getElementById(&quot;text1&quot;).defaultValue</code>)
}
&lt;/script&gt;
&lt;/head&gt;
&lt;body&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_text_defaultvalue">获得该文本域的默认文本</a></dt>
</dl>
</div>
