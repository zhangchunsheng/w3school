...
<div>
<h2>定义和用法</h2>
<p>id 属性可设置或返回表单的 id。</p>

<h3>语法</h3>
<pre>formObject.id=id</pre>
</div>

<div>
<h2>实例</h2>
<p>下面的例子展示了两种返回 &lt;form&gt; 元素的 id 的方法：</p>
<pre>&lt;html&gt;
&lt;body&gt;
...
document.write(&quot;Form id: &quot; + <code>x.id</code>);
document.write(&quot;&lt;br /&gt;&quot;);
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_form_id">从 &lt;form&gt; 元素取得 id</a></dt>
</dl>
</div>
