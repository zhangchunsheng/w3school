...
<h1>HTML DOM hash 属性</h1>

<div class="backtoreference">
<p><a href="/jsref/dom_obj_location.asp">HTML DOM Location 对象</a></p>
</div>
...
<h3>语法</h3>
<pre>location.hash=anchorname</pre>
</div>

<div>
<h2>实例</h2>
<p>假设当前的 URL 是: http://example.com:1234/test.htm#part2：</p>
<pre>&lt;html&gt;
&lt;body&gt;

&lt;script type=&quot;text/javascript&quot;&gt;
document.write(<code>location.hash</code>);
&lt;/script&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_loc_hash">使用 location 对象的 hash 属性</a></dt>
<dt><a href="/tiy/t.asp?f=hdom_anchor1">锚的数组</a></dt>
<dd>本例打开两个窗口。第一个窗口中包含四个按钮。第二个窗口定义了四个锚。当点击第一个窗口中的某个按钮时，onclick 事件句柄会到达第二个窗口指定的锚。</dd>
</dl>
</div>
