...
<title>JavaScript asin() 方法</title>
...
<h1>JavaScript asin() 方法</h1>

<div class="backtoreference">
<p><a href="/jsref/jsref_obj_math.asp" title="JavaScript Math 对象">JavaScript Math 对象</a></p>
</div>
...
<table class="dataintable"> 
  ...
  <tr>
    <td>x</td>
    <td>必需。必须是一个数值，该值介于 -1.0 ~ 1.0 之间。</td>
  </tr>
</table>

<h3>返回值</h3>

<p>x 的反正弦值。返回的值是 -PI/2 到 PI/2 之间的弧度值。</p>
</div>
...
<p class="note"><span>注释：</span>如果参数 x 超过了 -1.0 ~ 1.0 的范围，那么浏览器将返回 NaN。</p>

<p class="note"><span>注释：</span>如果参数 x 取值 1，那么将返回 PI/2。</p>
</div>
...
<dl>
<dt><a href="/tiy/t.asp?f=jseg_asin">asin()</a></dt>
<dd>如何使用 asin() 来取得不同数字的反正弦值。</dd>
</dl>
</div>
