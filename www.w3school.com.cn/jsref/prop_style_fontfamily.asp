...
<title>HTML DOM fontFamily 属性</title>
...
<div>
<h2>定义和用法</h2>
<p>fontFamily 属性定义用于元素文本显示的字体系列。</p>

<h3>语法：</h3>
<pre>Object.style.fontFamily=font1,font2,....</pre>
...
<div>
<h2>提示和注释</h2>
<p class="tip"><span>提示：</span>使用逗号分割每个值，并始终提供一个类族名称作为最后的选择。</p>
<p class="note"><span>注释：</span>如果字体族名称中含有空格，请为其加上引号。</p>
</div>
...
function setFont()
{
<code>document.getElementById(&quot;p1&quot;).style.fontFamily=&quot;arial,sans-serif&quot;;</code>
}
&lt;/script&gt;
&lt;/head&gt;
&lt;body&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_style_fontfamily">fontFamily - 改变文本的字体系列</a></dt>
</dl>
</div>
