...
<div>
<h2>定义和用法</h2>
<p>name 属性可设置或返回下拉列表的名称。</p>

<h3>语法</h3>
<pre>selectObject.name=name</pre>
</div>
...
function getName()
  {
  alert(<code>document.getElementById(&quot;mySelect&quot;).name</code>)
  }
&lt;/script&gt;
&lt;/head&gt;
&lt;body&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_select_name">取得下拉列表的名称</a></dt>
</dl>
</div>
