...
<title>JavaScript toGMTString() 方法</title>
...
<h1>JavaScript toGMTString() 方法</h1>
...
<div>
<h2>定义和用法</h2>
<p>toGMTString() 方法可根据格林威治时间 (GMT) 把 Date 对象转换为字符串，并返回结果。</p>

<h3>语法</h3>
<pre>dateObject.toGMTString()</pre>

<h3>返回值</h3>
<p>dateObject 的字符串表示。此日期会在转换为字符串之前由本地时区转换为 GMT 时区。</p>
</div>

<div>
<h2>提示和注释</h2>
<p>不赞成使用此方法。请使用 toUTCString() 取而代之！！</p>
</div>
...
<h3>例子 1</h3>
<p>在本例中，我们将把今天的日期转换为（根据 GMT）字符串：</p>
...
<h3>例子 2</h3>
<p>在下面的例子中，我们将把具体的日期转换为（根据 GMT）字符串：</p>
<pre>&lt;script type=&quot;text/javascript&quot;&gt;
...
<pre><script type="text/javascript">
var born = new Date("July 21, 1983 01:15:00")
document.write(born.toGMTString())</script></pre>
</div>

<div class="example">
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=jseg_togmtstring">toGMTString()</a></dt>
<dd>如何通过 toGMTString() 把今天的日期转换为（根据 GMT）字符串。</dd>
</dl>
</div>
