...
<h3>语法</h3>
<pre>arrayObject.toString()</pre>

<h3>返回值</h3>
<p>arrayObject 的字符串表示。返回值与没有参数的 join() 方法返回的字符串相同。</p>
...
<div>
<h2>提示和注释</h2>
<p class="tip"><span>注释：</span>数组中的元素之间用逗号分隔。</p>
</div>
...
document.write(<code>arr.toString()</code>)
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=jseg_toString_array">toString()</a></dt>
<dd>如何使用 toString() 来更改数组。</dd>
</dl>
</div>
