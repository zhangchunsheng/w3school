...
<title>HTML DOM moveBy() 方法</title>
...
<div>
<h2>定义和用法</h2>
<p>moveBy() 方法可相对窗口的当前坐标把它移动指定的像素。</p>

<h3>语法</h3>
<pre>window.moveBy(x,y)</pre>
...
<div>
<h2>实例</h2>
<p>下面的例子将把窗口相对其当前位置移动 50 个像素：</p>
<pre>&lt;html&gt;
&lt;head&gt;
&lt;script type=&quot;text/javascript&quot;&gt;
function moveWin()
  {
  <code>myWindow.moveBy(50,50)</code>
  }
&lt;/script&gt;
&lt;/head&gt;
&lt;body&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_win_moveby">通过 moveBy() 移动窗口</a></dt>
</dl>
</div>
