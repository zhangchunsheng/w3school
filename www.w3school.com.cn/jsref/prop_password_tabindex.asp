...
<div>
<h2>定义和用法</h2>
<p>tabIndex 属性设置或返回密码域的 tab 键控制次序。</p>

<h3>语法</h3>
<pre>passwordObject.tabIndex=number</pre>
</div>

<div>
<h2>实例</h2>
<p>下面的例子可显示表单元素的 tab 键控制次序：</p>
<pre>&lt;html&gt;
&lt;head&gt;
&lt;script type=&quot;text/javascript&quot;&gt;
function showTabIndex()
  {
  var email=<code>document.getElementById('email').tabIndex</code>;
  var pwd=<code>document.getElementById('pwd').tabIndex</code>;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_password_tabindex">显示表单元素的 tab 键控制次序</a></dt>
</dl>
</div>
