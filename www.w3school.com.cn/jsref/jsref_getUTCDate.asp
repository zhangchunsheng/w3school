...
<title>JavaScript getUTCDate() 方法</title>
...
<h1>JavaScript getUTCDate() 方法</h1>
...
<p>getUTCDate() 方法可根据世界时返回一个月 (UTC) 中的某一天。</p>

<h3>语法</h3>

<pre>dateObject.getUTCDate()</pre>

<h3>返回值</h3>

<p>dateObject 用世界时表示时，返回该月中的某一天 （是 1 ~ 31 中的一个值）。</p>
</div>
...
<p>我们在此处定义了一个带有具体日期的变量，然后根据 UTC 输出变量中的月中的那一天：</p>
...
<dl>
<dt><a href="/tiy/t.asp?f=jseg_getUTCdate">getUTCDate()</a></dt>
<dd>如何使用 getUTCDate() 来取得此月的当前一天（根据 UTC）。</dd>
<dt><a href="/tiy/t.asp?f=jseg_datedate">以不同的格式来显示 UTC 日期。</a></dt>
<dd>如何使用 getUTCDate(), getUTCMonth() 以及 getUTCFullYear() 以不同的格式来显示 UTC 日期。</dd>
</dl>
</div>
