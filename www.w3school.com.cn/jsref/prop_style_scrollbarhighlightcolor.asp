...
<title>HTML DOM scrollbarHighlightColor 属性</title>
...
<h1>HTML DOM scrollbarHighlightColor 属性</h1>
...
<div>
<h2>定义和用法</h2>
<p>scrollbarHighlightColor 属性设置箭头和滚动条的左边和上边的颜色，以及滚动条的背景。</p>

<h3>语法：</h3>
<pre>Object.style.scrollbarHighlightColor=color</pre>
...
<div>
<h2>实例</h2>
<p>本例设置箭头和滚动条的左边和上边的颜色，以及滚动条的背景：</p>
...
{
<code>document.body.style.scrollbarHighlightColor=&quot;purple&quot;;</code>
}
&lt;/script&gt;
&lt;/head&gt; 
&lt;body&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_style_scrollbarhighlightcolor">scrollbarHighlightColor</a></dt>
</dl>
</div>
