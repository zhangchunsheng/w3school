...
<div>
<h2>定义和用法</h2>
<p>The disabled property sets or returns whether or not the target URL should be disabled.</p>

<h3>语法</h3>
<pre>linkObject.disabled=true|false</pre>
</div>

<div>
<h2>实例</h2>
<p>The following example disables the style sheet:</p>
<pre>&lt;html&gt;
&lt;head&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_link_disabled">Disable a style sheet</a></dt>
</dl>
</div>
