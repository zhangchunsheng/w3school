...
<div>
<h2>定义和用法</h2>
<p>media 属性设置或返回显示文档的设备。</p>
<p>对于样式信息而言，目标媒介非常重要。移动设备和桌面计算机的样式可能是不同的。</p>

<h3>语法</h3>
<pre>linkObject.media=device</pre>
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_link_media">获得使用 link 元素的媒介类型</a></dt>
</dl>
</div>
