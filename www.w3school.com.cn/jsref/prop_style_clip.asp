...
<p>clip 属性设置元素的形状。</p>
<p>当图像大于它所在的元素时会发生什么？&quot;clip&quot; 属性允许你规定元素的可见尺寸，以及元素被裁剪和显示的形状。</p>

<h3>语法：</h3>
<pre>Object.style.clip=rect(top,right,bottom,left)|auto</pre>
...
<table class="dataintable">
	...
	<tr>
		<td>rect(<i>top,right,bottom,left</i>)</td>
		<td>设置元素的形状。</td>
	</tr>
	<tr>
		<td>auto</td>
...
<div>
<h2>提示和注释</h2>
<p class="note"><span>注释：</span>该属性不能用于 &quot;overflow&quot; 设置为 &quot;visible&quot; 的元素。</p>
</div>
...
function clipImage()
{
<code>document.getElementById(&quot;img1&quot;).style.clip=&quot;rect(0px,50px,50px,0px)&quot;;</code>
}
&lt;/script&gt;
&lt;/head&gt;
&lt;body&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_style_clip">把图像裁剪为指定的形状</a></dt>
</dl>
</div>
