...
<li class="currentLink"><a href="/jsref/dom_obj_reset.asp" title="HTML DOM Reset 对象">&lt;input&gt; reset</a></li>
...
<h1>HTML DOM Reset 对象</h1>


<div>
<h2>Reset 对象</h2>

<p>Reset 对象代表 HTML 表单中的一个重置按钮。</p>

<p>在 HTML 表单中 &lt;input type=&quot;reset&quot;&gt; 标签每出现一次，一个 Reset 对象就会被创建。</p>

<p>当重置按钮被点击，包含它的表单中所有输入元素的值都重置为它们的默认值。默认值由 HTML value 属性或 JavaScript 的 defaultValue 属性指定。</p>

<p>重置按钮在重置表单之前触发 onclick 句柄，并且这个句柄可以通过返回 fasle 来取消。</p>

<p>参阅 <a href="/jsref/met_form_reset.asp">Form.reset() 方法</a> 和 <a href="/jsref/prop_form_onreset.asp">Form.onreset</a> 事件句柄。</p>

<p>您可以通过遍历表单的 elements[] 数组来访问某个重置按钮，或者通过使用document.getElementById()。</p>
</div>
...
<table class="dataintable">
  ...
  <tr>
    <td><a href="/jsref/prop_reset_accesskey.asp">accesskey</a></td>
    <td>设置或返回访问重置按钮的快捷键。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_reset_alt.asp">alt</a></td>
    <td>设置或返回当浏览器不支持重置按钮时供显示的替代文本。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_reset_disabled.asp">disabled</a></td>
    <td>设置或返回重置按钮是否应被禁用。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_reset_form.asp">form</a></td>
    <td>返回一个对包含此重置按钮的表单对象的引用。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_reset_id.asp">id</a></td>
    <td>设置或返回重置按钮的 id。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_reset_name.asp">name</a></td>
    <td>设置或返回重置按钮的名称。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_reset_tabindex.asp">tabIndex</a></td>
    <td>设置或返回重置按钮的 tab 键控制次序。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_reset_type.asp">type</a></td>
    <td>返回重置按钮的表单元素类型。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_reset_value.asp">value</a></td>
    <td>设置或返回重置按钮上显示的文本。</td>
  </tr>
</table>
</div>
