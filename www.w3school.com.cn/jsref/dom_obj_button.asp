...
<title>HTML DOM Button 对象</title>
...
<li class="currentLink"><a href="/jsref/dom_obj_button.asp" title="HTML DOM Button 对象">&lt;input&gt; button</a></li>
...
<h1>HTML DOM Button 对象</h1>


<div>
<h2>Button 对象</h2>

<p>Button 对象代表 HTML 文档中的一个按钮。</p>

<p>该元素没有默认的行为，但是必须有一个 onclick 事件句柄以便使用。</p>

<p>在 HTML 文档中 &lt;input type=&quot;button&quot;&gt; 标签每出现一次，一个 Button 对象 就会被创建。</p>

<p>您可以通过遍历表单的 elements[] 数组来访问某个按钮，或者通过使用 document.getElementById()。</p>
</div>
...
<table class="dataintable">
  ...
  <tr>
    <td><a href="/jsref/prop_button_accesskey.asp">accessKey</a></td>
    <td>设置或返回访问按钮的快捷键。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_button_alt.asp">alt</a></td>
    <td>设置或返回当浏览器无法显示按钮时供显示的替代文本。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_button_disabled.asp">disabled</a></td>
    <td>设置或返回是否禁用按钮。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_button_form.asp">form</a></td>
    <td>返回对包含该按钮的表单对象的引用。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_button_id.asp">id</a></td>
    <td>设置或返回按钮的 id。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_button_name.asp">name</a></td>
    <td>设置或返回按钮的名称。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_button_tabindex.asp">tabIndex</a></td>
    <td>设置或返回按钮的 tab 键控制次序。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_button_type.asp">type</a></td>
    <td>返回按钮的表单元素类型。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_button_value.asp">value</a></td>
    <td>设置或返回在按钮上显示的文本。</td>
  </tr>
</table>
</div>
...
<table class="dataintable">
  ...
  <tr>
    <td><a href="/jsref/met_button_blur.asp">blur()</a></td>
    <td>把焦点从元素上移开。</td>
  </tr>
  <tr>
    <td><a href="/jsref/met_button_click.asp">click()</a></td>
    <td>在某个按钮上模拟一次鼠标单击。</td>
  </tr>
  <tr>
    <td><a href="/jsref/met_button_focus.asp">focus()</a></td>
    <td>为某个按钮赋予焦点。</td>
  </tr>
</table>
</div>
