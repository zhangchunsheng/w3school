...
<li class="currentLink"><a href="/jsref/dom_obj_form.asp" title="HTML DOM Form 对象">&lt;form&gt;</a></li>
...
<h1>HTML DOM Form 对象</h1>


<div>
<h2>Form 对象</h2>

<p>Form 对象代表一个 HTML 表单。</p>

<p>在 HTML 文档中 &lt;form&gt; 每出现一次，Form 对象就会被创建。</p>
</div>
...
<table class="dataintable">
  ...
  <tr>
    <td><a href="/jsref/coll_form_elements.asp">elements[]</a></td>
    <td>包含表单中所有元素的数组。</td>
  </tr>
</table>
</div>
...
<table class="dataintable">
  ...
  <tr>
    <td><a href="/jsref/prop_form_acceptcharset.asp">acceptCharset</a></td>
    <td>服务器可接受的字符集。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_form_action.asp">action</a></td>
    <td>设置或返回表单的 action 属性。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_form_enctype.asp">enctype</a></td>
    <td>设置或返回表单用来编码内容的 MIME 类型。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_form_id.asp">id</a></td>
    <td>设置或返回表单的 id。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_form_length.asp">length</a></td>
    <td>返回表单中的元素数目。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_form_method.asp">method</a></td>
    <td>设置或返回将数据发送到服务器的 HTTP 方法。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_form_name.asp">name</a></td>
    <td>设置或返回表单的名称。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_form_target.asp">target</a></td>
    <td>设置或返回表单提交结果的 Frame 或 Window 名。</td>
  </tr>
</table>
</div>
...
<table class="dataintable">
  ...
  <tr>
    <td><a href="/jsref/met_form_reset.asp">reset()</a></td>
    <td>把表单的所有输入元素重置为它们的默认值。</td>
  </tr>
  <tr>
    <td><a href="/jsref/met_form_submit.asp">submit()</a></td>
    <td>提交表单。</td>
  </tr>
</table>
</div>
...
<table class="dataintable">
  ...
  <tr>
    <td><a href="/jsref/prop_form_onreset.asp">onreset</a></td>
    <td>在重置表单元素之前调用。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_form_onsubmit.asp">onsubmit</a></td>
    <td>在提交表单之前调用。</td>
  </tr>
</table>
</div>
