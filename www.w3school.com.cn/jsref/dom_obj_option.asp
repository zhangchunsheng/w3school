...
<title>HTML DOM Option 对象</title>
...
<li class="currentLink"><a href="/jsref/dom_obj_option.asp" title="HTML DOM Option 对象">&lt;option&gt;</a></li>
...
<table class="dataintable">
  ...
  <tr>
    <td><a href="/jsref/prop_option_defaultselected.asp">defaultSelected</a></td>
    <td>返回 selected  属性的默认值。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_option_disabled.asp">disabled</a></td>
    <td>设置或返回选项是否应被禁用。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_option_form.asp">form</a></td>
    <td>返回对包含该元素的 &lt;form&gt; 元素的引用。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_option_id.asp">id</a></td>
    <td>设置或返回选项的 id。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_option_index.asp">index</a></td>
    <td>返回下拉列表中某个选项的索引位置。</td>
  </tr>
  <tr>
    <td>label</td>
    <td>设置或返回选项的标记 （仅用于选项组）。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_option_selected.asp">selected</a></td>
    <td>设置或返回 selected 属性的值。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_option_text.asp">text</a></td>
    <td>设置或返回某个选项的纯文本值。</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_option_value.asp">value</a></td>
    <td>设置或返回被送往服务器的值。</td>
  </tr>
</table>
</div>
