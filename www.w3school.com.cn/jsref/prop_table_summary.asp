...
<title>HTML DOM summary 属性</title>
...
<div>
<h2>定义和用法</h2>
<p>summary 属性可设置或返回表格的概述。</p>
<p>summary 属性为语音合成或非可视的浏览器规定了表格的概述。</p>

<h3>语法</h3>
<pre>tableObject.summary=text</pre>
</div>
...
function alertSummary()
  {
  alert(<code>document.getElementById(&quot;table1&quot;).summary</code>);
  }
&lt;/script&gt;
&lt;/head&gt;
&lt;body&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_table_summary">取得表格的概述</a></dt>
</dl>
</div>
