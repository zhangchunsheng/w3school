...
<title>HTML DOM paddingBottom 属性</title>
...
<h1>HTML DOM paddingBottom 属性</h1>
...
<p>paddingBottom 属性设置元素的下内边距。</p>
<p>padding 属性定义元素边框与元素内容之间的空间。</p>

<h3>语法：</h3>
<pre>Object.style.paddingBottom=length|%</pre>
...
<tr>
<td>length</td>
<td>定义固定的下内边距值。默认值是 0。</td>
</tr>

<tr>
<td>%</td>
<td>定义基于父元素高度的百分比下内边距。此值不会如预期的那样工作于所有的浏览器中。</td>
</tr>
</table>
</div>
...
{
<code>document.getElementById(&quot;p1&quot;).style.paddingBottom=&quot;2cm&quot;;</code>
}
&lt;/script&gt;
&lt;/head&gt;
&lt;body&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_style_paddingbottom">paddingBottom - 改变元素的下内边距</a></dt>
</dl>
</div>
