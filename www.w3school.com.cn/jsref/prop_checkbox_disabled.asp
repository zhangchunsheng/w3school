...
<div>
<h2>定义和用法</h2>
<p>disabled 属性可设置或返回是否禁用 checkbox。</p>

<h3>语法</h3>
<pre>checkboxObject.disabled=true|false</pre>
</div>

<div>
<h2>实例</h2>
<p>下面的例子禁用了该 checkbox：</p>
<pre>&lt;html&gt;
&lt;head&gt;
&lt;script type=&quot;text/javascript&quot;&gt;
function disable()
  {
  <code>document.getElementById(&quot;check1&quot;).disabled=true</code>
  }
&lt;/script&gt;
&lt;/head&gt;
&lt;body&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_checkbox_disabled">禁用 checkbox</a></dt>
</dl>
</div>
