...
<pre>arrayObject.pop()</pre>

<h3>返回值</h3>

<p>arrayObject 的最后一个元素。</p>
...
<p>在本例中，我们将创建一个数组，然后删除数组的最后一个元素。请注意，这也会改变数组的程度：</p>
...
<code>document.write(arr)</code>

document.write(&quot;&lt;br /&gt;&quot;)

<code>document.write(arr.pop())</code>
...
<dl>
<dt><a href="/tiy/t.asp?f=jseg_pop">pop()</a></dt>
<dd>如何使用 pop() 来删除并返回数组的最后一个元素。</dd>
</dl>
</div>
