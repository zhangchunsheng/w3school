...
<title>HTML DOM onLine 属性</title>
...
<div>
<h2>定义和用法</h2>
<p>onLine 属性是一个只读的布尔值，声明了系统是否处于脱机模式。</p>
<p class="note"><span>注释：</span>在 IE 4+ 中，用户可以在浏览器中选择脱机工作的状态。当脱机工作被选后，系统就进入了脱机状态，内容将从缓存进行读取。</p>
...
document.write(<code>navigator.onLine</code> + &quot;&lt;/p&gt;&quot;)
&lt;/script&gt;
&lt;/body&gt;
