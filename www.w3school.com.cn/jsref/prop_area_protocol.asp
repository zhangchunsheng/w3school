...
<title>HTML DOM protocol 属性</title>
...
<div>
<h2>定义和用法</h2>
<p>protocol 属性可设置或返回某个区域中 link-URL 的协议。</p>

<h3>语法</h3>
<pre>areaObject.protocol=protocol</pre>
</div>

<div>
<h2>实例</h2>
<p>下面的例子可返回 &quot;Venus&quot; 区域中 link-URL 的协议：</p>
<pre>&lt;html&gt;
&lt;body&gt;
...
document.write(<code>x.protocol</code>);
&lt;/script&gt;
&lt;/p&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_area_protocol">取得图像地图中某个区域的 link-URL 所用的协议</a></dt>
</dl>
</div>
