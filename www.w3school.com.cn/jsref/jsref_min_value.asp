...
<title>JavaScript MIN_VALUE 属性</title>
...
<p>MIN_VALUE 属性是 JavaScript 中可表示的最小的数（接近 0 ，但不是负数）。它的近似值为 5 x 10<sup>-324</sup>。</p>
...
<p>返回 JavaScript 中可能的最小值：</p>

<pre>
&lt;script type=&quot;text/javascript&quot;&gt;

document.write(<code>Number.MIN_VALUE</code>);
...
<p><a href="/tiy/t.asp?f=jseg_min_value">TIY</a></p>
</div>
...
<dl>
<dt><a href="/tiy/t.asp?f=jseg_min_value">MIN_VALUE</a></dt>
<dd>本例返回 JavaScript 中最小的数。</dd>
</dl>
</div>
