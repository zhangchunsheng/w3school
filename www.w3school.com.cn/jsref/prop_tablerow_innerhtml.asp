...
<h3>语法</h3>
<pre>tablerowObject.innerHTML=HTML</pre>
</div>

<div>
<h2>实例</h2>
<p>下面的例子返回了表格行的 inner HTML：</p>
<pre>&lt;html&gt;
&lt;head&gt;
&lt;script type=&quot;text/javascript&quot;&gt;
function getInnerHTML()
  {
  alert(<code>document.getElementById(&quot;tr1&quot;).innerHTML</code>);
  }
&lt;/script&gt;
&lt;/head&gt;
&lt;body&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_tablerow_innerhtml">取得表格行的 inner HTML</a></dt>
</dl>
</div>
