...
<title>HTML DOM scheme 属性</title>
...
<p>scheme 属性设置或返回用于解释 content 属性的值的格式。</p>

<h3>语法</h3>
<pre>metaObject.scheme=format</pre>
</div>

<div>
<h2>实例</h2>

<p>本例返回用于解释 content 属性的值的格式：</p>
...
document.write(&quot;Content format: &quot; + <code>x.scheme</code>);
&lt;/script&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_meta_scheme">返回 &lt;meta&gt; 元素中 content 的格式</a></dt>
</dl>
</div>
