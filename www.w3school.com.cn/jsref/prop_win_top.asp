...
<div>
<h2>定义和用法</h2>
<p>top 属性返回最顶层的先辈窗口。</p>
<p>该属性返回对一个顶级窗口的只读引用。如果窗口本身就是一个顶级窗口，top 属性存放对窗口自身的引用。如果窗口是一个框架，那么 top 属性引用包含框架的顶层窗口。</p>
...
function breakout()
{
if (<code>window.top</code>!=window.self) 
{
...
<p><a href="/tiy/t.asp?f=hdom_breakout">亲自试一试</a></p>
</div>
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_breakout">跳出框架</a></dt>
<dt><a href="/tiy/t.asp?f=hdom_window_resizeby">调整窗口的尺寸</a></dt>
<dt><a href="/tiy/t.asp?f=hdom_window_resizeto">把窗口调整为指定的尺寸</a></dt>
</dl>
</div>
