...
<p><a href="/jsref/dom_obj_hidden.asp" title="HTML DOM Hidden 对象">HTML DOM Hidden 对象</a></p>
</div>

<div>
<h2>定义和用法</h2>
<p>value 属性可设置或返回隐藏输入域的 value 属性的值。</p>
<p>value 属性定义了该隐藏域的默认值。</p>

<h3>语法</h3>
<pre>hiddenObject.value</pre>
</div>
...
function alertValue()
  {
  alert(<code>document.getElementById(&quot;hidden1&quot;).value</code>)
  }
&lt;/script&gt;
&lt;/head&gt;
&lt;body&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_hidden_value">取得隐藏域的值</a></dt>
</dl>
</div>
