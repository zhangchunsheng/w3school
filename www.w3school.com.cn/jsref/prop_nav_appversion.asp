...
<title>HTML DOM appVersion 属性</title>
...
<div>
<h2>定义和用法</h2>
<p>appVersion 属性可返回浏览器的平台和版本信息。该属性是一个只读的字符串。</p>
<p>该字符串的第一部分是版本号。把该字符串传递给 parseInt() 只能获取主版本号。该属性的其余部分提供了有关浏览器版本的其他细节，包括运行它的操作系统的信息。</p>
...
<div>
<h2>提示和注释</h2>
<p class="note"><span>注释：</span>不同浏览器提供的信息的格式是不同的。</p>
</div>
...
document.write(<code>navigator.appVersion</code> + &quot;&lt;/p&gt;&quot;)
&lt;/script&gt;
&lt;/body&gt;
