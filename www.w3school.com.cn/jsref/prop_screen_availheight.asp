...
<title>HTML DOM availHeight 属性</title>
...
<h1>HTML DOM availHeight 属性</h1>

<div class="backtoreference">
<p><a href="/jsref/dom_obj_screen.asp">HTML DOM Screen 对象</a></p>
</div>

<div>
<h2>定义和用法</h2>
<p>availHeight 属性声明了显示浏览器的屏幕的可用高度，以像素计。在 Windows 这样的操作系统中，这个可用高度不包括分配给半永久特性（如屏幕底部的任务栏）的垂直空间。</p>

<h3>语法</h3>
<pre>screen.availHeight</pre>
</div>
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_browsermonitor">检测有关客户机的屏幕的细节</a></dt>
</dl>
</div>
