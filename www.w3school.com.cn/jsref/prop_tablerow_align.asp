...
<div>
<h2>定义和用法</h2>
<p>align 属性可设置或返回数据在行中的水平对齐方式。</p>

<h3>语法</h3>
<pre>tablerowObject.align=left|center|right|justify|char</pre>
</div>

<div>
<h2>实例</h2>
<p>下面的例子更改了数据在行中的水平对齐方式：</p>
<pre>&lt;html&gt;
&lt;head&gt;
&lt;script type=&quot;text/javascript&quot;&gt;
function leftAlign()
  {
  <code>document.getElementById('header').align=&quot;left&quot;;</code>
  }
&lt;/script&gt;
&lt;/head&gt;
&lt;body&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_tablerow_align">对齐行中的单元格内容</a></dt>
</dl>
</div>
