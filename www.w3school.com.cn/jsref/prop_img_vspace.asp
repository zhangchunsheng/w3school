...
<title>HTML DOM vspace 属性</title>
...
<div>
<h2>定义和用法</h2>
<p>vspace 属性设置或返回图像的顶部和底部的空白。</p>
<p>Thspace 和 vspace 属性可与 align 一同使用，来设置图像与周围文本的距离。</p>

<h3>语法</h3>
<pre>imageObject.vspace=pixels</pre>
</div>
