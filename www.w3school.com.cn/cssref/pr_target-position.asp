...
<title>CSS3 target-position 属性</title>
...
<p>在新窗口中打开超链接，并在所有其他标签页/窗口之前放置新的窗口：</p>
...
<p>target-position 属性规定在何处放置新的目的地链接。</p>

<p class="note"><span>注释：</span>target-position 属性只有在 <a href="/cssref/pr_target-name.asp" title="CSS3 target-name 属性">target-name</a> 属性创建新标签页或新窗口时有效。</p>

<table class="dataintable">
  <tr>
    <th style="width:25%;">默认值：</th>
    <td style="width:75%;">above</td>
  </tr>
  <tr>
    <th>继承性：</th>
    <td>no</td>
  ...
  <tr>
    <th>JavaScript 语法：</th>
    <td><i>object</i>.style.targetPosition=&quot;front&quot;</td>
  </tr>
</table>
</div>
...
<pre>target-position: above|behind|front|back;</pre>
...
<tr>
<td>above</td>
<td>在当前标签页/窗口之前放置新的目的地标签页/窗口。</td>
</tr>

<tr>
<td>behind</td>
<td>在当前标签页/窗口之后放置新的目的地标签页/窗口。</td>
</tr>

<tr>
<td>front</td>
<td>在所有其他标签页/窗口之前放置新的目的地标签页/窗口。</td>
</tr>

<tr>
<td>back</td>
<td>在所有其他标签页/窗口之后放置新的目的地标签页/窗口。</td>
</tr>
</table>
</div>
