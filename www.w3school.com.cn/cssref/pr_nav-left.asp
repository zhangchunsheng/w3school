...
<p>nav-left 属性规定当使用 nav-left 导航键时，向何处进行导航。</p>
...
<pre>nav-left: auto|<i>id</i>|<i>target-name</i>|inherit;</pre>
