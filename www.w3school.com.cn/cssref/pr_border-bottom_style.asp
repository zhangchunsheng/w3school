...
<title>CSS border-bottom-style 属性</title>
...
<h1>CSS border-bottom-style 属性</h1>
...
<p>border-bottom-style 设置元素下边框的样式。</p>
...
<table class="dataintable">
  ...
  <tr>
    <th>JavaScript 语法：</th>
    <td><i>object</i>.style.borderBottomStyle=&quot;dotted&quot;</td>
  </tr>
</table>
</div>
...
p
  {
  border-style:solid;
  <code>border-bottom-style:dotted;</code>
  }
</pre>

<p><a href="/tiy/t.asp?f=csse_border-bottom-style">TIY</a></p>
</div>
...
<p>所有浏览器都支持 border-bottom-style 属性。</p>
...
<p>HTML DOM 参考手册：<a href="/jsref/prop_style_borderbottomstyle.asp" title="HTML DOM borderBottomStyle 属性">borderBottomStyle 属性</a></p>
</div>
