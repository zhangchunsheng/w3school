...
<table class="dataintable">
  <tr>
    ...
    <td style="width:75%;">invert none medium</td>
  </tr>
  <tr>
    <th>继承性：</th>
    <td>no</td>
  ...
  <tr>
    <th>JavaScript 语法：</th>
    <td><i>object</i>.style.outline=&quot;#0000FF dotted thin&quot;</td>
  </tr>
</table>
</div>
...
p
  {
  <code>outline:#00FF00 dotted thick;</code>
  }
</pre>

<p><a href="/tiy/t.asp?f=csse_outline">TIY</a></p>
</div>
...
<td>规定边框的颜色。参阅：<a href="pr_outline-color.asp" title="CSS outline-color 属性">outline-color</a> 中可能的值。</td>
</tr>

<tr>
<td><i>outline-style</i></td>
<td>规定边框的样式。参阅：<a href="pr_outline-style.asp" title="CSS outline-style 属性">outline-style</a> 中可能的值。</td>
</tr>

<tr>
<td><i>outline-width</i></td>
<td>规定边框的宽度。参阅：<a href="pr_outline-width.asp" title="CSS outline-width 属性">outline-width</a> 中可能的值。</td>
</tr>
...
<dd>本例演示使用 outline 属性在元素周围画一条线。</dd>
</dl>
</div>
...
<p>HTML DOM 参考手册：<a href="/jsref/prop_style_outline.asp" title="HTML DOM outline 属性">outline 属性</a></p>
</div>
