...
<p>:lang 伪类向带有指定 lang 属性的元素添加样式。</p>

<h3>说明</h3>

<p>:lang 伪类根据元素的语言编码匹配元素。这种语言信息必须包含在文档中，或者与文档关联，不能从 CSS 指定。:lang 的处理与 |= 选择器相同。</p>
</div>
...
<p>:lang 伪类允许您为不同的语言定义特殊的规则。在下面的例子中，:lang 类为带有值为 &quot;no&quot; 的 lang 属性的 q 元素定义引号的类型：</p>
...
<p><a href="/tiy/t.asp?f=csse_lang">TIY</a></p>
</div>
...
<p>所有主流浏览器都支持 :lang 伪类。</p>

<p class="note"><span>注释：</span>如果已规定 !DOCTYPE，那么 Internet Explorer 8 （以及更高版本）支持 :lang 伪类。</p>
</div>
...
<dl>
<dt><a href="/tiy/t.asp?f=csse_lang">:lang</a></dt>
