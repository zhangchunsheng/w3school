...
<p><a target="_blank" href="/tiy/t.asp?f=css3_opacity">亲自试一试</a></p>
...
<p>所有浏览器都支持 opacity 属性。</p>

<p class="note"><span>注释：</span>IE8 以及更早的版本支持替代的 filter 属性。例如：filter:Alpha(opacity=50)。</p>
</div>
...
<table class="dataintable">
  ...
  <tr>
    <th>JavaScript 语法：</th>
    <td><i>object</i>.style.opacity=0.5</td>
  </tr>
</table>
</div>
...
<pre>opacity: <i>value</i>|inherit;</pre>
...
<td><a target="_blank" href="/tiy/c.asp?f=css_opacity">测试</a></td>
</tr>
...
<dl>
<dt><a target="_blank" href="/tiy/t.asp?f=css3_opacity_js">改变元素的不透明度</a></dt>
<dd>本例演示如何使用 JavaScript 来改变元素的不透明度。</dd>
</dl>
</div>
...
<p>CSS 教程：<a href="/css/css_image_transparency.asp" title="CSS 图像透明度">CSS 图像透明度</a></p>
</div>
