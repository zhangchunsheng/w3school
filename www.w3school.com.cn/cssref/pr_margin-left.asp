...
<title>CSS margin-left 属性</title>
...
<table class="dataintable">
  ...
  <tr>
    <th>JavaScript 语法：</th>
    <td><i>object</i>.style.marginLeft=&quot;10px&quot;</td>
  </tr>
</table>
</div>
...
p
  {
  <code>margin-left:2cm;</code>
  }
</pre>

<p><a href="/tiy/t.asp?f=csse_margin-left">TIY</a> （在页面底部可以找到更多实例）</p>
</div>
...
<tr>
<td><i>length</i></td>
<td>定义固定的左外边距。默认值是0。</td>
</tr>

<tr>
<td><i>%</i></td>
<td>定义基于父对象总高度的百分比左外边距。</td>
</tr>

<tr>
<td>inherit</td>
<td>规定应该从父元素继承左外边距。</td>
</tr>
</table>
</div>
...
<dl>
<dt><a href="/tiy/t.asp?f=csse_margin-left">设置文本的左外边距 1</a></dt>
<dd>本例演示如何使用厘米值来设置文本的左边距。</dd>
<dt><a href="/tiy/t.asp?f=csse_margin-left_percent">设置文本的左外边距 2</a></dt>
<dd>本例演示如何使用百分比值来设置文本的左边距。</dd>
</dl>
</div>
...
<p>HTML DOM 参考手册：<a href="/jsref/prop_style_marginleft.asp" title="HTML DOM marginLeft 属性">marginLeft 属性</a></p>
</div>
