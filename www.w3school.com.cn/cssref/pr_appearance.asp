...
<title>CSS3 appearance 属性</title>
...
<p>使 div 元素看上去像一个按钮：</p>

<pre>
div
{
appearance:button;
-moz-appearance:button; <span class="code_comment">/* Firefox */</span>
-webkit-appearance:button; <span class="code_comment">/* Safari 和 Chrome */</span>
}
</pre>

<p><a target="_blank" href="/tiy/t.asp?f=css3_appearance">亲自试一试</a></p>
...
<p>appearance 属性允许您使元素看上去像标准的用户界面元素。</p>
...
<pre>appearance: normal|icon|window|button|menu|field;</pre>
