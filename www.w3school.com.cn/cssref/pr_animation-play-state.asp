...
<h1>CSS3 animation-play-state 属性</h1>
...
-webkit-animation-play-state:paused; <span class="code_comment">/* Safari 和 Chrome */</span>
}
</pre>

<p><a target="_blank" href="/tiy/t.asp?f=css3_animation-play-state">亲自试一试</a></p>
</div>
...
<p>Internet Explorer 10、Firefox 以及 Opera 支持 animation-play-state 属性。</p>

<p>Safari 和 Chrome 支持替代的 -webkit-animation-play-state 属性。</p>

<p class="note"><span>注释：</span>Internet Explorer 9 以及更早的版本不支持 animation-play-state 属性。</p>
</div>
...
<p class="note"><span>注释：</span>您可以在 JavaScript 中使用该属性，这样就能在播放过程中暂停动画。</p>

<table class="dataintable">
  <tr>
    <th style="width:25%;">默认值：</th>
    <td style="width:75%;">running</td>
  </tr>
  <tr>
    <th>继承性：</th>
    <td>no</td>
  ...
  <tr>
    <th>JavaScript 语法：</th>
    <td><i>object</i>.style.animationPlayState=&quot;paused&quot;</td>
  </tr>
</table>
</div>
...
<td>paused</td>
<td>规定动画已暂停。</td>
<td><a target="_blank" href="/tiy/c.asp?f=css_animation-play-state">测试</a></td>
</tr>

<tr>
<td>running</td>
<td>规定动画正在播放。</td>
<td><a target="_blank" href="/tiy/c.asp?f=css_animation-play-state&p=2">测试</a></td>
</tr>
</table>
</div>
