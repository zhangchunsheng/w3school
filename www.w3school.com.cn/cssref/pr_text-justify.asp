...
<title>CSS3 text-justify 属性</title>
...
<p><a target="_blank" href="/tiy/t.asp?f=css3_text-justify">亲自试一试</a></p>
</div>
...
<p>只有 Internet Explorer 支持 text-justify 属性。</p>
...
<p>text-justify 属性规定当 text-align 被设置为 text-align 时的齐行方法。</p>

<p>该属性规定如何对齐行文本进行对齐和分隔。</p>
...
<td>auto</td>
<td>浏览器决定齐行算法。</td>
<td><a target="_blank" href="/tiy/c.asp?f=css_text-justify">测试</a></td>
</tr>

<tr>
<td>none</td>
<td>禁用齐行。</td>
<td><a target="_blank" href="/tiy/c.asp?f=css_text-justify&p=2">测试</a></td>
</tr>

<tr>
<td>inter-word</td>
<td>增加/减少单词间的间隔。</td>
<td><a target="_blank" href="/tiy/c.asp?f=css_text-justify&p=3">测试</a></td>
</tr>

<tr>
<td>inter-ideograph</td>
<td>用表意文本来排齐内容。</td>
<td><a target="_blank" href="/tiy/c.asp?f=css_text-justify&p=4">测试</a></td>
</tr>

<tr>
<td>inter-cluster</td>
<td>只对不包含内部单词间隔的内容（比如亚洲语系）进行排齐。</td>
<td><a target="_blank" href="/tiy/c.asp?f=css_text-justify&p=5">测试</a></td>
</tr>

<tr>
<td>distribute</td>
<td>类似报纸版面，除了在东亚语系中最后一行是不齐行的。</td>
<td><a target="_blank" href="/tiy/c.asp?f=css_text-justify&p=6">测试</a></td>
</tr>

<tr>
<td>kashida</td>
<td>通过拉伸字符来排齐内容。</td>
<td><a target="_blank" href="/tiy/c.asp?f=css_text-justify&p=7">测试</a></td>
</tr>
</table>
</div>
