...
<title>CSS3 border-top-left-radius 属性</title>
...
<h1>CSS3 border-top-left-radius 属性</h1>
...
<p>向 div 元素的左上角添加圆角边框：</p>

<pre>
div
{
border:2px solid;
<code>border-top-left-radius:2em;</code>
}
</pre>

<p><a target="_blank" href="/tiy/t.asp?f=css3_border-top-left-radius">亲自试一试</a></p>
...
<p>IE9+、Firefox 4+、Chrome、Safari 5+ 以及 Opera 支持 border-top-left-radius 属性。</p>
</div>
...
<p>border-top-left-radius 属性定义左上角边框的形状。</p>
...
<table class="dataintable">
  ...
  <tr>
    <th>JavaScript 语法：</th>
    <td><i>object</i>.style.borderTopLeftRadius=&quot;5px&quot;</td>
  </tr>
</table>
</div>
...
<p class="note"><span>注释：</span>border-top-left-radius 属性的长度值和百分比值定义四分之一椭圆（定义外部边框边缘的边角形状）的半径（radii）。第一个值是水平半径，第二个值是垂直半径。如果省略第二个值，则复制第一个值。如果长度为零，则边角为方形，而不是圆形。水平半径的百分比值参考边框盒的宽度，而垂直半径的百分比值参考边框盒的高度。</p>
...
<td><i>length</i></td>
<td>定义左下角的形状。</td>
<td><a target="_blank" href="/tiy/c.asp?f=css_border-top-left-radius">测试</a></td>
</tr>

<tr>
<td><i>%</i></td>
<td>以百分比值定义左下角的形状。</td>
<td><a target="_blank" href="/tiy/c.asp?f=css_border-top-left-radius&p=6">测试</a></td>
</tr>
</table>
</div>
