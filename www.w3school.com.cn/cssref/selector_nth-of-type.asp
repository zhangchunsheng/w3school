...
<title>CSS3 :nth-of-type() 选择器</title>
...
<p>规定属于其父元素的第二个 p 元素的每个 p：</p>

<pre>
<code>p:nth-of-type(2)</code>
{
background:#ff0000;
}
</pre>

<p><a target="_blank" href="/tiy/t.asp?f=css_sel_nth-of-type">亲自试一试</a></p>
</div>
...
<p>:nth-of-type(<i>n</i>) 选择器匹配属于父元素的特定类型的第 N 个子元素的每个元素.</p>

<p><i>n</i> 可以是数字、关键词或公式。</p>

<p class="tip"><span>提示：</span>请参阅 <a href="/cssref/selector_nth-child.asp" title="CSS :nth-child() 选择器">:nth-child()</a> 选择器，该选择器选取父元素的第 N 个子元素，<em>与类型无关</em>。</p>
</div>
...
<p>所有主流浏览器均支持 :nth-of-type() 选择器，除了 IE8 及更早的版本。</p>
</div>
...
<p>在这里，我们为奇数和偶数 p 元素指定两种不同的背景色：</p>

<pre>
<code>p:nth-of-type(odd)</code>
{
background:#ff0000;
}
<code>p:nth-of-type(even)</code>
{
background:#0000ff;
}
</pre>

<p><a target="_blank" href="/tiy/t.asp?f=css_sel_nth-of-type_odd_even">亲自试一试</a></p>

<h3>实例 2</h3>

<p>使用公式 (<i>an</i> + <i>b</i>)。描述：表示周期的长度，n 是计数器（从 0 开始），b 是偏移值。</p>

<p>在这里，我们指定了下标是 3 的倍数的所有 p 元素的背景色：</p>

<pre>
<code>p:nth-of-type(3n+0)</code>
{
background:#ff0000;
}
</pre>

<p><a target="_blank" href="/tiy/t.asp?f=css_sel_nth-of-type_formula">亲自试一试</a></p>
</div>
