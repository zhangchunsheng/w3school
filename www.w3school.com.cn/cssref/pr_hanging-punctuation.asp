...
<title>CSS3 hanging-punctuation 属性</title>
...
<h1>CSS3 hanging-punctuation 属性</h1>
...
<p>在 p 元素首行的开始边缘之外放置一个标点符号：</p>

<pre>
p
{
<code>hanging-punctuation:first;</code>
}
</pre>
...
<p>目前主流浏览器都不支持 hanging-punctuation 属性。</p>
...
<p>hanging-punctuation 属性规定把标点符号放在文本整行的开头还是结尾的行框之外。</p>
...
<pre>hanging-punctuation: none|first|last|allow-end|force-end;</pre>
...
<tr>
<td>none</td>
<td>不在文本整行的开头还是结尾的行框之外放置标签符号。</td>
</tr>
