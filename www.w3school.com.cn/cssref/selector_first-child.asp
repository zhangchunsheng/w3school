...
<title>CSS :first-child 选择器</title>
...
<p>选择属于其父元素的首个子元素的每个 &lt;p&gt; 元素，并为其设置样式：</p>
...
<p><a target="_blank" href="/tiy/t.asp?f=css_sel_firstchild">亲自试一试</a></p>
</div>
...
<p>所有主流浏览器都支持 :first-child 选择器。</p>

<p class="note"><span>注释：</span>对于 IE8 及更早版本的浏览器中的 :first-child，必须声明 <a href="/tags/tag_doctype.asp" title="HTML &lt;!DOCTYPE&gt; 标签">&lt;!DOCTYPE&gt;</a>。</p>
</div>
...
<p>:first-child 选择器用于选取属于其父元素的首个子元素的指定选择器。</p>
</div>
...
<p>选择每个 &lt;p&gt; 中的每个 &lt;i&gt; 元素并设置其样式，其中的 &lt;p&gt; 元素是其父元素的第一个子元素：</p>
...
<p><a target="_blank" href="/tiy/t.asp?f=css_sel_firstchild_2">亲自试一试</a></p>

<h3>例子 2</h3>

<p>选择列表中的第一个 &lt;li&gt; 元素并设置其样式：</p>

<pre>
<code>li:first-child</code>
{
background:yellow;
}
</pre>

<p><a target="_blank" href="/tiy/t.asp?f=css_sel_firstchild_3">亲自试一试</a></p>

<h3>例子 3</h3>

<p>设置每个 &lt;ul&gt; 的首个子元素，并设置其样式：</p>
...
<p><a target="_blank" href="/tiy/t.asp?f=css_sel_firstchild_4">亲自试一试</a></p>
</div>
