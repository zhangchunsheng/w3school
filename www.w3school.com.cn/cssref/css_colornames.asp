...
<li class="currentLink"><a href="/cssref/css_colornames.asp" title="CSS 颜色名">CSS 颜色名</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/cssref/css_colors_legal.asp" title="CSS 合法颜色值">CSS 颜色值</a></li>
<li class="next"><a href="/cssref/css_colorsfull.asp" title="CSS 颜色十六进制值">CSS 颜色十六进制</a></li>
</ul>
</div>
...
<p>HTML 和 CSS 颜色规范中定义了 147 中颜色名（17 种标准颜色加 130 种其他颜色）。下面的表格中列出了所有这些颜色，以及它们的十六进制值。</p>

<p class="tip"><span>提示：</span>17 种标准色是 aqua, black, blue, fuchsia, gray, green, lime, maroon, navy, olive, orange, purple, red, silver, teal, white, yellow。</p>

<p>点击颜色名（或十六进制值）来查看这种颜色作为背景色搭配不同的文本颜色：</p>
</div>
...
<p><a href="/cssref/css_colorsfull.asp" title="CSS 颜色十六进制值">根据十六进制值排序的相同列表</a></p>
