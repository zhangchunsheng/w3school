...
<title>CSS3 border-image-outset 属性</title>
...
<h1>CSS3 border-image-outset 属性</h1>
...
<p>设置 border-image-outset 属性：</p>

<pre>
div
{
border-image-source: url(border.png);
<code>border-image-outset: 30 30;</code>
}
</pre>
...
<p>目前主流浏览器都不支持 border-image-outset 属性。</p>

<p>请参阅 <a href="/cssref/pr_border-image.asp" title="CSS3 border-image 属性">border-image</a> 属性。</p>
</div>
...
<p>border-image-outset 属性规定边框图像超过边框盒的量。</p>
...
<table class="dataintable">
  ...
  <tr>
    <th>JavaScript 语法：</th>
    <td><i>object</i>.style.borderImageOutset=&quot;30 30&quot;</td>
  </tr>
</table>
</div>
...
<pre>border-image-outset: <i>length</i>|<i>number</i>;</pre>

<p class="note"><span>注释：</span>border-image-outset 属性规定边框图像超出边框盒的量。在上、右、下、左侧。如果忽略第四个值，则与第二个值相同。如果省略第三个值，则与第一个值相同。如果省略第二个值，则与第一个值相同。不允许任何负值作为 border-image-outset 值。</p>
