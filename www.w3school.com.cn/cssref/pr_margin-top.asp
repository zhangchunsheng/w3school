...
<table class="dataintable">
  ...
  <tr>
    <th>JavaScript 语法：</th>
    <td><i>object</i>.style.marginTop=&quot;10px&quot;</td>
  </tr>
</table>
</div>
...
p
  {
  <code>margin-top:2cm;</code>
  }
</pre>

<p><a href="/tiy/t.asp?f=csse_margin-top">TIY</a> （在页面底部可以找到更多实例）</p>
</div>
...
<tr>
<td><i>%</i></td>
<td>定义基于父对象总高度的百分比上外边距。</td>
</tr>

<tr>
<td>inherit</td>
<td>规定应该从父元素继承上外边距。</td>
</tr>
</table>
</div>
...
<dl>
<dt><a href="/tiy/t.asp?f=csse_margin-top">设置文本的上外边距 1</a></dt>
<dd>本例演示如何使用厘米值来设置文本的顶边距。</dd>

<dt><a href="/tiy/t.asp?f=csse_margin-top_percent">设置文本的上外边距 2</a></dt>
<dd>本例演示如何使用百分比值来设置文本的顶边距。</dd>
</dl>
</div>
...
<p>HTML DOM 参考手册：<a href="/jsref/prop_style_margintop.asp" title="HTML DOM marginTop 属性">marginTop 属性</a></p>
</div>
