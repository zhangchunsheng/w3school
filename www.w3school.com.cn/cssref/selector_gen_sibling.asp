...
<title>CSS3 element1~element2 选择器</title>
...
<h1>CSS3 <i>element1</i>~<i>element2</i> 选择器</h1>
...
<p>为所有相同的父元素中位于 p 元素之后的所有 ul 元素设置背景：</p>
...
<p><a target="_blank" href="/tiy/t.asp?f=css_sel_sibling">亲自试一试</a></p>
</div>
...
<p>所有主流浏览器都支持 <i>element1</i>~<i>element2</i> 选择器。</p>

<p class="note"><span>注释：</span>对于 IE8 中的该选择器，必须声明 <a href="/tags/tag_doctype.asp" title="HTML &lt;!DOCTYPE&gt; 标签">&lt;!DOCTYPE&gt;</a>。</p>
</div>
...
<p><i>element1</i>~<i>element2</i> 选择器 <i>element1</i> 之后出现的所有 <i>element2</i>。</p>

<p>两种元素必须拥有相同的父元素，但是 <i>element2</i> 不必直接紧随 <i>element1</i>。</p>
</div>
