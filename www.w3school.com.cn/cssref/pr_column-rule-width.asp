...
<title>CSS3 column-rule-width 属性</title>
...
<h1>CSS3 column-rule-width 属性</h1>
...
div
{
-moz-column-rule-width:1px; <span class="code_comment">/* Firefox */</span>
-webkit-column-rule-width:1px; <span class="code_comment">/* Safari 和 Chrome */</span>
column-rule-width:1px;
}
</pre>

<p><a target="_blank" href="/tiy/t.asp?f=css3_column-rule-width">亲自试一试</a></p>
...
<p>Internet Explorer 10 和 Opera 支持 column-rule-width 属性。</p>

<p>Firefox 支持替代的 -moz-column-rule-width 属性。</p>

<p>Safari 和 Chrome 支持替代的 -webkit-column-rule-width 属性。</p>

<p class="note"><span>注释：</span>Internet Explorer 9 以及更早版本的浏览器不支持 column-rule-width 属性。</p>
</div>
...
<p>column-rule-width 属性规定列之间的宽度规则。</p>
...
<table class="dataintable">
  ...
  <tr>
    <th>JavaScript 语法：</th>
    <td><i>object</i>.style.columnRuleWidth=&quot;thin&quot;</td>
  </tr>
</table>
</div>
...
<pre>column-rule-width: thin|medium|thick|<i>length</i>;</pre>
...
<td>thin</td>
<td>定义纤细规则。</td>
<td><a target="_blank" href="/tiy/c.asp?f=css_column-rule-width">测试</a></td>
</tr>

<tr>
<td>medium</td>
<td>定义中等规则。</td>
<td><a target="_blank" href="/tiy/c.asp?f=css_column-rule-width&p=2">测试</a></td>
</tr>

<tr>
<td>thick</td>
<td>定义宽厚规则。</td>
<td><a target="_blank" href="/tiy/c.asp?f=css_column-rule-width&p=3">测试</a></td>
</tr>

<tr>
<td><i>length</i></td>
<td>规定规则的宽度。</td>
<td><a target="_blank" href="/tiy/c.asp?f=css_column-rule-width&p=4">测试</a></td>
</tr>
</table>
</div>
