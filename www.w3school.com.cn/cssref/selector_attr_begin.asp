...
<p><a target="_blank" href="/tiy/t.asp?f=css_sel_attr_begin">亲自试一试</a></p>
</div>
...
<p>[<i>attribute</i>^=<i>value</i>] 选择器匹配属性值以指定值开头的每个元素。</p>
</div>
...
<p>设置 class 属性值以 &quot;test&quot; 开头的所有元素的背景色：</p>
...
<p><a target="_blank" href="/tiy/t.asp?f=css_sel_attr_begin2">亲自试一试</a></p>
</div>
