...
<title>CSS3 ::selection 选择器</title>
...
<code>::-moz-selection</code>
{
color:#ff0000;
}
</pre>

<p><a target="_blank" href="/tiy/t.asp?f=css_sel_selection">亲自试一试</a></p>
</div>
...
<p>::selection 选择器匹配被用户选取的选取是部分。</p>

<p>只能向 ::selection 选择器应用少量 CSS 属性：color、background、cursor 以及 outline。</p>
</div>
...
<p>IE9+、Opera、Google Chrome 以及 Safari 中支持 ::selection 选择器。</p>

<p>Firefox 支持替代的 ::-moz-selection。</p>
</div>
