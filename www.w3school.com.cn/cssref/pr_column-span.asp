...
<title>CSS3 column-span 属性</title>
...
h2
{
-webkit-column-span:all; <span class="code_comment">/* Chrome */</span>
column-span:all;
}
</pre>

<p><a target="_blank" href="/tiy/t.asp?f=css3_column-span">亲自试一试</a></p>
...
<p>Internet Explorer 10 和 Opera 支持 column-span 属性。</p>

<p>Safari 和 Chrome 支持替代的 -webkit-column-span 属性。</p>

<p class="note"><span>注释：</span>Internet Explorer 9 以及更早版本的浏览器不支持 column-span 属性。</p>
</div>
...
<table class="dataintable">
  ...
  <tr>
    <th>JavaScript 语法：</th>
    <td><i>object</i>.style.columnSpan=&quot;all&quot;</td>
  </tr>
</table>
</div>
...
<td>1</td>
<td>元素应横跨一列。</td>
<td><a target="_blank" href="/tiy/c.asp?f=css_column-span">测试</a></td>
</tr>

<tr>
<td>all</td>
<td>元素应横跨所有列。</td>
<td><a target="_blank" href="/tiy/c.asp?f=css_column-span&p=2">测试</a></td>
</tr>
</table>
</div>
