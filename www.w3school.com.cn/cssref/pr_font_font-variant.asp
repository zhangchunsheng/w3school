...
<title>CSS font-variant 属性</title>
...
<h3>说明</h3>
<p>该属性主要用于定义小型大写字母文本。理论上，用户代理可以根据正常字体计算出小型大写字母字体。</p>
...
<table class="dataintable">
  ...
  <tr>
    <th>JavaScript 语法：</th>
    <td><i>object</i>.style.fontVariant=&quot;small-caps&quot;</td>
  </tr>
</table>
</div>
...
<p><a href="/tiy/t.asp?f=csse_font-variant">TIY</a></p>
</div>


<div>
<h2>浏览器支持</h2>
<p>所有主流浏览器都支持 font-variant 属性。</p>
...
<p>HTML DOM 参考手册：<a href="/jsref/prop_style_fontvariant.asp" title="HTML DOM fontVariant 属性">fontVariant 属性</a></p>
</div>
