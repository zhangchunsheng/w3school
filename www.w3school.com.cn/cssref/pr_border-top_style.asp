...
<title>CSS border-top-style 属性</title>
...
<p>border-top-style 设置元素上边框的样式。</p>
...
<table class="dataintable">
  ...
  <tr>
    <th>JavaScript 语法：</th>
    <td><i>object</i>.style.borderTopStyle=&quot;dotted&quot;</td>
  </tr>
</table>
</div>
...
p
  {
  border-style:solid;
  <code>border-top-style:dotted;</code>
  }
</pre>

<p><a href="/tiy/t.asp?f=csse_border-top-style">TIY</a></p>
</div>
...
<p>所有浏览器都支持 border-top-style 属性。</p>
...
<p>HTML DOM 参考手册：<a href="/jsref/prop_style_bordertopstyle.asp" title="HTML DOM borderTopStyle 属性">borderTopStyle 属性</a></p>
</div>
