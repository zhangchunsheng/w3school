...
<p>icon 属性为创作者提供了将元素设置为图标等价物的能力。</p>

<p class="note"><span>注释：</span>除非 &quot;content&quot; 属性的值被设置为 &quot;icon&quot;，否则元素的图标不会被使用。</p>
...
<pre>icon: auto|<i>URL</i>|inherit;</pre>
...
<tr>
<td>auto</td>
<td>使用由浏览器提供的默认通用图标。</td>
</tr>

<tr>
<td><i>URL</i></td>
<td>引用列表中的一个或多个图标，列表用逗号分隔。</td>
</tr>

<tr>
<td>inherit</td>
<td>规定应从元素继承 icon 属性的值。</td>
</tr>
</table>
</div>
