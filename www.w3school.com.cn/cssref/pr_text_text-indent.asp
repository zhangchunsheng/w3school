...
<title>CSS text-indent 属性</title>
...
<div>
<h2>定义</h2>
<p>text-indent 属性规定文本块中首行文本的缩进。</p>
<p class="note"><span>注释：</span>允许使用负值。如果使用负值，那么首行会被缩进到左边。</p>
<p class="important"><span>注意：</span>在 CSS 2.1 之前，text-indent 总是继承计算值，而不是声明值。</p>

<h3>说明</h3>
<p>用于定义块级元素中第一个内容行的缩进。这最常用于建立一个“标签页”效果。允许指定负值，这会产生一种“悬挂缩进”的效果。</p>
...
<table class="dataintable">
  ...
  <tr>
    <th>JavaScript 语法：</th>
    <td><i>object</i>.style.textIndent=&quot;50px&quot;</td>
  </tr>
</table>
</div>
...
p
  {
  <code>text-indent:50px;</code>
  }
</pre>
<p><a href="/tiy/t.asp?f=csse_text-indent">TIY</a></p>
</div>


<div>
<h2>浏览器支持</h2>
<p>所有浏览器都支持 text-indent 属性。</p>
...
<h2>TIY 实例</h2>
<dl>
<dt><a href="/tiy/t.asp?f=csse_text-indent">缩进文本</a></dt>
<dd>本例演示如何缩进文本首行。</dd>
</dl>
</div>
...
<p>HTML DOM 参考手册：<a href="/jsref/prop_style_textindent.asp" title="HTML DOM textIndent 属性">textIndent 属性</a></p>
</div>
