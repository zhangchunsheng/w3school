...
<title>CSS3 column-rule-color 属性</title>
...
<h1>CSS3 column-rule-color 属性</h1>
...
div
{
-moz-column-rule-color:#ff0000; <span class="code_comment">/* Firefox */</span>
-webkit-column-rule-color:#ff0000; <span class="code_comment">/* Safari 和 Chrome */</span>
column-rule-color:#ff0000;
}
</pre>

<p><a target="_blank" href="/tiy/t.asp?f=css3_column-rule-color">亲自试一试</a></p>
...
<p>Internet Explorer 10 和 Opera 支持 column-rule-color 属性。</p>

<p>Firefox 支持替代的 -moz-column-rule-color 属性。</p>

<p>Safari 和 Chrome 支持替代的 -webkit-column-rule-color 属性。</p>

<p class="note"><span>注释：</span>Internet Explorer 9 以及更早版本的浏览器不支持 column-rule-color 属性。</p>
</div>
...
<p>column-rule-color 属性规定列之间的颜色规则。</p>
...
<table class="dataintable">
  ...
  <tr>
    <th>JavaScript 语法：</th>
    <td><i>object</i>.style.columnRuleColor=&quot;#ff00ff&quot;</td>
  </tr>
</table>
</div>
...
<pre>column-rule-color: <i>color</i>;</pre>
...
<tr>
<td><i>color</i></td>
<td>规定颜色规则。请参阅 <a href="/cssref/css_colors_legal.asp" title="CSS 合法颜色值">CSS 颜色值</a>。</td>
</tr>
</table>
</div>
