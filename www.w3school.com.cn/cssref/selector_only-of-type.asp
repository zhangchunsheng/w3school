...
<title>CSS3 :only-of-type 选择器</title>
...
<p>指定属于父元素的特定类型的唯一子元素的每个 p 元素：</p>

<pre>
<code>p:only-of-type</code>
{
background:#ff0000;
}
</pre>

<p><a target="_blank" href="/tiy/t.asp?f=css_sel_only-of-type">亲自试一试</a></p>
</div>
...
<p>所有主流浏览器均支持 :only-of-type 选择器，除了 IE8 及更早的版本。</p>
</div>
...
<p>:only-of-type 选择器匹配属于其父元素的特定类型的唯一子元素的每个元素。</p>
</div>
