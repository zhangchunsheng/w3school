...
<title>CSS text-decoration 属性</title>
...
<div>
<h2>定义和用法</h2>
<p>text-decoration 属性规定添加到文本的修饰。</p>
<p class="note"><span>注释：</span>修饰的颜色由 &quot;color&quot; 属性设置。</p>

<h3>说明</h3>
<p>这个属性允许对文本设置某种效果，如加下划线。如果后代元素没有自己的装饰，祖先元素上设置的装饰会“延伸”到后代元素中。不要求用户代理支持 blink。</p>
...
<table class="dataintable">
  ...
  <tr>
    <th>JavaScript 语法：</th>
    <td><i>object</i>.style.textDecoration=&quot;overline&quot;</td>
  </tr>
</table>
</div>
...
<div>
<h2>实例</h2>
<p>设置 h1、h2、h3、h4 元素的文本修饰：</p>
<pre>
h1 {<code>text-decoration:overline</code>}
h2 {<code>text-decoration:line-through</code>}
h3 {<code>text-decoration:underline</code>}
h4 {<code>text-decoration:blink</code>}
</pre>
<p><a href="/tiy/t.asp?f=csse_text-decoration">TIY</a></p>
</div>


<div>
<h2>浏览器支持</h2>
<p>所有主流浏览器都支持 text-decoration 属性。</p>
<p class="note"><span>注释：</span>任何的版本的 Internet Explorer （包括 IE8）都不支持属性值 &quot;inherit&quot;。</p>
<p class="note"><span>注释：</span>IE、Chrome 或 Safari 不支持 &quot;blink&quot; 属性值。</p>
</div>
...
<p>HTML DOM 参考手册：<a href="/jsref/prop_style_textdecoration.asp" title="HTML DOM textDecoration 属性">textDecoration 属性</a></p>
</div>
