...
<p>list-style 简写属性在一个声明中设置所有的列表属性。</p>

<h3>说明</h3>

<p>该属性是一个简写属性，涵盖了所有其他列表样式属性。由于它应用到所有 display 为 list-item 的元素，所以在普通的 HTML 和 XHTML 中只能用于 li 元素，不过实际上它可以应用到任何元素，并由 list-item 元素继承。</p>
...
<p>可以不设置其中的某个值，比如 &quot;list-style:circle inside;&quot; 也是允许的。未设置的属性会使用其默认值。</p>
...
<p><a href="/tiy/t.asp?f=csse_list-style">TIY</a></p>
</div>
...
<td>设置列表项标记的类型。参阅：<a href="/cssref/pr_list-style-type.asp" title="CSS list-style-type 属性">list-style-type</a> 中可能的值。</td>
</tr>

<tr>
<td><i>list-style-position</i></td>
<td>设置在何处放置列表项标记。参阅：<a href="/cssref/pr_list-style-position.asp" title="CSS list-style-position 属性">list-style-position</a> 中可能的值。</td>
</tr>

<tr>
<td><i>list-style-image</i></td>
<td>使用图像来替换列表项的标记。参阅：<a href="/cssref/pr_list-style-image.asp" title="CSS list-style-image 属性">list-style-image</a> 中可能的值。</td>
</tr>

<tr>
<td>inherit</td>
<td>规定应该从父元素继承 list-style 属性的值。</td>
</tr>
</table>
</div>
...
<p>HTML DOM 参考手册：<a href="/jsref/prop_style_liststyle.asp" title="HTML DOM listStyle 属性">listStyle 属性</a></p>
</div>
