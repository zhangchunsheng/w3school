...
<p>选择 lang 属性值以 &quot;en&quot; 开头的元素，并设置其样式：</p>
...
<p><a target="_blank" href="/tiy/t.asp?f=css_sel_attribute_value_lang">亲自试一试</a></p>
</div>
...
<p class="note"><span>注释：</span>对于 IE8 及更早版本的浏览器中的 [<i>attribute</i>|=<i>value</i>]，必须声明 <a href="/tags/tag_doctype.asp" title="HTML &lt;!DOCTYPE&gt; 标签">&lt;!DOCTYPE&gt;</a>。</p>
</div>
...
<p>[<i>attribute</i>|=<i>value</i>] 选择器用于选取带有以指定值开头的属性值的元素。</p>

<p class="note"><span>注释：</span>该值必须是整个单词，比如 lang=&quot;en&quot;，或者后面跟着连字符，比如 lang=&quot;en-us&quot;。</p>
</div>
...
<p>选择其 class 属性值以 &quot;top&quot; 开头的元素，并设置其样式：</p>
...
<p><a target="_blank" href="/tiy/t.asp?f=css_sel_attribute_value_hyphen">亲自试一试</a></p>
</div>
