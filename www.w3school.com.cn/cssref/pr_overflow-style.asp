...
<title>CSS3 overflow-style 属性</title>
...
{
overflow:auto;
<code>overflow-style:marquee,panner;</code>
}
</pre>

<p><a target="_blank" href="/tiy/t.asp?f=css3_overflow-style">亲自试一试</a></p>
</div>
...
<p>目前没有浏览器支持 overflow-style 属性。</p>
</div>
...
<p>overflow-style 规定溢出元素的首选滚动方法。</p>
...
<table class="dataintable">
  ...
  <tr>
    <th>JavaScript 语法：</th>
    <td><i>object</i>.style.overflowStyle=&quot;scrollbar&quot;</td>
  </tr>
</table>
</div>
...
<pre>overflow-style: auto|scrollbar|panner|move|marquee;</pre>

<p class="note"><span>注释：</span>值既可以是 auto，或者是按照优先次序的方法列表。浏览器应该使用列表中其支持的的第一个滚动方法。</p>
...
<tr>
<td>move</td>
<td>用户能够直接移动元素的内容。通常，用户能够用鼠标拖动内容。</td>
</tr>

<tr>
<td>marquee</td>
<td>内容自主移动，不需任何用户代理对其控制。</td>
</tr>
