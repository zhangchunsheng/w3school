...
<p>这个属性设置背景原图像（由 <a href="/cssref/pr_background-image.asp" title="CSS background-image 属性">background-image</a> 定义）的位置，背景图像如果要重复，将从这一点开始。</p>
...
<p><a href="/tiy/t.asp?f=csse_background-position">TIY</a></p>
</div>
...
<p>CSS 参考手册：<a href="/cssref/pr_background-image.asp" title="CSS background-image 属性">background-image 属性</a></p>
