...
<p>选择 &lt;div&gt; 元素之后紧跟的每个 &lt;p&gt; 元素，并设置其背景色：</p>
...
<p><a target="_blank" href="/tiy/t.asp?f=css_sel_element_plus">亲自试一试</a></p>
</div>
...
<p><i>element</i>+<i>element</i> 选择器用于选取第一个指定的元素之后（不是内部）紧跟的元素。</p>
</div>
...
<p>CSS 教程：<a href="/css/css_selector_adjacent_sibling.asp" title="CSS 相邻兄弟选择器">CSS 相邻兄弟选择器</a></p>
</div>
