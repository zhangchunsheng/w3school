...
<title>CSS :first-letter 选择器</title>
...
<p><a target="_blank" href="/tiy/t.asp?f=css_sel_firstletter">亲自试一试</a></p>
</div>
...
<p>所有主流浏览器都支持 :first-letter 选择器。</p>
</div>
...
<p>:first-letter 选择器用于选取指定选择器的首字母。</p>

<p class="note"><span>注释：</span>以下属性可与 :first-letter 使用：</p>
