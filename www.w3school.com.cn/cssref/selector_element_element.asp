...
<p>选择并设置位于 &lt;div&gt; 元素内部的每个 &lt;p&gt; 元素的样式：</p>
...
<p><a target="_blank" href="/tiy/t.asp?f=css_sel_element_element">亲自试一试</a></p>
</div>
...
<p><i>element</i> <i>element</i> 选择器用于选取元素内部的元素。</p>
</div>
...
<p>CSS 教程：<a href="/css/css_selector_descendant.asp" title="CSS 后代选择器">CSS 后代选择器</a></p>
</div>
