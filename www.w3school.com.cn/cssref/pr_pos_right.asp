...
<p>right 属性规定元素的右边缘。该属性定义了定位元素右外边距边界与其包含块右边界之间的偏移。</p>

<p class="note"><span>注释：</span>如果 &quot;position&quot; 属性的值为 &quot;static&quot;，那么设置 &quot;right&quot; 属性不会产生任何效果。</p>
...
<table class="dataintable">
  ...
  <tr>
    <th>JavaScript 语法：</th>
    <td><i>object</i>.style.right=&quot;50px&quot;</td>
  </tr>
</table>
</div>
...
<p>把图像的右边缘设置在其包含元素右边缘向左 5 像素的位置：</p>
...
<p><a href="/tiy/t.asp?f=csse_position_right_test">TIY</a></p>
</div>
...
<tr>
<td>auto</td>
<td>默认值。通过浏览器计算右边缘的位置。</td>
</tr>

<tr>
<td><i>%</i></td>
<td>设置以包含元素的百分比计的右边位置。可使用负值。</td>
</tr>

<tr>
<td><i>length</i></td>
<td>使用 px、cm 等单位设置元素的右边位置。可使用负值。</td>
</tr>

<tr>
<td>inherit</td>
<td>规定应该从父元素继承 right 属性的值。</td>
</tr>
</table>
</div>
...
<p>HTML DOM 参考手册：<a href="/jsref/prop_style_right.asp" title="HTML DOM right 属性">right 属性</a></p>
</div>
