...
<title>CSS margin-right 属性</title>
...
<table class="dataintable">
  ...
  <tr>
    <th>JavaScript 语法：</th>
    <td><i>object</i>.style.marginRight=&quot;10px&quot;</td>
  </tr>
</table>
</div>
...
p
  {
  <code>margin-right:2cm;</code>
  }
</pre>

<p><a href="/tiy/t.asp?f=csse_margin-right">TIY</a> （在页面底部可以找到更多实例）</p>
</div>
...
<p>所有主流浏览器都支持 margin-right 属性。</p>
...
<tr>
<td><i>length</i></td>
<td>定义固定的右外边距。默认值是 0。</td>
</tr>

<tr>
<td><i>%</i></td>
<td>定义基于父对象总高度的百分比右外边距。</td>
</tr>

<tr>
<td>inherit</td>
<td>规定应该从父元素继承右外边距。</td>
</tr>
</table>
</div>
...
<dl>
<dt><a href="/tiy/t.asp?f=csse_margin-right">设置文本的右外边距 1</a></dt>
<dd>本例演示如何使用厘米值来设置文本的右外边距。</dd>
<dt><a href="/tiy/t.asp?f=csse_margin-right_percent">设置文本的右外边距 2</a></dt>
<dd>本例演示如何使用百分比值来设置文本的右外边距。</dd>
</dl>
</div>
...
<p>HTML DOM 参考手册：<a href="/jsref/prop_style_marginright.asp" title="HTML DOM marginRight 属性">marginRight 属性</a></p>
</div>
