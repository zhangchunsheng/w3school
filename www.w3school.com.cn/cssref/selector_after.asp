...
<p><a target="_blank" href="/tiy/t.asp?f=css_sel_after">亲自试一试</a></p>
</div>
...
<p>所有主流浏览器都支持 :after 选择器。</p>

<p class="note"><span>注释：</span>对于 IE8 及更早版本中的 :after，必须声明 <a href="/tags/tag_doctype.asp" title="HTML &lt;!DOCTYPE&gt; 标签">&lt;!DOCTYPE&gt;</a>。</p>
</div>
...
<p>在每个 &lt;p&gt; 元素后面插入内容，并设置所插入内容的样式：</p>
...
<p><a target="_blank" href="/tiy/t.asp?f=css_sel_after_style">亲自试一试</a></p>
</div>
...
<p>CSS 选择器参考手册：<a href="/cssref/selector_before.asp" title="CSS :before 选择器">CSS :before 选择器</a></p>
</div>
