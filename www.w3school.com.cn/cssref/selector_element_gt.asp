...
<h1>CSS <i>element</i>&gt;<i>element</i> 选择器</h1>
...
<p>选取父元素是 &lt;div&gt; 元素的每个 &lt;p&gt; 元素，并设置其背景色：</p>
...
<p><a target="_blank" href="/tiy/t.asp?f=css_sel_element_gt">亲自试一试</a></p>
</div>
...
<p>所有主流浏览器都支持 <i>element</i>&gt;<i>element</i> 选择器。</p>

<p class="note"><span>注释：</span>对于 IE8 及更早版本的浏览器中的 <i>element</i>&gt;<i>element</i>，必须声明 <a href="/tags/tag_doctype.asp" title="HTML &lt;!DOCTYPE&gt; 标签">&lt;!DOCTYPE&gt;</a>。</p>
</div>
...
<p><i>element</i>&gt;<i>element</i> 选择器用于选取带有特定父元素的元素。</p>

<p class="note"><span>注释：</span>如果元素不是父元素的直接子元素，则不会被选择。</p>
</div>
...
<p>CSS 教程：<a href="/css/css_selector_child.asp" title="CSS 子元素选择器">CSS 子元素选择器</a></p>
</div>
