...
<p><a target="_blank" href="/tiy/t.asp?f=css_sel_empty">亲自试一试</a></p>
</div>
...
<p>:empty 选择器匹配没有子元素（包括文本节点）的每个元素。</p>
</div>
...
<p>所有主流浏览器均支持 :empty 选择器，除了 IE8 及更早的版本。</p>
</div>
