...
<title>CSS3 perspective 属性</title>
...
{
perspective: 500;
-webkit-perspective: 500; <span class="code_comment">/* Safari 和 Chrome */</span>
}
</pre>
...
<p>目前浏览器都不支持 perspective 属性。</p>

<p>Chrome 和 Safari 支持替代的 -webkit-perspective 属性。</p>
</div>
...
<p class="note"><span>注释：</span>perspective 属性只影响 3D 转换元素。</p>

<p class="tip"><span>提示：</span>请与 <a href="/cssref/pr_perspective-origin.asp" title="CSS3 perspective-origin 属性">perspective-origin</a> 属性一同使用该属性，这样您就能够改变 3D 元素的底部位置。</p>
...
<table class="dataintable">
  ...
  <tr>
    <th>JavaScript 语法：</th>
    <td><i>object</i>.style.perspective=500</td>
  </tr>
</table>
</div>
...
<pre>perspective: <i>number</i>|none;</pre>
...
<tr>
<td><i>number</i></td>
<td>元素距离视图的距离，以像素计。</td>
</tr>

<tr>
<td>none</td>
<td>默认值。与 0 相同。不设置透视。</td>
</tr>
</table>
</div>
