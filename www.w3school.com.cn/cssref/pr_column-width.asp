...
<title>CSS3 column-width 属性</title>
...
{
column-width:100px;
-moz-column-width:100px; <span class="code_comment">/* Firefox */</span>
-webkit-column-width:100px; <span class="code_comment">/* Safari 和 Chrome */</span>
}
</pre>

<p><a target="_blank" href="/tiy/t.asp?f=css3_column-width">亲自试一试</a></p>
...
<p>Internet Explorer 10 和 Opera 支持 column-width 属性。</p>

<p>Firefox 支持替代的 -moz-column-width 属性。</p>

<p>Safari 和 Chrome 支持替代的 -webkit-column-width 属性。</p>

<p class="note"><span>注释：</span>Internet Explorer 9 以及更早版本的浏览器不支持 column-width 属性。</p>
</div>
...
<table class="dataintable">
  ...
  <tr>
    <th>JavaScript 语法：</th>
    <td><i>object</i>.style.columnWidth=&quot;100px&quot;</td>
  </tr>
</table>
</div>
...
<pre>column-width: auto|<i>length</i>;</pre>
...
<td>auto</td>
<td>由浏览器决定列宽。</td>
<td><a target="_blank" href="/tiy/c.asp?f=css_column-width">测试</a></td>
</tr>

<tr>
<td><i>length</i></td>
<td>规定列的宽度。</td>
<td><a target="_blank" href="/tiy/c.asp?f=css_column-width&p=2">测试</a></td>
</tr>
</table>
</div>
