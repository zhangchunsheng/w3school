...
<p>background 简写属性在一个声明中设置所有的背景属性。</p>
...
<p>如果不设置其中的某个值，也不会出问题，比如 background:#ff0000 url('smiley.gif'); 也是允许的。</p>

<p>通常建议使用这个属性，而不是分别使用单个属性，因为这个属性在较老的浏览器中能够得到更好的支持，而且需要键入的字母也更少。</p>
...
<p><a href="/tiy/t.asp?f=csse_background">亲自试一试</a></p>
</div>
...
<p>所有浏览器都支持 background 属性。</p>

<p class="note"><span>注释：</span>IE8 以及更早的浏览器不支持一个元素多个背景图像。</p>

<p class="note"><span>注释：</span>IE7 以及更早的浏览器不支持 &quot;inherit&quot;。IE8 需要 !DOCTYPE。IE9 支持 &quot;inherit&quot;。</p>
</div>
...
<tr>
<td><i><a href="/cssref/pr_background-size.asp" title="CSS3 background-size 属性">background-size</a></i></td>
<td>规定背景图片的尺寸。</td>
<td>3</td>
</tr>
...
<tr>
<td><i><a href="/cssref/pr_background-origin.asp" title="CSS3 background-origin 属性">background-origin</a></i></td>
<td>规定背景图片的定位区域。</td>
<td>3</td>
</tr>

<tr>
<td><i><a href="/cssref/pr_background-clip.asp" title="CSS3 background-clip 属性">background-clip</a></i></td>
<td>规定背景的绘制区域。</td>
<td>3</td>
</tr>
...
<p>HTML DOM 参考手册：<a href="/jsref/prop_style_background.asp" title="HTML DOM background 属性">background 属性</a></p>
</div>
