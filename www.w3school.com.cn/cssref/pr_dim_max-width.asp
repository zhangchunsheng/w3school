...
<p>max-width 定义元素的最大宽度。</p>

<h3>说明</h3>

<p>该属性值会对元素的宽度设置一个最高限制。因此，元素可以比指定值窄，但不能比其宽。不允许指定负值。</p>
...
<table class="dataintable">
  ...
  <tr>
    <th>JavaScript 语法：</th>
    <td><i>object</i>.style.maxWidth=&quot;50px&quot;</td>
  </tr>
</table>
</div>
...
p
  {
  <code>max-width:100px;</code>
  }
</pre>

<p><a href="/tiy/t.asp?f=csse_dim_max-width">TIY</a></p>
</div>
...
<tr>
<td><i>%</i></td>
<td>定义基于包含它的块级对象的百分比最大宽度。</td>
</tr>

<tr>
<td>inherit</td>
<td>规定应该从父元素继承 max-width 属性的值。</td>
</tr>
</table>
</div>
...
<p>CSS 参考手册：<a href="/cssref/pr_dim_min-width.asp" title="CSS min-width 属性">CSS min-width 属性</a></p>

<p>HTML DOM 参考手册：<a href="/jsref/prop_style_maxwidth.asp" title="HTML DOM maxWidth 属性">maxWidth 属性</a></p>
</div>
