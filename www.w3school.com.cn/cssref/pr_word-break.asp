...
<title>CSS3 word-break 属性</title>
...
<p><a target="_blank" href="/tiy/t.asp?f=css3_word-break">亲自试一试</a></p>
</div>
...
<p>所有主流浏览器都支持 word-break 属性，除了 Opera。</p>
...
<p class="tip"><span>提示：</span>通过使用 word-break 属性，可以让浏览器实现在任意位置的换行。</p>
...
<table class="dataintable">
  ...
  <tr>
    <th>JavaScript 语法：</th>
    <td><i>object</i>.style.wordBreak=&quot;keep-all&quot;</td>
  </tr>
</table>
</div>
...
<pre>word-break: normal|break-all|keep-all;</pre>
