...
<p><a target="_blank" href="/tiy/t.asp?f=css_sel_not">亲自试一试</a></p>
</div>
...
<p>:not(<i>selector</i>) 选择器匹配非指定元素/选择器的每个元素。</p>
</div>
...
<p>所有主流浏览器均支持 :not 选择器，除了 IE8 及更早的版本。</p>
</div>
