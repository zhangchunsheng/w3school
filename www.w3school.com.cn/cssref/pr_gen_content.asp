...
<p>该属性用于定义元素之前或之后放置的生成内容。默认地，这往往是行内内容，不过该内容创建的框类型可以用属性 display 控制。</p>
...
<table class="dataintable">
  ...
  <tr>
    <th>JavaScript 语法：</th>
    <td><i>object</i>.style.content=&quot;url(beep.wav)&quot;</td>
  </tr>
</table>
</div>
...
<div>
<h2>浏览器支持</h2>
<p>所有浏览器都支持 content 属性。</p>
<p class="note"><span>注释：</span>如果已规定 !DOCTYPE，那么 Internet Explorer 8 （以及更高版本）支持 content 属性。</p>
</div>
...
<tr>
<td><i>content specifications</i></td>
<td>&nbsp;</td>
</tr>

<tr>
<td>inherit</td>
<td>规定应该从父元素继承 content 属性的值。</td>
</tr>
</table>
</div>
...
<p>HTML DOM 参考手册：<a href="/jsref/prop_style_content.asp" title="HTML DOM content 属性">content 属性</a></p>
</div>
