...
<title>CSS border-right-color 属性</title>
...
<h1>CSS border-right-color 属性</h1>
...
<p>border-right-color 设置元素的右边框的颜色。</p>

<p>只能定义纯色，而且只有当边框的样式是一个非 none 或 hidden 的值时边框才可能出现。</p>

<p class="note"><span>注释：</span>请始终把 border-style 属性声明到 border-color 属性之前。元素必须在您改变其颜色之前获得边框。</p>
...
<table class="dataintable">
  ...
  <tr>
    <th>JavaScript 语法：</th>
    <td><i>object</i>.style.borderRightColor=&quot;blue&quot;</td>
  </tr>
</table>
</div>
...
p
  {
  border-style:solid;
  <code>border-right-color:#ff0000;</code>
  }
</pre>

<p><a href="/tiy/t.asp?f=csse_border-right-color">TIY</a></p>
</div>
...
<p>所有浏览器都支持 border-right-color 属性。</p>

<p class="note"><span>注释：</span>Internet Explorer 6（以及更早的版本）不支持属性值 &quot;transparent&quot;。</p>
...
<tr>
    ...
    <td>规定颜色值为颜色名称的边框颜色（比如 red）。</td>
</tr>

<tr>
    <td><i>hex_number</i></td>
    <td>规定颜色值为十六进制值的边框颜色（比如 #ff0000）。</td>
</tr>

<tr>
    <td><i>rgb_number</i></td>
    <td>规定颜色值为 rgb 代码的边框颜色（比如 rgb(255,0,0)）。</td>
</tr>
...
<p>CSS 参考手册：<a href="/cssref/pr_border-right.asp" title="CSS border-right 属性">border-right 属性</a></p>

<p>HTML DOM 参考手册：<a href="/jsref/prop_style_borderrightcolor.asp" title="HTML DOM borderRightColor 属性">borderRightColor 属性</a></p>
</div>
