...
<title>CSS3 border-image-repeat 属性</title>
...
<h1>CSS3 border-image-repeat 属性</h1>
...
<p>目前主流浏览器都不支持 border-image-repeat 属性。</p>
...
<p>border-image-repeat 属性规定图像边框是否应该被重复（repeated）、拉伸（stretched）或铺满（rounded）。</p>
...
<table class="dataintable">
  ...
  <tr>
    <th>JavaScript 语法：</th>
    <td><i>object</i>.style.borderImageRepeat=&quot;round&quot;</td>
  </tr>
</table>
</div>
...
<pre>border-image-repeat: stretch|repeat|round;</pre>

<p class="note"><span>注释：</span>该属性规定如何延展和铺排边框图像的边缘和中间部分。因此，您可以规定两个值。如果省略第二个值，则采取与第一个值相同的值。</p>
