...
<p>所有主流浏览器都支持 overflow-y 属性。</p>

<p class="note"><span>注释：</span>overflow-y 属性无法在 IE8 以及更早的浏览器正确地工作。</p>
</div>
...
<p class="tip"><span>提示：</span>使用 <a href="/cssref/pr_overflow-x.asp" title="CSS3 overflow-x 属性">overflow-x</a> 属性来确定对左/右边缘的裁剪。</p>
...
<pre>overflow-y: visible|hidden|scroll|auto|no-display|no-content;</pre>
...
<td><a target="_blank" href="/tiy/c.asp?f=css_overflow-y">测试</a></td>
</tr>

<tr>
<td>hidden</td>
<td>裁剪内容 - 不提供滚动机制。</td>
<td><a target="_blank" href="/tiy/c.asp?f=css_overflow-y&p=2">测试</a></td>
</tr>

<tr>
<td>scroll</td>
<td>裁剪内容 - 提供滚动机制。</td>
<td><a target="_blank" href="/tiy/c.asp?f=css_overflow-y&p=3">测试</a></td>
</tr>

<tr>
<td>auto</td>
<td>如果溢出框，则应该提供滚动机制。</td>
<td><a target="_blank" href="/tiy/c.asp?f=css_overflow-y&p=4">测试</a></td>
</tr>

<tr>
<td>no-display</td>
<td>如果内容不适合内容框，则删除整个框。</td>
<td><a target="_blank" href="/tiy/c.asp?f=css_overflow-y&p=5">测试</a></td>
</tr>

<tr>
<td>no-content</td>
<td>如果内容不适合内容框，则隐藏整个内容。</td>
<td><a target="_blank" href="/tiy/c.asp?f=css_overflow-y&p=6">测试</a></td>
</tr>
