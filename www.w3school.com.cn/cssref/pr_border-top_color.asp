...
<title>CSS border-top-color 属性</title>
...
<p>border-top-color 设置元素的上边框的颜色。</p>
...
<table class="dataintable">
  ...
  <tr>
    <th>JavaScript 语法：</th>
    <td><i>object</i>.style.borderTopColor=&quot;blue&quot;</td>
  </tr>
</table>
</div>
...
p
  {
  border-style:solid;
  <code>border-top-color:#ff0000;</code>
  }
</pre>

<p><a href="/tiy/t.asp?f=csse_border-top-color">TIY</a></p>
</div>
...
<p>所有浏览器都支持 border-top-color 属性。</p>
...
<p>HTML DOM 参考手册：<a href="/jsref/prop_style_bordertopcolor.asp" title="HTML DOM borderTopColor 属性">borderTopColor 属性</a></p>
</div>
