...
<p><a target="_blank" href="/tiy/t.asp?f=css_sel_attribute">亲自试一试</a></p>
</div>
...
<p>所有主流浏览器都支持 [<i>attribute</i>] 选择器。</p>

<p class="note"><span>注释：</span>对于 IE8 及更早版本的浏览器中的 [<i>attribute</i>]，必须声明 <a href="/tags/tag_doctype.asp" title="HTML &lt;!DOCTYPE&gt; 标签">&lt;!DOCTYPE&gt;</a>。</p>
</div>
...
<p>[<i>attribute</i>] 选择器用于选取带有指定属性的元素。</p>
</div>
