...
<title>CSS padding-bottom 属性</title>
...
<p>padding-bottom 属性设置元素的下内边距（底部空白）。</p>

<h3>说明</h3>

<p>该属性设置元素下内边距的宽度。行内非替换元素上设置的下内边距不会影响行高计算，因此，如果一个元素既有内边距又有背景，从视觉上看可能延伸到其他行，有可能还会与其他内容重叠。不允许指定负内边距值。</p>
...
<table class="dataintable">
  ...
  <tr>
    <th>JavaScript 语法：</th>
    <td><i>object</i>.style.paddingBottom=&quot;10px&quot;</td>
  </tr>
</table>
</div>
...
p
  {
  <code>padding-bottom:2cm;</code>
  }
</pre>

<p><a href="/tiy/t.asp?f=csse_padding-bottom">TIY</a> （在页面底部可以找到更多实例）</p>
</div>
...
<p>所有主流浏览器都支持 padding-bottom 属性。</p>
...
<tr>
<td><i>%</i></td>
<td>定义基于父元素宽度的百分比下内边距。此值不会如预期地那样工作于所有的浏览器中。</td>
</tr>
...
<p>HTML DOM 参考手册：<a href="/jsref/prop_style_paddingbottom.asp" title="HTML DOM paddingBottom 属性">paddingBottom 属性</a></p>
</div>
