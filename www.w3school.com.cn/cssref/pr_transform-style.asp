...
-webkit-transform: rotateY(60deg);	<span class="code_comment">/* Safari 和 Chrome */</span>
-webkit-transform-style: preserve-3d;	<span class="code_comment">/* Safari 和 Chrome */</span>
}
</pre>

<p><a target="_blank" href="/tiy/t.asp?f=css3_transform-style">亲自试一试</a></p>
</div>
...
<p>Firefox 支持 transform-style 属性。</p>

<p>Chrome 和 Safari 支持替代的 -webkit-transform-style 属性。</p>
</div>
...
<p class="note"><span>注释：</span>该属性必须与 <a href="/cssref/pr_transform.asp" title="CSS3 transform 属性">transform</a> 属性一同使用。</p>

<table class="dataintable">
  <tr>
    <th style="width:25%;">默认值：</th>
    <td style="width:75%;">flat</td>
  </tr>
  <tr>
    <th>继承性：</th>
    <td>no</td>
  ...
  <tr>
    <th>JavaScript 语法：</th>
    <td><i>object</i>.style.transformStyle=&quot;preserve-3d&quot;</td>
  </tr>
</table>
</div>
