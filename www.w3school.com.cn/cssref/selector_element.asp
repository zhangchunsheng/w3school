...
<p><a target="_blank" href="/tiy/t.asp?f=css_sel_element">亲自试一试</a></p>
</div>
...
<p>所有主流浏览器都支持 <i>element</i> 选择器。</p>
</div>
...
<p><i>element</i> 选择器用于指定元素名称的所有元素。</p>
</div>
