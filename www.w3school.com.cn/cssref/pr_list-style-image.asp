...
<title>CSS list-style-image 属性</title>
...
<p>list-style-image 属性使用图像来替换列表项的标记。</p>

<h3>说明</h3>

<p>这个属性指定作为一个有序或无序列表项标志的图像。图像相对于列表项内容的放置位置通常使用 list-style-position 属性控制。</p>

<p class="note"><span>注释：</span>请始终规定一个 &quot;list-style-type&quot; 属性以防图像不可用。</p>
...
<table class="dataintable">
  ...
  <tr>
    <th>JavaScript 语法：</th>
    <td><i>object</i>.style.listStyleImage=&quot;url('/images/blueball.gif')&quot;</td>
  </tr>
</table>
</div>
...
ul
  {
  <code>list-style-image:url("/i/arrow.gif");</code>
  list-style-type:square;
  }
</pre>

<p><a href="/tiy/t.asp?f=csse_list-style-image">TIY</a></p>
</div>
...
<p>所有浏览器都支持 list-style-image 属性。</p>
...
<p>HTML DOM 参考手册：<a href="/jsref/prop_style_liststyleimage.asp" title="HTML DOM listStyleImage 属性">listStyleImage 属性</a></p>
</div>
