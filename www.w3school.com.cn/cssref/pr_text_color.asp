...
<h2>定义和用法</h2>
<p>color 属性规定文本的颜色。</p>
<p>这个属性设置了一个元素的前景色（在 HTML 表现中，就是元素文本的颜色）；光栅图像不受 color 影响。这个颜色还会应用到元素的所有边框，除非被 border-color 或另外某个边框颜色属性覆盖。</p>
<p>要设置一个元素的前景色，最容易的方法是使用 color 属性。</p>
...
<table class="dataintable">
  ...
  <tr>
    <th>JavaScript 语法：</th>
    <td><i>object</i>.style.color=&quot;#FF0000&quot;</td>
  </tr>
</table>
</div>
...
h1
  {
  <code>color:#00ff00;</code>
  }
p
  {
  <code>color:rgb(0,0,255);</code>
  }
</pre>
<p><a href="/tiy/t.asp?f=csse_color">TIY</a></p>
</div>


<div>
<h2>浏览器支持</h2>
<p>所有浏览器都支持 color 属性。</p>
...
<div>
<h2>提示和注释</h2>
<p class="tip"><span>提示：</span>请使用合理的背景颜色和文本颜色搭配，这样可以提高文本的可读性。</p>
</div>
...
<p>HTML DOM 参考手册：<a href="/jsref/prop_style_color.asp" title="HTML DOM color 属性">color 属性</a></p>
</div>
