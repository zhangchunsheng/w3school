...
<p><a target="_blank" href="/tiy/t.asp?f=css3_nav">亲自试一试</a></p>
</div>
...
<p>目前只有 Opera 支持 nav-right 属性。</p>
</div>
...
<p>nav-right 属性规定当使用 nav-right 导航键时，向何处进行导航。</p>
...
<pre>nav-right: auto|<i>id</i>|<i>target-name</i>|inherit;</pre>
...
<tr>
<td>inherit</td>
<td>规定应从父元素继承 nav-right 属性的值。</td>
</tr>
</table>
</div>
