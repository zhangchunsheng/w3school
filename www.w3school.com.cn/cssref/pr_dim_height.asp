...
<p>height 属性设置元素的高度。</p>

<h3>说明</h3>

<p>这个属性定义元素内容区的高度，在内容区外面可以增加内边距、边框和外边距。</p>
...
<table class="dataintable">
  ...
  <tr>
    <th>JavaScript 语法：</th>
    <td><i>object</i>.style.height=&quot;50px&quot;</td>
  </tr>
</table>
</div>
...
<p><a href="/tiy/t.asp?f=csse_dim_height">TIY</a></p>
</div>
...
<p>CSS 教程：<a href="/css/css_boxmodel.asp" title="CSS 框模型概述">CSS 框模型概述</a></p>

<p>CSS 参考手册：<a href="/cssref/pr_dim_width.asp" title="CSS width 属性">width 属性</a></p>

<p>HTML DOM 参考手册：<a href="/jsref/prop_style_height.asp" title="HTML DOM height 属性">height 属性</a></p>
</div>
