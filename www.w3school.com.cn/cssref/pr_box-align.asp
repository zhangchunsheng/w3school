...
<p>通过使用 box-align and box-pack 属性，居中 div 框的子元素：</p>
...
<p>目前没有浏览器支持 box-align 属性。</p>

<p>Firefox 支持替代的 -moz-box-align 属性。</p>

<p>Safari、Opera 以及 Chrome 支持替代的 -webkit-box-align 属性。</p>
</div>
...
<td>start</td>
<td>
<p>对于正常方向的框，每个子元素的上边缘沿着框的顶边放置。</p>
<p>对于反方向的框，每个子元素的下边缘沿着框的底边放置。</p>
</td>
<td><a target="_blank" href="/tiy/c.asp?f=css_box-align">测试</a></td>
</tr>

<tr>
<td>end</td>
<td>
<p>对于正常方向的框，每个子元素的下边缘沿着框的底边放置。</p>
<p>对于反方向的框，每个子元素的上边缘沿着框的顶边放置。</p>
</td>
<td><a target="_blank" href="/tiy/c.asp?f=css_box-align&p=2">测试</a></td>
</tr>

<tr>
<td>center</td>
<td>均等地分割多余的空间，一半位于子元素之上，另一半位于子元素之下。</td>
<td><a target="_blank" href="/tiy/c.asp?f=css_box-align&p=3">测试</a></td>
</tr>

<tr>
<td>baseline</td>
<td>如果 box-orient 是inline-axis或horizontal，所有子元素均与其基线对齐。</td>
<td><a target="_blank" href="/tiy/c.asp?f=css_box-align&p=4">测试</a></td>
</tr>
...
<dl>
<dt><a target="_blank" href="/tiy/t.asp?f=css3_box-align_js">改变元素的 box-align 值</a></dt>
<dd>该例演示如何使用 JavaScript 来改变元素的 box-align 值。</dd>
</dl>
</div>
