...
<div>
<h2>定义和用法</h2>
<p>letter-spacing 属性增加或减少字符间的空白（字符间距）。</p>
<p>该属性定义了在文本字符框之间插入多少空间。由于字符字形通常比其字符框要窄，指定长度值时，会调整字母之间通常的间隔。因此，normal 就相当于值为 0。</p>
<p class="note"><span>注释：</span>允许使用负值，这会让字母之间挤得更紧。</p>
...
<table class="dataintable">
  ...
  <tr>
    <th>JavaScript 语法：</th>
    <td><i>object</i>.style.letterSpacing=&quot;3px&quot;</td>
  </tr>
</table>
</div>
...
<div>
<h2>实例</h2>
<p>设置 h1 和 h2 元素的字母间距：</p>
<pre>
h1 {<code>letter-spacing:2px</code>}
h2 {<code>letter-spacing:-3px</code>}
</pre>
<p><a href="/tiy/t.asp?f=csse_letter-spacing">TIY</a></p>
</div>
...
<h2>TIY 实例</h2>
<dl>
<dt><a href="/tiy/t.asp?f=csse_letter-spacing">规定字符间距（字母间隔）</a></dt>
...
<p>HTML DOM 参考手册：<a href="/jsref/prop_style_letterspacing.asp" title="HTML DOM letterSpacing 属性">letterSpacing 属性</a></p>
</div>
