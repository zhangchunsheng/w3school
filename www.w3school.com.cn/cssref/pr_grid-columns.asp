...
<title>CSS3 grid-columns 属性</title>
...
<p>在 div 元素中部添加一个网格行，距右侧 200 像素处添加另一个，在余下空间的中间再添加一个：</p>
...
<table class="dataintable">
  ...
  <tr>
    <th>JavaScript 语法：</th>
    <td><i>object</i>.style.gridColumns=&quot;50% * * 200px&quot;</td>
  </tr>
</table>
</div>
...
<pre>grid-columns: <i>length</i>|<i>%</i>|none|inherit;</pre>
