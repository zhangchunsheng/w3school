...
<title>CSS page-break-before 属性</title>
...
<h1>CSS page-break-before 属性</h1>
...
<p>page-break-before 属性设置元素前的 page-breaking 行为。</p>
...
@media print
{
table {<code>page-break-before:always;</code>}
}
&lt;/style&gt;
&lt;/head&gt;
...
<p>所有浏览器都支持 page-break-before 属性。</p>
...
<tr>
<td>left</td>
<td>在元素之前足够的分页符，一直到一张空白的左页为止。</td>
</tr>

<tr>
<td>right</td>
<td>在元素之前足够的分页符，一直到一张空白的右页为止。</td>
</tr>

<tr>
<td>inherit</td>
<td>规定应该从父元素继承 page-break-before 属性的设置。</td>
</tr>
</table>
</div>
...
<p>HTML DOM 参考手册：<a href="/jsref/prop_style_pagebreakbefore.asp" title="HTML DOM pageBreakBefore 属性">pageBreakBefore 属性</a></p>
</div>
