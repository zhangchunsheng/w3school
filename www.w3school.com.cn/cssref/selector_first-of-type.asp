...
<title>CSS3 :first-of-type 选择器</title>
...
<p>指定父元素的首个 p 元素的背景色：</p>

<pre>
<code>p:first-of-type</code>
{
background:#ff0000;
}
</pre>

<p><a target="_blank" href="/tiy/t.asp?f=css_sel_first-of-type">亲自试一试</a></p>
</div>
...
<p>所有主流浏览器均支持 :first-of-type 选择器，除了 IE8 及更早的版本。</p>
</div>
...
<p>:first-of-type 选择器匹配属于其父元素的特定类型的首个子元素的每个元素。</p>

<p class="tip"><span>提示：</span>等同于 :nth-of-type(1)。</p>
</div>
