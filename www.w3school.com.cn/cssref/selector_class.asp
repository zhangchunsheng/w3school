...
<p><a target="_blank" href="/tiy/t.asp?f=css_sel_class">亲自试一试</a></p>
</div>
...
<p>.class 选择器选取带有指定类 (class) 的元素。</p>
</div>
...
<p>为 class=&quot;hometown&quot; 的所有 &lt;p&gt; 元素设置样式：</p>
...
<p><a target="_blank" href="/tiy/t.asp?f=css_sel_class_more">亲自试一试</a></p>
</div>
...
<p>CSS 教程：<a href="/css/css_syntax_class_selector.asp" title="CSS 类选择器">CSS 类选择器</a></p>

<p>CSS 教程：<a href="/css/css_selector_class.asp" title="CSS 类选择器详解">CSS 类选择器详解</a></p>
</div>
