...
<title>CSS empty-cells 属性</title>
...
<p>empty-cells 属性设置是否显示表格中的空单元格（仅用于“分离边框”模式）。</p>

<p class="note"><span>注释：</span>某些版本的 IE 浏览器不支持此属性。</p>

<h3>说明</h3>

<p>该属性定义了不包含任何内容的表单元格如何表示。如果显示，就会绘制出单元格的边框和背景。除非 border-collapse 设置为 separate，否则将忽略这个属性。</p>

<table class="dataintable">
  <tr>
    <th style="width:25%;">默认值：</th>
    <td style="width:75%;">show</td>
  </tr>
  <tr>
    <th>继承性：</th>
    <td>yes</td>
  ...
  <tr>
    <th>JavaScript 语法：</th>
    <td><i>object</i>.style.emptyCells=&quot;hide&quot;</td>
  </tr>
</table>
</div>
...
<p><a href="/tiy/t.asp?f=csse_table_empty-cells">亲自试一试</a></p>
</div>
...
<p>所有浏览器都支持 empty-cells 属性。</p>

<p class="note"><span>注释：</span>如果已规定 !DOCTYPE，那么 Internet Explorer 8 （以及更高版本）支持 empty-cells 属性。</p>
</div>
...
<tr>
<td>show</td>
<td>在空单元格周围绘制边框。默认。</td>
</tr>

<tr>
<td>inherit</td>
<td>规定应该从父元素继承 empty-cells 属性的值。</td>
</tr>
</table>
</div>
...
<p>HTML DOM 参考手册：<a href="/jsref/prop_style_emptycells.asp" title="HTML DOM emptyCells 属性">emptyCells 属性</a></p>
</div>
