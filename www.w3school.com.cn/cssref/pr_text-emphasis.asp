...
<title>CSS3 text-emphasis 属性</title>
...
<p>目前主流浏览器都不支持 text-emphasis 属性。</p>
...
<p>text-emphasis 属性是简写属性，用于在一个声明中设置 text-emphasis-style 和 text-emphasis-color。</p>

<p class="tip"><span>提示：</span>Adobe 的 &quot;Kenten Generic OpenType Font&quot; 是一个适合重点标记的字体，它专门为重点标记设计。</p>
...
<pre>text-emphasis: <i>text-emphasis-style</i> <i>text-emphasis-color</i>;</pre>
