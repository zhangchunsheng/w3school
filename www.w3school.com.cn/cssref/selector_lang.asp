...
<p>选择带有以 &quot;en&quot; 开头的 lang 属性值的每个 &lt;p&gt; 元素，并设置其样式：</p>
...
<p><a target="_blank" href="/tiy/t.asp?f=css_sel_lang">亲自试一试</a></p>
</div>
...
<p>所有主流浏览器都支持 :lang 选择器。</p>

<p class="note"><span>注释：</span>对于 IE8 中的 :lang，必须声明 <a href="/tags/tag_doctype.asp" title="HTML &lt;!DOCTYPE&gt; 标签">&lt;!DOCTYPE&gt;</a>。</p>
</div>
...
<p>:lang 选择器用于选取带有以指定值开头的 lang 属性的元素。</p>

<p class="note"><span>注释：</span>该值必须是整个单词，即可是单独的，比如 lang=&quot;en&quot;，也可后跟连接符，比如 lang=&quot;en-us&quot;。</p>
</div>
