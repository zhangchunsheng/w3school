...
<p><a target="_blank" href="/tiy/t.asp?f=css_sel_target">亲自试一试</a></p>
</div>
...
<p>URL 带有后面跟有锚名称 #，指向文档内某个具体的元素。这个被链接的元素就是目标元素(target element)。</p>
...
<p>所有主流浏览器均支持 :target 选择器，除了 IE8 及更早的版本。</p>
</div>
