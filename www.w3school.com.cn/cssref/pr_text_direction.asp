...
<div>
<h2>定义和用法</h2>
<p>direction 属性规定文本的方向 / 书写方向。</p>
<p>该属性指定了块的基本书写方向，以及针对 Unicode 双向算法的嵌入和覆盖方向。不支持双向文本的用户代理可以忽略这个属性。</p>

<table class="dataintable">
  <tr>
    <th style="width:25%;">默认值：</th>
    <td style="width:75%;">ltr</td>
  </tr>
  <tr>
    <th>继承性：</th>
    <td>yes</td>
  ...
  <tr>
    <th>JavaScript 语法：</th>
    <td><i>object</i>.style.direction=&quot;rtl&quot;</td>
  </tr>
</table>
</div>
...
<p><a href="/tiy/t.asp?f=csse_text_direction">TIY</a></p>
</div>


<div>
<h2>浏览器支持</h2>
<p>所有浏览器都支持 direction 属性。</p>
...
<h2>TIY 实例</h2>
<dl>
<dt><a href="/tiy/t.asp?f=csse_text_direction">设置文本的方向</a></dt>
<dd>本例演示如何设置文本的方向。</dd>
</dl>
</div>
...
<p>HTML DOM 参考手册：<a href="/jsref/prop_style_direction.asp" title="HTML DOM direction 属性">direction 属性</a></p>
</div>
