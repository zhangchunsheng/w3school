...
<title>CSS3 box-flex-group 属性</title>
...
<p>目前没有浏览器支持 box-flex-group 属性。</p>
</div>
...
<p>box-flex-group 属性用于向柔性分组分配可伸缩元素。</p>

<p class="tip"><span>提示：</span>可伸缩元素能够随着框的缩小和扩大而伸缩。</p>
...
<table class="dataintable">
  ...
  <tr>
    <th>JavaScript 语法：</th>
    <td><i>object</i>.style.boxFlexGroup=2</td>
  </tr>
</table>
</div>
...
<pre>box-flex-group: <i>integer</i>;</pre>
...
<tr>
<td><i>integer</i></td>
<td>一个整数。（第一个柔性分组是 1，后面的柔性分组是更大的值）。</td>
</tr>
</table>
</div>
