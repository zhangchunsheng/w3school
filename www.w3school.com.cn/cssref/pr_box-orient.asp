...
<title>CSS3 box-orient 属性</title>
...
<p><a target="_blank" href="/tiy/t.asp?f=css3_box-orient">亲自试一试</a></p>
</div>
...
<p>目前没有浏览器支持 box-orient 属性。</p>

<p>Firefox 支持替代的 -moz-box-orient 属性。</p>

<p>Safari、Opera 以及 Chrome 支持替代的 -webkit-box-orient 属性。</p>
</div>
...
<p>box-orient 属性规定框的子元素应该被水平或垂直排列。</p>

<p class="tip"><span>提示：</span>水平框中的子元素从左向右进行显示，而垂直框的子元素从上向下进行显示。不过，box-direction 和 box-ordinal-group 能够改变这种顺序。</p>
...
<tr>
<td>horizontal</td>
<td>在水平行中从左向右排列子元素。</td>
<td><a target="_blank" href="/tiy/c.asp?f=css_box-orient">测试</a></td>
</tr>

<tr>
<td>vertical</td>
<td>从上向下垂直排列子元素。</td>
<td><a target="_blank" href="/tiy/c.asp?f=css_box-orient&p=2">测试</a></td>
</tr>

<tr>
<td>inline-axis</td>
<td>沿着行内轴来排列子元素（映射为 horizontal）。</td>
<td><a target="_blank" href="/tiy/c.asp?f=css_box-orient&p=3">测试</a></td>
</tr>

<tr>
<td>block-axis</td>
<td>沿着块轴来排列子元素（映射为 vertical）。</td>
<td><a target="_blank" href="/tiy/c.asp?f=css_box-orient&p=4">测试</a></td>
</tr>

<tr>
<td>inherit</td>
<td>应该从父元素继承 box-orient 属性的值。</td>
<td></td>
</tr>
</table>
</div>
