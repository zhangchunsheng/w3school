...
<p>设置 class 属性值以 &quot;test&quot; 结尾的所有 div 元素的背景色：</p>
...
<p><a target="_blank" href="/tiy/t.asp?f=css_sel_attr_end">亲自试一试</a></p>
</div>
...
<p>[<i>attribute</i>$=<i>value</i>] 选择器匹配属性值以指定值结尾的每个元素。</p>
</div>
...
<p>设置 class 属性值以 &quot;test&quot; 结尾的所有元素的背景色：</p>
...
<p><a target="_blank" href="/tiy/t.asp?f=css_sel_attr_end2">亲自试一试</a></p>
</div>
