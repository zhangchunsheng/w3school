...
<h1>CSS3 transition-delay 属性</h1>
...
{
transition-delay: 2s;
-moz-transition-delay: 2s; <span class="code_comment">/* Firefox 4 */</span>
-webkit-transition-delay: 2s; <span class="code_comment">/* Safari 和 Chrome */</span>
-o-transition-delay: 2s; <span class="code_comment">/* Opera */</span>
}
</pre>

<p><a target="_blank" href="/tiy/t.asp?f=css3_transition-delay">亲自试一试</a></p>
</div>
...
<p>Internet Explorer 10、Firefox、Opera 和 Chrome 支持 transition-delay 属性。</p>

<p>Safari 支持替代的 -webkit-transition-delay 属性。</p>

<p class="note"><span>注释：</span>Internet Explorer 9 以及更早版本的浏览器不支持 transition-delay 属性。</p>
</div>
...
<p>transition-delay 属性规定过渡效果何时开始。</p>

<p>transition-delay 值以秒或毫秒计。</p>
...
<pre>transition-delay: <i>time</i>;</pre>
...
<tr>
<td><i>time</i></td>
<td>规定在过渡效果开始之前需要等待的时间，以秒或毫秒计。</td>
</tr>
</table>
</div>
