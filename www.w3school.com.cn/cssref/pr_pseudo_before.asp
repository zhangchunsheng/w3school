...
<p>:before 伪元素在元素之前添加内容。</p>

<p>这个伪元素允许创作人员在元素内容的最前面插入生成内容。默认地，这个伪元素是行内元素，不过可以使用属性 display 改变这一点。</p>
</div>
...
<p>此样式会在每个 h1 元素之前播放一段声音：</p>

<pre>
h1:before
  {
  <code>content:url(beep.wav);</code>
  }
</pre>

<p><a href="/tiy/t.asp?f=csse_before">TIY</a></p>
</div>
...
<dl>
<dt><a href="/tiy/t.asp?f=csse_before">使用 :before 在元素内容之前插入内容</a></dt>
<dd>本例演示如何使用 :before 在元素内容之前插入图像。</dd>
</dl>
</div>
