...
<p>top 属性规定元素的顶部边缘。该属性定义了一个定位元素的上外边距边界与其包含块上边界之间的偏移。</p>

<p class="note"><span>注释：</span>如果 &quot;position&quot; 属性的值为 &quot;static&quot;，那么设置 &quot;top&quot; 属性不会产生任何效果。</p>

<h3>说明</h3>

<p>对于 static 元素，为 auto；对于长度值，则为相应的绝对长度；对于百分比数值，为指定值；否则为 auto。</p>

<p>对于相对定义元素，如果 top 和 bottom 都是 auto，其计算值则都是 0；如果其中之一为 auto，则取另一个值的相反数；如果二者都不是 auto，bottom 将取 top 值的相反数。</p>
...
<p>把图像的上边缘设置在其包含元素上边缘之下 5 像素高的位置：</p>
...
<p><a href="/tiy/t.asp?f=csse_position_top_test">TIY</a></p>
</div>
...
<tr>
<td>auto</td>
<td>默认值。通过浏览器计算上边缘的位置。</td>
</tr>

<tr>
<td><i>%</i></td>
<td>设置以包含元素的百分比计的上边位置。可使用负值。</td>
</tr>

<tr>
<td><i>length</i></td>
<td>使用 px、cm 等单位设置元素的上边位置。可使用负值。</td>
</tr>

<tr>
<td>inherit</td>
<td>规定应该从父元素继承 top 属性的值。</td>
</tr>
</table>
</div>
...
<p>HTML DOM 参考手册：<a href="/jsref/prop_style_top.asp" title="HTML DOM top 属性">top 属性</a></p>
</div>
