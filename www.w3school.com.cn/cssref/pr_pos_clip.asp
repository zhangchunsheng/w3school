...
<p>当一幅图像的尺寸大于包含它的元素时会发生什么呢？&quot;clip&quot; 属性允许您规定一个元素的可见尺寸，这样此元素就会被修剪并显示为这个形状。</p>
...
<table class="dataintable">
  ...
  <tr>
    <th>JavaScript 语法：</th>
    <td><i>object</i>.style.clip=&quot;rect(0px,50px,50px,0px)&quot;</td>
  </tr>
</table>
</div>
...
img
  {
  position:absolute;
  <code>clip:rect(0px,60px,200px,0px);</code>
  }
</pre>

<p><a href="/tiy/t.asp?f=csse_clip">TIY</a></p>
</div>
...
<tr>
<td><i>shape</i></td>
<td>设置元素的形状。唯一合法的形状值是：rect (<i>top</i>, <i>right</i>, <i>bottom</i>, <i>left</i>)</td>
</tr>
...
<dd>本例演示如何设置元素的形状。此元素被剪入形状中，然后显示出来。</dd>
</dl>
</div>
...
<p>HTML DOM 参考手册：<a href="/jsref/prop_style_clip.asp" title="HTML DOM clip 属性">clip 属性</a></p>
</div>
