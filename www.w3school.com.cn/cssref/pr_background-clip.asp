...
<p><a target="_blank" href="/tiy/t.asp?f=css3_background-clip">亲自试一试</a></p>
...
<p>IE9+、Firefox、Opera、Chrome 以及 Safari 支持 background-clip 属性。</p>

<p class="note"><span>注释：</span>Internet Explorer 8 以及更早的版本不支持 background-clip 属性。</p>
</div>
...
<table class="dataintable">
  <tr>
    ...
    <td style="width:75%;">border-box</td>
  </tr>
  <tr>
    <th>继承性：</th>
    <td>no</td>
  ...
  <tr>
    <th>JavaScript 语法：</th>
    <td><i>object</i>.style.backgroundClip=&quot;content-box&quot;</td>
  </tr>
</table>
</div>
...
<pre>background-clip: border-box|padding-box|content-box;</pre>
