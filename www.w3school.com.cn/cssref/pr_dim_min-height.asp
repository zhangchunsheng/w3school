...
<p>min-height 属性设置元素的最小高度。</p>

<h3>说明</h3>

<p>该属性值会对元素的高度设置一个最低限制。因此，元素可以比指定值高，但不能比其矮。不允许指定负值。</p>
...
<table class="dataintable">
  ...
  <tr>
    <th>JavaScript 语法：</th>
    <td><i>object</i>.style.minHeight=&quot;50px&quot;</td>
  </tr>
</table>
</div>
...
p
  {
  <code>min-height:100px;</code>
  }
</pre>

<p><a href="/tiy/t.asp?f=csse_dim_min-height">TIY</a></p>
</div>
...
<tr>
<td><i>length</i></td>
<td>定义元素的最小高度。默认值是 0。</td>
</tr>

<tr>
<td><i>%</i></td>
<td>定义基于包含它的块级对象的百分比最小高度。</td>
</tr>

<tr>
<td>inherit</td>
<td>规定应该从父元素继承 min-height 属性的值。</td>
</tr>
</table>
</div>
...
<p>CSS 教程：<a href="/cssref/pr_dim_max-height.asp" title="CSS max-height 属性">max-height 属性</a></p>

<p>HTML DOM 参考手册：<a href="/jsref/prop_style_minheight.asp" title="HTML DOM minHeight 属性">minHeight 属性</a></p>
</div>
