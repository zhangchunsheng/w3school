...
<title>CSS page-break-inside 属性</title>
...
<h1>CSS page-break-inside 属性</h1>
...
<p>page-break-inside 属性设置元素内部的 page-breaking 行为。</p>
...
@media print
{
table {<code>page-break-inside:avoid;</code>}
}
&lt;/style&gt;
&lt;/head&gt;
...
<p>只有 Opera 浏览器支持 page-break-inside 属性。</p>
</div>
...
<p>HTML DOM 参考手册：<a href="/jsref/prop_style_pagebreakinside.asp" title="HTML DOM pageBreakInside 属性">pageBreakInside 属性</a></p>
</div>
