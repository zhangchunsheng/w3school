...
<title>CSS3 border-image-width 属性</title>
...
<h1>CSS3 border-image-width 属性</h1>
...
<code>border-image-width: 30 30;</code>
}
</pre>
...
<p>目前主流浏览器都不支持 border-image-width 属性。</p>
...
<p>border-image-width 属性规定图像边框的宽度。</p>
...
<table class="dataintable">
  ...
  <tr>
    <th>JavaScript 语法：</th>
    <td><i>object</i>.style.borderImageWidth=&quot;30 30&quot;</td>
  </tr>
</table>
</div>
...
<pre>border-image-width: <i>number</i>|<i>%</i>|auto;</pre>

<p class="note"><span>注释：</span>border-image-width 属性的四个之规定将边框图像分割为九个部分的偏移。它们代表了从区域的上、右、下、左侧向内的距离。如果忽略第四个值，则与第二个值相同。如果省略第三个值，则与第一个值相同。如果省略第二个值，则与第一个值相同。不允许任何负值作为 border-image-width 值。</p>
