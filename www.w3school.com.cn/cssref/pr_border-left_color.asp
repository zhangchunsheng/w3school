...
<title>CSS border-left-color 属性</title>
...
<h1>CSS border-left-color 属性</h1>
...
<p>border-left-color 设置元素的左边框的颜色。</p>
...
<table class="dataintable">
  ...
  <tr>
    <th>JavaScript 语法：</th>
    <td><i>object</i>.style.borderLeftColor=&quot;blue&quot;</td>
  </tr>
</table>
</div>
...
p
  {
  border-style:solid;
  <code>border-left-color:#ff0000;</code>
  }
</pre>

<p><a href="/tiy/t.asp?f=csse_border-left-color">TIY</a></p>
</div>
...
<p>所有浏览器都支持 border-left-color 属性。</p>
...
<p>CSS 参考手册：<a href="/cssref/pr_border-left.asp" title="CSS border-left 属性">border-left 属性</a></p>

<p>HTML DOM 参考手册：<a href="/jsref/prop_style_borderleftcolor.asp" title="HTML DOM borderLeftColor 属性">borderLeftColor 属性</a></p>
</div>
