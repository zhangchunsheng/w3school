...
<title>CSS3 :nth-child() 选择器</title>
...
<p><a target="_blank" href="/tiy/t.asp?f=css_sel_nth-child">亲自试一试</a></p>
</div>
...
<p>:nth-child(<i>n</i>) 选择器匹配属于其父元素的第 N 个子元素，不论元素的类型。</p>

<p><i>n</i> 可以是数字、关键词或公式。</p>

<p class="tip"><span>提示：</span>请参阅 <a href="selector_nth-of-type.asp" title="CSS :nth-of-type() 选择器">:nth-of-type()</a> 选择器，该选择器选取父元素的第 N 个指定类型的子元素。</p>
</div>
...
<p>所有主流浏览器均支持 :nth-child() 选择器，除了 IE8 及更早的版本。</p>
</div>
...
<pre>
<code>p:nth-child(odd)</code>
{
background:#ff0000;
}
<code>p:nth-child(even)</code>
{
background:#0000ff;
}
</pre>

<p><a target="_blank" href="/tiy/t.asp?f=css_sel_nth-child_odd_even">亲自试一试</a></p>
...
<pre>
<code>p:nth-child(3n+0)</code>
{
background:#ff0000;
}
</pre>

<p><a target="_blank" href="/tiy/t.asp?f=css_sel_nth-child_formula">亲自试一试</a></p>
</div>
