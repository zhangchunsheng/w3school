...
<title>CSS3 punctuation-trim 属性</title>
...
<h1>CSS3 punctuation-trim 属性</h1>
...
<p>目前主流浏览器都不支持 punctuation-trim 属性。</p>
...
<p>punctuation-trim 属性规定如果标点位于行开头或结尾处，或者临近另一个全角标点符号，是否对标点符号进行修剪。</p>
...
<pre>punctuation-trim: none|start|end|allow-end|adjacent;</pre>
