...
<p>从原图像开始重复，原图像由 <a href="/cssref/pr_background-image.asp" title="CSS background-image 属性">background-image</a> 定义，并根据 <a href="/cssref/pr_background-position.asp" title="CSS background-position 属性">background-position</a> 的值放置。</p>
...
<p><a href="/tiy/t.asp?f=csse_background-repeaty">亲自试一试</a></p>
</div>
