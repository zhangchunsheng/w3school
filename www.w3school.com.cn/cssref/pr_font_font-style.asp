...
<div>
<h2>定义和用法</h2>
<p>font-style 属性定义字体的风格。</p>

<h3>说明</h3>
<p>该属性设置使用斜体、倾斜或正常字体。斜体字体通常定义为字体系列中的一个单独的字体。理论上讲，用户代理可以根据正常字体计算一个斜体字体。</p>
...
<table class="dataintable">
  ...
  <tr>
    <th>JavaScript 语法：</th>
    <td><i>object</i>.style.fontStyle=&quot;italic&quot;</td>
  </tr>
</table>
</div>
...
<pre>
p.normal {<code>font-style:normal;</code>}
p.italic {<code>font-style:italic;</code>}
p.oblique {<code>font-style:oblique;</code>}
</pre>

<p><a href="/tiy/t.asp?f=csse_font-style">TIY</a></p>
</div>


<div>
<h2>浏览器支持</h2>
<p>所有主流浏览器都支持 font-style 属性。</p>
...
<p>HTML DOM 参考手册：<a href="/jsref/prop_style_fontstyle.asp" title="HTML DOM fontStyle 属性">fontStyle 属性</a></p>
</div>
