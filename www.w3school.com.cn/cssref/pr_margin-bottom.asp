...
<title>CSS margin-bottom 属性</title>
...
<table class="dataintable">
  ...
  <tr>
    <th>JavaScript 语法：</th>
    <td><i>object</i>.style.marginBottom=&quot;10px&quot;</td>
  </tr>
</table>
</div>
...
p
  {
  <code>margin-bottom:2cm;</code>
  }
</pre>

<p><a href="/tiy/t.asp?f=csse_margin-bottom">TIY</a> （在页面底部可以找到更多实例）</p>
</div>
...
<p>所有主流浏览器都支持 margin-bottom 属性。</p>
...
<tr>
<td><i>length</i></td>
<td>规定以具体单位计的下外边距值，比如像素、厘米等。默认值是 0px。</td>
</tr>

<tr>
<td><i>%</i></td>
<td>规定基于父元素的宽度的百分比的下外边距。</td>
</tr>

<tr>
<td>inherit</td>
<td>规定应该从父元素继承下外边距。</td>
</tr>
</table>
</div>
...
<dl>
<dt><a href="/tiy/t.asp?f=csse_margin-bottom">设置文本的下外边距 1</a></dt>
<dd>本例演示如何使用厘米值来设置文本的下外边距。</dd>

<dt><a href="/tiy/t.asp?f=csse_margin-bottom_percent">设置文本的下外边距 2</a></dt>
<dd>本例演示如何使用百分比值来设置文本的下外边距。</dd>
</dl>
</div>
...
<p>HTML DOM 参考手册：<a href="/jsref/prop_style_marginbottom.asp" title="HTML DOM marginBottom 属性">marginBottom 属性</a></p>
</div>
