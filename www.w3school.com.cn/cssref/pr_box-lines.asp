...
<code>box-lines:multiple;</code>
width:200px;
}
</pre>

<p><a target="_blank" href="/tiy/t.asp?f=css3_box-lines">亲自试一试</a></p>
</div>
...
<p>box-lines 属性规定如果列超出了父框中的空间，是否要换行显示。</p>

<p class="tip"><span>提示：</span>默认地，水平框会在单独的行中排列其子元素，而垂直框会在单独的列中排列其子元素。</p>

<table class="dataintable">
  <tr>
    <th style="width:25%;">默认值：</th>
    <td style="width:75%;">single</td>
  </tr>
  <tr>
    <th>继承性：</th>
    <td>no</td>
  ...
  <tr>
    <th>JavaScript 语法：</th>
    <td><i>object</i>.style.boxLines=&quot;multiple&quot;</td>
  </tr>
</table>
</div>
...
<pre>box-lines: single|multiple;</pre>
...
<tr>
<td>single</td>
<td>所有子元素会被放置在单独的行或列中。（无法匹配的元素会被视为溢出）。</td>
</tr>

<tr>
<td>multiple</td>
<td>允许框扩展为多行，以容纳其所有子元素。</td>
</tr>
</table>
</div>
