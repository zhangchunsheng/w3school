...
<title>CSS padding-top 属性</title>
...
<p>padding-top 属性设置元素的上内边距（空间）。</p>

<h3>说明</h3>

<p>该属性设置元素上内边距的宽度。行内非替换元素上设置的上内边距不会影响行高计算，因此，如果一个元素既有内边距又有背景，从视觉上看可能延伸到其他行，有可能还会与其他内容重叠。不允许指定负内边距值。</p>
...
<table class="dataintable">
  ...
  <tr>
    <th>JavaScript 语法：</th>
    <td><i>object</i>.style.paddingTop=&quot;10px&quot;</td>
  </tr>
</table>
</div>
...
p
  {
  <code>padding-top:2cm;</code>
  }
</pre>

<p><a href="/tiy/t.asp?f=csse_padding-top">TIY</a> （在页面底部可以找到更多实例）</p>
</div>
...
<tr>
<td><i>length</i></td>
<td>规定以具体单位计的固定的上内边距值，比如像素、厘米等。默认值是 0px。</td>
</tr>

<tr>
<td><i>%</i></td>
<td>定义基于父元素宽度的百分比上内边距。此值不会如预期的那样工作于所有的浏览器中。</td>
</tr>

<tr>
<td>inherit</td>
<td>规定应该从父元素继承上内边距。</td>
</tr>
</table>
</div>
...
<p>HTML DOM 参考手册：<a href="/jsref/prop_style_paddingtop.asp" title="HTML DOM paddingTop 属性">paddingTop 属性</a></p>
</div>
