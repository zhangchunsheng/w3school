...
<title>CSS border-bottom-color 属性</title>
...
<h1>CSS border-bottom-color 属性</h1>
...
<table class="dataintable">
  ...
  <tr>
    <th>JavaScript 语法：</th>
    <td><i>object</i>.style.borderBottomColor=&quot;blue&quot;</td>
  </tr>
</table>
</div>
...
p
  {
  border-style:solid;
  <code>border-bottom-color:#ff0000;</code>
  }
</pre>

<p><a href="/tiy/t.asp?f=csse_border-bottom-color">TIY</a></p>
</div>
...
<p>所有浏览器都支持 border-bottom-color 属性。</p>
...
<p>CSS 参考手册：<a href="/cssref/pr_border-bottom.asp" title="CSS border-bottom 属性">border-bottom 属性</a></p>
<p>HTML DOM 参考手册：<a href="/jsref/prop_style_borderbottomcolor.asp" title="HTML DOM borderBottomColor 属性">borderBottomColor 属性</a></p>
</div>
