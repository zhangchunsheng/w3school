...
<h1>CSS3 animation-duration 属性</h1>
...
<p>为 @keyframes 动画规定一个名称：</p>

<pre>
div
{
animation-duration:2s;
-webkit-animation-duration:2s; <span class="code_comment">/* Safari 和 Chrome */</span>
}
</pre>

<p><a target="_blank" href="/tiy/t.asp?f=css3_animation-duration">亲自试一试</a></p>
</div>
...
<p>Internet Explorer 10、Firefox 以及 Opera 支持 animation-duration 属性。</p>

<p>Safari 和 Chrome 支持替代的 -webkit-animation-duration 属性。</p>

<p class="note"><span>注释：</span>Internet Explorer 9 以及更早的版本不支持 animation-duration 属性。</p>
</div>
...
<p>animation-duration 属性定义动画完成一个周期所需要的时间，以秒或毫秒计。</p>
...
<table class="dataintable">
  ...
  <tr>
    <th>JavaScript 语法：</th>
    <td><i>object</i>.style.animationDuration=&quot;3s&quot;</td>
  </tr>
</table>
</div>
...
<pre>animation-duration: <i>time</i>;</pre>
