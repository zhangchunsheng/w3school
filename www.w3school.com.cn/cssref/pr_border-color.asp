...
<title>CSS border-color 属性</title>
...
<p>要记住，边框的样式不能为 none 或 hidden，否则边框不会出现。</p>
...
<p><a href="/tiy/t.asp?f=csse_border-color">TIY</a></p>
</div>
...
<dd>本例演示如何设置四个边框的颜色。可以设置一到四种颜色。</dd>
</dl>
</div>
...
<p>HTML DOM 参考手册：<a href="/jsref/prop_style_bordercolor.asp" title="HTML DOM borderColor 属性">borderColor 属性</a></p>
</div>
