...
<p><a target="_blank" href="/tiy/t.asp?f=css3_text-overflow">亲自试一试</a></p>
...
<p>所有主流浏览器都支持 text-overflow 属性。</p>
...
<table class="dataintable">
  ...
  <tr>
    <th>JavaScript 语法：</th>
    <td><i>object</i>.style.textOverflow=&quot;ellipsis&quot;</td>
  </tr>
</table>
</div>
...
<pre>text-overflow: clip|ellipsis|<i>string</i>;</pre>
...
<td>clip</td>
<td>修剪文本。</td>
<td><a target="_blank" href="/tiy/c.asp?f=css_text-overflow">测试</a></td>
</tr>

<tr>
<td>ellipsis</td>
<td>显示省略符号来代表被修剪的文本。</td>
<td><a target="_blank" href="/tiy/c.asp?f=css_text-overflow&p=2">测试</a></td>
</tr>
...
<dl>
<dt><a target="_blank" href="/tiy/t.asp?f=css3_text-overflow_hover">带有 hover 效果的 Text-overflow</a></dt>
<dd>本例演示当光标浮动到元素上时如何显示全部文本。</dd>
</dl>
</div>
