...
<p>如果不设置其中的某个值，也不会出问题，比如 border:solid #ff0000; 也是允许的。</p>
...
<table class="dataintable">
  ...
  <tr>
    <th>JavaScript 语法：</th>
    <td><i>object</i>.style.border=&quot;3px solid blue&quot;</td>
  </tr>
</table>
</div>
...
<p><a href="/tiy/t.asp?f=csse_border">TIY</a></p>
</div>
...
<td>规定边框的宽度。参阅：<a href="pr_border-width.asp" title="CSS border-width 属性">border-width</a> 中可能的值。</td>
</tr>

<tr>
<td><i>border-style</i></td>
<td>规定边框的样式。参阅：<a href="pr_border-style.asp" title="CSS border-style 属性">border-style</a> 中可能的值。</td>
</tr>

<tr>
<td><i>border-color</i></td>
<td>规定边框的颜色。参阅：<a href="pr_border-color.asp" title="CSS border-color 属性">border-color</a> 中可能的值。</td>
</tr>

<tr>
<td>inherit</td>
<td>规定应该从父元素继承 border 属性的设置。</td>
</tr>
</table>
</div>
...
<p>HTML DOM 参考手册：<a href="/jsref/prop_style_border.asp" title="HTML DOM border 属性">border 属性</a></p>
</div>
