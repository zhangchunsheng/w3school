...
<p><a target="_blank" href="/tiy/t.asp?f=css3_column-gap">亲自试一试</a></p>
...
<p>Internet Explorer 10 和 Opera 支持 column-gap 属性。</p>

<p>Firefox 支持替代的 -moz-column-gap 属性。</p>

<p>Safari 和 Chrome 支持替代的 -webkit-column-gap 属性。</p>

<p class="note"><span>注释：</span>Internet Explorer 9 以及更早版本的浏览器不支持 column-gap 属性。</p>
</div>
...
<p class="note"><span>注释：</span>如果列之间设置了 column-rule，它会在间隔中间显示。</p>
...
<table class="dataintable">
  ...
  <tr>
    <th>JavaScript 语法：</th>
    <td><i>object</i>.style.columnGap=&quot;40px&quot;</td>
  </tr>
</table>
</div>
...
<pre>column-gap: <i>length</i>|normal;</pre>
...
<tr>
<td><i>length</i></td>
<td>把列间的间隔设置为指定的长度。</td>
<td><a target="_blank" href="/tiy/c.asp?f=css_column-gap">测试</a></td>
</tr>

<tr>
<td>normal</td>
<td>规定列间间隔为一个常规的间隔。W3C 建议的值是 1em。</td>
<td><a target="_blank" href="/tiy/c.asp?f=css_column-gap&p=5">测试</a></td>
</tr>
</table>
</div>
