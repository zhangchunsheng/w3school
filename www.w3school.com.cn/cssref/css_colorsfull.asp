...
<li class="currentLink"><a href="/cssref/css_colorsfull.asp" title="CSS 颜色十六进制值">CSS 颜色十六进制</a></li>
</ul>
</div>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/cssref/css_colornames.asp" title="CSS 颜色名">CSS 颜色名</a></li>
<li class="next"><a href="/cssref/index.asp" title="CSS 参考手册">CSS 参考手册</a></li>
</ul>
</div>
...
<p><a href="/cssref/css_colornames.asp" title="CSS 颜色名">根据颜色名排序的相同列表</a></p>
