...
<p><a target="_blank" href="/tiy/t.asp?f=css_sel_element_comma">亲自试一试</a></p>
</div>
...
<p><i>element</i>,<i>element</i> 选择器用于用于同时选取多个元素。</p>

<p>如需为不同的元素设置相同的样式，请用逗号来分隔每个元素。</p>
</div>
...
<p>CSS 教程：<a href="/css/css_selector_grouping.asp" title="CSS 分组">CSS 分组</a></p>
</div>
