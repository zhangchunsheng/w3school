...
<p>nav-down 属性规定当使用 nav-down 导航键时，向何处进行导航。</p>
...
<pre>nav-down: auto|<i>id</i>|<i>target-name</i>|inherit;</pre>
