...
<title>CSS border-right-width 属性</title>
...
<h1>CSS border-right-width 属性</h1>
...
<p>border-right-width 属性设置元素的右边框的宽度。</p>

<p>只有当边框样式不是 none 时才起作用。如果边框样式是 none，边框宽度实际上会重置为 0。不允许指定负长度值。</p>

<p class="note"><span>注释：</span>请始终在 border-right-width 属性之前声明 border-style 属性。元素只有在获得边框之后，才能改变其边框的宽度。</p>
...
<table class="dataintable">
  ...
  <tr>
    <th>JavaScript 语法：</th>
    <td><i>object</i>.style.borderRightWidth=&quot;thick&quot;</td>
  </tr>
</table>
</div>
...
p
  {
  border-style:solid;
  <code>border-right-width:15px;</code>
  }
</pre>

<p><a href="/tiy/t.asp?f=csse_border-right-width">TIY</a></p>
</div>
...
<p>所有浏览器都支持 border-right-width 属性。</p>
...
<p>HTML DOM 参考手册：<a href="/jsref/prop_style_borderrightwidth.asp" title="HTML DOM borderRightWidth 属性">borderRightWidth 属性</a></p>
</div>
