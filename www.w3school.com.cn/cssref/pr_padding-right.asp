...
<title>CSS padding-right 属性</title>
...
<p>padding-right 属性设置元素右内边距（空白）。</p>

<p class="note"><span>注释：</span>不允许使用负值。</p>

<h3>说明</h3>

<p>该属性设置元素右内边距的宽度。行内非替换元素上设置的右内边距仅在元素所生成的第一个行内框的右边出现.</p>
...
<table class="dataintable">
  ...
  <tr>
    <th>JavaScript 语法：</th>
    <td><i>object</i>.style.paddingRight=&quot;10px&quot;</td>
  </tr>
</table>
</div>
...
p
  {
  <code>padding-right:2cm;</code>
  }
</pre>

<p><a href="/tiy/t.asp?f=csse_padding-right">TIY</a> （在页面底部可以找到更多实例）</p>
</div>
...
<p>所有主流浏览器都支持 padding-right 属性。</p>
...
<tr>
<td><i>length</i></td>
<td>规定以具体单位计的固定的右内边距值，比如像素、厘米等。默认值是 0px。</td>
</tr>

<tr>
<td><i>%</i></td>
<td>定义基于父元素宽度的百分比右内边距。此值不会如预期地那样工作于所有的浏览器中。</td>
</tr>

<tr>
<td>inherit</td>
<td>规定应该从父元素继承右内边距。</td>
</tr>
</table>
</div>
...
<p>HTML DOM 参考手册：<a href="/jsref/prop_style_paddingright.asp" title="HTML DOM paddingRight 属性">paddingRight 属性</a></p>
</div>
