...
<p><a target="_blank" href="/tiy/t.asp?f=css_sel_hover">亲自试一试</a></p>
</div>
...
<p class="tip"><span>提示：</span>:hover 选择器可用于所有元素，不只是链接。</p>

<p class="tip"><span>提示：</span><a href="/cssref/selector_link.asp" title="CSS :link 选择器">:link</a> 选择器设置指向未被访问页面的链接的样式，<a href="/cssref/selector_visited.asp" title="CSS :visited 选择器">:visited</a> 选择器用于设置指向已被访问的页面的链接，<a href="/cssref/selector_active.asp" title="CSS :active 选择器">:active</a> 选择器用于活动链接。</p>

<p class="note"><span>注释：</span>在 CSS 定义中，:hover 必须位于 :link 和 :visited 之后（如果存在的话），这样样式才能生效。</p>
</div>
