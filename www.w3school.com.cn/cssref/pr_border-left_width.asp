...
<title>CSS border-left-width 属性</title>
...
<h1>CSS border-left-width 属性</h1>
...
<p>border-left-width 属性设置元素的左边框的宽度。</p>

<p>只有当边框样式不是 none 时才起作用。如果边框样式是 none，边框宽度实际上会重置为 0。不允许指定负长度值。</p>

<p class="note"><span>注释：</span>请始终在 border-left-width 属性之前声明 border-style 属性。元素只有在获得边框之后，才能改变其边框的宽度。</p>
...
<table class="dataintable">
  ...
  <tr>
    <th>JavaScript 语法：</th>
    <td><i>object</i>.style.borderLeftWidth=&quot;thick&quot;</td>
  </tr>
</table>
</div>
...
p
  {
  border-style:solid;
  <code>border-left-width:15px;</code>
  }
</pre>

<p><a href="/tiy/t.asp?f=csse_border-left-width">TIY</a></p>
</div>
...
<p>所有浏览器都支持 border-left-width 属性。</p>
...
<p>HTML DOM 参考手册：<a href="/jsref/prop_style_borderleftwidth.asp" title="HTML DOM borderLeftWidth 属性">borderLeftWidth 属性</a></p>
</div>
