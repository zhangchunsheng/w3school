...
<title>CSS3 column-count 属性</title>
...
<p><a target="_blank" href="/tiy/t.asp?f=css3_column-count">亲自试一试</a></p>
...
<p>Internet Explorer 10 和 Opera 支持 column-count 属性。</p>

<p>Firefox 支持替代的 -moz-column-count 属性。</p>

<p>Safari 和 Chrome 支持替代的 -webkit-column-count 属性。</p>

<p class="note"><span>注释：</span>Internet Explorer 9 以及更早版本的浏览器不支持 column-count 属性。</p>
</div>
...
<p>column-count 属性规定元素应该被划分的列数。</p>
...
<table class="dataintable">
  ...
  <tr>
    <th>JavaScript 语法：</th>
    <td><i>object</i>.style.columnCount=3</td>
  </tr>
</table>
</div>
...
<pre>column-count: <i>number</i>|auto;</pre>
...
<td><i>number</i></td>
<td>元素内容将被划分的最佳列数。</td>
<td><a target="_blank" href="/tiy/c.asp?f=css_column-count">测试</a></td>
</tr>

<tr>
<td>auto</td>
<td>由其他属性决定列数，比如 &quot;column-width&quot;。</td>
<td><a target="_blank" href="/tiy/c.asp?f=css_column-count&p=7">测试</a></td>
</tr>
</table>
</div>
...
<dd>将 div 元素中的文本分为三列，并规定列间 30 像素的间隔。</dd>
