...
<p><a target="_blank" href="/tiy/t.asp?f=css_sel_focus">亲自试一试</a></p>
</div>
...
<p>所有主流浏览器都支持 :focus 选择器。</p>

<p class="note"><span>注释：</span>如果 :focus 用于 IE8 ，则必须声明 &lt;!DOCTYPE&gt;。</p>
</div>
...
<p>:focus 选择器用于选取获得焦点的元素。</p>

<p class="tip"><span>提示：</span>接收键盘事件或其他用户输入的元素都允许 :focus 选择器。</p>
</div>
