...
<title>CSS3 column-fill 属性</title>
...
<p>column-fill 属性规定如何填充列（是否进行协调）。</p>

<table class="dataintable">
  <tr>
    <th style="width:25%;">默认值：</th>
    <td style="width:75%;">balance</td>
  </tr>
  <tr>
    <th>继承性：</th>
    <td>no</td>
...
<pre>column-fill: balance|auto;</pre>
...
<tr>
<td>balance</td>
<td>对列进行协调。浏览器应对列长度的差异进行最小化处理。</td>
</tr>

<tr>
<td>auto</td>
<td>按顺序对列进行填充，列长度会各有不同。</td>
</tr>
</table>
</div>
