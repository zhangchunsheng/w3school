...
<p><a href="/tiy/t.asp?f=csse_table_border-collapse">TIY</a></p>
</div>
...
<p>所有主流浏览器都支持 border-collapse 属性。</p>

<p class="note"><span>注释：</span>任何的版本的 Internet Explorer （包括 IE8）都不支持属性值 &quot;inherit&quot;。</p>

<p class="note"><span>注释：</span>如果没有规定 !DOCTYPE，则 border-collapse 可能产生意想不到的结果。</p>
</div>
...
<p>HTML DOM 参考手册：<a href="/jsref/prop_style_bordercollapse.asp" title="HTML DOM borderCollapse 属性">borderCollapse 属性</a></p>
</div>
