...
<p><a target="_blank" href="/tiy/t.asp?f=css3_animation-name">亲自试一试</a></p>
</div>
...
<p>Internet Explorer 10、Firefox 以及 Opera 支持 animation-name 属性。</p>

<p>Safari 和 Chrome 支持替代的 -webkit-animation-name 属性。</p>

<p class="note"><span>注释：</span>Internet Explorer 9 以及更早的版本不支持 animation-name 属性。</p>
</div>
...
<p>animation-name 属性为 @keyframes 动画规定名称。</p>
...
<table class="dataintable">
  ...
  <tr>
    <th>JavaScript 语法：</th>
    <td><i>object</i>.style.animationName=&quot;mymove&quot;</td>
  </tr>
</table>
</div>
...
<pre>animation-name: <i>keyframename</i>|none;</pre>
