...
<p>选择 titile 属性包含单词 &quot;flower&quot; 的元素，并设置其样式：</p>

<pre>
<code>[title~=flower]</code>
{ 
background-color:yellow;
}
</pre>

<p><a target="_blank" href="/tiy/t.asp?f=css_sel_attribute_value_contains">亲自试一试</a></p>
</div>
...
<p>[<i>attribute</i>~=<i>value</i>] 选择器用于选取属性值中包含指定词汇的元素。</p>
</div>
