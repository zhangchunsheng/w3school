...
<p>max-height 属性设置元素的最大高度。</p>

<h3>说明</h3>

<p>该属性值会对元素的高度设置一个最高限制。因此，元素可以比指定值矮，但不能比其高。不允许指定负值。</p>

<p class="note"><span>注释：</span>max-height 属性不包括外边距、边框和内边距。</p>
...
<table class="dataintable">
  ...
  <tr>
    <th>JavaScript 语法：</th>
    <td><i>object</i>.style.maxHeight=&quot;50px&quot;</td>
  </tr>
</table>
</div>
...
p
  {
  <code>max-height:100px;</code>
  }
</pre>

<p><a href="/tiy/t.asp?f=csse_dim_max-height">TIY</a></p>
</div>
...
<tr>
<td><i>%</i></td>
<td>定义基于包含它的块级对象的百分比最大高度。</td>
</tr>

<tr>
<td>inherit</td>
<td>规定应该从父元素继承 max-height 属性的值。</td>
</tr>
</table>
</div>
...
<p>CSS 教程：<a href="/cssref/pr_dim_min-height.asp" title="CSS min-height 属性">min-height 属性</a></p>

<p>HTML DOM 参考手册：<a href="/jsref/prop_style_maxheight.asp" title="HTML DOM maxHeight 属性">maxHeight 属性</a></p>
</div>
