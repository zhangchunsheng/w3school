...
{
columns:100px 3;
-moz-columns:100px 3; <span class="code_comment">/* Firefox */</span>
-webkit-columns:100px 3; <span class="code_comment">/* Safari 和 Chrome */</span>
}
</pre>

<p><a target="_blank" href="/tiy/t.asp?f=css3_columns">亲自试一试</a></p>
...
<p>Internet Explorer 10 和 Opera 支持 column 属性。</p>

<p>Firefox 支持替代的 -moz-column 属性。</p>

<p>Safari 和 Chrome 支持替代的 -webkit-column 属性。</p>

<p class="note"><span>注释：</span>Internet Explorer 9 以及更早版本的浏览器不支持 column 属性。</p>
</div>
...
<p>columns 属性是一个简写属性，用于设置列宽和列数。</p>

<table class="dataintable">
  <tr>
    <th style="width:25%;">默认值：</th>
    <td style="width:75%;">auto auto</td>
  </tr>
  <tr>
    <th>继承性：</th>
    <td>no</td>
  ...
  <tr>
    <th>JavaScript 语法：</th>
    <td><i>object</i>.style.columns=&quot;100px 3&quot;</td>
  </tr>
</table>
</div>
...
<pre>columns: <i>column-width</i> <i>column-count</i>;</pre>
...
<tr>
<td><i>column-width</i></td>
<td>列的宽度。</td>
</tr>

<tr>
<td><i>column-count</i></td>
<td>列数。</td>
</tr>
</table>
</div>
