...
<title>CSS3 box-direction 属性</title>
...
<p><a target="_blank" href="/tiy/t.asp?f=css3_box-direction">亲自试一试</a></p>
</div>
...
<p>目前没有浏览器支持 box-direction 属性。</p>

<p>Firefox 支持替代的 -moz-box-direction 属性。</p>

<p>Safari、Opera 以及 Chrome 支持替代的 -webkit-box-direction 属性。</p>
</div>
...
<p>box-direction 属性规定框元素的子元素以什么方向来排列。</p>
...
<table class="dataintable">
  ...
  <tr>
    <th>JavaScript 语法：</th>
    <td><i>object</i>.style.boxDirection=&quot;reverse&quot;</td>
  </tr>
</table>
</div>
...
<pre>box-direction: normal|reverse|inherit;</pre>
...
<td>normal</td>
<td>以默认方向显示子元素。</td>
<td><a target="_blank" href="/tiy/c.asp?f=css_box-direction">测试</a></td>
</tr>

<tr>
<td>reverse</td>
<td>以反方向显示子元素。</td>
<td><a target="_blank" href="/tiy/c.asp?f=css_box-direction&p=2">测试</a></td>
</tr>

<tr>
<td>inherit</td>
<td>应该从子元素继承 box-direction 属性的值</td>
<td></td>
</tr>
</table>
</div>
