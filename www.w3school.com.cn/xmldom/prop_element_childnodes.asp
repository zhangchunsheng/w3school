...
<title>XML DOM childNodes 属性</title>
</head>
...
<p>childNodes 属性返回包含被选节点的子节点的 NodeList。</p>
...
<div>
<h2>提示和注释</h2>
<p class="tip"><span>提示：</span>如需循环子节点列表，使用 nextSibling 属性，要比使用父对象的 childNodes 列表效率更高。</p>
</div>
...
<h3>例子 1</h3>
<p>下面的代码片段输出 &quot;books.xml&quot; 中第一个 &lt;title&gt; 元素的文本节点：</p>

<pre>xmlDoc=loadXMLDoc(&quot;books.xml&quot;);
var x=<code>xmlDoc.getElementsByTagName(&quot;title&quot;)[0].childNodes[0]</code>;
document.write(x.nodeValue);</pre>
...
<p>下面的代码片段输出 &quot;books.xml&quot; 中第一个 &lt;book&gt; 元素的子节点数量：</p>
<pre>xmlDoc=loadXMLDoc(&quot;books.xml&quot;);
var x=<code>xmlDoc.getElementsByTagName(&quot;book&quot;)[0].childNodes</code>;
document.write(x.length);</pre>

<p>在 Internet Explorer 中的输出：</p>
<pre>4</pre>

<p>在 Mozilla browsers 中的输出：</p>
<pre>9</pre>

<p>Internet Explorer 会忽略节点之间生成的空白文本节点（比如换行字符），而 Mozilla 不这么做。因此，在上面的例子中，输出是不同的。</p>
<p>如需更多有关 IE 与 Mozilla 浏览器差异的内容，请访问 W3School 的 XML DOM 教程中的 <a href="dom_mozilla_vs_ie.asp" title="XML DOM 浏览器差异">DOM 浏览器</a> 这一节。</p>
</div>

<div class="example">
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=xdom_getelementsbytagname">getelemenstByTagname() 和 childNodes - 获取元素的值</a></dt>

<dt><a href="/tiy/t.asp?f=xdom_childnodes_length">childNodes - 获取 NodeList 的长度</a></dt>
</dl>
</div>
