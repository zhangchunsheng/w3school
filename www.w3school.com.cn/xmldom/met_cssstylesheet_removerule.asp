...
<title>XML DOM removeRule() 方法</title>
</head>
...
<div>
<h2>定义和用法</h2>
<p>removeRule() 方法从一个样式表中移除一条规则，该方法是特定于 IE 的方法。</p>

<h3>语法：</h3>
<pre>removeRule(<i>index</i>)</pre>
...
<tr>
<td>index</td>
<td>可选。要删除的规则在 cssRules 数组中的下标。如果省略该参数，将移除数组的第一条规则。</td>
</tr>
</table>
...
<p>该方法将删除规则数组的指定 <i>index</i> 处的 CSS 样式规则。它是标准的 <a href="/xmldom/met_cssstylesheet_deleterule.asp">deleteRule() 方法</a>的一个特定于 IE 的替代方法。</p>
...
<p>XML DOM 参考手册：<a href="/xmldom/met_cssstylesheet_deleterule.asp">CSSStyleSheet.deleteRule()</a></p>
</div>
