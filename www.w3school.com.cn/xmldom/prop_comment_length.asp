...
<div>
<h2>定义和用法</h2>
<p>length 属性返回注释节点中的文本长度，以字符数计。</p>

<h3>语法：</h3>
<pre>commentNode.length</pre>
</div>

<div>
<h2>实例</h2>

<p>以下代码段使用 JavaScript 函数 <a href="/xmldom/dom_loadxmldoc.asp" title="XML DOM 加载函数">loadXMLDoc()</a> 把 XML 文件 <a href="/example/xdom/books_comment.xml">books_comment.xml</a> 载入 xmlDoc 中，并获得第一个 &lt;book&gt; 元素的注释文本的长度：</p>
...
if (x[i].nodeType==8)
  ...
  document.write(<code>x[i].length</code>);
  document.write(&quot;&lt;br /&gt;&quot;);
  } 
}</pre>
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=xdom_comment_length">length 属性 - 获取注释节点的长度</a></dt>
</dl>
</div>
