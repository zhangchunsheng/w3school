...
<title>XML DOM nodeType 属性</title>
</head>
...
<p>nodeType 属性返回节点的类型。</p>

<h3>语法：</h3>
<pre>attrObject.nodeType</pre>
</div>
...
document.write(<code>x.item(i).attributes[0].nodeType</code> + &quot;)&quot;);
document.write(&quot;&lt;br /&gt;&quot;);
}</pre>
