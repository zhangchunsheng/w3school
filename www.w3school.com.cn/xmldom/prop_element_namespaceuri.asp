...
<p>namespaceURI 属性为被选节点返回命名空间的 URI。</p>

<p>如果选定的节点不是元素或属性，则该属性返回 NULL。</p>

<h3>语法：</h3>
<pre>elementNode.namespaceURI</pre>
</div>
...
<p>下面的代码片段从 &quot;books_ns.xml&quot; 中的第一个 &lt;title&gt; 元素获取命名空间的 URI：</p>

<pre>xmlDoc=loadXMLDoc(&quot;books_ns.xml&quot;);
x=xmlDoc.getElementsByTagName(&quot;title&quot;)[0];

document.write(<code>x.namespaceURI</code>);</pre>
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=xdom_element_namespaceuri">namespaceURI - 从节点获取命名空间的 URI</a></dt>
</dl>
</div>
