...
<title>XML DOM lookupNamespaceURI() 方法</title>
</head>
...
<h1>XML DOM lookupNamespaceURI() 方法</h1>
...
<p>lookupNamespaceURI() 方法返回匹配当前节点上指定的前缀的命名空间。</p>

<h3>语法：</h3>
<pre>elementNode.lookupNamespaceURI(prefix)</pre>
...
<p>下面的代码片段查找第一个 &lt;book&gt; 元素中匹配 &quot;c&quot; 前缀的名字空间：</p>

<pre>xmlDoc=loadXMLDoc(&quot;books_ns.xml&quot;);

x=xmlDoc.getElementsByTagName(&quot;book&quot;)[0];

document.write(<code>x.lookupNamespaceURI(&quot;c&quot;)</code>);</pre>

<p>以上代码的输出：</p>

<pre>http://www.w3school.com.cn/children/</pre>
</div>

<div class="example">
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=xdom_element_lookupnamespaceuri">lookupNamespaceURI() - 通过前缀获取命名空间</a></dt>
</dl>
</div>
