...
<div>
<h2>定义和用法</h2>
<p>appendData() 方法把字符串附加到 <a href="/xmldom/dom_text.asp">Text</a> 或 <a href="/xmldom/met_text_appenddata.asp">Comment</a> 节点上。</p>

<h3>语法：</h3>
<pre>CharacterData.appendData(<i>string</i>)</pre>
...
<tr>
<td>string</td>
<td>必需。要附加到 Text 或 Comment 节点的字符串。</td>
</tr>
</table>

<h3>抛出</h3>

<p>如果调用该方法的节点是只读的，它将抛出具有代码为 NO_MODIFICATION_ALLOWED_ERR 的 <a href="/xmldom/dom_domexception.asp">DOMException 异常</a>。</p>
...
<p>XML DOM 参考手册：<a href="/xmldom/met_text_appenddata.asp">Text.appendData()</a></p>
<p>XML DOM 参考手册：<a href="/xmldom/met_comment_appenddata.asp">Comment.appendData()</a></p>
</div>
