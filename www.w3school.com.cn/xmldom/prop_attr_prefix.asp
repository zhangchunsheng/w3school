...
<p>prefix 属性设置或返回属性的 namespace 前缀。</p>

<h3>语法：</h3>
<pre>attrObject.prefix</pre>
</div>
...
<p>下面的代码片段返回 &quot;lang&quot; 属性的 namespace 前缀：</p>
...
{
document.write(<code>x.item(i).attributes[0].prefix</code>);
document.write(&quot;&lt;br /&gt;&quot;);
}</pre>
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=xdom_attr_prefix">获取属性的前缀、本地名称、命名空间 URI 以及基准 URI</a></dt>
</dl>
</div>
