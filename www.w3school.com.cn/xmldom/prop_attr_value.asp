...
document.write(&quot; = &quot;);
document.write(<code>x.item(i).attributes[0].value</code>);
document.write(&quot;&lt;br /&gt;&quot;);
}</pre>
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=xdom_attr_name">返回属性的名称和值</a></dt>
</dl>
</div>
