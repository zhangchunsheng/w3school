...
<title>XML DOM setStartBefore() 方法</title>
</head>
...
<h1>XML DOM setStartBefore() 方法</h1>
...
<div>
<h2>定义和用法</h2>
<p>setStartBefore() 方法在指定的节点之前开始范围。</p>

<h3>语法：</h3>
<pre>setStartAfter(<i>refNode</i>)</pre>
...
<tr>
<td>refNode</td>
<td>一个节点，要设置的范围的开始点位于该节点之前。</td>
</tr>
</table>


<h3>抛出</h3>
<p>该方法将出于和 <a href="/xmldom/met_range_setendafter.asp" title="XML DOM setEndAfter() 方法">Range.setEndAfter() 方法</a>同样的原因抛出同样的异常。</p>

<h3>描述</h3>
<p>该方法将把范围的开始点设置为指定的 <i>refNode</i> 节点之前的位置。</p>
</div>
