...
<h3>抛出</h3>
<p>如果 <i>refNode</i> 或它的一个祖先节点是 DocumentType 节点，该方法将抛出代码为 INVALID_NODE_TYPE_ERR 的 <a href="/xmldom/dom_rangeexception.asp" title="XML DOM - RangeException 对象">RangeException 异常</a>。</p>
...
<p>如果 <i>offset</i> 是负数，或者大于 <i>refNode</i> 中的子节点数或字符数，该方法将抛出代码为 INDEX_SIZE_ERR 的 <a href="/xmldom/dom_domexception.asp" title="XML DOM - DOMException 对象">DOMException 异常</a>。</p>
