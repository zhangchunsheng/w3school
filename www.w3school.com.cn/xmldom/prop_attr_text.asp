...
<h3>语法：</h3>
<pre>attrObject.text</pre>
</div>

<div>
<h2>提示和注释</h2>
<p class="note"><span>注释：</span>此属性是 Internet Explorer 专用的。</p>
</div>
...
<p>下面的代码片段显示 XML 文档中 category 属性的文本：</p>
...
{
document.write(<code>x.item(i).attributes[0].text</code>);
document.write(&quot;&lt;br /&gt;&quot;);
}</pre>
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=xdom_attr_text">显示属性的文本</a></dt>
</dl>
</div>
