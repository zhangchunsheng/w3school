...
<title>XML DOM renameNode() 方法</title>
</head>
...
<p>renameNode()方法重命名已有的元素节点或属性节点。</p>
<p>如有可能，此方法会改变所给定节点的名称，否则此方法会使用指定的名称来创建一个新节点，然后用此新节点来替换已有节点。</p>
<p>此方法返回已重新命名的节点。</p>

<h3>语法：</h3>
<pre>renameNode(<i>node</i>,<i>uri</i>,<i>name</i>)</pre>
