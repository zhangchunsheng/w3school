...
<title>XML DOM specified 属性</title>
</head>
...
<p>如果在文档中设置了属性值，则 specified 属性返回 true，如果是 DTD/Schema 中的默认值，则返回 false。</p>

<h3>语法：</h3>
<pre>attrObject.specified</pre>
</div>
...
<p>下面的代码片段显示 category 属性的名称和值：</p>
...
{
document.write(<code>x.item(i).attributes[0].specified</code>);
document.write(&quot;&lt;br /&gt;&quot;);
}</pre>
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=xdom_attr_specified">返回是否在文档中设置了属性值</a></dt>
</dl>
</div>
