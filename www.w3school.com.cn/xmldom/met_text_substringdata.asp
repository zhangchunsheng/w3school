...
<div>
<h2>定义和用法</h2>
<p>substringData() 方法从文本节点中获取数据。</p>

<h3>语法：</h3>
<pre>substringData(start,length)</pre>
...
<p>下面的代码片段从 &quot;books.xml&quot; 中的第一个 &lt;title&gt; 元素的文本节点中获取了一个片段，并将它输出：</p>

<pre>xmlDoc=loadXMLDoc(&quot;books.xml&quot;);
x=xmlDoc.getElementsByTagName(&quot;title&quot;)[0].childNodes[0];

y=<code>x.substringData(9,7)</code>;

document.write(x.nodeValue);
document.write(&quot;&lt;br /&gt;&quot;);
document.write(y);</pre>
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=xdom_text_substringdata">substringData() - 提取文本节点中的数据</a></dt>
</dl>
</div>
