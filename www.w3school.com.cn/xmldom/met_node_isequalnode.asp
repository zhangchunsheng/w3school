...
<title>XML DOM isEqualNode() 方法</title>
</head>
...
<div>
<h2>定义和用法</h2>
<p>isEqualNode() 方法可在节点等于某个给定的节点时返回 true，否则返回 false。</p>

<h3>语法：</h3>
<pre>nodeObject.isEqualNode(node)</pre>
