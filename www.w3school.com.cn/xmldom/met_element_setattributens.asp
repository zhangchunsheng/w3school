...
<title>XML DOM setAttributeNS() 方法</title>
</head>
...
<h1>XML DOM setAttributeNS() 方法</h1>
...
<p>setAttributeNS() 方法创建或改变具有命名空间的属性。</p>

<h3>语法：</h3>
<pre>elementNode.setAttributeNS(name,value)</pre>
...
<tr>
<td>ns</td>
<td>必需。规定要设置的属性的命名空间 URI。</td>
</tr>

<tr>
<td>name</td>
<td>必需。规定要设置的属性的名称。</td>
</tr>
...
<h3>说明</h3>
<p>该方法与 <a href="/xmldom/met_element_setattribute.asp" title="XML DOM setAttribute() 方法">setAttribute() 方法</a>类似，只是要创建或设置的属性由命名空间 URI 和限定名（由名字空间前缀、冒号和名字空间中的本地名构成）共同指定。除了可以改变一个属性的值以外，使用该方法还可以改变属性的名字空间前缀。</p>
<p>只有使用名字空间的 XML 文档才会使用该方法。不支持 XML 文档的浏览器可能不会实现该方法。</p>
</div>

<div>
<h2>实例</h2>

<p>在所有的例子中，我们将使用 XML 文件 <a href="/example/xdom/books_ns.xml">books_ns.xml</a>，以及 JavaScript 函数 <a href="/xmldom/dom_loadxmldoc.asp" title="XML DOM 加载函数">loadXMLDoc()</a>。</p>

<h3>例子 1</h3>
<p>下面的代码向 &quot;books_ns.xml&quot; 中的第一个 &lt;book&gt; 元素添加一个 &quot;edition&quot; 属性：</p>
...
<code>x.setAttributeNS(ns,&quot;edition&quot;,&quot;first&quot;);</code>

document.write(x.getAttributeNS(ns,&quot;edition&quot;));</pre>
...
<h3>例子 2</h3>
<p>下面的代码更改了 &quot;books_ns.xml&quot; 中第一个  &lt;title&gt; 元素的 &quot;lang&quot; 属性的值：</p>
...
<code>x.setAttributeNS(ns,&quot;c:lang&quot;,&quot;italian&quot;);</code>

document.write(x.getAttributeNS(ns,&quot;lang&quot;));</pre>
