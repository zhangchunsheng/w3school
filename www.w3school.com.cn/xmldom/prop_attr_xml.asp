...
<p>下面的代码片段显示 XML 文档中 category 属性的 XML：</p>
...
{
document.write(&quot;&lt;xmp&gt;&quot; + <code>x.item(i).attributes[0].xml</code> + &quot;&lt;/xmp&gt;&quot;);
document.write(&quot;&lt;br /&gt;&quot;);
}</pre>

<p>以上代码的输出：</p>

<pre>category=&quot;children&quot;
category=&quot;cooking&quot;
category=&quot;web&quot;
category=&quot;web&quot;
</pre>
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=xdom_attr_xml">显示属性的 XML</a></dt>
</dl>
</div>
