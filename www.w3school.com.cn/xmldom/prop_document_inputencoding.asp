...
<title>XML DOM inputEncoding 属性</title>
</head>
...
<h1>XML DOM inputEncoding 属性</h1>
...
<div>
<h2>定义和用法</h2>
<p>inputEncoding 属性可返回用于文档的编码（在解析时）。</p>

<h3>语法：</h3>
<pre>documentObject.inputEncoding</pre>
</div>
...
<p>以下代码片段可显示 XML 编码、standalone 属性以及文档的 XML 版本：</p>
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=xdom_doc_xmlencoding">取得 XML 编码、standalone 属性以及文档的 XML 版本</a></dt>
</dl>
</div>
