...
<div>
<h2>定义和用法</h2>
<p>namespaceURI 属性可返回某个节点的命名空间 URI。</p>

<h3>语法：</h3>
<pre>nodeObject.namespaceURI</pre>
</div>
...
<p>下面的代码片段可返回 &lt;title&gt; 元素的命名空间 URI：</p>
<pre>
...
for(i=0;i&lt;x.length;i++)
  {
  document.write(<code>x.item(i).namespaceURI</code>);
  document.write(&quot;&lt;br /&gt;&quot;);
  }
</pre>
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=xdom_node_prefix">取得某个节点的前缀、本地名称、命名空间 URI、以及绝对基准 URI</a></dt>
</dl>
</div>
