...
<title>XML DOM internalSubset 属性</title>
</head>
...
<h1>XML DOM internalSubset 属性</h1>
...
<div>
<h2>定义和用法</h2>
<p>internalSubset 属性能够以一个字符串返回内部 DTD（无定界方括号），如果没有则返回 null。</p>

<h3>语法：</h3>
<pre>documentObject.doctype.internalSubset</pre>
</div>
...
<p>以下代码片段能够以字符串显示内部 DTD：</p>
<pre>xmlDoc=loadXMLDoc(&quot;note_internal_dtd.xml&quot;);
document.write(<code>xmlDoc.doctype.internalSubset</code>);</pre>
