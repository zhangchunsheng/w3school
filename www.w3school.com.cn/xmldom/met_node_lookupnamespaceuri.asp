...
<div>
<h2>定义和用法</h2>
<p>lookupNamespaceURI() 方法可返回匹配某个节点上所指定的前缀的命名空间 URI。</p>

<h3>语法：</h3>
<pre>nodeObject.lookupNamespaceURI(prefix)</pre>
...
<p>下面的代码片段可在首个 &lt;book&gt; 元素中查找前缀 &quot;c&quot; 所属的命名空间：</p>
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=xdom_element_lookupnamespaceuri">lookupNamespaceURI() - 通过前缀取得某个命名空间的 URI</a></dt>
</dl>
</div>
