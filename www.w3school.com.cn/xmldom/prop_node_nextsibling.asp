...
<div>
<h2>定义和用法</h2>
<p>nextSibling 属性可返回某个元素之后紧跟的元素（处于同一树层级中）。</p>
<p>如果无此节点，则属性返回 null。</p>

<h3>语法：</h3>
<pre>nodeObject.nextSibling</pre>
</div>
...
<p>下面的代码片段可取得 XML 文档中首个 &lt;title&gt; 元素的下一个同级子节点：</p>
<pre>//check if the next sibling node is an element node
function get_nextsibling(n)
  {
  var x=<code>n.nextSibling</code>;
  while (x.nodeType!=1)
   {
   x=x.nextSibling;
   }
