...
<title>XML DOM getAttributeNode() 方法</title>
</head>
...
<h1>XML DOM getAttributeNode() 方法</h1>
...
<p>getAttributeNode() 方法从当前元素中通过名称获取属性节点。</p>
...
<h3>说明</h3>
<p>该方法将返回一个 Attr 节点，表示指定的属性和值。请注意，通过从 Node 接口继承的 attributes 属性也可以获取该属性节点。</p>
</div>
...
<p>下面的例子从 &quot;books.xml&quot; 中的所有 &lt;book&gt; 元素获取 &quot;category&quot; 属性：</p>
...
{
attnode=<code>x.item(i).getAttributeNode(&quot;category&quot;)</code>;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=xdom_element_getattributenode">getAttributeNode() - 获取拥有特定名称的所有属性节点</a></dt>
</dl>
</div>
