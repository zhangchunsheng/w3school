...
<p>下面的代码片段显示 XML 文档的位置：</p>

<pre>xmlDoc=loadXMLDoc(&quot;books.xml&quot;);
x=xmlDoc.getElementsByTagName(&quot;book&quot;)[0];

document.write(&quot;Document location: &quot; + <code>x.baseURI</code>);</pre>

<p>以上代码的输出：</p>

<pre>Document location: http://www.w3school.com.cn/dom/books.xml</pre>
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=xdom_element_baseuri">baseURI - 获取 XML 文档的位置</a></dt>
</dl>
</div>
