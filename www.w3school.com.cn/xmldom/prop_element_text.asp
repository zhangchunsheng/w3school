...
<p>text 属性返回选定节点中所有文本节点的值。</p>

<h3>语法：</h3>

<pre>elementNode.text</pre>
</div>

<div>
<h2>提示和注释：</h2>
<p class="tip"><span>提示：</span>如需针对 Mozilla 浏览器返回文本节点的文本，请使用 textContent 属性。</p>
</div>
...
document.write(<code>x.text</code>);</pre>
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=xdom_element_text">text - 从元素中获取文本节点</a></dt>
</dl>
</div>
