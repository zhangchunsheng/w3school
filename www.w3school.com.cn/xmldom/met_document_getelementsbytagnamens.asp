...
<title>XML DOM getElementsByTagNameNS() 方法</title>
</head>
...
<h1>XML DOM getElementsByTagNameNS() 方法</h1>
...
<div>
<h2>定义和用法</h2>
<p>getElementsByTagNameNS() 方法可返回带有指定名称和命名空间的所有元素的一个节点列表。</p>

<h3>语法：</h3>
<pre>getElementsByTagNameNS(<i>ns</i>,<i>name</i>)</pre>
...
<tr>
<td>ns</td>
<td>字符串值，可规定需检索的命名空间名称。值 &quot;*&quot; 可匹配所有的标签。</td>
</tr>
<tr>
<td>name</td>
<td>字符串值，可规定需检索的标签名。值 &quot;*&quot; 可匹配所有的标签。</td>
</tr>
</table>

<h3>返回值</h3>
<p>文档树中具有指定命名空间和本地名的 Element 节点的只读数组（从技术上讲，是 <a href="/xmldom/dom_nodelist.asp" title="XML DOM - NodeList 对象">NodeList 对象</a>）。</p>

<h3>说明</h3>
<p>该方法与 <a href="/xmldom/met_document_getelementsbytagname.asp" title="XML DOM getElementsByTagName() 方法">getElementsByTagName() 方法</a>相似，只是它根据命名空间和名称来检索元素。只有使用命名空间的 XML 文档才会使用它。</p>
</div>
...
<p>以下代码片段可向每个 &lt;book&gt; 元素添加一个带有命名空间的元素节点：</p>
<pre>
...
for (i=0;i&lt;x.length;i++)
  {
  newel=<code>xmlDoc.createElementNS('p','edition')</code>;
  newtext=xmlDoc.createTextNode('First');
  newel.appendChild(newtext);
  x[i].appendChild(newel);
  }

<span>//输出所有 title 和 edition</span>
var y=xmlDoc.getElementsByTagName(&quot;title&quot;);
var z=<code>xmlDoc.getElementsByTagNameNS(&quot;p&quot;,&quot;edition&quot;)</code>;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=xdom_createelementns">createElementNS() - 创建带有命名空间的元素节点</a>（不支持 IE 浏览器）</dt>
</dl>
</div>
