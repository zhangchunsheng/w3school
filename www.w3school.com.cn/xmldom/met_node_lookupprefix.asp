...
<title>XML DOM lookupPrefix() 方法</title>
</head>
...
<div>
<h2>定义和用法</h2>
<p>lookupPrefix() 方法可返回在节点上匹配指定的命名空间的前缀。</p>

<h3>语法：</h3>
<pre>nodeObject.lookupPrefix(URI)</pre>
...
<p>下面的代码片段可查找第一个 &lt;book&gt; 元素中所属命名空间 URI 的前缀：</p>

<pre>xmlDoc=loadXMLDoc(&quot;books_ns.xml&quot;);

var x=xmlDoc.getElementsByTagName(&quot;book&quot;)[0];

document.write(<code>x.lookupPrefix(&quot;http://www.w3school.com.cn/children/&quot;)</code>);</pre>
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=xdom_element_lookupprefix">lookupPrefix() - 通过命名空间取得某个前缀</a></dt>
</dl>
</div>
