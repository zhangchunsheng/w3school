...
<title>XML DOM selectNode() 方法</title>
</head>
...
<div>
<h2>定义和用法</h2>
<p>selectNode() 方法把范围边界设置为一个节点。</p>

<h3>语法：</h3>
<pre>selectNode(<i>refNode</i>)</pre>
...
<tr>
<td>refNode</td>
<td>被选中的节点（即将成为当前范围的内容的节点）。</td>
</tr>
</table>


<h3>抛出</h3>
<p>如果 <i>refNode</i> 是 Attr、Document、或 Notation 节点，该方法将抛出代码为 INVALID_NODE_TYPE_ERR 的 <a href="/xmldom/dom_rangeexception.asp" title="XML DOM - RangeException 对象">RangeException 异常</a>。</p>
...
<h3>描述</h3>
<p>该方法将把范围的内容设置为指定的 <i>refNode</i> 节点。也就是说，“选中”那个节点和它的子孙节点。</p>

<h3>参阅</h3>
<p><a href="/xmldom/met_range_selectnodecontents.asp" title="XML DOM selectNodeContents() 方法">Range.selectNodeContents()</a>。</p>
</div>
