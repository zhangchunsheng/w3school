...
<li class="currentLink"><a href="/xmldom/dom_nodes_replace.asp" title="XML DOM 替换节点">DOM 替换节点</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/xmldom/dom_nodes_remove.asp" title="XML DOM 删除节点">DOM 删除节点</a></li>
<li class="next"><a href="/xmldom/dom_nodes_create.asp" title="XML DOM 创建节点">DOM 创建节点</a></li>
</ul>
</div>

<div id="intro">
<p><strong>replaceChild() 方法替换指定节点。</strong></p>
<p><strong>nodeValue 属性替换文本节点中的文本。</strong></p>
</div>
...
<dd>本例使用 replaceChild() 来替换第一个 &lt;book&gt; 节点。</dd>

<dt><a href="/tiy/t.asp?f=xdom_replacedata_2">替换文本节点中的数据</a></dt>
<dd>本例使用 nodeValue 属性来替换文本节点中的数据。</dd>
</dl>
</div>
...
<span>//创建一个 book 元素、一个 title 元素，以及一个 text 节点</span>
newNode=xmlDoc.createElement(&quot;book&quot;);
newTitle=xmlDoc.createElement(&quot;title&quot;);
newText=xmlDoc.createTextNode(&quot;Hello World&quot;);

<span>//向 title 节点添加文本节点</span>
newTitle.appendChild(newText);

<span>//向 book 节点添加 title 节点</span>
newNode.appendChild(newTitle);

y=xmlDoc.getElementsByTagName(&quot;book&quot;)[0];

<span>//用这个新节点替换第一个 book 节点</span>
...
<li>创建一个新的文本节点，带有文本 &quot;Hello World&quot;</li>
<li>向新元素节点 &lt;title&gt; 追加这个新文本节点</li>
<li>向新元素节点 &lt;book&gt; 追加这个新元素节点 &lt;title&gt;</li>
<li>用新的 &lt;book&gt; 元素节点替换第一个 &lt;book&gt; 元素节点</li>
</ul>

<p><a href="/tiy/t.asp?f=xdom_replacechild">TIY</a></p>
</div>
...
<li>使用 replaceDat 方法把文本节点的前 8 个字符替换为 &quot;hello&quot;</li>
</ul>

<p><a href="/tiy/t.asp?f=xdom_replacedata">TIY</a></p>
</div>

<div>
<h2>使用 nodeValue 属性</h2>
...
<p><a href="/tiy/t.asp?f=xdom_replacedata_2">TIY</a></p>

<p>您可以在 <a href="/xmldom/dom_nodes_set.asp" title="XML DOM 改变节点值">改变节点</a> 这一节中阅读更多有关更改节点值的内容。</p>
</div>
