...
<title>XML DOM systemId 属性</title>
</head>
...
<div>
<h2>定义和用法</h2>
<p>systemId 属性可返回外部 DTD 的系统标识符。</p>

<h3>语法：</h3>
<pre>documentObject.doctype.systemId</pre>
</div>

<div>
<h2>实例</h2>

<p>在所有的例子中，我们将使用 XML 文件 <a href="/example/xdom/note_external_dtd.xml">note_external_dtd.xml</a>，以及 JavaScript 函数 <a href="/xmldom/dom_loadxmldoc.asp" title="XML DOM 加载函数">loadXMLDoc()</a>。</p>

<p>以下代码片段可显示与 XML 文档相关联的外部 DTD 的系统 id：</p>
<pre>xmlDoc=loadXMLDoc(&quot;note_external_dtd.xml&quot;);
document.write(<code>xmlDoc.doctype.systemId</code>);</pre>
...
<h2>DIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=xdom_systemid">取得 XML 文档中的外部 DTD 的系统标识符</a></dt>
</dl>
</div>
