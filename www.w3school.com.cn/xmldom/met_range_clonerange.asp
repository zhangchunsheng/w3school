...
<title>XML DOM cloneRange() 方法</title>
</head>
...
<div>
<h2>定义和用法</h2>
<p>cloneRange() 方法复制该范围。</p>

<h3>语法：</h3>
<pre>cloneRange()</pre>

<h3>返回值</h3>
<p>返回新创建的 <a href="/xmldom/dom_range.asp" title="XML DOM - Range 对象">Range 对象</a>。</p>
</div>


<div>
<h2>参阅</h2>
<p><a href="/xmldom/met_document_createrange.asp" title="XML DOM createRange() 方法">Document.createRange()</a></p>
</div>
