...
<p>cloneNode() 方法创建指定节点的精确拷贝。</p>

<p>此方法返回被克隆的节点。</p>
<h3>语法：</h3>
<pre>cloneNode(include_all)</pre>
...
<tr>
<td>include_all</td>
<td>必需。如果这个布尔参数设置为 true，被克隆的节点会复制原始节点的所有子节点。</td>
</tr>
</table>
</div>
...
<p>下面的代码片段复制第一个 &lt;book&gt; 节点，然后把此备份添加到节点列表的末尾：</p>

<pre>xmlDoc=loadXMLDoc(&quot;books.xml&quot;);

oldNode=xmlDoc.getElementsByTagName('book')[0];
newNode=<code>oldNode.cloneNode(true)</code>;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=xdom_clonenode">cloneNode() - 复制并追加节点</a></dt>
</dl>
</div>
