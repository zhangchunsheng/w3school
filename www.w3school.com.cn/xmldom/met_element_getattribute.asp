...
<title>XML DOM getAttribute() 方法</title>
</head>
...
<div>
<h2>提示和注释</h2>
<p>对于使用名称空间的 XML 文档来说，需要使用 <a href="/xmldom/met_element_getattributens.asp" title="XML DOM getAttributeNS() 方法">getAttributeNS() 方法</a>。</p>
</div>
...
<p>下面的代码片段获取所有 &lt;book&gt; 元素中 &quot;category&quot; 属性的值：</p>
...
{
document.write(<code>x[i].getAttribute('category')</code>);
document.write(&quot;&lt;br /&gt;&quot;);
}</pre>
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=xdom_getattribute">getAttribute() - 获取指定属性的值</a></dt>
</dl>
</div>
