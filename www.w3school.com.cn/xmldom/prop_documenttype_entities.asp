...
<title>XML DOM entities 属性</title>
</head>
...
<h1>XML DOM entities 属性</h1>

<div>
<p><a href="/xmldom/dom_documenttype.asp">DocumentType 对象参考手册</a></p>
</div>

<div>
<h2>定义和用法</h2>
<p>entities 属性可返回包含有在 DTD 中所声明的外部实体和内部实体的 NamedNodeMap。</p>

<h3>语法：</h3>
<pre>documentObject.doctype.entities</pre>
</div>
...
<p>以下代码片段可显示在 DTD 中声明过的实体的节点名称和节点类型：</p>
<pre>xmlDoc=loadXMLDoc(&quot;note_internal_dtd.xml&quot;);

var x=<code>xmlDoc.doctype.entities</code>
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=xdom_documenttype_entities">取得在 XML 文档的 DTD 中声明过的实体</a></dt>
</dl>
</div>
