...
<title>XML DOM ownerElement 属性</title>
</head>
...
<p>ownerElement 属性返回 attribute 所附属的元素节点。</p>

<h3>语法：</h3>
<pre>attrObject.ownerElement</pre>
</div>
...
<p>下面的代码片段返回第一个 category 属性所附属的元素：</p>

<pre>xmlDoc=loadXMLDoc(&quot;/example/xdom/books.xml&quot;);

x=xmlDoc.getElementsByTagName('book');

document.write(<code>x.item(0).attributes[0].ownerElement</code>);
document.write(&quot;&lt;br /&gt;&quot;);
document.write(<code>x.item(0).attributes[0].ownerElement.nodeName</code>);
document.write(&quot;&lt;br /&gt;&quot;);
document.write(<code>x.item(0).attributes[0].ownerElement.nodeType</code>);</pre>
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=xdom_attr_ownerelement">ownerElement - 获取属性所属的元素节点</a></dt>
</dl>
</div>
