...
<div>
<h2>定义和用法</h2>
<p>textContent 属性可设置或返回节点及其后代的文本内容。</p>
<p>关于设置，任何子节点可被删除，并被一个单独的文本节点所替换，所替换的内容是此属性所设置的字符串。</p>

<h3>语法：</h3>
<pre>nodeObject.textContent</pre>
</div>
...
for(i=0;i&lt;x.length;i++)
  {
  document.write(<code>x.item(i).textContent</code>);
  document.write(&quot;&lt;br /&gt;&quot;);
  }
</pre>
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=xdom_node_textcontent">textContent - 取得某节点的文本内容</a>（IE 不支持）</dt>
<dt><a href="/tiy/t.asp?f=xdom_node_textcontent_set">textContent - 设置某节点的文本内容</a>（IE 不支持）</dt>
</dl>
</div>
