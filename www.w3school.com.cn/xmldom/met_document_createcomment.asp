...
<title>XML DOM createComment() 方法</title>
</head>
...
<h1>XML DOM createComment() 方法</h1>
...
<div>
<h2>定义和用法</h2>
<p>createComment() 方法可创建注释节点。</p>
<p>此方法可返回一个 Comment 对象。</p>

<h3>语法：</h3>
<pre>createComment(data)</pre>
...
<h3>返回值</h3>
<p>返回新创建的 Comment 节点，文本为指定的 data。</p>
</div>
...
for (i=0;i&lt;x.length;i++)
  {
  newComment=<code>xmlDoc.createComment(newtext)</code>;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=xdom_createcomment">createComment() - 创建注释节点</a></dt>
</dl>
</div>
