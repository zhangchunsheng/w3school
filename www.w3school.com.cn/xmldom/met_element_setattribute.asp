...
<title>XML DOM setAttribute() 方法</title>
</head>
...
<h3>说明</h3>
<p>该方法把指定的属性设置为指定的值。如果不存在具有指定名称的属性，该方法将创建一个新属性。</p>
</div>
...
<p>下面的代码片段向 &quot;books.xml&quot; 中的所有 &lt;book&gt; 元素添加一个 &quot;edition&quot; 属性：</p>
...
{
<code>x.item(i).setAttribute(&quot;edition&quot;,&quot;first&quot;);</code>
}
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=xdom_setattribute">setAttribute() - 改变属性的值</a></dt>

<dt><a href="/tiy/t.asp?f=xdom_setattribute2">setAttribute() - 创建新的属性和属性值</a></dt>
</dl>
</div>
