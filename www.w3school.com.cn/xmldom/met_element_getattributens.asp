...
<title>XML DOM getAttributeNS() 方法</title>
</head>
...
<h1>XML DOM getAttributeNS() 方法</h1>
...
<p>getAttributeNS() 方法通过命名空间 URI 和名称来获取属性值。</p>

<h3>语法：</h3>
<pre>elementNode.getAttributeNS(ns,name)</pre>
...
<tr>
<td>ns</td>
<td>必需。规定从中获取属性值的命名空间 URI。</td>
</tr>

<tr>
<td>name</td>
<td>必需。规定从中取得属性值的属性。</td>
</tr>
</table>
</div>
...
<p>下面的代码片段从 &quot;books_ns.xml&quot; 中的第一个 &lt;title&gt; 元素中获取 &quot;lang&quot; 属性的值：</p>
...
document.write(<code>x.getAttributeNS(ns,&quot;lang&quot;)</code>);</pre>
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=xdom_element_getattributens">getAttributeNS() - 通过名称和命名空间来获取属性的值</a></dt>
</dl>
</div>
