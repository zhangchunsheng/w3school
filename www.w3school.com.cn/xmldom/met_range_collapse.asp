...
<title>XML DOM collapse() 方法</title>
</head>
...
<div>
<h2>定义和用法</h2>
<p>collapse() 方法是范围的边界点重合。</p>

<h3>语法：</h3>
<pre>collapse(<i>toStart</i>)</pre>

<h3>参数</h3>
<p>如果把参数 <i>toStart</i> 设置为 true，该方法将把范围的结束点设置为与开始点相同的值。否则，它将把范围的开始点设置为与结束点相同的值。</p>

<h3>描述</h3>
<p>该方法将设置范围的一个边界点，使它与另一个边界点相同。要修改的边界点由参数 <i>toStart</i> 指定。该方法返回后，范围将“折叠”，即表示文档中的一个点，没有内容。当范围被折叠后，它的 collapsed 属性将被设置为 true。</p>
</div>
