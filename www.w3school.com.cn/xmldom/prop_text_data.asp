...
<div>
<h2>定义和用法</h2>
<p>data 属性设置或返回元素或属性的文本。</p>

<h3>语法：</h3>
<pre>textNode.data</pre>
</div>
...
<p>下面的代码片段输出 &quot;books.xml&quot; 中的第一个 &lt;title&gt; 元素的文本：</p>
<pre>xmlDoc=loadXMLDoc(&quot;books.xml&quot;);

x=xmlDoc.getElementsByTagName(&quot;title&quot;)[0].childNodes[0];

document.write(<code>x.data</code>);</pre>

<h3>输出：</h3>
<pre>Everyday Italian</pre>
</div>

<div class="example">
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=xdom_text_data">data - 获取文本节点的数据</a></dt>
</dl>
</div>
