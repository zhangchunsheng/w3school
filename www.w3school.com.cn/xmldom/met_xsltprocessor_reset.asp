...
<p>reset() 方法把一个 XSLTProcessor 恢复为默认状态。</p>

<h3>语法：</h3>
<pre>reset()</pre>

<h3>说明</h3>
<p>这个方法把一个 XSLTProcessor 恢复为它的默认状态，就是它第一次创建时所处的状态。在调用这个方法之后，就没有和 XSLTProcessor 相关联的样式表和参数。</p>
</div>
