...
<p>compareDocumentPosition() 方法按照文档顺序，比较当前节点与指定节点的文档位置。</p>

<p>该方法返回新的子节点。</p>

<h3>语法：</h3>
<pre>elementNode.compareDocumentPostition(node)</pre>
...
<p>下面的代码片段比较 &quot;books.xml&quot; 中第一个与第三个 &lt;book&gt; 节点：</p>
...
<p class="note"><span>注释：</span>Internet Explorer 会忽略节点之间生成的空白文本节点（比如换行字符），而 Mozilla 不这么做。因此，在上面的例子中，Mozilla 输出 4，而 Internet Explorer 输出 2。</p>
