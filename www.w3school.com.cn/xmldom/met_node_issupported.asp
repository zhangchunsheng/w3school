...
<title>XML DOM isSupported() 方法</title>
</head>
...
<div>
<h2>定义和用法</h2>
<p>isSupported() 方法用于判断当前节点是否支持某个特性。</p>

<h3>语法：</h3>
<pre>nodeObject.isSupported(feature, version)</pre>
...
<tr>
<td>version</td>
<td>要检测的特性的版本号，如果要检测对该特性的版本的支持，则为空串。</td>
</tr>
</table>

<h3>返回值</h3>
<p>如果当前节点支持指定特性的指定版本，则返回 true，否则返回 false。</p>

<h3>说明</h3>
<p>W3C DOM 标准被模块化，它的实现不必实现标准规定的所有模块或特性。该方法用于检测当前节点的实现是否支持支持指定特性的指定版本。</p>

<p>关于参数 feature 和 version 的值的列表，请参阅 “DOMImplementation.hasFeature()” 参考页。</p>

<h3>参阅</h3>
<p><a href="/xmldom/met_domimplementation_hasfeature.asp" title="XML DOM hasFeature() 方法">DOMImplementation.hasFeature()</a></p>
</div>
