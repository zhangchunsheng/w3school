...
<div>
<h2>定义和用法</h2>
<p>baseURI 属性返回属性 (attribute) 的绝对基准 URI。</p>

<h3>语法：</h3>
<pre>elementNode.baseURI</pre>
</div>
...
{
document.write(<code>x.item(i).attributes[0].baseURI</code>);
document.write(&quot;&lt;br /&gt;&quot;);
}</pre>
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=xdom_attr_baseuri">获取属性的基准 URI</a>（IE 浏览器不支持）</dt>
</dl>
</div>
