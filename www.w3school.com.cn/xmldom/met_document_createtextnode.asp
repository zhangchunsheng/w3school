...
<title>XML DOM createTextNode() 方法</title>
</head>
...
<h1>XML DOM createTextNode() 方法</h1>
...
<p>createTextNode() 可创建文本节点。</p>
<p>此方法可返回 <a href="/xmldom/dom_text.asp" title="XML DOM - Text 对象">Text 对象</a>。</p>


<h3>语法：</h3>
<pre>createTextNode(<i>data</i>)</pre>
...
<tr>
<td>data</td>
<td>字符串值，可规定此节点的文本。</td>
</tr>
</table>

<h3>返回值</h3>
<p>返回新创建的 Text 节点，表示指定的 <i>data</i> 字符串。</p>
</div>
...
<p>以下代码片段可向每个 &lt;book&gt; 元素添加一个带有文本节点的元素节点：</p>
<pre>
...
for (i=0;i&lt;x.length;i++)
  ...
  newtext=<code>xmlDoc.createTextNode('First')</code>;
