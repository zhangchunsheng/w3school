...
<title>XML DOM lastChild 属性</title>
</head>
...
<h3>语法：</h3>
<pre>documentObject.lastChild</pre>
</div>
...
<p>以下代码片段可显示文档的最后一个子节点的节点名称和节点类型：</p>
<pre>
<span>//检查最后一个节点是否是 element 节点</span>
function get_lastchild(n)
{
var x=<code>n.lastChild</code>;
while (x.nodeType!=1)
{
x=x.previousSibling;
}
