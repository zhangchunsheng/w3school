...
<div>
<h2>定义和用法</h2>
<p>childNodes 属性可返回 document 的子节点的 NodeList。</p>

<h3>语法：</h3>
<pre>documentObject.childNodes</pre>
</div>

<div>
<h2>提示和注释：</h2>
<p class="tip"><span>提示：</span>请使用 NodeList 的长度属性来测定节点列表中的节点数目。在您已知晓节点列表的长度后，就能够轻易地循环遍历此节点，并提取您需要的值！</p>
</div>
...
<p>下面的代码片段可显示 XML 文档的子节点：</p>
<pre>xmlDoc=loadXMLDoc(&quot;/example/xdom/books.xml&quot;);

var x=<code>xmlDoc.childNodes</code>;
...
<h3>IE 的输出：</h3>
<pre>Nodename: xml (nodetype: 7)
Nodename: #comment (nodetype: 8)
Nodename: #comment (nodetype: 8)
Nodename: bookstore (nodetype: 1)</pre>

<h3>Mozilla (Firefox) 的输出：</h3>
<pre>Nodename: #comment (nodetype: 8)
Nodename: #comment (nodetype: 8)
Nodename: bookstore (nodetype: 1)</pre>
</div>
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=xdom_document_childnodes">显示 XML 文档的子节点</a></dt>
<dt><a href="/tiy/t.asp?f=xdom_nodetype">显示 XML 文档中所有元素的所有子节点</a></dt>
</dl>
</div>
