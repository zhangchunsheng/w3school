...
<div>
<h2>定义和用法</h2>
<p>ownerDocument 可返回某元素的根元素。</p>

<h3>语法：</h3>
<pre>nodeObject.ownerDocument</pre>
</div>
...
<p>下面的代码片段可XML文档中首个 &lt;title&gt; 节点的根元素：</p>
<pre>
xmlDoc=loadXMLDoc(&quot;books.xml&quot;);

var x=<code>xmlDoc.getElementsByTagName(&quot;title&quot;)[0].ownerDocument</code>;
...
<h3>输出：</h3>
<pre>Nodename: #document (nodetype: 9)</pre>
</div>

<div class="example">
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=xdom_ownerdocument">ownerDocument - 取得某个节点的根元素（document对象）</a></dt>
</dl>
</div>
