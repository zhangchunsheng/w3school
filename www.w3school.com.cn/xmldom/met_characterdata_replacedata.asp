...
<title>XML DOM replaceData() 方法</title>
</head>
...
<div>
<h2>定义和用法</h2>
<p>replaceData() 方法用指定的字符串替换 <a href="/xmldom/dom_text.asp">Text</a> 或 <a href="/xmldom/met_text_appenddata.asp">Comment</a> 节点的字符。</p>

<h3>语法：</h3>
<pre>CharacterData.replaceData(<i>start</i>,<i>length</i>,<i>string</i>)</pre>
...
<tr>
<td>start</td>
<td>必需。要把字符串插入 Text 节点或 Comment 节点的字符位置。</td>
</tr>
...
<p>NO_MODIFICATION_ALLOWED_ERR - 节点是只读的，不能修改。</p>

<h3>描述</h3>

<p>该方法将用字符串 <i>string</i> 替换从 <i>start</i> 开始的 <i>length</i> 个字符。如果 <i>start</i> 加 <i>length</i> 大于 Text 节点或 Comment 节点中的字符数，那么替换从 <i>start</i> 开始到字符串结尾的所有字符。</p>
</div>
