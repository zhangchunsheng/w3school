...
<title>XML DOM timeStamp 事件属性</title>
</head>
...
<p>timeStamp 事件属性可返回一个时间戳。指示发生事件的日期和时间（从 epoch 开始的毫秒数）。</p>
<p>epoch 是一个事件参考点。在这里，它是客户机启动的时间。</p>
<p>并非所有系统都提供该信息，因此，timeStamp 属性并非对所有系统/事件都是可用的。</p>

<h3>语法</h3>
<pre>event.timeStamp</pre>
</div>

<div>
<h2>实例</h2>
<p>下面的例子可获得系统启动开始的事件戳：</p>
<pre>&lt;html&gt;
&lt;head&gt;
&lt;script type=&quot;text/javascript&quot;&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_event_timestamp">timestamp event</a></dt>
<dd>返回系统启动至今的分钟数（IE 浏览器不支持）。</dd>
</dl>
</div>
