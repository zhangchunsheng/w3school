...
<title>XML DOM baseURI 属性</title>
</head>
...
<div>
<h2>定义和用法</h2>
<p>baseURI 属性可返回某个节点的绝对基准 URI。</p>

<h3>语法</h3>
<pre>nodeObject.baseURI</pre>
</div>
...
for(i=0;i&lt;x.length;i++)
  {
  document.write(<code>x.item(i).baseURI</code>);
  document.write(&quot;&lt;br /&gt;&quot;);
  }
</pre>

<h3>输出：</h3>
<pre>http://www.w3school.com.cn/dom/books_ns.xml
http://www.w3school.com.cn/dom/books_ns.xml</pre>
</div>

<div>
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=xdom_node_prefix">取得某个节点的前缀、本地名称、命名空间 URI、以及绝对基准 URI</a>（IE 不支持）</dt>
</dl>
</div>
