...
<li class="currentLink"><a href="/xmldom/dom_nodes_clone.asp" title="XML DOM 克隆节点">DOM 克隆节点</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/xmldom/dom_nodes_add.asp" title="XML DOM 添加节点">DOM 添加节点</a></li>
<li class="next"><a href="/xmldom/dom_httprequest.asp" title="XMLHttpRequest 对象">DOM HttpRequest</a></li>
</ul>
</div>
...
<p>cloneNode() 方法有一个参数（true 或 false）。该参数指示被复制的节点是否包括原节点的所有属性和子节点。</p>

<p>下面的代码片段拷贝第一个 &lt;book&gt; 节点，并把它追加到文档的根节点：</p>
...
<li>获取要复制的节点</li>
<li>通过使用 cloneNode 方法把节点复制到 &quot;newNode&quot; 中</li>
<li>向 XML 文档的根节点追加新节点</li>
<li>输出文档中所有 book 的 title</li>
</ol>

<p><a href="/tiy/t.asp?f=xdom_clonenode">TIY</a></p>
</div>
