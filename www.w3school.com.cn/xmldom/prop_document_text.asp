...
<div>
<h2>定义和用法</h2>
<p>text 属性可返回某个节点及其后代的文本。</p>

<h3>语法：</h3>
<pre>documentObject.text</pre>
</div>

<div>
<h2>提示和注释：</h2>
<p class="note"><span>注释：</span>此属性只可用于 Internet Explorer ！</p>
</div>
...
<p>以下代码片段可显示 XML 文档的文本：</p>
<pre>xmlDoc=loadXMLDoc(&quot;books.xml&quot;);
document.write(<code>xmlDoc.text</code>);</pre>

<h3>输出：</h3>
<pre>Harry Potter J K. Rowling 2005 29.99 
Everyday Italian Giada De Laurentiis 2005 30.00 
Learning XML Erik T. Ray 2003 39.95 
XQuery Kick Start James McGovern Per Bothner 
Kurt Cagle James Linn Vaidyanathan Nagarajan 2003 49.99</pre>
</div>

<div class="example">
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=xdom_document_text">显示 XML 文档的文本</a></dt>
</dl>
</div>
