...
<title>XML DOM removeAttribute() 方法</title>
</head>
...
<h1>XML DOM removeAttribute() 方法</h1>
...
<p>removeAttribute() 方法删除指定的属性。如果文档类型声明 (DTD) 为指定的属性设置了默认值，那么接下来调用 <a href="/xmldom/met_element_getattribute.asp" title="XML DOM getAttribute() 方法">getAttribute() 方法</a>将返回那个默认值。</p>

<p>删除不存在的属性或没有设置但具有默认值属性的操作将被忽略。</p>

<h3>语法：</h3>
<pre>elementNode.removeAttribute(name)</pre>
...
<p>下面的代码片段删除 &quot;books.xml&quot; 中所有 &lt;book&gt; 元素的 &quot;category&quot; 属性：</p>
...
{
<code>x[i].removeAttribute('category'));</code>
}</pre>
</div>
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=xdom_removeattribute">removeAttributes() - 删除属性</a></dt>
</dl>
</div>
