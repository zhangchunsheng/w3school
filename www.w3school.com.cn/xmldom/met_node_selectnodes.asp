...
<title>XML DOM selectNodes() 方法</title>
</head>
...
<div>
<h2>定义和用法</h2>
<p>selectNodes() 方法用一个 XPath 查询选择节点。</p>

<h3>语法：</h3>
<pre>nodeObject.selectNodes(query)</pre>
...
<h3>返回值</h3>
<p>包含了匹配查询的节点的一个 NodeList。</p>

<h3>说明</h3>
<p>这个特定于 IE 的方法计算一个 XPath 表达式，使用该节点作为查询的根节点，并且将结果作为一个 NodeList 返回。这个 selectNodes() 方法只用于 XML 文档节点，不用于 HTML 文档节点。注意，既然 <a href="/xmldom/dom_document.asp" title="XML DOM - Document 对象">Document 对象</a>是它们自己的节点，这个方法可以应用于整个 XML 文档。</p>
