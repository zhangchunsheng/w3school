...
<title>XML DOM target 事件属性</title>
</head>
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_event_target">target event</a></dt>
<dd>获得触发事件的元素（IE 浏览器不支持）。</dd>
</dl>
</div>
