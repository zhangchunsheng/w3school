...
<title>XML DOM setAttributeNode() 方法</title>
</head>
...
<h1>XML DOM setAttributeNode() 方法</h1>
...
<p>setAttributeNode() 方法添加新的属性节点。</p>

<p>如果元素中已经存在指定名称的属性，那么该属性将被新属性替代。如果新属性替代了已有的属性，则返回被替代的属性，否则返回 NULL。</p>

<h3>语法：</h3>
<pre>elementNode.setAttributeNode(att_node)</pre>
...
<h3>说明</h3>
<p>该方法将给 Element 节点的属性集合添加新的 Attr 节点。如果当前 Element 已经具有一个同名的属性，该方法将用新属性替换那个属性，返回被替换的 Attr 节点。如果不存在这样的属性，该方法将为 Element 定义一个新属性。</p>
<p>通常，用 <a href="/xmldom/met_element_setattribute.asp" title="XML DOM setAttribute() 方法">setAttribute() 方法</a>比用 setAttributeNode() 简单。</p>
</div>
...
<p>下面的代码向 &quot;books.xml&quot; 中的所有 &lt;book&gt; 元素添加了 &quot;edition&quot; 属性：</p>
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=xdom_createattribute">setAttributeNode() - 创建并插入一个新的 Attr 节点</a></dt>
</dl>
</div>
