...
<h3>语法：</h3>
<pre>insertBefore(newchild,refchild)</pre>
...
<p>下面的下面片段可创建一个新的 &lt;book&gt; 节点，并在文档中的最后一个 &lt;book&gt; 元素前插入此节点：</p>
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=xdom_insertbefore">insertBefore() - 在某个指定的节点前插入节点</a></dt>
</dl>
</div>
