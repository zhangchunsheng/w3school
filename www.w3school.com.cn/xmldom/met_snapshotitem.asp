...
<title>XML DOM snapshotItem() 方法</title>
</head>
...
<div>
<h2>定义和用法</h2>
<p>iterateNext() 方法返回与一个 XPath 查询匹配的一个节点。</p>

<h3>语法：</h3>
<pre>snapshotItem(index)</pre>
...
<h3>返回值</h3>
<p>指定下标的节点，如果下标小于 0 或者大于或等于 snapshotLength，则为 null。</p>

<h3>抛出</h3>
<p>如果 resultType 不是 UNORDERED_NODE_SNAPSHOT_TYPE 或 ORDERED_NODE_SNAPSHOT_TYPE 的时候调用，该方法会抛出异常。</p>
</div>
