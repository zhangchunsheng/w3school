...
<div>
<h2>定义和用法</h2>
<p>async 属性可规定 XML 文件的下载是否应当被同步处理。</p>
<p>True 意味着 load() 方法可在下载完成之前向调用程序返回控制权。</p>
<p>False 意味着在调用程序取回控制权之前必须完成下载。</p>

<h3>语法：</h3>
<pre>documentObject.async</pre>
</div>
