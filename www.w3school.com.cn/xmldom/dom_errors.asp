...
<li class="currentLink"><a href="/xmldom/dom_errors.asp" title="XML DOM ParseError 对象">DOM ParseError</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/xmldom/dom_nodelist.asp" title="XML DOM NodeList 对象">DOM NodeList</a></li>
<li class="next"><a href="/xmldom/dom_processinginstruction.asp" title="XML DOM ProcessingInstr 对象">DOM ProcessingInstr</a></li>
</ul>
</div>
...
<p><a href="/tiy/t.asp?f=xdom_note_error">TIY</a></p>
</div>

<div>
<h2>XML 错误（XML Error）</h2>
<p>在下面的代码中，我们会让解析器加载一个形式不良的 XML 文档。</p>
<p>（您可以在我们的 <a href="/xml/index.asp" title="XML 教程">XML 教程</a> 中阅读更多有关形式良好且有效的 XML。）</p>
<pre>var xmlDoc = new ActiveXObject(&quot;Microsoft.XMLDOM&quot;)
xmlDoc.async=&quot;false&quot;
...
document.write(&quot;&lt;br /&gt;Error reason: &quot; + xmlDoc.parseError.reason)
document.write(&quot;&lt;br /&gt;Error line: &quot; + xmlDoc.parseError.line)</pre>
<p><a href="/tiy/t.asp?f=xdom_note_error_two">TIY</a> 或 <a href="/example/xdom/note_error.xml">仅仅查看此XML文件</a></p>
</div>
