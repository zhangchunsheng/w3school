...
<li class="currentLink"><a href="/xmldom/dom_nodes_access.asp" title="XML DOM 访问节点">DOM 访问节点</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/xmldom/dom_methods.asp" title="XML DOM - 属性和方法">DOM 属性和方法</a></li>
<li class="next"><a href="/xmldom/dom_nodes_info.asp" title="XML DOM 节点信息">DOM 节点信息</a></li>
</ul>
</div>
...
<p>下面的代码通过使用 <a href="/xmldom/dom_loadxmldoc.asp" title="XML DOM 加载函数">loadXMLDoc()</a> 把 &quot;<a href="/example/xdom/books.xml">books.xml</a>&quot; 载入 xmlDoc 中，然后在变量 x 中存储 &lt;title&gt; 节点的一个列表：</p>
...
<p><a href="/tiy/t.asp?f=xdom_index">TIY</a></p>
...
<ol>
<li>使用 <a href="/xmldom/dom_loadxmldoc.asp">loadXMLDoc()</a> 把 &quot;<a href="/example/xdom/books.xml">books.xml</a>&quot; 载入 xmlDoc</li>
<li>取得所有 &lt;title&gt; 元素节点</li>
<li>输出每个 &lt;title&gt; 元素的文本节点的值</li>
</ol>

<p><a href="/tiy/t.asp?f=xdom_list_loop">TIY</a></p>
</div>
...
<ol>
<li>通过使用 <a href="/xmldom/dom_loadxmldoc.asp">loadXMLDoc()</a> 把 &quot;<a href="/example/xdom/books.xml">books.xml</a>&quot; 载入 xmlDoc 中</li>
<li>获得根元素的子节点</li>
<li>检查每个子节点的节点类型。如果节点类型是 &quot;1&quot;，则是元素节点</li>
<li>如果是元素节点，则输出节点的名称</li>
</ol>

<p><a href="/tiy/t.asp?f=xdom_loop">TIY</a></p>
</div>
...
<p><a href="/tiy/t.asp?f=xdom_navigate">TIY</a></p>
</div>
