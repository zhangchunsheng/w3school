...
<title>XML DOM normalize() 方法</title>
</head>
...
<div>
<h2>定义和用法</h2>
<p>合并相邻的 Text 节点并删除空的 Text 节点。</p>

<h3>语法：</h3>
<pre>nodeObject.normalize()</pre>

<h3>说明</h3>
<p>这个方法将遍历当前节点的所有子孙节点，通过删除空的 Text 节点，已经合并所有相邻的 Text 节点来规范化文档。该方法在进行节点的插入或删除操作后，对于简化文档树的结构很有用。</p>

<h3>参阅</h3>
<p><a href="/xmldom/dom_text.asp" title="XML DOM - Text 对象">Text</a></p>
</div>
