...
<p>nodeType 属性返回被选节点的节点类型。</p>

<h3>语法：</h3>
<pre>elementNode.nodeType</pre>

<table class="dataintable">
	<tr>
		<th style="width:30%">节点编号：</th>
...
<p>下面的代码片段获取 &quot;books.xml&quot; 的第一个 &lt;title&gt; 元素的节点类型：</p>

<pre>xmlDoc=loadXMLDoc(&quot;books.xml&quot;);

x=xmlDoc.getElementsByTagName(&quot;title&quot;)[0];
document.write(<code>x.nodeType</code>);</pre>
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=xdom_nodetype">nodeType - 获取整个 XML 文档的节点类型</a></dt>

<dt><a href="/tiy/t.asp?f=xdom_firstchild">nodeType - 忽略空的文本节点</a></dt>
</dl>
</div>
