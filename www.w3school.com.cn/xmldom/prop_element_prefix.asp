...
<p>prefix 属性返回选定的节点的命名空间前缀。</p>

<p>如果选定的节点不是元素或属性，则该属性返回 NULL。</p>

<h3>语法：</h3>
<pre>elementNode.prefix</pre>
</div>
...
<p>下面的代码片段获取 &quot;books_ns.xml&quot; 中的第一个 &lt;title&gt; 元素的命名空间前缀：</p>

<pre>xmlDoc=loadXMLDoc(&quot;books_ns.xml&quot;);
x=xmlDoc.getElementsByTagName(&quot;title&quot;)[0];

document.write(<code>x.prefix</code>);</pre>
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=xdom_element_prefix">prefix - 从节点获取命名空间前缀</a></dt>
</dl>
</div>
