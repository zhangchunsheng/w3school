...
<p>以下代码段使用 JavaScript 函数 <a href="/xmldom/dom_loadxmldoc.asp" title="XML DOM 加载函数">loadXMLDoc()</a> 把 XML 文件 <a href="/example/xdom/books_comment.xml">books_comment.xml</a> 载入 xmlDoc 中，并把文本附加到第一个 comment 节点：</p>
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=xdom_comment_appenddata">appendData() - 把字符串附加到注释节点</a></dt>
</dl>
</div>
