...
<title>XML DOM hasAttributeNS() 方法</title>
</head>
...
<h1>XML DOM hasAttributeNS() 方法</h1>
...
<p>如果属性由指定的命名空间和名称组成，则 hasAttributeNS() 方法返回 true，否则返回 false。</p>

<h3>语法：</h3>
<pre>hasAttributeNS(ns,name)</pre>
...
<tr>
<td>ns</td>
<td>必需。规定要检索的属性的命名空间。</td>
</tr>

<tr>
<td>name</td>
<td>必需。规定要检索的属性的名称。</td>
</tr>
</table>

<h3>说明</h3>
<p>该方法与 <a href="/xmldom/met_element_hasattribute.asp" title="XML DOM hasAttribute() 方法">hasAttribute() 方法</a>类似，只是要检查的属性由命名空间和名称指定。只有使用命名空间的 XML 文档才使用方法。</p>
</div>
...
<p>下面的代码片段检查 &quot;books_ns.xml&quot; 中的第一个 &lt;title&gt; 元素是否拥有带有指定的命名空间和名称的属性：</p>
...
document.write(<code>x.hasAttributeNS(ns,&quot;lang&quot;)</code>);</pre>
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=xdom_element_hasattributens">hasAttributeNS - 检查元素是否拥有带有指定的命名空间和名称的属性</a></dt>
</dl>
</div>
