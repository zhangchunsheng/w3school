...
<title>XML DOM strictErrorChecking 属性</title>
</head>
...
<h1>XML DOM strictErrorChecking 属性</h1>
...
<p>strictErrorChecking 属性可设置或返回是否强制进行错误检查（error-checking）。</p>
<p>在设置为 false 后，实现不会对每个可能的错误情况进行测试。此属性被默认设置为 true。</p>

<h3>语法：</h3>
<pre>documentObject.strictErrorChecking</pre>
</div>
...
<p>以下代码片段可返回错误检查是否被设置为强制执行：</p>
<pre>
xmlDoc=loadXMLDoc(&quot;books.xml&quot;);

var errCheck=<code>xmlDoc.strictErrorChecking</code>;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=xdom_stricterrorchecking">检测错误检查是否被设置为强制执行</a></dt>
</dl>
</div>
