...
<title>XML DOM createCDATASection() 方法</title>
</head>
...
<h1>XML DOM createCDATASection() 方法</h1>
...
<div>
<h2>定义和用法</h2>
<p>createCDATASection() 方法可创建 CDATASection 节点。</p>
<p>此方法可返回 CDATASection 对象。</p>

<h3>语法：</h3>
<pre>createCDATASection(data)</pre>
...
<tr>
<td>data</td>
<td>字符串值，这个字符串可为此节点规定数据。</td>
</tr>
</table>

<h3>返回值</h3>
<p>返回新创建的 CDATASection 节点，内容为指定的 data。</p>

<h3>抛出</h3>
<p>如果该文档是 HTML 文档，该方法将抛出代码为 NOT_SUPPORTED_ERR 的 <a href="/xmldom/dom_domexception.asp" title="XML DOM - DOMException 对象">DOMException 异常</a>，因为 HTML 文档不支持 CDATASection 节点。</p>
</div>
...
<p>以下代码片段可向 &lt;book&gt; 元素添加一个 CDATA 区段节点：</p>
<pre>
...
for (i=0;i&lt;x.length;i++)
  {
  newCDATA=<code>xmlDoc.createCDATASection(newtext)</code>;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=xdom_createcdatasection">createCDATASection() - 创建一个 CDATASection 节点</a></dt>
</dl>
</div>
