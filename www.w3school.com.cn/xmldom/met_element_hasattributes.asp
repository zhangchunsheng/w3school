...
<p>如果当前元素节点拥有任何属性，则 hasAttributes() 返回 true，否则返回 false。</p>

<h3>语法：</h3>
<pre>hasAttributes()</pre>
</div>
...
<p>下面的代码片段检查 &quot;books.xml&quot; 中的第一个 &lt;book&gt; 元素是否拥有属性：</p>
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=xdom_element_hasattributes">hasAttributes() - 检查元素是否拥有属性</a></dt>
</dl>
</div>
