...
<h2>XML DOM 参考手册</h2>
<ul>
<li class="currentLink"><a href="/xmldom/xmldom_reference.asp" title="XML DOM 参考手册">DOM 手册目录</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/xmldom/dom_httprequest.asp" title="XMLHttpRequest 对象">DOM HttpRequest</a></li>
<li class="next"><a href="/xmldom/dom_nodetype.asp" title="XML DOM 节点类型（Node Types）">DOM 节点类型</a></li>
</ul>
</div>

<div id="intro">
<p>W3School 为您提供完整的 XML DOM 参考手册，其中包括所有的 XML DOM 对象以及它们的属性和方法。</p>
<p>在对象的属性及方法的描述页面中，提供了关于属性和方法的详细信息，包括定义用法、语法，以及实例代码。</p>
<p>此外，您可以亲自对所有实例代码进行编辑和测试（TIY 功能）。</p>
</div>


<div>
<h2>XML DOM 参考手册目录</h2>
<p class="note"><span>注释：</span>本目录的对象列表部分按照字母顺序排序。</p>
<ul>
<li><a href="/xmldom/dom_nodetype.asp">Node Types</a></li>
<li><a href="/xmldom/dom_attribute.asp">Attr</a></li>
<li><a href="/xmldom/dom_cdatasection.asp">CDATASection</a></li>
<li><a href="/xmldom/dom_characterdata.asp">CharacterData</a></li>
<li><a href="/xmldom/dom_css2properties.asp">CSS2Properties</a></li>
<li><a href="/xmldom/dom_cssrule.asp">CSSRule</a></li>
<li><a href="/xmldom/dom_cssstylerule.asp">CSSStyleRule</a></li>
<li><a href="/xmldom/dom_cssstylesheet.asp">CSSStyleSheet</a></li>
<li><a href="/xmldom/dom_comment.asp">Comment</a></li>
<li><a href="/xmldom/dom_document.asp">Document</a></li>
<li><a href="/xmldom/dom_documentfragment.asp">DocumentFragment</a></li>
<li><a href="/xmldom/dom_documenttype.asp">DocumentType</a></li>
<li><a href="/xmldom/dom_domexception.asp">DOMException</a></li>
<li><a href="/xmldom/dom_domimplementation.asp">DOMImplementation</a></li>
<li><a href="/xmldom/dom_domparser.asp">DOMParser</a></li>
<li><a href="/xmldom/dom_element.asp">Element</a></li>
<li><a href="/xmldom/dom_event.asp">Event</a></li>
<li><a href="/xmldom/dom_htmlcollection.asp">HTMLCollection</a></li>
<li><a href="/xmldom/dom_htmldocument.asp">HTMLDocument</a></li>
<li><a href="/xmldom/dom_htmlelement.asp">HTMLElement</a></li>
<li><a href="/xmldom/dom_namednodemap.asp">NamedNodeMap</a></li>
<li><a href="/xmldom/dom_node.asp">Node</a></li>
<li><a href="/xmldom/dom_nodelist.asp">NodeList</a></li>
<li><a href="/xmldom/dom_errors.asp">parseError</a></li>
<li><a href="/xmldom/dom_processinginstruction.asp">ProcessingInstruction</a></li>
<li><a href="/xmldom/dom_range.asp">Range</a></li>
<li><a href="/xmldom/dom_rangeexception.asp">RangeException</a></li>
<li><a href="/xmldom/dom_text.asp">Text</a></li>
<li><a href="/xmldom/dom_http.asp">XMLHttpRequest</a></li>
<li><a href="/xmldom/dom_xmlserializer.asp">XMLSerializer</a></li>
<li><a href="/xmldom/dom_xpathexpression.asp">XPathExpression</a></li>
<li><a href="/xmldom/dom_xpathresult.asp">XPathResult</a></li>
<li><a href="/xmldom/dom_xsltprocessor.asp">XSLTProcessor</a></li>
</ul>
</div>
...
<p>参考手册：<a href="/htmldom/htmldom_reference.asp">HTML DOM 参考手册</a></p>
</div>
