...
<div>
<h2>定义和用法</h2>
<p>childNodes 属性可返回指定节点的子节点的节点列表。</p>

<h3>语法：</h3>
<pre>nodeObject.childNodes</pre>
</div>

<div>
<h2>提示和注释</h2>
<p class="tip"><span>提示：</span>请使用 length 属性来计算一个节点列表中节点的数目。当你已获悉节点列表的长度后，您就可以轻松地循环遍历此列表，并提取您所需要的值！</p>
</div>
