...
<title>XML DOM setStart() 方法</title>
</head>
...
<div>
<h2>定义和用法</h2>
<p>setStart() 方法设置范围的开始点。</p>

<h3>语法：</h3>
<pre>setStart(<i>refNode</i>,<i>offset</i>)</pre>
...
<tr>
<td>offset</td>
<td>新开始点在 <i>refNode</i> 中的位置。</td>
</tr>
</table>


<h3>抛出</h3>
<p>该方法抛出异常的原因和 <a href="/xmldom/met_range_setend.asp" title="XML DOM setEnd() 方法">Range.setEnd()</a> 方法相同，抛出的异常也相同。</p>

<h3>描述</h3>
<p>该方法将把范围的开始点设置为 startContainer 属性和 startOffset 属性指定的值。</p>
</div>
