...
<div>
<h2>定义和用法</h2>
<p>type 事件属性返回发生的事件的类型，即当前 Event 对象表示的事件的名称。</p>
<p>它与注册的事件句柄同名，或者是事件句柄属性删除前缀 &quot;on&quot; 比如 &quot;submit&quot;、&quot;load&quot; 或 &quot;click&quot;。</p>
...
<div>
<h2>实例</h2>
<p>下面的例子可返回被触发的事件的类型：</p>
<pre>&lt;html&gt;
&lt;head&gt;
&lt;script type=&quot;text/javascript&quot;&gt;
function getEventType(event)
  { 
  alert(<code>event.type</code>);
  }
&lt;/script&gt;
&lt;/head&gt;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=hdom_event_type">type event</a></dt>
<dd>返回被触发的事件的类型（IE 浏览器不支持）。</dd>
</dl>
</div>
