...
<li class="currentLink"><a href="/xmldom/dom_nodes_set.asp" title="XML DOM 改变节点值">DOM 改变节点</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/xmldom/dom_nodes_get.asp" title="XML DOM 获取节点值">DOM 获取节点</a></li>
<li class="next"><a href="/xmldom/dom_nodes_remove.asp" title="XML DOM 删除节点">DOM 删除节点</a></li>
</ul>
</div>

<div id="intro">
<p><strong>nodeValue 属性用于改变节点值。</strong></p>

<p><strong>setAttribute() 方法用于改变属性的值。</strong></p>
</div>
...
<dd>本例使用 nodeValue 属性来改变 &quot;books.xml&quot; 中第一个 &lt;title&gt; 元素的文本节点。</dd>

<dt><a href="/tiy/t.asp?f=xdom_setattribute_1">通过使用 setAttribute 来改变属性的值</a></dt>
<dd>本例使用 setAttribute() 方法来改变第一个 &lt;book&gt; 的 &quot;category&quot; 属性的值。</dd>

<dt><a href="/tiy/t.asp?f=xdom_att_nodevalue">通过使用 nodeValue 来改变属性值</a></dt>
<dd>本例使用 nodeValue 属性来改变第一个 &lt;book&gt; 的 &quot;category&quot; 属性的值。</dd>
</dl>
</div>
...
<li>把此文本节点的节点值更改为 &quot;Hello World&quot;</li>
</ul>

<p><a href="/tiy/t.asp?f=xdom_nodevalue_change">TIY</a></p>

<p>遍历并更改所有 &lt;title&gt; 元素的文本节点：<a href="/tiy/t.asp?f=xdom_nodevalue_change_1">TIY</a></p>
</div>
...
<div>
<h2>通过使用 setAttribute() 来改变属性</h2>

<p>setAttribute() 方法设置已有属性的值，或创建新属性。</p>
...
x[0].setAttribute(&quot;category&quot;,&quot;child&quot;);</pre>
...
<li>通过使用 <a href="/xmldom/dom_loadxmldoc.asp" title="XML DOM 加载函数">loadXMLDoc()</a> 把 &quot;<a href="/example/xdom/books.xml">books.xml</a>&quot; 载入 xmlDoc 中</li>
<li>获取第一个 &lt;book&gt; 元素</li>
<li>把 &quot;category&quot; 属性的值更改为 &quot;child&quot;</li>
</ul>

<p><a href="/tiy/t.asp?f=xdom_setattribute_1">TIY</a></p>

<p>遍历所有 &lt;title&gt; 并添加一个新属性：<a href="/tiy/t.asp?f=xdom_setattribute_2">TIY</a></p>

<p class="note"><span>注释：</span>如果属性节点不存在，则创建一个新属性（拥有指定的名称和值）。</p>
</div>
...
<li>把该属性节点的值更改为 &quot;child&quot;</li>
</ul>

<p><a href="/tiy/t.asp?f=xdom_att_nodevalue">TIY</a></p>
</div>
