...
<title>XML DOM createElementNS() 方法</title>
</head>
...
<h1>XML DOM createElementNS() 方法</h1>
...
<div>
<h2>定义和用法</h2>
<p>createElementNS() 方法可创建带有指定命名空间的元素节点。</p>
<p>此方法可返回一个 Element 对象。</p>

<h3>语法：</h3>
<pre>createElementNS(ns,name)</pre>
...
<tr>
<td>ns</td>
<td>字符串值，可为此元素节点规定命名空间的名称。</td>
</tr>
<tr>
<td>name</td>
<td>字符串值，可为此元素节点规定其名称。</td>
</tr>
</table>

<h3>说明</h3>
<p>createElementNS() 方法与 <a href="/xmldom/met_document_createelement.asp" title="XML DOM createElement() 方法">createElement() 方法</a>相似，只是它创建的 Element 节点除了具有指定的名称外，还具有指定的命名空间。只有使用命名空间的 XML 文档才会使用该方法。</p>
</div>
...
<p>以下代码片段可将带有指定命名空间的元素节点添加到每个 &lt;book&gt;：</p>
<pre>
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=xdom_createelementns">createElementNS() - 创建带有命名空间的元素节点</a></dt>
</dl>
</div>
