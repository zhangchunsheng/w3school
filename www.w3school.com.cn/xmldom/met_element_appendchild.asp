...
<p>下面的代码片段创建并向第一个 &lt;book&gt; 元素追加了一个节点，然后输出第一个 &lt;book&gt; 元素的的所有子节点：</p>
...
<code>newel.appendChild(newtext);
x[i].appendChild(newel);</code>
}
...
<pre>Everyday Italian - Edition: First
Harry Potter - Edition: First
XQuery Kick Start - Edition: First
Learning XML - Edition: First</pre>

<p class="note"><span>注释：</span>Internet Explorer 会忽略节点之间生成的空白文本节点（比如换行字符），而 Mozilla 不这么做。因此，在上面的例子中，我们仅仅处理元素节点（元素节点的 nodeType 等于 1）。</p>
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=xdom_element_appendchild">appendChild() - 向第一个 &lt;book&gt; 节点追加子节点</a></dt>
<dt><a href="/tiy/t.asp?f=xdom_createelement">appendChild() - 向所有 &lt;book&gt; 节点追加子节点</a></dt>
</dl>
</div>
