...
<title>XML DOM hasAttributes() 方法</title>
</head>
...
<h1>XML DOM hasAttributes() 方法</h1>
...
<div>
<h2>定义和用法</h2>
<p>hasAttributes() 方法会在某节点用于任何属性时返回 true，否则返回 false。</p>

<h3>语法：</h3>
<pre>nodeObject.hasAttributes()</pre>
</div>
...
<p>下面的代码片段可返回是否首个 &lt;book&gt; 元素用于任何的属性：</p>

<pre>xmlDoc=loadXMLDoc(&quot;books.xml&quot;);
var x=xmlDoc.getElementsByTagName('book')[0];

document.write(<code>x.hasAttributes()</code>);</pre>
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=xdom_element_hasattributes">hasAttributes() - 检查某元素是否用于属性</a></dt>
</dl>
</div>
