...
<p>deleteData() 方法从注释节点删除数据。</p>

<h3>语法：</h3>
<pre>commentNode.deleteData(<i>start</i>,<i>length</i>)</pre>
...
<p>该方法从 <i>start</i> 指定的字符开始，从 Comment 节点中删除 <i>length</i> 个字符。如果 <i>start</i> 加 <i>length</i> 大于 Comment 节点中的字符数，那么删除从 <i>start</i> 开始到字符串结尾的所有字符。</p>
</div>
...
<p>以下代码段使用 JavaScript 函数 <a href="/xmldom/dom_loadxmldoc.asp" title="XML DOM 加载函数">loadXMLDoc()</a> 把 XML 文件 <a href="/example/xdom/books_comment.xml">books_comment.xml</a> 载入 xmlDoc 中，然后从第一个注释节点中删除一些字符：</p>
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=xdom_comment_deleteData">deleteData() - 从注释节点中删除字符</a></dt>
</dl>
</div>
...
<p>XML DOM 参考手册：<a href="/xmldom/met_characterdata_deletedata.asp">CharacterData.deleteData()</a></p>
</div>
