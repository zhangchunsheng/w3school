...
<li class="currentLink"><a href="/xmldom/dom_node.asp" title="XML DOM Node 对象">DOM Node</a></li>
...
<h1>XML DOM - Node 对象</h1>

<div  id="tpn">
<ul class="prenext">
<li class="pre"><a href="/xmldom/dom_namednodemap.asp" title="XML DOM NamedNodeMap 对象">DOM NamedNodeMap</a></li>
<li class="next"><a href="/xmldom/dom_nodelist.asp" title="XML DOM NodeList 对象">DOM NodeList</a></li>
</ul>
</div>

<div id="intro">
<p><strong>节点对象代表文档树中的一个节点。</strong></p>
</div>

<div>
<h2>Node 对象</h2>

<p>Node 对象是整个 DOM 的主要数据类型。</p>
<p>节点对象代表文档树中的一个单独的节点。</p>
<p>节点可以是元素节点、属性节点、文本节点，或者也可以是“节点类型”那一节中所介绍的任何一种节点。</p>
<p>请注意，虽然所有的对象均能继承用于处理父节点和子节点的属性和方法，但是并不是所有的对象都拥有父节点或子节点。例如，文本节点不能拥有子节点，所以向类似的节点添加子节点就会导致 DOM 错误。</p>
...
<tr>
	<td><a href="prop_node_text.asp">text</a></td>
	<td>返回节点及其后代的文本（IE 独有的属性）。</td>
	<td>5</td>
	<td>No</td>
	<td>No</td>
	<td>No</td>
...
<tr>
	<td><a href="prop_node_xml.asp">xml</a></td>
	<td>返回节点及其后代的 XML（IE 独有的属性）。</td>
	<td>5</td>
	<td>No</td>
	<td>No</td>
	<td>No</td>
...
<tr>
	<td class="no_wrap"><a href="met_node_comparedocumentposition.asp">compareDocumentPosition()</a></td>
	<td>对比两个节点的文档位置。</td>
	<td>No</td>
	<td>1</td>
	<td>No</td>
...
<tr>
	...
	<td>返回一个 DOM 对象，此对象可执行带有指定特性和版本的专门的 API。</td>
	<td>&nbsp;</td>
	<td>&nbsp;</td>
	<td>No</td>
	<td>Yes</td>
...
<tr>
	...
	<td>返回与此节点上的某个键相关联的对象。此对象必须首先通过使用相同的键来调用 setUserData 被设置到此节点。</td>
	<td>&nbsp;</td>
	<td>&nbsp;</td>
	<td>No</td>
	<td>Yes</td>
...
<tr>
	<td><a href="met_node_normalize.asp" title="XML DOM normalize() 方法">normalize()</a></td>
	<td>合并相邻的Text节点并删除空的Text节点。</td>
	<td>5</td>
	<td>1</td>
	<td>9</td>
	<td>Yes</td>
...
<tr>
	<td><a href="met_node_selectnodes.asp">selectNodes()</a></td>
	<td>用一个 XPath 表达式查询选择节点。</td>
	<td>6</td>
	<td>&nbsp;</td>
	<td>&nbsp;</td>
	<td>&nbsp;</td>
...
<tr>
	<td><a href="met_node_selectsinglenode.asp">selectSingleNode()</a></td>
	<td>查找和 XPath 查询匹配的一个节点。</td>
	<td>6</td>
	<td>&nbsp;</td>
	<td>&nbsp;</td>
	<td>&nbsp;</td>
...
<tr>
	<td><a href="met_node_transformnode.asp">transformNode()</a></td>
	<td>使用 XSLT 把一个节点转换为一个字符串。</td>
	<td>6</td>
	<td>&nbsp;</td>
	<td>&nbsp;</td>
	<td>&nbsp;</td>
...
<tr>
	<td><a href="met_node_transformnodetoobject.asp">transformNodeToObject()</a></td>
	<td>使用 XSLT 把一个节点转换为一个文档。</td>
	<td>6</td>
	<td>&nbsp;</td>
	<td>&nbsp;</td>
	<td>&nbsp;</td>
