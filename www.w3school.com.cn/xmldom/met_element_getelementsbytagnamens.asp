...
<p>getElementsByTagNameNS() 方法返回带有指定名称和命名空间的所有元素的 NodeList。</p>

<h3>语法：</h3>
<pre>elementNode.getElementsByTagNameNS(ns,name)</pre>
...
<tr>
<td>ns</td>
<td>字符串值，规定要检索的命名空间。值 &quot;*&quot; 匹配所有标签。</td>
</tr>

<tr>
<td>name</td>
<td>字符串值，规定要检索的标签名。值 &quot;*&quot; 匹配所有标签。</td>
</tr>
</table>

<h3>说明</h3>
<p>该方法与 <a href="/xmldom/met_element_getelementsbytagname.asp" title="XML DOM getElementsByTagName() 方法">getElementsByTagName() 方法</a>相似，只是想获取的元素的标记名被指定为命名空间 URI 和在命名空间中定义的本地名的组合。只有使用命名空间的 XML 文档才使用该方法。</p>
</div>
...
<p>下面的代码片段通过标签名和命名空间获取元素：</p>

<pre>xmlDoc=loadXMLDoc(&quot;books_ns.xml&quot;);

x=<code>xmlDoc.getElementsByTagNameNS(&quot;http://www.w3school.com.cn/children/&quot;,&quot;title&quot;)</code>;
document.write(x[0].nodeName);</pre>
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=xdom_element_getelementsbytagnamens">getElementByTagNameNS() - 通过名称和命名空间检索元素</a></dt>
</dl>
</div>
