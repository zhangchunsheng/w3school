...
<title>XML DOM deleteRule() 方法</title>
</head>
...
<div>
<h2>定义和用法</h2>
<p>deleteRule() 方法从样式表中删除一个规则。</p>

<h3>语法：</h3>
<pre>deleteRule(<i>index</i>)</pre>
...
<tr>
<td>index</td>
<td>必需。要删除的规则在 cssRules 数组中的下标。</td>
</tr>
</table>
...
<p>该方法将删除 cssRules 数组指定 <i>index</i> 处的规则，它是 DOM 标准方法。请参阅 <a href="/xmldom/met_cssstylesheet_addrule.asp">CSSStyleSheet.addRule()</a>，它是特定于 IE 的一个替代方法。</p>
...
<p>删除 myStyles 对象的第一条规则：</p>

<pre>myStyles.deleteRule(0);</pre>
...
<p>XML DOM 参考手册：<a href="/xmldom/met_cssstylesheet_removerule.asp">CSSStyleSheet.removeRule()</a></p>
</div>
