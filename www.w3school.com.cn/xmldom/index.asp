...
<ul>
<li class="currentLink"><a href="/xmldom/index.asp" title="XML DOM 教程">DOM 首页</a></li>
...
<li class="next"><a href="/xmldom/dom_intro.asp" title="XML DOM 简介">DOM 简介</a></li>
</ul>
</div>

<div id="intro">
<p><strong>XML 文档对象模型定义访问和操作XML文档的标准方法。</strong></p>
<p><strong>DOM 将 XML 文档作为一个树形结构，而树叶被定义为节点。</strong></p>
<p><a href="/xmldom/dom_intro.asp" title="DOM 简介">开始学习 DOM</a>！</p>
<img src="/i/ct_nodetree1.gif" alt="节点树" />
</div>

<div>
<h2>XML DOM 对象 参考手册</h2>

<p>在 W3School，我们提供完整的 DOM 参考手册，其中包括所有的对象以及它们的属性和方法。</p>
<p><a href="/xmldom/xmldom_reference.asp" title="XML DOM 参考手册">XML DOM 参考手册</a></p>
</div>

<div>
<h2>XML DOM 实例</h2>

<p>学习 50 个实例！使用我们的编辑器，你可以编辑源代码，然后单击测试按钮来查看结果。</p>
<p><a href="/example/xdom_examples.asp" title="XML DOM 实例">亲自试一试吧</a>！</p>
</div>
