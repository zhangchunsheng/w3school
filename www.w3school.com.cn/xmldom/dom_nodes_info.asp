...
<li class="currentLink"><a href="/xmldom/dom_nodes_info.asp" title="XML DOM 节点信息">DOM 节点信息</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/xmldom/dom_nodes_access.asp" title="XML DOM 访问节点">DOM 访问节点</a></li>
<li class="next"><a href="/xmldom/dom_nodes_nodelist.asp" title="XML DOM 节点列表">DOM 节点列表</a></li>
</ul>
</div>

<div id="intro">
<p><strong>节点属性：nodeName、nodeValue 以及 nodeType。</strong></p>
</div>
...
<dd>本例使用 nodeName 属性来获取 &quot;books.xml&quot; 中根元素的节点名称。</dd>

<dt><a href="/tiy/t.asp?f=xdom_getelement">从文本节点获取文本</a></dt>
<dd>本例使用 nodeValue 属性来获取 &quot;books.xml&quot; 中第一个 &lt;title&gt; 元素的文本。</dd>

<dt><a href="/tiy/t.asp?f=xdom_changeelement">更改文本节点中的文本</a></dt>
<dd>本例使用 nodeValue 属性来更改 &quot;books.xml&quot; 中第一个 &lt;title&gt; 元素的文本。</dd>

<dt><a href="/tiy/t.asp?f=xdom_root">获取元素节点的节点名称和类型</a></dt>
<dd>本例使用 nodeName 和 nodeType 属性来获取 &quot;books.xml&quot; 中根元素的节点名称和类型。</dd>
</dl>
</div>
...
<p>在 XML 文档对象模型 (DOM) 中，每个节点都是一个<em>对象</em>。</p>

<p>对象拥有方法（功能）和属性（关于对象的信息），并可通过 JavaScript 进行访问和操作。</p>

<p>三个重要的 XML DOM 节点属性是：</p>
...
<p><a href="/tiy/t.asp?f=xdom_nodename3">TIY</a></p>
</div>
...
<p>下面的代码检索第一个 &lt;title&gt; 元素的文本节点的值：</p>
...
<ul>
<li>通过使用 loadXMLDoc() 把 &quot;books.xml&quot; 载入 xmlDoc 中</li>
<li>获取第一个 &lt;title&gt; 元素节点的文本节点</li>
<li>把 txt 变量设置为文本节点的值</li>
</ul>

<p><a href="/tiy/t.asp?f=xdom_getelement">TIY</a></p>
</div>
...
<p>下面的代码更改第一个 &lt;title&gt; 元素的文本节点的值：</p>
...
<li>通过使用 loadXMLDoc() 把 &quot;books.xml&quot; 载入 xmlDoc 中</li>
<li>获取第一个 &lt;title&gt; 元素节点的文本节点</li>
<li>把文本节点的值更改为 &quot;Easy Cooking&quot;</li>
</ul>

<p><a href="/tiy/t.asp?f=xdom_changeelement">TIY</a></p>
</div>
...
<p><a href="/tiy/t.asp?f=xdom_root">TIY</a></p>
</div>
