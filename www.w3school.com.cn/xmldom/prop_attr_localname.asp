...
<div>
<h2>定义和用法</h2>
<p>localName 属性返回属性名称的本地部分。</p>

<h3>语法：</h3>
<pre>attrObject.localName</pre>
</div>
...
{
document.write(<code>x.item(i).attributes[0].localName</code>);
document.write(&quot;&lt;br /&gt;&quot;);
}</pre>
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=xdom_attr_localname">获取属性的 localName</a>（IE 浏览器不支持）</dt>
</dl>
</div>
