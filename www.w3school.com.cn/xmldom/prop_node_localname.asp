...
<div>
<h2>定义和用法</h2>
<p>localName 属性可返回某个节点名称的本地部分。</p>

<h3>语法：</h3>
<pre>nodeObject.localName</pre>
</div>
...
for(i=0;i&lt;x.length;i++)
  {
  document.write(<code>x.item(i).localName</code>);
  document.write(&quot;&lt;br /&gt;&quot;);
  }
</pre>
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=xdom_node_prefix">取得某个节点的前缀、本地名称、命名空间URI、以及绝对基准URI</a></dt>
</dl>
</div>
