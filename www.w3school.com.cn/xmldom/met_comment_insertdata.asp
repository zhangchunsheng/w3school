...
<title>XML DOM insertData() 方法</title>
</head>
...
<div>
<h2>定义和用法</h2>
<p>insertData() 方法把字符串插入注释节点。</p>

<h3>语法：</h3>
<pre>commentNode.insertData(<i>start</i>,<i>string</i>)</pre>
...
<p>该方法把字符串 <i>string</i> 插入指定位置 <i>start</i> 的 Comment 节点的文本处。</p>
</div>
...
<p>以下代码段使用 JavaScript 函数 <a href="/xmldom/dom_loadxmldoc.asp" title="XML DOM 加载函数">loadXMLDoc()</a> 把 XML 文件 <a href="/example/xdom/books_comment.xml">books_comment.xml</a> 载入 xmlDoc 中，然后向第一个 Comment 节点插入一个字符串：</p>
...
{ 
  ...
  <code>x[i].insertData(10,&quot;Illustrated &quot;);</code>
...
<pre>(Book 6) (Illustrated Hardcover)</pre>
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=xdom_comment_insertData">insertData() - 向注释节点插入文本</a></dt>
</dl>
</div>
...
<p>XML DOM 参考手册：<a href="/xmldom/met_characterdata_insertdata.asp">CharacterData.insertData()</a></p>
</div>
