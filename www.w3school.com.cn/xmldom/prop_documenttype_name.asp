...
<div>
<h2>定义和用法</h2>
<p>name 属性可返回 DTD 的名称（紧随关键词 DOCTYPE 的名称）</p>

<h3>语法：</h3>
<pre>documentObject.doctype.name</pre>
</div>
...
<p>以下代码片段可显示与 XML 文档相关联的 DTD 的名称：</p>
<pre>xmlDoc=loadXMLDoc(&quot;note_internal_dtd.xml&quot;);
document.write(<code>xmlDoc.doctype.name</code>);</pre>
...
<h2>DIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=xdom_doctype">取得与 XML 文档相关联的 DTD 的名称</a></dt>
</dl>
</div>
