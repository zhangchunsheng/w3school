...
<title>XML DOM createElement() 方法</title>
</head>
...
<h1>XML DOM createElement() 方法</h1>
...
<div>
<h2>定义和用法</h2>
<p>createElement() 方法可创建元素节点。</p>
<p>此方法可返回一个 Element 对象。</p>

<h3>语法：</h3>
<pre>createElement(name)</pre>
...
<tr>
<td>name</td>
<td>字符串值，这个字符串可为此元素节点规定名称。</td>
</tr>
</table>

<h3>返回值</h3>
<p>新创建的 Element 节点，具有指定的标签名。</p>

<h3>抛出</h3>
<p>如果 name 参数中含有不合法的字符，该方法将抛出代码为 INVALID_CHARACTER_ERR 的 <a href="/xmldom/dom_domexception.asp" title="XML DOM - DOMException 对象">DOMException 异常</a>。</p>
</div>
...
<p>以下代码片段可将一个带有文本节点的元素节点添加到每个 &lt;book&gt; 元素：</p>
...
for (i=0;i&lt;x.length;i++)
  {
  newel=<code>xmlDoc.createElement('edition')</code>;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=xdom_createelement">createElement() 和 createTextNode() - 创建元素节点和文本节点</a></dt>
</dl>
</div>
