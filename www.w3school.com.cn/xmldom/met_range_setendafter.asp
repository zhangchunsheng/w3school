...
<title>XML DOM setEndAfter() 方法</title>
</head>
...
<div>
<h2>定义和用法</h2>
<p>setEndAfter() 方法在指定的节点后结束范围。</p>

<h3>语法：</h3>
<pre>setEndAfter(<i>refNode</i>)</pre>
...
<tr>
<td>refNode</td>
<td>一个节点，要设置的范围的结束点位于该节点之后。</td>
</tr>
</table>


<h3>抛出</h3>
<p>如果 <i>refNode</i> 是 Document、DocumentFragment 或 Attr 节点，或者 <i>refNode</i> 的根包容节点不是 Document、DocumentFragment 或 Attr 节点，该方法将抛出代码为 INVALID_NODE_TYPE_ERR 的 <a href="/xmldom/dom_rangeexception.asp" title="XML DOM - RangeException 对象">RangeException 异常</a>。</p>
...
<h3>描述</h3>
<p>该方法将把范围的结束点设置为紧邻指定的 <i>refNode</i> 节点的位置。</p>
</div>
