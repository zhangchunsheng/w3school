...
<title>XML DOM attributes 属性</title>
</head>
...
<div>
<h2>定义和用法</h2>
<p>attributes 属性返回包含被选节点属性的 NamedNodeMap。</p>

<p>如果被选节点不是元素，则该属性返回 NULL。</p>
<h3>语法：</h3>
<pre>elementNode.attributes</pre>
</div>

<div>
<h2>提示和注释</h2>
<p class="tip"><span>提示：</span>该属性仅用于 element 节点。</p>
</div>
...
<p>下面的代码片段获取 &quot;books.xml&quot; 中第一个 &lt;title&gt; 元素的属性数目：</p>

<pre>xmlDoc=loadXMLDoc(&quot;books.xml&quot;);

var x=<code>xmlDoc.getElementsByTagName(&quot;book&quot;)[0].attributes</code>;
...
<p>下面的代码片段输出第一个 &lt;book&gt; 元素中 &quot;category&quot; 属性的值：</p>
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=xdom_getnameditem">getNamedItem() 和 属性 - 获取项目的值</a></dt>

<dt><a href="/tiy/t.asp?f=xdom_attributes_length">属性和长度 - 从元素中获取属性的数目</a></dt>
</dl>
</div>
