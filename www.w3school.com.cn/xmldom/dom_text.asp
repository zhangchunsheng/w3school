...
<li class="currentLink"><a href="/xmldom/dom_text.asp" title="XML DOM Text 对象">DOM Text</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/xmldom/dom_rangeexception.asp" title="XML DOM RangeException 对象">DOM RangeException</a></li>
<li class="next"><a href="/xmldom/dom_http.asp" title="XML DOM XMLHttpRequest 对象">DOM XMLHttpRequest</a></li>
</ul>
</div>
...
<p>Text 节点继承了 <a href="/xmldom/dom_characterdata.asp">CharacterData 接口</a>，通过从 CharacterData 接口继承的 data 属性或从 Node 接口继承的 nadevalue 属性，可以访问 Text 节点的文本内容。</p>
...
<tr>
	<td><a href="/xmldom/prop_text_data.asp">data</a></td>
	<td>设置或返回元素或属性的文本</td>
	<td>6</td>
	<td>1</td>
	<td>9</td>
...
<tr>
	<td><a href="/xmldom/prop_text_length.asp">length</a></td>
	<td>返回元素或属性的文本长度</td>
	<td>6</td>
	<td>1</td>
	<td>9</td>
...
<tr>
	<td><a href="/xmldom/met_text_appenddata.asp">appendData()</a></td>
	<td>向节点追加数据</td>
	<td>6</td>
	<td>1</td>
	<td>9</td>
...
<tr>
	<td><a href="/xmldom/met_text_deletedata.asp">deleteData()</a></td>
	<td>从节点删除数据</td>
	<td>6</td>
	<td>1</td>
	<td>9</td>
...
<tr>
	<td><a href="/xmldom/met_text_insertdata.asp">insertData()</a></td>
	<td>向节点中插入数据</td>
	<td>6</td>
	<td>1</td>
	<td>9</td>
...
<tr>
	<td><a href="/xmldom/met_text_replacedata.asp">replaceData()</a></td>
	<td>替换节点中的数据</td>
	<td>6</td>
	<td>1</td>
	<td>9</td>
...
<tr>
	<td><a href="/xmldom/met_text_splittext.asp">splitText()</a></td>
...
<tr>
	<td><a href="/xmldom/met_text_substringdata.asp">substringData()</a></td>
	<td>从节点提取数据</td>
	<td>6</td>
	<td>1</td>
	<td>9</td>
