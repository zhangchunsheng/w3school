...
<title>XML DOM ownerDocument 属性</title>
</head>
...
<h1>XML DOM ownerDocument 属性</h1>
...
<p>ownerDocument 属性返回节点所属的根元素（<a href="/xmldom/dom_document.asp" title="XML DOM - Document 对象">Document 对象</a>）。</p>

<h3>语法：</h3>
<pre>attrObject.ownerDocument</pre>
</div>
...
<p>下面的代码片段返回 XML 文档中第一个 category 属性节点的根元素：</p>

<pre>xmlDoc=loadXMLDoc(&quot;/example/xdom/books.xml&quot;);

x=xmlDoc.getElementsByTagName('book');

document.write(<code>x.item(0).attributes[0].ownerDocument</code>);
document.write(&quot;&lt;br /&gt;&quot;);
document.write(<code>x.item(0).attributes[0].ownerDocument.nodeName</code>);
document.write(&quot;&lt;br /&gt;&quot;);
document.write(<code>x.item(0).attributes[0].ownerDocument.nodeType</code>);</pre>

<p>以上代码的输出：</p>

<pre>[object XMLDocument]
#document
9</pre>
</div>
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=xdom_attr_ownerdocument">ownerDocument - 获取属性节点所属的根元素（document 对象）</a></dt>
</dl>
</div>
