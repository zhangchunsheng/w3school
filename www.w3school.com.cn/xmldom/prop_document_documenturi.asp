...
<title>XML DOM documentURI 属性</title>
</head>
...
<div>
<h2>定义和用法</h2>
<p>documentURI 属性可设置或返回文档的位置。</p>

<h3>语法：</h3>
<pre>documentObject.documentURI</pre>
</div>
...
<p>以下代码片段可显示 XML 文档的位置：</p>
<pre>xmlDoc=loadXMLDoc(&quot;/example/xdom/books.xml&quot;);
document.write(&quot;Document location: &quot; + xmlDoc.documentURI);</pre>

<h3>输出：</h3>
<pre>Document location: http://www.w3school.com.cn/example/xdom/books.xml </pre>
</div>

<div class="example">
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=xdom_documenturi">取得文档的位置</a></dt>
</dl>
</div>
