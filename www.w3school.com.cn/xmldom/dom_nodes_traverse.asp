...
<li class="currentLink"><a href="/xmldom/dom_nodes_traverse.asp" title="XML DOM 遍历节点">DOM 遍历节点</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/xmldom/dom_nodes_nodelist.asp" title="XML DOM 节点列表">DOM 节点列表</a></li>
<li class="next"><a href="/xmldom/dom_mozilla_vs_ie.asp" title="XML DOM 浏览器差异">DOM 浏览器</a></li>
</ul>
</div>

<div id="intro">
<p><strong>遍历 (Traverse) 意味着在节点树中进行循环或移动。</strong></p>
</div>
...
<p>您经常需要循环 XML 文档，比如：当你需要提取每个元素的值时。</p>

<p>这个过程叫作“遍历节点树”。</p>

<p>下面的例子循环 &lt;book&gt; 的所有子节点，并显示它们的名称和值：</p>
...
<ul>
<li><a href="/xmldom/dom_loadxmldoc.asp" title="XML DOM 加载函数">loadXMLString()</a> 把 XML 字符串载入 xmlDoc 中</li>
<li>获取根元素的子节点</li>
<li>输出每个子节点的名称，以及文本节点的节点值</li>
</ul>

<p><a href="/tiy/t.asp?f=xdom_parsertest3">TIY</a></p>
</div>
