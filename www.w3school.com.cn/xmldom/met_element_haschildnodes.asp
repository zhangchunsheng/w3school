...
<p>如果当前元素节点拥有子节点，则 hasChildNodes() 返回 true，否则返回 false。</p>
...
<p>下面的代码片段检查 &quot;books.xml&quot; 中的第一个 &lt;book&gt; 元素是否拥有子节点：</p>
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=xdom_element_haschildnodes">hasChildNodes() - 检查元素是否拥有子节点</a></dt>
</dl>
</div>
