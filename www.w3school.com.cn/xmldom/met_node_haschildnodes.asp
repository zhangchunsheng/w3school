...
<title>XML DOM hasChildNodes() 方法</title>
</head>
...
<h1>XML DOM hasChildNodes() 方法</h1>
...
<div>
<h2>定义和用法</h2>
<p>hasChildNodes() 方法可在某节点用于任何子节点时返回 true，否则返回 false。</p>

<h3>语法：</h3>
<pre>nodeObject.hasChildNodes()</pre>
</div>
...
<p>下面的代码片段可返回是否 &lt;book&gt; 元素是否拥有任何子节点：</p>
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=xdom_element_haschildnodes">hasChildNodes() - 检查某个元素是否拥有任何子节点</a></dt>
</dl>
</div>
