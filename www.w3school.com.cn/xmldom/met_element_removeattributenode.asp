...
<title>XML DOM removeAttributeNode() 方法</title>
</head>
...
<h1>XML DOM removeAttributeNode() 方法</h1>
...
<p>removeAttributeNode() 方法从元素中删除指定的属性节点。</p>

<h3>语法：</h3>
<pre>elementNode.removeAttributeNode(node)</pre>
...
<h3>说明</h3>
<p>该方法从当前元素的属性集合中删除（并返回）一个 Attr 节点。如果 DTD 给删除的属性设置了默认值，那么该方法将添加一个新的 Attr 节点，表示这个默认值。用 <a href="/xmldom/met_element_removeattribute.asp" title="XML DOM removeAttribute() 方法">removeAttribute() 方法</a>代替该方法往往会更简单。</p>
</div>
...
<p>下面代码片段从 &quot;books.xml&quot; 中的所有 &lt;book&gt; 元素中删除 &quot;category&quot; 属性：</p>
...
old_att=<code>x.item(i).removeAttributeNode(attnode)</code>;
document.write(&quot;Removed attribute: &quot; + old_att.name + &quot;&lt;br /&gt;&quot;);
}</pre>

<p>输出：</p>
<pre>Removed attribute: category
Removed attribute: category
Removed attribute: category
Removed attribute: category</pre>
</div>

<div class="example">
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=xdom_removeattributenode">removeAttributeNode() - 删除属性节点</a></dt>
</dl>
</div>
