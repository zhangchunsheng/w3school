...
<title>XML DOM nodeName 属性</title>
</head>
...
<p>nodeName 属性根据节点的类型返回其名称。</p>

<h3>语法：</h3>
<pre>attrObject.nodeName</pre>
</div>
...
<p>下面的代码片段显示 category 属性的节点名称、节点值以及节点类型：</p>
...
{
document.write(<code>x.item(i).attributes[0].nodeName</code>);
document.write(&quot; = &quot;);
...
<pre>category = children (nodetype: 2)
category = cooking (nodetype: 2)
category = web (nodetype: 2)
category = web (nodetype: 2)</pre>
</div>

<div class="example">
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=xdom_attr_nodename">显示属性的 nodeName 、nodeValue 以及 nodeType</a></dt>
</dl>
</div>
