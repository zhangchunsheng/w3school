...
<div>
<h2>定义和用法</h2>
<p>appendData() 方法在文本节点的末尾添加一个字符串。</p>

<h3>语法：</h3>
<pre>textNode.appendData(string)</pre>
...
<p>下面的代码片段向 &quot;books.xml&quot; 中的第一个 &lt;title&gt; 元素追加文本：</p>

<pre>xmlDoc=loadXMLDoc(&quot;books.xml&quot;);
x=xmlDoc.getElementsByTagName(&quot;title&quot;)[0].childNodes[0];

<code>x.appendData(&quot; Cooking&quot;);</code>
document.write(x.data);</pre>

<h3>输出：</h3>
<pre>Everyday Italian Cooking</pre>
</div>
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=xdom_text_appenddata">appendData() - 向文本节点追加文本</a></dt>
</dl>
</div>
...
<p>XML DOM 参考手册：<a href="/xmldom/met_characterdata_appenddata.asp">CharacterData.appendData()</a></p>
</div>
