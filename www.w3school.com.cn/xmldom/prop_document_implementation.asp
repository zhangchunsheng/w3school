...
<title>XML DOM implementation 属性</title>
</head>
...
<h1>XML DOM implementation 属性</h1>
...
<div>
<h2>定义和用法</h2>
<p>implementation 属性可返回处理该文档的 DOMImplementation 对象。</p>

<h3>语法：</h3>
<pre>documentObject.implementation</pre>
</div>
...
<p>以下的代码片段可返回操作该文档的 DOMImplementation 对象：</p>
<pre>
xmlDoc=loadXMLDoc(&quot;/example/xdom/books.xml&quot;);

document.write(<code>xmlDoc.implementation</code>);
</pre>

<h3>输出：</h3>
<pre>[object DOMImplementation]</pre>
</div>

<div class="example">
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=xdom_implementation">显示操作文档的 DOMImplementation 对象</a>（不支持 IE 浏览器）</dt>
</dl>
</div>
