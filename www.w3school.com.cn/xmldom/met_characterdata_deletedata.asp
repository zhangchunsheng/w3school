...
<title>XML DOM deleteData() 方法</title>
</head>
...
<div>
<h2>定义和用法</h2>
<p>deleteData() 方法从 <a href="/xmldom/dom_text.asp">Text</a> 或 <a href="/xmldom/met_text_appenddata.asp">Comment</a> 节点删除文本。</p>

<h3>语法：</h3>
<pre>CharacterData.deleteData(<i>start</i>,<i>length</i>)</pre>
...
<p>该方法将从 <i>start</i> 指定的字符开始，从 Text 节点或 Comment 节点中删除 <i>length</i> 个字符。如果 <i>start</i> 加 <i>length</i> 大于 Text 节点或 Comment 节点中的字符数，那么删除从 <i>start</i> 开始到字符串结尾的所有字符。</p>
</div>
...
<p>XML DOM 参考手册：<a href="/xmldom/met_text_deletedata.asp">Text.deleteData()</a></p>
<p>XML DOM 参考手册：<a href="/xmldom/met_comment_deletedata.asp">Comment.deleteData()</a></p>
</div>
