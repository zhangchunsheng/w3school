...
<title>XML DOM selectNodeContents() 方法</title>
</head>
...
<h1>XML DOM selectNodeContents() 方法</h1>
...
<div>
<h2>定义和用法</h2>
<p>selectNodeContents() 方法把范围边界设置为一个节点的子节点。</p>

<h3>语法：</h3>
<pre>selectNodeContents(<i>refNode</i>)</pre>
...
<tr>
<td>refNode</td>
<td>其子节点将成为当前范围的内容的节点。</td>
</tr>
</table>


<h3>抛出</h3>
<p>如果 <i>refNode</i> 或它的一个祖先节点是 DocumentType、Entity、或 Notation 节点，该方法将抛出代码为 INVALID_NODE_TYPE_ERR 的 <a href="/xmldom/dom_rangeexception.asp" title="XML DOM - RangeException 对象">RangeException 异常</a>。</p>

<p>如果 <i>refNode</i> 所属的文档与创建该范围的文档不同，该方法将抛出代码为 WRONG_DOCUMENT_ERR 的 <a href="/xmldom/dom_domexception.asp" title="XML DOM - DOMException 对象">DOMException 异常</a>。</p>

<h3>描述</h3>
<p>该方法将设置范围的边界点，使该范围包含 <i>refNode</i> 的子节点。</p>

<h3>参阅</h3>
<p><a href="/xmldom/met_range_selectnode.asp" title="XML DOM selectNode() 方法">Range.selectNode()</a>。</p>
</div>
