...
<div>
<h2>定义和用法</h2>
<p>insertData() 方法把字符串插入 <a href="/xmldom/dom_text.asp">Text</a> 或 <a href="/xmldom/met_text_appenddata.asp">Comment</a> 节点。</p>
...
<p>该方法将指定的字符串 <i>string</i> 插入 Text 节点或 Comment 节点的指定位置 <i>start</i> 的文本处。</p>
</div>
...
<p>XML DOM 参考手册：<a href="/xmldom/met_text_insertdata.asp">Text.insertData()</a></p>
<p>XML DOM 参考手册：<a href="/xmldom/met_comment_insertdata.asp">Comment.insertData()</a></p>
</div>
