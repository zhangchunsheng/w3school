...
<div>
<h2>定义和用法</h2>
<p>text 属性可返回节点及其后代的文本。</p>

<h3>语法：</h3>
<pre>nodeObject.text</pre>
</div>

<div>
<h2>提示和注释</h2>
<p class="note"><span>注释：</span>此属性只能用于 Internet Explorer ！</p>
</div>
...
<p>下面的代码可显示 XML 文档的文本：：</p>
<pre>xmlDoc=loadXMLDoc(&quot;books.xml&quot;);
document.write(<code>xmlDoc.text</code>);</pre>

<h3>输出：</h3>
<pre>Everyday Italian Giada De Laurentiis 2005 30.00
...
Erik T. Ray 2003 39.95</pre>
</div>

<div class="example">
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=xdom_document_text">显示一个 XML 文档的文本</a></dt>
</dl>
</div>
