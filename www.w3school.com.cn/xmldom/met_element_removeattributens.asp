...
<title>XML DOM removeAttributeNS() 方法</title>
</head>
...
<h1>XML DOM removeAttributeNS() 方法</h1>
...
<p>removeAttributeNS() 方法删除由命名空间和名称指定的属性。</p>

<h3>语法：</h3>
<pre>elementNode.removeAttributeNS(ns,name)</pre>
...
<tr>
<td>ns</td>
<td>必需。规定要删除的属性的名字空间。</td>
</tr>

<tr>
<td>name</td>
<td>必需。规定要删除的属性的名称。</td>
</tr>
</table>
</div>
...
<p>下面的代码片段从 &quot;books_ns.xml&quot; 中的第一个 &lt;title&gt; 元素删除 &quot;lang&quot; 属性：</p>
...
document.write(<code>x.hasAttributeNS(ns,&quot;lang&quot;)</code>);
...
<p>输出：</p>
<pre>Attribute Found: true
Attribute Found: false</pre>
</div>

<div class="example">
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=xdom_element_removeattributens">removeAttributeNS() - 通过名称和名字空间删除属性</a></dt>
</dl>
</div>
