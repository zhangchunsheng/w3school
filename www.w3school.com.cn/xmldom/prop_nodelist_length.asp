...
<div>
<p><a href="/xmldom/dom_nodelist.asp">NodeList 对象参考手册</a></p>
</div>

<div>
<h2>定义和用法</h2>
<p>length 属性可返回一个节点列表中的节点数目。</p>

<h3>语法</h3>
<pre>nodelistObject.length</pre>
</div>
...
<p>下面的代码片段可取得 XML 文档 中&lt;title&gt; 元素的数目：</p>
<pre>xmlDoc=loadXMLDoc(&quot;books.xml&quot;);

var x=xmlDoc.getElementsByTagName('title');

document.write(&quot;Number of title elements: &quot; + <code>x.length</code>);</pre>

<h3>输出：</h3>
<pre>Number of title elements: 4</pre>
</div>

<div class="example">
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=xdom_length">length - 可返回节点列表中的节点数目</a></dt>
<dt><a href="/tiy/t.asp?f=xdom_length2">length - 循环遍历节点列表中的节点</a></dt>
</dl>
</div>
