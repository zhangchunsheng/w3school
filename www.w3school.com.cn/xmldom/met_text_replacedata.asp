...
<div>
<h2>定义和用法</h2>
<p>replaceData() 方法替换文本节点中的数据。</p>

<h3>语法：</h3>
<pre>replaceData(start,length,string)</pre>
...
<p>下面的代码片段用 &quot;Easy&quot; 替换 &lt;title&gt; 元素的文本节点的前 8 个字符：</p>

<pre>xmlDoc=loadXMLDoc(&quot;books.xml&quot;);

x=xmlDoc.getElementsByTagName(&quot;title&quot;)[0].childNodes[0];

<code>x.replaceData(0,8,&quot;Easy&quot;);</code>

document.write(x.nodeValue);</pre>

<h3>输出：</h3>
<pre>Easy Italian</pre>
</div>
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=xdom_replacedata">replaceData() - 替换文本节点中的数据</a></dt>
</dl>
</div>
