...
<div>
<h2>定义和用法</h2>
<p>replaceChild() 方法可将某个子节点替换为另一个。</p>
<p>如替换成功，此方法可返回被替换的节点，如替换失败，则返回 NULL。。</p>

<h3>语法：</h3>
<pre>nodeObject.replaceChild(new_node,old_node)</pre>
...
<p>下面的代码片段可替换首个 &lt;book&lt; 元素中的 &lt;title&gt; 元素：</p>
<pre>
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=xdom_element_replacechild">replaceChild() - 替换某个元素节点</a></dt>
</dl>
</div>
