...
<title>XML DOM createAttributeNS() 方法</title>
</head>
...
<h1>XML DOM createAttributeNS() 方法</h1>
...
<div>
<h2>定义和用法</h2>
<p>创建具有指定的名称和命名空间的 Attr 节点。</p>

<h3>语法：</h3>
<pre>createAttributeNS(uri,name)</pre>
...
<tr>
<td>uri</td>
<td>Attr 的命名空间的唯一标识符。如果没有命名空间。则为 null。</td>
</tr>

<tr>
<td>name</td>
<td>属性的限定名，应包括命名空间前缀、冒号和本地名。</td>
</tr>
</table>

<h3>返回值</h3>
<p>返回新创建的 Attr 节点，具有指定的名称和命名空间。</p>

<h3>说明</h3>
<p>createAttributeNS() 方法与 <a href="/xmldom/met_document_createattribute.asp" title="XML DOM createAttribute() 方法">createAttribute() 方法</a>相似，只是它创建的 Attr 节点除了具有指定的名称外，还具有指定的命名空间。只有使用命名空间的 XML 文档才会使用该方法。</p>
</div>
