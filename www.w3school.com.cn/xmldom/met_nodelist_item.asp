...
<tr>
<td>index</td>
<td>表示 NodeList 中节点位置的整数。该值是大于等于 0 小于等于 NodeList.length-1 的整数。</td>
</tr>
</table>
</div>
...
<p>下面的代码片段可循环遍历 XML 文档中 &lt;bookstore&gt; 元素的所有直系的子节点：</p>
<pre>
...
for (i=0;i&lt;x.length;i++)
  ...
  if (x.item(i).nodeType==1)
    {
    document.write(<code>x.item(i).nodeName</code>)
    document.write(&quot;&lt;br /&gt;&quot;)
    }
  }
</pre>
...
<p><a href="/tiy/t.asp?f=xdom_nodelist_item">亲自试一试</a></p>
</div>
