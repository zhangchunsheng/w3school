...
<div>
<h2>定义和用法</h2>
<p>item() 方法返回位于指定索引位置的节点。</p>

<h3>语法：</h3>
<pre>htmlcollectionObject.item(<i>index</i>)</pre>
...
<td>index</td>
<td>
	<p>必需。要返回的节点的索引位置。该值是大于 0 小于等于 HTMLCollection.length-1 的整数。</p>
	<p>节点或元素在 HTMLCollection 对象中出现的顺序与它们在文档源代码中出现的顺序一样。</p>
</td>
</tr>
</table>
...
<p>返回指定 <i>index</i> 处的元素或节点。如果 <i>index</i> 小于 0 或大于 length 属性，则返回 null。</p>

<h3>描述</h3>

<p>在 JavaScript 中，将 HTMLCollection 作为数组处理，用数组的语法索引它更容易一些。</p>
</div>
...
<pre>
var c = document.images;		<span>//这是一个 HTMLCollection 对象</span>
var img0 = c.item(0);		<span>//能够以这种方式使用 item() 方法</span>
var img1 = c.[1];			<span>//但是这种表示法更容易且更普遍</span>
</pre>
</div>
...
<p>XML DOM 参考手册：<a href="/xmldom/met_nodelist_item.asp">NodeList.item()</a></p>
</div>
