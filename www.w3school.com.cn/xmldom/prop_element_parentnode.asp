...
<title>XML DOM parentNode 属性</title>
</head>
...
<p>parentNode 属性返回指定节点的父节点。</p>

<h3>语法：</h3>
<pre>elementNode.parentNode</pre>
</div>
...
<p>下面的代码片段获取 &quot;books.xml&quot; 中第一个 &lt;title&gt; 元素的父节点：</p>

<pre>xmlDoc=loadXMLDoc(&quot;books.xml&quot;);

var x=xmlDoc.getElementsByTagName(&quot;title&quot;)[0];
var parent=<code>x.parentNode</code>;

document.write(&quot;Parent node: &quot; + parent.nodeName);</pre>

<p>以上代码的输出：</p>

<pre>Parent node: book</pre>
</div>

<div class="example">
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=xdom_parentnode">parentNode - 获取元素的父节点</a></dt>
</dl>
</div>
