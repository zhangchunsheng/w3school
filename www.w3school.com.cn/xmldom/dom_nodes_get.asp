...
<h2>节点操作</h2>
<ul>
<li class="currentLink"><a href="/xmldom/dom_nodes_get.asp" title="XML DOM 获取节点值">DOM 获取节点</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/xmldom/dom_nodes_navigate.asp" title="XML DOM 定位节点">DOM 定位节点</a></li>
<li class="next"><a href="/xmldom/dom_nodes_set.asp" title="XML DOM 改变节点值">DOM 改变节点</a></li>
</ul>
</div>


<div id="intro">
<p><strong>nodeValue 属性用于获取节点的文本值。</strong></p>
<p><strong>getAttribute() 方法返回属性的值。</strong></p>
</div>
...
<dd>本例使用 getElementsByTagname() 获取 &quot;books.xml&quot; 中第一个 &lt;title&gt; 元素。</dd>

<dt><a href="/tiy/t.asp?f=xdom_getattribute">获取属性的值</a></dt>
<dd>本例使用 getAttribute() 方法获取 &quot;books.xml&quot; 中第一个 &lt;title&gt; 元素的 &quot;lang&quot; 属性的值。</dd>
</dl>
</div>
...
<p>下面的代码通过使用 <a href="/xmldom/dom_loadxmldoc.asp" title="XML DOM 加载函数">loadXMLDoc()</a> 把 &quot;<a href="/example/xdom/books.xml">books.xml</a>&quot; 载入 xmlDoc 中，并检索第一个 &lt;title&gt; 元素：</p>

<pre>xmlDoc=loadXMLDoc(&quot;books.xml&quot;);

x=xmlDoc.getElementsByTagName(&quot;title&quot;)[0];</pre>

<p>childNodes 属性返回子节点的列表。&lt;title&gt; 元素只有一个子节点，即一个文本节点。</p>
...
<p>结果：txt = &quot;Harry Potter&quot;</p>

<p><a href="/tiy/t.asp?f=xdom_getelementsbytagname">TIY</a></p>

<p>遍历所有 &lt;title&gt; 元素：<a href="/tiy/t.asp?f=xdom_getelementsbytagname_1">TIY</a></p>
</div>
...
<p>getAttribute() 方法返回属性的值。</p>

<p>下面的代码检索第一个 &lt;title&gt; 元素的 &quot;lang&quot; 属性的文本值：</p>
...
<p><a href="/tiy/t.asp?f=xdom_getattribute">TIY</a></p>

<p>遍历所有 &lt;book&gt; 元素，并获取它们的 &quot;category&quot; 属性：<a href="/tiy/t.asp?f=xdom_getattribute_1">TIY</a></p>
</div>
...
<p>getAttributeNode() 方法返回属性节点。</p>

<p>下面代码检索第一个 &lt;title&gt; 元素的 &quot;lang&quot; 属性的文本值：</p>
...
<p><a href="/tiy/t.asp?f=xdom_getattributenode">TIY</a></p>

<p>循环所有 &lt;book&gt; 元素并获取它们的 &quot;category&quot; 属性：<a href="/tiy/t.asp?f=xdom_getattributenode_1">TIY</a></p>
</div>
