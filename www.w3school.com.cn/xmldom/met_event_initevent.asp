...
<title>XML DOM initEvent() 方法</title>
</head>
...
<h1>XML DOM initEvent() 方法</h1>

<div class="backtoreference">
<p><a href="/xmldom/dom_event.asp" title="XML DOM Event 对象">Event 对象参考手册</a></p>
</div>

<div>
<h2>定义和用法</h2>

<p>initEvent() 方法初始化新事件对象的属性。</p>

<h3>语法</h3>
<pre>event.initEvent(<i>eventType</i>,<i>canBubble</i>,<i>cancelable</i>)</pre>
...
<p>
该方法将初始化 <a href="/xmldom/met_document_createevent.asp" title="XML DOM createEvent() 方法">Document.createEvent() 方法</a> 创建的合成 Event 对象的 type 属性、bubbles 属性和 cancelable 属性。

只有在新创建的 Event 对象被 <a href="/xmldom/dom_document.asp" title="XML DOM - Document 对象">Document 对象</a> 或 <a href="/xmldom/dom_element.asp" title="XML DOM - Element 对象">Element 对象</a> 的 <a href="/xmldom/met_element_dispatchevent.asp" title="XML DOM dispatchEvent() 方法">dispatchEvent() 方法</a> 分派之前，才能调用 Event.initEvent() 方法。
</p>
</div>
