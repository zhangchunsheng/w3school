...
<p>该方法与 <a href="/xmldom/met_element_getattributenode.asp" title="XML DOM getAttributeNode() 方法">getAttributeNode() 方法</a>类似，只是属性名由命名空间 URI 和在这个命名空间中定义的本地名共同指定。只有使用命名空间的 XML 文档才使用该方法。</p>
</div>
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=xdom_element_getattributenode">获取属性的值</a></dt>
