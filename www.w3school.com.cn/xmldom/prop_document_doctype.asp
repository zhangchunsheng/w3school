...
<title>XML DOM doctype 属性</title>
</head>
...
<div>
<h2>定义和用法</h2>
<p>doctype 属性可返回与文档相关的文档类型声明（Document Type Declaration）。</p>
<p>对于没有 DTD 的 XML 文档，则返回 null。</p>
<p>此属性可提供对 DocumentType 对象（Document 的一个子节点）的直接访问。</p>

<h3>语法：</h3>
<pre>documentObject.doctype</pre>
</div>

<div>
<h2>实例</h2>

<p>在所有的例子中，我们将使用 XML 文件 <a href="/example/xdom/note_internal_dtd.xml">note_internal_dtd.xml</a>，以及 JavaScript 函数 <a href="/xmldom/dom_loadxmldoc.asp" title="XML DOM 加载函数">loadXMLDoc()</a>。</p>

<p>下面的代码片段可返回一个 DocumentType 对象：</p>
<pre>xmlDoc=loadXMLDoc(&quot;note_internal_dtd.xml&quot;);
document.write(<code>xmlDoc.doctype</code>);</pre>

<h3>输出：</h3>
<pre>[object DocumentType]</pre>
</div>

<div class="example">
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=xdom_doctype">取得与 XML 文档相关联的 DOCTYPE 的名称</a></dt>
</dl>
</div>
