...
<div>
<h2>定义和用法</h2>
<p>length 属性返回节点的文本的长度（以字符计）。</p>

<h3>语法：</h3>
<pre>textNode.length</pre>
</div>
...
<p>下面的代码片段输出 &quot;books.xml&quot; 中第一个 &lt;title&gt; 元素的文本节点数据和长度：</p>
...
document.write(<code>x.length</code>);</pre>

<h3>输出：</h3>
<pre>Everyday Italian - Length: 16</pre>
</div>

<div class="example">
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=xdom_text_length">length - 获取的文本节点的长度</a></dt>
</dl>
</div>
