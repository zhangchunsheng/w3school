...
<title>XML DOM clearParameters() 方法</title>
</head>
...
<h1>XML DOM clearParameters() 方法</h1>
...
<p>clearParameters() 方法删除所有样式表参数值。</p>

<h3>语法：</h3>
<pre>clearParameters()</pre>

<h3>描述</h3>
<p>这个方法删除 <a href="/xmldom/met_xsltprocessor_setparameter.asp" title="XML DOM setParameter() 方法">setParameter()</a> 已经指定的所有参数值。如果不带参数集来执行转换，那么样式表会使用指定的默认值。</p>
</div>
