...
<title>XML DOM getParameter() 方法</title>
</head>
...
<p>getParameter() 方法返回指定的参数的值。</p>

<h3>语法：</h3>
<pre>getParameter(<i>namespaceURI</i>,<i>localName</i>)</pre>
