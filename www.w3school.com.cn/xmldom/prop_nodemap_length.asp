...
<div>
<h2>定义和用法</h2>
<p>length 属性可返回 NamedNodeMap 中的节点数目。</p>

<h3>语法</h3>
<pre>nodemapObject.length</pre>
</div>
...
<p>下面的代码片段可取得 XML 文档的第一个 &lt;book&gt; 元素中属性的数目：</p>
<pre>
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=xdom_nodemap_length">length - 可返回指定的节点地图中的节点数目</a></dt>
<dt><a href="/tiy/t.asp?f=xdom_length">length - 可返回节点列表中节点的数目</a></dt>
<dt><a href="/tiy/t.asp?f=xdom_length2">length - 可循环遍历节点列表中的节点</a></dt>
</dl>
</div>
