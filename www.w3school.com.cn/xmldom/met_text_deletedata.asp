...
<div>
<h2>定义和用法</h2>
<p>deleteData() 方法从文本节点删除数据。</p>

<h3>语法：</h3>
<pre>deleteData(start,length)</pre>
...
<tr>
<td>start</td>
<td>必需。规定从何处开始删除数据。开始值以 0 开始</td>
</tr>
...
<p>下面的代码片段从 &quot;books.xml&quot; 中的第一个 &lt;title&gt; 元素的文本节点删除一些字符：</p>

<pre>xmlDoc=loadXMLDoc(&quot;books.xml&quot;);
x=xmlDoc.getElementsByTagName(&quot;title&quot;)[0].childNodes[0];

<code>x.deleteData(0,9);</code>
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=xdom_deletedata">deleteData() - 从文本节点删除文本</a></dt>
</dl>
</div>
