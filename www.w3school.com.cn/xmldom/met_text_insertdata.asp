...
<div>
<h2>定义和用法</h2>
<p>insertData() 方法向文本节点插入数据。</p>

<h3>语法：</h3>
<pre>insertData(start,string)</pre>
...
<p>下面的代码片段向 &quot;books.xml&quot; 中的第一个 &lt;title&gt; 元素的文本节点插入一个字符串：</p>

<pre>xmlDoc=loadXMLDoc(&quot;books.xml&quot;);
x=xmlDoc.getElementsByTagName(&quot;title&quot;)[0].childNodes[0];

<code>x.insertData(0,&quot;Cooking: &quot;);</code>
document.write(x.data);</pre>

<h3>输出：</h3>
<pre>Cooking: Everyday Italian</pre>
</div>
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=xdom_text_insertdata">insertData() - 向文本节点插入文本</a></dt>
</dl>
</div>
