...
<title>XML DOM compareDocumentPosition() 方法</title>
</head>
...
<h1>XML DOM compareDocumentPosition() 方法</h1>
...
<div>
<h2>定义和用法</h2>
<p>compareDocumentPosition() 方法可根据文档顺序使用指定的节点比较当前节点的文档位置。</p>

<h3>语法：</h3>
<pre>nodeObject.compareDocumentPostition(node)</pre>
...
<p>下面的代码片段可比较第一个 book 元素与第三个 book 元素的文档位置：</p>
<pre>xmlDoc=loadXMLDoc(&quot;books.xml&quot;);

var x=xmlDoc.getElementsByTagName('book')[0];
var y=xmlDoc.getElementsByTagName('book')[2];

document.write(<code>x.compareDocumentPosition(y)</code>);</pre>

<h3>输出：</h3>
<pre>4</pre>

<p class="note"><span>注释：</span>Internet Explorer 会忽略节点间生成的空白文本节点（例如，换行符号），而 Mozilla 不会这样做。因此，在上面的例子中，Mozilla 浏览器会输出 4，而 Internet Explorer 会输出 2。</p>
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=xdom_element_comparedocumentposition">compareDocumentPosition() - 比较两个节点的文档位置</a></dt>
</dl>
</div>
