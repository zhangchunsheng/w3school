...
<title>XML DOM setParameter() 方法</title>
</head>
...
<p>setParameter() 方法设置一个样式表参数。</p>

<h3>语法：</h3>
<pre>setParameter(<i>namespaceURI</i>,<i>localName</i>,<i>value</i>)</pre>
