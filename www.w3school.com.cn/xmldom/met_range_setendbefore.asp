...
<title>XML DOM setEndBefore() 方法</title>
</head>
...
<div>
<h2>定义和用法</h2>
<p>setEndBefore() 方法在指定的节点之前结束范围。</p>

<h3>语法：</h3>
<pre>setEndBefore(<i>refNode</i>)</pre>
...
<tr>
<td>refNode</td>
<td>一个节点，要设置的范围的结束点位于该节点之前。</td>
</tr>
</table>


<h3>抛出</h3>
<p>该方法将在与 <a href="/xmldom/met_range_setendafter.asp" title="XML DOM setEndAfter() 方法">Range.setEndAfter() 方法</a>一样的环境中抛出相同的异常。</p>

<h3>描述</h3>
<p>该方法将把范围的结束点设置为指定的 <i>refNode</i> 节点之前的位置。</p>
</div>
