...
<title>XML DOM createProcessingInstruction() 方法</title>
</head>
...
<h1>XML DOM createProcessingInstruction() 方法</h1>
...
<div>
<h2>定义和用法</h2>
<p>createProcessingInstruction() 方法创建 ProcessingInstruction 节点。</p>

<h3>语法：</h3>
<pre>createProcessingInstruction(<i>target</i>,<i>data</i>)</pre>
...
<h3>返回值</h3>
<p>新创建的 ProcessingInstruction 节点。</p>

<h3>抛出</h3>
<p>如果 <i>target</i> 中含有不合法的字符，则抛出代码为 INVALID_CHARACTER_ERR 的 <a href="/xmldom/dom_domexception.asp" title="XML DOM - DOMException 对象">DOMException 异常</a>。</p>
<p>如果是一个 HTML 文档，不支持处理指令，将抛出代码为 NOT_SUPPORTED_ERR 的 <a href="/xmldom/dom_domexception.asp" title="XML DOM - DOMException 对象">DOMException 异常</a>。</p>
</div>
