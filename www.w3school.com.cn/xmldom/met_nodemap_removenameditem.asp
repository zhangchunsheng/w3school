...
<title>XML DOM removeNamedItem() 方法</title>
</head>
...
<h1>XML DOM removeNamedItem() 方法</h1>
...
<div>
<h2>定义和用法</h2>
<p>removeNamedItem() 方法可删除指定的节点。</p>
<p>如果被删除的属性拥有默认值，那么一个新的属性会立即产生，连同命名空间 URI、本地名称、前缀。</p>
<p>此方法可返回被删除的节点。</p>

<h3>语法：</h3>
<pre>removeNamedItem(nodename)</pre>
...
<p>以下代码片段可循环遍历 &lt;book&gt; 元素，并删除 category 属性：</p>
<pre>
...
for(i=0;i&lt;x.length;i++)
  {
  <code>x.item(i).attributes.removeNamedItem(&quot;category&quot;);</code>
  }
</pre>
</div>
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=xdom_removenameditem">removeNamedItem() - 删除一个项目</a></dt>
</dl>
</div>
