...
<div>
<h2>定义和用法</h2>
<p>isSameNode() 方法可在某个节点与给定的节点是同一个节点时返回 true，否则返回 false。</p>

<h3>语法：</h3>
<pre>nodeObject.isSameNode(node)</pre>
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=xdom_element_haschildnodes">isSameNode() - 检查两个节点是否为同一个节点</a></dt>
</dl>
</div>
