...
<title>XML DOM importStylesheet() 方法</title>
</head>
...
<h1>XML DOM importStylesheet() 方法</h1>
...
<p>importStylesheet() 方法指定一个 XSLT 样式表用于转换。</p>

<h3>语法：</h3>
<pre>importStylesheet(<i>stylesheet</i>)</pre>
...
<td>
<p>要用于转换的 XSLT 样式表。</p>
<p>可以是 Document，也可以是 &lt;xsl:stylesheet&gt; 或 &lt;xsl:transform&gt; 元素。</p>
</td>
</tr>
</table>

<h3>说明</h3>
<p>importStylesheet() 指定了将来调用 <a href="/xmldom/met_xsltprocessor_transformtodocument.asp" title="XML DOM transformToDocument() 方法">transformToDocument()</a> 和 <a href="/xmldom/met_xsltprocessor_transformtofragment.asp" title="XML DOM transformToFragment() 方法">transformToFragment()</a> 要用到的 XSLT 样式表。</p>
</div>
