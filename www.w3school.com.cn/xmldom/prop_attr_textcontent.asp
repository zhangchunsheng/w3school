...
<p>textContent 属性设置或返回属性的文本内容。</p>

<h3>语法：</h3>
<pre>attrObject.textContent</pre>
</div>
...
<p>下面的代码片段返回 category 属性的文本内容：</p>
...
{
document.write(<code>x.item(i).attributes[0].textContent</code>);
document.write(&quot;&lt;br /&gt;&quot;);
}</pre>
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=xdom_attr_textcontent">textContent - 获取属性的文本内容</a>（不支持 IE 浏览器）</dt>

<dt><a href="/tiy/t.asp?f=xdom_attr_textcontent_set">textContent - 设置属性的文本内容</a>（不支持 IE 浏览器）</dt>
</dl>
</div>
