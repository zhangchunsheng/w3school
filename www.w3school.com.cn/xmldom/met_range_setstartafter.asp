...
<title>XML DOM setStartAfter() 方法</title>
</head>
...
<h1>XML DOM setStartAfter() 方法</h1>
...
<div>
<h2>定义和用法</h2>
<p>setStartAfter() 方法在指定的节点后开始范围。</p>
...
<h3>描述</h3>
<p>该方法将把范围的开始点设置为紧邻指定的 <i>refNode</i> 节点的位置。</p>
</div>
