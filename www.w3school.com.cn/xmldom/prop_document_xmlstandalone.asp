...
<title>XML DOM xmlStandalone 属性</title>
</head>
...
<h1>XML DOM xmlStandalone 属性</h1>
...
<div>
<h2>定义和用法</h2>
<p>xmlStandalone 属性可设置或返回文档是否为 standalone。</p>

<h3>语法：</h3>
<pre>documentObject.xmlStandalone</pre>
</div>
...
<p>以下代码片段可显示 XML 的编码方法、standalone 属性以及文档的 XML 版本：</p>
<pre>
xmlDoc=loadXMLDoc(&quot;books.xml&quot;);

document.write(&quot;XML encoding: &quot; + xmlDoc.xmlEncoding);
document.write(&quot;&lt;br /&gt;&quot;);
document.write(&quot;XML standalone: &quot; + <code>xmlDoc.xmlStandalone</code>);
document.write(&quot;&lt;br /&gt;&quot;);
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=xdom_doc_xmlencoding">取得 XML 的编码方法、standalone 属性以及文档的 XML 版本</a></dt>
</dl>
</div>
