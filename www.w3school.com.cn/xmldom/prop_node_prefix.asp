...
<div>
<h2>定义和用法</h2>
<p>prefix 属性可设置或返回节点的命名空间前缀。</p>

<h3>语法：</h3>
<pre>nodeObject.prefix</pre>
</div>
...
<p>下面的代码片段可返回 &lt;title&gt; 元素的命名空间前缀：</p>
<pre>
...
for(i=0;i&lt;x.length;i++)
  {
  document.write(<code>x.item(i).prefix</code>);
  document.write(&quot;&lt;br /&gt;&quot;);
  }
</pre>
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=xdom_node_prefix">取得某个空间的前缀、本地命名、命名空间 URI 以及基准 URI</a></dt>
</dl>
</div>
