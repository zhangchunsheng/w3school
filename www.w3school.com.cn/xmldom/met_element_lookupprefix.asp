...
<p>lookupPrefix() 方法返回在当前节点上匹配指定的命名空间 URI 的前缀。</p>

<h3>语法：</h3>
<pre>elementNode.lookupPrefix(URI)</pre>
...
<p>下面的代码片段查找第一个 &lt;book&gt; 元素中匹配命名空间 URI 的前缀：</p>

<pre>xmlDoc=loadXMLDoc(&quot;books_ns.xml&quot;);

x=xmlDoc.getElementsByTagName(&quot;book&quot;)[0];

document.write(x.lookupPrefix(&quot;http://www.w3school.com.cn/children/&quot;));</pre>
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=xdom_element_lookupprefix">lookupPrefix() - 通过命名空间获取前缀</a></dt>
</dl>
</div>
