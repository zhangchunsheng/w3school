...
<title>XML DOM localName 属性</title>
</head>
...
<p>localName 属性返回被选元素的本地名称（元素名称）。</p>

<p>如果选定的节点不是元素或属性，则该属性返回 NULL。</p>

<h3>语法：</h3>
<pre>elementNode.localName</pre>
</div>
...
<h3>例子 1</h3>
<p>下面的代码片段从 &quot;books.xml&quot; 中的第一个 &lt;book&gt; 元素获取本地名称：</p>

<pre>xmlDoc=loadXMLDoc(&quot;books.xml&quot;);
x=xmlDoc.getElementsByTagName(&quot;book&quot;)[0];

document.write(<code>x.localName</code>);</pre>
...
<h3>例子 2</h3>
<p>下面的代码片段从 &quot;books.xml&quot; 中的最后一个 &lt;book&gt; 元素获取本地名称：</p>
...
document.write(<code>lastNode.localName</code>);</pre>
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=xdom_localname">localName - 获取节点的本地名称</a></dt>

<dt><a href="/tiy/t.asp?f=xdom_localname2">localName - 获取最后一个子节点的本地名称</a></dt>
</dl>
</div>
