...
<title>XML DOM namespaceURI 属性</title>
</head>
...
<h1>XML DOM namespaceURI 属性</h1>

<div class="backtoreference">
<p><a href="/xmldom/dom_attribute.asp" title="XML DOM Attr 对象">Attr 对象参考手册</a></p>
</div>

<div>
<h2>定义和用法</h2>

<p>namespaceURI 属性设置或返回属性的命名空间 URI。</p>

<h3>语法：</h3>
<pre>attrObject.namespaceURI</pre>
</div>
...
<p>下面的代码片段返回 &quot;lang&quot; 属性的 namespace URI：</p>

<pre>xmlDoc=loadXMLDoc(&quot;/example/xdom/books_ns.xml&quot;);

var x=xmlDoc.getElementsByTagName('title');

for(i=0;i&lt;x.length;i++)
{
document.write(<code>x.item(i).attributes[0].namespaceURI</code>);
document.write(&quot;&lt;br /&gt;&quot;);
}</pre>

<p>以上代码的输出：</p>

<pre>http://www.w3school.com.cn/children/
http://www.w3school.com.cn/xml/</pre>
</div>

<div class="example">
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=xdom_attr_namespaceuri">获取属性的 namespaceURI</a></dt>
</dl>
</div>
