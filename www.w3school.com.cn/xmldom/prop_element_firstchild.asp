...
<p>firstChild 属性返回被选节点的第一个子节点。</p>

<p>如果选定的节点没有子节点，则该属性返回 NULL。</p>
<h3>语法：</h3>
<pre>elementNode.firstChild</pre>
</div>

<div>
<h2>提示和注释</h2>
<p class="note"><span>注释：</span>Internet Explorer 会忽略节点之间生成的空白文本节点（比如换行字符），而 Mozilla 不这么做。因此，在下面的例子中，我们用一个函数来检测第一个子节点的节点类型。</p>
...
<p>下面的代码片段从 &quot;books.xml&quot; 中获取第一个子节点：</p>

<pre>//check if the first node is an element node
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=xdom_firstchild">firstChild - 获取 XML 文档中的第一个子节点</a></dt>
</dl>
</div>
