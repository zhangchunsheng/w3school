...
<title>XML DOM getNamedItem() 方法</title>
</head>
...
<div>
<h2>定义和用法</h2>
<p>getNamedItem() 方法可返回指定的节点。</p>

<h3>语法：</h3>
<pre>getNamedItem(nodename)</pre>
...
<p>下面的代码片段可循环遍历 &lt;book&gt; 元素，并输出 category 属性的值：</p>
<pre>
