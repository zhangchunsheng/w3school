...
<div>
<p><a href="/xmldom/dom_namednodemap.asp">NamedNodeMap 对象参考手册</a></p>
</div>

<div>
<h2>定义和用法</h2>
<p>item() 方法可返回节点列表中处于指定索引号的节点。</p>
...
<p>以下代码片段可循环遍历 &lt;book&gt; 元素，并输出 category 属性的值：</p>
<pre>
...
for(i=0;i&lt;x.length;i++)
  {
  var att=<code>x.item(i).attributes.getNamedItem(&quot;category&quot;)</code>;
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=xdom_nodelist_item">item() - 循环遍历节点列表中的项目</a></dt>
<dt><a href="/tiy/t.asp?f=xdom_getnameditem">getNamedItem() - 取得某个项目的值</a></dt>
<dt><a href="/tiy/t.asp?f=xdom_getnameditem2">getNamedItem() - 改变某个项目的值</a></dt>
</dl>
</div>
