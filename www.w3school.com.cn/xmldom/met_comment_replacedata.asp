...
<div>
<h2>定义和用法</h2>
<p>replaceData() 方法用指定的字符串替换注释节点中的数据。</p>

<h3>语法：</h3>
<pre>commentNode.replaceData(<i>start</i>,<i>length</i>,<i>string</i>)</pre>
...
<tr>
<td>string</td>
<td>必需。要替换由 <i>start</i> 和 <i>length</i> 指定的字符的字符串。</td>
</tr>
</table>

<h3>描述</h3>

<p>该方法用字符串 <i>string</i> 替换从 <i>start</i> 开始的 <i>length</i> 个字符。如果 <i>start</i> 加 <i>length</i> 大于 Comment 节点的长度，那么从 <i>start</i> 开始的所有字符都讲被替换。</p>
</div>
...
<p>以下代码段使用 JavaScript 函数 <a href="/xmldom/dom_loadxmldoc.asp" title="XML DOM 加载函数">loadXMLDoc()</a> 把 XML 文件 <a href="/example/xdom/books_comment.xml">books_comment.xml</a> 载入 xmlDoc 中，然后用 &quot;Paperback&quot; 替换第一个 &lt;book&gt; 元素的注释节点中的 &quot;Hardcover&quot;：</p>
...
if (x[i].nodeType==8)
  ...
  <code>x[i].replaceData(10,9,&quot;Easy&quot;);</code>
...
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=xdom_comment_replaceData">replaceData() - 替换注释节点中的数据</a></dt>
</dl>
</div>
...
<p>XML DOM 参考手册：<a href="/xmldom/met_characterdata_replacedata.asp">CharacterData.replaceData()</a></p>
</div>
