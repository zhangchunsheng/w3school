...
<li class="currentLink"><a href="/xlink/xlink_example.asp" title="XLink 实例">XLink 实例</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/xlink/xlink_syntax.asp" title="XLink 和 XPointer 语法">XLink 语法</a></li>
<li class="next"><a href="/xlink/xpointer_example.asp" title="XPointer 实例">XPointer 实例</a></li>
</ul>
</div>

<div id="intro">
<p><strong>让我们通过研究一个实例来学习一些基础的 XLink 语法</strong></p>
</div>

<div>
<h2>XML 实例文档</h2>
<p>请看下面的 XML 文档，&quot;bookstore.xml&quot;，它用来呈现书籍：
...
<p><a href="/xlink/bookstore.xml">在您的浏览器查看 &quot;bookstore.xml&quot; 文件</a>。</p>
<p>在上面的例子中，XLink 文档命名空间被声明于文档的顶部：</p>
<pre>xmlns:xlink=&quot;http://www.w3.org/1999/xlink&quot;</pre>
<p>这意味着文档可访问 XLink 的属性和特性。</p>
<p>xlink:type=&quot;simple&quot; 可创建简单的类似 HTML 的链接。您也可以规定更多的复杂的链接（多方向链接），但是目前，我们仅使用简易链接。</p>
<p>xlink:href 属性规定了要链接的 URL，而 xlink:show 属性规定了在何处打开链接。xlink:show=&quot;new&quot; 意味着链接（在此例中，是一幅图像）会在新窗口打开。</p>
</div>
