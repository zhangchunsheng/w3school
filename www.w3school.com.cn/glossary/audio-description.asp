...
<title>W3C 术语 - audio description</title>
</head>
...
<h1>W3C 术语 - audio description</h1>
...
<h3>解释</h3>
<p>音频描述（在 Web Content Accessibility Guidelines 1.0 [WCAG10] 中称为听觉描述）既是预先录制的人类声音，也可以是描述电影或其他动画的关键可视元素的合成语音。音频描述与表现的音轨（可能是音轨的组成部分）是同步的。音频描述包含有关动作、肢体语言、图形以及场景改变的信息。</p>
