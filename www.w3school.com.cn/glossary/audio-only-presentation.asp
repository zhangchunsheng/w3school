...
<title>W3C 术语 - audio-only presentation</title>
</head>
...
<h1>W3C 术语 - audio-only presentation</h1>
...
<p class="chinese"><span>中文：</span>纯音频呈现、纯音频演示</p>

<h3>解释</h3>
<p>纯音频呈现是完全由一个或多个并行或串行呈现的音轨构成的内容。纯音频呈现的例子包括音乐演奏会、无线电式的新闻广播，以及叙事。</p>
