...
<li class="currentLink"><a href="/htmldom/dom_elements.asp" title="HTML DOM 元素">DOM 元素</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/htmldom/dom_content.asp" title="HTML DOM 内容">DOM 内容</a></li>
<li class="next"><a href="/htmldom/dom_events.asp" title="HTML DOM 事件">DOM 事件</a></li>
</ul>
</div>


<div id="intro">
<p>添加、删除和替换 HTML 元素。</p>
</div>
...
<p class="tiy"><a target="_blank" href="/tiy/t.asp?f=dom_elementcreate2">亲自试一试</a></p>
</div>
...
<p class="tiy"><a target="_blank" href="/tiy/t.asp?f=dom_elementremove">亲自试一试</a></p>

<h3>例子解释</h3>

<p>这个 HTML 文档包含一个带有两个子节点（两个 &lt;p&gt; 元素）的 &lt;div&gt; 元素：</p>
...
<p class="tiy"><a target="_blank" href="/tiy/t.asp?f=dom_elementreplace">亲自试一试</a></p>
</div>
