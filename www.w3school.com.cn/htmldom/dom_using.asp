...
<li class="currentLink"><a href="/htmldom/dom_using.asp" title="HTML DOM 访问">DOM 访问</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/htmldom/dom_properties.asp" title="HTML DOM 属性">DOM 属性</a></li>
<li class="next"><a href="/htmldom/dom_modify.asp" title="HTML DOM 修改">DOM 修改</a></li>
</ul>
</div>


<div id="intro">
<p>访问 HTML DOM - 查找 HTML 元素。</p>
</div>
...
<p class="tiy"><a target="_blank" href="/tiy/t.asp?f=dom_getelementsbytagname">亲自试一试</a></p>

<p>下面的例子返回包含文档中所有 &lt;p&gt; 元素的列表，并且这些 &lt;p&gt; 元素应该是  id=&quot;main&quot; 的元素的后代（子、孙等等）：</p>

<h3>实例 2</h3>

<pre>document.getElementById(&quot;main&quot;).getElementsByTagName(&quot;p&quot;);</pre>

<p class="tiy"><a target="_blank" href="/tiy/t.asp?f=dom_getelementsbytagname2">亲自试一试</a></p>
</div>
...
<p>如果您希望查找带有相同类名的所有 HTML 元素，请使用这个方法：</p>

<pre>document.getElementsByClassName(&quot;intro&quot;);</pre>

<p>上面的例子返回包含 class=&quot;intro&quot; 的所有元素的一个列表：</p>

<p class="note"><span>注释：</span>getElementsByClassName() 在 Internet Explorer 5,6,7,8 中无效。</p>
</div>
