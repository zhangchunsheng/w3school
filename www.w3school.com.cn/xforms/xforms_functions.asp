...
<li class="currentLink"><a href="/xforms/xforms_functions.asp" title="XForms 函数">XForms 函数</a></li>
</ul>
<h2>XForms 参考手册</h2>
<ul>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/xforms/xforms_actions.asp" title="XForms 行为（Actions）">XForms 行为</a></li>
<li class="next"><a href="/xforms/xforms_typeref.asp" title="XForms 数据类型参考手册">XForms 数据类型</a></li>
</ul>
</div>
