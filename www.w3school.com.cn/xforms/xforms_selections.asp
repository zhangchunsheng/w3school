...
<li class="currentLink"><a href="/xforms/xforms_selections.asp" title="XForms 选择控件">XForms 选择</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/xforms/xforms_input.asp" title="XForms 输入控件">XForms 输入</a></li>
<li class="next"><a href="/xforms/xforms_datatypes.asp" title="XForms 数据类型">XForms 数据类型</a></li>
</ul>
</div>

<div id="intro">
<p><strong>XForms 用户界面使用 XForms 控件。</strong></p>
</div>

<div>
<h2>Select1 控件</h2>
<p>select1 控件用于从一个项目列表中选取一个项目：</p>
<pre>&lt;select1 ref=&quot;status&quot;&gt;
  ...
  &lt;/item&gt;
&lt;/select1&gt;</pre>
<p>在上面的例子中，用户可在两个值中选择其中之一，Male 或者 Female。存储在 XForms 实例（XML 文档）中的数据将是 M 或 F。</p>
<p>Try it yourself</p>
</div>

<div>
<h2>Select 控件</h2>
<p>Select 控件用于从一个项目列表中选取项目（一个或多个）：</p>
...
<div>
<h2>Range 控件</h2>
<p>Range 控件用于从值的一个范围内选取值：</p>
<pre>&lt;range ref=&quot;length&quot; start=&quot;0&quot; end=&quot;100&quot; step=&quot;5&quot;&gt;
  &lt;label&gt;Length:&lt;/label&gt;
&lt;/range&gt;</pre>
<p>在上面的例子中，用户可按照步长 5 选择介于 0 到 100 之间的某个值。</p>
</div>
