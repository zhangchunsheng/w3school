...
<li class="currentLink"><a href="/xforms/xforms_example.asp" title="XForms 实例">XForms 实例</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/xforms/xforms_namespace.asp" title="XForms 命名空间">XForms 命名空间</a></li>
<li class="next"><a href="/xforms/xforms_xpath.asp" title="XForms 和 XPath">XForms XPath</a></li>
</ul>
</div>
...
<p>页面会显示为这样：</p>
<img src="/xforms/i/xforms_model_01.gif" alt="xforms_example" />
