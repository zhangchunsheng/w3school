...
<body id="homesecond" class="dotnet">
<div id="wrapper">
...
<p><a href="/aspnet/index.asp" title="ASP.NET 教程">进一步了解 ASP.NET 开发框架</a> ！</p>
</div>
...
<p><a href="/aspnet/webpages_intro.asp" title="ASP.NET Web Pages - 教程">开始学习 ASP.NET Web Pages</a> ！</p>
</div>
...
<p>Razor 是一种允许您向网页中嵌入基于服务器的代码（Visual Basic 和 C#）的标记语法。</p>

<p>Razor 基于 ASP.NET，它为 web 应用程序的创建而设计。它拥有传统 ASP.NET 标记的能力，但更易使用，也更易学习。</p>

<p><a href="/aspnet/razor_intro.asp" title="ASP.NET Razor - 标记">开始学习 Razor</a> ！</p>
</div>
...
<p><a href="/aspnet/mvc_intro.asp" title="ASP.NET MVC - 教程">开始学习 ASP.NET MVC</a> ！</p>
</div>
...
<p><a href="/aspnet/aspnet_intro.asp" title="ASP.NET Web Forms - 教程">开始学习 ASP.NET Web Forms</a> ！</p>
</div>
