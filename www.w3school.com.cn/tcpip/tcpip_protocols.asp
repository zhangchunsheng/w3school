...
<li class="currentLink"><a href="/tcpip/tcpip_protocols.asp" title="TCP/IP 协议">TCP/IP 协议</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/tcpip/tcpip_addressing.asp" title="TCP/IP 寻址">TCP/IP 寻址</a></li>
<li class="next"><a href="/tcpip/tcpip_email.asp" title="TCP/IP 邮件">TCP/IP 邮件</a></li>
</ul>
</div>

<div id="intro">
<p><strong>TCP/IP 是不同的通信协议的大集合。</strong></p>
</div>

<div>
<h2>协议族</h2>
<p>TCP/IP 是基于 TCP 和 IP 这两个最初的协议之上的不同的通信协议的大的集合。</p>
</div>
...
<div>
<h2>LDAP - 轻量级的目录访问协议</h2>
<p>LDAP 用于从因特网搜集关于用户和电子邮件地址的信息。</p>
</div>

<div>
<h2>ICMP - 因特网消息控制协议</h2>
<p>ICMP 负责网络中的错误处理。</p>
</div>
