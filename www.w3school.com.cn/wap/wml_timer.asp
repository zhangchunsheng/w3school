...
<li class="currentLink"><a href="/wap/wml_timer.asp" title="WML 计时器">WML 计时器</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/wap/wml_tasks.asp" title="WML 任务">WML 任务</a></li>
<li class="next"><a href="/wap/wml_variables.asp" title="WML 变量">WML 变量</a></li>
</ul>
</div>
...
<p>可以制作 WML 卡片来使用 WML 的计时器功能。计时器的时间单位是一秒的十分之一。</p>

<p>下面的例子将用 3 秒来显示一条消息，然后切换到文件 &quot;test.wml&quot;：</p>
