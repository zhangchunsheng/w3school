...
<p>table 标签定义表格。</p>
<p class="note"><span>注释：</span>&lt;table&gt; 标签与 &lt;tr&gt; 和 &lt;td&gt; 一起使用，来创建创建表格。</p>
<p class="note"><span>注释：</span>number 属性是必需的。值 0 不允许使用。</p>
<p class="note"><span>注释：</span>WML 表格没有边框。</p>
...
<td>对齐列中的文本。规定一系列的对齐值，每个对应一列。</td>
</tr>
