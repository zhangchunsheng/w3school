...
<ul>
<li class="currentLink"><a href="/wap/index.asp" title="WAP 教程">WAP 教程</a></li>
...
<li class="next"><a href="/wap/wap_intro.asp" title="WAP 简介">WAP 简介</a></li>
</ul>
</div>

<div id="intro">
<p><strong>WAP 协议被设计为用来在诸如移动电话之类的无线客户端上展示因特网内容。</strong></p>
<p><strong>WML 是用来创建供 WAP 浏览器显示的页面的语言。</strong></p>
<p><strong>在我们的 WAP 教程，你将学习关于 WAP 和 WML 的知识。</strong></p>
<p><strong>你将学习如何将网页转换为袖珍的格式（pocket format），这样你的信息就可以被诸如移动电话之类的无线客户端访问到。</strong></p>
<p><a href="/wap/wap_intro.asp" title="WAP 简介">开始学习WAP / WML</a>！</p>
</div>

<div>
<h2>WML 参考手册</h2>
<p>在 W3School 我们提供完整的 WML 参考手册，包括元素、属性、实体等等。</p>
<p><a href="/wap/wml_reference.asp" title="WML Reference">WML 参考手册</a></p>
</div>
