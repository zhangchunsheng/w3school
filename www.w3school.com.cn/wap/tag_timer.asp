...
<p>&lt;timer&gt; 标签定义卡片计时器。当进入卡片时，该计时器启动，在退出卡片时，计时器停止。</p>

<p class="note"><span>注释：</span>每张卡片不允许一个以上的 timer 元素。</p>
<p class="note"><span>注释：</span>计时器的事件单位是一秒的十分之一。</p>
<p class="note"><span>注释：</span>此标签可与 &lt;card&gt;、&lt;onevent&gt; 以及 &lt;template&gt; 一起使用。</p>

<h3>语法</h3>
<pre>&lt;timer value=&quot;somevalue&quot;/&gt;</pre>
...
<td>value</td>
<td><i>cdata</i></td>
<td>必需。设置定义于 &quot;name&quot; 属性的变量的默认值。</td>
</tr>

<tr>
<td>name</td>
<td><i>nmtoken</i></td>
<td>对变量进行命名，该变量通过计时器的值进行设置。</td>
</tr>
...
<p>下面的例子将把 &quot;Hello World!&quot; 显示 3 秒钟，然后跳转到 &quot;test.wml&quot;：</p>
