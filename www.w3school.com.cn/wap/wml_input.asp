...
<li class="currentLink"><a href="/wap/wml_input.asp" title="WML 输入">WML 输入</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/wap/wml_links.asp" title="WML 链接和图像">WML 连接</a></li>
<li class="next"><a href="/wap/wml_tasks.asp" title="WML 任务">WML 任务</a></li>
</ul>
</div>
...
<p>可以制作让用户可输入信息的 WML 卡片，正如这个例子演示的：</p>
...
<p>在您的移动电话显示屏上结果也许类似这样：</p>

<img src="i/ct_wap_input_input.gif" />
</div>

<div>
<h2>选择和选项</h2>

<p>可以制作 WML 卡片来显示 WML 的选择和选项功能：</p>
...
<img src="i/ct_wap_input_selectablelist.gif" />
 
<p>在下面的例子中，结果是一个用户可在其中选择多个项目的可选列表：</p>
...
<img src="i/ct_wap_input_selectablelist2.gif" />
</div>

<div>
<h2>Fieldset</h2>

<p>可以制作 WML 卡片来显示 WML 的 fieldset 函数：</p>
...
<img src="i/ct_wap_input_fieldset.gif" />
</div>
