...
<p>&lt;select&gt; 标签定义可选列表。</p>
<p class="note"><span>注释：</span>&lt;option&gt; 标签用于定义可选列表中的选项。</p>
...
<td>iname</td>
<td>nmtoken</td>
<td>命名变量，该变量通过选择的 index 结果进行设置。</td>
</tr>

<tr>
<td>ivalue</td>
<td>cdata</td>
<td>设置预选的 option 元素。</td>
</tr>
...
<td>设置是否可进行多选。默认是 &quot;false&quot;。</td>
</tr>

<tr>
<td>name</td>
<td>nmtoken</td>
<td>命名变量，该变量通过选择的结果进行设置。</td>
</tr>
