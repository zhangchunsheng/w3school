...
<p>&lt;do&gt; 标签可用于在用户点击屏幕上的一个单词或短语时激活一个任务。</p>

<p>&lt;do&gt; 标签也可以嵌套在 &lt;template&gt; 标签内，这样 &lt;do&gt; 标签就可以应用到 deck 中的所有卡片。</p>
...
<td>必需。定义 &quot;do&quot; 元素的类型。</td>
</tr>

<tr>
<td>label</td>
<td>cdata</td>
<td>为 &quot;do&quot; 元素创建 label。</td>
</tr>
...
<td>如果该属性设置为 true，则浏览器忽略该元素，如果设置为 false，则浏览器不会忽略该元素。默认是 &quot;false&quot;。</td>
</tr>
...
<p>下面的例子在一个 &lt;template&gt; 标签中使用了一个 &lt;do&gt; 标签，来向每个卡片添加一个 &quot;Back&quot; 链接：</p>
...
<div>
<h2>注释：</h2>
<p>如果单个 &lt;card&gt; 包含多个类型为 &quot;accept&quot; 的 &lt;do&gt; 元素，且这些 &lt;do&gt; 元素没有被命名，WML 会出现编译错误，而且不会显示出页面。</p>
<p>引起这种情况的原因是，如果没有规定名称，那么默认的名称是元素的类型（accept）。</p>
</div>
