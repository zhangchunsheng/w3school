...
<p>&lt;optgroup&gt; 标签定义可选列表中的一组选项。</p>
<p class="note"><span>注释：</span>&lt;optgroup&gt; 标签必须位于 select 元素中。</p>
