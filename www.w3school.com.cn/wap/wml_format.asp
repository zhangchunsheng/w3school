...
<li class="currentLink"><a href="/wap/wml_format.asp" title="WML 格式化">WML 格式化</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/wap/wap_basic.asp" title="WAP 基础">WAP 基础</a></li>
<li class="next"><a href="/wap/wml_links.asp" title="WML 链接和图像">WML 连接</a></li>
</ul>
</div>
...
<p>WML 页面通常称为 &quot;deck&quot;。每个 deck 含有一系列的 card。card 元素可包含文本、标记、链接、输入字段、task、图像等等。卡片之间通过链接彼此相互联系。</p>

<p>当从移动电话访问一张 WML 页面时，页面中的所有卡片都会从 WAP 服务器下载下来。卡片之间的导航是通过电话的计算机完成的 - 在电话内部 - 不需要对服务器的额外访问：</p>
...
<p>在您的移动电话显示屏上，结果应该类似这样（请注意每次只显示一个 card）：</p>

<img src="/wap/i/ct_wap_formatting_helloworld.gif" alt="card 1" />
</div>

<div>
<h2>段落和换行</h2>

<p>可以编写显示段落和换行的 WML 卡片：</p>
...
<p>在您的移动电话显示屏上，结果应该类似这样：</p>

<img src="/wap/i/ct_wap_formatting_paragraph.gif" alt="Paragraphs" />
</div>

<div>
<h2>文本格式化</h2>

<p>可以编写显示格式化文本的 WML 卡片：</p>
...
<p>在您的移动电话显示屏上，结果应该类似这样（不要认为所有格式化标签都会按照预期的效果呈现）：</p>

<img src="/wap/i/ct_wap_formatting_text.gif" alt="Formatting" />
</div>

<div>
<h2>表格</h2>

<p>可以编写显示表格的 WML 卡片：</p>
...
<img src="i/ct_wap_formatting_table.gif" alt="Table" />
