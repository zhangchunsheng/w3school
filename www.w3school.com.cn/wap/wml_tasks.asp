...
<li class="currentLink"><a href="/wap/wml_tasks.asp" title="WML 任务">WML 任务</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/wap/wml_input.asp" title="WML 输入">WML 输入</a></li>
<li class="next"><a href="/wap/wml_timer.asp" title="WML 计时器">WML 计时器</a></li>
</ul>
</div>

<div>
<p><strong>任务 (task) 定义了事件发生时所执行的动作，比如在输入一个卡片或选择一个链接之类的时间发生时。</strong></p>
</div>

<div>
<h2>Go 任务</h2>

<p>&lt;go&gt; 任务表示切换到一个新卡片的动作。</p>
...
<p>&lt;refresh&gt; 任务会刷新一些指定的卡片变量。如果变量显示在屏幕上，任务也会刷新屏幕。</p>

<p>下面的例子使用 &lt;anchor&gt; 标签向卡片添加了一个 &quot;Refresh this page&quot; 链接。当用户点击该链接时，他或她会刷新页面，同时变量 x 的值将被设置为 30：</p>
...
<p>&lt;noop&gt; 任务规定不做任何事（noop 指的是 &quot;no operation&quot;）。此标签用于覆盖卡片组级别的元素。</p>

<p>&lt;do&gt; 标签用于在用户点击屏幕上的某个单词或短语时启动一个任务。</p>

<p>下面的例子使用 &lt;do&gt; 标签向卡片添加一个 &quot;Back&quot; 链接。当用户点击这个 &quot;Back&quot; 链接时，他或他被被带回前面的卡片。但是 &lt;noop&gt; 标签阻止了这个操作；当用户点击 &quot;Back&quot; 时，不会发生任何事情：</p>
...
<tr>
<td>&lt;refresh&gt;</td>
<td>刷新一些指定的卡片变量。如果有变量显示在屏幕上，此任务也刷新屏幕。</td>
<td>1.1</td>
</tr>
</table>
</div>
