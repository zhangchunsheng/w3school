...
<li class="currentLink"><a href="/wap/wml_links.asp" title="WML 链接和图像">WML 连接</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/wap/wml_format.asp" title="WML 格式化">WML 格式化</a></li>
<li class="next"><a href="/wap/wml_input.asp" title="WML 输入">WML 输入</a></li>
</ul>
</div>
...
<p>可以制作 WML 卡片来显示 WML 的锚功能。</p>

<h3>&lt;anchor&gt;</h3>
<p>&lt;anchor&gt; 标签总是要规定一个任务 (&quot;go&quot;, &quot;prev&quot;, 或 &quot;refresh&quot;)。任务定义了当用户选择此链接时要做的事情。在本例中，当用户选择 &quot;Next page&quot;，其任务是 &quot;前往 test.wml&quot;：</p>
...
<h3>&lt;a&gt;</h3>
<p>&lt;a&gt; 标签永远执行 &quot;go&quot; 任务，不带参数。下面的例子与那个 &lt;anchor&gt; 标签的例子起得作用是相同的：</p>
...
<p>在您的移动电话显示屏上，结果也许类似这样：</p>

<img src="i/ct_wap_link_image.gif" alt="image" />
 
<p>请注意，.wbmp 是唯一可以显示在 WAP 浏览器中的图像类型。</p>
</div>
