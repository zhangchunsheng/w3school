...
<p>&lt;go&gt; 任务表示跳转到新卡片的动作。在 href 属性中规定跳转的目的地。</p>
<p class="note"><span>注释：</span>&lt;go&gt; 标签的内容是可选的。</p>
<p class="note"><span>注释：</span>&lt;go&gt; 标签可包含 &lt;postfield&gt; 或 &lt;setvar&gt; 标签。</p>
...
<tr>
<td class="no_wrap">accept-charset</td>
<td>charset_list</td>
<td>服务器能够处理的字符编码列表，用逗号或空格分隔。默认值是 &quot;unknown&quot;。</td>
</tr>
