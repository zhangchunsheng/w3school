...
<title>ADO NumericScale 属性</title>
</head>
...
<div>
<h2>定义和用法</h2>
<p>NumericScale 属性设置或返回 Byte 值，指示 Field 或 Parameter 对象的数字值要精确的小数位数。</p>

<table class="dataintable">
    <tr>
      <th>对象</th>
      <th>NumericScale 属性的描述</th>
    </tr>
    <tr>
      <td>Field</td>
      <td>
        <p>对于 Field 对象，NumericScale 通常为只读。但是，对于已追加到 Record 的 Fields 集合中的新 Field 对象，只有当 Field 的 Value 属性已被指定并且数据提供者通过调用 Fields 集合的 Update 方法成功添加了新的 Field 时，NumericScale 才为读/写。</p>
      </td>
    </tr>
    <tr>
      <td>Parameter</td>
      <td>对于 Parameter 对象，NumericScale 属性拥有读/写权限。</td>
    </tr>
</table>

<h3>语法</h3>
<pre>object.NumericScale</pre>
</div>
