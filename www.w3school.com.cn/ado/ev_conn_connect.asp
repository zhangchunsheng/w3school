...
<title>ADO WillConnect, ConnectComplete 以及 Disconnect 事件</title>
</head>
...
<h1>ADO WillConnect, ConnectComplete 以及 Disconnect 事件</h1>
...
<ul>
<li>WillConnect 事件在连接开始之前被触发。</li>
<li>ConnectComplete 事件在连接开始之后被触发。</li>
<li>Disconnect 事件在连接结束后被触发。</li>
</ul>
...
<table class="dataintable"> 
  ...
  <tr>
    ...
    <td>一个包含用于连接的信息的字符串。</td>
  </tr>
  <tr>
    <td>userid</td>
    <td>一个包含用于连接的用户名的字符串。</td>
  </tr>
  <tr>
    <td>psword</td>
    <td>一个包含用于连接的密码的字符串。</td>
  </tr>
  <tr>
    <td>options</td>
    <td>Long 值，指示提供者计算 ConnectionString 的方式。唯一的选项是 adAsyncOpen。</td>
  </tr>
  <tr>
    <td>objerror</td>
    <td>
	<p>包含所发生错误的 Error 对象。</p>
	<p>注释：<a href="#eventstatusenum">EventStatusEnum</a> 值必需设置为 adStatusErrorsOccurred ，以创建 Error 对象。</p>
	</td>
  </tr>
  <tr>
    <td>status</td>
    <td>
	<p>一个 <a href="#eventstatusenum">EventStatusEnum</a> 值。默认是 adStatusOK。</p>
	<p>当调用 ConnectComplete 时，如果 WillConnect 事件请求取消挂起的连接，此参数将设置为 adStatusCancel。</p>
	</td>
  </tr>
  <tr>
    <td>objconn</td>
    <td>应用此事件的 Connection 对象。</td>
  </tr>
</table>
</div>
