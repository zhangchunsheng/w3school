...
<title>ADO ConnectionString 属性</title>
</head>
...
<div>
<h2>定义和用法</h2>
<p>ConnectionString 属性可设置或返回用于建立到数据源的连接的信息。</p>

<p class="note"><span>注释：</span>您不能同时使用 Provider 和 File Name 参数。</p>

<h3>语法</h3>
<pre>objconn.ConnectionString=&quot;para1=value;para2=value;etc;&quot;</pre>

<p>ConnectionString 属性有 5 个参数：</p>
<table class="dataintable">
    ...
    <tr>
      <td>File Name</td>
      <td>提供者特有的文件（例如，持久保留的数据源对象）的名称，这些文件中包含预置的连接信息。</td>
    </tr>
    <tr>
      <td>Remote Provider</td>
      <td>当打开客户端连接时使用的提供者的名称。（仅限于远程数据服务。）</td>
    </tr>
    <tr>
      <td>Remote Server</td>
      <td>当打开客户端连接时使用的服务器的路径名称。（仅限于远程数据服务。）</td>
    </tr>
    <tr>
      <td>url</td>
      <td>标识资源（比如文件或目录）的绝对 URL。</td>
    </tr>
</table>
</div>
...
<code>conn.ConnectionString=&quot;Provider=Microsoft.Jet.OLEDB.4.0&quot;</code>
