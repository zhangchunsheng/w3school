...
<title>ADO NativeError 属性</title>
</head>
...
<h1>ADO NativeError 属性</h1>

<div class="backtoreference">
<p><a href="/ado/ado_ref_error.asp" title="ADO Error 对象">返回 ADO Error 对象参考手册</a></p>
</div>

<div>
<h2>定义和用法</h2>
<p>NativeError 属性可返回一个 long 值，该值是由提供者或数据源返回 ADO 的错误代码。</p>

<p>使用 NativeError 属性对某个 Error 对象检索数据库特有的错误信息。例如，当配合使用 Microsoft ODBC Provider for OLE DB 和 Microsoft SQL Server 数据库时，从 SQL Server 产生的原生错误代码将通过 ODBC 和 ODBC Provider 传递到 ADO NativeError 属性。</p>

<h3>语法</h3>
<pre>lngErrorNative=objErr.NativeError</pre>
</div>
