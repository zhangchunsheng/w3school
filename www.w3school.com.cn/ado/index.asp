...
<ul>
<li class="currentLink"><a href="/ado/index.asp" title="ADO 教程">ADO 教程</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/ado/index.asp" title="ADO 教程">ADO 教程</a></li>
<li class="next"><a href="/ado/ado_intro.asp" title="ADO 简介">ADO 简介</a></li>
</ul>
</div>

<div>
<p><strong>在我们的 ADO 教程中，您将学到有关 ADO 的知识，以及如何使用 ADO 从您的网站访问数据库。</strong></p>
<p><a href="/ado/ado_intro.asp" title="ADO 简介">开始学习 ADO</a> ！</p>
</div>

<div>
<h2>ADO 参考手册</h2>
<p>在 W3School，我们为您提供完整的 ADO 参考手册，其中包括内建对象，以及它们的属性和方法。</p>
<p><a href="/ado/ado_reference.asp">ADO 参考手册</a></p>
</div>

<div>
<h2>ADO 实例</h2>
<p>通过实例来学习！因为 ASP 脚本只能在服务器端执行，所以你无法在浏览器中查看 ASP 代码，你能看到的仅仅是由 ASP 输出的纯粹的 HTML 代码。</p>
<p>在 W3School，每个实例均可显示出以往被隐藏的 ASP 代码。这样，您就可以更容易理解它们的工作原理。</p>
<p><a href="/example/adoe_examples.asp">ADO 实例</a></p>
</div>
