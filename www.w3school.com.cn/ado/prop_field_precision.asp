...
<div>
<h2>定义和用法</h2>
<p>Precision 属性可设置或返回一个 byte 值，该值是表示 Parameter 或 Field 对象中的数值时所允许的最大位数。</p>

<h3>语法</h3>
<pre>objectname.Precision</pre>

<table class="dataintable">
    <tr>
      <th>对象</th>
      <th>Precision 属性的描述</th>
    </tr>
    <tr>
      <td>Field</td>
      <td>
        <p>对于 Field 对象，Precision 通常为只读。但是，对于已追加到 Record 的 Fields 集合的新 Field 对象，只有当已指定 Field 的 Value 属性并且数据提供者通过调用 Fields 集合的 Update 方法成功添加了新 Field 时，Precision 才为读/写。</p>
      </td>
    </tr>
    <tr>
      <td>Parameter</td>
      <td>对于 Parameter 对象，Precision属性拥有读/写权限。</td>
    </tr>
</table>
</div>
