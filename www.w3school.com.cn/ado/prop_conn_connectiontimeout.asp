...
<title>ADO ConnectionTimeout 属性</title>
</head>
...
<h1>ADO ConnectionTimeout 属性</h1>
...
<div>
<h2>定义和用法</h2>
<p>ConnectionTimeout 属性可设置或返回在终止尝试和产生错误之前打开连接需要等待的秒数。默认是 15 秒。</p>

<h3>语法</h3>
<pre>objconn.ConnectionTimeout</pre>
</div>
