...
<li class="currentLink"><a href="/ado/ado_summary.asp" title="您已经学习了 ADO，下一步呢？">ADO 总结</a></li>
</ul>
<h2>ADO 实例</h2>
<ul>
...
<h1>您已经学习了 ADO，下一步呢？</h1>

<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/ado/ado_datatypes.asp" title="ADO 数据类型">ADO 数据类型</a></li>
<li class="next"><a href="/example/adoe_examples.asp" title="ADO 实例">ADO 实例</a></li>
</ul>
</div>
...
<p>本教程已经向您讲解了如何从网站访问数据库中的数据。</p>

<p>您已经学习了如何在网站上显示来自数据库的数据，以及如何通过 ADO 来编辑、添加及删除这些数据。</p>

<p>如需更多有关 ADO 的信息，请参阅我们的 <a href="/example/adoe_examples.asp">ADO 实例</a>。</p>
</div>

<div>
<h2>您已经学习了 ADO，下一步呢？</h2>

<p>下一步应该学习 SQL。</p>

<p>SQL 是一门用于访问和操作数据库系统的标准计算机语言。</p>

<p>SQL 语句用于检索和更新数据库中的数据。SQL 可以和这些数据库系统配合工作：MS Access, DB2, Informix, MS SQL Server, Oracle, Sybase, 以及其他的数据库系统。</p>

<p>如果您需要学习更多有关 SQL 的知识，请访问我们的 <a href="/sql/index.asp">SQL 教程</a>。</p>
</div>
