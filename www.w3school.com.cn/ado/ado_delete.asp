...
<li class="currentLink"><a href="/ado/ado_delete.asp" title="ADO 删除记录">ADO 删除</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/ado/ado_update.asp" title="ADO 更新记录">ADO 更新</a></li>
<li class="next"><a href="/ado/ado_getstring.asp" title="ADO 通过 GetString() 加速脚本">ADO 加速</a></li>
</ul>
</div>
