...
<title>ADO DefaultDatabase 属性</title>
</head>
...
<div>
<h2>定义和用法</h2>
<p>DefaultDatabase 属性可设置或返回一个字符串值，该值是特定 Connection 对象上的默认数据库的名称。</p>

<h3>语法</h3>
<pre>objconn.DefaultDatabase</pre>
</div>
