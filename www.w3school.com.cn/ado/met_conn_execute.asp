...
<table class="dataintable"> 
  ...
  <tr>
    <td>options</td>
    <td>可选。设置提供者应当如何设置计算 commandtext 参数。可以是一个或多个 <a href="app_commandtypeenum.asp">CommandTypeEnum</a> 或 <a href="app_executeoptionenum.asp">ExecuteOptionEnum</a> 值。默认是 adCmdUnspecified。</td>
  </tr>
</table>
</div>
