...
<div>
<h2>定义和用法</h2>
<p>Name 属性可设置或返回一个字符串，该值包含 Command、Property、Field 或者 Parameter 对象的名称。</p>
...
<table class="dataintable">
    ...
    <tr>
      <td>Command</td>
      <td>Name 属性拥有对 Command 对象的读写权限。</td>
    </tr>
    <tr>
      <td>Property</td>
      <td>Name 属性拥有对 Property 属性的只读权限。</td>
    </tr>
    <tr>
      <td>Field</td>
      <td>在被用于创建 Recordset 时 Name 属性拥有读写权限，但是当您打开一个已有的 Recordset 时是只读的。</td>
    </tr>
    <tr>
      <td>Parameter</td>
      <td>对于尚未追加到 Parameters 集合的 Parameter 对象，Name 属性为读/写。对于已追加的 Parameter 对象和所有其他对象，Name 属性为只读。名称在集合中不必是唯一的。</td>
    </tr>
</table>
