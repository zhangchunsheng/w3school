...
<title>ADO WillExecute 和 ExecuteComplete 事件</title>
</head>
...
<h1>ADO WillExecute 和 ExecuteComplete 事件</h1>
...
<div>
<h2>定义和用法</h2>
<p>事件是某个具体的操作发生后被自动调用的子例程。</p>

<ul>
<li>WillExecute 事件在调用 objcomm.Execute, objconn.Execute 或者 objrs.Open 之前会被触发</li>
<li>ExecuteComplete 事件会在完成对 objcomm.Execute, objconn.Execute, objrs.Open, objrs.Requery 或 objrs.NextRecordset 的调用之后被触发</li>
</ul>
...
<table class="dataintable"> 
  ...
  <tr>
    <td>src</td>
    <td>字符串，包含 SQL 命令或存储过程名称。</td>
  </tr>
  <tr>
    <td>cursortyp</td>
    <td>规定要使用的游标类型。<a href="app_cursortypeenum.asp">CursorTypeEnum</a> 值之一。</td>
  </tr>
  <tr>
    <td>locktyp</td>
    <td>规定要使用的锁定类型。<a href="app_locktypeenum.asp">LockTypeEnum</a> 值之一。</td>
  </tr>
  <tr>
    <td>options</td>
    <td>一个或多个 <a href="app_commandtypeenum.asp">CommandTypeEnum</a> 或 <a href="app_executeoptionenum.asp">ExecuteOptionEnum</a> 值</td>
  </tr>
  <tr>
    <td>recaffected </td>
    <td>Long 值，该命令影响的记录的数目。</td>
  </tr>
  <tr>
    <td>objerror</td>
    <td>
	包含已发生的错误的 Error 对象。
	<p>注释：EventStatusEnum 值必须被设置为 adStatusErrorsOccurred，以创建该 Error 对象。</td>
  </tr>
  <tr>
    <td>status</td>
    <td>一个 <a href="#eventstatusenum">EventStatusEnum</a> 值。</td>
  </tr>
  <tr>
    <td>objcomm</td>
    <td>
	<p>对于 WillExecute：如果此事件由 Command.Execute 引发，objcomm 参数将引用 Command 对象，objrs 参数将设置为 Nothing。</p>
    <p>对于 ExecuteComplete：被执行的 Command 对象。</p>
    </td>
  </tr>
  <tr>
    <td>objrs</td>
    <td>
	<p>对于 WillExecute：如果此事件由 Recordset.Open 引发，objrs 参数将引用 Recordset 对象，pCommand 参数将设置为 Nothing。</p>
    <p>对于 ExecuteComplete：Recordset 对象，是命令执行的结果。</p>
    </td>
  </tr>
  <tr>
    <td>objconn</td>
    <td>与命令执行相关联的 Connection 对象。</td>
  </tr>
</table>
</div>
...
<div>
<h2><a id="eventstatusenum">EventStatusEnum 值</a></h2>
<table class="dataintable">
    <tr>
      <th>常量</th>
      <th>值</th>
