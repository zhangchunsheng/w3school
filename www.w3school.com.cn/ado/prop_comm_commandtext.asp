...
<title>ADO CommandText 属性</title>
</head>
...
<div>
<h2>定义和用法</h2>
<p>CommandText 属性可设置或返回一个字符串，该字符串包含一个 provider 命令，比如一条 SQL 语句、一个表名称、一个相对 URL、或者一个存储过程调用。默认值为零 &quot;&quot;（零长度字符串）。</p>

<h3>语法</h3>
<pre>objcommand.CommandText</pre>
</div>
