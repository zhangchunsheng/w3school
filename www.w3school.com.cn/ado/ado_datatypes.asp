...
<h2>ADO 总结</h2>
<ul>
<li class="currentLink"><a href="/ado/ado_datatypes.asp" title="ADO 数据类型">ADO 数据类型</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/ado/ado_ref_stream.asp" title="ADO Stream 对象">ADO Stream</a></li>
<li class="next"><a href="/ado/ado_summary.asp" title="您已经学习了 ADO，下一步呢？">ADO 总结</a></li>
</ul>
</div>

<div>
<p>下面的表格列出了 Access、SQL Server 与 Oracle 之间的数据类型映射：</p>
