...
<div>
<h2>定义和用法</h2>
<p>Delete 方法可从 Parameters 集合中删除某个对象。</p>
<p class="note"><span>注释：</span>此方法只能用在 Command 对象的 Parameters 集合上。</p>
<p>在调用 Delete 方法时您必须使用 Parameter 对象的 Name 属性或其集合索引 —— 对象变量不是有效的参数。</p>

<h3>语法</h3>
<pre>objparameter.Delete index</pre>
...
<table class="dataintable"> 
  ...
  <tr>
    <td>index</td>
    <td>String 值，该值包含要删除的对象的名称，或者对象在集合中的顺序位置（索引）。</td>
  </tr>
</table>
</div>
