...
<title>ADO IsolationLevel 属性</title>
</head>
...
<div>
<h2>定义和用法</h2>
<p>IsolationLevel 属性可设置或返回 Connection 对象的隔离级别。该值是一个 <a href="#isolationlevelenum">IsolationLevelEnum</a> 值。默认是 adXactChaos。</p>
<p class="note"><span>注释：</span>IsolationLevel 设置直到下次调用 BeginTrans 方法时才生效。</p>

<h3>语法</h3>
<pre>objconn.IsolationLevel</pre>
</div>
...
<div>
<h2><a id="isolationlevelenum">IsolationLevelEnum</a></h2>
<table class="dataintable">
  <tbody>
    ...
    <tr>
      ...
      <td>-1</td>
      <td>无法使用指定的隔离级别，因为提供者正在使用不同的隔离级别，而且该级别无法被确定。</td>
    </tr>
    <tr>
      <td>adXactChaos</td>
      <td>16</td>
    ...
    <tr>
      <td>adXactBrowse</td>
      <td>256</td>
      <td>可以从一个事务中查看其他事务中未提交的更改。</td>
    </tr>
    <tr>
      <td>adXactReadUncommitted</td>
      <td>256</td>
      <td>与 adXactBrowse 相同。</td>
    </tr>
    <tr>
      <td>adXactCursorStability</td>
      <td>4096</td>
      <td>只能从一个事务中查看其他事务中提交的更改。</td>
    </tr>
    <tr>
      <td>adXactReadCommitted</td>
      <td>4096</td>
      <td>与 adXactCursorStability 相同。</td>
    </tr>
    <tr>
      <td>adXactRepeatableRead</td>
      <td>65536</td>
      <td>不能从一个事务中查看其他事务中所作的修改，但是重新查询可以检索新的 Recordset 对象。</td>
    </tr>
    <tr>
