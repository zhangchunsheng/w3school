...
<div>
<h2>定义和用法</h2>
<p>Close 方法用于关闭 Connection 对象、Record 对象、Recordset 对象或者 Stream 对象，以释放系统资源。</p>

<p class="note"><span>注释：</span>关闭对象不会将其从内存中删除；随后可以更改其属性设置并再次将其打开。要从内存中彻底清除对象，请在关闭对象后将对象变量设置为 Nothing（在 Visual Basic 中）。</p>

<h3>语法</h3>
<pre>object.Close</pre>
</div>
