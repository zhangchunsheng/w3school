...
<div>
<h2><a id="locktypeenum">LockTypeEnum 值</a></h2>
<table class="dataintable">
    ...
    <tr>
      ...
      <td>未指定锁定类型。创建副本时，副本与源对象使用相同的锁定类型。</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>2</td>
      <td>指示逐个记录的保守式锁定。提供者要确保记录编辑成功，通常在编辑之后立即在数据源锁定记录。</td>
    </tr>
    <tr>
      <td>adLockOptimistic</td>
      <td>3</td>
      <td>指示逐个记录的开放式锁定。提供者使用开放式锁定，仅在调用 Update 方法时锁定记录。</td>
    </tr>
    <tr>
      <td>adLockBatchOptimistic</td>
      <td>4</td>
      <td>指示开放式批更新。需要批更新模式。</td>
    </tr>
</table>
</div>
