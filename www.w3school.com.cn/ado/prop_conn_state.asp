...
<p>State 属性可返回一个值，该值描述对象的当前状态是打开、关闭、正在连接、正在执行还是正在检索数据。该值返回 <a href="/ado/objectstateenum.asp">ObjectStateEnum</a> 值。默认值为 adStateClosed。</p>

<p>此属性可用于 Command, Connection, Record, Recordset 以及 Stream 对象。</p>

<p>State 属性可以是值的组合。例如，如果正在执行某个语句，此属性将有一个 adStateOpen 和 adStateExecuting 的组合值。</p>
