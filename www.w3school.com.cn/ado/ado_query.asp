...
<li class="currentLink"><a href="/ado/ado_query.asp" title="ADO 查询">ADO 查询</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/ado/ado_display.asp" title="ADO 显示">ADO 显示</a></li>
<li class="next"><a href="/ado/ado_sort.asp" title="ADO 排序">ADO 排序</a></li>
</ul>
</div>

<div>
<p><strong>我们可以使用 SQL 来创建查询，这样就可以指定仅查看选定的记录和字段。</strong></p>
</div>
...
<dd>如何仅仅显示 &quot;Customers&quot; 表的 &quot;Companyname&quot; 字段中以 A 开头的记录。</dd>

<dt><a href="/tiy/s.asp?f=demo_adoe_query_2">显示 &quot;Companyname&quot; 大于 E 的记录</a></dt>
<dd>如何仅仅显示 &quot;Customers&quot; 表的 &quot;Companyname&quot; 字段中大于 E 的记录。</dd>

<dt><a href="/tiy/s.asp?f=demo_adoe_query_3">仅显示西班牙的客户</a></dt>
<dd>如何仅仅显示 &quot;Customers&quot; 表中的西班牙客户。</dd>

<dt><a href="/tiy/s.asp?f=demo_adoe_query_4">让用户来选择筛选标准</a></dt>
<dd>让用户根据国别来选择客户</dd>
</dl>
</div>
...
<div>
<h2>显示选定的数据</h2>
<p>我们希望仅仅显示 &quot;Customers&quot; 表的 &quot;Companyname&quot; 字段中以 A 开头的记录：</p>
<pre>
&lt;html&gt;
&lt;body&gt;
...
<code>sql=&quot;SELECT Companyname, Contactname FROM Customers
WHERE CompanyName LIKE 'A%'&quot;</code>
rs.Open sql, conn
%&gt;
