...
<div>
<h2>定义和用法</h2>
<p>Mode 属性可设置或返回一个 <a href="#connectmodeenum">ConnectModeEnum</a> 值，该值指示在 Connection, Record 或 Stream 对象中修改数据的权限。在对象关闭时，此属性为读写，在对象打开时为只读。</p>

<ul>
<li>Connection 对象 - 默认是 adModeUnknown</li>
<li>Record 对象 - 默认是 adModeRead</li>
<li>Stream 对象 - 默认是 adModeRead 或 adModeUnknown</li>
</ul>

<p class="note"><span>注释：</span>该属性只能在 Connection 对象关闭时设置。</p>
...
<div>
<h2><a id="connectmodeenum">ConnectModeEnum</a></h2>
<table class="dataintable">
  <tbody>
    ...
    <tr>
      ...
      <td>16</td>
      <td>允许其他人以任何权限打开连接。不拒绝其他人的读或写访问。</td>
    </tr>
    <tr>
      <td>adModeRecursive</td>
      <td>0x400000</td>
      <td>与 adModeShareDenyNone, adModeShareDenyWrite 或 adModeShareDenyRead 一起使用，对当前 Record 的所有子记录设置权限。</td>
    </tr>
  </tbody>
</table>
</div>
