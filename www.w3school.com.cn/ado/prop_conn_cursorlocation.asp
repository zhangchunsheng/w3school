...
<title>ADO CursorLocation 属性</title>
</head>
...
<div>
<h2>定义和用法</h2>
<p>CursorLocation 属性可设置或返回一个 long 值，该值指示游标服务的位置。可被设置为 <a href="/ado/app_cursorlocationenum.asp">CursorLocationEnum</a> 值之一。默认值是 AdUseServer。</p>

<p>游标用于：</p> 
<ul>
<li>控制记录定位</li>
<li>控制其他用户对数据库所作的更改的可视性</li>
<li>控制数据可更新性</li>
</ul>
<p class="note"><span>注释：</span>Recordset 对象将从与它们相关联的连接上自动继承此设置。</p>
<p class="note"><span>注释：</span>此属性在 Connection 或已关闭的 Recordset 上为读/写，在打开的 Recordset 上为只读。</p>

<h3>语法</h3>
<pre>objConnection.CursorLocation
objRecordset.CursorLocation</pre>
</div>
