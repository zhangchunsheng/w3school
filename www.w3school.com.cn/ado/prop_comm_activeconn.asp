...
<title>ADO ActiveConnection 属性</title>
</head>
...
<div>
<h2>定义和用法</h2>
<p>ActiveConnection 属性可指示 Command 对象当前所属的 Connection 对象。

<p>如果连接被关闭，它可设置或返回连接的定义。如果连接打开，它会设置或返回当前的 Connection 对象。</p>

<h3>语法</h3>
<pre>objcommand.ActiveConnection</pre>
</div>
