...
<li class="currentLink"><a href="/ado/ado_intro.asp" title="ADO 简介">ADO 简介</a></li>
...
<li class="next"><a href="/ado/ado_connect.asp" title="ADO 数据库连接">ADO 连接</a></li>
</ul>
</div>

<div>
<p><strong>ADO 被用于从网页访问数据库。</strong></p>
</div>
...
<p>如果您希望首先学习这些项目，请在我们的 <a href="/" title="W3School 在线教程">首页</a> 访问这些教程。</p>
</div>
...
<ul>
<li>ADO 是一项微软的技术</li>
<li>ADO 指 ActiveX 数据对象（<em>A</em>ctiveX <em>D</em>ata <em>O</em>bjects）</li>
<li>ADO 是一个微软的 Active-X 组件</li>
<li>ADO 会随微软的 IIS 被自动安装</li>
