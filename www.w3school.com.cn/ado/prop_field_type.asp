...
<div>
<h2>定义和用法</h2>
<p>Type 属性可设置或返回一个 <a href="/ado/app_datatypeenum.asp">DataTypeEnum</a> 值，该值可指示 Parameter, Field 或 Property 对象的类型。</p>
...
<table class="dataintable"> 
  ...
  <tr>
    <td>Parameter</td>
    <td>对于 Parameter 对象，Type 属性拥有读/写权限。</td>
  </tr>
  <tr>
    <td>Field</td>
    <td>对于已追加到 Record 的 Fields 集合中的新 Field 对象，只有当 Field 的 Value 属性已被指定并且数据提供者通过调用 Fields 集合的 Update 方法成功添加了新的 Field 时，Type 才为读/写。</td>
  </tr>
  <tr>
    <td>Property</td>
    <td>对于 Property 对象，Type 属性是只读的。</td>
  </tr>
</table>

<h3>语法</h3>
<pre>objectname.Type</pre>
</div>
...
<p>针对 Property 对象：</p>
<pre><span class="CODE">&lt;%
</span>set conn=Server.CreateObject(&quot;ADODB.Connection&quot;)
conn.Provider=&quot;Microsoft.Jet.OLEDB.4.0&quot;
conn.Open &quot;c:/webdata/northwind.mdb&quot;
...
<span class="CODE">for each prop in rs.Properties
