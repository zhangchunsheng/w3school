...
<title>ADO InfoMessage 事件</title>
</head>
...
<p>InfoMessage 事件在连接操作期间出现警告时调用。</p>

<h3>语法</h3>
<pre>InfoMessage objerror,status,objconn</pre>
...
<table class="dataintable"> 
  ...
  <tr>
    <td>objerror</td>
    <td>Error 对象。此参数包含返回的任何错误。</td>
  </tr>
  <tr>
    <td>status</td>
    <td>一个 <a href="#eventstatusenum">EventStatusEnum</a> 值。如果出现警告，status 将被设置为 adStatusOK，并且 objerror 中包含该警告。</td>
  </tr>
  <tr>
    <td>objconn</td>
    <td>Connection 对象。引发警告的连接。</td>
  </tr>
</table>
</div>
