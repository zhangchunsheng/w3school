...
<title>ADO CommandType 属性</title>
</head>
...
<div>
<h2>定义和用法</h2>
<p>CommandType 属性可设置或返回一个 <a href="/ado/app_commandtypeenum.asp">CommandTypeEnum</a> 值，该值可定义 Command 对象的类型。默认是 adCmdUnknown。</p>
<p>如果您没有规定此类型，ADO 将需要联系 provider 以确定命令的类型。如果您定义了该类型，则 ADO 将有能力更快地处理此命令。</p>

<h3>语法</h3>
<pre>objcommand.CommandType</pre>
</div>
