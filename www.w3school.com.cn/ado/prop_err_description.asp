...
<title>ADO Description 属性</title>
</head>
...
<div>
<h2>定义和用法</h2>
<p>Description 属性可返回一个字符串，该字符串包含对错误的描述。</p>

<p>这是 Error 对象的默认属性。提供者和 ADO 均可成为错误源。</p>

<p>提供者负责向 ADO 传递特定的错误文本。对于接收到的每一个提供者错误或警告，ADO 都会向 Errors 集合中添加一个 Error 对象。枚举 Errors 集合以跟踪提供者传递的错误。</p>

<h3>语法</h3>
<pre>strErrorText=objErr.Description</pre>
</div>
