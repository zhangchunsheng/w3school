...
<li class="currentLink"><a href="/ado/ado_update.asp" title="ADO 更新记录">ADO 更新</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/ado/ado_add.asp" title="ADO 添加记录">ADO 添加</a></li>
<li class="next"><a href="/ado/ado_delete.asp" title="ADO 删除记录">ADO 删除</a></li>
</ul>
</div>

<div>
<p><strong>我们可使用 SQL 的 UPDATE 来更新数据库表中的某条记录。</strong></p>
</div>

<div>
<h2>更新数据库表中的记录</h2>
<p>我们希望更新 Northwind 数据中 Customers 表的某条记录。首先我们需要创建一个表格，来列出 Customers 中的所有记录。</p>
<pre>
&lt;html&gt;
&lt;body&gt;
&lt;%
...
<p>如果用户点击 &quot;customerID&quot; 列中的按钮，会打开一个新文件 &quot;demo_update.asp&quot;。此文件包含了创建输入域的源代码，这些输入域基于数据库中记录的字段，同时也含有一个保存修改的“更新按钮”：</p>
<pre>&lt;html&gt;
&lt;body&gt;
