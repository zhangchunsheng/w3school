...
<div>
<h2><a id="commandtypeenum">CommandTypeEnum 值</a></h2>
<table class="dataintable">
    ...
    <tr>
      <td>adCmdText</td>
      <td>1</td>
      <td>按命令或存储过程调用的文本定义计算 CommandText。</td>
    </tr>
    <tr>
      <td>adCmdTable</td>
      <td>2</td>
      <td>按表名计算 CommandText，该表的列全部是由内部生成的 SQL 查询返回的。</td>
    </tr>
    <tr>
      <td>adCmdStoredProc</td>
      <td>4</td>
      <td>按存储过程名计算 CommandText。</td>
    </tr>
    <tr>
      <td>adCmdUnknown</td>
      <td>8</td>
      <td>默认值。指示 CommandText 属性中命令的类型未知。</td>
    </tr>
    <tr>
      <td>adCmdFile</td>
      <td>256</td>
      <td>按持久存储的 Recordset 的文件名计算 CommandText。仅与 Recordset.Open 或 Requery 使用。</td>
    </tr>
    <tr>
      <td>adCmdTableDirect</td>
      <td>512</td>
      <td>按表名计算 CommandText，该表的列被全部返回。仅与 Recordset.Open 或 Requery 使用。如需使用 Seek 方法，Recordset 必须通过 adCmdTableDirect 打开。该值不能与 ExecuteOptionEnum 值 adAsyncExecute 结合。</td>
    </tr>
</table>
</div>
