...
<div>
<h2>定义和用法</h2>
<p>Provider 属性可设置或返回包含特定 Connection 对象的提供者名称的字符串值。默认是 MSDASQL (Microsoft OLE DB provider for ODBC)。请参阅 <a href="#providercodes">Provider 代码</a>。</p>
<p>在连接关闭时，此属性是可读写的。</p>
<p>提供者名称也可通过 Connection 对象的 ConnectionString 属性或者 Open 方法的 ConnectionString 参数来设置。</p>
<p class="note"><span>注释：</span>请不要在多个地方为特定的 Connection 设置 provider。</p>

<h3>语法</h3>
<pre>connobj.Provider</pre>
</div>
...
<div>
<h2><a id="providercodes">Provider 代码</a></h2>
<table class="dataintable"> 
  ...
  <tr>
    <td>Microsoft.Jet.OLEDB.4.0</td>
    <td>Microsoft Jet databases</td>
  </tr>
  <tr>
    <td>MSDAIPP.DSO.1</td>
    <td>Microsoft Internet Publishing</td>
  </tr>
  <tr>
    <td>MSDAORA</td>
    <td>Oracle databases</td>
  </tr>
  <tr>
    <td>MSDAOSP</td>
  ...
  <tr>
    <td>MSDASQL</td>
    <td>Microsoft OLE DB provider for ODBC</td>
  </tr>
  <tr>
    <td>MSDataShape</td>
    <td>Microsoft Data Shape</td>
  </tr>
  <tr>
    <td>MSPersist</td>
    <td>Locally saved files</td>
  </tr>
  <tr>
    <td>SQLOLEDB</td>
