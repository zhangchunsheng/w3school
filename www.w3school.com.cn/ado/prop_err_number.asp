...
<div>
<h2>定义和用法</h2>
<p>Number 属性指示唯一标识 Error 对象的数字。 </p>

<p>返回 Long 值，该值可能对应于一个 ErrorValueEnum 常量。</p>

<p>使用 Number 属性确定发生了哪个错误。属性的值是与错误条件对应的唯一数字。</p>

<p>Errors 集合以十六进制格式（例如 0x80004005）或以 Long 值（例如 2147467259）返回 HRESULT。这些 HRESULT 由基本组件生成，如 OLE DB，甚至是 OLE 本身。</p>

<h3>语法</h3>
<pre>lngErrorNumber=objErr.Number</pre>
</div>
