...
<li class="currentLink"><a href="/xquery/xquery_intro.asp" title="XQuery 简介">XQuery 简介</a></li>
...
<li class="next"><a href="/xquery/xquery_example.asp" title="XQuery 实例">XQuery 实例</a></li>
</ul>
</div>


<div id="intro">
<p><strong>解释 XQuery 最佳方式是这样讲：XQuery 相对于 XML 的关系，等同于 SQL 相对于数据库表的关系。</strong></p>
...
<p>“从存储在名为 cd_catalog.xml 的 XML 文档中的 CD 集那里选取所有价格低于 10 美元的 CD 记录。”</p>
</div>
