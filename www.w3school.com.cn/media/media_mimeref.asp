...
<li class="currentLink"><a href="/media/media_mimeref.asp" title="MIME 参考手册">MIME 参考</a></li>
</ul>
</div><div id="selected">
<h2>建站手册</h2>
<ul>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/media/media_playerref.asp" title="Windows Media Player 参考手册">播放器参考</a></li>
<li class="next"><a href="/media/index.asp" title="网络多媒体 教程">媒体教程</a></li>
</ul>
</div>
...
<ul>
	<li><a href="http://www.rfc-editor.org/rfc/rfc822.txt" title="rfc822">RFC-822</a> Standard for  ARPA Internet text messages</li>
	<li><a href="http://www.rfc-editor.org/rfc/rfc2045.txt" title="rfc2045">RFC-2045</a> MIME Part 1: Format of Internet Message Bodies</li>
	<li><a href="http://www.rfc-editor.org/rfc/rfc2046.txt" title="rfc2046">RFC-2046</a> MIME Part 2: Media Types</li>
	<li><a href="http://www.rfc-editor.org/rfc/rfc2047.txt" title="rfc2047">RFC-2047</a> MIME Part 3: Header Extensions for Non-ASCII Text</li>
	<li><a href="http://www.rfc-editor.org/rfc/rfc2048.txt" title="rfc2048">RFC-2048</a> MIME Part 4: Registration Procedures</li>
	<li><a href="http://www.rfc-editor.org/rfc/rfc2049.txt" title="rfc2049">RFC-2049</a> MIME Part 5: Conformance Criteria and Examples </li>
</ul>

<p>不同的应用程序支持不同的 MIME 类型。</p>

<p>下面的参考手册是由 Microsoft Internet Information Server version 5 所支持的 MIME 类型列表。</p>
</div>
