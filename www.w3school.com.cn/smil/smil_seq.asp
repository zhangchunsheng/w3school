...
<li class="currentLink"><a href="/smil/smil_seq.asp" title="SMIL in Parallel">SMIL Sequence</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/smil/smil_timing.asp" title="SMIL Timing">SMIL Timing</a></li>
<li class="next"><a href="/smil/smil_parallel.asp" title="SMIL Parallel">SMIL Parallel</a></li>
</ul>
</div>

<div id="intro">
<p><strong>&lt;seq&gt; - 最常用的 SMIL 元素 - 定义序列。</strong></p>
</div>

<div>
<h2>序列元素 &lt;seq&gt;</h2>

<p>&lt;seq&gt; 元素可定义序列。&lt;seq&gt; 元素中的子元素依次显示在序列中。</p>

<p>您可以使用 &lt;seq&gt; 元素来定义要显示的图像列表、段落列表、视频列表，或任何其他的元素。</p>

<p>&lt;seq&gt; 元素拥有许多属性，最常用的属性有：</p>
...
<p><a href="/tiy/t.asp?f=smil_seq_img">TIY</a></p>
</div>
...
<p><a href="/tiy/t.asp?f=smil_seq_text">TIY</a></p>
</div>
