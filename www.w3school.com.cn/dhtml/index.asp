...
<ul>
<li class="currentLink"><a href="/dhtml/index.asp" title="DHTML 教程">DHTML 教程</a></li>
...
<li class="next"><a href="/dhtml/dhtml_intro.asp" title="DHTML 简介">DHTML 简介</a></li>
</ul>
</div>


<div id="intro">
<p><strong>DHTML 是一种使 HTML 页面具有动态特性的艺术。</strong></p>
<p><strong>DHTML 是一种创建动态和交互 WEB 站点的技术集。</strong></p>
<p><strong>对大多数人来说，DHTML 意味着 HTML、样式表和 JavaScript 的组合。</strong></p>
<p><a href="/dhtml/dhtml_intro.asp" title="DHTML简介">开始学习 DHTML</a> ！</p>
</div>


<div>
<h2>DHTML 参考手册</h2>
<p>在 W3School，你能找到所有 DOM 对象的完整 DHTML DOM 参考手册，以及它们的属性和方法。</p>
<p><a href="/htmldom/htmldom_reference.asp" title="HTML DOM 参考手册">HTML DOM 参考手册</a></p>
</div>


<div>
<h2>DHTML 实例</h2>
<p>学习 100 个实例！使用我们的编辑器，你可以编辑源代码，单击 test 按钮来查看结果。</p>
<p><a href="/example/dhtm_examples.asp" title="DHTML 实例">DHTML 实例</a></p>
<p><a href="/example/hdom_examples.asp">HTML DOM 实例</a></p>
</div>
