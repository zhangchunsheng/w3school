...
<li class="currentLink"><a href="/webservices/ws_use.asp" title="Web Services 使用">WS 使用</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/webservices/ws_example.asp" title="Web Services 实例">WS 实例</a></li>
<li class="next"><a href="/webservices/ws_summary.asp" title="您已经学习了 Web Services,下一步学习什么内容呢？">WS 总结</a></li>
</ul>
</div>
