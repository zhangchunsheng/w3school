...
<p class="note"><span>注释：</span><a href="/tags/canvas_filltext.asp" title="HTML5 canvas fillRect() 方法">fillText()</a> 或 <a href="/tags/canvas_stroketext.asp" title="HTML5 canvas strokeText() 方法">strokeText()</a> 方法在画布上定位文本时，将使用指定的 textBaseline 值。</p>
