...
<li class="currentLink"><a href="/tags/tag_img.asp" title="HTML &lt;img&gt; 标签">&lt;img&gt;</a></li>
...
<p class="tiy"><a target="_blank" href="/tiy/t.asp?f=html_image_test">亲自试一试</a></p>
...
<p>img 元素向网页中嵌入一幅图像。</p>

<p>请注意，从技术上讲，&lt;img&gt; 标签并不会在网页中插入图像，而是从网页上链接图像。&lt;img&gt; 标签创建的是被引用图像的占位空间。</p>

<p>&lt;img&gt; 标签有两个必需的属性：<a href="/tags/att_img_src.asp">src 属性</a> 和 <a href="/tags/att_img_alt.asp">alt 属性</a>。</p>

<p class="note"><span>延伸阅读：</span><a href="#how-to-use-image">如何正确地使用图像</a></p>
</div>
...
<p>在 HTML 4.01 中，不推荐使用 image 元素的 &quot;align&quot;、&quot;border&quot;、&quot;hspace&quot; 以及 &quot;vspace&quot; 属性。</p>

<p>在 XHTML 1.0 Strict DTD 中，不支持 image 元素的 &quot;align&quot;、&quot;border&quot;、&quot;hspace&quot; 以及 &quot;vspace&quot; 属性。</p>
</div>
...
<tr>
<td><a href="/tags/att_img_alt.asp" title="HTML &lt;img&gt; 标签的 alt 属性">alt</a></td>
<td><i>text</i></td>
<td>规定图像的替代文本。</td>
</tr>

<tr>
<td><a href="/tags/att_img_src.asp" title="HTML &lt;img&gt; 标签的 src 属性">src</a></td>
<td><i>URL</i></td>
<td>规定显示图像的 URL。</td>
</tr>
</table>
...
<tr>
<td><a href="/tags/att_img_align.asp" title="HTML &lt;img&gt; 标签的 align 属性">align</a></td>
<td>
<ul>
<li>top</li>
<li>bottom</li>
...
<td><span class="deprecated">不推荐使用。</span>规定如何根据周围的文本来排列图像。</td>
</tr>

<tr>
<td><a href="/tags/att_img_border.asp" title="HTML &lt;img&gt; 标签的 border 属性">border</a></td>
<td><i>pixels</i></td>
<td><span class="deprecated">不推荐使用。</span>定义图像周围的边框。</td>
</tr>

<tr>
<td><a href="/tags/att_img_height-width.asp" title="HTML &lt;img&gt; 标签的 height 和 width 属性">height</a></td>
<td>
<ul>
<li><i>pixels</i></li>
<li><i>%</i></li>
...
<tr>
<td><a href="/tags/att_img_hspace_vspace.asp" title="HTML &lt;img&gt; 标签的 hspace 和 vspace 属性">hspace</a></td>
<td><i>pixels</i></td>
<td><span class="deprecated">不推荐使用。</span>定义图像左侧和右侧的空白。</td>
</tr>

<tr>
<td><a href="/tags/att_img_ismap.asp" title="HTML &lt;img&gt; 标签的 ismap 属性">ismap</a></td>
<td><i>URL</i></td>
<td>将图像定义为服务器端图像映射。</td>
</tr>

<tr>
<td><a href="/tags/att_img_longdesc.asp" title="HTML &lt;img&gt; 标签的 longdesc 属性">longdesc</a></td>
<td><i>URL</i></td>
<td>指向包含长的图像描述文档的 URL。</td>
</tr>

<tr>
<td><a href="/tags/att_img_usemap.asp" title="HTML &lt;img&gt; 标签的 usemap 属性">usemap</a></td>
<td><i>URL</i></td>
<td>将图像定义为客户器端图像映射。</td>
</tr>

<tr>
<td><a href="/tags/att_img_hspace_vspace.asp" title="HTML &lt;img&gt; 标签的 hspace 和 vspace 属性">vspace</a></td>
<td><i>pixels</i></td>
<td><span class="deprecated">不推荐使用。</span>定义图像顶部和底部的空白。</td>
</tr>

<tr>
<td><a href="/tags/att_img_height-width.asp" title="HTML &lt;img&gt; 标签的 height 和 width 属性">width</a></td>
<td>
<ul>
<li><i>pixels</i></li>
<li><i>%</i></li>
...
<p>&lt;img&gt; 标签支持 <a href="/tags/html_ref_standardattributes.asp">HTML 中的全局属性</a>。</p>
</div>
...
<p>&lt;img&gt; 标签支持 <a href="/tags/html_ref_eventattributes.asp">HTML 中的事件属性</a>。</p>
</div>
...
<dd>本例演示如何为图片显示替换文本。在浏览器无法载入图像时，替换文本属性告诉读者她们失去的信息。为页面上的图像都加上替换文本属性是个好习惯。</dd>

<dt><a href="/tiy/t.asp?f=html_image_link">制作图像链接</a></dt>
<dd>本例演示如何将图像作为一个链接使用。</dd>

<dt><a href="/tiy/t.asp?f=html_areamap">创建图像地图</a></dt>
<dd>本例显示如何创建带有可供点击区域的图像地图。其中的每个区域都是一个超级链接。</dd></dl>
</div>


<div id="how-to-use-image">
<h2>延伸阅读 - 如何正确地使用图像</h2>

<p>HTML 和 XHTML 最引人注目的特征之一，就是能够在文档的文本中包括图像，既可以把图像作为文档的内在对象（内联图像），也可以将其作为一个可通过超链接下载的单独文档，或者作为文档的背景。</p>

<p>合理地在文档内容中加入图像（静态的或者具有动画效果的图标、照片、说明、绘画，等等）时，会使文档变得更加生动活泼，更加引人入胜，而且看上去更加专业，更具信息性并易于浏览。还可以专门使一个图像成为超链接的可视引导图。</p>

<p>然而，如果过度使用图像，文档就会变得支离破碎，混乱不堪，而且无法阅读，用户在下载和查看该页面时，更会增加很多不必要的等待时间。</p>

<p>请阅读下面的文章，学习 Web 上的两种主要图像格式：GIF 和 JPEG，以及如何正确地使用图像：</p>
...
<li><a href="/media/media_browserimages.asp" title="多媒体教程 - 在 Web 上使用图像">在 Web 上使用图像</a></li>
</ul>
</div>
...
<li><a href="/html5/tag_img.asp" title="HTML 5 &lt;img&gt; 标签">参考手册：HTML 5 &lt;img&gt; 标签</a></li>
</ul>
</div>
