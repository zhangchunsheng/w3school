...
<li class="currentLink"><a href="/tags/tag_wbr.asp" title="HTML &lt;wbr&gt; 标签">&lt;wbr&gt;</a></li>
</ul>
</div><div id="selected">
<h2>建站手册</h2>
<ul>
...
<p>一段带有 Word Break Opportunity 的文本：</p>

<pre>
&lt;p&gt;
如果想学习 AJAX，那么您必须熟悉 XML<code>&lt;wbr&gt;</code>Http&lt;wbr&gt;Request 对象。
&lt;/p&gt;
</pre>

<p class="tiy"><a target="_blank" href="/tiy/t.asp?f=html5_wbr">亲自试一试</a></p>
</div>
...
<p>所有浏览器都支持 &lt;wbr&gt; 标签，除了 Internet Explorer。</p>
</div>
...
<p>Word Break Opportunity (&lt;wbr&gt;) 规定在文本中的何处适合添加换行符。</p>

<p class="tip"><span>提示：</span>如果单词太长，或者您担心浏览器会在错误的位置换行，那么您可以使用 &lt;wbr&gt; 元素来添加 Word Break Opportunity（单词换行时机）。</p>
</div>
...
<p>所有主流浏览器均支持 &lt;wbr&gt; 标签，除了 Internet Explorer。</p>
</div>
...
<p>&lt;wbr&gt; 标签支持 <a href="/tags/html_ref_standardattributes.asp">HTML 中的全局属性</a>。</p>
</div>
...
<p>&lt;wbr&gt; 标签支持 <a href="/tags/html_ref_eventattributes.asp">HTML 中的事件属性</a>。</p>
</div>
