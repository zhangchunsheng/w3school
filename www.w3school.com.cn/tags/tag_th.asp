...
<li class="currentLink"><a href="/tags/tag_th.asp" title="HTML &lt;th&gt; 标签">&lt;th&gt;</a></li>
...
<p>普通的 HTML 表格，包含两行两列：</p>

<pre>
&lt;table border="1"&gt;
  &lt;tr&gt;
    <code>&lt;th&gt;Company&lt;/th&gt;</code>
    <code>&lt;th&gt;Address&lt;/th&gt;</code>
  &lt;/tr&gt;
...
<p class="tiy"><a target="_blank" href="/tiy/t.asp?f=html_table">亲自试一试</a></p>
</div>
...
<p>th 元素内部的文本通常会呈现为居中的粗体文本，而 td 元素内的文本通常是左对齐的普通文本。</p>
</div>
...
<p class="tip"><span>提示：</span>如果需要将内容横跨多个行或列，请使用 colspan 和 rowspan 属性。</p>
</div>
...
<p>在 HTML 4.01 中，th 元素的 &quot;bgcolor&quot;、&quot;height&quot;、&quot;width&quot; 以及 &quot;nowrap&quot; 属性是不被推荐使用的。</p>

<p>在 XHTML 1.0 Strict DTD 中，th 元素的 &quot;bgcolor&quot;、&quot;height&quot;、&quot;width&quot; 以及 &quot;nowrap&quot; 属性是不被支持。</p>
</div>
...
<tr>
<td><a href="/tags/att_th_abbr.asp" title="HTML &lt;th&gt; 标签的 abbr 属性">abbr</a></td>
<td><i>text</i></td>
<td>规定单元格中内容的缩写版本。</td>
</tr>

<tr>
<td><a href="/tags/att_th_align.asp" title="HTML &lt;th&gt; 标签的 align 属性">align</a></td>
<td>
	<ul>
	<li>left</li>
	<li>right</li>
...
<tr>
<td><a href="/tags/att_th_axis.asp" title="HTML &lt;th&gt; 标签的 axis 属性">axis</a></td>
<td><i>category_name</i></td>
<td>对单元格进行分类。</td>
</tr>

<tr>
<td><a href="/tags/att_th_bgcolor.asp" title="HTML &lt;th&gt; 标签的 bgcolor 属性">bgcolor</a></td>
<td>
	<ul>
	<li><i>rgb(x,x,x)</i></li>
	<li><i>#xxxxxx</i></li>
...
<td>
	<p><span class="deprecated">不推荐使用。</span>请使用样式替代它。</p>
	<p>规定表格单元格的背景颜色。</p>
</td>
</tr>

<tr>
<td><a href="/tags/att_th_char.asp" title="HTML &lt;th&gt; 标签的 char 属性">char</a></td>
<td><i>character</i></td>
<td>规定根据哪个字符来进行内容的对齐。</td>
</tr>

<tr>
<td><a href="/tags/att_th_charoff.asp" title="HTML &lt;th&gt; 标签的 charoff 属性">charoff</a></td>
<td><i>number</i></td>
<td>规定对齐字符的偏移量。</td>
</tr>

<tr>
<td><a href="/tags/att_th_colspan.asp" title="HTML &lt;th&gt; 标签的 colspan 属性">colspan</a></td>
<td><i>number</i></td>
<td>设置单元格可横跨的列数。</td>
</tr>

<tr>
<td><a href="/tags/att_th_headers.asp" title="HTML &lt;th&gt; 标签的 headers 属性">headers</a></td>
<td><i>idrefs</i></td>
<td>由空格分隔的表头单元格 ID 列表，为数据单元格提供表头信息。</td>
</tr>

<tr>
<td><a href="/tags/att_th_height.asp" title="HTML &lt;th&gt; 标签的 height 属性">height</a></td>
<td>
	<ul>
	<li><i>pixels</i></li>
	<li><i>%</i></li>
...
<tr>
<td><a href="/tags/att_th_nowrap.asp" title="HTML &lt;th&gt; 标签的 nowrap 属性">nowrap</a></td>
<td>nowrap</td>
<td>
	<p><span class="deprecated">不推荐使用。</span>请使用样式取而代之。</p>
	<p>规定单元格中的内容是否折行。</p>
</td>
</tr>

<tr>
<td><a href="/tags/att_th_rowspan.asp" title="HTML &lt;th&gt; 标签的 rowspan 属性">rowspan</a></td>
<td><i>number</i></td>
<td>规定单元格可横跨的行数。</td>
</tr>

<tr>
<td><a href="/tags/att_th_scope.asp" title="HTML &lt;th&gt; 标签的 scope 属性">scope</a></td>
<td>
	<ul>
	<li>col</li>
	<li>colgroup</li>
...
<tr>
<td><a href="/tags/att_th_valign.asp" title="HTML &lt;th&gt; 标签的 valign 属性">valign</a></td>
<td>
	<ul>
	<li>top</li>
	<li>middle</li>
...
<tr>
<td><a href="/tags/att_th_width.asp" title="HTML &lt;th&gt; 标签的 width 属性">width</a></td>
<td>
	<ul>
	<li><i>pixels</i></li>
	<li><i>%</i></li>
...
<p>&lt;th&gt; 标签支持 <a href="/tags/html_ref_standardattributes.asp">HTML 中的全局属性</a>。</p>
</div>
...
<p>&lt;th&gt; 标签支持 <a href="/tags/html_ref_eventattributes.asp">HTML 中的事件属性</a>。</p>
</div>
...
<h2>TIY 实例</h2>
<dl>
<dt><a href="/tiy/t.asp?f=html_tables" title="表格">表格</a></dt>
<dd>这个例子演示如何在HTML文档中创建表格。</dd>

<dt><a href="/tiy/t.asp?f=html_table_borders" title="表格边框">表格边框</a></dt>
<dd>本例演示各种类型的表格边框。</dd>

<dt><a href="/tiy/t.asp?f=html_tables2" title="没有边框的表格">没有边框的表格</a></dt>
<dd>本例演示一个没有边框的表格。</dd>

<dt><a href="/tiy/t.asp?f=html_table_headers" title="表格中的标题(Headings)">表格中的标题(Headings)</a></dt>
<dd>本例演示如何显示表格标题。</dd>

<dt><a href="/tiy/t.asp?f=html_table_nbsp" title="空单元格">空单元格</a></dt>
<dd>本例展示如何使用&quot;&amp;nbsp;&quot;处理没有内容的单元格。</dd>

<dt><a href="/tiy/t.asp?f=html_tables3" title="带有标题的表格">带有标题的表格</a></dt>
<dd>本例演示一个带标题(caption)的表格</dd>

<dt><a href="/tiy/t.asp?f=html_table_span" title="跨行或跨列的表格单元格">跨行或跨列的表格单元格</a></dt>
<dd>本例演示如何定义跨行或跨列的表格单元格。</dd>

<dt><a href="/tiy/t.asp?f=html_table_elements" title="表格内的标签">表格内的标签</a></dt>
<dd>本例演示如何显示在不同的元素内显示元素。</dd>

<dt><a href="/tiy/t.asp?f=html_table_cellpadding" title="单元格填充(Cell padding)">单元格填充(Cell padding)</a></dt>
<dd>本例演示如何使用单元格填充来创建单元格内容与其边框之间的空白。</dd>

<dt><a href="/tiy/t.asp?f=html_table_cellspacing" title="单元格间距(Cell spacing)">单元格间距(Cell spacing)</a></dt>
<dd>本例演示如何使用单元格间距增加单元格之间的距离。</dd>

<dt><a href="/tiy/t.asp?f=html_table_background" title="向表格添加背景颜色或背景图像">向表格添加背景颜色或背景图像</a></dt>
<dd>本例演示如何向表格添加背景</dd>

<dt><a href="/tiy/t.asp?f=html_table_cellbackground" title="向表格单元添加背景颜色或者背景图像">向表格单元添加背景颜色或者背景图像</a></dt>
<dd>本例演示如何向一个或者更多表格单元添加背景</dd>

<dt><a href="/tiy/t.asp?f=html_table_align" title="在表格单元中排列内容">在表格单元中排列内容</a></dt>
<dd>本例演示如何使用 &quot;align&quot; 属性排列单元格内容,以便创建一个美观的表格。</dd>

<dt><a href="/tiy/t.asp?f=html_table_frame" title="frame属性">框架(frame)属性</a></dt>
