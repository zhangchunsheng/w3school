...
<title>HTML &lt;button&gt; 标签的 name 属性</title>
</head>
...
<p class="tip"><span>提示：</span>不同的 button 元素可以共享相同的名称。这就允许您标记带有相同名称的若干按钮，以便在表单中使用时能够提交不同的值。</p>
</div>
