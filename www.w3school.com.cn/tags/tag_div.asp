...
<li class="currentLink"><a href="/tags/tag_div.asp" title="HTML &lt;div&gt; 标签">&lt;div&gt;</a></li>
...
<pre>
<code>&lt;div <span style="color:red;">style=&quot;color:#00FF00&quot;</span>&gt;</code>
  &lt;h3&gt;This is a header&lt;/h3&gt;
  &lt;p&gt;This is a paragraph.&lt;/p&gt;
<code>&lt;/div&gt;</code>
</pre>

<p class="tiy"><a target="_blank" href="/tiy/t.asp?f=html_div_test">亲自试一试</a></p>
</div>
...
<p>如果用 id 或 class 来标记 &lt;div&gt;，那么该标签的作用会变得更加有效。</p>


<h3>用法</h3>

<p>&lt;div&gt; 是一个块级元素。这意味着它的内容自动地开始一个新行。实际上，换行是 &lt;div&gt; 固有的唯一格式表现。可以通过 &lt;div&gt; 的 class 或 id 应用额外的样式。</p>

<p>不必为每一个 &lt;div&gt; 都加上类或 id，虽然这样做也有一定的好处。</p>

<p>可以对同一个 &lt;div&gt; 元素应用 class 或 id 属性，但是更常见的情况是只应用其中一种。这两者的主要差异是，class 用于元素组（类似的元素，或者可以理解为某一类元素），而 id 用于标识单独的唯一的元素。</p>
</div>
...
<p>在 HTML 4.01 中，div 元素的 &quot;align&quot; 属性不被赞成使用。</p>

<p>在 XHTML 1.0 Strict DTD 中，div 元素的 &quot;align&quot; 属性不被支持。</p>
</div>
...
<p class="note"><span>注释：</span>&lt;div&gt; 是一个块级元素，也就是说，浏览器通常会在 div 元素前后放置一个换行符。</p>

<p class="tip"><span>提示：</span>请使用 &lt;div&gt; 元素来组合块级元素，这样就可以使用样式对它们进行格式化。</p>
</div>
...
<pre>&lt;body&gt;
 ...
 <code>&lt;div <span style="color:red;">class=&quot;news&quot;</span>&gt;</code>
...
<p>正如您看到的，上面这段 HTML 模拟了新闻网站的结构。其中的每个 div 把每条新闻的标题和摘要组合在一起，也就是说，div 为文档添加了额外的结构。同时，由于这些 div 属于同一类元素，所以可以使用 class=&quot;news&quot; 对这些 div 进行标识，这么做不仅为 div 添加了合适的语义，而且便于进一步使用样式对 div 进行格式化，可谓一举两得。</p>

<p class="tip"><span>提示：</span>如需更深入地学习 class 和 id 的用法，请阅《W3school 的结构化标记》这一章中 <a href="/xhtml/xhtml_structural_02.asp#div-class-id" title="div、id 和其他帮手">div、id 和其他帮手</a> 这一节。</p>
</div>
...
<tr>
<td><a href="/tags/att_div_align.asp" title="HTML &lt;div&gt; 标签的 align 属性">align</a></td>
<td>
<ul>
<li>left</li>
<li>right</li>
...
<p>&lt;div&gt; 标签支持 <a href="/tags/html_ref_standardattributes.asp">HTML 中的全局属性</a>。</p>
</div>
...
<p>&lt;div&gt; 标签支持 <a href="/tags/html_ref_eventattributes.asp">HTML 中的事件属性</a>。</p>
</div>
