...
<title>HTML &lt;caption&gt; 标签的 align 属性</title>
</head>
...
<h1>HTML &lt;caption&gt; 标签的 align 属性</h1>


<div class="backtoreference">
<p><a href="/tags/tag_caption.asp">HTML &lt;caption&gt; 标签</a></p>
</div>


<div>
<h2>定义和用法</h2>
<p>align 属性规定 caption 元素的对齐方式。</p>
<p>该属性将 caption 作为块元素向表格的左边、右边、顶部、底部进行对齐。</p>
</div>


<div>
<h2>实例</h2>
<p>带有与底部对齐的 caption 元素的表格：</p>

<pre>
&lt;table border=&quot;1&quot;&gt;
  &lt;caption <code>align=&quot;bottom&quot;</code>&gt;Monthly savings&lt;/caption&gt;
  &lt;tr&gt;
    &lt;th&gt;Month&lt;/th&gt;
    &lt;th&gt;Savings&lt;/th&gt;
  &lt;/tr&gt;
...
<p><a href="/tiy/t.asp?f=html_caption_align">TIY</a></p>
</div>


<div>
<h2>浏览器支持</h2>
<p>除了 Firefox，其他主流浏览器都无法正确地支持 align 属性。</p>
<p class="note"><span>注释：</span>所有主流浏览器都支持 &quot;top&quot; 和 &quot;bottom&quot; 值。Chrome 和 Safari 不支持 &quot;left&quot; 和 &quot;right&quot;。Internet Explorer 和 Opera 只能对 caption 内部的文本（而不是整个 caption 元素）进行对齐。</p>
</div>


<div>
<h2>兼容性注释</h2>
<p>在 HTML 4.01 中，不赞成使用 caption 元素的 align 属性；在 XHTML 1.0 Strict DTD 中，不支持 caption 元素的 align 属性。</p>
<p>请使用 CSS 代替。</p>
<p>CSS 语法：&lt;caption style=&quot;caption-side:left&quot;&gt;</p>
<p class="note"><span>注释：</span>主流浏览器对 CSS 的 caption-side 属性的支持不是很好。</p>
<p><a href="/tiy/t.asp?f=html_caption_align_css">CSS 实例：定位表格标题</a></p>
<p>在我们的 CSS 教程中，您可以找到更多有关 <a href="/cssref/pr_tab_caption-side.asp" title="CSS caption-side 属性">caption-side 属性</a>的细节。</p>
</div>
...
<pre>&lt;caption align=&quot;<i>value</i>&quot;&gt;</pre>
