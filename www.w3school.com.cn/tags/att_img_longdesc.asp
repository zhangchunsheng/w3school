...
<title>HTML &lt;img&gt; 标签的 longdesc 属性</title>
</head>
...
<h1>HTML &lt;img&gt; 标签的 longdesc 属性</h1>
...
<p>longdesc 属性规定指向图像描述信息页面的 URL。</p>

<h3>详细信息</h3>

<p>&lt;img&gt; 标签的 longdesc 属性与 <a href="/tags/att_img_alt.asp" title="HTML &lt;img&gt; 标签的 alt 属性">alt 属性</a>类似，但它允许更长的描述性文字。longdesc 的值是一个指向包含图像说明的文档的 URL。如果说明多于 1024 个字符，那么可以使用 longdesc 属性来设置指向它的链接。</p>

<p>不论是 HTML 还是 XHTML 都没有指定说明中必须是什么内容，而且目前浏览器都还没有支持 longdesc 属性。因此，对于如何创建那些大块的描述，我们的建议是<em>创建一个超链接指向包含描述的页面</em>即可。</p>

<p>alt 属性对于残疾人很有帮助，而出于显而易见的原因考虑，longdesc 属性似乎是更好的选项。</p>
</div>
...
<p>使用 longdesc 属性，指向一个包含图像描述信息的页面：</p>

<pre>&lt;img src=&quot;eg_logo_w3school.gif&quot; alt=&quot;W3School.com.cn&quot; <code>longdesc=&quot;w3s.txt&quot;</code> /&gt;</pre>

<p><a href="/tiy/t.asp?f=html_img_longdesc">亲自试一试</a></p>
</div>
  ...
  <tr>
	...
	<p>可能的值：</p>
		<ul class="listintable">
			<li>绝对 URL - 指向其他站点（比如 longdesc=&quot;example.com/description.txt&quot;）</li>
			<li>相对 URL - 指向站点内的文件（比如 longdesc=&quot;description.txt&quot;）</li>
		</ul>
    </td>
  </tr>
</table>
...
<h2>TIY 实例</h2>
<dl>
<dt><a href="/tiy/t.asp?f=html_img_longdesc">&lt;img&gt; 标签的 longdesc 属性</a></dt>
<dd>本例演示如何使用 longdesc 属性为图像指定一个描述文档。</dd>
</div>


<div>
<h2>参阅</h2>
<p><a href="/tags/att_img_alt.asp" title="HTML &lt;img&gt; 标签的 alt 属性">HTML &lt;img&gt; 标签的 alt 属性</a></p>
</div>
