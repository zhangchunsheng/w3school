...
<title>HTML &lt;select&gt; 标签的 size 属性</title>
</head>
...
<p>size 属性规定下拉列表中可见选项的数目。</p>
<p>如果 size 属性的值大于 1，但是小于列表中选项的总数目，浏览器会显示出滚动条，表示可以查看更多选项。</p>
</div>
...
<p>在下拉列表中 size 属性显示两个选项：</p>

<pre>
&lt;select <code>size=&quot;2&quot;</code>&gt;
...
<p><a href="/tiy/t.asp?f=html_select_size">TIY</a></p>
</div>


<div>
<h2>浏览器支持</h2>
<p>所有浏览器都支持 size 属性。</p>
</div>
