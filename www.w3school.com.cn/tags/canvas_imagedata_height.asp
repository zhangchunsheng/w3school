...
<title>HTML5 canvas height 属性</title>
...
<pre>
alert(&quot;Width of imgData is: &quot; + <code>imgData.height</code>);
</pre>

<p><a href="/tiy/t.asp?f=html5_canvas_imagedata_height">亲自试一试</a></p>
</div>
...
<p>Internet Explorer 9、Firefox、Opera、Chrome 以及 Safari 支持 height 属性。</p>
...
<p class="tip"><span>提示：</span>请参阅 <a href="/tags/canvas_createimagedata.asp" title="HTML5 canvas createImageData() 方法">createImageData()</a>、<a href="/tags/canvas_getimagedata.asp" title="HTML5 canvas getImageData() 方法">getImageData()</a> 以及 <a href="/tags/canvas_putimagedata.asp" title="HTML5 canvas putImageData() 方法">putImageData()</a> 方法，以获得更多关于 ImageData 对象的知识。</p>
