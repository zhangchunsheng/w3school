...
<title>HTML &lt;select&gt; 标签的 disabled 属性</title>
</head>
...
<h1>HTML &lt;select&gt; 标签的 disabled 属性</h1>


<div class="backtoreference">
<p><a href="/tags/tag_select.asp">HTML &lt;select&gt; 标签</a></p>
</div>


<div>
<h2>定义和用法</h2>
<p>disabled 属性规定禁用下拉列表。被禁用的下拉列表既不可用，也不可点击。</p>
<p>可以设置 disabled 属性，直到满足某些条件（比如选择一个复选框），才恢复用户对该下拉列表的使用。然后，可以使用 JavaScript 来清除 disabled 属性，以使下拉列表变为可用状态。</p>
</div>
...
<pre>
&lt;select <code>disabled=&quot;disabled&quot;</code>&gt;
...
<p><a href="/tiy/t.asp?f=html_select_disabled">TIY</a></p>
</div>


<div>
<h2>浏览器支持</h2>
<p>所有浏览器都支持 disabled 属性。</p>
</div>
...
<pre>&lt;select disabled=&quot;<i>value</i>&quot;&gt;</pre>
