...
<title>HTML &lt;basefont&gt; 标签的 color 属性</title>
</head>
...
<h1>HTML &lt;basefont&gt; 标签的 color 属性</h1>


<div class="backtoreference">
<p><a href="/tags/tag_basefont.asp">HTML &lt;basefont&gt; 标签</a></p>
</div>


<div>
<h2>定义和用法</h2>
<p>color 属性规定文档中文本的默认颜色。</p>
</div>
...
<p><a href="/tiy/t.asp?f=html_basefont_color">TIY</a></p>
</div>


<div>
<h2>浏览器支持</h2>
<p>除了 Internet Explorer，其他浏览器都不支持 color 属性。</p>
</div>


<div>
<h2>兼容性注释</h2>
<p>在 HTML 4.01 中，不赞成使用 basefont 元素的 color 属性；在 XHTML 1.0 Strict DTD 中，不支持 basefont 元素的 color 属性。</p>
<p>请使用 CSS 代替。</p>
<p>CSS 语法（在 &lt;head&gt; 部分）：&lt;style&gt;body{color:red}&lt;/style&gt;</p>
<p><a href="/tiy/t.asp?f=html_basefont_color_css">CSS 实例：为页面规定默认文本颜色</a></p>
<p>在我们的 CSS 教程中，您可以找到更多有关<a href="/cssref/pr_text_color.asp" title="CSS color 属性">文本 color 属性</a>的细节。</p>
</div>
...
<pre>&lt;basefont color=&quot;<i>value</i>&quot;&gt;</pre>
