...
<title>HTML 5 Audio/Video DOM canPlayType() 方法</title>
...
<h1>HTML 5 Audio/Video DOM canPlayType() 方法</h1>
...
<p>检测您的浏览器是否能播放不同类型的视频：</p>

<pre>
myVid=document.createElement('video');
isSupp=<code>myVid.canPlayType(vidType+';codecs=&quot;'+codType+'&quot;')</code>;
</pre>

<p><a href="/tiy/t.asp?f=html5_av_met_canplaytype">亲自试一试</a></p>
</div>
...
<p>canPlayType() 方法浏览器是否能播放指定的音频/视频类型。</p>

<p>canPlayType() 方法可返回下列值之一：</p>
...
<div>
<h2>语法</h2>
<pre>audio|video.canPlayType(<i>type</i>))</pre>
...
<p class="note"><span>注释：</span>如果包含编解码器，则只能返回 &quot;probably&quot;。</p>
</td>
</tr>
</table>
