...
<li class="currentLink"><a href="/tags/tag_rp.asp" title="HTML &lt;rp&gt; 标签">&lt;rp&gt;</a></li>
...
<p class="tiy"><a target="_blank" href="/tiy/t.asp?f=html5_rp">亲自试一试</a></p>
</div>
...
<p>Internet Explorer 9+, Firefox, Opera, Chrome 以及 Safari 支持 &lt;rp&gt; 标签。</p>

<p class="note"><span>注释：</span>Internet Explorer 8 以及更早的版本不支持 &lt;rp&gt; 标签。</p>
</div>
...
<p>&lt;rp&gt; 标签在 ruby 注释中使用，以定义不支持 ruby 元素的浏览器所显示的内容。</p>
...
<p>&lt;rp&gt; 标签支持 <a href="/tags/html_ref_standardattributes.asp">HTML 中的全局属性</a>。</p>
</div>
...
<p>&lt;rp&gt; 标签支持 <a href="/tags/html_ref_eventattributes.asp">HTML 中的事件属性</a>。</p>
</div>
