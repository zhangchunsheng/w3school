...
<title>HTML &lt;br&gt; 标签的 clear 属性</title>
...
<h1>HTML &lt;br&gt; 标签的 clear 属性</h1>

<div>
<p>通常情况下，&lt;br&gt; 标签会告诉浏览器立即停止当前的文本流，并在下一行的左边，或者在左对齐的内联图形或表格的右边开始继续输出文本流。</p>
<p>但是有时候，您也许希望当前的文本流在当前左边或右边的内联表格或图像的下面一行继续输出。</p>

<p>HTML 4 和 XHTML 通过 &lt;br&gt; 标签提供了这样的功能。它可以具有三个值：left、right 或者 all，每个值都代表一个边界或两边的边界。当指定的边界没有图像时，浏览器才会继续输出文本。</p>
</div>

<div>
<h2>提示和注释</h2>
<p class="tip"><span>提示：</span>一般情况下，文本流中的其他行会在内联图像的底部显示，除非图形的 &lt;img&gt; 标签被设置为左对齐或右对齐（对于 &lt;table&gt; 标签也一样）。因此，&lt;br&gt; 标签的 clear 属性只对这些左对齐或右对齐的图像或表格起作用。</p>
</div>

<div class="example">
<h2>TIY</h2>
<dl>
<dt><a href="/tiy/t.asp?f=html_br_prop_clear_1">不带有 align 属性的 &lt;img&gt; 标签与带有 clear 属性的 &lt;br&gt; 标签</a></dt>
<dt><a href="/tiy/t.asp?f=html_br_prop_clear_2">带有 align 属性的 &lt;img&gt; 标签与不带有 clear 属性的 &lt;br&gt; 标签</a></dt>
<dt><a href="/tiy/t.asp?f=html_br_prop_clear_3">带有 align 属性的 &lt;img&gt; 标签与带有 clear 属性的 &lt;br&gt; 标签</a></dt>
<dt><a href="/tiy/t.asp?f=html_br_prop_clear_4">align 属性为 absmiddle 的 &lt;img&gt; 标签与clear 属性为 left 的 &lt;br&gt; 标签</a></dt>
</dl>
</div>
