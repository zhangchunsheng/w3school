...
<title>HTML &lt;hr&gt; 标签的 align 属性</title>
</head>
...
<div>
<h2>定义和用法</h2>
<p>align 属性规定水平线的水平对齐方式。</p>
<p class="note"><span>注释：</span>除非 width 属性设置为小于 100%，否则 align 属性不会有任何效果。</p>
</div>
...
<h2>实例</h2>
<p>居中对齐的水平线：</p>
<pre>&lt;hr <code>align=&quot;center&quot;</code> width=&quot;50%&quot; /&gt;</pre>
<p><a href="/tiy/t.asp?f=html_hr_align">TIY</a></p>
</div>


<div>
<h2>浏览器支持</h2>
<p>虽然不赞成使用 align 属性，但是该属性仍然得到所有主流浏览器的支持。</p>
</div>


<div>
<h2>兼容性注释</h2>
<p>在 HTML 4.01 中，不赞成使用 hr 元素的 align 属性；在 XHTML 1.0 Strict DTD 中，不支持 hr 元素的 align 属性。</p>
<p>请使用 CSS 代替。</p>
<p>CSS 语法（IE 和 Opera）：&lt;hr style=&quot;text-align:right&quot; /&gt;</p>
<p>CSS 语法（Firefox、Chrome 以及 Safari）：&lt;hr style=&quot;margin-right:0&quot; /&gt;</p>
<p>CSS 语法（跨浏览器）：&lt;hr style=&quot;text-align:right;margin-right:0&quot; /&gt;</p>
<p><a href="/tiy/t.asp?f=html_hr_align_css">CSS 实例：对齐 hr 元素</a></p>
<p>在我们的 CSS 教程中，您可以找到更多有关 <a href="/cssref/pr_text_text-align.asp" title="CSS text-align 属性">text-align 属性</a> 的细节。</p>
</div>
