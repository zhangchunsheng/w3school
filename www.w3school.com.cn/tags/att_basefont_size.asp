...
<title>HTML &lt;basefont&gt; 标签的 size 属性</title>
</head>
...
<h1>HTML &lt;basefont&gt; 标签的 size 属性</h1>
...
<p><a href="/tiy/t.asp?f=html_basefont_size">TIY</a></p>
</div>


<div>
<h2>浏览器支持</h2>
<p>除了 Internet Explorer，其他浏览器都不支持 size 属性。</p>
</div>


<div>
<h2>兼容性注释</h2>
<p>在 HTML 4.01 中，不赞成使用 basefont 元素的 size 属性；在 XHTML 1.0 Strict DTD 中，不支持 basefont 元素的 size 属性。</p>
<p>请使用 CSS 代替。</p>
<p>CSS 语法（在 &lt;head&gt; 部分）：&lt;style&gt;body{font-size: 10px}&lt;/style&gt;</p>
<p><a href="/tiy/t.asp?f=html_basefont_size_css">CSS 实例：为页面规定默认文本尺寸</a></p>
<p>在我们的 CSS 教程中，您可以找到更多有关 <a href="/cssref/pr_font_font-size.asp" title="CSS font-size 属性">font-size 属性</a>的细节。</p>
</div>
...
<pre>&lt;basefont size=&quot;<i>value</i>&quot;&gt;</pre>
...
<table class="dataintable">
  ...
  <tr>
    ...
    <td>
		<p>规定文本尺寸。</p>
		<p>可能的值：从 1 到 7 的数字。浏览器默认值是 3。</p>
	</td>
  </tr>
</table>
</div>
