...
<li class="currentLink"><a href="/tags/tag_b.asp" title="HTML &lt;b&gt; 标签">&lt;b&gt;</a></li>
...
<pre>&lt;p&gt;这是普通文本 - &lt;b&gt;这是粗体文本&lt;/b&gt;。&lt;/p&gt;</pre>

<p class="tiy"><a target="_blank" href="/tiy/t.asp?f=html_b">亲自试一试</a></p>
</div>
...
<p class="note"><span>注释：</span>根据 HTML5 规范，在没有其他合适标签更合适时，才应该把 &lt;b&gt; 标签作为最后的选项。HTML5 规范声明：应该使用 <a href="/tags/tag_hn.asp" title="HTML &lt;h1&gt; - &lt;h6&gt; 标签">&lt;h1&gt; - &lt;h6&gt;</a> 来表示标题，使用 <a href="/tags/tag_phrase_elements.asp" title="HTML &lt;em&gt; 标签">&lt;em&gt;</a> 标签来表示强调的文本，应该使用 <a href="/tags/tag_phrase_elements.asp" title="HTML &lt;strong&gt; 标签">&lt;strong&gt;</a> 标签来表示重要文本，应该使用 &lt;mark&gt; 标签来表示标注的/突出显示的文本。</p>

<p class="tip"><span>提示：</span>您也能够使用 CSS &quot;<a href="/cssref/pr_font_weight.asp" title="CSS font-weight 属性">font-weight</a>&quot; 属性来设置粗体文本。</p>
</div>
...
<p>&lt;b&gt; 标签支持 <a href="/tags/html_ref_standardattributes.asp">HTML 中的全局属性</a>。</p>
</div>
...
<p>&lt;b&gt; 标签支持 <a href="/tags/html_ref_eventattributes.asp">HTML 中的事件属性</a>。</p>
</div>
