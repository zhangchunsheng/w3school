...
<title>HTML &lt;input&gt; 标签的 accept 属性</title>
</head>
...
<h1>HTML &lt;input&gt; 标签的 accept 属性</h1>
...
<p>accept 属性只能与 &lt;input type=&quot;file&quot;&gt; 配合使用。它规定能够通过文件上传进行提交的文件类型。</p>
...
<p>在文件上传中使用 accept 属性，本例中的输入字段可以接受 GIF 和 JPEG 两种图像：</p>

<pre>
&lt;form&gt;
  &lt;input type=&quot;file&quot; name=&quot;pic&quot; id=&quot;pic&quot; <code>accept=&quot;image/gif, image/jpeg&quot;</code> /&gt;
&lt;/form&gt;
</pre>

<p>如果不限制图像的格式，可以写为：accept=&quot;image/*&quot;。</p>
</div>
