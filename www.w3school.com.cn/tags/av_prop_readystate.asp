...
<title>HTML 5 Audio/Video DOM readyState 属性</title>
...
<h1>HTML 5 Audio/Video DOM readyState 属性</h1>
...
alert(<code>myVid.readyState</code>);
</pre>

<p><a href="/tiy/t.asp?f=html5_av_prop_readystate">亲自试一试</a></p>
</div>
...
<p>readyState 属性返回音频/视频的当前就绪状态。</p>

<p>就绪状态指示音频/视频是否已准备好播放。</p>
</div>
...
<pre>audio|video.readyState</pre>
