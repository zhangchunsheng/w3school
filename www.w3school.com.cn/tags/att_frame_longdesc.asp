...
<title>HTML &lt;frame&gt; 标签的 longdesc 属性</title>
</head>
...
<h1>HTML &lt;frame&gt; 标签的 longdesc 属性</h1>


<div class="backtoreference">
<p><a href="/tags/tag_frame.asp">HTML &lt;frame&gt; 标签</a></p>
</div>
...
<p>longdesc 属性规定指向一个页面的 URL，该页面包含有关框架内容的长描述。</p>
<p>由于浏览器对 longdesc 属性的支持性非常差，没有必要使用该属性。</p>
<p class="tip"><span>提示：</span>如需为某个 frame 提供长描述（如果有必要的话），只要简单地创建一个指向描述页面的链接即可（该链接对任何人都是可见的）。</p>
</div>
...
<p>longdesc 属性指向了带有框架内容长描述的页面：</p>

<pre>
&lt;html&gt;

&lt;frameset cols=&quot;50%,50%&quot;&gt;
&lt;frame src=&quot;frame_a.htm&quot; <code>longdesc=&quot;w3school.txt&quot;</code> /&gt;
...
<p><a href="/tiy/t.asp?f=html_frame_longdesc">TIY</a></p>
</div>
...
<pre>&lt;frame longdesc=&quot;<i>value</i>&quot;&gt;</pre>
