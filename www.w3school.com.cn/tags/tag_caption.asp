...
<li class="currentLink"><a href="/tags/tag_caption.asp" title="HTML &lt;caption&gt; 标签">&lt;caption&gt;</a></li>
...
<pre>
&lt;table border=&quot;1&quot;&gt;
  <code>&lt;caption&gt;Monthly savings&lt;/caption&gt;</code>
  &lt;tr&gt;
    &lt;th&gt;Month&lt;/th&gt;
    &lt;th&gt;Savings&lt;/th&gt;
  &lt;/tr&gt;
...
<p class="tiy"><a target="_blank" href="/tiy/t.asp?f=html_tables3">亲自试一试</a></p>
</div>
...
<p>在 HTML 4.01 中，caption 元素的 align 属性是不被赞成使用的。</p>

<p>在 XHTML 1.0 Strict DTD 中，caption 元素的 align 属性是不被支持的。</p>
</div>
...
<tr>
<td><a href="/tags/att_caption_align.asp" title="HTML &lt;caption&gt; 标签的 align 属性">align</a></td>
<td>
	<ul>
	<li>left</li>
	<li>right</li>
...
<td>
	<p><span class="deprecated">不赞成使用。请使用样式取而代之。</span></p>
	<p>规定标题的对齐方式。</p>
</td>
</tr>
</table>
...
<p>&lt;caption&gt; 标签支持 <a href="/tags/html_ref_standardattributes.asp">HTML 中的全局属性</a>。</p>
</div>
...
<p>&lt;caption&gt; 标签支持 <a href="/tags/html_ref_eventattributes.asp">HTML 中的事件属性</a>。</p>
</div>
...
<dd>本例演示一个带标题(caption)的表格</dd></dl>
</div>
