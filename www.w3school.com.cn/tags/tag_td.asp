...
<li class="currentLink"><a href="/tags/tag_td.asp" title="HTML &lt;td&gt; 标签">&lt;td&gt;</a></li>
...
&lt;table border=&quot;1&quot;&gt;
  ...
  &lt;/tr&gt;
  &lt;tr&gt;
    <code>&lt;td&gt;January&lt;/td&gt;</code>
    <code>&lt;td&gt;$100&lt;/td&gt;</code>
  &lt;/tr&gt;
&lt;/table&gt;
</pre>

<p class="tiy"><a target="_blank" href="/tiy/t.asp?f=html_table_test">亲自试一试</a></p>
</div>
...
<ul>
<li>表头单元 - 包含头部信息（由 th 元素创建）</li>
<li>标准单元 - 包含数据（由 td 元素创建）</li>
</ul>

<p>td 元素中的文本一般显示为正常字体且左对齐。</p>
</div>
...
<p>在 HTML 4.01 中，td 元素的 &quot;bgcolor&quot;、&quot;height&quot;、&quot;width&quot; 以及 &quot;nowrap&quot; 是不被赞成使用的。</p>

<p>在 XHTML 1.0 Strict DTD 中，td 元素的 &quot;bgcolor&quot;、&quot;height&quot;、&quot;width&quot; 以及 &quot;nowrap&quot; 是不被支持的。</p>
</div>
...
<p class="tip"><span>提示：</span>请使用 colspan 和 rowspan 属性来实现内容横跨多个行或列。</p>
</div>
...
<tr>
<td><a href="/tags/att_td_abbr.asp" title="HTML &lt;td&gt; 标签的 abbr 属性">abbr</a></td>
<td><i>text</i></td>
<td>规定单元格中内容的缩写版本。</td>
</tr>

<tr>
<td><a href="/tags/att_td_align.asp" title="HTML &lt;td&gt; 标签的 align 属性">align</a></td>
<td>
	<ul>
	<li>left</li>
	<li>right</li>
...
<tr>
<td><a href="/tags/att_td_axis.asp" title="HTML &lt;td&gt; 标签的 axis 属性">axis</a></td>
<td><i>category_name</i></td>
<td>对单元进行分类。</td>
</tr>

<tr>
<td><a href="/tags/att_td_bgcolor.asp" title="HTML &lt;td&gt; 标签的 bgcolor 属性">bgcolor</a></td>
<td>
	<ul>
	<li><i>rgb(x,x,x)</i></li>
	<li><i>#xxxxxx</i></li>
...
<td>
	<p><span class="deprecated">不赞成使用。</span>请使用样式取而代之。</p>
	<p>规定单元格的背景颜色。</p>
</td>
</tr>

<tr>
<td><a href="/tags/att_td_char.asp" title="HTML &lt;td&gt; 标签的 char 属性">char</a></td>
<td><i>character</i></td>
<td>规定根据哪个字符来进行内容的对齐。</td>
</tr>

<tr>
<td><a href="/tags/att_td_charoff.asp" title="HTML &lt;td&gt; 标签的 charoff 属性">charoff</a></td>
<td><i>number</i></td>
<td>规定对齐字符的偏移量。</td>
</tr>

<tr>
<td><a href="/tags/att_td_colspan.asp" title="HTML &lt;td&gt; 标签的 colspan 属性">colspan</a></td>
<td><i>number</i></td>
<td>规定单元格可横跨的列数。</td>
</tr>

<tr>
<td><a href="/tags/att_td_headers.asp" title="HTML &lt;td&gt; 标签的 headers 属性">headers</a></td>
<td><i>header_cells'_id</i></td>
<td>规定与单元格相关的表头。</td>
</tr>

<tr>
<td><a href="/tags/att_td_height.asp" title="HTML &lt;td&gt; 标签的 height 属性">height</a></td>
<td>
	<ul>
	<li><i>pixels</i></li>
	<li><i>%</i></li>
...
<tr>
<td><a href="/tags/att_td_nowrap.asp" title="HTML &lt;td&gt; 标签的 nowrap 属性">nowrap</a></td>
<td>nowrap</td>
<td>
	<p><span class="deprecated">不赞成使用。</span>请使用样式取而代之。</p>
	<p>规定单元格中的内容是否折行。</p>
...
<tr>
<td><a href="/tags/att_td_rowspan.asp" title="HTML &lt;td&gt; 标签的 rowspan 属性">rowspan</a></td>
<td><i>number</i></td>
<td>规定单元格可横跨的行数。</td>
</tr>

<tr>
<td><a href="/tags/att_td_scope.asp" title="HTML &lt;td&gt; 标签的 scope 属性">scope</a></td>
<td>
	<ul>
	<li>col</li>
	<li>colgroup</li>
...
<tr>
<td><a href="/tags/att_td_valign.asp" title="HTML &lt;td&gt; 标签的 valign 属性">valign</a></td>
<td>
	<ul>
	<li>top</li>
	<li>middle</li>
...
<tr>
<td><a href="/tags/att_td_width.asp" title="HTML &lt;td&gt; 标签的 width 属性">width</a></td>
<td>
	<ul>
	<li><i>pixels</i></li>
	<li><i>%</i></li>
...
<p>&lt;td&gt; 标签支持 <a href="/tags/html_ref_standardattributes.asp">HTML 中的全局属性</a>。</p>
</div>
...
<p>&lt;td&gt; 标签支持 <a href="/tags/html_ref_eventattributes.asp">HTML 中的事件属性</a>。</p>
</div>
...
<dt><a href="/tiy/t.asp?f=html_table_headers">表格中的标题(Headings)</a></dt>
<dd>本例演示如何显示表格标题。</dd>
...
<dt><a href="/tiy/t.asp?f=html_table_cellpadding">单元格填充(Cell padding)</a></dt>
