...
<title>HTML5 canvas measureText() 方法</title>
...
<h1>HTML5 canvas measureText() 方法</h1>
...
ctx.font=&quot;30px Arial&quot;;
var txt=&quot;Hello World&quot;
ctx.fillText(&quot;width:&quot; + <code>ctx.measureText(txt).width</code>,10,50)
ctx.fillText(txt,10,100);
</pre>

<p><a target="_blank" href="/tiy/t.asp?f=html5_canvas_measuretext">亲自试一试</a></p>
</div>
...
<p>Internet Explorer 9、Firefox、Opera、Chrome 以及 Safari 支持 measureText() 方法。</p>
...
<p>measureText() 方法返回包含一个对象，该对象包含以像素计的指定字体宽度。</p>

<p class="tip"><span>提示：</span>如果您需要在文本向画布输出之前，就了解文本的宽度，那么请使用该方法。</p>

<h3>JavaScript 语法：</h3>

<pre><i>context</i>.measureText(<i>text</i>).width;</pre>
