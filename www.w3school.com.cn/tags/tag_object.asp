...
<li class="currentLink"><a href="/tags/tag_object.asp" title="HTML &lt;object&gt; 标签">&lt;object&gt;</a></li>
...
<pre>
<code>&lt;object classid=&quot;clsid:F08DF954-8592-11D1-B16A-00C0F0283628&quot; id=&quot;Slider1&quot; 
width=&quot;100&quot; height=&quot;50&quot;&gt;</code>
...
<p class="tiy"><a target="_blank" href="/tiy/t.asp?f=html_object">亲自试一试</a></p>
</div>
...
<p>几乎所有主流浏览器都拥有部分对 &lt;object&gt; 标签的支持。</p>
</div>
...
<p>定义一个嵌入的对象。请使用此元素向您的 XHTML 页面添加多媒体。此元素允许您规定插入 HTML 文档中的对象的数据和参数，以及可用来显示和操作数据的代码。</p>
...
<p class="note"><span>注释：</span><a href="/tags/tag_param.asp" title="HTML &lt;param&gt; 标签">&lt;param&gt; 标签</a>定义用于对象的 run-time 设置。</p>

<p class="note"><span>注释：</span>不要对图像使用 &lt;object&gt; 标签，请使用 <a href="/tags/tag_img.asp" title="HTML &lt;img&gt; 标签">&lt;img&gt; 标签</a>代替。</p>
</div>
...
<td>定义围绕该对象的文本对齐方式。</td>
</tr>

<tr>
<td><a href="/tags/tag_object_prop.asp#archive">archive</a></td>
<td><i>URL</i></td>
<td>由空格分隔的指向档案文件的 URL 列表。这些档案文件包含了与对象相关的资源。</td>
</tr>
...
<tr>
<td><a href="/tags/tag_object_prop.asp#classid">classid</a></td>
<td><i>class ID</i></td>
<td>定义嵌入 Windows Registry 中或某个 URL 中的类的 ID 值，此属性可用来指定浏览器中包含的对象的位置，通常是一个 Java 类。</td>
</tr>

<tr>
<td><a href="/tags/tag_object_prop.asp#codebase">codebase</a></td>
<td><i>URL</i></td>
<td>定义在何处可找到对象所需的代码，提供一个基准 URL。</td>
</tr>

<tr>
<td><a href="/tags/tag_object_prop.asp#codetype">codetype</a></td>
<td><i>MIME type</i></td>
<td>通过 classid 属性所引用的代码的 MIME 类型。</td>
</tr>

<tr>
<td><a href="/tags/tag_object_prop.asp#data">data</a></td>
<td><i>URL</i></td>
<td>定义引用对象数据的 URL。如果有需要对象处理的数据文件,要用 data 属性来指定这些数据文件。</td>
</tr>

<tr>
<td><a href="/tags/tag_object_prop.asp#declare">declare</a></td>
<td>declare</td>
<td>可定义此对象仅可被声明，但不能被创建或例示，直到此对象得到应用为止。</td>
</tr>
...
<td>为对象定义唯一的名称（以便在脚本中使用）。</td>
</tr>

<tr>
<td>standby</td>
<td><i>text</i></td>
<td>定义当对象正在加载时所显示的文本。</td>
</tr>

<tr>
<td>type</td>
<td><i>MIME_type</i></td>
<td>定义被规定在 data 属性中指定的文件中出现的数据的 MIME 类型。</td>
</tr>

<tr>
<td>usemap</td>
<td><i>URL</i></td>
<td>规定与对象一同使用的客户端图像映射的 URL。</td>
</tr>
...
<p>&lt;object&gt; 标签支持 <a href="/tags/html_ref_standardattributes.asp">HTML 中的全局属性</a>。</p>
</div>
...
<p>&lt;object&gt; 标签支持 <a href="/tags/html_ref_eventattributes.asp">HTML 中的事件属性</a>。</p>
</div>
