...
<p><a href="/tags/html_ref_standardattributes.asp">HTML 标准属性</a></p>
</div>
...
&lt;body&gt;
&lt;h1 <code>class=&quot;intro&quot;</code>&gt;Header 1&lt;/h1&gt;
&lt;p&gt;A paragraph.&lt;/p&gt;
&lt;p <code>class=&quot;important&quot;</code>&gt;Note that this is an important paragraph.&lt;/p&gt;
&lt;/body&gt;
&lt;/html&gt;
</pre>

<p><a href="/tiy/t.asp?f=html_standard_class">亲自试一试</a></p>
...
<p class="note"><span>注释：</span>class 属性不能在以下 HTML 元素中使用：base, head, html, meta, param, script, style 以及 title。</p>

<p class="tip"><span>提示：</span>可以给 HTML 元素赋予多个 class，例如：&lt;span class=&quot;left_menu important&quot;&gt;。这么做可以把若干个 CSS 类合并到一个 HTML 元素。</p>

<p class="tip"><span>提示：</span>类名不能以数字开头！只有 Internet Explorer 支持这种做法。</p>
</div>
...
<p class="note"><span>W3C:</span> &quot;W3C&quot; 列指示 W3C 的 HTML/XHTML 推荐标准中是否定义了该属性。</p>
...
<pre>&lt;element <code>class=&quot;<i>value</i>&quot;</code>&gt;</pre>
...
<tr>
<td><i>classname</i></td>
<td>规定元素的类的名称。如需为一个元素规定多个类，用空格分隔类名。</td>
</tr>
</table>
</div>
...
<dl>
<dt><a href="/tiy/t.asp?f=html_standard_class2">向元素添加多个类</a></dt>
<dd>如何向一个元素添加多个类。</dd>
</dl>
</div>
