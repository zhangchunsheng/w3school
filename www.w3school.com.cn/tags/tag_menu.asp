...
<li class="currentLink"><a href="/tags/tag_menu.asp" title="HTML &lt;menu&gt; 标签">&lt;menu&gt;</a></li>
...
<p>在 HTML 4.01 中，menu 元素不被赞成使用。</p>

<p>在 XHTML 1.0 Strict DTD 中，menu 元素不被支持。</p>
</div>
...
<p class="tip"><span>提示：</span>请使用 CSS 样式来定义列表的类型！</p>
</div>
...
<p>&lt;menu&gt; 标签支持 <a href="/tags/html_ref_standardattributes.asp">HTML 中的全局属性</a>。</p>
</div>
...
<p>&lt;menu&gt; 标签支持 <a href="/tags/html_ref_eventattributes.asp">HTML 中的事件属性</a>。</p>
</div>
