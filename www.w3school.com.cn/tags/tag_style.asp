...
<li class="currentLink"><a href="/tags/tag_style.asp" title="HTML &lt;style&gt; 标签">&lt;style&gt;</a></li>
...
<p class="tiy"><a target="_blank" href="/tiy/t.asp?f=html_style">亲自试一试</a></p>
</div>
...
<p class="tip"><span>提示：</span>如需链接外部样式表，请使用 <a href="/tags/tag_link.asp" title="HTML &lt;link&gt; 标签">&lt;link&gt; 标签</a>。</p>

<p class="tip"><span>提示：</span>如需学习更多有关样式表的知识，请阅读我们的 <a href="/css/index.asp" title="CSS 教程">CSS 教程</a>。</p>
</div>
...
<tr>
<td><a href="/tags/att_style_type.asp" title="HTML &lt;style&gt; 标签的 type 属性">type</a></td>
<td>text/css</td>
<td>规定样式表的 MIME 类型。</td>
</tr>
</table>
</div>
...
<tr>
<td><a href="/tags/att_style_media.asp" title="HTML &lt;style&gt; 标签的 media 属性">media</a></td>
<td>
	<ul>
	<li>screen</li>
	<li>tty</li>
...
<p>&lt;style&gt; 标签支持 <a href="/tags/html_ref_standardattributes.asp">HTML 中的全局属性</a>。</p>
</div>
...
<p>&lt;style&gt; 标签支持 <a href="/tags/html_ref_eventattributes.asp">HTML 中的事件属性</a>。</p>
</div>
