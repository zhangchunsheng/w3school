...
<title>HTML &lt;table&gt; 标签的 rules 属性</title>
</head>
...
<h1>HTML &lt;table&gt; 标签的 rules 属性</h1>


<div class="backtoreference">
<p><a href="/tags/tag_table.asp">HTML &lt;table&gt; 标签</a></p>
</div>


<div>
<h2>定义和用法</h2>
<p>rules 属性规定内侧边框的哪个部分是可见的。</p>
<p>从实用角度出发，最好不要规定 rules，而是使用 CSS 来添加<a href="/css/css_border.asp" title="CSS 边框">边框样式</a>。</p>
</div>
...
<p>下面的例子规定只有行之间的边框是可见的：</p>

<pre>
&lt;table <code>rules=&quot;rows&quot;</code>&gt;
  &lt;tr&gt;
    &lt;th&gt;Month&lt;/th&gt;
    &lt;th&gt;Savings&lt;/th&gt;
  &lt;/tr&gt;
...
<p><a href="/tiy/t.asp?f=html_table_rules">TIY</a></p>
</div>


<div>
<h2>浏览器支持</h2>
<p>rules 属性在 Firefox 和 Opera 中可以正确地显示。</p>
<p>Internet Explorer、Chrome 以及 Safari 3 对该属性的显示并不正确。</p>

<ul>
<li>IE: 除了内侧边框，还会添加 4 边的外侧边框。</li>
<li>Chrome 和 Safari：除了内侧边框，还会添加 affected 外侧边框。</li>
</ul>

<p class="note"><span>注释：</span>Safari 2.0 和更早的版本不支持该属性。</p>
</div>
