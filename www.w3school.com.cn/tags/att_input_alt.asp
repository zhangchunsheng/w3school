...
<title>HTML &lt;input&gt; 标签的 alt 属性</title>
</head>
...
<p>alt 属性只能与 &lt;input type=&quot;image&quot;&gt; 配合使用。它为图像输入规定替代文本。</p>
<p>alt 属性为用户由于某些原因无法查看图像时提供了备选的信息。</p>
<p class="note"><span>注释：</span>即使 alt 属性不是必需的属性，但是当输入类型为 image 时，仍然应该设置该属性。如果不使用该属性，就有可能对文本浏览器或非可视的浏览器造成使用障碍。</p>
</div>
...
&lt;form action=&quot;form_action.asp&quot; method=&quot;get&quot;&gt;
  ...
  &lt;input <span style="color:#ff0000;">type=&quot;image&quot;</span> src=&quot;submit.jpg&quot; <code>alt=&quot;Submit&quot;</code> align=&quot;right&quot; /&gt;
&lt;/form&gt;
</pre>
...
<p>除了 Safari，所有主流的浏览器都支持 &quot;alt&quot; 属性。</p>
</div>
