...
<title>HTML &lt;table&gt; 标签的 align 属性</title>
</head>
...
<div>
<h2>定义和用法</h2>
<p>align 属性规定表格相对于周围元素的对齐方式。</p>
<p>通常来说，HTML 表格的前后都会出现折行。通过运用 align 属性，可实现其他 HTML 元素围绕表格的效果。</p>
</div>
...
<pre>
&lt;table border=&quot;1&quot; <code>align=&quot;right&quot;</code>&gt;
  &lt;tr&gt;
    &lt;th&gt;Month&lt;/th&gt;
    &lt;th&gt;Savings&lt;/th&gt;
  &lt;/tr&gt;
...
<p><a href="/tiy/t.asp?f=html_table_align2">TIY</a></p>
</div>
...
<p>请使用 CSS 代替。</p>
<p>CSS 语法：&lt;table style=&quot;float:right&quot;&gt;</p>
<p><a href="/tiy/t.asp?f=html_table_align_css">CSS 实例：表格对齐方式</a></p>
<p>在我们的 CSS 教程中，您可以找到更多有关 <a href="/cssref/pr_class_float.asp" title="CSS float 属性">float 属性</a>的细节。</p>
</div>
