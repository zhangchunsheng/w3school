...
<title>HTML5 canvas arc() 方法</title>
...
var ctx=c.getContext(&quot;2d&quot;);
ctx.beginPath();
<code>ctx.arc(100,75,50,0,2*Math.PI);</code>
ctx.stroke();
</pre>

<p><a target="_blank" href="/tiy/t.asp?f=html5_canvas_arc">亲自试一试</a></p>
</div>
...
<p>Internet Explorer 9、Firefox、Opera、Chrome 以及 Safari 支持 arc() 方法。</p>
...
<p class="tip"><span>提示：</span>如需通过 arc() 来创建圆，请把起始角设置为 0，结束角设置为 2*Math.PI。</p>

<p class="tip"><span>提示：</span>请使用 <a href="/html5/canvas_stroke.asp" title="HTML5 canvas stroke() 方法">stroke()</a> 或 <a href="/html5/canvas_fill.asp" title="HTML5 canvas fill() 方法">fill()</a> 方法在画布上绘制实际的弧。</p>

<img src="/i/arc.gif" alt="弧/曲线" />

<ul>
<li>中心：arc(<span class="marked">100</span>,<span class="marked">75</span>,50,0*Math.PI,1.5*Math.PI)</li>
<li>起始角：arc(100,75,50,<span class="marked">0</span>,1.5*Math.PI)</li>
<li>结束角：arc(100,75,50,0*Math.PI,<span class="marked">1.5*Math.PI</span>)</li>
</ul>

<h3>JavaScript 语法：</h3>

<pre>context.arc(<i>x</i>,<i>y</i>,<i>r</i>,<i>sAngle</i>,<i>eAngle</i>,<i>counterclockwise</i>);</pre>
