...
<title>HTML &lt;body&gt; 标签的 background 属性</title>
</head>
...
<h1>HTML &lt;body&gt; 标签的 background 属性</h1>
...
<pre>
&lt;html&gt;
&lt;body <code>background=&quot;bgimage.jpg&quot;</code>&gt;
&lt;h1&gt;Hello world!&lt;/h1&gt;
...
<p><a href="/tiy/t.asp?f=html_body_background">TIY</a></p>
</div>
...
<p>请使用 CSS 代替。</p>
<p>CSS 语法：&lt;body style=&quot;background-image:url(bgimage.jpg)&quot;&gt;</p>
<p><a href="/tiy/t.asp?f=html_body_background_css">CSS 实例：向文档添加一幅背景图像</a></p>
<p>在我们的 CSS 教程中，您可以找到更多有关 <a href="/cssref/pr_background-image.asp" title="CSS background-image 属性">background-image</a> 的细节。</p>
</div>
...
<pre>&lt;body background=&quot;<i>value</i>&quot;&gt;</pre>
  ...
  <tr>
	...
	<p>背景图像的 URL。可能的值：</p>
		<ul class="listintable">
			<li>绝对 URL - 指向另一个站点（比如 href=&quot;http://www.example.com/bgimage.gif&quot;）</li>
			<li>相对 URL - 指向站点内的某个文件（href=&quot;bgimage.gif&quot;）</li>
		</ul>
	</td>
  </tr>
</table>
