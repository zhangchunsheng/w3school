...
<li class="currentLink"><a href="/tags/tag_a.asp" title="HTML &lt;a&gt; 标签">&lt;a&gt;</a></li>
...
<p><a href="/tiy/t.asp?f=html_a">亲自试一试</a></p>
</div>
...
<p class="tip"><span>提示：</span>您可能已经注意到了，W3School 站点内的链接外观与默认的链接外观非常不同。您可以使用 <a href="/css/css_pseudo_classes.asp" title="CSS 伪类 (Pseudo-classes)">CSS 伪类</a> 向文本超链接添加复杂而多样的样式。</p>
</div>
...
<p><a href="/tags/tag_term_hypertext.asp">什么是超文本？</a></p>
</div>
...
<p>&lt;a&gt; 标签支持 <a href="/tags/html_ref_standardattributes.asp">HTML 中的全局属性</a>。</p>
</div>
...
<p>&lt;a&gt; 标签支持 <a href="/tags/html_ref_eventattributes.asp">HTML 中的事件属性</a>。</p>
</div>
...
<p>HTML 教程：<a href="/html/html_links.asp" title="HTML 链接">HTML 链接</a></p>

<p>HTML DOM 参考手册：<a href="/jsref/dom_obj_anchor.asp" title="HTML DOM Anchor 对象">Anchor 对象</a></p>
</div>
