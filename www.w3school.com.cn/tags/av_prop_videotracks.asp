...
<title>HTML 5 Audio/Video DOM videoTracks 属性</title>
...
<h1>HTML 5 Audio/Video DOM videoTracks 属性</h1>
...
alert(<code>myVid.videoTracks.length</code>);
</pre>

<p><a href="/tiy/t.asp?f=html5_av_prop_videotracks">亲自试一试</a></p>
</div>
...
<p>videoTracks 属性返回 VideoTrackList 对象。</p>

<p>VideoTrackList 对象表示视频的可用视频轨道。</p>

<p>VideoTrack 对象表示每一条可用的视频轨道。</p>
</div>
...
<p>没有任何主流浏览器支持 videoTracks 属性。</p>
</div>
...
<td>
	<p>表示视频的可用视频轨道。</p>
	<p>VideoTrackList 对象：</p>
	<ul class="listintable">
	<li>videoTracks.length - 获得视频中可用视频轨道的数量</li>
	<li>videoTracks.getTrackById(<i>id</i>) - 通过 id 获得 VideoTrack 对象</li>
	<li>videoTracks[<i>index</i>] - 通过下标获得 VideoTrack 对象</li>
	<li>videoTracks.selectedIndex - 获得当前 VideoTrack 对象的下标</li>
	</ul>
	<p class="note"><span>注释：</span>第一个可用 VideoTrack 对象的下标是 0。</p>
</td>
</tr>
...
<td>
	<p>表示一条视频轨道。</p>
	<p>VideoTrack 对象的属性：</p>
	<ul class="listintable">
	<li>id - 获得视频轨道的 id</li>
	<li>kind - 获得视频轨道的类型（可以是 &quot;alternative&quot;, &quot;captions&quot;, &quot;main&quot;, &quot;sign&quot;, &quot;subtitles&quot;, &quot;commentary&quot;, 或 &quot;&quot; （空字符串））</li>
	<li>label - 获得视频轨道的标签</li>
	<li>language - 获得视频轨道的语言</li>
	<li>selected - 获得或设置视频轨道是否是活动的 (true|false)</li>
	</ul>
</td>
</tr>
</table>
