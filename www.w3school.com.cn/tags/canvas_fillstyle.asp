...
<tr>
<td><i>gradient</i></td>
<td>用于填充绘图的渐变对象（<a href="/tags/canvas_createlineargradient.asp" title="HTML5 canvas createLinearGradient() 方法">线性</a>或<a href="/tags/canvas_createradialgradient.asp" title="HTML5 canvas createRadialGradient() 方法">放射性</a>）</td>
</tr>
