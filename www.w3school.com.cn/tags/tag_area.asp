...
<li class="currentLink"><a href="/tags/tag_area.asp" title="HTML &lt;area&gt; 标签">&lt;area&gt;</a></li>
...
&lt;map name=&quot;planetmap&quot; id=&quot;planetmap&quot;&gt;
  <code>&lt;area shape=&quot;circle&quot; coords=&quot;180,139,14&quot; href =&quot;venus.html&quot; alt=&quot;Venus&quot; /&gt;</code>
  <code>&lt;area shape=&quot;circle&quot; coords=&quot;129,161,10&quot; href =&quot;mercur.html&quot; alt=&quot;Mercury&quot; /&gt;</code>
  <code>&lt;area shape=&quot;rect&quot; coords=&quot;0,0,110,260&quot; href =&quot;sun.html&quot; alt=&quot;Sun&quot; /&gt;</code>
&lt;/map&gt;
</pre>

<p class="tiy"><a target="_blank" href="/tiy/t.asp?f=html_areamap">亲自试一试</a></p>
</div>
...
<p class="note"><span>注释：</span><a href="tag_img.asp">&lt;img&gt;</a> 标签中的 usemap 属性与 <a href="tag_map.asp">map</a> 元素 name 属性相关联，创建图像与映射之间的联系。</p>
</div>
...
<p>在 HTML 中，&lt;area&gt; 没有结束标签。</p>

<p>在 XHTML 中，&lt;area&gt; 必须正确地关闭。</p>
</div>
...
<p class="note"><span>注释：</span>&lt;img&gt; 中的 <em>usemap</em> 属性可引用 &lt;map&gt; 中的 <em>id</em> 或 <em>name</em> 属性（由浏览器决定），所以我们需要同时向 &lt;map&gt; 添加 id 和 name 两个属性。</p>
</div>
...
<tr>
<td><a href="/tags/att_area_alt.asp" title="HTML &lt;area&gt; 标签的 alt 属性">alt</a></td>
<td><i>text</i></td>
<td>定义此区域的替换文本。</td>
</tr>
</table>
...
<tr>
<td><a href="/tags/att_area_coords.asp" title="HTML &lt;area&gt; 标签的 coords 属性">coords</a></td>
<td>坐标值</td>
<td>定义可点击区域（对鼠标敏感的区域）的坐标。</td>
</tr>

<tr>
<td><a href="/tags/att_area_href.asp" title="HTML &lt;area&gt; 标签的 href 属性">href</a></td>
<td><i>URL</i></td>
<td>定义此区域的目标 URL。</td>
</tr>

<tr>
<td><a href="/tags/att_area_nohref.asp" title="HTML &lt;area&gt; 标签的 nohref 属性">nohref</a></td>
<td>nohref</td>
<td>从图像映射排除某个区域。</td>
</tr>

<tr>
<td><a href="/tags/att_area_shape.asp" title="HTML &lt;area&gt; 标签的 shape 属性">shape</a></td>
<td>
	<ul>
	<li>default</li>
	<li>rect</li>
...
<tr>
<td><a href="/tags/att_area_target.asp" title="HTML &lt;area&gt; 标签的 target 属性">target</a></td>
<td>
	<ul>
	<li>_blank</li>
	<li>_parent</li>
...
<td>规定在何处打开 href 属性指定的目标 URL。</td>
</tr>
</table>
</div>
...
<p>&lt;area&gt; 标签支持 <a href="/tags/html_ref_standardattributes.asp">HTML 中的全局属性</a>。</p>
</div>
...
<p>&lt;area&gt; 标签支持 <a href="/tags/html_ref_eventattributes.asp">HTML 中的事件属性</a>。</p>
</div>
...
<dd>本例显示如何创建带有可供点击区域的图像映射。其中的每个区域都是一个超级链接。</dd>
</dl>
</div>
