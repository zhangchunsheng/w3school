...
<title>HTML &lt;td&gt; 标签的 headers 属性</title>
</head>
...
<div>
<h2>定义和用法</h2>
<p>headers 属性规定表头与单元格相关联。</p>
<p>headers 属性不会在普通浏览器中产生任何视觉变化。</p>
<p>屏幕阅读器可以利用该属性。</p>


<h3>详细解释</h3>
<p>headers 属性会将表格中的一个表头单元格和一个数据单元格联系起来。</p>
<p>这个属性的值是引号包括的一列名称，这些名称是用 id 属性定义的不同表头单元格的名称。</p>
<p>headers 属性对非可视化的浏览器，也就是那些在显示出相关数据单元格内容之前就显示表头单元格内容的浏览器非常有用。</p>
</div>


<div>
<h2>实例</h2>
<p>下面的例子显示表头与每个单元相关联：</p>
<pre>
&lt;table border=&quot;1&quot; width=&quot;100%&quot;&gt;
  &lt;tr&gt;
    &lt;th <code>id=&quot;name&quot;</code>&gt;Name&lt;/td&gt;
    &lt;th <code>id=&quot;Email&quot;</code>&gt;Email&lt;/td&gt;
    &lt;th <code>id=&quot;Phone&quot;</code>&gt;Phone&lt;/td&gt;
    &lt;th <code>id=&quot;Address&quot;</code>&gt;Address&lt;/td&gt;
  &lt;/tr&gt;
  &lt;tr&gt;
    &lt;td <code>headers=&quot;name&quot;</code>&gt;George Bush&lt;/td&gt;
    &lt;td <code>headers=&quot;Email&quot;</code>&gt;someone@example.com&lt;/td&gt;
    &lt;td <code>headers=&quot;Phone&quot;</code>&gt;+789451236&lt;/td&gt;
    &lt;td <code>headers=&quot;Address&quot;</code>&gt;Fifth Avenue New York,USA&lt;/td&gt;
  &lt;/tr&gt;
&lt;/table&gt;
</pre>

<p><a href="/tiy/t.asp?f=html_td_headers">TIY</a></p>
</div>


<div>
<h2>浏览器支持</h2>
<p>由于不会在普通浏览器中产生任何视觉效果，很难判断浏览器是否支持 headers 属性。</p>
</div>
...
<table class="dataintable">
  ...
  <tr>
    <td><i>idrefs</i></td>
    <td>规定与表格单元相关联的一个或多个表头单元的 id。</td>
  </tr>
</table>
</div>
