...
<title>HTML5 canvas miterLimit 属性</title>
...
<h1>HTML 5 canvas miterLimit 属性</h1>
...
<p><a href="/tiy/t.asp?f=html5_canvas_miterlimit">亲自试一试</a></p>
</div>
...
<p>Internet Explorer 9、Firefox、Opera、Chrome 以及 Safari 支持 miterLimit 属性。</p>
...
<img src="/i/miterlimit.gif" align="Miter Limit 图解 1" />

<p class="tip"><span>提示：</span>只有当 lineJoin 属性为 &quot;miter&quot; 时，miterLimit 才有效。</p>

<p>边角的角度越小，斜接长度就会越大。</p>

<p>为了避免斜接长度过长，我们可以使用 miterLimit 属性。</p>

<p>如果斜接长度超过 miterLimit 的值，边角会以 lineJoin 的 &quot;bevel&quot; 类型来显示（图解 3）：</p>

<img src="/i/miterlimit_bevel.gif" align="Miter Limit 图解 2" />
...
<tr>
<th>JavaScript 语法：</th>
<td>context.miterLimit=<i>number</i>;</td>
</tr>
</table>
...
<td>
	<p>正数。规定最大斜接长度。</p>
	<p>如果斜接长度超过 miterLimit 的值，边角会以 lineJoin 的 &quot;bevel&quot; 类型来显示。</p>
</td>
</tr>
</table>
</div>
