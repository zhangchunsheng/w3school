...
<title>HTML &lt;del&gt; 标签的 datetime 属性</title>
</head>
...
<h1>HTML &lt;del&gt; 标签的 datetime 属性</h1>
...
<div>
<h2>定义和用法</h2>
<p>datetime 属性规定文本被删除的日期和时间。</p>
</div>


<div>
<h2>实例</h2>
<p>在 del 元素中使用 datetime 属性：</p>

<pre>a dozen is <code>&lt;del <code>datetime=&quot;2009-08-08T21:55:06Z&quot;</code>&gt;20&lt;/del&gt;</code> 12 pieces</pre>

<p><a href="/tiy/t.asp?f=html_ins_datetime">亲自试一试</a></p>
</div>


<div>
<h2>浏览器支持</h2>
<p>没有浏览器以任何方式使用 datetime 属性。</p>
</div>
...
<pre>&lt;del datetime=&quot;<i>value</i>&quot;&gt;</pre>
  ...
  <tr>
	...
	<p>组件解释：</p>
		<ul class="listintable">
			...
			<li>MM - 月（例如 01 for January）</li>
			<li>DD - 月中的日 （例如 08）</li>
			<li>T - 必需的分隔符</li>
			<li>hh - 小时 （例如 22 for 10.00pm）</li>
			<li>mm - 分钟 （例如 55）</li>
			<li>ss - 秒 （例如 03）</li>
