...
<p>&lt;html&gt; 与 &lt;/html&gt; 标签限定了文档的开始点和结束点，在它们之间是文档的头部和主体。正如您所了解的那样，文档的头部由 <a href="/tags/tag_head.asp" title="HTML &lt;head&gt; 标签">&lt;head&gt; 标签</a>定义，而主体由 <a href="/tags/tag_body.asp" title="HTML &lt;body&gt; 标签">&lt;body&gt; 标签</a>定义。</p>
</div>
...
<p><a href="/tags/tag_prop_xmlns.asp">有关 xmlns 属性的更多信息</a>。</p>
</div>
...
<p class="note"><span>注释：</span>即使 html 元素是文档的根元素，它也不包含 doctype 元素。doctype 元素必须位于 html 元素之前。</p>
</div>
...
<tr>
<td><a href="/tags/tag_prop_xmlns.asp">xmlns</a></td>
<td>http://www.w3.org/1999/xhtml</td>
<td>定义 XML namespace 属性。</td>
</tr>
</table>
</div>
...
<p>&lt;html&gt; 标签支持 <a href="/tags/html_ref_standardattributes.asp">HTML 中的全局属性</a>。</p>
</div>
