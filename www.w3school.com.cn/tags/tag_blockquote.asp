...
<li class="currentLink"><a href="/tags/tag_blockquote.asp" title="HTML &lt;blockquote&gt; 标签">&lt;blockquote&gt;</a></li>
...
<p class="tiy"><a target="_blank" href="/tiy/t.asp?f=html_blockquote">亲自试一试</a></p>
</div>
...
<p>所有主流的浏览器均支持 &lt;blockquote&gt; 标签。</p>

<p class="note"><span>注释：</span>没有浏览器能够正确地显示 cite 属性。</p>
</div>
...
<p class="tip"><span>提示：</span>请使用 <a href="/tags/tag_q.asp" title="HTML &lt;q&gt; 标签">q 元素</a>来标记短的引用。</p>

<p class="note"><span>注释：</span>如需把页面作为 strict XHTML 进行验证，那么 &lt;blockquote&gt; 元素必须包含块级元素，比如这样：</p>

<pre>
&lt;blockquote&gt;
<span class="marked">&lt;p&gt;here is a long quotation here is a long quotation&lt;/p&gt;</span>
&lt;/blockquote&gt;
</pre>
</div>
...
<tr>
<td><a href="/tags/att_blockquote_cite.asp" title="HTML &lt;blockquote&gt; cite 属性">cite</a></td>
<td><i>URL</i></td>
<td>规定引用的来源。</td>
</tr>
</table>
...
<p>&lt;blockquote&gt; 标签支持 <a href="/tags/html_ref_standardattributes.asp">HTML 中的全局属性</a>。</p>
</div>
...
<p>&lt;blockquote&gt; 标签支持 <a href="/tags/html_ref_eventattributes.asp">HTML 中的事件属性</a>。</p>
</div>
