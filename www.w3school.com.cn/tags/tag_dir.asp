...
<li class="currentLink"><a href="/tags/tag_dir.asp" title="HTML &lt;dir&gt; 标签">&lt;dir&gt;</a></li>
...
<div>
<p><strong>不赞成使用 dir 元素！</strong></p>
</div>
...
<p class="tiy"><a target="_blank" href="/tiy/t.asp?f=html_dir_test">亲自试一试</a></p>
</div>
...
<p>在 HTML 4.01 中，dir 元素不被赞成使用。</p>

<p>在 XHTML 1.0 Strict DTD 中，dir 元素不被支持。</p>
</div>
...
<p class="tip"><span>提示：</span>请使用 CSS 来为列表添加样式！在我们的 CSS 教程中，您可以找到更多有关<a href="/css/css_list.asp" title="CSS 列表">为列表添加样式</a>的细节。</p>
</div>
...
<tr>
<td><a href="/tags/att_dir_compact.asp" title="HTML &lt;dir&gt; 标签的 compact 属性">compact</a></td>
<td>compact</td>
<td>
...
<div>
<h2>事件属性</h2>
<pre>onclick, ondblclick, onfocus, onblur, onmousedown, onmouseup, onmouseover, 
