...
<title>HTML &lt;img&gt; 标签的 hspace 和 vspace 属性</title>
</head>
...
<h1>HTML &lt;img&gt; 标签的 hspace 和 vspace 属性</h1>
...
<p>&lt;img&gt; 标签的 hspace 和 vspace 属性可以设置图像周围的空间。</p>

<h3>详细说明</h3>
<p>通常图形浏览器不会在图像和其周围的文字之间留出很多空间。除非创建一个透明的图像边框来扩大这些间距，否则图像与其周围文字之间默认的两个像素的距离，对于大多数设计者来说是太近了。如果把图像放在超链接中，特殊颜色的边框会把你费尽心思留出的所有间距都占据了，而且还会使人们注意到文字与图像是多么接近。</p>
<p>hspace 和 vspace 属性可以给图像一个自由呼吸的空间。通过 hspace，可以以像素为单位，指定图像左边和右边的文字与图像之间的间距；而 vspace 值则是上面的下面的文字与图像之间的距离的像素数。</p>
<p>我们确信您同意这一点，也就是在这些图像周围留出额外的空间，会使文本更容易阅读，而且页面整体上看上去会更引人入胜。</p>
</div>
...
<pre>&lt;img src=&quot;w3school.gif&quot; hspace=&quot;30&quot; vspace=&quot;30&quot; /&gt;</pre>

<p><a href="/tiy/t.asp?f=html_img_hspace_vspace">亲自试一试</a></p>
</div>
...
<p class="tip"><span>提示：</span>您可以在外部样式表中使用 CSS 的<a href="/css/css_margin.asp" title="CSS 外边距">外边距属性</a>和<a href="/css/css_padding.asp" title="CSS 内边距">内边距属性</a>，为站点上的所有图像设置一致的边距。与单独为一个图像设置 hspace 和 vspace 属性相比，这种方式无疑拥有更高的效率。</p>
</div>


<div>
<h2>兼容性注释</h2>
<p>不推荐使用 img 元素的 hspace 和 vspace 属性；在 HTML 4.01 Strict 以及 XHTML 1.0 Strict DTD 中，不支持 img 元素的 hspace 和 vspace 属性。</p>
<p>请使用 CSS 代替。</p>
<p>CSS 语法：&lt;img style=&quot;margin: 0px 50px&quot;&gt;</p>
<p><a href="/tiy/t.asp?f=html_img_hspace_vspace_css">CSS 实例：带有外边距的图像</a></p>
<p>在我们的 CSS 教程中，您可以找到更多有关 <a href="/cssref/pr_margin.asp" title="CSS margin 属性">margin 属性</a> 的细节。</p>
</div>
...
<pre>&lt;img hspace=&quot;<i>value</i>&quot; /&gt;</pre>

<p>或者：</p>

<pre>&lt;img vspace=&quot;<i>value</i>&quot; /&gt;</pre>
...
<h2>TIY 实例</h2>
<dl>
<dt><a href="/tiy/t.asp?f=html_img_hspace_vspace">&lt;img&gt; 标签的 hspace 和 vspace 属性</a></dt>
<dd>本例演示如何使用 &lt;img&gt; 标签的 hspace 和 vspace 属性来增加图像周围的空白。</dd>
</dl>
</div>
