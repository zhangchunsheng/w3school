...
<title>HTML &lt;td&gt; 标签的 nowrap 属性</title>
</head>
...
<div>
<h2>定义和用法</h2>
<p>nowrap 属性规定表格单元格中的内容不换行。</p>
</div>


<div>
<h2>实例</h2>
<p>带有 nowrap 属性的表格单元：</p>
...
&lt;table border=&quot;1&quot;&gt;
  ...
  &lt;/tr&gt;
  &lt;tr&gt;
    &lt;td <code>nowrap=&quot;nowrap&quot;</code>&gt;<i>Never increase, beyond what is necessary, the 
	number of entities required to explain anything</i>&lt;/td&gt;
    &lt;td&gt;<i>Never increase, beyond what is necessary, the number of entities 
	required to explain anything</i>&lt;/td&gt;
  &lt;/tr&gt;
&lt;/table&gt;
</pre>

<p><a href="/tiy/t.asp?f=html_td_nowrap">TIY</a></p>
</div>


<div>
<h2>浏览器支持</h2>
<p>尽管不赞成使用 nowrap 属性，但是所有浏览器都支持它。</p>
</div>
...
<p>请使用 CSS 代替。</p>
<p>CSS 语法：&lt;td style=&quot;white-space: nowrap&quot;&gt;</p>
<p><a href="/tiy/t.asp?f=html_td_nowrap_css">CSS 实例：td 中不换行</a></p>
<p>在我们的 CSS 教程中，您可以找到更多有关 <a href="/cssref/pr_text_white-space.asp" title="CSS white-space 属性">white-space 属性</a>的细节。</p>
</div>
