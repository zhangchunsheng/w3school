...
<title>HTML5 canvas createPattern() 方法</title>
...
<h1>HTML5 canvas createPattern() 方法</h1>
...
var pat=<code>ctx.createPattern(img,&quot;repeat&quot;)</code>;
ctx.rect(0,0,150,100);
ctx.fillStyle=pat;
ctx.fill();
</pre>
...
<p><a target="_blank" href="/tiy/t.asp?f=html5_canvas_createpattern">亲自试一试</a></p>
</div>
...
<p>Internet Explorer 9、Firefox、Opera、Chrome 以及 Safari 支持 createPattern() 方法。</p>
...
<pre>context.createPattern(<i>image</i>,&quot;repeat|repeat-x|repeat-y|no-repeat&quot;);</pre>
