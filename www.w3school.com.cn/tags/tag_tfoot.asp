...
<li class="currentLink"><a href="/tags/tag_tfoot.asp" title="HTML &lt;tfoot&gt; 标签">&lt;tfoot&gt;</a></li>
...
<p>带有 thead、tbody 以及 tfoot 元素的 HTML 表格：</p>
...
<p class="tiy"><a target="_blank" href="/tiy/t.asp?f=html_tbody">亲自试一试</a></p>
</div>
...
<p>&lt;tfoot&gt; 标签定义表格的页脚（脚注或表注）。该标签用于组合 HTML 表格中的表注内容。</p>

<p>tfoot 元素应该与 <a href="/tags/tag_thead.asp" title="HTML &lt;thead&gt; 标签">thead</a> 和 <a href="/tags/tag_tbody.asp" title="HTML &lt;tbody&gt; 标签">tbody</a> 元素结合起来使用。</p>

<p>thead 元素用于对 HTML 表格中的表头内容进行分组，而 tbody 元素用于对 HTML 表格中的主体内容进行分组。</p>

<p class="note"><span>注释：</span>如果您使用 thead、tfoot 以及 tbody 元素，您就必须使用全部的元素。它们的出现次序是：thead、tfoot、tbody，这样浏览器就可以在收到所有数据前呈现页脚了。您必须在 table 元素内部使用这些标签。</p>

<p class="tip"><span>提示：</span>在默认情况下这些元素不会影响到表格的布局。不过，您可以使用 CSS 使这些元素改变表格的外观。</p>
...
<p class="note"><span>注释：</span>&lt;thead&gt; 内部必须拥有 &lt;tr&gt; 标签！</p>
<p class="note"><span>注释：</span>&lt;thead&gt;、&lt;tbody&gt; 以及 &lt;tfoot&gt; 很少被使用，这是因为糟糕的浏览器支持。我们期望在 XHTML 的未来版本中这种情况会发生变化。假如您使用 Internet Explorer 5.0 或更新的浏览器，可以在我们的 XML 教程中查看一个<a href="/tiy/t.asp?f=xmle_cd_catalog_island_thead">例子</a>。</p>
</div>
...
<tr>
<td><a href="/tags/att_tfoot_align.asp" title="HTML &lt;tfoot&gt; 标签的 align 属性">align</a></td>
<td>
	<ul>
	<li>right</li>
	<li>left</li>
...
<td>定义 tfoot 元素中内容的对齐方式。</td>
</tr>

<tr>
<td><a href="/tags/att_tfoot_char.asp" title="HTML &lt;tfoot&gt; 标签的 char 属性">char</a></td>
<td><i>character</i></td>
<td>规定根据哪个字符来进行文本对齐。</td>
</tr>

<tr>
<td><a href="/tags/att_tfoot_charoff.asp" title="HTML &lt;tfoot&gt; 标签的 charoff 属性">charoff</a></td>
<td><i>number</i></td>
<td>规定第一个对齐字符的偏移量。</td>
</tr>

<tr>
<td><a href="/tags/att_tfoot_valign.asp" title="HTML &lt;tfoot&gt; 标签的 valign 属性">valign</a></td>
<td>
<ul>
<li>top</li>
<li>middle</li>
...
<p>&lt;tfoot&gt; 标签支持 <a href="/tags/html_ref_standardattributes.asp">HTML 中的全局属性</a>。</p>
</div>
...
<p>&lt;tfoot&gt; 标签支持 <a href="/tags/html_ref_eventattributes.asp">HTML 中的事件属性</a>。</p>
</div>
