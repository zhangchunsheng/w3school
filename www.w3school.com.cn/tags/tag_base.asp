...
<li class="currentLink"><a href="/tags/tag_base.asp" title="HTML &lt;base&gt; 标签">&lt;base&gt;</a></li>
...
<p class="tiy"><a target="_blank" href="/tiy/t.asp?f=html_base_test">亲自试一试</a></p>
</div>
...
<tr>
<td><a href="/tags/att_base_href.asp" title="HTML &lt;base&gt; 标签的 href 属性">href</a></td>
<td><i>URL</i></td>
...
<tr>
<td><a href="/tags/att_base_target.asp" title="HTML &lt;base&gt; 标签的 target 属性">target</a></td>
<td>
	<ul>
	<li>_blank</li>
	<li>_parent</li>
...
<dl>
<dt><a href="/tiy/t.asp?f=html_base" title="一个target，所有的链接。">一个 target，所有的链接</a></dt>
<dd>本例显示如何使用 base 标签使得页面中的所有标签在新窗口中打开。</dd>
</dl>
</div>
