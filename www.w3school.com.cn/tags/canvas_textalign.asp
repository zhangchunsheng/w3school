...
<p class="tip"><span>提示：</span>使用 <a href="/tags/canvas_filltext.asp" title="HTML5 canvas fillRect() 方法">fillText()</a> 或 <a href="/tags/canvas_stroketext.asp" title="HTML5 canvas strokeText() 方法">strokeText()</a> 方法在实际地在画布上绘制并定位文本。</p>
