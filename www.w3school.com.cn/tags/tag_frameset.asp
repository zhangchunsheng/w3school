...
<li class="currentLink"><a href="/tags/tag_frameset.asp" title="HTML &lt;frameset&gt; 标签">&lt;frameset&gt;</a></li>
...
<code>&lt;frameset cols=&quot;25%,50%,25%&quot;&gt;</code>
...
<p>frameset 元素可定义一个框架集。它被用来组织多个窗口（框架）。每个框架存有独立的文档。在其最简单的应用中，frameset 元素仅仅会规定在框架集中存在多少列或多少行。您必须使用 cols 或 rows 属性。</p>
</div>
...
<p class="note"><span>注释：</span>如果您希望验证某个包含框架的页面，请确保 DTD 被设置为 &quot;Frameset DTD&quot;。阅读更多有关 <a href="/xhtml/xhtml_validate.asp">XHTML 验证</a>的内容。</p>
...
<td>定义框架集中列的数目和尺寸。<a href="/tags/tag_frameset_prop_cols_rows.asp" title="HTML &lt;frameset&gt; 标签的 cols 属性和 rows 属性">有关 cols 属性的详细信息</a>。</td>
</tr>
...
<td>定义框架集中行的数目和尺寸。<a href="/tags/tag_frameset_prop_cols_rows.asp" title="HTML &lt;frameset&gt; 标签的 cols 属性和 rows 属性">有关 rows 属性的详细信息</a>。</td>
</tr>
</table>
</div>
...
<p>如需完整的描述，请访问<a href="/tags/html_ref_eventattributes.asp">事件属性</a>。</p>
</div>
