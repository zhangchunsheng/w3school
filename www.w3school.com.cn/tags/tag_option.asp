...
<li class="currentLink"><a href="/tags/tag_option.asp" title="HTML &lt;option&gt; 标签">&lt;option&gt;</a></li>
...
<pre>
&lt;select&gt;
  <code>&lt;option value =&quot;volvo&quot;&gt;Volvo&lt;/option&gt;</code>
  <code>&lt;option value =&quot;saab&quot;&gt;Saab&lt;/option&gt;</code>
  <code>&lt;option value=&quot;opel&quot;&gt;Opel&lt;/option&gt;</code>
  <code>&lt;option value=&quot;audi&quot;&gt;Audi&lt;/option&gt;</code>
&lt;/select&gt;
</pre>

<p class="tiy"><a target="_blank" href="/tiy/t.asp?f=html_option">亲自试一试</a></p>
</div>
...
<p>option 元素定义下拉列表中的一个选项（一个条目）。</p>

<p>浏览器将 &lt;option&gt; 标签中的内容作为 &lt;select&gt; 标签的菜单或是滚动列表中的一个元素显示。</p>

<p>option 元素位于 select 元素内部。</p>
</div>
...
<p>在 HTML 中，&lt;option&gt; 没有结束标签。</p>

<p>在 XHTML 中，&lt;option&gt; 必须被正确关闭。</p>
</div>
...
<p class="note"><span>注释：</span>&lt;option&gt; 标签可以在不带有任何属性的情况下使用，但是您通常需要使用 value 属性，此属性会指示出被送往服务器的内容。</p>

<p class="note"><span>注释：</span>请与 select 元素配合使用此标签，否则这个标签是没有意义的。</p>

<p class="tip"><span>提示：</span>如果列表选项很多，可以使用 &lt;optgroup&gt; 标签对相关选项进行组合。</p>
</div>
...
<tr>
<td><a href="/tags/att_option_disabled.asp" title="HTML &lt;option&gt; 标签的 disabled 属性">disabled</a></td>
<td>disabled</td>
<td>规定此选项应在首次加载时被禁用。</td>
</tr>

<tr>
<td><a href="/tags/att_option_label.asp" title="HTML &lt;option&gt; 标签的 label 属性">label</a></td>
<td><i>text</i></td>
<td>定义当使用 &lt;optgroup&gt; 时所使用的标注。</td>
</tr>

<tr>
<td><a href="/tags/att_option_selected.asp" title="HTML &lt;option&gt; 标签的 selected 属性">selected</a></td>
<td>selected</td>
<td>规定选项（在首次显示在列表中时）表现为选中状态。</td>
</tr>

<tr>
<td><a href="/tags/att_option_value.asp" title="HTML &lt;option&gt; 标签的 value 属性">value</a></td>
<td><i>text</i></td>
<td>定义送往服务器的选项值。</td>
</tr>
</table>
...
<p>&lt;option&gt; 标签支持 <a href="/tags/html_ref_standardattributes.asp">HTML 中的全局属性</a>。</p>
</div>
...
<p>&lt;option&gt; 标签支持 <a href="/tags/html_ref_eventattributes.asp">HTML 中的事件属性</a>。</p>
</div>
