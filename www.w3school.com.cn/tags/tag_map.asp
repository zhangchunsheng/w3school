...
<li class="currentLink"><a href="/tags/tag_map.asp" title="HTML &lt;map&gt; 标签">&lt;map&gt;</a></li>
...
<pre>
&lt;img src=&quot;planets.jpg&quot; border=&quot;0&quot; <span class="marked">usemap=&quot;#planetmap&quot;</span> alt=&quot;Planets&quot; /&gt;

<code>&lt;map name=&quot;planetmap&quot; id=&quot;planetmap&quot;&gt;</code>
...
<p class="note"><span>注释：</span>area 元素永远嵌套在 map 元素内部。area 元素可定义图像映射中的区域。</p>

<p class="note"><span>注释：</span>&lt;img&gt;中的 usemap 属性可引用 &lt;map&gt; 中的 id 或 name 属性（取决于浏览器），所以我们应同时向 &lt;map&gt; 添加 id 和 name 属性。</p>
</div>
...
<tr>
<td><a href="/tags/att_map_name.asp" title="HTML &lt;map&gt; 标签的 name 属性">name</a></td>
<td><i>mapname</i></td>
<td>为 image-map 规定的名称。</td>
</tr>
</table>
</div>
...
<p>&lt;map&gt; 标签支持 <a href="/tags/html_ref_standardattributes.asp">HTML 中的全局属性</a>。</p>
</div>
...
<p>&lt;map&gt; 标签支持 <a href="/tags/html_ref_eventattributes.asp">HTML 中的事件属性</a>。</p>
</div>
...
<dd>本例显示如何创建带有可点击区域的图像地图。其中的每个区域都是一个超级链接。</dd>
</dl>
</div>
