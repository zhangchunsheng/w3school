...
<li class="currentLink"><a href="/tags/tag_u.asp" title="HTML &lt;u&gt; 标签">&lt;u&gt;</a></li>
...
<p class="tiy"><a target="_blank" href="/tiy/t.asp?f=html_u">亲自试一试</a></p>
</div>
...
<p>在 HTML 4.01 中，u 元素是不被推荐使用的。</p>

<p>在 XHTML 1.0 Strict DTD 中，u 元素是不被支持的。</p>
</div>
...
<p class="note"><span>注释：</span>请尽量避免为文本加下划线 - 用户会把它混淆为一个超链接！</p>
</div>
...
<p>&lt;u&gt; 标签支持 <a href="/tags/html_ref_standardattributes.asp">HTML 中的全局属性</a>。</p>
</div>
...
<p>&lt;u&gt; 标签支持 <a href="/tags/html_ref_eventattributes.asp">HTML 中的事件属性</a>。</p>
</div>
