...
<title>HTML &lt;select&gt; 标签的 multiple 属性</title>
</head>
...
<h1>HTML &lt;select&gt; 标签的 multiple 属性</h1>
...
<p>由于上述差异的存在，同时由于需要告知用户可以使用多项选择，对用户更友好的方式是使用复选框。</p>

<p class="tip"><span>提示：</span>可以把 multiple 属性与 size 属性配合使用，来定义可见选项的数目。</p>
</div>
...
<pre>
&lt;select <code>multiple=&quot;multiple&quot;</code> size=&quot;2&quot;&gt;
...
<p><a href="/tiy/t.asp?f=html_select_multiple">TIY</a></p>
</div>


<div>
<h2>浏览器支持</h2>
<p>所有浏览器都支持 multiple 属性。</p>
</div>
...
<pre>&lt;select multiple=&quot;<i>value</i>&quot;&gt;</pre>
