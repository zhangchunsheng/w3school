...
<li class="currentLink"><a href="/tags/tag_input.asp" title="HTML &lt;input&gt; 标签">&lt;input&gt;</a></li>
...
<p class="tiy"><a target="_blank" href="/tiy/t.asp?f=html_form_submit">亲自试一试</a></p>
...
<p>在 HTML 中，&lt;input&gt; 标签没有结束标签。</p>

<p>在 XHTML 中，&lt;input&gt; 标签必须被正确地关闭。</p>
</div>
...
<p class="tip"><span>提示：</span>请使用 <a href="/tags/tag_label.asp" title="HTML &lt;label&gt; 标签">label 元素</a>为某个表单控件定义标签。</p>
</div>
...
<tr>
<td><a href="/tags/att_input_accept.asp" title="HTML &lt;input&gt; 标签的 accept 属性">accept</a></td>
<td><i>mime_type</i></td>
<td>规定通过文件上传来提交的文件的类型。</td>
</tr>

<tr>
<td><a href="/tags/att_input_align.asp" title="HTML &lt;input&gt; 标签的 align 属性">align</a></td>
<td>
<ul>
<li>left</li>
<li>right</li>
...
<td><span class="deprecated">不赞成使用。</span>规定图像输入的对齐方式。</td>
</tr>

<tr>
<td><a href="/tags/att_input_alt.asp" title="HTML &lt;input&gt; 标签的 alt 属性">alt</a></td>
<td>text</td>
<td>定义图像输入的替代文本。</td>
</tr>

<tr>
<td><a href="/tags/att_input_checked.asp" title="HTML &lt;input&gt; 标签的 checked 属性">checked</a></td>
<td>checked</td>
<td>规定此 input 元素首次加载时应当被选中。</td>
</tr>

<tr>
<td><a href="/tags/att_input_disabled.asp" title="HTML &lt;input&gt; 标签的 disabled 属性">disabled</a></td>
<td>disabled</td>
<td>当 input 元素加载时禁用此元素。</td>
</tr>

<tr>
<td><a href="/tags/att_input_maxlength.asp" title="HTML &lt;input&gt; 标签的 maxlength 属性">maxlength</a></td>
<td>number</td>
<td>规定输入字段中的字符的最大长度。</td>
</tr>

<tr>
<td><a href="/tags/att_input_name.asp" title="HTML &lt;input&gt; 标签的 name 属性">name</a></td>
<td>field_name</td>
<td>定义 input 元素的名称。</td>
</tr>

<tr>
<td><a href="/tags/att_input_readonly.asp" title="HTML &lt;input&gt; 标签的 readonly 属性">readonly</a></td>
<td>readonly</td>
<td>规定输入字段为只读。</td>
</tr>

<tr>
<td><a href="/tags/att_input_size.asp" title="HTML &lt;input&gt; 标签的 size 属性">size</a></td>
<td>number_of_char</td>
<td>定义输入字段的宽度。</td>
</tr>

<tr>
<td><a href="/tags/att_input_src.asp" title="HTML &lt;input&gt; 标签的 src 属性">src</a></td>
<td>URL</td>
<td>定义以提交按钮形式显示的图像的 URL。</td>
</tr>

<tr>
<td><a href="/tags/att_input_type.asp" title="HTML &lt;input&gt; 标签的 type 属性">type</a></td>
<td>
<ul>
<li>button</li>
<li>checkbox</li>
...
<tr>
<td><a href="/tags/att_input_value.asp" title="HTML &lt;input&gt; 标签的 value 属性">value</a></td>
<td><i>value</i></td>
<td>规定 input 元素的值。</td>
</tr>
</table>
...
<p>&lt;input&gt; 标签支持 <a href="/tags/html_ref_standardattributes.asp">HTML 中的全局属性</a>。</p>
</div>
...
<p>&lt;input&gt; 标签支持 <a href="/tags/html_ref_eventattributes.asp">HTML 中的事件属性</a>。</p>
</div>
...
<dt><a href="/tiy/t.asp?f=html_textarea">文本域(Textarea)</a></dt>
<dd>本例演示如何创建一个文本域（多行文本输入控制）。用户可以在文本域中写入文本。在文本域中，可写入的字符字数不受限制。</dd>

<dt><a href="/tiy/t.asp?f=html_button">创建按钮</a></dt>
<dd>本例演示如何创建按钮。你可以对按钮上的文字进行自定义。</dd>

<dt><a href="/tiy/t.asp?f=html_fieldset">围绕数据的Fieldset</a></dt>
