...
<title>HTML &lt;body&gt; 标签的 vlink 属性</title>
</head>
...
<p>将文档中已被访问的链接颜色设置为红色：</p>

<pre>
&lt;html&gt;
&lt;body <code>vlink=&quot;red&quot;</code>&gt;
...
<p><a href="/tiy/t.asp?f=html_body_vlink">TIY</a></p>
</div>


<div>
<h2>兼容性注释</h2>
<p>在 HTML 4.01 中，不赞成使用 body 元素的 vlink 属性；在 XHTML 1.0 Strict DTD 中，不支持 body 元素的 vlink 属性。</p>
<p>请使用 CSS 代替。</p>
<p>CSS 语法（在 &lt;head&gt; 部分）：&lt;style&gt;a:visited {color: #FF0000}&lt;/style&gt;</p>
<p><a href="/tiy/t.asp?f=html_body_vlink_css">CSS 实例：设置已访问链接的颜色</a></p>
<p>在我们的 CSS 教程中，您可以找到更多有关 <a href="/cssref/pr_pseudo_visited.asp" title="CSS :visited 伪类">:visited 伪类</a>的细节。</p>
</div>
