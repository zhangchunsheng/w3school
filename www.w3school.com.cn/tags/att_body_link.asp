...
<title>HTML &lt;body&gt; 标签的 link 属性</title>
</head>
...
<p>将文档中的默认链接颜色设置为蓝色：</p>

<pre>
&lt;html&gt;
&lt;body <code>link=&quot;blue&quot;</code>&gt;
...
<p><a href="/tiy/t.asp?f=html_body_link">TIY</a></p>
</div>


<div>
<h2>兼容性注释</h2>
<p>在 HTML 4.01 中，不赞成使用 body 元素的 link 属性；在 XHTML 1.0 Strict DTD 中，不支持 body 元素的 link 属性。</p>
<p>请使用 CSS 代替。</p>
<p>CSS 语法（在 &lt;head&gt; 部分）：&lt;style&gt;a:link {color: #FF0000}&lt;/style&gt;</p>
<p><a href="/tiy/t.asp?f=html_body_link_css">CSS 实例：设置文档中未访问链接的颜色</a></p>
<p>在我们的 CSS 教程中，您可以找到更多有关 <a href="/cssref/pr_pseudo_link.asp" title="CSS :link 伪类">:link 伪类</a>的细节。</p>
</div>
