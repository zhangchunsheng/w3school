...
<li class="currentLink"><a href="/tags/tag_output.asp" title="HTML &lt;output&gt; 标签">&lt;output&gt;</a></li>
...
<h1>HTML &lt;output&gt; 标签</h1>


<div>
<h2>实例</h2>

<p>如何在表单中使用 output 元素：</p>

<pre>
&lt;form action="form_action.asp" method="get" name="sumform"&gt;
<code>&lt;output name="sum"&gt;&lt;/output&gt;</code>
&lt;/form&gt;
</pre>

<p class="tiy"><a target="_blank" href="/tiy/t.asp?f=html5_output">亲自试一试</a></p>
</div>
...
<p>Firefox, Chrome, Safari 以及 Opera 支持 &lt;output&gt; 标签。</p>

<p class="note"><span>注释：</span>Internet Explorer 8 以及更早的版本不支持 &lt;output&gt; 标签。</p>
</div>
...
<table class="dataintable">
  ...
  <tr>
    <td class="html5_new">for</td>
    <td><i>id of another element</i></td>
...
<p>&lt;output&gt; 标签支持 <a href="/tags/html_ref_standardattributes.asp">HTML 中的全局属性</a>。</p>
</div>
...
<p>&lt;output&gt; 标签支持 <a href="/tags/html_ref_eventattributes.asp">HTML 中的事件属性</a>。</p>
</div>
