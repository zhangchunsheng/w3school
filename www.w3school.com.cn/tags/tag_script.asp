...
<li class="currentLink"><a href="/tags/tag_script.asp" title="HTML &lt;script&gt; 标签">&lt;script&gt;</a></li>
...
<p class="tiy"><a target="_blank" href="/tiy/t.asp?f=html_script">亲自试一试</a></p>
...
<p>script 元素既可以包含脚本语句，也可以通过 src 属性指向外部脚本文件。</p>

<p>必需的 type 属性规定脚本的 MIME 类型。</p>

<p>JavaScript 的常见应用时图像操作、表单验证以及动态内容更新。</p>
</div>
...
<p class="note"><span>注释：</span>假如此元素内部的代码没有位于某个函数中，那么这些代码会在页面被加载时被立即执行。&lt;frameset&gt; 标签之后的脚本会被忽略。</p>

<p class="tip"><span>提示：</span>请参阅 <a href="/tags/tag_noscript.asp" title="HTML &lt;noscript&gt; 标签">noscript 元素</a>；对于那些在浏览器中禁用脚本或者其浏览器不支持客户端脚本的用户来说，该元素非常有用。</p>
</div>
...
<p>在 HTML 4.01 中，script 元素的 &quot;language&quot; 属性不被赞成使用。</p>

<p>在 XHTML 1.0 Strict DTD 中，script 元素的 &quot;language&quot; 属性不被支持。</p>

<h3>HTML 4 和 XHTML 在处理脚本中的内容方面有所不同：</h3>

<p>在 HTML 4 中，内容类型声明为 CDATA，就是说不会对实体进行解析。</p>

<p>在 XHTML 中，内容类型声明为 (#PCDATA)，也就是说会对实体进行解析。</p>

<p>这意味着，在 XHTML 中，应该编码所有特殊的字符，或者把所有内容嵌套在 CDATA 部分中。</p>

<p>为了确保在 XHTML 文档中脚本正确进行解析，请使用如下语法：</p>
...
<tr>
<td><a href="/tags/att_script_type.asp">type</a></td>
<td><i>MIME-type</i></td>
<td>指示脚本的 MIME 类型。</td>
</tr>
</table>
...
<tr>
<td><a href="/tags/att_script_charset.asp">charset</a></td>
<td><i>charset</i></td>
<td>规定在外部脚本文件中使用的字符编码。</td>
</tr>

<tr>
<td><a href="/tags/att_script_defer.asp">defer</a></td>
<td>defer</td>
<td>规定是否对脚本执行进行延迟，直到页面加载为止。</td>
</tr>

<tr>
<td><a href="/tags/att_script_type.asp#type_language">language</a></td>
<td><i>script</i></td>
<td><span class="deprecated">不赞成使用。</span>规定脚本语言。请使用 type 属性代替它。</td>
</tr>

<tr>
<td><a href="/tags/att_script_src.asp">src</a></td>
<td><i>URL</i></td>
<td>规定外部脚本文件的 URL。</td>
</tr>
...
<p>&lt;script&gt; 标签支持 <a href="/tags/html_ref_standardattributes.asp">HTML 中的全局属性</a>。</p>
</div>
...
<p>教程：<a href="/js/index.asp">JavaScript 教程</a></p>

<p>教程：<a href="/vbscript/index.asp">VBScript 教程</a></p>
</div>
