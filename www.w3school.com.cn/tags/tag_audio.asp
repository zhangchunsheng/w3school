...
<li class="currentLink"><a href="/tags/tag_audio.asp" title="HTML &lt;audio&gt; 标签">&lt;audio&gt;</a></li>
...
<pre>
<code>&lt;audio src=&quot;someaudio.wav&quot;&gt;</code>
您的浏览器不支持 audio 标签。
<code>&lt;/audio&gt;</code>
</pre>

<p class="tiy"><a target="_blank" href="/tiy/t.asp?f=html5_audio">亲自试一试</a></p>
</div>
...
<p>Internet Explorer 9+, Firefox, Opera, Chrome 以及 Safari 支持 &lt;audio&gt; 标签。</p>

<p class="note"><span>注释：</span>Internet Explorer 8 以及更早的版本不支持 &lt;audio&gt; 标签。</p>
</div>
...
<p class="tip"><span>提示：</span>可以在开始标签和结束标签之间放置文本内容，这样老的浏览器就可以显示出不支持该标签的信息。</p>
</div>
...
<p>&lt;audio&gt; 标签支持 <a href="/tags/html_ref_standardattributes.asp">HTML 中的全局属性</a>。</p>
</div>
...
<p>&lt;audio&gt; 标签支持 <a href="/tags/html_ref_eventattributes.asp">HTML 中的事件属性</a>。</p>
</div>
