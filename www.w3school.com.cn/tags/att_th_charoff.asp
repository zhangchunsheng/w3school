...
<title>HTML &lt;th&gt; 标签的 charoff 属性</title>
</head>
...
<div>
<h2>定义和用法</h2>
<p>charoff 属性设置内容相对于由 char 属性规定的字符的对齐偏移量。</p>
...
<p>在下面的例子中，第一个表头单元的的内容与 &quot;C&quot; 字符向右二个字符的位置对齐：</p>

<pre>
&lt;table border=&quot;1&quot;&gt;
  &lt;tr&gt;
    &lt;th <span class="marked">align=&quot;char&quot; char=&quot;C&quot;</span> <code>charoff=&quot;2&quot;</code>&gt;Company&lt;/th&gt;
    &lt;th&gt;Address&lt;/th&gt;
  &lt;/tr&gt;
  &lt;tr&gt;
    &lt;td&gt;Apple, Inc.&lt;/td&gt;
...
<p><a href="/tiy/t.asp?f=html_th_charoff">TIY</a></p>
</div>
