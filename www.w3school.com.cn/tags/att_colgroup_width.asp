...
<title>HTML &lt;colgroup&gt; 标签的 width 属性</title>
</head>
...
<h1>HTML &lt;colgroup&gt; 标签的 width 属性</h1>


<div class="backtoreference">
<p><a href="/tags/tag_colgroup.asp">HTML &lt;colgroup&gt; 标签</a></p>
</div>
...
<h2>定义和用法</h2>
<p>width 属性规定列组的宽度。</p>
<p>通常，列组占用的空间就是它显示内容需要的空间。width 属性用于为单元格设置预定义的宽度。</p>
<p class="note"><span>注释：</span>该属性会被 col 元素中的任何宽度设置覆盖。</p>
</div>
...
<p>下面的列组设置了两列的预定义宽度值是 100 像素：</p>

<pre>
&lt;table border=&quot;1&quot;&gt;
  &lt;colgroup span=&quot;2&quot; <code>width=&quot;100&quot;</code> /&gt;
  &lt;tr&gt;
    &lt;th&gt;Month&lt;/th&gt;
    &lt;th&gt;Savings&lt;/th&gt;
  &lt;/tr&gt;
...
<p><a href="/tiy/t.asp?f=html_colgroup_width">TIY</a></p>
</div>
...
<pre>&lt;colgroup width=&quot;<i>value</i>&quot;&gt;</pre>
