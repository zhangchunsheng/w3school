...
<li class="currentLink"><a href="/tags/tag_basefont.asp" title="HTML &lt;basefont&gt; 标签">&lt;basefont&gt;</a></li>
...
<pre>
&lt;head&gt;
<code>&lt;basefont color=&quot;red&quot; size=&quot;5&quot; /&gt;</code>
&lt;/head&gt;
...
<p class="tiy"><a target="_blank" href="/tiy/t.asp?f=html_basefont">亲自试一试</a></p>
</div>
...
<p>只有 Internet Explorer 支持 &lt;basefont&gt; 标签。应该避免使用该标签。</p>
</div>
...
<p>&lt;basefont&gt; 标签定义基准字体。该标签可以为文档中的所有文本定义默认字体颜色、字体大小和字体系列。</p>
</div>
...
<p>在 HTML 4.01 中，不赞成使用 basefont 元素；在 XHTML 1.0 Strict DTD 中，不支持 basefont 元素。</p>
</div>
...
<tr>
<td><a href="/tags/att_basefont_color.asp" title="HTML &lt;basefont&gt; 标签的 color 属性">color</a></td>
<td>
<ul>
<li><i>rgb(x,x,x)</i></li>
<li><i>#xxxxxx</i></li>
...
<tr>
<td><a href="/tags/att_basefont_face.asp" title="HTML &lt;basefont&gt; 标签的 face 属性">face</a></td>
...
<tr>
<td><a href="/tags/att_basefont_size.asp" title="HTML &lt;basefont&gt; 标签的 size 属性">size</a></td>
<td><i>number</i></td>
<td>
	<p><span class="deprecated">不赞成使用。</span>请使用样式取代它。</p>
	<p>规定文档中的默认字体大小。</p>
