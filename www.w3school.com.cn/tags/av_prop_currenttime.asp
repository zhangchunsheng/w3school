...
<title>HTML 5 Audio/Video DOM currentTime 属性</title>
...
<h1>HTML 5 Audio/Video DOM currentTime 属性</h1>
...
<code>myVid.currentTime=5</code>;
</pre>

<p><a href="/tiy/t.asp?f=html5_av_prop_currenttime">亲自试一试</a></p>
</div>
...
<p>currentTime 属性设置或返回音频/视频播放的当前位置（以秒计）。</p>

<p>当设置该属性时，播放会跳跃到指定的位置。</p>
</div>
...
<pre>audio|video.currentTime=&quot;<i>seconds</i>&quot;</pre>

<p>返回 currentTime 属性：</p>
<pre>audio|video.currentTime</pre>
