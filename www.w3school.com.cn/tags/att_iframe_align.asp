...
<p>CSS 实例：<a href="/tiy/t.asp?f=html_iframe_align_css">向右浮动 iframe</a></p>

<p>在我们的 CSS 教程中，您可以找到更多有关 <a href="/cssref/pr_class_float.asp" title="CSS float 属性">float 属性</a>的知识。</p>
</div>
