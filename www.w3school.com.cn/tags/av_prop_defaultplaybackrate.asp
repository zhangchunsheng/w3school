...
<title>HTML 5 Audio/Video DOM defaultPlaybackRate 属性</title>
...
<h1>HTML 5 Audio/Video DOM defaultPlaybackRate 属性</h1>
...
<code>myVid.defaultPlaybackRate=0.5</code>;
</pre>

<p><a href="/tiy/t.asp?f=html5_av_prop_defaultplaybackrate">亲自试一试</a></p>
</div>
...
<p>defaultPlaybackRate 属性设置或返回音频/视频的默认播放速度。</p>

<p>设置该属性仅会改变默认的播放速度，而不是当前的。要改变当前的播放速度，请使用 playbackRate 属性。</p>
</div>
...
<p>只有 Google Chrome 支持 defaultPlaybackRate 属性。</p>
</div>
...
<p>设置 defaultPlaybackRate 属性：</p>
<pre>audio|video.defaultPlaybackRate=<i>playbackspeed</i></pre>

<p>返回 defaultPlaybackRate 属性：</p>
<pre>audio|video.defaultPlaybackRate</pre>
