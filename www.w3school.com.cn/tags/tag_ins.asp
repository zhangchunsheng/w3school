...
<li class="currentLink"><a href="/tags/tag_ins.asp" title="HTML &lt;ins&gt; 标签">&lt;ins&gt;</a></li>
...
<p>带有已删除部分和新插入部分的文本：</p>

<pre>a dozen is &lt;del&gt;20&lt;/del&gt; <code>&lt;ins&gt;12&lt;/ins&gt;</code> pieces</pre>

<p class="tiy"><a target="_blank" href="/tiy/t.asp?f=html_delins">亲自试一试</a></p>
</div>
...
<p>所有主流浏览器都支持 &lt;ins&gt; 标签。</p>

<p class="note"><span>注释：</span>没有主流浏览器能够正确地显示 &lt;ins&gt; 标签的 cite 或 datetime 属性。</p>
</div>
...
<p class="tip"><span>提示：</span>请与 <a href="/tags/tag_del.asp" title="HTML &lt;del&gt; 标签">&lt;del&gt;</a> 一同使用，来描述文档中的更新和修正。</p>
</div>
...
<tr>
<td><a href="/tags/att_ins_cite.asp" title="HTML &lt;ins&gt; 标签的 cite 属性">cite</a></td>
<td>URL</td>
<td>指向另外一个文档的 URL，此文档可解释文本被插入的原因。</td>
</tr>

<tr>
<td><a href="/tags/att_ins_datetime.asp" title="HTML &lt;ins&gt; 标签的 datetime 属性">datetime</a></td>
<td>YYYYMMDD</td>
<td>定义文本被插入的日期和时间。</td>
</tr>
</table>
...
<p>&lt;ins&gt; 标签支持 <a href="/tags/html_ref_standardattributes.asp">HTML 中的全局属性</a>。</p>
</div>
...
<p>&lt;ins&gt; 标签支持 <a href="/tags/html_ref_eventattributes.asp">HTML 中的事件属性</a>。</p>
</div>
