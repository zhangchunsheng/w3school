...
<p>&lt;samp&gt; 标签表示一段用户应该对其没有什么其他解释的文本字符。要从正常的上下文抽取这些字符时，通常要用到这个标签。</p>

<p>请看下面的例子：</p>

<pre>字符序列 &lt;samp&gt;ae&lt;/samp&gt; 可能会被转换为 &amp;aelig; 连字字符。</pre>

<p>上面的 HTML 代码会显示为：</p>

<pre>字符序列 ae 可能会被转换为 &aelig; 连字字符。</pre>

<p class="note"><span>注释：</span>在 HTML 中，用于 &quot;ae&quot; 连字的特殊实体是 &quot;&amp;aelig;&quot;，大多数浏览器都会将它转换成相应的 &quot;&aelig;&quot; 连字字符。</p>
<p>&lt;samp&gt; 标签并不经常使用。只有在要从正常的上下文中将某些短字符序列提取出来，对它们加以强调的极少情况下，才使用这个标签。</p>
</div>
