...
<p><a href="/tiy/t.asp?f=html_image_border">亲自试一试</a></p>
</div>
...
<p class="tip"><span>提示：</span>请使用 <a href="/css/css_border.asp" title="CSS 边框">CSS 的边框属性</a> 来改变元素的边框样式。您可以在一个外部样式表中使用 CSS 边框属性，为站点上的所有图像设置一致的边框。与单独为一个图像设置 border 属性相比，这种方式无疑拥有更高的效率。</p>
</div>
...
<p><a href="/tiy/t.asp?f=html_div_border_css">CSS 实例：图像边框</a></p>
<p>在我们的 CSS 教程中，您可以找到更多有关 <a href="/cssref/pr_border.asp" title="CSS border 属性">border 属性</a> 的细节。</p>
</div>
...
<h2>TIY 实例</h2>
<dl>
<dt><a href="/tiy/t.asp?f=html_image_border">&lt;img&gt; 标签的 border 属性</a></dt>
