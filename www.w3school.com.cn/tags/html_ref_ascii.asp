...
<li class="currentLink"><a href="/tags/html_ref_ascii.asp" title="HTML 7 比特 ASCII 代码 参考手册">HTML ASCII</a></li>
...
<h1>HTML ASCII 参考手册</h1>

<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/tags/html_ref_charactersets.asp" title="HTML 字符集">HTML 字符集</a></li>
<li class="next"><a href="/tags/html_ref_entities.html" title="HTML ISO-8859-1 参考手册">HTML ISO-8859-1</a></li>
</ul>
</div>

<div id="intro">
<p><strong>HTML 和 XHTML 用标准的 7 比特 ASCII 代码在网络上传输数据。</strong></p>
<p><strong>7 比特 ASCII 代码可提供 128 个不同的字符值。</strong></p>
</div>

<div>
<h2>7 比特 可显示的 ASCII 代码</h2>
...
<div>
<h2>7 比特 设备控制 ASCII代码</h2>
<p>ASCII设备控制代码最初被设计为用来控制诸如打印机和磁带驱动器之类的硬件设备。在HTML文档中这些代码不会起任何作用。</p>
<table class="dataintable">
    <tr>
      <th style="width:20%">结果</th>
      <th style="width:50%">描述</th>
