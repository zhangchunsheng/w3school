...
<li class="currentLink"><a href="/tags/tag_details.asp" title="HTML &lt;details&gt; 标签">&lt;details&gt;</a></li>
...
<p class="tiy"><a target="_blank" href="/tiy/t.asp?f=html5_details">亲自试一试</a></p>
</div>
...
<p class="tip"><span>提示：</span>与 <a href="/tags/tag_summary.asp" title="HTML 5 &lt;summary&gt; 标签">&lt;summary&gt; 标签</a> 配合使用可以为 details 定义标题。标题是可见的，用户点击标题时，会显示出 details。
</div>
...
<table class="dataintable">
  ...
  <tr>
    <td class="html5_new"><a href="/tags/att_details_open.asp" title="HTML5 &lt;details&gt; open 属性">open</a></td>
    <td>open</td>
...
<p>&lt;details&gt; 标签支持 <a href="/tags/html_ref_standardattributes.asp">HTML 中的全局属性</a>。</p>
</div>
...
<p>&lt;details&gt; 标签支持 <a href="/tags/html_ref_eventattributes.asp">HTML 中的事件属性</a>。</p>
</div>
