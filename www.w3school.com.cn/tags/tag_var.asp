...
<p>&lt;var&gt; 标签表示变量的名称，或者由用户提供的值。</p>
<p>&lt;var&gt; 标签是计算机文档中应用的另一个小窍门，这个标签经常与 <a href="/tags/tag_code.asp" title="HTML &lt;code&gt; 标签">&lt;code&gt;</a> 和 <a href="/tags/tag_pre.asp" title="HTML &lt;pre&gt; 标签">&lt;pre&gt; 标签</a>一起使用，用来显示计算机编程代码范例及类似方面的特定元素。</p>
