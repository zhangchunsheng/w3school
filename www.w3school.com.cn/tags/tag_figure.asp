...
<li class="currentLink"><a href="/tags/tag_figure.asp" title="HTML &lt;figure&gt; 标签">&lt;figure&gt;</a></li>
...
<p class="tiy"><a target="_blank" href="/tiy/t.asp?f=html5_figure">亲自试一试</a></p>
</div>
...
<p>Internet Explorer 9, Firefox, Opera, Chrome 以及 Safari 支持 &lt;figure&gt; 标签。</p>

<p class="note"><span>注释：</span>Internet Explorer 8 以及更早的版本不支持 &lt;figure&gt; 标签。</p>
</div>
...
<p class="tip"><span>提示：</span>请使用 <a href="/html5/tag_figcaption.asp" title="HTML 5 &lt;figcaption&gt; 标签">&lt;figcaption&gt;</a> 元素为 figure 添加标题（caption）。</p>
</div>
...
<p>&lt;figure&gt; 标签支持 <a href="/tags/html_ref_standardattributes.asp">HTML 中的全局属性</a>。</p>
</div>
...
<p>&lt;figure&gt; 标签支持 <a href="/tags/html_ref_eventattributes.asp">HTML 中的事件属性</a>。</p>
</div>
