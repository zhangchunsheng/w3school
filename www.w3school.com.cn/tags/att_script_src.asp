...
<title>HTML &lt;script&gt; 标签的 src 属性</title>
</head>
...
<p class="note"><span>注释：</span>外部文件不能包含 &lt;script&gt; 标签！</p>
</div>
...
<pre>&lt;script type=&quot;text/javascript&quot; <code>src=&quot;myscripts.js&quot;</code>&gt;&lt;/script&gt;</pre>

<p><a href="/tiy/t.asp?f=html_script_src">TIY</a></p>
</div>
...
<table class="dataintable">
  ...
  <tr>
	...
	<ul class="listintable">
		<li>绝对 URL - 指向其他站点（比如 src=&quot;www.example.com/example.js&quot;）</li>
		<li>相对 URL - 指向站点内的文件（比如 src=&quot;/scripts/example.js&quot;）</li>
	</ul>
	</td>
  </tr>
</table>
