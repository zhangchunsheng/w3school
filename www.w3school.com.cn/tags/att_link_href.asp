...
<title>HTML &lt;link&gt; 标签的 href 属性</title>
</head>
...
<h1>HTML &lt;link&gt; 标签的 href 属性</h1>


<div class="backtoreference">
<p><a href="/tags/tag_link.asp">HTML &lt;link&gt; 标签</a></p>
</div>


<div>
<h2>定义和用法</h2>
<p>href 属性规定被链接文档的位置（URL）。</p>
</div>
...
<p>在下面的例子中，href 属性指向了一个外部样式表的位置：</p>

<pre>
&lt;head&gt;
&lt;link rel=&quot;stylesheet&quot; type=&quot;text/css&quot; <code>href=&quot;theme.css&quot;</code> /&gt;
&lt;/head&gt;
</pre>

<p><a href="/tiy/t.asp?f=html_link">TIY</a></p>
</div>
...
<p class="note"><span>注释：</span>如果需要，应该对所有的 URL 进行 <a href="/tags/html_ref_urlencode.html" title="HTML URL 编码">URL 编码</a>。</p>
</div>
  ...
  <tr>
	...
	<p>超链接的 URL。可能的值：</p>
		<ul class="listintable">
			<li>绝对 URL - 指向另一个站点（比如 href=&quot;http://www.example.com/theme.css&quot;）</li>
			<li>相对 URL - 指向站点内的某个文件（href=&quot;/themes/theme.css&quot;）</li>
		</ul>
	</td>
  </tr>
</table>
