...
<title>HTML &lt;a&gt; download 属性</title>
...
<pre>&lt;a href=&quot;/images/myw3schoolimage.jpg&quot; <code>download=&quot;w3logo&quot;</code>&gt;</pre>

<p class="tiy"><a target="_blank" href="/tiy/t.asp?f=html_a_download">亲自试一试</a></p>
</div>
...
<p>只有 Firefox 和 Chrome 支持 download 属性。</p>
</div>
...
<p>download 属性规定被下载的超链接目标。</p>

<p>在 &lt;a&gt; 标签中必须设置 href 属性。</p>

<p>该属性也可以设置一个值来规定下载文件的名称。所允许的值没有限制，浏览器将自动检测正确的文件扩展名并添加到文件 (.img, .pdf, .txt, .html, 等等)。</p>
</div>
...
<p>在 HTML5 中，download 属性是 &lt;a&gt; 标签的新属性。</p>
</div>
...
<pre>&lt;a download=&quot;<i>filename</i>&quot;&gt;</pre>
