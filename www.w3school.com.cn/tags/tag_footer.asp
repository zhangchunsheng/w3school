...
<li class="currentLink"><a href="/tags/tag_footer.asp" title="HTML &lt;footer&gt; 标签">&lt;footer&gt;</a></li>
...
<p class="tiy"><a target="_blank" href="/tiy/t.asp?f=html_footer">亲自试一试</a></p>
</div>
...
<p>Internet Explorer 9, Firefox, Opera, Chrome, and Safari 支持 &lt;footer&gt; 标签。</p>

<p class="note"><span>注释：</span>Internet Explorer 8 以及更早的版本不支持 &lt;footer&gt; 标签。</p>
</div>
...
<p>&lt;footer&gt; 标签定义文档或节的页脚。</p>

<p>&lt;footer&gt; 元素应当含有其包含元素的信息。</p>
...
<p class="tip"><span>提示：</span>&lt;footer&gt; 元素内的联系信息应该位于 <a href="/tags/tag_address.asp" title="HTML &lt;address&gt; 标签">&lt;address&gt;</a> 标签中。</p>
</div>
...
<p>&lt;footer&gt; 标签支持 <a href="/tags/html_ref_standardattributes.asp">HTML 中的全局属性</a>。</p>
</div>
...
<p>&lt;footer&gt; 标签支持 <a href="/tags/html_ref_eventattributes.asp">HTML 中的事件属性</a>。</p>
</div>
