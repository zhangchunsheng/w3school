...
<title>HTML5 canvas globalAlpha 属性</title>
...
<h1>HTML 5 canvas globalAlpha 属性</h1>
...
<p>首先，绘制一个红色的矩形，然后将透明度 (globalAlpha) 设置为 0.2，然后再绘制一个绿色和一个蓝色的矩形：</p>
...
ctx.fillStyle=&quot;red&quot;;
ctx.fillRect(20,20,75,50);
<span class="code_comment">// 调节透明度</span>
<code>ctx.globalAlpha=0.2;</code>
ctx.fillStyle=&quot;blue&quot;;
ctx.fillRect(50,50,75,50);
ctx.fillStyle=&quot;green&quot;;
ctx.fillRect(80,80,75,50);
...
<p><a target="_blank" href="/tiy/t.asp?f=html5_canvas_globalalpha">亲自试一试</a></p>
</div>
...
<p>Internet Explorer 9、Firefox、Opera、Chrome 以及 Safari 支持 globalAlpha 属性。</p>
