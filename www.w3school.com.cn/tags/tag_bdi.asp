...
<li class="currentLink"><a href="/tags/tag_bdi.asp" title="HTML &lt;bdi&gt; 标签">&lt;bdi&gt;</a></li>
...
<p class="tiy"><a target="_blank" href="/tiy/t.asp?f=html5_bdi">亲自试一试</a></p>
</div>
...
<p>目前只有 Firefox 和 Chrome 支持 &lt;bdi&gt; 标签。</p>
</div>
...
<p>&lt;bdi&gt; 标签允许您设置一段文本，使其脱离其父元素的文本方向设置。</p>

<p>在发布用户评论或其他您无法完全控制的内容时，该标签很有用。</p>
</div>
...
<table class="dataintable">
  ...
  <tr>
    ...
    <td>可选。规定 &lt;bdi&gt; 元素内的文本的文本方向。默认值：auto。</td>
  </tr>
</table>
</div>
...
<p>&lt;bdi&gt; 标签支持 <a href="/tags/html_ref_standardattributes.asp">HTML 中的全局属性</a>。</p>
</div>
...
<p>&lt;bdi&gt; 标签支持 <a href="/tags/html_ref_eventattributes.asp">HTML 中的事件属性</a>。</p>
</div>
