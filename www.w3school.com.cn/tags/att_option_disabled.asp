...
<title>HTML &lt;option&gt; 标签的 disabled 属性</title>
</head>
...
<h1>HTML &lt;option&gt; 标签的 disabled 属性</h1>
...
<div>
<h2>定义和用法</h2>
<p>disabled 属性规定某个选项应该被禁用。被禁用的选项既不可用，也不可点击。</p>
<p>可以设置 disabled 属性，直到满足某些条件（比如选择一个复选框），才恢复用户对该选项的使用。然后，可以使用 JavaScript 来清除 disabled 属性，以使选项变为可用状态。</p>
</div>
...
<p>带有 4 个选项的下拉列表，一个选项已被禁用：</p>

<pre>
&lt;select&gt;
  &lt;option&gt;Volvo&lt;/option&gt;
  &lt;option&gt;Saab&lt;/option&gt;
  &lt;option <code>disabled=&quot;disabled&quot;</code>&gt;Opel&lt;/option&gt;
  &lt;option&gt;Audi&lt;/option&gt;
&lt;/select&gt;
</pre>

<p><a href="/tiy/t.asp?f=html_option_disabled">TIY</a></p>
</div>


<div>
<h2>浏览器支持</h2>
<p>除了 Internet Explorer，所有浏览器都支持 disabled 属性。</p>
<p class="note"><span>注释：</span>Safari 2.0 或更早的版本不支持该属性。IE 8 或更新的版本支持该属性。</p>
</div>
...
<pre>&lt;option disabled=&quot;<i>value</i>&quot;&gt;</pre>
