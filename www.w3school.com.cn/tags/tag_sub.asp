...
<li class="currentLink"><a href="/tags/tag_sub.asp" title="HTML &lt;sub&gt; 标签">&lt;sub&gt;</a></li>
...
<pre>这段文本包含 <code>&lt;sub&gt;下标&lt;/sub&gt;</code></pre>
</div>
...
<p class="tip"><span>提示：</span>无论是 &lt;sub&gt; 标签还是和它对应的 <a href="/tags/tag_sup.asp" title="HTML &lt;sup&gt; 标签">&lt;sup&gt; 标签</a>，在数学等式、科学符号和化学公式中都非常有用。</p>
</div>
...
<p>&lt;sub&gt; 标签支持 <a href="/tags/html_ref_standardattributes.asp">HTML 中的全局属性</a>。</p>
</div>
...
<p>&lt;sub&gt; 标签支持 <a href="/tags/html_ref_eventattributes.asp">HTML 中的事件属性</a>。</p>
</div>
...
<h2>TIY 实例</h2>
<dl>
<dt><a href="/tiy/t.asp?f=html_sup">上标和下标</a></dt>
<dd>本例演示如何使用 sup 和 sub 元素。</dd>
</dl>
</div>
