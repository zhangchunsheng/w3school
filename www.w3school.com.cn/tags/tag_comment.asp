...
<h2>HTML 标签</h2>
<ul>
<li class="currentLink"><a href="/tags/tag_comment.asp" title="HTML &lt;!--&gt; 标签">&lt;!--&gt;</a></li>
...
<p>注释标签用于在源代码中插入注释。注释不会显示在浏览器中。</p>

<p>您可使用注释对您的代码进行解释，这样做有助于您在以后的时间对代码的编辑。当您编写了大量代码时尤其有用。</p>

<p>使用注释标签来隐藏浏览器不支持的脚本也是一个好习惯（这样就不会把脚本显示为纯文本）：</p>
...
<p class="note"><span>注释：</span>注释行结尾处的两条斜杠 (//) 是 JavaScript 注释符号。这可以避免 JavaScript 执行 --&gt; 标签。</p>
</div>
...
<p>如需更多有关 HTML 事件属性的信息，请访问 <a href="/tags/html_ref_eventattributes.asp">事件属性</a>。</p>
</div>
