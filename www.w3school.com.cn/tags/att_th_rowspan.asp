...
<title>HTML &lt;th&gt; 标签的 rowspan 属性</title>
</head>
...
&lt;table border=&quot;1&quot;&gt;
  &lt;tr&gt;
    &lt;th&gt;Company&lt;/th&gt;
    &lt;th&gt;Address&lt;/th&gt;
    &lt;th <code>rowspan=&quot;3&quot;</code>&gt;All the companies in USA&lt;/th&gt;
  &lt;/tr&gt;
  &lt;tr&gt;
    &lt;td&gt;Apple, Inc.&lt;/td&gt;
...
<p><a href="/tiy/t.asp?f=html_th_rowspan">TIY</a></p>
</div>


<div>
<h2>浏览器支持</h2>
<p>所以浏览器都支持 rowspan 属性。</p>
<p>没有浏览器支持 rowspan=&quot;0&quot;，这个值有特殊的意义。（参见属性值表格中的描述）</p>
</div>
...
<table class="dataintable">
  ...
  <tr>
    ...
    <td>
		<p>设置表头单元格可横跨的行数。</p>
		<p class="note"><span>注释：</span>rowspan=&quot;0&quot; 指示浏览器横跨到表格部分的最后一行（thead、tbody 或者 tfoot）。</p>
	</td>
  </tr>
</table>
</div>
