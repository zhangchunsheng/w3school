...
<title>HTML &lt;img&gt; 标签的 src 属性</title>
</head>
...
<p>&lt;img&gt; 标签的 src 属性是必需的。它的值是图像文件的 URL，也就是引用该图像的文件的的绝对路径或相对路径。</p>
<p class="tip"><span>提示：</span>为了整理文档的存储，创作者通常会把图像文件存放在一个单独的文件夹中，而且通常会将这些目录命名为 &quot;pics&quot; 或者 &quot;images&quot; 之类的名称。在 W3School 在线教程中，我们的工程师把大部分常用的图像都存放到一个名为 &quot;i&quot; 的文件夹中，&quot;i&quot;是 &quot;images&quot; 的缩写，这样做的好处是可以最大程度地简化路径。</p>
</div>
...
<p>在下面的例子中，我们在页面中插入一幅 W3School 的工程师在上海鲜花港拍摄的郁金香照片，该照片文件的名称是 &quot;eg_tulip.jpg&quot;，存放在服务器上的 &quot;i&quot; 文件夹中。这是源代码：</p>
<pre>&lt;img <code>src=&quot;/i/eg_tulip.jpg&quot;</code> /&gt;</pre>
<p>以上代码的效果：</p>
<img src="/i/eg_tulip.jpg" />
<p class="tip"><span>提示：</span>您可以在我们的在线测试工具中<a href="/tiy/t.asp?f=html_image_src">亲自试一试</a>，如果您把例子中的文件名更改为&quot;eg_chinarose.jpg&quot;，会看到一幅月季花的照片。就像这样：</p>
<p>源代码：</p>
<pre>&lt;img <code>src=&quot;/i/eg_chinarose.jpg&quot;</code> /&gt;</pre>
<p>以上代码的效果：</p>
  ...
  <tr>
	...
	<p>可能的值：</p>
		<ul class="listintable">
			<li>绝对 URL - 指向其他站点（比如 src=&quot;http://www.example.com/&quot;）</li>
			<li>相对 URL - 指向站点内的文件（比如 src=&quot;/i/image.gif&quot;）</li>
		</ul>
    </td>
  </tr>
</table>
