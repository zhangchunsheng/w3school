...
<li class="currentLink"><a href="/tags/tag_q.asp" title="HTML &lt;q&gt; 标签">&lt;q&gt;</a></li>
...
<pre>
<code>&lt;q&gt;</code>Here is a short quotation here is a short quotation<code>&lt;/q&gt;</code>
</pre>

<p class="tiy"><a target="_blank" href="/tiy/t.asp?f=html_q">亲自试一试</a></p>
</div>
...
<div>
<h2>&lt;q&gt; 与 &lt;blockquote&gt; 的区别</h2>

<p>&lt;q&gt; 标签在本质上与 <a href="/tags/tag_blockquote.asp" title="HTML &lt;blockquote&gt; 标签">&lt;blockquote&gt;</a> 是一样的。不同之处在于它们的显示和应用。&lt;q&gt; 标签用于简短的行内引用。如果需要从周围内容分离出来比较长的部分（通常显示为缩进的块），请使用 &lt;blockquote&gt; 标签。</p>
</div>
...
<p class="tip"><span>提示：</span>根据 HTML 4.01 规范，q 元素应当使用分界引号来呈现，就是说，q 元素包含的文本必须以引号来开始和结束。Mozilla 浏览器 (Firefox) 以及 Opera 符合这个规定，但是 Internet Explorer 却不支持此规定。结果，如果要使用 &lt;q&gt; 标签，而且用自己的引号来满足 Internet Explorer，那么就要在符合标准的浏览器使用两组引号。尽管如此，我们还是推荐使用 &lt;q&gt; 标签，这不仅仅因为我们喜欢标准，还因为我们预见到了将其应用于文档处理、信息提取等方面的显示效果。</p>
</div>
...
<tr>
<td><a href="/tags/att_q_cite.asp" title="HTML &lt;q&gt; cite 属性">cite</a></td>
<td>citation</td>
<td>定义引用的出处或来源（citation）</td>
</tr>
</table>
</div>
...
<p>&lt;abbr&gt; 标签支持 <a href="/tags/html_ref_standardattributes.asp">HTML 中的全局属性</a>。</p>
</div>
...
<p>&lt;abbr&gt; 标签支持 <a href="/tags/html_ref_eventattributes.asp">HTML 中的事件属性</a>。</p>
</div>
...
<dl>
<dt><a href="/tiy/t.asp?f=html_quotations">引用</a></dt>
