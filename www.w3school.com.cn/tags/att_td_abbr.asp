...
<title>HTML &lt;td&gt; 标签的 abbr 属性</title>
</head>
...
<div>
<h2>定义和用法</h2>
<p>abbr 属性规定单元格中内容的缩写版本。</p>
<p>abbr 属性不会在普通的 web 浏览器中造成任何视觉效果方面的变化。</p>
<p>屏幕阅读器可以利用该属性。</p>
</div>
...
&lt;table border=&quot;1&quot;&gt;
  ...
  &lt;/tr&gt;
  &lt;tr&gt;
    &lt;td <code>abbr=&quot;IBM&quot;</code>&gt;International Business Machine&lt;/td&gt;
    &lt;td&gt;USA&lt;/td&gt;
  &lt;/tr&gt;
  &lt;tr&gt;
    &lt;td <code>abbr=&quot;ICBC&quot;</code>&gt;Industrial and Commercial Bank of China&lt;/td&gt;
    &lt;td&gt;PRC&lt;/td&gt;
  &lt;/tr&gt;
&lt;/table&gt;
</pre>

<p><a href="/tiy/t.asp?f=html_td_abbr">TIY</a></p>
</div>


<div>
<h2>浏览器支持</h2>
<p>由于在普通的 web 浏览器中不会造成任何视觉效果方面的变化，因此很难说是否存在对 abbr 属性的支持。</p>
</div>
