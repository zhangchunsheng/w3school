...
<title>HTML &lt;form&gt; 标签的 action 属性</title>
</head>
...
<p>必需的 action 属性规定当提交表单时，向何处发送表单数据。</p>
</div>
...
<p>下面的表单拥有两个输入字段以及一个提交按钮，当提交表单时，表单数据会提交到名为 &quot;form_action.asp&quot; 的页面：</p>

<pre>
&lt;form <code>action=&quot;form_action.asp&quot;</code> method=&quot;get&quot;&gt;
...
<p><a href="/tiy/t.asp?f=html_form_submit">TIY</a></p>
</div>
