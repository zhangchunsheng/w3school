...
<li class="currentLink"><a href="/tags/tag_del.asp" title="HTML &lt;del&gt; 标签">&lt;del&gt;</a></li>
...
<pre>a dozen is <code>&lt;del&gt;20&lt;/del&gt;</code> 12 pieces</pre>
...
<p class="note"><span>注释：</span>请与 &lt;ins&gt; 标签配合使用，来描述文档中的更新和修正。</p>
</div>
...
<tr>
<td><a href="/tags/att_del_cite.asp" title="HTML &lt;del&gt; 标签的 cite 属性">cite</a></td>
<td><i>URL</i></td>
<td>指向另外一个文档的 URL，此文档可解释文本被删除的原因。</td>
</tr>

<tr>
<td><a href="/tags/att_del_datetime.asp" title="HTML &lt;del&gt; 标签的 datetime 属性">datetime</a></td>
<td><i>YYYYMMDD</i></td>
<td>定义文本被删除的日期和时间。</td>
</tr>
</table>
...
<p>&lt;del&gt; 标签支持 <a href="/tags/html_ref_standardattributes.asp">HTML 中的全局属性</a>。</p>
</div>
...
<p>&lt;del&gt; 标签支持 <a href="/tags/html_ref_eventattributes.asp">HTML 中的事件属性</a>。</p>
</div>
...
<dl>
<dt><a href="/tiy/t.asp?f=html_delins">删除和插入文本</a></dt>
<dd>此例演示如何标记文档中删除和插入的文本。</dd>
</dl>
</div>
