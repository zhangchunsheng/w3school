...
<li class="currentLink"><a href="/tags/tag_body.asp" title="HTML &lt;body&gt; 标签">&lt;body&gt;</a></li>
...
<p>在 HTML 4.01 中，所有 body 元素的“呈现属性”均不被赞成使用。</p>

<p>在 XHTML 1.0 Strict DTD 中，所有 body 元素的“呈现属性”均不被支持。</p>
</div>
...
<tr>
<td><a href="/tags/att_body_alink.asp" title="HTML &lt;body&gt; 标签的 alink 属性">alink</a></td>
<td>
	<ul>
	<li><i>rgb(x,x,x)</i></li>
	<li><i>#xxxxxx</i></li>
...
<td>
	...
	<p>规定文档中活动链接（active link）的的颜色。</p>
</td>
</tr>

<tr>
<td><a href="/tags/att_body_background.asp" title="HTML &lt;body&gt; 标签的 background 属性">background</a></td>
<td><i>URL</i></td>
<td>
	<p><span class="deprecated">不赞成使用。</span>请使用样式取代它。</p>
	<p>规定文档的背景图像。</p>
...
<tr>
<td><a href="/tags/att_body_bgcolor.asp" title="HTML &lt;body&gt; 标签的 bgcolor 属性">bgcolor</a></td>
<td>
	<ul>
	<li><i>rgb(x,x,x)</i></li>
	<li><i>#xxxxxx</i></li>
...
<tr>
<td><a href="/tags/att_body_link.asp" title="HTML &lt;body&gt; 标签的 link 属性">link</a></td>
<td>
	<ul>
	<li><i>rgb(x,x,x)</i></li>
	<li><i>#xxxxxx</i></li>
...
<tr>
<td><a href="/tags/att_body_text.asp" title="HTML &lt;body&gt; 标签的 text 属性">text</a></td>
<td>
	<ul>
	<li><i>rgb(x,x,x)</i></li>
	<li><i>#xxxxxx</i></li>
...
<tr>
<td><a href="/tags/att_body_vlink.asp" title="HTML &lt;body&gt; 标签的 vlink 属性">vlink</a></td>
<td>
	<ul>
	<li><i>rgb(x,x,x)</i></li>
	<li><i>#xxxxxx</i></li>
...
<p>&lt;body&gt; 标签支持 <a href="/tags/html_ref_standardattributes.asp">HTML 中的全局属性</a>。</p>
</div>
...
<p>&lt;body&gt; 标签支持 <a href="/tags/html_ref_eventattributes.asp">HTML 中的事件属性</a>。</p>
</div>
...
<dl>
<dt><a href="/tiy/t.asp?f=html_basic" title="一个简单的HTML文件">一个简单的 HTML 文件</a></dt>
<dd>这个例子是一个很简单的 HTML 文件，使用了尽量少的 HTML 标签。它向您演示了 body 元素中的内容是如何被浏览器显示的。</dd>

<dt><a href="/tiy/t.asp?f=html_bgcolor" title="HTML背景颜色">背景颜色</a></dt>
<dd>本例演示如何为 HTML 页面添加背景颜色。</dd>

<dt><a href="/tiy/t.asp?f=html_backgroundimage" title="背景图片">背景图片</a></dt>
<dd>本例演示如何添加背景图片到 HTML 页面。</dd>
</dl>
</div>
