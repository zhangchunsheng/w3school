...
<title>HTML 5 Audio/Video DOM addTextTrack() 方法</title>
...
<h1>HTML 5 Audio/Video DOM addTextTrack() 方法</h1>
...
<pre>
text1=<code>myVid.addTextTrack(&quot;caption&quot;)</code>;
text1.addCue(new TextTrackCue(&quot;Test text&quot;, 01.000, 04.000,&quot;&quot;,&quot;&quot;,&quot;&quot;,true));
</pre>

<p><a href="/tiy/t.asp?f=html5_av_met_addtexttrack">亲自试一试</a></p>
</div>
...
<p>addTextTrack() 方法创建和返回新的文本轨道。</p>

<p>新的 TextTrack 对象会被添加到视频/音频元素的文本轨道列表中。</p>
</div>
...
<p>所有主流浏览器都不支持 addTextTrack() 方法。</p>
</div>


<div>
<h2>语法</h2>
<pre>audio|video.addTextTrack(<i>kind</i>,<i>label</i>,<i>language</i>)</pre>
...
<tr>
<td><i>label</i></td>
<td>字符串值，为文本轨道规定标签。用于为用户对文本轨道进行标识。</td>
</tr>

<tr>
<td><i>language</i></td>
<td>
<p>双字母语言代码，规定文本轨道的语言。</p>
<p>如需查看所有可用的语言代码，请参阅我们的<a href="/tags/html_ref_language_codes.asp" title="HTML 语言代码参考手册">语言代码参考手册</a>。</p>
</td>
</tr>
</table>
