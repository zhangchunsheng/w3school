...
<li class="currentLink"><a href="/tags/tag_button.asp" title="HTML &lt;button&gt; 标签">&lt;button&gt;</a></li>
...
<p class="tiy"><a target="_blank" href="/tiy/t.asp?f=html_button_test">亲自试一试</a></p>
</div>
...
<p>所有主流浏览器都支持 &lt;button&gt; 标签。</p>

<p class="important"><span>重要事项：</span>如果在 HTML 表单中使用 button 元素，不同的浏览器会提交不同的值。Internet Explorer 将提交 &lt;button&gt; 与 &lt;button/&gt; 之间的文本，而其他浏览器将提交 value 属性的内容。请在 HTML 表单中使用 <a href="/tags/tag_input.asp" title="HTML &lt;input&gt; 标签">input 元素</a>来创建按钮。</p>
</div>
...
<p>&lt;button&gt; 控件 与 &lt;input type=&quot;button&quot;&gt; 相比，提供了更为强大的功能和更丰富的内容。&lt;button&gt; 与 &lt;/button&gt; 标签之间的所有内容都是按钮的内容，其中包括任何可接受的正文内容，比如文本或多媒体内容。例如，我们可以在按钮中包括一个图像和相关的文本，用它们在按钮中创建一个吸引人的标记图像。</p>

<p>唯一禁止使用的元素是图像映射，因为它对鼠标和键盘敏感的动作会干扰表单按钮的行为。</p>

<p>请始终为按钮规定 type 属性。Internet Explorer 的默认类型是 &quot;button&quot;，而其他浏览器中（包括 W3C 规范）的默认值是 &quot;submit&quot;。</p>
</div>
...
<tr>
<td><a href="/tags/att_button_disabled.asp" title="HTML &lt;button&gt; 标签的 disabled 属性">disabled</a></td>
<td>disabled</td>
<td>规定禁用此按钮。</td>
</tr>

<tr>
<td><a href="/tags/att_button_name.asp" title="HTML &lt;button&gt; 标签的 name 属性">name</a></td>
<td><i>name</i></td>
<td>规定按钮的名称。</td>
</tr>

<tr>
<td><a href="/tags/att_button_type.asp" title="HTML &lt;button&gt; 标签的 type 属性">type</a></td>
<td>
<ul>
<li>button</li>
<li>reset</li>
...
<tr>
<td><a href="/tags/att_button_value.asp" title="HTML &lt;button&gt; 标签的 value 属性">value</a></td>
<td><i>text</i></td>
<td>规定按钮的初始值。</td>
</tr>
</table>
...
<p>&lt;button&gt; 标签支持 <a href="/tags/html_ref_standardattributes.asp">HTML 中的全局属性</a>。</p>
</div>
...
<p>&lt;button&gt; 标签支持 <a href="/tags/html_ref_eventattributes.asp">HTML 中的事件属性</a>。</p>
</div>
