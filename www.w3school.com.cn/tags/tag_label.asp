...
<li class="currentLink"><a href="/tags/tag_label.asp" title="HTML &lt;label&gt; 标签">&lt;label&gt;</a></li>
...
<p class="tiy"><a target="_blank" href="/tiy/t.asp?f=html_label">亲自试一试</a></p>
</div>
...
<p>Safari 2 或更早的版本不支持 &lt;label&gt; 标签。</p>
</div>
...
<p class="note"><span>注释：</span>&quot;for&quot; 属性可把 label 绑定到另外一个元素。请把 &quot;for&quot; 属性的值设置为相关元素的 id 属性的值。</p>
</div>
...
<tr>
<td><a href="/tags/att_label_for.asp" title="HTML &lt;label&gt; 标签的 for 属性">for</a></td>
<td><i>element_id</i></td>
<td>规定 label 与哪个表单元素绑定。</td>
</tr>
</table>
</div>
...
<p>&lt;label&gt; 标签支持 <a href="/tags/html_ref_standardattributes.asp">HTML 中的全局属性</a>。</p>
</div>
...
<p>&lt;label&gt; 标签支持 <a href="/tags/html_ref_eventattributes.asp">HTML 中的事件属性</a>。</p>
</div>
...
<dl>
<dt><a href="/tiy/t.asp?f=html_label">label</a></dt>
<dd>如何为控件定义标记。</dd>
</dl>
</div>
