...
<li class="currentLink"><a href="/tags/tag_abbr.asp" title="HTML &lt;abbr&gt; 标签">&lt;abbr&gt;</a></li>
...
<pre>The <code>&lt;abbr title=&quot;People's Republic of China&quot;&gt;PRC&lt;/abbr&gt;</code> was founded in 1948.</pre>

<p class="tiy"><a target="_blank" href="/tiy/t.asp?f=html_abbr">亲自试一试</a></p>
</div>
...
<p>所有浏览器都支持 &lt;abbr&gt; 标签。</p>

<p class="note"><span>注释：</span>IE 6 或更早版本的 IE 浏览器不支持 &lt;abbr&gt; 标签。</p>
</div>
...
<p>&lt;abbr&gt; 标签指示简称或缩写，比如 &quot;WWW&quot; 或 &quot;NATO&quot;。</p>

<p>通过对缩写进行标记，您能够为浏览器、拼写检查和搜索引擎提供有用的信息。</p>

<p>&lt;abbr&gt; 标签最初是在 HTML 4.0 中引入的，表示它所包含的文本是一个更长的单词或短语的缩写形式。</p>
</div>
...
<p class="tip"><span>提示：</span>可以在 &lt;abbr&gt; 标签中使用全局的 title 属性，这样就能够在鼠标指针移动到 &lt;abbr&gt; 元素上时显示出简称/缩写的完整版本。</p>
</div>
