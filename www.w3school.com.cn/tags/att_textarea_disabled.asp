...
<title>HTML &lt;textarea&gt; 标签的 disabled 属性</title>
</head>
...
<h1>HTML &lt;textarea&gt; 标签的 disabled 属性</h1>
...
<div>
<h2>定义和用法</h2>
<p>disabled 属性规定禁用文本区。被禁用的文本区既不可用，也不可点击。</p>
<p>可以设置 disabled 属性，直到满足某些条件（比如选择一个复选框），才恢复用户对该文本区的使用。然后，可以使用 JavaScript 来清除 disabled 属性，以使文本区变为可用状态。</p>
</div>
...
<pre>
&lt;textarea rows=&quot;3&quot; cols=&quot;20&quot; <code>disabled=&quot;disabled&quot;</code>&gt;
在w3school，你可以找到你所需要的所有的网站建设教程。
&lt;/textarea&gt;
</pre>

<p><a href="/tiy/s.asp?f=demo_html_textarea_disabled">TIY</a></p>
</div>
...
<pre>&lt;textarea disabled=&quot;<i>value</i>&quot;&gt;</pre>
