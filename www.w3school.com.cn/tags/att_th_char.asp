...
<title>HTML &lt;th&gt; 标签的 char 属性</title>
</head>
...
<div>
<h2>定义和用法</h2>
<p>char 属性规定将表头单元格中的内容相对某个字符的对齐方式。</p>
...
<p>在下面的例子中，第一个表头单元的的内容与 &quot;C&quot; 字符对齐：</p>

<pre>
&lt;table border=&quot;1&quot;&gt;
  &lt;tr&gt;
    &lt;th <span class="marked">align=&quot;char&quot;</span> <code>char=&quot;C&quot;</code>&gt;Company&lt;/th&gt;
    &lt;th&gt;Address&lt;/th&gt;
  &lt;/tr&gt;
  &lt;tr&gt;
    &lt;td&gt;Apple, Inc.&lt;/td&gt;
...
<p><a href="/tiy/t.asp?f=html_th_char">TIY</a></p>
</div>
