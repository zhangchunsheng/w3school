...
<title>HTML &lt;th&gt; 标签的 height 属性</title>
</head>
...
<h1>HTML &lt;th&gt; 标签的 height 属性</h1>


<div class="backtoreference">
<p><a href="/tags/tag_th.asp">HTML &lt;th&gt; 标签</a></p>
</div>


<div>
<h2>定义和用法</h2>
<p>height 属性规定表格的表头单元格的高度。</p>
<p>通常，单元格占用的空间就是它显示内容需要的空间。height 属性用于为单元格设置预定义的高度。</p>
</div>
...
&lt;table border=&quot;1&quot;&gt;
  &lt;tr&gt;
    &lt;th <code>height=&quot;100px&quot;</code>&gt;Company in USA&lt;/th&gt;
    &lt;th <code>height=&quot;100px&quot;</code>&gt;Address&lt;/th&gt;
  &lt;/tr&gt;
  &lt;tr&gt;
    &lt;td&gt;Apple, Inc.&lt;/td&gt;
...
<p><a href="/tiy/t.asp?f=html_th_height">TIY</a></p>
</div>


<div>
<h2>浏览器支持</h2>
<p>尽管不赞成使用 height 属性，但是所有浏览器都支持它。</p>
</div>


<div>
<h2>兼容性注释</h2>
<p>在 HTML 4.01 中，不推荐使用 th 元素的 height 属性；在 XHTML 1.0 Strict DTD 中，不支持 th 元素的 height 属性。</p>
<p>请使用 CSS 代替。</p>
<p>CSS 语法：&lt;th style=&quot;height:100px&quot;&gt;</p>
<p><a href="/tiy/t.asp?f=html_th_height_css">CSS 实例：设置表格单元的高度</a></p>
<p>在我们的 CSS 教程中，您可以找到更多有关 <a href="/cssref/pr_dim_height.asp" title="CSS height 属性">height 属性</a> 的细节。</p>
</div>
...
<table class="dataintable">
  ...
  <tr>
    <td><i>pixels</i></td>
    <td>以像素计的高度值（比如 &quot;100px&quot;）。</td>
  </tr>
  <tr>
    <td><i>percent</i></td>
    <td>以包含元素百分比计的高度值（比如 &quot;20%&quot;）。</td>
  </tr>
</table>
</div>
