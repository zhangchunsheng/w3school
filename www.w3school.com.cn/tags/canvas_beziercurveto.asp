...
<p class="tip"><span>提示：</span>三次贝塞尔曲线需要三个点。前两个点是用于三次贝塞尔计算中的控制点，第三个点是曲线的结束点。曲线的开始点是当前路径中最后一个点。如果路径不存在，那么请使用 <a href="/tags/canvas_beginpath.asp" title="HTML5 canvas beginPath() 方法">beginPath()</a> 和 <a href="/tags/canvas_moveto.asp" title="HTML5 canvas moveTo() 方法">moveTo()</a> 方法来定义开始点。</p>
...
<a href="/tags/canvas_quadraticcurveto.asp" title="HTML5 canvas quadraticCurveTo() 方法">quadraticCurveTo() 方法</a>。它有一个控制点，而不是两个。</p>
