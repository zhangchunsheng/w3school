...
<title>HTML &lt;basefont&gt; 标签的 face 属性</title>
</head>
...
<h1>HTML &lt;basefont&gt; 标签的 face 属性</h1>
...
<pre>
&lt;head&gt;
&lt;basefont <code>face=&quot;courier, serif&quot;</code> /&gt;
&lt;/head&gt;
...
<p><a href="/tiy/t.asp?f=html_basefont_face">TIY</a></p>
</div>


<div>
<h2>浏览器支持</h2>
<p>除了 Internet Explorer，其他浏览器都不支持 face 属性。</p>
</div>
...
<p>请使用 CSS 代替。</p>
<p>CSS 语法（在 &lt;head&gt; 部分）：&lt;style&gt;body{font-family: courier, serif}&lt;/style&gt;</p>
<p><a href="/tiy/t.asp?f=html_basefont_face_css">CSS 实例：为页面规定默认文本字体</a></p>
...
<pre>&lt;basefont face=&quot;<i>value</i>&quot;&gt;</pre>
