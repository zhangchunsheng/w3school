...
<li class="currentLink"><a href="/tags/tag_dl.asp" title="HTML &lt;dl&gt; 标签">&lt;dl&gt;</a></li>
...
<p class="tiy"><a target="_blank" href="/tiy/t.asp?f=html_list_definition">亲自试一试</a></p>
</div>
...
<p>&lt;dl&gt; 标签定义了定义列表（definition list）。</p>

<p>&lt;dl&gt; 标签用于结合 <a href="/tags/tag_dt.asp" title="HTML &lt;dt&gt; 标签">&lt;dt&gt;</a> （定义列表中的项目）和 <a href="/tags/tag_dd.asp" title="HTML &lt;dd&gt; 标签">&lt;dd&gt;</a> （描述列表中的项目）。</p>
</div>
...
<p>&lt;dl&gt; 标签支持 <a href="/tags/html_ref_standardattributes.asp">HTML 中的全局属性</a>。</p>
</div>
...
<p>&lt;dl&gt; 标签支持 <a href="/tags/html_ref_eventattributes.asp">HTML 中的事件属性</a>。</p>
</div>
