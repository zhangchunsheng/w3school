...
<title>HTML &lt;body&gt; 标签的 alink 属性</title>
</head>
...
<h1>HTML &lt;body&gt; 标签的 alink 属性</h1>


<div class="backtoreference">
<p><a href="/tags/tag_body.asp">HTML &lt;body&gt; 标签</a></p>
</div>
...
<p>alink 属性规定文档中活动链接（active link）的的颜色。</p>
<p class="note"><span>注释：</span>当链接被点击时，该链接就处于活动状态。</p>
</div>
...
<p>文档中活动链接的颜色被设置为绿色：</p>

<pre>
&lt;html&gt;
&lt;body <code>alink=&quot;green&quot;</code>&gt;
...
<p><a href="/tiy/t.asp?f=html_body_alink">TIY</a></p>
</div>


<div>
<h2>兼容性注释</h2>
<p>在 HTML 4.01 中，不赞成使用 body 元素的 alink 属性；在 XHTML 1.0 Strict DTD 中，不支持 body 元素的 alink 属性。</p>
<p>请使用 CSS 代替。</p>
<p>CSS 语法（在 &lt;head&gt; 部分）：&lt;style&gt;a:active {color: #0000FF}&lt;/style&gt;</p>
<p><a href="/tiy/t.asp?f=html_body_alink_css">CSS 实例：设置活动链接的颜色</a></p>
<p>在我们的 CSS 教程中，您可以找到更多有关 <a href="/cssref/pr_pseudo_active.asp" title="CSS :active 伪类">:active 伪类</a>的细节。</p>
</div>
...
<table class="dataintable">
  ...
  <tr>
    ...
    <td>规定颜色值为颜色名称的字体颜色（比如 &quot;red&quot;）。</td>
  </tr>
	<tr>
    <td><i>hex_number</i></td>
    <td>规定颜色值为十六进制值的字体颜色（比如 &quot;#ff0000&quot;）。</td>
  </tr>
	<tr>
    <td><i>rgb_number</i></td>
    <td>规定颜色值为 rgb 代码的字体颜色（比如 &quot;rgb(255,0,0)&quot;）。</td>
  </tr>
</table>
</div>
