...
<li class="currentLink"><a href="/tags/tag_ul.asp" title="HTML &lt;ul&gt; 标签">&lt;ul&gt;</a></li>
...
<p class="tiy"><a target="_blank" href="/tiy/t.asp?f=html_list_unordered">亲自试一试</a></p>
...
<p>在 HTML 4.01 中，ul 元素的 &quot;compact&quot; 和 &quot;type&quot; 属性是不被赞成使用的。</p>

<p>在 XHTML 1.0 Strict DTD 中，ul 元素的 &quot;compact&quot; 和 &quot;type&quot; 属性是不被支持的。</p>
</div>
...
<p class="tip"><span>提示：</span>请使用<em>样式</em>来定义列表的类型。</p>
</div>
...
<tr>
<td><a href="/tags/att_ul_compact.asp" title="HTML &lt;ul&gt; 标签的 compact 属性">compact</a></td>
<td>compact</td>
<td>
	<p><span class="deprecated">不赞成使用。</span>请使用样式取代它。</p>
	<p>规定列表呈现的效果比正常情况更小巧。</p>
</td>
</tr>

<tr>
<td><a href="/tags/att_ul_type.asp" title="HTML &lt;ul&gt; 标签的 type 属性">type</a></td>
<td>
	<ul>
	<li>disc</li>
	<li>square</li>
...
<p>&lt;ul&gt; 标签支持 <a href="/tags/html_ref_standardattributes.asp">HTML 中的全局属性</a>。</p>
</div>
...
<p>&lt;ul&gt; 标签支持 <a href="/tags/html_ref_eventattributes.asp">HTML 中的事件属性</a>。</p>
</div>
...
<h2>HTML 列表实例</h2>
<dl>
<dt><a href="/tiy/t.asp?f=html_list_unordered">一个无序列表</a></dt>
<dd>本例演示一个无序列表。</dd>
