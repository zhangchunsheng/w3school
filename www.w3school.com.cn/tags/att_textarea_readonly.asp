...
<title>HTML &lt;textarea&gt; 标签的 readonly 属性</title>
</head>
...
<h1>HTML &lt;textarea&gt; 标签的 readonly 属性</h1>


<div class="backtoreference">
<p><a href="/tags/tag_textarea.asp">HTML &lt;textarea&gt; 标签</a></p>
</div>
...
<p>readonly 属性规定文本区为只读。</p>

<p>在只读的文本区中，无法对内容进行修改，但用户可以通过 tab 键切换到该控件，选取或复制其中的内容。</p>

<p>可以设置 readonly 属性，直到满足某些条件（比如选择一个复选框），才恢复用户对该文本区的使用。然后，可以使用 JavaScript 来清除 readonly 属性，以使文本区变为可编辑状态。</p>
</div>
...
<p>一个带有 name 属性的文本区：</p>

<pre>
&lt;textarea rows=&quot;3&quot; cols=&quot;20&quot; <code>readonly=&quot;readonly&quot;</code>&gt;
在w3school，你可以找到你所需要的所有的网站建设教程。
&lt;/textarea&gt;
</pre>

<p><a href="/tiy/s.asp?f=demo_html_textarea_readonly">TIY</a></p>
</div>
...
<pre>&lt;textarea readonly=&quot;<i>value</i>&quot;&gt;</pre>
