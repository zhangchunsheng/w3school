...
<title>HTML &lt;form&gt; 标签的 accept 属性</title>
</head>
...
<p>accept 属性规定能够通过文件上传进行提交的文件类型。</p>
...
<p>在表单中使用 accept 属性（允许上传两种类型的文件：gif 和 jpeg）：</p>

<pre>
&lt;form action=&quot;form_action.asp&quot; <code>accept=&quot;image/gif, image/jpeg&quot;</code>&gt;
...
<p><a href="/tiy/t.asp?f=html_form_accept">TIY</a></p>
</div>
...
<p class="note"><span>注释：</span>几乎没有浏览器正确地支持 accept 属性。</p>
</div>
...
<table class="dataintable">
  ...
  <tr>
    <td><i>MIME_type</i></td>
    <td>
		<p>允许被提交的一个或多个 MIME 类型。</p>
		<p>如需规定多个 MIME 类型，请使用逗号分隔它们。</p>
	</td>
  </tr>
</table>
</div>
