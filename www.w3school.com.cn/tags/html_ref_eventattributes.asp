...
<li class="currentLink"><a href="/tags/html_ref_eventattributes.asp" title="HTML 事件属性">HTML 事件</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/tags/html_ref_standardattributes.asp" title="HTML 标准属性">HTML 属性</a></li>
<li class="next"><a href="/tags/html5_ref_audio_video_dom.asp" title="HTML Audio/Video DOM 属性">HTML 视频/音频</a></li>
</ul>
</div>
...
<p>在现代浏览器中都内置有大量的事件处理器。这些处理器会监视特定的条件或用户行为，例如鼠标单击或浏览器窗口中完成加载某个图像。通过使用客户端的 JavaScript，可以将某些特定的事件处理器作为属性添加给特定的标签，并可以在事件发生时执行一个或多个 JavaScript 命令或函数。</p>

<p>事件处理器的值是一个或一系列以分号隔开的 Javascript 表达式、方法和函数调用，并用引号引起来。当事件发生时，浏览器会执行这些代码。例如，当您把鼠标移动到一个超链接时，会启动一个 JavaScript 函数。支持 JavaScript 的浏览器支持 &lt;a&gt; 标签中的一个特殊的 &quot;mouse over&quot;事件处理器 - 被称为 onmouseover 来完成这项工作：</p>

<pre>&lt;a href=&quot;/index.html&quot; <code>onmouseover=&quot;alert('Welcome');return false&quot;</code>&gt;&lt;/a&gt;</pre>

<p>如需学习更多有关事件编程方面的知识，请访问 W3School 提供的 <a href="/js/index.asp" title="JavaScript 教程">JavaScript 教程</a> 和 <a href="/dhtml/index.asp" title="DHTML 教程">DHTML 教程</a>。</p>
