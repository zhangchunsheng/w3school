...
<title>HTML 5 Audio/Video DOM error 属性</title>
...
<h1>HTML 5 Audio/Video DOM error 属性</h1>
...
alert(<code>myVid.error.code</code>);
</pre>

<p><a href="/tiy/t.asp?f=html5_av_prop_error">亲自试一试</a></p>
</div>
...
<p>error 属性返回一个 MediaError 对象。</p>

<p>MediaError 对象的 code 属性包含了音频/视频的错误状态。</p>
</div>
...
<p>只有 Internet Explorer 9 支持 error 属性。</p>
</div>
...
<pre>audio|video.error.code</pre>
...
<td>数字值</td>
<td>
	<p>MediaError 对象的 code 属性返回一个数字值，它表示音频/视频的错误状态：</p>
