...
<title>HTML &lt;th&gt; 标签的 colspan 属性</title>
</head>
...
&lt;table border=&quot;1&quot;&gt;
  &lt;tr&gt;
    &lt;th <code>colspan=&quot;2&quot;</code>&gt;Company in USA&lt;/th&gt;
  &lt;/tr&gt;
  &lt;tr&gt;
    &lt;td&gt;Apple, Inc.&lt;/td&gt;
...
<p><a href="/tiy/t.asp?f=html_th_colspan">TIY</a></p>
</div>


<div>
<h2>浏览器支持</h2>
<p>所以浏览器都支持 colspan 属性。</p>
<p>没有浏览器支持 colspan=&quot;0&quot;，这个值有特殊的意义。（参见属性值表格中的描述）</p>
</div>
...
<table class="dataintable">
  ...
  <tr>
    ...
    <td>
		<p>设置单元格可横跨的列数。</p>
		<p class="note"><span>注释：</span>colspan=&quot;0&quot; 指示浏览器横跨到列组的最后一列。</p>
	</td>
  </tr>
</table>
</div>
