...
<title>HTML &lt;img&gt; 标签的 ismap 属性</title>
</head>
...
<p>ismap 属性将图像定义为服务器端图像映射。</p>

<p>图像映射指的是带有可点击区域的图像。</p>

<p>当点击一个服务器端图像映射时，点击坐标会以 URL 查询字符串的形式发送到服务器。</p>

<p class="note"><span>注释：</span>只有当 &lt;img&gt; 元素属于带有有效 href 属性的 &lt;a&gt; 元素的后代时，才允许 ismap 属性。</p>
</div>
...
<p>在 XHTML 中，禁止属性简写，并且必须把 ismap 属性定义为 &lt;img ismap=&quot;ismap&quot; /&gt;。</p>
</div>
...
&lt;img src=&quot;tulip.gif&quot; <code>ismap</code> /&gt;
&lt;/a&gt;
</pre>

<p><a href="/tiy/t.asp?f=html_img_ismap">亲自试一试</a></p>

<h3>解释</h3>

<p>当用户在 ismap 图像上单击了某处时，浏览器会自动把鼠标的 x、y 位置（相对于图像的左上角）发送到服务器端。特殊的服务器端软件（在本例中是 demo_form.asp 程序）可以根据这些坐标来做出响应。</p>
</div>


<div>
<h2>浏览器支持</h2>
<p>所有浏览器都支持 ismap 属性。</p>
</div>
