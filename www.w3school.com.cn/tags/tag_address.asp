...
<li class="currentLink"><a href="/tags/tag_address.asp" title="HTML &lt;address&gt; 标签">&lt;address&gt;</a></li>
...
<p class="tiy"><a target="_blank" href="/tiy/t.asp?f=html_address">亲自试一试</a></p>
</div>
...
<p>&lt;address&gt; 标签定义文档或文章的作者/拥有者的联系信息。</p>

<p>如果 &lt;address&gt; 元素位于 &lt;body&gt; 元素内，则它表示文档联系信息。</p>

<p>如果 &lt;address&gt; 元素位于 &lt;article&gt; 元素内，则它表示文章的联系信息。</p>

<p>&lt;address&gt; 元素中的文本通常呈现为斜体。大多数浏览器会在 address 元素前后添加折行。</p>
</div>
...
<p class="tip"><span>提示：</span>&lt;address&gt; 标签不应该用于描述通讯地址，除非它是联系信息的一部分。</p>

<p class="tip"><span>提示：</span>&lt;address&gt; 元素通常连同其他信息被包含在 &lt;footer&gt; 元素中。</p>
</div>
...
<p>HTML 4.01 不支持 &lt;article&gt; 标签，因此在 HTML 4.01 中，&lt;address&gt; 标签始终定义文档作者/拥有者的联系信息。</p>
</div>
...
<p>&lt;address&gt; 标签支持 <a href="/tags/html_ref_standardattributes.asp">HTML 中的全局属性</a>。</p>
</div>
...
<p>&lt;address&gt; 标签支持 <a href="/tags/html_ref_eventattributes.asp">HTML 中的事件属性</a>。</p>
</div>
