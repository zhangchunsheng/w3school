...
<title>HTML5 canvas arcTo() 方法</title>
...
ctx.beginPath();
ctx.beginPath();
ctx.moveTo(20,20);           <span class="code_comment">// 创建开始点</span>
ctx.lineTo(100,20);          <span class="code_comment">// 创建水平线</span>
ctx.arcTo(150,20,150,70,50); <span class="code_comment">// 创建弧</span>
ctx.lineTo(150,120);         <span class="code_comment">// 创建垂直线</span>
ctx.stroke();                <span class="code_comment">// 进行绘制</span>
</pre>

<p><a target="_blank" href="/tiy/t.asp?f=html5_canvas_arcto">亲自试一试</a></p>
</div>
...
<p>Internet Explorer 9、Firefox、Opera、Chrome 以及 Safari 支持 arcTo() 方法。</p>
...
<p>arcTo() 方法在画布上创建介于两个切线之间的弧/曲线。</p>

<p class="tip"><span>提示：</span>请使用 stroke() 方法在画布上绘制确切的弧。</p>

<h3>JavaScript 语法：</h3>

<pre>context.fillRect(<i>x1</i>,<i>y1</i>,<i>x2</i>,<i>y2</i>,<i>r</i>);</pre>
