...
<title>HTML &lt;form&gt; 标签的 accept-charset 属性</title>
</head>
...
<h1>HTML &lt;form&gt; 标签的 accept-charset 属性</h1>


<div class="backtoreference">
<p><a href="/tags/tag_form.asp">HTML &lt;form&gt; 标签</a></p>
</div>
...
<p>accept-charset 属性允许您指定一系列字符集，服务器必须支持这些字符集，从而得以正确解释表单中的数据。</p>
<p>该属性的值是用引号包含字符集名称列表。如果可接受字符集与用户所使用的字符即不相匹配的话，浏览器可以选择忽略表单或是将该表单区别对待。</p>
<p>此属性的默认值是 &quot;unknown&quot;，表示表单的字符集与包含表单的文档的字符集相同。</p>
<p class="tip"><span>提示：</span>请避免使用该属性。应该在服务器端验证文件上传。</p>
</div>
...
<p>在表单中使用 accept-charset 属性：</p>

<pre>
&lt;form action=&quot;form_action.asp&quot; <code>accept-charset=&quot;ISO-8859-1&quot;</code>&gt;
...
<p><a href="/tiy/t.asp?f=html_form_accept_charset">TIY</a></p>
</div>
...
<p>除了 Internet Explorer，accept-charset 属性得到几乎所有浏览器的支持。</p>

<p class="note"><span>注释：</span>accept-charset 属性无法在 Internet Explorer 中正确地工作。如果 accept-charset 属性设置为 &quot;ISO-8859-1&quot;，IE 将发送以 &quot;Windows-1252&quot; 编码的数据。</p>
</div>
...
<pre>&lt;form accept-charset=&quot;<i>value</i>&quot;&gt;</pre>
...
<table class="dataintable">
  ...
  <tr>
    ...
    <td>
		<p>服务器能够处理的一个或多个字符集。如需规定多个字符集，请使用逗号分隔它们。</p>
		<p>常用的字符集有：</p>
		<ul class="listintable">
			<li>UTF-8 - Unicode 字符编码</li>
			<li>ISO-8859-1 - 拉丁字母表的字符编码</li>
		</ul>
		<p>在理论上，可以使用任何字符集，但并不是所有浏览器都能够理解它们。某种字符集使用的范围越广，浏览器就越有可能理解它。</p>
