...
<li class="currentLink"><a href="/tags/tag_noframes.asp" title="HTML &lt;noframes&gt; 标签">&lt;noframes&gt;</a></li>
...
<p class="tiy"><a target="_blank" href="/tiy/t.asp?f=html_noframes">亲自试一试</a></p>
</div>
...
<p>noframes 元素可为那些不支持框架的浏览器显示文本。noframes 元素位于 frameset 元素内部。</p>
</div>
...
<p class="note"><span>注释：</span>如果浏览器有能力处理框架，就不会显示出 frameset 元素中的文本。</p>

<p class="important"><span>重要事项：</span>如果您希望 frameset 添加 &lt;noframes&gt; 标签，就必须把其中的文本包装在 &lt;body&gt;&lt;/body&gt; 标签中！</p>

<p class="note"><span>注释：</span>如果您希望验证包含框架的页面，请确保 DTD 被设置为 &quot;Frameset DTD&quot;。</p>

<p><a href="/xhtml/xhtml_validate.asp">阅读更多有关 XHTML 验证的内容</a>。</p>

<p class="note"><span>注释：</span>在<a href="/tags/tag_doctype.asp">XHTML 1.0 Strict DTD</a> 中，&lt;noframes&gt; 标签是不被允许的。</p>
</div>
