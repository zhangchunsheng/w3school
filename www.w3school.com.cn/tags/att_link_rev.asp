...
<title>HTML &lt;link&gt; 标签的 rev 属性</title>
</head>
...
<div>
<h2>定义和用法</h2>
<p>rev 属性规定被链接文档与当前文档之间的关系。</p>
<p>rev 属性与 <a href="/tags/att_link_rel.asp" title="HTML &lt;link&gt; 标签的 rel 属性">rel 属性</a>是相反的。</p>
</div>
...
<p>在下面的例子中，rev 属性指示当前文档是  &quot;wildcats.htm&quot; 的父页面：</p>

<pre>
&lt;head&gt;
&lt;link <code>rev=&quot;parent&quot;</code> href=&quot;intro.html&quot; /&gt;
&lt;/head&gt;
</pre>
</div>
