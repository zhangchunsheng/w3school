...
<li class="currentLink"><a href="/tags/tag_datalist.asp" title="HTML &lt;datalist&gt; 标签">&lt;datalist&gt;</a></li>
...
<p class="tiy"><a target="_blank" href="/tiy/t.asp?f=html5_datalist">亲自试一试</a></p>
</div>
...
<p>&lt;datalist&gt; 标签定义选项列表。请与 input 元素配合使用该元素，来定义 input 可能的值。</p>
...
<p>所有主流浏览器都支持 &lt;datalist&gt; 标签，除了 Internet Explorer 和 Safari。</p>
</div>
...
<p>&lt;datalist&gt; 标签支持 <a href="/tags/html_ref_standardattributes.asp">HTML 中的全局属性</a>。</p>
</div>
...
<p>&lt;datalist&gt; 标签支持 <a href="/tags/html_ref_eventattributes.asp">HTML 中的事件属性</a>。</p>
</div>
