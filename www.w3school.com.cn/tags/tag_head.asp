...
<li class="currentLink"><a href="/tags/tag_head.asp" title="HTML &lt;head&gt; 标签">&lt;head&gt;</a></li>
...
<p class="tiy"><a target="_blank" href="/tiy/t.asp?f=html_basic">亲自试一试</a></p>
</div>
...
<p>&lt;head&gt; 标签用于定义文档的头部，它是所有头部元素的容器。&lt;head&gt; 中的元素可以引用脚本、指示浏览器在哪里找到样式表、提供元信息等等。</p>

<p>文档的头部描述了文档的各种属性和信息，包括文档的标题、在 Web 中的位置以及和其他文档的关系等。绝大多数文档头部包含的数据都不会真正作为内容显示给读者。</p>

<p>下面这些标签可用在 head 部分：<a href="/tags/tag_base.asp" title="HTML &lt;base&gt; 标签">&lt;base&gt;</a>, <a href="/tags/tag_link.asp" title="HTML &lt;link&gt; 标签">&lt;link&gt;</a>, <a href="/tags/tag_meta.asp" title="HTML &lt;meta&gt; 标签">&lt;meta&gt;</a>, <a href="/tags/tag_script.asp" title="HTML &lt;script&gt; 标签">&lt;script&gt;</a>, <a href="/tags/tag_style.asp" title="HTML &lt;style&gt; 标签">&lt;style&gt;</a>, 以及 <a href="/tags/tag_title.asp" title="HTML &lt;title&gt; 标签">&lt;title&gt;</a>。</p>

<p>&lt;title&gt; 定义文档的标题，它是 head 部分中唯一必需的元素。</p>
</div>
...
<p class="tip"><span>提示：</span>应该把 &lt;head&gt; 标签放在文档的开始处，紧跟在 &lt;html&gt; 后面，并处于 &lt;body&gt; 标签或 &lt;frameset&gt; 标签之前。</p>

<p class="tip"><span>提示：</span>请记住始终为文档规定标题！</p>
</div>
...
<td>profile</td>
<td><i>URL</i></td>
<td>一个由空格分隔的 URL 列表，这些 URL 包含着有关页面的元数据信息。</td>
</tr>
</table>

<h3 id="attribute_profile">profile 属性的更多信息</h3>

<p>文档的头部经常会包含一些 &lt;meta&gt; 标签，用来告诉浏览器关于文档的附加信息。在将来，创作者可能会利用预先定义好的标准文档的元数据配置文件（metadata profile），以便更好地描述它们的文档。profile 属性提供了与当前文档相关联的配置文件的 URL。</p>

<p>配置文件的格式以及浏览器使用它们的方式都还没有进行定义，这个属性主要是为将来的开发而保留的占位符。</p>
</div>
...
<p>&lt;head&gt; 标签支持 <a href="/tags/html_ref_standardattributes.asp">HTML 中的全局属性</a>。</p>
</div>
