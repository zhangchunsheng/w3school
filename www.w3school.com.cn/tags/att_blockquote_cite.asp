...
<title>HTML &lt;blockquote&gt; cite 属性</title>
</head>
...
<h1>HTML &lt;blockquote&gt; cite 属性</h1>


<div class="backtoreference">
<p><a href="/tags/tag_blockquote.asp">HTML &lt;blockquote&gt; 标签</a></p>
</div>
...
<p>该属性的值是一个包含在引号中并指向联机文档的 URL，以及（如果有可能的话）引用在该文档中的确切位置。</p>
</div>
...
<p>下面这个 blockquote 元素中的 cite 属性指定了引用的来源：</p>

<pre>
&lt;blockquote <code>cite=&quot;http://www.wwf.org&quot;</code>&gt;
WWF's ultimate goal is to build a future where people live in harmony with nature.
&lt;/blockquote&gt;
</pre>

<p><a href="/tiy/t.asp?f=html_blockquote_cite">亲自试一试</a></p>
</div>
...
<p>主流浏览器均不支持 cite 属性。不过，搜索引擎可能会使用该属性获得更多有关引用的信息。</p>
</div>
...
<pre>&lt;blockquote cite=&quot;<i>URL</i>&quot;&gt;</pre>
...
<td>
	...
	<li>绝对 URL - 指向另一个站点（比如 href=&quot;http://www.example.com/song.ogg&quot;）</li>
	<li>相对 URL - 指向网站内的文件（比如 href=&quot;song.ogg&quot;）</li>
	</ul>
</td>
</tr>
</table>
