...
<li class="currentLink"><a href="/tags/tag_mark.asp" title="HTML &lt;mark&gt; 标签">&lt;mark&gt;</a></li>
...
<pre>&lt;p&gt;Do not forget to buy <code>&lt;mark&gt;milk&lt;/mark&gt;</code> today.&lt;/p&gt;</pre>

<p class="tiy"><a target="_blank" href="/tiy/t.asp?f=html5_mark">亲自试一试</a></p>
</div>
...
<p>Internet Explorer 9+, Firefox, Opera, Chrome 以及 Safari 支持 &lt;mark&gt; 标签。</p>

<p class="note"><span>注释：</span>Internet Explorer 8 以及更早的版本不支持 &lt;mark&gt; 标签。</p>
</div>
...
<p>&lt;mark&gt; 标签定义带有记号的文本。请在需要突出显示文本时使用 &lt;m&gt; 标签。</p>
</div>
...
<p>&lt;mark&gt; 标签支持 <a href="/tags/html_ref_standardattributes.asp">HTML 中的全局属性</a>。</p>
</div>
...
<p>&lt;mark&gt; 标签支持 <a href="/tags/html_ref_eventattributes.asp">HTML 中的事件属性</a>。</p>
</div>
