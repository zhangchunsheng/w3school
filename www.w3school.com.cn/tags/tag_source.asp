...
<li class="currentLink"><a href="/tags/tag_source.asp" title="HTML &lt;source&gt; 标签">&lt;source&gt;</a></li>
...
<p>Internet Explorer 9+, Firefox, Opera, Chrome 以及 Safari 支持 &lt;source&gt; 标签。</p>

<p class="note"><span>注释：</span>Internet Explorer 8 以及更早的版本不支持 &lt;source&gt; 标签。</p>
</div>
...
<p>&lt;source&gt; 标签为媒介元素（比如 &lt;video&gt; 和 &lt;audio&gt;）定义媒介资源。</p>
</div>
...
<table class="dataintable"> 
  ...
  <tr>
    ...
    <td><i>numeric value</i></td>
    <td>定义播放器在音频流中的什么位置开始播放。默认，音频从开头播放。</td>
  </tr>
</table>
</div>
...
<p>&lt;source&gt; 标签支持 <a href="/tags/html_ref_standardattributes.asp">HTML 中的全局属性</a>。</p>
</div>
...
<p>&lt;source&gt; 标签支持 <a href="/tags/html_ref_eventattributes.asp">HTML 中的事件属性</a>。</p>
</div>
