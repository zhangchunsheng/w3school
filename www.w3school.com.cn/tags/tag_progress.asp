...
<li class="currentLink"><a href="/tags/tag_progress.asp" title="HTML &lt;progress&gt; 标签">&lt;progress&gt;</a></li>
...
<p class="tiy"><a target="_blank" href="/tiy/t.asp?f=html5_progress">亲自试一试</a></p>
</div>
...
<p>Internet Explorer 10, Firefox, Opera, Chrome 以及 Safari 6 支持 &lt;progress&gt; 标签。</p>

<p class="note"><span>注释：</span>Internet Explorer 9 以及更早的版本不支持 &lt;progress&gt; 标签。</p>
</div>
...
<p>&lt;progress&gt; 标签定义运行中的进度（进程）。</p>

<p>可以使用 &lt;progress&gt; 标签来显示 JavaScript 中耗费时间的函数的进度。</p>
</div>
...
<p class="tip"><span>提示：</span>请使用 &lt;progress&gt; 标签来显示下载的进度。</p>
</div>
...
<p>&lt;progress&gt; 标签支持 <a href="/tags/html_ref_standardattributes.asp">HTML 中的全局属性</a>。</p>
</div>
...
<p>&lt;progress&gt; 标签支持 <a href="/tags/html_ref_eventattributes.asp">HTML 中的事件属性</a>。</p>
</div>
