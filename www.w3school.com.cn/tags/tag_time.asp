...
<li class="currentLink"><a href="/tags/tag_time.asp" title="HTML &lt;time&gt; 标签">&lt;time&gt;</a></li>
...
<pre>
&lt;p&gt;我们在每天早上 <code>&lt;time&gt;9:00&lt;/time&gt;</code> 开始营业。&lt;/p&gt;

&lt;p&gt;我在 <code>&lt;time datetime=&quot;2008-02-14&quot;&gt;情人节&lt;/time&gt;</code> 有个约会。&lt;/p&gt;
</pre>

<p class="tiy"><a target="_blank" href="/tiy/t.asp?f=html5_time">亲自试一试</a></p>
</div>
...
<p>&lt;time&gt; 标签定义公历的时间（24 小时制）或日期，时间和时区偏移是可选的。</p>

<p>该元素能够以机器可读的方式对日期和时间进行编码，这样，举例说，用户代理能够把生日提醒或排定的事件添加到用户日程表中，搜索引擎也能够生成更智能的搜索结果。</p>
</div>
...
<table class="dataintable">
  ...
  <tr>
    <td class="html5_new"><a href="/tags/att_time_datetime.asp" title="HTML5 &lt;time&gt; datetime 属性">datetime</a></td>
    <td><i>datetime</i></td>
    <td>规定日期 / 时间。否则，由元素的内容给定日期 / 时间。</td>
  </tr>

  <tr>
    <td class="html5_new"><a href="/tags/att_time_pubdate.asp" title="HTML5 &lt;time&gt; pubdate 属性">pubdate</a></td>
    <td><i>pubdate</i></td>
    <td>指示 &lt;time&gt; 元素中的日期 / 时间是文档（或 &lt;article&gt; 元素）的发布日期。</td>
  </tr>
</table>
</div>
...
<p>&lt;time&gt; 标签支持 <a href="/tags/html_ref_standardattributes.asp">HTML 中的全局属性</a>。</p>
</div>
...
<p>&lt;time&gt; 标签支持 <a href="/tags/html_ref_eventattributes.asp">HTML 中的事件属性</a>。</p>
</div>
