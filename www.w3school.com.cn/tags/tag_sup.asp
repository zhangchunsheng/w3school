...
<li class="currentLink"><a href="/tags/tag_sup.asp" title="HTML &lt;sup&gt; 标签">&lt;sup&gt;</a></li>
...
<p class="tip"><span>提示：</span>这个标签在向文档添加脚注以及表示方程式中的指数值时非常有用。如果和 &lt;a&gt; 标签结合起来使用，就可以创建出很好的超链接脚注。</p>
</div>
...
<pre>这段文本包含 <code>&lt;sup&gt;上标&lt;/sup&gt;</code></pre>
</div>
...
<p>&lt;sup&gt; 标签支持 <a href="/tags/html_ref_standardattributes.asp">HTML 中的全局属性</a>。</p>
</div>
...
<p>&lt;sup&gt; 标签支持 <a href="/tags/html_ref_eventattributes.asp">HTML 中的事件属性</a>。</p>
</div>
