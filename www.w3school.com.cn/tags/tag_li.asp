...
<li class="currentLink"><a href="/tags/tag_li.asp" title="HTML &lt;li&gt; 标签">&lt;li&gt;</a></li>
...
<p class="tiy"><a target="_blank" href="/tiy/t.asp?f=html_list_test">亲自试一试</a></p>
...
<tr>
<td><a href="/tags/att_li_type.asp" title="HTML &lt;li&gt; 标签的 type 属性">type</a></td>
<td>
<ul>
<li>A</li>
<li>a</li>
...
<tr>
<td><a href="/tags/att_li_value.asp" title="HTML &lt;li&gt; 标签的 value 属性">value</a></td>
<td><i>number</i></td>
<td>
	<p><span class="deprecated">不赞成使用。</span>请使用样式取代它。</p>
	<p>规定列表项目的数字。</p>
...
<p>&lt;li&gt; 标签支持 <a href="/tags/html_ref_standardattributes.asp">HTML 中的全局属性</a>。</p>
</div>
...
<p>&lt;li&gt; 标签支持 <a href="/tags/html_ref_eventattributes.asp">HTML 中的事件属性</a>。</p>
</div>
...
<dt><a href="/tiy/t.asp?f=html_list_ordered">一个有序列表</a></dt>
<dd>本例演示一个有序列表。</dd>
