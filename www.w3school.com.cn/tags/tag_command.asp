...
<li class="currentLink"><a href="/tags/tag_command.asp" title="HTML &lt;command&gt; 标签">&lt;command&gt;</a></li>
...
<p class="tiy"><a target="_blank" href="/tiy/t.asp?f=html5_command">亲自试一试</a></p>
</div>
...
<p>没有浏览器支持 &lt;command&gt; 标签。</p>

<p>只有 Internet Explorer 9 （更早或更晚的版本都不支持）支持 &lt;command&gt; 标签。</p>
</div>
...
<p>command 元素表示用户能够调用的命令。</p>

<p>&lt;command&gt; 标签可以定义命令按钮，比如单选按钮、复选框或按钮。</p>
...
<p>目前只有 Internet Explorer 支持 &lt;command&gt; 标签。</p>
</div>
...
<table class="dataintable"> 
  ...
  <tr>
    <td class="html5_new"><a href="/tags/att_command_checked.asp" title="HTML5 &lt;command&gt; checked 属性">checked</a></td>
    <td>checked</td>
    <td>定义是否被选中。仅用于 radio 或 checkbox 类型。</td>
  </tr>
  <tr>
    <td class="html5_new"><a href="/tags/att_command_disabled.asp" title="HTML5 &lt;command&gt; disabled 属性">disabled</a></td>
    <td>disabled</td>
    <td>定义 command 是否可用。</td>
  </tr>
  <tr>
    <td class="html5_new"><a href="/tags/att_command_icon.asp" title="HTML5 &lt;command&gt; icon 属性">icon</a></td>
    <td><i>url</i></td>
    <td>定义作为 command 来显示的图像的 url。</td>
  </tr>
  <tr>
    <td class="html5_new"><a href="/tags/att_command_label.asp" title="HTML5 &lt;command&gt; label 属性">label</a></td>
    <td><i>text</i></td>
    <td>为 command 定义可见的 label。</td>
  </tr>
  <tr>
    <td class="html5_new"><a href="/tags/att_command_radiogroup.asp" title="HTML5 &lt;command&gt; radiogroup 属性">radiogroup</a></td>
    <td class="no_wrap"><i>groupname</i></td>
    <td>定义 command 所属的组名。仅在类型为 radio 时使用。</td>
  </tr>
  <tr>
    <td class="html5_new"><a href="/tags/att_command_type.asp" title="HTML5 &lt;command&gt; type 属性">type</a></td>
    <td>
	<ul>
	<li>checkbox</li>
	<li>command</li>
...
<p>&lt;command&gt; 标签支持 <a href="/tags/html_ref_standardattributes.asp">HTML 中的全局属性</a>。</p>
</div>
...
<p>&lt;command&gt; 标签支持 <a href="/tags/html_ref_eventattributes.asp">HTML 中的事件属性</a>。</p>
</div>
