...
<li class="currentLink"><a href="/tags/tag_br.asp" title="HTML &lt;br&gt; 标签">&lt;br&gt;</a></li>
...
<h2>TIY 实例</h2>
<dl>
<dt><a href="/tiy/t.asp?f=html_paragraphs">换行</a></dt>
<dd>本例演示如何在文档中插入换行符。</dd>
</dl>
</div>
...
<p>&lt;br&gt; 标签是空标签（意味着它没有结束标签，因此这是错误的：&lt;br&gt;&lt;/br&gt;）。在 XHTML 中，把结束标签放在开始标签中，也就是 &lt;br /&gt;。</p>

<p>请注意，&lt;br&gt; 标签只是简单地开始新的一行，而当浏览器遇到 <a href="/tags/tag_p.asp" title="HTML &lt;p&gt; 标签">&lt;p&gt; 标签</a>时，通常会在相邻的段落之间插入一些垂直的间距。</p>
</div>


<div>
<h2>clear 属性</h2>
<p>如果您希望文本流在内联表格或图像的下一行继续输出，请使用 clear 属性，该属性有三个可选的值：left、right 或者 all，每个值都代表一个边界或两边的边界。</p>

<p>更多有关 <a href="tag_br_prop_clear.asp">&lt;br&gt; 标签的 clear 属性</a>的信息。</p>
</div>
...
<p class="note"><span>注释：</span>请使用 &lt;br&gt; 来输入空行，而不是分割段落。</p>
</div>
...
<p>&lt;br&gt; 标签支持 <a href="/tags/html_ref_standardattributes.asp">HTML 中的全局属性</a>。</p>
</div>
...
<p>&lt;br&gt; 标签支持 <a href="/tags/html_ref_eventattributes.asp">HTML 中的事件属性</a>。</p>
</div>
