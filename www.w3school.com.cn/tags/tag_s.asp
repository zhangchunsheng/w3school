...
<li class="currentLink"><a href="/tags/tag_s.asp" title="HTML &lt;s&gt; 标签">&lt;s&gt;</a></li>
...
<pre>在 HTML 5 中，&lt;s&gt;仍然支持&lt;/s&gt;已经不支持这个标签了。</pre>
</div>
...
<p>&lt;s&gt; 标签是 <a href="/tags/tag_strike.asp" title="HTML &lt;strike&gt; 标签">&lt;strike&gt; 标签</a>的缩写版本，Netscape 和 Internet Explorer 都支持它。但在 HTML 4 和 XHTML 中已经不再赞成使用它了，意思就是不再使用了；它早晚有一天将会消失。</p>
</div>
...
<p>在 HTML 4.01 中，&lt;s&gt; 标签不被赞成使用。</p>

<p>在 XHTML 1.0 Strict DTD 中，&lt;s&gt; 标签不被支持。</p>
</div>
...
<p class="note"><span>注释：</span>请使用 &lt;del&gt; 替代它！</p>
</div>
...
<p>&lt;s&gt; 标签支持 <a href="/tags/html_ref_standardattributes.asp">HTML 中的全局属性</a>。</p>
</div>
...
<p>&lt;s&gt; 标签支持 <a href="/tags/html_ref_eventattributes.asp">HTML 中的事件属性</a>。</p>
</div>
...
<dl>
<dt><a href="/tiy/t.asp?f=html_s">删除线文本</a></dt>
<dd>此例演示如何为文本标记添加删除线。</dd>
</dl>
</div>
...
<p>请参阅 HTML 5 参考手册，了解有关 &lt;s&gt; 标签的最新信息：</p>

<p><a href="/html5/tag_s.asp" title="HTML 5 &lt;s&gt; 标签">HTML 5 &lt;s&gt; 标签</a></p>
</div>
