...
<title>HTML &lt;a&gt; 标签的 shape 属性</title>
</head>
...
<div>
<h2>定义和用法</h2>
<p>shape 属性与 <a href="/tags/att_a_coords.asp" title="HTML &lt;a&gt; 标签的 coords 属性">coords 属性</a>配合，可以规定 object 或 img 元素中链接的尺寸、形状和位置。</p>
...
&lt;object data="planets.gif" alt="Planets" type="image/gif" usemap="#Map1"&gt;
  &lt;map name="Map1"&gt;
  &lt;a href="sun.htm" <code>shape="rect"</code> coords="0,0,110,260"&gt;Sun&lt;/a&gt;
  &lt;a href="mercur.htm" <code>shape="circle"</code> coords="129,161,10"&gt;Mercury&lt;/a&gt;
  &lt;a href="venus.htm" <code>shape="circle"</code> coords="180,139,14"&gt;Venus&lt;/a&gt;
  &lt;/map&gt;
&lt;/object&gt;
</pre>

<p><a href="/tiy/t.asp?f=html_a_shape">亲自试一试</a></p>
</div>


<div>
<h2>浏览器支持</h2>
<p>只有 Firefox 和 Opera 支持 shape 属性。</p>
</div>
...
<li><a href="/tags/att_area_shape.asp">&lt;area&gt; 标签的 shape 属性</a></li>
</ul>
</div>
