...
<title>HTML &lt;body&gt; 标签的 text 属性</title>
</head>
...
<p><a href="/tiy/t.asp?f=html_body_text">TIY</a></p>
</div>


<div>
<h2>兼容性注释</h2>
<p>在 HTML 4.01 中，不赞成使用 body 元素的 text 属性；在 XHTML 1.0 Strict DTD 中，不支持 body 元素的 text 属性。</p>
<p>请使用 CSS 代替。</p>
<p>CSS 语法（在 &lt;head&gt; 部分）：&lt;style&gt;body{color:green}&lt;/style&gt;</p>
<p><a href="/tiy/t.asp?f=html_body_text_css">CSS 实例：设置文档中的文本颜色</a></p>
<p>在我们的 CSS 教程中，您可以找到更多有关 <a href="/cssref/pr_text_color.asp" title="CSS color 属性">color</a> 的细节。</p>
</div>
