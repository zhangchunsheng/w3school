...
<title>HTML &lt;table&gt; 标签的 cellspacing 属性</title>
</head>
...
<h1>HTML &lt;table&gt; 标签的 cellspacing 属性</h1>
...
<div>
<h2>定义和用法</h2>
<p>cellspacing 属性规定单元格之间的空间。</p>
<p class="note"><span>注释：</span>请勿将该属性与 <a href="/tags/att_table_cellpadding.asp" title="HTML &lt;table&gt; 标签的 cellpadding 属性">cellpadding 属性</a>相混淆，cellpadding 属性规定的是单元边沿与单元内容之间的空间。</p>
</div>
...
<p>下面的例子把表格单元格间距设置为 10 像素：</p>

<pre>
&lt;table border=&quot;8&quot; <code>cellspacing=&quot;10&quot;</code>&gt;
  &lt;tr&gt;
    &lt;th&gt;Month&lt;/th&gt;
    &lt;th&gt;Savings&lt;/th&gt;
  &lt;/tr&gt;
...
<p><a href="/tiy/t.asp?f=html_table_cellspacing">TIY</a></p>
</div>
...
<pre>&lt;body cellspacing=&quot;<i>value</i>&quot;&gt;</pre>
