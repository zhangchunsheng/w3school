...
<p class="tip"><span>提示：</span>请使用 <a href="/tags/canvas_stroke.asp" title="HTML5 canvas stroke() 方法">stroke()</a> 或 <a href="/tags/canvas_fill.asp" title="HTML5 canvas fill() 方法">fill()</a> 方法在画布上实际地绘制矩形。</p>
