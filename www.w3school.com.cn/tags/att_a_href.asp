...
<title>HTML &lt;a&gt; 标签的 href 属性</title>
</head>
...
<div>
<h2>定义和用法</h2>
<p>&lt;a&gt; 标签的 href 属性用于指定超链接目标的 URL。</p>
<p>href 属性的值可以是任何有效文档的相对或绝对 URL，包括片段标识符和 JavaScript 代码段。如果用户选择了 &lt;a&gt; 标签中的内容，那么浏览器会尝试检索并显示 href 属性指定的 URL 所表示的文档，或者执行 JavaScript 表达式、方法和函数的列表。</p>
</div>
...
<pre>&lt;a <code>href=&quot;http://www.w3school.com.cn&quot;</code>&gt;W3School&lt;/a&gt;</pre>

<p><a href="/tiy/t.asp?f=html_a_href">TIY</a></p>
</div>
...
<p class="important"><span>注意：</span>&lt;a&gt; 标签中必须提供 href 属性或 name 属性。</p>
</div>


<div>
<h2>制作文本链接</h2>
<p>一个引用其他文档的简单 &lt;a&gt; 标签可以是下列形式：</p>
<pre>&lt;a href=&quot;http://www.w3school.com.cn/index.html&quot;&gt;W3School 在线教程&lt;/a&gt;</pre>
<p>浏览器用特殊效果显示短语“W3School 在线教程”（通常是带下划线的蓝色文本），这样用户就会知道它是一个可以链接到其他文档的超链接。就像这样：</p>
<p><a href="http://www.w3school.com.cn/index.html" style="color:#0000ff;">W3School 在线教程</a></p>
<p>用户还可以利用浏览器中的选项来自己指定文本颜色、设置链接前和链接后链接文本的颜色。</p>
<p class="tip"><span>提示：</span>可以使用 <a href="/css/css_pseudo_classes.asp" title="CSS 伪类 (Pseudo-classes)">CSS 伪类</a>向文本超链接添加复杂而多样的样式。</p>
</div>


<div>
<h2>制作图像链接</h2>
<p>更复杂的锚还可以包含图像。下面这个 LOGO 是一个图像链接，点击该图像，可以返回 W3school 的首页：</p>
<pre>&lt;a href=&quot;http://www.w3school.com.cn/index.html&quot;&gt;
&lt;img src=&quot;/i/w3school_logo_white.gif&quot; /&gt;
&lt;/a&gt;</pre>
<p>上面的代码会为 W3School 的 LOGO 添加一个返回首页的超链接：</p>
<a href="http://www.w3school.com.cn/index.html"><img src="/i/w3school_logo_white.gif" alt="W3School 在线教程" /></a>
<p>大多数图形浏览器都会在作为锚的一部分的图像周围放置特殊的边框。通过在 &lt;img&gt; 标签中把图像的 <a href="/tags/att_img_border.asp" title="HTML &lt;img&gt; 标签的 border 属性">border 属性</a>设置为 0 可以删除超链接的边框。也可以使用 <a href="/css/css_border.asp" title="CSS 边框">CSS 的边框属性</a>来全局性地改变元素的边框样式。</p>
</div>
