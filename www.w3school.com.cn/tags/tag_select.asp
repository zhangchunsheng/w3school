...
<li class="currentLink"><a href="/tags/tag_select.asp" title="HTML &lt;select&gt; 标签">&lt;select&gt;</a></li>
...
<p>select 元素可创建单选或多选菜单。</p>

<p>当提交表单时，浏览器会提交选定的项目，或者收集用逗号分隔的多个选项，将其合成一个单独的参数列表，并且在将 &lt;select&gt; 表单数据提交给服务器时包括 name 属性。</p>
</div>
...
<p class="tip"><span>提示：</span>select 元素是一种表单控件，可用于在表单中接受用户输入。</p>
</div>
...
<p>&lt;select&gt; 标签支持 <a href="/tags/html_ref_standardattributes.asp">HTML 中的全局属性</a>。</p>
</div>
...
<p>&lt;select&gt; 标签支持 <a href="/tags/html_ref_eventattributes.asp">HTML 中的事件属性</a>。</p>
</div>
...
<dl>
<dt><a href="/tiy/t.asp?f=html_dropdownbox" title="Simple drop down box">简单的下拉列表</a></dt>
<dd>本例演示如何在HTML页面中创建简单的下拉列表框。下拉列表框是一个可选列表。</dd>

<dt><a href="/tiy/t.asp?f=html_dropdownbox2" title="Another drop down box">另一个下拉列表</a></dt>
