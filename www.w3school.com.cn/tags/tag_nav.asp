...
<li class="currentLink"><a href="/tags/tag_nav.asp" title="HTML &lt;nav&gt; 标签">&lt;nav&gt;</a></li>
...
<p class="tiy"><a target="_blank" href="/tiy/t.asp?f=html5_nav">亲自试一试</a></p>
</div>
...
<p>Internet Explorer 9, Firefox, Opera, Chrome 以及 Safari 支持 &lt;nav&gt; 标签。</p>

<p class="note"><span>注释：</span>Internet Explorer 8 以及更早的版本不支持 &lt;nav&gt; 标签。</p>
</div>
...
<p class="tip"><span>提示：</span>如果文档中有“前后”按钮，则应该把它放到 &lt;nav&gt; 元素中。</p>
</div>
...
<p>&lt;nav&gt; 标签支持 <a href="/tags/html_ref_standardattributes.asp">HTML 中的全局属性</a>。</p>
</div>
...
<p>&lt;nav&gt; 标签支持 <a href="/tags/html_ref_eventattributes.asp">HTML 中的事件属性</a>。</p>
</div>
