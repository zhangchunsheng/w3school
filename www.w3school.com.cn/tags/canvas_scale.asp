...
<title>HTML5 canvas scale() 方法</title>
...
var ctx=c.getContext(&quot;2d&quot;);
ctx.strokeRect(5,5,25,15);
<code>ctx.scale(2,2);</code>
ctx.strokeRect(5,5,25,15);
</pre>

<p><a target="_blank" href="/tiy/t.asp?f=html5_canvas_scale">亲自试一试</a></p>
</div>
...
<p>Internet Explorer 9、Firefox、Opera、Chrome 以及 Safari 支持 scale() 方法。</p>
...
<p>scale() 方法缩放当前绘图，更大或更小。</p>

<p class="note"><span>注释：</span>如果您对绘图进行缩放，所有之后的绘图也会被缩放。定位也会被缩放。如果您 scale(2,2)，那么绘图将定位于距离画布左上角两倍远的位置。</p>

<h3>JavaScript 语法：</h3>

<pre>context.scale(<i>scalewidth</i>,<i>scaleheight</i>);</pre>
...
<p>绘制一个矩形；放大到 200%，再次绘制矩形；放大到 200%，然后再次绘制矩形；放大到 200%，再次绘制矩形：</p>
...
var ctx=c.getContext(&quot;2d&quot;);
ctx.strokeRect(5,5,25,15);
<code class="code_comment">ctx.scale(2,2);</code>
ctx.strokeRect(5,5,25,15);
<code class="code_comment">ctx.scale(2,2);</code>
ctx.strokeRect(5,5,25,15);
<code class="code_comment">ctx.scale(2,2);</code>
...
<p><a target="_blank" href="/tiy/t.asp?f=html5_canvas_scale2">亲自试一试</a></p>
</div>
