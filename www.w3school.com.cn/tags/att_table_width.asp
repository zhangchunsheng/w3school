...
<title>HTML &lt;table&gt; 标签的 width 属性</title>
</head>
...
<h2>定义和用法</h2>
<p>width 属性规定表格的宽度。</p>
<p>如果没有设置 width 属性，表格会占用需要的空间来显示表格数据。</p>
<p>从实用角度出发，最好不要规定宽度，而是使用 CSS 来应用<a href="/css/css_dimension.asp" title="CSS 尺寸 (Dimension)">宽度</a>。</p>
</div>
...
<pre>
&lt;table border=&quot;1&quot; <code>width=&quot;400&quot;</code>&gt;
  &lt;tr&gt;
    &lt;th&gt;Month&lt;/th&gt;
    &lt;th&gt;Savings&lt;/th&gt;
  &lt;/tr&gt;
...
<p><a href="/tiy/t.asp?f=html_table_width">TIY</a></p>
</div>
...
<table class="dataintable"> 
  ...
  <tr>
    <td><i>pixels</i></td>
    <td>设置以像素计的宽度（例子：width=&quot;50&quot;）。</td>
  </tr>
  <tr>
    <td><i>%</i></td>
    <td>设置以包含元素的百分比计的宽度（例子：width=&quot;50%&quot;）。</td>
  </tr>
</table>
</div>
