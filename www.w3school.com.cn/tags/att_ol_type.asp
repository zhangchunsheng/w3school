...
<title>HTML &lt;ol&gt; 标签的 type 属性</title>
</head>
...
<h1>HTML &lt;ol&gt; 标签的 type 属性</h1>


<div class="backtoreference">
<p><a href="/tags/tag_ol.asp">HTML &lt;ol&gt; 标签</a></p>
</div>


<div>
<h2>定义和用法</h2>
<p>type 属性规定有序列表的项目符号的类型。</p>
</div>


<div>
<h2>实例</h2>
<p>在有序列表中使用 type 属性：</p>
...
<p><a href="/tiy/t.asp?f=html_ol_type">TIY</a></p>
</div>
...
<table class="dataintable">
  ...
  <tr>
    <td>1</td>
    <td>默认值。数字有序列表。（1、2、3、4）</td>
  </tr>
  <tr>
    <td>a</td>
    <td>按字母顺序排列的有序列表，小写。（a、b、c、d）</td>
  </tr>
  <tr>
    <td>A</td>
    <td>按字母顺序排列的有序列表，大写。（A、B、C、D）</td>
  </tr>
  <tr>
    <td>i</td>
