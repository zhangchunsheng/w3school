...
<li class="currentLink"><a href="/tags/tag_article.asp" title="HTML &lt;article&gt; 标签">&lt;article&gt;</a></li>
...
<p class="tiy"><a target="_blank" href="/tiy/t.asp?f=html_article">亲自试一试</a></p>
</div>
...
<p>Internet Explorer 9, Firefox, Opera, Chrome 以及 Safari 支持 &lt;article&gt; 标签。</p>

<p class="note"><span>注释：</span>Internet Explorer 8 以及更早的版本不支持 &lt;article&gt; 标签。</p>
</div>
...
<p>&lt;article&gt; 标签支持 <a href="/tags/html_ref_standardattributes.asp">HTML 中的全局属性</a>。</p>
</div>
...
<p>&lt;article&gt; 标签支持 <a href="/tags/html_ref_eventattributes.asp">HTML 中的事件属性</a>。</p>
</div>
