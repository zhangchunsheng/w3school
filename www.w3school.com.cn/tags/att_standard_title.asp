...
<p><a href="/tiy/t.asp?f=html_standard_title">亲自试一试</a></p>
...
<p class="tip"><span>提示：</span>title 属性常与 form 以及 a 元素一同使用，以提供关于输入格式和链接目标的信息。同时它也是 abbr 和 acronym 元素的必需属性。</p>
</div>
...
<pre>&lt;element <code>title=&quot;<i>value</i>&quot;</code>&gt;</pre>
