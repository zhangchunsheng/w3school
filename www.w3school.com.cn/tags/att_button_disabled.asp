...
<title>HTML &lt;button&gt; 标签的 disabled 属性</title>
</head>
...
<h1>HTML &lt;button&gt; 标签的 disabled 属性</h1>
...
<div>
<h2>定义和用法</h2>
<p>disabled 属性规定禁用按钮。</p>
<p>被禁用的按钮既不可用，也不可点击。</p>
<p>可以设置 disabled 属性，直到满足某些条件（比如选择一个复选框），才恢复用户对该按钮的使用。然后，可以使用 JavaScript 来清除 disabled 属性，以使文本区变为可用状态。</p>
</div>
...
<pre>&lt;button type=&quot;button&quot; <code>disabled=&quot;disabled&quot;</code>&gt;Click Me!&lt;/button&gt;</pre>

<p><a href="/tiy/t.asp?f=html_button_disabled">TIY</a></p>
</div>
...
<pre>&lt;button disabled=&quot;<i>value</i>&quot;&gt;</pre>
