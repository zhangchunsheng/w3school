...
<li class="currentLink"><a href="/tags/html_ref_colornames.asp" title="HTML 颜色名">HTML 颜色名</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/tags/html5_ref_dtd.asp" title="HTML 元素和有效的 DTD">HTML 文档类型</a></li>
<li class="next"><a href="/tags/html_ref_charactersets.asp" title="HTML 字符集">HTML 字符集</a></li>
</ul>
</div>


<div id="intro">
<p><strong>本页提供了被大多数浏览器支持的颜色名。</strong></p>

<p class="tip"><span>提示：</span>W3C 的 HTML 4.0 标准仅支持 16 种<em>颜色名</em>，它们是：aqua、black、blue、fuchsia、gray、green、lime、maroon、navy、olive、purple、red、silver、teal、white、yellow。</p>

<p>如果使用其它颜色的话，就应该使用<em>十六进制的颜色值</em>。</p>
</div>
