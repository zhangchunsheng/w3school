...
<title>HTML &lt;hr&gt; 标签的 width 属性</title>
</head>
...
<div>
<h2>定义和用法</h2>
<p>width 属性规定水平线的宽度，以像素计或百分比计。</p>
</div>
...
<h2>实例</h2>
<p>宽度为 50% 的水平线：</p>
<pre>&lt;hr <code>width=&quot;50%&quot;</code> /&gt;</pre>
<p><a href="/tiy/t.asp?f=html_hr_width">TIY</a></p>
</div>


<div>
<h2>浏览器支持</h2>
<p>虽然不赞成使用 width 属性，但是该属性仍然得到所有主流浏览器的支持。</p>
</div>


<div>
<h2>兼容性注释</h2>
<p>在 HTML 4.01 中，不赞成使用 hr 元素的 width 属性；在 XHTML 1.0 Strict DTD 中，不支持 hr 元素的 width 属性。</p>
<p>请使用 CSS 代替。</p>
<p>CSS 语法：&lt;hr style=&quot;width:50%&quot; /&gt;</p>
<p><a href="/tiy/t.asp?f=html_hr_width_css">CSS 实例：设置 hr 元素的宽度</a></p>
<p>在我们的 CSS 教程中，您可以找到更多有关 <a href="/cssref/pr_dim_width.asp" title="CSS width 属性">width 属性</a> 的细节。</p>
</div>
...
<table class="dataintable">
  ...
  <tr>
    <td><i>pixels</i></td>
    <td>规定以像素计的宽度（比如 &quot;50px&quot; 或者仅仅是 &quot;50&quot;）。</td>
  </tr>
  <tr>
    <td><i>%</i></td>
    <td>规定以可用空间的百分比计的宽度（比如 &quot;50%&quot;）。</td>
  </tr>
</table>
</div>
