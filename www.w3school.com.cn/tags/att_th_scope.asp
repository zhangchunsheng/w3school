...
<title>HTML &lt;th&gt; 标签的 scope 属性</title>
</head>
...
<div>
<h2>定义和用法</h2>
<p>scope 属性定义将表头单元与数据单元相关联的方法。</p>
<p>scope 属性标识某个单元是否是列、行、列组或行组的表头。</p>
<p>scope 属性不会在普通浏览器中产生任何视觉变化。</p>
<p>屏幕阅读器可以利用该属性。</p>

<h3>详细解释</h3>
<p>使用 scope 属性，可以将数据单元格与表头单元格联系起来。</p>
<p>通过属性值 row，表头行包括的所有表格都将和表头单元格联系起来。指定 col，会将当前列的所有单元格和表头单元格绑定起来。</p>
<p>使用 rowgroup 和 colgroup 会将单元格的行组（由 &lt;thead&gt;、&lt;tbody&gt; 或 &lt;tfoot&gt; 标签定义）或列组中的所有单元格和表头单元格绑定起来（由 &lt;col&gt; 或 &lt;colgroup&gt; 标签定义）。</p>
</div>


<div>
<h2>实例</h2>
<p>下面的例子把两个 th 元素标识为列的表头，把两个 td 元素标识为行的表头：</p>

<pre>
&lt;table border=&quot;1&quot;&gt;
  &lt;tr&gt;
    &lt;th <code>scope=&quot;col&quot;</code>&gt;Month&lt;/th&gt;
    &lt;th <code>scope=&quot;col&quot;</code>&gt;Savings&lt;/th&gt;
  &lt;/tr&gt;
  &lt;tr&gt;
    &lt;td <code>scope=&quot;row&quot;</code>&gt;1&lt;/td&gt;
    &lt;td&gt;January&lt;/td&gt;
    &lt;td&gt;$100.00&lt;/td&gt;
  &lt;/tr&gt;
  &lt;tr&gt;
    &lt;td <code>scope=&quot;row&quot;</code>&gt;2&lt;/td&gt;
    &lt;td&gt;February&lt;/td&gt;
    &lt;td&gt;$10.00&lt;/td&gt;
  &lt;/tr&gt;
&lt;/table&gt;
...
<p><a href="/tiy/t.asp?f=html_th_scope">TIY</a></p>
</div>


<div>
<h2>浏览器支持</h2>
<p>由于不会在普通浏览器中产生任何视觉效果，很难判断浏览器是否支持 scope 属性。</p>
</div>
