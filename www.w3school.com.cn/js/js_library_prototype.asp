...
<title>JavaScript - 测试 Prototype</title>
</head>
...
<li class="currentLink"><a href="/js/js_library_prototype.asp" title="JavaScript 测试 Prototype">JS Prototype</a></li>
</ul>
<h2>JS 实例和测验</h2>
<ul>
...
<h1>JavaScript - 测试 Prototype</h1>

<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/js/js_library_jquery.asp" title="JavaScript - 测试 jQuery">JS jQuery</a></li>
<li class="next"><a href="/example/jseg_examples.asp" title="JavaScript 实例">JS 实例</a></li>
</ul>
</div>


<div>
<p><strong>测试 JavaScript 框架库 - Prototype</strong></p>
</div>
...
<p><a href="/tiy/t.asp?f=js_library_prototype">亲自试一试</a></p>
...
<p><a href="/tiy/t.asp?f=js_library_prototype2">亲自试一试</a></p>
