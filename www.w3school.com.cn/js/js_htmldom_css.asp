...
<title>JavaScript HTML DOM - 改变 CSS</title>
</head>
...
<li class="currentLink"><a href="/js/js_htmldom_css.asp" title="JavaScript HTML DOM - 改变 CSS">DOM CSS</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/js/js_htmldom_html.asp" title="JavaScript HTML DOM - 改变 HTML">DOM HTML</a></li>
<li class="next"><a href="/js/js_htmldom_events.asp" title="JavaScript HTML DOM 事件">DOM 事件</a></li>
</ul>
</div>


<div>
<p><strong>HTML DOM 允许 JavaScript 改变 HTML 元素的样式。</strong></p>
</div>
...
<p><a href="/tiy/t.asp?f=js_change_style">亲自试一试</a></p>
...
<p><a href="/tiy/t.asp?f=js_change_style2">亲自试一试</a></p>
</div>
...
<dl>
<dt><a href="/tiy/t.asp?f=js_change_style_visibility">Visibility</a></dt>
<dd>如何使元素不可见。您希望元素显示或消失吗？</dd>
</dl>
</div>


<div>
<h2>HTML DOM Style 对象参考手册</h2>

<p>如需完整的 HTML DOM Style 对象属性，请参阅我们的 <a href="/jsref/dom_obj_style.asp" title="HTML DOM Style 对象">HTML DOM Style 对象参考手册</a>。</p>
</div>
