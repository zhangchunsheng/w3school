...
<h2>ECMAScript 基础</h2>
<ul>
<li class="currentLink"><a href="/js/pro_js_syntax.asp" title="ECMAScript 语法">ECMAScript 语法</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/js/pro_js_implement.asp" title="JavaScript 实现">JavaScript 实现</a></li>
<li class="next"><a href="/js/pro_js_variables.asp" title="ECMAScript 变量">ECMAScript 变量</a></li>
</ul>
</div>
