...
<li class="currentLink"><a href="/js/js_operators.asp" title="JavaScript 运算符">JS 运算符</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/js/js_functions.asp" title="JavaScript 函数">JS 函数</a></li>
<li class="next"><a href="/js/js_comparisons.asp" title="JavaScript 比较和逻辑运算符">JS 比较</a></li>
</ul>
</div>
...
<p>在以上语句执行后，x 的值是 7。</p>
</div>

<div>
<h2>JavaScript 算术运算符</h2>

<p>算术运算符用于执行变量与/或值之间的算术运算。</p>

<p>给定 <em>y=5</em>，下面的表格解释了这些算术运算符：</p>
...
<p>给定 <em>x=10</em> 和 <em>y=5</em>，下面的表格解释了赋值运算符：</p>
...
<p><a href="/tiy/t.asp?f=jseg_variables">TIY</a></p>
...
<p>如需更多有关 <em>JavaScript 运算符</em>的知识，请阅读 JavaScript 高级教程中的相关内容：</p>
