...
<li class="currentLink"><a href="/js/pro_js_typeconversion.asp" title="ECMAScript 类型转换">ECMAScript 类型转换</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/js/pro_js_primitivetypes.asp" title="ECMAScript 原始类型">ECMAScript 原始类型</a></li>
<li class="next"><a href="/js/pro_js_referencetypes.asp" title="ECMAScript 引用类型">ECMAScript 引用类型</a></li>
</ul>
</div>
...
<h4>参阅：</h4>
<p>请参阅 <a href="/js/js_reference.asp" title="JavaScript 参考手册">JavaScript 参考手册</a>提供的有关 toString() 方法的详细信息：</p>
<ul>
...
<p>请参阅 <a href="/js/js_reference.asp" title="JavaScript 参考手册">JavaScript 参考手册</a>提供的有关 parseInt() 方法的详细信息：<a href="/jsref/jsref_parseInt.asp" title="JavaScript parseInt() 函数">parseInt()</a>。</p>
...
<p><a href="/tiy/t.asp?f=js_pro_parsefloat">亲自试一试</a></p>
