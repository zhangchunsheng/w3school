...
<li class="currentLink"><a href="/js/js_obj_boolean.asp" title="JavaScript Boolean 对象">JS 逻辑</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/js/js_obj_array.asp" title="JavaScript Array 对象">JS 数组</a></li>
<li class="next"><a href="/js/js_obj_math.asp" title="JavaScript Math 对象">JS 算数</a></li>
</ul>
</div>
...
<p>我们提供 <a href="/jsref/jsref_obj_boolean.asp">JavaScript Boolean 对象参考手册</a>，其中包括所有可用于逻辑对象的属性和方法。</p>
