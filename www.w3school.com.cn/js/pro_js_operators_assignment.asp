...
<li class="currentLink"><a href="/js/pro_js_operators_assignment.asp" title="ECMAScript 赋值运算符">赋值运算符</a></li>
...
<h1>ECMAScript 赋值运算符</h1>

<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/js/pro_js_operators_conditional.asp" title="ECMAScript 条件运算符">条件运算符</a></li>
<li class="next"><a href="/js/pro_js_operators_comma.asp" title="ECMAScript 逗号运算符">逗号运算符</a></li>
</ul>
</div>
