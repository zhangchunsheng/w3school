...
<h2>JS 对象</h2>
<ul>
<li class="currentLink"><a href="/js/js_objects.asp" title="JavaScript 对象">JS 对象</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/js/js_htmldom_elements.asp" title="JavaScript HTML DOM 元素（节点）">DOM 节点</a></li>
<li class="next"><a href="/js/js_obj_number.asp" title="JavaScript Number 对象">JS 数字</a></li>
</ul>
</div>
...
<p>JavaScript 提供多个<em>内建</em>对象，比如 String、Date、Array 等等。</p>

<p>对象只是带有<em>属性</em>和<em>方法</em>的特殊数据类型。</p>
</div>
...
var x=message.<code>length</code>;
</pre>
...
<pre>
var message=&quot;Hello world!&quot;;
var x=message.<code>toUpperCase()</code>;
</pre>
...
<pre>person={firstname:&quot;John&quot;,lastname:&quot;Doe&quot;,age:50,eyecolor:&quot;blue&quot;};</pre>

<p class="tiy"><a href="/tiy/t.asp?f=js_create_object1">亲自试一试</a></p>
</div>
...
<p class="tiy"><a href="/tiy/t.asp?f=js_create_object2">亲自试一试</a></p>
...
<pre>myMother.changeName(&quot;Ballmer&quot;);</pre>

<p class="tiy"><a href="/tiy/t.asp?f=js_create_object3">亲自试一试</a></p>
...
<p class="note"><span>注释：</span>for...in 循环中的代码块将针对每个属性执行一次。</p>
