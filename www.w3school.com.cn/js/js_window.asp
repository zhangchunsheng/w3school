...
<title>JavaScript Window - 浏览器对象模型</title>
</head>
...
<h2>JS Window</h2>
<ul>
<li class="currentLink"><a href="/js/js_window.asp" title="JavaScript Window - 浏览器对象模型">JS Window</a></li>
...
<h1>JavaScript Window - 浏览器对象模型</h1>

<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/js/js_obj_regexp.asp" title="JavaScript RegExp 对象">JS 正则表达式</a></li>
<li class="next"><a href="/js/js_window_screen.asp" title="JavaScript Window Screen">JS Screen</a></li>
</ul>
</div>


<div id="intro">
<p><strong>浏览器对象模型 (BOM) 使 JavaScript 有能力与浏览器“对话”。</strong></p>
</div>
...
<p>浏览器对象模型（<span class="marked">B</span>rowser <span class="marked">O</span>bject <span class="marked">M</span>odel）尚无正式标准。</p>
...
<p>所有浏览器都支持 <em>window</em> 对象。它表示浏览器窗口。</p>
...
<p><a href="/tiy/t.asp?f=js_window_innerwidth_innerheight">亲自试一试</a></p>
