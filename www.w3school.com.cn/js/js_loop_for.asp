...
<li class="currentLink"><a href="/js/js_loop_for.asp" title="JavaScript For 循环">JS For</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/js/js_switch.asp" title="JavaScript Switch 语句">JS Switch</a></li>
<li class="next"><a href="/js/js_loop_while.asp" title="JavaScript While 循环">JS While</a></li>
</ul>
</div>
