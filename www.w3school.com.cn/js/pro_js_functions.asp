...
<h2>ECMAScript 函数</h2>
<ul>
<li class="currentLink"><a href="/js/pro_js_functions.asp" title="ECMAScript 函数概述">函数概述</a></li>
...
<h1>ECMAScript 函数概述</h1>

<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/js/pro_js_statements_switch.asp" title="ECMAScript switch 语句">switch 语句</a></li>
<li class="next"><a href="/js/pro_js_functions_arguments_object.asp" title="ECMAScript arguments 对象">arguments 对象</a></li>
</ul>
</div>
...
<p>函数可以通过其名字加上括号中的参数进行调用，如果有多个参数。</p>

<p>如果您想调用上例中的那个函数，可以使用如下的代码：</p>

<pre>sayHi(&quot;David&quot;, &quot; Nice to meet you!&quot;)</pre>

<p>调用上面的函数 sayHi() 会生成一个警告窗口。您可以<a href="/tiy/t.asp?f=jseg_function_alert">亲自试一试这个例子</a>。</p>
</div>
...
<p class="note"><span>注释：</span>如果函数无明确的返回值，或调用了没有参数的 return 语句，那么它真正返回的值是 undefined。</p>
</div>
