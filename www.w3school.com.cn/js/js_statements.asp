...
<li class="currentLink"><a href="/js/js_statements.asp" title="JavaScript 语句">JS 语句</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/js/js_whereto.asp" title="JavaScript 输出">JS 输出</a></li>
<li class="next"><a href="/js/js_comments.asp" title="JavaScript 注释">JS 注释</a></li>
</ul>
</div>
...
<p>下面的 JavaScript 语句向 id=&quot;demo&quot; 的 HTML 元素输出文本 &quot;Hello World&quot;：</p>

<pre>document.getElementById(&quot;demo&quot;).innerHTML=&quot;Hello World&quot;;</pre>
</div>
...
<p class="tip"><span>提示：</span>您也可能看到不带有分号的案例。</p>
...
<p>JavaScript 代码（或者只有 JavaScript）是 JavaScript 语句的序列。</p>

<p>浏览器会按照编写顺序来执行每条语句。</p>
...
<p class="tiy"><a href="/tiy/t.asp?f=js_statements">亲自试一试</a></p>
</div>
...
<p>JavaScript 语句通过代码块的形式进行组合。</p>

<p>块由左花括号开始，由右花括号结束。</p>

<p>块的作用是使语句序列一起执行。</p>

<p>JavaScript 函数是将语句组合在块中的典型例子。</p>

<p>下面的例子将运行可操作两个 HTML 元素的函数：</p>
...
<p class="tiy"><a href="/tiy/t.asp?f=js_blocks">亲自试一试</a></p>
...
<p class="tip"><span>提示：</span>JavaScript 是脚本语言。浏览器会在读取代码时，逐行地执行脚本代码。而对于传统编程来说，会在执行前对所有代码进行编译。</p>
</div>
