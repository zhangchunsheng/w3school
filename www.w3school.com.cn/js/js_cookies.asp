...
<li class="currentLink"><a href="/js/js_cookies.asp" title="JavaScript Cookies">JS Cookies</a></li>
</ul>
<h2>JS 库</h2>
<ul>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/js/js_timing.asp" title="JavaScript Timing 事件">JS Timing</a></li>
<li class="next"><a href="/js/js_libraries.asp" title="JavaScript 库">JS 库</a></li>
</ul>
</div>

<div id="intro">
<p><strong>cookie 用来识别用户。</strong></p>
</div>

<div class="example">
<h2>实例</h2>
<dl>
<dt><a href="/tiy/t.asp?f=jseg_cookie_username">创建一个欢迎 cookie</a></dt>
