...
<li class="currentLink"><a href="/js/js_window_location.asp" title="JavaScript Window Location">JS Location</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/js/js_window_screen.asp" title="JavaScript Window Screen">JS Screen</a></li>
<li class="next"><a href="/js/js_window_history.asp" title="JavaScript Window History">JS History</a></li>
</ul>
</div>
...
<p><a href="/tiy/t.asp?f=js_location_assign">亲自试一试</a></p>
</div>
