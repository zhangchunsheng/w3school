...
<li class="currentLink"><a href="/js/pro_js_object_working_with.asp" title="ECMAScript 对象应用">对象应用</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/js/pro_js_object_oriented.asp" title="ECMAScript 面向对象技术">面向对象</a></li>
<li class="next"><a href="/js/pro_js_object_types.asp" title="ECMAScript 对象类型">对象类型</a></li>
</ul>
</div>
