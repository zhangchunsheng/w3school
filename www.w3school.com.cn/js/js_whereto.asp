...
<li class="currentLink"><a href="/js/js_whereto.asp" title="JavaScript 输出">JS 输出</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/js/js_howto.asp" title="JavaScript 实现">JS 实现</a></li>
<li class="next"><a href="/js/js_statements.asp" title="JavaScript 语句">JS 语句</a></li>
</ul>
</div>


<div id="intro">
<p><strong>JavaScript 通常用于操作 HTML 元素。</strong></p>
</div>
...
&lt;p <span class="marked">id=&quot;demo&quot;</span>&gt;My First Paragraph&lt;/p&gt;

&lt;script&gt;
<code>document.getElementById(&quot;demo&quot;).innerHTML=&quot;My First JavaScript&quot;;</code>
&lt;/script&gt;
...
<p class="tiy"><a href="/tiy/t.asp?f=js_dom">亲自试一试</a></p>

<p>JavaScript 由 web 浏览器来执行。在这种情况下，浏览器将访问 id=&quot;demo&quot; 的 HTML 元素，并把它的内容（innerHTML）替换为 &quot;My First JavaScript&quot;。</p>
</div>
...
&lt;script&gt;
<code>document.write(&quot;&lt;p&gt;My First JavaScript&lt;/p&gt;&quot;);</code>
&lt;/script&gt;
...
<p class="tiy"><a href="/tiy/t.asp?f=js_write">亲自试一试</a></p>
</div>
...
<p class="tiy"><a href="/tiy/t.asp?f=js_write_over">亲自试一试</a></p>
</div>


<div>
<h2>Windows 8 中的 JavaScript</h2>

<p class="tip"><span>提示：</span>微软支持通过 JavaScript 创建 Windows 8 app。</p>
