...
<li class="currentLink"><a href="/js/js_switch.asp" title="JavaScript Switch 语句">JS Switch</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/js/js_if_else.asp" title="JavaScript If...Else 语句">JS If...Else</a></li>
<li class="next"><a href="/js/js_loop_for.asp" title="JavaScript For 循环">JS For</a></li>
</ul>
</div>

<div id="intro">
<p><strong>switch 语句用于基于不同的条件来执行不同的动作。</strong></p>
</div>
...
<p>工作原理：首先设置表达式 n（通常是一个变量）。随后表达式的值会与结构中的每个 case 的值做比较。如果存在匹配，则与该 case 关联的代码块会被执行。请使用 <em>break</em> 来阻止代码自动地向下一个 case 运行。</p>

<h3>实例</h3>

<p>显示今日的周名称。请注意 Sunday=0, Monday=1, Tuesday=2, 等等：</p>
...
<p class="tiy"><a href="/tiy/t.asp?f=js_switch">亲自试一试</a></p>
</div>
...
case 0:
  ...
  break;
<code>default:
  x=&quot;Looking forward to the Weekend&quot;;</code>
}
</pre>
...
<p class="tiy"><a href="/tiy/t.asp?f=js_switch2">亲自试一试</a></p>
</div>
...
<p>如需更多有关 <em>JavaScript Switch 语句</em>的知识，请阅读 JavaScript 高级教程中的相关内容：</p>
