...
<li class="currentLink"><a href="/js/js_htmldom_html.asp" title="JavaScript HTML DOM - 改变 HTML">DOM HTML</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/js/js_htmldom.asp" title="JavaScript HTML DOM">DOM 简介</a></li>
<li class="next"><a href="/js/js_htmldom_css.asp" title="JavaScript HTML DOM - 改变 CSS">DOM CSS</a></li>
</ul>
</div>


<div>
<p><strong>HTML DOM 允许 JavaScript 改变 HTML 元素的内容。</strong></p>
</div>
...
<p><a href="/tiy/t.asp?f=js_dom_change_html_output_stream">亲自试一试</a></p>

<p class="tip"><span>提示：</span>绝不要使用在文档加载之后使用 document.write()。这会覆盖该文档。</p>
</div>
...
<p><a href="/tiy/t.asp?f=js_dom_change_html_innerhtml">亲自试一试</a></p>
...
<p><a href="/tiy/t.asp?f=js_dom_change_html_innerhtml2">亲自试一试</a></p>
...
<p><a href="/tiy/t.asp?f=js_dom_change_html_attribute">亲自试一试</a></p>
