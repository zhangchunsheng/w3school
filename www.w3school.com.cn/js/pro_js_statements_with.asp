...
<title>ECMAScript with 语句</title>
</head>
...
<li class="currentLink"><a href="/js/pro_js_statements_with.asp" title="ECMAScript with 语句">with 语句</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/js/pro_js_statements_break_continue.asp" title="ECMAScript break 和 continue 语句">continue 语句</a></li>
<li class="next"><a href="/js/pro_js_statements_switch.asp" title="ECMAScript switch 语句">switch 语句</a></li>
</ul>
</div>
