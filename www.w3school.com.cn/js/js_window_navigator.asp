...
<li class="currentLink"><a href="/js/js_window_navigator.asp" title="JavaScript Window Navigator">JS Navigator</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/js/js_window_history.asp" title="JavaScript Window History">JS History</a></li>
<li class="next"><a href="/js/js_popup.asp" title="JavaScript Popup Box">JS PopupAlert</a></li>
</ul>
</div>
...
<p>window.navigator 对象在编写时可不使用 window 这个前缀。</p>
...
<p><a href="/tiy/t.asp?f=js_navigator_all">亲自试一试</a></p>

<p class="important"><span>警告：</span>来自 navigator 对象的信息具有误导性，不应该被用于检测浏览器版本，这是因为：</p>
