...
<li class="currentLink"><a href="/js/pro_js_functions_function_object.asp" title="ECMAScript Function 对象（类）">Function 对象</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/js/pro_js_functions_arguments_object.asp" title="ECMAScript arguments 对象">arguments 对象</a></li>
<li class="next"><a href="/js/pro_js_functions_closures.asp" title="ECMAScript 闭包（closure）">闭包（closure）</a></li>
</ul>
</div>
...
<p>上面这段代码输出了 doAdd() 函数的文本。<a href="/tiy/t.asp?f=jseg_tostring_function">亲自试一试</a>！</p>
</div>
