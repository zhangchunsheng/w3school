...
<ul>
<li class="currentLink"><a href="/js/index.asp" title="JavaScript 教程">JS 教程</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/js/index.asp" title="JavaScript 教程">JS 教程</a></li>
<li class="next"><a href="/js/js_intro.asp" title="JavaScript 简介">JS 简介</a></li>
</ul>
</div>


<div id="intro">
<p><strong>JavaScript 是属于网络的脚本语言！</strong></p>
<p><strong>JavaScript 被数百万计的网页用来改进设计、验证表单、检测浏览器、创建cookies，以及更多的应用。</strong></p>
<p><strong>JavaScript 是因特网上最流行的脚本语言。</strong></p>
<p><strong>JavaScript 很容易使用！你一定会喜欢它的！</strong></p>
<p><a href="/js/js_intro.asp" title="JavaScript 简介">开始学习 JavaScript</a> ！</p>
</div>


<div>
<h2>JavaScript 实例</h2>
<p>学习 100 个实例！使用我们的编辑器，你可以编辑源代码，然后单击 TIY 按钮来查看结果。</p>
<p><a href="/example/jseg_examples.asp" title="JavaScript Examples">JavaScript 实例</a></p>
<p><a href="/example/jsrf_examples.asp" title="JavaScript Object Examples">JavaScript Object 实例</a></p>
<p><a href="/example/hdom_examples.asp" title="HTML DOM 实例">HTML DOM 实例</a></p>
</div>


<div>
<h2>JavaScript 测试</h2>
<p>在 W3School 测试你的 JavaScript 技能！</p>
<p><a href="/js/js_quiz.asp" title="JavaScript 测验">开始 JavaScript 测验</a> ！</p>
</div>


<div>
<h2>JavaScript 参考手册</h2>

<p>在 W3School，我们为您提供完整的 JavaScript 对象参考手册。</p>

<p><a href="/jsref/index.asp" title="JavaScript objects reference">完整的 JavaScript 对象参考手册（包含实例）</a></p>

<p><a href="/htmldom/htmldom_reference.asp" title="HTML DOM objects reference">完整的 HTML DOM 对象参考手册（包含实例）</a></p>
</div>


<div>
<h2>JavaScript 课外书</h2>

<p>如果您已经把我们的 JavaScript 教程学习完毕，并且需要更深入地学习这门语言，那么 w3school 提供的 《<a href="/js/index_pro.asp" title="JavaScript 高级教程">JavaScript 高级教程</a>》绝对是您最好的选择。</p>

<p>本教程从 JavaScript 的历史开始讲起，直到当前它对 XML 和 Web 服务的支持。</p>

<p>您将学习到如何扩展该语言，以使它适应特殊的需求。</p>

<p>您还将学到如何使用 JavaScript 创建无缝的客户机 - 服务器通信。</p>

<p>本教程深入浅出，在您认真学习之后，一定会获益良多。</p>

<p><a href="/js/index_pro.asp" title="JavaScript 高级教程">马上开始学习 JavaScript 高级教程吧</a> ！</p>
</div>
