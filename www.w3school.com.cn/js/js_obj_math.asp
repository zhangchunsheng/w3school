...
<title>JavaScript Math（算数）对象</title>
</head>
...
<li class="currentLink"><a href="/js/js_obj_math.asp" title="JavaScript Math 对象">JS 算数</a></li>
...
<h1>JavaScript Math（算数）对象</h1>

<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/js/js_obj_boolean.asp" title="JavaScript Boolean 对象">JS 逻辑</a></li>
<li class="next"><a href="/js/js_obj_regexp.asp" title="JavaScript RegExp 对象">JS 正则表达式</a></li>
</ul>
</div>


<div id="intro">
<p><strong>Math（算数）对象的作用是：执行常见的算数任务。</strong></p>
</div>
...
<h2>实例</h2>
<dl>
<dt><a href="/tiy/t.asp?f=jsrf_math_round">round()</a></dt>
<dd>如何使用 round()。</dd>

<dt><a href="/tiy/t.asp?f=jsrf_math_random">random()</a></dt>
<dd>如何使用 random() 来返回 0 到 1 之间的随机数。</dd>

<dt><a href="/tiy/t.asp?f=jsrf_math_max">max()</a></dt>
<dd>如何使用 max() 来返回两个给定的数中的较大的数。（在 ECMASCript v3 之前，该方法只有两个参数。）</dd>

<dt><a href="/tiy/t.asp?f=jsrf_math_min">min()</a></dt>
<dd>如何使用 min() 来返回两个给定的数中的较小的数。（在 ECMASCript v3 之前，该方法只有两个参数。）</dd>
</dl>
</div>
...
<p>我们提供 <a href="/jsref/jsref_obj_math.asp">JavaScript Math 对象的参考手册</a>，其中包括所有可用于算术对象的属性和方法。</p>
...
<pre>document.write(<code>Math.round(4.7)</code>)</pre>

<p>上面的代码输出为：</p>
<pre>5</pre>

<p>下面的例子使用了 Math 对象的 random() 方法来返回一个介于 0 和 1 之间的随机数：</p>
<pre>document.write(<code>Math.random()</code>)</pre>

<p>上面的代码输出为：</p>
<pre>0.9370844220218102</pre>

<p>下面的例子使用了 Math 对象的 floor() 方法和 random() 来返回一个介于 0 和 10 之间的随机数：</p>
<pre>document.write(<code>Math.floor(Math.random()*11)</code>) </pre>
