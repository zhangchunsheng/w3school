...
<li class="currentLink"><a href="/js/js_break.asp" title="JavaScript Break 和 Continue 语句">JS Break</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/js/js_loop_while.asp" title="JavaScript While 循环">JS While</a></li>
<li class="next"><a href="/js/js_errors.asp" title="JavaScript 错误 - Throw 和 Try to Catch">JS 错误</a></li>
</ul>
</div>
...
<p><strong>continue 用于跳过循环中的一个迭代。</strong></p>
</div>
...
<p class="tiy"><a href="/tiy/t.asp?f=js_continue">亲自试一试</a></p>
</div>
...
<p class="tiy"><a href="/tiy/t.asp?f=js_break_label">亲自试一试</a></p>
</div>
...
<p>如需更多有关 <em>JavaScript Break 和 Continue 语句</em>的知识，请阅读 JavaScript 高级教程中的相关内容：</p>
