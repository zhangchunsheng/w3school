...
<li class="currentLink"><a href="/js/js_popup.asp" title="JavaScript Popup Box">JS PopupAlert</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/js/js_window_navigator.asp" title="JavaScript Window Navigator">JS Navigator</a></li>
<li class="next"><a href="/js/js_timing.asp" title="JavaScript Timing 事件">JS Timing</a></li>
</ul>
</div>
...
<h2>实例</h2>
<dl>
<dt><a href="/tiy/t.asp?f=jseg_alert">警告框</a></dt>

<dt><a href="/tiy/t.asp?f=jseg_alert2">带有折行的警告框</a></dt>

<dt><a href="/tiy/t.asp?f=jseg_confirm">确认框</a></dt>

<dt><a href="/tiy/t.asp?f=jseg_prompt">提示框</a></dt>
</dl>
</div>
