...
<li class="currentLink"><a href="/js/pro_js_statements_labeled.asp" title="ECMAScript 标签语句">标签语句</a></li>
...
<h1>ECMAScript 标签语句</h1>

<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/js/pro_js_statements_iterative.asp" title="ECMAScript 迭代语句">迭代语句</a></li>
<li class="next"><a href="/js/pro_js_statements_break_continue.asp" title="ECMAScript break 和 continue 语句">break 语句</a></li>
</ul>
</div>
...
<p>在这个例子中，标签 start 可以被之后的 break 或 continue 语句引用。</p>

<p class="tip"><span>提示：</span>在下面的章节，我们将为您介绍 break 和 continue 语句。</p>
</div>
