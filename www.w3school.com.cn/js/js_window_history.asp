...
<li class="currentLink"><a href="/js/js_window_history.asp" title="JavaScript Window History">JS History</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/js/js_window_location.asp" title="JavaScript Window Location">JS Location</a></li>
<li class="next"><a href="/js/js_window_navigator.asp" title="JavaScript Window Navigator">JS Navigator</a></li>
</ul>
</div>


<div>
<p>window.history 对象包含浏览器的历史。</p>
</div>
...
<p><em>window.history</em> 对象在编写时可不使用 window 这个前缀。</p>
...
<pre><input type="button" value="转到上一页" onclick="goBack()" /></pre>
</div>
...
function goForward()
  {
  <code>window.history.forward()</code>
  }
&lt;/script&gt;
&lt;/head&gt;
&lt;body&gt;
...
<pre><input type="button" value="转到下一页" onclick="goForward()" /></pre>
</div>
