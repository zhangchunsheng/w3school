...
<li class="currentLink"><a href="/js/js_loop_while.asp" title="JavaScript While 循环">JS While</a></li>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/js/js_loop_for.asp" title="JavaScript For 循环">JS For</a></li>
<li class="next"><a href="/js/js_break.asp" title="JavaScript Break 和 Continue 语句">JS Break</a></li>
</ul>
</div>

<div id="intro">
<p><strong>只要指定条件为 true，循环就可以一直执行代码。</strong></p>
</div>
...
<p class="tiy"><a href="/tiy/t.asp?f=js_while">亲自试一试</a></p>

<p class="tip"><span>提示：</span>如果您忘记增加条件中所用变量的值，该循环永远不会结束。该可能导致浏览器崩溃。</p>
</div>
...
<p>下面的例子使用 do/while 循环。该循环至少会执行一次，即使条件是 false，隐藏代码块会在条件被测试前执行：</p>
...
<p class="tiy"><a href="/tiy/t.asp?f=js_dowhile">亲自试一试</a></p>
...
<p class="tiy"><a href="/tiy/t.asp?f=js_loop_for_cars">亲自试一试</a></p>

<h3>while 语句实例</h3>

<p>本例中的循环使用使用 while 循环来显示 cars 数组中的所有值：</p>
...
<p class="tiy"><a href="/tiy/t.asp?f=js_loop_while_cars">亲自试一试</a></p>
</div>
...
<p>如需更多有关 <em>JavaScript while 语句</em>的知识，请阅读 JavaScript 高级教程中的相关内容：</p>
