...
<li class="currentLink"><a href="/js/js_window_screen.asp" title="JavaScript Window Screen">JS Screen</a></li>
...
<h1>JavaScript Window Screen</h1>

<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/js/js_window.asp" title="JavaScript Window - 浏览器对象模型">JS Window</a></li>
<li class="next"><a href="/js/js_window_location.asp" title="JavaScript Window Location">JS Location</a></li>
</ul>
</div>


<div id="intro">
<p><strong>window.screen 对象包含有关用户屏幕的信息。</strong></p>
</div>
...
<p><em>window.screen</em> 对象在编写时可以不使用 window 这个前缀。</p>
...
document.write(&quot;可用宽度：&quot; + <code>screen.availWidth</code>);
...
<pre><script>document.write("可用宽度：" + screen.availWidth);</script></pre>

<p><a href="/tiy/t.asp?f=js_window_screen_availwidth">亲自试一试</a></p>
</div>
...
document.write(&quot;可用高度：&quot; + <code>screen.availHeight</code>);
...
<pre><script>document.write("可用高度：" + screen.availHeight);</script></pre>

<p><a href="/tiy/t.asp?f=js_window_screen_availheight">亲自试一试</a></p>
</div>
