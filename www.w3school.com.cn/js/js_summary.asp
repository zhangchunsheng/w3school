...
<li class="currentLink"><a href="/js/js_summary.asp" title="JavaScript 总结">JS 总结</a></li>
</ul>
<h2>JS 参考手册</h2>
<ul>
...
<div id="tpn">
<ul class="prenext">
<li class="pre"><a href="/js/js_quiz.asp" title="JavaScript 测验">JS 测验</a></li>
<li class="next"><a href="/js/index.asp" title="JavaScript 教程">JS 教程</a></li>
</ul>
</div>


<div id="intro">
<p><strong>现在您已经学习了 JavaScript，接下来该学习什么呢？</strong></p>
</div>
...
<p>如需更多关于 JavaScript 的信息和知识，请参阅我们的 <a href="/example/jseg_examples.asp">JavaScript 实例</a> 和 <a href="/jsref/index.asp">JavaScript 参考手册</a>。</p>
</div>
...
<p>如果你希望学习关于服务器端脚本的知识，那么下一步应该学习 ASP。</p>
...
<p>假如希望了解更多关于 jQuery 的知识，请访问我们的 <a href="/jquery/index.asp">jQuery 教程</a>。</p>
...
<p>假如希望了解更多关于 jQuery Mobile 的知识，请访问我们的 <a href="/jquerymobile/index.asp">jQuery Mobile 教程</a>。</p>
...
<p>HTML DOM 独立于平台和语言，可被任何编程语言使用，比如 Java、JavaScript 和 VBscript。</p>

<p>假如希望了解更多关于 DOM 的知识，请访问我们的 <a href="/htmldom/index.asp">HTML DOM 教程</a>。</p>
...
<p>假如您希望学习更多关于 AJAX 的知识，请访问我们的 <a href="/ajax/index.asp">AJAX 教程</a>。</p>
...
<p>如果希望学习更多关于 ASP 的知识，请访问我们的 <a href="/asp/index.asp">ASP 教程</a>。</p>

<p>如果希望学习更多关于 PHP 的知识，请访问我们的 <a href="/php/index.asp">PHP 教程</a>。</p>
</div>
